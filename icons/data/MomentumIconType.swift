...
@objc public enum MomentumIconType: Int {
    ...
    public var ligature: String {
        ...
        case .secureFips24: return "\u{f96f}"
        case .selfview16: return "\u{f970}"
        case .selfview20: return "\u{f971}"
        case .selfview24: return "\u{f972}"
        case .send12: return "\u{f973}"
        case .send14: return "\u{f974}"
        case .send16: return "\u{f975}"
        case .send20: return "\u{f976}"
        case .send24: return "\u{f977}"
        case .seperate12: return "\u{f978}"
        case .seperate16: return "\u{f979}"
        case .seperate20: return "\u{f97a}"
        case .seperate24: return "\u{f97b}"
        case .server16: return "\u{f97c}"
        case .server24: return "\u{f97d}"
        case .serverCircle100: return "\u{f97e}"
        case .serverError16: return "\u{f97f}"
        case .settings10: return "\u{f980}"
        case .settings12: return "\u{f981}"
        case .settings14: return "\u{f982}"
        case .settings16: return "\u{f983}"
        case .settings18: return "\u{f984}"
        case .settings20: return "\u{f985}"
        case .settings24: return "\u{f986}"
        case .settings32: return "\u{f987}"
        case .settings8: return "\u{f988}"
        case .settingsActive10: return "\u{f989}"
        case .settingsActive12: return "\u{f98a}"
        case .settingsActive14: return "\u{f98b}"
        case .settingsActive16: return "\u{f98c}"
        case .settingsActive18: return "\u{f98d}"
        case .settingsActive20: return "\u{f98e}"
        case .settingsActive24: return "\u{f98f}"
        case .settingsActive32: return "\u{f990}"
        case .settingsActive8: return "\u{f991}"
        case .setupAssistant16: return "\u{f992}"
        case .shakeDevice18: return "\u{f993}"
        case .shakeDevice20: return "\u{f994}"
        case .shapeDiagonalArrowheadDual16: return "\u{f995}"
        case .shapeDiagonalArrowheadSingle16: return "\u{f996}"
        case .shapeDiagonalLine16: return "\u{f997}"
        case .shapeOval16: return "\u{f998}"
        case .shapeSquare16: return "\u{f999}"
        case .share12: return "\u{f99a}"
        case .share14: return "\u{f99b}"
        case .share16: return "\u{f99c}"
        case .share18: return "\u{f99d}"
        case .share20: return "\u{f99e}"
        case .share24: return "\u{f99f}"
        case .share28: return "\u{f9a0}"
        case .share32: return "\u{f9a1}"
        case .shareCNativeAdr14: return "\u{f9a2}"
        case .shareCNativeAdr16: return "\u{f9a3}"
        case .shareCNativeAdr24: return "\u{f9a4}"
        case .shareCNativeIos10: return "\u{f9a5}"
        case .shareCNativeIos12: return "\u{f9a6}"
        case .shareCNativeIos14: return "\u{f9a7}"
        case .shareCNativeIos16: return "\u{f9a8}"
        case .shareCNativeIos20: return "\u{f9a9}"
        case .shareCNativeIos28: return "\u{f9aa}"
        case .shareCNativeIph10: return "\u{f9ab}"
        case .shareCNativeIph12: return "\u{f9ac}"
        case .shareCNativeIph14: return "\u{f9ad}"
        case .shareCNativeIph16: return "\u{f9ae}"
        case .shareCNativeIph20: return "\u{f9af}"
        case .shareCNativeIph24: return "\u{f9b0}"
        case .shareCNativeIph28: return "\u{f9b1}"
        case .shareScreen10: return "\u{f9b2}"
        case .shareScreen12: return "\u{f9b3}"
        case .shareScreen120: return "\u{f9b4}"
        case .shareScreen124: return "\u{f9b5}"
        case .shareScreen14: return "\u{f9b6}"
        case .shareScreen16: return "\u{f9b7}"
        case .shareScreen18: return "\u{f9b8}"
        case .shareScreen20: return "\u{f9b9}"
        case .shareScreen24: return "\u{f9ba}"
        case .shareScreen26: return "\u{f9bb}"
        case .shareScreen28: return "\u{f9bc}"
        case .shareScreen32: return "\u{f9bd}"
        case .shareScreen36: return "\u{f9be}"
        case .shareScreen48: return "\u{f9bf}"
        case .shareScreen56: return "\u{f9c0}"
        case .shareScreen8: return "\u{f9c1}"
        case .shareScreenActive14: return "\u{f9c2}"
        case .shareScreenActive24: return "\u{f9c3}"
        case .shareSpace12: return "\u{f9c4}"
        case .shareSpace14: return "\u{f9c5}"
        case .shareSpace18: return "\u{f9c6}"
        case .shareSpace20: return "\u{f9c7}"
        case .shareSpace24: return "\u{f9c8}"
        case .shield12: return "\u{f9c9}"
        case .shield14: return "\u{f9ca}"
        case .shield24: return "\u{f9cb}"
        case .show12: return "\u{f9cc}"
        case .show16: return "\u{f9cd}"
        case .show20: return "\u{f9ce}"
        case .show24: return "\u{f9cf}"
        case .signIn16: return "\u{f9d0}"
        case .signIn20: return "\u{f9d1}"
        case .signIn24: return "\u{f9d2}"
        case .signInForced16: return "\u{f9d3}"
        case .signInForced24: return "\u{f9d4}"
        case .signOut10: return "\u{f9d5}"
        case .signOut12: return "\u{f9d6}"
        case .signOut16: return "\u{f9d7}"
        case .signOut20: return "\u{f9d8}"
        case .signOut24: return "\u{f9d9}"
        case .signal016: return "\u{f9da}"
        case .signal10012: return "\u{f9db}"
        case .signal10016: return "\u{f9dc}"
        case .signal2516: return "\u{f9dd}"
        case .signal5016: return "\u{f9de}"
        case .signal7516: return "\u{f9df}"
        case .singleNumberReach12: return "\u{f9e0}"
        case .singleNumberReach14: return "\u{f9e1}"
        case .singleNumberReach16: return "\u{f9e2}"
        case .singleNumberReach20: return "\u{f9e3}"
        case .skip10: return "\u{f9e4}"
        case .skip16: return "\u{f9e5}"
        case .skip24: return "\u{f9e6}"
        case .skipBw16: return "\u{f9e7}"
        case .skipBw24: return "\u{f9e8}"
        case .skipFw16: return "\u{f9e9}"
        case .skipFw24: return "\u{f9ea}"
        case .sortDown20: return "\u{f9eb}"
        case .sortDown24: return "\u{f9ec}"
        case .sortUp20: return "\u{f9ed}"
        case .sortUp24: return "\u{f9ee}"
        case .space12: return "\u{f9ef}"
        case .space16: return "\u{f9f0}"
        case .spark16: return "\u{f9f1}"
        case .sparkBoard12: return "\u{f9f2}"
        case .sparkBoard14: return "\u{f9f3}"
        case .sparkBoard16: return "\u{f9f4}"
        case .sparkBoard20: return "\u{f9f5}"
        case .sparkBoard24: return "\u{f9f6}"
        case .sparkBoard28: return "\u{f9f7}"
        case .sparkBoard32: return "\u{f9f8}"
        case .sparkBoard48: return "\u{f9f9}"
        case .sparkQuadCamera16: return "\u{f9fa}"
        case .sparkQuadCamera20: return "\u{f9fb}"
        case .sparkRoomKit16: return "\u{f9fc}"
        case .sparkRoomKit20: return "\u{f9fd}"
        case .sparkRoomKitPlus16: return "\u{f9fe}"
        case .sparkRoomKitPlus20: return "\u{f9ff}"
        case .sparkShare16: return "\u{fa00}"
        case .sparkShare20: return "\u{fa01}"
        case .sparkVoice16: return "\u{fa02}"
        case .sparkVoice20: return "\u{fa03}"
        case .speaker12: return "\u{fa04}"
        case .speaker16: return "\u{fa05}"
        case .speaker20: return "\u{fa06}"
        case .speaker24: return "\u{fa07}"
        case .speaker28: return "\u{fa08}"
        case .speakerBluetooth16: return "\u{fa09}"
        case .speakerDisconnected12: return "\u{fa0a}"
        case .speakerDisconnected14: return "\u{fa0b}"
        case .speakerDisconnected16: return "\u{fa0c}"
        case .speakerDisconnected20: return "\u{fa0d}"
        case .speakerDisconnected24: return "\u{fa0e}"
        case .speakerDisconnected28: return "\u{fa0f}"
        case .speakerDisconnected36: return "\u{fa10}"
        case .speakerLineOutLeft16: return "\u{fa11}"
        case .speakerLineOutRight16: return "\u{fa12}"
        case .speakerMuted12: return "\u{fa13}"
        case .speakerMuted16: return "\u{fa14}"
        case .speakerMuted24: return "\u{fa15}"
        case .speakerMuted28: return "\u{fa16}"
        case .speakerMuted32: return "\u{fa17}"
        case .speakerOff16: return "\u{fa18}"
        case .speakerOff24: return "\u{fa19}"
        case .speakerOff28: return "\u{fa1a}"
        case .spinner12: return "\u{fa1b}"
        case .spinner14: return "\u{fa1c}"
        case .spinner16: return "\u{fa1d}"
        case .spinner18: return "\u{fa1e}"
        case .spinner20: return "\u{fa1f}"
        case .spinner24: return "\u{fa20}"
        case .spinner28: return "\u{fa21}"
        case .spinner32: return "\u{fa22}"
        case .spinner36: return "\u{fa23}"
        case .spinner40: return "\u{fa24}"
        case .spinner48: return "\u{fa25}"
        case .spinner56: return "\u{fa26}"
        case .spinner72: return "\u{fa27}"
        case .spinner8: return "\u{fa28}"
        case .spinner80: return "\u{fa29}"
        case .spinner90: return "\u{fa2a}"
        case .spreadsheet16: return "\u{fa2b}"
        case .startChat20: return "\u{fa2c}"
        case .stickers16: return "\u{fa2d}"
        case .stickers24: return "\u{fa2e}"
        case .stickies12: return "\u{fa2f}"
        case .stickies16: return "\u{fa30}"
        case .stickies24: return "\u{fa31}"
        case .stop10: return "\u{fa32}"
        case .stop12: return "\u{fa33}"
        case .stop16: return "\u{fa34}"
        case .stop20: return "\u{fa35}"
        case .stop24: return "\u{fa36}"
        case .stopCircle12: return "\u{fa37}"
        case .stopCircle16: return "\u{fa38}"
        case .stopCircle20: return "\u{fa39}"
        case .stopCircle24: return "\u{fa3a}"
        case .stopContentShare20: return "\u{fa3b}"
        case .storedInfo12: return "\u{fa3c}"
        case .storedInfo16: return "\u{fa3d}"
        case .storedInfo20: return "\u{fa3e}"
        case .storedInfo24: return "\u{fa3f}"
        case .storedInfoActive12: return "\u{fa40}"
        case .storedInfoActive16: return "\u{fa41}"
        case .storedInfoActive20: return "\u{fa42}"
        case .storedInfoActive24: return "\u{fa43}"
        case .streaming16: return "\u{fa44}"
        case .streaming20: return "\u{fa45}"
        case .streaming24: return "\u{fa46}"
        case .subscribe16: return "\u{fa47}"
        case .swift16: return "\u{fa48}"
        case .sx1016: return "\u{fa49}"
        case .sx1020: return "\u{fa4a}"
        case .sx2016: return "\u{fa4b}"
        case .sx2020: return "\u{fa4c}"
        case .sx80Codec16: return "\u{fa4d}"
        case .sx80Codec20: return "\u{fa4e}"
        case .tablet16: return "\u{fa4f}"
        case .tablet24: return "\u{fa50}"
        case .tag12: return "\u{fa51}"
        case .tag16: return "\u{fa52}"
        case .tag20: return "\u{fa53}"
        case .tap20: return "\u{fa54}"
        case .tasks10: return "\u{fa55}"
        case .tasks12: return "\u{fa56}"
        case .tasks14: return "\u{fa57}"
        case .tasks16: return "\u{fa58}"
        case .tasks18: return "\u{fa59}"
        case .tasks20: return "\u{fa5a}"
        case .tasks24: return "\u{fa5b}"
        case .tasks26: return "\u{fa5c}"
        case .tasks28: return "\u{fa5d}"
        case .tasks32: return "\u{fa5e}"
        case .tasks36: return "\u{fa5f}"
        case .tasks8: return "\u{fa60}"
        case .team12: return "\u{fa61}"
        case .team14: return "\u{fa62}"
        case .team16: return "\u{fa63}"
        case .team18: return "\u{fa64}"
        case .team20: return "\u{fa65}"
        case .team24: return "\u{fa66}"
        case .team32: return "\u{fa67}"
        case .teamActive12: return "\u{fa68}"
        case .teamActive14: return "\u{fa69}"
        case .teamActive16: return "\u{fa6a}"
        case .teamActive18: return "\u{fa6b}"
        case .teamActive20: return "\u{fa6c}"
        case .teamActive24: return "\u{fa6d}"
        case .teamActive32: return "\u{fa6e}"
        case .telepresence12: return "\u{fa6f}"
        case .telepresence14: return "\u{fa70}"
        case .telepresence16: return "\u{fa71}"
        case .telepresence18: return "\u{fa72}"
        case .telepresence20: return "\u{fa73}"
        case .telepresence24: return "\u{fa74}"
        case .telepresence64: return "\u{fa75}"
        case .telepresenceAlert12: return "\u{fa76}"
        case .telepresenceIx500016: return "\u{fa77}"
        case .telepresenceIx500020: return "\u{fa78}"
        case .telepresenceMuted12: return "\u{fa79}"
        case .telepresenceMuted64: return "\u{fa7a}"
        case .telepresenceMutedAlert12: return "\u{fa7b}"
        case .telepresencePrivate12: return "\u{fa7c}"
        case .text10: return "\u{fa7d}"
        case .text12: return "\u{fa7e}"
        case .text16: return "\u{fa7f}"
        case .textAlignLeft16: return "\u{fa80}"
        case .textAlignRight16: return "\u{fa81}"
        case .textBlockquote12: return "\u{fa82}"
        case .textBlockquote16: return "\u{fa83}"
        case .textBlockquote18: return "\u{fa84}"
        case .textBlockquote20: return "\u{fa85}"
        case .textBlockquote8: return "\u{fa86}"
        case .textBold12: return "\u{fa87}"
        case .textBold16: return "\u{fa88}"
        case .textCodeBlock12: return "\u{fa89}"
        case .textCodeBlock16: return "\u{fa8a}"
        case .textColor16: return "\u{fa8b}"
        case .textFormat10: return "\u{fa8c}"
        case .textFormat12: return "\u{fa8d}"
        case .textFormat16: return "\u{fa8e}"
        case .textFormat20: return "\u{fa8f}"
        case .textFormat24: return "\u{fa90}"
        case .textFormat8: return "\u{fa91}"
        case .textHeading112: return "\u{fa92}"
        case .textHeading116: return "\u{fa93}"
        case .textHeading212: return "\u{fa94}"
        case .textHeading216: return "\u{fa95}"
        case .textHeading312: return "\u{fa96}"
        case .textHeading316: return "\u{fa97}"
        case .textItalic12: return "\u{fa98}"
        case .textItalic16: return "\u{fa99}"
        case .textListBulleted10: return "\u{fa9a}"
        case .textListBulleted12: return "\u{fa9b}"
        case .textListBulleted16: return "\u{fa9c}"
        case .textListBulleted8: return "\u{fa9d}"
        case .textListNumbered12: return "\u{fa9e}"
        case .textListNumbered16: return "\u{fa9f}"
        case .textListNumbered36: return "\u{faa0}"
        case .textListNumbered40: return "\u{faa1}"
        case .textStrikethrough16: return "\u{faa2}"
        case .textTable16: return "\u{faa3}"
        case .textUnderline12: return "\u{faa4}"
        case .textUnderline16: return "\u{faa5}"
        case .tooFast12: return "\u{faa6}"
        case .tooFast16: return "\u{faa7}"
        case .tooSlow12: return "\u{faa8}"
        case .tooSlow16: return "\u{faa9}"
        case .tools16: return "\u{faaa}"
        case .tools20: return "\u{faab}"
        case .tools24: return "\u{faac}"
        case .tools32: return "\u{faad}"
        case .touch16: return "\u{faae}"
        case .touch1024: return "\u{faaf}"
        case .transcript16: return "\u{fab0}"
        case .transcript20: return "\u{fab1}"
        case .twitter16: return "\u{fab2}"
        case .twitterCircle24: return "\u{fab3}"
        case .twitterCircle32: return "\u{fab4}"
        case .twitterCircle40: return "\u{fab5}"
        case .ucmCloud10: return "\u{fab6}"
        case .ucmCloud16: return "\u{fab7}"
        case .ucmCloud24: return "\u{fab8}"
        case .ucmCloud32: return "\u{fab9}"
        case .undo12: return "\u{faba}"
        case .undo14: return "\u{fabb}"
        case .undo16: return "\u{fabc}"
        case .undo24: return "\u{fabd}"
        case .unlink20: return "\u{fabe}"
        case .unreadBadge10: return "\u{fabf}"
        case .unreadBadge12: return "\u{fac0}"
        case .unreadBadge16: return "\u{fac1}"
        case .unreadBadge8: return "\u{fac2}"
        case .unsecure12: return "\u{fac3}"
        case .unsecure14: return "\u{fac4}"
        case .unsecure16: return "\u{fac5}"
        case .unsecure24: return "\u{fac6}"
        case .unsecure28: return "\u{fac7}"
        case .upload12: return "\u{fac8}"
        case .upload130: return "\u{fac9}"
        case .upload14: return "\u{faca}"
        case .upload16: return "\u{facb}"
        case .upload18: return "\u{facc}"
        case .upload20: return "\u{facd}"
        case .upload24: return "\u{face}"
        case .upload28: return "\u{facf}"
        case .upload32: return "\u{fad0}"
        case .upload36: return "\u{fad1}"
        case .usb16: return "\u{fad2}"
        case .user16: return "\u{fad3}"
        case .user20: return "\u{fad4}"
        case .user24: return "\u{fad5}"
        case .user56: return "\u{fad6}"
        case .videoEffect12: return "\u{fad7}"
        case .videoLayout12: return "\u{fad8}"
        case .videoLayout16: return "\u{fad9}"
        case .videoLayoutAuto12: return "\u{fada}"
        case .videoLayoutAuto16: return "\u{fadb}"
        case .videoLayoutAuto20: return "\u{fadc}"
        case .videoLayoutAuto24: return "\u{fadd}"
        case .videoLayoutEqual12: return "\u{fade}"
        case .videoLayoutEqual14: return "\u{fadf}"
        case .videoLayoutEqual16: return "\u{fae0}"
        case .videoLayoutEqual20: return "\u{fae1}"
        case .videoLayoutEqual24: return "\u{fae2}"
        case .videoLayoutOverlay12: return "\u{fae3}"
        case .videoLayoutOverlay16: return "\u{fae4}"
        case .videoLayoutOverlay20: return "\u{fae5}"
        case .videoLayoutOverlay24: return "\u{fae6}"
        case .videoLayoutProminent12: return "\u{fae7}"
        case .videoLayoutProminent16: return "\u{fae8}"
        case .videoLayoutProminent20: return "\u{fae9}"
        case .videoLayoutProminent24: return "\u{faea}"
        case .videoLayoutShareDominant12: return "\u{faeb}"
        case .videoLayoutShareDominant16: return "\u{faec}"
        case .videoLayoutShareDominant20: return "\u{faed}"
        case .videoLayoutShareDominant24: return "\u{faee}"
        case .videoLayoutSingle16: return "\u{faef}"
        case .videoLayoutSingle20: return "\u{faf0}"
        case .videoLayoutVideoDominant12: return "\u{faf1}"
        case .videoLayoutVideoDominant16: return "\u{faf2}"
        case .videoLayoutVideoDominant20: return "\u{faf3}"
        case .videoLayoutVideoDominant24: return "\u{faf4}"
        case .viewAll12: return "\u{faf5}"
        case .viewAll14: return "\u{faf6}"
        case .viewFeedMultiple16: return "\u{faf7}"
        case .viewFeedPanel16: return "\u{faf8}"
        case .viewFeedSingle16: return "\u{faf9}"
        case .viewList10: return "\u{fafa}"
        case .viewList12: return "\u{fafb}"
        case .viewList14: return "\u{fafc}"
        case .viewList16: return "\u{fafd}"
        case .viewList20: return "\u{fafe}"
        case .viewList24: return "\u{faff}"
        case .viewList28: return "\u{fb00}"
        case .viewListCircle100: return "\u{fb01}"
        case .viewMixed12: return "\u{fb02}"
        case .viewStack12: return "\u{fb03}"
        case .viewStack14: return "\u{fb04}"
        case .viewStack20: return "\u{fb05}"
        case .viewStack24: return "\u{fb06}"
        case .viewThumbnail12: return "\u{fb07}"
        case .viewThumbnail14: return "\u{fb08}"
        case .viewThumbnail16: return "\u{fb09}"
        case .viewThumbnail20: return "\u{fb0a}"
        case .viewThumbnail24: return "\u{fb0b}"
        case .voice20: return "\u{fb0c}"
        case .voicemail10: return "\u{fb0d}"
        case .voicemail14: return "\u{fb0e}"
        case .voicemail16: return "\u{fb0f}"
        case .voicemail18: return "\u{fb10}"
        case .voicemail20: return "\u{fb11}"
        case .voicemail24: return "\u{fb12}"
        case .voicemail28: return "\u{fb13}"
        case .voicemail8: return "\u{fb14}"
        case .voicemailActive12: return "\u{fb15}"
        case .voicemailActive14: return "\u{fb16}"
        case .voicemailActive16: return "\u{fb17}"
        case .voicemailActive18: return "\u{fb18}"
        case .voicemailActive20: return "\u{fb19}"
        case .voicemailActive24: return "\u{fb1a}"
        case .voicemailActive28: return "\u{fb1b}"
        case .wallpaper16: return "\u{fb1c}"
        case .wallpaper20: return "\u{fb1d}"
        case .wallpaper24: return "\u{fb1e}"
        case .wallpaper28: return "\u{fb1f}"
        case .wallpaper32: return "\u{fb20}"
        case .warning100: return "\u{fb21}"
        case .warning12: return "\u{fb22}"
        case .warning14: return "\u{fb23}"
        case .warning16: return "\u{fb24}"
        case .warning20: return "\u{fb25}"
        case .warning24: return "\u{fb26}"
        case .warning28: return "\u{fb27}"
        case .warning32: return "\u{fb28}"
        case .warning40: return "\u{fb29}"
        case .warning44: return "\u{fb2a}"
        case .warning56: return "\u{fb2b}"
        case .warning64: return "\u{fb2c}"
        case .warning72: return "\u{fb2d}"
        case .waveform20: return "\u{fb2e}"
        case .webSharing16: return "\u{fb2f}"
        case .webSharing24: return "\u{fb30}"
        case .webex10: return "\u{fb31}"
        case .webex16: return "\u{fb32}"
        case .webex24: return "\u{fb33}"
        case .webex48: return "\u{fb34}"
        case .webexBoard12: return "\u{fb35}"
        case .webexBoard14: return "\u{fb36}"
        case .webexBoard16: return "\u{fb37}"
        case .webexBoard20: return "\u{fb38}"
        case .webexBoard24: return "\u{fb39}"
        case .webexBoard28: return "\u{fb3a}"
        case .webexBoard32: return "\u{fb3b}"
        case .webexBoard48: return "\u{fb3c}"
        case .webexCalling10: return "\u{fb3d}"
        case .webexCalling12: return "\u{fb3e}"
        case .webexCalling16: return "\u{fb3f}"
        case .webexCalling18: return "\u{fb40}"
        case .webexCalling20: return "\u{fb41}"
        case .webexCalling24: return "\u{fb42}"
        case .webexCodecPlus16: return "\u{fb43}"
        case .webexCodecPlus20: return "\u{fb44}"
        case .webexInstantMeeting12: return "\u{fb45}"
        case .webexInstantMeeting14: return "\u{fb46}"
        case .webexInstantMeeting16: return "\u{fb47}"
        case .webexInstantMeeting20: return "\u{fb48}"
        case .webexInstantMeeting24: return "\u{fb49}"
        case .webexMeetings10: return "\u{fb4a}"
        case .webexMeetings12: return "\u{fb4b}"
        case .webexMeetings14: return "\u{fb4c}"
        case .webexMeetings16: return "\u{fb4d}"
        case .webexMeetings20: return "\u{fb4e}"
        case .webexMeetings24: return "\u{fb4f}"
        case .webexMeetings48: return "\u{fb50}"
        case .webexQuadCamera16: return "\u{fb51}"
        case .webexQuadCamera20: return "\u{fb52}"
        case .webexRoomKit16: return "\u{fb53}"
        case .webexRoomKit20: return "\u{fb54}"
        case .webexRoomKitPlus16: return "\u{fb55}"
        case .webexRoomKitPlus20: return "\u{fb56}"
        case .webexShare12: return "\u{fb57}"
        case .webexShare14: return "\u{fb58}"
        case .webexShare16: return "\u{fb59}"
        case .webexShare20: return "\u{fb5a}"
        case .webexTeams10: return "\u{fb5b}"
        case .webexTeams12: return "\u{fb5c}"
        case .webexTeams14: return "\u{fb5d}"
        case .webexTeams16: return "\u{fb5e}"
        case .webexTeams18: return "\u{fb5f}"
        case .webexTeams20: return "\u{fb60}"
        case .webexVoice16: return "\u{fb61}"
        case .webexVoice20: return "\u{fb62}"
        case .webpop12: return "\u{fb63}"
        case .webpop16: return "\u{fb64}"
        case .webpop20: return "\u{fb65}"
        case .webpop24: return "\u{fb66}"
        case .whiteboard10: return "\u{fb67}"
        case .whiteboard12: return "\u{fb68}"
        case .whiteboard14: return "\u{fb69}"
        case .whiteboard16: return "\u{fb6a}"
        case .whiteboard20: return "\u{fb6b}"
        case .whiteboard24: return "\u{fb6c}"
        case .whiteboard26: return "\u{fb6d}"
        case .whiteboard28: return "\u{fb6e}"
        case .whiteboard32: return "\u{fb6f}"
        case .whiteboard36: return "\u{fb70}"
        case .whiteboard8: return "\u{fb71}"
        case .whiteboardContent16: return "\u{fb72}"
        case .whiteboardContent24: return "\u{fb73}"
        case .widgetsAdr20: return "\u{fb74}"
        case .wifi12: return "\u{fb75}"
        case .wifi16: return "\u{fb76}"
        case .wifi20: return "\u{fb77}"
        case .wifi24: return "\u{fb78}"
        case .wifiError12: return "\u{fb79}"
        case .wifiError16: return "\u{fb7a}"
        case .wikipedia16: return "\u{fb7b}"
        case .windowCornerScrub16: return "\u{fb7c}"
        case .windowVerticalScrub16: return "\u{fb7d}"
        case .youtubeCircle24: return "\u{fb7e}"
        case .youtubeCircle32: return "\u{fb7f}"
        case .youtubeCircle40: return "\u{fb80}"
        case .zoomIn12: return "\u{fb81}"
        case .zoomIn14: return "\u{fb82}"
        case .zoomIn16: return "\u{fb83}"
        case .zoomIn20: return "\u{fb84}"
        case .zoomOut12: return "\u{fb85}"
        case .zoomOut14: return "\u{fb86}"
        case .zoomOut16: return "\u{fb87}"
        case .zoomOut20: return "\u{fb88}"
