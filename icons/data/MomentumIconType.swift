...
@objc public enum MomentumIconType: Int {
    ...
    public var ligature: String {
        ...
        case .twitter12: return "\u{fb62}"
        case .twitter16: return "\u{fb63}"
        case .twitterCircle24: return "\u{fb64}"
        case .twitterCircle32: return "\u{fb65}"
        case .twitterCircle40: return "\u{fb66}"
        case .ucmCloud10: return "\u{fb67}"
        case .ucmCloud16: return "\u{fb68}"
        case .ucmCloud24: return "\u{fb69}"
        case .ucmCloud32: return "\u{fb6a}"
        case .undo12: return "\u{fb6b}"
        case .undo14: return "\u{fb6c}"
        case .undo16: return "\u{fb6d}"
        case .undo24: return "\u{fb6e}"
        case .unlink20: return "\u{fb6f}"
        case .unreadBadge10: return "\u{fb70}"
        case .unreadBadge12: return "\u{fb71}"
        case .unreadBadge16: return "\u{fb72}"
        case .unreadBadge8: return "\u{fb73}"
        case .unsecure12: return "\u{fb74}"
        case .unsecure14: return "\u{fb75}"
        case .unsecure16: return "\u{fb76}"
        case .unsecure24: return "\u{fb77}"
        case .unsecure28: return "\u{fb78}"
        case .upload12: return "\u{fb79}"
        case .upload130: return "\u{fb7a}"
        case .upload14: return "\u{fb7b}"
        case .upload16: return "\u{fb7c}"
        case .upload18: return "\u{fb7d}"
        case .upload20: return "\u{fb7e}"
        case .upload24: return "\u{fb7f}"
        case .upload28: return "\u{fb80}"
        case .upload32: return "\u{fb81}"
        case .upload36: return "\u{fb82}"
        case .usb16: return "\u{fb83}"
        case .user16: return "\u{fb84}"
        case .user20: return "\u{fb85}"
        case .user24: return "\u{fb86}"
        case .user56: return "\u{fb87}"
        case .videoEffect12: return "\u{fb88}"
        case .videoEffect16: return "\u{fb89}"
        case .videoLayout12: return "\u{fb8a}"
        case .videoLayout16: return "\u{fb8b}"
        case .videoLayoutAuto12: return "\u{fb8c}"
        case .videoLayoutAuto16: return "\u{fb8d}"
        case .videoLayoutAuto20: return "\u{fb8e}"
        case .videoLayoutAuto24: return "\u{fb8f}"
        case .videoLayoutEqual12: return "\u{fb90}"
        case .videoLayoutEqual14: return "\u{fb91}"
        case .videoLayoutEqual16: return "\u{fb92}"
        case .videoLayoutEqual20: return "\u{fb93}"
        case .videoLayoutEqual24: return "\u{fb94}"
        case .videoLayoutOverlay12: return "\u{fb95}"
        case .videoLayoutOverlay16: return "\u{fb96}"
        case .videoLayoutOverlay20: return "\u{fb97}"
        case .videoLayoutOverlay24: return "\u{fb98}"
        case .videoLayoutProminent12: return "\u{fb99}"
        case .videoLayoutProminent16: return "\u{fb9a}"
        case .videoLayoutProminent20: return "\u{fb9b}"
        case .videoLayoutProminent24: return "\u{fb9c}"
        case .videoLayoutShareDominant12: return "\u{fb9d}"
        case .videoLayoutShareDominant16: return "\u{fb9e}"
        case .videoLayoutShareDominant20: return "\u{fb9f}"
        case .videoLayoutShareDominant24: return "\u{fba0}"
        case .videoLayoutSingle12: return "\u{fba1}"
        case .videoLayoutSingle16: return "\u{fba2}"
        case .videoLayoutSingle20: return "\u{fba3}"
        case .videoLayoutVideoDominant12: return "\u{fba4}"
        case .videoLayoutVideoDominant16: return "\u{fba5}"
        case .videoLayoutVideoDominant20: return "\u{fba6}"
        case .videoLayoutVideoDominant24: return "\u{fba7}"
        case .viewAll12: return "\u{fba8}"
        case .viewAll14: return "\u{fba9}"
        case .viewFeedMultiple16: return "\u{fbaa}"
        case .viewFeedPanel16: return "\u{fbab}"
        case .viewFeedSingle16: return "\u{fbac}"
        case .viewList10: return "\u{fbad}"
        case .viewList12: return "\u{fbae}"
        case .viewList14: return "\u{fbaf}"
        case .viewList16: return "\u{fbb0}"
        case .viewList20: return "\u{fbb1}"
        case .viewList24: return "\u{fbb2}"
        case .viewList28: return "\u{fbb3}"
        case .viewListCircle100: return "\u{fbb4}"
        case .viewMixed12: return "\u{fbb5}"
        case .viewStack12: return "\u{fbb6}"
        case .viewStack14: return "\u{fbb7}"
        case .viewStack20: return "\u{fbb8}"
        case .viewStack24: return "\u{fbb9}"
        case .viewThumbnail12: return "\u{fbba}"
        case .viewThumbnail14: return "\u{fbbb}"
        case .viewThumbnail16: return "\u{fbbc}"
        case .viewThumbnail20: return "\u{fbbd}"
        case .viewThumbnail24: return "\u{fbbe}"
        case .voice20: return "\u{fbbf}"
        case .voicemail10: return "\u{fbc0}"
        case .voicemail14: return "\u{fbc1}"
        case .voicemail16: return "\u{fbc2}"
        case .voicemail18: return "\u{fbc3}"
        case .voicemail20: return "\u{fbc4}"
        case .voicemail22: return "\u{fbc5}"
        case .voicemail24: return "\u{fbc6}"
        case .voicemail28: return "\u{fbc7}"
        case .voicemail8: return "\u{fbc8}"
        case .voicemailActive12: return "\u{fbc9}"
        case .voicemailActive14: return "\u{fbca}"
        case .voicemailActive16: return "\u{fbcb}"
        case .voicemailActive18: return "\u{fbcc}"
        case .voicemailActive20: return "\u{fbcd}"
        case .voicemailActive22: return "\u{fbce}"
        case .voicemailActive24: return "\u{fbcf}"
        case .voicemailActive28: return "\u{fbd0}"
        case .wallpaper16: return "\u{fbd1}"
        case .wallpaper20: return "\u{fbd2}"
        case .wallpaper24: return "\u{fbd3}"
        case .wallpaper28: return "\u{fbd4}"
        case .wallpaper32: return "\u{fbd5}"
        case .warning100: return "\u{fbd6}"
        case .warning12: return "\u{fbd7}"
        case .warning14: return "\u{fbd8}"
        case .warning16: return "\u{fbd9}"
        case .warning20: return "\u{fbda}"
        case .warning24: return "\u{fbdb}"
        case .warning28: return "\u{fbdc}"
        case .warning32: return "\u{fbdd}"
        case .warning40: return "\u{fbde}"
        case .warning44: return "\u{fbdf}"
        case .warning56: return "\u{fbe0}"
        case .warning64: return "\u{fbe1}"
        case .warning72: return "\u{fbe2}"
        case .waveform20: return "\u{fbe3}"
        case .webSharing16: return "\u{fbe4}"
        case .webSharing24: return "\u{fbe5}"
        case .webex10: return "\u{fbe6}"
        case .webex16: return "\u{fbe7}"
        case .webex24: return "\u{fbe8}"
        case .webex48: return "\u{fbe9}"
        case .webexBoard12: return "\u{fbea}"
        case .webexBoard14: return "\u{fbeb}"
        case .webexBoard16: return "\u{fbec}"
        case .webexBoard20: return "\u{fbed}"
        case .webexBoard24: return "\u{fbee}"
        case .webexBoard28: return "\u{fbef}"
        case .webexBoard32: return "\u{fbf0}"
        case .webexBoard48: return "\u{fbf1}"
        case .webexCalling10: return "\u{fbf2}"
        case .webexCalling12: return "\u{fbf3}"
        case .webexCalling16: return "\u{fbf4}"
        case .webexCalling18: return "\u{fbf5}"
        case .webexCalling20: return "\u{fbf6}"
        case .webexCalling24: return "\u{fbf7}"
        case .webexCodecPlus16: return "\u{fbf8}"
        case .webexCodecPlus20: return "\u{fbf9}"
        case .webexCommunity20: return "\u{fbfa}"
        case .webexInstantMeeting12: return "\u{fbfb}"
        case .webexInstantMeeting14: return "\u{fbfc}"
        case .webexInstantMeeting16: return "\u{fbfd}"
        case .webexInstantMeeting20: return "\u{fbfe}"
        case .webexInstantMeeting24: return "\u{fbff}"
        case .webexMeetings10: return "\u{fc00}"
        case .webexMeetings12: return "\u{fc01}"
        case .webexMeetings14: return "\u{fc02}"
        case .webexMeetings16: return "\u{fc03}"
        case .webexMeetings20: return "\u{fc04}"
        case .webexMeetings24: return "\u{fc05}"
        case .webexMeetings48: return "\u{fc06}"
        case .webexQuadCamera16: return "\u{fc07}"
        case .webexQuadCamera20: return "\u{fc08}"
        case .webexRoomKit16: return "\u{fc09}"
        case .webexRoomKit20: return "\u{fc0a}"
        case .webexRoomKitPlus16: return "\u{fc0b}"
        case .webexRoomKitPlus20: return "\u{fc0c}"
        case .webexShare12: return "\u{fc0d}"
        case .webexShare14: return "\u{fc0e}"
        case .webexShare16: return "\u{fc0f}"
        case .webexShare20: return "\u{fc10}"
        case .webexTeams10: return "\u{fc11}"
        case .webexTeams12: return "\u{fc12}"
        case .webexTeams14: return "\u{fc13}"
        case .webexTeams16: return "\u{fc14}"
        case .webexTeams18: return "\u{fc15}"
        case .webexTeams20: return "\u{fc16}"
        case .webexVoice16: return "\u{fc17}"
        case .webexVoice20: return "\u{fc18}"
        case .webpop12: return "\u{fc19}"
        case .webpop16: return "\u{fc1a}"
        case .webpop20: return "\u{fc1b}"
        case .webpop24: return "\u{fc1c}"
        case .whatsApp12: return "\u{fc1d}"
        case .whatsApp16: return "\u{fc1e}"
        case .whiteboard10: return "\u{fc1f}"
        case .whiteboard12: return "\u{fc20}"
        case .whiteboard14: return "\u{fc21}"
        case .whiteboard16: return "\u{fc22}"
        case .whiteboard20: return "\u{fc23}"
        case .whiteboard24: return "\u{fc24}"
        case .whiteboard26: return "\u{fc25}"
        case .whiteboard28: return "\u{fc26}"
        case .whiteboard32: return "\u{fc27}"
        case .whiteboard36: return "\u{fc28}"
        case .whiteboard8: return "\u{fc29}"
        case .whiteboardContent16: return "\u{fc2a}"
        case .whiteboardContent24: return "\u{fc2b}"
        case .widgetsAdr20: return "\u{fc2c}"
        case .wifi12: return "\u{fc2d}"
        case .wifi16: return "\u{fc2e}"
        case .wifi20: return "\u{fc2f}"
        case .wifi24: return "\u{fc30}"
        case .wifiError12: return "\u{fc31}"
        case .wifiError16: return "\u{fc32}"
        case .wikipedia16: return "\u{fc33}"
        case .windowCornerScrub16: return "\u{fc34}"
        case .windowVerticalScrub16: return "\u{fc35}"
        case .youtubeCircle24: return "\u{fc36}"
        case .youtubeCircle32: return "\u{fc37}"
        case .youtubeCircle40: return "\u{fc38}"
        case .zoomIn12: return "\u{fc39}"
        case .zoomIn14: return "\u{fc3a}"
        case .zoomIn16: return "\u{fc3b}"
        case .zoomIn20: return "\u{fc3c}"
        case .zoomOut12: return "\u{fc3d}"
        case .zoomOut14: return "\u{fc3e}"
        case .zoomOut16: return "\u{fc3f}"
        case .zoomOut20: return "\u{fc40}"
