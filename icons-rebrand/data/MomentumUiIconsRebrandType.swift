...
@objc public enum MomentumIconsRebrandType: Int {
    ...
    public var ligature: String {
        ...
        case .greenRoomBold: return "\u{f574}"
        case .greenRoomFilled: return "\u{f575}"
        case .greenRoomLight: return "\u{f576}"
        case .greenRoomRegular: return "\u{f577}"
        case .groupBold: return "\u{f578}"
        case .groupLight: return "\u{f579}"
        case .groupPickupBold: return "\u{f57a}"
        case .groupPickupFilled: return "\u{f57b}"
        case .groupPickupLight: return "\u{f57c}"
        case .groupPickupRegular: return "\u{f57d}"
        case .groupRegular: return "\u{f57e}"
        case .guestIssuerBold: return "\u{f57f}"
        case .guestIssuerLight: return "\u{f580}"
        case .guestIssuerRegular: return "\u{f581}"
        case .guideBold: return "\u{f582}"
        case .guideLight: return "\u{f583}"
        case .guideRegular: return "\u{f584}"
        case .handlerBold: return "\u{f585}"
        case .handlerLight: return "\u{f586}"
        case .handlerRegular: return "\u{f587}"
        case .handsetAlertBold: return "\u{f588}"
        case .handsetAlertFilled: return "\u{f589}"
        case .handsetAlertLight: return "\u{f58a}"
        case .handsetAlertRegular: return "\u{f58b}"
        case .handsetBold: return "\u{f58c}"
        case .handsetFilled: return "\u{f58d}"
        case .handsetLight: return "\u{f58e}"
        case .handsetMutedBold: return "\u{f58f}"
        case .handsetMutedFilled: return "\u{f590}"
        case .handsetMutedLight: return "\u{f591}"
        case .handsetMutedRegular: return "\u{f592}"
        case .handsetRegular: return "\u{f593}"
        case .handshakeBold: return "\u{f594}"
        case .handshakeLight: return "\u{f595}"
        case .handshakeRegular: return "\u{f596}"
        case .headingOneBold: return "\u{f597}"
        case .headingOneLight: return "\u{f598}"
        case .headingOneRegular: return "\u{f599}"
        case .headingThreeBold: return "\u{f59a}"
        case .headingThreeLight: return "\u{f59b}"
        case .headingThreeRegular: return "\u{f59c}"
        case .headingTwoBold: return "\u{f59d}"
        case .headingTwoLight: return "\u{f59e}"
        case .headingTwoRegular: return "\u{f59f}"
        case .headphonesBold: return "\u{f5a0}"
        case .headphonesFilled: return "\u{f5a1}"
        case .headphonesLight: return "\u{f5a2}"
        case .headphonesMutedBold: return "\u{f5a3}"
        case .headphonesMutedFilled: return "\u{f5a4}"
        case .headphonesMutedLight: return "\u{f5a5}"
        case .headphonesMutedRegular: return "\u{f5a6}"
        case .headphonesRegular: return "\u{f5a7}"
        case .headsetAlertBold: return "\u{f5a8}"
        case .headsetAlertLight: return "\u{f5a9}"
        case .headsetAlertRegular: return "\u{f5aa}"
        case .headsetBold: return "\u{f5ab}"
        case .headsetFilled: return "\u{f5ac}"
        case .headsetLight: return "\u{f5ad}"
        case .headsetMutedBold: return "\u{f5ae}"
        case .headsetMutedLight: return "\u{f5af}"
        case .headsetMutedRegular: return "\u{f5b0}"
        case .headsetPrivateBold: return "\u{f5b1}"
        case .headsetPrivateLight: return "\u{f5b2}"
        case .headsetPrivateRegular: return "\u{f5b3}"
        case .headsetRegular: return "\u{f5b4}"
        case .hearingImpairedBold: return "\u{f5b5}"
        case .hearingImpairedLight: return "\u{f5b6}"
        case .hearingImpairedRegular: return "\u{f5b7}"
        case .helpBold: return "\u{f5b8}"
        case .helpCircleActiveFilled: return "\u{f5b9}"
        case .helpCircleBold: return "\u{f5ba}"
        case .helpCircleLight: return "\u{f5bb}"
        case .helpCircleRegular: return "\u{f5bc}"
        case .helpLight: return "\u{f5bd}"
        case .helpRegular: return "\u{f5be}"
        case .helpdeskBold: return "\u{f5bf}"
        case .helpdeskLight: return "\u{f5c0}"
        case .helpdeskRegular: return "\u{f5c1}"
        case .hideBold: return "\u{f5c2}"
        case .hideFilled: return "\u{f5c3}"
        case .hideLight: return "\u{f5c4}"
        case .hideRegular: return "\u{f5c5}"
        case .homeBold: return "\u{f5c6}"
        case .homeFilled: return "\u{f5c7}"
        case .homeLight: return "\u{f5c8}"
        case .homeRegular: return "\u{f5c9}"
        case .horizontalLineBold: return "\u{f5ca}"
        case .horizontalLineLight: return "\u{f5cb}"
        case .horizontalLineRegular: return "\u{f5cc}"
        case .hotelingBold: return "\u{f5cd}"
        case .hotelingFilled: return "\u{f5ce}"
        case .hotelingLight: return "\u{f5cf}"
        case .hotelingRegular: return "\u{f5d0}"
        case .humidityBold: return "\u{f5d1}"
        case .humidityLight: return "\u{f5d2}"
        case .humidityRegular: return "\u{f5d3}"
        case .huntGroupBold: return "\u{f5d4}"
        case .huntGroupFilled: return "\u{f5d5}"
        case .huntGroupLight: return "\u{f5d6}"
        case .huntGroupRegular: return "\u{f5d7}"
        case .importBold: return "\u{f5d8}"
        case .importLight: return "\u{f5d9}"
        case .importRegular: return "\u{f5da}"
        case .inCommonBold: return "\u{f5db}"
        case .inCommonLight: return "\u{f5dc}"
        case .inCommonRegular: return "\u{f5dd}"
        case .includeBold: return "\u{f5de}"
        case .includeLight: return "\u{f5df}"
        case .includeRegular: return "\u{f5e0}"
        case .incomingCallLegacyBold: return "\u{f5e1}"
        case .incomingCallLegacyFilled: return "\u{f5e2}"
        case .incomingCallLegacyLight: return "\u{f5e3}"
        case .incomingCallLegacyRegular: return "\u{f5e4}"
        case .infoBadgeFilled: return "\u{f5e5}"
        case .infoCircleBold: return "\u{f5e6}"
        case .infoCircleFilled: return "\u{f5e7}"
        case .infoCircleLight: return "\u{f5e8}"
        case .infoCircleRegular: return "\u{f5e9}"
        case .infoCircleTwoBold: return "\u{f5ea}"
        case .infoCircleTwoFilled: return "\u{f5eb}"
        case .infoCircleTwoLight: return "\u{f5ec}"
        case .infoCircleTwoRegular: return "\u{f5ed}"
        case .inputBold: return "\u{f5ee}"
        case .inputDisconnectedBold: return "\u{f5ef}"
        case .inputDisconnectedLight: return "\u{f5f0}"
        case .inputDisconnectedRegular: return "\u{f5f1}"
        case .inputLight: return "\u{f5f2}"
        case .inputRegular: return "\u{f5f3}"
        case .insightsBold: return "\u{f5f4}"
        case .insightsLight: return "\u{f5f5}"
        case .insightsRegular: return "\u{f5f6}"
        case .instantScheduleBold: return "\u{f5f7}"
        case .instantScheduleFilled: return "\u{f5f8}"
        case .instantScheduleLight: return "\u{f5f9}"
        case .instantScheduleRegular: return "\u{f5fa}"
        case .integrationsBold: return "\u{f5fb}"
        case .integrationsLight: return "\u{f5fc}"
        case .integrationsRegular: return "\u{f5fd}"
        case .intelligentRoutingBold: return "\u{f5fe}"
        case .intelligentRoutingLight: return "\u{f5ff}"
        case .intelligentRoutingRegular: return "\u{f600}"
        case .invitedUserBold: return "\u{f601}"
        case .invitedUserLight: return "\u{f602}"
        case .invitedUserRegular: return "\u{f603}"
        case .italicBold: return "\u{f604}"
        case .italicLight: return "\u{f605}"
        case .italicRegular: return "\u{f606}"
        case .joinAudioBold: return "\u{f607}"
        case .joinAudioFilled: return "\u{f608}"
        case .joinAudioLight: return "\u{f609}"
        case .joinAudioRegular: return "\u{f60a}"
        case .keepInTouchBold: return "\u{f60b}"
        case .keepInTouchFilled: return "\u{f60c}"
        case .keepInTouchLight: return "\u{f60d}"
        case .keepInTouchRegular: return "\u{f60e}"
        case .keyboardBold: return "\u{f60f}"
        case .keyboardCloseBold: return "\u{f610}"
        case .keyboardCloseLight: return "\u{f611}"
        case .keyboardCloseRegular: return "\u{f612}"
        case .keyboardLight: return "\u{f613}"
        case .keyboardRegular: return "\u{f614}"
        case .languageBold: return "\u{f615}"
        case .languageLight: return "\u{f616}"
        case .languageRegular: return "\u{f617}"
        case .laptopBold: return "\u{f618}"
        case .laptopDisconnectedBold: return "\u{f619}"
        case .laptopDisconnectedLight: return "\u{f61a}"
        case .laptopDisconnectedRegular: return "\u{f61b}"
        case .laptopFilled: return "\u{f61c}"
        case .laptopLight: return "\u{f61d}"
        case .laptopRegular: return "\u{f61e}"
        case .laserPointerBold: return "\u{f61f}"
        case .laserPointerLight: return "\u{f620}"
        case .laserPointerRegular: return "\u{f621}"
        case .launchBold: return "\u{f622}"
        case .launchLight: return "\u{f623}"
        case .launchRegular: return "\u{f624}"
        case .layoutSideBySideVerticalBold: return "\u{f625}"
        case .layoutSideBySideVerticalFilled: return "\u{f626}"
        case .layoutSideBySideVerticalLight: return "\u{f627}"
        case .layoutSideBySideVerticalRegular: return "\u{f628}"
        case .leaveBreakoutSessionBold: return "\u{f629}"
        case .leaveBreakoutSessionLight: return "\u{f62a}"
        case .leaveBreakoutSessionRegular: return "\u{f62b}"
        case .leaveDeviceBold: return "\u{f62c}"
        case .leaveDeviceLight: return "\u{f62d}"
        case .leaveDeviceRegular: return "\u{f62e}"
        case .lightningBold: return "\u{f62f}"
        case .lightningFilled: return "\u{f630}"
        case .lightningLight: return "\u{f631}"
        case .lightningRegular: return "\u{f632}"
        case .likeBold: return "\u{f633}"
        case .likeFilled: return "\u{f634}"
        case .likeLight: return "\u{f635}"
        case .likeRegular: return "\u{f636}"
        case .linkBold: return "\u{f637}"
        case .linkLight: return "\u{f638}"
        case .linkRegular: return "\u{f639}"
        case .listBulletedBold: return "\u{f63a}"
        case .listBulletedLight: return "\u{f63b}"
        case .listBulletedRegular: return "\u{f63c}"
        case .listMenuBold: return "\u{f63d}"
        case .listMenuLight: return "\u{f63e}"
        case .listMenuRegular: return "\u{f63f}"
        case .listNumberedBold: return "\u{f640}"
        case .listNumberedLight: return "\u{f641}"
        case .listNumberedRegular: return "\u{f642}"
        case .liveBold: return "\u{f643}"
        case .liveFilled: return "\u{f644}"
        case .liveLight: return "\u{f645}"
        case .liveRegular: return "\u{f646}"
        case .locationBold: return "\u{f647}"
        case .locationFilled: return "\u{f648}"
        case .locationLight: return "\u{f649}"
        case .locationRegular: return "\u{f64a}"
        case .longTextBoxBold: return "\u{f64b}"
        case .longTextBoxLight: return "\u{f64c}"
        case .longTextBoxRegular: return "\u{f64d}"
        case .lowerHandBold: return "\u{f64e}"
        case .lowerHandLight: return "\u{f64f}"
        case .lowerHandRegular: return "\u{f650}"
        case .magicPenBold: return "\u{f651}"
        case .magicPenFilled: return "\u{f652}"
        case .magicPenLight: return "\u{f653}"
        case .magicPenRegular: return "\u{f654}"
        case .markAsUnreadBold: return "\u{f655}"
        case .markAsUnreadLight: return "\u{f656}"
        case .markAsUnreadRegular: return "\u{f657}"
        case .markdownBold: return "\u{f658}"
        case .markdownLight: return "\u{f659}"
        case .markdownRegular: return "\u{f65a}"
        case .markerBold: return "\u{f65b}"
        case .markerFilled: return "\u{f65c}"
        case .markerLight: return "\u{f65d}"
        case .markerRegular: return "\u{f65e}"
        case .maximizeBold: return "\u{f65f}"
        case .maximizeLight: return "\u{f660}"
        case .maximizeRegular: return "\u{f661}"
        case .mediaPlayerBold: return "\u{f662}"
        case .mediaPlayerLight: return "\u{f663}"
        case .mediaPlayerRegular: return "\u{f664}"
        case .mediaQualityGoodBold: return "\u{f665}"
        case .mediaQualityGoodFilled: return "\u{f666}"
        case .mediaQualityGoodLight: return "\u{f667}"
        case .mediaQualityGoodRegular: return "\u{f668}"
        case .mediaQualityPoorBold: return "\u{f669}"
        case .mediaQualityPoorFilled: return "\u{f66a}"
        case .mediaQualityPoorLight: return "\u{f66b}"
        case .mediaQualityPoorRegular: return "\u{f66c}"
        case .mediaQualityUnstableBold: return "\u{f66d}"
        case .mediaQualityUnstableFilled: return "\u{f66e}"
        case .mediaQualityUnstableLight: return "\u{f66f}"
        case .mediaQualityUnstableRegular: return "\u{f670}"
        case .mediumQualityGoodFilled: return "\u{f671}"
        case .mediumQualityPoorFilled: return "\u{f672}"
        case .mediumQualityUnstableFilled: return "\u{f673}"
        case .meetBold: return "\u{f674}"
        case .meetEndBold: return "\u{f675}"
        case .meetEndLight: return "\u{f676}"
        case .meetEndRegular: return "\u{f677}"
        case .meetFilled: return "\u{f678}"
        case .meetLight: return "\u{f679}"
        case .meetRegular: return "\u{f67a}"
        case .meetingsBold: return "\u{f67b}"
        case .meetingsFilled: return "\u{f67c}"
        case .meetingsFocusMonthBold: return "\u{f67d}"
        case .meetingsFocusMonthLight: return "\u{f67e}"
        case .meetingsFocusMonthRegular: return "\u{f67f}"
        case .meetingsFocusOneDayBold: return "\u{f680}"
        case .meetingsFocusOneDayLight: return "\u{f681}"
        case .meetingsFocusOneDayRegular: return "\u{f682}"
        case .meetingsFocusThreeDayBold: return "\u{f683}"
        case .meetingsFocusThreeDayLight: return "\u{f684}"
        case .meetingsFocusThreeDayRegular: return "\u{f685}"
        case .meetingsFocusUpcomingBold: return "\u{f686}"
        case .meetingsFocusUpcomingLight: return "\u{f687}"
        case .meetingsFocusUpcomingRegular: return "\u{f688}"
        case .meetingsFocusWeekBold: return "\u{f689}"
        case .meetingsFocusWeekLight: return "\u{f68a}"
        case .meetingsFocusWeekRegular: return "\u{f68b}"
        case .meetingsLight: return "\u{f68c}"
        case .meetingsPresenceBold: return "\u{f68d}"
        case .meetingsPresenceFilled: return "\u{f68e}"
        case .meetingsPresenceLight: return "\u{f68f}"
        case .meetingsPresenceRegular: return "\u{f690}"
        case .meetingsPresenceSmallFilled: return "\u{f691}"
        case .meetingsRegular: return "\u{f692}"
        case .meetingsTeamActiveBold: return "\u{f693}"
        case .meetingsTeamActiveLight: return "\u{f694}"
        case .meetingsTeamActiveRegular: return "\u{f695}"
        case .meetingsTeamBold: return "\u{f696}"
        case .meetingsTeamLight: return "\u{f697}"
        case .meetingsTeamNewBold: return "\u{f698}"
        case .meetingsTeamNewLight: return "\u{f699}"
        case .meetingsTeamNewRegular: return "\u{f69a}"
        case .meetingsTeamRegular: return "\u{f69b}"
        case .mentionBold: return "\u{f69c}"
        case .mentionLight: return "\u{f69d}"
        case .mentionRegular: return "\u{f69e}"
        case .messageQueingBold: return "\u{f69f}"
        case .messageQueingLight: return "\u{f6a0}"
        case .messageQueingRegular: return "\u{f6a1}"
        case .microphoneBold: return "\u{f6a2}"
        case .microphoneFilled: return "\u{f6a3}"
        case .microphoneHardMutedBold: return "\u{f6a4}"
        case .microphoneHardMutedCircleFilled: return "\u{f6a5}"
        case .microphoneHardMutedColoredBold: return "\u{f6a6}"
        case .microphoneHardMutedColoredLight: return "\u{f6a7}"
        case .microphoneHardMutedColoredRegular: return "\u{f6a8}"
        case .microphoneHardMutedLight: return "\u{f6a9}"
        case .microphoneHardMutedRegular: return "\u{f6aa}"
        case .microphoneLight: return "\u{f6ab}"
        case .microphoneMusicModeBold: return "\u{f6ac}"
        case .microphoneMusicModeColoredBold: return "\u{f6ad}"
        case .microphoneMusicModeColoredLight: return "\u{f6ae}"
        case .microphoneMusicModeColoredRegular: return "\u{f6af}"
        case .microphoneMusicModeLight: return "\u{f6b0}"
        case .microphoneMusicModeRegular: return "\u{f6b1}"
        case .microphoneMutedBold: return "\u{f6b2}"
        case .microphoneMutedFilled: return "\u{f6b3}"
        case .microphoneMutedIndicatorFilled: return "\u{f6b4}"
        case .microphoneMutedLight: return "\u{f6b5}"
        case .microphoneMutedRedBold: return "\u{f6b6}"
        case .microphoneMutedRedFilled: return "\u{f6b7}"
        case .microphoneMutedRedLight: return "\u{f6b8}"
        case .microphoneMutedRedRegular: return "\u{f6b9}"
        case .microphoneMutedRegular: return "\u{f6ba}"
        case .microphoneOptAllBold: return "\u{f6bb}"
        case .microphoneOptAllLight: return "\u{f6bc}"
        case .microphoneOptAllRegular: return "\u{f6bd}"
        case .microphoneOptMeBold: return "\u{f6be}"
        case .microphoneOptMeLight: return "\u{f6bf}"
        case .microphoneOptMeRegular: return "\u{f6c0}"
        case .microphoneRegular: return "\u{f6c1}"
        case .minimizeBold: return "\u{f6c2}"
        case .minimizeLight: return "\u{f6c3}"
        case .minimizeRegular: return "\u{f6c4}"
        case .minusBold: return "\u{f6c5}"
        case .minusLight: return "\u{f6c6}"
        case .minusRegular: return "\u{f6c7}"
        case .mirrorBold: return "\u{f6c8}"
        case .mirrorFilled: return "\u{f6c9}"
        case .mirrorLight: return "\u{f6ca}"
        case .mirrorRegular: return "\u{f6cb}"
        case .moderatorBold: return "\u{f6cc}"
        case .moderatorLight: return "\u{f6cd}"
        case .moderatorRegular: return "\u{f6ce}"
        case .monitoringBold: return "\u{f6cf}"
        case .monitoringLight: return "\u{f6d0}"
        case .monitoringRegular: return "\u{f6d1}"
        case .monthlyRecurringScheduleNodeBold: return "\u{f6d2}"
        case .monthlyRecurringScheduleNodeLight: return "\u{f6d3}"
        case .monthlyRecurringScheduleNodeRegular: return "\u{f6d4}"
        case .moreAdrBold: return "\u{f6d5}"
        case .moreAdrLight: return "\u{f6d6}"
        case .moreAdrRegular: return "\u{f6d7}"
        case .moreBold: return "\u{f6d8}"
        case .moreCircleBold: return "\u{f6d9}"
        case .moreCircleFilled: return "\u{f6da}"
        case .moreCircleLight: return "\u{f6db}"
        case .moreCircleRegular: return "\u{f6dc}"
        case .moreCirecleFilled: return "\u{f6dd}"
        case .moreLight: return "\u{f6de}"
        case .moreRegular: return "\u{f6df}"
        case .mouseCursorBold: return "\u{f6e0}"
        case .mouseCursorLight: return "\u{f6e1}"
        case .mouseCursorRegular: return "\u{f6e2}"
        case .moveCallInAdrBold: return "\u{f6e3}"
        case .moveCallInAdrLight: return "\u{f6e4}"
        case .moveCallInAdrRegular: return "\u{f6e5}"
        case .moveCallInIphBold: return "\u{f6e6}"
        case .moveCallInIphLight: return "\u{f6e7}"
        case .moveCallInIphRegular: return "\u{f6e8}"
        case .moveCallInLaptopBold: return "\u{f6e9}"
        case .moveCallInLaptopLight: return "\u{f6ea}"
        case .moveCallInLaptopRegular: return "\u{f6eb}"
        case .moveCallInOutAdrBold: return "\u{f6ec}"
        case .moveCallInOutAdrLight: return "\u{f6ed}"
        case .moveCallInOutAdrRegular: return "\u{f6ee}"
        case .moveCallInOutIphBold: return "\u{f6ef}"
        case .moveCallInOutIphLight: return "\u{f6f0}"
        case .moveCallInOutIphRegular: return "\u{f6f1}"
        case .moveCallInTabletBold: return "\u{f6f2}"
        case .moveCallInTabletLight: return "\u{f6f3}"
        case .moveCallInTabletRegular: return "\u{f6f4}"
        case .moveCallOutAdrBold: return "\u{f6f5}"
        case .moveCallOutAdrLight: return "\u{f6f6}"
        case .moveCallOutAdrRegular: return "\u{f6f7}"
        case .moveCallOutIphBold: return "\u{f6f8}"
        case .moveCallOutIphLight: return "\u{f6f9}"
        case .moveCallOutIphRegular: return "\u{f6fa}"
        case .moveCallOutLaptopBold: return "\u{f6fb}"
        case .moveCallOutLaptopLight: return "\u{f6fc}"
        case .moveCallOutLaptopRegular: return "\u{f6fd}"
        case .moveCallOutTabletBold: return "\u{f6fe}"
        case .moveCallOutTabletLight: return "\u{f6ff}"
        case .moveCallOutTabletRegular: return "\u{f700}"
        case .msTeams: return "\u{f701}"
        case .multilineChartBold: return "\u{f702}"
        case .multilineChartFilled: return "\u{f703}"
        case .multilineChartLight: return "\u{f704}"
        case .multilineChartRegular: return "\u{f705}"
        case .multimediaBold: return "\u{f706}"
        case .multimediaFilled: return "\u{f707}"
        case .multimediaLight: return "\u{f708}"
        case .multimediaRegular: return "\u{f709}"
        case .multipledDevicesBold: return "\u{f70a}"
        case .multipledDevicesLight: return "\u{f70b}"
        case .multipledDevicesRegular: return "\u{f70c}"
        case .musicModeBold: return "\u{f70d}"
        case .musicModeCircleBold: return "\u{f70e}"
        case .musicModeCircleFilled: return "\u{f70f}"
        case .musicModeCircleLight: return "\u{f710}"
        case .musicModeCircleRegular: return "\u{f711}"
        case .musicModeFilled: return "\u{f712}"
        case .musicModeLight: return "\u{f713}"
        case .musicModeRegular: return "\u{f714}"
        case .muteOnEntryBold: return "\u{f715}"
        case .muteOnEntryFilled: return "\u{f716}"
        case .muteOnEntryLight: return "\u{f717}"
        case .muteOnEntryRegular: return "\u{f718}"
        case .newManagerBold: return "\u{f719}"
        case .newManagerLight: return "\u{f71a}"
        case .newManagerRegular: return "\u{f71b}"
        case .newTitleBold: return "\u{f71c}"
        case .newTitleLight: return "\u{f71d}"
        case .newTitleRegular: return "\u{f71e}"
        case .newVoicemailBold: return "\u{f71f}"
        case .newVoicemailLight: return "\u{f720}"
        case .newVoicemailRegular: return "\u{f721}"
        case .newWhiteboardBold: return "\u{f722}"
        case .newWhiteboardLight: return "\u{f723}"
        case .newWhiteboardRegular: return "\u{f724}"
        case .nextBold: return "\u{f725}"
        case .nextLight: return "\u{f726}"
        case .nextRegular: return "\u{f727}"
        case .noDevicesBold: return "\u{f728}"
        case .noDevicesLight: return "\u{f729}"
        case .noDevicesRegular: return "\u{f72a}"
        case .noiseDetectedCanceledFilled: return "\u{f72b}"
        case .noiseDetectedFilled: return "\u{f72c}"
        case .noiseNoneCanceledFilled: return "\u{f72d}"
        case .noiseNoneFilled: return "\u{f72e}"
        case .noiseRemovalBold: return "\u{f72f}"
        case .noiseRemovalLight: return "\u{f730}"
        case .noiseRemovalRegular: return "\u{f731}"
        case .noteBold: return "\u{f732}"
        case .noteLight: return "\u{f733}"
        case .notePptBold: return "\u{f734}"
        case .notePptLight: return "\u{f735}"
        case .notePptRegular: return "\u{f736}"
        case .noteRegular: return "\u{f737}"
        case .notesBold: return "\u{f738}"
        case .notesLight: return "\u{f739}"
        case .notesRegular: return "\u{f73a}"
        case .numberBold: return "\u{f73b}"
        case .numberLight: return "\u{f73c}"
        case .numberRegular: return "\u{f73d}"
        case .oldRemoteBold: return "\u{f73e}"
        case .oldRemoteLight: return "\u{f73f}"
        case .oldRemoteRegular: return "\u{f740}"
        case .oldTouchBold: return "\u{f741}"
        case .oldTouchLight: return "\u{f742}"
        case .oldTouchRegular: return "\u{f743}"
        case .oneColumnBold: return "\u{f744}"
        case .oneColumnLight: return "\u{f745}"
        case .oneColumnRegular: return "\u{f746}"
        case .openInFolderBold: return "\u{f747}"
        case .openInFolderLight: return "\u{f748}"
        case .openInFolderRegular: return "\u{f749}"
        case .openPagesBold: return "\u{f74a}"
        case .openPagesLight: return "\u{f74b}"
        case .openPagesRegular: return "\u{f74c}"
        case .otherNumberBold: return "\u{f74d}"
        case .otherNumberLight: return "\u{f74e}"
        case .otherNumberRegular: return "\u{f74f}"
        case .otherNumberWarningBold: return "\u{f750}"
        case .otherNumberWarningLight: return "\u{f751}"
        case .otherNumberWarningRegular: return "\u{f752}"
        case .outgoingCallLegacyBold: return "\u{f753}"
        case .outgoingCallLegacyLight: return "\u{f754}"
        case .outgoingCallLegacyRegular: return "\u{f755}"
        case .overflowLeftBold: return "\u{f756}"
        case .overflowLeftLight: return "\u{f757}"
        case .overflowLeftRegular: return "\u{f758}"
        case .overflowRightBold: return "\u{f759}"
        case .overflowRightLight: return "\u{f75a}"
        case .overflowRightRegular: return "\u{f75b}"
        case .pairedCameraBold: return "\u{f75c}"
        case .pairedCameraLight: return "\u{f75d}"
        case .pairedCameraRegular: return "\u{f75e}"
        case .pairedDeviceBold: return "\u{f75f}"
        case .pairedDeviceLight: return "\u{f760}"
        case .pairedDeviceRegular: return "\u{f761}"
        case .pairedHandsetBold: return "\u{f762}"
        case .pairedHandsetLight: return "\u{f763}"
        case .pairedHandsetRegular: return "\u{f764}"
        case .pairingBold: return "\u{f765}"
        case .pairingLight: return "\u{f766}"
        case .pairingRegular: return "\u{f767}"
        case .parkedBold: return "\u{f768}"
        case .parkedFilled: return "\u{f769}"
        case .parkedLight: return "\u{f76a}"
        case .parkedRegular: return "\u{f76b}"
        case .parseBold: return "\u{f76c}"
        case .parseLight: return "\u{f76d}"
        case .parseRegular: return "\u{f76e}"
        case .partialBold: return "\u{f76f}"
        case .partialLight: return "\u{f770}"
        case .partialRegular: return "\u{f771}"
        case .participantAddBold: return "\u{f772}"
        case .participantAddLight: return "\u{f773}"
        case .participantAddRegular: return "\u{f774}"
        case .participantBlockedBold: return "\u{f775}"
        case .participantBlockedLight: return "\u{f776}"
        case .participantBlockedRegular: return "\u{f777}"
        case .participantBold: return "\u{f778}"
        case .participantFilled: return "\u{f779}"
        case .participantLight: return "\u{f77a}"
        case .participantListBold: return "\u{f77b}"
        case .participantListFilled: return "\u{f77c}"
        case .participantListLight: return "\u{f77d}"
        case .participantListRegular: return "\u{f77e}"
        case .participantRegular: return "\u{f77f}"
        case .participantRemoveBold: return "\u{f780}"
        case .participantRemoveLight: return "\u{f781}"
        case .participantRemoveRegular: return "\u{f782}"
        case .participantUnknownBold: return "\u{f783}"
        case .participantUnknownLight: return "\u{f784}"
        case .participantUnknownRegular: return "\u{f785}"
        case .passMouseBold: return "\u{f786}"
        case .passMouseLight: return "\u{f787}"
        case .passMouseRegular: return "\u{f788}"
        case .pauseBold: return "\u{f789}"
        case .pauseFilled: return "\u{f78a}"
        case .pauseLight: return "\u{f78b}"
        case .pauseRegular: return "\u{f78c}"
        case .penBold: return "\u{f78d}"
        case .penFilled: return "\u{f78e}"
        case .penLight: return "\u{f78f}"
        case .penRegular: return "\u{f790}"
        case .peopleBold: return "\u{f791}"
        case .peopleCircleBold: return "\u{f792}"
        case .peopleCircleFilled: return "\u{f793}"
        case .peopleCircleLight: return "\u{f794}"
        case .peopleCircleRegular: return "\u{f795}"
        case .peopleFilled: return "\u{f796}"
        case .peopleInsightsFilled: return "\u{f797}"
        case .peopleLight: return "\u{f798}"
        case .peopleRegular: return "\u{f799}"
        case .phoneAlertBold: return "\u{f79a}"
        case .phoneAlertLight: return "\u{f79b}"
        case .phoneAlertRegular: return "\u{f79c}"
        case .phoneBold: return "\u{f79d}"
        case .phoneFilled: return "\u{f79e}"
        case .phoneLight: return "\u{f79f}"
        case .phoneMutedBold: return "\u{f7a0}"
        case .phoneMutedLight: return "\u{f7a1}"
        case .phoneMutedRegular: return "\u{f7a2}"
        case .phonePrivateBold: return "\u{f7a3}"
        case .phonePrivateLight: return "\u{f7a4}"
        case .phonePrivateRegular: return "\u{f7a5}"
        case .phoneRegular: return "\u{f7a6}"
        case .phoneReplyAllBold: return "\u{f7a7}"
        case .phoneReplyAllLight: return "\u{f7a8}"
        case .phoneReplyAllRegular: return "\u{f7a9}"
        case .phoneReplyBold: return "\u{f7aa}"
        case .phoneReplyLight: return "\u{f7ab}"
        case .phoneReplyRegular: return "\u{f7ac}"
        case .phoneSmallFilled: return "\u{f7ad}"
        case .pickerBold: return "\u{f7ae}"
        case .pickerLight: return "\u{f7af}"
        case .pickerRegular: return "\u{f7b0}"
        case .pictureInPictureBold: return "\u{f7b1}"
        case .pictureInPictureFilled: return "\u{f7b2}"
        case .pictureInPictureLight: return "\u{f7b3}"
        case .pictureInPictureRegular: return "\u{f7b4}"
        case .pieChartBold: return "\u{f7b5}"
        case .pieChartFilled: return "\u{f7b6}"
        case .pieChartLight: return "\u{f7b7}"
        case .pieChartRegular: return "\u{f7b8}"
        case .pinBold: return "\u{f7b9}"
        case .pinFilled: return "\u{f7ba}"
        case .pinLight: return "\u{f7bb}"
        case .pinListActivityBold: return "\u{f7bc}"
        case .pinListActivityColoredBold: return "\u{f7bd}"
        case .pinListActivityColoredLight: return "\u{f7be}"
        case .pinListActivityColoredRegular: return "\u{f7bf}"
        case .pinListActivityLight: return "\u{f7c0}"
        case .pinListActivityRegular: return "\u{f7c1}"
        case .pinListBold: return "\u{f7c2}"
        case .pinListLight: return "\u{f7c3}"
        case .pinListRegular: return "\u{f7c4}"
        case .pinMutedBold: return "\u{f7c5}"
        case .pinMutedFilled: return "\u{f7c6}"
        case .pinMutedLight: return "\u{f7c7}"
        case .pinMutedRegular: return "\u{f7c8}"
        case .pinRegular: return "\u{f7c9}"
        case .placeholderBold: return "\u{f7ca}"
        case .placeholderLight: return "\u{f7cb}"
        case .placeholderRegular: return "\u{f7cc}"
        case .playBold: return "\u{f7cd}"
        case .playCircleBold: return "\u{f7ce}"
        case .playCircleFilled: return "\u{f7cf}"
        case .playCircleLight: return "\u{f7d0}"
        case .playCircleRegular: return "\u{f7d1}"
        case .playFilled: return "\u{f7d2}"
        case .playLight: return "\u{f7d3}"
        case .playRegular: return "\u{f7d4}"
        case .plugAcBold: return "\u{f7d5}"
        case .plugAcLight: return "\u{f7d6}"
        case .plugAcRegular: return "\u{f7d7}"
        case .plusBold: return "\u{f7d8}"
        case .plusCircleBold: return "\u{f7d9}"
        case .plusCircleFilled: return "\u{f7da}"
        case .plusCircleLight: return "\u{f7db}"
        case .plusCircleRegular: return "\u{f7dc}"
        case .plusLight: return "\u{f7dd}"
        case .plusRegular: return "\u{f7de}"
        case .pmrBold: return "\u{f7df}"
        case .pmrFilled: return "\u{f7e0}"
        case .pmrLight: return "\u{f7e1}"
        case .pmrRegular: return "\u{f7e2}"
        case .pollBold: return "\u{f7e3}"
        case .pollLight: return "\u{f7e4}"
        case .pollRegular: return "\u{f7e5}"
        case .popInBold: return "\u{f7e6}"
        case .popInLight: return "\u{f7e7}"
        case .popInRegular: return "\u{f7e8}"
        case .popOutBold: return "\u{f7e9}"
        case .popOutLight: return "\u{f7ea}"
        case .popOutRegular: return "\u{f7eb}"
        case .popUpBold: return "\u{f7ec}"
        case .popUpLight: return "\u{f7ed}"
        case .popUpRegular: return "\u{f7ee}"
        case .portraitLandscapeBold: return "\u{f7ef}"
        case .portraitLandscapeLight: return "\u{f7f0}"
        case .portraitLandscapeRegular: return "\u{f7f1}"
        case .powerAcBold: return "\u{f7f2}"
        case .powerAcLight: return "\u{f7f3}"
        case .powerAcRegular: return "\u{f7f4}"
        case .powerBold: return "\u{f7f5}"
        case .powerLight: return "\u{f7f6}"
        case .powerRegular: return "\u{f7f7}"
        case .preHeaderBold: return "\u{f7f8}"
        case .preHeaderLight: return "\u{f7f9}"
        case .preHeaderRegular: return "\u{f7fa}"
        case .presentationBold: return "\u{f7fb}"
        case .presentationLight: return "\u{f7fc}"
        case .presentationRegular: return "\u{f7fd}"
        case .primaryParticipantBold: return "\u{f7fe}"
        case .primaryParticipantLight: return "\u{f7ff}"
        case .primaryParticipantRegular: return "\u{f800}"
        case .printBold: return "\u{f801}"
        case .printLight: return "\u{f802}"
        case .printRegular: return "\u{f803}"
        case .priorityBadgeFilled: return "\u{f804}"
        case .priorityCircleBold: return "\u{f805}"
        case .priorityCircleFilled: return "\u{f806}"
        case .priorityCircleLight: return "\u{f807}"
        case .priorityCircleRegular: return "\u{f808}"
        case .priorityCircleTwoBold: return "\u{f809}"
        case .priorityCircleTwoFilled: return "\u{f80a}"
        case .priorityCircleTwoLight: return "\u{f80b}"
        case .priorityCircleTwoRegular: return "\u{f80c}"
        case .privacyCircleBold: return "\u{f80d}"
        case .privacyCircleFilled: return "\u{f80e}"
        case .privacyCircleLight: return "\u{f80f}"
        case .privacyCircleRegular: return "\u{f810}"
        case .privateBold: return "\u{f811}"
        case .privateCircleBold: return "\u{f812}"
        case .privateCircleFilled: return "\u{f813}"
        case .privateCircleLight: return "\u{f814}"
        case .privateCircleRegular: return "\u{f815}"
        case .privateLight: return "\u{f816}"
        case .privateMeetingBold: return "\u{f817}"
        case .privateMeetingLight: return "\u{f818}"
        case .privateMeetingRegular: return "\u{f819}"
        case .privateRegular: return "\u{f81a}"
        case .productDemoBold: return "\u{f81b}"
        case .productDemoLight: return "\u{f81c}"
        case .productDemoRegular: return "\u{f81d}"
        case .proximityBold: return "\u{f81e}"
        case .proximityLight: return "\u{f81f}"
        case .proximityMutedBold: return "\u{f820}"
        case .proximityMutedLight: return "\u{f821}"
        case .proximityMutedRegular: return "\u{f822}"
        case .proximityRegular: return "\u{f823}"
        case .proximityVideoBold: return "\u{f824}"
        case .proximityVideoLight: return "\u{f825}"
        case .proximityVideoRegular: return "\u{f826}"
        case .ptoPresenceBold: return "\u{f827}"
        case .ptoPresenceFilled: return "\u{f828}"
        case .ptoPresenceLight: return "\u{f829}"
        case .ptoPresenceRegular: return "\u{f82a}"
        case .pullCallBold: return "\u{f82b}"
        case .pullCallLight: return "\u{f82c}"
        case .pullCallRegular: return "\u{f82d}"
        case .qABold: return "\u{f82e}"
        case .qALight: return "\u{f82f}"
        case .qARegular: return "\u{f830}"
        case .qualityBold: return "\u{f831}"
        case .qualityLight: return "\u{f832}"
        case .qualityRegular: return "\u{f833}"
        case .queueContactBold: return "\u{f834}"
        case .queueContactLight: return "\u{f835}"
        case .queueContactRegular: return "\u{f836}"
        case .quietBold: return "\u{f837}"
        case .quietHoursPresenceBold: return "\u{f838}"
        case .quietHoursPresenceFilled: return "\u{f839}"
        case .quietHoursPresenceLight: return "\u{f83a}"
        case .quietHoursPresenceRegular: return "\u{f83b}"
        case .quietLight: return "\u{f83c}"
        case .quietRegular: return "\u{f83d}"
        case .radioButtonGroupBold: return "\u{f83e}"
        case .radioButtonGroupLight: return "\u{f83f}"
        case .radioButtonGroupRegular: return "\u{f840}"
        case .raiseHandBold: return "\u{f841}"
        case .raiseHandCircleFilled: return "\u{f842}"
        case .raiseHandFilled: return "\u{f843}"
        case .raiseHandLight: return "\u{f844}"
        case .raiseHandRegular: return "\u{f845}"
        case .ramBold: return "\u{f846}"
        case .ramLight: return "\u{f847}"
        case .ramRegular: return "\u{f848}"
        case .reactionsBold: return "\u{f849}"
        case .reactionsFilled: return "\u{f84a}"
        case .reactionsLight: return "\u{f84b}"
        case .reactionsRegular: return "\u{f84c}"
        case .reactivateBold: return "\u{f84d}"
        case .reactivateLight: return "\u{f84e}"
        case .reactivateRegular: return "\u{f84f}"
        case .recentsBold: return "\u{f850}"
        case .recentsFilled: return "\u{f851}"
        case .recentsLight: return "\u{f852}"
        case .recentsPresenceBold: return "\u{f853}"
        case .recentsPresenceFilled: return "\u{f854}"
        case .recentsPresenceLight: return "\u{f855}"
        case .recentsPresenceRegular: return "\u{f856}"
        case .recentsPresenceSmallFilled: return "\u{f857}"
        case .recentsRegular: return "\u{f858}"
        case .recordActiveBold: return "\u{f859}"
        case .recordActiveFilled: return "\u{f85a}"
        case .recordActiveLight: return "\u{f85b}"
        case .recordActiveRegular: return "\u{f85c}"
        case .recordBold: return "\u{f85d}"
        case .recordFilled: return "\u{f85e}"
        case .recordLight: return "\u{f85f}"
        case .recordPausedBold: return "\u{f860}"
        case .recordPausedFilled: return "\u{f861}"
        case .recordPausedLight: return "\u{f862}"
        case .recordPausedRegular: return "\u{f863}"
        case .recordRegular: return "\u{f864}"
        case .recurringBold: return "\u{f865}"
        case .recurringLight: return "\u{f866}"
        case .recurringOffBold: return "\u{f867}"
        case .recurringOffLight: return "\u{f868}"
        case .recurringOffRegular: return "\u{f869}"
        case .recurringRegular: return "\u{f86a}"
        case .redialBold: return "\u{f86b}"
        case .redialLight: return "\u{f86c}"
        case .redialRegular: return "\u{f86d}"
        case .redoBold: return "\u{f86e}"
        case .redoLight: return "\u{f86f}"
        case .redoRegular: return "\u{f870}"
        case .refreshBold: return "\u{f871}"
        case .refreshLight: return "\u{f872}"
        case .refreshRegular: return "\u{f873}"
        case .remoteCallBold: return "\u{f874}"
        case .remoteCallFilled: return "\u{f875}"
        case .remoteCallLight: return "\u{f876}"
        case .remoteCallRegular: return "\u{f877}"
        case .remoteDesktopControlBold: return "\u{f878}"
        case .remoteDesktopControlFilled: return "\u{f879}"
        case .remoteDesktopControlLight: return "\u{f87a}"
        case .remoteDesktopControlRegular: return "\u{f87b}"
        case .removeBold: return "\u{f87c}"
        case .removeFilled: return "\u{f87d}"
        case .removeLight: return "\u{f87e}"
        case .removeRegular: return "\u{f87f}"
        case .replyBold: return "\u{f880}"
        case .replyFilled: return "\u{f881}"
        case .replyLight: return "\u{f882}"
        case .replyListBold: return "\u{f883}"
        case .replyListLight: return "\u{f884}"
        case .replyListRegular: return "\u{f885}"
        case .replyPrivatelyBold: return "\u{f886}"
        case .replyPrivatelyLight: return "\u{f887}"
        case .replyPrivatelyRegular: return "\u{f888}"
        case .replyRegular: return "\u{f889}"
        case .resetBold: return "\u{f88a}"
        case .resetLight: return "\u{f88b}"
        case .resetRegular: return "\u{f88c}"
        case .responsiveMobileBold: return "\u{f88d}"
        case .responsiveMobileLight: return "\u{f88e}"
        case .responsiveMobileRegular: return "\u{f88f}"
        case .restartBold: return "\u{f890}"
        case .restartLight: return "\u{f891}"
        case .restartRegular: return "\u{f892}"
        case .retrieveCallBold: return "\u{f893}"
        case .retrieveCallLight: return "\u{f894}"
        case .retrieveCallRegular: return "\u{f895}"
        case .returnBold: return "\u{f896}"
        case .returnLight: return "\u{f897}"
        case .returnRegular: return "\u{f898}"
        case .ringtoneBold: return "\u{f899}"
        case .ringtoneLight: return "\u{f89a}"
        case .ringtoneRegular: return "\u{f89b}"
        case .roomCalendarBold: return "\u{f89c}"
        case .roomCalendarLight: return "\u{f89d}"
        case .roomCalendarRegular: return "\u{f89e}"
        case .roomLightsBold: return "\u{f89f}"
        case .roomLightsFilled: return "\u{f8a0}"
        case .roomLightsLight: return "\u{f8a1}"
        case .roomLightsRegular: return "\u{f8a2}"
        case .rotateContentBold: return "\u{f8a3}"
        case .rotateContentFilled: return "\u{f8a4}"
        case .rotateContentLight: return "\u{f8a5}"
        case .rotateContentRegular: return "\u{f8a6}"
        case .ruleBasedBold: return "\u{f8a7}"
        case .ruleBasedLight: return "\u{f8a8}"
        case .ruleBasedRegular: return "\u{f8a9}"
        case .runningApplicationBold: return "\u{f8aa}"
        case .runningApplicationFilled: return "\u{f8ab}"
        case .runningApplicationLight: return "\u{f8ac}"
        case .runningApplicationRegular: return "\u{f8ad}"
        case .saveBold: return "\u{f8ae}"
        case .saveLight: return "\u{f8af}"
        case .saveRegular: return "\u{f8b0}"
        case .saveTranscriptBold: return "\u{f8b1}"
        case .saveTranscriptFilled: return "\u{f8b2}"
        case .saveTranscriptLight: return "\u{f8b3}"
        case .saveTranscriptRegular: return "\u{f8b4}"
        case .scanBold: return "\u{f8b5}"
        case .scanLight: return "\u{f8b6}"
        case .scanRegular: return "\u{f8b7}"
        case .schedulerAvailableBold: return "\u{f8b8}"
        case .schedulerAvailableLight: return "\u{f8b9}"
        case .schedulerAvailableRegular: return "\u{f8ba}"
        case .schedulerNotWorkingHoursBold: return "\u{f8bb}"
        case .schedulerNotWorkingHoursLight: return "\u{f8bc}"
        case .schedulerNotWorkingHoursRegular: return "\u{f8bd}"
        case .schedulerUnavailableBold: return "\u{f8be}"
        case .schedulerUnavailableLight: return "\u{f8bf}"
        case .schedulerUnavailableRegular: return "\u{f8c0}"
        case .schedulerUnknownBold: return "\u{f8c1}"
        case .schedulerUnknownLight: return "\u{f8c2}"
        case .schedulerUnknownRegular: return "\u{f8c3}"
        case .screenshotBold: return "\u{f8c4}"
        case .screenshotDocBold: return "\u{f8c5}"
        case .screenshotDocFilled: return "\u{f8c6}"
        case .screenshotDocLight: return "\u{f8c7}"
        case .screenshotDocRegular: return "\u{f8c8}"
        case .screenshotLight: return "\u{f8c9}"
        case .screenshotRegular: return "\u{f8ca}"
        case .searchBold: return "\u{f8cb}"
        case .searchFilled: return "\u{f8cc}"
        case .searchLight: return "\u{f8cd}"
        case .searchRegular: return "\u{f8ce}"
        case .secondaryArrowBold: return "\u{f8cf}"
        case .secondaryArrowLight: return "\u{f8d0}"
        case .secondaryArrowRegular: return "\u{f8d1}"
        case .secureCallLockBold: return "\u{f8d2}"
        case .secureCallLockFilled: return "\u{f8d3}"
        case .secureCallLockLight: return "\u{f8d4}"
        case .secureCallLockRegular: return "\u{f8d5}"
        case .secureCallShieldBold: return "\u{f8d6}"
        case .secureCallShieldFilled: return "\u{f8d7}"
        case .secureCallShieldLight: return "\u{f8d8}"
        case .secureCallShieldRegular: return "\u{f8d9}"
        case .secureCircleBold: return "\u{f8da}"
        case .secureCircleFilled: return "\u{f8db}"
        case .secureCircleLight: return "\u{f8dc}"
        case .secureCircleRegular: return "\u{f8dd}"
        case .secureLockBold: return "\u{f8de}"
        case .secureLockFilled: return "\u{f8df}"
        case .secureLockLight: return "\u{f8e0}"
        case .secureLockRegular: return "\u{f8e1}"
        case .segmentExcludeFilled: return "\u{f8e2}"
        case .segmentFilterFilled: return "\u{f8e3}"
        case .segmentIncludeFilled: return "\u{f8e4}"
        case .selectAllBold: return "\u{f8e5}"
        case .selectAllFilled: return "\u{f8e6}"
        case .selectAllLight: return "\u{f8e7}"
        case .selectAllRegular: return "\u{f8e8}"
        case .selectionBold: return "\u{f8e9}"
        case .selectionLight: return "\u{f8ea}"
        case .selectionRegular: return "\u{f8eb}"
        case .sendBold: return "\u{f8ec}"
        case .sendFilled: return "\u{f8ed}"
        case .sendLight: return "\u{f8ee}"
        case .sendRegular: return "\u{f8ef}"
        case .serverBold: return "\u{f8f0}"
        case .serverErrorBold: return "\u{f8f1}"
        case .serverErrorLight: return "\u{f8f2}"
        case .serverErrorRegular: return "\u{f8f3}"
        case .serverLight: return "\u{f8f4}"
        case .serverRegular: return "\u{f8f5}"
        case .servicesBold: return "\u{f8f6}"
        case .servicesLight: return "\u{f8f7}"
        case .servicesRegular: return "\u{f8f8}"
        case .setVariableBold: return "\u{f8f9}"
        case .setVariableLight: return "\u{f8fa}"
        case .setVariableRegular: return "\u{f8fb}"
        case .settingsBold: return "\u{f8fc}"
        case .settingsFilled: return "\u{f8fd}"
        case .settingsLight: return "\u{f8fe}"
        case .settingsRegular: return "\u{f8ff}"
        case .setupAssistantBold: return "\u{f900}"
        case .setupAssistantLight: return "\u{f901}"
        case .setupAssistantRegular: return "\u{f902}"
        case .sftpBold: return "\u{f903}"
        case .sftpLight: return "\u{f904}"
        case .sftpRegular: return "\u{f905}"
        case .shapeCircleBold: return "\u{f906}"
        case .shapeCircleFilled: return "\u{f907}"
        case .shapeCircleLight: return "\u{f908}"
        case .shapeCircleRegular: return "\u{f909}"
        case .shapeDiagonalLineBold: return "\u{f90a}"
        case .shapeDiagonalLineLight: return "\u{f90b}"
        case .shapeDiagonalLineRegular: return "\u{f90c}"
        case .shapeDiamondBold: return "\u{f90d}"
        case .shapeDiamondFilled: return "\u{f90e}"
        case .shapeDiamondLight: return "\u{f90f}"
        case .shapeDiamondRegular: return "\u{f910}"
        case .shapeOvalBold: return "\u{f911}"
        case .shapeOvalLight: return "\u{f912}"
        case .shapeOvalRegular: return "\u{f913}"
        case .shapeSquareBold: return "\u{f914}"
        case .shapeSquareFilled: return "\u{f915}"
        case .shapeSquareLight: return "\u{f916}"
        case .shapeSquareRegular: return "\u{f917}"
        case .shapeTriangleBold: return "\u{f918}"
        case .shapeTriangleFilled: return "\u{f919}"
        case .shapeTriangleLight: return "\u{f91a}"
        case .shapeTriangleRegular: return "\u{f91b}"
        case .shapesBold: return "\u{f91c}"
        case .shapesLight: return "\u{f91d}"
        case .shapesRegular: return "\u{f91e}"
        case .shareCNativeAdrBold: return "\u{f91f}"
        case .shareCNativeAdrFilled: return "\u{f920}"
        case .shareCNativeAdrLight: return "\u{f921}"
        case .shareCNativeAdrRegular: return "\u{f922}"
        case .shareCNativeIphBold: return "\u{f923}"
        case .shareCNativeIphLight: return "\u{f924}"
        case .shareCNativeIphRegular: return "\u{f925}"
        case .shareScreenBold: return "\u{f926}"
        case .shareScreenFilled: return "\u{f927}"
        case .shareScreenLight: return "\u{f928}"
        case .shareScreenRegular: return "\u{f929}"
        case .shareScreenSmallFilled: return "\u{f92a}"
        case .shareSpaceBold: return "\u{f92b}"
        case .shareSpaceLight: return "\u{f92c}"
        case .shareSpaceRegular: return "\u{f92d}"
        case .shieldBold: return "\u{f92e}"
        case .shieldLight: return "\u{f92f}"
        case .shieldRegular: return "\u{f930}"
        case .shoppingCartBold: return "\u{f931}"
        case .shoppingCartFilled: return "\u{f932}"
        case .shoppingCartLight: return "\u{f933}"
        case .shoppingCartRegular: return "\u{f934}"
        case .shortTextBoxBold: return "\u{f935}"
        case .shortTextBoxLight: return "\u{f936}"
        case .shortTextBoxRegular: return "\u{f937}"
        case .showBold: return "\u{f938}"
        case .showFilled: return "\u{f939}"
        case .showLight: return "\u{f93a}"
        case .showRegular: return "\u{f93b}"
        case .signInBold: return "\u{f93c}"
        case .signInFilled: return "\u{f93d}"
        case .signInForcedBold: return "\u{f93e}"
        case .signInForcedLight: return "\u{f93f}"
        case .signInForcedRegular: return "\u{f940}"
        case .signInLight: return "\u{f941}"
        case .signInRegular: return "\u{f942}"
        case .signLangIntBold: return "\u{f943}"
        case .signLangIntLight: return "\u{f944}"
        case .signLangIntRegular: return "\u{f945}"
        case .signOutBold: return "\u{f946}"
        case .signOutLight: return "\u{f947}"
        case .signOutRegular: return "\u{f948}"
        case .signal0Bold: return "\u{f949}"
        case .signal0Light: return "\u{f94a}"
        case .signal0Regular: return "\u{f94b}"
        case .signal100Bold: return "\u{f94c}"
        case .signal100Light: return "\u{f94d}"
        case .signal100Regular: return "\u{f94e}"
        case .signal25Bold: return "\u{f94f}"
        case .signal25Light: return "\u{f950}"
        case .signal25Regular: return "\u{f951}"
        case .signal50Bold: return "\u{f952}"
        case .signal50Light: return "\u{f953}"
        case .signal50Regular: return "\u{f954}"
        case .signal75Bold: return "\u{f955}"
        case .signal75Light: return "\u{f956}"
        case .signal75Regular: return "\u{f957}"
        case .simplePromotionBold: return "\u{f958}"
        case .simplePromotionLight: return "\u{f959}"
        case .simplePromotionRegular: return "\u{f95a}"
        case .singleNumberReachBold: return "\u{f95b}"
        case .singleNumberReachLight: return "\u{f95c}"
        case .singleNumberReachRegular: return "\u{f95d}"
        case .sipRegistrationInProgressBold: return "\u{f95e}"
        case .sipRegistrationInProgressFilled: return "\u{f95f}"
        case .sipRegistrationInProgressLight: return "\u{f960}"
        case .sipRegistrationInProgressRegular: return "\u{f961}"
        case .skipBold: return "\u{f962}"
        case .skipBwBold: return "\u{f963}"
        case .skipBwFilled: return "\u{f964}"
        case .skipBwLight: return "\u{f965}"
        case .skipBwRegular: return "\u{f966}"
        case .skipFwBold: return "\u{f967}"
        case .skipFwFilled: return "\u{f968}"
        case .skipFwLight: return "\u{f969}"
        case .skipFwRegular: return "\u{f96a}"
        case .skipLight: return "\u{f96b}"
        case .skipRegular: return "\u{f96c}"
        case .smsInboundBold: return "\u{f96d}"
        case .smsInboundLight: return "\u{f96e}"
        case .smsInboundRegular: return "\u{f96f}"
        case .smsMessageBold: return "\u{f970}"
        case .smsMessageFilled: return "\u{f971}"
        case .smsMessageLight: return "\u{f972}"
        case .smsMessageRegular: return "\u{f973}"
        case .socialAlexaFilled: return "\u{f974}"
        case .socialFacebookColoredFilled: return "\u{f975}"
        case .socialFacebookFilled: return "\u{f976}"
        case .socialFbmessengerColoredFilled: return "\u{f977}"
        case .socialFbmessengerFilled: return "\u{f978}"
        case .socialInstagramBold: return "\u{f979}"
        case .socialMicrosoftColoredFilled: return "\u{f97a}"
        case .socialMicrosoftFilled: return "\u{f97b}"
        case .socialMmsFilled: return "\u{f97c}"
        case .socialMmsGoldFilled: return "\u{f97d}"
        case .socialSmsFilled: return "\u{f97e}"
        case .socialSmsMintFilled: return "\u{f97f}"
        case .socialTwitterColoredFilled: return "\u{f980}"
        case .socialTwitterFilled: return "\u{f981}"
        case .socialViberBold: return "\u{f982}"
        case .socialViberColoredBold: return "\u{f983}"
        case .socialWhatsappBold: return "\u{f984}"
        case .socialWhatsappColoredFilled: return "\u{f985}"
        case .sortAscendingBold: return "\u{f986}"
        case .sortAscendingLight: return "\u{f987}"
        case .sortAscendingRegular: return "\u{f988}"
        case .sortDescendingBold: return "\u{f989}"
        case .sortDescendingLight: return "\u{f98a}"
        case .sortDescendingRegular: return "\u{f98b}"
        case .soundDefaultBold: return "\u{f98c}"
        case .soundDefaultLight: return "\u{f98d}"
        case .soundDefaultRegular: return "\u{f98e}"
        case .speakerBold: return "\u{f98f}"
        case .speakerDisconnectedBold: return "\u{f990}"
        case .speakerDisconnectedFilled: return "\u{f991}"
        case .speakerDisconnectedLight: return "\u{f992}"
        case .speakerDisconnectedRegular: return "\u{f993}"
        case .speakerFilled: return "\u{f994}"
        case .speakerLight: return "\u{f995}"
        case .speakerMutedBold: return "\u{f996}"
        case .speakerMutedFilled: return "\u{f997}"
        case .speakerMutedLight: return "\u{f998}"
        case .speakerMutedRegular: return "\u{f999}"
        case .speakerOffBold: return "\u{f99a}"
        case .speakerOffFilled: return "\u{f99b}"
        case .speakerOffLight: return "\u{f99c}"
        case .speakerOffRegular: return "\u{f99d}"
        case .speakerOnColoredBold: return "\u{f99e}"
        case .speakerOnColoredLight: return "\u{f99f}"
        case .speakerOnColoredRegular: return "\u{f9a0}"
        case .speakerRegular: return "\u{f9a1}"
        case .speakerTurnDownBold: return "\u{f9a2}"
        case .speakerTurnDownFilled: return "\u{f9a3}"
        case .speakerTurnDownLight: return "\u{f9a4}"
        case .speakerTurnDownRegular: return "\u{f9a5}"
        case .speakerTurnUpBold: return "\u{f9a6}"
        case .speakerTurnUpFilled: return "\u{f9a7}"
        case .speakerTurnUpLight: return "\u{f9a8}"
        case .speakerTurnUpRegular: return "\u{f9a9}"
        case .spellCheckerBold: return "\u{f9aa}"
        case .spellCheckerLight: return "\u{f9ab}"
        case .spellCheckerRegular: return "\u{f9ac}"
        case .spinnerBold: return "\u{f9ad}"
        case .spinnerFilledBold: return "\u{f9ae}"
        case .spinnerFilledLight: return "\u{f9af}"
        case .spinnerFilledRegular: return "\u{f9b0}"
        case .spinnerLight: return "\u{f9b1}"
        case .spinnerPartialBold: return "\u{f9b2}"
        case .spinnerPartialLight: return "\u{f9b3}"
        case .spinnerPartialRegular: return "\u{f9b4}"
        case .spinnerRegular: return "\u{f9b5}"
        case .stackedArea100ChartBold: return "\u{f9b6}"
        case .stackedArea100ChartFilled: return "\u{f9b7}"
        case .stackedArea100ChartLight: return "\u{f9b8}"
        case .stackedArea100ChartRegular: return "\u{f9b9}"
        case .stackedAreaChartBold: return "\u{f9ba}"
        case .stackedAreaChartFilled: return "\u{f9bb}"
        case .stackedAreaChartLight: return "\u{f9bc}"
        case .stackedAreaChartRegular: return "\u{f9bd}"
        case .stackedBar100ChartBold: return "\u{f9be}"
        case .stackedBar100ChartFilled: return "\u{f9bf}"
        case .stackedBar100ChartLight: return "\u{f9c0}"
        case .stackedBar100ChartRegular: return "\u{f9c1}"
        case .stackedBarChartBold: return "\u{f9c2}"
        case .stackedBarChartFilled: return "\u{f9c3}"
        case .stackedBarChartLight: return "\u{f9c4}"
        case .stackedBarChartRegular: return "\u{f9c5}"
        case .startChatBold: return "\u{f9c6}"
        case .startChatLight: return "\u{f9c7}"
        case .startChatRegular: return "\u{f9c8}"
        case .stethoscopeBold: return "\u{f9c9}"
        case .stethoscopeLight: return "\u{f9ca}"
        case .stethoscopeRegular: return "\u{f9cb}"
        case .stickersBold: return "\u{f9cc}"
        case .stickersLight: return "\u{f9cd}"
        case .stickersRegular: return "\u{f9ce}"
        case .stickiesBold: return "\u{f9cf}"
        case .stickiesLight: return "\u{f9d0}"
        case .stickiesRegular: return "\u{f9d1}"
        case .stopBold: return "\u{f9d2}"
        case .stopCircleBold: return "\u{f9d3}"
        case .stopCircleFilled: return "\u{f9d4}"
        case .stopCircleLight: return "\u{f9d5}"
        case .stopCircleRegular: return "\u{f9d6}"
        case .stopContentShareBold: return "\u{f9d7}"
        case .stopContentShareLight: return "\u{f9d8}"
        case .stopContentShareRegular: return "\u{f9d9}"
        case .stopFilled: return "\u{f9da}"
        case .stopLight: return "\u{f9db}"
        case .stopRegular: return "\u{f9dc}"
        case .storedInfoBold: return "\u{f9dd}"
        case .storedInfoFilled: return "\u{f9de}"
        case .storedInfoLight: return "\u{f9df}"
        case .storedInfoRegular: return "\u{f9e0}"
        case .streamingBold: return "\u{f9e1}"
        case .streamingLight: return "\u{f9e2}"
        case .streamingRegular: return "\u{f9e3}"
        case .strikethroughBold: return "\u{f9e4}"
        case .strikethroughLight: return "\u{f9e5}"
        case .strikethroughRegular: return "\u{f9e6}"
        case .studioModeBold: return "\u{f9e7}"
        case .studioModeLight: return "\u{f9e8}"
        case .studioModeRegular: return "\u{f9e9}"
        case .subscriptBold: return "\u{f9ea}"
        case .subscriptLight: return "\u{f9eb}"
        case .subscriptRegular: return "\u{f9ec}"
        case .superscriptBold: return "\u{f9ed}"
        case .superscriptLight: return "\u{f9ee}"
        case .superscriptRegular: return "\u{f9ef}"
        case .surveyBold: return "\u{f9f0}"
        case .surveyFilled: return "\u{f9f1}"
        case .surveyLight: return "\u{f9f2}"
        case .surveyRegular: return "\u{f9f3}"
        case .sx10Bold: return "\u{f9f4}"
        case .sx10Light: return "\u{f9f5}"
        case .sx10Regular: return "\u{f9f6}"
        case .sx20Bold: return "\u{f9f7}"
        case .sx20Light: return "\u{f9f8}"
        case .sx20Regular: return "\u{f9f9}"
        case .sx80CodecBold: return "\u{f9fa}"
        case .sx80CodecLight: return "\u{f9fb}"
        case .sx80CodecRegular: return "\u{f9fc}"
        case .tableBold: return "\u{f9fd}"
        case .tableLight: return "\u{f9fe}"
        case .tableRegular: return "\u{f9ff}"
        case .tabletBold: return "\u{fa00}"
        case .tabletLight: return "\u{fa01}"
        case .tabletRegular: return "\u{fa02}"
        case .tabsBold: return "\u{fa03}"
        case .tabsLight: return "\u{fa04}"
        case .tabsRegular: return "\u{fa05}"
        case .tagBold: return "\u{fa06}"
        case .tagLight: return "\u{fa07}"
        case .tagRegular: return "\u{fa08}"
        case .tapBold: return "\u{fa09}"
        case .tapFilled: return "\u{fa0a}"
        case .tapLight: return "\u{fa0b}"
        case .tapRegular: return "\u{fa0c}"
        case .telepresenceAlertBold: return "\u{fa0d}"
        case .telepresenceAlertLight: return "\u{fa0e}"
        case .telepresenceAlertMutedBold: return "\u{fa0f}"
        case .telepresenceAlertMutedLight: return "\u{fa10}"
        case .telepresenceAlertMutedRegular: return "\u{fa11}"
        case .telepresenceAlertRegular: return "\u{fa12}"
        case .telepresenceBold: return "\u{fa13}"
        case .telepresenceIx5000Bold: return "\u{fa14}"
        case .telepresenceIx5000Light: return "\u{fa15}"
        case .telepresenceIx5000Regular: return "\u{fa16}"
        case .telepresenceLight: return "\u{fa17}"
        case .telepresencePrivateBold: return "\u{fa18}"
        case .telepresencePrivateLight: return "\u{fa19}"
        case .telepresencePrivateRegular: return "\u{fa1a}"
        case .telepresenceRegular: return "\u{fa1b}"
        case .temperatureBold: return "\u{fa1c}"
        case .temperatureLight: return "\u{fa1d}"
        case .temperatureRegular: return "\u{fa1e}"
        case .textAlignCenterBold: return "\u{fa1f}"
        case .textAlignCenterFilled: return "\u{fa20}"
        case .textAlignCenterLight: return "\u{fa21}"
        case .textAlignCenterRegular: return "\u{fa22}"
        case .textAlignLeftBold: return "\u{fa23}"
        case .textAlignLeftFilled: return "\u{fa24}"
        case .textAlignLeftLight: return "\u{fa25}"
        case .textAlignLeftRegular: return "\u{fa26}"
        case .textAlignRightBold: return "\u{fa27}"
        case .textAlignRightFilled: return "\u{fa28}"
        case .textAlignRightLight: return "\u{fa29}"
        case .textAlignRightRegular: return "\u{fa2a}"
        case .textBold: return "\u{fa2b}"
        case .textCodeBlockBold: return "\u{fa2c}"
        case .textCodeBlockLight: return "\u{fa2d}"
        case .textCodeBlockRegular: return "\u{fa2e}"
        case .textHighlightBold: return "\u{fa2f}"
        case .textHighlightLight: return "\u{fa30}"
        case .textHighlightRegular: return "\u{fa31}"
        case .textLight: return "\u{fa32}"
        case .textRegular: return "\u{fa33}"
        case .threeColumnBold: return "\u{fa34}"
        case .threeColumnLight: return "\u{fa35}"
        case .threeColumnRegular: return "\u{fa36}"
        case .threeDObjectBold: return "\u{fa37}"
        case .threeDObjectLight: return "\u{fa38}"
        case .threeDObjectRegular: return "\u{fa39}"
        case .tooFastBold: return "\u{fa3a}"
        case .tooFastLight: return "\u{fa3b}"
        case .tooFastRegular: return "\u{fa3c}"
        case .tooSlowBold: return "\u{fa3d}"
        case .tooSlowLight: return "\u{fa3e}"
        case .tooSlowRegular: return "\u{fa3f}"
        case .toolsBold: return "\u{fa40}"
        case .toolsLight: return "\u{fa41}"
        case .toolsRegular: return "\u{fa42}"
        case .touch10Bold: return "\u{fa43}"
        case .touch10Light: return "\u{fa44}"
        case .touch10Regular: return "\u{fa45}"
        case .transcriptBold: return "\u{fa46}"
        case .transcriptFilled: return "\u{fa47}"
        case .transcriptLight: return "\u{fa48}"
        case .transcriptRegular: return "\u{fa49}"
        case .translateBold: return "\u{fa4a}"
        case .translateLight: return "\u{fa4b}"
        case .translateRegular: return "\u{fa4c}"
        case .trimBold: return "\u{fa4d}"
        case .trimLight: return "\u{fa4e}"
        case .trimRegular: return "\u{fa4f}"
        case .twoColumnBold: return "\u{fa50}"
        case .twoColumnLight: return "\u{fa51}"
        case .twoColumnRegular: return "\u{fa52}"
        case .ucmCloudBold: return "\u{fa53}"
        case .ucmCloudLight: return "\u{fa54}"
        case .ucmCloudRegular: return "\u{fa55}"
        case .underlineBold: return "\u{fa56}"
        case .underlineLight: return "\u{fa57}"
        case .underlineRegular: return "\u{fa58}"
        case .undoBold: return "\u{fa59}"
        case .undoLight: return "\u{fa5a}"
        case .undoRegular: return "\u{fa5b}"
        case .unlinkBold: return "\u{fa5c}"
        case .unlinkLight: return "\u{fa5d}"
        case .unlinkRegular: return "\u{fa5e}"
        case .unreadBold: return "\u{fa5f}"
        case .unreadFilled: return "\u{fa60}"
        case .unreadLight: return "\u{fa61}"
        case .unreadRegular: return "\u{fa62}"
        case .unsecureUnlockedBold: return "\u{fa63}"
        case .unsecureUnlockedFilled: return "\u{fa64}"
        case .unsecureUnlockedLight: return "\u{fa65}"
        case .unsecureUnlockedRegular: return "\u{fa66}"
        case .unsortedBold: return "\u{fa67}"
        case .unsortedLight: return "\u{fa68}"
        case .unsortedRegular: return "\u{fa69}"
        case .updateFileShareBold: return "\u{fa6a}"
        case .updateFileShareLight: return "\u{fa6b}"
        case .updateFileShareRegular: return "\u{fa6c}"
        case .upgradeBold: return "\u{fa6d}"
        case .upgradeFilled: return "\u{fa6e}"
        case .upgradeLight: return "\u{fa6f}"
        case .upgradeRegular: return "\u{fa70}"
        case .uploadBold: return "\u{fa71}"
        case .uploadImageBold: return "\u{fa72}"
        case .uploadImageLight: return "\u{fa73}"
        case .uploadImageRegular: return "\u{fa74}"
        case .uploadLight: return "\u{fa75}"
        case .uploadRegular: return "\u{fa76}"
        case .urgentVoicemailBold: return "\u{fa77}"
        case .urgentVoicemailFilled: return "\u{fa78}"
        case .usbBold: return "\u{fa79}"
        case .usbHeadsetBold: return "\u{fa7a}"
        case .usbHeadsetLight: return "\u{fa7b}"
        case .usbHeadsetMutedBold: return "\u{fa7c}"
        case .usbHeadsetMutedLight: return "\u{fa7d}"
        case .usbHeadsetMutedRegular: return "\u{fa7e}"
        case .usbHeadsetRegular: return "\u{fa7f}"
        case .usbLight: return "\u{fa80}"
        case .usbRegular: return "\u{fa81}"
        case .userBold: return "\u{fa82}"
        case .userDeactivateBold: return "\u{fa83}"
        case .userDeactivateLight: return "\u{fa84}"
        case .userDeactivateRegular: return "\u{fa85}"
        case .userLight: return "\u{fa86}"
        case .userRegular: return "\u{fa87}"
        case .vcsBold: return "\u{fa88}"
        case .vcsLight: return "\u{fa89}"
        case .vcsRegular: return "\u{fa8a}"
        case .videoBlurBold: return "\u{fa8b}"
        case .videoBlurFilled: return "\u{fa8c}"
        case .videoBlurLight: return "\u{fa8d}"
        case .videoBlurRegular: return "\u{fa8e}"
        case .videoBold: return "\u{fa8f}"
        case .videoEffectBold: return "\u{fa90}"
        case .videoEffectFilled: return "\u{fa91}"
        case .videoEffectLight: return "\u{fa92}"
        case .videoEffectRegular: return "\u{fa93}"
        case .videoFilled: return "\u{fa94}"
        case .videoLayoutBold: return "\u{fa95}"
        case .videoLayoutEqualBold: return "\u{fa96}"
        case .videoLayoutEqualDualBold: return "\u{fa97}"
        case .videoLayoutEqualDualLight: return "\u{fa98}"
        case .videoLayoutEqualDualRegular: return "\u{fa99}"
        case .videoLayoutEqualFilled: return "\u{fa9a}"
        case .videoLayoutEqualLight: return "\u{fa9b}"
        case .videoLayoutEqualRegular: return "\u{fa9c}"
        case .videoLayoutFilled: return "\u{fa9d}"
        case .videoLayoutLight: return "\u{fa9e}"
        case .videoLayoutOverlayBold: return "\u{fa9f}"
        case .videoLayoutOverlayLight: return "\u{faa0}"
        case .videoLayoutOverlayRegular: return "\u{faa1}"
        case .videoLayoutPresenterDominantBold: return "\u{faa2}"
        case .videoLayoutPresenterDominantLight: return "\u{faa3}"
        case .videoLayoutPresenterDominantRegular: return "\u{faa4}"
        case .videoLayoutProminentBold: return "\u{faa5}"
        case .videoLayoutProminentFilled: return "\u{faa6}"
        case .videoLayoutProminentLight: return "\u{faa7}"
        case .videoLayoutProminentRegular: return "\u{faa8}"
        case .videoLayoutRegular: return "\u{faa9}"
        case .videoLayoutShareDominantBold: return "\u{faaa}"
        case .videoLayoutShareDominantLight: return "\u{faab}"
        case .videoLayoutShareDominantRegular: return "\u{faac}"
        case .videoLayoutSingleBold: return "\u{faad}"
        case .videoLayoutSingleFilled: return "\u{faae}"
        case .videoLayoutSingleLight: return "\u{faaf}"
        case .videoLayoutSingleRegular: return "\u{fab0}"
        case .videoLayoutStackBold: return "\u{fab1}"
        case .videoLayoutStackFilled: return "\u{fab2}"
        case .videoLayoutStackLight: return "\u{fab3}"
        case .videoLayoutStackRegular: return "\u{fab4}"
        case .videoLayoutVideoDominantBold: return "\u{fab5}"
        case .videoLayoutVideoDominantFilled: return "\u{fab6}"
        case .videoLayoutVideoDominantLight: return "\u{fab7}"
        case .videoLayoutVideoDominantRegular: return "\u{fab8}"
        case .videoLight: return "\u{fab9}"
        case .videoPlusBold: return "\u{faba}"
        case .videoPlusFilled: return "\u{fabb}"
        case .videoPlusLight: return "\u{fabc}"
        case .videoPlusRegular: return "\u{fabd}"
        case .videoRegular: return "\u{fabe}"
        case .videoSpeakerTrackBold: return "\u{fabf}"
        case .videoSpeakerTrackFilled: return "\u{fac0}"
        case .videoSpeakerTrackLight: return "\u{fac1}"
        case .videoSpeakerTrackRegular: return "\u{fac2}"
        case .viewAllBold: return "\u{fac3}"
        case .viewAllLight: return "\u{fac4}"
        case .viewAllRegular: return "\u{fac5}"
        case .viewListBold: return "\u{fac6}"
        case .viewListLight: return "\u{fac7}"
        case .viewListRegular: return "\u{fac8}"
        case .viewStackedBold: return "\u{fac9}"
        case .viewStackedFilled: return "\u{faca}"
        case .viewStackedLight: return "\u{facb}"
        case .viewStackedRegular: return "\u{facc}"
        case .viewThumbnailBold: return "\u{facd}"
        case .viewThumbnailFilled: return "\u{face}"
        case .viewThumbnailLight: return "\u{facf}"
        case .viewThumbnailRegular: return "\u{fad0}"
        case .voicemailBold: return "\u{fad1}"
        case .voicemailFilled: return "\u{fad2}"
        case .voicemailLight: return "\u{fad3}"
        case .voicemailRegular: return "\u{fad4}"
        case .waffleMenuBold: return "\u{fad5}"
        case .waffleMenuLight: return "\u{fad6}"
        case .waffleMenuRegular: return "\u{fad7}"
        case .waitingroomActiveBold: return "\u{fad8}"
        case .waitingroomActiveLight: return "\u{fad9}"
        case .waitingroomActiveRegular: return "\u{fada}"
        case .wallpaperBold: return "\u{fadb}"
        case .wallpaperLight: return "\u{fadc}"
        case .wallpaperRegular: return "\u{fadd}"
        case .warningBadgeFilled: return "\u{fade}"
        case .warningBold: return "\u{fadf}"
        case .warningFilled: return "\u{fae0}"
        case .warningLight: return "\u{fae1}"
        case .warningRegular: return "\u{fae2}"
        case .webexAssistantActiveColored: return "\u{fae3}"
        case .webexAssistantActive: return "\u{fae4}"
        case .webexAssistantFlat: return "\u{fae5}"
        case .webexAssistantInactiveColored: return "\u{fae6}"
        case .webexAssistantInactive: return "\u{fae7}"
        case .webexAssistant: return "\u{fae8}"
        case .webexBoardBold: return "\u{fae9}"
        case .webexBoardLight: return "\u{faea}"
        case .webexBoardRegular: return "\u{faeb}"
        case .webexCodecPlusBold: return "\u{faec}"
        case .webexCodecPlusLight: return "\u{faed}"
        case .webexCodecPlusRegular: return "\u{faee}"
        case .webexDeskCameraBold: return "\u{faef}"
        case .webexDeskCameraLight: return "\u{faf0}"
        case .webexDeskCameraRegular: return "\u{faf1}"
        case .webexHelixFilled: return "\u{faf2}"
        case .webexMeetingsBold: return "\u{faf3}"
        case .webexMeetingsFilled: return "\u{faf4}"
        case .webexMeetingsLight: return "\u{faf5}"
        case .webexMeetingsRegular: return "\u{faf6}"
        case .webexQuadCameraBold: return "\u{faf7}"
        case .webexQuadCameraLight: return "\u{faf8}"
        case .webexQuadCameraRegular: return "\u{faf9}"
        case .webexRoomKitBold: return "\u{fafa}"
        case .webexRoomKitLight: return "\u{fafb}"
        case .webexRoomKitPlusBold: return "\u{fafc}"
        case .webexRoomKitPlusLight: return "\u{fafd}"
        case .webexRoomKitPlusRegular: return "\u{fafe}"
        case .webexRoomKitRegular: return "\u{faff}"
        case .webexShareBold: return "\u{fb00}"
        case .webexShareLight: return "\u{fb01}"
        case .webexShareRegular: return "\u{fb02}"
        case .webexTeamsBold: return "\u{fb03}"
        case .webexTeamsFilled: return "\u{fb04}"
        case .webexTeamsLight: return "\u{fb05}"
        case .webexTeamsNewBold: return "\u{fb06}"
        case .webexTeamsNewFilled: return "\u{fb07}"
        case .webexTeamsNewLight: return "\u{fb08}"
        case .webexTeamsNewRegular: return "\u{fb09}"
        case .webexTeamsRegular: return "\u{fb0a}"
        case .webinarBold: return "\u{fb0b}"
        case .webinarFilled: return "\u{fb0c}"
        case .webinarLight: return "\u{fb0d}"
        case .webinarRegular: return "\u{fb0e}"
        case .weeklyRecurringScheduleNodeBold: return "\u{fb0f}"
        case .weeklyRecurringScheduleNodeLight: return "\u{fb10}"
        case .weeklyRecurringScheduleNodeRegular: return "\u{fb11}"
        case .whatsNewBold: return "\u{fb12}"
        case .whatsNewFilled: return "\u{fb13}"
        case .whatsNewLight: return "\u{fb14}"
        case .whatsNewRegular: return "\u{fb15}"
        case .whiteboardBold: return "\u{fb16}"
        case .whiteboardContentBold: return "\u{fb17}"
        case .whiteboardContentLight: return "\u{fb18}"
        case .whiteboardContentRegular: return "\u{fb19}"
        case .whiteboardFilled: return "\u{fb1a}"
        case .whiteboardLight: return "\u{fb1b}"
        case .whiteboardRegular: return "\u{fb1c}"
        case .widgetBold: return "\u{fb1d}"
        case .widgetFilled: return "\u{fb1e}"
        case .widgetLight: return "\u{fb1f}"
        case .widgetRegular: return "\u{fb20}"
        case .wifiBold: return "\u{fb21}"
        case .wifiErrorBold: return "\u{fb22}"
        case .wifiErrorLight: return "\u{fb23}"
        case .wifiErrorRegular: return "\u{fb24}"
        case .wifiLight: return "\u{fb25}"
        case .wifiRegular: return "\u{fb26}"
        case .wifiSignalGoodColoredBold: return "\u{fb27}"
        case .wifiSignalGoodColoredLight: return "\u{fb28}"
        case .wifiSignalGoodColoredRegular: return "\u{fb29}"
        case .wifiSignalPoorColoredBold: return "\u{fb2a}"
        case .wifiSignalPoorColoredLight: return "\u{fb2b}"
        case .wifiSignalPoorColoredRegular: return "\u{fb2c}"
        case .wifiSignalUnstableColoredBold: return "\u{fb2d}"
        case .wifiSignalUnstableColoredLight: return "\u{fb2e}"
        case .wifiSignalUnstableColoredRegular: return "\u{fb2f}"
        case .windowCornerScrubBold: return "\u{fb30}"
        case .windowCornerScrubLight: return "\u{fb31}"
        case .windowCornerScrubRegular: return "\u{fb32}"
        case .windowRightCornerScrubBold: return "\u{fb33}"
        case .windowRightCornerScrubLight: return "\u{fb34}"
        case .windowRightCornerScrubRegular: return "\u{fb35}"
        case .windowVerticalScrubBold: return "\u{fb36}"
        case .windowVerticalScrubLight: return "\u{fb37}"
        case .windowVerticalScrubRegular: return "\u{fb38}"
        case .workflowDeploymentsBold: return "\u{fb39}"
        case .workflowDeploymentsFilled: return "\u{fb3a}"
        case .workflowDeploymentsLight: return "\u{fb3b}"
        case .workflowDeploymentsRegular: return "\u{fb3c}"
        case .workphoneBold: return "\u{fb3d}"
        case .workphoneLight: return "\u{fb3e}"
        case .workphoneRegular: return "\u{fb3f}"
        case .zoomInBold: return "\u{fb40}"
        case .zoomInLight: return "\u{fb41}"
        case .zoomInRegular: return "\u{fb42}"
        case .zoomOutBold: return "\u{fb43}"
        case .zoomOutLight: return "\u{fb44}"
        case .zoomOutRegular: return "\u{fb45}"
        case .zoom: return "\u{fb46}"
