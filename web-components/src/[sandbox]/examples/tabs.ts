...
export class DefaultDraggableTabs extends LitElement {
  ...
  @property({ type: Boolean }) tabDisabled = false;
  ...
  render() {
    ...
    <div>
      <md-tabs selected="0" justified>
        <md-tab ?disabled=${this.tabDisabled} aria-label="Contact History" slot="tab" label="History">
          <md-icon name="recents_16"></md-icon>
...
//     <div>
//       <md-tabs selected="0" justified>
//         <md-tab disabled aria-label="Contact History" slot="tab" label="History">
//           <md-icon name="recents_16"></md-icon>
