...
@objc public enum MomentumIconType: Int {
    ...
    public var ligature: String {
        ...
        case .queueContact20: return "\u{f981}"
        case .queueLookup16: return "\u{f982}"
        case .quiet16: return "\u{f983}"
        case .quiet20: return "\u{f984}"
        case .quiet32: return "\u{f985}"
        case .quiet8: return "\u{f986}"
        case .raiseHand12: return "\u{f987}"
        case .raiseHand16: return "\u{f988}"
        case .raiseHand20: return "\u{f989}"
        case .raiseHand24: return "\u{f98a}"
        case .reactions12: return "\u{f98b}"
        case .reactions16: return "\u{f98c}"
        case .reactions20: return "\u{f98d}"
        case .recents12: return "\u{f98e}"
        case .recents14: return "\u{f98f}"
        case .recents16: return "\u{f990}"
        case .recents18: return "\u{f991}"
        case .recents20: return "\u{f992}"
        case .recents24: return "\u{f993}"
        case .recents80: return "\u{f994}"
        case .recentsActive14: return "\u{f995}"
        case .recentsActive24: return "\u{f996}"
        case .recentsPresence12: return "\u{f997}"
        case .recentsPresence14: return "\u{f998}"
        case .recentsPresence24: return "\u{f999}"
        case .recentsPresence28: return "\u{f99a}"
        case .recentsPresence8: return "\u{f99b}"
        case .recentsPresenceStroke10: return "\u{f99c}"
        case .recentsPresenceStroke14: return "\u{f99d}"
        case .recentsPresenceStroke16: return "\u{f99e}"
        case .recentsPresenceStroke26: return "\u{f99f}"
        case .recentsPresenceStroke30: return "\u{f9a0}"
        case .record12: return "\u{f9a1}"
        case .record14: return "\u{f9a2}"
        case .record16: return "\u{f9a3}"
        case .record20: return "\u{f9a4}"
        case .record24: return "\u{f9a5}"
        case .record28: return "\u{f9a6}"
        case .recordActive12: return "\u{f9a7}"
        case .recordActive14: return "\u{f9a8}"
        case .recordActive16: return "\u{f9a9}"
        case .recordActive20: return "\u{f9aa}"
        case .recordActive24: return "\u{f9ab}"
        case .recordActiveBg12: return "\u{f9ac}"
        case .recordActiveBg14: return "\u{f9ad}"
        case .recordActiveBg16: return "\u{f9ae}"
        case .recordActiveBg20: return "\u{f9af}"
        case .recordActiveBg24: return "\u{f9b0}"
        case .recordActiveCircle12: return "\u{f9b1}"
        case .recordActiveCircle14: return "\u{f9b2}"
        case .recordActiveCircle16: return "\u{f9b3}"
        case .recordActiveCircle20: return "\u{f9b4}"
        case .recordActiveCircle24: return "\u{f9b5}"
        case .recurring12: return "\u{f9b6}"
        case .recurring14: return "\u{f9b7}"
        case .recurring16: return "\u{f9b8}"
        case .recurring20: return "\u{f9b9}"
        case .recurring24: return "\u{f9ba}"
        case .recurringOff12: return "\u{f9bb}"
        case .recurringOff16: return "\u{f9bc}"
        case .redial16: return "\u{f9bd}"
        case .redial20: return "\u{f9be}"
        case .redial24: return "\u{f9bf}"
        case .redo12: return "\u{f9c0}"
        case .redo14: return "\u{f9c1}"
        case .redo16: return "\u{f9c2}"
        case .refresh10: return "\u{f9c3}"
        case .refresh12: return "\u{f9c4}"
        case .refresh16: return "\u{f9c5}"
        case .refresh18: return "\u{f9c6}"
        case .refresh20: return "\u{f9c7}"
        case .refresh24: return "\u{f9c8}"
        case .remoteDesktopControl10: return "\u{f9c9}"
        case .remoteDesktopControl12: return "\u{f9ca}"
        case .remoteDesktopControl14: return "\u{f9cb}"
        case .remoteDesktopControl16: return "\u{f9cc}"
        case .remove12: return "\u{f9cd}"
        case .remove16: return "\u{f9ce}"
        case .remove20: return "\u{f9cf}"
        case .remove24: return "\u{f9d0}"
        case .reply10: return "\u{f9d1}"
        case .reply12: return "\u{f9d2}"
        case .reply16: return "\u{f9d3}"
        case .reply20: return "\u{f9d4}"
        case .reply24: return "\u{f9d5}"
        case .replyList12: return "\u{f9d6}"
        case .replyList16: return "\u{f9d7}"
        case .replyList20: return "\u{f9d8}"
        case .report16: return "\u{f9d9}"
        case .report28: return "\u{f9da}"
        case .reset16: return "\u{f9db}"
        case .reset24: return "\u{f9dc}"
        case .response16: return "\u{f9dd}"
        case .responsiveMobile16: return "\u{f9de}"
        case .retrieveCall14: return "\u{f9df}"
        case .retrieveCall16: return "\u{f9e0}"
        case .return12: return "\u{f9e1}"
        case .return16: return "\u{f9e2}"
        case .ringtone16: return "\u{f9e3}"
        case .ringtone24: return "\u{f9e4}"
        case .roomCalendar24: return "\u{f9e5}"
        case .roomLights16: return "\u{f9e6}"
        case .roomLights24: return "\u{f9e7}"
        case .rotateContent24: return "\u{f9e8}"
        case .rssCircle24: return "\u{f9e9}"
        case .rssCircle32: return "\u{f9ea}"
        case .rssCircle40: return "\u{f9eb}"
        case .runningApplication16: return "\u{f9ec}"
        case .runningApplication24: return "\u{f9ed}"
        case .save12: return "\u{f9ee}"
        case .save14: return "\u{f9ef}"
        case .save16: return "\u{f9f0}"
        case .save24: return "\u{f9f1}"
        case .scan20: return "\u{f9f2}"
        case .scan24: return "\u{f9f3}"
        case .screenToggle10: return "\u{f9f4}"
        case .screenToggle12: return "\u{f9f5}"
        case .screenToggle16: return "\u{f9f6}"
        case .screenToggle20: return "\u{f9f7}"
        case .screenToggle24: return "\u{f9f8}"
        case .screenshot12: return "\u{f9f9}"
        case .screenshot16: return "\u{f9fa}"
        case .screenshot20: return "\u{f9fb}"
        case .screenshot24: return "\u{f9fc}"
        case .search12: return "\u{f9fd}"
        case .search14: return "\u{f9fe}"
        case .search16: return "\u{f9ff}"
        case .search18: return "\u{fa00}"
        case .search20: return "\u{fa01}"
        case .search24: return "\u{fa02}"
        case .search28: return "\u{fa03}"
        case .secure10: return "\u{fa04}"
        case .secure12: return "\u{fa05}"
        case .secure14: return "\u{fa06}"
        case .secure16: return "\u{fa07}"
        case .secure20: return "\u{fa08}"
        case .secure24: return "\u{fa09}"
        case .secure28: return "\u{fa0a}"
        case .secure8: return "\u{fa0b}"
        case .secureActive12: return "\u{fa0c}"
        case .secureActive14: return "\u{fa0d}"
        case .secureActive16: return "\u{fa0e}"
        case .secureActive20: return "\u{fa0f}"
        case .secureActive24: return "\u{fa10}"
        case .secureActive28: return "\u{fa11}"
        case .secureActive8: return "\u{fa12}"
        case .secureBadge28: return "\u{fa13}"
        case .secureCircle14: return "\u{fa14}"
        case .secureCircle16: return "\u{fa15}"
        case .secureCircleActive14: return "\u{fa16}"
        case .secureCircleActive16: return "\u{fa17}"
        case .secureFips24: return "\u{fa18}"
        case .selfview16: return "\u{fa19}"
        case .selfview20: return "\u{fa1a}"
        case .selfview24: return "\u{fa1b}"
        case .send12: return "\u{fa1c}"
        case .send14: return "\u{fa1d}"
        case .send16: return "\u{fa1e}"
        case .send20: return "\u{fa1f}"
        case .send24: return "\u{fa20}"
        case .seperate12: return "\u{fa21}"
        case .seperate16: return "\u{fa22}"
        case .seperate20: return "\u{fa23}"
        case .seperate24: return "\u{fa24}"
        case .server16: return "\u{fa25}"
        case .server24: return "\u{fa26}"
        case .serverCircle100: return "\u{fa27}"
        case .serverError16: return "\u{fa28}"
        case .setVariable16: return "\u{fa29}"
        case .setVariable20: return "\u{fa2a}"
        case .settings10: return "\u{fa2b}"
        case .settings12: return "\u{fa2c}"
        case .settings14: return "\u{fa2d}"
        case .settings16: return "\u{fa2e}"
        case .settings18: return "\u{fa2f}"
        case .settings20: return "\u{fa30}"
        case .settings24: return "\u{fa31}"
        case .settings32: return "\u{fa32}"
        case .settings8: return "\u{fa33}"
        case .settingsActive10: return "\u{fa34}"
        case .settingsActive12: return "\u{fa35}"
        case .settingsActive14: return "\u{fa36}"
        case .settingsActive16: return "\u{fa37}"
        case .settingsActive18: return "\u{fa38}"
        case .settingsActive20: return "\u{fa39}"
        case .settingsActive24: return "\u{fa3a}"
        case .settingsActive32: return "\u{fa3b}"
        case .settingsActive8: return "\u{fa3c}"
        case .setupAssistant16: return "\u{fa3d}"
        case .shakeDevice18: return "\u{fa3e}"
        case .shakeDevice20: return "\u{fa3f}"
        case .shapeDiagonalArrowheadDual16: return "\u{fa40}"
        case .shapeDiagonalArrowheadSingle16: return "\u{fa41}"
        case .shapeDiagonalLine16: return "\u{fa42}"
        case .shapeOval16: return "\u{fa43}"
        case .shapeSquare16: return "\u{fa44}"
        case .share12: return "\u{fa45}"
        case .share14: return "\u{fa46}"
        case .share16: return "\u{fa47}"
        case .share18: return "\u{fa48}"
        case .share20: return "\u{fa49}"
        case .share24: return "\u{fa4a}"
        case .share28: return "\u{fa4b}"
        case .share32: return "\u{fa4c}"
        case .shareCNativeAdr12: return "\u{fa4d}"
        case .shareCNativeAdr14: return "\u{fa4e}"
        case .shareCNativeAdr16: return "\u{fa4f}"
        case .shareCNativeAdr24: return "\u{fa50}"
        case .shareCNativeIos10: return "\u{fa51}"
        case .shareCNativeIos12: return "\u{fa52}"
        case .shareCNativeIos14: return "\u{fa53}"
        case .shareCNativeIos16: return "\u{fa54}"
        case .shareCNativeIos20: return "\u{fa55}"
        case .shareCNativeIos28: return "\u{fa56}"
        case .shareCNativeIph10: return "\u{fa57}"
        case .shareCNativeIph12: return "\u{fa58}"
        case .shareCNativeIph14: return "\u{fa59}"
        case .shareCNativeIph16: return "\u{fa5a}"
        case .shareCNativeIph20: return "\u{fa5b}"
        case .shareCNativeIph24: return "\u{fa5c}"
        case .shareCNativeIph28: return "\u{fa5d}"
        case .shareScreen10: return "\u{fa5e}"
        case .shareScreen12: return "\u{fa5f}"
        case .shareScreen120: return "\u{fa60}"
        case .shareScreen124: return "\u{fa61}"
        case .shareScreen14: return "\u{fa62}"
        case .shareScreen16: return "\u{fa63}"
        case .shareScreen18: return "\u{fa64}"
        case .shareScreen20: return "\u{fa65}"
        case .shareScreen24: return "\u{fa66}"
        case .shareScreen26: return "\u{fa67}"
        case .shareScreen28: return "\u{fa68}"
        case .shareScreen32: return "\u{fa69}"
        case .shareScreen36: return "\u{fa6a}"
        case .shareScreen48: return "\u{fa6b}"
        case .shareScreen56: return "\u{fa6c}"
        case .shareScreen8: return "\u{fa6d}"
        case .shareScreenActive14: return "\u{fa6e}"
        case .shareScreenActive24: return "\u{fa6f}"
        case .shareScreenPresence12: return "\u{fa70}"
        case .shareScreenPresence14: return "\u{fa71}"
        case .shareScreenPresence28: return "\u{fa72}"
        case .shareScreenPresence8: return "\u{fa73}"
        case .shareScreenPresenceStroke12: return "\u{fa74}"
        case .shareScreenPresenceStroke14: return "\u{fa75}"
        case .shareScreenPresenceStroke16: return "\u{fa76}"
        case .shareScreenPresenceStroke26: return "\u{fa77}"
        case .shareScreenPresenceStroke30: return "\u{fa78}"
        case .shareSpace12: return "\u{fa79}"
        case .shareSpace14: return "\u{fa7a}"
        case .shareSpace18: return "\u{fa7b}"
        case .shareSpace20: return "\u{fa7c}"
        case .shareSpace24: return "\u{fa7d}"
        case .shield12: return "\u{fa7e}"
        case .shield14: return "\u{fa7f}"
        case .shield20: return "\u{fa80}"
        case .shield24: return "\u{fa81}"
        case .show12: return "\u{fa82}"
        case .show16: return "\u{fa83}"
        case .show20: return "\u{fa84}"
        case .show24: return "\u{fa85}"
        case .signIn16: return "\u{fa86}"
        case .signIn20: return "\u{fa87}"
        case .signIn24: return "\u{fa88}"
        case .signInForced16: return "\u{fa89}"
        case .signInForced24: return "\u{fa8a}"
        case .signOut10: return "\u{fa8b}"
        case .signOut12: return "\u{fa8c}"
        case .signOut16: return "\u{fa8d}"
        case .signOut20: return "\u{fa8e}"
        case .signOut24: return "\u{fa8f}"
        case .signal016: return "\u{fa90}"
        case .signal10012: return "\u{fa91}"
        case .signal10016: return "\u{fa92}"
        case .signal2516: return "\u{fa93}"
        case .signal5016: return "\u{fa94}"
        case .signal7516: return "\u{fa95}"
        case .singleNumberReach12: return "\u{fa96}"
        case .singleNumberReach14: return "\u{fa97}"
        case .singleNumberReach16: return "\u{fa98}"
        case .singleNumberReach20: return "\u{fa99}"
        case .skip10: return "\u{fa9a}"
        case .skip16: return "\u{fa9b}"
        case .skip24: return "\u{fa9c}"
        case .skipBw16: return "\u{fa9d}"
        case .skipBw24: return "\u{fa9e}"
        case .skipFw16: return "\u{fa9f}"
        case .skipFw24: return "\u{faa0}"
        case .sms12: return "\u{faa1}"
        case .sms16: return "\u{faa2}"
        case .sortDown16: return "\u{faa3}"
        case .sortDown20: return "\u{faa4}"
        case .sortDown24: return "\u{faa5}"
        case .sortUp20: return "\u{faa6}"
        case .sortUp24: return "\u{faa7}"
        case .space12: return "\u{faa8}"
        case .space16: return "\u{faa9}"
        case .spark16: return "\u{faaa}"
        case .sparkBoard12: return "\u{faab}"
        case .sparkBoard14: return "\u{faac}"
        case .sparkBoard16: return "\u{faad}"
        case .sparkBoard20: return "\u{faae}"
        case .sparkBoard24: return "\u{faaf}"
        case .sparkBoard28: return "\u{fab0}"
        case .sparkBoard32: return "\u{fab1}"
        case .sparkBoard48: return "\u{fab2}"
        case .sparkQuadCamera16: return "\u{fab3}"
        case .sparkQuadCamera20: return "\u{fab4}"
        case .sparkRoomKit16: return "\u{fab5}"
        case .sparkRoomKit20: return "\u{fab6}"
        case .sparkRoomKitPlus16: return "\u{fab7}"
        case .sparkRoomKitPlus20: return "\u{fab8}"
        case .sparkShare16: return "\u{fab9}"
        case .sparkShare20: return "\u{faba}"
        case .sparkVoice16: return "\u{fabb}"
        case .sparkVoice20: return "\u{fabc}"
        case .speaker12: return "\u{fabd}"
        case .speaker16: return "\u{fabe}"
        case .speaker20: return "\u{fabf}"
        case .speaker24: return "\u{fac0}"
        case .speaker28: return "\u{fac1}"
        case .speakerBluetooth16: return "\u{fac2}"
        case .speakerDisconnected12: return "\u{fac3}"
        case .speakerDisconnected14: return "\u{fac4}"
        case .speakerDisconnected16: return "\u{fac5}"
        case .speakerDisconnected20: return "\u{fac6}"
        case .speakerDisconnected24: return "\u{fac7}"
        case .speakerDisconnected28: return "\u{fac8}"
        case .speakerDisconnected36: return "\u{fac9}"
        case .speakerLineOutLeft16: return "\u{faca}"
        case .speakerLineOutRight16: return "\u{facb}"
        case .speakerMuted12: return "\u{facc}"
        case .speakerMuted14: return "\u{facd}"
        case .speakerMuted16: return "\u{face}"
        case .speakerMuted24: return "\u{facf}"
        case .speakerMuted28: return "\u{fad0}"
        case .speakerMuted32: return "\u{fad1}"
        case .speakerOff16: return "\u{fad2}"
        case .speakerOff24: return "\u{fad3}"
        case .speakerOff28: return "\u{fad4}"
        case .spinner12: return "\u{fad5}"
        case .spinner14: return "\u{fad6}"
        case .spinner16: return "\u{fad7}"
        case .spinner18: return "\u{fad8}"
        case .spinner20: return "\u{fad9}"
        case .spinner24: return "\u{fada}"
        case .spinner28: return "\u{fadb}"
        case .spinner32: return "\u{fadc}"
        case .spinner36: return "\u{fadd}"
        case .spinner40: return "\u{fade}"
        case .spinner48: return "\u{fadf}"
        case .spinner56: return "\u{fae0}"
        case .spinner72: return "\u{fae1}"
        case .spinner8: return "\u{fae2}"
        case .spinner80: return "\u{fae3}"
        case .spinner90: return "\u{fae4}"
        case .spreadsheet16: return "\u{fae5}"
        case .startChat20: return "\u{fae6}"
        case .startChat24: return "\u{fae7}"
        case .stickers16: return "\u{fae8}"
        case .stickers24: return "\u{fae9}"
        case .stickies12: return "\u{faea}"
        case .stickies16: return "\u{faeb}"
        case .stickies24: return "\u{faec}"
        case .stop10: return "\u{faed}"
        case .stop12: return "\u{faee}"
        case .stop16: return "\u{faef}"
        case .stop20: return "\u{faf0}"
        case .stop24: return "\u{faf1}"
        case .stopCircle12: return "\u{faf2}"
        case .stopCircle16: return "\u{faf3}"
        case .stopCircle20: return "\u{faf4}"
        case .stopCircle24: return "\u{faf5}"
        case .stopContentShare20: return "\u{faf6}"
        case .storedInfo12: return "\u{faf7}"
        case .storedInfo16: return "\u{faf8}"
        case .storedInfo20: return "\u{faf9}"
        case .storedInfo24: return "\u{fafa}"
        case .storedInfoActive12: return "\u{fafb}"
        case .storedInfoActive16: return "\u{fafc}"
        case .storedInfoActive20: return "\u{fafd}"
        case .storedInfoActive24: return "\u{fafe}"
        case .streaming16: return "\u{faff}"
        case .streaming20: return "\u{fb00}"
        case .streaming24: return "\u{fb01}"
        case .subscribe16: return "\u{fb02}"
        case .subscript12: return "\u{fb03}"
        case .subscript16: return "\u{fb04}"
        case .superscript12: return "\u{fb05}"
        case .superscript16: return "\u{fb06}"
        case .swift16: return "\u{fb07}"
        case .sx1016: return "\u{fb08}"
        case .sx1020: return "\u{fb09}"
        case .sx2016: return "\u{fb0a}"
        case .sx2020: return "\u{fb0b}"
        case .sx80Codec16: return "\u{fb0c}"
        case .sx80Codec20: return "\u{fb0d}"
        case .tablet12: return "\u{fb0e}"
        case .tablet16: return "\u{fb0f}"
        case .tablet24: return "\u{fb10}"
        case .tag12: return "\u{fb11}"
        case .tag16: return "\u{fb12}"
        case .tag20: return "\u{fb13}"
        case .tap20: return "\u{fb14}"
        case .tasks10: return "\u{fb15}"
        case .tasks12: return "\u{fb16}"
        case .tasks14: return "\u{fb17}"
        case .tasks16: return "\u{fb18}"
        case .tasks18: return "\u{fb19}"
        case .tasks20: return "\u{fb1a}"
        case .tasks24: return "\u{fb1b}"
        case .tasks26: return "\u{fb1c}"
        case .tasks28: return "\u{fb1d}"
        case .tasks32: return "\u{fb1e}"
        case .tasks36: return "\u{fb1f}"
        case .tasks8: return "\u{fb20}"
        case .team12: return "\u{fb21}"
        case .team14: return "\u{fb22}"
        case .team16: return "\u{fb23}"
        case .team18: return "\u{fb24}"
        case .team20: return "\u{fb25}"
        case .team24: return "\u{fb26}"
        case .team32: return "\u{fb27}"
        case .teamActive12: return "\u{fb28}"
        case .teamActive14: return "\u{fb29}"
        case .teamActive16: return "\u{fb2a}"
        case .teamActive18: return "\u{fb2b}"
        case .teamActive20: return "\u{fb2c}"
        case .teamActive24: return "\u{fb2d}"
        case .teamActive32: return "\u{fb2e}"
        case .teamNew24: return "\u{fb2f}"
        case .telepresence12: return "\u{fb30}"
        case .telepresence14: return "\u{fb31}"
        case .telepresence16: return "\u{fb32}"
        case .telepresence18: return "\u{fb33}"
        case .telepresence20: return "\u{fb34}"
        case .telepresence24: return "\u{fb35}"
        case .telepresence64: return "\u{fb36}"
        case .telepresenceAlert12: return "\u{fb37}"
        case .telepresenceIx500016: return "\u{fb38}"
        case .telepresenceIx500020: return "\u{fb39}"
        case .telepresenceMuted12: return "\u{fb3a}"
        case .telepresenceMuted64: return "\u{fb3b}"
        case .telepresenceMutedAlert12: return "\u{fb3c}"
        case .telepresencePrivate12: return "\u{fb3d}"
        case .text10: return "\u{fb3e}"
        case .text12: return "\u{fb3f}"
        case .text16: return "\u{fb40}"
        case .textAlignLeft16: return "\u{fb41}"
        case .textAlignRight16: return "\u{fb42}"
        case .textBlockquote12: return "\u{fb43}"
        case .textBlockquote16: return "\u{fb44}"
        case .textBlockquote18: return "\u{fb45}"
        case .textBlockquote20: return "\u{fb46}"
        case .textBlockquote8: return "\u{fb47}"
        case .textBold12: return "\u{fb48}"
        case .textBold16: return "\u{fb49}"
        case .textBold24: return "\u{fb4a}"
        case .textCodeBlock12: return "\u{fb4b}"
        case .textCodeBlock16: return "\u{fb4c}"
        case .textCodeBlock24: return "\u{fb4d}"
        case .textCodeInline12: return "\u{fb4e}"
        case .textCodeInline16: return "\u{fb4f}"
        case .textColor12: return "\u{fb50}"
        case .textColor16: return "\u{fb51}"
        case .textFormat10: return "\u{fb52}"
        case .textFormat12: return "\u{fb53}"
        case .textFormat16: return "\u{fb54}"
        case .textFormat20: return "\u{fb55}"
        case .textFormat24: return "\u{fb56}"
        case .textFormat8: return "\u{fb57}"
        case .textHeading112: return "\u{fb58}"
        case .textHeading116: return "\u{fb59}"
        case .textHeading212: return "\u{fb5a}"
        case .textHeading216: return "\u{fb5b}"
        case .textHeading312: return "\u{fb5c}"
        case .textHeading316: return "\u{fb5d}"
        case .textHighlight12: return "\u{fb5e}"
        case .textHighlight16: return "\u{fb5f}"
        case .textIndentDecrease12: return "\u{fb60}"
        case .textIndentIncrease12: return "\u{fb61}"
        case .textItalic12: return "\u{fb62}"
        case .textItalic16: return "\u{fb63}"
        case .textItalic24: return "\u{fb64}"
        case .textListBulleted10: return "\u{fb65}"
        case .textListBulleted12: return "\u{fb66}"
        case .textListBulleted16: return "\u{fb67}"
        case .textListBulleted24: return "\u{fb68}"
        case .textListBulleted8: return "\u{fb69}"
        case .textListNumbered12: return "\u{fb6a}"
        case .textListNumbered16: return "\u{fb6b}"
        case .textListNumbered24: return "\u{fb6c}"
        case .textListNumbered36: return "\u{fb6d}"
        case .textListNumbered40: return "\u{fb6e}"
        case .textStrikethrough12: return "\u{fb6f}"
        case .textStrikethrough16: return "\u{fb70}"
        case .textTable12: return "\u{fb71}"
        case .textTable16: return "\u{fb72}"
        case .textUnderline12: return "\u{fb73}"
        case .textUnderline16: return "\u{fb74}"
        case .textUnderline24: return "\u{fb75}"
        case .tooFast12: return "\u{fb76}"
        case .tooFast16: return "\u{fb77}"
        case .tooSlow12: return "\u{fb78}"
        case .tooSlow16: return "\u{fb79}"
        case .tools16: return "\u{fb7a}"
        case .tools20: return "\u{fb7b}"
        case .tools24: return "\u{fb7c}"
        case .tools28: return "\u{fb7d}"
        case .tools32: return "\u{fb7e}"
        case .touch16: return "\u{fb7f}"
        case .touch1024: return "\u{fb80}"
        case .transcript16: return "\u{fb81}"
        case .transcript20: return "\u{fb82}"
        case .twitter12: return "\u{fb83}"
        case .twitter16: return "\u{fb84}"
        case .twitterCircle24: return "\u{fb85}"
        case .twitterCircle32: return "\u{fb86}"
        case .twitterCircle40: return "\u{fb87}"
        case .ucmCloud10: return "\u{fb88}"
        case .ucmCloud16: return "\u{fb89}"
        case .ucmCloud24: return "\u{fb8a}"
        case .ucmCloud32: return "\u{fb8b}"
        case .undo12: return "\u{fb8c}"
        case .undo14: return "\u{fb8d}"
        case .undo16: return "\u{fb8e}"
        case .undo24: return "\u{fb8f}"
        case .unlink20: return "\u{fb90}"
        case .unreadBadge10: return "\u{fb91}"
        case .unreadBadge12: return "\u{fb92}"
        case .unreadBadge16: return "\u{fb93}"
        case .unreadBadge8: return "\u{fb94}"
        case .unsecure12: return "\u{fb95}"
        case .unsecure14: return "\u{fb96}"
        case .unsecure16: return "\u{fb97}"
        case .unsecure24: return "\u{fb98}"
        case .unsecure28: return "\u{fb99}"
        case .unsorted10: return "\u{fb9a}"
        case .unsorted16: return "\u{fb9b}"
        case .unsorted24: return "\u{fb9c}"
        case .upload12: return "\u{fb9d}"
        case .upload130: return "\u{fb9e}"
        case .upload14: return "\u{fb9f}"
        case .upload16: return "\u{fba0}"
        case .upload18: return "\u{fba1}"
        case .upload20: return "\u{fba2}"
        case .upload24: return "\u{fba3}"
        case .upload28: return "\u{fba4}"
        case .upload32: return "\u{fba5}"
        case .upload36: return "\u{fba6}"
        case .usb16: return "\u{fba7}"
        case .user16: return "\u{fba8}"
        case .user20: return "\u{fba9}"
        case .user24: return "\u{fbaa}"
        case .user56: return "\u{fbab}"
        case .videoEffect12: return "\u{fbac}"
        case .videoEffect16: return "\u{fbad}"
        case .videoLayout12: return "\u{fbae}"
        case .videoLayout16: return "\u{fbaf}"
        case .videoLayoutAuto12: return "\u{fbb0}"
        case .videoLayoutAuto16: return "\u{fbb1}"
        case .videoLayoutAuto20: return "\u{fbb2}"
        case .videoLayoutAuto24: return "\u{fbb3}"
        case .videoLayoutEqual12: return "\u{fbb4}"
        case .videoLayoutEqual14: return "\u{fbb5}"
        case .videoLayoutEqual16: return "\u{fbb6}"
        case .videoLayoutEqual20: return "\u{fbb7}"
        case .videoLayoutEqual24: return "\u{fbb8}"
        case .videoLayoutOverlay12: return "\u{fbb9}"
        case .videoLayoutOverlay16: return "\u{fbba}"
        case .videoLayoutOverlay20: return "\u{fbbb}"
        case .videoLayoutOverlay24: return "\u{fbbc}"
        case .videoLayoutProminent12: return "\u{fbbd}"
        case .videoLayoutProminent16: return "\u{fbbe}"
        case .videoLayoutProminent20: return "\u{fbbf}"
        case .videoLayoutProminent24: return "\u{fbc0}"
        case .videoLayoutShareDominant12: return "\u{fbc1}"
        case .videoLayoutShareDominant16: return "\u{fbc2}"
        case .videoLayoutShareDominant20: return "\u{fbc3}"
        case .videoLayoutShareDominant24: return "\u{fbc4}"
        case .videoLayoutSingle12: return "\u{fbc5}"
        case .videoLayoutSingle16: return "\u{fbc6}"
        case .videoLayoutSingle20: return "\u{fbc7}"
        case .videoLayoutVideoDominant12: return "\u{fbc8}"
        case .videoLayoutVideoDominant16: return "\u{fbc9}"
        case .videoLayoutVideoDominant20: return "\u{fbca}"
        case .videoLayoutVideoDominant24: return "\u{fbcb}"
        case .viewAll12: return "\u{fbcc}"
        case .viewAll14: return "\u{fbcd}"
        case .viewFeedMultiple16: return "\u{fbce}"
        case .viewFeedPanel16: return "\u{fbcf}"
        case .viewFeedSingle16: return "\u{fbd0}"
        case .viewList10: return "\u{fbd1}"
        case .viewList12: return "\u{fbd2}"
        case .viewList14: return "\u{fbd3}"
        case .viewList16: return "\u{fbd4}"
        case .viewList20: return "\u{fbd5}"
        case .viewList24: return "\u{fbd6}"
        case .viewList28: return "\u{fbd7}"
        case .viewListCircle100: return "\u{fbd8}"
        case .viewMixed12: return "\u{fbd9}"
        case .viewStack12: return "\u{fbda}"
        case .viewStack14: return "\u{fbdb}"
        case .viewStack20: return "\u{fbdc}"
        case .viewStack24: return "\u{fbdd}"
        case .viewThumbnail12: return "\u{fbde}"
        case .viewThumbnail14: return "\u{fbdf}"
        case .viewThumbnail16: return "\u{fbe0}"
        case .viewThumbnail20: return "\u{fbe1}"
        case .viewThumbnail24: return "\u{fbe2}"
        case .voice20: return "\u{fbe3}"
        case .voicemail10: return "\u{fbe4}"
        case .voicemail14: return "\u{fbe5}"
        case .voicemail16: return "\u{fbe6}"
        case .voicemail18: return "\u{fbe7}"
        case .voicemail20: return "\u{fbe8}"
        case .voicemail22: return "\u{fbe9}"
        case .voicemail24: return "\u{fbea}"
        case .voicemail28: return "\u{fbeb}"
        case .voicemail8: return "\u{fbec}"
        case .voicemailActive12: return "\u{fbed}"
        case .voicemailActive14: return "\u{fbee}"
        case .voicemailActive16: return "\u{fbef}"
        case .voicemailActive18: return "\u{fbf0}"
        case .voicemailActive20: return "\u{fbf1}"
        case .voicemailActive22: return "\u{fbf2}"
        case .voicemailActive24: return "\u{fbf3}"
        case .voicemailActive28: return "\u{fbf4}"
        case .wallpaper16: return "\u{fbf5}"
        case .wallpaper20: return "\u{fbf6}"
        case .wallpaper24: return "\u{fbf7}"
        case .wallpaper28: return "\u{fbf8}"
        case .wallpaper32: return "\u{fbf9}"
        case .warning100: return "\u{fbfa}"
        case .warning12: return "\u{fbfb}"
        case .warning14: return "\u{fbfc}"
        case .warning16: return "\u{fbfd}"
        case .warning20: return "\u{fbfe}"
        case .warning24: return "\u{fbff}"
        case .warning28: return "\u{fc00}"
        case .warning32: return "\u{fc01}"
        case .warning40: return "\u{fc02}"
        case .warning44: return "\u{fc03}"
        case .warning56: return "\u{fc04}"
        case .warning64: return "\u{fc05}"
        case .warning72: return "\u{fc06}"
        case .warningActive12: return "\u{fc07}"
        case .waveform20: return "\u{fc08}"
        case .webSharing16: return "\u{fc09}"
        case .webSharing24: return "\u{fc0a}"
        case .webex10: return "\u{fc0b}"
        case .webex16: return "\u{fc0c}"
        case .webex24: return "\u{fc0d}"
        case .webex48: return "\u{fc0e}"
        case .webexBoard12: return "\u{fc0f}"
        case .webexBoard14: return "\u{fc10}"
        case .webexBoard16: return "\u{fc11}"
        case .webexBoard20: return "\u{fc12}"
        case .webexBoard24: return "\u{fc13}"
        case .webexBoard28: return "\u{fc14}"
        case .webexBoard32: return "\u{fc15}"
        case .webexBoard48: return "\u{fc16}"
        case .webexCalling10: return "\u{fc17}"
        case .webexCalling12: return "\u{fc18}"
        case .webexCalling16: return "\u{fc19}"
        case .webexCalling18: return "\u{fc1a}"
        case .webexCalling20: return "\u{fc1b}"
        case .webexCalling24: return "\u{fc1c}"
        case .webexCodecPlus16: return "\u{fc1d}"
        case .webexCodecPlus20: return "\u{fc1e}"
        case .webexCommunity20: return "\u{fc1f}"
        case .webexInstantMeeting12: return "\u{fc20}"
        case .webexInstantMeeting14: return "\u{fc21}"
        case .webexInstantMeeting16: return "\u{fc22}"
        case .webexInstantMeeting20: return "\u{fc23}"
        case .webexInstantMeeting24: return "\u{fc24}"
        case .webexMeetings10: return "\u{fc25}"
        case .webexMeetings12: return "\u{fc26}"
        case .webexMeetings14: return "\u{fc27}"
        case .webexMeetings16: return "\u{fc28}"
        case .webexMeetings20: return "\u{fc29}"
        case .webexMeetings24: return "\u{fc2a}"
        case .webexMeetings48: return "\u{fc2b}"
        case .webexQuadCamera16: return "\u{fc2c}"
        case .webexQuadCamera20: return "\u{fc2d}"
        case .webexRoomKit16: return "\u{fc2e}"
        case .webexRoomKit20: return "\u{fc2f}"
        case .webexRoomKitPlus16: return "\u{fc30}"
        case .webexRoomKitPlus20: return "\u{fc31}"
        case .webexShare12: return "\u{fc32}"
        case .webexShare14: return "\u{fc33}"
        case .webexShare16: return "\u{fc34}"
        case .webexShare20: return "\u{fc35}"
        case .webexTeams10: return "\u{fc36}"
        case .webexTeams12: return "\u{fc37}"
        case .webexTeams14: return "\u{fc38}"
        case .webexTeams16: return "\u{fc39}"
        case .webexTeams18: return "\u{fc3a}"
        case .webexTeams20: return "\u{fc3b}"
        case .webexVoice16: return "\u{fc3c}"
        case .webexVoice20: return "\u{fc3d}"
        case .webpop12: return "\u{fc3e}"
        case .webpop16: return "\u{fc3f}"
        case .webpop20: return "\u{fc40}"
        case .webpop24: return "\u{fc41}"
        case .whatsApp12: return "\u{fc42}"
        case .whatsApp16: return "\u{fc43}"
        case .whiteboard10: return "\u{fc44}"
        case .whiteboard12: return "\u{fc45}"
        case .whiteboard14: return "\u{fc46}"
        case .whiteboard16: return "\u{fc47}"
        case .whiteboard20: return "\u{fc48}"
        case .whiteboard24: return "\u{fc49}"
        case .whiteboard26: return "\u{fc4a}"
        case .whiteboard28: return "\u{fc4b}"
        case .whiteboard32: return "\u{fc4c}"
        case .whiteboard36: return "\u{fc4d}"
        case .whiteboard8: return "\u{fc4e}"
        case .whiteboardContent16: return "\u{fc4f}"
        case .whiteboardContent24: return "\u{fc50}"
        case .widgetsAdr20: return "\u{fc51}"
        case .wifi12: return "\u{fc52}"
        case .wifi16: return "\u{fc53}"
        case .wifi20: return "\u{fc54}"
        case .wifi24: return "\u{fc55}"
        case .wifiError12: return "\u{fc56}"
        case .wifiError16: return "\u{fc57}"
        case .wikipedia16: return "\u{fc58}"
        case .windowCornerScrub16: return "\u{fc59}"
        case .windowVerticalScrub16: return "\u{fc5a}"
        case .youtubeCircle24: return "\u{fc5b}"
        case .youtubeCircle32: return "\u{fc5c}"
        case .youtubeCircle40: return "\u{fc5d}"
        case .zoomIn12: return "\u{fc5e}"
        case .zoomIn14: return "\u{fc5f}"
        case .zoomIn16: return "\u{fc60}"
        case .zoomIn20: return "\u{fc61}"
        case .zoomOut12: return "\u{fc62}"
        case .zoomOut14: return "\u{fc63}"
        case .zoomOut16: return "\u{fc64}"
        case .zoomOut20: return "\u{fc65}"
