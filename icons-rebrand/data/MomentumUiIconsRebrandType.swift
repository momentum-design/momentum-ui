...
@objc public enum MomentumIconsRebrandType: Int {
    ...
    public var ligature: String {
        ...
        case .microphoneMusicModeColoredBold: return "\u{f6a9}"
        case .microphoneMusicModeColoredLight: return "\u{f6aa}"
        case .microphoneMusicModeColoredRegular: return "\u{f6ab}"
        case .microphoneMutedBold: return "\u{f6ac}"
        case .microphoneMutedFilled: return "\u{f6ad}"
        case .microphoneMutedIndicatorFilled: return "\u{f6ae}"
        case .microphoneMutedLight: return "\u{f6af}"
        case .microphoneMutedRedBold: return "\u{f6b0}"
        case .microphoneMutedRedFilled: return "\u{f6b1}"
        case .microphoneMutedRedLight: return "\u{f6b2}"
        case .microphoneMutedRedRegular: return "\u{f6b3}"
        case .microphoneMutedRegular: return "\u{f6b4}"
        case .microphoneRegular: return "\u{f6b5}"
        case .minimizeBold: return "\u{f6b6}"
        case .minimizeLight: return "\u{f6b7}"
        case .minimizeRegular: return "\u{f6b8}"
        case .minusBold: return "\u{f6b9}"
        case .minusLight: return "\u{f6ba}"
        case .minusRegular: return "\u{f6bb}"
        case .mirrorBold: return "\u{f6bc}"
        case .mirrorFilled: return "\u{f6bd}"
        case .mirrorLight: return "\u{f6be}"
        case .mirrorRegular: return "\u{f6bf}"
        case .moderatorBold: return "\u{f6c0}"
        case .moderatorLight: return "\u{f6c1}"
        case .moderatorRegular: return "\u{f6c2}"
        case .monitoringBold: return "\u{f6c3}"
        case .monitoringLight: return "\u{f6c4}"
        case .monitoringRegular: return "\u{f6c5}"
        case .monthlyRecurringScheduleNodeBold: return "\u{f6c6}"
        case .monthlyRecurringScheduleNodeLight: return "\u{f6c7}"
        case .monthlyRecurringScheduleNodeRegular: return "\u{f6c8}"
        case .moreAdrBold: return "\u{f6c9}"
        case .moreAdrLight: return "\u{f6ca}"
        case .moreAdrRegular: return "\u{f6cb}"
        case .moreBold: return "\u{f6cc}"
        case .moreCircleBold: return "\u{f6cd}"
        case .moreCircleFilled: return "\u{f6ce}"
        case .moreCircleLight: return "\u{f6cf}"
        case .moreCircleRegular: return "\u{f6d0}"
        case .moreCirecleFilled: return "\u{f6d1}"
        case .moreLight: return "\u{f6d2}"
        case .moreRegular: return "\u{f6d3}"
        case .mouseCursorBold: return "\u{f6d4}"
        case .mouseCursorLight: return "\u{f6d5}"
        case .mouseCursorRegular: return "\u{f6d6}"
        case .moveCallInAdrBold: return "\u{f6d7}"
        case .moveCallInAdrLight: return "\u{f6d8}"
        case .moveCallInAdrRegular: return "\u{f6d9}"
        case .moveCallInIphBold: return "\u{f6da}"
        case .moveCallInIphLight: return "\u{f6db}"
        case .moveCallInIphRegular: return "\u{f6dc}"
        case .moveCallInLaptopBold: return "\u{f6dd}"
        case .moveCallInLaptopLight: return "\u{f6de}"
        case .moveCallInLaptopRegular: return "\u{f6df}"
        case .moveCallInOutAdrBold: return "\u{f6e0}"
        case .moveCallInOutAdrLight: return "\u{f6e1}"
        case .moveCallInOutAdrRegular: return "\u{f6e2}"
        case .moveCallInOutIphBold: return "\u{f6e3}"
        case .moveCallInOutIphLight: return "\u{f6e4}"
        case .moveCallInOutIphRegular: return "\u{f6e5}"
        case .moveCallInTabletBold: return "\u{f6e6}"
        case .moveCallInTabletLight: return "\u{f6e7}"
        case .moveCallInTabletRegular: return "\u{f6e8}"
        case .moveCallOutAdrBold: return "\u{f6e9}"
        case .moveCallOutAdrLight: return "\u{f6ea}"
        case .moveCallOutAdrRegular: return "\u{f6eb}"
        case .moveCallOutIphBold: return "\u{f6ec}"
        case .moveCallOutIphLight: return "\u{f6ed}"
        case .moveCallOutIphRegular: return "\u{f6ee}"
        case .moveCallOutLaptopBold: return "\u{f6ef}"
        case .moveCallOutLaptopLight: return "\u{f6f0}"
        case .moveCallOutLaptopRegular: return "\u{f6f1}"
        case .moveCallOutTabletBold: return "\u{f6f2}"
        case .moveCallOutTabletLight: return "\u{f6f3}"
        case .moveCallOutTabletRegular: return "\u{f6f4}"
        case .msTeams: return "\u{f6f5}"
        case .multilineChartBold: return "\u{f6f6}"
        case .multilineChartFilled: return "\u{f6f7}"
        case .multilineChartLight: return "\u{f6f8}"
        case .multilineChartRegular: return "\u{f6f9}"
        case .multimediaBold: return "\u{f6fa}"
        case .multimediaFilled: return "\u{f6fb}"
        case .multimediaLight: return "\u{f6fc}"
        case .multimediaRegular: return "\u{f6fd}"
        case .multipledDevicesBold: return "\u{f6fe}"
        case .multipledDevicesLight: return "\u{f6ff}"
        case .multipledDevicesRegular: return "\u{f700}"
        case .musicModeBold: return "\u{f701}"
        case .musicModeCircleBold: return "\u{f702}"
        case .musicModeCircleFilled: return "\u{f703}"
        case .musicModeCircleLight: return "\u{f704}"
        case .musicModeCircleRegular: return "\u{f705}"
        case .musicModeFilled: return "\u{f706}"
        case .musicModeLight: return "\u{f707}"
        case .musicModeRegular: return "\u{f708}"
        case .muteOnEntryBold: return "\u{f709}"
        case .muteOnEntryFilled: return "\u{f70a}"
        case .muteOnEntryLight: return "\u{f70b}"
        case .muteOnEntryRegular: return "\u{f70c}"
        case .newManagerBold: return "\u{f70d}"
        case .newManagerLight: return "\u{f70e}"
        case .newManagerRegular: return "\u{f70f}"
        case .newTitleBold: return "\u{f710}"
        case .newTitleLight: return "\u{f711}"
        case .newTitleRegular: return "\u{f712}"
        case .newVoicemailBold: return "\u{f713}"
        case .newVoicemailLight: return "\u{f714}"
        case .newVoicemailRegular: return "\u{f715}"
        case .newWhiteboardBold: return "\u{f716}"
        case .newWhiteboardLight: return "\u{f717}"
        case .newWhiteboardRegular: return "\u{f718}"
        case .nextBold: return "\u{f719}"
        case .nextLight: return "\u{f71a}"
        case .nextRegular: return "\u{f71b}"
        case .noDevicesBold: return "\u{f71c}"
        case .noDevicesLight: return "\u{f71d}"
        case .noDevicesRegular: return "\u{f71e}"
        case .noiseDetectedCanceledFilled: return "\u{f71f}"
        case .noiseDetectedFilled: return "\u{f720}"
        case .noiseNoneCanceledFilled: return "\u{f721}"
        case .noiseNoneFilled: return "\u{f722}"
        case .noiseRemovalBold: return "\u{f723}"
        case .noiseRemovalLight: return "\u{f724}"
        case .noiseRemovalRegular: return "\u{f725}"
        case .noteBold: return "\u{f726}"
        case .noteLight: return "\u{f727}"
        case .notePptBold: return "\u{f728}"
        case .notePptLight: return "\u{f729}"
        case .notePptRegular: return "\u{f72a}"
        case .noteRegular: return "\u{f72b}"
        case .notesBold: return "\u{f72c}"
        case .notesLight: return "\u{f72d}"
        case .notesRegular: return "\u{f72e}"
        case .numberBold: return "\u{f72f}"
        case .numberLight: return "\u{f730}"
        case .numberRegular: return "\u{f731}"
        case .oldRemoteBold: return "\u{f732}"
        case .oldRemoteLight: return "\u{f733}"
        case .oldRemoteRegular: return "\u{f734}"
        case .oldTouchBold: return "\u{f735}"
        case .oldTouchLight: return "\u{f736}"
        case .oldTouchRegular: return "\u{f737}"
        case .oneColumnBold: return "\u{f738}"
        case .oneColumnLight: return "\u{f739}"
        case .oneColumnRegular: return "\u{f73a}"
        case .openInFolderBold: return "\u{f73b}"
        case .openInFolderLight: return "\u{f73c}"
        case .openInFolderRegular: return "\u{f73d}"
        case .openPagesBold: return "\u{f73e}"
        case .openPagesLight: return "\u{f73f}"
        case .openPagesRegular: return "\u{f740}"
        case .otherNumberBold: return "\u{f741}"
        case .otherNumberLight: return "\u{f742}"
        case .otherNumberRegular: return "\u{f743}"
        case .otherNumberWarningBold: return "\u{f744}"
        case .otherNumberWarningLight: return "\u{f745}"
        case .otherNumberWarningRegular: return "\u{f746}"
        case .outgoingCallLegacyBold: return "\u{f747}"
        case .outgoingCallLegacyLight: return "\u{f748}"
        case .outgoingCallLegacyRegular: return "\u{f749}"
        case .overflowLeftBold: return "\u{f74a}"
        case .overflowLeftLight: return "\u{f74b}"
        case .overflowLeftRegular: return "\u{f74c}"
        case .overflowRightBold: return "\u{f74d}"
        case .overflowRightLight: return "\u{f74e}"
        case .overflowRightRegular: return "\u{f74f}"
        case .pairedCameraBold: return "\u{f750}"
        case .pairedCameraLight: return "\u{f751}"
        case .pairedCameraRegular: return "\u{f752}"
        case .pairedDeviceBold: return "\u{f753}"
        case .pairedDeviceLight: return "\u{f754}"
        case .pairedDeviceRegular: return "\u{f755}"
        case .pairedHandsetBold: return "\u{f756}"
        case .pairedHandsetLight: return "\u{f757}"
        case .pairedHandsetRegular: return "\u{f758}"
        case .pairingBold: return "\u{f759}"
        case .pairingLight: return "\u{f75a}"
        case .pairingRegular: return "\u{f75b}"
        case .parkedBold: return "\u{f75c}"
        case .parkedFilled: return "\u{f75d}"
        case .parkedLight: return "\u{f75e}"
        case .parkedRegular: return "\u{f75f}"
        case .parseBold: return "\u{f760}"
        case .parseLight: return "\u{f761}"
        case .parseRegular: return "\u{f762}"
        case .partialBold: return "\u{f763}"
        case .partialLight: return "\u{f764}"
        case .partialRegular: return "\u{f765}"
        case .participantAddBold: return "\u{f766}"
        case .participantAddLight: return "\u{f767}"
        case .participantAddRegular: return "\u{f768}"
        case .participantBlockedBold: return "\u{f769}"
        case .participantBlockedLight: return "\u{f76a}"
        case .participantBlockedRegular: return "\u{f76b}"
        case .participantBold: return "\u{f76c}"
        case .participantFilled: return "\u{f76d}"
        case .participantLight: return "\u{f76e}"
        case .participantListBold: return "\u{f76f}"
        case .participantListFilled: return "\u{f770}"
        case .participantListLight: return "\u{f771}"
        case .participantListRegular: return "\u{f772}"
        case .participantRegular: return "\u{f773}"
        case .participantRemoveBold: return "\u{f774}"
        case .participantRemoveLight: return "\u{f775}"
        case .participantRemoveRegular: return "\u{f776}"
        case .participantUnknownBold: return "\u{f777}"
        case .participantUnknownLight: return "\u{f778}"
        case .participantUnknownRegular: return "\u{f779}"
        case .passMouseBold: return "\u{f77a}"
        case .passMouseLight: return "\u{f77b}"
        case .passMouseRegular: return "\u{f77c}"
        case .pauseBold: return "\u{f77d}"
        case .pauseFilled: return "\u{f77e}"
        case .pauseLight: return "\u{f77f}"
        case .pauseRegular: return "\u{f780}"
        case .penBold: return "\u{f781}"
        case .penFilled: return "\u{f782}"
        case .penLight: return "\u{f783}"
        case .penRegular: return "\u{f784}"
        case .peopleBold: return "\u{f785}"
        case .peopleCircleBold: return "\u{f786}"
        case .peopleCircleFilled: return "\u{f787}"
        case .peopleCircleLight: return "\u{f788}"
        case .peopleCircleRegular: return "\u{f789}"
        case .peopleFilled: return "\u{f78a}"
        case .peopleInsightsFilled: return "\u{f78b}"
        case .peopleLight: return "\u{f78c}"
        case .peopleRegular: return "\u{f78d}"
        case .phoneAlertBold: return "\u{f78e}"
        case .phoneAlertLight: return "\u{f78f}"
        case .phoneAlertRegular: return "\u{f790}"
        case .phoneBold: return "\u{f791}"
        case .phoneFilled: return "\u{f792}"
        case .phoneLight: return "\u{f793}"
        case .phoneMutedBold: return "\u{f794}"
        case .phoneMutedLight: return "\u{f795}"
        case .phoneMutedRegular: return "\u{f796}"
        case .phonePrivateBold: return "\u{f797}"
        case .phonePrivateLight: return "\u{f798}"
        case .phonePrivateRegular: return "\u{f799}"
        case .phoneRegular: return "\u{f79a}"
        case .phoneReplyAllBold: return "\u{f79b}"
        case .phoneReplyAllLight: return "\u{f79c}"
        case .phoneReplyAllRegular: return "\u{f79d}"
        case .phoneReplyBold: return "\u{f79e}"
        case .phoneReplyLight: return "\u{f79f}"
        case .phoneReplyRegular: return "\u{f7a0}"
        case .phoneSmallFilled: return "\u{f7a1}"
        case .pickerBold: return "\u{f7a2}"
        case .pickerLight: return "\u{f7a3}"
        case .pickerRegular: return "\u{f7a4}"
        case .pictureInPictureBold: return "\u{f7a5}"
        case .pictureInPictureFilled: return "\u{f7a6}"
        case .pictureInPictureLight: return "\u{f7a7}"
        case .pictureInPictureRegular: return "\u{f7a8}"
        case .pieChartBold: return "\u{f7a9}"
        case .pieChartFilled: return "\u{f7aa}"
        case .pieChartLight: return "\u{f7ab}"
        case .pieChartRegular: return "\u{f7ac}"
        case .pinBold: return "\u{f7ad}"
        case .pinFilled: return "\u{f7ae}"
        case .pinLight: return "\u{f7af}"
        case .pinListActivityBold: return "\u{f7b0}"
        case .pinListActivityColoredBold: return "\u{f7b1}"
        case .pinListActivityColoredLight: return "\u{f7b2}"
        case .pinListActivityColoredRegular: return "\u{f7b3}"
        case .pinListActivityLight: return "\u{f7b4}"
        case .pinListActivityRegular: return "\u{f7b5}"
        case .pinListBold: return "\u{f7b6}"
        case .pinListLight: return "\u{f7b7}"
        case .pinListRegular: return "\u{f7b8}"
        case .pinMutedBold: return "\u{f7b9}"
        case .pinMutedFilled: return "\u{f7ba}"
        case .pinMutedLight: return "\u{f7bb}"
        case .pinMutedRegular: return "\u{f7bc}"
        case .pinRegular: return "\u{f7bd}"
        case .placeholderBold: return "\u{f7be}"
        case .placeholderLight: return "\u{f7bf}"
        case .placeholderRegular: return "\u{f7c0}"
        case .playBold: return "\u{f7c1}"
        case .playCircleBold: return "\u{f7c2}"
        case .playCircleFilled: return "\u{f7c3}"
        case .playCircleLight: return "\u{f7c4}"
        case .playCircleRegular: return "\u{f7c5}"
        case .playFilled: return "\u{f7c6}"
        case .playLight: return "\u{f7c7}"
        case .playRegular: return "\u{f7c8}"
        case .plugAcBold: return "\u{f7c9}"
        case .plugAcLight: return "\u{f7ca}"
        case .plugAcRegular: return "\u{f7cb}"
        case .plusBold: return "\u{f7cc}"
        case .plusCircleBold: return "\u{f7cd}"
        case .plusCircleFilled: return "\u{f7ce}"
        case .plusCircleLight: return "\u{f7cf}"
        case .plusCircleRegular: return "\u{f7d0}"
        case .plusLight: return "\u{f7d1}"
        case .plusRegular: return "\u{f7d2}"
        case .pmrBold: return "\u{f7d3}"
        case .pmrFilled: return "\u{f7d4}"
        case .pmrLight: return "\u{f7d5}"
        case .pmrRegular: return "\u{f7d6}"
        case .pollBold: return "\u{f7d7}"
        case .pollLight: return "\u{f7d8}"
        case .pollRegular: return "\u{f7d9}"
        case .popInBold: return "\u{f7da}"
        case .popInLight: return "\u{f7db}"
        case .popInRegular: return "\u{f7dc}"
        case .popOutBold: return "\u{f7dd}"
        case .popOutLight: return "\u{f7de}"
        case .popOutRegular: return "\u{f7df}"
        case .popUpBold: return "\u{f7e0}"
        case .popUpLight: return "\u{f7e1}"
        case .popUpRegular: return "\u{f7e2}"
        case .portraitLandscapeBold: return "\u{f7e3}"
        case .portraitLandscapeLight: return "\u{f7e4}"
        case .portraitLandscapeRegular: return "\u{f7e5}"
        case .powerAcBold: return "\u{f7e6}"
        case .powerAcLight: return "\u{f7e7}"
        case .powerAcRegular: return "\u{f7e8}"
        case .powerBold: return "\u{f7e9}"
        case .powerLight: return "\u{f7ea}"
        case .powerRegular: return "\u{f7eb}"
        case .preHeaderBold: return "\u{f7ec}"
        case .preHeaderLight: return "\u{f7ed}"
        case .preHeaderRegular: return "\u{f7ee}"
        case .presentationBold: return "\u{f7ef}"
        case .presentationLight: return "\u{f7f0}"
        case .presentationRegular: return "\u{f7f1}"
        case .primaryParticipantBold: return "\u{f7f2}"
        case .primaryParticipantLight: return "\u{f7f3}"
        case .primaryParticipantRegular: return "\u{f7f4}"
        case .printBold: return "\u{f7f5}"
        case .printLight: return "\u{f7f6}"
        case .printRegular: return "\u{f7f7}"
        case .priorityBadgeFilled: return "\u{f7f8}"
        case .priorityCircleBold: return "\u{f7f9}"
        case .priorityCircleFilled: return "\u{f7fa}"
        case .priorityCircleLight: return "\u{f7fb}"
        case .priorityCircleRegular: return "\u{f7fc}"
        case .priorityCircleTwoBold: return "\u{f7fd}"
        case .priorityCircleTwoFilled: return "\u{f7fe}"
        case .priorityCircleTwoLight: return "\u{f7ff}"
        case .priorityCircleTwoRegular: return "\u{f800}"
        case .privacyCircleBold: return "\u{f801}"
        case .privacyCircleFilled: return "\u{f802}"
        case .privacyCircleLight: return "\u{f803}"
        case .privacyCircleRegular: return "\u{f804}"
        case .privateBold: return "\u{f805}"
        case .privateCircleBold: return "\u{f806}"
        case .privateCircleFilled: return "\u{f807}"
        case .privateCircleLight: return "\u{f808}"
        case .privateCircleRegular: return "\u{f809}"
        case .privateLight: return "\u{f80a}"
        case .privateMeetingBold: return "\u{f80b}"
        case .privateMeetingLight: return "\u{f80c}"
        case .privateMeetingRegular: return "\u{f80d}"
        case .privateRegular: return "\u{f80e}"
        case .productDemoBold: return "\u{f80f}"
        case .productDemoLight: return "\u{f810}"
        case .productDemoRegular: return "\u{f811}"
        case .proximityBold: return "\u{f812}"
        case .proximityLight: return "\u{f813}"
        case .proximityMutedBold: return "\u{f814}"
        case .proximityMutedLight: return "\u{f815}"
        case .proximityMutedRegular: return "\u{f816}"
        case .proximityRegular: return "\u{f817}"
        case .proximityVideoBold: return "\u{f818}"
        case .proximityVideoLight: return "\u{f819}"
        case .proximityVideoRegular: return "\u{f81a}"
        case .ptoPresenceBold: return "\u{f81b}"
        case .ptoPresenceFilled: return "\u{f81c}"
        case .ptoPresenceLight: return "\u{f81d}"
        case .ptoPresenceRegular: return "\u{f81e}"
        case .pullCallBold: return "\u{f81f}"
        case .pullCallLight: return "\u{f820}"
        case .pullCallRegular: return "\u{f821}"
        case .qABold: return "\u{f822}"
        case .qALight: return "\u{f823}"
        case .qARegular: return "\u{f824}"
        case .qualityBold: return "\u{f825}"
        case .qualityLight: return "\u{f826}"
        case .qualityRegular: return "\u{f827}"
        case .queueContactBold: return "\u{f828}"
        case .queueContactLight: return "\u{f829}"
        case .queueContactRegular: return "\u{f82a}"
        case .quietBold: return "\u{f82b}"
        case .quietHoursPresenceBold: return "\u{f82c}"
        case .quietHoursPresenceFilled: return "\u{f82d}"
        case .quietHoursPresenceLight: return "\u{f82e}"
        case .quietHoursPresenceRegular: return "\u{f82f}"
        case .quietLight: return "\u{f830}"
        case .quietRegular: return "\u{f831}"
        case .radioButtonGroupBold: return "\u{f832}"
        case .radioButtonGroupLight: return "\u{f833}"
        case .radioButtonGroupRegular: return "\u{f834}"
        case .raiseHandBold: return "\u{f835}"
        case .raiseHandCircleFilled: return "\u{f836}"
        case .raiseHandFilled: return "\u{f837}"
        case .raiseHandLight: return "\u{f838}"
        case .raiseHandRegular: return "\u{f839}"
        case .ramBold: return "\u{f83a}"
        case .ramLight: return "\u{f83b}"
        case .ramRegular: return "\u{f83c}"
        case .reactionsBold: return "\u{f83d}"
        case .reactionsFilled: return "\u{f83e}"
        case .reactionsLight: return "\u{f83f}"
        case .reactionsRegular: return "\u{f840}"
        case .reactivateBold: return "\u{f841}"
        case .reactivateLight: return "\u{f842}"
        case .reactivateRegular: return "\u{f843}"
        case .recentsBold: return "\u{f844}"
        case .recentsFilled: return "\u{f845}"
        case .recentsLight: return "\u{f846}"
        case .recentsPresenceBold: return "\u{f847}"
        case .recentsPresenceFilled: return "\u{f848}"
        case .recentsPresenceLight: return "\u{f849}"
        case .recentsPresenceRegular: return "\u{f84a}"
        case .recentsPresenceSmallFilled: return "\u{f84b}"
        case .recentsRegular: return "\u{f84c}"
        case .recordActiveBold: return "\u{f84d}"
        case .recordActiveFilled: return "\u{f84e}"
        case .recordActiveLight: return "\u{f84f}"
        case .recordActiveRegular: return "\u{f850}"
        case .recordBold: return "\u{f851}"
        case .recordFilled: return "\u{f852}"
        case .recordLight: return "\u{f853}"
        case .recordPausedBold: return "\u{f854}"
        case .recordPausedFilled: return "\u{f855}"
        case .recordPausedLight: return "\u{f856}"
        case .recordPausedRegular: return "\u{f857}"
        case .recordRegular: return "\u{f858}"
        case .recurringBold: return "\u{f859}"
        case .recurringLight: return "\u{f85a}"
        case .recurringOffBold: return "\u{f85b}"
        case .recurringOffLight: return "\u{f85c}"
        case .recurringOffRegular: return "\u{f85d}"
        case .recurringRegular: return "\u{f85e}"
        case .redialBold: return "\u{f85f}"
        case .redialLight: return "\u{f860}"
        case .redialRegular: return "\u{f861}"
        case .redoBold: return "\u{f862}"
        case .redoLight: return "\u{f863}"
        case .redoRegular: return "\u{f864}"
        case .refreshBold: return "\u{f865}"
        case .refreshLight: return "\u{f866}"
        case .refreshRegular: return "\u{f867}"
        case .remoteCallBold: return "\u{f868}"
        case .remoteCallFilled: return "\u{f869}"
        case .remoteCallLight: return "\u{f86a}"
        case .remoteCallRegular: return "\u{f86b}"
        case .remoteDesktopControlBold: return "\u{f86c}"
        case .remoteDesktopControlFilled: return "\u{f86d}"
        case .remoteDesktopControlLight: return "\u{f86e}"
        case .remoteDesktopControlRegular: return "\u{f86f}"
        case .removeBold: return "\u{f870}"
        case .removeFilled: return "\u{f871}"
        case .removeLight: return "\u{f872}"
        case .removeRegular: return "\u{f873}"
        case .replyBold: return "\u{f874}"
        case .replyFilled: return "\u{f875}"
        case .replyLight: return "\u{f876}"
        case .replyListBold: return "\u{f877}"
        case .replyListLight: return "\u{f878}"
        case .replyListRegular: return "\u{f879}"
        case .replyPrivatelyBold: return "\u{f87a}"
        case .replyPrivatelyLight: return "\u{f87b}"
        case .replyPrivatelyRegular: return "\u{f87c}"
        case .replyRegular: return "\u{f87d}"
        case .resetBold: return "\u{f87e}"
        case .resetLight: return "\u{f87f}"
        case .resetRegular: return "\u{f880}"
        case .responsiveMobileBold: return "\u{f881}"
        case .responsiveMobileLight: return "\u{f882}"
        case .responsiveMobileRegular: return "\u{f883}"
        case .restartBold: return "\u{f884}"
        case .restartLight: return "\u{f885}"
        case .restartRegular: return "\u{f886}"
        case .retrieveCallBold: return "\u{f887}"
        case .retrieveCallLight: return "\u{f888}"
        case .retrieveCallRegular: return "\u{f889}"
        case .returnBold: return "\u{f88a}"
        case .returnLight: return "\u{f88b}"
        case .returnRegular: return "\u{f88c}"
        case .ringtoneBold: return "\u{f88d}"
        case .ringtoneLight: return "\u{f88e}"
        case .ringtoneRegular: return "\u{f88f}"
        case .roomCalendarBold: return "\u{f890}"
        case .roomCalendarLight: return "\u{f891}"
        case .roomCalendarRegular: return "\u{f892}"
        case .roomLightsBold: return "\u{f893}"
        case .roomLightsFilled: return "\u{f894}"
        case .roomLightsLight: return "\u{f895}"
        case .roomLightsRegular: return "\u{f896}"
        case .rotateContentBold: return "\u{f897}"
        case .rotateContentFilled: return "\u{f898}"
        case .rotateContentLight: return "\u{f899}"
        case .rotateContentRegular: return "\u{f89a}"
        case .ruleBasedBold: return "\u{f89b}"
        case .ruleBasedLight: return "\u{f89c}"
        case .ruleBasedRegular: return "\u{f89d}"
        case .runningApplicationBold: return "\u{f89e}"
        case .runningApplicationFilled: return "\u{f89f}"
        case .runningApplicationLight: return "\u{f8a0}"
        case .runningApplicationRegular: return "\u{f8a1}"
        case .saveBold: return "\u{f8a2}"
        case .saveLight: return "\u{f8a3}"
        case .saveRegular: return "\u{f8a4}"
        case .saveTranscriptBold: return "\u{f8a5}"
        case .saveTranscriptFilled: return "\u{f8a6}"
        case .saveTranscriptLight: return "\u{f8a7}"
        case .saveTranscriptRegular: return "\u{f8a8}"
        case .scanBold: return "\u{f8a9}"
        case .scanLight: return "\u{f8aa}"
        case .scanRegular: return "\u{f8ab}"
        case .schedulerAvailableBold: return "\u{f8ac}"
        case .schedulerAvailableLight: return "\u{f8ad}"
        case .schedulerAvailableRegular: return "\u{f8ae}"
        case .schedulerNotWorkingHoursBold: return "\u{f8af}"
        case .schedulerNotWorkingHoursLight: return "\u{f8b0}"
        case .schedulerNotWorkingHoursRegular: return "\u{f8b1}"
        case .schedulerUnavailableBold: return "\u{f8b2}"
        case .schedulerUnavailableLight: return "\u{f8b3}"
        case .schedulerUnavailableRegular: return "\u{f8b4}"
        case .schedulerUnknownBold: return "\u{f8b5}"
        case .schedulerUnknownLight: return "\u{f8b6}"
        case .schedulerUnknownRegular: return "\u{f8b7}"
        case .screenshotBold: return "\u{f8b8}"
        case .screenshotDocBold: return "\u{f8b9}"
        case .screenshotDocFilled: return "\u{f8ba}"
        case .screenshotDocLight: return "\u{f8bb}"
        case .screenshotDocRegular: return "\u{f8bc}"
        case .screenshotLight: return "\u{f8bd}"
        case .screenshotRegular: return "\u{f8be}"
        case .searchBold: return "\u{f8bf}"
        case .searchFilled: return "\u{f8c0}"
        case .searchLight: return "\u{f8c1}"
        case .searchRegular: return "\u{f8c2}"
        case .secondaryArrowBold: return "\u{f8c3}"
        case .secondaryArrowLight: return "\u{f8c4}"
        case .secondaryArrowRegular: return "\u{f8c5}"
        case .secureCallLockBold: return "\u{f8c6}"
        case .secureCallLockFilled: return "\u{f8c7}"
        case .secureCallLockLight: return "\u{f8c8}"
        case .secureCallLockRegular: return "\u{f8c9}"
        case .secureCallShieldBold: return "\u{f8ca}"
        case .secureCallShieldFilled: return "\u{f8cb}"
        case .secureCallShieldLight: return "\u{f8cc}"
        case .secureCallShieldRegular: return "\u{f8cd}"
        case .secureCircleBold: return "\u{f8ce}"
        case .secureCircleFilled: return "\u{f8cf}"
        case .secureCircleLight: return "\u{f8d0}"
        case .secureCircleRegular: return "\u{f8d1}"
        case .secureLockBold: return "\u{f8d2}"
        case .secureLockFilled: return "\u{f8d3}"
        case .secureLockLight: return "\u{f8d4}"
        case .secureLockRegular: return "\u{f8d5}"
        case .segmentExcludeFilled: return "\u{f8d6}"
        case .segmentFilterFilled: return "\u{f8d7}"
        case .segmentIncludeFilled: return "\u{f8d8}"
        case .selectAllBold: return "\u{f8d9}"
        case .selectAllFilled: return "\u{f8da}"
        case .selectAllLight: return "\u{f8db}"
        case .selectAllRegular: return "\u{f8dc}"
        case .selectionBold: return "\u{f8dd}"
        case .selectionLight: return "\u{f8de}"
        case .selectionRegular: return "\u{f8df}"
        case .sendBold: return "\u{f8e0}"
        case .sendFilled: return "\u{f8e1}"
        case .sendLight: return "\u{f8e2}"
        case .sendRegular: return "\u{f8e3}"
        case .serverBold: return "\u{f8e4}"
        case .serverErrorBold: return "\u{f8e5}"
        case .serverErrorLight: return "\u{f8e6}"
        case .serverErrorRegular: return "\u{f8e7}"
        case .serverLight: return "\u{f8e8}"
        case .serverRegular: return "\u{f8e9}"
        case .servicesBold: return "\u{f8ea}"
        case .servicesLight: return "\u{f8eb}"
        case .servicesRegular: return "\u{f8ec}"
        case .setVariableBold: return "\u{f8ed}"
        case .setVariableLight: return "\u{f8ee}"
        case .setVariableRegular: return "\u{f8ef}"
        case .settingsBold: return "\u{f8f0}"
        case .settingsFilled: return "\u{f8f1}"
        case .settingsLight: return "\u{f8f2}"
        case .settingsRegular: return "\u{f8f3}"
        case .setupAssistantBold: return "\u{f8f4}"
        case .setupAssistantLight: return "\u{f8f5}"
        case .setupAssistantRegular: return "\u{f8f6}"
        case .sftpBold: return "\u{f8f7}"
        case .sftpLight: return "\u{f8f8}"
        case .sftpRegular: return "\u{f8f9}"
        case .shapeCircleBold: return "\u{f8fa}"
        case .shapeCircleFilled: return "\u{f8fb}"
        case .shapeCircleLight: return "\u{f8fc}"
        case .shapeCircleRegular: return "\u{f8fd}"
        case .shapeDiagonalLineBold: return "\u{f8fe}"
        case .shapeDiagonalLineLight: return "\u{f8ff}"
        case .shapeDiagonalLineRegular: return "\u{f900}"
        case .shapeDiamondBold: return "\u{f901}"
        case .shapeDiamondFilled: return "\u{f902}"
        case .shapeDiamondLight: return "\u{f903}"
        case .shapeDiamondRegular: return "\u{f904}"
        case .shapeOvalBold: return "\u{f905}"
        case .shapeOvalLight: return "\u{f906}"
        case .shapeOvalRegular: return "\u{f907}"
        case .shapeSquareBold: return "\u{f908}"
        case .shapeSquareFilled: return "\u{f909}"
        case .shapeSquareLight: return "\u{f90a}"
        case .shapeSquareRegular: return "\u{f90b}"
        case .shapeTriangleBold: return "\u{f90c}"
        case .shapeTriangleFilled: return "\u{f90d}"
        case .shapeTriangleLight: return "\u{f90e}"
        case .shapeTriangleRegular: return "\u{f90f}"
        case .shapesBold: return "\u{f910}"
        case .shapesLight: return "\u{f911}"
        case .shapesRegular: return "\u{f912}"
        case .shareCNativeAdrBold: return "\u{f913}"
        case .shareCNativeAdrFilled: return "\u{f914}"
        case .shareCNativeAdrLight: return "\u{f915}"
        case .shareCNativeAdrRegular: return "\u{f916}"
        case .shareCNativeIphBold: return "\u{f917}"
        case .shareCNativeIphLight: return "\u{f918}"
        case .shareCNativeIphRegular: return "\u{f919}"
        case .shareScreenBold: return "\u{f91a}"
        case .shareScreenFilled: return "\u{f91b}"
        case .shareScreenLight: return "\u{f91c}"
        case .shareScreenRegular: return "\u{f91d}"
        case .shareScreenSmallFilled: return "\u{f91e}"
        case .shareSpaceBold: return "\u{f91f}"
        case .shareSpaceLight: return "\u{f920}"
        case .shareSpaceRegular: return "\u{f921}"
        case .shieldBold: return "\u{f922}"
        case .shieldLight: return "\u{f923}"
        case .shieldRegular: return "\u{f924}"
        case .shoppingCartBold: return "\u{f925}"
        case .shoppingCartFilled: return "\u{f926}"
        case .shoppingCartLight: return "\u{f927}"
        case .shoppingCartRegular: return "\u{f928}"
        case .shortTextBoxBold: return "\u{f929}"
        case .shortTextBoxLight: return "\u{f92a}"
        case .shortTextBoxRegular: return "\u{f92b}"
        case .showBold: return "\u{f92c}"
        case .showFilled: return "\u{f92d}"
        case .showLight: return "\u{f92e}"
        case .showRegular: return "\u{f92f}"
        case .signInBold: return "\u{f930}"
        case .signInFilled: return "\u{f931}"
        case .signInForcedBold: return "\u{f932}"
        case .signInForcedLight: return "\u{f933}"
        case .signInForcedRegular: return "\u{f934}"
        case .signInLight: return "\u{f935}"
        case .signInRegular: return "\u{f936}"
        case .signOutBold: return "\u{f937}"
        case .signOutLight: return "\u{f938}"
        case .signOutRegular: return "\u{f939}"
        case .signal0Bold: return "\u{f93a}"
        case .signal0Light: return "\u{f93b}"
        case .signal0Regular: return "\u{f93c}"
        case .signal100Bold: return "\u{f93d}"
        case .signal100Light: return "\u{f93e}"
        case .signal100Regular: return "\u{f93f}"
        case .signal25Bold: return "\u{f940}"
        case .signal25Light: return "\u{f941}"
        case .signal25Regular: return "\u{f942}"
        case .signal50Bold: return "\u{f943}"
        case .signal50Light: return "\u{f944}"
        case .signal50Regular: return "\u{f945}"
        case .signal75Bold: return "\u{f946}"
        case .signal75Light: return "\u{f947}"
        case .signal75Regular: return "\u{f948}"
        case .simplePromotionBold: return "\u{f949}"
        case .simplePromotionLight: return "\u{f94a}"
        case .simplePromotionRegular: return "\u{f94b}"
        case .singleNumberReachBold: return "\u{f94c}"
        case .singleNumberReachLight: return "\u{f94d}"
        case .singleNumberReachRegular: return "\u{f94e}"
        case .sipRegistrationInProgressBold: return "\u{f94f}"
        case .sipRegistrationInProgressFilled: return "\u{f950}"
        case .sipRegistrationInProgressLight: return "\u{f951}"
        case .sipRegistrationInProgressRegular: return "\u{f952}"
        case .skipBold: return "\u{f953}"
        case .skipBwBold: return "\u{f954}"
        case .skipBwFilled: return "\u{f955}"
        case .skipBwLight: return "\u{f956}"
        case .skipBwRegular: return "\u{f957}"
        case .skipFwBold: return "\u{f958}"
        case .skipFwFilled: return "\u{f959}"
        case .skipFwLight: return "\u{f95a}"
        case .skipFwRegular: return "\u{f95b}"
        case .skipLight: return "\u{f95c}"
        case .skipRegular: return "\u{f95d}"
        case .smsInboundBold: return "\u{f95e}"
        case .smsInboundLight: return "\u{f95f}"
        case .smsInboundRegular: return "\u{f960}"
        case .smsMessageBold: return "\u{f961}"
        case .smsMessageFilled: return "\u{f962}"
        case .smsMessageLight: return "\u{f963}"
        case .smsMessageRegular: return "\u{f964}"
        case .socialAlexaFilled: return "\u{f965}"
        case .socialFacebookColoredFilled: return "\u{f966}"
        case .socialFacebookFilled: return "\u{f967}"
        case .socialFbmessengerColoredFilled: return "\u{f968}"
        case .socialFbmessengerFilled: return "\u{f969}"
        case .socialInstagramBold: return "\u{f96a}"
        case .socialMicrosoftColoredFilled: return "\u{f96b}"
        case .socialMicrosoftFilled: return "\u{f96c}"
        case .socialMmsFilled: return "\u{f96d}"
        case .socialMmsGoldFilled: return "\u{f96e}"
        case .socialSmsFilled: return "\u{f96f}"
        case .socialSmsMintFilled: return "\u{f970}"
        case .socialTwitterColoredFilled: return "\u{f971}"
        case .socialTwitterFilled: return "\u{f972}"
        case .socialViberBold: return "\u{f973}"
        case .socialViberColoredBold: return "\u{f974}"
        case .socialWhatsappBold: return "\u{f975}"
        case .socialWhatsappColoredFilled: return "\u{f976}"
        case .sortAscendingBold: return "\u{f977}"
        case .sortAscendingLight: return "\u{f978}"
        case .sortAscendingRegular: return "\u{f979}"
        case .sortDescendingBold: return "\u{f97a}"
        case .sortDescendingLight: return "\u{f97b}"
        case .sortDescendingRegular: return "\u{f97c}"
        case .soundDefaultBold: return "\u{f97d}"
        case .soundDefaultLight: return "\u{f97e}"
        case .soundDefaultRegular: return "\u{f97f}"
        case .speakerBold: return "\u{f980}"
        case .speakerDisconnectedBold: return "\u{f981}"
        case .speakerDisconnectedFilled: return "\u{f982}"
        case .speakerDisconnectedLight: return "\u{f983}"
        case .speakerDisconnectedRegular: return "\u{f984}"
        case .speakerFilled: return "\u{f985}"
        case .speakerLight: return "\u{f986}"
        case .speakerMutedBold: return "\u{f987}"
        case .speakerMutedFilled: return "\u{f988}"
        case .speakerMutedLight: return "\u{f989}"
        case .speakerMutedRegular: return "\u{f98a}"
        case .speakerOffBold: return "\u{f98b}"
        case .speakerOffFilled: return "\u{f98c}"
        case .speakerOffLight: return "\u{f98d}"
        case .speakerOffRegular: return "\u{f98e}"
        case .speakerOnColoredBold: return "\u{f98f}"
        case .speakerOnColoredLight: return "\u{f990}"
        case .speakerOnColoredRegular: return "\u{f991}"
        case .speakerRegular: return "\u{f992}"
        case .speakerTurnDownBold: return "\u{f993}"
        case .speakerTurnDownFilled: return "\u{f994}"
        case .speakerTurnDownLight: return "\u{f995}"
        case .speakerTurnDownRegular: return "\u{f996}"
        case .speakerTurnUpBold: return "\u{f997}"
        case .speakerTurnUpFilled: return "\u{f998}"
        case .speakerTurnUpLight: return "\u{f999}"
        case .speakerTurnUpRegular: return "\u{f99a}"
        case .spellCheckerBold: return "\u{f99b}"
        case .spellCheckerLight: return "\u{f99c}"
        case .spellCheckerRegular: return "\u{f99d}"
        case .spinnerBold: return "\u{f99e}"
        case .spinnerFilledBold: return "\u{f99f}"
        case .spinnerFilledLight: return "\u{f9a0}"
        case .spinnerFilledRegular: return "\u{f9a1}"
        case .spinnerLight: return "\u{f9a2}"
        case .spinnerPartialBold: return "\u{f9a3}"
        case .spinnerPartialLight: return "\u{f9a4}"
        case .spinnerPartialRegular: return "\u{f9a5}"
        case .spinnerRegular: return "\u{f9a6}"
        case .stackedArea100ChartBold: return "\u{f9a7}"
        case .stackedArea100ChartFilled: return "\u{f9a8}"
        case .stackedArea100ChartLight: return "\u{f9a9}"
        case .stackedArea100ChartRegular: return "\u{f9aa}"
        case .stackedAreaChartBold: return "\u{f9ab}"
        case .stackedAreaChartFilled: return "\u{f9ac}"
        case .stackedAreaChartLight: return "\u{f9ad}"
        case .stackedAreaChartRegular: return "\u{f9ae}"
        case .stackedBar100ChartBold: return "\u{f9af}"
        case .stackedBar100ChartFilled: return "\u{f9b0}"
        case .stackedBar100ChartLight: return "\u{f9b1}"
        case .stackedBar100ChartRegular: return "\u{f9b2}"
        case .stackedBarChartBold: return "\u{f9b3}"
        case .stackedBarChartFilled: return "\u{f9b4}"
        case .stackedBarChartLight: return "\u{f9b5}"
        case .stackedBarChartRegular: return "\u{f9b6}"
        case .startChatBold: return "\u{f9b7}"
        case .startChatLight: return "\u{f9b8}"
        case .startChatRegular: return "\u{f9b9}"
        case .stethoscopeBold: return "\u{f9ba}"
        case .stethoscopeLight: return "\u{f9bb}"
        case .stethoscopeRegular: return "\u{f9bc}"
        case .stickersBold: return "\u{f9bd}"
        case .stickersLight: return "\u{f9be}"
        case .stickersRegular: return "\u{f9bf}"
        case .stickiesBold: return "\u{f9c0}"
        case .stickiesLight: return "\u{f9c1}"
        case .stickiesRegular: return "\u{f9c2}"
        case .stopBold: return "\u{f9c3}"
        case .stopCircleBold: return "\u{f9c4}"
        case .stopCircleFilled: return "\u{f9c5}"
        case .stopCircleLight: return "\u{f9c6}"
        case .stopCircleRegular: return "\u{f9c7}"
        case .stopContentShareBold: return "\u{f9c8}"
        case .stopContentShareLight: return "\u{f9c9}"
        case .stopContentShareRegular: return "\u{f9ca}"
        case .stopFilled: return "\u{f9cb}"
        case .stopLight: return "\u{f9cc}"
        case .stopRegular: return "\u{f9cd}"
        case .storedInfoBold: return "\u{f9ce}"
        case .storedInfoFilled: return "\u{f9cf}"
        case .storedInfoLight: return "\u{f9d0}"
        case .storedInfoRegular: return "\u{f9d1}"
        case .streamingBold: return "\u{f9d2}"
        case .streamingLight: return "\u{f9d3}"
        case .streamingRegular: return "\u{f9d4}"
        case .strikethroughBold: return "\u{f9d5}"
        case .strikethroughLight: return "\u{f9d6}"
        case .strikethroughRegular: return "\u{f9d7}"
        case .studioModeBold: return "\u{f9d8}"
        case .studioModeLight: return "\u{f9d9}"
        case .studioModeRegular: return "\u{f9da}"
        case .subscriptBold: return "\u{f9db}"
        case .subscriptLight: return "\u{f9dc}"
        case .subscriptRegular: return "\u{f9dd}"
        case .superscriptBold: return "\u{f9de}"
        case .superscriptLight: return "\u{f9df}"
        case .superscriptRegular: return "\u{f9e0}"
        case .surveyBold: return "\u{f9e1}"
        case .surveyFilled: return "\u{f9e2}"
        case .surveyLight: return "\u{f9e3}"
        case .surveyRegular: return "\u{f9e4}"
        case .sx10Bold: return "\u{f9e5}"
        case .sx10Light: return "\u{f9e6}"
        case .sx10Regular: return "\u{f9e7}"
        case .sx20Bold: return "\u{f9e8}"
        case .sx20Light: return "\u{f9e9}"
        case .sx20Regular: return "\u{f9ea}"
        case .sx80CodecBold: return "\u{f9eb}"
        case .sx80CodecLight: return "\u{f9ec}"
        case .sx80CodecRegular: return "\u{f9ed}"
        case .tableBold: return "\u{f9ee}"
        case .tableLight: return "\u{f9ef}"
        case .tableRegular: return "\u{f9f0}"
        case .tabletBold: return "\u{f9f1}"
        case .tabletLight: return "\u{f9f2}"
        case .tabletRegular: return "\u{f9f3}"
        case .tabsBold: return "\u{f9f4}"
        case .tabsLight: return "\u{f9f5}"
        case .tabsRegular: return "\u{f9f6}"
        case .tagBold: return "\u{f9f7}"
        case .tagLight: return "\u{f9f8}"
        case .tagRegular: return "\u{f9f9}"
        case .tapBold: return "\u{f9fa}"
        case .tapFilled: return "\u{f9fb}"
        case .tapLight: return "\u{f9fc}"
        case .tapRegular: return "\u{f9fd}"
        case .telepresenceAlertBold: return "\u{f9fe}"
        case .telepresenceAlertLight: return "\u{f9ff}"
        case .telepresenceAlertMutedBold: return "\u{fa00}"
        case .telepresenceAlertMutedLight: return "\u{fa01}"
        case .telepresenceAlertMutedRegular: return "\u{fa02}"
        case .telepresenceAlertRegular: return "\u{fa03}"
        case .telepresenceBold: return "\u{fa04}"
        case .telepresenceIx5000Bold: return "\u{fa05}"
        case .telepresenceIx5000Light: return "\u{fa06}"
        case .telepresenceIx5000Regular: return "\u{fa07}"
        case .telepresenceLight: return "\u{fa08}"
        case .telepresencePrivateBold: return "\u{fa09}"
        case .telepresencePrivateLight: return "\u{fa0a}"
        case .telepresencePrivateRegular: return "\u{fa0b}"
        case .telepresenceRegular: return "\u{fa0c}"
        case .temperatureBold: return "\u{fa0d}"
        case .temperatureLight: return "\u{fa0e}"
        case .temperatureRegular: return "\u{fa0f}"
        case .textAlignCenterBold: return "\u{fa10}"
        case .textAlignCenterFilled: return "\u{fa11}"
        case .textAlignCenterLight: return "\u{fa12}"
        case .textAlignCenterRegular: return "\u{fa13}"
        case .textAlignLeftBold: return "\u{fa14}"
        case .textAlignLeftFilled: return "\u{fa15}"
        case .textAlignLeftLight: return "\u{fa16}"
        case .textAlignLeftRegular: return "\u{fa17}"
        case .textAlignRightBold: return "\u{fa18}"
        case .textAlignRightFilled: return "\u{fa19}"
        case .textAlignRightLight: return "\u{fa1a}"
        case .textAlignRightRegular: return "\u{fa1b}"
        case .textBold: return "\u{fa1c}"
        case .textCodeBlockBold: return "\u{fa1d}"
        case .textCodeBlockLight: return "\u{fa1e}"
        case .textCodeBlockRegular: return "\u{fa1f}"
        case .textHighlightBold: return "\u{fa20}"
        case .textHighlightLight: return "\u{fa21}"
        case .textHighlightRegular: return "\u{fa22}"
        case .textLight: return "\u{fa23}"
        case .textRegular: return "\u{fa24}"
        case .threeColumnBold: return "\u{fa25}"
        case .threeColumnLight: return "\u{fa26}"
        case .threeColumnRegular: return "\u{fa27}"
        case .threeDObjectBold: return "\u{fa28}"
        case .threeDObjectLight: return "\u{fa29}"
        case .threeDObjectRegular: return "\u{fa2a}"
        case .tooFastBold: return "\u{fa2b}"
        case .tooFastLight: return "\u{fa2c}"
        case .tooFastRegular: return "\u{fa2d}"
        case .tooSlowBold: return "\u{fa2e}"
        case .tooSlowLight: return "\u{fa2f}"
        case .tooSlowRegular: return "\u{fa30}"
        case .toolsBold: return "\u{fa31}"
        case .toolsLight: return "\u{fa32}"
        case .toolsRegular: return "\u{fa33}"
        case .touch10Bold: return "\u{fa34}"
        case .touch10Light: return "\u{fa35}"
        case .touch10Regular: return "\u{fa36}"
        case .transcriptBold: return "\u{fa37}"
        case .transcriptFilled: return "\u{fa38}"
        case .transcriptLight: return "\u{fa39}"
        case .transcriptRegular: return "\u{fa3a}"
        case .translateBold: return "\u{fa3b}"
        case .translateLight: return "\u{fa3c}"
        case .translateRegular: return "\u{fa3d}"
        case .trimBold: return "\u{fa3e}"
        case .trimLight: return "\u{fa3f}"
        case .trimRegular: return "\u{fa40}"
        case .twoColumnBold: return "\u{fa41}"
        case .twoColumnLight: return "\u{fa42}"
        case .twoColumnRegular: return "\u{fa43}"
        case .ucmCloudBold: return "\u{fa44}"
        case .ucmCloudLight: return "\u{fa45}"
        case .ucmCloudRegular: return "\u{fa46}"
        case .underlineBold: return "\u{fa47}"
        case .underlineLight: return "\u{fa48}"
        case .underlineRegular: return "\u{fa49}"
        case .undoBold: return "\u{fa4a}"
        case .undoLight: return "\u{fa4b}"
        case .undoRegular: return "\u{fa4c}"
        case .unlinkBold: return "\u{fa4d}"
        case .unlinkLight: return "\u{fa4e}"
        case .unlinkRegular: return "\u{fa4f}"
        case .unreadBold: return "\u{fa50}"
        case .unreadFilled: return "\u{fa51}"
        case .unreadLight: return "\u{fa52}"
        case .unreadRegular: return "\u{fa53}"
        case .unsecureUnlockedBold: return "\u{fa54}"
        case .unsecureUnlockedFilled: return "\u{fa55}"
        case .unsecureUnlockedLight: return "\u{fa56}"
        case .unsecureUnlockedRegular: return "\u{fa57}"
        case .unsortedBold: return "\u{fa58}"
        case .unsortedLight: return "\u{fa59}"
        case .unsortedRegular: return "\u{fa5a}"
        case .updateFileShareBold: return "\u{fa5b}"
        case .updateFileShareLight: return "\u{fa5c}"
        case .updateFileShareRegular: return "\u{fa5d}"
        case .upgradeBold: return "\u{fa5e}"
        case .upgradeFilled: return "\u{fa5f}"
        case .upgradeLight: return "\u{fa60}"
        case .upgradeRegular: return "\u{fa61}"
        case .uploadBold: return "\u{fa62}"
        case .uploadImageBold: return "\u{fa63}"
        case .uploadImageLight: return "\u{fa64}"
        case .uploadImageRegular: return "\u{fa65}"
        case .uploadLight: return "\u{fa66}"
        case .uploadRegular: return "\u{fa67}"
        case .urgentVoicemailBold: return "\u{fa68}"
        case .urgentVoicemailFilled: return "\u{fa69}"
        case .usbBold: return "\u{fa6a}"
        case .usbHeadsetBold: return "\u{fa6b}"
        case .usbHeadsetLight: return "\u{fa6c}"
        case .usbHeadsetMutedBold: return "\u{fa6d}"
        case .usbHeadsetMutedLight: return "\u{fa6e}"
        case .usbHeadsetMutedRegular: return "\u{fa6f}"
        case .usbHeadsetRegular: return "\u{fa70}"
        case .usbLight: return "\u{fa71}"
        case .usbRegular: return "\u{fa72}"
        case .userBold: return "\u{fa73}"
        case .userDeactivateBold: return "\u{fa74}"
        case .userDeactivateLight: return "\u{fa75}"
        case .userDeactivateRegular: return "\u{fa76}"
        case .userLight: return "\u{fa77}"
        case .userRegular: return "\u{fa78}"
        case .vcsBold: return "\u{fa79}"
        case .vcsLight: return "\u{fa7a}"
        case .vcsRegular: return "\u{fa7b}"
        case .videoBlurBold: return "\u{fa7c}"
        case .videoBlurFilled: return "\u{fa7d}"
        case .videoBlurLight: return "\u{fa7e}"
        case .videoBlurRegular: return "\u{fa7f}"
        case .videoBold: return "\u{fa80}"
        case .videoEffectBold: return "\u{fa81}"
        case .videoEffectFilled: return "\u{fa82}"
        case .videoEffectLight: return "\u{fa83}"
        case .videoEffectRegular: return "\u{fa84}"
        case .videoFilled: return "\u{fa85}"
        case .videoLayoutBold: return "\u{fa86}"
        case .videoLayoutEqualBold: return "\u{fa87}"
        case .videoLayoutEqualDualBold: return "\u{fa88}"
        case .videoLayoutEqualDualLight: return "\u{fa89}"
        case .videoLayoutEqualDualRegular: return "\u{fa8a}"
        case .videoLayoutEqualFilled: return "\u{fa8b}"
        case .videoLayoutEqualLight: return "\u{fa8c}"
        case .videoLayoutEqualRegular: return "\u{fa8d}"
        case .videoLayoutFilled: return "\u{fa8e}"
        case .videoLayoutLight: return "\u{fa8f}"
        case .videoLayoutOverlayBold: return "\u{fa90}"
        case .videoLayoutOverlayLight: return "\u{fa91}"
        case .videoLayoutOverlayRegular: return "\u{fa92}"
        case .videoLayoutPresenterDominantBold: return "\u{fa93}"
        case .videoLayoutPresenterDominantLight: return "\u{fa94}"
        case .videoLayoutPresenterDominantRegular: return "\u{fa95}"
        case .videoLayoutProminentBold: return "\u{fa96}"
        case .videoLayoutProminentFilled: return "\u{fa97}"
        case .videoLayoutProminentLight: return "\u{fa98}"
        case .videoLayoutProminentRegular: return "\u{fa99}"
        case .videoLayoutRegular: return "\u{fa9a}"
        case .videoLayoutShareDominantBold: return "\u{fa9b}"
        case .videoLayoutShareDominantLight: return "\u{fa9c}"
        case .videoLayoutShareDominantRegular: return "\u{fa9d}"
        case .videoLayoutSingleBold: return "\u{fa9e}"
        case .videoLayoutSingleFilled: return "\u{fa9f}"
        case .videoLayoutSingleLight: return "\u{faa0}"
        case .videoLayoutSingleRegular: return "\u{faa1}"
        case .videoLayoutStackBold: return "\u{faa2}"
        case .videoLayoutStackFilled: return "\u{faa3}"
        case .videoLayoutStackLight: return "\u{faa4}"
        case .videoLayoutStackRegular: return "\u{faa5}"
        case .videoLayoutVideoDominantBold: return "\u{faa6}"
        case .videoLayoutVideoDominantLight: return "\u{faa7}"
        case .videoLayoutVideoDominantRegular: return "\u{faa8}"
        case .videoLight: return "\u{faa9}"
        case .videoPlusBold: return "\u{faaa}"
        case .videoPlusFilled: return "\u{faab}"
        case .videoPlusLight: return "\u{faac}"
        case .videoPlusRegular: return "\u{faad}"
        case .videoRegular: return "\u{faae}"
        case .videoSpeakerTrackBold: return "\u{faaf}"
        case .videoSpeakerTrackFilled: return "\u{fab0}"
        case .videoSpeakerTrackLight: return "\u{fab1}"
        case .videoSpeakerTrackRegular: return "\u{fab2}"
        case .viewAllBold: return "\u{fab3}"
        case .viewAllLight: return "\u{fab4}"
        case .viewAllRegular: return "\u{fab5}"
        case .viewListBold: return "\u{fab6}"
        case .viewListLight: return "\u{fab7}"
        case .viewListRegular: return "\u{fab8}"
        case .viewStackedBold: return "\u{fab9}"
        case .viewStackedFilled: return "\u{faba}"
        case .viewStackedLight: return "\u{fabb}"
        case .viewStackedRegular: return "\u{fabc}"
        case .viewThumbnailBold: return "\u{fabd}"
        case .viewThumbnailFilled: return "\u{fabe}"
        case .viewThumbnailLight: return "\u{fabf}"
        case .viewThumbnailRegular: return "\u{fac0}"
        case .voicemailBold: return "\u{fac1}"
        case .voicemailFilled: return "\u{fac2}"
        case .voicemailLight: return "\u{fac3}"
        case .voicemailRegular: return "\u{fac4}"
        case .waffleMenuBold: return "\u{fac5}"
        case .waffleMenuLight: return "\u{fac6}"
        case .waffleMenuRegular: return "\u{fac7}"
        case .waitingroomActiveBold: return "\u{fac8}"
        case .waitingroomActiveLight: return "\u{fac9}"
        case .waitingroomActiveRegular: return "\u{faca}"
        case .wallpaperBold: return "\u{facb}"
        case .wallpaperLight: return "\u{facc}"
        case .wallpaperRegular: return "\u{facd}"
        case .warningBadgeFilled: return "\u{face}"
        case .warningBold: return "\u{facf}"
        case .warningFilled: return "\u{fad0}"
        case .warningLight: return "\u{fad1}"
        case .warningRegular: return "\u{fad2}"
        case .webexAssistantActiveColored: return "\u{fad3}"
        case .webexAssistantInactiveColored: return "\u{fad4}"
        case .webexBoardBold: return "\u{fad5}"
        case .webexBoardLight: return "\u{fad6}"
        case .webexBoardRegular: return "\u{fad7}"
        case .webexCodecPlusBold: return "\u{fad8}"
        case .webexCodecPlusLight: return "\u{fad9}"
        case .webexCodecPlusRegular: return "\u{fada}"
        case .webexDeskCameraBold: return "\u{fadb}"
        case .webexDeskCameraLight: return "\u{fadc}"
        case .webexDeskCameraRegular: return "\u{fadd}"
        case .webexHelixFilled: return "\u{fade}"
        case .webexMeetingsBold: return "\u{fadf}"
        case .webexMeetingsFilled: return "\u{fae0}"
        case .webexMeetingsLight: return "\u{fae1}"
        case .webexMeetingsRegular: return "\u{fae2}"
        case .webexQuadCameraBold: return "\u{fae3}"
        case .webexQuadCameraLight: return "\u{fae4}"
        case .webexQuadCameraRegular: return "\u{fae5}"
        case .webexRoomKitBold: return "\u{fae6}"
        case .webexRoomKitLight: return "\u{fae7}"
        case .webexRoomKitPlusBold: return "\u{fae8}"
        case .webexRoomKitPlusLight: return "\u{fae9}"
        case .webexRoomKitPlusRegular: return "\u{faea}"
        case .webexRoomKitRegular: return "\u{faeb}"
        case .webexShareBold: return "\u{faec}"
        case .webexShareLight: return "\u{faed}"
        case .webexShareRegular: return "\u{faee}"
        case .webexTeamsBold: return "\u{faef}"
        case .webexTeamsFilled: return "\u{faf0}"
        case .webexTeamsLight: return "\u{faf1}"
        case .webexTeamsNewBold: return "\u{faf2}"
        case .webexTeamsNewFilled: return "\u{faf3}"
        case .webexTeamsNewLight: return "\u{faf4}"
        case .webexTeamsNewRegular: return "\u{faf5}"
        case .webexTeamsRegular: return "\u{faf6}"
        case .webinarBold: return "\u{faf7}"
        case .webinarFilled: return "\u{faf8}"
        case .webinarLight: return "\u{faf9}"
        case .webinarRegular: return "\u{fafa}"
        case .weeklyRecurringScheduleNodeBold: return "\u{fafb}"
        case .weeklyRecurringScheduleNodeLight: return "\u{fafc}"
        case .weeklyRecurringScheduleNodeRegular: return "\u{fafd}"
        case .whatsNewBold: return "\u{fafe}"
        case .whatsNewFilled: return "\u{faff}"
        case .whatsNewLight: return "\u{fb00}"
        case .whatsNewRegular: return "\u{fb01}"
        case .whiteboardBold: return "\u{fb02}"
        case .whiteboardContentBold: return "\u{fb03}"
        case .whiteboardContentLight: return "\u{fb04}"
        case .whiteboardContentRegular: return "\u{fb05}"
        case .whiteboardFilled: return "\u{fb06}"
        case .whiteboardLight: return "\u{fb07}"
        case .whiteboardRegular: return "\u{fb08}"
        case .widgetBold: return "\u{fb09}"
        case .widgetFilled: return "\u{fb0a}"
        case .widgetLight: return "\u{fb0b}"
        case .widgetRegular: return "\u{fb0c}"
        case .wifiBold: return "\u{fb0d}"
        case .wifiErrorBold: return "\u{fb0e}"
        case .wifiErrorLight: return "\u{fb0f}"
        case .wifiErrorRegular: return "\u{fb10}"
        case .wifiLight: return "\u{fb11}"
        case .wifiRegular: return "\u{fb12}"
        case .wifiSignalGoodColoredBold: return "\u{fb13}"
        case .wifiSignalGoodColoredLight: return "\u{fb14}"
        case .wifiSignalGoodColoredRegular: return "\u{fb15}"
        case .wifiSignalPoorColoredBold: return "\u{fb16}"
        case .wifiSignalPoorColoredLight: return "\u{fb17}"
        case .wifiSignalPoorColoredRegular: return "\u{fb18}"
        case .wifiSignalUnstableColoredBold: return "\u{fb19}"
        case .wifiSignalUnstableColoredLight: return "\u{fb1a}"
        case .wifiSignalUnstableColoredRegular: return "\u{fb1b}"
        case .windowCornerScrubBold: return "\u{fb1c}"
        case .windowCornerScrubLight: return "\u{fb1d}"
        case .windowCornerScrubRegular: return "\u{fb1e}"
        case .windowRightCornerScrubBold: return "\u{fb1f}"
        case .windowRightCornerScrubLight: return "\u{fb20}"
        case .windowRightCornerScrubRegular: return "\u{fb21}"
        case .windowVerticalScrubBold: return "\u{fb22}"
        case .windowVerticalScrubLight: return "\u{fb23}"
        case .windowVerticalScrubRegular: return "\u{fb24}"
        case .workflowDeploymentsBold: return "\u{fb25}"
        case .workflowDeploymentsFilled: return "\u{fb26}"
        case .workflowDeploymentsLight: return "\u{fb27}"
        case .workflowDeploymentsRegular: return "\u{fb28}"
        case .workphoneBold: return "\u{fb29}"
        case .workphoneLight: return "\u{fb2a}"
        case .workphoneRegular: return "\u{fb2b}"
        case .zoomInBold: return "\u{fb2c}"
        case .zoomInLight: return "\u{fb2d}"
        case .zoomInRegular: return "\u{fb2e}"
        case .zoomOutBold: return "\u{fb2f}"
        case .zoomOutLight: return "\u{fb30}"
        case .zoomOutRegular: return "\u{fb31}"
        case .zoom: return "\u{fb32}"
