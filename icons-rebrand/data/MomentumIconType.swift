...
@objc public enum MomentumIconType: Int {
    ...
    public var ligature: String {
        ...
        case .infoCircleBold: return "\u{f4d2}"
        case .infoCircleFilled: return "\u{f4d3}"
        case .infoCircleLight: return "\u{f4d4}"
        case .infoCircleRegular: return "\u{f4d5}"
        case .infoCircleTwoBold: return "\u{f4d6}"
        case .infoCircleTwoFilled: return "\u{f4d7}"
        case .infoCircleTwoLight: return "\u{f4d8}"
        case .infoCircleTwoRegular: return "\u{f4d9}"
        case .inputBold: return "\u{f4da}"
        case .inputDisconnectedBold: return "\u{f4db}"
        case .inputDisconnectedLight: return "\u{f4dc}"
        case .inputDisconnectedRegular: return "\u{f4dd}"
        case .inputLight: return "\u{f4de}"
        case .inputRegular: return "\u{f4df}"
        case .integrationsBold: return "\u{f4e0}"
        case .integrationsLight: return "\u{f4e1}"
        case .integrationsRegular: return "\u{f4e2}"
        case .invitedUserBold: return "\u{f4e3}"
        case .invitedUserLight: return "\u{f4e4}"
        case .invitedUserRegular: return "\u{f4e5}"
        case .italicBold: return "\u{f4e6}"
        case .italicLight: return "\u{f4e7}"
        case .italicRegular: return "\u{f4e8}"
        case .joinAudioBold: return "\u{f4e9}"
        case .joinAudioFilled: return "\u{f4ea}"
        case .joinAudioLight: return "\u{f4eb}"
        case .joinAudioRegular: return "\u{f4ec}"
        case .keyboardBold: return "\u{f4ed}"
        case .keyboardCloseBold: return "\u{f4ee}"
        case .keyboardCloseLight: return "\u{f4ef}"
        case .keyboardCloseRegular: return "\u{f4f0}"
        case .keyboardLight: return "\u{f4f1}"
        case .keyboardRegular: return "\u{f4f2}"
        case .languageBold: return "\u{f4f3}"
        case .languageLight: return "\u{f4f4}"
        case .languageRegular: return "\u{f4f5}"
        case .laptopBold: return "\u{f4f6}"
        case .laptopDisconnectedBold: return "\u{f4f7}"
        case .laptopDisconnectedLight: return "\u{f4f8}"
        case .laptopDisconnectedRegular: return "\u{f4f9}"
        case .laptopFilled: return "\u{f4fa}"
        case .laptopLight: return "\u{f4fb}"
        case .laptopRegular: return "\u{f4fc}"
        case .laserPointerBold: return "\u{f4fd}"
        case .laserPointerLight: return "\u{f4fe}"
        case .laserPointerRegular: return "\u{f4ff}"
        case .launchBold: return "\u{f500}"
        case .launchLight: return "\u{f501}"
        case .launchRegular: return "\u{f502}"
        case .layoutSideBySideVerticalBold: return "\u{f503}"
        case .layoutSideBySideVerticalFilled: return "\u{f504}"
        case .layoutSideBySideVerticalLight: return "\u{f505}"
        case .layoutSideBySideVerticalRegular: return "\u{f506}"
        case .likeBold: return "\u{f507}"
        case .likeFilled: return "\u{f508}"
        case .likeLight: return "\u{f509}"
        case .likeRegular: return "\u{f50a}"
        case .linkBold: return "\u{f50b}"
        case .linkLight: return "\u{f50c}"
        case .linkRegular: return "\u{f50d}"
        case .listBulletedBold: return "\u{f50e}"
        case .listBulletedLight: return "\u{f50f}"
        case .listBulletedRegular: return "\u{f510}"
        case .listMenuBold: return "\u{f511}"
        case .listMenuLight: return "\u{f512}"
        case .listMenuRegular: return "\u{f513}"
        case .listNumberedBold: return "\u{f514}"
        case .listNumberedLight: return "\u{f515}"
        case .listNumberedRegular: return "\u{f516}"
        case .locationBold: return "\u{f517}"
        case .locationFilled: return "\u{f518}"
        case .locationLight: return "\u{f519}"
        case .locationRegular: return "\u{f51a}"
        case .lowerHandBold: return "\u{f51b}"
        case .lowerHandLight: return "\u{f51c}"
        case .lowerHandRegular: return "\u{f51d}"
        case .markAsUnreadBold: return "\u{f51e}"
        case .markAsUnreadLight: return "\u{f51f}"
        case .markAsUnreadRegular: return "\u{f520}"
        case .markdownBold: return "\u{f521}"
        case .markdownLight: return "\u{f522}"
        case .markdownRegular: return "\u{f523}"
        case .markerBold: return "\u{f524}"
        case .markerFilled: return "\u{f525}"
        case .markerLight: return "\u{f526}"
        case .markerRegular: return "\u{f527}"
        case .maximizeBold: return "\u{f528}"
        case .maximizeLight: return "\u{f529}"
        case .maximizeRegular: return "\u{f52a}"
        case .mediaPlayerBold: return "\u{f52b}"
        case .mediaPlayerLight: return "\u{f52c}"
        case .mediaPlayerRegular: return "\u{f52d}"
        case .mediaQualityGoodBold: return "\u{f52e}"
        case .mediaQualityGoodFilled: return "\u{f52f}"
        case .mediaQualityGoodLight: return "\u{f530}"
        case .mediaQualityGoodRegular: return "\u{f531}"
        case .mediaQualityPoorBold: return "\u{f532}"
        case .mediaQualityPoorFilled: return "\u{f533}"
        case .mediaQualityPoorLight: return "\u{f534}"
        case .mediaQualityPoorRegular: return "\u{f535}"
        case .mediaQualityUnstableBold: return "\u{f536}"
        case .mediaQualityUnstableFilled: return "\u{f537}"
        case .mediaQualityUnstableLight: return "\u{f538}"
        case .mediaQualityUnstableRegular: return "\u{f539}"
        case .meetBold: return "\u{f53a}"
        case .meetEndBold: return "\u{f53b}"
        case .meetEndLight: return "\u{f53c}"
        case .meetEndRegular: return "\u{f53d}"
        case .meetFilled: return "\u{f53e}"
        case .meetLight: return "\u{f53f}"
        case .meetRegular: return "\u{f540}"
        case .meetingsBold: return "\u{f541}"
        case .meetingsFilled: return "\u{f542}"
        case .meetingsFocusMonthBold: return "\u{f543}"
        case .meetingsFocusMonthLight: return "\u{f544}"
        case .meetingsFocusMonthRegular: return "\u{f545}"
        case .meetingsFocusOneDayBold: return "\u{f546}"
        case .meetingsFocusOneDayLight: return "\u{f547}"
        case .meetingsFocusOneDayRegular: return "\u{f548}"
        case .meetingsFocusThreeDayBold: return "\u{f549}"
        case .meetingsFocusThreeDayLight: return "\u{f54a}"
        case .meetingsFocusThreeDayRegular: return "\u{f54b}"
        case .meetingsFocusUpcomingBold: return "\u{f54c}"
        case .meetingsFocusUpcomingLight: return "\u{f54d}"
        case .meetingsFocusUpcomingRegular: return "\u{f54e}"
        case .meetingsFocusWeekBold: return "\u{f54f}"
        case .meetingsFocusWeekLight: return "\u{f550}"
        case .meetingsFocusWeekRegular: return "\u{f551}"
        case .meetingsLight: return "\u{f552}"
        case .meetingsPresenceBold: return "\u{f553}"
        case .meetingsPresenceFilled: return "\u{f554}"
        case .meetingsPresenceLight: return "\u{f555}"
        case .meetingsPresenceRegular: return "\u{f556}"
        case .meetingsRegular: return "\u{f557}"
        case .meetingsTeamActiveBold: return "\u{f558}"
        case .meetingsTeamActiveLight: return "\u{f559}"
        case .meetingsTeamActiveRegular: return "\u{f55a}"
        case .meetingsTeamBold: return "\u{f55b}"
        case .meetingsTeamLight: return "\u{f55c}"
        case .meetingsTeamNewBold: return "\u{f55d}"
        case .meetingsTeamNewLight: return "\u{f55e}"
        case .meetingsTeamNewRegular: return "\u{f55f}"
        case .meetingsTeamRegular: return "\u{f560}"
        case .mentionBold: return "\u{f561}"
        case .mentionLight: return "\u{f562}"
        case .mentionRegular: return "\u{f563}"
        case .microphoneBold: return "\u{f564}"
        case .microphoneFilled: return "\u{f565}"
        case .microphoneHardMutedBold: return "\u{f566}"
        case .microphoneHardMutedColoredBold: return "\u{f567}"
        case .microphoneHardMutedColoredLight: return "\u{f568}"
        case .microphoneHardMutedColoredRegular: return "\u{f569}"
        case .microphoneHardMutedLight: return "\u{f56a}"
        case .microphoneHardMutedRegular: return "\u{f56b}"
        case .microphoneLight: return "\u{f56c}"
        case .microphoneMusicModeColoredBold: return "\u{f56d}"
        case .microphoneMusicModeColoredLight: return "\u{f56e}"
        case .microphoneMusicModeColoredRegular: return "\u{f56f}"
        case .microphoneMutedBold: return "\u{f570}"
        case .microphoneMutedFilled: return "\u{f571}"
        case .microphoneMutedLight: return "\u{f572}"
        case .microphoneMutedRegular: return "\u{f573}"
        case .microphoneRegular: return "\u{f574}"
        case .minimizeBold: return "\u{f575}"
        case .minimizeLight: return "\u{f576}"
        case .minimizeRegular: return "\u{f577}"
        case .minusBold: return "\u{f578}"
        case .minusLight: return "\u{f579}"
        case .minusRegular: return "\u{f57a}"
        case .mirrorBold: return "\u{f57b}"
        case .mirrorFilled: return "\u{f57c}"
        case .mirrorLight: return "\u{f57d}"
        case .mirrorRegular: return "\u{f57e}"
        case .moreAdrBold: return "\u{f57f}"
        case .moreAdrLight: return "\u{f580}"
        case .moreAdrRegular: return "\u{f581}"
        case .moreBold: return "\u{f582}"
        case .moreCircleBold: return "\u{f583}"
        case .moreCircleFilled: return "\u{f584}"
        case .moreCircleLight: return "\u{f585}"
        case .moreCircleRegular: return "\u{f586}"
        case .moreLight: return "\u{f587}"
        case .moreRegular: return "\u{f588}"
        case .mouseCursorBold: return "\u{f589}"
        case .mouseCursorLight: return "\u{f58a}"
        case .mouseCursorRegular: return "\u{f58b}"
        case .moveCallInAdrBold: return "\u{f58c}"
        case .moveCallInAdrLight: return "\u{f58d}"
        case .moveCallInAdrRegular: return "\u{f58e}"
        case .moveCallInIphBold: return "\u{f58f}"
        case .moveCallInIphLight: return "\u{f590}"
        case .moveCallInIphRegular: return "\u{f591}"
        case .moveCallInLaptopBold: return "\u{f592}"
        case .moveCallInLaptopLight: return "\u{f593}"
        case .moveCallInLaptopRegular: return "\u{f594}"
        case .moveCallInOutAdrBold: return "\u{f595}"
        case .moveCallInOutAdrLight: return "\u{f596}"
        case .moveCallInOutAdrRegular: return "\u{f597}"
        case .moveCallInOutIphBold: return "\u{f598}"
        case .moveCallInOutIphLight: return "\u{f599}"
        case .moveCallInOutIphRegular: return "\u{f59a}"
        case .moveCallInTabletBold: return "\u{f59b}"
        case .moveCallInTabletLight: return "\u{f59c}"
        case .moveCallInTabletRegular: return "\u{f59d}"
        case .moveCallOutAdrBold: return "\u{f59e}"
        case .moveCallOutAdrLight: return "\u{f59f}"
        case .moveCallOutAdrRegular: return "\u{f5a0}"
        case .moveCallOutIphBold: return "\u{f5a1}"
        case .moveCallOutIphLight: return "\u{f5a2}"
        case .moveCallOutIphRegular: return "\u{f5a3}"
        case .moveCallOutLaptopBold: return "\u{f5a4}"
        case .moveCallOutLaptopLight: return "\u{f5a5}"
        case .moveCallOutLaptopRegular: return "\u{f5a6}"
        case .moveCallOutTabletBold: return "\u{f5a7}"
        case .moveCallOutTabletLight: return "\u{f5a8}"
        case .moveCallOutTabletRegular: return "\u{f5a9}"
        case .multilineChartBold: return "\u{f5aa}"
        case .multilineChartFilled: return "\u{f5ab}"
        case .multilineChartLight: return "\u{f5ac}"
        case .multilineChartRegular: return "\u{f5ad}"
        case .multimediaBold: return "\u{f5ae}"
        case .multimediaLight: return "\u{f5af}"
        case .multimediaRegular: return "\u{f5b0}"
        case .multipledDevicesBold: return "\u{f5b1}"
        case .multipledDevicesLight: return "\u{f5b2}"
        case .multipledDevicesRegular: return "\u{f5b3}"
        case .musicModeBold: return "\u{f5b4}"
        case .musicModeCircleBold: return "\u{f5b5}"
        case .musicModeCircleFilled: return "\u{f5b6}"
        case .musicModeCircleLight: return "\u{f5b7}"
        case .musicModeCircleRegular: return "\u{f5b8}"
        case .musicModeFilled: return "\u{f5b9}"
        case .musicModeLight: return "\u{f5ba}"
        case .musicModeRegular: return "\u{f5bb}"
        case .muteOnEntryBold: return "\u{f5bc}"
        case .muteOnEntryFilled: return "\u{f5bd}"
        case .muteOnEntryLight: return "\u{f5be}"
        case .muteOnEntryRegular: return "\u{f5bf}"
        case .newVoicemailBold: return "\u{f5c0}"
        case .newVoicemailLight: return "\u{f5c1}"
        case .newVoicemailRegular: return "\u{f5c2}"
        case .newWhiteboardBold: return "\u{f5c3}"
        case .newWhiteboardLight: return "\u{f5c4}"
        case .newWhiteboardRegular: return "\u{f5c5}"
        case .nextBold: return "\u{f5c6}"
        case .nextLight: return "\u{f5c7}"
        case .nextRegular: return "\u{f5c8}"
        case .noDevicesBold: return "\u{f5c9}"
        case .noDevicesLight: return "\u{f5ca}"
        case .noDevicesRegular: return "\u{f5cb}"
        case .noiseRemovalBold: return "\u{f5cc}"
        case .noiseRemovalLight: return "\u{f5cd}"
        case .noiseRemovalRegular: return "\u{f5ce}"
        case .noteBold: return "\u{f5cf}"
        case .noteLight: return "\u{f5d0}"
        case .notePptBold: return "\u{f5d1}"
        case .notePptLight: return "\u{f5d2}"
        case .notePptRegular: return "\u{f5d3}"
        case .noteRegular: return "\u{f5d4}"
        case .notesBold: return "\u{f5d5}"
        case .notesLight: return "\u{f5d6}"
        case .notesRegular: return "\u{f5d7}"
        case .numberBold: return "\u{f5d8}"
        case .numberLight: return "\u{f5d9}"
        case .numberRegular: return "\u{f5da}"
        case .oldRemoteBold: return "\u{f5db}"
        case .oldRemoteLight: return "\u{f5dc}"
        case .oldRemoteRegular: return "\u{f5dd}"
        case .oldTouchBold: return "\u{f5de}"
        case .oldTouchLight: return "\u{f5df}"
        case .oldTouchRegular: return "\u{f5e0}"
        case .openInFolderBold: return "\u{f5e1}"
        case .openInFolderLight: return "\u{f5e2}"
        case .openInFolderRegular: return "\u{f5e3}"
        case .openPagesBold: return "\u{f5e4}"
        case .openPagesLight: return "\u{f5e5}"
        case .openPagesRegular: return "\u{f5e6}"
        case .otherNumberBold: return "\u{f5e7}"
        case .otherNumberLight: return "\u{f5e8}"
        case .otherNumberRegular: return "\u{f5e9}"
        case .otherNumberWarningBold: return "\u{f5ea}"
        case .otherNumberWarningLight: return "\u{f5eb}"
        case .otherNumberWarningRegular: return "\u{f5ec}"
        case .outgoingCallLegacyBold: return "\u{f5ed}"
        case .outgoingCallLegacyLight: return "\u{f5ee}"
        case .outgoingCallLegacyRegular: return "\u{f5ef}"
        case .overflowLeftBold: return "\u{f5f0}"
        case .overflowLeftLight: return "\u{f5f1}"
        case .overflowLeftRegular: return "\u{f5f2}"
        case .overflowRightBold: return "\u{f5f3}"
        case .overflowRightLight: return "\u{f5f4}"
        case .overflowRightRegular: return "\u{f5f5}"
        case .pairedCameraBold: return "\u{f5f6}"
        case .pairedCameraLight: return "\u{f5f7}"
        case .pairedCameraRegular: return "\u{f5f8}"
        case .pairedDeviceBold: return "\u{f5f9}"
        case .pairedDeviceLight: return "\u{f5fa}"
        case .pairedDeviceRegular: return "\u{f5fb}"
        case .pairedHandsetBold: return "\u{f5fc}"
        case .pairedHandsetLight: return "\u{f5fd}"
        case .pairedHandsetRegular: return "\u{f5fe}"
        case .pairingBold: return "\u{f5ff}"
        case .pairingLight: return "\u{f600}"
        case .pairingRegular: return "\u{f601}"
        case .parkedBold: return "\u{f602}"
        case .parkedFilled: return "\u{f603}"
        case .parkedLight: return "\u{f604}"
        case .parkedRegular: return "\u{f605}"
        case .parseBold: return "\u{f606}"
        case .parseLight: return "\u{f607}"
        case .parseRegular: return "\u{f608}"
        case .participantAddBold: return "\u{f609}"
        case .participantAddLight: return "\u{f60a}"
        case .participantAddRegular: return "\u{f60b}"
        case .participantBlockedBold: return "\u{f60c}"
        case .participantBlockedLight: return "\u{f60d}"
        case .participantBlockedRegular: return "\u{f60e}"
        case .participantBold: return "\u{f60f}"
        case .participantFilled: return "\u{f610}"
        case .participantLight: return "\u{f611}"
        case .participantListBold: return "\u{f612}"
        case .participantListFilled: return "\u{f613}"
        case .participantListLight: return "\u{f614}"
        case .participantListRegular: return "\u{f615}"
        case .participantRegular: return "\u{f616}"
        case .participantRemoveBold: return "\u{f617}"
        case .participantRemoveLight: return "\u{f618}"
        case .participantRemoveRegular: return "\u{f619}"
        case .participantUnknownBold: return "\u{f61a}"
        case .participantUnknownLight: return "\u{f61b}"
        case .participantUnknownRegular: return "\u{f61c}"
        case .passMouseBold: return "\u{f61d}"
        case .passMouseLight: return "\u{f61e}"
        case .passMouseRegular: return "\u{f61f}"
        case .pauseBold: return "\u{f620}"
        case .pauseFilled: return "\u{f621}"
        case .pauseLight: return "\u{f622}"
        case .pauseRegular: return "\u{f623}"
        case .penBold: return "\u{f624}"
        case .penFilled: return "\u{f625}"
        case .penLight: return "\u{f626}"
        case .penRegular: return "\u{f627}"
        case .peopleBold: return "\u{f628}"
        case .peopleCircleBold: return "\u{f629}"
        case .peopleCircleFilled: return "\u{f62a}"
        case .peopleCircleLight: return "\u{f62b}"
        case .peopleCircleRegular: return "\u{f62c}"
        case .peopleFilled: return "\u{f62d}"
        case .peopleLight: return "\u{f62e}"
        case .peopleRegular: return "\u{f62f}"
        case .phoneAlertBold: return "\u{f630}"
        case .phoneAlertLight: return "\u{f631}"
        case .phoneAlertRegular: return "\u{f632}"
        case .phoneBold: return "\u{f633}"
        case .phoneFilled: return "\u{f634}"
        case .phoneLight: return "\u{f635}"
        case .phoneMutedBold: return "\u{f636}"
        case .phoneMutedLight: return "\u{f637}"
        case .phoneMutedRegular: return "\u{f638}"
        case .phonePrivateBold: return "\u{f639}"
        case .phonePrivateLight: return "\u{f63a}"
        case .phonePrivateRegular: return "\u{f63b}"
        case .phoneRegular: return "\u{f63c}"
        case .phoneReplyAllBold: return "\u{f63d}"
        case .phoneReplyAllLight: return "\u{f63e}"
        case .phoneReplyAllRegular: return "\u{f63f}"
        case .phoneReplyBold: return "\u{f640}"
        case .phoneReplyLight: return "\u{f641}"
        case .phoneReplyRegular: return "\u{f642}"
        case .pickerBold: return "\u{f643}"
        case .pickerLight: return "\u{f644}"
        case .pickerRegular: return "\u{f645}"
        case .pictureInPictureBold: return "\u{f646}"
        case .pictureInPictureLight: return "\u{f647}"
        case .pictureInPictureRegular: return "\u{f648}"
        case .pieChartBold: return "\u{f649}"
        case .pieChartFilled: return "\u{f64a}"
        case .pieChartLight: return "\u{f64b}"
        case .pieChartRegular: return "\u{f64c}"
        case .pinBold: return "\u{f64d}"
        case .pinFilled: return "\u{f64e}"
        case .pinLight: return "\u{f64f}"
        case .pinListBold: return "\u{f650}"
        case .pinListLight: return "\u{f651}"
        case .pinListRegular: return "\u{f652}"
        case .pinMutedBold: return "\u{f653}"
        case .pinMutedLight: return "\u{f654}"
        case .pinMutedRegular: return "\u{f655}"
        case .pinRegular: return "\u{f656}"
        case .placeholderBold: return "\u{f657}"
        case .placeholderLight: return "\u{f658}"
        case .placeholderRegular: return "\u{f659}"
        case .playBold: return "\u{f65a}"
        case .playFilled: return "\u{f65b}"
        case .playLight: return "\u{f65c}"
        case .playRegular: return "\u{f65d}"
        case .plugAcBold: return "\u{f65e}"
        case .plugAcLight: return "\u{f65f}"
        case .plugAcRegular: return "\u{f660}"
        case .plusBold: return "\u{f661}"
        case .plusCircleBold: return "\u{f662}"
        case .plusCircleFilled: return "\u{f663}"
        case .plusCircleLight: return "\u{f664}"
        case .plusCircleRegular: return "\u{f665}"
        case .plusLight: return "\u{f666}"
        case .plusRegular: return "\u{f667}"
        case .pmrBold: return "\u{f668}"
        case .pmrFilled: return "\u{f669}"
        case .pmrLight: return "\u{f66a}"
        case .pmrRegular: return "\u{f66b}"
        case .pollBold: return "\u{f66c}"
        case .pollLight: return "\u{f66d}"
        case .pollRegular: return "\u{f66e}"
        case .popInBold: return "\u{f66f}"
        case .popInLight: return "\u{f670}"
        case .popInRegular: return "\u{f671}"
        case .popOutBold: return "\u{f672}"
        case .popOutLight: return "\u{f673}"
        case .popOutRegular: return "\u{f674}"
        case .popUpBold: return "\u{f675}"
        case .popUpLight: return "\u{f676}"
        case .popUpRegular: return "\u{f677}"
        case .powerAcBold: return "\u{f678}"
        case .powerAcLight: return "\u{f679}"
        case .powerAcRegular: return "\u{f67a}"
        case .powerBold: return "\u{f67b}"
        case .powerLight: return "\u{f67c}"
        case .powerRegular: return "\u{f67d}"
        case .presentationBold: return "\u{f67e}"
        case .presentationLight: return "\u{f67f}"
        case .presentationRegular: return "\u{f680}"
        case .printBold: return "\u{f681}"
        case .printLight: return "\u{f682}"
        case .printRegular: return "\u{f683}"
        case .priorityCircleBold: return "\u{f684}"
        case .priorityCircleFilled: return "\u{f685}"
        case .priorityCircleLight: return "\u{f686}"
        case .priorityCircleRegular: return "\u{f687}"
        case .priorityCircleTwoBold: return "\u{f688}"
        case .priorityCircleTwoFilled: return "\u{f689}"
        case .priorityCircleTwoLight: return "\u{f68a}"
        case .priorityCircleTwoRegular: return "\u{f68b}"
        case .privacyCircleBold: return "\u{f68c}"
        case .privacyCircleFilled: return "\u{f68d}"
        case .privacyCircleLight: return "\u{f68e}"
        case .privacyCircleRegular: return "\u{f68f}"
        case .privateBold: return "\u{f690}"
        case .privateCircleBold: return "\u{f691}"
        case .privateCircleFilled: return "\u{f692}"
        case .privateCircleLight: return "\u{f693}"
        case .privateCircleRegular: return "\u{f694}"
        case .privateLight: return "\u{f695}"
        case .privateMeetingBold: return "\u{f696}"
        case .privateMeetingLight: return "\u{f697}"
        case .privateMeetingRegular: return "\u{f698}"
        case .privateRegular: return "\u{f699}"
        case .productDemoBold: return "\u{f69a}"
        case .productDemoLight: return "\u{f69b}"
        case .productDemoRegular: return "\u{f69c}"
        case .proximityBold: return "\u{f69d}"
        case .proximityLight: return "\u{f69e}"
        case .proximityMutedBold: return "\u{f69f}"
        case .proximityMutedLight: return "\u{f6a0}"
        case .proximityMutedRegular: return "\u{f6a1}"
        case .proximityRegular: return "\u{f6a2}"
        case .proximityVideoBold: return "\u{f6a3}"
        case .proximityVideoLight: return "\u{f6a4}"
        case .proximityVideoRegular: return "\u{f6a5}"
        case .ptoPresenceBold: return "\u{f6a6}"
        case .ptoPresenceFilled: return "\u{f6a7}"
        case .ptoPresenceLight: return "\u{f6a8}"
        case .ptoPresenceRegular: return "\u{f6a9}"
        case .pullCallBold: return "\u{f6aa}"
        case .pullCallLight: return "\u{f6ab}"
        case .pullCallRegular: return "\u{f6ac}"
        case .qABold: return "\u{f6ad}"
        case .qALight: return "\u{f6ae}"
        case .qARegular: return "\u{f6af}"
        case .qualityBold: return "\u{f6b0}"
        case .qualityLight: return "\u{f6b1}"
        case .qualityRegular: return "\u{f6b2}"
        case .queueContactBold: return "\u{f6b3}"
        case .queueContactLight: return "\u{f6b4}"
        case .queueContactRegular: return "\u{f6b5}"
        case .quietBold: return "\u{f6b6}"
        case .quietHoursPresenceBold: return "\u{f6b7}"
        case .quietHoursPresenceFilled: return "\u{f6b8}"
        case .quietHoursPresenceLight: return "\u{f6b9}"
        case .quietHoursPresenceRegular: return "\u{f6ba}"
        case .quietLight: return "\u{f6bb}"
        case .quietRegular: return "\u{f6bc}"
        case .raiseHandBold: return "\u{f6bd}"
        case .raiseHandLight: return "\u{f6be}"
        case .raiseHandRegular: return "\u{f6bf}"
        case .ramBold: return "\u{f6c0}"
        case .ramLight: return "\u{f6c1}"
        case .ramRegular: return "\u{f6c2}"
        case .reactionsBold: return "\u{f6c3}"
        case .reactionsFilled: return "\u{f6c4}"
        case .reactionsLight: return "\u{f6c5}"
        case .reactionsRegular: return "\u{f6c6}"
        case .reactivateBold: return "\u{f6c7}"
        case .reactivateLight: return "\u{f6c8}"
        case .reactivateRegular: return "\u{f6c9}"
        case .recentsBold: return "\u{f6ca}"
        case .recentsFilled: return "\u{f6cb}"
        case .recentsLight: return "\u{f6cc}"
        case .recentsPresenceBold: return "\u{f6cd}"
        case .recentsPresenceFilled: return "\u{f6ce}"
        case .recentsPresenceLight: return "\u{f6cf}"
        case .recentsPresenceRegular: return "\u{f6d0}"
        case .recentsRegular: return "\u{f6d1}"
        case .recordBold: return "\u{f6d2}"
        case .recordFilled: return "\u{f6d3}"
        case .recordLight: return "\u{f6d4}"
        case .recordPausedBold: return "\u{f6d5}"
        case .recordPausedFilled: return "\u{f6d6}"
        case .recordPausedLight: return "\u{f6d7}"
        case .recordPausedRegular: return "\u{f6d8}"
        case .recordRegular: return "\u{f6d9}"
        case .recurringBold: return "\u{f6da}"
        case .recurringLight: return "\u{f6db}"
        case .recurringOffBold: return "\u{f6dc}"
        case .recurringOffLight: return "\u{f6dd}"
        case .recurringOffRegular: return "\u{f6de}"
        case .recurringRegular: return "\u{f6df}"
        case .redialBold: return "\u{f6e0}"
        case .redialLight: return "\u{f6e1}"
        case .redialRegular: return "\u{f6e2}"
        case .redoBold: return "\u{f6e3}"
        case .redoLight: return "\u{f6e4}"
        case .redoRegular: return "\u{f6e5}"
        case .refreshBold: return "\u{f6e6}"
        case .refreshLight: return "\u{f6e7}"
        case .refreshRegular: return "\u{f6e8}"
        case .remoteDesktopControlBold: return "\u{f6e9}"
        case .remoteDesktopControlFilled: return "\u{f6ea}"
        case .remoteDesktopControlLight: return "\u{f6eb}"
        case .remoteDesktopControlRegular: return "\u{f6ec}"
        case .removeBold: return "\u{f6ed}"
        case .removeFilled: return "\u{f6ee}"
        case .removeLight: return "\u{f6ef}"
        case .removeRegular: return "\u{f6f0}"
        case .replyBold: return "\u{f6f1}"
        case .replyFilled: return "\u{f6f2}"
        case .replyLight: return "\u{f6f3}"
        case .replyListBold: return "\u{f6f4}"
        case .replyListLight: return "\u{f6f5}"
        case .replyListRegular: return "\u{f6f6}"
        case .replyRegular: return "\u{f6f7}"
        case .resetBold: return "\u{f6f8}"
        case .resetLight: return "\u{f6f9}"
        case .resetRegular: return "\u{f6fa}"
        case .responsiveMobileBold: return "\u{f6fb}"
        case .responsiveMobileLight: return "\u{f6fc}"
        case .responsiveMobileRegular: return "\u{f6fd}"
        case .restartBold: return "\u{f6fe}"
        case .restartLight: return "\u{f6ff}"
        case .restartRegular: return "\u{f700}"
        case .returnBold: return "\u{f701}"
        case .returnLight: return "\u{f702}"
        case .returnRegular: return "\u{f703}"
        case .ringtoneBold: return "\u{f704}"
        case .ringtoneLight: return "\u{f705}"
        case .ringtoneRegular: return "\u{f706}"
        case .roomCalendarBold: return "\u{f707}"
        case .roomCalendarLight: return "\u{f708}"
        case .roomCalendarRegular: return "\u{f709}"
        case .roomLightsBold: return "\u{f70a}"
        case .roomLightsLight: return "\u{f70b}"
        case .roomLightsRegular: return "\u{f70c}"
        case .rotateContentBold: return "\u{f70d}"
        case .rotateContentFilled: return "\u{f70e}"
        case .rotateContentLight: return "\u{f70f}"
        case .rotateContentRegular: return "\u{f710}"
        case .runningApplicationBold: return "\u{f711}"
        case .runningApplicationFilled: return "\u{f712}"
        case .runningApplicationLight: return "\u{f713}"
        case .runningApplicationRegular: return "\u{f714}"
        case .saveBold: return "\u{f715}"
        case .saveLight: return "\u{f716}"
        case .saveRegular: return "\u{f717}"
        case .scanBold: return "\u{f718}"
        case .scanLight: return "\u{f719}"
        case .scanRegular: return "\u{f71a}"
        case .schedulerAvailableBold: return "\u{f71b}"
        case .schedulerAvailableLight: return "\u{f71c}"
        case .schedulerAvailableRegular: return "\u{f71d}"
        case .schedulerNotWorkingHoursBold: return "\u{f71e}"
        case .schedulerNotWorkingHoursLight: return "\u{f71f}"
        case .schedulerNotWorkingHoursRegular: return "\u{f720}"
        case .schedulerUnavailableBold: return "\u{f721}"
        case .schedulerUnavailableLight: return "\u{f722}"
        case .schedulerUnavailableRegular: return "\u{f723}"
        case .schedulerUnknownBold: return "\u{f724}"
        case .schedulerUnknownLight: return "\u{f725}"
        case .schedulerUnknownRegular: return "\u{f726}"
        case .screenshotBold: return "\u{f727}"
        case .screenshotDocBold: return "\u{f728}"
        case .screenshotDocFilled: return "\u{f729}"
        case .screenshotDocLight: return "\u{f72a}"
        case .screenshotDocRegular: return "\u{f72b}"
        case .screenshotLight: return "\u{f72c}"
        case .screenshotRegular: return "\u{f72d}"
        case .searchBold: return "\u{f72e}"
        case .searchLight: return "\u{f72f}"
        case .searchRegular: return "\u{f730}"
        case .secondaryArrowBold: return "\u{f731}"
        case .secondaryArrowLight: return "\u{f732}"
        case .secondaryArrowRegular: return "\u{f733}"
        case .secureCallLockBold: return "\u{f734}"
        case .secureCallLockFilled: return "\u{f735}"
        case .secureCallLockLight: return "\u{f736}"
        case .secureCallLockRegular: return "\u{f737}"
        case .secureCircleBold: return "\u{f738}"
        case .secureCircleFilled: return "\u{f739}"
        case .secureCircleLight: return "\u{f73a}"
        case .secureCircleRegular: return "\u{f73b}"
        case .secureLockBold: return "\u{f73c}"
        case .secureLockFilled: return "\u{f73d}"
        case .secureLockLight: return "\u{f73e}"
        case .secureLockRegular: return "\u{f73f}"
        case .selectionBold: return "\u{f740}"
        case .selectionLight: return "\u{f741}"
        case .selectionRegular: return "\u{f742}"
        case .sendBold: return "\u{f743}"
        case .sendFilled: return "\u{f744}"
        case .sendLight: return "\u{f745}"
        case .sendRegular: return "\u{f746}"
        case .serverBold: return "\u{f747}"
        case .serverErrorBold: return "\u{f748}"
        case .serverErrorLight: return "\u{f749}"
        case .serverErrorRegular: return "\u{f74a}"
        case .serverLight: return "\u{f74b}"
        case .serverRegular: return "\u{f74c}"
        case .servicesBold: return "\u{f74d}"
        case .servicesLight: return "\u{f74e}"
        case .servicesRegular: return "\u{f74f}"
        case .setVariableBold: return "\u{f750}"
        case .setVariableLight: return "\u{f751}"
        case .setVariableRegular: return "\u{f752}"
        case .settingsBold: return "\u{f753}"
        case .settingsFilled: return "\u{f754}"
        case .settingsLight: return "\u{f755}"
        case .settingsRegular: return "\u{f756}"
        case .setupAssistantBold: return "\u{f757}"
        case .setupAssistantLight: return "\u{f758}"
        case .setupAssistantRegular: return "\u{f759}"
        case .shapeDiagonalLineBold: return "\u{f75a}"
        case .shapeDiagonalLineLight: return "\u{f75b}"
        case .shapeDiagonalLineRegular: return "\u{f75c}"
        case .shapeOvalBold: return "\u{f75d}"
        case .shapeOvalLight: return "\u{f75e}"
        case .shapeOvalRegular: return "\u{f75f}"
        case .shapesBold: return "\u{f760}"
        case .shapesLight: return "\u{f761}"
        case .shapesRegular: return "\u{f762}"
        case .shareCNativeAdrBold: return "\u{f763}"
        case .shareCNativeAdrLight: return "\u{f764}"
        case .shareCNativeAdrRegular: return "\u{f765}"
        case .shareCNativeIphBold: return "\u{f766}"
        case .shareCNativeIphLight: return "\u{f767}"
        case .shareCNativeIphRegular: return "\u{f768}"
        case .shareScreenBold: return "\u{f769}"
        case .shareScreenFilled: return "\u{f76a}"
        case .shareScreenLight: return "\u{f76b}"
        case .shareScreenRegular: return "\u{f76c}"
        case .shareSpaceBold: return "\u{f76d}"
        case .shareSpaceLight: return "\u{f76e}"
        case .shareSpaceRegular: return "\u{f76f}"
        case .shieldBold: return "\u{f770}"
        case .shieldLight: return "\u{f771}"
        case .shieldRegular: return "\u{f772}"
        case .showBold: return "\u{f773}"
        case .showFilled: return "\u{f774}"
        case .showLight: return "\u{f775}"
        case .showRegular: return "\u{f776}"
        case .signInBold: return "\u{f777}"
        case .signInForcedBold: return "\u{f778}"
        case .signInForcedLight: return "\u{f779}"
        case .signInForcedRegular: return "\u{f77a}"
        case .signInLight: return "\u{f77b}"
        case .signInRegular: return "\u{f77c}"
        case .signOutBold: return "\u{f77d}"
        case .signOutLight: return "\u{f77e}"
        case .signOutRegular: return "\u{f77f}"
        case .signal0Bold: return "\u{f780}"
        case .signal0Light: return "\u{f781}"
        case .signal0Regular: return "\u{f782}"
        case .signal100Bold: return "\u{f783}"
        case .signal100Light: return "\u{f784}"
        case .signal100Regular: return "\u{f785}"
        case .signal25Bold: return "\u{f786}"
        case .signal25Light: return "\u{f787}"
        case .signal25Regular: return "\u{f788}"
        case .signal50Bold: return "\u{f789}"
        case .signal50Light: return "\u{f78a}"
        case .signal50Regular: return "\u{f78b}"
        case .signal75Bold: return "\u{f78c}"
        case .signal75Light: return "\u{f78d}"
        case .signal75Regular: return "\u{f78e}"
        case .singleNumberReachBold: return "\u{f78f}"
        case .singleNumberReachLight: return "\u{f790}"
        case .singleNumberReachRegular: return "\u{f791}"
        case .sipRegistrationInProgressBold: return "\u{f792}"
        case .sipRegistrationInProgressFilled: return "\u{f793}"
        case .sipRegistrationInProgressLight: return "\u{f794}"
        case .sipRegistrationInProgressRegular: return "\u{f795}"
        case .skipBold: return "\u{f796}"
        case .skipBwBold: return "\u{f797}"
        case .skipBwFilled: return "\u{f798}"
        case .skipBwLight: return "\u{f799}"
        case .skipBwRegular: return "\u{f79a}"
        case .skipFwBold: return "\u{f79b}"
        case .skipFwFilled: return "\u{f79c}"
        case .skipFwLight: return "\u{f79d}"
        case .skipFwRegular: return "\u{f79e}"
        case .skipLight: return "\u{f79f}"
        case .skipRegular: return "\u{f7a0}"
        case .speakerBold: return "\u{f7a1}"
        case .speakerDisconnectedBold: return "\u{f7a2}"
        case .speakerDisconnectedFilled: return "\u{f7a3}"
        case .speakerDisconnectedLight: return "\u{f7a4}"
        case .speakerDisconnectedRegular: return "\u{f7a5}"
        case .speakerFilled: return "\u{f7a6}"
        case .speakerLight: return "\u{f7a7}"
        case .speakerMutedBold: return "\u{f7a8}"
        case .speakerMutedFilled: return "\u{f7a9}"
        case .speakerMutedLight: return "\u{f7aa}"
        case .speakerMutedRegular: return "\u{f7ab}"
        case .speakerOffBold: return "\u{f7ac}"
        case .speakerOffFilled: return "\u{f7ad}"
        case .speakerOffLight: return "\u{f7ae}"
        case .speakerOffRegular: return "\u{f7af}"
        case .speakerOnColoredBold: return "\u{f7b0}"
        case .speakerOnColoredLight: return "\u{f7b1}"
        case .speakerOnColoredRegular: return "\u{f7b2}"
        case .speakerRegular: return "\u{f7b3}"
        case .speakerTurnDownBold: return "\u{f7b4}"
        case .speakerTurnDownFilled: return "\u{f7b5}"
        case .speakerTurnDownLight: return "\u{f7b6}"
        case .speakerTurnDownRegular: return "\u{f7b7}"
        case .speakerTurnUpBold: return "\u{f7b8}"
        case .speakerTurnUpFilled: return "\u{f7b9}"
        case .speakerTurnUpLight: return "\u{f7ba}"
        case .speakerTurnUpRegular: return "\u{f7bb}"
        case .spinnerBold: return "\u{f7bc}"
        case .spinnerFilledBold: return "\u{f7bd}"
        case .spinnerFilledLight: return "\u{f7be}"
        case .spinnerFilledRegular: return "\u{f7bf}"
        case .spinnerLight: return "\u{f7c0}"
        case .spinnerRegular: return "\u{f7c1}"
        case .stackedArea100ChartBold: return "\u{f7c2}"
        case .stackedArea100ChartFilled: return "\u{f7c3}"
        case .stackedArea100ChartLight: return "\u{f7c4}"
        case .stackedArea100ChartRegular: return "\u{f7c5}"
        case .stackedAreaChartBold: return "\u{f7c6}"
        case .stackedAreaChartFilled: return "\u{f7c7}"
        case .stackedAreaChartLight: return "\u{f7c8}"
        case .stackedAreaChartRegular: return "\u{f7c9}"
        case .stackedBar100ChartBold: return "\u{f7ca}"
        case .stackedBar100ChartFilled: return "\u{f7cb}"
        case .stackedBar100ChartLight: return "\u{f7cc}"
        case .stackedBar100ChartRegular: return "\u{f7cd}"
        case .stackedBarChartBold: return "\u{f7ce}"
        case .stackedBarChartFilled: return "\u{f7cf}"
        case .stackedBarChartLight: return "\u{f7d0}"
        case .stackedBarChartRegular: return "\u{f7d1}"
        case .startChatBold: return "\u{f7d2}"
        case .startChatLight: return "\u{f7d3}"
        case .startChatRegular: return "\u{f7d4}"
        case .stickersBold: return "\u{f7d5}"
        case .stickersLight: return "\u{f7d6}"
        case .stickersRegular: return "\u{f7d7}"
        case .stickiesBold: return "\u{f7d8}"
        case .stickiesLight: return "\u{f7d9}"
        case .stickiesRegular: return "\u{f7da}"
        case .stopBold: return "\u{f7db}"
        case .stopCircleBold: return "\u{f7dc}"
        case .stopCircleFilled: return "\u{f7dd}"
        case .stopCircleLight: return "\u{f7de}"
        case .stopCircleRegular: return "\u{f7df}"
        case .stopContentShareBold: return "\u{f7e0}"
        case .stopContentShareLight: return "\u{f7e1}"
        case .stopContentShareRegular: return "\u{f7e2}"
        case .stopFilled: return "\u{f7e3}"
        case .stopLight: return "\u{f7e4}"
        case .stopRegular: return "\u{f7e5}"
        case .storedInfoBold: return "\u{f7e6}"
        case .storedInfoFilled: return "\u{f7e7}"
        case .storedInfoLight: return "\u{f7e8}"
        case .storedInfoRegular: return "\u{f7e9}"
        case .streamingBold: return "\u{f7ea}"
        case .streamingLight: return "\u{f7eb}"
        case .streamingRegular: return "\u{f7ec}"
        case .strikethroughBold: return "\u{f7ed}"
        case .strikethroughLight: return "\u{f7ee}"
        case .strikethroughRegular: return "\u{f7ef}"
        case .subscriptBold: return "\u{f7f0}"
        case .subscriptLight: return "\u{f7f1}"
        case .subscriptRegular: return "\u{f7f2}"
        case .superscriptBold: return "\u{f7f3}"
        case .superscriptLight: return "\u{f7f4}"
        case .superscriptRegular: return "\u{f7f5}"
        case .sx10Bold: return "\u{f7f6}"
        case .sx10Light: return "\u{f7f7}"
        case .sx10Regular: return "\u{f7f8}"
        case .sx20Bold: return "\u{f7f9}"
        case .sx20Light: return "\u{f7fa}"
        case .sx20Regular: return "\u{f7fb}"
        case .sx80CodecBold: return "\u{f7fc}"
        case .sx80CodecLight: return "\u{f7fd}"
        case .sx80CodecRegular: return "\u{f7fe}"
        case .tableBold: return "\u{f7ff}"
        case .tableLight: return "\u{f800}"
        case .tableRegular: return "\u{f801}"
        case .tabletBold: return "\u{f802}"
        case .tabletLight: return "\u{f803}"
        case .tabletRegular: return "\u{f804}"
        case .tabsBold: return "\u{f805}"
        case .tabsLight: return "\u{f806}"
        case .tabsRegular: return "\u{f807}"
        case .tagBold: return "\u{f808}"
        case .tagLight: return "\u{f809}"
        case .tagRegular: return "\u{f80a}"
        case .telepresenceAlertBold: return "\u{f80b}"
        case .telepresenceAlertLight: return "\u{f80c}"
        case .telepresenceAlertMutedBold: return "\u{f80d}"
        case .telepresenceAlertMutedLight: return "\u{f80e}"
        case .telepresenceAlertMutedRegular: return "\u{f80f}"
        case .telepresenceAlertRegular: return "\u{f810}"
        case .telepresenceBold: return "\u{f811}"
        case .telepresenceIx5000Bold: return "\u{f812}"
        case .telepresenceIx5000Light: return "\u{f813}"
        case .telepresenceIx5000Regular: return "\u{f814}"
        case .telepresenceLight: return "\u{f815}"
        case .telepresencePrivateBold: return "\u{f816}"
        case .telepresencePrivateLight: return "\u{f817}"
        case .telepresencePrivateRegular: return "\u{f818}"
        case .telepresenceRegular: return "\u{f819}"
        case .temperatureBold: return "\u{f81a}"
        case .temperatureLight: return "\u{f81b}"
        case .temperatureRegular: return "\u{f81c}"
        case .textBold: return "\u{f81d}"
        case .textCodeBlockBold: return "\u{f81e}"
        case .textCodeBlockLight: return "\u{f81f}"
        case .textCodeBlockRegular: return "\u{f820}"
        case .textHighlightBold: return "\u{f821}"
        case .textHighlightLight: return "\u{f822}"
        case .textHighlightRegular: return "\u{f823}"
        case .textLight: return "\u{f824}"
        case .textRegular: return "\u{f825}"
        case .threeDObjectBold: return "\u{f826}"
        case .threeDObjectLight: return "\u{f827}"
        case .threeDObjectRegular: return "\u{f828}"
        case .tooFastBold: return "\u{f829}"
        case .tooFastLight: return "\u{f82a}"
        case .tooFastRegular: return "\u{f82b}"
        case .tooSlowBold: return "\u{f82c}"
        case .tooSlowLight: return "\u{f82d}"
        case .tooSlowRegular: return "\u{f82e}"
        case .toolsBold: return "\u{f82f}"
        case .toolsLight: return "\u{f830}"
        case .toolsRegular: return "\u{f831}"
        case .touch10Bold: return "\u{f832}"
        case .touch10Light: return "\u{f833}"
        case .touch10Regular: return "\u{f834}"
        case .transcriptBold: return "\u{f835}"
        case .transcriptLight: return "\u{f836}"
        case .transcriptRegular: return "\u{f837}"
        case .ucmCloudBold: return "\u{f838}"
        case .ucmCloudLight: return "\u{f839}"
        case .ucmCloudRegular: return "\u{f83a}"
        case .underlineBold: return "\u{f83b}"
        case .underlineLight: return "\u{f83c}"
        case .underlineRegular: return "\u{f83d}"
        case .undoBold: return "\u{f83e}"
        case .undoLight: return "\u{f83f}"
        case .undoRegular: return "\u{f840}"
        case .unlinkBold: return "\u{f841}"
        case .unlinkLight: return "\u{f842}"
        case .unlinkRegular: return "\u{f843}"
        case .unreadBold: return "\u{f844}"
        case .unreadFilled: return "\u{f845}"
        case .unreadLight: return "\u{f846}"
        case .unreadRegular: return "\u{f847}"
        case .unsecureUnlockedBold: return "\u{f848}"
        case .unsecureUnlockedFilled: return "\u{f849}"
        case .unsecureUnlockedLight: return "\u{f84a}"
        case .unsecureUnlockedRegular: return "\u{f84b}"
        case .unsortedBold: return "\u{f84c}"
        case .unsortedLight: return "\u{f84d}"
        case .unsortedRegular: return "\u{f84e}"
        case .updateFileShareBold: return "\u{f84f}"
        case .updateFileShareLight: return "\u{f850}"
        case .updateFileShareRegular: return "\u{f851}"
        case .uploadBold: return "\u{f852}"
        case .uploadLight: return "\u{f853}"
        case .uploadRegular: return "\u{f854}"
        case .usbBold: return "\u{f855}"
        case .usbHeadsetBold: return "\u{f856}"
        case .usbHeadsetLight: return "\u{f857}"
        case .usbHeadsetMutedBold: return "\u{f858}"
        case .usbHeadsetMutedLight: return "\u{f859}"
        case .usbHeadsetMutedRegular: return "\u{f85a}"
        case .usbHeadsetRegular: return "\u{f85b}"
        case .usbLight: return "\u{f85c}"
        case .usbRegular: return "\u{f85d}"
        case .userBold: return "\u{f85e}"
        case .userLight: return "\u{f85f}"
        case .userRegular: return "\u{f860}"
        case .vcsBold: return "\u{f861}"
        case .vcsLight: return "\u{f862}"
        case .vcsRegular: return "\u{f863}"
        case .videoBlurBold: return "\u{f864}"
        case .videoBlurFilled: return "\u{f865}"
        case .videoBlurLight: return "\u{f866}"
        case .videoBlurRegular: return "\u{f867}"
        case .videoBold: return "\u{f868}"
        case .videoEffectBold: return "\u{f869}"
        case .videoEffectFilled: return "\u{f86a}"
        case .videoEffectLight: return "\u{f86b}"
        case .videoEffectRegular: return "\u{f86c}"
        case .videoFilled: return "\u{f86d}"
        case .videoLayoutBold: return "\u{f86e}"
        case .videoLayoutEqualBold: return "\u{f86f}"
        case .videoLayoutEqualDualBold: return "\u{f870}"
        case .videoLayoutEqualDualLight: return "\u{f871}"
        case .videoLayoutEqualDualRegular: return "\u{f872}"
        case .videoLayoutEqualFilled: return "\u{f873}"
        case .videoLayoutEqualLight: return "\u{f874}"
        case .videoLayoutEqualRegular: return "\u{f875}"
        case .videoLayoutLight: return "\u{f876}"
        case .videoLayoutOverlayBold: return "\u{f877}"
        case .videoLayoutOverlayLight: return "\u{f878}"
        case .videoLayoutOverlayRegular: return "\u{f879}"
        case .videoLayoutProminentBold: return "\u{f87a}"
        case .videoLayoutProminentLight: return "\u{f87b}"
        case .videoLayoutProminentRegular: return "\u{f87c}"
        case .videoLayoutRegular: return "\u{f87d}"
        case .videoLayoutShareDominantBold: return "\u{f87e}"
        case .videoLayoutShareDominantLight: return "\u{f87f}"
        case .videoLayoutShareDominantRegular: return "\u{f880}"
        case .videoLayoutSingleBold: return "\u{f881}"
        case .videoLayoutSingleLight: return "\u{f882}"
        case .videoLayoutSingleRegular: return "\u{f883}"
        case .videoLayoutStackBold: return "\u{f884}"
        case .videoLayoutStackFilled: return "\u{f885}"
        case .videoLayoutStackLight: return "\u{f886}"
        case .videoLayoutStackRegular: return "\u{f887}"
        case .videoLayoutVideoDominantBold: return "\u{f888}"
        case .videoLayoutVideoDominantLight: return "\u{f889}"
        case .videoLayoutVideoDominantRegular: return "\u{f88a}"
        case .videoLight: return "\u{f88b}"
        case .videoPlusBold: return "\u{f88c}"
        case .videoPlusFilled: return "\u{f88d}"
        case .videoPlusLight: return "\u{f88e}"
        case .videoPlusRegular: return "\u{f88f}"
        case .videoRegular: return "\u{f890}"
        case .videoSpeakerTrackBold: return "\u{f891}"
        case .videoSpeakerTrackFilled: return "\u{f892}"
        case .videoSpeakerTrackLight: return "\u{f893}"
        case .videoSpeakerTrackRegular: return "\u{f894}"
        case .viewAllBold: return "\u{f895}"
        case .viewAllLight: return "\u{f896}"
        case .viewAllRegular: return "\u{f897}"
        case .viewListBold: return "\u{f898}"
        case .viewListLight: return "\u{f899}"
        case .viewListRegular: return "\u{f89a}"
        case .viewStackedBold: return "\u{f89b}"
        case .viewStackedLight: return "\u{f89c}"
        case .viewStackedRegular: return "\u{f89d}"
        case .viewThumbnailBold: return "\u{f89e}"
        case .viewThumbnailLight: return "\u{f89f}"
        case .viewThumbnailRegular: return "\u{f8a0}"
        case .voicemailBold: return "\u{f8a1}"
        case .voicemailFilled: return "\u{f8a2}"
        case .voicemailLight: return "\u{f8a3}"
        case .voicemailRegular: return "\u{f8a4}"
        case .wallpaperBold: return "\u{f8a5}"
        case .wallpaperLight: return "\u{f8a6}"
        case .wallpaperRegular: return "\u{f8a7}"
        case .warningBold: return "\u{f8a8}"
        case .warningFilled: return "\u{f8a9}"
        case .warningLight: return "\u{f8aa}"
        case .warningRegular: return "\u{f8ab}"
        case .webexBoardBold: return "\u{f8ac}"
        case .webexBoardLight: return "\u{f8ad}"
        case .webexBoardRegular: return "\u{f8ae}"
        case .webexCodecPlusBold: return "\u{f8af}"
        case .webexCodecPlusLight: return "\u{f8b0}"
        case .webexCodecPlusRegular: return "\u{f8b1}"
        case .webexDeskCameraBold: return "\u{f8b2}"
        case .webexDeskCameraLight: return "\u{f8b3}"
        case .webexDeskCameraRegular: return "\u{f8b4}"
        case .webexMeetingsBold: return "\u{f8b5}"
        case .webexMeetingsFilled: return "\u{f8b6}"
        case .webexMeetingsLight: return "\u{f8b7}"
        case .webexMeetingsRegular: return "\u{f8b8}"
        case .webexQuadCameraBold: return "\u{f8b9}"
        case .webexQuadCameraLight: return "\u{f8ba}"
        case .webexQuadCameraRegular: return "\u{f8bb}"
        case .webexRoomKitBold: return "\u{f8bc}"
        case .webexRoomKitLight: return "\u{f8bd}"
        case .webexRoomKitPlusBold: return "\u{f8be}"
        case .webexRoomKitPlusLight: return "\u{f8bf}"
        case .webexRoomKitPlusRegular: return "\u{f8c0}"
        case .webexRoomKitRegular: return "\u{f8c1}"
        case .webexShareBold: return "\u{f8c2}"
        case .webexShareLight: return "\u{f8c3}"
        case .webexShareRegular: return "\u{f8c4}"
        case .webexTeamsBold: return "\u{f8c5}"
        case .webexTeamsFilled: return "\u{f8c6}"
        case .webexTeamsLight: return "\u{f8c7}"
        case .webexTeamsNewBold: return "\u{f8c8}"
        case .webexTeamsNewFilled: return "\u{f8c9}"
        case .webexTeamsNewLight: return "\u{f8ca}"
        case .webexTeamsNewRegular: return "\u{f8cb}"
        case .webexTeamsRegular: return "\u{f8cc}"
        case .whiteboardBold: return "\u{f8cd}"
        case .whiteboardContentBold: return "\u{f8ce}"
        case .whiteboardContentLight: return "\u{f8cf}"
        case .whiteboardContentRegular: return "\u{f8d0}"
        case .whiteboardFilled: return "\u{f8d1}"
        case .whiteboardLight: return "\u{f8d2}"
        case .whiteboardRegular: return "\u{f8d3}"
        case .wifiBold: return "\u{f8d4}"
        case .wifiErrorBold: return "\u{f8d5}"
        case .wifiErrorLight: return "\u{f8d6}"
        case .wifiErrorRegular: return "\u{f8d7}"
        case .wifiLight: return "\u{f8d8}"
        case .wifiRegular: return "\u{f8d9}"
        case .windowCornerScrubBold: return "\u{f8da}"
        case .windowCornerScrubLight: return "\u{f8db}"
        case .windowCornerScrubRegular: return "\u{f8dc}"
        case .windowVerticalScrubBold: return "\u{f8dd}"
        case .windowVerticalScrubLight: return "\u{f8de}"
        case .windowVerticalScrubRegular: return "\u{f8df}"
        case .workphoneBold: return "\u{f8e0}"
        case .workphoneLight: return "\u{f8e1}"
        case .workphoneRegular: return "\u{f8e2}"
        case .zoomInBold: return "\u{f8e3}"
        case .zoomInLight: return "\u{f8e4}"
        case .zoomInRegular: return "\u{f8e5}"
        case .zoomOutBold: return "\u{f8e6}"
        case .zoomOutLight: return "\u{f8e7}"
        case .zoomOutRegular: return "\u{f8e8}"
