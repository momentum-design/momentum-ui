...
var IconContent = function IconContent(props) {
  ...
  return _react.default.createElement("div", null, _react.default.createElement("div", _extends({
    className: 'md-content-file' + ("" + (onClick && ' md-content-file--clickable' || '')) + ("" + (className && " " + className || '')),
    onClick: onClick,
    onKeyDown: handleKeyDown,
    role: "presentation"
  }, otherProps), !isProtected && actionNode && _react.default.createElement("div", {
    className: "md-content-file__icon"
  }, actionNode), _react.default.createElement("span", null, _react.default.createElement(_.Icon, {
    name: icon
  }))), _react.default.createElement("div", {
    className: "md-content-file__info-container"
  }, _react.default.createElement("span", {
    className: "md-content-file__title"
  }, loading ? 'Loading' : title), _react.default.createElement("span", {
