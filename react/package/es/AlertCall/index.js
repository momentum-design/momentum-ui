...
var AlertCall = function AlertCall(props) {
  ...
  var getDeviceList = function getDeviceList() {
    return devices.length > 0 && /*#__PURE__*/React.createElement(DeviceListCall, _extends({
  ...
  return show && /*#__PURE__*/React.createElement("div", _extends({
  ...
  }, getAvatar(), /*#__PURE__*/React.createElement("div", {
    className: "md-alert__caller-title"
  }, caller.title), /*#__PURE__*/React.createElement("div", {
    className: "md-alert__caller-subtitle"
  }, caller.alt)), /*#__PURE__*/React.createElement(UIDReset, null, getDeviceList()), /*#__PURE__*/React.createElement("div", {
    className: "md-alert--call--buttons"
  }, onAnswerShare && /*#__PURE__*/React.createElement(Button, _extends({
    ariaLabel: shareAriaLabel,
    circle: true,
    color: "blue",
    onClick: onAnswerShare,
    size: 44
  }, shareBtnProps), /*#__PURE__*/React.createElement(Icon, {
    name: "share-screen_24"
  })), onAnswerVideo && /*#__PURE__*/React.createElement(Button, _extends({
    ariaLabel: videoAriaLabel,
    circle: true,
    color: "green",
    onClick: onAnswerVideo,
    size: 44
  }, videoBtnProps), /*#__PURE__*/React.createElement(Icon, {
    name: "camera_24"
  })), onAnswerVoice && /*#__PURE__*/React.createElement(Button, _extends({
    ariaLabel: voiceAriaLabel,
    circle: true,
    color: "green",
    onClick: onAnswerVoice,
    size: 44
  }, voiceBtnProps), /*#__PURE__*/React.createElement(Icon, {
    name: "handset_24"
    ...
    onClick: onReject,
    size: 44
  }, rejectBtnProps), /*#__PURE__*/React.createElement(Icon, {
    name: "cancel_24"
  }))));
};
