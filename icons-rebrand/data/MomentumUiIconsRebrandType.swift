...
@objc public enum MomentumIconsRebrandType: Int {
    ...
    public var ligature: String {
        ...
        case .ciscoAiAssistantDefault: return "\u{f325}"
        case .ciscoAiAssistantFlat: return "\u{f326}"
        case .ciscoAiAssistantInactive: return "\u{f327}"
        case .cleanUpBold: return "\u{f328}"
        case .cleanUpLight: return "\u{f329}"
        case .cleanUpRegular: return "\u{f32a}"
        case .clearBold: return "\u{f32b}"
        case .clearFilled: return "\u{f32c}"
        case .clearLight: return "\u{f32d}"
        case .clearRegular: return "\u{f32e}"
        case .closeSpaceBold: return "\u{f32f}"
        case .closeSpaceLight: return "\u{f330}"
        case .closeSpaceRegular: return "\u{f331}"
        case .closedCaptionBadgeBold: return "\u{f332}"
        case .closedCaptionBadgeFilled: return "\u{f333}"
        case .closedCaptionBadgeLight: return "\u{f334}"
        case .closedCaptionBadgeRegular: return "\u{f335}"
        case .closedCaptionsBold: return "\u{f336}"
        case .closedCaptionsFilled: return "\u{f337}"
        case .closedCaptionsLight: return "\u{f338}"
        case .closedCaptionsRegular: return "\u{f339}"
        case .cloudBold: return "\u{f33a}"
        case .cloudDownloadBold: return "\u{f33b}"
        case .cloudDownloadLight: return "\u{f33c}"
        case .cloudDownloadRegular: return "\u{f33d}"
        case .cloudFilled: return "\u{f33e}"
        case .cloudFrameBold: return "\u{f33f}"
        case .cloudFrameFilled: return "\u{f340}"
        case .cloudFrameRegular: return "\u{f341}"
        case .cloudFramedFilled: return "\u{f342}"
        case .cloudFramedLight: return "\u{f343}"
        case .cloudLight: return "\u{f344}"
        case .cloudMutedBold: return "\u{f345}"
        case .cloudMutedFilled: return "\u{f346}"
        case .cloudMutedLight: return "\u{f347}"
        case .cloudMutedRegular: return "\u{f348}"
        case .cloudRegular: return "\u{f349}"
        case .cloudUploadBold: return "\u{f34a}"
        case .cloudUploadLight: return "\u{f34b}"
        case .cloudUploadRegular: return "\u{f34c}"
        case .codeBlockBold: return "\u{f34d}"
        case .codeBlockLight: return "\u{f34e}"
        case .codeBlockRegular: return "\u{f34f}"
        case .coffeeBold: return "\u{f350}"
        case .coffeeLight: return "\u{f351}"
        case .coffeeRegular: return "\u{f352}"
        case .colorBold: return "\u{f353}"
        case .colorLight: return "\u{f354}"
        case .colorRegular: return "\u{f355}"
        case .colourPaletteBold: return "\u{f356}"
        case .colourPaletteFilled: return "\u{f357}"
        case .colourPaletteLight: return "\u{f358}"
        case .colourPaletteRegular: return "\u{f359}"
        case .commentingBold: return "\u{f35a}"
        case .commentingFilled: return "\u{f35b}"
        case .commentingLight: return "\u{f35c}"
        case .commentingRegular: return "\u{f35d}"
        case .companyBold: return "\u{f35e}"
        case .companyLight: return "\u{f35f}"
        case .companyRegular: return "\u{f360}"
        case .completedByTimeBold: return "\u{f361}"
        case .completedByTimeLight: return "\u{f362}"
        case .completedByTimeRegular: return "\u{f363}"
        case .computerBold: return "\u{f364}"
        case .computerLight: return "\u{f365}"
        case .computerRegular: return "\u{f366}"
        case .conciergeBold: return "\u{f367}"
        case .conciergeLight: return "\u{f368}"
        case .conciergeRegular: return "\u{f369}"
        case .conditionalBlockBold: return "\u{f36a}"
        case .conditionalBlockLight: return "\u{f36b}"
        case .conditionalBlockRegular: return "\u{f36c}"
        case .contactCardBold: return "\u{f36d}"
        case .contactCardFilled: return "\u{f36e}"
        case .contactCardLight: return "\u{f36f}"
        case .contactCardRegular: return "\u{f370}"
        case .contactGroupBold: return "\u{f371}"
        case .contactGroupFilled: return "\u{f372}"
        case .contactGroupLight: return "\u{f373}"
        case .contactGroupRegular: return "\u{f374}"
        case .contactsBold: return "\u{f375}"
        case .contactsFilled: return "\u{f376}"
        case .contactsLight: return "\u{f377}"
        case .contactsRegular: return "\u{f378}"
        case .contentDownloadBold: return "\u{f379}"
        case .contentDownloadFilled: return "\u{f37a}"
        case .contentDownloadLight: return "\u{f37b}"
        case .contentDownloadRegular: return "\u{f37c}"
        case .contentShareBold: return "\u{f37d}"
        case .contentShareLight: return "\u{f37e}"
        case .contentShareRegular: return "\u{f37f}"
        case .contrastBold: return "\u{f380}"
        case .contrastLight: return "\u{f381}"
        case .contrastRegular: return "\u{f382}"
        case .copyBold: return "\u{f383}"
        case .copyLight: return "\u{f384}"
        case .copyRegular: return "\u{f385}"
        case .cpuBold: return "\u{f386}"
        case .cpuLight: return "\u{f387}"
        case .cpuRegular: return "\u{f388}"
        case .createAGroupBold: return "\u{f389}"
        case .createAGroupLight: return "\u{f38a}"
        case .createAGroupRegular: return "\u{f38b}"
        case .cropBold: return "\u{f38c}"
        case .cropLight: return "\u{f38d}"
        case .cropRegular: return "\u{f38e}"
        case .cucmConnectionBold: return "\u{f38f}"
        case .cucmConnectionLight: return "\u{f390}"
        case .cucmConnectionRegular: return "\u{f391}"
        case .dailyRecurringScheduleNodeBold: return "\u{f392}"
        case .dailyRecurringScheduleNodeLight: return "\u{f393}"
        case .dailyRecurringScheduleNodeRegular: return "\u{f394}"
        case .dashboardBold: return "\u{f395}"
        case .dashboardFilled: return "\u{f396}"
        case .dashboardLight: return "\u{f397}"
        case .dashboardRegular: return "\u{f398}"
        case .dataManagement1: return "\u{f399}"
        case .dataManagement2: return "\u{f39a}"
        case .dataManagement: return "\u{f39b}"
        case .declineBold: return "\u{f39c}"
        case .declineFilled: return "\u{f39d}"
        case .declineLight: return "\u{f39e}"
        case .declineRegular: return "\u{f39f}"
        case .deleteBold: return "\u{f3a0}"
        case .deleteFilled: return "\u{f3a1}"
        case .deleteLight: return "\u{f3a2}"
        case .deleteRegular: return "\u{f3a3}"
        case .deskPhoneBold: return "\u{f3a4}"
        case .deskPhoneFilled: return "\u{f3a5}"
        case .deskPhoneLight: return "\u{f3a6}"
        case .deskPhoneRegular: return "\u{f3a7}"
        case .deskPhoneWarningBold: return "\u{f3a8}"
        case .deskPhoneWarningLight: return "\u{f3a9}"
        case .deskPhoneWarningRegular: return "\u{f3aa}"
        case .deviceConnectionBold: return "\u{f3ab}"
        case .deviceConnectionFilled: return "\u{f3ac}"
        case .deviceConnectionLight: return "\u{f3ad}"
        case .deviceConnectionRegular: return "\u{f3ae}"
        case .deviceMutedBold: return "\u{f3af}"
        case .deviceMutedLight: return "\u{f3b0}"
        case .deviceMutedRegular: return "\u{f3b1}"
        case .devicePolicyControllerBold: return "\u{f3b2}"
        case .devicePolicyControllerLight: return "\u{f3b3}"
        case .devicePolicyControllerRegular: return "\u{f3b4}"
        case .diagnosticsBold: return "\u{f3b5}"
        case .diagnosticsLight: return "\u{f3b6}"
        case .diagnosticsRegular: return "\u{f3b7}"
        case .dialpadBold: return "\u{f3b8}"
        case .dialpadLight: return "\u{f3b9}"
        case .dialpadRegular: return "\u{f3ba}"
        case .directionalPadBold: return "\u{f3bb}"
        case .directionalPadFilled: return "\u{f3bc}"
        case .directionalPadLight: return "\u{f3bd}"
        case .directionalPadRegular: return "\u{f3be}"
        case .directoryBold: return "\u{f3bf}"
        case .directoryLight: return "\u{f3c0}"
        case .directoryRegular: return "\u{f3c1}"
        case .disappearingPenBold: return "\u{f3c2}"
        case .disappearingPenLight: return "\u{f3c3}"
        case .disappearingPenRegular: return "\u{f3c4}"
        case .discBold: return "\u{f3c5}"
        case .discDisconnectedBold: return "\u{f3c6}"
        case .discDisconnectedLight: return "\u{f3c7}"
        case .discDisconnectedRegular: return "\u{f3c8}"
        case .discLight: return "\u{f3c9}"
        case .discRegular: return "\u{f3ca}"
        case .disconnectBold: return "\u{f3cb}"
        case .disconnectFilled: return "\u{f3cc}"
        case .disconnectLight: return "\u{f3cd}"
        case .disconnectRegular: return "\u{f3ce}"
        case .dislikeBold: return "\u{f3cf}"
        case .dislikeFilled: return "\u{f3d0}"
        case .dislikeLight: return "\u{f3d1}"
        case .dislikeRegular: return "\u{f3d2}"
        case .displayBold: return "\u{f3d3}"
        case .displayInputBold: return "\u{f3d4}"
        case .displayInputLight: return "\u{f3d5}"
        case .displayInputRegular: return "\u{f3d6}"
        case .displayLight: return "\u{f3d7}"
        case .displayRegular: return "\u{f3d8}"
        case .displayWarningBold: return "\u{f3d9}"
        case .displayWarningLight: return "\u{f3da}"
        case .displayWarningRegular: return "\u{f3db}"
        case .distributeHorizontalBold: return "\u{f3dc}"
        case .distributeHorizontalFilled: return "\u{f3dd}"
        case .distributeHorizontalLight: return "\u{f3de}"
        case .distributeHorizontalRegular: return "\u{f3df}"
        case .distributeVerticallyBold: return "\u{f3e0}"
        case .distributeVerticallyFilled: return "\u{f3e1}"
        case .distributeVerticallyLight: return "\u{f3e2}"
        case .distributeVerticallyRegular: return "\u{f3e3}"
        case .dndPresenceBold: return "\u{f3e4}"
        case .dndPresenceFilled: return "\u{f3e5}"
        case .dndPresenceLight: return "\u{f3e6}"
        case .dndPresenceRegular: return "\u{f3e7}"
        case .dndPresenceSmallFilled: return "\u{f3e8}"
        case .documentBold: return "\u{f3e9}"
        case .documentCameraBold: return "\u{f3ea}"
        case .documentCameraDisconnectedBold: return "\u{f3eb}"
        case .documentCameraDisconnectedLight: return "\u{f3ec}"
        case .documentCameraDisconnectedRegular: return "\u{f3ed}"
        case .documentCameraLight: return "\u{f3ee}"
        case .documentCameraRegular: return "\u{f3ef}"
        case .documentCreateBold: return "\u{f3f0}"
        case .documentCreateFilled: return "\u{f3f1}"
        case .documentCreateLight: return "\u{f3f2}"
        case .documentCreateRegular: return "\u{f3f3}"
        case .documentFilled: return "\u{f3f4}"
        case .documentLight: return "\u{f3f5}"
        case .documentMoveBold: return "\u{f3f6}"
        case .documentMoveFilled: return "\u{f3f7}"
        case .documentMoveLight: return "\u{f3f8}"
        case .documentMoveRegular: return "\u{f3f9}"
        case .documentRegular: return "\u{f3fa}"
        case .documentShareBold: return "\u{f3fb}"
        case .documentShareFilled: return "\u{f3fc}"
        case .documentShareLight: return "\u{f3fd}"
        case .documentShareRegular: return "\u{f3fe}"
        case .doneAllBold: return "\u{f3ff}"
        case .doneAllLight: return "\u{f400}"
        case .doneAllRegular: return "\u{f401}"
        case .donutChartBold: return "\u{f402}"
        case .donutChartFilled: return "\u{f403}"
        case .donutChartLight: return "\u{f404}"
        case .donutChartRegular: return "\u{f405}"
        case .downloadBold: return "\u{f406}"
        case .downloadFilled: return "\u{f407}"
        case .downloadLight: return "\u{f408}"
        case .downloadRegular: return "\u{f409}"
        case .draftBold: return "\u{f40a}"
        case .draftFilled: return "\u{f40b}"
        case .draftIndicatorBold: return "\u{f40c}"
        case .draftIndicatorSmallFilled: return "\u{f40d}"
        case .draftLight: return "\u{f40e}"
        case .draftRegular: return "\u{f40f}"
        case .dragBold: return "\u{f410}"
        case .dragLight: return "\u{f411}"
        case .dragRegular: return "\u{f412}"
        case .dropdownBold: return "\u{f413}"
        case .dropdownLight: return "\u{f414}"
        case .dropdownRegular: return "\u{f415}"
        case .dx70Bold: return "\u{f416}"
        case .dx70Light: return "\u{f417}"
        case .dx70Regular: return "\u{f418}"
        case .dx80Bold: return "\u{f419}"
        case .dx80Filled: return "\u{f41a}"
        case .dx80Light: return "\u{f41b}"
        case .dx80Regular: return "\u{f41c}"
        case .editBold: return "\u{f41d}"
        case .editLight: return "\u{f41e}"
        case .editRegular: return "\u{f41f}"
        case .editablePartialBold: return "\u{f420}"
        case .editablePartialLight: return "\u{f421}"
        case .editablePartialRegular: return "\u{f422}"
        case .educationBold: return "\u{f423}"
        case .educationFilled: return "\u{f424}"
        case .educationLight: return "\u{f425}"
        case .educationRegular: return "\u{f426}"
        case .emailBold: return "\u{f427}"
        case .emailDeliveredBold: return "\u{f428}"
        case .emailDeliveredLight: return "\u{f429}"
        case .emailDeliveredRegular: return "\u{f42a}"
        case .emailFailureBold: return "\u{f42b}"
        case .emailFailureLight: return "\u{f42c}"
        case .emailFailureRegular: return "\u{f42d}"
        case .emailFilled: return "\u{f42e}"
        case .emailInviteBold: return "\u{f42f}"
        case .emailInviteLight: return "\u{f430}"
        case .emailInviteRegular: return "\u{f431}"
        case .emailLight: return "\u{f432}"
        case .emailReadBold: return "\u{f433}"
        case .emailReadFilled: return "\u{f434}"
        case .emailReadLight: return "\u{f435}"
        case .emailReadRegular: return "\u{f436}"
        case .emailRegular: return "\u{f437}"
        case .emojiExcitedBold: return "\u{f438}"
        case .emojiExcitedFilled: return "\u{f439}"
        case .emojiHappyBold: return "\u{f43a}"
        case .emojiHappyFilled: return "\u{f43b}"
        case .emojiHappyLight: return "\u{f43c}"
        case .emojiHappyRegular: return "\u{f43d}"
        case .emojiPassiveBold: return "\u{f43e}"
        case .emojiPassiveFilled: return "\u{f43f}"
        case .emojiPassiveLight: return "\u{f440}"
        case .emojiPassiveRegular: return "\u{f441}"
        case .emojiSadBold: return "\u{f442}"
        case .emojiSadFilled: return "\u{f443}"
        case .emojiSadLight: return "\u{f444}"
        case .emojiSadRegular: return "\u{f445}"
        case .emojiUnhappyBold: return "\u{f446}"
        case .emojiUnhappyFilled: return "\u{f447}"
        case .encryptionCircleFilled: return "\u{f448}"
        case .encryptionFilled: return "\u{f449}"
        case .endRemoteDesktopControlBold: return "\u{f44a}"
        case .endRemoteDesktopControlLight: return "\u{f44b}"
        case .endRemoteDesktopControlRegular: return "\u{f44c}"
        case .endToEndEncryptionCircleFilled: return "\u{f44d}"
        case .endToEndEncryptionFilled: return "\u{f44e}"
        case .endpointBlockedBold: return "\u{f44f}"
        case .endpointBlockedLight: return "\u{f450}"
        case .endpointBlockedRegular: return "\u{f451}"
        case .endpointBold: return "\u{f452}"
        case .endpointG270Bold: return "\u{f453}"
        case .endpointG270DualBold: return "\u{f454}"
        case .endpointG270DualLight: return "\u{f455}"
        case .endpointG270DualRegular: return "\u{f456}"
        case .endpointG270Light: return "\u{f457}"
        case .endpointG270Regular: return "\u{f458}"
        case .endpointG2Bold: return "\u{f459}"
        case .endpointG2Light: return "\u{f45a}"
        case .endpointG2Regular: return "\u{f45b}"
        case .endpointG2StandBold: return "\u{f45c}"
        case .endpointG2StandLight: return "\u{f45d}"
        case .endpointG2StandRegular: return "\u{f45e}"
        case .endpointLight: return "\u{f45f}"
        case .endpointMx800Bold: return "\u{f460}"
        case .endpointMx800DualBold: return "\u{f461}"
        case .endpointMx800DualLight: return "\u{f462}"
        case .endpointMx800DualRegular: return "\u{f463}"
        case .endpointMx800Light: return "\u{f464}"
        case .endpointMx800Regular: return "\u{f465}"
        case .endpointRegular: return "\u{f466}"
        case .endpointStandBold: return "\u{f467}"
        case .endpointStandFilled: return "\u{f468}"
        case .endpointStandLight: return "\u{f469}"
        case .endpointStandRegular: return "\u{f46a}"
        case .endpointWarningBold: return "\u{f46b}"
        case .endpointWarningLight: return "\u{f46c}"
        case .endpointWarningRegular: return "\u{f46d}"
        case .enterBold: return "\u{f46e}"
        case .enterLight: return "\u{f46f}"
        case .enterRegular: return "\u{f470}"
        case .enterRoomBold: return "\u{f471}"
        case .enterRoomFilled: return "\u{f472}"
        case .enterRoomLight: return "\u{f473}"
        case .enterRoomRegular: return "\u{f474}"
        case .eraserBold: return "\u{f475}"
        case .eraserFilled: return "\u{f476}"
        case .eraserLight: return "\u{f477}"
        case .eraserRegular: return "\u{f478}"
        case .errorLegacyBadgeFilled: return "\u{f479}"
        case .errorLegacyBold: return "\u{f47a}"
        case .errorLegacyFilled: return "\u{f47b}"
        case .errorLegacyLight: return "\u{f47c}"
        case .errorLegacyRegular: return "\u{f47d}"
        case .ethernetBold: return "\u{f47e}"
        case .ethernetLight: return "\u{f47f}"
        case .ethernetRegular: return "\u{f480}"
        case .eventBold: return "\u{f481}"
        case .eventLight: return "\u{f482}"
        case .eventRegular: return "\u{f483}"
        case .exchangeBold: return "\u{f484}"
        case .exchangeLight: return "\u{f485}"
        case .exchangeRegular: return "\u{f486}"
        case .exitRoomBold: return "\u{f487}"
        case .exitRoomLight: return "\u{f488}"
        case .exitRoomRegular: return "\u{f489}"
        case .exludeBold: return "\u{f48a}"
        case .exludeLight: return "\u{f48b}"
        case .exludeRegular: return "\u{f48c}"
        case .exploreBold: return "\u{f48d}"
        case .exploreLight: return "\u{f48e}"
        case .exploreRegular: return "\u{f48f}"
        case .exportBold: return "\u{f490}"
        case .exportLight: return "\u{f491}"
        case .exportRegular: return "\u{f492}"
        case .extensionMobilityBold: return "\u{f493}"
        case .extensionMobilityLight: return "\u{f494}"
        case .extensionMobilityRegular: return "\u{f495}"
        case .externalMessageBold: return "\u{f496}"
        case .externalMessageLight: return "\u{f497}"
        case .externalMessageRegular: return "\u{f498}"
        case .externalUserBold: return "\u{f499}"
        case .externalUserLight: return "\u{f49a}"
        case .externalUserRegular: return "\u{f49b}"
        case .familyFontBold: return "\u{f49c}"
        case .familyFontLight: return "\u{f49d}"
        case .familyFontRegular: return "\u{f49e}"
        case .fastForwardBold: return "\u{f49f}"
        case .fastForwardLight: return "\u{f4a0}"
        case .fastForwardRegular: return "\u{f4a1}"
        case .favoriteApps192CobaltLime: return "\u{f4a2}"
        case .favoriteApps192: return "\u{f4a3}"
        case .favoriteBold: return "\u{f4a4}"
        case .favoriteFilled: return "\u{f4a5}"
        case .favoriteLight: return "\u{f4a6}"
        case .favoriteRegular: return "\u{f4a7}"
        case .favoritesBold: return "\u{f4a8}"
        case .favoritesFilled: return "\u{f4a9}"
        case .favoritesLight: return "\u{f4aa}"
        case .favoritesRegular: return "\u{f4ab}"
        case .fbwBold: return "\u{f4ac}"
        case .fbwFilled: return "\u{f4ad}"
        case .fbwLight: return "\u{f4ae}"
        case .fbwRegular: return "\u{f4af}"
        case .ffwBold: return "\u{f4b0}"
        case .ffwFilled: return "\u{f4b1}"
        case .ffwLight: return "\u{f4b2}"
        case .ffwRegular: return "\u{f4b3}"
        case .file3DBold: return "\u{f4b4}"
        case .file3DFilled: return "\u{f4b5}"
        case .file3DLight: return "\u{f4b6}"
        case .file3DRegular: return "\u{f4b7}"
        case .fileAnalysisBold: return "\u{f4b8}"
        case .fileAnalysisFilled: return "\u{f4b9}"
        case .fileAnalysisLight: return "\u{f4ba}"
        case .fileAnalysisRegular: return "\u{f4bb}"
        case .fileAnnotationBold: return "\u{f4bc}"
        case .fileAnnotationFilled: return "\u{f4bd}"
        case .fileAnnotationLight: return "\u{f4be}"
        case .fileAnnotationRegular: return "\u{f4bf}"
        case .fileAudioBold: return "\u{f4c0}"
        case .fileAudioFilled: return "\u{f4c1}"
        case .fileAudioLight: return "\u{f4c2}"
        case .fileAudioRegular: return "\u{f4c3}"
        case .fileBugBold: return "\u{f4c4}"
        case .fileBugFilled: return "\u{f4c5}"
        case .fileBugLight: return "\u{f4c6}"
        case .fileBugRegular: return "\u{f4c7}"
        case .fileCodeBold: return "\u{f4c8}"
        case .fileCodeFilled: return "\u{f4c9}"
        case .fileCodeLight: return "\u{f4ca}"
        case .fileCodeRegular: return "\u{f4cb}"
        case .fileDashboardBold: return "\u{f4cc}"
        case .fileDashboardFilled: return "\u{f4cd}"
        case .fileDashboardLight: return "\u{f4ce}"
        case .fileDashboardRegular: return "\u{f4cf}"
        case .fileExcelBold: return "\u{f4d0}"
        case .fileExcelFilled: return "\u{f4d1}"
        case .fileExcelLight: return "\u{f4d2}"
        case .fileExcelRegular: return "\u{f4d3}"
        case .fileGraphBold: return "\u{f4d4}"
        case .fileGraphFilled: return "\u{f4d5}"
        case .fileGraphLight: return "\u{f4d6}"
        case .fileGraphRegular: return "\u{f4d7}"
        case .fileImageBold: return "\u{f4d8}"
        case .fileImageFilled: return "\u{f4d9}"
        case .fileImageLight: return "\u{f4da}"
        case .fileImageNoneBold: return "\u{f4db}"
        case .fileImageNoneLight: return "\u{f4dc}"
        case .fileImageNoneRegular: return "\u{f4dd}"
        case .fileImageRegular: return "\u{f4de}"
        case .fileKeynoteBold: return "\u{f4df}"
        case .fileKeynoteFilled: return "\u{f4e0}"
        case .fileKeynoteLight: return "\u{f4e1}"
        case .fileKeynoteRegular: return "\u{f4e2}"
        case .fileLockedBold: return "\u{f4e3}"
        case .fileLockedFilled: return "\u{f4e4}"
        case .fileLockedLight: return "\u{f4e5}"
        case .fileLockedRegular: return "\u{f4e6}"
        case .fileMissingBold: return "\u{f4e7}"
        case .fileMissingFilled: return "\u{f4e8}"
        case .fileMissingLight: return "\u{f4e9}"
        case .fileMissingRegular: return "\u{f4ea}"
        case .fileMusicBold: return "\u{f4eb}"
        case .fileMusicFilled: return "\u{f4ec}"
        case .fileMusicLight: return "\u{f4ed}"
        case .fileMusicRegular: return "\u{f4ee}"
        case .fileOnenoteBold: return "\u{f4ef}"
        case .fileOnenoteFilled: return "\u{f4f0}"
        case .fileOnenoteLight: return "\u{f4f1}"
        case .fileOnenoteRegular: return "\u{f4f2}"
        case .filePdfBold: return "\u{f4f3}"
        case .filePdfFilled: return "\u{f4f4}"
        case .filePdfLight: return "\u{f4f5}"
        case .filePdfRegular: return "\u{f4f6}"
        case .filePowerpointBold: return "\u{f4f7}"
        case .filePowerpointFilled: return "\u{f4f8}"
        case .filePowerpointLight: return "\u{f4f9}"
        case .filePowerpointRegular: return "\u{f4fa}"
        case .fileSpreadsheetBold: return "\u{f4fb}"
        case .fileSpreadsheetFilled: return "\u{f4fc}"
        case .fileSpreadsheetLight: return "\u{f4fd}"
        case .fileSpreadsheetRegular: return "\u{f4fe}"
        case .fileTextBold: return "\u{f4ff}"
        case .fileTextFilled: return "\u{f500}"
        case .fileTextLight: return "\u{f501}"
        case .fileTextRegular: return "\u{f502}"
        case .fileVectorBold: return "\u{f503}"
        case .fileVectorFilled: return "\u{f504}"
        case .fileVectorLight: return "\u{f505}"
        case .fileVectorRegular: return "\u{f506}"
        case .fileVideoBold: return "\u{f507}"
        case .fileVideoFilled: return "\u{f508}"
        case .fileVideoLight: return "\u{f509}"
        case .fileVideoRegular: return "\u{f50a}"
        case .fileWordBold: return "\u{f50b}"
        case .fileWordFilled: return "\u{f50c}"
        case .fileWordLight: return "\u{f50d}"
        case .fileWordRegular: return "\u{f50e}"
        case .fileZipBold: return "\u{f50f}"
        case .fileZipFilled: return "\u{f510}"
        case .fileZipLight: return "\u{f511}"
        case .fileZipRegular: return "\u{f512}"
        case .filesBold: return "\u{f513}"
        case .filesFilled: return "\u{f514}"
        case .filesLight: return "\u{f515}"
        case .filesRegular: return "\u{f516}"
        case .fillColourBold: return "\u{f517}"
        case .fillColourFilled: return "\u{f518}"
        case .fillColourLight: return "\u{f519}"
        case .fillColourRegular: return "\u{f51a}"
        case .filterBold: return "\u{f51b}"
        case .filterCircleBold: return "\u{f51c}"
        case .filterCircleFilled: return "\u{f51d}"
        case .filterCircleLight: return "\u{f51e}"
        case .filterCircleRegular: return "\u{f51f}"
        case .filterLight: return "\u{f520}"
        case .filterRegular: return "\u{f521}"
        case .fitToWidthBold: return "\u{f522}"
        case .fitToWidthLight: return "\u{f523}"
        case .fitToWidthRegular: return "\u{f524}"
        case .fitToWindowBold: return "\u{f525}"
        case .fitToWindowExitBold: return "\u{f526}"
        case .fitToWindowExitLight: return "\u{f527}"
        case .fitToWindowExitRegular: return "\u{f528}"
        case .fitToWindowLight: return "\u{f529}"
        case .fitToWindowRegular: return "\u{f52a}"
        case .flagBold: return "\u{f52b}"
        case .flagCircleBold: return "\u{f52c}"
        case .flagCircleFilled: return "\u{f52d}"
        case .flagCircleLight: return "\u{f52e}"
        case .flagCircleRegular: return "\u{f52f}"
        case .flagFilled: return "\u{f530}"
        case .flagLight: return "\u{f531}"
        case .flagRegular: return "\u{f532}"
        case .folderBold: return "\u{f533}"
        case .folderEditBold: return "\u{f534}"
        case .folderEditLight: return "\u{f535}"
        case .folderEditRegular: return "\u{f536}"
        case .folderLight: return "\u{f537}"
        case .folderLockBold: return "\u{f538}"
        case .folderLockLight: return "\u{f539}"
        case .folderLockRegular: return "\u{f53a}"
        case .folderRegular: return "\u{f53b}"
        case .folderViewBold: return "\u{f53c}"
        case .folderViewLight: return "\u{f53d}"
        case .folderViewRegular: return "\u{f53e}"
        case .followUpBold: return "\u{f53f}"
        case .followUpLight: return "\u{f540}"
        case .followUpRegular: return "\u{f541}"
        case .foodBold: return "\u{f542}"
        case .foodLight: return "\u{f543}"
        case .foodRegular: return "\u{f544}"
        case .formatBold: return "\u{f545}"
        case .formatControlPanelDraggerBold: return "\u{f546}"
        case .formatControlPanelDraggerHorizontalBold: return "\u{f547}"
        case .formatControlPanelDraggerHorizontalLight: return "\u{f548}"
        case .formatControlPanelDraggerHorizontalRegular: return "\u{f549}"
        case .formatControlPanelDraggerLight: return "\u{f54a}"
        case .formatControlPanelDraggerRegular: return "\u{f54b}"
        case .formatDefaultAppBold: return "\u{f54c}"
        case .formatDefaultAppLight: return "\u{f54d}"
        case .formatDefaultAppRegular: return "\u{f54e}"
        case .formatLight: return "\u{f54f}"
        case .formatPanelControlBarBold: return "\u{f550}"
        case .formatPanelControlBarLight: return "\u{f551}"
        case .formatPanelControlBarRegular: return "\u{f552}"
        case .formatPanelControlDownBold: return "\u{f553}"
        case .formatPanelControlDownLight: return "\u{f554}"
        case .formatPanelControlDownRegular: return "\u{f555}"
        case .formatPanelControlLeftBold: return "\u{f556}"
        case .formatPanelControlLeftLight: return "\u{f557}"
        case .formatPanelControlLeftRegular: return "\u{f558}"
        case .formatPanelControlRightBold: return "\u{f559}"
        case .formatPanelControlRightLight: return "\u{f55a}"
        case .formatPanelControlRightRegular: return "\u{f55b}"
        case .formatPanelControlUpBold: return "\u{f55c}"
        case .formatPanelControlUpDownBold: return "\u{f55d}"
        case .formatPanelControlUpDownLight: return "\u{f55e}"
        case .formatPanelControlUpDownRegular: return "\u{f55f}"
        case .formatPanelControlUpLight: return "\u{f560}"
        case .formatPanelControlUpRegular: return "\u{f561}"
        case .formatRegular: return "\u{f562}"
        case .formatViewMixedBold: return "\u{f563}"
        case .formatViewMixedLight: return "\u{f564}"
        case .formatViewMixedRegular: return "\u{f565}"
        case .forwardMessageBold: return "\u{f566}"
        case .forwardMessageFilled: return "\u{f567}"
        case .forwardMessageLight: return "\u{f568}"
        case .forwardMessageRegular: return "\u{f569}"
        case .fourColumnBold: return "\u{f56a}"
        case .fourColumnLight: return "\u{f56b}"
        case .fourColumnRegular: return "\u{f56c}"
        case .fourWayNavigationBold: return "\u{f56d}"
        case .fourWayNavigationLight: return "\u{f56e}"
        case .fourWayNavigationRegular: return "\u{f56f}"
        case .frequencyCappingBold: return "\u{f570}"
        case .frequencyCappingLight: return "\u{f571}"
        case .frequencyCappingRegular: return "\u{f572}"
        case .fufillmentBold: return "\u{f573}"
        case .fufillmentLight: return "\u{f574}"
        case .fufillmentRegular: return "\u{f575}"
        case .fullscreenBold: return "\u{f576}"
        case .fullscreenExitBold: return "\u{f577}"
        case .fullscreenExitLight: return "\u{f578}"
        case .fullscreenExitRegular: return "\u{f579}"
        case .fullscreenLight: return "\u{f57a}"
        case .fullscreenRegular: return "\u{f57b}"
        case .genericDeviceVideoBold: return "\u{f57c}"
        case .genericDeviceVideoFilled: return "\u{f57d}"
        case .genericDeviceVideoLight: return "\u{f57e}"
        case .genericDeviceVideoRegular: return "\u{f57f}"
        case .genericDeviceVideoSmallFilled: return "\u{f580}"
        case .gifBold: return "\u{f581}"
        case .gifFilled: return "\u{f582}"
        case .gifHorizontalFilled: return "\u{f583}"
        case .gifLight: return "\u{f584}"
        case .gifRegular: return "\u{f585}"
        case .googleMeet: return "\u{f586}"
        case .grabberBold: return "\u{f587}"
        case .grabberLight: return "\u{f588}"
        case .grabberRegular: return "\u{f589}"
        case .greenLeafFilled: return "\u{f58a}"
        case .greenRoomBold: return "\u{f58b}"
        case .greenRoomFilled: return "\u{f58c}"
        case .greenRoomLight: return "\u{f58d}"
        case .greenRoomRegular: return "\u{f58e}"
        case .groupBold: return "\u{f58f}"
        case .groupLight: return "\u{f590}"
        case .groupPickupBold: return "\u{f591}"
        case .groupPickupFilled: return "\u{f592}"
        case .groupPickupLight: return "\u{f593}"
        case .groupPickupRegular: return "\u{f594}"
        case .groupRegular: return "\u{f595}"
        case .guestIssuerBold: return "\u{f596}"
        case .guestIssuerLight: return "\u{f597}"
        case .guestIssuerRegular: return "\u{f598}"
        case .guideBold: return "\u{f599}"
        case .guideLight: return "\u{f59a}"
        case .guideRegular: return "\u{f59b}"
        case .handlerBold: return "\u{f59c}"
        case .handlerLight: return "\u{f59d}"
        case .handlerRegular: return "\u{f59e}"
        case .handsetAlertBold: return "\u{f59f}"
        case .handsetAlertFilled: return "\u{f5a0}"
        case .handsetAlertLight: return "\u{f5a1}"
        case .handsetAlertRegular: return "\u{f5a2}"
        case .handsetBold: return "\u{f5a3}"
        case .handsetFilled: return "\u{f5a4}"
        case .handsetLight: return "\u{f5a5}"
        case .handsetMutedBold: return "\u{f5a6}"
        case .handsetMutedFilled: return "\u{f5a7}"
        case .handsetMutedLight: return "\u{f5a8}"
        case .handsetMutedRegular: return "\u{f5a9}"
        case .handsetRegular: return "\u{f5aa}"
        case .handshakeBold: return "\u{f5ab}"
        case .handshakeLight: return "\u{f5ac}"
        case .handshakeRegular: return "\u{f5ad}"
        case .headingOneBold: return "\u{f5ae}"
        case .headingOneLight: return "\u{f5af}"
        case .headingOneRegular: return "\u{f5b0}"
        case .headingThreeBold: return "\u{f5b1}"
        case .headingThreeLight: return "\u{f5b2}"
        case .headingThreeRegular: return "\u{f5b3}"
        case .headingTwoBold: return "\u{f5b4}"
        case .headingTwoLight: return "\u{f5b5}"
        case .headingTwoRegular: return "\u{f5b6}"
        case .headphonesBold: return "\u{f5b7}"
        case .headphonesFilled: return "\u{f5b8}"
        case .headphonesLight: return "\u{f5b9}"
        case .headphonesMutedBold: return "\u{f5ba}"
        case .headphonesMutedFilled: return "\u{f5bb}"
        case .headphonesMutedLight: return "\u{f5bc}"
        case .headphonesMutedRegular: return "\u{f5bd}"
        case .headphonesRegular: return "\u{f5be}"
        case .headsetAlertBold: return "\u{f5bf}"
        case .headsetAlertLight: return "\u{f5c0}"
        case .headsetAlertRegular: return "\u{f5c1}"
        case .headsetBold: return "\u{f5c2}"
        case .headsetFilled: return "\u{f5c3}"
        case .headsetLight: return "\u{f5c4}"
        case .headsetMutedBold: return "\u{f5c5}"
        case .headsetMutedLight: return "\u{f5c6}"
        case .headsetMutedRegular: return "\u{f5c7}"
        case .headsetPrivateBold: return "\u{f5c8}"
        case .headsetPrivateLight: return "\u{f5c9}"
        case .headsetPrivateRegular: return "\u{f5ca}"
        case .headsetRegular: return "\u{f5cb}"
        case .hearingImpairedBold: return "\u{f5cc}"
        case .hearingImpairedLight: return "\u{f5cd}"
        case .hearingImpairedRegular: return "\u{f5ce}"
        case .helpBold: return "\u{f5cf}"
        case .helpCircleActiveFilled: return "\u{f5d0}"
        case .helpCircleBold: return "\u{f5d1}"
        case .helpCircleLight: return "\u{f5d2}"
        case .helpCircleRegular: return "\u{f5d3}"
        case .helpLight: return "\u{f5d4}"
        case .helpRegular: return "\u{f5d5}"
        case .helpdeskBold: return "\u{f5d6}"
        case .helpdeskFilled: return "\u{f5d7}"
        case .helpdeskLight: return "\u{f5d8}"
        case .helpdeskRegular: return "\u{f5d9}"
        case .hideBold: return "\u{f5da}"
        case .hideFilled: return "\u{f5db}"
        case .hideLight: return "\u{f5dc}"
        case .hideRegular: return "\u{f5dd}"
        case .homeBold: return "\u{f5de}"
        case .homeFilled: return "\u{f5df}"
        case .homeLight: return "\u{f5e0}"
        case .homeRegular: return "\u{f5e1}"
        case .horizontalLineBold: return "\u{f5e2}"
        case .horizontalLineLight: return "\u{f5e3}"
        case .horizontalLineRegular: return "\u{f5e4}"
        case .hotelingBold: return "\u{f5e5}"
        case .hotelingFilled: return "\u{f5e6}"
        case .hotelingLight: return "\u{f5e7}"
        case .hotelingRegular: return "\u{f5e8}"
        case .humidityBold: return "\u{f5e9}"
        case .humidityLight: return "\u{f5ea}"
        case .humidityRegular: return "\u{f5eb}"
        case .huntGroupBold: return "\u{f5ec}"
        case .huntGroupFilled: return "\u{f5ed}"
        case .huntGroupLight: return "\u{f5ee}"
        case .huntGroupRegular: return "\u{f5ef}"
        case .importBold: return "\u{f5f0}"
        case .importLight: return "\u{f5f1}"
        case .importRegular: return "\u{f5f2}"
        case .inCommonBold: return "\u{f5f3}"
        case .inCommonLight: return "\u{f5f4}"
        case .inCommonRegular: return "\u{f5f5}"
        case .includeBold: return "\u{f5f6}"
        case .includeLight: return "\u{f5f7}"
        case .includeRegular: return "\u{f5f8}"
        case .incomingCallLegacyBold: return "\u{f5f9}"
        case .incomingCallLegacyFilled: return "\u{f5fa}"
        case .incomingCallLegacyLight: return "\u{f5fb}"
        case .incomingCallLegacyRegular: return "\u{f5fc}"
        case .infoBadgeFilled: return "\u{f5fd}"
        case .infoCircleBold: return "\u{f5fe}"
        case .infoCircleFilled: return "\u{f5ff}"
        case .infoCircleLight: return "\u{f600}"
        case .infoCircleRegular: return "\u{f601}"
        case .infoCircleTwoBold: return "\u{f602}"
        case .infoCircleTwoFilled: return "\u{f603}"
        case .infoCircleTwoLight: return "\u{f604}"
        case .infoCircleTwoRegular: return "\u{f605}"
        case .inputBold: return "\u{f606}"
        case .inputDisconnectedBold: return "\u{f607}"
        case .inputDisconnectedLight: return "\u{f608}"
        case .inputDisconnectedRegular: return "\u{f609}"
        case .inputLight: return "\u{f60a}"
        case .inputRegular: return "\u{f60b}"
        case .insightsBold: return "\u{f60c}"
        case .insightsLight: return "\u{f60d}"
        case .insightsRegular: return "\u{f60e}"
        case .instantScheduleBold: return "\u{f60f}"
        case .instantScheduleFilled: return "\u{f610}"
        case .instantScheduleLight: return "\u{f611}"
        case .instantScheduleRegular: return "\u{f612}"
        case .integrationsBold: return "\u{f613}"
        case .integrationsLight: return "\u{f614}"
        case .integrationsRegular: return "\u{f615}"
        case .intelligentRoutingBold: return "\u{f616}"
        case .intelligentRoutingLight: return "\u{f617}"
        case .intelligentRoutingRegular: return "\u{f618}"
        case .invitedUserBold: return "\u{f619}"
        case .invitedUserLight: return "\u{f61a}"
        case .invitedUserRegular: return "\u{f61b}"
        case .italicBold: return "\u{f61c}"
        case .italicLight: return "\u{f61d}"
        case .italicRegular: return "\u{f61e}"
        case .joinAudioBold: return "\u{f61f}"
        case .joinAudioFilled: return "\u{f620}"
        case .joinAudioLight: return "\u{f621}"
        case .joinAudioRegular: return "\u{f622}"
        case .keepInTouchBold: return "\u{f623}"
        case .keepInTouchFilled: return "\u{f624}"
        case .keepInTouchLight: return "\u{f625}"
        case .keepInTouchRegular: return "\u{f626}"
        case .keyboardBold: return "\u{f627}"
        case .keyboardCloseBold: return "\u{f628}"
        case .keyboardCloseLight: return "\u{f629}"
        case .keyboardCloseRegular: return "\u{f62a}"
        case .keyboardLight: return "\u{f62b}"
        case .keyboardRegular: return "\u{f62c}"
        case .languageBold: return "\u{f62d}"
        case .languageLight: return "\u{f62e}"
        case .languageRegular: return "\u{f62f}"
        case .laptopBold: return "\u{f630}"
        case .laptopDisconnectedBold: return "\u{f631}"
        case .laptopDisconnectedLight: return "\u{f632}"
        case .laptopDisconnectedRegular: return "\u{f633}"
        case .laptopFilled: return "\u{f634}"
        case .laptopLight: return "\u{f635}"
        case .laptopRegular: return "\u{f636}"
        case .laserPointerBold: return "\u{f637}"
        case .laserPointerLight: return "\u{f638}"
        case .laserPointerRegular: return "\u{f639}"
        case .launchBold: return "\u{f63a}"
        case .launchLight: return "\u{f63b}"
        case .launchRegular: return "\u{f63c}"
        case .layoutSideBySideVerticalBold: return "\u{f63d}"
        case .layoutSideBySideVerticalFilled: return "\u{f63e}"
        case .layoutSideBySideVerticalLight: return "\u{f63f}"
        case .layoutSideBySideVerticalRegular: return "\u{f640}"
        case .leaveBreakoutSessionBold: return "\u{f641}"
        case .leaveBreakoutSessionLight: return "\u{f642}"
        case .leaveBreakoutSessionRegular: return "\u{f643}"
        case .leaveDeviceBold: return "\u{f644}"
        case .leaveDeviceLight: return "\u{f645}"
        case .leaveDeviceRegular: return "\u{f646}"
        case .lightningBold: return "\u{f647}"
        case .lightningFilled: return "\u{f648}"
        case .lightningLight: return "\u{f649}"
        case .lightningRegular: return "\u{f64a}"
        case .likeBold: return "\u{f64b}"
        case .likeFilled: return "\u{f64c}"
        case .likeLight: return "\u{f64d}"
        case .likeRegular: return "\u{f64e}"
        case .linkBold: return "\u{f64f}"
        case .linkLight: return "\u{f650}"
        case .linkRegular: return "\u{f651}"
        case .listBulletedBold: return "\u{f652}"
        case .listBulletedLight: return "\u{f653}"
        case .listBulletedRegular: return "\u{f654}"
        case .listMenuBold: return "\u{f655}"
        case .listMenuLight: return "\u{f656}"
        case .listMenuRegular: return "\u{f657}"
        case .listNumberedBold: return "\u{f658}"
        case .listNumberedLight: return "\u{f659}"
        case .listNumberedRegular: return "\u{f65a}"
        case .liveBold: return "\u{f65b}"
        case .liveFilled: return "\u{f65c}"
        case .liveLight: return "\u{f65d}"
        case .liveRegular: return "\u{f65e}"
        case .locationBold: return "\u{f65f}"
        case .locationFilled: return "\u{f660}"
        case .locationLight: return "\u{f661}"
        case .locationRegular: return "\u{f662}"
        case .longTextBoxBold: return "\u{f663}"
        case .longTextBoxLight: return "\u{f664}"
        case .longTextBoxRegular: return "\u{f665}"
        case .lowerHandBold: return "\u{f666}"
        case .lowerHandLight: return "\u{f667}"
        case .lowerHandRegular: return "\u{f668}"
        case .magicPenBold: return "\u{f669}"
        case .magicPenFilled: return "\u{f66a}"
        case .magicPenLight: return "\u{f66b}"
        case .magicPenRegular: return "\u{f66c}"
        case .markAsUnreadBold: return "\u{f66d}"
        case .markAsUnreadLight: return "\u{f66e}"
        case .markAsUnreadRegular: return "\u{f66f}"
        case .markdownBold: return "\u{f670}"
        case .markdownLight: return "\u{f671}"
        case .markdownRegular: return "\u{f672}"
        case .markerBold: return "\u{f673}"
        case .markerFilled: return "\u{f674}"
        case .markerLight: return "\u{f675}"
        case .markerRegular: return "\u{f676}"
        case .maximizeBold: return "\u{f677}"
        case .maximizeLight: return "\u{f678}"
        case .maximizeRegular: return "\u{f679}"
        case .mediaPlayerBold: return "\u{f67a}"
        case .mediaPlayerLight: return "\u{f67b}"
        case .mediaPlayerRegular: return "\u{f67c}"
        case .mediaQualityGoodBold: return "\u{f67d}"
        case .mediaQualityGoodFilled: return "\u{f67e}"
        case .mediaQualityGoodLight: return "\u{f67f}"
        case .mediaQualityGoodRegular: return "\u{f680}"
        case .mediaQualityPoorBold: return "\u{f681}"
        case .mediaQualityPoorFilled: return "\u{f682}"
        case .mediaQualityPoorLight: return "\u{f683}"
        case .mediaQualityPoorRegular: return "\u{f684}"
        case .mediaQualityUnstableBold: return "\u{f685}"
        case .mediaQualityUnstableFilled: return "\u{f686}"
        case .mediaQualityUnstableLight: return "\u{f687}"
        case .mediaQualityUnstableRegular: return "\u{f688}"
        case .mediumQualityGoodFilled: return "\u{f689}"
        case .mediumQualityPoorFilled: return "\u{f68a}"
        case .mediumQualityUnstableFilled: return "\u{f68b}"
        case .meetBold: return "\u{f68c}"
        case .meetEndBold: return "\u{f68d}"
        case .meetEndLight: return "\u{f68e}"
        case .meetEndRegular: return "\u{f68f}"
        case .meetFilled: return "\u{f690}"
        case .meetLight: return "\u{f691}"
        case .meetRegular: return "\u{f692}"
        case .meetingsBold: return "\u{f693}"
        case .meetingsFilled: return "\u{f694}"
        case .meetingsFocusMonthBold: return "\u{f695}"
        case .meetingsFocusMonthLight: return "\u{f696}"
        case .meetingsFocusMonthRegular: return "\u{f697}"
        case .meetingsFocusOneDayBold: return "\u{f698}"
        case .meetingsFocusOneDayLight: return "\u{f699}"
        case .meetingsFocusOneDayRegular: return "\u{f69a}"
        case .meetingsFocusThreeDayBold: return "\u{f69b}"
        case .meetingsFocusThreeDayLight: return "\u{f69c}"
        case .meetingsFocusThreeDayRegular: return "\u{f69d}"
        case .meetingsFocusUpcomingBold: return "\u{f69e}"
        case .meetingsFocusUpcomingLight: return "\u{f69f}"
        case .meetingsFocusUpcomingRegular: return "\u{f6a0}"
        case .meetingsFocusWeekBold: return "\u{f6a1}"
        case .meetingsFocusWeekLight: return "\u{f6a2}"
        case .meetingsFocusWeekRegular: return "\u{f6a3}"
        case .meetingsLight: return "\u{f6a4}"
        case .meetingsPresenceBold: return "\u{f6a5}"
        case .meetingsPresenceFilled: return "\u{f6a6}"
        case .meetingsPresenceLight: return "\u{f6a7}"
        case .meetingsPresenceRegular: return "\u{f6a8}"
        case .meetingsPresenceSmallFilled: return "\u{f6a9}"
        case .meetingsRegular: return "\u{f6aa}"
        case .meetingsTeamActiveBold: return "\u{f6ab}"
        case .meetingsTeamActiveLight: return "\u{f6ac}"
        case .meetingsTeamActiveRegular: return "\u{f6ad}"
        case .meetingsTeamBold: return "\u{f6ae}"
        case .meetingsTeamLight: return "\u{f6af}"
        case .meetingsTeamNewBold: return "\u{f6b0}"
        case .meetingsTeamNewLight: return "\u{f6b1}"
        case .meetingsTeamNewRegular: return "\u{f6b2}"
        case .meetingsTeamRegular: return "\u{f6b3}"
        case .mentionBold: return "\u{f6b4}"
        case .mentionLight: return "\u{f6b5}"
        case .mentionRegular: return "\u{f6b6}"
        case .messageQueingBold: return "\u{f6b7}"
        case .messageQueingLight: return "\u{f6b8}"
        case .messageQueingRegular: return "\u{f6b9}"
        case .microphoneBold: return "\u{f6ba}"
        case .microphoneFilled: return "\u{f6bb}"
        case .microphoneHardMutedBold: return "\u{f6bc}"
        case .microphoneHardMutedCircleFilled: return "\u{f6bd}"
        case .microphoneHardMutedColoredBold: return "\u{f6be}"
        case .microphoneHardMutedColoredLight: return "\u{f6bf}"
        case .microphoneHardMutedColoredRegular: return "\u{f6c0}"
        case .microphoneHardMutedLight: return "\u{f6c1}"
        case .microphoneHardMutedRegular: return "\u{f6c2}"
        case .microphoneLight: return "\u{f6c3}"
        case .microphoneMusicModeBold: return "\u{f6c4}"
        case .microphoneMusicModeColoredBold: return "\u{f6c5}"
        case .microphoneMusicModeColoredLight: return "\u{f6c6}"
        case .microphoneMusicModeColoredRegular: return "\u{f6c7}"
        case .microphoneMusicModeLight: return "\u{f6c8}"
        case .microphoneMusicModeRegular: return "\u{f6c9}"
        case .microphoneMutedBold: return "\u{f6ca}"
        case .microphoneMutedFilled: return "\u{f6cb}"
        case .microphoneMutedIndicatorFilled: return "\u{f6cc}"
        case .microphoneMutedLight: return "\u{f6cd}"
        case .microphoneMutedRedBold: return "\u{f6ce}"
        case .microphoneMutedRedFilled: return "\u{f6cf}"
        case .microphoneMutedRedLight: return "\u{f6d0}"
        case .microphoneMutedRedRegular: return "\u{f6d1}"
        case .microphoneMutedRegular: return "\u{f6d2}"
        case .microphoneOptAllBold: return "\u{f6d3}"
        case .microphoneOptAllLight: return "\u{f6d4}"
        case .microphoneOptAllMutedBold: return "\u{f6d5}"
        case .microphoneOptAllMutedLight: return "\u{f6d6}"
        case .microphoneOptAllMutedRegular: return "\u{f6d7}"
        case .microphoneOptAllOnColoredBold: return "\u{f6d8}"
        case .microphoneOptAllOnColoredLight: return "\u{f6d9}"
        case .microphoneOptAllOnColoredRegular: return "\u{f6da}"
        case .microphoneOptAllRegular: return "\u{f6db}"
        case .microphoneOptMeBold: return "\u{f6dc}"
        case .microphoneOptMeLight: return "\u{f6dd}"
        case .microphoneOptMeMutedBold: return "\u{f6de}"
        case .microphoneOptMeMutedLight: return "\u{f6df}"
        case .microphoneOptMeMutedRegular: return "\u{f6e0}"
        case .microphoneOptMeOnColoredBold: return "\u{f6e1}"
        case .microphoneOptMeOnColoredLight: return "\u{f6e2}"
        case .microphoneOptMeOnColoredRegular: return "\u{f6e3}"
        case .microphoneOptMeRegular: return "\u{f6e4}"
        case .microphoneRegular: return "\u{f6e5}"
        case .minimizeBold: return "\u{f6e6}"
        case .minimizeLight: return "\u{f6e7}"
        case .minimizeRegular: return "\u{f6e8}"
        case .minusBold: return "\u{f6e9}"
        case .minusLight: return "\u{f6ea}"
        case .minusRegular: return "\u{f6eb}"
        case .mirrorBold: return "\u{f6ec}"
        case .mirrorFilled: return "\u{f6ed}"
        case .mirrorLight: return "\u{f6ee}"
        case .mirrorRegular: return "\u{f6ef}"
        case .moderatorBold: return "\u{f6f0}"
        case .moderatorLight: return "\u{f6f1}"
        case .moderatorRegular: return "\u{f6f2}"
        case .monitoringBold: return "\u{f6f3}"
        case .monitoringLight: return "\u{f6f4}"
        case .monitoringRegular: return "\u{f6f5}"
        case .monthlyRecurringScheduleNodeBold: return "\u{f6f6}"
        case .monthlyRecurringScheduleNodeLight: return "\u{f6f7}"
        case .monthlyRecurringScheduleNodeRegular: return "\u{f6f8}"
        case .moreAdrBold: return "\u{f6f9}"
        case .moreAdrLight: return "\u{f6fa}"
        case .moreAdrRegular: return "\u{f6fb}"
        case .moreBold: return "\u{f6fc}"
        case .moreCircleBold: return "\u{f6fd}"
        case .moreCircleFilled: return "\u{f6fe}"
        case .moreCircleLight: return "\u{f6ff}"
        case .moreCircleRegular: return "\u{f700}"
        case .moreCirecleFilled: return "\u{f701}"
        case .moreLight: return "\u{f702}"
        case .moreRegular: return "\u{f703}"
        case .mouseCursorBold: return "\u{f704}"
        case .mouseCursorLight: return "\u{f705}"
        case .mouseCursorRegular: return "\u{f706}"
        case .moveCallInAdrBold: return "\u{f707}"
        case .moveCallInAdrLight: return "\u{f708}"
        case .moveCallInAdrRegular: return "\u{f709}"
        case .moveCallInIphBold: return "\u{f70a}"
        case .moveCallInIphLight: return "\u{f70b}"
        case .moveCallInIphRegular: return "\u{f70c}"
        case .moveCallInLaptopBold: return "\u{f70d}"
        case .moveCallInLaptopLight: return "\u{f70e}"
        case .moveCallInLaptopRegular: return "\u{f70f}"
        case .moveCallInOutAdrBold: return "\u{f710}"
        case .moveCallInOutAdrLight: return "\u{f711}"
        case .moveCallInOutAdrRegular: return "\u{f712}"
        case .moveCallInOutIphBold: return "\u{f713}"
        case .moveCallInOutIphLight: return "\u{f714}"
        case .moveCallInOutIphRegular: return "\u{f715}"
        case .moveCallInTabletBold: return "\u{f716}"
        case .moveCallInTabletLight: return "\u{f717}"
        case .moveCallInTabletRegular: return "\u{f718}"
        case .moveCallOutAdrBold: return "\u{f719}"
        case .moveCallOutAdrLight: return "\u{f71a}"
        case .moveCallOutAdrRegular: return "\u{f71b}"
        case .moveCallOutIphBold: return "\u{f71c}"
        case .moveCallOutIphLight: return "\u{f71d}"
        case .moveCallOutIphRegular: return "\u{f71e}"
        case .moveCallOutLaptopBold: return "\u{f71f}"
        case .moveCallOutLaptopLight: return "\u{f720}"
        case .moveCallOutLaptopRegular: return "\u{f721}"
        case .moveCallOutTabletBold: return "\u{f722}"
        case .moveCallOutTabletLight: return "\u{f723}"
        case .moveCallOutTabletRegular: return "\u{f724}"
        case .msTeams: return "\u{f725}"
        case .multilineChartBold: return "\u{f726}"
        case .multilineChartFilled: return "\u{f727}"
        case .multilineChartLight: return "\u{f728}"
        case .multilineChartRegular: return "\u{f729}"
        case .multimediaBold: return "\u{f72a}"
        case .multimediaFilled: return "\u{f72b}"
        case .multimediaLight: return "\u{f72c}"
        case .multimediaRegular: return "\u{f72d}"
        case .multipledDevicesBold: return "\u{f72e}"
        case .multipledDevicesLight: return "\u{f72f}"
        case .multipledDevicesRegular: return "\u{f730}"
        case .musicModeBold: return "\u{f731}"
        case .musicModeCircleBold: return "\u{f732}"
        case .musicModeCircleFilled: return "\u{f733}"
        case .musicModeCircleLight: return "\u{f734}"
        case .musicModeCircleRegular: return "\u{f735}"
        case .musicModeFilled: return "\u{f736}"
        case .musicModeLight: return "\u{f737}"
        case .musicModeRegular: return "\u{f738}"
        case .muteOnEntryBold: return "\u{f739}"
        case .muteOnEntryFilled: return "\u{f73a}"
        case .muteOnEntryLight: return "\u{f73b}"
        case .muteOnEntryRegular: return "\u{f73c}"
        case .newManagerBold: return "\u{f73d}"
        case .newManagerLight: return "\u{f73e}"
        case .newManagerRegular: return "\u{f73f}"
        case .newTitleBold: return "\u{f740}"
        case .newTitleLight: return "\u{f741}"
        case .newTitleRegular: return "\u{f742}"
        case .newVoicemailBold: return "\u{f743}"
        case .newVoicemailLight: return "\u{f744}"
        case .newVoicemailRegular: return "\u{f745}"
        case .newWhiteboardBold: return "\u{f746}"
        case .newWhiteboardLight: return "\u{f747}"
        case .newWhiteboardRegular: return "\u{f748}"
        case .nextBold: return "\u{f749}"
        case .nextLight: return "\u{f74a}"
        case .nextRegular: return "\u{f74b}"
        case .noDevicesBold: return "\u{f74c}"
        case .noDevicesLight: return "\u{f74d}"
        case .noDevicesRegular: return "\u{f74e}"
        case .noiseDetectedCanceledFilled: return "\u{f74f}"
        case .noiseDetectedFilled: return "\u{f750}"
        case .noiseNoneCanceledFilled: return "\u{f751}"
        case .noiseNoneFilled: return "\u{f752}"
        case .noiseRemovalBold: return "\u{f753}"
        case .noiseRemovalLight: return "\u{f754}"
        case .noiseRemovalRegular: return "\u{f755}"
        case .noteBold: return "\u{f756}"
        case .noteLight: return "\u{f757}"
        case .notePptBold: return "\u{f758}"
        case .notePptLight: return "\u{f759}"
        case .notePptRegular: return "\u{f75a}"
        case .noteRegular: return "\u{f75b}"
        case .notesBold: return "\u{f75c}"
        case .notesLight: return "\u{f75d}"
        case .notesRegular: return "\u{f75e}"
        case .numberBold: return "\u{f75f}"
        case .numberLight: return "\u{f760}"
        case .numberRegular: return "\u{f761}"
        case .oldRemoteBold: return "\u{f762}"
        case .oldRemoteLight: return "\u{f763}"
        case .oldRemoteRegular: return "\u{f764}"
        case .oldTouchBold: return "\u{f765}"
        case .oldTouchLight: return "\u{f766}"
        case .oldTouchRegular: return "\u{f767}"
        case .oneColumnBold: return "\u{f768}"
        case .oneColumnLight: return "\u{f769}"
        case .oneColumnRegular: return "\u{f76a}"
        case .openInFolderBold: return "\u{f76b}"
        case .openInFolderLight: return "\u{f76c}"
        case .openInFolderRegular: return "\u{f76d}"
        case .openPagesBold: return "\u{f76e}"
        case .openPagesLight: return "\u{f76f}"
        case .openPagesRegular: return "\u{f770}"
        case .otherNumberBold: return "\u{f771}"
        case .otherNumberLight: return "\u{f772}"
        case .otherNumberRegular: return "\u{f773}"
        case .otherNumberWarningBold: return "\u{f774}"
        case .otherNumberWarningLight: return "\u{f775}"
        case .otherNumberWarningRegular: return "\u{f776}"
        case .outgoingCallLegacyBold: return "\u{f777}"
        case .outgoingCallLegacyLight: return "\u{f778}"
        case .outgoingCallLegacyRegular: return "\u{f779}"
        case .overflowLeftBold: return "\u{f77a}"
        case .overflowLeftLight: return "\u{f77b}"
        case .overflowLeftRegular: return "\u{f77c}"
        case .overflowRightBold: return "\u{f77d}"
        case .overflowRightLight: return "\u{f77e}"
        case .overflowRightRegular: return "\u{f77f}"
        case .pairedCameraBold: return "\u{f780}"
        case .pairedCameraLight: return "\u{f781}"
        case .pairedCameraRegular: return "\u{f782}"
        case .pairedDeviceBold: return "\u{f783}"
        case .pairedDeviceLight: return "\u{f784}"
        case .pairedDeviceRegular: return "\u{f785}"
        case .pairedHandsetBold: return "\u{f786}"
        case .pairedHandsetLight: return "\u{f787}"
        case .pairedHandsetRegular: return "\u{f788}"
        case .pairingBold: return "\u{f789}"
        case .pairingLight: return "\u{f78a}"
        case .pairingRegular: return "\u{f78b}"
        case .parkedBold: return "\u{f78c}"
        case .parkedFilled: return "\u{f78d}"
        case .parkedLight: return "\u{f78e}"
        case .parkedRegular: return "\u{f78f}"
        case .parseBold: return "\u{f790}"
        case .parseLight: return "\u{f791}"
        case .parseRegular: return "\u{f792}"
        case .partialBold: return "\u{f793}"
        case .partialLight: return "\u{f794}"
        case .partialRegular: return "\u{f795}"
        case .participantAddBold: return "\u{f796}"
        case .participantAddLight: return "\u{f797}"
        case .participantAddRegular: return "\u{f798}"
        case .participantBlockedBold: return "\u{f799}"
        case .participantBlockedLight: return "\u{f79a}"
        case .participantBlockedRegular: return "\u{f79b}"
        case .participantBold: return "\u{f79c}"
        case .participantFilled: return "\u{f79d}"
        case .participantLight: return "\u{f79e}"
        case .participantListBold: return "\u{f79f}"
        case .participantListFilled: return "\u{f7a0}"
        case .participantListLight: return "\u{f7a1}"
        case .participantListRegular: return "\u{f7a2}"
        case .participantRegular: return "\u{f7a3}"
        case .participantRemoveBold: return "\u{f7a4}"
        case .participantRemoveLight: return "\u{f7a5}"
        case .participantRemoveRegular: return "\u{f7a6}"
        case .participantUnknownBold: return "\u{f7a7}"
        case .participantUnknownLight: return "\u{f7a8}"
        case .participantUnknownRegular: return "\u{f7a9}"
        case .passMouseBold: return "\u{f7aa}"
        case .passMouseLight: return "\u{f7ab}"
        case .passMouseRegular: return "\u{f7ac}"
        case .pauseBold: return "\u{f7ad}"
        case .pauseFilled: return "\u{f7ae}"
        case .pauseLight: return "\u{f7af}"
        case .pauseRegular: return "\u{f7b0}"
        case .penBold: return "\u{f7b1}"
        case .penFilled: return "\u{f7b2}"
        case .penLight: return "\u{f7b3}"
        case .penRegular: return "\u{f7b4}"
        case .peopleBold: return "\u{f7b5}"
        case .peopleCircleBold: return "\u{f7b6}"
        case .peopleCircleFilled: return "\u{f7b7}"
        case .peopleCircleLight: return "\u{f7b8}"
        case .peopleCircleRegular: return "\u{f7b9}"
        case .peopleFilled: return "\u{f7ba}"
        case .peopleInsightsFilled: return "\u{f7bb}"
        case .peopleLight: return "\u{f7bc}"
        case .peopleRegular: return "\u{f7bd}"
        case .phoneAlertBold: return "\u{f7be}"
        case .phoneAlertLight: return "\u{f7bf}"
        case .phoneAlertRegular: return "\u{f7c0}"
        case .phoneBold: return "\u{f7c1}"
        case .phoneFilled: return "\u{f7c2}"
        case .phoneLight: return "\u{f7c3}"
        case .phoneMutedBold: return "\u{f7c4}"
        case .phoneMutedLight: return "\u{f7c5}"
        case .phoneMutedRegular: return "\u{f7c6}"
        case .phonePrivateBold: return "\u{f7c7}"
        case .phonePrivateLight: return "\u{f7c8}"
        case .phonePrivateRegular: return "\u{f7c9}"
        case .phoneRegular: return "\u{f7ca}"
        case .phoneReplyAllBold: return "\u{f7cb}"
        case .phoneReplyAllLight: return "\u{f7cc}"
        case .phoneReplyAllRegular: return "\u{f7cd}"
        case .phoneReplyBold: return "\u{f7ce}"
        case .phoneReplyLight: return "\u{f7cf}"
        case .phoneReplyRegular: return "\u{f7d0}"
        case .phoneSmallFilled: return "\u{f7d1}"
        case .pickerBold: return "\u{f7d2}"
        case .pickerLight: return "\u{f7d3}"
        case .pickerRegular: return "\u{f7d4}"
        case .pictureInPictureBold: return "\u{f7d5}"
        case .pictureInPictureFilled: return "\u{f7d6}"
        case .pictureInPictureLight: return "\u{f7d7}"
        case .pictureInPictureRegular: return "\u{f7d8}"
        case .pieChartBold: return "\u{f7d9}"
        case .pieChartFilled: return "\u{f7da}"
        case .pieChartLight: return "\u{f7db}"
        case .pieChartRegular: return "\u{f7dc}"
        case .pinBold: return "\u{f7dd}"
        case .pinFilled: return "\u{f7de}"
        case .pinLight: return "\u{f7df}"
        case .pinListActivityBold: return "\u{f7e0}"
        case .pinListActivityColoredBold: return "\u{f7e1}"
        case .pinListActivityColoredLight: return "\u{f7e2}"
        case .pinListActivityColoredRegular: return "\u{f7e3}"
        case .pinListActivityLight: return "\u{f7e4}"
        case .pinListActivityRegular: return "\u{f7e5}"
        case .pinListBold: return "\u{f7e6}"
        case .pinListLight: return "\u{f7e7}"
        case .pinListRegular: return "\u{f7e8}"
        case .pinMutedBold: return "\u{f7e9}"
        case .pinMutedFilled: return "\u{f7ea}"
        case .pinMutedLight: return "\u{f7eb}"
        case .pinMutedRegular: return "\u{f7ec}"
        case .pinRegular: return "\u{f7ed}"
        case .pipBold: return "\u{f7ee}"
        case .pipEnterBold: return "\u{f7ef}"
        case .pipEnterLight: return "\u{f7f0}"
        case .pipEnterRegular: return "\u{f7f1}"
        case .pipExitBold: return "\u{f7f2}"
        case .pipExitLight: return "\u{f7f3}"
        case .pipExitRegular: return "\u{f7f4}"
        case .pipFilled: return "\u{f7f5}"
        case .pipLight: return "\u{f7f6}"
        case .pipRegular: return "\u{f7f7}"
        case .placeholderBold: return "\u{f7f8}"
        case .placeholderLight: return "\u{f7f9}"
        case .placeholderRegular: return "\u{f7fa}"
        case .playBold: return "\u{f7fb}"
        case .playCircleBold: return "\u{f7fc}"
        case .playCircleFilled: return "\u{f7fd}"
        case .playCircleLight: return "\u{f7fe}"
        case .playCircleRegular: return "\u{f7ff}"
        case .playFilled: return "\u{f800}"
        case .playLight: return "\u{f801}"
        case .playRegular: return "\u{f802}"
        case .plugAcBold: return "\u{f803}"
        case .plugAcLight: return "\u{f804}"
        case .plugAcRegular: return "\u{f805}"
        case .plusBold: return "\u{f806}"
        case .plusCircleBold: return "\u{f807}"
        case .plusCircleFilled: return "\u{f808}"
        case .plusCircleLight: return "\u{f809}"
        case .plusCircleRegular: return "\u{f80a}"
        case .plusLight: return "\u{f80b}"
        case .plusRegular: return "\u{f80c}"
        case .pmrBold: return "\u{f80d}"
        case .pmrFilled: return "\u{f80e}"
        case .pmrLight: return "\u{f80f}"
        case .pmrRegular: return "\u{f810}"
        case .pollBold: return "\u{f811}"
        case .pollLight: return "\u{f812}"
        case .pollRegular: return "\u{f813}"
        case .popInBold: return "\u{f814}"
        case .popInLight: return "\u{f815}"
        case .popInRegular: return "\u{f816}"
        case .popOutBold: return "\u{f817}"
        case .popOutLight: return "\u{f818}"
        case .popOutRegular: return "\u{f819}"
        case .popUpBold: return "\u{f81a}"
        case .popUpLight: return "\u{f81b}"
        case .popUpRegular: return "\u{f81c}"
        case .portraitLandscapeBold: return "\u{f81d}"
        case .portraitLandscapeLight: return "\u{f81e}"
        case .portraitLandscapeRegular: return "\u{f81f}"
        case .powerAcBold: return "\u{f820}"
        case .powerAcLight: return "\u{f821}"
        case .powerAcRegular: return "\u{f822}"
        case .powerBold: return "\u{f823}"
        case .powerLight: return "\u{f824}"
        case .powerRegular: return "\u{f825}"
        case .preHeaderBold: return "\u{f826}"
        case .preHeaderLight: return "\u{f827}"
        case .preHeaderRegular: return "\u{f828}"
        case .presentationBold: return "\u{f829}"
        case .presentationLight: return "\u{f82a}"
        case .presentationRegular: return "\u{f82b}"
        case .primaryParticipantBold: return "\u{f82c}"
        case .primaryParticipantLight: return "\u{f82d}"
        case .primaryParticipantRegular: return "\u{f82e}"
        case .printBold: return "\u{f82f}"
        case .printLight: return "\u{f830}"
        case .printRegular: return "\u{f831}"
        case .priorityBadgeFilled: return "\u{f832}"
        case .priorityCircleBold: return "\u{f833}"
        case .priorityCircleFilled: return "\u{f834}"
        case .priorityCircleLight: return "\u{f835}"
        case .priorityCircleRegular: return "\u{f836}"
        case .priorityCircleTwoBold: return "\u{f837}"
        case .priorityCircleTwoFilled: return "\u{f838}"
        case .priorityCircleTwoLight: return "\u{f839}"
        case .priorityCircleTwoRegular: return "\u{f83a}"
        case .privacyCircleBold: return "\u{f83b}"
        case .privacyCircleFilled: return "\u{f83c}"
        case .privacyCircleLight: return "\u{f83d}"
        case .privacyCircleRegular: return "\u{f83e}"
        case .privateBold: return "\u{f83f}"
        case .privateCircleBold: return "\u{f840}"
        case .privateCircleFilled: return "\u{f841}"
        case .privateCircleLight: return "\u{f842}"
        case .privateCircleRegular: return "\u{f843}"
        case .privateLight: return "\u{f844}"
        case .privateMeetingBold: return "\u{f845}"
        case .privateMeetingLight: return "\u{f846}"
        case .privateMeetingRegular: return "\u{f847}"
        case .privateRegular: return "\u{f848}"
        case .productDemoBold: return "\u{f849}"
        case .productDemoLight: return "\u{f84a}"
        case .productDemoRegular: return "\u{f84b}"
        case .proximityBold: return "\u{f84c}"
        case .proximityLight: return "\u{f84d}"
        case .proximityMutedBold: return "\u{f84e}"
        case .proximityMutedLight: return "\u{f84f}"
        case .proximityMutedRegular: return "\u{f850}"
        case .proximityRegular: return "\u{f851}"
        case .proximityVideoBold: return "\u{f852}"
        case .proximityVideoLight: return "\u{f853}"
        case .proximityVideoRegular: return "\u{f854}"
        case .ptoPresenceBold: return "\u{f855}"
        case .ptoPresenceFilled: return "\u{f856}"
        case .ptoPresenceLight: return "\u{f857}"
        case .ptoPresenceRegular: return "\u{f858}"
        case .pullCallBold: return "\u{f859}"
        case .pullCallLight: return "\u{f85a}"
        case .pullCallRegular: return "\u{f85b}"
        case .qABold: return "\u{f85c}"
        case .qALight: return "\u{f85d}"
        case .qARegular: return "\u{f85e}"
        case .qualityBold: return "\u{f85f}"
        case .qualityLight: return "\u{f860}"
        case .qualityRegular: return "\u{f861}"
        case .queueContactBold: return "\u{f862}"
        case .queueContactLight: return "\u{f863}"
        case .queueContactRegular: return "\u{f864}"
        case .quietBold: return "\u{f865}"
        case .quietHoursPresenceBold: return "\u{f866}"
        case .quietHoursPresenceFilled: return "\u{f867}"
        case .quietHoursPresenceLight: return "\u{f868}"
        case .quietHoursPresenceRegular: return "\u{f869}"
        case .quietLight: return "\u{f86a}"
        case .quietRegular: return "\u{f86b}"
        case .radioButtonGroupBold: return "\u{f86c}"
        case .radioButtonGroupLight: return "\u{f86d}"
        case .radioButtonGroupRegular: return "\u{f86e}"
        case .raiseHandBold: return "\u{f86f}"
        case .raiseHandCircleFilled: return "\u{f870}"
        case .raiseHandFilled: return "\u{f871}"
        case .raiseHandLight: return "\u{f872}"
        case .raiseHandRegular: return "\u{f873}"
        case .ramBold: return "\u{f874}"
        case .ramLight: return "\u{f875}"
        case .ramRegular: return "\u{f876}"
        case .reactionsBold: return "\u{f877}"
        case .reactionsFilled: return "\u{f878}"
        case .reactionsLight: return "\u{f879}"
        case .reactionsRegular: return "\u{f87a}"
        case .reactivateBold: return "\u{f87b}"
        case .reactivateLight: return "\u{f87c}"
        case .reactivateRegular: return "\u{f87d}"
        case .recentsBold: return "\u{f87e}"
        case .recentsFilled: return "\u{f87f}"
        case .recentsLight: return "\u{f880}"
        case .recentsPresenceBold: return "\u{f881}"
        case .recentsPresenceFilled: return "\u{f882}"
        case .recentsPresenceLight: return "\u{f883}"
        case .recentsPresenceRegular: return "\u{f884}"
        case .recentsPresenceSmallFilled: return "\u{f885}"
        case .recentsRegular: return "\u{f886}"
        case .recordActiveBold: return "\u{f887}"
        case .recordActiveFilled: return "\u{f888}"
        case .recordActiveLight: return "\u{f889}"
        case .recordActiveRegular: return "\u{f88a}"
        case .recordBold: return "\u{f88b}"
        case .recordFilled: return "\u{f88c}"
        case .recordLight: return "\u{f88d}"
        case .recordPausedBold: return "\u{f88e}"
        case .recordPausedFilled: return "\u{f88f}"
        case .recordPausedLight: return "\u{f890}"
        case .recordPausedRegular: return "\u{f891}"
        case .recordRegular: return "\u{f892}"
        case .recurringBold: return "\u{f893}"
        case .recurringLight: return "\u{f894}"
        case .recurringOffBold: return "\u{f895}"
        case .recurringOffLight: return "\u{f896}"
        case .recurringOffRegular: return "\u{f897}"
        case .recurringRegular: return "\u{f898}"
        case .redialBold: return "\u{f899}"
        case .redialLight: return "\u{f89a}"
        case .redialRegular: return "\u{f89b}"
        case .redoBold: return "\u{f89c}"
        case .redoLight: return "\u{f89d}"
        case .redoRegular: return "\u{f89e}"
        case .refreshBold: return "\u{f89f}"
        case .refreshLight: return "\u{f8a0}"
        case .refreshRegular: return "\u{f8a1}"
        case .remoteCallBold: return "\u{f8a2}"
        case .remoteCallFilled: return "\u{f8a3}"
        case .remoteCallLight: return "\u{f8a4}"
        case .remoteCallRegular: return "\u{f8a5}"
        case .remoteDesktopControlBold: return "\u{f8a6}"
        case .remoteDesktopControlFilled: return "\u{f8a7}"
        case .remoteDesktopControlLight: return "\u{f8a8}"
        case .remoteDesktopControlRegular: return "\u{f8a9}"
        case .removeBold: return "\u{f8aa}"
        case .removeFilled: return "\u{f8ab}"
        case .removeLight: return "\u{f8ac}"
        case .removeRegular: return "\u{f8ad}"
        case .replyBold: return "\u{f8ae}"
        case .replyFilled: return "\u{f8af}"
        case .replyLight: return "\u{f8b0}"
        case .replyListBold: return "\u{f8b1}"
        case .replyListLight: return "\u{f8b2}"
        case .replyListRegular: return "\u{f8b3}"
        case .replyPrivatelyBold: return "\u{f8b4}"
        case .replyPrivatelyLight: return "\u{f8b5}"
        case .replyPrivatelyRegular: return "\u{f8b6}"
        case .replyRegular: return "\u{f8b7}"
        case .resetBold: return "\u{f8b8}"
        case .resetLight: return "\u{f8b9}"
        case .resetRegular: return "\u{f8ba}"
        case .responsiveMobileBold: return "\u{f8bb}"
        case .responsiveMobileLight: return "\u{f8bc}"
        case .responsiveMobileRegular: return "\u{f8bd}"
        case .restartBold: return "\u{f8be}"
        case .restartLight: return "\u{f8bf}"
        case .restartRegular: return "\u{f8c0}"
        case .retrieveCallBold: return "\u{f8c1}"
        case .retrieveCallLight: return "\u{f8c2}"
        case .retrieveCallRegular: return "\u{f8c3}"
        case .returnBold: return "\u{f8c4}"
        case .returnLight: return "\u{f8c5}"
        case .returnRegular: return "\u{f8c6}"
        case .ringtoneBold: return "\u{f8c7}"
        case .ringtoneLight: return "\u{f8c8}"
        case .ringtoneRegular: return "\u{f8c9}"
        case .roomCalendarBold: return "\u{f8ca}"
        case .roomCalendarLight: return "\u{f8cb}"
        case .roomCalendarRegular: return "\u{f8cc}"
        case .roomLightsBold: return "\u{f8cd}"
        case .roomLightsFilled: return "\u{f8ce}"
        case .roomLightsLight: return "\u{f8cf}"
        case .roomLightsRegular: return "\u{f8d0}"
        case .rotateContentBold: return "\u{f8d1}"
        case .rotateContentFilled: return "\u{f8d2}"
        case .rotateContentLight: return "\u{f8d3}"
        case .rotateContentRegular: return "\u{f8d4}"
        case .ruleBasedBold: return "\u{f8d5}"
        case .ruleBasedLight: return "\u{f8d6}"
        case .ruleBasedRegular: return "\u{f8d7}"
        case .runningApplicationBold: return "\u{f8d8}"
        case .runningApplicationFilled: return "\u{f8d9}"
        case .runningApplicationLight: return "\u{f8da}"
        case .runningApplicationRegular: return "\u{f8db}"
        case .saveBold: return "\u{f8dc}"
        case .saveLight: return "\u{f8dd}"
        case .saveRegular: return "\u{f8de}"
        case .saveTranscriptBold: return "\u{f8df}"
        case .saveTranscriptFilled: return "\u{f8e0}"
        case .saveTranscriptLight: return "\u{f8e1}"
        case .saveTranscriptRegular: return "\u{f8e2}"
        case .scanBold: return "\u{f8e3}"
        case .scanLight: return "\u{f8e4}"
        case .scanRegular: return "\u{f8e5}"
        case .scheduleSendBold: return "\u{f8e6}"
        case .scheduleSendFilled: return "\u{f8e7}"
        case .scheduleSendLight: return "\u{f8e8}"
        case .scheduleSendRegular: return "\u{f8e9}"
        case .schedulerAvailableBold: return "\u{f8ea}"
        case .schedulerAvailableLight: return "\u{f8eb}"
        case .schedulerAvailableRegular: return "\u{f8ec}"
        case .schedulerNotWorkingHoursBold: return "\u{f8ed}"
        case .schedulerNotWorkingHoursLight: return "\u{f8ee}"
        case .schedulerNotWorkingHoursRegular: return "\u{f8ef}"
        case .schedulerUnavailableBold: return "\u{f8f0}"
        case .schedulerUnavailableLight: return "\u{f8f1}"
        case .schedulerUnavailableRegular: return "\u{f8f2}"
        case .schedulerUnknownBold: return "\u{f8f3}"
        case .schedulerUnknownLight: return "\u{f8f4}"
        case .schedulerUnknownRegular: return "\u{f8f5}"
        case .screenshotBold: return "\u{f8f6}"
        case .screenshotDocBold: return "\u{f8f7}"
        case .screenshotDocFilled: return "\u{f8f8}"
        case .screenshotDocLight: return "\u{f8f9}"
        case .screenshotDocRegular: return "\u{f8fa}"
        case .screenshotLight: return "\u{f8fb}"
        case .screenshotRegular: return "\u{f8fc}"
        case .searchBold: return "\u{f8fd}"
        case .searchFilled: return "\u{f8fe}"
        case .searchLight: return "\u{f8ff}"
        case .searchRegular: return "\u{f900}"
        case .secondaryArrowBold: return "\u{f901}"
        case .secondaryArrowLight: return "\u{f902}"
        case .secondaryArrowRegular: return "\u{f903}"
        case .secureCallLockBold: return "\u{f904}"
        case .secureCallLockFilled: return "\u{f905}"
        case .secureCallLockLight: return "\u{f906}"
        case .secureCallLockRegular: return "\u{f907}"
        case .secureCallShieldBold: return "\u{f908}"
        case .secureCallShieldFilled: return "\u{f909}"
        case .secureCallShieldLight: return "\u{f90a}"
        case .secureCallShieldRegular: return "\u{f90b}"
        case .secureCircleBold: return "\u{f90c}"
        case .secureCircleFilled: return "\u{f90d}"
        case .secureCircleLight: return "\u{f90e}"
        case .secureCircleRegular: return "\u{f90f}"
        case .secureLockBold: return "\u{f910}"
        case .secureLockFilled: return "\u{f911}"
        case .secureLockLight: return "\u{f912}"
        case .secureLockRegular: return "\u{f913}"
        case .segmentExcludeFilled: return "\u{f914}"
        case .segmentFilterFilled: return "\u{f915}"
        case .segmentIncludeFilled: return "\u{f916}"
        case .selectAllBold: return "\u{f917}"
        case .selectAllFilled: return "\u{f918}"
        case .selectAllLight: return "\u{f919}"
        case .selectAllRegular: return "\u{f91a}"
        case .selectionBold: return "\u{f91b}"
        case .selectionLight: return "\u{f91c}"
        case .selectionRegular: return "\u{f91d}"
        case .sendBold: return "\u{f91e}"
        case .sendFilled: return "\u{f91f}"
        case .sendLight: return "\u{f920}"
        case .sendRegular: return "\u{f921}"
        case .serverBold: return "\u{f922}"
        case .serverErrorBold: return "\u{f923}"
        case .serverErrorLight: return "\u{f924}"
        case .serverErrorRegular: return "\u{f925}"
        case .serverLight: return "\u{f926}"
        case .serverRegular: return "\u{f927}"
        case .servicesBold: return "\u{f928}"
        case .servicesLight: return "\u{f929}"
        case .servicesRegular: return "\u{f92a}"
        case .setVariableBold: return "\u{f92b}"
        case .setVariableLight: return "\u{f92c}"
        case .setVariableRegular: return "\u{f92d}"
        case .settingsBold: return "\u{f92e}"
        case .settingsFilled: return "\u{f92f}"
        case .settingsLight: return "\u{f930}"
        case .settingsRegular: return "\u{f931}"
        case .setupAssistantBold: return "\u{f932}"
        case .setupAssistantLight: return "\u{f933}"
        case .setupAssistantRegular: return "\u{f934}"
        case .sftpBold: return "\u{f935}"
        case .sftpLight: return "\u{f936}"
        case .sftpRegular: return "\u{f937}"
        case .shapeCircleBold: return "\u{f938}"
        case .shapeCircleFilled: return "\u{f939}"
        case .shapeCircleLight: return "\u{f93a}"
        case .shapeCircleRegular: return "\u{f93b}"
        case .shapeDiagonalLineBold: return "\u{f93c}"
        case .shapeDiagonalLineLight: return "\u{f93d}"
        case .shapeDiagonalLineRegular: return "\u{f93e}"
        case .shapeDiamondBold: return "\u{f93f}"
        case .shapeDiamondFilled: return "\u{f940}"
        case .shapeDiamondLight: return "\u{f941}"
        case .shapeDiamondRegular: return "\u{f942}"
        case .shapeOvalBold: return "\u{f943}"
        case .shapeOvalLight: return "\u{f944}"
        case .shapeOvalRegular: return "\u{f945}"
        case .shapeSquareBold: return "\u{f946}"
        case .shapeSquareFilled: return "\u{f947}"
        case .shapeSquareLight: return "\u{f948}"
        case .shapeSquareRegular: return "\u{f949}"
        case .shapeTriangleBold: return "\u{f94a}"
        case .shapeTriangleFilled: return "\u{f94b}"
        case .shapeTriangleLight: return "\u{f94c}"
        case .shapeTriangleRegular: return "\u{f94d}"
        case .shapesBold: return "\u{f94e}"
        case .shapesLight: return "\u{f94f}"
        case .shapesRegular: return "\u{f950}"
        case .shareCNativeAdrBold: return "\u{f951}"
        case .shareCNativeAdrFilled: return "\u{f952}"
        case .shareCNativeAdrLight: return "\u{f953}"
        case .shareCNativeAdrRegular: return "\u{f954}"
        case .shareCNativeIphBold: return "\u{f955}"
        case .shareCNativeIphLight: return "\u{f956}"
        case .shareCNativeIphRegular: return "\u{f957}"
        case .shareScreenAddBold: return "\u{f958}"
        case .shareScreenAddLight: return "\u{f959}"
        case .shareScreenAddRegular: return "\u{f95a}"
        case .shareScreenBold: return "\u{f95b}"
        case .shareScreenFilled: return "\u{f95c}"
        case .shareScreenLight: return "\u{f95d}"
        case .shareScreenRegular: return "\u{f95e}"
        case .shareScreenSmallFilled: return "\u{f95f}"
        case .shareSpaceBold: return "\u{f960}"
        case .shareSpaceLight: return "\u{f961}"
        case .shareSpaceRegular: return "\u{f962}"
        case .shieldBold: return "\u{f963}"
        case .shieldLight: return "\u{f964}"
        case .shieldRegular: return "\u{f965}"
        case .shoppingCartBold: return "\u{f966}"
        case .shoppingCartFilled: return "\u{f967}"
        case .shoppingCartLight: return "\u{f968}"
        case .shoppingCartRegular: return "\u{f969}"
        case .shortTextBoxBold: return "\u{f96a}"
        case .shortTextBoxLight: return "\u{f96b}"
        case .shortTextBoxRegular: return "\u{f96c}"
        case .showBold: return "\u{f96d}"
        case .showFilled: return "\u{f96e}"
        case .showLight: return "\u{f96f}"
        case .showRegular: return "\u{f970}"
        case .signInBold: return "\u{f971}"
        case .signInFilled: return "\u{f972}"
        case .signInForcedBold: return "\u{f973}"
        case .signInForcedLight: return "\u{f974}"
        case .signInForcedRegular: return "\u{f975}"
        case .signInLight: return "\u{f976}"
        case .signInRegular: return "\u{f977}"
        case .signLangIntBold: return "\u{f978}"
        case .signLangIntLight: return "\u{f979}"
        case .signLangIntRegular: return "\u{f97a}"
        case .signOutBold: return "\u{f97b}"
        case .signOutLight: return "\u{f97c}"
        case .signOutRegular: return "\u{f97d}"
        case .signal0Bold: return "\u{f97e}"
        case .signal0Light: return "\u{f97f}"
        case .signal0Regular: return "\u{f980}"
        case .signal100Bold: return "\u{f981}"
        case .signal100Light: return "\u{f982}"
        case .signal100Regular: return "\u{f983}"
        case .signal25Bold: return "\u{f984}"
        case .signal25Light: return "\u{f985}"
        case .signal25Regular: return "\u{f986}"
        case .signal50Bold: return "\u{f987}"
        case .signal50Light: return "\u{f988}"
        case .signal50Regular: return "\u{f989}"
        case .signal75Bold: return "\u{f98a}"
        case .signal75Light: return "\u{f98b}"
        case .signal75Regular: return "\u{f98c}"
        case .simplePromotionBold: return "\u{f98d}"
        case .simplePromotionLight: return "\u{f98e}"
        case .simplePromotionRegular: return "\u{f98f}"
        case .singleNumberReachBold: return "\u{f990}"
        case .singleNumberReachLight: return "\u{f991}"
        case .singleNumberReachRegular: return "\u{f992}"
        case .sipRegistrationInProgressBold: return "\u{f993}"
        case .sipRegistrationInProgressFilled: return "\u{f994}"
        case .sipRegistrationInProgressLight: return "\u{f995}"
        case .sipRegistrationInProgressRegular: return "\u{f996}"
        case .skipBold: return "\u{f997}"
        case .skipBwBold: return "\u{f998}"
        case .skipBwFilled: return "\u{f999}"
        case .skipBwLight: return "\u{f99a}"
        case .skipBwRegular: return "\u{f99b}"
        case .skipFwBold: return "\u{f99c}"
        case .skipFwFilled: return "\u{f99d}"
        case .skipFwLight: return "\u{f99e}"
        case .skipFwRegular: return "\u{f99f}"
        case .skipLight: return "\u{f9a0}"
        case .skipRegular: return "\u{f9a1}"
        case .slidoLogo: return "\u{f9a2}"
        case .smsInboundBold: return "\u{f9a3}"
        case .smsInboundLight: return "\u{f9a4}"
        case .smsInboundRegular: return "\u{f9a5}"
        case .smsMessageBold: return "\u{f9a6}"
        case .smsMessageFilled: return "\u{f9a7}"
        case .smsMessageLight: return "\u{f9a8}"
        case .smsMessageRegular: return "\u{f9a9}"
        case .socialAlexaFilled: return "\u{f9aa}"
        case .socialFacebookColoredFilled: return "\u{f9ab}"
        case .socialFacebookFilled: return "\u{f9ac}"
        case .socialFbmessengerColoredFilled: return "\u{f9ad}"
        case .socialFbmessengerFilled: return "\u{f9ae}"
        case .socialInstagramBold: return "\u{f9af}"
        case .socialMicrosoftColoredFilled: return "\u{f9b0}"
        case .socialMicrosoftFilled: return "\u{f9b1}"
        case .socialMmsFilled: return "\u{f9b2}"
        case .socialMmsGoldFilled: return "\u{f9b3}"
        case .socialSmsFilled: return "\u{f9b4}"
        case .socialSmsMintFilled: return "\u{f9b5}"
        case .socialTwitterColoredFilled: return "\u{f9b6}"
        case .socialTwitterFilled: return "\u{f9b7}"
        case .socialViberBold: return "\u{f9b8}"
        case .socialViberColoredBold: return "\u{f9b9}"
        case .socialWhatsappBold: return "\u{f9ba}"
        case .socialWhatsappColoredFilled: return "\u{f9bb}"
        case .sortAscendingBold: return "\u{f9bc}"
        case .sortAscendingLight: return "\u{f9bd}"
        case .sortAscendingRegular: return "\u{f9be}"
        case .sortDescendingBold: return "\u{f9bf}"
        case .sortDescendingLight: return "\u{f9c0}"
        case .sortDescendingRegular: return "\u{f9c1}"
        case .soundDefaultBold: return "\u{f9c2}"
        case .soundDefaultLight: return "\u{f9c3}"
        case .soundDefaultRegular: return "\u{f9c4}"
        case .speakerBold: return "\u{f9c5}"
        case .speakerDisconnectedBold: return "\u{f9c6}"
        case .speakerDisconnectedFilled: return "\u{f9c7}"
        case .speakerDisconnectedLight: return "\u{f9c8}"
        case .speakerDisconnectedRegular: return "\u{f9c9}"
        case .speakerFilled: return "\u{f9ca}"
        case .speakerLight: return "\u{f9cb}"
        case .speakerMutedBold: return "\u{f9cc}"
        case .speakerMutedFilled: return "\u{f9cd}"
        case .speakerMutedLight: return "\u{f9ce}"
        case .speakerMutedRegular: return "\u{f9cf}"
        case .speakerOffBold: return "\u{f9d0}"
        case .speakerOffFilled: return "\u{f9d1}"
        case .speakerOffLight: return "\u{f9d2}"
        case .speakerOffRegular: return "\u{f9d3}"
        case .speakerOnColoredBold: return "\u{f9d4}"
        case .speakerOnColoredLight: return "\u{f9d5}"
        case .speakerOnColoredRegular: return "\u{f9d6}"
        case .speakerRegular: return "\u{f9d7}"
        case .speakerTurnDownBold: return "\u{f9d8}"
        case .speakerTurnDownFilled: return "\u{f9d9}"
        case .speakerTurnDownLight: return "\u{f9da}"
        case .speakerTurnDownRegular: return "\u{f9db}"
        case .speakerTurnUpBold: return "\u{f9dc}"
        case .speakerTurnUpFilled: return "\u{f9dd}"
        case .speakerTurnUpLight: return "\u{f9de}"
        case .speakerTurnUpRegular: return "\u{f9df}"
        case .spellCheckerBold: return "\u{f9e0}"
        case .spellCheckerLight: return "\u{f9e1}"
        case .spellCheckerRegular: return "\u{f9e2}"
        case .spinnerBold: return "\u{f9e3}"
        case .spinnerFilledBold: return "\u{f9e4}"
        case .spinnerFilledLight: return "\u{f9e5}"
        case .spinnerFilledRegular: return "\u{f9e6}"
        case .spinnerLight: return "\u{f9e7}"
        case .spinnerPartialBold: return "\u{f9e8}"
        case .spinnerPartialLight: return "\u{f9e9}"
        case .spinnerPartialRegular: return "\u{f9ea}"
        case .spinnerRegular: return "\u{f9eb}"
        case .stackedArea100ChartBold: return "\u{f9ec}"
        case .stackedArea100ChartFilled: return "\u{f9ed}"
        case .stackedArea100ChartLight: return "\u{f9ee}"
        case .stackedArea100ChartRegular: return "\u{f9ef}"
        case .stackedAreaChartBold: return "\u{f9f0}"
        case .stackedAreaChartFilled: return "\u{f9f1}"
        case .stackedAreaChartLight: return "\u{f9f2}"
        case .stackedAreaChartRegular: return "\u{f9f3}"
        case .stackedBar100ChartBold: return "\u{f9f4}"
        case .stackedBar100ChartFilled: return "\u{f9f5}"
        case .stackedBar100ChartLight: return "\u{f9f6}"
        case .stackedBar100ChartRegular: return "\u{f9f7}"
        case .stackedBarChartBold: return "\u{f9f8}"
        case .stackedBarChartFilled: return "\u{f9f9}"
        case .stackedBarChartLight: return "\u{f9fa}"
        case .stackedBarChartRegular: return "\u{f9fb}"
        case .startChatBold: return "\u{f9fc}"
        case .startChatLight: return "\u{f9fd}"
        case .startChatRegular: return "\u{f9fe}"
        case .stethoscopeBold: return "\u{f9ff}"
        case .stethoscopeLight: return "\u{fa00}"
        case .stethoscopeRegular: return "\u{fa01}"
        case .stickersBold: return "\u{fa02}"
        case .stickersLight: return "\u{fa03}"
        case .stickersRegular: return "\u{fa04}"
        case .stickiesBold: return "\u{fa05}"
        case .stickiesLight: return "\u{fa06}"
        case .stickiesRegular: return "\u{fa07}"
        case .stopBold: return "\u{fa08}"
        case .stopCircleBold: return "\u{fa09}"
        case .stopCircleFilled: return "\u{fa0a}"
        case .stopCircleLight: return "\u{fa0b}"
        case .stopCircleRegular: return "\u{fa0c}"
        case .stopContentShareBold: return "\u{fa0d}"
        case .stopContentShareLight: return "\u{fa0e}"
        case .stopContentShareRegular: return "\u{fa0f}"
        case .stopFilled: return "\u{fa10}"
        case .stopLight: return "\u{fa11}"
        case .stopRegular: return "\u{fa12}"
        case .storedInfoBold: return "\u{fa13}"
        case .storedInfoFilled: return "\u{fa14}"
        case .storedInfoLight: return "\u{fa15}"
        case .storedInfoRegular: return "\u{fa16}"
        case .streamingBold: return "\u{fa17}"
        case .streamingLight: return "\u{fa18}"
        case .streamingRegular: return "\u{fa19}"
        case .strikethroughBold: return "\u{fa1a}"
        case .strikethroughLight: return "\u{fa1b}"
        case .strikethroughRegular: return "\u{fa1c}"
        case .studioModeBold: return "\u{fa1d}"
        case .studioModeLight: return "\u{fa1e}"
        case .studioModeRegular: return "\u{fa1f}"
        case .subscriptBold: return "\u{fa20}"
        case .subscriptLight: return "\u{fa21}"
        case .subscriptRegular: return "\u{fa22}"
        case .superscriptBold: return "\u{fa23}"
        case .superscriptLight: return "\u{fa24}"
        case .superscriptRegular: return "\u{fa25}"
        case .surveyBold: return "\u{fa26}"
        case .surveyFilled: return "\u{fa27}"
        case .surveyLight: return "\u{fa28}"
        case .surveyRegular: return "\u{fa29}"
        case .sx10Bold: return "\u{fa2a}"
        case .sx10Light: return "\u{fa2b}"
        case .sx10Regular: return "\u{fa2c}"
        case .sx20Bold: return "\u{fa2d}"
        case .sx20Light: return "\u{fa2e}"
        case .sx20Regular: return "\u{fa2f}"
        case .sx80CodecBold: return "\u{fa30}"
        case .sx80CodecLight: return "\u{fa31}"
        case .sx80CodecRegular: return "\u{fa32}"
        case .tableBold: return "\u{fa33}"
        case .tableLight: return "\u{fa34}"
        case .tableRegular: return "\u{fa35}"
        case .tabletBold: return "\u{fa36}"
        case .tabletLight: return "\u{fa37}"
        case .tabletRegular: return "\u{fa38}"
        case .tabsBold: return "\u{fa39}"
        case .tabsLight: return "\u{fa3a}"
        case .tabsRegular: return "\u{fa3b}"
        case .tagBold: return "\u{fa3c}"
        case .tagLight: return "\u{fa3d}"
        case .tagRegular: return "\u{fa3e}"
        case .tapBold: return "\u{fa3f}"
        case .tapFilled: return "\u{fa40}"
        case .tapLight: return "\u{fa41}"
        case .tapRegular: return "\u{fa42}"
        case .telepresenceAlertBold: return "\u{fa43}"
        case .telepresenceAlertLight: return "\u{fa44}"
        case .telepresenceAlertMutedBold: return "\u{fa45}"
        case .telepresenceAlertMutedLight: return "\u{fa46}"
        case .telepresenceAlertMutedRegular: return "\u{fa47}"
        case .telepresenceAlertRegular: return "\u{fa48}"
        case .telepresenceBold: return "\u{fa49}"
        case .telepresenceIx5000Bold: return "\u{fa4a}"
        case .telepresenceIx5000Light: return "\u{fa4b}"
        case .telepresenceIx5000Regular: return "\u{fa4c}"
        case .telepresenceLight: return "\u{fa4d}"
        case .telepresencePrivateBold: return "\u{fa4e}"
        case .telepresencePrivateLight: return "\u{fa4f}"
        case .telepresencePrivateRegular: return "\u{fa50}"
        case .telepresenceRegular: return "\u{fa51}"
        case .temperatureBold: return "\u{fa52}"
        case .temperatureLight: return "\u{fa53}"
        case .temperatureRegular: return "\u{fa54}"
        case .textAlignCenterBold: return "\u{fa55}"
        case .textAlignCenterFilled: return "\u{fa56}"
        case .textAlignCenterLight: return "\u{fa57}"
        case .textAlignCenterRegular: return "\u{fa58}"
        case .textAlignLeftBold: return "\u{fa59}"
        case .textAlignLeftFilled: return "\u{fa5a}"
        case .textAlignLeftLight: return "\u{fa5b}"
        case .textAlignLeftRegular: return "\u{fa5c}"
        case .textAlignRightBold: return "\u{fa5d}"
        case .textAlignRightFilled: return "\u{fa5e}"
        case .textAlignRightLight: return "\u{fa5f}"
        case .textAlignRightRegular: return "\u{fa60}"
        case .textBold: return "\u{fa61}"
        case .textBoxCursorBold: return "\u{fa62}"
        case .textBoxCursorLight: return "\u{fa63}"
        case .textCodeBlockBold: return "\u{fa64}"
        case .textCodeBlockLight: return "\u{fa65}"
        case .textCodeBlockRegular: return "\u{fa66}"
        case .textHighlightBold: return "\u{fa67}"
        case .textHighlightLight: return "\u{fa68}"
        case .textHighlightRegular: return "\u{fa69}"
        case .textLight: return "\u{fa6a}"
        case .textRegular: return "\u{fa6b}"
        case .threeColumnBold: return "\u{fa6c}"
        case .threeColumnLight: return "\u{fa6d}"
        case .threeColumnRegular: return "\u{fa6e}"
        case .threeDObjectBold: return "\u{fa6f}"
        case .threeDObjectLight: return "\u{fa70}"
        case .threeDObjectRegular: return "\u{fa71}"
        case .tooFastBold: return "\u{fa72}"
        case .tooFastLight: return "\u{fa73}"
        case .tooFastRegular: return "\u{fa74}"
        case .tooSlowBold: return "\u{fa75}"
        case .tooSlowLight: return "\u{fa76}"
        case .tooSlowRegular: return "\u{fa77}"
        case .toolsBold: return "\u{fa78}"
        case .toolsLight: return "\u{fa79}"
        case .toolsRegular: return "\u{fa7a}"
        case .touch10Bold: return "\u{fa7b}"
        case .touch10Light: return "\u{fa7c}"
        case .touch10Regular: return "\u{fa7d}"
        case .transcriptBold: return "\u{fa7e}"
        case .transcriptFilled: return "\u{fa7f}"
        case .transcriptLight: return "\u{fa80}"
        case .transcriptRegular: return "\u{fa81}"
        case .translateBold: return "\u{fa82}"
        case .translateLight: return "\u{fa83}"
        case .translateRegular: return "\u{fa84}"
        case .trimBold: return "\u{fa85}"
        case .trimLight: return "\u{fa86}"
        case .trimRegular: return "\u{fa87}"
        case .twoColumnBold: return "\u{fa88}"
        case .twoColumnLight: return "\u{fa89}"
        case .twoColumnRegular: return "\u{fa8a}"
        case .ucmCloudBold: return "\u{fa8b}"
        case .ucmCloudLight: return "\u{fa8c}"
        case .ucmCloudRegular: return "\u{fa8d}"
        case .underlineBold: return "\u{fa8e}"
        case .underlineLight: return "\u{fa8f}"
        case .underlineRegular: return "\u{fa90}"
        case .undoBold: return "\u{fa91}"
        case .undoLight: return "\u{fa92}"
        case .undoRegular: return "\u{fa93}"
        case .unlinkBold: return "\u{fa94}"
        case .unlinkLight: return "\u{fa95}"
        case .unlinkRegular: return "\u{fa96}"
        case .unreadBold: return "\u{fa97}"
        case .unreadFilled: return "\u{fa98}"
        case .unreadLight: return "\u{fa99}"
        case .unreadRegular: return "\u{fa9a}"
        case .unsecureUnlockedBold: return "\u{fa9b}"
        case .unsecureUnlockedFilled: return "\u{fa9c}"
        case .unsecureUnlockedLight: return "\u{fa9d}"
        case .unsecureUnlockedRegular: return "\u{fa9e}"
        case .unsortedBold: return "\u{fa9f}"
        case .unsortedLight: return "\u{faa0}"
        case .unsortedRegular: return "\u{faa1}"
        case .updateFileShareBold: return "\u{faa2}"
        case .updateFileShareLight: return "\u{faa3}"
        case .updateFileShareRegular: return "\u{faa4}"
        case .upgradeBold: return "\u{faa5}"
        case .upgradeFilled: return "\u{faa6}"
        case .upgradeLight: return "\u{faa7}"
        case .upgradeRegular: return "\u{faa8}"
        case .uploadBold: return "\u{faa9}"
        case .uploadImageBold: return "\u{faaa}"
        case .uploadImageLight: return "\u{faab}"
        case .uploadImageRegular: return "\u{faac}"
        case .uploadLight: return "\u{faad}"
        case .uploadRegular: return "\u{faae}"
        case .urgentVoicemailBold: return "\u{faaf}"
        case .urgentVoicemailFilled: return "\u{fab0}"
        case .usbBold: return "\u{fab1}"
        case .usbHeadsetBold: return "\u{fab2}"
        case .usbHeadsetLight: return "\u{fab3}"
        case .usbHeadsetMutedBold: return "\u{fab4}"
        case .usbHeadsetMutedLight: return "\u{fab5}"
        case .usbHeadsetMutedRegular: return "\u{fab6}"
        case .usbHeadsetRegular: return "\u{fab7}"
        case .usbLight: return "\u{fab8}"
        case .usbRegular: return "\u{fab9}"
        case .userBold: return "\u{faba}"
        case .userDeactivateBold: return "\u{fabb}"
        case .userDeactivateLight: return "\u{fabc}"
        case .userDeactivateRegular: return "\u{fabd}"
        case .userLight: return "\u{fabe}"
        case .userRegular: return "\u{fabf}"
        case .vcsBold: return "\u{fac0}"
        case .vcsLight: return "\u{fac1}"
        case .vcsRegular: return "\u{fac2}"
        case .vidcastLogoDark: return "\u{fac3}"
        case .videoBlurBold: return "\u{fac4}"
        case .videoBlurFilled: return "\u{fac5}"
        case .videoBlurLight: return "\u{fac6}"
        case .videoBlurRegular: return "\u{fac7}"
        case .videoBold: return "\u{fac8}"
        case .videoEffectBold: return "\u{fac9}"
        case .videoEffectFilled: return "\u{faca}"
        case .videoEffectLight: return "\u{facb}"
        case .videoEffectRegular: return "\u{facc}"
        case .videoFilled: return "\u{facd}"
        case .videoLayoutBold: return "\u{face}"
        case .videoLayoutEqualBold: return "\u{facf}"
        case .videoLayoutEqualDualBold: return "\u{fad0}"
        case .videoLayoutEqualDualLight: return "\u{fad1}"
        case .videoLayoutEqualDualRegular: return "\u{fad2}"
        case .videoLayoutEqualFilled: return "\u{fad3}"
        case .videoLayoutEqualLight: return "\u{fad4}"
        case .videoLayoutEqualRegular: return "\u{fad5}"
        case .videoLayoutFilled: return "\u{fad6}"
        case .videoLayoutLight: return "\u{fad7}"
        case .videoLayoutOverlayBold: return "\u{fad8}"
        case .videoLayoutOverlayLight: return "\u{fad9}"
        case .videoLayoutOverlayRegular: return "\u{fada}"
        case .videoLayoutPresenterDominantBold: return "\u{fadb}"
        case .videoLayoutPresenterDominantLight: return "\u{fadc}"
        case .videoLayoutPresenterDominantRegular: return "\u{fadd}"
        case .videoLayoutProminentBold: return "\u{fade}"
        case .videoLayoutProminentFilled: return "\u{fadf}"
        case .videoLayoutProminentLight: return "\u{fae0}"
        case .videoLayoutProminentRegular: return "\u{fae1}"
        case .videoLayoutRegular: return "\u{fae2}"
        case .videoLayoutShareDominantBold: return "\u{fae3}"
        case .videoLayoutShareDominantLight: return "\u{fae4}"
        case .videoLayoutShareDominantRegular: return "\u{fae5}"
        case .videoLayoutSingleBold: return "\u{fae6}"
        case .videoLayoutSingleFilled: return "\u{fae7}"
        case .videoLayoutSingleLight: return "\u{fae8}"
        case .videoLayoutSingleRegular: return "\u{fae9}"
        case .videoLayoutStackBold: return "\u{faea}"
        case .videoLayoutStackFilled: return "\u{faeb}"
        case .videoLayoutStackLight: return "\u{faec}"
        case .videoLayoutStackRegular: return "\u{faed}"
        case .videoLayoutVideoDominantBold: return "\u{faee}"
        case .videoLayoutVideoDominantFilled: return "\u{faef}"
        case .videoLayoutVideoDominantLight: return "\u{faf0}"
        case .videoLayoutVideoDominantRegular: return "\u{faf1}"
        case .videoLight: return "\u{faf2}"
        case .videoPlusBold: return "\u{faf3}"
        case .videoPlusFilled: return "\u{faf4}"
        case .videoPlusLight: return "\u{faf5}"
        case .videoPlusRegular: return "\u{faf6}"
        case .videoRegular: return "\u{faf7}"
        case .videoSpeakerTrackBold: return "\u{faf8}"
        case .videoSpeakerTrackFilled: return "\u{faf9}"
        case .videoSpeakerTrackLight: return "\u{fafa}"
        case .videoSpeakerTrackRegular: return "\u{fafb}"
        case .viewAllBold: return "\u{fafc}"
        case .viewAllLight: return "\u{fafd}"
        case .viewAllRegular: return "\u{fafe}"
        case .viewListBold: return "\u{faff}"
        case .viewListLight: return "\u{fb00}"
        case .viewListRegular: return "\u{fb01}"
        case .viewStackedBold: return "\u{fb02}"
        case .viewStackedFilled: return "\u{fb03}"
        case .viewStackedLight: return "\u{fb04}"
        case .viewStackedRegular: return "\u{fb05}"
        case .viewThumbnailBold: return "\u{fb06}"
        case .viewThumbnailFilled: return "\u{fb07}"
        case .viewThumbnailLight: return "\u{fb08}"
        case .viewThumbnailRegular: return "\u{fb09}"
        case .voicemailBold: return "\u{fb0a}"
        case .voicemailFilled: return "\u{fb0b}"
        case .voicemailLight: return "\u{fb0c}"
        case .voicemailRegular: return "\u{fb0d}"
        case .waffleMenuBold: return "\u{fb0e}"
        case .waffleMenuLight: return "\u{fb0f}"
        case .waffleMenuRegular: return "\u{fb10}"
        case .waitingroomActiveBold: return "\u{fb11}"
        case .waitingroomActiveLight: return "\u{fb12}"
        case .waitingroomActiveRegular: return "\u{fb13}"
        case .wallpaperBold: return "\u{fb14}"
        case .wallpaperLight: return "\u{fb15}"
        case .wallpaperRegular: return "\u{fb16}"
        case .warningBadgeFilled: return "\u{fb17}"
        case .warningBold: return "\u{fb18}"
        case .warningFilled: return "\u{fb19}"
        case .warningLight: return "\u{fb1a}"
        case .warningRegular: return "\u{fb1b}"
        case .webexAssistantActiveColored: return "\u{fb1c}"
        case .webexAssistantActive: return "\u{fb1d}"
        case .webexAssistantFlat: return "\u{fb1e}"
        case .webexAssistantInactiveColored: return "\u{fb1f}"
        case .webexAssistantInactive: return "\u{fb20}"
        case .webexAssistantIndicator: return "\u{fb21}"
        case .webexAssistant: return "\u{fb22}"
        case .webexBoardBold: return "\u{fb23}"
        case .webexBoardLight: return "\u{fb24}"
        case .webexBoardRegular: return "\u{fb25}"
        case .webexCodecPlusBold: return "\u{fb26}"
        case .webexCodecPlusLight: return "\u{fb27}"
        case .webexCodecPlusRegular: return "\u{fb28}"
        case .webexDeskCameraBold: return "\u{fb29}"
        case .webexDeskCameraLight: return "\u{fb2a}"
        case .webexDeskCameraRegular: return "\u{fb2b}"
        case .webexHelixFilled: return "\u{fb2c}"
        case .webexMeetingsBold: return "\u{fb2d}"
        case .webexMeetingsFilled: return "\u{fb2e}"
        case .webexMeetingsLight: return "\u{fb2f}"
        case .webexMeetingsRegular: return "\u{fb30}"
        case .webexQuadCameraBold: return "\u{fb31}"
        case .webexQuadCameraLight: return "\u{fb32}"
        case .webexQuadCameraRegular: return "\u{fb33}"
        case .webexRoomKitBold: return "\u{fb34}"
        case .webexRoomKitLight: return "\u{fb35}"
        case .webexRoomKitPlusBold: return "\u{fb36}"
        case .webexRoomKitPlusLight: return "\u{fb37}"
        case .webexRoomKitPlusRegular: return "\u{fb38}"
        case .webexRoomKitRegular: return "\u{fb39}"
        case .webexShareBold: return "\u{fb3a}"
        case .webexShareLight: return "\u{fb3b}"
        case .webexShareRegular: return "\u{fb3c}"
        case .webexTeamsBold: return "\u{fb3d}"
        case .webexTeamsFilled: return "\u{fb3e}"
        case .webexTeamsLight: return "\u{fb3f}"
        case .webexTeamsNewBold: return "\u{fb40}"
        case .webexTeamsNewFilled: return "\u{fb41}"
        case .webexTeamsNewLight: return "\u{fb42}"
        case .webexTeamsNewRegular: return "\u{fb43}"
        case .webexTeamsRegular: return "\u{fb44}"
        case .webinarBold: return "\u{fb45}"
        case .webinarFilled: return "\u{fb46}"
        case .webinarLight: return "\u{fb47}"
        case .webinarRegular: return "\u{fb48}"
        case .weeklyRecurringScheduleNodeBold: return "\u{fb49}"
        case .weeklyRecurringScheduleNodeLight: return "\u{fb4a}"
        case .weeklyRecurringScheduleNodeRegular: return "\u{fb4b}"
        case .whatsNewBold: return "\u{fb4c}"
        case .whatsNewFilled: return "\u{fb4d}"
        case .whatsNewLight: return "\u{fb4e}"
        case .whatsNewRegular: return "\u{fb4f}"
        case .whiteboardBold: return "\u{fb50}"
        case .whiteboardContentBold: return "\u{fb51}"
        case .whiteboardContentLight: return "\u{fb52}"
        case .whiteboardContentRegular: return "\u{fb53}"
        case .whiteboardFilled: return "\u{fb54}"
        case .whiteboardLight: return "\u{fb55}"
        case .whiteboardRegular: return "\u{fb56}"
        case .widgetBold: return "\u{fb57}"
        case .widgetFilled: return "\u{fb58}"
        case .widgetLight: return "\u{fb59}"
        case .widgetRegular: return "\u{fb5a}"
        case .wifiBold: return "\u{fb5b}"
        case .wifiErrorBold: return "\u{fb5c}"
        case .wifiErrorLight: return "\u{fb5d}"
        case .wifiErrorRegular: return "\u{fb5e}"
        case .wifiLight: return "\u{fb5f}"
        case .wifiRegular: return "\u{fb60}"
        case .wifiSignalGoodColoredBold: return "\u{fb61}"
        case .wifiSignalGoodColoredLight: return "\u{fb62}"
        case .wifiSignalGoodColoredRegular: return "\u{fb63}"
        case .wifiSignalPoorColoredBold: return "\u{fb64}"
        case .wifiSignalPoorColoredLight: return "\u{fb65}"
        case .wifiSignalPoorColoredRegular: return "\u{fb66}"
        case .wifiSignalUnstableColoredBold: return "\u{fb67}"
        case .wifiSignalUnstableColoredLight: return "\u{fb68}"
        case .wifiSignalUnstableColoredRegular: return "\u{fb69}"
        case .windowCornerScrubBold: return "\u{fb6a}"
        case .windowCornerScrubLight: return "\u{fb6b}"
        case .windowCornerScrubRegular: return "\u{fb6c}"
        case .windowRightCornerScrubBold: return "\u{fb6d}"
        case .windowRightCornerScrubLight: return "\u{fb6e}"
        case .windowRightCornerScrubRegular: return "\u{fb6f}"
        case .windowVerticalScrubBold: return "\u{fb70}"
        case .windowVerticalScrubLight: return "\u{fb71}"
        case .windowVerticalScrubRegular: return "\u{fb72}"
        case .workflowDeploymentsBold: return "\u{fb73}"
        case .workflowDeploymentsFilled: return "\u{fb74}"
        case .workflowDeploymentsLight: return "\u{fb75}"
        case .workflowDeploymentsRegular: return "\u{fb76}"
        case .workphoneBold: return "\u{fb77}"
        case .workphoneLight: return "\u{fb78}"
        case .workphoneRegular: return "\u{fb79}"
        case .zoomInBold: return "\u{fb7a}"
        case .zoomInLight: return "\u{fb7b}"
        case .zoomInRegular: return "\u{fb7c}"
        case .zoomOutBold: return "\u{fb7d}"
        case .zoomOutLight: return "\u{fb7e}"
        case .zoomOutRegular: return "\u{fb7f}"
        case .zoom: return "\u{fb80}"
    ...
    public var filename: String {
        ...
        case .ciscoAiAssistantFlat: return "cisco-ai-assistant-flat"
        ...
        case .textBoxCursorBold: return "text-box-cursor-bold"
        ...
        case .vidcastLogoDark: return "vidcast_logo-dark"
        ...
        case .webexAssistantIndicator: return "webex-assistant-indicator"
