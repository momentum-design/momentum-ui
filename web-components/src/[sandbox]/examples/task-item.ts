...
export const taskItemTemplate = html`
  <div style="width:328px">
    ...
    <md-task-item mediaType="email" status="play" title="mlittlefoot@gmail.com" queue="IRV_quelle_12" selected>
      <div>00:08</div>
    </md-task-item>
    <md-task-item mediaType="telephony" status="consulting" title="Mihael Varificantare" queue="IRV_quelle_11">
      <div>Ringing</div>
    </md-task-item>
    ...
    <md-task-item mediaType="facebook" title="MediaType: facebook" queue="IRV_quelle_11">
      <div>01:10:25</div>
    </md-task-item>
