...
var EventOverlay = /*#__PURE__*/function (_React$Component) {
  ...
  function EventOverlay() {
    ...
    _this.handleAllowClickAway = function (e) {
      ...
      return _this.container && !anchorNode.contains(eventTarget) && !ReactDOM.findDOMNode(_this.container).contains(eventTarget) && _this.handleClickAway(e);
    };
    ...
    _this.handleCloseOnClick = function (e) {
      ...
      return closeOnClick && _this.container && ReactDOM.findDOMNode(_this.container).contains(eventTarget) && _this.handleClickAway(e);
    };
    ...
    _this.handleKeyDown = function (e) {
      ...
      var eventTarget = eventPath(e)[0];
      var anchorNode = ReactDOM.findDOMNode(_this.props.anchorNode);
      return _this.container && anchorNode && !anchorNode.contains(eventTarget) && !ReactDOM.findDOMNode(_this.container).contains(eventTarget) && _this.handleClickAway(e);
    };
  ...
  _proto.render = function render() {
    ...
    var contentNodes = isOpen && /*#__PURE__*/React.createElement("div", {
    ...
    var withFocusLock = function withFocusLock(content) {
      return shouldLockFocus ? /*#__PURE__*/React.createElement(FocusLock, focusLockProps, content) : content;
    };

    var withPortal = function withPortal(content) {
      return portalNode ? /*#__PURE__*/ReactDOM.createPortal(content, portalNode) : content;
    };
