...
@objc public enum MomentumIconType: Int {
    ...
    public var ligature: String {
        ...
        case .foodBold: return "\u{f439}"
        case .foodLight: return "\u{f43a}"
        case .foodRegular: return "\u{f43b}"
        case .formatBold: return "\u{f43c}"
        case .formatControlPanelDraggerBold: return "\u{f43d}"
        case .formatControlPanelDraggerLight: return "\u{f43e}"
        case .formatControlPanelDraggerRegular: return "\u{f43f}"
        case .formatDefaultAppBold: return "\u{f440}"
        case .formatDefaultAppLight: return "\u{f441}"
        case .formatDefaultAppRegular: return "\u{f442}"
        case .formatLight: return "\u{f443}"
        case .formatPanelControlBarBold: return "\u{f444}"
        case .formatPanelControlBarLight: return "\u{f445}"
        case .formatPanelControlBarRegular: return "\u{f446}"
        case .formatPanelControlDownBold: return "\u{f447}"
        case .formatPanelControlDownLight: return "\u{f448}"
        case .formatPanelControlDownRegular: return "\u{f449}"
        case .formatPanelControlLeftBold: return "\u{f44a}"
        case .formatPanelControlLeftLight: return "\u{f44b}"
        case .formatPanelControlLeftRegular: return "\u{f44c}"
        case .formatPanelControlRightBold: return "\u{f44d}"
        case .formatPanelControlRightLight: return "\u{f44e}"
        case .formatPanelControlRightRegular: return "\u{f44f}"
        case .formatPanelControlUpBold: return "\u{f450}"
        case .formatPanelControlUpLight: return "\u{f451}"
        case .formatPanelControlUpRegular: return "\u{f452}"
        case .formatRegular: return "\u{f453}"
        case .formatViewMixedBold: return "\u{f454}"
        case .formatViewMixedLight: return "\u{f455}"
        case .formatViewMixedRegular: return "\u{f456}"
        case .forwardMessageBold: return "\u{f457}"
        case .forwardMessageFilled: return "\u{f458}"
        case .forwardMessageLight: return "\u{f459}"
        case .forwardMessageRegular: return "\u{f45a}"
        case .fourWayNavigationBold: return "\u{f45b}"
        case .fourWayNavigationLight: return "\u{f45c}"
        case .fourWayNavigationRegular: return "\u{f45d}"
        case .fullscreenBold: return "\u{f45e}"
        case .fullscreenExitBold: return "\u{f45f}"
        case .fullscreenExitLight: return "\u{f460}"
        case .fullscreenExitRegular: return "\u{f461}"
        case .fullscreenLight: return "\u{f462}"
        case .fullscreenRegular: return "\u{f463}"
        case .genericDeviceVideoBold: return "\u{f464}"
        case .genericDeviceVideoFilled: return "\u{f465}"
        case .genericDeviceVideoLight: return "\u{f466}"
        case .genericDeviceVideoRegular: return "\u{f467}"
        case .gifBold: return "\u{f468}"
        case .gifFilled: return "\u{f469}"
        case .gifLight: return "\u{f46a}"
        case .gifRegular: return "\u{f46b}"
        case .guestIssuerBold: return "\u{f46c}"
        case .guestIssuerLight: return "\u{f46d}"
        case .guestIssuerRegular: return "\u{f46e}"
        case .guideBold: return "\u{f46f}"
        case .guideLight: return "\u{f470}"
        case .guideRegular: return "\u{f471}"
        case .handsetAlertBold: return "\u{f472}"
        case .handsetAlertFilled: return "\u{f473}"
        case .handsetAlertLight: return "\u{f474}"
        case .handsetAlertRegular: return "\u{f475}"
        case .handsetBold: return "\u{f476}"
        case .handsetFilled: return "\u{f477}"
        case .handsetLight: return "\u{f478}"
        case .handsetMutedBold: return "\u{f479}"
        case .handsetMutedFilled: return "\u{f47a}"
        case .handsetMutedLight: return "\u{f47b}"
        case .handsetMutedRegular: return "\u{f47c}"
        case .handsetRegular: return "\u{f47d}"
        case .handshakeBold: return "\u{f47e}"
        case .handshakeLight: return "\u{f47f}"
        case .handshakeRegular: return "\u{f480}"
        case .headingOneBold: return "\u{f481}"
        case .headingOneLight: return "\u{f482}"
        case .headingOneRegular: return "\u{f483}"
        case .headingThreeBold: return "\u{f484}"
        case .headingThreeLight: return "\u{f485}"
        case .headingThreeRegular: return "\u{f486}"
        case .headingTwoBold: return "\u{f487}"
        case .headingTwoLight: return "\u{f488}"
        case .headingTwoRegular: return "\u{f489}"
        case .headsetAlertBold: return "\u{f48a}"
        case .headsetAlertLight: return "\u{f48b}"
        case .headsetAlertRegular: return "\u{f48c}"
        case .headsetBold: return "\u{f48d}"
        case .headsetLight: return "\u{f48e}"
        case .headsetMutedBold: return "\u{f48f}"
        case .headsetMutedLight: return "\u{f490}"
        case .headsetMutedRegular: return "\u{f491}"
        case .headsetPrivateBold: return "\u{f492}"
        case .headsetPrivateLight: return "\u{f493}"
        case .headsetPrivateRegular: return "\u{f494}"
        case .headsetRegular: return "\u{f495}"
        case .helpBold: return "\u{f496}"
        case .helpCircleActiveFilled: return "\u{f497}"
        case .helpCircleBold: return "\u{f498}"
        case .helpCircleLight: return "\u{f499}"
        case .helpCircleRegular: return "\u{f49a}"
        case .helpLight: return "\u{f49b}"
        case .helpRegular: return "\u{f49c}"
        case .helpdeskBold: return "\u{f49d}"
        case .helpdeskLight: return "\u{f49e}"
        case .helpdeskRegular: return "\u{f49f}"
        case .hideBold: return "\u{f4a0}"
        case .hideFilled: return "\u{f4a1}"
        case .hideLight: return "\u{f4a2}"
        case .hideRegular: return "\u{f4a3}"
        case .homeBold: return "\u{f4a4}"
        case .homeFilled: return "\u{f4a5}"
        case .homeLight: return "\u{f4a6}"
        case .homeRegular: return "\u{f4a7}"
        case .horizontalLineBold: return "\u{f4a8}"
        case .horizontalLineLight: return "\u{f4a9}"
        case .horizontalLineRegular: return "\u{f4aa}"
        case .humidityBold: return "\u{f4ab}"
        case .humidityLight: return "\u{f4ac}"
        case .humidityRegular: return "\u{f4ad}"
        case .huntGroupBold: return "\u{f4ae}"
        case .huntGroupLight: return "\u{f4af}"
        case .huntGroupRegular: return "\u{f4b0}"
        case .importBold: return "\u{f4b1}"
        case .importLight: return "\u{f4b2}"
        case .importRegular: return "\u{f4b3}"
        case .incomingCallLegacyBold: return "\u{f4b4}"
        case .incomingCallLegacyLight: return "\u{f4b5}"
        case .incomingCallLegacyRegular: return "\u{f4b6}"
        case .infoCircleBold: return "\u{f4b7}"
        case .infoCircleFilled: return "\u{f4b8}"
        case .infoCircleLight: return "\u{f4b9}"
        case .infoCircleRegular: return "\u{f4ba}"
        case .inputBold: return "\u{f4bb}"
        case .inputDisconnectedBold: return "\u{f4bc}"
        case .inputDisconnectedLight: return "\u{f4bd}"
        case .inputDisconnectedRegular: return "\u{f4be}"
        case .inputLight: return "\u{f4bf}"
        case .inputRegular: return "\u{f4c0}"
        case .integrationsBold: return "\u{f4c1}"
        case .integrationsLight: return "\u{f4c2}"
        case .integrationsRegular: return "\u{f4c3}"
        case .invitedUserBold: return "\u{f4c4}"
        case .invitedUserLight: return "\u{f4c5}"
        case .invitedUserRegular: return "\u{f4c6}"
        case .italicBold: return "\u{f4c7}"
        case .italicLight: return "\u{f4c8}"
        case .italicRegular: return "\u{f4c9}"
        case .joinAudioBold: return "\u{f4ca}"
        case .joinAudioFilled: return "\u{f4cb}"
        case .joinAudioLight: return "\u{f4cc}"
        case .joinAudioRegular: return "\u{f4cd}"
        case .keyboardBold: return "\u{f4ce}"
        case .keyboardCloseBold: return "\u{f4cf}"
        case .keyboardCloseLight: return "\u{f4d0}"
        case .keyboardCloseRegular: return "\u{f4d1}"
        case .keyboardLight: return "\u{f4d2}"
        case .keyboardRegular: return "\u{f4d3}"
        case .languageBold: return "\u{f4d4}"
        case .languageLight: return "\u{f4d5}"
        case .languageRegular: return "\u{f4d6}"
        case .laptopBold: return "\u{f4d7}"
        case .laptopDisconnectedBold: return "\u{f4d8}"
        case .laptopDisconnectedLight: return "\u{f4d9}"
        case .laptopDisconnectedRegular: return "\u{f4da}"
        case .laptopLight: return "\u{f4db}"
        case .laptopRegular: return "\u{f4dc}"
        case .laserPointerBold: return "\u{f4dd}"
        case .laserPointerLight: return "\u{f4de}"
        case .laserPointerRegular: return "\u{f4df}"
        case .launchBold: return "\u{f4e0}"
        case .launchLight: return "\u{f4e1}"
        case .launchRegular: return "\u{f4e2}"
        case .layoutSideBySideVerticalBold: return "\u{f4e3}"
        case .layoutSideBySideVerticalFilled: return "\u{f4e4}"
        case .layoutSideBySideVerticalLight: return "\u{f4e5}"
        case .layoutSideBySideVerticalRegular: return "\u{f4e6}"
        case .likeBold: return "\u{f4e7}"
        case .likeFilled: return "\u{f4e8}"
        case .likeLight: return "\u{f4e9}"
        case .likeRegular: return "\u{f4ea}"
        case .linkBold: return "\u{f4eb}"
        case .linkLight: return "\u{f4ec}"
        case .linkRegular: return "\u{f4ed}"
        case .listBulletedBold: return "\u{f4ee}"
        case .listBulletedLight: return "\u{f4ef}"
        case .listBulletedRegular: return "\u{f4f0}"
        case .listMenuBold: return "\u{f4f1}"
        case .listMenuLight: return "\u{f4f2}"
        case .listMenuRegular: return "\u{f4f3}"
        case .listNumberedBold: return "\u{f4f4}"
        case .listNumberedLight: return "\u{f4f5}"
        case .listNumberedRegular: return "\u{f4f6}"
        case .locationBold: return "\u{f4f7}"
        case .locationFilled: return "\u{f4f8}"
        case .locationLight: return "\u{f4f9}"
        case .locationRegular: return "\u{f4fa}"
        case .lowerHandBold: return "\u{f4fb}"
        case .lowerHandLight: return "\u{f4fc}"
        case .lowerHandRegular: return "\u{f4fd}"
        case .markAsUnreadBold: return "\u{f4fe}"
        case .markAsUnreadLight: return "\u{f4ff}"
        case .markAsUnreadRegular: return "\u{f500}"
        case .markdownBold: return "\u{f501}"
        case .markdownLight: return "\u{f502}"
        case .markdownRegular: return "\u{f503}"
        case .markerBold: return "\u{f504}"
        case .markerFilled: return "\u{f505}"
        case .markerLight: return "\u{f506}"
        case .markerRegular: return "\u{f507}"
        case .maximizeBold: return "\u{f508}"
        case .maximizeLight: return "\u{f509}"
        case .maximizeRegular: return "\u{f50a}"
        case .mediaPlayerBold: return "\u{f50b}"
        case .mediaPlayerLight: return "\u{f50c}"
        case .mediaPlayerRegular: return "\u{f50d}"
        case .meetBold: return "\u{f50e}"
        case .meetEndBold: return "\u{f50f}"
        case .meetEndLight: return "\u{f510}"
        case .meetEndRegular: return "\u{f511}"
        case .meetFilled: return "\u{f512}"
        case .meetLight: return "\u{f513}"
        case .meetRegular: return "\u{f514}"
        case .meetingsBold: return "\u{f515}"
        case .meetingsFilled: return "\u{f516}"
        case .meetingsFocusMonthBold: return "\u{f517}"
        case .meetingsFocusMonthLight: return "\u{f518}"
        case .meetingsFocusMonthRegular: return "\u{f519}"
        case .meetingsFocusOneDayBold: return "\u{f51a}"
        case .meetingsFocusOneDayLight: return "\u{f51b}"
        case .meetingsFocusOneDayRegular: return "\u{f51c}"
        case .meetingsFocusThreeDayBold: return "\u{f51d}"
        case .meetingsFocusThreeDayLight: return "\u{f51e}"
        case .meetingsFocusThreeDayRegular: return "\u{f51f}"
        case .meetingsFocusUpcomingBold: return "\u{f520}"
        case .meetingsFocusUpcomingLight: return "\u{f521}"
        case .meetingsFocusUpcomingRegular: return "\u{f522}"
        case .meetingsFocusWeekBold: return "\u{f523}"
        case .meetingsFocusWeekLight: return "\u{f524}"
        case .meetingsFocusWeekRegular: return "\u{f525}"
        case .meetingsLight: return "\u{f526}"
        case .meetingsPresenceBold: return "\u{f527}"
        case .meetingsPresenceFilled: return "\u{f528}"
        case .meetingsPresenceLight: return "\u{f529}"
        case .meetingsPresenceRegular: return "\u{f52a}"
        case .meetingsRegular: return "\u{f52b}"
        case .meetingsTeamActiveBold: return "\u{f52c}"
        case .meetingsTeamActiveLight: return "\u{f52d}"
        case .meetingsTeamActiveRegular: return "\u{f52e}"
        case .meetingsTeamBold: return "\u{f52f}"
        case .meetingsTeamLight: return "\u{f530}"
        case .meetingsTeamNewBold: return "\u{f531}"
        case .meetingsTeamNewLight: return "\u{f532}"
        case .meetingsTeamNewRegular: return "\u{f533}"
        case .meetingsTeamRegular: return "\u{f534}"
        case .mentionBold: return "\u{f535}"
        case .mentionLight: return "\u{f536}"
        case .mentionRegular: return "\u{f537}"
        case .microphoneBold: return "\u{f538}"
        case .microphoneFilled: return "\u{f539}"
        case .microphoneHardMutedBold: return "\u{f53a}"
        case .microphoneHardMutedColoredBold: return "\u{f53b}"
        case .microphoneHardMutedColoredLight: return "\u{f53c}"
        case .microphoneHardMutedColoredRegular: return "\u{f53d}"
        case .microphoneHardMutedLight: return "\u{f53e}"
        case .microphoneHardMutedRegular: return "\u{f53f}"
        case .microphoneLight: return "\u{f540}"
        case .microphoneMutedBold: return "\u{f541}"
        case .microphoneMutedFilled: return "\u{f542}"
        case .microphoneMutedLight: return "\u{f543}"
        case .microphoneMutedRegular: return "\u{f544}"
        case .microphoneRegular: return "\u{f545}"
        case .minimizeBold: return "\u{f546}"
        case .minimizeLight: return "\u{f547}"
        case .minimizeRegular: return "\u{f548}"
        case .minusBold: return "\u{f549}"
        case .minusLight: return "\u{f54a}"
        case .minusRegular: return "\u{f54b}"
        case .mirrorBold: return "\u{f54c}"
        case .mirrorFilled: return "\u{f54d}"
        case .mirrorLight: return "\u{f54e}"
        case .mirrorRegular: return "\u{f54f}"
        case .moreAdrBold: return "\u{f550}"
        case .moreAdrLight: return "\u{f551}"
        case .moreAdrRegular: return "\u{f552}"
        case .moreBold: return "\u{f553}"
        case .moreCircleBold: return "\u{f554}"
        case .moreCircleFilled: return "\u{f555}"
        case .moreCircleLight: return "\u{f556}"
        case .moreCircleRegular: return "\u{f557}"
        case .moreLight: return "\u{f558}"
        case .moreRegular: return "\u{f559}"
        case .mouseCursorBold: return "\u{f55a}"
        case .mouseCursorLight: return "\u{f55b}"
        case .mouseCursorRegular: return "\u{f55c}"
        case .moveCallInAdrBold: return "\u{f55d}"
        case .moveCallInAdrLight: return "\u{f55e}"
        case .moveCallInAdrRegular: return "\u{f55f}"
        case .moveCallInIphBold: return "\u{f560}"
        case .moveCallInIphLight: return "\u{f561}"
        case .moveCallInIphRegular: return "\u{f562}"
        case .moveCallInLaptopBold: return "\u{f563}"
        case .moveCallInLaptopLight: return "\u{f564}"
        case .moveCallInLaptopRegular: return "\u{f565}"
        case .moveCallInOutAdrBold: return "\u{f566}"
        case .moveCallInOutAdrLight: return "\u{f567}"
        case .moveCallInOutAdrRegular: return "\u{f568}"
        case .moveCallInOutIphBold: return "\u{f569}"
        case .moveCallInOutIphLight: return "\u{f56a}"
        case .moveCallInOutIphRegular: return "\u{f56b}"
        case .moveCallInTabletBold: return "\u{f56c}"
        case .moveCallInTabletLight: return "\u{f56d}"
        case .moveCallInTabletRegular: return "\u{f56e}"
        case .moveCallOutAdrBold: return "\u{f56f}"
        case .moveCallOutAdrLight: return "\u{f570}"
        case .moveCallOutAdrRegular: return "\u{f571}"
        case .moveCallOutIphBold: return "\u{f572}"
        case .moveCallOutIphLight: return "\u{f573}"
        case .moveCallOutIphRegular: return "\u{f574}"
        case .moveCallOutLaptopBold: return "\u{f575}"
        case .moveCallOutLaptopLight: return "\u{f576}"
        case .moveCallOutLaptopRegular: return "\u{f577}"
        case .moveCallOutTabletBold: return "\u{f578}"
        case .moveCallOutTabletLight: return "\u{f579}"
        case .moveCallOutTabletRegular: return "\u{f57a}"
        case .multilineChartBold: return "\u{f57b}"
        case .multilineChartFilled: return "\u{f57c}"
        case .multilineChartLight: return "\u{f57d}"
        case .multilineChartRegular: return "\u{f57e}"
        case .multimediaBold: return "\u{f57f}"
        case .multimediaLight: return "\u{f580}"
        case .multimediaRegular: return "\u{f581}"
        case .multipledDevicesBold: return "\u{f582}"
        case .multipledDevicesLight: return "\u{f583}"
        case .multipledDevicesRegular: return "\u{f584}"
        case .musicModeBold: return "\u{f585}"
        case .musicModeFilled: return "\u{f586}"
        case .musicModeLight: return "\u{f587}"
        case .musicModeRegular: return "\u{f588}"
        case .muteOnEntryBold: return "\u{f589}"
        case .muteOnEntryFilled: return "\u{f58a}"
        case .muteOnEntryLight: return "\u{f58b}"
        case .muteOnEntryRegular: return "\u{f58c}"
        case .newVoicemailBold: return "\u{f58d}"
        case .newVoicemailLight: return "\u{f58e}"
        case .newVoicemailRegular: return "\u{f58f}"
        case .newWhiteboardBold: return "\u{f590}"
        case .newWhiteboardLight: return "\u{f591}"
        case .newWhiteboardRegular: return "\u{f592}"
        case .nextBold: return "\u{f593}"
        case .nextLight: return "\u{f594}"
        case .nextRegular: return "\u{f595}"
        case .noDevicesBold: return "\u{f596}"
        case .noDevicesLight: return "\u{f597}"
        case .noDevicesRegular: return "\u{f598}"
        case .noteBold: return "\u{f599}"
        case .noteLight: return "\u{f59a}"
        case .notePptBold: return "\u{f59b}"
        case .notePptLight: return "\u{f59c}"
        case .notePptRegular: return "\u{f59d}"
        case .noteRegular: return "\u{f59e}"
        case .notesBold: return "\u{f59f}"
        case .notesLight: return "\u{f5a0}"
        case .notesRegular: return "\u{f5a1}"
        case .numberBold: return "\u{f5a2}"
        case .numberLight: return "\u{f5a3}"
        case .numberRegular: return "\u{f5a4}"
        case .oldRemoteBold: return "\u{f5a5}"
        case .oldRemoteLight: return "\u{f5a6}"
        case .oldRemoteRegular: return "\u{f5a7}"
        case .oldTouchBold: return "\u{f5a8}"
        case .oldTouchLight: return "\u{f5a9}"
        case .oldTouchRegular: return "\u{f5aa}"
        case .openInFolderBold: return "\u{f5ab}"
        case .openInFolderLight: return "\u{f5ac}"
        case .openInFolderRegular: return "\u{f5ad}"
        case .openPagesBold: return "\u{f5ae}"
        case .openPagesLight: return "\u{f5af}"
        case .openPagesRegular: return "\u{f5b0}"
        case .otherNumberBold: return "\u{f5b1}"
        case .otherNumberLight: return "\u{f5b2}"
        case .otherNumberRegular: return "\u{f5b3}"
        case .otherNumberWarningBold: return "\u{f5b4}"
        case .otherNumberWarningLight: return "\u{f5b5}"
        case .otherNumberWarningRegular: return "\u{f5b6}"
        case .outgoingCallLegacyBold: return "\u{f5b7}"
        case .outgoingCallLegacyLight: return "\u{f5b8}"
        case .outgoingCallLegacyRegular: return "\u{f5b9}"
        case .overflowLeftBold: return "\u{f5ba}"
        case .overflowLeftLight: return "\u{f5bb}"
        case .overflowLeftRegular: return "\u{f5bc}"
        case .overflowRightBold: return "\u{f5bd}"
        case .overflowRightLight: return "\u{f5be}"
        case .overflowRightRegular: return "\u{f5bf}"
        case .pairedCameraBold: return "\u{f5c0}"
        case .pairedCameraLight: return "\u{f5c1}"
        case .pairedCameraRegular: return "\u{f5c2}"
        case .pairedDeviceBold: return "\u{f5c3}"
        case .pairedDeviceLight: return "\u{f5c4}"
        case .pairedDeviceRegular: return "\u{f5c5}"
        case .pairedHandsetBold: return "\u{f5c6}"
        case .pairedHandsetLight: return "\u{f5c7}"
        case .pairedHandsetRegular: return "\u{f5c8}"
        case .pairingBold: return "\u{f5c9}"
        case .pairingLight: return "\u{f5ca}"
        case .pairingRegular: return "\u{f5cb}"
        case .parkedBold: return "\u{f5cc}"
        case .parkedLight: return "\u{f5cd}"
        case .parkedRegular: return "\u{f5ce}"
        case .parseBold: return "\u{f5cf}"
        case .parseLight: return "\u{f5d0}"
        case .parseRegular: return "\u{f5d1}"
        case .participantAddBold: return "\u{f5d2}"
        case .participantAddLight: return "\u{f5d3}"
        case .participantAddRegular: return "\u{f5d4}"
        case .participantBlockedBold: return "\u{f5d5}"
        case .participantBlockedLight: return "\u{f5d6}"
        case .participantBlockedRegular: return "\u{f5d7}"
        case .participantBold: return "\u{f5d8}"
        case .participantFilled: return "\u{f5d9}"
        case .participantLight: return "\u{f5da}"
        case .participantListBold: return "\u{f5db}"
        case .participantListFilled: return "\u{f5dc}"
        case .participantListLight: return "\u{f5dd}"
        case .participantListRegular: return "\u{f5de}"
        case .participantRegular: return "\u{f5df}"
        case .participantRemoveBold: return "\u{f5e0}"
        case .participantRemoveLight: return "\u{f5e1}"
        case .participantRemoveRegular: return "\u{f5e2}"
        case .participantUnknownBold: return "\u{f5e3}"
        case .participantUnknownLight: return "\u{f5e4}"
        case .participantUnknownRegular: return "\u{f5e5}"
        case .passMouseBold: return "\u{f5e6}"
        case .passMouseLight: return "\u{f5e7}"
        case .passMouseRegular: return "\u{f5e8}"
        case .pauseBold: return "\u{f5e9}"
        case .pauseFilled: return "\u{f5ea}"
        case .pauseLight: return "\u{f5eb}"
        case .pauseRegular: return "\u{f5ec}"
        case .penBold: return "\u{f5ed}"
        case .penFilled: return "\u{f5ee}"
        case .penLight: return "\u{f5ef}"
        case .penRegular: return "\u{f5f0}"
        case .peopleBold: return "\u{f5f1}"
        case .peopleCircleBold: return "\u{f5f2}"
        case .peopleCircleLight: return "\u{f5f3}"
        case .peopleCircleRegular: return "\u{f5f4}"
        case .peopleFilled: return "\u{f5f5}"
        case .peopleLight: return "\u{f5f6}"
        case .peopleRegular: return "\u{f5f7}"
        case .phoneAlertBold: return "\u{f5f8}"
        case .phoneAlertLight: return "\u{f5f9}"
        case .phoneAlertRegular: return "\u{f5fa}"
        case .phoneBold: return "\u{f5fb}"
        case .phoneFilled: return "\u{f5fc}"
        case .phoneLight: return "\u{f5fd}"
        case .phoneMutedBold: return "\u{f5fe}"
        case .phoneMutedLight: return "\u{f5ff}"
        case .phoneMutedRegular: return "\u{f600}"
        case .phonePrivateBold: return "\u{f601}"
        case .phonePrivateLight: return "\u{f602}"
        case .phonePrivateRegular: return "\u{f603}"
        case .phoneRegular: return "\u{f604}"
        case .phoneReplyAllBold: return "\u{f605}"
        case .phoneReplyAllLight: return "\u{f606}"
        case .phoneReplyAllRegular: return "\u{f607}"
        case .phoneReplyBold: return "\u{f608}"
        case .phoneReplyLight: return "\u{f609}"
        case .phoneReplyRegular: return "\u{f60a}"
        case .pickerBold: return "\u{f60b}"
        case .pickerLight: return "\u{f60c}"
        case .pickerRegular: return "\u{f60d}"
        case .pictureInPictureBold: return "\u{f60e}"
        case .pictureInPictureLight: return "\u{f60f}"
        case .pictureInPictureRegular: return "\u{f610}"
        case .pieChartBold: return "\u{f611}"
        case .pieChartFilled: return "\u{f612}"
        case .pieChartLight: return "\u{f613}"
        case .pieChartRegular: return "\u{f614}"
        case .pinBold: return "\u{f615}"
        case .pinFilled: return "\u{f616}"
        case .pinLight: return "\u{f617}"
        case .pinListBold: return "\u{f618}"
        case .pinListLight: return "\u{f619}"
        case .pinListRegular: return "\u{f61a}"
        case .pinMutedBold: return "\u{f61b}"
        case .pinMutedLight: return "\u{f61c}"
        case .pinMutedRegular: return "\u{f61d}"
        case .pinRegular: return "\u{f61e}"
        case .placeholderBold: return "\u{f61f}"
        case .placeholderLight: return "\u{f620}"
        case .placeholderRegular: return "\u{f621}"
        case .playBold: return "\u{f622}"
        case .playFilled: return "\u{f623}"
        case .playLight: return "\u{f624}"
        case .playRegular: return "\u{f625}"
        case .plugAcBold: return "\u{f626}"
        case .plugAcLight: return "\u{f627}"
        case .plugAcRegular: return "\u{f628}"
        case .plusBold: return "\u{f629}"
        case .plusCircleBold: return "\u{f62a}"
        case .plusCircleFilled: return "\u{f62b}"
        case .plusCircleLight: return "\u{f62c}"
        case .plusCircleRegular: return "\u{f62d}"
        case .plusLight: return "\u{f62e}"
        case .plusRegular: return "\u{f62f}"
        case .pmrBold: return "\u{f630}"
        case .pmrFilled: return "\u{f631}"
        case .pmrLight: return "\u{f632}"
        case .pmrRegular: return "\u{f633}"
        case .pollBold: return "\u{f634}"
        case .pollLight: return "\u{f635}"
        case .pollRegular: return "\u{f636}"
        case .popInBold: return "\u{f637}"
        case .popInLight: return "\u{f638}"
        case .popInRegular: return "\u{f639}"
        case .popOutBold: return "\u{f63a}"
        case .popOutLight: return "\u{f63b}"
        case .popOutRegular: return "\u{f63c}"
        case .popUpBold: return "\u{f63d}"
        case .popUpLight: return "\u{f63e}"
        case .popUpRegular: return "\u{f63f}"
        case .powerAcBold: return "\u{f640}"
        case .powerAcLight: return "\u{f641}"
        case .powerAcRegular: return "\u{f642}"
        case .powerBold: return "\u{f643}"
        case .powerLight: return "\u{f644}"
        case .powerRegular: return "\u{f645}"
        case .presentationBold: return "\u{f646}"
        case .presentationLight: return "\u{f647}"
        case .presentationRegular: return "\u{f648}"
        case .printBold: return "\u{f649}"
        case .printLight: return "\u{f64a}"
        case .printRegular: return "\u{f64b}"
        case .priorityCircleBold: return "\u{f64c}"
        case .priorityCircleFilled: return "\u{f64d}"
        case .priorityCircleLight: return "\u{f64e}"
        case .priorityCircleRegular: return "\u{f64f}"
        case .privacyCircleBold: return "\u{f650}"
        case .privacyCircleFilled: return "\u{f651}"
        case .privacyCircleLight: return "\u{f652}"
        case .privacyCircleRegular: return "\u{f653}"
        case .privateBold: return "\u{f654}"
        case .privateCircleBold: return "\u{f655}"
        case .privateCircleFilled: return "\u{f656}"
        case .privateCircleLight: return "\u{f657}"
        case .privateCircleRegular: return "\u{f658}"
        case .privateLight: return "\u{f659}"
        case .privateMeetingBold: return "\u{f65a}"
        case .privateMeetingLight: return "\u{f65b}"
        case .privateMeetingRegular: return "\u{f65c}"
        case .privateRegular: return "\u{f65d}"
        case .productDemoBold: return "\u{f65e}"
        case .productDemoLight: return "\u{f65f}"
        case .productDemoRegular: return "\u{f660}"
        case .proximityBold: return "\u{f661}"
        case .proximityLight: return "\u{f662}"
        case .proximityMutedBold: return "\u{f663}"
        case .proximityMutedLight: return "\u{f664}"
        case .proximityMutedRegular: return "\u{f665}"
        case .proximityRegular: return "\u{f666}"
        case .proximityVideoBold: return "\u{f667}"
        case .proximityVideoLight: return "\u{f668}"
        case .proximityVideoRegular: return "\u{f669}"
        case .ptoPresenceBold: return "\u{f66a}"
        case .ptoPresenceFilled: return "\u{f66b}"
        case .ptoPresenceLight: return "\u{f66c}"
        case .ptoPresenceRegular: return "\u{f66d}"
        case .pullCallBold: return "\u{f66e}"
        case .pullCallLight: return "\u{f66f}"
        case .pullCallRegular: return "\u{f670}"
        case .qABold: return "\u{f671}"
        case .qALight: return "\u{f672}"
        case .qARegular: return "\u{f673}"
        case .qualityBold: return "\u{f674}"
        case .qualityLight: return "\u{f675}"
        case .qualityRegular: return "\u{f676}"
        case .queueContactBold: return "\u{f677}"
        case .queueContactLight: return "\u{f678}"
        case .queueContactRegular: return "\u{f679}"
        case .quietBold: return "\u{f67a}"
        case .quietHoursPresenceBold: return "\u{f67b}"
        case .quietHoursPresenceFilled: return "\u{f67c}"
        case .quietHoursPresenceLight: return "\u{f67d}"
        case .quietHoursPresenceRegular: return "\u{f67e}"
        case .quietLight: return "\u{f67f}"
        case .quietRegular: return "\u{f680}"
        case .raiseHandBold: return "\u{f681}"
        case .raiseHandLight: return "\u{f682}"
        case .raiseHandRegular: return "\u{f683}"
        case .ramBold: return "\u{f684}"
        case .ramLight: return "\u{f685}"
        case .ramRegular: return "\u{f686}"
        case .reactionsBold: return "\u{f687}"
        case .reactionsFilled: return "\u{f688}"
        case .reactionsLight: return "\u{f689}"
        case .reactionsRegular: return "\u{f68a}"
        case .reactivateBold: return "\u{f68b}"
        case .reactivateLight: return "\u{f68c}"
        case .reactivateRegular: return "\u{f68d}"
        case .recentsBold: return "\u{f68e}"
        case .recentsFilled: return "\u{f68f}"
        case .recentsLight: return "\u{f690}"
        case .recentsPresenceBold: return "\u{f691}"
        case .recentsPresenceFilled: return "\u{f692}"
        case .recentsPresenceLight: return "\u{f693}"
        case .recentsPresenceRegular: return "\u{f694}"
        case .recentsRegular: return "\u{f695}"
        case .recordBold: return "\u{f696}"
        case .recordFilled: return "\u{f697}"
        case .recordLight: return "\u{f698}"
        case .recordPausedBold: return "\u{f699}"
        case .recordPausedFilled: return "\u{f69a}"
        case .recordPausedLight: return "\u{f69b}"
        case .recordPausedRegular: return "\u{f69c}"
        case .recordRegular: return "\u{f69d}"
        case .recurringBold: return "\u{f69e}"
        case .recurringLight: return "\u{f69f}"
        case .recurringOffBold: return "\u{f6a0}"
        case .recurringOffLight: return "\u{f6a1}"
        case .recurringOffRegular: return "\u{f6a2}"
        case .recurringRegular: return "\u{f6a3}"
        case .redialBold: return "\u{f6a4}"
        case .redialLight: return "\u{f6a5}"
        case .redialRegular: return "\u{f6a6}"
        case .redoBold: return "\u{f6a7}"
        case .redoLight: return "\u{f6a8}"
        case .redoRegular: return "\u{f6a9}"
        case .refreshBold: return "\u{f6aa}"
        case .refreshLight: return "\u{f6ab}"
        case .refreshRegular: return "\u{f6ac}"
        case .remoteDesktopControlBold: return "\u{f6ad}"
        case .remoteDesktopControlLight: return "\u{f6ae}"
        case .remoteDesktopControlRegular: return "\u{f6af}"
        case .removeBold: return "\u{f6b0}"
        case .removeFilled: return "\u{f6b1}"
        case .removeLight: return "\u{f6b2}"
        case .removeRegular: return "\u{f6b3}"
        case .replyBold: return "\u{f6b4}"
        case .replyFilled: return "\u{f6b5}"
        case .replyLight: return "\u{f6b6}"
        case .replyListBold: return "\u{f6b7}"
        case .replyListLight: return "\u{f6b8}"
        case .replyListRegular: return "\u{f6b9}"
        case .replyRegular: return "\u{f6ba}"
        case .resetBold: return "\u{f6bb}"
        case .resetLight: return "\u{f6bc}"
        case .resetRegular: return "\u{f6bd}"
        case .responsiveMobileBold: return "\u{f6be}"
        case .responsiveMobileLight: return "\u{f6bf}"
        case .responsiveMobileRegular: return "\u{f6c0}"
        case .restartBold: return "\u{f6c1}"
        case .restartLight: return "\u{f6c2}"
        case .restartRegular: return "\u{f6c3}"
        case .returnBold: return "\u{f6c4}"
        case .returnLight: return "\u{f6c5}"
        case .returnRegular: return "\u{f6c6}"
        case .ringtoneBold: return "\u{f6c7}"
        case .ringtoneLight: return "\u{f6c8}"
        case .ringtoneRegular: return "\u{f6c9}"
        case .roomCalendarBold: return "\u{f6ca}"
        case .roomCalendarLight: return "\u{f6cb}"
        case .roomCalendarRegular: return "\u{f6cc}"
        case .roomLightsBold: return "\u{f6cd}"
        case .roomLightsLight: return "\u{f6ce}"
        case .roomLightsRegular: return "\u{f6cf}"
        case .rotateContentBold: return "\u{f6d0}"
        case .rotateContentFilled: return "\u{f6d1}"
        case .rotateContentLight: return "\u{f6d2}"
        case .rotateContentRegular: return "\u{f6d3}"
        case .runningApplicationBold: return "\u{f6d4}"
        case .runningApplicationFilled: return "\u{f6d5}"
        case .runningApplicationLight: return "\u{f6d6}"
        case .runningApplicationRegular: return "\u{f6d7}"
        case .saveBold: return "\u{f6d8}"
        case .saveLight: return "\u{f6d9}"
        case .saveRegular: return "\u{f6da}"
        case .scanBold: return "\u{f6db}"
        case .scanLight: return "\u{f6dc}"
        case .scanRegular: return "\u{f6dd}"
        case .schedulerAvailableBold: return "\u{f6de}"
        case .schedulerAvailableLight: return "\u{f6df}"
        case .schedulerAvailableRegular: return "\u{f6e0}"
        case .schedulerNotWorkingHoursBold: return "\u{f6e1}"
        case .schedulerNotWorkingHoursLight: return "\u{f6e2}"
        case .schedulerNotWorkingHoursRegular: return "\u{f6e3}"
        case .schedulerUnavailableBold: return "\u{f6e4}"
        case .schedulerUnavailableLight: return "\u{f6e5}"
        case .schedulerUnavailableRegular: return "\u{f6e6}"
        case .schedulerUnknownBold: return "\u{f6e7}"
        case .schedulerUnknownLight: return "\u{f6e8}"
        case .schedulerUnknownRegular: return "\u{f6e9}"
        case .screenshotBold: return "\u{f6ea}"
        case .screenshotDocBold: return "\u{f6eb}"
        case .screenshotDocFilled: return "\u{f6ec}"
        case .screenshotDocLight: return "\u{f6ed}"
        case .screenshotDocRegular: return "\u{f6ee}"
        case .screenshotLight: return "\u{f6ef}"
        case .screenshotRegular: return "\u{f6f0}"
        case .searchBold: return "\u{f6f1}"
        case .searchLight: return "\u{f6f2}"
        case .searchRegular: return "\u{f6f3}"
        case .secondaryArrowBold: return "\u{f6f4}"
        case .secondaryArrowLight: return "\u{f6f5}"
        case .secondaryArrowRegular: return "\u{f6f6}"
        case .secureCircleBold: return "\u{f6f7}"
        case .secureCircleFilled: return "\u{f6f8}"
        case .secureCircleLight: return "\u{f6f9}"
        case .secureCircleRegular: return "\u{f6fa}"
        case .secureLockBold: return "\u{f6fb}"
        case .secureLockFilled: return "\u{f6fc}"
        case .secureLockLight: return "\u{f6fd}"
        case .secureLockRegular: return "\u{f6fe}"
        case .selectionBold: return "\u{f6ff}"
        case .selectionLight: return "\u{f700}"
        case .selectionRegular: return "\u{f701}"
        case .sendBold: return "\u{f702}"
        case .sendFilled: return "\u{f703}"
        case .sendLight: return "\u{f704}"
        case .sendRegular: return "\u{f705}"
        case .serverBold: return "\u{f706}"
        case .serverErrorBold: return "\u{f707}"
        case .serverErrorLight: return "\u{f708}"
        case .serverErrorRegular: return "\u{f709}"
        case .serverLight: return "\u{f70a}"
        case .serverRegular: return "\u{f70b}"
        case .servicesBold: return "\u{f70c}"
        case .servicesLight: return "\u{f70d}"
        case .servicesRegular: return "\u{f70e}"
        case .setVariableBold: return "\u{f70f}"
        case .setVariableLight: return "\u{f710}"
        case .setVariableRegular: return "\u{f711}"
        case .settingsBold: return "\u{f712}"
        case .settingsFilled: return "\u{f713}"
        case .settingsLight: return "\u{f714}"
        case .settingsRegular: return "\u{f715}"
        case .setupAssistantBold: return "\u{f716}"
        case .setupAssistantLight: return "\u{f717}"
        case .setupAssistantRegular: return "\u{f718}"
        case .shapesBold: return "\u{f719}"
        case .shapesLight: return "\u{f71a}"
        case .shapesRegular: return "\u{f71b}"
        case .shareCNativeAdrBold: return "\u{f71c}"
        case .shareCNativeAdrLight: return "\u{f71d}"
        case .shareCNativeAdrRegular: return "\u{f71e}"
        case .shareCNativeIphBold: return "\u{f71f}"
        case .shareCNativeIphLight: return "\u{f720}"
        case .shareCNativeIphRegular: return "\u{f721}"
        case .shareScreenBold: return "\u{f722}"
        case .shareScreenFilled: return "\u{f723}"
        case .shareScreenLight: return "\u{f724}"
        case .shareScreenRegular: return "\u{f725}"
        case .shareSpaceBold: return "\u{f726}"
        case .shareSpaceLight: return "\u{f727}"
        case .shareSpaceRegular: return "\u{f728}"
        case .shieldBold: return "\u{f729}"
        case .shieldLight: return "\u{f72a}"
        case .shieldRegular: return "\u{f72b}"
        case .showBold: return "\u{f72c}"
        case .showFilled: return "\u{f72d}"
        case .showLight: return "\u{f72e}"
        case .showRegular: return "\u{f72f}"
        case .signInBold: return "\u{f730}"
        case .signInForcedBold: return "\u{f731}"
        case .signInForcedLight: return "\u{f732}"
        case .signInForcedRegular: return "\u{f733}"
        case .signInLight: return "\u{f734}"
        case .signInRegular: return "\u{f735}"
        case .signOutBold: return "\u{f736}"
        case .signOutLight: return "\u{f737}"
        case .signOutRegular: return "\u{f738}"
        case .signal0Bold: return "\u{f739}"
        case .signal0Light: return "\u{f73a}"
        case .signal0Regular: return "\u{f73b}"
        case .signal100Bold: return "\u{f73c}"
        case .signal100Light: return "\u{f73d}"
        case .signal100Regular: return "\u{f73e}"
        case .signal25Bold: return "\u{f73f}"
        case .signal25Light: return "\u{f740}"
        case .signal25Regular: return "\u{f741}"
        case .signal50Bold: return "\u{f742}"
        case .signal50Light: return "\u{f743}"
        case .signal50Regular: return "\u{f744}"
        case .signal75Bold: return "\u{f745}"
        case .signal75Light: return "\u{f746}"
        case .signal75Regular: return "\u{f747}"
        case .singleNumberReachBold: return "\u{f748}"
        case .singleNumberReachLight: return "\u{f749}"
        case .singleNumberReachRegular: return "\u{f74a}"
        case .skipBold: return "\u{f74b}"
        case .skipBwBold: return "\u{f74c}"
        case .skipBwFilled: return "\u{f74d}"
        case .skipBwLight: return "\u{f74e}"
        case .skipBwRegular: return "\u{f74f}"
        case .skipFwBold: return "\u{f750}"
        case .skipFwFilled: return "\u{f751}"
        case .skipFwLight: return "\u{f752}"
        case .skipFwRegular: return "\u{f753}"
        case .skipLight: return "\u{f754}"
        case .skipRegular: return "\u{f755}"
        case .speakerBold: return "\u{f756}"
        case .speakerDisconnectedBold: return "\u{f757}"
        case .speakerDisconnectedFilled: return "\u{f758}"
        case .speakerDisconnectedLight: return "\u{f759}"
        case .speakerDisconnectedRegular: return "\u{f75a}"
        case .speakerFilled: return "\u{f75b}"
        case .speakerLight: return "\u{f75c}"
        case .speakerMutedBold: return "\u{f75d}"
        case .speakerMutedFilled: return "\u{f75e}"
        case .speakerMutedLight: return "\u{f75f}"
        case .speakerMutedRegular: return "\u{f760}"
        case .speakerOffBold: return "\u{f761}"
        case .speakerOffFilled: return "\u{f762}"
        case .speakerOffLight: return "\u{f763}"
        case .speakerOffRegular: return "\u{f764}"
        case .speakerRegular: return "\u{f765}"
        case .speakerTurnDownBold: return "\u{f766}"
        case .speakerTurnDownFilled: return "\u{f767}"
        case .speakerTurnDownLight: return "\u{f768}"
        case .speakerTurnDownRegular: return "\u{f769}"
        case .speakerTurnUpBold: return "\u{f76a}"
        case .speakerTurnUpFilled: return "\u{f76b}"
        case .speakerTurnUpLight: return "\u{f76c}"
        case .speakerTurnUpRegular: return "\u{f76d}"
        case .spinnerBold: return "\u{f76e}"
        case .spinnerFilledBold: return "\u{f76f}"
        case .spinnerFilledLight: return "\u{f770}"
        case .spinnerFilledRegular: return "\u{f771}"
        case .spinnerLight: return "\u{f772}"
        case .spinnerRegular: return "\u{f773}"
        case .stackedArea100ChartBold: return "\u{f774}"
        case .stackedArea100ChartFilled: return "\u{f775}"
        case .stackedArea100ChartLight: return "\u{f776}"
        case .stackedArea100ChartRegular: return "\u{f777}"
        case .stackedAreaChartBold: return "\u{f778}"
        case .stackedAreaChartFilled: return "\u{f779}"
        case .stackedAreaChartLight: return "\u{f77a}"
        case .stackedAreaChartRegular: return "\u{f77b}"
        case .stackedBar100ChartBold: return "\u{f77c}"
        case .stackedBar100ChartFilled: return "\u{f77d}"
        case .stackedBar100ChartLight: return "\u{f77e}"
        case .stackedBar100ChartRegular: return "\u{f77f}"
        case .stackedBarChartBold: return "\u{f780}"
        case .stackedBarChartFilled: return "\u{f781}"
        case .stackedBarChartLight: return "\u{f782}"
        case .stackedBarChartRegular: return "\u{f783}"
        case .startChatBold: return "\u{f784}"
        case .startChatLight: return "\u{f785}"
        case .startChatRegular: return "\u{f786}"
        case .stickersBold: return "\u{f787}"
        case .stickersLight: return "\u{f788}"
        case .stickersRegular: return "\u{f789}"
        case .stickiesBold: return "\u{f78a}"
        case .stickiesLight: return "\u{f78b}"
        case .stickiesRegular: return "\u{f78c}"
        case .stopBold: return "\u{f78d}"
        case .stopCircleBold: return "\u{f78e}"
        case .stopCircleFilled: return "\u{f78f}"
        case .stopCircleLight: return "\u{f790}"
        case .stopCircleRegular: return "\u{f791}"
        case .stopContentShareBold: return "\u{f792}"
        case .stopContentShareLight: return "\u{f793}"
        case .stopContentShareRegular: return "\u{f794}"
        case .stopFilled: return "\u{f795}"
        case .stopLight: return "\u{f796}"
        case .stopRegular: return "\u{f797}"
        case .storedInfoBold: return "\u{f798}"
        case .storedInfoFilled: return "\u{f799}"
        case .storedInfoLight: return "\u{f79a}"
        case .storedInfoRegular: return "\u{f79b}"
        case .streamingBold: return "\u{f79c}"
        case .streamingLight: return "\u{f79d}"
        case .streamingRegular: return "\u{f79e}"
        case .strikethroughBold: return "\u{f79f}"
        case .strikethroughLight: return "\u{f7a0}"
        case .strikethroughRegular: return "\u{f7a1}"
        case .subscriptBold: return "\u{f7a2}"
        case .subscriptLight: return "\u{f7a3}"
        case .subscriptRegular: return "\u{f7a4}"
        case .superscriptBold: return "\u{f7a5}"
        case .superscriptLight: return "\u{f7a6}"
        case .superscriptRegular: return "\u{f7a7}"
        case .sx10Bold: return "\u{f7a8}"
        case .sx10Light: return "\u{f7a9}"
        case .sx10Regular: return "\u{f7aa}"
        case .sx20Bold: return "\u{f7ab}"
        case .sx20Light: return "\u{f7ac}"
        case .sx20Regular: return "\u{f7ad}"
        case .sx80CodecBold: return "\u{f7ae}"
        case .sx80CodecLight: return "\u{f7af}"
        case .sx80CodecRegular: return "\u{f7b0}"
        case .tableBold: return "\u{f7b1}"
        case .tableLight: return "\u{f7b2}"
        case .tableRegular: return "\u{f7b3}"
        case .tabletBold: return "\u{f7b4}"
        case .tabletLight: return "\u{f7b5}"
        case .tabletRegular: return "\u{f7b6}"
        case .tabsBold: return "\u{f7b7}"
        case .tabsLight: return "\u{f7b8}"
        case .tabsRegular: return "\u{f7b9}"
        case .tagBold: return "\u{f7ba}"
        case .tagLight: return "\u{f7bb}"
        case .tagRegular: return "\u{f7bc}"
        case .telepresenceAlertBold: return "\u{f7bd}"
        case .telepresenceAlertLight: return "\u{f7be}"
        case .telepresenceAlertMutedBold: return "\u{f7bf}"
        case .telepresenceAlertMutedLight: return "\u{f7c0}"
        case .telepresenceAlertMutedRegular: return "\u{f7c1}"
        case .telepresenceAlertRegular: return "\u{f7c2}"
        case .telepresenceBold: return "\u{f7c3}"
        case .telepresenceIx5000Bold: return "\u{f7c4}"
        case .telepresenceIx5000Light: return "\u{f7c5}"
        case .telepresenceIx5000Regular: return "\u{f7c6}"
        case .telepresenceLight: return "\u{f7c7}"
        case .telepresencePrivateBold: return "\u{f7c8}"
        case .telepresencePrivateLight: return "\u{f7c9}"
        case .telepresencePrivateRegular: return "\u{f7ca}"
        case .telepresenceRegular: return "\u{f7cb}"
        case .temperatureBold: return "\u{f7cc}"
        case .temperatureLight: return "\u{f7cd}"
        case .temperatureRegular: return "\u{f7ce}"
        case .textBold: return "\u{f7cf}"
        case .textCodeBlockBold: return "\u{f7d0}"
        case .textCodeBlockLight: return "\u{f7d1}"
        case .textCodeBlockRegular: return "\u{f7d2}"
        case .textHighlightBold: return "\u{f7d3}"
        case .textHighlightLight: return "\u{f7d4}"
        case .textHighlightRegular: return "\u{f7d5}"
        case .textLight: return "\u{f7d6}"
        case .textRegular: return "\u{f7d7}"
        case .threeDObjectBold: return "\u{f7d8}"
        case .threeDObjectLight: return "\u{f7d9}"
        case .threeDObjectRegular: return "\u{f7da}"
        case .tooFastBold: return "\u{f7db}"
        case .tooFastLight: return "\u{f7dc}"
        case .tooFastRegular: return "\u{f7dd}"
        case .tooSlowBold: return "\u{f7de}"
        case .tooSlowLight: return "\u{f7df}"
        case .tooSlowRegular: return "\u{f7e0}"
        case .toolsBold: return "\u{f7e1}"
        case .toolsLight: return "\u{f7e2}"
        case .toolsRegular: return "\u{f7e3}"
        case .touch10Bold: return "\u{f7e4}"
        case .touch10Light: return "\u{f7e5}"
        case .touch10Regular: return "\u{f7e6}"
        case .transcriptBold: return "\u{f7e7}"
        case .transcriptLight: return "\u{f7e8}"
        case .transcriptRegular: return "\u{f7e9}"
        case .ucmCloudBold: return "\u{f7ea}"
        case .ucmCloudLight: return "\u{f7eb}"
        case .ucmCloudRegular: return "\u{f7ec}"
        case .underlineBold: return "\u{f7ed}"
        case .underlineLight: return "\u{f7ee}"
        case .underlineRegular: return "\u{f7ef}"
        case .undoBold: return "\u{f7f0}"
        case .undoLight: return "\u{f7f1}"
        case .undoRegular: return "\u{f7f2}"
        case .unlinkBold: return "\u{f7f3}"
        case .unlinkLight: return "\u{f7f4}"
        case .unlinkRegular: return "\u{f7f5}"
        case .unreadBold: return "\u{f7f6}"
        case .unreadFilled: return "\u{f7f7}"
        case .unreadLight: return "\u{f7f8}"
        case .unreadRegular: return "\u{f7f9}"
        case .unsecureUnlockedBold: return "\u{f7fa}"
        case .unsecureUnlockedFilled: return "\u{f7fb}"
        case .unsecureUnlockedLight: return "\u{f7fc}"
        case .unsecureUnlockedRegular: return "\u{f7fd}"
        case .unsortedBold: return "\u{f7fe}"
        case .unsortedLight: return "\u{f7ff}"
        case .unsortedRegular: return "\u{f800}"
        case .updateFileShareBold: return "\u{f801}"
        case .updateFileShareLight: return "\u{f802}"
        case .updateFileShareRegular: return "\u{f803}"
        case .uploadBold: return "\u{f804}"
        case .uploadLight: return "\u{f805}"
        case .uploadRegular: return "\u{f806}"
        case .usbBold: return "\u{f807}"
        case .usbHeadsetBold: return "\u{f808}"
        case .usbHeadsetLight: return "\u{f809}"
        case .usbHeadsetMutedBold: return "\u{f80a}"
        case .usbHeadsetMutedLight: return "\u{f80b}"
        case .usbHeadsetMutedRegular: return "\u{f80c}"
        case .usbHeadsetRegular: return "\u{f80d}"
        case .usbLight: return "\u{f80e}"
        case .usbRegular: return "\u{f80f}"
        case .userBold: return "\u{f810}"
        case .userLight: return "\u{f811}"
        case .userRegular: return "\u{f812}"
        case .vcsBold: return "\u{f813}"
        case .vcsLight: return "\u{f814}"
        case .vcsRegular: return "\u{f815}"
        case .videoBlurBold: return "\u{f816}"
        case .videoBlurFilled: return "\u{f817}"
        case .videoBlurLight: return "\u{f818}"
        case .videoBlurRegular: return "\u{f819}"
        case .videoBold: return "\u{f81a}"
        case .videoEffectBold: return "\u{f81b}"
        case .videoEffectFilled: return "\u{f81c}"
        case .videoEffectLight: return "\u{f81d}"
        case .videoEffectRegular: return "\u{f81e}"
        case .videoFilled: return "\u{f81f}"
        case .videoLayoutBold: return "\u{f820}"
        case .videoLayoutEqualBold: return "\u{f821}"
        case .videoLayoutEqualFilled: return "\u{f822}"
        case .videoLayoutEqualLight: return "\u{f823}"
        case .videoLayoutEqualRegular: return "\u{f824}"
        case .videoLayoutLight: return "\u{f825}"
        case .videoLayoutOverlayBold: return "\u{f826}"
        case .videoLayoutOverlayLight: return "\u{f827}"
        case .videoLayoutOverlayRegular: return "\u{f828}"
        case .videoLayoutProminentBold: return "\u{f829}"
        case .videoLayoutProminentLight: return "\u{f82a}"
        case .videoLayoutProminentRegular: return "\u{f82b}"
        case .videoLayoutRegular: return "\u{f82c}"
        case .videoLayoutShareDominantBold: return "\u{f82d}"
        case .videoLayoutShareDominantLight: return "\u{f82e}"
        case .videoLayoutShareDominantRegular: return "\u{f82f}"
        case .videoLayoutSingleBold: return "\u{f830}"
        case .videoLayoutSingleLight: return "\u{f831}"
        case .videoLayoutSingleRegular: return "\u{f832}"
        case .videoLayoutStackBold: return "\u{f833}"
        case .videoLayoutStackFilled: return "\u{f834}"
        case .videoLayoutStackLight: return "\u{f835}"
        case .videoLayoutStackRegular: return "\u{f836}"
        case .videoLayoutVideoDominantBold: return "\u{f837}"
        case .videoLayoutVideoDominantLight: return "\u{f838}"
        case .videoLayoutVideoDominantRegular: return "\u{f839}"
        case .videoLight: return "\u{f83a}"
        case .videoRegular: return "\u{f83b}"
        case .videoSpeakerTrackBold: return "\u{f83c}"
        case .videoSpeakerTrackFilled: return "\u{f83d}"
        case .videoSpeakerTrackLight: return "\u{f83e}"
        case .videoSpeakerTrackRegular: return "\u{f83f}"
        case .viewAllBold: return "\u{f840}"
        case .viewAllLight: return "\u{f841}"
        case .viewAllRegular: return "\u{f842}"
        case .viewListBold: return "\u{f843}"
        case .viewListLight: return "\u{f844}"
        case .viewListRegular: return "\u{f845}"
        case .viewStackedBold: return "\u{f846}"
        case .viewStackedLight: return "\u{f847}"
        case .viewStackedRegular: return "\u{f848}"
        case .viewThumbnailBold: return "\u{f849}"
        case .viewThumbnailLight: return "\u{f84a}"
        case .viewThumbnailRegular: return "\u{f84b}"
        case .voicemailBold: return "\u{f84c}"
        case .voicemailFilled: return "\u{f84d}"
        case .voicemailLight: return "\u{f84e}"
        case .voicemailRegular: return "\u{f84f}"
        case .wallpaperBold: return "\u{f850}"
        case .wallpaperLight: return "\u{f851}"
        case .wallpaperRegular: return "\u{f852}"
        case .warningBold: return "\u{f853}"
        case .warningFilled: return "\u{f854}"
        case .warningLight: return "\u{f855}"
        case .warningRegular: return "\u{f856}"
        case .webexBoardBold: return "\u{f857}"
        case .webexBoardLight: return "\u{f858}"
        case .webexBoardRegular: return "\u{f859}"
        case .webexCodecPlusBold: return "\u{f85a}"
        case .webexCodecPlusLight: return "\u{f85b}"
        case .webexCodecPlusRegular: return "\u{f85c}"
        case .webexDeskCameraBold: return "\u{f85d}"
        case .webexDeskCameraLight: return "\u{f85e}"
        case .webexDeskCameraRegular: return "\u{f85f}"
        case .webexMeetingsBold: return "\u{f860}"
        case .webexMeetingsFilled: return "\u{f861}"
        case .webexMeetingsLight: return "\u{f862}"
        case .webexMeetingsRegular: return "\u{f863}"
        case .webexQuadCameraBold: return "\u{f864}"
        case .webexQuadCameraLight: return "\u{f865}"
        case .webexQuadCameraRegular: return "\u{f866}"
        case .webexRoomKitBold: return "\u{f867}"
        case .webexRoomKitLight: return "\u{f868}"
        case .webexRoomKitPlusBold: return "\u{f869}"
        case .webexRoomKitPlusLight: return "\u{f86a}"
        case .webexRoomKitPlusRegular: return "\u{f86b}"
        case .webexRoomKitRegular: return "\u{f86c}"
        case .webexShareBold: return "\u{f86d}"
        case .webexShareLight: return "\u{f86e}"
        case .webexShareRegular: return "\u{f86f}"
        case .webexTeamsBold: return "\u{f870}"
        case .webexTeamsFilled: return "\u{f871}"
        case .webexTeamsLight: return "\u{f872}"
        case .webexTeamsNewBold: return "\u{f873}"
        case .webexTeamsNewFilled: return "\u{f874}"
        case .webexTeamsNewLight: return "\u{f875}"
        case .webexTeamsNewRegular: return "\u{f876}"
        case .webexTeamsRegular: return "\u{f877}"
        case .whiteboardBold: return "\u{f878}"
        case .whiteboardContentBold: return "\u{f879}"
        case .whiteboardContentLight: return "\u{f87a}"
        case .whiteboardContentRegular: return "\u{f87b}"
        case .whiteboardFilled: return "\u{f87c}"
        case .whiteboardLight: return "\u{f87d}"
        case .whiteboardRegular: return "\u{f87e}"
        case .wifiBold: return "\u{f87f}"
        case .wifiErrorBold: return "\u{f880}"
        case .wifiErrorLight: return "\u{f881}"
        case .wifiErrorRegular: return "\u{f882}"
        case .wifiLight: return "\u{f883}"
        case .wifiRegular: return "\u{f884}"
        case .windowCornerScrubBold: return "\u{f885}"
        case .windowCornerScrubLight: return "\u{f886}"
        case .windowCornerScrubRegular: return "\u{f887}"
        case .windowVerticalScrubBold: return "\u{f888}"
        case .windowVerticalScrubLight: return "\u{f889}"
        case .windowVerticalScrubRegular: return "\u{f88a}"
        case .workphoneBold: return "\u{f88b}"
        case .workphoneLight: return "\u{f88c}"
        case .workphoneRegular: return "\u{f88d}"
        case .zoomInBold: return "\u{f88e}"
        case .zoomInLight: return "\u{f88f}"
        case .zoomInRegular: return "\u{f890}"
        case .zoomOutBold: return "\u{f891}"
        case .zoomOutLight: return "\u{f892}"
        case .zoomOutRegular: return "\u{f893}"
