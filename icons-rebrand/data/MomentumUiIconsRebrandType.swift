...
@objc public enum MomentumIconsRebrandType: Int {
    ...
    public var ligature: String {
        ...
        case .likeBold: return "\u{f613}"
        case .likeFilled: return "\u{f614}"
        case .likeLight: return "\u{f615}"
        case .likeRegular: return "\u{f616}"
        case .linkBold: return "\u{f617}"
        case .linkLight: return "\u{f618}"
        case .linkRegular: return "\u{f619}"
        case .listBulletedBold: return "\u{f61a}"
        case .listBulletedLight: return "\u{f61b}"
        case .listBulletedRegular: return "\u{f61c}"
        case .listMenuBold: return "\u{f61d}"
        case .listMenuLight: return "\u{f61e}"
        case .listMenuRegular: return "\u{f61f}"
        case .listNumberedBold: return "\u{f620}"
        case .listNumberedLight: return "\u{f621}"
        case .listNumberedRegular: return "\u{f622}"
        case .locationBold: return "\u{f623}"
        case .locationFilled: return "\u{f624}"
        case .locationLight: return "\u{f625}"
        case .locationRegular: return "\u{f626}"
        case .longTextBoxBold: return "\u{f627}"
        case .longTextBoxLight: return "\u{f628}"
        case .longTextBoxRegular: return "\u{f629}"
        case .lowerHandBold: return "\u{f62a}"
        case .lowerHandLight: return "\u{f62b}"
        case .lowerHandRegular: return "\u{f62c}"
        case .magicPenBold: return "\u{f62d}"
        case .magicPenFilled: return "\u{f62e}"
        case .magicPenLight: return "\u{f62f}"
        case .magicPenRegular: return "\u{f630}"
        case .markAsUnreadBold: return "\u{f631}"
        case .markAsUnreadLight: return "\u{f632}"
        case .markAsUnreadRegular: return "\u{f633}"
        case .markdownBold: return "\u{f634}"
        case .markdownLight: return "\u{f635}"
        case .markdownRegular: return "\u{f636}"
        case .markerBold: return "\u{f637}"
        case .markerFilled: return "\u{f638}"
        case .markerLight: return "\u{f639}"
        case .markerRegular: return "\u{f63a}"
        case .maximizeBold: return "\u{f63b}"
        case .maximizeLight: return "\u{f63c}"
        case .maximizeRegular: return "\u{f63d}"
        case .mediaPlayerBold: return "\u{f63e}"
        case .mediaPlayerLight: return "\u{f63f}"
        case .mediaPlayerRegular: return "\u{f640}"
        case .mediaQualityGoodBold: return "\u{f641}"
        case .mediaQualityGoodFilled: return "\u{f642}"
        case .mediaQualityGoodLight: return "\u{f643}"
        case .mediaQualityGoodRegular: return "\u{f644}"
        case .mediaQualityPoorBold: return "\u{f645}"
        case .mediaQualityPoorFilled: return "\u{f646}"
        case .mediaQualityPoorLight: return "\u{f647}"
        case .mediaQualityPoorRegular: return "\u{f648}"
        case .mediaQualityUnstableBold: return "\u{f649}"
        case .mediaQualityUnstableFilled: return "\u{f64a}"
        case .mediaQualityUnstableLight: return "\u{f64b}"
        case .mediaQualityUnstableRegular: return "\u{f64c}"
        case .mediumQualityGoodFilled: return "\u{f64d}"
        case .mediumQualityPoorFilled: return "\u{f64e}"
        case .mediumQualityUnstableFilled: return "\u{f64f}"
        case .meetBold: return "\u{f650}"
        case .meetEndBold: return "\u{f651}"
        case .meetEndLight: return "\u{f652}"
        case .meetEndRegular: return "\u{f653}"
        case .meetFilled: return "\u{f654}"
        case .meetLight: return "\u{f655}"
        case .meetRegular: return "\u{f656}"
        case .meetingsBold: return "\u{f657}"
        case .meetingsFilled: return "\u{f658}"
        case .meetingsFocusMonthBold: return "\u{f659}"
        case .meetingsFocusMonthLight: return "\u{f65a}"
        case .meetingsFocusMonthRegular: return "\u{f65b}"
        case .meetingsFocusOneDayBold: return "\u{f65c}"
        case .meetingsFocusOneDayLight: return "\u{f65d}"
        case .meetingsFocusOneDayRegular: return "\u{f65e}"
        case .meetingsFocusThreeDayBold: return "\u{f65f}"
        case .meetingsFocusThreeDayLight: return "\u{f660}"
        case .meetingsFocusThreeDayRegular: return "\u{f661}"
        case .meetingsFocusUpcomingBold: return "\u{f662}"
        case .meetingsFocusUpcomingLight: return "\u{f663}"
        case .meetingsFocusUpcomingRegular: return "\u{f664}"
        case .meetingsFocusWeekBold: return "\u{f665}"
        case .meetingsFocusWeekLight: return "\u{f666}"
        case .meetingsFocusWeekRegular: return "\u{f667}"
        case .meetingsLight: return "\u{f668}"
        case .meetingsPresenceBold: return "\u{f669}"
        case .meetingsPresenceFilled: return "\u{f66a}"
        case .meetingsPresenceLight: return "\u{f66b}"
        case .meetingsPresenceRegular: return "\u{f66c}"
        case .meetingsPresenceSmallFilled: return "\u{f66d}"
        case .meetingsRegular: return "\u{f66e}"
        case .meetingsTeamActiveBold: return "\u{f66f}"
        case .meetingsTeamActiveLight: return "\u{f670}"
        case .meetingsTeamActiveRegular: return "\u{f671}"
        case .meetingsTeamBold: return "\u{f672}"
        case .meetingsTeamLight: return "\u{f673}"
        case .meetingsTeamNewBold: return "\u{f674}"
        case .meetingsTeamNewLight: return "\u{f675}"
        case .meetingsTeamNewRegular: return "\u{f676}"
        case .meetingsTeamRegular: return "\u{f677}"
        case .mentionBold: return "\u{f678}"
        case .mentionLight: return "\u{f679}"
        case .mentionRegular: return "\u{f67a}"
        case .messageQueingBold: return "\u{f67b}"
        case .messageQueingLight: return "\u{f67c}"
        case .messageQueingRegular: return "\u{f67d}"
        case .microphoneBold: return "\u{f67e}"
        case .microphoneFilled: return "\u{f67f}"
        case .microphoneHardMutedBold: return "\u{f680}"
        case .microphoneHardMutedColoredBold: return "\u{f681}"
        case .microphoneHardMutedColoredLight: return "\u{f682}"
        case .microphoneHardMutedColoredRegular: return "\u{f683}"
        case .microphoneHardMutedLight: return "\u{f684}"
        case .microphoneHardMutedRegular: return "\u{f685}"
        case .microphoneLight: return "\u{f686}"
        case .microphoneMusicModeColoredBold: return "\u{f687}"
        case .microphoneMusicModeColoredLight: return "\u{f688}"
        case .microphoneMusicModeColoredRegular: return "\u{f689}"
        case .microphoneMutedBold: return "\u{f68a}"
        case .microphoneMutedFilled: return "\u{f68b}"
        case .microphoneMutedIndicatorFilled: return "\u{f68c}"
        case .microphoneMutedLight: return "\u{f68d}"
        case .microphoneMutedRedBold: return "\u{f68e}"
        case .microphoneMutedRedFilled: return "\u{f68f}"
        case .microphoneMutedRedLight: return "\u{f690}"
        case .microphoneMutedRedRegular: return "\u{f691}"
        case .microphoneMutedRegular: return "\u{f692}"
        case .microphoneRegular: return "\u{f693}"
        case .minimizeBold: return "\u{f694}"
        case .minimizeLight: return "\u{f695}"
        case .minimizeRegular: return "\u{f696}"
        case .minusBold: return "\u{f697}"
        case .minusLight: return "\u{f698}"
        case .minusRegular: return "\u{f699}"
        case .mirrorBold: return "\u{f69a}"
        case .mirrorFilled: return "\u{f69b}"
        case .mirrorLight: return "\u{f69c}"
        case .mirrorRegular: return "\u{f69d}"
        case .moderatorBold: return "\u{f69e}"
        case .moderatorLight: return "\u{f69f}"
        case .moderatorRegular: return "\u{f6a0}"
        case .monitoringBold: return "\u{f6a1}"
        case .monitoringLight: return "\u{f6a2}"
        case .monitoringRegular: return "\u{f6a3}"
        case .monthlyRecurringScheduleNodeBold: return "\u{f6a4}"
        case .monthlyRecurringScheduleNodeLight: return "\u{f6a5}"
        case .monthlyRecurringScheduleNodeRegular: return "\u{f6a6}"
        case .moreAdrBold: return "\u{f6a7}"
        case .moreAdrLight: return "\u{f6a8}"
        case .moreAdrRegular: return "\u{f6a9}"
        case .moreBold: return "\u{f6aa}"
        case .moreCircleBold: return "\u{f6ab}"
        case .moreCircleFilled: return "\u{f6ac}"
        case .moreCircleLight: return "\u{f6ad}"
        case .moreCircleRegular: return "\u{f6ae}"
        case .moreCirecleFilled: return "\u{f6af}"
        case .moreLight: return "\u{f6b0}"
        case .moreRegular: return "\u{f6b1}"
        case .mouseCursorBold: return "\u{f6b2}"
        case .mouseCursorLight: return "\u{f6b3}"
        case .mouseCursorRegular: return "\u{f6b4}"
        case .moveCallInAdrBold: return "\u{f6b5}"
        case .moveCallInAdrLight: return "\u{f6b6}"
        case .moveCallInAdrRegular: return "\u{f6b7}"
        case .moveCallInIphBold: return "\u{f6b8}"
        case .moveCallInIphLight: return "\u{f6b9}"
        case .moveCallInIphRegular: return "\u{f6ba}"
        case .moveCallInLaptopBold: return "\u{f6bb}"
        case .moveCallInLaptopLight: return "\u{f6bc}"
        case .moveCallInLaptopRegular: return "\u{f6bd}"
        case .moveCallInOutAdrBold: return "\u{f6be}"
        case .moveCallInOutAdrLight: return "\u{f6bf}"
        case .moveCallInOutAdrRegular: return "\u{f6c0}"
        case .moveCallInOutIphBold: return "\u{f6c1}"
        case .moveCallInOutIphLight: return "\u{f6c2}"
        case .moveCallInOutIphRegular: return "\u{f6c3}"
        case .moveCallInTabletBold: return "\u{f6c4}"
        case .moveCallInTabletLight: return "\u{f6c5}"
        case .moveCallInTabletRegular: return "\u{f6c6}"
        case .moveCallOutAdrBold: return "\u{f6c7}"
        case .moveCallOutAdrLight: return "\u{f6c8}"
        case .moveCallOutAdrRegular: return "\u{f6c9}"
        case .moveCallOutIphBold: return "\u{f6ca}"
        case .moveCallOutIphLight: return "\u{f6cb}"
        case .moveCallOutIphRegular: return "\u{f6cc}"
        case .moveCallOutLaptopBold: return "\u{f6cd}"
        case .moveCallOutLaptopLight: return "\u{f6ce}"
        case .moveCallOutLaptopRegular: return "\u{f6cf}"
        case .moveCallOutTabletBold: return "\u{f6d0}"
        case .moveCallOutTabletLight: return "\u{f6d1}"
        case .moveCallOutTabletRegular: return "\u{f6d2}"
        case .msTeams: return "\u{f6d3}"
        case .multilineChartBold: return "\u{f6d4}"
        case .multilineChartFilled: return "\u{f6d5}"
        case .multilineChartLight: return "\u{f6d6}"
        case .multilineChartRegular: return "\u{f6d7}"
        case .multimediaBold: return "\u{f6d8}"
        case .multimediaFilled: return "\u{f6d9}"
        case .multimediaLight: return "\u{f6da}"
        case .multimediaRegular: return "\u{f6db}"
        case .multipledDevicesBold: return "\u{f6dc}"
        case .multipledDevicesLight: return "\u{f6dd}"
        case .multipledDevicesRegular: return "\u{f6de}"
        case .musicModeBold: return "\u{f6df}"
        case .musicModeCircleBold: return "\u{f6e0}"
        case .musicModeCircleFilled: return "\u{f6e1}"
        case .musicModeCircleLight: return "\u{f6e2}"
        case .musicModeCircleRegular: return "\u{f6e3}"
        case .musicModeFilled: return "\u{f6e4}"
        case .musicModeLight: return "\u{f6e5}"
        case .musicModeRegular: return "\u{f6e6}"
        case .muteOnEntryBold: return "\u{f6e7}"
        case .muteOnEntryFilled: return "\u{f6e8}"
        case .muteOnEntryLight: return "\u{f6e9}"
        case .muteOnEntryRegular: return "\u{f6ea}"
        case .newManagerBold: return "\u{f6eb}"
        case .newManagerLight: return "\u{f6ec}"
        case .newManagerRegular: return "\u{f6ed}"
        case .newTitleBold: return "\u{f6ee}"
        case .newTitleLight: return "\u{f6ef}"
        case .newTitleRegular: return "\u{f6f0}"
        case .newVoicemailBold: return "\u{f6f1}"
        case .newVoicemailLight: return "\u{f6f2}"
        case .newVoicemailRegular: return "\u{f6f3}"
        case .newWhiteboardBold: return "\u{f6f4}"
        case .newWhiteboardLight: return "\u{f6f5}"
        case .newWhiteboardRegular: return "\u{f6f6}"
        case .nextBold: return "\u{f6f7}"
        case .nextLight: return "\u{f6f8}"
        case .nextRegular: return "\u{f6f9}"
        case .noDevicesBold: return "\u{f6fa}"
        case .noDevicesLight: return "\u{f6fb}"
        case .noDevicesRegular: return "\u{f6fc}"
        case .noiseDetectedCanceledFilled: return "\u{f6fd}"
        case .noiseDetectedFilled: return "\u{f6fe}"
        case .noiseNoneCanceledFilled: return "\u{f6ff}"
        case .noiseNoneFilled: return "\u{f700}"
        case .noiseRemovalBold: return "\u{f701}"
        case .noiseRemovalLight: return "\u{f702}"
        case .noiseRemovalRegular: return "\u{f703}"
        case .noteBold: return "\u{f704}"
        case .noteLight: return "\u{f705}"
        case .notePptBold: return "\u{f706}"
        case .notePptLight: return "\u{f707}"
        case .notePptRegular: return "\u{f708}"
        case .noteRegular: return "\u{f709}"
        case .notesBold: return "\u{f70a}"
        case .notesLight: return "\u{f70b}"
        case .notesRegular: return "\u{f70c}"
        case .numberBold: return "\u{f70d}"
        case .numberLight: return "\u{f70e}"
        case .numberRegular: return "\u{f70f}"
        case .oldRemoteBold: return "\u{f710}"
        case .oldRemoteLight: return "\u{f711}"
        case .oldRemoteRegular: return "\u{f712}"
        case .oldTouchBold: return "\u{f713}"
        case .oldTouchLight: return "\u{f714}"
        case .oldTouchRegular: return "\u{f715}"
        case .oneColumnBold: return "\u{f716}"
        case .oneColumnLight: return "\u{f717}"
        case .oneColumnRegular: return "\u{f718}"
        case .openInFolderBold: return "\u{f719}"
        case .openInFolderLight: return "\u{f71a}"
        case .openInFolderRegular: return "\u{f71b}"
        case .openPagesBold: return "\u{f71c}"
        case .openPagesLight: return "\u{f71d}"
        case .openPagesRegular: return "\u{f71e}"
        case .otherNumberBold: return "\u{f71f}"
        case .otherNumberLight: return "\u{f720}"
        case .otherNumberRegular: return "\u{f721}"
        case .otherNumberWarningBold: return "\u{f722}"
        case .otherNumberWarningLight: return "\u{f723}"
        case .otherNumberWarningRegular: return "\u{f724}"
        case .outgoingCallLegacyBold: return "\u{f725}"
        case .outgoingCallLegacyLight: return "\u{f726}"
        case .outgoingCallLegacyRegular: return "\u{f727}"
        case .overflowLeftBold: return "\u{f728}"
        case .overflowLeftLight: return "\u{f729}"
        case .overflowLeftRegular: return "\u{f72a}"
        case .overflowRightBold: return "\u{f72b}"
        case .overflowRightLight: return "\u{f72c}"
        case .overflowRightRegular: return "\u{f72d}"
        case .pairedCameraBold: return "\u{f72e}"
        case .pairedCameraLight: return "\u{f72f}"
        case .pairedCameraRegular: return "\u{f730}"
        case .pairedDeviceBold: return "\u{f731}"
        case .pairedDeviceLight: return "\u{f732}"
        case .pairedDeviceRegular: return "\u{f733}"
        case .pairedHandsetBold: return "\u{f734}"
        case .pairedHandsetLight: return "\u{f735}"
        case .pairedHandsetRegular: return "\u{f736}"
        case .pairingBold: return "\u{f737}"
        case .pairingLight: return "\u{f738}"
        case .pairingRegular: return "\u{f739}"
        case .parkedBold: return "\u{f73a}"
        case .parkedFilled: return "\u{f73b}"
        case .parkedLight: return "\u{f73c}"
        case .parkedRegular: return "\u{f73d}"
        case .parseBold: return "\u{f73e}"
        case .parseLight: return "\u{f73f}"
        case .parseRegular: return "\u{f740}"
        case .partialBold: return "\u{f741}"
        case .partialLight: return "\u{f742}"
        case .partialRegular: return "\u{f743}"
        case .participantAddBold: return "\u{f744}"
        case .participantAddLight: return "\u{f745}"
        case .participantAddRegular: return "\u{f746}"
        case .participantBlockedBold: return "\u{f747}"
        case .participantBlockedLight: return "\u{f748}"
        case .participantBlockedRegular: return "\u{f749}"
        case .participantBold: return "\u{f74a}"
        case .participantFilled: return "\u{f74b}"
        case .participantLight: return "\u{f74c}"
        case .participantListBold: return "\u{f74d}"
        case .participantListFilled: return "\u{f74e}"
        case .participantListLight: return "\u{f74f}"
        case .participantListRegular: return "\u{f750}"
        case .participantRegular: return "\u{f751}"
        case .participantRemoveBold: return "\u{f752}"
        case .participantRemoveLight: return "\u{f753}"
        case .participantRemoveRegular: return "\u{f754}"
        case .participantUnknownBold: return "\u{f755}"
        case .participantUnknownLight: return "\u{f756}"
        case .participantUnknownRegular: return "\u{f757}"
        case .passMouseBold: return "\u{f758}"
        case .passMouseLight: return "\u{f759}"
        case .passMouseRegular: return "\u{f75a}"
        case .pauseBold: return "\u{f75b}"
        case .pauseFilled: return "\u{f75c}"
        case .pauseLight: return "\u{f75d}"
        case .pauseRegular: return "\u{f75e}"
        case .penBold: return "\u{f75f}"
        case .penFilled: return "\u{f760}"
        case .penLight: return "\u{f761}"
        case .penRegular: return "\u{f762}"
        case .peopleBold: return "\u{f763}"
        case .peopleCircleBold: return "\u{f764}"
        case .peopleCircleFilled: return "\u{f765}"
        case .peopleCircleLight: return "\u{f766}"
        case .peopleCircleRegular: return "\u{f767}"
        case .peopleFilled: return "\u{f768}"
        case .peopleInsightsFilled: return "\u{f769}"
        case .peopleLight: return "\u{f76a}"
        case .peopleRegular: return "\u{f76b}"
        case .phoneAlertBold: return "\u{f76c}"
        case .phoneAlertLight: return "\u{f76d}"
        case .phoneAlertRegular: return "\u{f76e}"
        case .phoneBold: return "\u{f76f}"
        case .phoneFilled: return "\u{f770}"
        case .phoneLight: return "\u{f771}"
        case .phoneMutedBold: return "\u{f772}"
        case .phoneMutedLight: return "\u{f773}"
        case .phoneMutedRegular: return "\u{f774}"
        case .phonePrivateBold: return "\u{f775}"
        case .phonePrivateLight: return "\u{f776}"
        case .phonePrivateRegular: return "\u{f777}"
        case .phoneRegular: return "\u{f778}"
        case .phoneReplyAllBold: return "\u{f779}"
        case .phoneReplyAllLight: return "\u{f77a}"
        case .phoneReplyAllRegular: return "\u{f77b}"
        case .phoneReplyBold: return "\u{f77c}"
        case .phoneReplyLight: return "\u{f77d}"
        case .phoneReplyRegular: return "\u{f77e}"
        case .phoneSmallFilled: return "\u{f77f}"
        case .pickerBold: return "\u{f780}"
        case .pickerLight: return "\u{f781}"
        case .pickerRegular: return "\u{f782}"
        case .pictureInPictureBold: return "\u{f783}"
        case .pictureInPictureFilled: return "\u{f784}"
        case .pictureInPictureLight: return "\u{f785}"
        case .pictureInPictureRegular: return "\u{f786}"
        case .pieChartBold: return "\u{f787}"
        case .pieChartFilled: return "\u{f788}"
        case .pieChartLight: return "\u{f789}"
        case .pieChartRegular: return "\u{f78a}"
        case .pinBold: return "\u{f78b}"
        case .pinFilled: return "\u{f78c}"
        case .pinLight: return "\u{f78d}"
        case .pinListActivityBold: return "\u{f78e}"
        case .pinListActivityColoredBold: return "\u{f78f}"
        case .pinListActivityColoredLight: return "\u{f790}"
        case .pinListActivityColoredRegular: return "\u{f791}"
        case .pinListActivityLight: return "\u{f792}"
        case .pinListActivityRegular: return "\u{f793}"
        case .pinListBold: return "\u{f794}"
        case .pinListLight: return "\u{f795}"
        case .pinListRegular: return "\u{f796}"
        case .pinMutedBold: return "\u{f797}"
        case .pinMutedFilled: return "\u{f798}"
        case .pinMutedLight: return "\u{f799}"
        case .pinMutedRegular: return "\u{f79a}"
        case .pinRegular: return "\u{f79b}"
        case .placeholderBold: return "\u{f79c}"
        case .placeholderLight: return "\u{f79d}"
        case .placeholderRegular: return "\u{f79e}"
        case .playBold: return "\u{f79f}"
        case .playCircleBold: return "\u{f7a0}"
        case .playCircleFilled: return "\u{f7a1}"
        case .playCircleLight: return "\u{f7a2}"
        case .playCircleRegular: return "\u{f7a3}"
        case .playFilled: return "\u{f7a4}"
        case .playLight: return "\u{f7a5}"
        case .playRegular: return "\u{f7a6}"
        case .plugAcBold: return "\u{f7a7}"
        case .plugAcLight: return "\u{f7a8}"
        case .plugAcRegular: return "\u{f7a9}"
        case .plusBold: return "\u{f7aa}"
        case .plusCircleBold: return "\u{f7ab}"
        case .plusCircleFilled: return "\u{f7ac}"
        case .plusCircleLight: return "\u{f7ad}"
        case .plusCircleRegular: return "\u{f7ae}"
        case .plusLight: return "\u{f7af}"
        case .plusRegular: return "\u{f7b0}"
        case .pmrBold: return "\u{f7b1}"
        case .pmrFilled: return "\u{f7b2}"
        case .pmrLight: return "\u{f7b3}"
        case .pmrRegular: return "\u{f7b4}"
        case .pollBold: return "\u{f7b5}"
        case .pollLight: return "\u{f7b6}"
        case .pollRegular: return "\u{f7b7}"
        case .popInBold: return "\u{f7b8}"
        case .popInLight: return "\u{f7b9}"
        case .popInRegular: return "\u{f7ba}"
        case .popOutBold: return "\u{f7bb}"
        case .popOutLight: return "\u{f7bc}"
        case .popOutRegular: return "\u{f7bd}"
        case .popUpBold: return "\u{f7be}"
        case .popUpLight: return "\u{f7bf}"
        case .popUpRegular: return "\u{f7c0}"
        case .portraitLandscapeBold: return "\u{f7c1}"
        case .portraitLandscapeLight: return "\u{f7c2}"
        case .portraitLandscapeRegular: return "\u{f7c3}"
        case .powerAcBold: return "\u{f7c4}"
        case .powerAcLight: return "\u{f7c5}"
        case .powerAcRegular: return "\u{f7c6}"
        case .powerBold: return "\u{f7c7}"
        case .powerLight: return "\u{f7c8}"
        case .powerRegular: return "\u{f7c9}"
        case .preHeaderBold: return "\u{f7ca}"
        case .preHeaderLight: return "\u{f7cb}"
        case .preHeaderRegular: return "\u{f7cc}"
        case .presentationBold: return "\u{f7cd}"
        case .presentationLight: return "\u{f7ce}"
        case .presentationRegular: return "\u{f7cf}"
        case .primaryParticipantBold: return "\u{f7d0}"
        case .primaryParticipantLight: return "\u{f7d1}"
        case .primaryParticipantRegular: return "\u{f7d2}"
        case .printBold: return "\u{f7d3}"
        case .printLight: return "\u{f7d4}"
        case .printRegular: return "\u{f7d5}"
        case .priorityBadgeFilled: return "\u{f7d6}"
        case .priorityCircleBold: return "\u{f7d7}"
        case .priorityCircleFilled: return "\u{f7d8}"
        case .priorityCircleLight: return "\u{f7d9}"
        case .priorityCircleRegular: return "\u{f7da}"
        case .priorityCircleTwoBold: return "\u{f7db}"
        case .priorityCircleTwoFilled: return "\u{f7dc}"
        case .priorityCircleTwoLight: return "\u{f7dd}"
        case .priorityCircleTwoRegular: return "\u{f7de}"
        case .privacyCircleBold: return "\u{f7df}"
        case .privacyCircleFilled: return "\u{f7e0}"
        case .privacyCircleLight: return "\u{f7e1}"
        case .privacyCircleRegular: return "\u{f7e2}"
        case .privateBold: return "\u{f7e3}"
        case .privateCircleBold: return "\u{f7e4}"
        case .privateCircleFilled: return "\u{f7e5}"
        case .privateCircleLight: return "\u{f7e6}"
        case .privateCircleRegular: return "\u{f7e7}"
        case .privateLight: return "\u{f7e8}"
        case .privateMeetingBold: return "\u{f7e9}"
        case .privateMeetingLight: return "\u{f7ea}"
        case .privateMeetingRegular: return "\u{f7eb}"
        case .privateRegular: return "\u{f7ec}"
        case .productDemoBold: return "\u{f7ed}"
        case .productDemoLight: return "\u{f7ee}"
        case .productDemoRegular: return "\u{f7ef}"
        case .proximityBold: return "\u{f7f0}"
        case .proximityLight: return "\u{f7f1}"
        case .proximityMutedBold: return "\u{f7f2}"
        case .proximityMutedLight: return "\u{f7f3}"
        case .proximityMutedRegular: return "\u{f7f4}"
        case .proximityRegular: return "\u{f7f5}"
        case .proximityVideoBold: return "\u{f7f6}"
        case .proximityVideoLight: return "\u{f7f7}"
        case .proximityVideoRegular: return "\u{f7f8}"
        case .ptoPresenceBold: return "\u{f7f9}"
        case .ptoPresenceFilled: return "\u{f7fa}"
        case .ptoPresenceLight: return "\u{f7fb}"
        case .ptoPresenceRegular: return "\u{f7fc}"
        case .pullCallBold: return "\u{f7fd}"
        case .pullCallLight: return "\u{f7fe}"
        case .pullCallRegular: return "\u{f7ff}"
        case .qABold: return "\u{f800}"
        case .qALight: return "\u{f801}"
        case .qARegular: return "\u{f802}"
        case .qualityBold: return "\u{f803}"
        case .qualityLight: return "\u{f804}"
        case .qualityRegular: return "\u{f805}"
        case .queueContactBold: return "\u{f806}"
        case .queueContactLight: return "\u{f807}"
        case .queueContactRegular: return "\u{f808}"
        case .quietBold: return "\u{f809}"
        case .quietHoursPresenceBold: return "\u{f80a}"
        case .quietHoursPresenceFilled: return "\u{f80b}"
        case .quietHoursPresenceLight: return "\u{f80c}"
        case .quietHoursPresenceRegular: return "\u{f80d}"
        case .quietLight: return "\u{f80e}"
        case .quietRegular: return "\u{f80f}"
        case .radioButtonGroupBold: return "\u{f810}"
        case .radioButtonGroupLight: return "\u{f811}"
        case .radioButtonGroupRegular: return "\u{f812}"
        case .raiseHandBold: return "\u{f813}"
        case .raiseHandFilled: return "\u{f814}"
        case .raiseHandLight: return "\u{f815}"
        case .raiseHandRegular: return "\u{f816}"
        case .ramBold: return "\u{f817}"
        case .ramLight: return "\u{f818}"
        case .ramRegular: return "\u{f819}"
        case .reactionsBold: return "\u{f81a}"
        case .reactionsFilled: return "\u{f81b}"
        case .reactionsLight: return "\u{f81c}"
        case .reactionsRegular: return "\u{f81d}"
        case .reactivateBold: return "\u{f81e}"
        case .reactivateLight: return "\u{f81f}"
        case .reactivateRegular: return "\u{f820}"
        case .recentsBold: return "\u{f821}"
        case .recentsFilled: return "\u{f822}"
        case .recentsLight: return "\u{f823}"
        case .recentsPresenceBold: return "\u{f824}"
        case .recentsPresenceFilled: return "\u{f825}"
        case .recentsPresenceLight: return "\u{f826}"
        case .recentsPresenceRegular: return "\u{f827}"
        case .recentsPresenceSmallFilled: return "\u{f828}"
        case .recentsRegular: return "\u{f829}"
        case .recordActiveBold: return "\u{f82a}"
        case .recordActiveFilled: return "\u{f82b}"
        case .recordActiveLight: return "\u{f82c}"
        case .recordActiveRegular: return "\u{f82d}"
        case .recordBold: return "\u{f82e}"
        case .recordFilled: return "\u{f82f}"
        case .recordLight: return "\u{f830}"
        case .recordPausedBold: return "\u{f831}"
        case .recordPausedFilled: return "\u{f832}"
        case .recordPausedLight: return "\u{f833}"
        case .recordPausedRegular: return "\u{f834}"
        case .recordRegular: return "\u{f835}"
        case .recurringBold: return "\u{f836}"
        case .recurringLight: return "\u{f837}"
        case .recurringOffBold: return "\u{f838}"
        case .recurringOffLight: return "\u{f839}"
        case .recurringOffRegular: return "\u{f83a}"
        case .recurringRegular: return "\u{f83b}"
        case .redialBold: return "\u{f83c}"
        case .redialLight: return "\u{f83d}"
        case .redialRegular: return "\u{f83e}"
        case .redoBold: return "\u{f83f}"
        case .redoLight: return "\u{f840}"
        case .redoRegular: return "\u{f841}"
        case .refreshBold: return "\u{f842}"
        case .refreshLight: return "\u{f843}"
        case .refreshRegular: return "\u{f844}"
        case .remoteCallBold: return "\u{f845}"
        case .remoteCallFilled: return "\u{f846}"
        case .remoteCallLight: return "\u{f847}"
        case .remoteCallRegular: return "\u{f848}"
        case .remoteDesktopControlBold: return "\u{f849}"
        case .remoteDesktopControlFilled: return "\u{f84a}"
        case .remoteDesktopControlLight: return "\u{f84b}"
        case .remoteDesktopControlRegular: return "\u{f84c}"
        case .removeBold: return "\u{f84d}"
        case .removeFilled: return "\u{f84e}"
        case .removeLight: return "\u{f84f}"
        case .removeRegular: return "\u{f850}"
        case .replyBold: return "\u{f851}"
        case .replyFilled: return "\u{f852}"
        case .replyLight: return "\u{f853}"
        case .replyListBold: return "\u{f854}"
        case .replyListLight: return "\u{f855}"
        case .replyListRegular: return "\u{f856}"
        case .replyPrivatelyBold: return "\u{f857}"
        case .replyPrivatelyLight: return "\u{f858}"
        case .replyPrivatelyRegular: return "\u{f859}"
        case .replyRegular: return "\u{f85a}"
        case .resetBold: return "\u{f85b}"
        case .resetLight: return "\u{f85c}"
        case .resetRegular: return "\u{f85d}"
        case .responsiveMobileBold: return "\u{f85e}"
        case .responsiveMobileLight: return "\u{f85f}"
        case .responsiveMobileRegular: return "\u{f860}"
        case .restartBold: return "\u{f861}"
        case .restartLight: return "\u{f862}"
        case .restartRegular: return "\u{f863}"
        case .retrieveCallBold: return "\u{f864}"
        case .retrieveCallLight: return "\u{f865}"
        case .retrieveCallRegular: return "\u{f866}"
        case .returnBold: return "\u{f867}"
        case .returnLight: return "\u{f868}"
        case .returnRegular: return "\u{f869}"
        case .ringtoneBold: return "\u{f86a}"
        case .ringtoneLight: return "\u{f86b}"
        case .ringtoneRegular: return "\u{f86c}"
        case .roomCalendarBold: return "\u{f86d}"
        case .roomCalendarLight: return "\u{f86e}"
        case .roomCalendarRegular: return "\u{f86f}"
        case .roomLightsBold: return "\u{f870}"
        case .roomLightsFilled: return "\u{f871}"
        case .roomLightsLight: return "\u{f872}"
        case .roomLightsRegular: return "\u{f873}"
        case .rotateContentBold: return "\u{f874}"
        case .rotateContentFilled: return "\u{f875}"
        case .rotateContentLight: return "\u{f876}"
        case .rotateContentRegular: return "\u{f877}"
        case .ruleBasedBold: return "\u{f878}"
        case .ruleBasedLight: return "\u{f879}"
        case .ruleBasedRegular: return "\u{f87a}"
        case .runningApplicationBold: return "\u{f87b}"
        case .runningApplicationFilled: return "\u{f87c}"
        case .runningApplicationLight: return "\u{f87d}"
        case .runningApplicationRegular: return "\u{f87e}"
        case .saveBold: return "\u{f87f}"
        case .saveLight: return "\u{f880}"
        case .saveRegular: return "\u{f881}"
        case .scanBold: return "\u{f882}"
        case .scanLight: return "\u{f883}"
        case .scanRegular: return "\u{f884}"
        case .schedulerAvailableBold: return "\u{f885}"
        case .schedulerAvailableLight: return "\u{f886}"
        case .schedulerAvailableRegular: return "\u{f887}"
        case .schedulerNotWorkingHoursBold: return "\u{f888}"
        case .schedulerNotWorkingHoursLight: return "\u{f889}"
        case .schedulerNotWorkingHoursRegular: return "\u{f88a}"
        case .schedulerUnavailableBold: return "\u{f88b}"
        case .schedulerUnavailableLight: return "\u{f88c}"
        case .schedulerUnavailableRegular: return "\u{f88d}"
        case .schedulerUnknownBold: return "\u{f88e}"
        case .schedulerUnknownLight: return "\u{f88f}"
        case .schedulerUnknownRegular: return "\u{f890}"
        case .screenshotBold: return "\u{f891}"
        case .screenshotDocBold: return "\u{f892}"
        case .screenshotDocFilled: return "\u{f893}"
        case .screenshotDocLight: return "\u{f894}"
        case .screenshotDocRegular: return "\u{f895}"
        case .screenshotLight: return "\u{f896}"
        case .screenshotRegular: return "\u{f897}"
        case .searchBold: return "\u{f898}"
        case .searchFilled: return "\u{f899}"
        case .searchLight: return "\u{f89a}"
        case .searchRegular: return "\u{f89b}"
        case .secondaryArrowBold: return "\u{f89c}"
        case .secondaryArrowLight: return "\u{f89d}"
        case .secondaryArrowRegular: return "\u{f89e}"
        case .secureCallLockBold: return "\u{f89f}"
        case .secureCallLockFilled: return "\u{f8a0}"
        case .secureCallLockLight: return "\u{f8a1}"
        case .secureCallLockRegular: return "\u{f8a2}"
        case .secureCallShieldBold: return "\u{f8a3}"
        case .secureCallShieldFilled: return "\u{f8a4}"
        case .secureCallShieldLight: return "\u{f8a5}"
        case .secureCallShieldRegular: return "\u{f8a6}"
        case .secureCircleBold: return "\u{f8a7}"
        case .secureCircleFilled: return "\u{f8a8}"
        case .secureCircleLight: return "\u{f8a9}"
        case .secureCircleRegular: return "\u{f8aa}"
        case .secureLockBold: return "\u{f8ab}"
        case .secureLockFilled: return "\u{f8ac}"
        case .secureLockLight: return "\u{f8ad}"
        case .secureLockRegular: return "\u{f8ae}"
        case .selectAllBold: return "\u{f8af}"
        case .selectAllFilled: return "\u{f8b0}"
        case .selectAllLight: return "\u{f8b1}"
        case .selectAllRegular: return "\u{f8b2}"
        case .selectionBold: return "\u{f8b3}"
        case .selectionLight: return "\u{f8b4}"
        case .selectionRegular: return "\u{f8b5}"
        case .sendBold: return "\u{f8b6}"
        case .sendFilled: return "\u{f8b7}"
        case .sendLight: return "\u{f8b8}"
        case .sendRegular: return "\u{f8b9}"
        case .serverBold: return "\u{f8ba}"
        case .serverErrorBold: return "\u{f8bb}"
        case .serverErrorLight: return "\u{f8bc}"
        case .serverErrorRegular: return "\u{f8bd}"
        case .serverLight: return "\u{f8be}"
        case .serverRegular: return "\u{f8bf}"
        case .servicesBold: return "\u{f8c0}"
        case .servicesLight: return "\u{f8c1}"
        case .servicesRegular: return "\u{f8c2}"
        case .setVariableBold: return "\u{f8c3}"
        case .setVariableLight: return "\u{f8c4}"
        case .setVariableRegular: return "\u{f8c5}"
        case .settingsBold: return "\u{f8c6}"
        case .settingsFilled: return "\u{f8c7}"
        case .settingsLight: return "\u{f8c8}"
        case .settingsRegular: return "\u{f8c9}"
        case .setupAssistantBold: return "\u{f8ca}"
        case .setupAssistantLight: return "\u{f8cb}"
        case .setupAssistantRegular: return "\u{f8cc}"
        case .sftpBold: return "\u{f8cd}"
        case .sftpLight: return "\u{f8ce}"
        case .sftpRegular: return "\u{f8cf}"
        case .shapeCircleBold: return "\u{f8d0}"
        case .shapeCircleFilled: return "\u{f8d1}"
        case .shapeCircleLight: return "\u{f8d2}"
        case .shapeCircleRegular: return "\u{f8d3}"
        case .shapeDiagonalLineBold: return "\u{f8d4}"
        case .shapeDiagonalLineLight: return "\u{f8d5}"
        case .shapeDiagonalLineRegular: return "\u{f8d6}"
        case .shapeDiamondBold: return "\u{f8d7}"
        case .shapeDiamondFilled: return "\u{f8d8}"
        case .shapeDiamondLight: return "\u{f8d9}"
        case .shapeDiamondRegular: return "\u{f8da}"
        case .shapeOvalBold: return "\u{f8db}"
        case .shapeOvalLight: return "\u{f8dc}"
        case .shapeOvalRegular: return "\u{f8dd}"
        case .shapeSquareBold: return "\u{f8de}"
        case .shapeSquareFilled: return "\u{f8df}"
        case .shapeSquareLight: return "\u{f8e0}"
        case .shapeSquareRegular: return "\u{f8e1}"
        case .shapeTriangleBold: return "\u{f8e2}"
        case .shapeTriangleFilled: return "\u{f8e3}"
        case .shapeTriangleLight: return "\u{f8e4}"
        case .shapeTriangleRegular: return "\u{f8e5}"
        case .shapesBold: return "\u{f8e6}"
        case .shapesLight: return "\u{f8e7}"
        case .shapesRegular: return "\u{f8e8}"
        case .shareCNativeAdrBold: return "\u{f8e9}"
        case .shareCNativeAdrLight: return "\u{f8ea}"
        case .shareCNativeAdrRegular: return "\u{f8eb}"
        case .shareCNativeIphBold: return "\u{f8ec}"
        case .shareCNativeIphLight: return "\u{f8ed}"
        case .shareCNativeIphRegular: return "\u{f8ee}"
        case .shareScreenBold: return "\u{f8ef}"
        case .shareScreenFilled: return "\u{f8f0}"
        case .shareScreenLight: return "\u{f8f1}"
        case .shareScreenRegular: return "\u{f8f2}"
        case .shareScreenSmallFilled: return "\u{f8f3}"
        case .shareSpaceBold: return "\u{f8f4}"
        case .shareSpaceLight: return "\u{f8f5}"
        case .shareSpaceRegular: return "\u{f8f6}"
        case .shieldBold: return "\u{f8f7}"
        case .shieldLight: return "\u{f8f8}"
        case .shieldRegular: return "\u{f8f9}"
        case .shoppingCartBold: return "\u{f8fa}"
        case .shoppingCartFilled: return "\u{f8fb}"
        case .shoppingCartLight: return "\u{f8fc}"
        case .shoppingCartRegular: return "\u{f8fd}"
        case .shortTextBoxBold: return "\u{f8fe}"
        case .shortTextBoxLight: return "\u{f8ff}"
        case .shortTextBoxRegular: return "\u{f900}"
        case .showBold: return "\u{f901}"
        case .showFilled: return "\u{f902}"
        case .showLight: return "\u{f903}"
        case .showRegular: return "\u{f904}"
        case .signInBold: return "\u{f905}"
        case .signInFilled: return "\u{f906}"
        case .signInForcedBold: return "\u{f907}"
        case .signInForcedLight: return "\u{f908}"
        case .signInForcedRegular: return "\u{f909}"
        case .signInLight: return "\u{f90a}"
        case .signInRegular: return "\u{f90b}"
        case .signOutBold: return "\u{f90c}"
        case .signOutLight: return "\u{f90d}"
        case .signOutRegular: return "\u{f90e}"
        case .signal0Bold: return "\u{f90f}"
        case .signal0Light: return "\u{f910}"
        case .signal0Regular: return "\u{f911}"
        case .signal100Bold: return "\u{f912}"
        case .signal100Light: return "\u{f913}"
        case .signal100Regular: return "\u{f914}"
        case .signal25Bold: return "\u{f915}"
        case .signal25Light: return "\u{f916}"
        case .signal25Regular: return "\u{f917}"
        case .signal50Bold: return "\u{f918}"
        case .signal50Light: return "\u{f919}"
        case .signal50Regular: return "\u{f91a}"
        case .signal75Bold: return "\u{f91b}"
        case .signal75Light: return "\u{f91c}"
        case .signal75Regular: return "\u{f91d}"
        case .simplePromotionBold: return "\u{f91e}"
        case .simplePromotionLight: return "\u{f91f}"
        case .simplePromotionRegular: return "\u{f920}"
        case .singleNumberReachBold: return "\u{f921}"
        case .singleNumberReachLight: return "\u{f922}"
        case .singleNumberReachRegular: return "\u{f923}"
        case .sipRegistrationInProgressBold: return "\u{f924}"
        case .sipRegistrationInProgressFilled: return "\u{f925}"
        case .sipRegistrationInProgressLight: return "\u{f926}"
        case .sipRegistrationInProgressRegular: return "\u{f927}"
        case .skipBold: return "\u{f928}"
        case .skipBwBold: return "\u{f929}"
        case .skipBwFilled: return "\u{f92a}"
        case .skipBwLight: return "\u{f92b}"
        case .skipBwRegular: return "\u{f92c}"
        case .skipFwBold: return "\u{f92d}"
        case .skipFwFilled: return "\u{f92e}"
        case .skipFwLight: return "\u{f92f}"
        case .skipFwRegular: return "\u{f930}"
        case .skipLight: return "\u{f931}"
        case .skipRegular: return "\u{f932}"
        case .smsInboundBold: return "\u{f933}"
        case .smsInboundLight: return "\u{f934}"
        case .smsInboundRegular: return "\u{f935}"
        case .smsMessageBold: return "\u{f936}"
        case .smsMessageFilled: return "\u{f937}"
        case .smsMessageLight: return "\u{f938}"
        case .smsMessageRegular: return "\u{f939}"
        case .socialAlexaFilled: return "\u{f93a}"
        case .socialFacebookColoredFilled: return "\u{f93b}"
        case .socialFacebookFilled: return "\u{f93c}"
        case .socialFbmessengerColoredFilled: return "\u{f93d}"
        case .socialFbmessengerFilled: return "\u{f93e}"
        case .socialInstagramBold: return "\u{f93f}"
        case .socialMicrosoftColoredFilled: return "\u{f940}"
        case .socialMicrosoftFilled: return "\u{f941}"
        case .socialMmsFilled: return "\u{f942}"
        case .socialMmsGoldFilled: return "\u{f943}"
        case .socialSmsFilled: return "\u{f944}"
        case .socialSmsMintFilled: return "\u{f945}"
        case .socialTwitterColoredFilled: return "\u{f946}"
        case .socialTwitterFilled: return "\u{f947}"
        case .socialViberBold: return "\u{f948}"
        case .socialViberColoredBold: return "\u{f949}"
        case .socialWhatsappBold: return "\u{f94a}"
        case .socialWhatsappColoredFilled: return "\u{f94b}"
        case .sortAscendingBold: return "\u{f94c}"
        case .sortAscendingLight: return "\u{f94d}"
        case .sortAscendingRegular: return "\u{f94e}"
        case .sortDescendingBold: return "\u{f94f}"
        case .sortDescendingLight: return "\u{f950}"
        case .sortDescendingRegular: return "\u{f951}"
        case .soundDefaultBold: return "\u{f952}"
        case .soundDefaultLight: return "\u{f953}"
        case .soundDefaultRegular: return "\u{f954}"
        case .speakerBold: return "\u{f955}"
        case .speakerDisconnectedBold: return "\u{f956}"
        case .speakerDisconnectedFilled: return "\u{f957}"
        case .speakerDisconnectedLight: return "\u{f958}"
        case .speakerDisconnectedRegular: return "\u{f959}"
        case .speakerFilled: return "\u{f95a}"
        case .speakerLight: return "\u{f95b}"
        case .speakerMutedBold: return "\u{f95c}"
        case .speakerMutedFilled: return "\u{f95d}"
        case .speakerMutedLight: return "\u{f95e}"
        case .speakerMutedRegular: return "\u{f95f}"
        case .speakerOffBold: return "\u{f960}"
        case .speakerOffFilled: return "\u{f961}"
        case .speakerOffLight: return "\u{f962}"
        case .speakerOffRegular: return "\u{f963}"
        case .speakerOnColoredBold: return "\u{f964}"
        case .speakerOnColoredLight: return "\u{f965}"
        case .speakerOnColoredRegular: return "\u{f966}"
        case .speakerRegular: return "\u{f967}"
        case .speakerTurnDownBold: return "\u{f968}"
        case .speakerTurnDownFilled: return "\u{f969}"
        case .speakerTurnDownLight: return "\u{f96a}"
        case .speakerTurnDownRegular: return "\u{f96b}"
        case .speakerTurnUpBold: return "\u{f96c}"
        case .speakerTurnUpFilled: return "\u{f96d}"
        case .speakerTurnUpLight: return "\u{f96e}"
        case .speakerTurnUpRegular: return "\u{f96f}"
        case .spinnerBold: return "\u{f970}"
        case .spinnerFilledBold: return "\u{f971}"
        case .spinnerFilledLight: return "\u{f972}"
        case .spinnerFilledRegular: return "\u{f973}"
        case .spinnerLight: return "\u{f974}"
        case .spinnerPartialBold: return "\u{f975}"
        case .spinnerPartialLight: return "\u{f976}"
        case .spinnerPartialRegular: return "\u{f977}"
        case .spinnerRegular: return "\u{f978}"
        case .stackedArea100ChartBold: return "\u{f979}"
        case .stackedArea100ChartFilled: return "\u{f97a}"
        case .stackedArea100ChartLight: return "\u{f97b}"
        case .stackedArea100ChartRegular: return "\u{f97c}"
        case .stackedAreaChartBold: return "\u{f97d}"
        case .stackedAreaChartFilled: return "\u{f97e}"
        case .stackedAreaChartLight: return "\u{f97f}"
        case .stackedAreaChartRegular: return "\u{f980}"
        case .stackedBar100ChartBold: return "\u{f981}"
        case .stackedBar100ChartFilled: return "\u{f982}"
        case .stackedBar100ChartLight: return "\u{f983}"
        case .stackedBar100ChartRegular: return "\u{f984}"
        case .stackedBarChartBold: return "\u{f985}"
        case .stackedBarChartFilled: return "\u{f986}"
        case .stackedBarChartLight: return "\u{f987}"
        case .stackedBarChartRegular: return "\u{f988}"
        case .startChatBold: return "\u{f989}"
        case .startChatLight: return "\u{f98a}"
        case .startChatRegular: return "\u{f98b}"
        case .stethoscopeBold: return "\u{f98c}"
        case .stethoscopeLight: return "\u{f98d}"
        case .stethoscopeRegular: return "\u{f98e}"
        case .stickersBold: return "\u{f98f}"
        case .stickersLight: return "\u{f990}"
        case .stickersRegular: return "\u{f991}"
        case .stickiesBold: return "\u{f992}"
        case .stickiesLight: return "\u{f993}"
        case .stickiesRegular: return "\u{f994}"
        case .stopBold: return "\u{f995}"
        case .stopCircleBold: return "\u{f996}"
        case .stopCircleFilled: return "\u{f997}"
        case .stopCircleLight: return "\u{f998}"
        case .stopCircleRegular: return "\u{f999}"
        case .stopContentShareBold: return "\u{f99a}"
        case .stopContentShareLight: return "\u{f99b}"
        case .stopContentShareRegular: return "\u{f99c}"
        case .stopFilled: return "\u{f99d}"
        case .stopLight: return "\u{f99e}"
        case .stopRegular: return "\u{f99f}"
        case .storedInfoBold: return "\u{f9a0}"
        case .storedInfoFilled: return "\u{f9a1}"
        case .storedInfoLight: return "\u{f9a2}"
        case .storedInfoRegular: return "\u{f9a3}"
        case .streamingBold: return "\u{f9a4}"
        case .streamingLight: return "\u{f9a5}"
        case .streamingRegular: return "\u{f9a6}"
        case .strikethroughBold: return "\u{f9a7}"
        case .strikethroughLight: return "\u{f9a8}"
        case .strikethroughRegular: return "\u{f9a9}"
        case .subscriptBold: return "\u{f9aa}"
        case .subscriptLight: return "\u{f9ab}"
        case .subscriptRegular: return "\u{f9ac}"
        case .superscriptBold: return "\u{f9ad}"
        case .superscriptLight: return "\u{f9ae}"
        case .superscriptRegular: return "\u{f9af}"
        case .surveyBold: return "\u{f9b0}"
        case .surveyFilled: return "\u{f9b1}"
        case .surveyLight: return "\u{f9b2}"
        case .surveyRegular: return "\u{f9b3}"
        case .sx10Bold: return "\u{f9b4}"
        case .sx10Light: return "\u{f9b5}"
        case .sx10Regular: return "\u{f9b6}"
        case .sx20Bold: return "\u{f9b7}"
        case .sx20Light: return "\u{f9b8}"
        case .sx20Regular: return "\u{f9b9}"
        case .sx80CodecBold: return "\u{f9ba}"
        case .sx80CodecLight: return "\u{f9bb}"
        case .sx80CodecRegular: return "\u{f9bc}"
        case .tableBold: return "\u{f9bd}"
        case .tableLight: return "\u{f9be}"
        case .tableRegular: return "\u{f9bf}"
        case .tabletBold: return "\u{f9c0}"
        case .tabletLight: return "\u{f9c1}"
        case .tabletRegular: return "\u{f9c2}"
        case .tabsBold: return "\u{f9c3}"
        case .tabsLight: return "\u{f9c4}"
        case .tabsRegular: return "\u{f9c5}"
        case .tagBold: return "\u{f9c6}"
        case .tagLight: return "\u{f9c7}"
        case .tagRegular: return "\u{f9c8}"
        case .tapBold: return "\u{f9c9}"
        case .tapFilled: return "\u{f9ca}"
        case .tapLight: return "\u{f9cb}"
        case .tapRegular: return "\u{f9cc}"
        case .telepresenceAlertBold: return "\u{f9cd}"
        case .telepresenceAlertLight: return "\u{f9ce}"
        case .telepresenceAlertMutedBold: return "\u{f9cf}"
        case .telepresenceAlertMutedLight: return "\u{f9d0}"
        case .telepresenceAlertMutedRegular: return "\u{f9d1}"
        case .telepresenceAlertRegular: return "\u{f9d2}"
        case .telepresenceBold: return "\u{f9d3}"
        case .telepresenceIx5000Bold: return "\u{f9d4}"
        case .telepresenceIx5000Light: return "\u{f9d5}"
        case .telepresenceIx5000Regular: return "\u{f9d6}"
        case .telepresenceLight: return "\u{f9d7}"
        case .telepresencePrivateBold: return "\u{f9d8}"
        case .telepresencePrivateLight: return "\u{f9d9}"
        case .telepresencePrivateRegular: return "\u{f9da}"
        case .telepresenceRegular: return "\u{f9db}"
        case .temperatureBold: return "\u{f9dc}"
        case .temperatureLight: return "\u{f9dd}"
        case .temperatureRegular: return "\u{f9de}"
        case .textAlignCenterBold: return "\u{f9df}"
        case .textAlignCenterFilled: return "\u{f9e0}"
        case .textAlignCenterLight: return "\u{f9e1}"
        case .textAlignCenterRegular: return "\u{f9e2}"
        case .textAlignLeftBold: return "\u{f9e3}"
        case .textAlignLeftFilled: return "\u{f9e4}"
        case .textAlignLeftLight: return "\u{f9e5}"
        case .textAlignLeftRegular: return "\u{f9e6}"
        case .textAlignRightBold: return "\u{f9e7}"
        case .textAlignRightFilled: return "\u{f9e8}"
        case .textAlignRightLight: return "\u{f9e9}"
        case .textAlignRightRegular: return "\u{f9ea}"
        case .textBold: return "\u{f9eb}"
        case .textCodeBlockBold: return "\u{f9ec}"
        case .textCodeBlockLight: return "\u{f9ed}"
        case .textCodeBlockRegular: return "\u{f9ee}"
        case .textHighlightBold: return "\u{f9ef}"
        case .textHighlightLight: return "\u{f9f0}"
        case .textHighlightRegular: return "\u{f9f1}"
        case .textLight: return "\u{f9f2}"
        case .textRegular: return "\u{f9f3}"
        case .threeColumnBold: return "\u{f9f4}"
        case .threeColumnLight: return "\u{f9f5}"
        case .threeColumnRegular: return "\u{f9f6}"
        case .threeDObjectBold: return "\u{f9f7}"
        case .threeDObjectLight: return "\u{f9f8}"
        case .threeDObjectRegular: return "\u{f9f9}"
        case .tooFastBold: return "\u{f9fa}"
        case .tooFastLight: return "\u{f9fb}"
        case .tooFastRegular: return "\u{f9fc}"
        case .tooSlowBold: return "\u{f9fd}"
        case .tooSlowLight: return "\u{f9fe}"
        case .tooSlowRegular: return "\u{f9ff}"
        case .toolsBold: return "\u{fa00}"
        case .toolsLight: return "\u{fa01}"
        case .toolsRegular: return "\u{fa02}"
        case .touch10Bold: return "\u{fa03}"
        case .touch10Light: return "\u{fa04}"
        case .touch10Regular: return "\u{fa05}"
        case .transcriptBold: return "\u{fa06}"
        case .transcriptFilled: return "\u{fa07}"
        case .transcriptLight: return "\u{fa08}"
        case .transcriptRegular: return "\u{fa09}"
        case .translateBold: return "\u{fa0a}"
        case .translateLight: return "\u{fa0b}"
        case .translateRegular: return "\u{fa0c}"
        case .trimBold: return "\u{fa0d}"
        case .trimLight: return "\u{fa0e}"
        case .trimRegular: return "\u{fa0f}"
        case .twoColumnBold: return "\u{fa10}"
        case .twoColumnLight: return "\u{fa11}"
        case .twoColumnRegular: return "\u{fa12}"
        case .ucmCloudBold: return "\u{fa13}"
        case .ucmCloudLight: return "\u{fa14}"
        case .ucmCloudRegular: return "\u{fa15}"
        case .underlineBold: return "\u{fa16}"
        case .underlineLight: return "\u{fa17}"
        case .underlineRegular: return "\u{fa18}"
        case .undoBold: return "\u{fa19}"
        case .undoLight: return "\u{fa1a}"
        case .undoRegular: return "\u{fa1b}"
        case .unlinkBold: return "\u{fa1c}"
        case .unlinkLight: return "\u{fa1d}"
        case .unlinkRegular: return "\u{fa1e}"
        case .unreadBold: return "\u{fa1f}"
        case .unreadFilled: return "\u{fa20}"
        case .unreadLight: return "\u{fa21}"
        case .unreadRegular: return "\u{fa22}"
        case .unsecureUnlockedBold: return "\u{fa23}"
        case .unsecureUnlockedFilled: return "\u{fa24}"
        case .unsecureUnlockedLight: return "\u{fa25}"
        case .unsecureUnlockedRegular: return "\u{fa26}"
        case .unsortedBold: return "\u{fa27}"
        case .unsortedLight: return "\u{fa28}"
        case .unsortedRegular: return "\u{fa29}"
        case .updateFileShareBold: return "\u{fa2a}"
        case .updateFileShareLight: return "\u{fa2b}"
        case .updateFileShareRegular: return "\u{fa2c}"
        case .upgradeBold: return "\u{fa2d}"
        case .upgradeFilled: return "\u{fa2e}"
        case .upgradeLight: return "\u{fa2f}"
        case .upgradeRegular: return "\u{fa30}"
        case .uploadBold: return "\u{fa31}"
        case .uploadLight: return "\u{fa32}"
        case .uploadRegular: return "\u{fa33}"
        case .urgentVoicemailBold: return "\u{fa34}"
        case .urgentVoicemailFilled: return "\u{fa35}"
        case .usbBold: return "\u{fa36}"
        case .usbHeadsetBold: return "\u{fa37}"
        case .usbHeadsetLight: return "\u{fa38}"
        case .usbHeadsetMutedBold: return "\u{fa39}"
        case .usbHeadsetMutedLight: return "\u{fa3a}"
        case .usbHeadsetMutedRegular: return "\u{fa3b}"
        case .usbHeadsetRegular: return "\u{fa3c}"
        case .usbLight: return "\u{fa3d}"
        case .usbRegular: return "\u{fa3e}"
        case .userBold: return "\u{fa3f}"
        case .userDeactivateBold: return "\u{fa40}"
        case .userDeactivateLight: return "\u{fa41}"
        case .userDeactivateRegular: return "\u{fa42}"
        case .userLight: return "\u{fa43}"
        case .userRegular: return "\u{fa44}"
        case .vcsBold: return "\u{fa45}"
        case .vcsLight: return "\u{fa46}"
        case .vcsRegular: return "\u{fa47}"
        case .videoBlurBold: return "\u{fa48}"
        case .videoBlurFilled: return "\u{fa49}"
        case .videoBlurLight: return "\u{fa4a}"
        case .videoBlurRegular: return "\u{fa4b}"
        case .videoBold: return "\u{fa4c}"
        case .videoEffectBold: return "\u{fa4d}"
        case .videoEffectFilled: return "\u{fa4e}"
        case .videoEffectLight: return "\u{fa4f}"
        case .videoEffectRegular: return "\u{fa50}"
        case .videoFilled: return "\u{fa51}"
        case .videoLayoutBold: return "\u{fa52}"
        case .videoLayoutEqualBold: return "\u{fa53}"
        case .videoLayoutEqualDualBold: return "\u{fa54}"
        case .videoLayoutEqualDualLight: return "\u{fa55}"
        case .videoLayoutEqualDualRegular: return "\u{fa56}"
        case .videoLayoutEqualFilled: return "\u{fa57}"
        case .videoLayoutEqualLight: return "\u{fa58}"
        case .videoLayoutEqualRegular: return "\u{fa59}"
        case .videoLayoutFilled: return "\u{fa5a}"
        case .videoLayoutLight: return "\u{fa5b}"
        case .videoLayoutOverlayBold: return "\u{fa5c}"
        case .videoLayoutOverlayLight: return "\u{fa5d}"
        case .videoLayoutOverlayRegular: return "\u{fa5e}"
        case .videoLayoutPresenterDominantBold: return "\u{fa5f}"
        case .videoLayoutPresenterDominantLight: return "\u{fa60}"
        case .videoLayoutPresenterDominantRegular: return "\u{fa61}"
        case .videoLayoutProminentBold: return "\u{fa62}"
        case .videoLayoutProminentFilled: return "\u{fa63}"
        case .videoLayoutProminentLight: return "\u{fa64}"
        case .videoLayoutProminentRegular: return "\u{fa65}"
        case .videoLayoutRegular: return "\u{fa66}"
        case .videoLayoutShareDominantBold: return "\u{fa67}"
        case .videoLayoutShareDominantLight: return "\u{fa68}"
        case .videoLayoutShareDominantRegular: return "\u{fa69}"
        case .videoLayoutSingleBold: return "\u{fa6a}"
        case .videoLayoutSingleFilled: return "\u{fa6b}"
        case .videoLayoutSingleLight: return "\u{fa6c}"
        case .videoLayoutSingleRegular: return "\u{fa6d}"
        case .videoLayoutStackBold: return "\u{fa6e}"
        case .videoLayoutStackFilled: return "\u{fa6f}"
        case .videoLayoutStackLight: return "\u{fa70}"
        case .videoLayoutStackRegular: return "\u{fa71}"
        case .videoLayoutVideoDominantBold: return "\u{fa72}"
        case .videoLayoutVideoDominantLight: return "\u{fa73}"
        case .videoLayoutVideoDominantRegular: return "\u{fa74}"
        case .videoLight: return "\u{fa75}"
        case .videoPlusBold: return "\u{fa76}"
        case .videoPlusFilled: return "\u{fa77}"
        case .videoPlusLight: return "\u{fa78}"
        case .videoPlusRegular: return "\u{fa79}"
        case .videoRegular: return "\u{fa7a}"
        case .videoSpeakerTrackBold: return "\u{fa7b}"
        case .videoSpeakerTrackFilled: return "\u{fa7c}"
        case .videoSpeakerTrackLight: return "\u{fa7d}"
        case .videoSpeakerTrackRegular: return "\u{fa7e}"
        case .viewAllBold: return "\u{fa7f}"
        case .viewAllLight: return "\u{fa80}"
        case .viewAllRegular: return "\u{fa81}"
        case .viewListBold: return "\u{fa82}"
        case .viewListLight: return "\u{fa83}"
        case .viewListRegular: return "\u{fa84}"
        case .viewStackedBold: return "\u{fa85}"
        case .viewStackedFilled: return "\u{fa86}"
        case .viewStackedLight: return "\u{fa87}"
        case .viewStackedRegular: return "\u{fa88}"
        case .viewThumbnailBold: return "\u{fa89}"
        case .viewThumbnailFilled: return "\u{fa8a}"
        case .viewThumbnailLight: return "\u{fa8b}"
        case .viewThumbnailRegular: return "\u{fa8c}"
        case .voicemailBold: return "\u{fa8d}"
        case .voicemailFilled: return "\u{fa8e}"
        case .voicemailLight: return "\u{fa8f}"
        case .voicemailRegular: return "\u{fa90}"
        case .waffleMenuBold: return "\u{fa91}"
        case .waffleMenuLight: return "\u{fa92}"
        case .waffleMenuRegular: return "\u{fa93}"
        case .waitingroomActiveBold: return "\u{fa94}"
        case .waitingroomActiveLight: return "\u{fa95}"
        case .waitingroomActiveRegular: return "\u{fa96}"
        case .wallpaperBold: return "\u{fa97}"
        case .wallpaperLight: return "\u{fa98}"
        case .wallpaperRegular: return "\u{fa99}"
        case .warningBadgeFilled: return "\u{fa9a}"
        case .warningBold: return "\u{fa9b}"
        case .warningFilled: return "\u{fa9c}"
        case .warningLight: return "\u{fa9d}"
        case .warningRegular: return "\u{fa9e}"
        case .webexAssistantActiveColored: return "\u{fa9f}"
        case .webexAssistantInactiveColored: return "\u{faa0}"
        case .webexBoardBold: return "\u{faa1}"
        case .webexBoardLight: return "\u{faa2}"
        case .webexBoardRegular: return "\u{faa3}"
        case .webexCodecPlusBold: return "\u{faa4}"
        case .webexCodecPlusLight: return "\u{faa5}"
        case .webexCodecPlusRegular: return "\u{faa6}"
        case .webexDeskCameraBold: return "\u{faa7}"
        case .webexDeskCameraLight: return "\u{faa8}"
        case .webexDeskCameraRegular: return "\u{faa9}"
        case .webexHelixFilled: return "\u{faaa}"
        case .webexMeetingsBold: return "\u{faab}"
        case .webexMeetingsFilled: return "\u{faac}"
        case .webexMeetingsLight: return "\u{faad}"
        case .webexMeetingsRegular: return "\u{faae}"
        case .webexQuadCameraBold: return "\u{faaf}"
        case .webexQuadCameraLight: return "\u{fab0}"
        case .webexQuadCameraRegular: return "\u{fab1}"
        case .webexRoomKitBold: return "\u{fab2}"
        case .webexRoomKitLight: return "\u{fab3}"
        case .webexRoomKitPlusBold: return "\u{fab4}"
        case .webexRoomKitPlusLight: return "\u{fab5}"
        case .webexRoomKitPlusRegular: return "\u{fab6}"
        case .webexRoomKitRegular: return "\u{fab7}"
        case .webexShareBold: return "\u{fab8}"
        case .webexShareLight: return "\u{fab9}"
        case .webexShareRegular: return "\u{faba}"
        case .webexTeamsBold: return "\u{fabb}"
        case .webexTeamsFilled: return "\u{fabc}"
        case .webexTeamsLight: return "\u{fabd}"
        case .webexTeamsNewBold: return "\u{fabe}"
        case .webexTeamsNewFilled: return "\u{fabf}"
        case .webexTeamsNewLight: return "\u{fac0}"
        case .webexTeamsNewRegular: return "\u{fac1}"
        case .webexTeamsRegular: return "\u{fac2}"
        case .webinarBold: return "\u{fac3}"
        case .webinarFilled: return "\u{fac4}"
        case .webinarLight: return "\u{fac5}"
        case .webinarRegular: return "\u{fac6}"
        case .weeklyRecurringScheduleNodeBold: return "\u{fac7}"
        case .weeklyRecurringScheduleNodeLight: return "\u{fac8}"
        case .weeklyRecurringScheduleNodeRegular: return "\u{fac9}"
        case .whiteboardBold: return "\u{faca}"
        case .whiteboardContentBold: return "\u{facb}"
        case .whiteboardContentLight: return "\u{facc}"
        case .whiteboardContentRegular: return "\u{facd}"
        case .whiteboardFilled: return "\u{face}"
        case .whiteboardLight: return "\u{facf}"
        case .whiteboardRegular: return "\u{fad0}"
        case .widgetBold: return "\u{fad1}"
        case .widgetFilled: return "\u{fad2}"
        case .widgetLight: return "\u{fad3}"
        case .widgetRegular: return "\u{fad4}"
        case .wifiBold: return "\u{fad5}"
        case .wifiErrorBold: return "\u{fad6}"
        case .wifiErrorLight: return "\u{fad7}"
        case .wifiErrorRegular: return "\u{fad8}"
        case .wifiLight: return "\u{fad9}"
        case .wifiRegular: return "\u{fada}"
        case .wifiSignalGoodColoredBold: return "\u{fadb}"
        case .wifiSignalGoodColoredLight: return "\u{fadc}"
        case .wifiSignalGoodColoredRegular: return "\u{fadd}"
        case .wifiSignalPoorColoredBold: return "\u{fade}"
        case .wifiSignalPoorColoredLight: return "\u{fadf}"
        case .wifiSignalPoorColoredRegular: return "\u{fae0}"
        case .wifiSignalUnstableColoredBold: return "\u{fae1}"
        case .wifiSignalUnstableColoredLight: return "\u{fae2}"
        case .wifiSignalUnstableColoredRegular: return "\u{fae3}"
        case .windowCornerScrubBold: return "\u{fae4}"
        case .windowCornerScrubLight: return "\u{fae5}"
        case .windowCornerScrubRegular: return "\u{fae6}"
        case .windowRightCornerScrubBold: return "\u{fae7}"
        case .windowRightCornerScrubLight: return "\u{fae8}"
        case .windowRightCornerScrubRegular: return "\u{fae9}"
        case .windowVerticalScrubBold: return "\u{faea}"
        case .windowVerticalScrubLight: return "\u{faeb}"
        case .windowVerticalScrubRegular: return "\u{faec}"
        case .workflowDeploymentsBold: return "\u{faed}"
        case .workflowDeploymentsLight: return "\u{faee}"
        case .workflowDeploymentsRegular: return "\u{faef}"
        case .workphoneBold: return "\u{faf0}"
        case .workphoneLight: return "\u{faf1}"
        case .workphoneRegular: return "\u{faf2}"
        case .zoomInBold: return "\u{faf3}"
        case .zoomInLight: return "\u{faf4}"
        case .zoomInRegular: return "\u{faf5}"
        case .zoomOutBold: return "\u{faf6}"
        case .zoomOutLight: return "\u{faf7}"
        case .zoomOutRegular: return "\u{faf8}"
        case .zoom: return "\u{faf9}"
