...
module.exports = {
  ...
  resolve: {
    ...
    alias: {
      ...
      '@collab-ui/icons': path.resolve(root),
      'node_modules/@collab-ui/icons': path.resolve(root),
    },
    // plugins: [
  ...
  plugins: [
    ...
    new CopyWebpackPlugin([{
      from: path.resolve('docs/assets'),
      to: 'assets'
    }, {
      from: path.resolve('node_modules/@collab-ui/core/favicons/*'),
