...
var ComboBox = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    var input = /*#__PURE__*/React.createElement(InputComp, _extends({
    ...
    var renderFilteredOption = filteredOptions && filteredOptions.map(function (option, i) {
      return /*#__PURE__*/React.cloneElement(option, _extends({
        active: i === focus,
        key: i,
    ...
    var dropdownElement = this.anchorNode && isOpen && /*#__PURE__*/React.createElement(EventOverlay, _extends({
      allowClickAway: true,
