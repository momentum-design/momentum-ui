...
@objc public enum MomentumIconsRebrandType: Int {
    ...
    public var ligature: String {
        ...
        case .groupPickupLight: return "\u{f537}"
        case .groupPickupBold: return "\u{f538}"
        case .groupPickupFilled: return "\u{f539}"
        ...
        case .recordBold: return "\u{f7f0}"
        case .recordFilled: return "\u{f7f1}"
        case .recordLight: return "\u{f7f2}"
        case .recordPausedBold: return "\u{f7f3}"
        case .recordPausedFilled: return "\u{f7f4}"
        case .recordPausedLight: return "\u{f7f5}"
        case .recordPausedRegular: return "\u{f7f6}"
        case .recordRegular: return "\u{f7f7}"
        case .recurringBold: return "\u{f7f8}"
        case .recurringLight: return "\u{f7f9}"
        case .recurringOffBold: return "\u{f7fa}"
        case .recurringOffLight: return "\u{f7fb}"
        case .recurringOffRegular: return "\u{f7fc}"
        case .recurringRegular: return "\u{f7fd}"
        case .redialBold: return "\u{f7fe}"
        case .redialLight: return "\u{f7ff}"
        case .redialRegular: return "\u{f800}"
        case .redoBold: return "\u{f801}"
        case .redoLight: return "\u{f802}"
        case .redoRegular: return "\u{f803}"
        case .refreshBold: return "\u{f804}"
        case .refreshLight: return "\u{f805}"
        case .refreshRegular: return "\u{f806}"
        case .remoteCallBold: return "\u{f807}"
        case .remoteCallFilled: return "\u{f808}"
        case .remoteCallLight: return "\u{f809}"
        case .remoteCallRegular: return "\u{f80a}"
        case .remoteDesktopControlBold: return "\u{f80b}"
        case .remoteDesktopControlFilled: return "\u{f80c}"
        case .remoteDesktopControlLight: return "\u{f80d}"
        case .remoteDesktopControlRegular: return "\u{f80e}"
        case .removeBold: return "\u{f80f}"
        case .removeFilled: return "\u{f810}"
        case .removeLight: return "\u{f811}"
        case .removeRegular: return "\u{f812}"
        case .replyBold: return "\u{f813}"
        case .replyFilled: return "\u{f814}"
        case .replyLight: return "\u{f815}"
        case .replyListBold: return "\u{f816}"
        case .replyListLight: return "\u{f817}"
        case .replyListRegular: return "\u{f818}"
        case .replyRegular: return "\u{f819}"
        case .resetBold: return "\u{f81a}"
        case .resetLight: return "\u{f81b}"
        case .resetRegular: return "\u{f81c}"
        case .responsiveMobileBold: return "\u{f81d}"
        case .responsiveMobileLight: return "\u{f81e}"
        case .responsiveMobileRegular: return "\u{f81f}"
        case .restartBold: return "\u{f820}"
        case .restartLight: return "\u{f821}"
        case .restartRegular: return "\u{f822}"
        case .retrieveCallBold: return "\u{f823}"
        case .retrieveCallLight: return "\u{f824}"
        case .retrieveCallRegular: return "\u{f825}"
        case .returnBold: return "\u{f826}"
        case .returnLight: return "\u{f827}"
        case .returnRegular: return "\u{f828}"
        case .ringtoneBold: return "\u{f829}"
        case .ringtoneLight: return "\u{f82a}"
        case .ringtoneRegular: return "\u{f82b}"
        case .roomCalendarBold: return "\u{f82c}"
        case .roomCalendarLight: return "\u{f82d}"
        case .roomCalendarRegular: return "\u{f82e}"
        case .roomLightsBold: return "\u{f82f}"
        case .roomLightsFilled: return "\u{f830}"
        case .roomLightsLight: return "\u{f831}"
        case .roomLightsRegular: return "\u{f832}"
        case .rotateContentBold: return "\u{f833}"
        case .rotateContentFilled: return "\u{f834}"
        case .rotateContentLight: return "\u{f835}"
        case .rotateContentRegular: return "\u{f836}"
        case .ruleBasedBold: return "\u{f837}"
        case .ruleBasedLight: return "\u{f838}"
        case .ruleBasedRegular: return "\u{f839}"
        case .runningApplicationBold: return "\u{f83a}"
        case .runningApplicationFilled: return "\u{f83b}"
        case .runningApplicationLight: return "\u{f83c}"
        case .runningApplicationRegular: return "\u{f83d}"
        case .saveBold: return "\u{f83e}"
        case .saveLight: return "\u{f83f}"
        case .saveRegular: return "\u{f840}"
        case .scanBold: return "\u{f841}"
        case .scanLight: return "\u{f842}"
        case .scanRegular: return "\u{f843}"
        case .schedulerAvailableBold: return "\u{f844}"
        case .schedulerAvailableLight: return "\u{f845}"
        case .schedulerAvailableRegular: return "\u{f846}"
        case .schedulerNotWorkingHoursBold: return "\u{f847}"
        case .schedulerNotWorkingHoursLight: return "\u{f848}"
        case .schedulerNotWorkingHoursRegular: return "\u{f849}"
        case .schedulerUnavailableBold: return "\u{f84a}"
        case .schedulerUnavailableLight: return "\u{f84b}"
        case .schedulerUnavailableRegular: return "\u{f84c}"
        case .schedulerUnknownBold: return "\u{f84d}"
        case .schedulerUnknownLight: return "\u{f84e}"
        case .schedulerUnknownRegular: return "\u{f84f}"
        case .screenshotBold: return "\u{f850}"
        case .screenshotDocBold: return "\u{f851}"
        case .screenshotDocFilled: return "\u{f852}"
        case .screenshotDocLight: return "\u{f853}"
        case .screenshotDocRegular: return "\u{f854}"
        case .screenshotLight: return "\u{f855}"
        case .screenshotRegular: return "\u{f856}"
        case .searchBold: return "\u{f857}"
        case .searchFilled: return "\u{f858}"
        case .searchLight: return "\u{f859}"
        case .searchRegular: return "\u{f85a}"
        case .secondaryArrowBold: return "\u{f85b}"
        case .secondaryArrowLight: return "\u{f85c}"
        case .secondaryArrowRegular: return "\u{f85d}"
        case .secureCallLockBold: return "\u{f85e}"
        case .secureCallLockFilled: return "\u{f85f}"
        case .secureCallLockLight: return "\u{f860}"
        case .secureCallLockRegular: return "\u{f861}"
        case .secureCallShieldBold: return "\u{f862}"
        case .secureCallShieldFilled: return "\u{f863}"
        case .secureCallShieldLight: return "\u{f864}"
        case .secureCallShieldRegular: return "\u{f865}"
        case .secureCircleBold: return "\u{f866}"
        case .secureCircleFilled: return "\u{f867}"
        case .secureCircleLight: return "\u{f868}"
        case .secureCircleRegular: return "\u{f869}"
        case .secureLockBold: return "\u{f86a}"
        case .secureLockFilled: return "\u{f86b}"
        case .secureLockLight: return "\u{f86c}"
        case .secureLockRegular: return "\u{f86d}"
        case .selectAllBold: return "\u{f86e}"
        case .selectAllFilled: return "\u{f86f}"
        case .selectAllLight: return "\u{f870}"
        case .selectAllRegular: return "\u{f871}"
        case .selectionBold: return "\u{f872}"
        case .selectionLight: return "\u{f873}"
        case .selectionRegular: return "\u{f874}"
        case .sendBold: return "\u{f875}"
        case .sendFilled: return "\u{f876}"
        case .sendLight: return "\u{f877}"
        case .sendRegular: return "\u{f878}"
        case .serverBold: return "\u{f879}"
        case .serverErrorBold: return "\u{f87a}"
        case .serverErrorLight: return "\u{f87b}"
        case .serverErrorRegular: return "\u{f87c}"
        case .serverLight: return "\u{f87d}"
        case .serverRegular: return "\u{f87e}"
        case .servicesBold: return "\u{f87f}"
        case .servicesLight: return "\u{f880}"
        case .servicesRegular: return "\u{f881}"
        case .setVariableBold: return "\u{f882}"
        case .setVariableLight: return "\u{f883}"
        case .setVariableRegular: return "\u{f884}"
        case .settingsBold: return "\u{f885}"
        case .settingsFilled: return "\u{f886}"
        case .settingsLight: return "\u{f887}"
        case .settingsRegular: return "\u{f888}"
        case .setupAssistantBold: return "\u{f889}"
        case .setupAssistantLight: return "\u{f88a}"
        case .setupAssistantRegular: return "\u{f88b}"
        case .sftpBold: return "\u{f88c}"
        case .sftpLight: return "\u{f88d}"
        case .sftpRegular: return "\u{f88e}"
        case .shapeCircleBold: return "\u{f88f}"
        case .shapeCircleFilled: return "\u{f890}"
        case .shapeCircleLight: return "\u{f891}"
        case .shapeCircleRegular: return "\u{f892}"
        case .shapeDiagonalLineBold: return "\u{f893}"
        case .shapeDiagonalLineLight: return "\u{f894}"
        case .shapeDiagonalLineRegular: return "\u{f895}"
        case .shapeDiamondBold: return "\u{f896}"
        case .shapeDiamondFilled: return "\u{f897}"
        case .shapeDiamondLight: return "\u{f898}"
        case .shapeDiamondRegular: return "\u{f899}"
        case .shapeOvalBold: return "\u{f89a}"
        case .shapeOvalLight: return "\u{f89b}"
        case .shapeOvalRegular: return "\u{f89c}"
        case .shapeSquareBold: return "\u{f89d}"
        case .shapeSquareFilled: return "\u{f89e}"
        case .shapeSquareLight: return "\u{f89f}"
        case .shapeSquareRegular: return "\u{f8a0}"
        case .shapeTriangleBold: return "\u{f8a1}"
        case .shapeTriangleFilled: return "\u{f8a2}"
        case .shapeTriangleLight: return "\u{f8a3}"
        case .shapeTriangleRegular: return "\u{f8a4}"
        case .shapesBold: return "\u{f8a5}"
        case .shapesLight: return "\u{f8a6}"
        case .shapesRegular: return "\u{f8a7}"
        case .shareCNativeAdrBold: return "\u{f8a8}"
        case .shareCNativeAdrLight: return "\u{f8a9}"
        case .shareCNativeAdrRegular: return "\u{f8aa}"
        case .shareCNativeIphBold: return "\u{f8ab}"
        case .shareCNativeIphLight: return "\u{f8ac}"
        case .shareCNativeIphRegular: return "\u{f8ad}"
        case .shareScreenBold: return "\u{f8ae}"
        case .shareScreenFilled: return "\u{f8af}"
        case .shareScreenLight: return "\u{f8b0}"
        case .shareScreenRegular: return "\u{f8b1}"
        case .shareScreenSmallFilled: return "\u{f8b2}"
        case .shareSpaceBold: return "\u{f8b3}"
        case .shareSpaceLight: return "\u{f8b4}"
        case .shareSpaceRegular: return "\u{f8b5}"
        case .shieldBold: return "\u{f8b6}"
        case .shieldLight: return "\u{f8b7}"
        case .shieldRegular: return "\u{f8b8}"
        case .shortTextBoxBold: return "\u{f8b9}"
        case .shortTextBoxLight: return "\u{f8ba}"
        case .shortTextBoxRegular: return "\u{f8bb}"
        case .showBold: return "\u{f8bc}"
        case .showFilled: return "\u{f8bd}"
        case .showLight: return "\u{f8be}"
        case .showRegular: return "\u{f8bf}"
        case .signInBold: return "\u{f8c0}"
        case .signInFilled: return "\u{f8c1}"
        case .signInForcedBold: return "\u{f8c2}"
        case .signInForcedLight: return "\u{f8c3}"
        case .signInForcedRegular: return "\u{f8c4}"
        case .signInLight: return "\u{f8c5}"
        case .signInRegular: return "\u{f8c6}"
        case .signOutBold: return "\u{f8c7}"
        case .signOutLight: return "\u{f8c8}"
        case .signOutRegular: return "\u{f8c9}"
        case .signal0Bold: return "\u{f8ca}"
        case .signal0Light: return "\u{f8cb}"
        case .signal0Regular: return "\u{f8cc}"
        case .signal100Bold: return "\u{f8cd}"
        case .signal100Light: return "\u{f8ce}"
        case .signal100Regular: return "\u{f8cf}"
        case .signal25Bold: return "\u{f8d0}"
        case .signal25Light: return "\u{f8d1}"
        case .signal25Regular: return "\u{f8d2}"
        case .signal50Bold: return "\u{f8d3}"
        case .signal50Light: return "\u{f8d4}"
        case .signal50Regular: return "\u{f8d5}"
        case .signal75Bold: return "\u{f8d6}"
        case .signal75Light: return "\u{f8d7}"
        case .signal75Regular: return "\u{f8d8}"
        case .simplePromotionBold: return "\u{f8d9}"
        case .simplePromotionLight: return "\u{f8da}"
        case .simplePromotionRegular: return "\u{f8db}"
        case .singleNumberReachBold: return "\u{f8dc}"
        case .singleNumberReachLight: return "\u{f8dd}"
        case .singleNumberReachRegular: return "\u{f8de}"
        case .sipRegistrationInProgressBold: return "\u{f8df}"
        case .sipRegistrationInProgressFilled: return "\u{f8e0}"
        case .sipRegistrationInProgressLight: return "\u{f8e1}"
        case .sipRegistrationInProgressRegular: return "\u{f8e2}"
        case .skipBold: return "\u{f8e3}"
        case .skipBwBold: return "\u{f8e4}"
        case .skipBwFilled: return "\u{f8e5}"
        case .skipBwLight: return "\u{f8e6}"
        case .skipBwRegular: return "\u{f8e7}"
        case .skipFwBold: return "\u{f8e8}"
        case .skipFwFilled: return "\u{f8e9}"
        case .skipFwLight: return "\u{f8ea}"
        case .skipFwRegular: return "\u{f8eb}"
        case .skipLight: return "\u{f8ec}"
        case .skipRegular: return "\u{f8ed}"
        case .smsInboundBold: return "\u{f8ee}"
        case .smsInboundLight: return "\u{f8ef}"
        case .smsInboundRegular: return "\u{f8f0}"
        case .socialAlexaFilled: return "\u{f8f1}"
        case .socialFacebookColoredFilled: return "\u{f8f2}"
        case .socialFacebookFilled: return "\u{f8f3}"
        case .socialFbmessengerColoredFilled: return "\u{f8f4}"
        case .socialFbmessengerFilled: return "\u{f8f5}"
        case .socialInstagramBold: return "\u{f8f6}"
        case .socialMicrosoftColoredFilled: return "\u{f8f7}"
        case .socialMicrosoftFilled: return "\u{f8f8}"
        case .socialMmsFilled: return "\u{f8f9}"
        case .socialMmsGoldFilled: return "\u{f8fa}"
        case .socialSmsFilled: return "\u{f8fb}"
        case .socialSmsMintFilled: return "\u{f8fc}"
        case .socialTwitterColoredFilled: return "\u{f8fd}"
        case .socialTwitterFilled: return "\u{f8fe}"
        case .socialViberBold: return "\u{f8ff}"
        case .socialViberColoredBold: return "\u{f900}"
        case .socialWhatsappBold: return "\u{f901}"
        case .socialWhatsappColoredFilled: return "\u{f902}"
        case .sortAscendingBold: return "\u{f903}"
        case .sortAscendingLight: return "\u{f904}"
        case .sortAscendingRegular: return "\u{f905}"
        case .sortDescendingBold: return "\u{f906}"
        case .sortDescendingLight: return "\u{f907}"
        case .sortDescendingRegular: return "\u{f908}"
        case .soundDefaultBold: return "\u{f909}"
        case .soundDefaultLight: return "\u{f90a}"
        case .soundDefaultRegular: return "\u{f90b}"
        case .speakerBold: return "\u{f90c}"
        case .speakerDisconnectedBold: return "\u{f90d}"
        case .speakerDisconnectedFilled: return "\u{f90e}"
        case .speakerDisconnectedLight: return "\u{f90f}"
        case .speakerDisconnectedRegular: return "\u{f910}"
        case .speakerFilled: return "\u{f911}"
        case .speakerLight: return "\u{f912}"
        case .speakerMutedBold: return "\u{f913}"
        case .speakerMutedFilled: return "\u{f914}"
        case .speakerMutedLight: return "\u{f915}"
        case .speakerMutedRegular: return "\u{f916}"
        case .speakerOffBold: return "\u{f917}"
        case .speakerOffFilled: return "\u{f918}"
        case .speakerOffLight: return "\u{f919}"
        case .speakerOffRegular: return "\u{f91a}"
        case .speakerOnColoredBold: return "\u{f91b}"
        case .speakerOnColoredLight: return "\u{f91c}"
        case .speakerOnColoredRegular: return "\u{f91d}"
        case .speakerRegular: return "\u{f91e}"
        case .speakerTurnDownBold: return "\u{f91f}"
        case .speakerTurnDownFilled: return "\u{f920}"
        case .speakerTurnDownLight: return "\u{f921}"
        case .speakerTurnDownRegular: return "\u{f922}"
        case .speakerTurnUpBold: return "\u{f923}"
        case .speakerTurnUpFilled: return "\u{f924}"
        case .speakerTurnUpLight: return "\u{f925}"
        case .speakerTurnUpRegular: return "\u{f926}"
        case .spinnerBold: return "\u{f927}"
        case .spinnerFilledBold: return "\u{f928}"
        case .spinnerFilledLight: return "\u{f929}"
        case .spinnerFilledRegular: return "\u{f92a}"
        case .spinnerLight: return "\u{f92b}"
        case .spinnerPartialBold: return "\u{f92c}"
        case .spinnerPartialLight: return "\u{f92d}"
        case .spinnerPartialRegular: return "\u{f92e}"
        case .spinnerRegular: return "\u{f92f}"
        case .stackedArea100ChartBold: return "\u{f930}"
        case .stackedArea100ChartFilled: return "\u{f931}"
        case .stackedArea100ChartLight: return "\u{f932}"
        case .stackedArea100ChartRegular: return "\u{f933}"
        case .stackedAreaChartBold: return "\u{f934}"
        case .stackedAreaChartFilled: return "\u{f935}"
        case .stackedAreaChartLight: return "\u{f936}"
        case .stackedAreaChartRegular: return "\u{f937}"
        case .stackedBar100ChartBold: return "\u{f938}"
        case .stackedBar100ChartFilled: return "\u{f939}"
        case .stackedBar100ChartLight: return "\u{f93a}"
        case .stackedBar100ChartRegular: return "\u{f93b}"
        case .stackedBarChartBold: return "\u{f93c}"
        case .stackedBarChartFilled: return "\u{f93d}"
        case .stackedBarChartLight: return "\u{f93e}"
        case .stackedBarChartRegular: return "\u{f93f}"
        case .startChatBold: return "\u{f940}"
        case .startChatLight: return "\u{f941}"
        case .startChatRegular: return "\u{f942}"
        case .stethoscopeBold: return "\u{f943}"
        case .stethoscopeLight: return "\u{f944}"
        case .stethoscopeRegular: return "\u{f945}"
        case .stickersBold: return "\u{f946}"
        case .stickersLight: return "\u{f947}"
        case .stickersRegular: return "\u{f948}"
        case .stickiesBold: return "\u{f949}"
        case .stickiesLight: return "\u{f94a}"
        case .stickiesRegular: return "\u{f94b}"
        case .stopBold: return "\u{f94c}"
        case .stopCircleBold: return "\u{f94d}"
        case .stopCircleFilled: return "\u{f94e}"
        case .stopCircleLight: return "\u{f94f}"
        case .stopCircleRegular: return "\u{f950}"
        case .stopContentShareBold: return "\u{f951}"
        case .stopContentShareLight: return "\u{f952}"
        case .stopContentShareRegular: return "\u{f953}"
        case .stopFilled: return "\u{f954}"
        case .stopLight: return "\u{f955}"
        case .stopRegular: return "\u{f956}"
        case .storedInfoBold: return "\u{f957}"
        case .storedInfoFilled: return "\u{f958}"
        case .storedInfoLight: return "\u{f959}"
        case .storedInfoRegular: return "\u{f95a}"
        case .streamingBold: return "\u{f95b}"
        case .streamingLight: return "\u{f95c}"
        case .streamingRegular: return "\u{f95d}"
        case .strikethroughBold: return "\u{f95e}"
        case .strikethroughLight: return "\u{f95f}"
        case .strikethroughRegular: return "\u{f960}"
        case .subscriptBold: return "\u{f961}"
        case .subscriptLight: return "\u{f962}"
        case .subscriptRegular: return "\u{f963}"
        case .superscriptBold: return "\u{f964}"
        case .superscriptLight: return "\u{f965}"
        case .superscriptRegular: return "\u{f966}"
        case .surveyBold: return "\u{f967}"
        case .surveyFilled: return "\u{f968}"
        case .surveyLight: return "\u{f969}"
        case .surveyRegular: return "\u{f96a}"
