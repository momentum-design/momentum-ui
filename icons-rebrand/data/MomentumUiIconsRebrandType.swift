...
@objc public enum MomentumIconsRebrandType: Int {
    ...
    public var ligature: String {
        ...
        case .peopleLight: return "\u{f641}"
        case .peopleRegular: return "\u{f642}"
        case .phoneAlertBold: return "\u{f643}"
        case .phoneAlertLight: return "\u{f644}"
        case .phoneAlertRegular: return "\u{f645}"
        case .phoneBold: return "\u{f646}"
        case .phoneFilled: return "\u{f647}"
        case .phoneLight: return "\u{f648}"
        case .phoneMutedBold: return "\u{f649}"
        case .phoneMutedLight: return "\u{f64a}"
        case .phoneMutedRegular: return "\u{f64b}"
        case .phonePrivateBold: return "\u{f64c}"
        case .phonePrivateLight: return "\u{f64d}"
        case .phonePrivateRegular: return "\u{f64e}"
        case .phoneRegular: return "\u{f64f}"
        case .phoneReplyAllBold: return "\u{f650}"
        case .phoneReplyAllLight: return "\u{f651}"
        case .phoneReplyAllRegular: return "\u{f652}"
        case .phoneReplyBold: return "\u{f653}"
        case .phoneReplyLight: return "\u{f654}"
        case .phoneReplyRegular: return "\u{f655}"
        case .pickerBold: return "\u{f656}"
        case .pickerLight: return "\u{f657}"
        case .pickerRegular: return "\u{f658}"
        case .pictureInPictureBold: return "\u{f659}"
        case .pictureInPictureLight: return "\u{f65a}"
        case .pictureInPictureRegular: return "\u{f65b}"
        case .pieChartBold: return "\u{f65c}"
        case .pieChartFilled: return "\u{f65d}"
        case .pieChartLight: return "\u{f65e}"
        case .pieChartRegular: return "\u{f65f}"
        case .pinBold: return "\u{f660}"
        case .pinFilled: return "\u{f661}"
        case .pinLight: return "\u{f662}"
        case .pinListBold: return "\u{f663}"
        case .pinListLight: return "\u{f664}"
        case .pinListRegular: return "\u{f665}"
        case .pinMutedBold: return "\u{f666}"
        case .pinMutedLight: return "\u{f667}"
        case .pinMutedRegular: return "\u{f668}"
        case .pinRegular: return "\u{f669}"
        case .placeholderBold: return "\u{f66a}"
        case .placeholderLight: return "\u{f66b}"
        case .placeholderRegular: return "\u{f66c}"
        case .playBold: return "\u{f66d}"
        case .playFilled: return "\u{f66e}"
        case .playLight: return "\u{f66f}"
        case .playRegular: return "\u{f670}"
        case .plugAcBold: return "\u{f671}"
        case .plugAcLight: return "\u{f672}"
        case .plugAcRegular: return "\u{f673}"
        case .plusBold: return "\u{f674}"
        case .plusCircleBold: return "\u{f675}"
        case .plusCircleFilled: return "\u{f676}"
        case .plusCircleLight: return "\u{f677}"
        case .plusCircleRegular: return "\u{f678}"
        case .plusLight: return "\u{f679}"
        case .plusRegular: return "\u{f67a}"
        case .pmrBold: return "\u{f67b}"
        case .pmrFilled: return "\u{f67c}"
        case .pmrLight: return "\u{f67d}"
        case .pmrRegular: return "\u{f67e}"
        case .pollBold: return "\u{f67f}"
        case .pollLight: return "\u{f680}"
        case .pollRegular: return "\u{f681}"
        case .popInBold: return "\u{f682}"
        case .popInLight: return "\u{f683}"
        case .popInRegular: return "\u{f684}"
        case .popOutBold: return "\u{f685}"
        case .popOutLight: return "\u{f686}"
        case .popOutRegular: return "\u{f687}"
        case .popUpBold: return "\u{f688}"
        case .popUpLight: return "\u{f689}"
        case .popUpRegular: return "\u{f68a}"
        case .portraitLandscapeBold: return "\u{f68b}"
        case .portraitLandscapeLight: return "\u{f68c}"
        case .portraitLandscapeRegular: return "\u{f68d}"
        case .powerAcBold: return "\u{f68e}"
        case .powerAcLight: return "\u{f68f}"
        case .powerAcRegular: return "\u{f690}"
        case .powerBold: return "\u{f691}"
        case .powerLight: return "\u{f692}"
        case .powerRegular: return "\u{f693}"
        case .presentationBold: return "\u{f694}"
        case .presentationLight: return "\u{f695}"
        case .presentationRegular: return "\u{f696}"
        case .printBold: return "\u{f697}"
        case .printLight: return "\u{f698}"
        case .printRegular: return "\u{f699}"
        case .priorityBadgeFilled: return "\u{f69a}"
        case .priorityCircleBold: return "\u{f69b}"
        case .priorityCircleFilled: return "\u{f69c}"
        case .priorityCircleLight: return "\u{f69d}"
        case .priorityCircleRegular: return "\u{f69e}"
        case .priorityCircleTwoBold: return "\u{f69f}"
        case .priorityCircleTwoFilled: return "\u{f6a0}"
        case .priorityCircleTwoLight: return "\u{f6a1}"
        case .priorityCircleTwoRegular: return "\u{f6a2}"
        case .privacyCircleBold: return "\u{f6a3}"
        case .privacyCircleFilled: return "\u{f6a4}"
        case .privacyCircleLight: return "\u{f6a5}"
        case .privacyCircleRegular: return "\u{f6a6}"
        case .privateBold: return "\u{f6a7}"
        case .privateCircleBold: return "\u{f6a8}"
        case .privateCircleFilled: return "\u{f6a9}"
        case .privateCircleLight: return "\u{f6aa}"
        case .privateCircleRegular: return "\u{f6ab}"
        case .privateLight: return "\u{f6ac}"
        case .privateMeetingBold: return "\u{f6ad}"
        case .privateMeetingLight: return "\u{f6ae}"
        case .privateMeetingRegular: return "\u{f6af}"
        case .privateRegular: return "\u{f6b0}"
        case .productDemoBold: return "\u{f6b1}"
        case .productDemoLight: return "\u{f6b2}"
        case .productDemoRegular: return "\u{f6b3}"
        case .proximityBold: return "\u{f6b4}"
        case .proximityLight: return "\u{f6b5}"
        case .proximityMutedBold: return "\u{f6b6}"
        case .proximityMutedLight: return "\u{f6b7}"
        case .proximityMutedRegular: return "\u{f6b8}"
        case .proximityRegular: return "\u{f6b9}"
        case .proximityVideoBold: return "\u{f6ba}"
        case .proximityVideoLight: return "\u{f6bb}"
        case .proximityVideoRegular: return "\u{f6bc}"
        case .ptoPresenceBold: return "\u{f6bd}"
        case .ptoPresenceFilled: return "\u{f6be}"
        case .ptoPresenceLight: return "\u{f6bf}"
        case .ptoPresenceRegular: return "\u{f6c0}"
        case .pullCallBold: return "\u{f6c1}"
        case .pullCallLight: return "\u{f6c2}"
        case .pullCallRegular: return "\u{f6c3}"
        case .qABold: return "\u{f6c4}"
        case .qALight: return "\u{f6c5}"
        case .qARegular: return "\u{f6c6}"
        case .qualityBold: return "\u{f6c7}"
        case .qualityLight: return "\u{f6c8}"
        case .qualityRegular: return "\u{f6c9}"
        case .queueContactBold: return "\u{f6ca}"
        case .queueContactLight: return "\u{f6cb}"
        case .queueContactRegular: return "\u{f6cc}"
        case .quietBold: return "\u{f6cd}"
        case .quietHoursPresenceBold: return "\u{f6ce}"
        case .quietHoursPresenceFilled: return "\u{f6cf}"
        case .quietHoursPresenceLight: return "\u{f6d0}"
        case .quietHoursPresenceRegular: return "\u{f6d1}"
        case .quietLight: return "\u{f6d2}"
        case .quietRegular: return "\u{f6d3}"
        case .raiseHandBold: return "\u{f6d4}"
        case .raiseHandLight: return "\u{f6d5}"
        case .raiseHandRegular: return "\u{f6d6}"
        case .ramBold: return "\u{f6d7}"
        case .ramLight: return "\u{f6d8}"
        case .ramRegular: return "\u{f6d9}"
        case .reactionsBold: return "\u{f6da}"
        case .reactionsFilled: return "\u{f6db}"
        case .reactionsLight: return "\u{f6dc}"
        case .reactionsRegular: return "\u{f6dd}"
        case .reactivateBold: return "\u{f6de}"
        case .reactivateLight: return "\u{f6df}"
        case .reactivateRegular: return "\u{f6e0}"
        case .recentsBold: return "\u{f6e1}"
        case .recentsFilled: return "\u{f6e2}"
        case .recentsLight: return "\u{f6e3}"
        case .recentsPresenceBold: return "\u{f6e4}"
        case .recentsPresenceFilled: return "\u{f6e5}"
        case .recentsPresenceLight: return "\u{f6e6}"
        case .recentsPresenceRegular: return "\u{f6e7}"
        case .recentsPresenceSmallFilled: return "\u{f6e8}"
        case .recentsRegular: return "\u{f6e9}"
        case .recordBold: return "\u{f6ea}"
        case .recordFilled: return "\u{f6eb}"
        case .recordLight: return "\u{f6ec}"
        case .recordPausedBold: return "\u{f6ed}"
        case .recordPausedFilled: return "\u{f6ee}"
        case .recordPausedLight: return "\u{f6ef}"
        case .recordPausedRegular: return "\u{f6f0}"
        case .recordRegular: return "\u{f6f1}"
        case .recurringBold: return "\u{f6f2}"
        case .recurringLight: return "\u{f6f3}"
        case .recurringOffBold: return "\u{f6f4}"
        case .recurringOffLight: return "\u{f6f5}"
        case .recurringOffRegular: return "\u{f6f6}"
        case .recurringRegular: return "\u{f6f7}"
        case .redialBold: return "\u{f6f8}"
        case .redialLight: return "\u{f6f9}"
        case .redialRegular: return "\u{f6fa}"
        case .redoBold: return "\u{f6fb}"
        case .redoLight: return "\u{f6fc}"
        case .redoRegular: return "\u{f6fd}"
        case .refreshBold: return "\u{f6fe}"
        case .refreshLight: return "\u{f6ff}"
        case .refreshRegular: return "\u{f700}"
        case .remoteDesktopControlBold: return "\u{f701}"
        case .remoteDesktopControlFilled: return "\u{f702}"
        case .remoteDesktopControlLight: return "\u{f703}"
        case .remoteDesktopControlRegular: return "\u{f704}"
        case .removeBold: return "\u{f705}"
        case .removeFilled: return "\u{f706}"
        case .removeLight: return "\u{f707}"
        case .removeRegular: return "\u{f708}"
        case .replyBold: return "\u{f709}"
        case .replyFilled: return "\u{f70a}"
        case .replyLight: return "\u{f70b}"
        case .replyListBold: return "\u{f70c}"
        case .replyListLight: return "\u{f70d}"
        case .replyListRegular: return "\u{f70e}"
        case .replyRegular: return "\u{f70f}"
        case .resetBold: return "\u{f710}"
        case .resetLight: return "\u{f711}"
        case .resetRegular: return "\u{f712}"
        case .responsiveMobileBold: return "\u{f713}"
        case .responsiveMobileLight: return "\u{f714}"
        case .responsiveMobileRegular: return "\u{f715}"
        case .restartBold: return "\u{f716}"
        case .restartLight: return "\u{f717}"
        case .restartRegular: return "\u{f718}"
        case .returnBold: return "\u{f719}"
        case .returnLight: return "\u{f71a}"
        case .returnRegular: return "\u{f71b}"
        case .ringtoneBold: return "\u{f71c}"
        case .ringtoneLight: return "\u{f71d}"
        case .ringtoneRegular: return "\u{f71e}"
        case .roomCalendarBold: return "\u{f71f}"
        case .roomCalendarLight: return "\u{f720}"
        case .roomCalendarRegular: return "\u{f721}"
        case .roomLightsBold: return "\u{f722}"
        case .roomLightsLight: return "\u{f723}"
        case .roomLightsRegular: return "\u{f724}"
        case .rotateContentBold: return "\u{f725}"
        case .rotateContentFilled: return "\u{f726}"
        case .rotateContentLight: return "\u{f727}"
        case .rotateContentRegular: return "\u{f728}"
        case .runningApplicationBold: return "\u{f729}"
        case .runningApplicationFilled: return "\u{f72a}"
        case .runningApplicationLight: return "\u{f72b}"
        case .runningApplicationRegular: return "\u{f72c}"
        case .saveBold: return "\u{f72d}"
        case .saveLight: return "\u{f72e}"
        case .saveRegular: return "\u{f72f}"
        case .scanBold: return "\u{f730}"
        case .scanLight: return "\u{f731}"
        case .scanRegular: return "\u{f732}"
        case .schedulerAvailableBold: return "\u{f733}"
        case .schedulerAvailableLight: return "\u{f734}"
        case .schedulerAvailableRegular: return "\u{f735}"
        case .schedulerNotWorkingHoursBold: return "\u{f736}"
        case .schedulerNotWorkingHoursLight: return "\u{f737}"
        case .schedulerNotWorkingHoursRegular: return "\u{f738}"
        case .schedulerUnavailableBold: return "\u{f739}"
        case .schedulerUnavailableLight: return "\u{f73a}"
        case .schedulerUnavailableRegular: return "\u{f73b}"
        case .schedulerUnknownBold: return "\u{f73c}"
        case .schedulerUnknownLight: return "\u{f73d}"
        case .schedulerUnknownRegular: return "\u{f73e}"
        case .screenshotBold: return "\u{f73f}"
        case .screenshotDocBold: return "\u{f740}"
        case .screenshotDocFilled: return "\u{f741}"
        case .screenshotDocLight: return "\u{f742}"
        case .screenshotDocRegular: return "\u{f743}"
        case .screenshotLight: return "\u{f744}"
        case .screenshotRegular: return "\u{f745}"
        case .searchBold: return "\u{f746}"
        case .searchLight: return "\u{f747}"
        case .searchRegular: return "\u{f748}"
        case .secondaryArrowBold: return "\u{f749}"
        case .secondaryArrowLight: return "\u{f74a}"
        case .secondaryArrowRegular: return "\u{f74b}"
        case .secureCallLockBold: return "\u{f74c}"
        case .secureCallLockFilled: return "\u{f74d}"
        case .secureCallLockLight: return "\u{f74e}"
        case .secureCallLockRegular: return "\u{f74f}"
        case .secureCallShieldBold: return "\u{f750}"
        case .secureCallShieldFilled: return "\u{f751}"
        case .secureCallShieldLight: return "\u{f752}"
        case .secureCallShieldRegular: return "\u{f753}"
        case .secureCircleBold: return "\u{f754}"
        case .secureCircleFilled: return "\u{f755}"
        case .secureCircleLight: return "\u{f756}"
        case .secureCircleRegular: return "\u{f757}"
        case .secureLockBold: return "\u{f758}"
        case .secureLockFilled: return "\u{f759}"
        case .secureLockLight: return "\u{f75a}"
        case .secureLockRegular: return "\u{f75b}"
        case .selectAllBold: return "\u{f75c}"
        case .selectAllFilled: return "\u{f75d}"
        case .selectAllLight: return "\u{f75e}"
        case .selectAllRegular: return "\u{f75f}"
        case .selectionBold: return "\u{f760}"
        case .selectionLight: return "\u{f761}"
        case .selectionRegular: return "\u{f762}"
        case .sendBold: return "\u{f763}"
        case .sendFilled: return "\u{f764}"
        case .sendLight: return "\u{f765}"
        case .sendRegular: return "\u{f766}"
        case .serverBold: return "\u{f767}"
        case .serverErrorBold: return "\u{f768}"
        case .serverErrorLight: return "\u{f769}"
        case .serverErrorRegular: return "\u{f76a}"
        case .serverLight: return "\u{f76b}"
        case .serverRegular: return "\u{f76c}"
        case .servicesBold: return "\u{f76d}"
        case .servicesLight: return "\u{f76e}"
        case .servicesRegular: return "\u{f76f}"
        case .setVariableBold: return "\u{f770}"
        case .setVariableLight: return "\u{f771}"
        case .setVariableRegular: return "\u{f772}"
        case .settingsBold: return "\u{f773}"
        case .settingsFilled: return "\u{f774}"
        case .settingsLight: return "\u{f775}"
        case .settingsRegular: return "\u{f776}"
        case .setupAssistantBold: return "\u{f777}"
        case .setupAssistantLight: return "\u{f778}"
        case .setupAssistantRegular: return "\u{f779}"
        case .shapeDiagonalLineBold: return "\u{f77a}"
        case .shapeDiagonalLineLight: return "\u{f77b}"
        case .shapeDiagonalLineRegular: return "\u{f77c}"
        case .shapeOvalBold: return "\u{f77d}"
        case .shapeOvalLight: return "\u{f77e}"
        case .shapeOvalRegular: return "\u{f77f}"
        case .shapesBold: return "\u{f780}"
        case .shapesLight: return "\u{f781}"
        case .shapesRegular: return "\u{f782}"
        case .shareCNativeAdrBold: return "\u{f783}"
        case .shareCNativeAdrLight: return "\u{f784}"
        case .shareCNativeAdrRegular: return "\u{f785}"
        case .shareCNativeIphBold: return "\u{f786}"
        case .shareCNativeIphLight: return "\u{f787}"
        case .shareCNativeIphRegular: return "\u{f788}"
        case .shareScreenBold: return "\u{f789}"
        case .shareScreenFilled: return "\u{f78a}"
        case .shareScreenLight: return "\u{f78b}"
        case .shareScreenRegular: return "\u{f78c}"
        case .shareScreenSmallFilled: return "\u{f78d}"
        case .shareSpaceBold: return "\u{f78e}"
        case .shareSpaceLight: return "\u{f78f}"
        case .shareSpaceRegular: return "\u{f790}"
        case .shieldBold: return "\u{f791}"
        case .shieldLight: return "\u{f792}"
        case .shieldRegular: return "\u{f793}"
        case .showBold: return "\u{f794}"
        case .showFilled: return "\u{f795}"
        case .showLight: return "\u{f796}"
        case .showRegular: return "\u{f797}"
        case .signInBold: return "\u{f798}"
        case .signInForcedBold: return "\u{f799}"
        case .signInForcedLight: return "\u{f79a}"
        case .signInForcedRegular: return "\u{f79b}"
        case .signInLight: return "\u{f79c}"
        case .signInRegular: return "\u{f79d}"
        case .signOutBold: return "\u{f79e}"
        case .signOutLight: return "\u{f79f}"
        case .signOutRegular: return "\u{f7a0}"
        case .signal0Bold: return "\u{f7a1}"
        case .signal0Light: return "\u{f7a2}"
        case .signal0Regular: return "\u{f7a3}"
        case .signal100Bold: return "\u{f7a4}"
        case .signal100Light: return "\u{f7a5}"
        case .signal100Regular: return "\u{f7a6}"
        case .signal25Bold: return "\u{f7a7}"
        case .signal25Light: return "\u{f7a8}"
        case .signal25Regular: return "\u{f7a9}"
        case .signal50Bold: return "\u{f7aa}"
        case .signal50Light: return "\u{f7ab}"
        case .signal50Regular: return "\u{f7ac}"
        case .signal75Bold: return "\u{f7ad}"
        case .signal75Light: return "\u{f7ae}"
        case .signal75Regular: return "\u{f7af}"
        case .singleNumberReachBold: return "\u{f7b0}"
        case .singleNumberReachLight: return "\u{f7b1}"
        case .singleNumberReachRegular: return "\u{f7b2}"
        case .sipRegistrationInProgressBold: return "\u{f7b3}"
        case .sipRegistrationInProgressFilled: return "\u{f7b4}"
        case .sipRegistrationInProgressLight: return "\u{f7b5}"
        case .sipRegistrationInProgressRegular: return "\u{f7b6}"
        case .skipBold: return "\u{f7b7}"
        case .skipBwBold: return "\u{f7b8}"
        case .skipBwFilled: return "\u{f7b9}"
        case .skipBwLight: return "\u{f7ba}"
        case .skipBwRegular: return "\u{f7bb}"
        case .skipFwBold: return "\u{f7bc}"
        case .skipFwFilled: return "\u{f7bd}"
        case .skipFwLight: return "\u{f7be}"
        case .skipFwRegular: return "\u{f7bf}"
        case .skipLight: return "\u{f7c0}"
        case .skipRegular: return "\u{f7c1}"
        case .speakerBold: return "\u{f7c2}"
        case .speakerDisconnectedBold: return "\u{f7c3}"
        case .speakerDisconnectedFilled: return "\u{f7c4}"
        case .speakerDisconnectedLight: return "\u{f7c5}"
        case .speakerDisconnectedRegular: return "\u{f7c6}"
        case .speakerFilled: return "\u{f7c7}"
        case .speakerLight: return "\u{f7c8}"
        case .speakerMutedBold: return "\u{f7c9}"
        case .speakerMutedFilled: return "\u{f7ca}"
        case .speakerMutedLight: return "\u{f7cb}"
        case .speakerMutedRegular: return "\u{f7cc}"
        case .speakerOffBold: return "\u{f7cd}"
        case .speakerOffFilled: return "\u{f7ce}"
        case .speakerOffLight: return "\u{f7cf}"
        case .speakerOffRegular: return "\u{f7d0}"
        case .speakerOnColoredBold: return "\u{f7d1}"
        case .speakerOnColoredLight: return "\u{f7d2}"
        case .speakerOnColoredRegular: return "\u{f7d3}"
        case .speakerRegular: return "\u{f7d4}"
        case .speakerTurnDownBold: return "\u{f7d5}"
        case .speakerTurnDownFilled: return "\u{f7d6}"
        case .speakerTurnDownLight: return "\u{f7d7}"
        case .speakerTurnDownRegular: return "\u{f7d8}"
        case .speakerTurnUpBold: return "\u{f7d9}"
        case .speakerTurnUpFilled: return "\u{f7da}"
        case .speakerTurnUpLight: return "\u{f7db}"
        case .speakerTurnUpRegular: return "\u{f7dc}"
        case .spinnerBold: return "\u{f7dd}"
        case .spinnerFilledBold: return "\u{f7de}"
        case .spinnerFilledLight: return "\u{f7df}"
        case .spinnerFilledRegular: return "\u{f7e0}"
        case .spinnerLight: return "\u{f7e1}"
        case .spinnerRegular: return "\u{f7e2}"
        case .stackedArea100ChartBold: return "\u{f7e3}"
        case .stackedArea100ChartFilled: return "\u{f7e4}"
        case .stackedArea100ChartLight: return "\u{f7e5}"
        case .stackedArea100ChartRegular: return "\u{f7e6}"
        case .stackedAreaChartBold: return "\u{f7e7}"
        case .stackedAreaChartFilled: return "\u{f7e8}"
        case .stackedAreaChartLight: return "\u{f7e9}"
        case .stackedAreaChartRegular: return "\u{f7ea}"
        case .stackedBar100ChartBold: return "\u{f7eb}"
        case .stackedBar100ChartFilled: return "\u{f7ec}"
        case .stackedBar100ChartLight: return "\u{f7ed}"
        case .stackedBar100ChartRegular: return "\u{f7ee}"
        case .stackedBarChartBold: return "\u{f7ef}"
        case .stackedBarChartFilled: return "\u{f7f0}"
        case .stackedBarChartLight: return "\u{f7f1}"
        case .stackedBarChartRegular: return "\u{f7f2}"
        case .startChatBold: return "\u{f7f3}"
        case .startChatLight: return "\u{f7f4}"
        case .startChatRegular: return "\u{f7f5}"
        case .stickersBold: return "\u{f7f6}"
        case .stickersLight: return "\u{f7f7}"
        case .stickersRegular: return "\u{f7f8}"
        case .stickiesBold: return "\u{f7f9}"
        case .stickiesLight: return "\u{f7fa}"
        case .stickiesRegular: return "\u{f7fb}"
        case .stopBold: return "\u{f7fc}"
        case .stopCircleBold: return "\u{f7fd}"
        case .stopCircleFilled: return "\u{f7fe}"
        case .stopCircleLight: return "\u{f7ff}"
        case .stopCircleRegular: return "\u{f800}"
        case .stopContentShareBold: return "\u{f801}"
        case .stopContentShareLight: return "\u{f802}"
        case .stopContentShareRegular: return "\u{f803}"
        case .stopFilled: return "\u{f804}"
        case .stopLight: return "\u{f805}"
        case .stopRegular: return "\u{f806}"
        case .storedInfoBold: return "\u{f807}"
        case .storedInfoFilled: return "\u{f808}"
        case .storedInfoLight: return "\u{f809}"
        case .storedInfoRegular: return "\u{f80a}"
        case .streamingBold: return "\u{f80b}"
        case .streamingLight: return "\u{f80c}"
        case .streamingRegular: return "\u{f80d}"
        case .strikethroughBold: return "\u{f80e}"
        case .strikethroughLight: return "\u{f80f}"
        case .strikethroughRegular: return "\u{f810}"
        case .subscriptBold: return "\u{f811}"
        case .subscriptLight: return "\u{f812}"
        case .subscriptRegular: return "\u{f813}"
        case .superscriptBold: return "\u{f814}"
        case .superscriptLight: return "\u{f815}"
        case .superscriptRegular: return "\u{f816}"
        case .sx10Bold: return "\u{f817}"
        case .sx10Light: return "\u{f818}"
        case .sx10Regular: return "\u{f819}"
        case .sx20Bold: return "\u{f81a}"
        case .sx20Light: return "\u{f81b}"
        case .sx20Regular: return "\u{f81c}"
        case .sx80CodecBold: return "\u{f81d}"
        case .sx80CodecLight: return "\u{f81e}"
        case .sx80CodecRegular: return "\u{f81f}"
        case .tableBold: return "\u{f820}"
        case .tableLight: return "\u{f821}"
        case .tableRegular: return "\u{f822}"
        case .tabletBold: return "\u{f823}"
        case .tabletLight: return "\u{f824}"
        case .tabletRegular: return "\u{f825}"
        case .tabsBold: return "\u{f826}"
        case .tabsLight: return "\u{f827}"
        case .tabsRegular: return "\u{f828}"
        case .tagBold: return "\u{f829}"
        case .tagLight: return "\u{f82a}"
        case .tagRegular: return "\u{f82b}"
        case .telepresenceAlertBold: return "\u{f82c}"
        case .telepresenceAlertLight: return "\u{f82d}"
        case .telepresenceAlertMutedBold: return "\u{f82e}"
        case .telepresenceAlertMutedLight: return "\u{f82f}"
        case .telepresenceAlertMutedRegular: return "\u{f830}"
        case .telepresenceAlertRegular: return "\u{f831}"
        case .telepresenceBold: return "\u{f832}"
        case .telepresenceIx5000Bold: return "\u{f833}"
        case .telepresenceIx5000Light: return "\u{f834}"
        case .telepresenceIx5000Regular: return "\u{f835}"
        case .telepresenceLight: return "\u{f836}"
        case .telepresencePrivateBold: return "\u{f837}"
        case .telepresencePrivateLight: return "\u{f838}"
        case .telepresencePrivateRegular: return "\u{f839}"
        case .telepresenceRegular: return "\u{f83a}"
        case .temperatureBold: return "\u{f83b}"
        case .temperatureLight: return "\u{f83c}"
        case .temperatureRegular: return "\u{f83d}"
        case .textBold: return "\u{f83e}"
        case .textCodeBlockBold: return "\u{f83f}"
        case .textCodeBlockLight: return "\u{f840}"
        case .textCodeBlockRegular: return "\u{f841}"
        case .textHighlightBold: return "\u{f842}"
        case .textHighlightLight: return "\u{f843}"
        case .textHighlightRegular: return "\u{f844}"
        case .textLight: return "\u{f845}"
        case .textRegular: return "\u{f846}"
        case .threeDObjectBold: return "\u{f847}"
        case .threeDObjectLight: return "\u{f848}"
        case .threeDObjectRegular: return "\u{f849}"
        case .tooFastBold: return "\u{f84a}"
        case .tooFastLight: return "\u{f84b}"
        case .tooFastRegular: return "\u{f84c}"
        case .tooSlowBold: return "\u{f84d}"
        case .tooSlowLight: return "\u{f84e}"
        case .tooSlowRegular: return "\u{f84f}"
        case .toolsBold: return "\u{f850}"
        case .toolsLight: return "\u{f851}"
        case .toolsRegular: return "\u{f852}"
        case .touch10Bold: return "\u{f853}"
        case .touch10Light: return "\u{f854}"
        case .touch10Regular: return "\u{f855}"
        case .transcriptBold: return "\u{f856}"
        case .transcriptLight: return "\u{f857}"
        case .transcriptRegular: return "\u{f858}"
        case .ucmCloudBold: return "\u{f859}"
        case .ucmCloudLight: return "\u{f85a}"
        case .ucmCloudRegular: return "\u{f85b}"
        case .underlineBold: return "\u{f85c}"
        case .underlineLight: return "\u{f85d}"
        case .underlineRegular: return "\u{f85e}"
        case .undoBold: return "\u{f85f}"
        case .undoLight: return "\u{f860}"
        case .undoRegular: return "\u{f861}"
        case .unlinkBold: return "\u{f862}"
        case .unlinkLight: return "\u{f863}"
        case .unlinkRegular: return "\u{f864}"
        case .unreadBold: return "\u{f865}"
        case .unreadFilled: return "\u{f866}"
        case .unreadLight: return "\u{f867}"
        case .unreadRegular: return "\u{f868}"
        case .unsecureUnlockedBold: return "\u{f869}"
        case .unsecureUnlockedFilled: return "\u{f86a}"
        case .unsecureUnlockedLight: return "\u{f86b}"
        case .unsecureUnlockedRegular: return "\u{f86c}"
        case .unsortedBold: return "\u{f86d}"
        case .unsortedLight: return "\u{f86e}"
        case .unsortedRegular: return "\u{f86f}"
        case .updateFileShareBold: return "\u{f870}"
        case .updateFileShareLight: return "\u{f871}"
        case .updateFileShareRegular: return "\u{f872}"
        case .uploadBold: return "\u{f873}"
        case .uploadLight: return "\u{f874}"
        case .uploadRegular: return "\u{f875}"
        case .usbBold: return "\u{f876}"
        case .usbHeadsetBold: return "\u{f877}"
        case .usbHeadsetLight: return "\u{f878}"
        case .usbHeadsetMutedBold: return "\u{f879}"
        case .usbHeadsetMutedLight: return "\u{f87a}"
        case .usbHeadsetMutedRegular: return "\u{f87b}"
        case .usbHeadsetRegular: return "\u{f87c}"
        case .usbLight: return "\u{f87d}"
        case .usbRegular: return "\u{f87e}"
        case .userBold: return "\u{f87f}"
        case .userLight: return "\u{f880}"
        case .userRegular: return "\u{f881}"
        case .vcsBold: return "\u{f882}"
        case .vcsLight: return "\u{f883}"
        case .vcsRegular: return "\u{f884}"
        case .videoBlurBold: return "\u{f885}"
        case .videoBlurFilled: return "\u{f886}"
        case .videoBlurLight: return "\u{f887}"
        case .videoBlurRegular: return "\u{f888}"
        case .videoBold: return "\u{f889}"
        case .videoEffectBold: return "\u{f88a}"
        case .videoEffectFilled: return "\u{f88b}"
        case .videoEffectLight: return "\u{f88c}"
        case .videoEffectRegular: return "\u{f88d}"
        case .videoFilled: return "\u{f88e}"
        case .videoLayoutBold: return "\u{f88f}"
        case .videoLayoutEqualBold: return "\u{f890}"
        case .videoLayoutEqualDualBold: return "\u{f891}"
        case .videoLayoutEqualDualLight: return "\u{f892}"
        case .videoLayoutEqualDualRegular: return "\u{f893}"
        case .videoLayoutEqualFilled: return "\u{f894}"
        case .videoLayoutEqualLight: return "\u{f895}"
        case .videoLayoutEqualRegular: return "\u{f896}"
        case .videoLayoutLight: return "\u{f897}"
        case .videoLayoutOverlayBold: return "\u{f898}"
        case .videoLayoutOverlayLight: return "\u{f899}"
        case .videoLayoutOverlayRegular: return "\u{f89a}"
        case .videoLayoutProminentBold: return "\u{f89b}"
        case .videoLayoutProminentLight: return "\u{f89c}"
        case .videoLayoutProminentRegular: return "\u{f89d}"
        case .videoLayoutRegular: return "\u{f89e}"
        case .videoLayoutShareDominantBold: return "\u{f89f}"
        case .videoLayoutShareDominantLight: return "\u{f8a0}"
        case .videoLayoutShareDominantRegular: return "\u{f8a1}"
        case .videoLayoutSingleBold: return "\u{f8a2}"
        case .videoLayoutSingleLight: return "\u{f8a3}"
        case .videoLayoutSingleRegular: return "\u{f8a4}"
        case .videoLayoutStackBold: return "\u{f8a5}"
        case .videoLayoutStackFilled: return "\u{f8a6}"
        case .videoLayoutStackLight: return "\u{f8a7}"
        case .videoLayoutStackRegular: return "\u{f8a8}"
        case .videoLayoutVideoDominantBold: return "\u{f8a9}"
        case .videoLayoutVideoDominantLight: return "\u{f8aa}"
        case .videoLayoutVideoDominantRegular: return "\u{f8ab}"
        case .videoLight: return "\u{f8ac}"
        case .videoPlusBold: return "\u{f8ad}"
        case .videoPlusFilled: return "\u{f8ae}"
        case .videoPlusLight: return "\u{f8af}"
        case .videoPlusRegular: return "\u{f8b0}"
        case .videoRegular: return "\u{f8b1}"
        case .videoSpeakerTrackBold: return "\u{f8b2}"
        case .videoSpeakerTrackFilled: return "\u{f8b3}"
        case .videoSpeakerTrackLight: return "\u{f8b4}"
        case .videoSpeakerTrackRegular: return "\u{f8b5}"
        case .viewAllBold: return "\u{f8b6}"
        case .viewAllLight: return "\u{f8b7}"
        case .viewAllRegular: return "\u{f8b8}"
        case .viewListBold: return "\u{f8b9}"
        case .viewListLight: return "\u{f8ba}"
        case .viewListRegular: return "\u{f8bb}"
        case .viewStackedBold: return "\u{f8bc}"
        case .viewStackedLight: return "\u{f8bd}"
        case .viewStackedRegular: return "\u{f8be}"
        case .viewThumbnailBold: return "\u{f8bf}"
        case .viewThumbnailLight: return "\u{f8c0}"
        case .viewThumbnailRegular: return "\u{f8c1}"
        case .voicemailBold: return "\u{f8c2}"
        case .voicemailFilled: return "\u{f8c3}"
        case .voicemailLight: return "\u{f8c4}"
        case .voicemailRegular: return "\u{f8c5}"
        case .wallpaperBold: return "\u{f8c6}"
        case .wallpaperLight: return "\u{f8c7}"
        case .wallpaperRegular: return "\u{f8c8}"
        case .warningBold: return "\u{f8c9}"
        case .warningFilled: return "\u{f8ca}"
        case .warningLight: return "\u{f8cb}"
        case .warningRegular: return "\u{f8cc}"
        case .webexBoardBold: return "\u{f8cd}"
        case .webexBoardLight: return "\u{f8ce}"
        case .webexBoardRegular: return "\u{f8cf}"
        case .webexCodecPlusBold: return "\u{f8d0}"
        case .webexCodecPlusLight: return "\u{f8d1}"
        case .webexCodecPlusRegular: return "\u{f8d2}"
        case .webexDeskCameraBold: return "\u{f8d3}"
        case .webexDeskCameraLight: return "\u{f8d4}"
        case .webexDeskCameraRegular: return "\u{f8d5}"
        case .webexHelixFilled: return "\u{f8d6}"
        case .webexMeetingsBold: return "\u{f8d7}"
        case .webexMeetingsFilled: return "\u{f8d8}"
        case .webexMeetingsLight: return "\u{f8d9}"
        case .webexMeetingsRegular: return "\u{f8da}"
        case .webexQuadCameraBold: return "\u{f8db}"
        case .webexQuadCameraLight: return "\u{f8dc}"
        case .webexQuadCameraRegular: return "\u{f8dd}"
        case .webexRoomKitBold: return "\u{f8de}"
        case .webexRoomKitLight: return "\u{f8df}"
        case .webexRoomKitPlusBold: return "\u{f8e0}"
        case .webexRoomKitPlusLight: return "\u{f8e1}"
        case .webexRoomKitPlusRegular: return "\u{f8e2}"
        case .webexRoomKitRegular: return "\u{f8e3}"
        case .webexShareBold: return "\u{f8e4}"
        case .webexShareLight: return "\u{f8e5}"
        case .webexShareRegular: return "\u{f8e6}"
        case .webexTeamsBold: return "\u{f8e7}"
        case .webexTeamsFilled: return "\u{f8e8}"
        case .webexTeamsLight: return "\u{f8e9}"
        case .webexTeamsNewBold: return "\u{f8ea}"
        case .webexTeamsNewFilled: return "\u{f8eb}"
        case .webexTeamsNewLight: return "\u{f8ec}"
        case .webexTeamsNewRegular: return "\u{f8ed}"
        case .webexTeamsRegular: return "\u{f8ee}"
        case .whiteboardBold: return "\u{f8ef}"
        case .whiteboardContentBold: return "\u{f8f0}"
        case .whiteboardContentLight: return "\u{f8f1}"
        case .whiteboardContentRegular: return "\u{f8f2}"
        case .whiteboardFilled: return "\u{f8f3}"
        case .whiteboardLight: return "\u{f8f4}"
        case .whiteboardRegular: return "\u{f8f5}"
        case .widgetBold: return "\u{f8f6}"
        case .widgetFilled: return "\u{f8f7}"
        case .widgetLight: return "\u{f8f8}"
        case .widgetRegular: return "\u{f8f9}"
        case .wifiBold: return "\u{f8fa}"
        case .wifiErrorBold: return "\u{f8fb}"
        case .wifiErrorLight: return "\u{f8fc}"
        case .wifiErrorRegular: return "\u{f8fd}"
        case .wifiLight: return "\u{f8fe}"
        case .wifiRegular: return "\u{f8ff}"
        case .windowCornerScrubBold: return "\u{f900}"
        case .windowCornerScrubLight: return "\u{f901}"
        case .windowCornerScrubRegular: return "\u{f902}"
        case .windowVerticalScrubBold: return "\u{f903}"
        case .windowVerticalScrubLight: return "\u{f904}"
        case .windowVerticalScrubRegular: return "\u{f905}"
        case .workphoneBold: return "\u{f906}"
        case .workphoneLight: return "\u{f907}"
        case .workphoneRegular: return "\u{f908}"
        case .zoomInBold: return "\u{f909}"
        case .zoomInLight: return "\u{f90a}"
        case .zoomInRegular: return "\u{f90b}"
        case .zoomOutBold: return "\u{f90c}"
        case .zoomOutLight: return "\u{f90d}"
        case .zoomOutRegular: return "\u{f90e}"
