  ...
  _proto.render = function render() {
    ...
    var chosenItem = function chosenItem() {
      if (failedText && type === 'chat') {
        ...
        return _react.default.createElement(_ChatContent.default, _extends({
        ...
        return _react.default.createElement(_FileContent.default, _extends({
          actionNode: actionNode,
          aspect: aspect ? aspect : findAspect(width, height),
          className: className,
          content: content,
        ...
        return _react.default.createElement(_IconContent.default, _extends({
          actionNode: actionNode,
          className: className,
          icon: icon,
          isProtected: isProtected,
    ...
    return _react.default.createElement("div", null, chosenItem());
  };
