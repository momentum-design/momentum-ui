            ...
            export default class CoreExample extends React.Component {
              ...
              // Disabled to ignore Dangerously Setting Inner HTML
                ...
                return <div dangerouslySetInnerHTML={{__html: ` <div class="input-states">
<div class="input-states medium-3 columns">
  <h3>Default</h3>
  <h5><code>.cui-input</code></h5>
...
<div class="input-states medium-3 columns cui--dark" style="background-color: #333333;">
...
<div class="medium-1 columns"></div>
<div class="input-states medium-3 columns cui--contrast">
  <h3>Contrast</h3>
  <h5><code>.cui--contrast</code></h5>
  <div class="default-state">
    <div class="cui-input-group">
      <label class="cui-label" for="default">Normal</label>
      <input class="cui-input" id="default" name="default" type="text" placeholder="Placeholder Text">
...
<div class="input-states medium-3 columns cui--contrast" style="background-color: #333333;">
  <div class=" cui--dark">
    <h3 style="color: white;">Dark Contrast</h3>
    <h5><code style="color: white; line-break">.cui--contrast .cui--dark</code></h5>
    <div class="default-state">
      <div class="cui-input-group">
        <label class="cui-label" for="default">Normal</label>
        <input class="cui-input" id="default" name="default" type="text" placeholder="Placeholder Text">
