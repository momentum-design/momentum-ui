...
@objc public enum MomentumIconType: Int {
    ...
    public var ligature: String {
        ...
        case .pdf12: return "\u{f763}"
        case .pdf28: return "\u{f764}"
        case .pdf44: return "\u{f765}"
        case .pdf72: return "\u{f766}"
        ...
        case .secureFips24: return "\u{f8bd}"
        case .selfview16: return "\u{f8be}"
        case .selfview20: return "\u{f8bf}"
        case .selfview24: return "\u{f8c0}"
        case .send12: return "\u{f8c1}"
        case .send14: return "\u{f8c2}"
        case .send16: return "\u{f8c3}"
        case .send20: return "\u{f8c4}"
        case .send24: return "\u{f8c5}"
        case .seperate12: return "\u{f8c6}"
        case .seperate16: return "\u{f8c7}"
        case .seperate20: return "\u{f8c8}"
        case .seperate24: return "\u{f8c9}"
        case .server16: return "\u{f8ca}"
        case .server24: return "\u{f8cb}"
        case .serverCircle100: return "\u{f8cc}"
        case .serverError16: return "\u{f8cd}"
        case .serverProblem16: return "\u{f8ce}"
        ...
        case .tasks10: return "\u{f99e}"
        case .tasks12: return "\u{f99f}"
        case .tasks14: return "\u{f9a0}"
        case .tasks16: return "\u{f9a1}"
        case .tasks18: return "\u{f9a2}"
        case .tasks20: return "\u{f9a3}"
        case .tasks24: return "\u{f9a4}"
        case .tasks26: return "\u{f9a5}"
        case .tasks28: return "\u{f9a6}"
        case .tasks32: return "\u{f9a7}"
        case .tasks36: return "\u{f9a8}"
        case .tasks8: return "\u{f9a9}"
        case .team12: return "\u{f9aa}"
        case .team14: return "\u{f9ab}"
        case .team16: return "\u{f9ac}"
        case .team18: return "\u{f9ad}"
        case .team20: return "\u{f9ae}"
        case .team24: return "\u{f9af}"
        case .team32: return "\u{f9b0}"
        case .teamActive12: return "\u{f9b1}"
        case .teamActive14: return "\u{f9b2}"
        case .teamActive16: return "\u{f9b3}"
        case .teamActive18: return "\u{f9b4}"
        case .teamActive20: return "\u{f9b5}"
        case .teamActive24: return "\u{f9b6}"
        case .teamActive32: return "\u{f9b7}"
        case .telepresence12: return "\u{f9b8}"
        case .telepresence16: return "\u{f9b9}"
        case .telepresence18: return "\u{f9ba}"
        case .telepresence20: return "\u{f9bb}"
        case .telepresence24: return "\u{f9bc}"
        case .telepresence64: return "\u{f9bd}"
        case .telepresenceAlert12: return "\u{f9be}"
        case .telepresenceIx500016: return "\u{f9bf}"
        case .telepresenceIx500020: return "\u{f9c0}"
        case .telepresenceMuted12: return "\u{f9c1}"
        case .telepresenceMuted64: return "\u{f9c2}"
        case .telepresenceMutedAlert12: return "\u{f9c3}"
        case .telepresencePrivate12: return "\u{f9c4}"
        case .text10: return "\u{f9c5}"
        case .text12: return "\u{f9c6}"
        case .text16: return "\u{f9c7}"
        case .textAlignLeft16: return "\u{f9c8}"
        case .textAlignRight16: return "\u{f9c9}"
        case .textBlockquote12: return "\u{f9ca}"
        case .textBlockquote16: return "\u{f9cb}"
        case .textBlockquote18: return "\u{f9cc}"
        case .textBlockquote20: return "\u{f9cd}"
        case .textBlockquote8: return "\u{f9ce}"
        case .textBlockquoteRounded20: return "\u{f9cf}"
        case .textBold12: return "\u{f9d0}"
        case .textBold16: return "\u{f9d1}"
        case .textCodeBlock12: return "\u{f9d2}"
        case .textCodeBlock16: return "\u{f9d3}"
        case .textColor16: return "\u{f9d4}"
        case .textFormat10: return "\u{f9d5}"
        case .textFormat12: return "\u{f9d6}"
        case .textFormat16: return "\u{f9d7}"
        case .textFormat20: return "\u{f9d8}"
        case .textFormat24: return "\u{f9d9}"
        case .textFormat8: return "\u{f9da}"
        case .textHeading112: return "\u{f9db}"
        case .textHeading116: return "\u{f9dc}"
        case .textHeading212: return "\u{f9dd}"
        case .textHeading216: return "\u{f9de}"
        case .textHeading312: return "\u{f9df}"
        case .textHeading316: return "\u{f9e0}"
        case .textItalic12: return "\u{f9e1}"
        case .textItalic16: return "\u{f9e2}"
        case .textListBulleted10: return "\u{f9e3}"
        case .textListBulleted12: return "\u{f9e4}"
        case .textListBulleted16: return "\u{f9e5}"
        case .textListBulleted8: return "\u{f9e6}"
        case .textListNumbered12: return "\u{f9e7}"
        case .textListNumbered16: return "\u{f9e8}"
        case .textListNumbered36: return "\u{f9e9}"
        case .textListNumbered40: return "\u{f9ea}"
        case .textStrikethrough16: return "\u{f9eb}"
        case .textTable16: return "\u{f9ec}"
        case .textUnderline12: return "\u{f9ed}"
        case .textUnderline16: return "\u{f9ee}"
        case .tooFast12: return "\u{f9ef}"
        case .tooFast16: return "\u{f9f0}"
        case .tooSlow12: return "\u{f9f1}"
        case .tooSlow16: return "\u{f9f2}"
        case .tools16: return "\u{f9f3}"
        case .tools20: return "\u{f9f4}"
        case .tools24: return "\u{f9f5}"
        case .tools32: return "\u{f9f6}"
        case .touch16: return "\u{f9f7}"
        case .touch1024: return "\u{f9f8}"
        case .transcript16: return "\u{f9f9}"
        case .twitter16: return "\u{f9fa}"
        case .twitterCircle24: return "\u{f9fb}"
        case .twitterCircle32: return "\u{f9fc}"
        case .twitterCircle40: return "\u{f9fd}"
        case .ucmCloud16: return "\u{f9fe}"
        case .ucmCloud24: return "\u{f9ff}"
        case .ucmCloud32: return "\u{fa00}"
        case .undo12: return "\u{fa01}"
        case .undo14: return "\u{fa02}"
        case .undo16: return "\u{fa03}"
        case .undo24: return "\u{fa04}"
        case .unlink20: return "\u{fa05}"
        case .unreadBadge10: return "\u{fa06}"
        case .unreadBadge12: return "\u{fa07}"
        case .unreadBadge16: return "\u{fa08}"
        case .unreadBadge8: return "\u{fa09}"
        case .unsecure12: return "\u{fa0a}"
        case .unsecure14: return "\u{fa0b}"
        case .unsecure16: return "\u{fa0c}"
        case .unsecure24: return "\u{fa0d}"
        case .unsecure28: return "\u{fa0e}"
        case .upload12: return "\u{fa0f}"
        case .upload130: return "\u{fa10}"
        case .upload14: return "\u{fa11}"
        case .upload16: return "\u{fa12}"
        case .upload18: return "\u{fa13}"
        case .upload20: return "\u{fa14}"
        case .upload24: return "\u{fa15}"
        case .upload28: return "\u{fa16}"
        case .upload32: return "\u{fa17}"
        case .upload36: return "\u{fa18}"
        case .usb16: return "\u{fa19}"
        case .user16: return "\u{fa1a}"
        case .user20: return "\u{fa1b}"
        case .user24: return "\u{fa1c}"
        case .user56: return "\u{fa1d}"
        case .videoEffect12: return "\u{fa1e}"
        case .videoLayout12: return "\u{fa1f}"
        case .videoLayout16: return "\u{fa20}"
        case .videoLayoutAuto12: return "\u{fa21}"
        case .videoLayoutAuto16: return "\u{fa22}"
        case .videoLayoutAuto20: return "\u{fa23}"
        case .videoLayoutAuto24: return "\u{fa24}"
        case .videoLayoutEqual12: return "\u{fa25}"
        case .videoLayoutEqual14: return "\u{fa26}"
        case .videoLayoutEqual16: return "\u{fa27}"
        case .videoLayoutEqual20: return "\u{fa28}"
        case .videoLayoutEqual24: return "\u{fa29}"
        case .videoLayoutOverlay12: return "\u{fa2a}"
        case .videoLayoutOverlay16: return "\u{fa2b}"
        case .videoLayoutOverlay20: return "\u{fa2c}"
        case .videoLayoutOverlay24: return "\u{fa2d}"
        case .videoLayoutProminent12: return "\u{fa2e}"
        case .videoLayoutProminent16: return "\u{fa2f}"
        case .videoLayoutProminent20: return "\u{fa30}"
        case .videoLayoutProminent24: return "\u{fa31}"
        case .videoLayoutShareDominant12: return "\u{fa32}"
        case .videoLayoutShareDominant16: return "\u{fa33}"
        case .videoLayoutShareDominant20: return "\u{fa34}"
        case .videoLayoutShareDominant24: return "\u{fa35}"
        case .videoLayoutSingle16: return "\u{fa36}"
        case .videoLayoutSingle20: return "\u{fa37}"
        case .videoLayoutVideoDominant12: return "\u{fa38}"
        case .videoLayoutVideoDominant16: return "\u{fa39}"
        case .videoLayoutVideoDominant20: return "\u{fa3a}"
        case .videoLayoutVideoDominant24: return "\u{fa3b}"
        case .viewAll12: return "\u{fa3c}"
        case .viewAll14: return "\u{fa3d}"
        case .viewFeedMultiple16: return "\u{fa3e}"
        case .viewFeedPanel16: return "\u{fa3f}"
        case .viewFeedSingle16: return "\u{fa40}"
        case .viewList10: return "\u{fa41}"
        case .viewList12: return "\u{fa42}"
        case .viewList14: return "\u{fa43}"
        case .viewList16: return "\u{fa44}"
        case .viewList20: return "\u{fa45}"
        case .viewList24: return "\u{fa46}"
        case .viewList28: return "\u{fa47}"
        case .viewListCircle100: return "\u{fa48}"
        case .viewMixed12: return "\u{fa49}"
        case .viewStack12: return "\u{fa4a}"
        case .viewStack14: return "\u{fa4b}"
        case .viewStack20: return "\u{fa4c}"
        case .viewStack24: return "\u{fa4d}"
        case .viewThumbnail12: return "\u{fa4e}"
        case .viewThumbnail14: return "\u{fa4f}"
        case .viewThumbnail16: return "\u{fa50}"
        case .viewThumbnail20: return "\u{fa51}"
        case .viewThumbnail24: return "\u{fa52}"
        case .voicemail10: return "\u{fa53}"
        case .voicemail14: return "\u{fa54}"
        case .voicemail16: return "\u{fa55}"
        case .voicemail18: return "\u{fa56}"
        case .voicemail20: return "\u{fa57}"
        case .voicemail24: return "\u{fa58}"
        case .voicemail28: return "\u{fa59}"
        case .voicemail8: return "\u{fa5a}"
        case .voicemailActive12: return "\u{fa5b}"
        case .voicemailActive14: return "\u{fa5c}"
        case .voicemailActive16: return "\u{fa5d}"
        case .voicemailActive18: return "\u{fa5e}"
        case .voicemailActive20: return "\u{fa5f}"
        case .voicemailActive24: return "\u{fa60}"
        case .voicemailActive28: return "\u{fa61}"
        case .wallpaper16: return "\u{fa62}"
        case .wallpaper20: return "\u{fa63}"
        case .wallpaper24: return "\u{fa64}"
        case .wallpaper28: return "\u{fa65}"
        case .wallpaper32: return "\u{fa66}"
        case .warning100: return "\u{fa67}"
        case .warning12: return "\u{fa68}"
        case .warning14: return "\u{fa69}"
        case .warning16: return "\u{fa6a}"
        case .warning20: return "\u{fa6b}"
        case .warning24: return "\u{fa6c}"
        case .warning28: return "\u{fa6d}"
        case .warning32: return "\u{fa6e}"
        case .warning40: return "\u{fa6f}"
        case .warning44: return "\u{fa70}"
        case .warning56: return "\u{fa71}"
        case .warning64: return "\u{fa72}"
        case .warning72: return "\u{fa73}"
        case .webSharing16: return "\u{fa74}"
        case .webSharing24: return "\u{fa75}"
        case .webex10: return "\u{fa76}"
        case .webex16: return "\u{fa77}"
        case .webex24: return "\u{fa78}"
        case .webex48: return "\u{fa79}"
        case .webexBoard12: return "\u{fa7a}"
        case .webexBoard14: return "\u{fa7b}"
        case .webexBoard16: return "\u{fa7c}"
        case .webexBoard20: return "\u{fa7d}"
        case .webexBoard24: return "\u{fa7e}"
        case .webexBoard28: return "\u{fa7f}"
        case .webexBoard32: return "\u{fa80}"
        case .webexBoard48: return "\u{fa81}"
        case .webexCalling10: return "\u{fa82}"
        case .webexCalling12: return "\u{fa83}"
        case .webexCalling16: return "\u{fa84}"
        case .webexCalling18: return "\u{fa85}"
        case .webexCalling20: return "\u{fa86}"
        case .webexCalling24: return "\u{fa87}"
        case .webexCodecPlus16: return "\u{fa88}"
        case .webexCodecPlus20: return "\u{fa89}"
        case .webexInstantMeeting12: return "\u{fa8a}"
        case .webexInstantMeeting14: return "\u{fa8b}"
        case .webexInstantMeeting16: return "\u{fa8c}"
        case .webexInstantMeeting20: return "\u{fa8d}"
        case .webexInstantMeeting24: return "\u{fa8e}"
        case .webexMeetings10: return "\u{fa8f}"
        case .webexMeetings12: return "\u{fa90}"
        case .webexMeetings14: return "\u{fa91}"
        case .webexMeetings16: return "\u{fa92}"
        case .webexMeetings20: return "\u{fa93}"
        case .webexMeetings24: return "\u{fa94}"
        case .webexMeetings48: return "\u{fa95}"
        case .webexQuadCamera16: return "\u{fa96}"
        case .webexQuadCamera20: return "\u{fa97}"
        case .webexRoomKit16: return "\u{fa98}"
        case .webexRoomKit20: return "\u{fa99}"
        case .webexRoomKitPlus16: return "\u{fa9a}"
        case .webexRoomKitPlus20: return "\u{fa9b}"
        case .webexShare12: return "\u{fa9c}"
        case .webexShare14: return "\u{fa9d}"
        case .webexShare16: return "\u{fa9e}"
        case .webexShare20: return "\u{fa9f}"
        case .webexTeams10: return "\u{faa0}"
        case .webexTeams12: return "\u{faa1}"
        case .webexTeams14: return "\u{faa2}"
        case .webexTeams16: return "\u{faa3}"
        case .webexTeams18: return "\u{faa4}"
        case .webexTeams20: return "\u{faa5}"
        case .webexVoice16: return "\u{faa6}"
        case .webexVoice20: return "\u{faa7}"
        case .webpop12: return "\u{faa8}"
        case .webpop16: return "\u{faa9}"
        case .webpop20: return "\u{faaa}"
        case .webpop24: return "\u{faab}"
        case .whiteboard10: return "\u{faac}"
        case .whiteboard12: return "\u{faad}"
        case .whiteboard14: return "\u{faae}"
        case .whiteboard16: return "\u{faaf}"
        case .whiteboard20: return "\u{fab0}"
        case .whiteboard24: return "\u{fab1}"
        case .whiteboard26: return "\u{fab2}"
        case .whiteboard28: return "\u{fab3}"
        case .whiteboard32: return "\u{fab4}"
        case .whiteboard36: return "\u{fab5}"
        case .whiteboard8: return "\u{fab6}"
        case .whiteboardContent16: return "\u{fab7}"
        case .whiteboardContent24: return "\u{fab8}"
        case .widgetsAdr20: return "\u{fab9}"
        case .wifi12: return "\u{faba}"
        case .wifi16: return "\u{fabb}"
        case .wifi20: return "\u{fabc}"
        case .wifi24: return "\u{fabd}"
        case .wifiError12: return "\u{fabe}"
        case .wifiError16: return "\u{fabf}"
        case .wikipedia16: return "\u{fac0}"
        case .windowCornerScrub16: return "\u{fac1}"
        case .windowVerticalScrub16: return "\u{fac2}"
        case .youtubeCircle24: return "\u{fac3}"
        case .youtubeCircle32: return "\u{fac4}"
        case .youtubeCircle40: return "\u{fac5}"
        case .zoomIn12: return "\u{fac6}"
        case .zoomIn14: return "\u{fac7}"
        case .zoomIn16: return "\u{fac8}"
        case .zoomIn20: return "\u{fac9}"
        case .zoomOut12: return "\u{faca}"
        case .zoomOut14: return "\u{facb}"
        case .zoomOut16: return "\u{facc}"
        case .zoomOut20: return "\u{facd}"
