...
@objc public enum MomentumIconType: Int {
    ...
    public var ligature: String {
        ...
        case .remoteDesktopControl12: return "\u{f995}"
        case .remoteDesktopControl14: return "\u{f996}"
        case .remoteDesktopControl16: return "\u{f997}"
        case .remove12: return "\u{f998}"
        case .remove16: return "\u{f999}"
        case .remove20: return "\u{f99a}"
        case .remove24: return "\u{f99b}"
        case .reply10: return "\u{f99c}"
        case .reply12: return "\u{f99d}"
        case .reply16: return "\u{f99e}"
        case .reply20: return "\u{f99f}"
        case .reply24: return "\u{f9a0}"
        case .replyList12: return "\u{f9a1}"
        case .replyList16: return "\u{f9a2}"
        case .replyList20: return "\u{f9a3}"
        case .report16: return "\u{f9a4}"
        case .report28: return "\u{f9a5}"
        case .reset16: return "\u{f9a6}"
        case .reset24: return "\u{f9a7}"
        case .response16: return "\u{f9a8}"
        case .responsiveMobile16: return "\u{f9a9}"
        case .return12: return "\u{f9aa}"
        case .return16: return "\u{f9ab}"
        case .ringtone16: return "\u{f9ac}"
        case .ringtone24: return "\u{f9ad}"
        case .roomCalendar24: return "\u{f9ae}"
        case .roomLights16: return "\u{f9af}"
        case .roomLights24: return "\u{f9b0}"
        case .rotateContent24: return "\u{f9b1}"
        case .rssCircle24: return "\u{f9b2}"
        case .rssCircle32: return "\u{f9b3}"
        case .rssCircle40: return "\u{f9b4}"
        case .runningApplication16: return "\u{f9b5}"
        case .runningApplication24: return "\u{f9b6}"
        case .save12: return "\u{f9b7}"
        case .save14: return "\u{f9b8}"
        case .save16: return "\u{f9b9}"
        case .save24: return "\u{f9ba}"
        case .scan20: return "\u{f9bb}"
        case .scan24: return "\u{f9bc}"
        case .screenToggle10: return "\u{f9bd}"
        case .screenToggle12: return "\u{f9be}"
        case .screenToggle16: return "\u{f9bf}"
        case .screenToggle20: return "\u{f9c0}"
        case .screenToggle24: return "\u{f9c1}"
        case .screenshot12: return "\u{f9c2}"
        case .screenshot16: return "\u{f9c3}"
        case .screenshot20: return "\u{f9c4}"
        case .screenshot24: return "\u{f9c5}"
        case .search12: return "\u{f9c6}"
        case .search14: return "\u{f9c7}"
        case .search16: return "\u{f9c8}"
        case .search18: return "\u{f9c9}"
        case .search20: return "\u{f9ca}"
        case .search24: return "\u{f9cb}"
        case .search28: return "\u{f9cc}"
        case .secure12: return "\u{f9cd}"
        case .secure14: return "\u{f9ce}"
        case .secure16: return "\u{f9cf}"
        case .secure20: return "\u{f9d0}"
        case .secure24: return "\u{f9d1}"
        case .secure28: return "\u{f9d2}"
        case .secure8: return "\u{f9d3}"
        case .secureActive12: return "\u{f9d4}"
        case .secureActive14: return "\u{f9d5}"
        case .secureActive16: return "\u{f9d6}"
        case .secureActive20: return "\u{f9d7}"
        case .secureActive24: return "\u{f9d8}"
        case .secureActive28: return "\u{f9d9}"
        case .secureActive8: return "\u{f9da}"
        case .secureBadge28: return "\u{f9db}"
        case .secureCircle14: return "\u{f9dc}"
        case .secureCircle16: return "\u{f9dd}"
        case .secureCircleActive14: return "\u{f9de}"
        case .secureCircleActive16: return "\u{f9df}"
        case .secureFips24: return "\u{f9e0}"
        case .selfview16: return "\u{f9e1}"
        case .selfview20: return "\u{f9e2}"
        case .selfview24: return "\u{f9e3}"
        case .send12: return "\u{f9e4}"
        case .send14: return "\u{f9e5}"
        case .send16: return "\u{f9e6}"
        case .send20: return "\u{f9e7}"
        case .send24: return "\u{f9e8}"
        case .seperate12: return "\u{f9e9}"
        case .seperate16: return "\u{f9ea}"
        case .seperate20: return "\u{f9eb}"
        case .seperate24: return "\u{f9ec}"
        case .server16: return "\u{f9ed}"
        case .server24: return "\u{f9ee}"
        case .serverCircle100: return "\u{f9ef}"
        case .serverError16: return "\u{f9f0}"
        case .setVariable16: return "\u{f9f1}"
        case .setVariable20: return "\u{f9f2}"
        case .settings10: return "\u{f9f3}"
        case .settings12: return "\u{f9f4}"
        case .settings14: return "\u{f9f5}"
        case .settings16: return "\u{f9f6}"
        case .settings18: return "\u{f9f7}"
        case .settings20: return "\u{f9f8}"
        case .settings24: return "\u{f9f9}"
        case .settings32: return "\u{f9fa}"
        case .settings8: return "\u{f9fb}"
        case .settingsActive10: return "\u{f9fc}"
        case .settingsActive12: return "\u{f9fd}"
        case .settingsActive14: return "\u{f9fe}"
        case .settingsActive16: return "\u{f9ff}"
        case .settingsActive18: return "\u{fa00}"
        case .settingsActive20: return "\u{fa01}"
        case .settingsActive24: return "\u{fa02}"
        case .settingsActive32: return "\u{fa03}"
        case .settingsActive8: return "\u{fa04}"
        case .setupAssistant16: return "\u{fa05}"
        case .shakeDevice18: return "\u{fa06}"
        case .shakeDevice20: return "\u{fa07}"
        case .shapeDiagonalArrowheadDual16: return "\u{fa08}"
        case .shapeDiagonalArrowheadSingle16: return "\u{fa09}"
        case .shapeDiagonalLine16: return "\u{fa0a}"
        case .shapeOval16: return "\u{fa0b}"
        case .shapeSquare16: return "\u{fa0c}"
        case .share12: return "\u{fa0d}"
        case .share14: return "\u{fa0e}"
        case .share16: return "\u{fa0f}"
        case .share18: return "\u{fa10}"
        case .share20: return "\u{fa11}"
        case .share24: return "\u{fa12}"
        case .share28: return "\u{fa13}"
        case .share32: return "\u{fa14}"
        case .shareCNativeAdr12: return "\u{fa15}"
        case .shareCNativeAdr14: return "\u{fa16}"
        case .shareCNativeAdr16: return "\u{fa17}"
        case .shareCNativeAdr24: return "\u{fa18}"
        case .shareCNativeIos10: return "\u{fa19}"
        case .shareCNativeIos12: return "\u{fa1a}"
        case .shareCNativeIos14: return "\u{fa1b}"
        case .shareCNativeIos16: return "\u{fa1c}"
        case .shareCNativeIos20: return "\u{fa1d}"
        case .shareCNativeIos28: return "\u{fa1e}"
        case .shareCNativeIph10: return "\u{fa1f}"
        case .shareCNativeIph12: return "\u{fa20}"
        case .shareCNativeIph14: return "\u{fa21}"
        case .shareCNativeIph16: return "\u{fa22}"
        case .shareCNativeIph20: return "\u{fa23}"
        case .shareCNativeIph24: return "\u{fa24}"
        case .shareCNativeIph28: return "\u{fa25}"
        case .shareScreen10: return "\u{fa26}"
        case .shareScreen12: return "\u{fa27}"
        case .shareScreen120: return "\u{fa28}"
        case .shareScreen124: return "\u{fa29}"
        case .shareScreen14: return "\u{fa2a}"
        case .shareScreen16: return "\u{fa2b}"
        case .shareScreen18: return "\u{fa2c}"
        case .shareScreen20: return "\u{fa2d}"
        case .shareScreen24: return "\u{fa2e}"
        case .shareScreen26: return "\u{fa2f}"
        case .shareScreen28: return "\u{fa30}"
        case .shareScreen32: return "\u{fa31}"
        case .shareScreen36: return "\u{fa32}"
        case .shareScreen48: return "\u{fa33}"
        case .shareScreen56: return "\u{fa34}"
        case .shareScreen8: return "\u{fa35}"
        case .shareScreenActive14: return "\u{fa36}"
        case .shareScreenActive24: return "\u{fa37}"
        case .shareScreenPresence12: return "\u{fa38}"
        case .shareScreenPresence14: return "\u{fa39}"
        case .shareScreenPresence28: return "\u{fa3a}"
        case .shareScreenPresence8: return "\u{fa3b}"
        case .shareScreenPresenceStroke12: return "\u{fa3c}"
        case .shareScreenPresenceStroke14: return "\u{fa3d}"
        case .shareScreenPresenceStroke16: return "\u{fa3e}"
        case .shareScreenPresenceStroke26: return "\u{fa3f}"
        case .shareScreenPresenceStroke30: return "\u{fa40}"
        case .shareSpace12: return "\u{fa41}"
        case .shareSpace14: return "\u{fa42}"
        case .shareSpace18: return "\u{fa43}"
        case .shareSpace20: return "\u{fa44}"
        case .shareSpace24: return "\u{fa45}"
        case .shield12: return "\u{fa46}"
        case .shield14: return "\u{fa47}"
        case .shield20: return "\u{fa48}"
        case .shield24: return "\u{fa49}"
        case .show12: return "\u{fa4a}"
        case .show16: return "\u{fa4b}"
        case .show20: return "\u{fa4c}"
        case .show24: return "\u{fa4d}"
        case .signIn16: return "\u{fa4e}"
        case .signIn20: return "\u{fa4f}"
        case .signIn24: return "\u{fa50}"
        case .signInForced16: return "\u{fa51}"
        case .signInForced24: return "\u{fa52}"
        case .signOut10: return "\u{fa53}"
        case .signOut12: return "\u{fa54}"
        case .signOut16: return "\u{fa55}"
        case .signOut20: return "\u{fa56}"
        case .signOut24: return "\u{fa57}"
        case .signal016: return "\u{fa58}"
        case .signal10012: return "\u{fa59}"
        case .signal10016: return "\u{fa5a}"
        case .signal2516: return "\u{fa5b}"
        case .signal5016: return "\u{fa5c}"
        case .signal7516: return "\u{fa5d}"
        case .singleNumberReach12: return "\u{fa5e}"
        case .singleNumberReach14: return "\u{fa5f}"
        case .singleNumberReach16: return "\u{fa60}"
        case .singleNumberReach20: return "\u{fa61}"
        case .skip10: return "\u{fa62}"
        case .skip16: return "\u{fa63}"
        case .skip24: return "\u{fa64}"
        case .skipBw16: return "\u{fa65}"
        case .skipBw24: return "\u{fa66}"
        case .skipFw16: return "\u{fa67}"
        case .skipFw24: return "\u{fa68}"
        case .sms16: return "\u{fa69}"
        case .sortDown16: return "\u{fa6a}"
        case .sortDown20: return "\u{fa6b}"
        case .sortDown24: return "\u{fa6c}"
        case .sortUp20: return "\u{fa6d}"
        case .sortUp24: return "\u{fa6e}"
        case .space12: return "\u{fa6f}"
        case .space16: return "\u{fa70}"
        case .spark16: return "\u{fa71}"
        case .sparkBoard12: return "\u{fa72}"
        case .sparkBoard14: return "\u{fa73}"
        case .sparkBoard16: return "\u{fa74}"
        case .sparkBoard20: return "\u{fa75}"
        case .sparkBoard24: return "\u{fa76}"
        case .sparkBoard28: return "\u{fa77}"
        case .sparkBoard32: return "\u{fa78}"
        case .sparkBoard48: return "\u{fa79}"
        case .sparkQuadCamera16: return "\u{fa7a}"
        case .sparkQuadCamera20: return "\u{fa7b}"
        case .sparkRoomKit16: return "\u{fa7c}"
        case .sparkRoomKit20: return "\u{fa7d}"
        case .sparkRoomKitPlus16: return "\u{fa7e}"
        case .sparkRoomKitPlus20: return "\u{fa7f}"
        case .sparkShare16: return "\u{fa80}"
        case .sparkShare20: return "\u{fa81}"
        case .sparkVoice16: return "\u{fa82}"
        case .sparkVoice20: return "\u{fa83}"
        case .speaker12: return "\u{fa84}"
        case .speaker16: return "\u{fa85}"
        case .speaker20: return "\u{fa86}"
        case .speaker24: return "\u{fa87}"
        case .speaker28: return "\u{fa88}"
        case .speakerBluetooth16: return "\u{fa89}"
        case .speakerDisconnected12: return "\u{fa8a}"
        case .speakerDisconnected14: return "\u{fa8b}"
        case .speakerDisconnected16: return "\u{fa8c}"
        case .speakerDisconnected20: return "\u{fa8d}"
        case .speakerDisconnected24: return "\u{fa8e}"
        case .speakerDisconnected28: return "\u{fa8f}"
        case .speakerDisconnected36: return "\u{fa90}"
        case .speakerLineOutLeft16: return "\u{fa91}"
        case .speakerLineOutRight16: return "\u{fa92}"
        case .speakerMuted12: return "\u{fa93}"
        case .speakerMuted14: return "\u{fa94}"
        case .speakerMuted16: return "\u{fa95}"
        case .speakerMuted24: return "\u{fa96}"
        case .speakerMuted28: return "\u{fa97}"
        case .speakerMuted32: return "\u{fa98}"
        case .speakerOff16: return "\u{fa99}"
        case .speakerOff24: return "\u{fa9a}"
        case .speakerOff28: return "\u{fa9b}"
        case .spinner12: return "\u{fa9c}"
        case .spinner14: return "\u{fa9d}"
        case .spinner16: return "\u{fa9e}"
        case .spinner18: return "\u{fa9f}"
        case .spinner20: return "\u{faa0}"
        case .spinner24: return "\u{faa1}"
        case .spinner28: return "\u{faa2}"
        case .spinner32: return "\u{faa3}"
        case .spinner36: return "\u{faa4}"
        case .spinner40: return "\u{faa5}"
        case .spinner48: return "\u{faa6}"
        case .spinner56: return "\u{faa7}"
        case .spinner72: return "\u{faa8}"
        case .spinner8: return "\u{faa9}"
        case .spinner80: return "\u{faaa}"
        case .spinner90: return "\u{faab}"
        case .spreadsheet16: return "\u{faac}"
        case .startChat20: return "\u{faad}"
        case .startChat24: return "\u{faae}"
        case .stickers16: return "\u{faaf}"
        case .stickers24: return "\u{fab0}"
        case .stickies12: return "\u{fab1}"
        case .stickies16: return "\u{fab2}"
        case .stickies24: return "\u{fab3}"
        case .stop10: return "\u{fab4}"
        case .stop12: return "\u{fab5}"
        case .stop16: return "\u{fab6}"
        case .stop20: return "\u{fab7}"
        case .stop24: return "\u{fab8}"
        case .stopCircle12: return "\u{fab9}"
        case .stopCircle16: return "\u{faba}"
        case .stopCircle20: return "\u{fabb}"
        case .stopCircle24: return "\u{fabc}"
        case .stopContentShare20: return "\u{fabd}"
        case .storedInfo12: return "\u{fabe}"
        case .storedInfo16: return "\u{fabf}"
        case .storedInfo20: return "\u{fac0}"
        case .storedInfo24: return "\u{fac1}"
        case .storedInfoActive12: return "\u{fac2}"
        case .storedInfoActive16: return "\u{fac3}"
        case .storedInfoActive20: return "\u{fac4}"
        case .storedInfoActive24: return "\u{fac5}"
        case .streaming16: return "\u{fac6}"
        case .streaming20: return "\u{fac7}"
        case .streaming24: return "\u{fac8}"
        case .subscribe16: return "\u{fac9}"
        case .subscript12: return "\u{faca}"
        case .subscript16: return "\u{facb}"
        case .superscript12: return "\u{facc}"
        case .superscript16: return "\u{facd}"
        case .swift16: return "\u{face}"
        case .sx1016: return "\u{facf}"
        case .sx1020: return "\u{fad0}"
        case .sx2016: return "\u{fad1}"
        case .sx2020: return "\u{fad2}"
        case .sx80Codec16: return "\u{fad3}"
        case .sx80Codec20: return "\u{fad4}"
        case .tablet12: return "\u{fad5}"
        case .tablet16: return "\u{fad6}"
        case .tablet24: return "\u{fad7}"
        case .tag12: return "\u{fad8}"
        case .tag16: return "\u{fad9}"
        case .tag20: return "\u{fada}"
        case .tap20: return "\u{fadb}"
        case .tasks10: return "\u{fadc}"
        case .tasks12: return "\u{fadd}"
        case .tasks14: return "\u{fade}"
        case .tasks16: return "\u{fadf}"
        case .tasks18: return "\u{fae0}"
        case .tasks20: return "\u{fae1}"
        case .tasks24: return "\u{fae2}"
        case .tasks26: return "\u{fae3}"
        case .tasks28: return "\u{fae4}"
        case .tasks32: return "\u{fae5}"
        case .tasks36: return "\u{fae6}"
        case .tasks8: return "\u{fae7}"
        case .team12: return "\u{fae8}"
        case .team14: return "\u{fae9}"
        case .team16: return "\u{faea}"
        case .team18: return "\u{faeb}"
        case .team20: return "\u{faec}"
        case .team24: return "\u{faed}"
        case .team32: return "\u{faee}"
        case .teamActive12: return "\u{faef}"
        case .teamActive14: return "\u{faf0}"
        case .teamActive16: return "\u{faf1}"
        case .teamActive18: return "\u{faf2}"
        case .teamActive20: return "\u{faf3}"
        case .teamActive24: return "\u{faf4}"
        case .teamActive32: return "\u{faf5}"
        case .teamNew24: return "\u{faf6}"
        case .telepresence12: return "\u{faf7}"
        case .telepresence14: return "\u{faf8}"
        case .telepresence16: return "\u{faf9}"
        case .telepresence18: return "\u{fafa}"
        case .telepresence20: return "\u{fafb}"
        case .telepresence24: return "\u{fafc}"
        case .telepresence64: return "\u{fafd}"
        case .telepresenceAlert12: return "\u{fafe}"
        case .telepresenceIx500016: return "\u{faff}"
        case .telepresenceIx500020: return "\u{fb00}"
        case .telepresenceMuted12: return "\u{fb01}"
        case .telepresenceMuted64: return "\u{fb02}"
        case .telepresenceMutedAlert12: return "\u{fb03}"
        case .telepresencePrivate12: return "\u{fb04}"
        case .text10: return "\u{fb05}"
        case .text12: return "\u{fb06}"
        case .text16: return "\u{fb07}"
        case .textAlignLeft16: return "\u{fb08}"
        case .textAlignRight16: return "\u{fb09}"
        case .textBlockquote12: return "\u{fb0a}"
        case .textBlockquote16: return "\u{fb0b}"
        case .textBlockquote18: return "\u{fb0c}"
        case .textBlockquote20: return "\u{fb0d}"
        case .textBlockquote8: return "\u{fb0e}"
        case .textBold12: return "\u{fb0f}"
        case .textBold16: return "\u{fb10}"
        case .textBold24: return "\u{fb11}"
        case .textCodeBlock12: return "\u{fb12}"
        case .textCodeBlock16: return "\u{fb13}"
        case .textCodeBlock24: return "\u{fb14}"
        case .textCodeInline12: return "\u{fb15}"
        case .textCodeInline16: return "\u{fb16}"
        case .textColor12: return "\u{fb17}"
        case .textColor16: return "\u{fb18}"
        case .textFormat10: return "\u{fb19}"
        case .textFormat12: return "\u{fb1a}"
        case .textFormat16: return "\u{fb1b}"
        case .textFormat20: return "\u{fb1c}"
        case .textFormat24: return "\u{fb1d}"
        case .textFormat8: return "\u{fb1e}"
        case .textHeading112: return "\u{fb1f}"
        case .textHeading116: return "\u{fb20}"
        case .textHeading212: return "\u{fb21}"
        case .textHeading216: return "\u{fb22}"
        case .textHeading312: return "\u{fb23}"
        case .textHeading316: return "\u{fb24}"
        case .textIndentDecrease12: return "\u{fb25}"
        case .textIndentIncrease12: return "\u{fb26}"
        case .textItalic12: return "\u{fb27}"
        case .textItalic16: return "\u{fb28}"
        case .textItalic24: return "\u{fb29}"
        case .textListBulleted10: return "\u{fb2a}"
        case .textListBulleted12: return "\u{fb2b}"
        case .textListBulleted16: return "\u{fb2c}"
        case .textListBulleted24: return "\u{fb2d}"
        case .textListBulleted8: return "\u{fb2e}"
        case .textListNumbered12: return "\u{fb2f}"
        case .textListNumbered16: return "\u{fb30}"
        case .textListNumbered24: return "\u{fb31}"
        case .textListNumbered36: return "\u{fb32}"
        case .textListNumbered40: return "\u{fb33}"
        case .textStrikethrough12: return "\u{fb34}"
        case .textStrikethrough16: return "\u{fb35}"
        case .textTable12: return "\u{fb36}"
        case .textTable16: return "\u{fb37}"
        case .textUnderline12: return "\u{fb38}"
        case .textUnderline16: return "\u{fb39}"
        case .textUnderline24: return "\u{fb3a}"
        case .tooFast12: return "\u{fb3b}"
        case .tooFast16: return "\u{fb3c}"
        case .tooSlow12: return "\u{fb3d}"
        case .tooSlow16: return "\u{fb3e}"
        case .tools16: return "\u{fb3f}"
        case .tools20: return "\u{fb40}"
        case .tools24: return "\u{fb41}"
        case .tools28: return "\u{fb42}"
        case .tools32: return "\u{fb43}"
        case .touch16: return "\u{fb44}"
        case .touch1024: return "\u{fb45}"
        case .transcript16: return "\u{fb46}"
        case .transcript20: return "\u{fb47}"
        case .twitter16: return "\u{fb48}"
        case .twitterCircle24: return "\u{fb49}"
        case .twitterCircle32: return "\u{fb4a}"
        case .twitterCircle40: return "\u{fb4b}"
        case .ucmCloud10: return "\u{fb4c}"
        case .ucmCloud16: return "\u{fb4d}"
        case .ucmCloud24: return "\u{fb4e}"
        case .ucmCloud32: return "\u{fb4f}"
        case .undo12: return "\u{fb50}"
        case .undo14: return "\u{fb51}"
        case .undo16: return "\u{fb52}"
        case .undo24: return "\u{fb53}"
        case .unlink20: return "\u{fb54}"
        case .unreadBadge10: return "\u{fb55}"
        case .unreadBadge12: return "\u{fb56}"
        case .unreadBadge16: return "\u{fb57}"
        case .unreadBadge8: return "\u{fb58}"
        case .unsecure12: return "\u{fb59}"
        case .unsecure14: return "\u{fb5a}"
        case .unsecure16: return "\u{fb5b}"
        case .unsecure24: return "\u{fb5c}"
        case .unsecure28: return "\u{fb5d}"
        case .upload12: return "\u{fb5e}"
        case .upload130: return "\u{fb5f}"
        case .upload14: return "\u{fb60}"
        case .upload16: return "\u{fb61}"
        case .upload18: return "\u{fb62}"
        case .upload20: return "\u{fb63}"
        case .upload24: return "\u{fb64}"
        case .upload28: return "\u{fb65}"
        case .upload32: return "\u{fb66}"
        case .upload36: return "\u{fb67}"
        case .usb16: return "\u{fb68}"
        case .user16: return "\u{fb69}"
        case .user20: return "\u{fb6a}"
        case .user24: return "\u{fb6b}"
        case .user56: return "\u{fb6c}"
        case .videoEffect12: return "\u{fb6d}"
        case .videoEffect16: return "\u{fb6e}"
        case .videoLayout12: return "\u{fb6f}"
        case .videoLayout16: return "\u{fb70}"
        case .videoLayoutAuto12: return "\u{fb71}"
        case .videoLayoutAuto16: return "\u{fb72}"
        case .videoLayoutAuto20: return "\u{fb73}"
        case .videoLayoutAuto24: return "\u{fb74}"
        case .videoLayoutEqual12: return "\u{fb75}"
        case .videoLayoutEqual14: return "\u{fb76}"
        case .videoLayoutEqual16: return "\u{fb77}"
        case .videoLayoutEqual20: return "\u{fb78}"
        case .videoLayoutEqual24: return "\u{fb79}"
        case .videoLayoutOverlay12: return "\u{fb7a}"
        case .videoLayoutOverlay16: return "\u{fb7b}"
        case .videoLayoutOverlay20: return "\u{fb7c}"
        case .videoLayoutOverlay24: return "\u{fb7d}"
        case .videoLayoutProminent12: return "\u{fb7e}"
        case .videoLayoutProminent16: return "\u{fb7f}"
        case .videoLayoutProminent20: return "\u{fb80}"
        case .videoLayoutProminent24: return "\u{fb81}"
        case .videoLayoutShareDominant12: return "\u{fb82}"
        case .videoLayoutShareDominant16: return "\u{fb83}"
        case .videoLayoutShareDominant20: return "\u{fb84}"
        case .videoLayoutShareDominant24: return "\u{fb85}"
        case .videoLayoutSingle16: return "\u{fb86}"
        case .videoLayoutSingle20: return "\u{fb87}"
        case .videoLayoutVideoDominant12: return "\u{fb88}"
        case .videoLayoutVideoDominant16: return "\u{fb89}"
        case .videoLayoutVideoDominant20: return "\u{fb8a}"
        case .videoLayoutVideoDominant24: return "\u{fb8b}"
        case .viewAll12: return "\u{fb8c}"
        case .viewAll14: return "\u{fb8d}"
        case .viewFeedMultiple16: return "\u{fb8e}"
        case .viewFeedPanel16: return "\u{fb8f}"
        case .viewFeedSingle16: return "\u{fb90}"
        case .viewList10: return "\u{fb91}"
        case .viewList12: return "\u{fb92}"
        case .viewList14: return "\u{fb93}"
        case .viewList16: return "\u{fb94}"
        case .viewList20: return "\u{fb95}"
        case .viewList24: return "\u{fb96}"
        case .viewList28: return "\u{fb97}"
        case .viewListCircle100: return "\u{fb98}"
        case .viewMixed12: return "\u{fb99}"
        case .viewStack12: return "\u{fb9a}"
        case .viewStack14: return "\u{fb9b}"
        case .viewStack20: return "\u{fb9c}"
        case .viewStack24: return "\u{fb9d}"
        case .viewThumbnail12: return "\u{fb9e}"
        case .viewThumbnail14: return "\u{fb9f}"
        case .viewThumbnail16: return "\u{fba0}"
        case .viewThumbnail20: return "\u{fba1}"
        case .viewThumbnail24: return "\u{fba2}"
        case .voice20: return "\u{fba3}"
        case .voicemail10: return "\u{fba4}"
        case .voicemail14: return "\u{fba5}"
        case .voicemail16: return "\u{fba6}"
        case .voicemail18: return "\u{fba7}"
        case .voicemail20: return "\u{fba8}"
        case .voicemail22: return "\u{fba9}"
        case .voicemail24: return "\u{fbaa}"
        case .voicemail28: return "\u{fbab}"
        case .voicemail8: return "\u{fbac}"
        case .voicemailActive12: return "\u{fbad}"
        case .voicemailActive14: return "\u{fbae}"
        case .voicemailActive16: return "\u{fbaf}"
        case .voicemailActive18: return "\u{fbb0}"
        case .voicemailActive20: return "\u{fbb1}"
        case .voicemailActive22: return "\u{fbb2}"
        case .voicemailActive24: return "\u{fbb3}"
        case .voicemailActive28: return "\u{fbb4}"
        case .wallpaper16: return "\u{fbb5}"
        case .wallpaper20: return "\u{fbb6}"
        case .wallpaper24: return "\u{fbb7}"
        case .wallpaper28: return "\u{fbb8}"
        case .wallpaper32: return "\u{fbb9}"
        case .warning100: return "\u{fbba}"
        case .warning12: return "\u{fbbb}"
        case .warning14: return "\u{fbbc}"
        case .warning16: return "\u{fbbd}"
        case .warning20: return "\u{fbbe}"
        case .warning24: return "\u{fbbf}"
        case .warning28: return "\u{fbc0}"
        case .warning32: return "\u{fbc1}"
        case .warning40: return "\u{fbc2}"
        case .warning44: return "\u{fbc3}"
        case .warning56: return "\u{fbc4}"
        case .warning64: return "\u{fbc5}"
        case .warning72: return "\u{fbc6}"
        case .waveform20: return "\u{fbc7}"
        case .webSharing16: return "\u{fbc8}"
        case .webSharing24: return "\u{fbc9}"
        case .webex10: return "\u{fbca}"
        case .webex16: return "\u{fbcb}"
        case .webex24: return "\u{fbcc}"
        case .webex48: return "\u{fbcd}"
        case .webexBoard12: return "\u{fbce}"
        case .webexBoard14: return "\u{fbcf}"
        case .webexBoard16: return "\u{fbd0}"
        case .webexBoard20: return "\u{fbd1}"
        case .webexBoard24: return "\u{fbd2}"
        case .webexBoard28: return "\u{fbd3}"
        case .webexBoard32: return "\u{fbd4}"
        case .webexBoard48: return "\u{fbd5}"
        case .webexCalling10: return "\u{fbd6}"
        case .webexCalling12: return "\u{fbd7}"
        case .webexCalling16: return "\u{fbd8}"
        case .webexCalling18: return "\u{fbd9}"
        case .webexCalling20: return "\u{fbda}"
        case .webexCalling24: return "\u{fbdb}"
        case .webexCodecPlus16: return "\u{fbdc}"
        case .webexCodecPlus20: return "\u{fbdd}"
        case .webexCommunity20: return "\u{fbde}"
        case .webexInstantMeeting12: return "\u{fbdf}"
        case .webexInstantMeeting14: return "\u{fbe0}"
        case .webexInstantMeeting16: return "\u{fbe1}"
        case .webexInstantMeeting20: return "\u{fbe2}"
        case .webexInstantMeeting24: return "\u{fbe3}"
        case .webexMeetings10: return "\u{fbe4}"
        case .webexMeetings12: return "\u{fbe5}"
        case .webexMeetings14: return "\u{fbe6}"
        case .webexMeetings16: return "\u{fbe7}"
        case .webexMeetings20: return "\u{fbe8}"
        case .webexMeetings24: return "\u{fbe9}"
        case .webexMeetings48: return "\u{fbea}"
        case .webexQuadCamera16: return "\u{fbeb}"
        case .webexQuadCamera20: return "\u{fbec}"
        case .webexRoomKit16: return "\u{fbed}"
        case .webexRoomKit20: return "\u{fbee}"
        case .webexRoomKitPlus16: return "\u{fbef}"
        case .webexRoomKitPlus20: return "\u{fbf0}"
        case .webexShare12: return "\u{fbf1}"
        case .webexShare14: return "\u{fbf2}"
        case .webexShare16: return "\u{fbf3}"
        case .webexShare20: return "\u{fbf4}"
        case .webexTeams10: return "\u{fbf5}"
        case .webexTeams12: return "\u{fbf6}"
        case .webexTeams14: return "\u{fbf7}"
        case .webexTeams16: return "\u{fbf8}"
        case .webexTeams18: return "\u{fbf9}"
        case .webexTeams20: return "\u{fbfa}"
        case .webexVoice16: return "\u{fbfb}"
        case .webexVoice20: return "\u{fbfc}"
        case .webpop12: return "\u{fbfd}"
        case .webpop16: return "\u{fbfe}"
        case .webpop20: return "\u{fbff}"
        case .webpop24: return "\u{fc00}"
        case .whatsApp16: return "\u{fc01}"
        case .whiteboard10: return "\u{fc02}"
        case .whiteboard12: return "\u{fc03}"
        case .whiteboard14: return "\u{fc04}"
        case .whiteboard16: return "\u{fc05}"
        case .whiteboard20: return "\u{fc06}"
        case .whiteboard24: return "\u{fc07}"
        case .whiteboard26: return "\u{fc08}"
        case .whiteboard28: return "\u{fc09}"
        case .whiteboard32: return "\u{fc0a}"
        case .whiteboard36: return "\u{fc0b}"
        case .whiteboard8: return "\u{fc0c}"
        case .whiteboardContent16: return "\u{fc0d}"
        case .whiteboardContent24: return "\u{fc0e}"
        case .widgetsAdr20: return "\u{fc0f}"
        case .wifi12: return "\u{fc10}"
        case .wifi16: return "\u{fc11}"
        case .wifi20: return "\u{fc12}"
        case .wifi24: return "\u{fc13}"
        case .wifiError12: return "\u{fc14}"
        case .wifiError16: return "\u{fc15}"
        case .wikipedia16: return "\u{fc16}"
        case .windowCornerScrub16: return "\u{fc17}"
        case .windowVerticalScrub16: return "\u{fc18}"
        case .youtubeCircle24: return "\u{fc19}"
        case .youtubeCircle32: return "\u{fc1a}"
        case .youtubeCircle40: return "\u{fc1b}"
        case .zoomIn12: return "\u{fc1c}"
        case .zoomIn14: return "\u{fc1d}"
        case .zoomIn16: return "\u{fc1e}"
        case .zoomIn20: return "\u{fc1f}"
        case .zoomOut12: return "\u{fc20}"
        case .zoomOut14: return "\u{fc21}"
        case .zoomOut16: return "\u{fc22}"
        case .zoomOut20: return "\u{fc23}"
