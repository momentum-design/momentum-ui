...
var AlertMeeting = function AlertMeeting(props) {
  ...
  var renderAvatar = function renderAvatar() {
    if (avatar) {
      ...
      if (attendees.length >= 2) {
        return /*#__PURE__*/React.createElement(CompositeAvatar, null, /*#__PURE__*/React.createElement(Avatar, _extends({
          alt: attendees[0].alt,
          src: attendees[0].src,
          title: attendees[0].title
        }, attendees[0].props)), /*#__PURE__*/React.createElement(Avatar, _extends({
          alt: attendees[1].alt,
          src: attendees[1].src,
  ...
  return show && /*#__PURE__*/React.createElement("div", _extends({
    ...
    role: 'button'
  }, otherProps), renderAvatar(), /*#__PURE__*/React.createElement("div", {
    ...
    title: message
  }, message)), onSnooze && /*#__PURE__*/React.createElement("div", {
    ...
    onClick: onSnooze,
    size: 44
  }, snoozeBtnProps), /*#__PURE__*/React.createElement(Icon, {
    name: "alarm_16"
  }))), /*#__PURE__*/React.createElement("div", {
    className: "md-alert__button"
  }, /*#__PURE__*/React.createElement(Button, _extends({
    ...
    onClick: onHide,
    size: 44
  }, closeBtnProps), /*#__PURE__*/React.createElement(Icon, {
    name: "cancel_16"
  }))));
};
