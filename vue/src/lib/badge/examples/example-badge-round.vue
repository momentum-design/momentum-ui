<template>
  <div>
    ...
    <md-badge :rounded='true' :color='"Red"'>Red</md-badge><br>
    ...
    <md-badge :rounded='true' :color='"blue-pastel"'>Blue Pastel</md-badge><br>
    <md-badge :rounded='true' :color='"red-pastel"'>Red Pastel</md-badge><br>
    <md-badge :rounded='true' :color='"yellow-pastel"'>Yellow Pastel</md-badge><br>
    <md-badge :rounded='true' :color='"green-pastel"'>Green Pastel</md-badge><br>
    <md-badge :rounded='true' :color='"mint-pastel"'>Mint Pastel</md-badge><br>
  </div>
</template>

<script>
export default {
  name: 'ExampleBadgeRound',
};
</script>
