...
@objc public enum MomentumIconType: Int {
    ...
    public var ligature: String {
        ...
        case .privacy16: return "\u{f997}"
        case .privacy20: return "\u{f998}"
        case .private10: return "\u{f999}"
        case .private12: return "\u{f99a}"
        case .private14: return "\u{f99b}"
        case .private16: return "\u{f99c}"
        case .private20: return "\u{f99d}"
        case .private24: return "\u{f99e}"
        case .private28: return "\u{f99f}"
        case .private8: return "\u{f9a0}"
        case .privateCircle100: return "\u{f9a1}"
        case .privateCircle14: return "\u{f9a2}"
        case .privateCircle16: return "\u{f9a3}"
        case .privateCircle20: return "\u{f9a4}"
        case .privateCircle24: return "\u{f9a5}"
        case .privateCircle48: return "\u{f9a6}"
        case .privateCircle56: return "\u{f9a7}"
        case .privateCircle80: return "\u{f9a8}"
        case .privateCircleActive16: return "\u{f9a9}"
        case .privateCircleActive20: return "\u{f9aa}"
        case .privateCircleActive24: return "\u{f9ab}"
        case .privateMeeting12: return "\u{f9ac}"
        case .privateMeeting14: return "\u{f9ad}"
        case .privateMeeting16: return "\u{f9ae}"
        case .privateMeeting20: return "\u{f9af}"
        case .proBadge28: return "\u{f9b0}"
        case .productDemo16: return "\u{f9b1}"
        case .proximity12: return "\u{f9b2}"
        case .proximity16: return "\u{f9b3}"
        case .proximity20: return "\u{f9b4}"
        case .proximity24: return "\u{f9b5}"
        case .proximity28: return "\u{f9b6}"
        case .proximityMuted12: return "\u{f9b7}"
        case .proximityMuted16: return "\u{f9b8}"
        case .proximityMuted24: return "\u{f9b9}"
        case .proximityMuted28: return "\u{f9ba}"
        case .proximityVideo12: return "\u{f9bb}"
        case .proximityVideo14: return "\u{f9bc}"
        case .proximityVideo16: return "\u{f9bd}"
        case .proximityVideo20: return "\u{f9be}"
        case .proximityVideo24: return "\u{f9bf}"
        case .proximityVideo26: return "\u{f9c0}"
        case .pto12: return "\u{f9c1}"
        case .pto120: return "\u{f9c2}"
        case .pto124: return "\u{f9c3}"
        case .pto14: return "\u{f9c4}"
        case .pto16: return "\u{f9c5}"
        case .pto18: return "\u{f9c6}"
        case .pto20: return "\u{f9c7}"
        case .pto24: return "\u{f9c8}"
        case .pto26: return "\u{f9c9}"
        case .pto28: return "\u{f9ca}"
        case .pto32: return "\u{f9cb}"
        case .pto40: return "\u{f9cc}"
        case .pto48: return "\u{f9cd}"
        case .pto56: return "\u{f9ce}"
        case .pto8: return "\u{f9cf}"
        case .pullCall12: return "\u{f9d0}"
        case .pullCall14: return "\u{f9d1}"
        case .pullCall16: return "\u{f9d2}"
        case .pullCall24: return "\u{f9d3}"
        case .qA16: return "\u{f9d4}"
        case .qA20: return "\u{f9d5}"
        case .qA24: return "\u{f9d6}"
        case .qA36: return "\u{f9d7}"
        case .quality16: return "\u{f9d8}"
        case .quality24: return "\u{f9d9}"
        case .queue14: return "\u{f9da}"
        case .queueContact: return "\u{f9db}"
        case .queueContact14: return "\u{f9dc}"
        case .queueContact20: return "\u{f9dd}"
        case .queueLookup16: return "\u{f9de}"
        case .quiet16: return "\u{f9df}"
        case .quiet20: return "\u{f9e0}"
        case .quiet32: return "\u{f9e1}"
        case .quiet8: return "\u{f9e2}"
        case .raiseHand12: return "\u{f9e3}"
        case .raiseHand16: return "\u{f9e4}"
        case .raiseHand20: return "\u{f9e5}"
        case .raiseHand24: return "\u{f9e6}"
        case .ram16: return "\u{f9e7}"
        case .reactions12: return "\u{f9e8}"
        case .reactions16: return "\u{f9e9}"
        case .reactions20: return "\u{f9ea}"
        case .realTimeTranslation24: return "\u{f9eb}"
        case .recents12: return "\u{f9ec}"
        case .recents14: return "\u{f9ed}"
        case .recents16: return "\u{f9ee}"
        case .recents18: return "\u{f9ef}"
        case .recents20: return "\u{f9f0}"
        case .recents24: return "\u{f9f1}"
        case .recents80: return "\u{f9f2}"
        case .recentsActive14: return "\u{f9f3}"
        case .recentsActive24: return "\u{f9f4}"
        case .recentsPresence12: return "\u{f9f5}"
        case .recentsPresence14: return "\u{f9f6}"
        case .recentsPresence24: return "\u{f9f7}"
        case .recentsPresence28: return "\u{f9f8}"
        case .recentsPresence8: return "\u{f9f9}"
        case .recentsPresenceStroke10: return "\u{f9fa}"
        case .recentsPresenceStroke14: return "\u{f9fb}"
        case .recentsPresenceStroke16: return "\u{f9fc}"
        case .recentsPresenceStroke26: return "\u{f9fd}"
        case .recentsPresenceStroke30: return "\u{f9fe}"
        case .record12: return "\u{f9ff}"
        case .record14: return "\u{fa00}"
        case .record16: return "\u{fa01}"
        case .record20: return "\u{fa02}"
        case .record24: return "\u{fa03}"
        case .record28: return "\u{fa04}"
        case .recordActive12: return "\u{fa05}"
        case .recordActive14: return "\u{fa06}"
        case .recordActive16: return "\u{fa07}"
        case .recordActive20: return "\u{fa08}"
        case .recordActive24: return "\u{fa09}"
        case .recordActiveBg12: return "\u{fa0a}"
        case .recordActiveBg14: return "\u{fa0b}"
        case .recordActiveBg16: return "\u{fa0c}"
        case .recordActiveBg20: return "\u{fa0d}"
        case .recordActiveBg24: return "\u{fa0e}"
        case .recordActiveCircle12: return "\u{fa0f}"
        case .recordActiveCircle14: return "\u{fa10}"
        case .recordActiveCircle16: return "\u{fa11}"
        case .recordActiveCircle20: return "\u{fa12}"
        case .recordActiveCircle24: return "\u{fa13}"
        case .recurring12: return "\u{fa14}"
        case .recurring14: return "\u{fa15}"
        case .recurring16: return "\u{fa16}"
        case .recurring20: return "\u{fa17}"
        case .recurring24: return "\u{fa18}"
        case .recurringOff12: return "\u{fa19}"
        case .recurringOff16: return "\u{fa1a}"
        case .redial16: return "\u{fa1b}"
        case .redial20: return "\u{fa1c}"
        case .redial24: return "\u{fa1d}"
        case .redo12: return "\u{fa1e}"
        case .redo14: return "\u{fa1f}"
        case .redo16: return "\u{fa20}"
        case .refresh10: return "\u{fa21}"
        case .refresh12: return "\u{fa22}"
        case .refresh16: return "\u{fa23}"
        case .refresh18: return "\u{fa24}"
        case .refresh20: return "\u{fa25}"
        case .refresh24: return "\u{fa26}"
        case .remoteDesktopControl10: return "\u{fa27}"
        case .remoteDesktopControl12: return "\u{fa28}"
        case .remoteDesktopControl14: return "\u{fa29}"
        case .remoteDesktopControl16: return "\u{fa2a}"
        case .remoteDesktopControl24: return "\u{fa2b}"
        case .remoteDesktopControlActive10: return "\u{fa2c}"
        case .remoteDesktopControlActive12: return "\u{fa2d}"
        case .remove12: return "\u{fa2e}"
        case .remove14: return "\u{fa2f}"
        case .remove16: return "\u{fa30}"
        case .remove20: return "\u{fa31}"
        case .remove24: return "\u{fa32}"
        case .reply10: return "\u{fa33}"
        case .reply12: return "\u{fa34}"
        case .reply16: return "\u{fa35}"
        case .reply20: return "\u{fa36}"
        case .reply24: return "\u{fa37}"
        case .replyList12: return "\u{fa38}"
        case .replyList16: return "\u{fa39}"
        case .replyList20: return "\u{fa3a}"
        case .report16: return "\u{fa3b}"
        case .report28: return "\u{fa3c}"
        case .reset16: return "\u{fa3d}"
        case .reset24: return "\u{fa3e}"
        case .response16: return "\u{fa3f}"
        case .responsiveMobile16: return "\u{fa40}"
        case .retrieveCall14: return "\u{fa41}"
        case .retrieveCall16: return "\u{fa42}"
        case .return12: return "\u{fa43}"
        case .return16: return "\u{fa44}"
        case .ringtone16: return "\u{fa45}"
        case .ringtone24: return "\u{fa46}"
        case .roomCalendar24: return "\u{fa47}"
        case .roomLights16: return "\u{fa48}"
        case .roomLights24: return "\u{fa49}"
        case .rotateContent12: return "\u{fa4a}"
        case .rotateContent16: return "\u{fa4b}"
        case .rotateContent24: return "\u{fa4c}"
        case .rotateLandscape16: return "\u{fa4d}"
        case .rssCircle24: return "\u{fa4e}"
        case .rssCircle32: return "\u{fa4f}"
        case .rssCircle40: return "\u{fa50}"
        case .runningApplication16: return "\u{fa51}"
        case .runningApplication24: return "\u{fa52}"
        case .save12: return "\u{fa53}"
        case .save14: return "\u{fa54}"
        case .save16: return "\u{fa55}"
        case .save24: return "\u{fa56}"
        case .scan20: return "\u{fa57}"
        case .scan24: return "\u{fa58}"
        case .schedulerAvailable14: return "\u{fa59}"
        case .schedulerAvailable16: return "\u{fa5a}"
        case .schedulerNotWorkingHours14: return "\u{fa5b}"
        case .schedulerNotWorkingHours16: return "\u{fa5c}"
        case .schedulerUnavailable14: return "\u{fa5d}"
        case .schedulerUnavailable16: return "\u{fa5e}"
        case .schedulerUnknown14: return "\u{fa5f}"
        case .schedulerUnknown16: return "\u{fa60}"
        case .screenToggle10: return "\u{fa61}"
        case .screenToggle12: return "\u{fa62}"
        case .screenToggle16: return "\u{fa63}"
        case .screenToggle20: return "\u{fa64}"
        case .screenToggle24: return "\u{fa65}"
        case .screenshot12: return "\u{fa66}"
        case .screenshot16: return "\u{fa67}"
        case .screenshot20: return "\u{fa68}"
        case .screenshot24: return "\u{fa69}"
        case .search12: return "\u{fa6a}"
        case .search14: return "\u{fa6b}"
        case .search16: return "\u{fa6c}"
        case .search18: return "\u{fa6d}"
        case .search20: return "\u{fa6e}"
        case .search24: return "\u{fa6f}"
        case .search28: return "\u{fa70}"
        case .secure10: return "\u{fa71}"
        case .secure12: return "\u{fa72}"
        case .secure14: return "\u{fa73}"
        case .secure16: return "\u{fa74}"
        case .secure20: return "\u{fa75}"
        case .secure24: return "\u{fa76}"
        case .secure28: return "\u{fa77}"
        case .secure8: return "\u{fa78}"
        case .secureActive12: return "\u{fa79}"
        case .secureActive14: return "\u{fa7a}"
        case .secureActive16: return "\u{fa7b}"
        case .secureActive20: return "\u{fa7c}"
        case .secureActive24: return "\u{fa7d}"
        case .secureActive28: return "\u{fa7e}"
        case .secureActive8: return "\u{fa7f}"
        case .secureBadge28: return "\u{fa80}"
        case .secureCircle14: return "\u{fa81}"
        case .secureCircle16: return "\u{fa82}"
        case .secureCircleActive14: return "\u{fa83}"
        case .secureCircleActive16: return "\u{fa84}"
        case .secureFips24: return "\u{fa85}"
        case .selfview16: return "\u{fa86}"
        case .selfview20: return "\u{fa87}"
        case .selfview24: return "\u{fa88}"
        case .send12: return "\u{fa89}"
        case .send14: return "\u{fa8a}"
        case .send16: return "\u{fa8b}"
        case .send20: return "\u{fa8c}"
        case .send24: return "\u{fa8d}"
        case .seperate12: return "\u{fa8e}"
        case .seperate16: return "\u{fa8f}"
        case .seperate20: return "\u{fa90}"
        case .seperate24: return "\u{fa91}"
        case .server16: return "\u{fa92}"
        case .server24: return "\u{fa93}"
        case .serverCircle100: return "\u{fa94}"
        case .serverError16: return "\u{fa95}"
        case .setVariable16: return "\u{fa96}"
        case .setVariable20: return "\u{fa97}"
        case .settings10: return "\u{fa98}"
        case .settings12: return "\u{fa99}"
        case .settings14: return "\u{fa9a}"
        case .settings16: return "\u{fa9b}"
        case .settings18: return "\u{fa9c}"
        case .settings20: return "\u{fa9d}"
        case .settings24: return "\u{fa9e}"
        case .settings32: return "\u{fa9f}"
        case .settings8: return "\u{faa0}"
        case .settingsActive10: return "\u{faa1}"
        case .settingsActive12: return "\u{faa2}"
        case .settingsActive14: return "\u{faa3}"
        case .settingsActive16: return "\u{faa4}"
        case .settingsActive18: return "\u{faa5}"
        case .settingsActive20: return "\u{faa6}"
        case .settingsActive24: return "\u{faa7}"
        case .settingsActive32: return "\u{faa8}"
        case .settingsActive8: return "\u{faa9}"
        case .setupAssistant16: return "\u{faaa}"
        case .shakeDevice18: return "\u{faab}"
        case .shakeDevice20: return "\u{faac}"
        case .shapeCircle20: return "\u{faad}"
        case .shapeCone20: return "\u{faae}"
        case .shapeCylinder20: return "\u{faaf}"
        case .shapeDiagonalArrowheadDual16: return "\u{fab0}"
        case .shapeDiagonalArrowheadSingle16: return "\u{fab1}"
        case .shapeDiagonalArrowheadSingle20: return "\u{fab2}"
        case .shapeDiagonalLine16: return "\u{fab3}"
        case .shapeDiagonalLine20: return "\u{fab4}"
        case .shapeOval16: return "\u{fab5}"
        case .shapeOval20: return "\u{fab6}"
        case .shapePolygon20: return "\u{fab7}"
        case .shapeSphere20: return "\u{fab8}"
        case .shapeSquare16: return "\u{fab9}"
        case .shapeSquare20: return "\u{faba}"
        case .shapes16: return "\u{fabb}"
        case .share12: return "\u{fabc}"
        case .share14: return "\u{fabd}"
        case .share16: return "\u{fabe}"
        case .share18: return "\u{fabf}"
        case .share20: return "\u{fac0}"
        case .share24: return "\u{fac1}"
        case .share28: return "\u{fac2}"
        case .share32: return "\u{fac3}"
        case .shareCNativeAdr12: return "\u{fac4}"
        case .shareCNativeAdr14: return "\u{fac5}"
        case .shareCNativeAdr16: return "\u{fac6}"
        case .shareCNativeAdr24: return "\u{fac7}"
        case .shareCNativeIos10: return "\u{fac8}"
        case .shareCNativeIos12: return "\u{fac9}"
        case .shareCNativeIos14: return "\u{faca}"
        case .shareCNativeIos16: return "\u{facb}"
        case .shareCNativeIos20: return "\u{facc}"
        case .shareCNativeIos28: return "\u{facd}"
        case .shareCNativeIph10: return "\u{face}"
        case .shareCNativeIph12: return "\u{facf}"
        case .shareCNativeIph14: return "\u{fad0}"
        case .shareCNativeIph16: return "\u{fad1}"
        case .shareCNativeIph20: return "\u{fad2}"
        case .shareCNativeIph24: return "\u{fad3}"
        case .shareCNativeIph28: return "\u{fad4}"
        case .shareScreen10: return "\u{fad5}"
        case .shareScreen12: return "\u{fad6}"
        case .shareScreen120: return "\u{fad7}"
        case .shareScreen124: return "\u{fad8}"
        case .shareScreen14: return "\u{fad9}"
        case .shareScreen16: return "\u{fada}"
        case .shareScreen18: return "\u{fadb}"
        case .shareScreen20: return "\u{fadc}"
        case .shareScreen24: return "\u{fadd}"
        case .shareScreen26: return "\u{fade}"
        case .shareScreen28: return "\u{fadf}"
        case .shareScreen32: return "\u{fae0}"
        case .shareScreen36: return "\u{fae1}"
        case .shareScreen48: return "\u{fae2}"
        case .shareScreen56: return "\u{fae3}"
        case .shareScreen8: return "\u{fae4}"
        case .shareScreenActive14: return "\u{fae5}"
        case .shareScreenActive24: return "\u{fae6}"
        case .shareScreenPresence12: return "\u{fae7}"
        case .shareScreenPresence14: return "\u{fae8}"
        case .shareScreenPresence28: return "\u{fae9}"
        case .shareScreenPresence8: return "\u{faea}"
        case .shareScreenPresenceStroke12: return "\u{faeb}"
        case .shareScreenPresenceStroke14: return "\u{faec}"
        case .shareScreenPresenceStroke16: return "\u{faed}"
        case .shareScreenPresenceStroke26: return "\u{faee}"
        case .shareScreenPresenceStroke30: return "\u{faef}"
        case .shareSpace12: return "\u{faf0}"
        case .shareSpace14: return "\u{faf1}"
        case .shareSpace18: return "\u{faf2}"
        case .shareSpace20: return "\u{faf3}"
        case .shareSpace24: return "\u{faf4}"
        case .shield12: return "\u{faf5}"
        case .shield14: return "\u{faf6}"
        case .shield20: return "\u{faf7}"
        case .shield24: return "\u{faf8}"
        case .show12: return "\u{faf9}"
        case .show16: return "\u{fafa}"
        case .show20: return "\u{fafb}"
        case .show24: return "\u{fafc}"
        case .sideBySideActive24: return "\u{fafd}"
        case .signIn16: return "\u{fafe}"
        case .signIn20: return "\u{faff}"
        case .signIn24: return "\u{fb00}"
        case .signInForced16: return "\u{fb01}"
        case .signInForced24: return "\u{fb02}"
        case .signOut10: return "\u{fb03}"
        case .signOut12: return "\u{fb04}"
        case .signOut16: return "\u{fb05}"
        case .signOut20: return "\u{fb06}"
        case .signOut24: return "\u{fb07}"
        case .signal016: return "\u{fb08}"
        case .signal10012: return "\u{fb09}"
        case .signal10016: return "\u{fb0a}"
        case .signal2516: return "\u{fb0b}"
        case .signal5016: return "\u{fb0c}"
        case .signal7516: return "\u{fb0d}"
        case .singleNumberReach12: return "\u{fb0e}"
        case .singleNumberReach14: return "\u{fb0f}"
        case .singleNumberReach16: return "\u{fb10}"
        case .singleNumberReach20: return "\u{fb11}"
        case .skip10: return "\u{fb12}"
        case .skip16: return "\u{fb13}"
        case .skip24: return "\u{fb14}"
        case .skipBw16: return "\u{fb15}"
        case .skipBw24: return "\u{fb16}"
        case .skipFw16: return "\u{fb17}"
        case .skipFw24: return "\u{fb18}"
        case .sms12: return "\u{fb19}"
        case .sms16: return "\u{fb1a}"
        case .sortDown12: return "\u{fb1b}"
        case .sortDown16: return "\u{fb1c}"
        case .sortDown20: return "\u{fb1d}"
        case .sortDown24: return "\u{fb1e}"
        case .sortUp20: return "\u{fb1f}"
        case .sortUp24: return "\u{fb20}"
        case .space12: return "\u{fb21}"
        case .space16: return "\u{fb22}"
        case .spark16: return "\u{fb23}"
        case .sparkBoard12: return "\u{fb24}"
        case .sparkBoard14: return "\u{fb25}"
        case .sparkBoard16: return "\u{fb26}"
        case .sparkBoard20: return "\u{fb27}"
        case .sparkBoard24: return "\u{fb28}"
        case .sparkBoard28: return "\u{fb29}"
        case .sparkBoard32: return "\u{fb2a}"
        case .sparkBoard48: return "\u{fb2b}"
        case .sparkQuadCamera16: return "\u{fb2c}"
        case .sparkQuadCamera20: return "\u{fb2d}"
        case .sparkRoomKit16: return "\u{fb2e}"
        case .sparkRoomKit20: return "\u{fb2f}"
        case .sparkRoomKitPlus16: return "\u{fb30}"
        case .sparkRoomKitPlus20: return "\u{fb31}"
        case .sparkShare16: return "\u{fb32}"
        case .sparkShare20: return "\u{fb33}"
        case .sparkVoice16: return "\u{fb34}"
        case .sparkVoice20: return "\u{fb35}"
        case .speaker12: return "\u{fb36}"
        case .speaker16: return "\u{fb37}"
        case .speaker20: return "\u{fb38}"
        case .speaker24: return "\u{fb39}"
        case .speaker28: return "\u{fb3a}"
        case .speakerBluetooth16: return "\u{fb3b}"
        case .speakerDisconnected12: return "\u{fb3c}"
        case .speakerDisconnected14: return "\u{fb3d}"
        case .speakerDisconnected16: return "\u{fb3e}"
        case .speakerDisconnected20: return "\u{fb3f}"
        case .speakerDisconnected24: return "\u{fb40}"
        case .speakerDisconnected28: return "\u{fb41}"
        case .speakerDisconnected36: return "\u{fb42}"
        case .speakerLineOutLeft16: return "\u{fb43}"
        case .speakerLineOutRight16: return "\u{fb44}"
        case .speakerMuted12: return "\u{fb45}"
        case .speakerMuted14: return "\u{fb46}"
        case .speakerMuted16: return "\u{fb47}"
        case .speakerMuted24: return "\u{fb48}"
        case .speakerMuted28: return "\u{fb49}"
        case .speakerMuted32: return "\u{fb4a}"
        case .speakerOff16: return "\u{fb4b}"
        case .speakerOff24: return "\u{fb4c}"
        case .speakerOff28: return "\u{fb4d}"
        case .speakerTurnDown16: return "\u{fb4e}"
        case .speakerTurnUp16: return "\u{fb4f}"
        case .spinner12: return "\u{fb50}"
        case .spinner14: return "\u{fb51}"
        case .spinner16: return "\u{fb52}"
        case .spinner18: return "\u{fb53}"
        case .spinner20: return "\u{fb54}"
        case .spinner24: return "\u{fb55}"
        case .spinner28: return "\u{fb56}"
        case .spinner32: return "\u{fb57}"
        case .spinner36: return "\u{fb58}"
        case .spinner40: return "\u{fb59}"
        case .spinner48: return "\u{fb5a}"
        case .spinner56: return "\u{fb5b}"
        case .spinner72: return "\u{fb5c}"
        case .spinner8: return "\u{fb5d}"
        case .spinner80: return "\u{fb5e}"
        case .spinner90: return "\u{fb5f}"
        case .spreadsheet16: return "\u{fb60}"
        case .stackedArea100Chart16: return "\u{fb61}"
        case .stackedAreaChart16: return "\u{fb62}"
        case .stackedBar100Chart16: return "\u{fb63}"
        case .stackedBarChart16: return "\u{fb64}"
        case .startChat20: return "\u{fb65}"
        case .startChat24: return "\u{fb66}"
        case .stickers16: return "\u{fb67}"
        case .stickers24: return "\u{fb68}"
        case .stickies12: return "\u{fb69}"
        case .stickies16: return "\u{fb6a}"
        case .stickies24: return "\u{fb6b}"
        case .stop10: return "\u{fb6c}"
        case .stop12: return "\u{fb6d}"
        case .stop16: return "\u{fb6e}"
        case .stop20: return "\u{fb6f}"
        case .stop24: return "\u{fb70}"
        case .stopCircle12: return "\u{fb71}"
        case .stopCircle16: return "\u{fb72}"
        case .stopCircle20: return "\u{fb73}"
        case .stopCircle24: return "\u{fb74}"
        case .stopContentShare20: return "\u{fb75}"
        case .storedInfo12: return "\u{fb76}"
        case .storedInfo16: return "\u{fb77}"
        case .storedInfo20: return "\u{fb78}"
        case .storedInfo24: return "\u{fb79}"
        case .storedInfoActive12: return "\u{fb7a}"
        case .storedInfoActive16: return "\u{fb7b}"
        case .storedInfoActive20: return "\u{fb7c}"
        case .storedInfoActive24: return "\u{fb7d}"
        case .streaming16: return "\u{fb7e}"
        case .streaming20: return "\u{fb7f}"
        case .streaming24: return "\u{fb80}"
        case .subscribe16: return "\u{fb81}"
        case .subscript12: return "\u{fb82}"
        case .subscript16: return "\u{fb83}"
        case .superscript12: return "\u{fb84}"
        case .superscript16: return "\u{fb85}"
        case .swift16: return "\u{fb86}"
        case .sx1016: return "\u{fb87}"
        case .sx1020: return "\u{fb88}"
        case .sx2016: return "\u{fb89}"
        case .sx2020: return "\u{fb8a}"
        case .sx80Codec16: return "\u{fb8b}"
        case .sx80Codec20: return "\u{fb8c}"
        case .tablet12: return "\u{fb8d}"
        case .tablet16: return "\u{fb8e}"
        case .tablet24: return "\u{fb8f}"
        case .tabs16: return "\u{fb90}"
        case .tabs24: return "\u{fb91}"
        case .tag12: return "\u{fb92}"
        case .tag16: return "\u{fb93}"
        case .tag20: return "\u{fb94}"
        case .tap20: return "\u{fb95}"
        case .tasks10: return "\u{fb96}"
        case .tasks12: return "\u{fb97}"
        case .tasks14: return "\u{fb98}"
        case .tasks16: return "\u{fb99}"
        case .tasks18: return "\u{fb9a}"
        case .tasks20: return "\u{fb9b}"
        case .tasks24: return "\u{fb9c}"
        case .tasks26: return "\u{fb9d}"
        case .tasks28: return "\u{fb9e}"
        case .tasks32: return "\u{fb9f}"
        case .tasks36: return "\u{fba0}"
        case .tasks8: return "\u{fba1}"
        case .team12: return "\u{fba2}"
        case .team14: return "\u{fba3}"
        case .team16: return "\u{fba4}"
        case .team18: return "\u{fba5}"
        case .team20: return "\u{fba6}"
        case .team24: return "\u{fba7}"
        case .team32: return "\u{fba8}"
        case .teamActive12: return "\u{fba9}"
        case .teamActive14: return "\u{fbaa}"
        case .teamActive16: return "\u{fbab}"
        case .teamActive18: return "\u{fbac}"
        case .teamActive20: return "\u{fbad}"
        case .teamActive24: return "\u{fbae}"
        case .teamActive32: return "\u{fbaf}"
        case .teamNew24: return "\u{fbb0}"
        case .telepresence12: return "\u{fbb1}"
        case .telepresence14: return "\u{fbb2}"
        case .telepresence16: return "\u{fbb3}"
        case .telepresence18: return "\u{fbb4}"
        case .telepresence20: return "\u{fbb5}"
        case .telepresence24: return "\u{fbb6}"
        case .telepresence64: return "\u{fbb7}"
        case .telepresenceAlert12: return "\u{fbb8}"
        case .telepresenceIx500016: return "\u{fbb9}"
        case .telepresenceIx500020: return "\u{fbba}"
        case .telepresenceMuted12: return "\u{fbbb}"
        case .telepresenceMuted64: return "\u{fbbc}"
        case .telepresenceMutedAlert12: return "\u{fbbd}"
        case .telepresencePrivate12: return "\u{fbbe}"
        case .temperature14: return "\u{fbbf}"
        case .text10: return "\u{fbc0}"
        case .text12: return "\u{fbc1}"
        case .text16: return "\u{fbc2}"
        case .textAlignLeft16: return "\u{fbc3}"
        case .textAlignRight16: return "\u{fbc4}"
        case .textBlockquote12: return "\u{fbc5}"
        case .textBlockquote16: return "\u{fbc6}"
        case .textBlockquote18: return "\u{fbc7}"
        case .textBlockquote20: return "\u{fbc8}"
        case .textBlockquote8: return "\u{fbc9}"
        case .textBold12: return "\u{fbca}"
        case .textBold16: return "\u{fbcb}"
        case .textBold24: return "\u{fbcc}"
        case .textCodeBlock12: return "\u{fbcd}"
        case .textCodeBlock16: return "\u{fbce}"
        case .textCodeBlock24: return "\u{fbcf}"
        case .textCodeInline12: return "\u{fbd0}"
        case .textCodeInline16: return "\u{fbd1}"
        case .textColor12: return "\u{fbd2}"
        case .textColor16: return "\u{fbd3}"
        case .textFormat10: return "\u{fbd4}"
        case .textFormat12: return "\u{fbd5}"
        case .textFormat16: return "\u{fbd6}"
        case .textFormat20: return "\u{fbd7}"
        case .textFormat24: return "\u{fbd8}"
        case .textFormat8: return "\u{fbd9}"
        case .textHeading112: return "\u{fbda}"
        case .textHeading116: return "\u{fbdb}"
        case .textHeading212: return "\u{fbdc}"
        case .textHeading216: return "\u{fbdd}"
        case .textHeading312: return "\u{fbde}"
        case .textHeading316: return "\u{fbdf}"
        case .textHighlight12: return "\u{fbe0}"
        case .textHighlight16: return "\u{fbe1}"
        case .textIndentDecrease12: return "\u{fbe2}"
        case .textIndentIncrease12: return "\u{fbe3}"
        case .textItalic12: return "\u{fbe4}"
        case .textItalic16: return "\u{fbe5}"
        case .textItalic24: return "\u{fbe6}"
        case .textListBulleted10: return "\u{fbe7}"
        case .textListBulleted12: return "\u{fbe8}"
        case .textListBulleted16: return "\u{fbe9}"
        case .textListBulleted24: return "\u{fbea}"
        case .textListBulleted8: return "\u{fbeb}"
        case .textListNumbered12: return "\u{fbec}"
        case .textListNumbered16: return "\u{fbed}"
        case .textListNumbered24: return "\u{fbee}"
        case .textListNumbered36: return "\u{fbef}"
        case .textListNumbered40: return "\u{fbf0}"
        case .textStrikethrough12: return "\u{fbf1}"
        case .textStrikethrough16: return "\u{fbf2}"
        case .textTable12: return "\u{fbf3}"
        case .textTable16: return "\u{fbf4}"
        case .textUnderline12: return "\u{fbf5}"
        case .textUnderline16: return "\u{fbf6}"
        case .textUnderline24: return "\u{fbf7}"
        case .tooFast12: return "\u{fbf8}"
        case .tooFast16: return "\u{fbf9}"
        case .tooSlow12: return "\u{fbfa}"
        case .tooSlow16: return "\u{fbfb}"
        case .tools16: return "\u{fbfc}"
        case .tools20: return "\u{fbfd}"
        case .tools24: return "\u{fbfe}"
        case .tools28: return "\u{fbff}"
        case .tools32: return "\u{fc00}"
        case .touch16: return "\u{fc01}"
        case .touch1024: return "\u{fc02}"
        case .transcript16: return "\u{fc03}"
        case .transcript20: return "\u{fc04}"
        case .trending10: return "\u{fc05}"
        case .twitter12: return "\u{fc06}"
        case .twitter16: return "\u{fc07}"
        case .twitterCircle24: return "\u{fc08}"
        case .twitterCircle32: return "\u{fc09}"
        case .twitterCircle40: return "\u{fc0a}"
        case .ucmCloud10: return "\u{fc0b}"
        case .ucmCloud16: return "\u{fc0c}"
        case .ucmCloud24: return "\u{fc0d}"
        case .ucmCloud32: return "\u{fc0e}"
        case .unassignPhoneNumber16: return "\u{fc0f}"
        case .undo12: return "\u{fc10}"
        case .undo14: return "\u{fc11}"
        case .undo16: return "\u{fc12}"
        case .undo24: return "\u{fc13}"
        case .unlink20: return "\u{fc14}"
        case .unreadBadge10: return "\u{fc15}"
        case .unreadBadge12: return "\u{fc16}"
        case .unreadBadge16: return "\u{fc17}"
        case .unreadBadge8: return "\u{fc18}"
        case .unsecure12: return "\u{fc19}"
        case .unsecure14: return "\u{fc1a}"
        case .unsecure16: return "\u{fc1b}"
        case .unsecure24: return "\u{fc1c}"
        case .unsecure28: return "\u{fc1d}"
        case .unsorted10: return "\u{fc1e}"
        case .unsorted16: return "\u{fc1f}"
        case .unsorted24: return "\u{fc20}"
        case .updateFileShare12: return "\u{fc21}"
        case .updateFileShare16: return "\u{fc22}"
        case .updateFileShare24: return "\u{fc23}"
        case .upgrade20: return "\u{fc24}"
        case .upload12: return "\u{fc25}"
        case .upload130: return "\u{fc26}"
        case .upload14: return "\u{fc27}"
        case .upload16: return "\u{fc28}"
        case .upload18: return "\u{fc29}"
        case .upload20: return "\u{fc2a}"
        case .upload24: return "\u{fc2b}"
        case .upload28: return "\u{fc2c}"
        case .upload32: return "\u{fc2d}"
        case .upload36: return "\u{fc2e}"
        case .usb16: return "\u{fc2f}"
        case .user16: return "\u{fc30}"
        case .user20: return "\u{fc31}"
        case .user24: return "\u{fc32}"
        case .user56: return "\u{fc33}"
        case .videoEffect12: return "\u{fc34}"
        case .videoEffect16: return "\u{fc35}"
        case .videoEffect20: return "\u{fc36}"
        case .videoLayout12: return "\u{fc37}"
        case .videoLayout16: return "\u{fc38}"
        case .videoLayoutAuto12: return "\u{fc39}"
        case .videoLayoutAuto16: return "\u{fc3a}"
        case .videoLayoutAuto20: return "\u{fc3b}"
        case .videoLayoutAuto24: return "\u{fc3c}"
        case .videoLayoutEqual12: return "\u{fc3d}"
        case .videoLayoutEqual14: return "\u{fc3e}"
        case .videoLayoutEqual16: return "\u{fc3f}"
        case .videoLayoutEqual20: return "\u{fc40}"
        case .videoLayoutEqual24: return "\u{fc41}"
        case .videoLayoutEqual28: return "\u{fc42}"
        case .videoLayoutEqualFilled24: return "\u{fc43}"
        case .videoLayoutOverlay12: return "\u{fc44}"
        case .videoLayoutOverlay16: return "\u{fc45}"
        case .videoLayoutOverlay20: return "\u{fc46}"
        case .videoLayoutOverlay24: return "\u{fc47}"
        case .videoLayoutProminent12: return "\u{fc48}"
        case .videoLayoutProminent16: return "\u{fc49}"
        case .videoLayoutProminent20: return "\u{fc4a}"
        case .videoLayoutProminent24: return "\u{fc4b}"
        case .videoLayoutShareDominant12: return "\u{fc4c}"
        case .videoLayoutShareDominant16: return "\u{fc4d}"
        case .videoLayoutShareDominant20: return "\u{fc4e}"
        case .videoLayoutShareDominant24: return "\u{fc4f}"
        case .videoLayoutSingle12: return "\u{fc50}"
        case .videoLayoutSingle16: return "\u{fc51}"
        case .videoLayoutSingle20: return "\u{fc52}"
        case .videoLayoutSingle28: return "\u{fc53}"
        case .videoLayoutStack12: return "\u{fc54}"
        case .videoLayoutStack16: return "\u{fc55}"
        case .videoLayoutStack20: return "\u{fc56}"
        case .videoLayoutStack24: return "\u{fc57}"
        case .videoLayoutStack28: return "\u{fc58}"
        case .videoLayoutStackFilled24: return "\u{fc59}"
        case .videoLayoutVideoDominant12: return "\u{fc5a}"
        case .videoLayoutVideoDominant16: return "\u{fc5b}"
        case .videoLayoutVideoDominant20: return "\u{fc5c}"
        case .videoLayoutVideoDominant24: return "\u{fc5d}"
        case .viewAll12: return "\u{fc5e}"
        case .viewAll14: return "\u{fc5f}"
        case .viewFeedMultiple16: return "\u{fc60}"
        case .viewFeedPanel16: return "\u{fc61}"
        case .viewFeedSingle16: return "\u{fc62}"
        case .viewList10: return "\u{fc63}"
        case .viewList12: return "\u{fc64}"
        case .viewList14: return "\u{fc65}"
        case .viewList16: return "\u{fc66}"
        case .viewList20: return "\u{fc67}"
        case .viewList24: return "\u{fc68}"
        case .viewList28: return "\u{fc69}"
        case .viewListCircle100: return "\u{fc6a}"
        case .viewMixed12: return "\u{fc6b}"
        case .viewStack12: return "\u{fc6c}"
        case .viewStack14: return "\u{fc6d}"
        case .viewStack20: return "\u{fc6e}"
        case .viewStack24: return "\u{fc6f}"
        case .viewThumbnail12: return "\u{fc70}"
        case .viewThumbnail14: return "\u{fc71}"
        case .viewThumbnail16: return "\u{fc72}"
        case .viewThumbnail20: return "\u{fc73}"
        case .viewThumbnail24: return "\u{fc74}"
        case .voice20: return "\u{fc75}"
        case .voicemail10: return "\u{fc76}"
        case .voicemail14: return "\u{fc77}"
        case .voicemail16: return "\u{fc78}"
        case .voicemail18: return "\u{fc79}"
        case .voicemail20: return "\u{fc7a}"
        case .voicemail22: return "\u{fc7b}"
        case .voicemail24: return "\u{fc7c}"
        case .voicemail28: return "\u{fc7d}"
        case .voicemail8: return "\u{fc7e}"
        case .voicemailActive12: return "\u{fc7f}"
        case .voicemailActive14: return "\u{fc80}"
        case .voicemailActive16: return "\u{fc81}"
        case .voicemailActive18: return "\u{fc82}"
        case .voicemailActive20: return "\u{fc83}"
        case .voicemailActive22: return "\u{fc84}"
        case .voicemailActive24: return "\u{fc85}"
        case .voicemailActive28: return "\u{fc86}"
        case .wallpaper16: return "\u{fc87}"
        case .wallpaper20: return "\u{fc88}"
        case .wallpaper24: return "\u{fc89}"
        case .wallpaper28: return "\u{fc8a}"
        case .wallpaper32: return "\u{fc8b}"
        case .warning100: return "\u{fc8c}"
        case .warning12: return "\u{fc8d}"
        case .warning14: return "\u{fc8e}"
        case .warning16: return "\u{fc8f}"
        case .warning20: return "\u{fc90}"
        case .warning24: return "\u{fc91}"
        case .warning28: return "\u{fc92}"
        case .warning32: return "\u{fc93}"
        case .warning40: return "\u{fc94}"
        case .warning44: return "\u{fc95}"
        case .warning56: return "\u{fc96}"
        case .warning64: return "\u{fc97}"
        case .warning72: return "\u{fc98}"
        case .warningActive12: return "\u{fc99}"
        case .warningActive16: return "\u{fc9a}"
        case .waveform20: return "\u{fc9b}"
        case .webSharing16: return "\u{fc9c}"
        case .webSharing24: return "\u{fc9d}"
        case .webex10: return "\u{fc9e}"
        case .webex16: return "\u{fc9f}"
        case .webex24: return "\u{fca0}"
        case .webex48: return "\u{fca1}"
        case .webexBoard12: return "\u{fca2}"
        case .webexBoard14: return "\u{fca3}"
        case .webexBoard16: return "\u{fca4}"
        case .webexBoard20: return "\u{fca5}"
        case .webexBoard24: return "\u{fca6}"
        case .webexBoard28: return "\u{fca7}"
        case .webexBoard32: return "\u{fca8}"
        case .webexBoard48: return "\u{fca9}"
        case .webexCalling10: return "\u{fcaa}"
        case .webexCalling12: return "\u{fcab}"
        case .webexCalling16: return "\u{fcac}"
        case .webexCalling18: return "\u{fcad}"
        case .webexCalling20: return "\u{fcae}"
        case .webexCalling24: return "\u{fcaf}"
        case .webexCodecPlus16: return "\u{fcb0}"
        case .webexCodecPlus20: return "\u{fcb1}"
        case .webexCommunity20: return "\u{fcb2}"
        case .webexDeskCamera20: return "\u{fcb3}"
        case .webexInstantMeeting12: return "\u{fcb4}"
        case .webexInstantMeeting14: return "\u{fcb5}"
        case .webexInstantMeeting16: return "\u{fcb6}"
        case .webexInstantMeeting20: return "\u{fcb7}"
        case .webexInstantMeeting24: return "\u{fcb8}"
        case .webexMeetings10: return "\u{fcb9}"
        case .webexMeetings12: return "\u{fcba}"
        case .webexMeetings14: return "\u{fcbb}"
        case .webexMeetings16: return "\u{fcbc}"
        case .webexMeetings20: return "\u{fcbd}"
        case .webexMeetings24: return "\u{fcbe}"
        case .webexMeetings48: return "\u{fcbf}"
        case .webexQuadCamera16: return "\u{fcc0}"
        case .webexQuadCamera20: return "\u{fcc1}"
        case .webexRoomKit16: return "\u{fcc2}"
        case .webexRoomKit20: return "\u{fcc3}"
        case .webexRoomKitPlus16: return "\u{fcc4}"
        case .webexRoomKitPlus20: return "\u{fcc5}"
        case .webexShare12: return "\u{fcc6}"
        case .webexShare14: return "\u{fcc7}"
        case .webexShare16: return "\u{fcc8}"
        case .webexShare20: return "\u{fcc9}"
        case .webexTeams10: return "\u{fcca}"
        case .webexTeams12: return "\u{fccb}"
        case .webexTeams14: return "\u{fccc}"
        case .webexTeams16: return "\u{fccd}"
        case .webexTeams18: return "\u{fcce}"
        case .webexTeams20: return "\u{fccf}"
        case .webexVoice16: return "\u{fcd0}"
        case .webexVoice20: return "\u{fcd1}"
        case .webpop12: return "\u{fcd2}"
        case .webpop16: return "\u{fcd3}"
        case .webpop20: return "\u{fcd4}"
        case .webpop24: return "\u{fcd5}"
        case .whatsApp12: return "\u{fcd6}"
        case .whatsApp16: return "\u{fcd7}"
        case .whiteboard10: return "\u{fcd8}"
        case .whiteboard12: return "\u{fcd9}"
        case .whiteboard14: return "\u{fcda}"
        case .whiteboard16: return "\u{fcdb}"
        case .whiteboard20: return "\u{fcdc}"
        case .whiteboard24: return "\u{fcdd}"
        case .whiteboard26: return "\u{fcde}"
        case .whiteboard28: return "\u{fcdf}"
        case .whiteboard32: return "\u{fce0}"
        case .whiteboard36: return "\u{fce1}"
        case .whiteboard8: return "\u{fce2}"
        case .whiteboardContent16: return "\u{fce3}"
        case .whiteboardContent24: return "\u{fce4}"
        case .widgetsAdr20: return "\u{fce5}"
        case .wifi12: return "\u{fce6}"
        case .wifi16: return "\u{fce7}"
        case .wifi20: return "\u{fce8}"
        case .wifi24: return "\u{fce9}"
        case .wifiError12: return "\u{fcea}"
        case .wifiError16: return "\u{fceb}"
        case .wifiSelected24: return "\u{fcec}"
        case .wikipedia16: return "\u{fced}"
        case .windowCornerScrub16: return "\u{fcee}"
        case .windowVerticalScrub16: return "\u{fcef}"
        case .youtubeCircle24: return "\u{fcf0}"
        case .youtubeCircle32: return "\u{fcf1}"
        case .youtubeCircle40: return "\u{fcf2}"
        case .zoomIn12: return "\u{fcf3}"
        case .zoomIn14: return "\u{fcf4}"
        case .zoomIn16: return "\u{fcf5}"
        case .zoomIn20: return "\u{fcf6}"
        case .zoomOut12: return "\u{fcf7}"
        case .zoomOut14: return "\u{fcf8}"
        case .zoomOut16: return "\u{fcf9}"
        case .zoomOut20: return "\u{fcfa}"
