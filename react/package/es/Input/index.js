...
var Input = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    var clearButton = clear && !disabled && value && /*#__PURE__*/React.createElement(InputSection, {
      position: "after"
    ...
    var inputSection = function inputSection(position) {
      return _this2.props["input" + position] && /*#__PURE__*/React.createElement(InputSection, {
    ...
    var inputElement = /*#__PURE__*/React.createElement("div", {
      className: 'md-input__wrapper' + ("" + (inputSize ? " columns " + inputSize : ''))
    }, inputLeft, /*#__PURE__*/React.createElement(InputTag, _extends({
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      htmlFor: htmlId || id,
      label: label
    }), inputElement, secondaryLabel && /*#__PURE__*/React.createElement(Label, {
      className: "md-input__secondary-label",
      htmlFor: htmlId || id,
      label: secondaryLabel
    }), helpText && /*#__PURE__*/React.createElement(InputHelper, {
      message: helpText
    }), messages && /*#__PURE__*/React.createElement("div", {
      className: "md-input__messages"
    }, messages.map(function (m, i) {
      return /*#__PURE__*/React.createElement(InputMessage, {
        message: m,
        key: "input-message-" + i
      });
    })));
