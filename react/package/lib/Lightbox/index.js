  ...
  _proto.render = function render() {
    ...
    var getThumbnails = function getThumbnails() {
      var thumbnails = pages.map(function (page, idx) {
        ...
        if (page.decrypting) {
          ...
          body = /*#__PURE__*/_react.default.createElement("img", {
            alt: "",
            className: "md-lightbox__thumbnail" + ("" + (!!page.decrypting && " md-lightbox__thumbnail--decrypting" || '')),
            "data-index": idx,
            draggable: "false",
        ...
        return /*#__PURE__*/_react.default.createElement("div", {
          ...
          role: "button",
          tabIndex: "0"
        }, body, /*#__PURE__*/_react.default.createElement("div", null, idx + 1));
      });
      return /*#__PURE__*/_react.default.createElement("div", {
    ...
    var getViewport = function getViewport() {
      ...
      if (currentPage.content) {
        ...
        viewport = /*#__PURE__*/_react.default.createElement("div", {
        ...
        if (zoom <= 1) {
          ...
          viewport = /*#__PURE__*/_react.default.createElement("img", {
            alt: "",
    ...
    var leftArrowControl = /*#__PURE__*/_react.default.createElement(_.Tooltip, {
    ...
    var rightArrowControl = /*#__PURE__*/_react.default.createElement(_.Tooltip, {
    ...
    var viewportControls = function viewportControls() {
      var downloadButton = /*#__PURE__*/_react.default.createElement("div", {
      ...
      var pageControl = pages.length > 1 ? /*#__PURE__*/_react.default.createElement("div", {
      ...
      }, index + 1 + " / " + pages.length), /*#__PURE__*/_react.default.createElement(_.Tooltip, {
        tooltip: tooltips.next
      }, /*#__PURE__*/_react.default.createElement("div", {
        className: "md-lightbox__control",
        role: "button",
      ...
      return /*#__PURE__*/_react.default.createElement("div", {
        ...
        className: "md-lightbox__control-value"
      }, Math.round(newHeight * 1.0 / height * 100), "%"), /*#__PURE__*/_react.default.createElement(_.Tooltip, {
        ...
        name: "zoom-in_16"
      })))), pageControl, /*#__PURE__*/_react.default.createElement("div", {
        className: "md-lightbox__controls",
        style: controlStyle
      }, /*#__PURE__*/_react.default.createElement("span", {
        className: "md-lightbox__control-value"
      }, info.size), /*#__PURE__*/_react.default.createElement(_.Tooltip, {
        tooltip: downloading ? tooltips.downloading : tooltips.download
      }, downloading ? /*#__PURE__*/_react.default.createElement("div", {
    ...
    return /*#__PURE__*/_react.default.createElement(_reactAriaModal.default, {
    ...
    }, info.sharedBy), /*#__PURE__*/_react.default.createElement("div", {
      className: "md-lightbox__header-timestamp"
    }, info.sharedOn))), /*#__PURE__*/_react.default.createElement("div", {
    ...
    }, showColumn && getThumbnails(), /*#__PURE__*/_react.default.createElement("div", {
    ...
    }, pages[index].decrypting && /*#__PURE__*/_react.default.createElement(_.Spinner, {
