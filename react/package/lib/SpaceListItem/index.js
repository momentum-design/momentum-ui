...
var SpaceListItem = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _proto.render = function render() {
    ...
    var leftSection = isOverview ? _react.default.createElement(_.Avatar, {
    ...
    var rightSection = _react.default.createElement(_.ListItemSection, {
      key: "child-2",
      position: "right"
    ...
    var highlightSubheader = function highlightSubheader() {
      ...
      return searchTerm && typeof subheader === 'string' ? subheader.split(re).map(function (ele, idx) {
        return ele.match(re) ? _react.default.createElement("span", {
          key: "subheader-" + idx,
    ...
    var getHeader = ['search', 'filter', 'flag', 'filter-search'].includes(type) ? [_react.default.createElement("span", {
      key: "header-0",
      className: "md-list-item__header-main"
    }, header), headerSecondary && _react.default.createElement("span", {
    ...
    var children = [_react.default.createElement(_.ListItemSection, {
      key: "child-0",
      position: "left"
    }, leftSection || _react.default.createElement(_.Avatar, {
      title: "NA"
    ...
    }, getHeader), ['search', 'filter', 'flag', 'filter-search'].includes(type) ? _react.default.createElement(_.ListItemSection, {
      position: "center",
      className: "md-list-item__result-container"
    }, ['flag'].includes(type) ? _react.default.createElement(_.ListItemSection, {
      position: "center",
    ...
    }, highlightSubheader(subheader)), resultRight && _react.default.createElement(_.ListItemSection, {
      position: "right",
      className: "md-list-item__attachment--top-right"
    }, resultRight)), attachments && attachments.length && _react.default.createElement("div", {
      className: "md-list-item__attachment--bottom"
    }, attachments[0])) : _react.default.createElement("div", {
      className: "md-list-item__result"
    }, highlightSubheader(subheader))) : _react.default.createElement("div", {
