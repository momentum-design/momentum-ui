...
@objc public enum MomentumIconsRebrandType: Int {
    ...
    public var ligature: String {
        ...
        case .multimediaFilled: return "\u{f5dc}"
        case .multimediaLight: return "\u{f5dd}"
        case .multimediaRegular: return "\u{f5de}"
        case .multipledDevicesBold: return "\u{f5df}"
        case .multipledDevicesLight: return "\u{f5e0}"
        case .multipledDevicesRegular: return "\u{f5e1}"
        case .musicModeBold: return "\u{f5e2}"
        case .musicModeCircleBold: return "\u{f5e3}"
        case .musicModeCircleFilled: return "\u{f5e4}"
        case .musicModeCircleLight: return "\u{f5e5}"
        case .musicModeCircleRegular: return "\u{f5e6}"
        case .musicModeFilled: return "\u{f5e7}"
        case .musicModeLight: return "\u{f5e8}"
        case .musicModeRegular: return "\u{f5e9}"
        case .muteOnEntryBold: return "\u{f5ea}"
        case .muteOnEntryFilled: return "\u{f5eb}"
        case .muteOnEntryLight: return "\u{f5ec}"
        case .muteOnEntryRegular: return "\u{f5ed}"
        case .newVoicemailBold: return "\u{f5ee}"
        case .newVoicemailLight: return "\u{f5ef}"
        case .newVoicemailRegular: return "\u{f5f0}"
        case .newWhiteboardBold: return "\u{f5f1}"
        case .newWhiteboardLight: return "\u{f5f2}"
        case .newWhiteboardRegular: return "\u{f5f3}"
        case .nextBold: return "\u{f5f4}"
        case .nextLight: return "\u{f5f5}"
        case .nextRegular: return "\u{f5f6}"
        case .noDevicesBold: return "\u{f5f7}"
        case .noDevicesLight: return "\u{f5f8}"
        case .noDevicesRegular: return "\u{f5f9}"
        case .noiseRemovalBold: return "\u{f5fa}"
        case .noiseRemovalLight: return "\u{f5fb}"
        case .noiseRemovalRegular: return "\u{f5fc}"
        case .noteBold: return "\u{f5fd}"
        case .noteLight: return "\u{f5fe}"
        case .notePptBold: return "\u{f5ff}"
        case .notePptLight: return "\u{f600}"
        case .notePptRegular: return "\u{f601}"
        case .noteRegular: return "\u{f602}"
        case .notesBold: return "\u{f603}"
        case .notesLight: return "\u{f604}"
        case .notesRegular: return "\u{f605}"
        case .numberBold: return "\u{f606}"
        case .numberLight: return "\u{f607}"
        case .numberRegular: return "\u{f608}"
        case .oldRemoteBold: return "\u{f609}"
        case .oldRemoteLight: return "\u{f60a}"
        case .oldRemoteRegular: return "\u{f60b}"
        case .oldTouchBold: return "\u{f60c}"
        case .oldTouchLight: return "\u{f60d}"
        case .oldTouchRegular: return "\u{f60e}"
        case .openInFolderBold: return "\u{f60f}"
        case .openInFolderLight: return "\u{f610}"
        case .openInFolderRegular: return "\u{f611}"
        case .openPagesBold: return "\u{f612}"
        case .openPagesLight: return "\u{f613}"
        case .openPagesRegular: return "\u{f614}"
        case .otherNumberBold: return "\u{f615}"
        case .otherNumberLight: return "\u{f616}"
        case .otherNumberRegular: return "\u{f617}"
        case .otherNumberWarningBold: return "\u{f618}"
        case .otherNumberWarningLight: return "\u{f619}"
        case .otherNumberWarningRegular: return "\u{f61a}"
        case .outgoingCallLegacyBold: return "\u{f61b}"
        case .outgoingCallLegacyLight: return "\u{f61c}"
        case .outgoingCallLegacyRegular: return "\u{f61d}"
        case .overflowLeftBold: return "\u{f61e}"
        case .overflowLeftLight: return "\u{f61f}"
        case .overflowLeftRegular: return "\u{f620}"
        case .overflowRightBold: return "\u{f621}"
        case .overflowRightLight: return "\u{f622}"
        case .overflowRightRegular: return "\u{f623}"
        case .pairedCameraBold: return "\u{f624}"
        case .pairedCameraLight: return "\u{f625}"
        case .pairedCameraRegular: return "\u{f626}"
        case .pairedDeviceBold: return "\u{f627}"
        case .pairedDeviceLight: return "\u{f628}"
        case .pairedDeviceRegular: return "\u{f629}"
        case .pairedHandsetBold: return "\u{f62a}"
        case .pairedHandsetLight: return "\u{f62b}"
        case .pairedHandsetRegular: return "\u{f62c}"
        case .pairingBold: return "\u{f62d}"
        case .pairingLight: return "\u{f62e}"
        case .pairingRegular: return "\u{f62f}"
        case .parkedBold: return "\u{f630}"
        case .parkedFilled: return "\u{f631}"
        case .parkedLight: return "\u{f632}"
        case .parkedRegular: return "\u{f633}"
        case .parseBold: return "\u{f634}"
        case .parseLight: return "\u{f635}"
        case .parseRegular: return "\u{f636}"
        case .participantAddBold: return "\u{f637}"
        case .participantAddLight: return "\u{f638}"
        case .participantAddRegular: return "\u{f639}"
        case .participantBlockedBold: return "\u{f63a}"
        case .participantBlockedLight: return "\u{f63b}"
        case .participantBlockedRegular: return "\u{f63c}"
        case .participantBold: return "\u{f63d}"
        case .participantFilled: return "\u{f63e}"
        case .participantLight: return "\u{f63f}"
        case .participantListBold: return "\u{f640}"
        case .participantListFilled: return "\u{f641}"
        case .participantListLight: return "\u{f642}"
        case .participantListRegular: return "\u{f643}"
        case .participantRegular: return "\u{f644}"
        case .participantRemoveBold: return "\u{f645}"
        case .participantRemoveLight: return "\u{f646}"
        case .participantRemoveRegular: return "\u{f647}"
        case .participantUnknownBold: return "\u{f648}"
        case .participantUnknownLight: return "\u{f649}"
        case .participantUnknownRegular: return "\u{f64a}"
        case .passMouseBold: return "\u{f64b}"
        case .passMouseLight: return "\u{f64c}"
        case .passMouseRegular: return "\u{f64d}"
        case .pauseBold: return "\u{f64e}"
        case .pauseFilled: return "\u{f64f}"
        case .pauseLight: return "\u{f650}"
        case .pauseRegular: return "\u{f651}"
        case .penBold: return "\u{f652}"
        case .penFilled: return "\u{f653}"
        case .penLight: return "\u{f654}"
        case .penRegular: return "\u{f655}"
        case .peopleBold: return "\u{f656}"
        case .peopleCircleBold: return "\u{f657}"
        case .peopleCircleFilled: return "\u{f658}"
        case .peopleCircleLight: return "\u{f659}"
        case .peopleCircleRegular: return "\u{f65a}"
        case .peopleFilled: return "\u{f65b}"
        case .peopleInsightsFilled: return "\u{f65c}"
        case .peopleLight: return "\u{f65d}"
        case .peopleRegular: return "\u{f65e}"
        case .phoneAlertBold: return "\u{f65f}"
        case .phoneAlertLight: return "\u{f660}"
        case .phoneAlertRegular: return "\u{f661}"
        case .phoneBold: return "\u{f662}"
        case .phoneFilled: return "\u{f663}"
        case .phoneLight: return "\u{f664}"
        case .phoneMutedBold: return "\u{f665}"
        case .phoneMutedLight: return "\u{f666}"
        case .phoneMutedRegular: return "\u{f667}"
        case .phonePrivateBold: return "\u{f668}"
        case .phonePrivateLight: return "\u{f669}"
        case .phonePrivateRegular: return "\u{f66a}"
        case .phoneRegular: return "\u{f66b}"
        case .phoneReplyAllBold: return "\u{f66c}"
        case .phoneReplyAllLight: return "\u{f66d}"
        case .phoneReplyAllRegular: return "\u{f66e}"
        case .phoneReplyBold: return "\u{f66f}"
        case .phoneReplyLight: return "\u{f670}"
        case .phoneReplyRegular: return "\u{f671}"
        case .phoneSmallFilled: return "\u{f672}"
        case .pickerBold: return "\u{f673}"
        case .pickerLight: return "\u{f674}"
        case .pickerRegular: return "\u{f675}"
        case .pictureInPictureBold: return "\u{f676}"
        case .pictureInPictureLight: return "\u{f677}"
        case .pictureInPictureRegular: return "\u{f678}"
        case .pieChartBold: return "\u{f679}"
        case .pieChartFilled: return "\u{f67a}"
        case .pieChartLight: return "\u{f67b}"
        case .pieChartRegular: return "\u{f67c}"
        case .pinBold: return "\u{f67d}"
        case .pinFilled: return "\u{f67e}"
        case .pinLight: return "\u{f67f}"
        case .pinListActivityColoredBold: return "\u{f680}"
        case .pinListActivityColoredLight: return "\u{f681}"
        case .pinListActivityColoredRegular: return "\u{f682}"
        case .pinListBold: return "\u{f683}"
        case .pinListLight: return "\u{f684}"
        case .pinListRegular: return "\u{f685}"
        case .pinMutedBold: return "\u{f686}"
        case .pinMutedLight: return "\u{f687}"
        case .pinMutedRegular: return "\u{f688}"
        case .pinRegular: return "\u{f689}"
        case .placeholderBold: return "\u{f68a}"
        case .placeholderLight: return "\u{f68b}"
        case .placeholderRegular: return "\u{f68c}"
        case .playBold: return "\u{f68d}"
        case .playFilled: return "\u{f68e}"
        case .playLight: return "\u{f68f}"
        case .playRegular: return "\u{f690}"
        case .plugAcBold: return "\u{f691}"
        case .plugAcLight: return "\u{f692}"
        case .plugAcRegular: return "\u{f693}"
        case .plusBold: return "\u{f694}"
        case .plusCircleBold: return "\u{f695}"
        case .plusCircleFilled: return "\u{f696}"
        case .plusCircleLight: return "\u{f697}"
        case .plusCircleRegular: return "\u{f698}"
        case .plusLight: return "\u{f699}"
        case .plusRegular: return "\u{f69a}"
        case .pmrBold: return "\u{f69b}"
        case .pmrFilled: return "\u{f69c}"
        case .pmrLight: return "\u{f69d}"
        case .pmrRegular: return "\u{f69e}"
        case .pollBold: return "\u{f69f}"
        case .pollLight: return "\u{f6a0}"
        case .pollRegular: return "\u{f6a1}"
        case .popInBold: return "\u{f6a2}"
        case .popInLight: return "\u{f6a3}"
        case .popInRegular: return "\u{f6a4}"
        case .popOutBold: return "\u{f6a5}"
        case .popOutLight: return "\u{f6a6}"
        case .popOutRegular: return "\u{f6a7}"
        case .popUpBold: return "\u{f6a8}"
        case .popUpLight: return "\u{f6a9}"
        case .popUpRegular: return "\u{f6aa}"
        case .portraitLandscapeBold: return "\u{f6ab}"
        case .portraitLandscapeLight: return "\u{f6ac}"
        case .portraitLandscapeRegular: return "\u{f6ad}"
        case .powerAcBold: return "\u{f6ae}"
        case .powerAcLight: return "\u{f6af}"
        case .powerAcRegular: return "\u{f6b0}"
        case .powerBold: return "\u{f6b1}"
        case .powerLight: return "\u{f6b2}"
        case .powerRegular: return "\u{f6b3}"
        case .presentationBold: return "\u{f6b4}"
        case .presentationLight: return "\u{f6b5}"
        case .presentationRegular: return "\u{f6b6}"
        case .printBold: return "\u{f6b7}"
        case .printLight: return "\u{f6b8}"
        case .printRegular: return "\u{f6b9}"
        case .priorityBadgeFilled: return "\u{f6ba}"
        case .priorityCircleBold: return "\u{f6bb}"
        case .priorityCircleFilled: return "\u{f6bc}"
        case .priorityCircleLight: return "\u{f6bd}"
        case .priorityCircleRegular: return "\u{f6be}"
        case .priorityCircleTwoBold: return "\u{f6bf}"
        case .priorityCircleTwoFilled: return "\u{f6c0}"
        case .priorityCircleTwoLight: return "\u{f6c1}"
        case .priorityCircleTwoRegular: return "\u{f6c2}"
        case .privacyCircleBold: return "\u{f6c3}"
        case .privacyCircleFilled: return "\u{f6c4}"
        case .privacyCircleLight: return "\u{f6c5}"
        case .privacyCircleRegular: return "\u{f6c6}"
        case .privateBold: return "\u{f6c7}"
        case .privateCircleBold: return "\u{f6c8}"
        case .privateCircleFilled: return "\u{f6c9}"
        case .privateCircleLight: return "\u{f6ca}"
        case .privateCircleRegular: return "\u{f6cb}"
        case .privateLight: return "\u{f6cc}"
        case .privateMeetingBold: return "\u{f6cd}"
        case .privateMeetingLight: return "\u{f6ce}"
        case .privateMeetingRegular: return "\u{f6cf}"
        case .privateRegular: return "\u{f6d0}"
        case .productDemoBold: return "\u{f6d1}"
        case .productDemoLight: return "\u{f6d2}"
        case .productDemoRegular: return "\u{f6d3}"
        case .proximityBold: return "\u{f6d4}"
        case .proximityLight: return "\u{f6d5}"
        case .proximityMutedBold: return "\u{f6d6}"
        case .proximityMutedLight: return "\u{f6d7}"
        case .proximityMutedRegular: return "\u{f6d8}"
        case .proximityRegular: return "\u{f6d9}"
        case .proximityVideoBold: return "\u{f6da}"
        case .proximityVideoLight: return "\u{f6db}"
        case .proximityVideoRegular: return "\u{f6dc}"
        case .ptoPresenceBold: return "\u{f6dd}"
        case .ptoPresenceFilled: return "\u{f6de}"
        case .ptoPresenceLight: return "\u{f6df}"
        case .ptoPresenceRegular: return "\u{f6e0}"
        case .pullCallBold: return "\u{f6e1}"
        case .pullCallLight: return "\u{f6e2}"
        case .pullCallRegular: return "\u{f6e3}"
        case .qABold: return "\u{f6e4}"
        case .qALight: return "\u{f6e5}"
        case .qARegular: return "\u{f6e6}"
        case .qualityBold: return "\u{f6e7}"
        case .qualityLight: return "\u{f6e8}"
        case .qualityRegular: return "\u{f6e9}"
        case .queueContactBold: return "\u{f6ea}"
        case .queueContactLight: return "\u{f6eb}"
        case .queueContactRegular: return "\u{f6ec}"
        case .quietBold: return "\u{f6ed}"
        case .quietHoursPresenceBold: return "\u{f6ee}"
        case .quietHoursPresenceFilled: return "\u{f6ef}"
        case .quietHoursPresenceLight: return "\u{f6f0}"
        case .quietHoursPresenceRegular: return "\u{f6f1}"
        case .quietLight: return "\u{f6f2}"
        case .quietRegular: return "\u{f6f3}"
        case .raiseHandBold: return "\u{f6f4}"
        case .raiseHandLight: return "\u{f6f5}"
        case .raiseHandRegular: return "\u{f6f6}"
        case .ramBold: return "\u{f6f7}"
        case .ramLight: return "\u{f6f8}"
        case .ramRegular: return "\u{f6f9}"
        case .reactionsBold: return "\u{f6fa}"
        case .reactionsFilled: return "\u{f6fb}"
        case .reactionsLight: return "\u{f6fc}"
        case .reactionsRegular: return "\u{f6fd}"
        case .reactivateBold: return "\u{f6fe}"
        case .reactivateLight: return "\u{f6ff}"
        case .reactivateRegular: return "\u{f700}"
        case .recentsBold: return "\u{f701}"
        case .recentsFilled: return "\u{f702}"
        case .recentsLight: return "\u{f703}"
        case .recentsPresenceBold: return "\u{f704}"
        case .recentsPresenceFilled: return "\u{f705}"
        case .recentsPresenceLight: return "\u{f706}"
        case .recentsPresenceRegular: return "\u{f707}"
        case .recentsPresenceSmallFilled: return "\u{f708}"
        case .recentsRegular: return "\u{f709}"
        case .recordBold: return "\u{f70a}"
        case .recordFilled: return "\u{f70b}"
        case .recordLight: return "\u{f70c}"
        case .recordPausedBold: return "\u{f70d}"
        case .recordPausedFilled: return "\u{f70e}"
        case .recordPausedLight: return "\u{f70f}"
        case .recordPausedRegular: return "\u{f710}"
        case .recordRegular: return "\u{f711}"
        case .recurringBold: return "\u{f712}"
        case .recurringLight: return "\u{f713}"
        case .recurringOffBold: return "\u{f714}"
        case .recurringOffLight: return "\u{f715}"
        case .recurringOffRegular: return "\u{f716}"
        case .recurringRegular: return "\u{f717}"
        case .redialBold: return "\u{f718}"
        case .redialLight: return "\u{f719}"
        case .redialRegular: return "\u{f71a}"
        case .redoBold: return "\u{f71b}"
        case .redoLight: return "\u{f71c}"
        case .redoRegular: return "\u{f71d}"
        case .refreshBold: return "\u{f71e}"
        case .refreshLight: return "\u{f71f}"
        case .refreshRegular: return "\u{f720}"
        case .remoteDesktopControlBold: return "\u{f721}"
        case .remoteDesktopControlFilled: return "\u{f722}"
        case .remoteDesktopControlLight: return "\u{f723}"
        case .remoteDesktopControlRegular: return "\u{f724}"
        case .removeBold: return "\u{f725}"
        case .removeFilled: return "\u{f726}"
        case .removeLight: return "\u{f727}"
        case .removeRegular: return "\u{f728}"
        case .replyBold: return "\u{f729}"
        case .replyFilled: return "\u{f72a}"
        case .replyLight: return "\u{f72b}"
        case .replyListBold: return "\u{f72c}"
        case .replyListLight: return "\u{f72d}"
        case .replyListRegular: return "\u{f72e}"
        case .replyRegular: return "\u{f72f}"
        case .resetBold: return "\u{f730}"
        case .resetLight: return "\u{f731}"
        case .resetRegular: return "\u{f732}"
        case .responsiveMobileBold: return "\u{f733}"
        case .responsiveMobileLight: return "\u{f734}"
        case .responsiveMobileRegular: return "\u{f735}"
        case .restartBold: return "\u{f736}"
        case .restartLight: return "\u{f737}"
        case .restartRegular: return "\u{f738}"
        case .returnBold: return "\u{f739}"
        case .returnLight: return "\u{f73a}"
        case .returnRegular: return "\u{f73b}"
        case .ringtoneBold: return "\u{f73c}"
        case .ringtoneLight: return "\u{f73d}"
        case .ringtoneRegular: return "\u{f73e}"
        case .roomCalendarBold: return "\u{f73f}"
        case .roomCalendarLight: return "\u{f740}"
        case .roomCalendarRegular: return "\u{f741}"
        case .roomLightsBold: return "\u{f742}"
        case .roomLightsFilled: return "\u{f743}"
        case .roomLightsLight: return "\u{f744}"
        case .roomLightsRegular: return "\u{f745}"
        case .rotateContentBold: return "\u{f746}"
        case .rotateContentFilled: return "\u{f747}"
        case .rotateContentLight: return "\u{f748}"
        case .rotateContentRegular: return "\u{f749}"
        case .runningApplicationBold: return "\u{f74a}"
        case .runningApplicationFilled: return "\u{f74b}"
        case .runningApplicationLight: return "\u{f74c}"
        case .runningApplicationRegular: return "\u{f74d}"
        case .saveBold: return "\u{f74e}"
        case .saveLight: return "\u{f74f}"
        case .saveRegular: return "\u{f750}"
        case .scanBold: return "\u{f751}"
        case .scanLight: return "\u{f752}"
        case .scanRegular: return "\u{f753}"
        case .schedulerAvailableBold: return "\u{f754}"
        case .schedulerAvailableLight: return "\u{f755}"
        case .schedulerAvailableRegular: return "\u{f756}"
        case .schedulerNotWorkingHoursBold: return "\u{f757}"
        case .schedulerNotWorkingHoursLight: return "\u{f758}"
        case .schedulerNotWorkingHoursRegular: return "\u{f759}"
        case .schedulerUnavailableBold: return "\u{f75a}"
        case .schedulerUnavailableLight: return "\u{f75b}"
        case .schedulerUnavailableRegular: return "\u{f75c}"
        case .schedulerUnknownBold: return "\u{f75d}"
        case .schedulerUnknownLight: return "\u{f75e}"
        case .schedulerUnknownRegular: return "\u{f75f}"
        case .screenshotBold: return "\u{f760}"
        case .screenshotDocBold: return "\u{f761}"
        case .screenshotDocFilled: return "\u{f762}"
        case .screenshotDocLight: return "\u{f763}"
        case .screenshotDocRegular: return "\u{f764}"
        case .screenshotLight: return "\u{f765}"
        case .screenshotRegular: return "\u{f766}"
        case .searchBold: return "\u{f767}"
        case .searchLight: return "\u{f768}"
        case .searchRegular: return "\u{f769}"
        case .secondaryArrowBold: return "\u{f76a}"
        case .secondaryArrowLight: return "\u{f76b}"
        case .secondaryArrowRegular: return "\u{f76c}"
        case .secureCallLockBold: return "\u{f76d}"
        case .secureCallLockFilled: return "\u{f76e}"
        case .secureCallLockLight: return "\u{f76f}"
        case .secureCallLockRegular: return "\u{f770}"
        case .secureCallShieldBold: return "\u{f771}"
        case .secureCallShieldFilled: return "\u{f772}"
        case .secureCallShieldLight: return "\u{f773}"
        case .secureCallShieldRegular: return "\u{f774}"
        case .secureCircleBold: return "\u{f775}"
        case .secureCircleFilled: return "\u{f776}"
        case .secureCircleLight: return "\u{f777}"
        case .secureCircleRegular: return "\u{f778}"
        case .secureLockBold: return "\u{f779}"
        case .secureLockFilled: return "\u{f77a}"
        case .secureLockLight: return "\u{f77b}"
        case .secureLockRegular: return "\u{f77c}"
        case .selectAllBold: return "\u{f77d}"
        case .selectAllFilled: return "\u{f77e}"
        case .selectAllLight: return "\u{f77f}"
        case .selectAllRegular: return "\u{f780}"
        case .selectionBold: return "\u{f781}"
        case .selectionLight: return "\u{f782}"
        case .selectionRegular: return "\u{f783}"
        case .sendBold: return "\u{f784}"
        case .sendFilled: return "\u{f785}"
        case .sendLight: return "\u{f786}"
        case .sendRegular: return "\u{f787}"
        case .serverBold: return "\u{f788}"
        case .serverErrorBold: return "\u{f789}"
        case .serverErrorLight: return "\u{f78a}"
        case .serverErrorRegular: return "\u{f78b}"
        case .serverLight: return "\u{f78c}"
        case .serverRegular: return "\u{f78d}"
        case .servicesBold: return "\u{f78e}"
        case .servicesLight: return "\u{f78f}"
        case .servicesRegular: return "\u{f790}"
        case .setVariableBold: return "\u{f791}"
        case .setVariableLight: return "\u{f792}"
        case .setVariableRegular: return "\u{f793}"
        case .settingsBold: return "\u{f794}"
        case .settingsFilled: return "\u{f795}"
        case .settingsLight: return "\u{f796}"
        case .settingsRegular: return "\u{f797}"
        case .setupAssistantBold: return "\u{f798}"
        case .setupAssistantLight: return "\u{f799}"
        case .setupAssistantRegular: return "\u{f79a}"
        case .shapeDiagonalLineBold: return "\u{f79b}"
        case .shapeDiagonalLineLight: return "\u{f79c}"
        case .shapeDiagonalLineRegular: return "\u{f79d}"
        case .shapeOvalBold: return "\u{f79e}"
        case .shapeOvalLight: return "\u{f79f}"
        case .shapeOvalRegular: return "\u{f7a0}"
        case .shapesBold: return "\u{f7a1}"
        case .shapesLight: return "\u{f7a2}"
        case .shapesRegular: return "\u{f7a3}"
        case .shareCNativeAdrBold: return "\u{f7a4}"
        case .shareCNativeAdrLight: return "\u{f7a5}"
        case .shareCNativeAdrRegular: return "\u{f7a6}"
        case .shareCNativeIphBold: return "\u{f7a7}"
        case .shareCNativeIphLight: return "\u{f7a8}"
        case .shareCNativeIphRegular: return "\u{f7a9}"
        case .shareScreenBold: return "\u{f7aa}"
        case .shareScreenFilled: return "\u{f7ab}"
        case .shareScreenLight: return "\u{f7ac}"
        case .shareScreenRegular: return "\u{f7ad}"
        case .shareScreenSmallFilled: return "\u{f7ae}"
        case .shareSpaceBold: return "\u{f7af}"
        case .shareSpaceLight: return "\u{f7b0}"
        case .shareSpaceRegular: return "\u{f7b1}"
        case .shieldBold: return "\u{f7b2}"
        case .shieldLight: return "\u{f7b3}"
        case .shieldRegular: return "\u{f7b4}"
        case .showBold: return "\u{f7b5}"
        case .showFilled: return "\u{f7b6}"
        case .showLight: return "\u{f7b7}"
        case .showRegular: return "\u{f7b8}"
        case .signInBold: return "\u{f7b9}"
        case .signInForcedBold: return "\u{f7ba}"
        case .signInForcedLight: return "\u{f7bb}"
        case .signInForcedRegular: return "\u{f7bc}"
        case .signInLight: return "\u{f7bd}"
        case .signInRegular: return "\u{f7be}"
        case .signOutBold: return "\u{f7bf}"
        case .signOutLight: return "\u{f7c0}"
        case .signOutRegular: return "\u{f7c1}"
        case .signal0Bold: return "\u{f7c2}"
        case .signal0Light: return "\u{f7c3}"
        case .signal0Regular: return "\u{f7c4}"
        case .signal100Bold: return "\u{f7c5}"
        case .signal100Light: return "\u{f7c6}"
        case .signal100Regular: return "\u{f7c7}"
        case .signal25Bold: return "\u{f7c8}"
        case .signal25Light: return "\u{f7c9}"
        case .signal25Regular: return "\u{f7ca}"
        case .signal50Bold: return "\u{f7cb}"
        case .signal50Light: return "\u{f7cc}"
        case .signal50Regular: return "\u{f7cd}"
        case .signal75Bold: return "\u{f7ce}"
        case .signal75Light: return "\u{f7cf}"
        case .signal75Regular: return "\u{f7d0}"
        case .singleNumberReachBold: return "\u{f7d1}"
        case .singleNumberReachLight: return "\u{f7d2}"
        case .singleNumberReachRegular: return "\u{f7d3}"
        case .sipRegistrationInProgressBold: return "\u{f7d4}"
        case .sipRegistrationInProgressFilled: return "\u{f7d5}"
        case .sipRegistrationInProgressLight: return "\u{f7d6}"
        case .sipRegistrationInProgressRegular: return "\u{f7d7}"
        case .skipBold: return "\u{f7d8}"
        case .skipBwBold: return "\u{f7d9}"
        case .skipBwFilled: return "\u{f7da}"
        case .skipBwLight: return "\u{f7db}"
        case .skipBwRegular: return "\u{f7dc}"
        case .skipFwBold: return "\u{f7dd}"
        case .skipFwFilled: return "\u{f7de}"
        case .skipFwLight: return "\u{f7df}"
        case .skipFwRegular: return "\u{f7e0}"
        case .skipLight: return "\u{f7e1}"
        case .skipRegular: return "\u{f7e2}"
        case .speakerBold: return "\u{f7e3}"
        case .speakerDisconnectedBold: return "\u{f7e4}"
        case .speakerDisconnectedFilled: return "\u{f7e5}"
        case .speakerDisconnectedLight: return "\u{f7e6}"
        case .speakerDisconnectedRegular: return "\u{f7e7}"
        case .speakerFilled: return "\u{f7e8}"
        case .speakerLight: return "\u{f7e9}"
        case .speakerMutedBold: return "\u{f7ea}"
        case .speakerMutedFilled: return "\u{f7eb}"
        case .speakerMutedLight: return "\u{f7ec}"
        case .speakerMutedRegular: return "\u{f7ed}"
        case .speakerOffBold: return "\u{f7ee}"
        case .speakerOffFilled: return "\u{f7ef}"
        case .speakerOffLight: return "\u{f7f0}"
        case .speakerOffRegular: return "\u{f7f1}"
        case .speakerOnColoredBold: return "\u{f7f2}"
        case .speakerOnColoredLight: return "\u{f7f3}"
        case .speakerOnColoredRegular: return "\u{f7f4}"
        case .speakerRegular: return "\u{f7f5}"
        case .speakerTurnDownBold: return "\u{f7f6}"
        case .speakerTurnDownFilled: return "\u{f7f7}"
        case .speakerTurnDownLight: return "\u{f7f8}"
        case .speakerTurnDownRegular: return "\u{f7f9}"
        case .speakerTurnUpBold: return "\u{f7fa}"
        case .speakerTurnUpFilled: return "\u{f7fb}"
        case .speakerTurnUpLight: return "\u{f7fc}"
        case .speakerTurnUpRegular: return "\u{f7fd}"
        case .spinnerBold: return "\u{f7fe}"
        case .spinnerFilledBold: return "\u{f7ff}"
        case .spinnerFilledLight: return "\u{f800}"
        case .spinnerFilledRegular: return "\u{f801}"
        case .spinnerLight: return "\u{f802}"
        case .spinnerRegular: return "\u{f803}"
        case .stackedArea100ChartBold: return "\u{f804}"
        case .stackedArea100ChartFilled: return "\u{f805}"
        case .stackedArea100ChartLight: return "\u{f806}"
        case .stackedArea100ChartRegular: return "\u{f807}"
        case .stackedAreaChartBold: return "\u{f808}"
        case .stackedAreaChartFilled: return "\u{f809}"
        case .stackedAreaChartLight: return "\u{f80a}"
        case .stackedAreaChartRegular: return "\u{f80b}"
        case .stackedBar100ChartBold: return "\u{f80c}"
        case .stackedBar100ChartFilled: return "\u{f80d}"
        case .stackedBar100ChartLight: return "\u{f80e}"
        case .stackedBar100ChartRegular: return "\u{f80f}"
        case .stackedBarChartBold: return "\u{f810}"
        case .stackedBarChartFilled: return "\u{f811}"
        case .stackedBarChartLight: return "\u{f812}"
        case .stackedBarChartRegular: return "\u{f813}"
        case .startChatBold: return "\u{f814}"
        case .startChatLight: return "\u{f815}"
        case .startChatRegular: return "\u{f816}"
        case .stickersBold: return "\u{f817}"
        case .stickersLight: return "\u{f818}"
        case .stickersRegular: return "\u{f819}"
        case .stickiesBold: return "\u{f81a}"
        case .stickiesLight: return "\u{f81b}"
        case .stickiesRegular: return "\u{f81c}"
        case .stopBold: return "\u{f81d}"
        case .stopCircleBold: return "\u{f81e}"
        case .stopCircleFilled: return "\u{f81f}"
        case .stopCircleLight: return "\u{f820}"
        case .stopCircleRegular: return "\u{f821}"
        case .stopContentShareBold: return "\u{f822}"
        case .stopContentShareLight: return "\u{f823}"
        case .stopContentShareRegular: return "\u{f824}"
        case .stopFilled: return "\u{f825}"
        case .stopLight: return "\u{f826}"
        case .stopRegular: return "\u{f827}"
        case .storedInfoBold: return "\u{f828}"
        case .storedInfoFilled: return "\u{f829}"
        case .storedInfoLight: return "\u{f82a}"
        case .storedInfoRegular: return "\u{f82b}"
        case .streamingBold: return "\u{f82c}"
        case .streamingLight: return "\u{f82d}"
        case .streamingRegular: return "\u{f82e}"
        case .strikethroughBold: return "\u{f82f}"
        case .strikethroughLight: return "\u{f830}"
        case .strikethroughRegular: return "\u{f831}"
        case .subscriptBold: return "\u{f832}"
        case .subscriptLight: return "\u{f833}"
        case .subscriptRegular: return "\u{f834}"
        case .superscriptBold: return "\u{f835}"
        case .superscriptLight: return "\u{f836}"
        case .superscriptRegular: return "\u{f837}"
        case .sx10Bold: return "\u{f838}"
        case .sx10Light: return "\u{f839}"
        case .sx10Regular: return "\u{f83a}"
        case .sx20Bold: return "\u{f83b}"
        case .sx20Light: return "\u{f83c}"
        case .sx20Regular: return "\u{f83d}"
        case .sx80CodecBold: return "\u{f83e}"
        case .sx80CodecLight: return "\u{f83f}"
        case .sx80CodecRegular: return "\u{f840}"
        case .tableBold: return "\u{f841}"
        case .tableLight: return "\u{f842}"
        case .tableRegular: return "\u{f843}"
        case .tabletBold: return "\u{f844}"
        case .tabletLight: return "\u{f845}"
        case .tabletRegular: return "\u{f846}"
        case .tabsBold: return "\u{f847}"
        case .tabsLight: return "\u{f848}"
        case .tabsRegular: return "\u{f849}"
        case .tagBold: return "\u{f84a}"
        case .tagLight: return "\u{f84b}"
        case .tagRegular: return "\u{f84c}"
        case .telepresenceAlertBold: return "\u{f84d}"
        case .telepresenceAlertLight: return "\u{f84e}"
        case .telepresenceAlertMutedBold: return "\u{f84f}"
        case .telepresenceAlertMutedLight: return "\u{f850}"
        case .telepresenceAlertMutedRegular: return "\u{f851}"
        case .telepresenceAlertRegular: return "\u{f852}"
        case .telepresenceBold: return "\u{f853}"
        case .telepresenceIx5000Bold: return "\u{f854}"
        case .telepresenceIx5000Light: return "\u{f855}"
        case .telepresenceIx5000Regular: return "\u{f856}"
        case .telepresenceLight: return "\u{f857}"
        case .telepresencePrivateBold: return "\u{f858}"
        case .telepresencePrivateLight: return "\u{f859}"
        case .telepresencePrivateRegular: return "\u{f85a}"
        case .telepresenceRegular: return "\u{f85b}"
        case .temperatureBold: return "\u{f85c}"
        case .temperatureLight: return "\u{f85d}"
        case .temperatureRegular: return "\u{f85e}"
        case .textBold: return "\u{f85f}"
        case .textCodeBlockBold: return "\u{f860}"
        case .textCodeBlockLight: return "\u{f861}"
        case .textCodeBlockRegular: return "\u{f862}"
        case .textHighlightBold: return "\u{f863}"
        case .textHighlightLight: return "\u{f864}"
        case .textHighlightRegular: return "\u{f865}"
        case .textLight: return "\u{f866}"
        case .textRegular: return "\u{f867}"
        case .threeDObjectBold: return "\u{f868}"
        case .threeDObjectLight: return "\u{f869}"
        case .threeDObjectRegular: return "\u{f86a}"
        case .tooFastBold: return "\u{f86b}"
        case .tooFastLight: return "\u{f86c}"
        case .tooFastRegular: return "\u{f86d}"
        case .tooSlowBold: return "\u{f86e}"
        case .tooSlowLight: return "\u{f86f}"
        case .tooSlowRegular: return "\u{f870}"
        case .toolsBold: return "\u{f871}"
        case .toolsLight: return "\u{f872}"
        case .toolsRegular: return "\u{f873}"
        case .touch10Bold: return "\u{f874}"
        case .touch10Light: return "\u{f875}"
        case .touch10Regular: return "\u{f876}"
        case .transcriptBold: return "\u{f877}"
        case .transcriptLight: return "\u{f878}"
        case .transcriptRegular: return "\u{f879}"
        case .ucmCloudBold: return "\u{f87a}"
        case .ucmCloudLight: return "\u{f87b}"
        case .ucmCloudRegular: return "\u{f87c}"
        case .underlineBold: return "\u{f87d}"
        case .underlineLight: return "\u{f87e}"
        case .underlineRegular: return "\u{f87f}"
        case .undoBold: return "\u{f880}"
        case .undoLight: return "\u{f881}"
        case .undoRegular: return "\u{f882}"
        case .unlinkBold: return "\u{f883}"
        case .unlinkLight: return "\u{f884}"
        case .unlinkRegular: return "\u{f885}"
        case .unreadBold: return "\u{f886}"
        case .unreadFilled: return "\u{f887}"
        case .unreadLight: return "\u{f888}"
        case .unreadRegular: return "\u{f889}"
        case .unsecureUnlockedBold: return "\u{f88a}"
        case .unsecureUnlockedFilled: return "\u{f88b}"
        case .unsecureUnlockedLight: return "\u{f88c}"
        case .unsecureUnlockedRegular: return "\u{f88d}"
        case .unsortedBold: return "\u{f88e}"
        case .unsortedLight: return "\u{f88f}"
        case .unsortedRegular: return "\u{f890}"
        case .updateFileShareBold: return "\u{f891}"
        case .updateFileShareLight: return "\u{f892}"
        case .updateFileShareRegular: return "\u{f893}"
        case .upgradeBold: return "\u{f894}"
        case .upgradeFilled: return "\u{f895}"
        case .upgradeLight: return "\u{f896}"
        case .upgradeRegular: return "\u{f897}"
        case .uploadBold: return "\u{f898}"
        case .uploadLight: return "\u{f899}"
        case .uploadRegular: return "\u{f89a}"
        case .usbBold: return "\u{f89b}"
        case .usbHeadsetBold: return "\u{f89c}"
        case .usbHeadsetLight: return "\u{f89d}"
        case .usbHeadsetMutedBold: return "\u{f89e}"
        case .usbHeadsetMutedLight: return "\u{f89f}"
        case .usbHeadsetMutedRegular: return "\u{f8a0}"
        case .usbHeadsetRegular: return "\u{f8a1}"
        case .usbLight: return "\u{f8a2}"
        case .usbRegular: return "\u{f8a3}"
        case .userBold: return "\u{f8a4}"
        case .userLight: return "\u{f8a5}"
        case .userRegular: return "\u{f8a6}"
        case .vcsBold: return "\u{f8a7}"
        case .vcsLight: return "\u{f8a8}"
        case .vcsRegular: return "\u{f8a9}"
        case .videoBlurBold: return "\u{f8aa}"
        case .videoBlurFilled: return "\u{f8ab}"
        case .videoBlurLight: return "\u{f8ac}"
        case .videoBlurRegular: return "\u{f8ad}"
        case .videoBold: return "\u{f8ae}"
        case .videoEffectBold: return "\u{f8af}"
        case .videoEffectFilled: return "\u{f8b0}"
        case .videoEffectLight: return "\u{f8b1}"
        case .videoEffectRegular: return "\u{f8b2}"
        case .videoFilled: return "\u{f8b3}"
        case .videoLayoutBold: return "\u{f8b4}"
        case .videoLayoutEqualBold: return "\u{f8b5}"
        case .videoLayoutEqualDualBold: return "\u{f8b6}"
        case .videoLayoutEqualDualLight: return "\u{f8b7}"
        case .videoLayoutEqualDualRegular: return "\u{f8b8}"
        case .videoLayoutEqualFilled: return "\u{f8b9}"
        case .videoLayoutEqualLight: return "\u{f8ba}"
        case .videoLayoutEqualRegular: return "\u{f8bb}"
        case .videoLayoutLight: return "\u{f8bc}"
        case .videoLayoutOverlayBold: return "\u{f8bd}"
        case .videoLayoutOverlayLight: return "\u{f8be}"
        case .videoLayoutOverlayRegular: return "\u{f8bf}"
        case .videoLayoutPresenterDominantBold: return "\u{f8c0}"
        case .videoLayoutPresenterDominantLight: return "\u{f8c1}"
        case .videoLayoutPresenterDominantRegular: return "\u{f8c2}"
        case .videoLayoutProminentBold: return "\u{f8c3}"
        case .videoLayoutProminentLight: return "\u{f8c4}"
        case .videoLayoutProminentRegular: return "\u{f8c5}"
        case .videoLayoutRegular: return "\u{f8c6}"
        case .videoLayoutShareDominantBold: return "\u{f8c7}"
        case .videoLayoutShareDominantLight: return "\u{f8c8}"
        case .videoLayoutShareDominantRegular: return "\u{f8c9}"
        case .videoLayoutSingleBold: return "\u{f8ca}"
        case .videoLayoutSingleFilled: return "\u{f8cb}"
        case .videoLayoutSingleLight: return "\u{f8cc}"
        case .videoLayoutSingleRegular: return "\u{f8cd}"
        case .videoLayoutStackBold: return "\u{f8ce}"
        case .videoLayoutStackFilled: return "\u{f8cf}"
        case .videoLayoutStackLight: return "\u{f8d0}"
        case .videoLayoutStackRegular: return "\u{f8d1}"
        case .videoLayoutVideoDominantBold: return "\u{f8d2}"
        case .videoLayoutVideoDominantLight: return "\u{f8d3}"
        case .videoLayoutVideoDominantRegular: return "\u{f8d4}"
        case .videoLight: return "\u{f8d5}"
        case .videoPlusBold: return "\u{f8d6}"
        case .videoPlusFilled: return "\u{f8d7}"
        case .videoPlusLight: return "\u{f8d8}"
        case .videoPlusRegular: return "\u{f8d9}"
        case .videoRegular: return "\u{f8da}"
        case .videoSpeakerTrackBold: return "\u{f8db}"
        case .videoSpeakerTrackFilled: return "\u{f8dc}"
        case .videoSpeakerTrackLight: return "\u{f8dd}"
        case .videoSpeakerTrackRegular: return "\u{f8de}"
        case .viewAllBold: return "\u{f8df}"
        case .viewAllLight: return "\u{f8e0}"
        case .viewAllRegular: return "\u{f8e1}"
        case .viewListBold: return "\u{f8e2}"
        case .viewListLight: return "\u{f8e3}"
        case .viewListRegular: return "\u{f8e4}"
        case .viewStackedBold: return "\u{f8e5}"
        case .viewStackedLight: return "\u{f8e6}"
        case .viewStackedRegular: return "\u{f8e7}"
        case .viewThumbnailBold: return "\u{f8e8}"
        case .viewThumbnailFilled: return "\u{f8e9}"
        case .viewThumbnailLight: return "\u{f8ea}"
        case .viewThumbnailRegular: return "\u{f8eb}"
        case .voicemailBold: return "\u{f8ec}"
        case .voicemailFilled: return "\u{f8ed}"
        case .voicemailLight: return "\u{f8ee}"
        case .voicemailRegular: return "\u{f8ef}"
        case .wallpaperBold: return "\u{f8f0}"
        case .wallpaperLight: return "\u{f8f1}"
        case .wallpaperRegular: return "\u{f8f2}"
        case .warningBadgeFilled: return "\u{f8f3}"
        case .warningBold: return "\u{f8f4}"
        case .warningFilled: return "\u{f8f5}"
        case .warningLight: return "\u{f8f6}"
        case .warningRegular: return "\u{f8f7}"
        case .webexBoardBold: return "\u{f8f8}"
        case .webexBoardLight: return "\u{f8f9}"
        case .webexBoardRegular: return "\u{f8fa}"
        case .webexCodecPlusBold: return "\u{f8fb}"
        case .webexCodecPlusLight: return "\u{f8fc}"
        case .webexCodecPlusRegular: return "\u{f8fd}"
        case .webexDeskCameraBold: return "\u{f8fe}"
        case .webexDeskCameraLight: return "\u{f8ff}"
        case .webexDeskCameraRegular: return "\u{f900}"
        case .webexHelixFilled: return "\u{f901}"
        case .webexMeetingsBold: return "\u{f902}"
        case .webexMeetingsFilled: return "\u{f903}"
        case .webexMeetingsLight: return "\u{f904}"
        case .webexMeetingsRegular: return "\u{f905}"
        case .webexQuadCameraBold: return "\u{f906}"
        case .webexQuadCameraLight: return "\u{f907}"
        case .webexQuadCameraRegular: return "\u{f908}"
        case .webexRoomKitBold: return "\u{f909}"
        case .webexRoomKitLight: return "\u{f90a}"
        case .webexRoomKitPlusBold: return "\u{f90b}"
        case .webexRoomKitPlusLight: return "\u{f90c}"
        case .webexRoomKitPlusRegular: return "\u{f90d}"
        case .webexRoomKitRegular: return "\u{f90e}"
        case .webexShareBold: return "\u{f90f}"
        case .webexShareLight: return "\u{f910}"
        case .webexShareRegular: return "\u{f911}"
        case .webexTeamsBold: return "\u{f912}"
        case .webexTeamsFilled: return "\u{f913}"
        case .webexTeamsLight: return "\u{f914}"
        case .webexTeamsNewBold: return "\u{f915}"
        case .webexTeamsNewFilled: return "\u{f916}"
        case .webexTeamsNewLight: return "\u{f917}"
        case .webexTeamsNewRegular: return "\u{f918}"
        case .webexTeamsRegular: return "\u{f919}"
        case .whiteboardBold: return "\u{f91a}"
        case .whiteboardContentBold: return "\u{f91b}"
        case .whiteboardContentLight: return "\u{f91c}"
        case .whiteboardContentRegular: return "\u{f91d}"
        case .whiteboardFilled: return "\u{f91e}"
        case .whiteboardLight: return "\u{f91f}"
        case .whiteboardRegular: return "\u{f920}"
        case .widgetBold: return "\u{f921}"
        case .widgetFilled: return "\u{f922}"
        case .widgetLight: return "\u{f923}"
        case .widgetRegular: return "\u{f924}"
        case .wifiBold: return "\u{f925}"
        case .wifiErrorBold: return "\u{f926}"
        case .wifiErrorLight: return "\u{f927}"
        case .wifiErrorRegular: return "\u{f928}"
        case .wifiLight: return "\u{f929}"
        case .wifiRegular: return "\u{f92a}"
        case .wifiSignalGoodColoredBold: return "\u{f92b}"
        case .wifiSignalGoodColoredLight: return "\u{f92c}"
        case .wifiSignalGoodColoredRegular: return "\u{f92d}"
        case .wifiSignalPoorColoredBold: return "\u{f92e}"
        case .wifiSignalPoorColoredLight: return "\u{f92f}"
        case .wifiSignalPoorColoredRegular: return "\u{f930}"
        case .wifiSignalUnstableColoredBold: return "\u{f931}"
        case .wifiSignalUnstableColoredLight: return "\u{f932}"
        case .wifiSignalUnstableColoredRegular: return "\u{f933}"
        case .windowCornerScrubBold: return "\u{f934}"
        case .windowCornerScrubLight: return "\u{f935}"
        case .windowCornerScrubRegular: return "\u{f936}"
        case .windowRightCornerScrubBold: return "\u{f937}"
        case .windowRightCornerScrubLight: return "\u{f938}"
        case .windowRightCornerScrubRegular: return "\u{f939}"
        case .windowVerticalScrubBold: return "\u{f93a}"
        case .windowVerticalScrubLight: return "\u{f93b}"
        case .windowVerticalScrubRegular: return "\u{f93c}"
        case .workphoneBold: return "\u{f93d}"
        case .workphoneLight: return "\u{f93e}"
        case .workphoneRegular: return "\u{f93f}"
        case .zoomInBold: return "\u{f940}"
        case .zoomInLight: return "\u{f941}"
        case .zoomInRegular: return "\u{f942}"
        case .zoomOutBold: return "\u{f943}"
        case .zoomOutLight: return "\u{f944}"
        case .zoomOutRegular: return "\u{f945}"
