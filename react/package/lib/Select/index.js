...
var Select = /*#__PURE__*/function (_React$Component) {
    ...
    _this.handleSelect = function (e, opts) {
      ...
      if (isActive && isMulti) {
        ...
        return _this.setState({
          ...
          selectedIndex: [].concat(selectedIndex, [keyboardKey])
        });
      }
    };
  ...
  _proto.render = function render() {
    ...
    var label = /*#__PURE__*/_react.default.createElement("div", {
      ...
      id: id + "__label"
    }, currentValue() || defaultValue, /*#__PURE__*/_react.default.createElement(_.Icon, {
      name: "arrow-down_16"
    }));

    var text = /*#__PURE__*/_react.default.createElement(_.Button, _extends({
      active: isOpen,
    ...
    var dropdownElement = isOpen && /*#__PURE__*/_react.default.createElement(_.EventOverlay, _extends({
      allowClickAway: true,
      anchorNode: anchorNode,
      close: this.hidePopover,
      isDynamic: isDynamic,
      isOpen: isOpen
    }, overlayProps), /*#__PURE__*/_react.default.createElement(_.List, _extends({
