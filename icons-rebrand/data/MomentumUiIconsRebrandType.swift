...
@objc public enum MomentumIconsRebrandType: Int {
    ...
    public var ligature: String {
        ...
        case .subscriptBold: return "\u{f9cf}"
        case .subscriptLight: return "\u{f9d0}"
        case .subscriptRegular: return "\u{f9d1}"
        case .superscriptBold: return "\u{f9d2}"
        case .superscriptLight: return "\u{f9d3}"
        case .superscriptRegular: return "\u{f9d4}"
        case .surveyBold: return "\u{f9d5}"
        case .surveyFilled: return "\u{f9d6}"
        case .surveyLight: return "\u{f9d7}"
        case .surveyRegular: return "\u{f9d8}"
        case .sx10Bold: return "\u{f9d9}"
        case .sx10Light: return "\u{f9da}"
        case .sx10Regular: return "\u{f9db}"
        case .sx20Bold: return "\u{f9dc}"
        case .sx20Light: return "\u{f9dd}"
        case .sx20Regular: return "\u{f9de}"
        case .sx80CodecBold: return "\u{f9df}"
        case .sx80CodecLight: return "\u{f9e0}"
        case .sx80CodecRegular: return "\u{f9e1}"
        case .tableBold: return "\u{f9e2}"
        case .tableLight: return "\u{f9e3}"
        case .tableRegular: return "\u{f9e4}"
        case .tabletBold: return "\u{f9e5}"
        case .tabletLight: return "\u{f9e6}"
        case .tabletRegular: return "\u{f9e7}"
        case .tabsBold: return "\u{f9e8}"
        case .tabsLight: return "\u{f9e9}"
        case .tabsRegular: return "\u{f9ea}"
        case .tagBold: return "\u{f9eb}"
        case .tagLight: return "\u{f9ec}"
        case .tagRegular: return "\u{f9ed}"
        case .tapBold: return "\u{f9ee}"
        case .tapFilled: return "\u{f9ef}"
        case .tapLight: return "\u{f9f0}"
        case .tapRegular: return "\u{f9f1}"
        case .telepresenceAlertBold: return "\u{f9f2}"
        case .telepresenceAlertLight: return "\u{f9f3}"
        case .telepresenceAlertMutedBold: return "\u{f9f4}"
        case .telepresenceAlertMutedLight: return "\u{f9f5}"
        case .telepresenceAlertMutedRegular: return "\u{f9f6}"
        case .telepresenceAlertRegular: return "\u{f9f7}"
        case .telepresenceBold: return "\u{f9f8}"
        case .telepresenceIx5000Bold: return "\u{f9f9}"
        case .telepresenceIx5000Light: return "\u{f9fa}"
        case .telepresenceIx5000Regular: return "\u{f9fb}"
        case .telepresenceLight: return "\u{f9fc}"
        case .telepresencePrivateBold: return "\u{f9fd}"
        case .telepresencePrivateLight: return "\u{f9fe}"
        case .telepresencePrivateRegular: return "\u{f9ff}"
        case .telepresenceRegular: return "\u{fa00}"
        case .temperatureBold: return "\u{fa01}"
        case .temperatureLight: return "\u{fa02}"
        case .temperatureRegular: return "\u{fa03}"
        case .textAlignCenterBold: return "\u{fa04}"
        case .textAlignCenterFilled: return "\u{fa05}"
        case .textAlignCenterLight: return "\u{fa06}"
        case .textAlignCenterRegular: return "\u{fa07}"
        case .textAlignLeftBold: return "\u{fa08}"
        case .textAlignLeftFilled: return "\u{fa09}"
        case .textAlignLeftLight: return "\u{fa0a}"
        case .textAlignLeftRegular: return "\u{fa0b}"
        case .textAlignRightBold: return "\u{fa0c}"
        case .textAlignRightFilled: return "\u{fa0d}"
        case .textAlignRightLight: return "\u{fa0e}"
        case .textAlignRightRegular: return "\u{fa0f}"
        case .textBold: return "\u{fa10}"
        case .textCodeBlockBold: return "\u{fa11}"
        case .textCodeBlockLight: return "\u{fa12}"
        case .textCodeBlockRegular: return "\u{fa13}"
        case .textHighlightBold: return "\u{fa14}"
        case .textHighlightLight: return "\u{fa15}"
        case .textHighlightRegular: return "\u{fa16}"
        case .textLight: return "\u{fa17}"
        case .textRegular: return "\u{fa18}"
        case .threeColumnBold: return "\u{fa19}"
        case .threeColumnLight: return "\u{fa1a}"
        case .threeColumnRegular: return "\u{fa1b}"
        case .threeDObjectBold: return "\u{fa1c}"
        case .threeDObjectLight: return "\u{fa1d}"
        case .threeDObjectRegular: return "\u{fa1e}"
        case .tooFastBold: return "\u{fa1f}"
        case .tooFastLight: return "\u{fa20}"
        case .tooFastRegular: return "\u{fa21}"
        case .tooSlowBold: return "\u{fa22}"
        case .tooSlowLight: return "\u{fa23}"
        case .tooSlowRegular: return "\u{fa24}"
        case .toolsBold: return "\u{fa25}"
        case .toolsLight: return "\u{fa26}"
        case .toolsRegular: return "\u{fa27}"
        case .touch10Bold: return "\u{fa28}"
        case .touch10Light: return "\u{fa29}"
        case .touch10Regular: return "\u{fa2a}"
        case .transcriptBold: return "\u{fa2b}"
        case .transcriptFilled: return "\u{fa2c}"
        case .transcriptLight: return "\u{fa2d}"
        case .transcriptRegular: return "\u{fa2e}"
        case .translateBold: return "\u{fa2f}"
        case .translateLight: return "\u{fa30}"
        case .translateRegular: return "\u{fa31}"
        case .trimBold: return "\u{fa32}"
        case .trimLight: return "\u{fa33}"
        case .trimRegular: return "\u{fa34}"
        case .twoColumnBold: return "\u{fa35}"
        case .twoColumnLight: return "\u{fa36}"
        case .twoColumnRegular: return "\u{fa37}"
        case .ucmCloudBold: return "\u{fa38}"
        case .ucmCloudLight: return "\u{fa39}"
        case .ucmCloudRegular: return "\u{fa3a}"
        case .underlineBold: return "\u{fa3b}"
        case .underlineLight: return "\u{fa3c}"
        case .underlineRegular: return "\u{fa3d}"
        case .undoBold: return "\u{fa3e}"
        case .undoLight: return "\u{fa3f}"
        case .undoRegular: return "\u{fa40}"
        case .unlinkBold: return "\u{fa41}"
        case .unlinkLight: return "\u{fa42}"
        case .unlinkRegular: return "\u{fa43}"
        case .unreadBold: return "\u{fa44}"
        case .unreadFilled: return "\u{fa45}"
        case .unreadLight: return "\u{fa46}"
        case .unreadRegular: return "\u{fa47}"
        case .unsecureUnlockedBold: return "\u{fa48}"
        case .unsecureUnlockedFilled: return "\u{fa49}"
        case .unsecureUnlockedLight: return "\u{fa4a}"
        case .unsecureUnlockedRegular: return "\u{fa4b}"
        case .unsortedBold: return "\u{fa4c}"
        case .unsortedLight: return "\u{fa4d}"
        case .unsortedRegular: return "\u{fa4e}"
        case .updateFileShareBold: return "\u{fa4f}"
        case .updateFileShareLight: return "\u{fa50}"
        case .updateFileShareRegular: return "\u{fa51}"
        case .upgradeBold: return "\u{fa52}"
        case .upgradeFilled: return "\u{fa53}"
        case .upgradeLight: return "\u{fa54}"
        case .upgradeRegular: return "\u{fa55}"
        case .uploadBold: return "\u{fa56}"
        case .uploadImageBold: return "\u{fa57}"
        case .uploadImageLight: return "\u{fa58}"
        case .uploadImageRegular: return "\u{fa59}"
        case .uploadLight: return "\u{fa5a}"
        case .uploadRegular: return "\u{fa5b}"
        case .urgentVoicemailBold: return "\u{fa5c}"
        case .urgentVoicemailFilled: return "\u{fa5d}"
        case .usbBold: return "\u{fa5e}"
        case .usbHeadsetBold: return "\u{fa5f}"
        case .usbHeadsetLight: return "\u{fa60}"
        case .usbHeadsetMutedBold: return "\u{fa61}"
        case .usbHeadsetMutedLight: return "\u{fa62}"
        case .usbHeadsetMutedRegular: return "\u{fa63}"
        case .usbHeadsetRegular: return "\u{fa64}"
        case .usbLight: return "\u{fa65}"
        case .usbRegular: return "\u{fa66}"
        case .userBold: return "\u{fa67}"
        case .userDeactivateBold: return "\u{fa68}"
        case .userDeactivateLight: return "\u{fa69}"
        case .userDeactivateRegular: return "\u{fa6a}"
        case .userLight: return "\u{fa6b}"
        case .userRegular: return "\u{fa6c}"
        case .vcsBold: return "\u{fa6d}"
        case .vcsLight: return "\u{fa6e}"
        case .vcsRegular: return "\u{fa6f}"
        case .videoBlurBold: return "\u{fa70}"
        case .videoBlurFilled: return "\u{fa71}"
        case .videoBlurLight: return "\u{fa72}"
        case .videoBlurRegular: return "\u{fa73}"
        case .videoBold: return "\u{fa74}"
        case .videoEffectBold: return "\u{fa75}"
        case .videoEffectFilled: return "\u{fa76}"
        case .videoEffectLight: return "\u{fa77}"
        case .videoEffectRegular: return "\u{fa78}"
        case .videoFilled: return "\u{fa79}"
        case .videoLayoutBold: return "\u{fa7a}"
        case .videoLayoutEqualBold: return "\u{fa7b}"
        case .videoLayoutEqualDualBold: return "\u{fa7c}"
        case .videoLayoutEqualDualLight: return "\u{fa7d}"
        case .videoLayoutEqualDualRegular: return "\u{fa7e}"
        case .videoLayoutEqualFilled: return "\u{fa7f}"
        case .videoLayoutEqualLight: return "\u{fa80}"
        case .videoLayoutEqualRegular: return "\u{fa81}"
        case .videoLayoutFilled: return "\u{fa82}"
        case .videoLayoutLight: return "\u{fa83}"
        case .videoLayoutOverlayBold: return "\u{fa84}"
        case .videoLayoutOverlayLight: return "\u{fa85}"
        case .videoLayoutOverlayRegular: return "\u{fa86}"
        case .videoLayoutPresenterDominantBold: return "\u{fa87}"
        case .videoLayoutPresenterDominantLight: return "\u{fa88}"
        case .videoLayoutPresenterDominantRegular: return "\u{fa89}"
        case .videoLayoutProminentBold: return "\u{fa8a}"
        case .videoLayoutProminentFilled: return "\u{fa8b}"
        case .videoLayoutProminentLight: return "\u{fa8c}"
        case .videoLayoutProminentRegular: return "\u{fa8d}"
        case .videoLayoutRegular: return "\u{fa8e}"
        case .videoLayoutShareDominantBold: return "\u{fa8f}"
        case .videoLayoutShareDominantLight: return "\u{fa90}"
        case .videoLayoutShareDominantRegular: return "\u{fa91}"
        case .videoLayoutSingleBold: return "\u{fa92}"
        case .videoLayoutSingleFilled: return "\u{fa93}"
        case .videoLayoutSingleLight: return "\u{fa94}"
        case .videoLayoutSingleRegular: return "\u{fa95}"
        case .videoLayoutStackBold: return "\u{fa96}"
        case .videoLayoutStackFilled: return "\u{fa97}"
        case .videoLayoutStackLight: return "\u{fa98}"
        case .videoLayoutStackRegular: return "\u{fa99}"
        case .videoLayoutVideoDominantBold: return "\u{fa9a}"
        case .videoLayoutVideoDominantLight: return "\u{fa9b}"
        case .videoLayoutVideoDominantRegular: return "\u{fa9c}"
        case .videoLight: return "\u{fa9d}"
        case .videoPlusBold: return "\u{fa9e}"
        case .videoPlusFilled: return "\u{fa9f}"
        case .videoPlusLight: return "\u{faa0}"
        case .videoPlusRegular: return "\u{faa1}"
        case .videoRegular: return "\u{faa2}"
        case .videoSpeakerTrackBold: return "\u{faa3}"
        case .videoSpeakerTrackFilled: return "\u{faa4}"
        case .videoSpeakerTrackLight: return "\u{faa5}"
        case .videoSpeakerTrackRegular: return "\u{faa6}"
        case .viewAllBold: return "\u{faa7}"
        case .viewAllLight: return "\u{faa8}"
        case .viewAllRegular: return "\u{faa9}"
        case .viewListBold: return "\u{faaa}"
        case .viewListLight: return "\u{faab}"
        case .viewListRegular: return "\u{faac}"
        case .viewStackedBold: return "\u{faad}"
        case .viewStackedFilled: return "\u{faae}"
        case .viewStackedLight: return "\u{faaf}"
        case .viewStackedRegular: return "\u{fab0}"
        case .viewThumbnailBold: return "\u{fab1}"
        case .viewThumbnailFilled: return "\u{fab2}"
        case .viewThumbnailLight: return "\u{fab3}"
        case .viewThumbnailRegular: return "\u{fab4}"
        case .voicemailBold: return "\u{fab5}"
        case .voicemailFilled: return "\u{fab6}"
        case .voicemailLight: return "\u{fab7}"
        case .voicemailRegular: return "\u{fab8}"
        case .waffleMenuBold: return "\u{fab9}"
        case .waffleMenuLight: return "\u{faba}"
        case .waffleMenuRegular: return "\u{fabb}"
        case .waitingroomActiveBold: return "\u{fabc}"
        case .waitingroomActiveLight: return "\u{fabd}"
        case .waitingroomActiveRegular: return "\u{fabe}"
        case .wallpaperBold: return "\u{fabf}"
        case .wallpaperLight: return "\u{fac0}"
        case .wallpaperRegular: return "\u{fac1}"
        case .warningBadgeFilled: return "\u{fac2}"
        case .warningBold: return "\u{fac3}"
        case .warningFilled: return "\u{fac4}"
        case .warningLight: return "\u{fac5}"
        case .warningRegular: return "\u{fac6}"
        case .webexAssistantActiveColored: return "\u{fac7}"
        case .webexAssistantInactiveColored: return "\u{fac8}"
        case .webexBoardBold: return "\u{fac9}"
        case .webexBoardLight: return "\u{faca}"
        case .webexBoardRegular: return "\u{facb}"
        case .webexCodecPlusBold: return "\u{facc}"
        case .webexCodecPlusLight: return "\u{facd}"
        case .webexCodecPlusRegular: return "\u{face}"
        case .webexDeskCameraBold: return "\u{facf}"
        case .webexDeskCameraLight: return "\u{fad0}"
        case .webexDeskCameraRegular: return "\u{fad1}"
        case .webexHelixFilled: return "\u{fad2}"
        case .webexMeetingsBold: return "\u{fad3}"
        case .webexMeetingsFilled: return "\u{fad4}"
        case .webexMeetingsLight: return "\u{fad5}"
        case .webexMeetingsRegular: return "\u{fad6}"
        case .webexQuadCameraBold: return "\u{fad7}"
        case .webexQuadCameraLight: return "\u{fad8}"
        case .webexQuadCameraRegular: return "\u{fad9}"
        case .webexRoomKitBold: return "\u{fada}"
        case .webexRoomKitLight: return "\u{fadb}"
        case .webexRoomKitPlusBold: return "\u{fadc}"
        case .webexRoomKitPlusLight: return "\u{fadd}"
        case .webexRoomKitPlusRegular: return "\u{fade}"
        case .webexRoomKitRegular: return "\u{fadf}"
        case .webexShareBold: return "\u{fae0}"
        case .webexShareLight: return "\u{fae1}"
        case .webexShareRegular: return "\u{fae2}"
        case .webexTeamsBold: return "\u{fae3}"
        case .webexTeamsFilled: return "\u{fae4}"
        case .webexTeamsLight: return "\u{fae5}"
        case .webexTeamsNewBold: return "\u{fae6}"
        case .webexTeamsNewFilled: return "\u{fae7}"
        case .webexTeamsNewLight: return "\u{fae8}"
        case .webexTeamsNewRegular: return "\u{fae9}"
        case .webexTeamsRegular: return "\u{faea}"
        case .webinarBold: return "\u{faeb}"
        case .webinarFilled: return "\u{faec}"
        case .webinarLight: return "\u{faed}"
        case .webinarRegular: return "\u{faee}"
        case .weeklyRecurringScheduleNodeBold: return "\u{faef}"
        case .weeklyRecurringScheduleNodeLight: return "\u{faf0}"
        case .weeklyRecurringScheduleNodeRegular: return "\u{faf1}"
        case .whiteboardBold: return "\u{faf2}"
        case .whiteboardContentBold: return "\u{faf3}"
        case .whiteboardContentLight: return "\u{faf4}"
        case .whiteboardContentRegular: return "\u{faf5}"
        case .whiteboardFilled: return "\u{faf6}"
        case .whiteboardLight: return "\u{faf7}"
        case .whiteboardRegular: return "\u{faf8}"
        case .widgetBold: return "\u{faf9}"
        case .widgetFilled: return "\u{fafa}"
        case .widgetLight: return "\u{fafb}"
        case .widgetRegular: return "\u{fafc}"
        case .wifiBold: return "\u{fafd}"
        case .wifiErrorBold: return "\u{fafe}"
        case .wifiErrorLight: return "\u{faff}"
        case .wifiErrorRegular: return "\u{fb00}"
        case .wifiLight: return "\u{fb01}"
        case .wifiRegular: return "\u{fb02}"
        case .wifiSignalGoodColoredBold: return "\u{fb03}"
        case .wifiSignalGoodColoredLight: return "\u{fb04}"
        case .wifiSignalGoodColoredRegular: return "\u{fb05}"
        case .wifiSignalPoorColoredBold: return "\u{fb06}"
        case .wifiSignalPoorColoredLight: return "\u{fb07}"
        case .wifiSignalPoorColoredRegular: return "\u{fb08}"
        case .wifiSignalUnstableColoredBold: return "\u{fb09}"
        case .wifiSignalUnstableColoredLight: return "\u{fb0a}"
        case .wifiSignalUnstableColoredRegular: return "\u{fb0b}"
        case .windowCornerScrubBold: return "\u{fb0c}"
        case .windowCornerScrubLight: return "\u{fb0d}"
        case .windowCornerScrubRegular: return "\u{fb0e}"
        case .windowRightCornerScrubBold: return "\u{fb0f}"
        case .windowRightCornerScrubLight: return "\u{fb10}"
        case .windowRightCornerScrubRegular: return "\u{fb11}"
        case .windowVerticalScrubBold: return "\u{fb12}"
        case .windowVerticalScrubLight: return "\u{fb13}"
        case .windowVerticalScrubRegular: return "\u{fb14}"
        case .workflowDeploymentsBold: return "\u{fb15}"
        case .workflowDeploymentsFilled: return "\u{fb16}"
        case .workflowDeploymentsLight: return "\u{fb17}"
        case .workflowDeploymentsRegular: return "\u{fb18}"
        case .workphoneBold: return "\u{fb19}"
        case .workphoneLight: return "\u{fb1a}"
        case .workphoneRegular: return "\u{fb1b}"
        case .zoomInBold: return "\u{fb1c}"
        case .zoomInLight: return "\u{fb1d}"
        case .zoomInRegular: return "\u{fb1e}"
        case .zoomOutBold: return "\u{fb1f}"
        case .zoomOutLight: return "\u{fb20}"
        case .zoomOutRegular: return "\u{fb21}"
        case .zoom: return "\u{fb22}"
