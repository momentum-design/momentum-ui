...
@objc public enum MomentumIconsRebrandType: Int {
    ...
    public var ligature: String {
        ...
        case .callBlindTransferBold: return "\u{f23e}"
        case .callBlindTransferLight: return "\u{f23f}"
        case .callBlindTransferRegular: return "\u{f240}"
        case .callForwardSettingsBold: return "\u{f241}"
        case .callForwardSettingsFilled: return "\u{f242}"
        case .callForwardSettingsLight: return "\u{f243}"
        case .callForwardSettingsRegular: return "\u{f244}"
        case .callHandlingBold: return "\u{f245}"
        case .callHandlingLight: return "\u{f246}"
        case .callHandlingRegular: return "\u{f247}"
        case .callHoldBold: return "\u{f248}"
        case .callHoldFilled: return "\u{f249}"
        case .callHoldLight: return "\u{f24a}"
        case .callHoldRegular: return "\u{f24b}"
        case .callIncomingBold: return "\u{f24c}"
        case .callIncomingLight: return "\u{f24d}"
        case .callIncomingRegular: return "\u{f24e}"
        case .callListBold: return "\u{f24f}"
        case .callListLight: return "\u{f250}"
        case .callListRegular: return "\u{f251}"
        case .callMergeBold: return "\u{f252}"
        case .callMergeLight: return "\u{f253}"
        case .callMergeRegular: return "\u{f254}"
        case .callOutgoingBold: return "\u{f255}"
        case .callOutgoingLight: return "\u{f256}"
        case .callOutgoingRegular: return "\u{f257}"
        case .callPickupBold: return "\u{f258}"
        case .callPickupFilled: return "\u{f259}"
        case .callPickupLight: return "\u{f25a}"
        case .callPickupRegular: return "\u{f25b}"
        case .callPrivateBold: return "\u{f25c}"
        case .callPrivateLight: return "\u{f25d}"
        case .callPrivateRegular: return "\u{f25e}"
        case .callRequestBold: return "\u{f25f}"
        case .callRequestFilled: return "\u{f260}"
        case .callRequestLight: return "\u{f261}"
        case .callRequestRegular: return "\u{f262}"
        case .callRoomBold: return "\u{f263}"
        case .callRoomLight: return "\u{f264}"
        case .callRoomRegular: return "\u{f265}"
        case .callSettingsBold: return "\u{f266}"
        case .callSettingsLight: return "\u{f267}"
        case .callSettingsRegular: return "\u{f268}"
        case .callSplitBold: return "\u{f269}"
        case .callSplitLight: return "\u{f26a}"
        case .callSplitRegular: return "\u{f26b}"
        case .callSwapBold: return "\u{f26c}"
        case .callSwapLight: return "\u{f26d}"
        case .callSwapRegular: return "\u{f26e}"
        case .callVoicemailBold: return "\u{f26f}"
        case .callVoicemailLight: return "\u{f270}"
        case .callVoicemailRegular: return "\u{f271}"
        case .callrateBold: return "\u{f272}"
        case .callrateLight: return "\u{f273}"
        case .callrateRegular: return "\u{f274}"
        case .cameraAuxBold: return "\u{f275}"
        case .cameraAuxFilled: return "\u{f276}"
        case .cameraAuxLight: return "\u{f277}"
        case .cameraAuxRegular: return "\u{f278}"
        case .cameraBold: return "\u{f279}"
        case .cameraFilled: return "\u{f27a}"
        case .cameraLight: return "\u{f27b}"
        case .cameraMutedBold: return "\u{f27c}"
        case .cameraMutedFilled: return "\u{f27d}"
        case .cameraMutedLight: return "\u{f27e}"
        case .cameraMutedRegular: return "\u{f27f}"
        case .cameraOnBold: return "\u{f280}"
        case .cameraOnColoredBold: return "\u{f281}"
        case .cameraOnColoredFilled: return "\u{f282}"
        case .cameraOnColoredLight: return "\u{f283}"
        case .cameraOnColoredRegular: return "\u{f284}"
        case .cameraOnFilled: return "\u{f285}"
        case .cameraOnLight: return "\u{f286}"
        case .cameraOnRegular: return "\u{f287}"
        case .cameraPhotoBold: return "\u{f288}"
        case .cameraPhotoFilled: return "\u{f289}"
        case .cameraPhotoLight: return "\u{f28a}"
        case .cameraPhotoRegular: return "\u{f28b}"
        case .cameraPresenceBold: return "\u{f28c}"
        case .cameraPresenceFilled: return "\u{f28d}"
        case .cameraPresenceLight: return "\u{f28e}"
        case .cameraPresenceRegular: return "\u{f28f}"
        case .cameraRegular: return "\u{f290}"
        case .cameraSwapBold: return "\u{f291}"
        case .cameraSwapLight: return "\u{f292}"
        case .cameraSwapRegular: return "\u{f293}"
        case .cancelBold: return "\u{f294}"
        case .cancelLight: return "\u{f295}"
        case .cancelRegular: return "\u{f296}"
        case .capsLockBold: return "\u{f297}"
        case .capsLockLight: return "\u{f298}"
        case .capsLockRegular: return "\u{f299}"
        case .captureRewindBold: return "\u{f29a}"
        case .captureRewindLight: return "\u{f29b}"
        case .captureRewindRegular: return "\u{f29c}"
        case .cellularBold: return "\u{f29d}"
        case .cellularLight: return "\u{f29e}"
        case .cellularRegular: return "\u{f29f}"
        case .certifiedBold: return "\u{f2a0}"
        case .certifiedLight: return "\u{f2a1}"
        case .certifiedRegular: return "\u{f2a2}"
        case .chPSearchBold: return "\u{f2a3}"
        case .chPSearchLight: return "\u{f2a4}"
        case .chPSearchRegular: return "\u{f2a5}"
        case .chatBold: return "\u{f2a6}"
        case .chatFilled: return "\u{f2a7}"
        case .chatGroupBold: return "\u{f2a8}"
        case .chatGroupFilled: return "\u{f2a9}"
        case .chatGroupLight: return "\u{f2aa}"
        case .chatGroupRegular: return "\u{f2ab}"
        case .chatLight: return "\u{f2ac}"
        case .chatMuteBold: return "\u{f2ad}"
        case .chatMuteLight: return "\u{f2ae}"
        case .chatMuteRegular: return "\u{f2af}"
        case .chatRegular: return "\u{f2b0}"
        case .checkBold: return "\u{f2b1}"
        case .checkCircleBadgeFilled: return "\u{f2b2}"
        case .checkCircleBold: return "\u{f2b3}"
        case .checkCircleFilled: return "\u{f2b4}"
        case .checkCircleLight: return "\u{f2b5}"
        case .checkCircleRegular: return "\u{f2b6}"
        case .checkLight: return "\u{f2b7}"
        case .checkRegular: return "\u{f2b8}"
        case .clearBold: return "\u{f2b9}"
        case .clearFilled: return "\u{f2ba}"
        case .clearLight: return "\u{f2bb}"
        case .clearRegular: return "\u{f2bc}"
        case .closeSpaceBold: return "\u{f2bd}"
        case .closeSpaceLight: return "\u{f2be}"
        case .closeSpaceRegular: return "\u{f2bf}"
        case .closedCaptionBadgeBold: return "\u{f2c0}"
        case .closedCaptionBadgeLight: return "\u{f2c1}"
        case .closedCaptionBadgeRegular: return "\u{f2c2}"
        case .closedCaptionsBold: return "\u{f2c3}"
        case .closedCaptionsFilled: return "\u{f2c4}"
        case .closedCaptionsLight: return "\u{f2c5}"
        case .closedCaptionsRegular: return "\u{f2c6}"
        case .cloudBold: return "\u{f2c7}"
        case .cloudFilled: return "\u{f2c8}"
        case .cloudFrameBold: return "\u{f2c9}"
        case .cloudFrameFilled: return "\u{f2ca}"
        case .cloudFrameRegular: return "\u{f2cb}"
        case .cloudFramedFilled: return "\u{f2cc}"
        case .cloudFramedLight: return "\u{f2cd}"
        case .cloudLight: return "\u{f2ce}"
        case .cloudMutedBold: return "\u{f2cf}"
        case .cloudMutedFilled: return "\u{f2d0}"
        case .cloudMutedLight: return "\u{f2d1}"
        case .cloudMutedRegular: return "\u{f2d2}"
        case .cloudRegular: return "\u{f2d3}"
        case .cloudUploadBold: return "\u{f2d4}"
        case .cloudUploadLight: return "\u{f2d5}"
        case .cloudUploadRegular: return "\u{f2d6}"
        case .codeBlockBold: return "\u{f2d7}"
        case .codeBlockLight: return "\u{f2d8}"
        case .codeBlockRegular: return "\u{f2d9}"
        case .colorBold: return "\u{f2da}"
        case .colorLight: return "\u{f2db}"
        case .colorRegular: return "\u{f2dc}"
        case .commentingBold: return "\u{f2dd}"
        case .commentingFilled: return "\u{f2de}"
        case .commentingLight: return "\u{f2df}"
        case .commentingRegular: return "\u{f2e0}"
        case .companyBold: return "\u{f2e1}"
        case .companyLight: return "\u{f2e2}"
        case .companyRegular: return "\u{f2e3}"
        case .computerBold: return "\u{f2e4}"
        case .computerLight: return "\u{f2e5}"
        case .computerRegular: return "\u{f2e6}"
        case .conciergeBold: return "\u{f2e7}"
        case .conciergeLight: return "\u{f2e8}"
        case .conciergeRegular: return "\u{f2e9}"
        case .contactCardBold: return "\u{f2ea}"
        case .contactCardFilled: return "\u{f2eb}"
        case .contactCardLight: return "\u{f2ec}"
        case .contactCardRegular: return "\u{f2ed}"
        case .contactGroupBold: return "\u{f2ee}"
        case .contactGroupFilled: return "\u{f2ef}"
        case .contactGroupLight: return "\u{f2f0}"
        case .contactGroupRegular: return "\u{f2f1}"
        case .contactsBold: return "\u{f2f2}"
        case .contactsFilled: return "\u{f2f3}"
        case .contactsLight: return "\u{f2f4}"
        case .contactsRegular: return "\u{f2f5}"
        case .contentDownloadBold: return "\u{f2f6}"
        case .contentDownloadFilled: return "\u{f2f7}"
        case .contentDownloadLight: return "\u{f2f8}"
        case .contentDownloadRegular: return "\u{f2f9}"
        case .contentShareBold: return "\u{f2fa}"
        case .contentShareLight: return "\u{f2fb}"
        case .contentShareRegular: return "\u{f2fc}"
        case .contrastBold: return "\u{f2fd}"
        case .contrastLight: return "\u{f2fe}"
        case .contrastRegular: return "\u{f2ff}"
        case .copyBold: return "\u{f300}"
        case .copyLight: return "\u{f301}"
        case .copyRegular: return "\u{f302}"
        case .cpuBold: return "\u{f303}"
        case .cpuLight: return "\u{f304}"
        case .cpuRegular: return "\u{f305}"
        case .cropBold: return "\u{f306}"
        case .cropLight: return "\u{f307}"
        case .cropRegular: return "\u{f308}"
        case .cucmConnectionBold: return "\u{f309}"
        case .cucmConnectionLight: return "\u{f30a}"
        case .cucmConnectionRegular: return "\u{f30b}"
        case .dashboardBold: return "\u{f30c}"
        case .dashboardFilled: return "\u{f30d}"
        case .dashboardLight: return "\u{f30e}"
        case .dashboardRegular: return "\u{f30f}"
        case .deleteBold: return "\u{f310}"
        case .deleteLight: return "\u{f311}"
        case .deleteRegular: return "\u{f312}"
        case .deskPhoneBold: return "\u{f313}"
        case .deskPhoneFilled: return "\u{f314}"
        case .deskPhoneLight: return "\u{f315}"
        case .deskPhoneRegular: return "\u{f316}"
        case .deskPhoneWarningBold: return "\u{f317}"
        case .deskPhoneWarningLight: return "\u{f318}"
        case .deskPhoneWarningRegular: return "\u{f319}"
        case .deviceConnectionBold: return "\u{f31a}"
        case .deviceConnectionFilled: return "\u{f31b}"
        case .deviceConnectionLight: return "\u{f31c}"
        case .deviceConnectionRegular: return "\u{f31d}"
        case .diagnosticsBold: return "\u{f31e}"
        case .diagnosticsLight: return "\u{f31f}"
        case .diagnosticsRegular: return "\u{f320}"
        case .dialpadBold: return "\u{f321}"
        case .dialpadLight: return "\u{f322}"
        case .dialpadRegular: return "\u{f323}"
        case .directionalPadBold: return "\u{f324}"
        case .directionalPadFilled: return "\u{f325}"
        case .directionalPadLight: return "\u{f326}"
        case .directionalPadRegular: return "\u{f327}"
        case .directoryBold: return "\u{f328}"
        case .directoryLight: return "\u{f329}"
        case .directoryRegular: return "\u{f32a}"
        case .discBold: return "\u{f32b}"
        case .discDisconnectedBold: return "\u{f32c}"
        case .discDisconnectedLight: return "\u{f32d}"
        case .discDisconnectedRegular: return "\u{f32e}"
        case .discLight: return "\u{f32f}"
        case .discRegular: return "\u{f330}"
        case .disconnectBold: return "\u{f331}"
        case .disconnectLight: return "\u{f332}"
        case .disconnectRegular: return "\u{f333}"
        case .dislikeBold: return "\u{f334}"
        case .dislikeFilled: return "\u{f335}"
        case .dislikeLight: return "\u{f336}"
        case .dislikeRegular: return "\u{f337}"
        case .displayBold: return "\u{f338}"
        case .displayInputBold: return "\u{f339}"
        case .displayInputLight: return "\u{f33a}"
        case .displayInputRegular: return "\u{f33b}"
        case .displayLight: return "\u{f33c}"
        case .displayRegular: return "\u{f33d}"
        case .displayWarningBold: return "\u{f33e}"
        case .displayWarningLight: return "\u{f33f}"
        case .displayWarningRegular: return "\u{f340}"
        case .dndPresenceBold: return "\u{f341}"
        case .dndPresenceFilled: return "\u{f342}"
        case .dndPresenceLight: return "\u{f343}"
        case .dndPresenceRegular: return "\u{f344}"
        case .dndPresenceSmallFilled: return "\u{f345}"
        case .documentBold: return "\u{f346}"
        case .documentCameraBold: return "\u{f347}"
        case .documentCameraDisconnectedBold: return "\u{f348}"
        case .documentCameraDisconnectedLight: return "\u{f349}"
        case .documentCameraDisconnectedRegular: return "\u{f34a}"
        case .documentCameraLight: return "\u{f34b}"
        case .documentCameraRegular: return "\u{f34c}"
        case .documentCreateBold: return "\u{f34d}"
        case .documentCreateFilled: return "\u{f34e}"
        case .documentCreateLight: return "\u{f34f}"
        case .documentCreateRegular: return "\u{f350}"
        case .documentFilled: return "\u{f351}"
        case .documentLight: return "\u{f352}"
        case .documentMoveBold: return "\u{f353}"
        case .documentMoveFilled: return "\u{f354}"
        case .documentMoveLight: return "\u{f355}"
        case .documentMoveRegular: return "\u{f356}"
        case .documentRegular: return "\u{f357}"
        case .documentShareBold: return "\u{f358}"
        case .documentShareFilled: return "\u{f359}"
        case .documentShareLight: return "\u{f35a}"
        case .documentShareRegular: return "\u{f35b}"
        case .donutChartBold: return "\u{f35c}"
        case .donutChartFilled: return "\u{f35d}"
        case .donutChartLight: return "\u{f35e}"
        case .donutChartRegular: return "\u{f35f}"
        case .downloadBold: return "\u{f360}"
        case .downloadFilled: return "\u{f361}"
        case .downloadLight: return "\u{f362}"
        case .downloadRegular: return "\u{f363}"
        case .draftIndicatorSmallFilled: return "\u{f364}"
        case .dragBold: return "\u{f365}"
        case .dragLight: return "\u{f366}"
        case .dragRegular: return "\u{f367}"
        case .dx70Bold: return "\u{f368}"
        case .dx70Light: return "\u{f369}"
        case .dx70Regular: return "\u{f36a}"
        case .dx80Bold: return "\u{f36b}"
        case .dx80Filled: return "\u{f36c}"
        case .dx80Light: return "\u{f36d}"
        case .dx80Regular: return "\u{f36e}"
        case .editBold: return "\u{f36f}"
        case .editLight: return "\u{f370}"
        case .editRegular: return "\u{f371}"
        case .emailBold: return "\u{f372}"
        case .emailFilled: return "\u{f373}"
        case .emailInviteBold: return "\u{f374}"
        case .emailInviteLight: return "\u{f375}"
        case .emailInviteRegular: return "\u{f376}"
        case .emailLight: return "\u{f377}"
        case .emailReadBold: return "\u{f378}"
        case .emailReadFilled: return "\u{f379}"
        case .emailReadLight: return "\u{f37a}"
        case .emailReadRegular: return "\u{f37b}"
        case .emailRegular: return "\u{f37c}"
        case .emojiExcitedBold: return "\u{f37d}"
        case .emojiExcitedFilled: return "\u{f37e}"
        case .emojiHappyBold: return "\u{f37f}"
        case .emojiHappyFilled: return "\u{f380}"
        case .emojiHappyLight: return "\u{f381}"
        case .emojiHappyRegular: return "\u{f382}"
        case .emojiPassiveBold: return "\u{f383}"
        case .emojiPassiveFilled: return "\u{f384}"
        case .emojiPassiveLight: return "\u{f385}"
        case .emojiPassiveRegular: return "\u{f386}"
        case .emojiSadBold: return "\u{f387}"
        case .emojiSadFilled: return "\u{f388}"
        case .emojiSadLight: return "\u{f389}"
        case .emojiSadRegular: return "\u{f38a}"
        case .emojiUnhappyBold: return "\u{f38b}"
        case .emojiUnhappyFilled: return "\u{f38c}"
        case .encryptionCircleFilled: return "\u{f38d}"
        case .encryptionFilled: return "\u{f38e}"
        case .endRemoteDesktopControlBold: return "\u{f38f}"
        case .endRemoteDesktopControlLight: return "\u{f390}"
        case .endRemoteDesktopControlRegular: return "\u{f391}"
        case .endToEndEncryptionCircleFilled: return "\u{f392}"
        case .endToEndEncryptionFilled: return "\u{f393}"
        case .endpointBlockedBold: return "\u{f394}"
        case .endpointBlockedLight: return "\u{f395}"
        case .endpointBlockedRegular: return "\u{f396}"
        case .endpointBold: return "\u{f397}"
        case .endpointG270Bold: return "\u{f398}"
        case .endpointG270DualBold: return "\u{f399}"
        case .endpointG270DualLight: return "\u{f39a}"
        case .endpointG270DualRegular: return "\u{f39b}"
        case .endpointG270Light: return "\u{f39c}"
        case .endpointG270Regular: return "\u{f39d}"
        case .endpointG2Bold: return "\u{f39e}"
        case .endpointG2Light: return "\u{f39f}"
        case .endpointG2Regular: return "\u{f3a0}"
        case .endpointG2StandBold: return "\u{f3a1}"
        case .endpointG2StandLight: return "\u{f3a2}"
        case .endpointG2StandRegular: return "\u{f3a3}"
        case .endpointLight: return "\u{f3a4}"
        case .endpointMx800Bold: return "\u{f3a5}"
        case .endpointMx800DualBold: return "\u{f3a6}"
        case .endpointMx800DualLight: return "\u{f3a7}"
        case .endpointMx800DualRegular: return "\u{f3a8}"
        case .endpointMx800Light: return "\u{f3a9}"
        case .endpointMx800Regular: return "\u{f3aa}"
        case .endpointRegular: return "\u{f3ab}"
        case .endpointStandBold: return "\u{f3ac}"
        case .endpointStandFilled: return "\u{f3ad}"
        case .endpointStandLight: return "\u{f3ae}"
        case .endpointStandRegular: return "\u{f3af}"
        case .endpointWarningBold: return "\u{f3b0}"
        case .endpointWarningLight: return "\u{f3b1}"
        case .endpointWarningRegular: return "\u{f3b2}"
        case .enterBold: return "\u{f3b3}"
        case .enterLight: return "\u{f3b4}"
        case .enterRegular: return "\u{f3b5}"
        case .enterRoomBold: return "\u{f3b6}"
        case .enterRoomFilled: return "\u{f3b7}"
        case .enterRoomLight: return "\u{f3b8}"
        case .enterRoomRegular: return "\u{f3b9}"
        case .eraserBold: return "\u{f3ba}"
        case .eraserFilled: return "\u{f3bb}"
        case .eraserLight: return "\u{f3bc}"
        case .eraserRegular: return "\u{f3bd}"
        case .errorLegacyBadgeFilled: return "\u{f3be}"
        case .errorLegacyBold: return "\u{f3bf}"
        case .errorLegacyFilled: return "\u{f3c0}"
        case .errorLegacyLight: return "\u{f3c1}"
        case .errorLegacyRegular: return "\u{f3c2}"
        case .ethernetBold: return "\u{f3c3}"
        case .ethernetLight: return "\u{f3c4}"
        case .ethernetRegular: return "\u{f3c5}"
        case .exitRoomBold: return "\u{f3c6}"
        case .exitRoomLight: return "\u{f3c7}"
        case .exitRoomRegular: return "\u{f3c8}"
        case .exploreBold: return "\u{f3c9}"
        case .exploreLight: return "\u{f3ca}"
        case .exploreRegular: return "\u{f3cb}"
        case .exportBold: return "\u{f3cc}"
        case .exportLight: return "\u{f3cd}"
        case .exportRegular: return "\u{f3ce}"
        case .extensionMobilityBold: return "\u{f3cf}"
        case .extensionMobilityLight: return "\u{f3d0}"
        case .extensionMobilityRegular: return "\u{f3d1}"
        case .externalMessageBold: return "\u{f3d2}"
        case .externalMessageLight: return "\u{f3d3}"
        case .externalMessageRegular: return "\u{f3d4}"
        case .externalUserBold: return "\u{f3d5}"
        case .externalUserLight: return "\u{f3d6}"
        case .externalUserRegular: return "\u{f3d7}"
        case .familyFontBold: return "\u{f3d8}"
        case .familyFontLight: return "\u{f3d9}"
        case .familyFontRegular: return "\u{f3da}"
        case .fastForwardBold: return "\u{f3db}"
        case .fastForwardLight: return "\u{f3dc}"
        case .fastForwardRegular: return "\u{f3dd}"
        case .favoriteBold: return "\u{f3de}"
        case .favoriteFilled: return "\u{f3df}"
        case .favoriteLight: return "\u{f3e0}"
        case .favoriteRegular: return "\u{f3e1}"
        case .favoritesBold: return "\u{f3e2}"
        case .favoritesFilled: return "\u{f3e3}"
        case .favoritesLight: return "\u{f3e4}"
        case .favoritesRegular: return "\u{f3e5}"
        case .fbwBold: return "\u{f3e6}"
        case .fbwFilled: return "\u{f3e7}"
        case .fbwLight: return "\u{f3e8}"
        case .fbwRegular: return "\u{f3e9}"
        case .ffwBold: return "\u{f3ea}"
        case .ffwFilled: return "\u{f3eb}"
        case .ffwLight: return "\u{f3ec}"
        case .ffwRegular: return "\u{f3ed}"
        case .file3DBold: return "\u{f3ee}"
        case .file3DFilled: return "\u{f3ef}"
        case .file3DLight: return "\u{f3f0}"
        case .file3DRegular: return "\u{f3f1}"
        case .fileAnalysisBold: return "\u{f3f2}"
        case .fileAnalysisFilled: return "\u{f3f3}"
        case .fileAnalysisLight: return "\u{f3f4}"
        case .fileAnalysisRegular: return "\u{f3f5}"
        case .fileAnnotationBold: return "\u{f3f6}"
        case .fileAnnotationFilled: return "\u{f3f7}"
        case .fileAnnotationLight: return "\u{f3f8}"
        case .fileAnnotationRegular: return "\u{f3f9}"
        case .fileAudioBold: return "\u{f3fa}"
        case .fileAudioFilled: return "\u{f3fb}"
        case .fileAudioLight: return "\u{f3fc}"
        case .fileAudioRegular: return "\u{f3fd}"
        case .fileBugBold: return "\u{f3fe}"
        case .fileBugFilled: return "\u{f3ff}"
        case .fileBugLight: return "\u{f400}"
        case .fileBugRegular: return "\u{f401}"
        case .fileCodeBold: return "\u{f402}"
        case .fileCodeFilled: return "\u{f403}"
        case .fileCodeLight: return "\u{f404}"
        case .fileCodeRegular: return "\u{f405}"
        case .fileDashboardBold: return "\u{f406}"
        case .fileDashboardFilled: return "\u{f407}"
        case .fileDashboardLight: return "\u{f408}"
        case .fileDashboardRegular: return "\u{f409}"
        case .fileExcelBold: return "\u{f40a}"
        case .fileExcelFilled: return "\u{f40b}"
        case .fileExcelLight: return "\u{f40c}"
        case .fileExcelRegular: return "\u{f40d}"
        case .fileGraphBold: return "\u{f40e}"
        case .fileGraphFilled: return "\u{f40f}"
        case .fileGraphLight: return "\u{f410}"
        case .fileGraphRegular: return "\u{f411}"
        case .fileImageBold: return "\u{f412}"
        case .fileImageFilled: return "\u{f413}"
        case .fileImageLight: return "\u{f414}"
        case .fileImageRegular: return "\u{f415}"
        case .fileKeynoteBold: return "\u{f416}"
        case .fileKeynoteFilled: return "\u{f417}"
        case .fileKeynoteLight: return "\u{f418}"
        case .fileKeynoteRegular: return "\u{f419}"
        case .fileLockedBold: return "\u{f41a}"
        case .fileLockedFilled: return "\u{f41b}"
        case .fileLockedLight: return "\u{f41c}"
        case .fileLockedRegular: return "\u{f41d}"
        case .fileMissingBold: return "\u{f41e}"
        case .fileMissingFilled: return "\u{f41f}"
        case .fileMissingLight: return "\u{f420}"
        case .fileMissingRegular: return "\u{f421}"
        case .fileMusicBold: return "\u{f422}"
        case .fileMusicFilled: return "\u{f423}"
        case .fileMusicLight: return "\u{f424}"
        case .fileMusicRegular: return "\u{f425}"
        case .fileOnenoteBold: return "\u{f426}"
        case .fileOnenoteFilled: return "\u{f427}"
        case .fileOnenoteLight: return "\u{f428}"
        case .fileOnenoteRegular: return "\u{f429}"
        case .filePdfBold: return "\u{f42a}"
        case .filePdfFilled: return "\u{f42b}"
        case .filePdfLight: return "\u{f42c}"
        case .filePdfRegular: return "\u{f42d}"
        case .filePowerpointBold: return "\u{f42e}"
        case .filePowerpointFilled: return "\u{f42f}"
        case .filePowerpointLight: return "\u{f430}"
        case .filePowerpointRegular: return "\u{f431}"
        case .fileSpreadsheetBold: return "\u{f432}"
        case .fileSpreadsheetFilled: return "\u{f433}"
        case .fileSpreadsheetLight: return "\u{f434}"
        case .fileSpreadsheetRegular: return "\u{f435}"
        case .fileTextBold: return "\u{f436}"
        case .fileTextFilled: return "\u{f437}"
        case .fileTextLight: return "\u{f438}"
        case .fileTextRegular: return "\u{f439}"
        case .fileVectorBold: return "\u{f43a}"
        case .fileVectorFilled: return "\u{f43b}"
        case .fileVectorLight: return "\u{f43c}"
        case .fileVectorRegular: return "\u{f43d}"
        case .fileVideoBold: return "\u{f43e}"
        case .fileVideoFilled: return "\u{f43f}"
        case .fileVideoLight: return "\u{f440}"
        case .fileVideoRegular: return "\u{f441}"
        case .fileWordBold: return "\u{f442}"
        case .fileWordFilled: return "\u{f443}"
        case .fileWordLight: return "\u{f444}"
        case .fileWordRegular: return "\u{f445}"
        case .fileZipBold: return "\u{f446}"
        case .fileZipFilled: return "\u{f447}"
        case .fileZipLight: return "\u{f448}"
        case .fileZipRegular: return "\u{f449}"
        case .filesBold: return "\u{f44a}"
        case .filesFilled: return "\u{f44b}"
        case .filesLight: return "\u{f44c}"
        case .filesRegular: return "\u{f44d}"
        case .filterBold: return "\u{f44e}"
        case .filterCircleBold: return "\u{f44f}"
        case .filterCircleFilled: return "\u{f450}"
        case .filterCircleLight: return "\u{f451}"
        case .filterCircleRegular: return "\u{f452}"
        case .filterLight: return "\u{f453}"
        case .filterRegular: return "\u{f454}"
        case .fitToWidthBold: return "\u{f455}"
        case .fitToWidthLight: return "\u{f456}"
        case .fitToWidthRegular: return "\u{f457}"
        case .fitToWindowBold: return "\u{f458}"
        case .fitToWindowExitBold: return "\u{f459}"
        case .fitToWindowExitLight: return "\u{f45a}"
        case .fitToWindowExitRegular: return "\u{f45b}"
        case .fitToWindowLight: return "\u{f45c}"
        case .fitToWindowRegular: return "\u{f45d}"
        case .flagBold: return "\u{f45e}"
        case .flagCircleBold: return "\u{f45f}"
        case .flagCircleFilled: return "\u{f460}"
        case .flagCircleLight: return "\u{f461}"
        case .flagCircleRegular: return "\u{f462}"
        case .flagFilled: return "\u{f463}"
        case .flagLight: return "\u{f464}"
        case .flagRegular: return "\u{f465}"
        case .folderBold: return "\u{f466}"
        case .folderEditBold: return "\u{f467}"
        case .folderEditLight: return "\u{f468}"
        case .folderEditRegular: return "\u{f469}"
        case .folderLight: return "\u{f46a}"
        case .folderLockBold: return "\u{f46b}"
        case .folderLockLight: return "\u{f46c}"
        case .folderLockRegular: return "\u{f46d}"
        case .folderRegular: return "\u{f46e}"
        case .folderViewBold: return "\u{f46f}"
        case .folderViewLight: return "\u{f470}"
        case .folderViewRegular: return "\u{f471}"
        case .foodBold: return "\u{f472}"
        case .foodLight: return "\u{f473}"
        case .foodRegular: return "\u{f474}"
        case .formatBold: return "\u{f475}"
        case .formatControlPanelDraggerBold: return "\u{f476}"
        case .formatControlPanelDraggerHorizontalBold: return "\u{f477}"
        case .formatControlPanelDraggerHorizontalLight: return "\u{f478}"
        case .formatControlPanelDraggerHorizontalRegular: return "\u{f479}"
        case .formatControlPanelDraggerLight: return "\u{f47a}"
        case .formatControlPanelDraggerRegular: return "\u{f47b}"
        case .formatDefaultAppBold: return "\u{f47c}"
        case .formatDefaultAppLight: return "\u{f47d}"
        case .formatDefaultAppRegular: return "\u{f47e}"
        case .formatLight: return "\u{f47f}"
        case .formatPanelControlBarBold: return "\u{f480}"
        case .formatPanelControlBarLight: return "\u{f481}"
        case .formatPanelControlBarRegular: return "\u{f482}"
        case .formatPanelControlDownBold: return "\u{f483}"
        case .formatPanelControlDownLight: return "\u{f484}"
        case .formatPanelControlDownRegular: return "\u{f485}"
        case .formatPanelControlLeftBold: return "\u{f486}"
        case .formatPanelControlLeftLight: return "\u{f487}"
        case .formatPanelControlLeftRegular: return "\u{f488}"
        case .formatPanelControlRightBold: return "\u{f489}"
        case .formatPanelControlRightLight: return "\u{f48a}"
        case .formatPanelControlRightRegular: return "\u{f48b}"
        case .formatPanelControlUpBold: return "\u{f48c}"
        case .formatPanelControlUpDownBold: return "\u{f48d}"
        case .formatPanelControlUpDownLight: return "\u{f48e}"
        case .formatPanelControlUpDownRegular: return "\u{f48f}"
        case .formatPanelControlUpLight: return "\u{f490}"
        case .formatPanelControlUpRegular: return "\u{f491}"
        case .formatRegular: return "\u{f492}"
        case .formatViewMixedBold: return "\u{f493}"
        case .formatViewMixedLight: return "\u{f494}"
        case .formatViewMixedRegular: return "\u{f495}"
        case .forwardMessageBold: return "\u{f496}"
        case .forwardMessageFilled: return "\u{f497}"
        case .forwardMessageLight: return "\u{f498}"
        case .forwardMessageRegular: return "\u{f499}"
        case .fourWayNavigationBold: return "\u{f49a}"
        case .fourWayNavigationLight: return "\u{f49b}"
        case .fourWayNavigationRegular: return "\u{f49c}"
        case .fullscreenBold: return "\u{f49d}"
        case .fullscreenExitBold: return "\u{f49e}"
        case .fullscreenExitLight: return "\u{f49f}"
        case .fullscreenExitRegular: return "\u{f4a0}"
        case .fullscreenLight: return "\u{f4a1}"
        case .fullscreenRegular: return "\u{f4a2}"
        case .genericDeviceVideoBold: return "\u{f4a3}"
        case .genericDeviceVideoFilled: return "\u{f4a4}"
        case .genericDeviceVideoLight: return "\u{f4a5}"
        case .genericDeviceVideoRegular: return "\u{f4a6}"
        case .genericDeviceVideoSmallFilled: return "\u{f4a7}"
        case .gifBold: return "\u{f4a8}"
        case .gifFilled: return "\u{f4a9}"
        case .gifLight: return "\u{f4aa}"
        case .gifRegular: return "\u{f4ab}"
        case .guestIssuerBold: return "\u{f4ac}"
        case .guestIssuerLight: return "\u{f4ad}"
        case .guestIssuerRegular: return "\u{f4ae}"
        case .guideBold: return "\u{f4af}"
        case .guideLight: return "\u{f4b0}"
        case .guideRegular: return "\u{f4b1}"
        case .handlerBold: return "\u{f4b2}"
        case .handlerLight: return "\u{f4b3}"
        case .handlerRegular: return "\u{f4b4}"
        case .handsetAlertBold: return "\u{f4b5}"
        case .handsetAlertFilled: return "\u{f4b6}"
        case .handsetAlertLight: return "\u{f4b7}"
        case .handsetAlertRegular: return "\u{f4b8}"
        case .handsetBold: return "\u{f4b9}"
        case .handsetFilled: return "\u{f4ba}"
        case .handsetLight: return "\u{f4bb}"
        case .handsetMutedBold: return "\u{f4bc}"
        case .handsetMutedFilled: return "\u{f4bd}"
        case .handsetMutedLight: return "\u{f4be}"
        case .handsetMutedRegular: return "\u{f4bf}"
        case .handsetRegular: return "\u{f4c0}"
        case .handshakeBold: return "\u{f4c1}"
        case .handshakeLight: return "\u{f4c2}"
        case .handshakeRegular: return "\u{f4c3}"
        case .headingOneBold: return "\u{f4c4}"
        case .headingOneLight: return "\u{f4c5}"
        case .headingOneRegular: return "\u{f4c6}"
        case .headingThreeBold: return "\u{f4c7}"
        case .headingThreeLight: return "\u{f4c8}"
        case .headingThreeRegular: return "\u{f4c9}"
        case .headingTwoBold: return "\u{f4ca}"
        case .headingTwoLight: return "\u{f4cb}"
        case .headingTwoRegular: return "\u{f4cc}"
        case .headsetAlertBold: return "\u{f4cd}"
        case .headsetAlertLight: return "\u{f4ce}"
        case .headsetAlertRegular: return "\u{f4cf}"
        case .headsetBold: return "\u{f4d0}"
        case .headsetFilled: return "\u{f4d1}"
        case .headsetLight: return "\u{f4d2}"
        case .headsetMutedBold: return "\u{f4d3}"
        case .headsetMutedLight: return "\u{f4d4}"
        case .headsetMutedRegular: return "\u{f4d5}"
        case .headsetPrivateBold: return "\u{f4d6}"
        case .headsetPrivateLight: return "\u{f4d7}"
        case .headsetPrivateRegular: return "\u{f4d8}"
        case .headsetRegular: return "\u{f4d9}"
        case .helpBold: return "\u{f4da}"
        case .helpCircleActiveFilled: return "\u{f4db}"
        case .helpCircleBold: return "\u{f4dc}"
        case .helpCircleLight: return "\u{f4dd}"
        case .helpCircleRegular: return "\u{f4de}"
        case .helpLight: return "\u{f4df}"
        case .helpRegular: return "\u{f4e0}"
        case .helpdeskBold: return "\u{f4e1}"
        case .helpdeskLight: return "\u{f4e2}"
        case .helpdeskRegular: return "\u{f4e3}"
        case .hideBold: return "\u{f4e4}"
        case .hideFilled: return "\u{f4e5}"
        case .hideLight: return "\u{f4e6}"
        case .hideRegular: return "\u{f4e7}"
        case .homeBold: return "\u{f4e8}"
        case .homeFilled: return "\u{f4e9}"
        case .homeLight: return "\u{f4ea}"
        case .homeRegular: return "\u{f4eb}"
        case .horizontalLineBold: return "\u{f4ec}"
        case .horizontalLineLight: return "\u{f4ed}"
        case .horizontalLineRegular: return "\u{f4ee}"
        case .humidityBold: return "\u{f4ef}"
        case .humidityLight: return "\u{f4f0}"
        case .humidityRegular: return "\u{f4f1}"
        case .huntGroupBold: return "\u{f4f2}"
        case .huntGroupFilled: return "\u{f4f3}"
        case .huntGroupLight: return "\u{f4f4}"
        case .huntGroupRegular: return "\u{f4f5}"
        case .importBold: return "\u{f4f6}"
        case .importLight: return "\u{f4f7}"
        case .importRegular: return "\u{f4f8}"
        case .incomingCallLegacyBold: return "\u{f4f9}"
        case .incomingCallLegacyLight: return "\u{f4fa}"
        case .incomingCallLegacyRegular: return "\u{f4fb}"
        case .infoBadgeFilled: return "\u{f4fc}"
        case .infoCircleBold: return "\u{f4fd}"
        case .infoCircleFilled: return "\u{f4fe}"
        case .infoCircleLight: return "\u{f4ff}"
        case .infoCircleRegular: return "\u{f500}"
        case .infoCircleTwoBold: return "\u{f501}"
        case .infoCircleTwoFilled: return "\u{f502}"
        case .infoCircleTwoLight: return "\u{f503}"
        case .infoCircleTwoRegular: return "\u{f504}"
        case .inputBold: return "\u{f505}"
        case .inputDisconnectedBold: return "\u{f506}"
        case .inputDisconnectedLight: return "\u{f507}"
        case .inputDisconnectedRegular: return "\u{f508}"
        case .inputLight: return "\u{f509}"
        case .inputRegular: return "\u{f50a}"
        case .insightsBold: return "\u{f50b}"
        case .insightsLight: return "\u{f50c}"
        case .insightsRegular: return "\u{f50d}"
        case .integrationsBold: return "\u{f50e}"
        case .integrationsLight: return "\u{f50f}"
        case .integrationsRegular: return "\u{f510}"
        case .invitedUserBold: return "\u{f511}"
        case .invitedUserLight: return "\u{f512}"
        case .invitedUserRegular: return "\u{f513}"
        case .italicBold: return "\u{f514}"
        case .italicLight: return "\u{f515}"
        case .italicRegular: return "\u{f516}"
        case .joinAudioBold: return "\u{f517}"
        case .joinAudioFilled: return "\u{f518}"
        case .joinAudioLight: return "\u{f519}"
        case .joinAudioRegular: return "\u{f51a}"
        case .keyboardBold: return "\u{f51b}"
        case .keyboardCloseBold: return "\u{f51c}"
        case .keyboardCloseLight: return "\u{f51d}"
        case .keyboardCloseRegular: return "\u{f51e}"
        case .keyboardLight: return "\u{f51f}"
        case .keyboardRegular: return "\u{f520}"
        case .languageBold: return "\u{f521}"
        case .languageLight: return "\u{f522}"
        case .languageRegular: return "\u{f523}"
        case .laptopBold: return "\u{f524}"
        case .laptopDisconnectedBold: return "\u{f525}"
        case .laptopDisconnectedLight: return "\u{f526}"
        case .laptopDisconnectedRegular: return "\u{f527}"
        case .laptopFilled: return "\u{f528}"
        case .laptopLight: return "\u{f529}"
        case .laptopRegular: return "\u{f52a}"
        case .laserPointerBold: return "\u{f52b}"
        case .laserPointerLight: return "\u{f52c}"
        case .laserPointerRegular: return "\u{f52d}"
        case .launchBold: return "\u{f52e}"
        case .launchLight: return "\u{f52f}"
        case .launchRegular: return "\u{f530}"
        case .layoutSideBySideVerticalBold: return "\u{f531}"
        case .layoutSideBySideVerticalFilled: return "\u{f532}"
        case .layoutSideBySideVerticalLight: return "\u{f533}"
        case .layoutSideBySideVerticalRegular: return "\u{f534}"
        case .leaveBreakoutSessionBold: return "\u{f535}"
        case .leaveBreakoutSessionLight: return "\u{f536}"
        case .leaveBreakoutSessionRegular: return "\u{f537}"
        case .leaveDeviceBold: return "\u{f538}"
        case .leaveDeviceLight: return "\u{f539}"
        case .leaveDeviceRegular: return "\u{f53a}"
        case .likeBold: return "\u{f53b}"
        case .likeFilled: return "\u{f53c}"
        case .likeLight: return "\u{f53d}"
        case .likeRegular: return "\u{f53e}"
        case .linkBold: return "\u{f53f}"
        case .linkLight: return "\u{f540}"
        case .linkRegular: return "\u{f541}"
        case .listBulletedBold: return "\u{f542}"
        case .listBulletedLight: return "\u{f543}"
        case .listBulletedRegular: return "\u{f544}"
        case .listMenuBold: return "\u{f545}"
        case .listMenuLight: return "\u{f546}"
        case .listMenuRegular: return "\u{f547}"
        case .listNumberedBold: return "\u{f548}"
        case .listNumberedLight: return "\u{f549}"
        case .listNumberedRegular: return "\u{f54a}"
        case .locationBold: return "\u{f54b}"
        case .locationFilled: return "\u{f54c}"
        case .locationLight: return "\u{f54d}"
        case .locationRegular: return "\u{f54e}"
        case .lowerHandBold: return "\u{f54f}"
        case .lowerHandLight: return "\u{f550}"
        case .lowerHandRegular: return "\u{f551}"
        case .markAsUnreadBold: return "\u{f552}"
        case .markAsUnreadLight: return "\u{f553}"
        case .markAsUnreadRegular: return "\u{f554}"
        case .markdownBold: return "\u{f555}"
        case .markdownLight: return "\u{f556}"
        case .markdownRegular: return "\u{f557}"
        case .markerBold: return "\u{f558}"
        case .markerFilled: return "\u{f559}"
        case .markerLight: return "\u{f55a}"
        case .markerRegular: return "\u{f55b}"
        case .maximizeBold: return "\u{f55c}"
        case .maximizeLight: return "\u{f55d}"
        case .maximizeRegular: return "\u{f55e}"
        case .mediaPlayerBold: return "\u{f55f}"
        case .mediaPlayerLight: return "\u{f560}"
        case .mediaPlayerRegular: return "\u{f561}"
        case .mediaQualityGoodBold: return "\u{f562}"
        case .mediaQualityGoodFilled: return "\u{f563}"
        case .mediaQualityGoodLight: return "\u{f564}"
        case .mediaQualityGoodRegular: return "\u{f565}"
        case .mediaQualityPoorBold: return "\u{f566}"
        case .mediaQualityPoorFilled: return "\u{f567}"
        case .mediaQualityPoorLight: return "\u{f568}"
        case .mediaQualityPoorRegular: return "\u{f569}"
        case .mediaQualityUnstableBold: return "\u{f56a}"
        case .mediaQualityUnstableFilled: return "\u{f56b}"
        case .mediaQualityUnstableLight: return "\u{f56c}"
        case .mediaQualityUnstableRegular: return "\u{f56d}"
        case .meetBold: return "\u{f56e}"
        case .meetEndBold: return "\u{f56f}"
        case .meetEndLight: return "\u{f570}"
        case .meetEndRegular: return "\u{f571}"
        case .meetFilled: return "\u{f572}"
        case .meetLight: return "\u{f573}"
        case .meetRegular: return "\u{f574}"
        case .meetingsBold: return "\u{f575}"
        case .meetingsFilled: return "\u{f576}"
        case .meetingsFocusMonthBold: return "\u{f577}"
        case .meetingsFocusMonthLight: return "\u{f578}"
        case .meetingsFocusMonthRegular: return "\u{f579}"
        case .meetingsFocusOneDayBold: return "\u{f57a}"
        case .meetingsFocusOneDayLight: return "\u{f57b}"
        case .meetingsFocusOneDayRegular: return "\u{f57c}"
        case .meetingsFocusThreeDayBold: return "\u{f57d}"
        case .meetingsFocusThreeDayLight: return "\u{f57e}"
        case .meetingsFocusThreeDayRegular: return "\u{f57f}"
        case .meetingsFocusUpcomingBold: return "\u{f580}"
        case .meetingsFocusUpcomingLight: return "\u{f581}"
        case .meetingsFocusUpcomingRegular: return "\u{f582}"
        case .meetingsFocusWeekBold: return "\u{f583}"
        case .meetingsFocusWeekLight: return "\u{f584}"
        case .meetingsFocusWeekRegular: return "\u{f585}"
        case .meetingsLight: return "\u{f586}"
        case .meetingsPresenceBold: return "\u{f587}"
        case .meetingsPresenceFilled: return "\u{f588}"
        case .meetingsPresenceLight: return "\u{f589}"
        case .meetingsPresenceRegular: return "\u{f58a}"
        case .meetingsPresenceSmallFilled: return "\u{f58b}"
        case .meetingsRegular: return "\u{f58c}"
        case .meetingsTeamActiveBold: return "\u{f58d}"
        case .meetingsTeamActiveLight: return "\u{f58e}"
        case .meetingsTeamActiveRegular: return "\u{f58f}"
        case .meetingsTeamBold: return "\u{f590}"
        case .meetingsTeamLight: return "\u{f591}"
        case .meetingsTeamNewBold: return "\u{f592}"
        case .meetingsTeamNewLight: return "\u{f593}"
        case .meetingsTeamNewRegular: return "\u{f594}"
        case .meetingsTeamRegular: return "\u{f595}"
        case .mentionBold: return "\u{f596}"
        case .mentionLight: return "\u{f597}"
        case .mentionRegular: return "\u{f598}"
        case .microphoneBold: return "\u{f599}"
        case .microphoneFilled: return "\u{f59a}"
        case .microphoneHardMutedBold: return "\u{f59b}"
        case .microphoneHardMutedColoredBold: return "\u{f59c}"
        case .microphoneHardMutedColoredLight: return "\u{f59d}"
        case .microphoneHardMutedColoredRegular: return "\u{f59e}"
        case .microphoneHardMutedLight: return "\u{f59f}"
        case .microphoneHardMutedRegular: return "\u{f5a0}"
        case .microphoneLight: return "\u{f5a1}"
        case .microphoneMusicModeColoredBold: return "\u{f5a2}"
        case .microphoneMusicModeColoredLight: return "\u{f5a3}"
        case .microphoneMusicModeColoredRegular: return "\u{f5a4}"
        case .microphoneMutedBold: return "\u{f5a5}"
        case .microphoneMutedFilled: return "\u{f5a6}"
        case .microphoneMutedIndicatorFilled: return "\u{f5a7}"
        case .microphoneMutedLight: return "\u{f5a8}"
        case .microphoneMutedRedBold: return "\u{f5a9}"
        case .microphoneMutedRedFilled: return "\u{f5aa}"
        case .microphoneMutedRedLight: return "\u{f5ab}"
        case .microphoneMutedRedRegular: return "\u{f5ac}"
        case .microphoneMutedRegular: return "\u{f5ad}"
        case .microphoneRegular: return "\u{f5ae}"
        case .minimizeBold: return "\u{f5af}"
        case .minimizeLight: return "\u{f5b0}"
        case .minimizeRegular: return "\u{f5b1}"
        case .minusBold: return "\u{f5b2}"
        case .minusLight: return "\u{f5b3}"
        case .minusRegular: return "\u{f5b4}"
        case .mirrorBold: return "\u{f5b5}"
        case .mirrorFilled: return "\u{f5b6}"
        case .mirrorLight: return "\u{f5b7}"
        case .mirrorRegular: return "\u{f5b8}"
        case .monitoringBold: return "\u{f5b9}"
        case .monitoringLight: return "\u{f5ba}"
        case .monitoringRegular: return "\u{f5bb}"
        case .moreAdrBold: return "\u{f5bc}"
        case .moreAdrLight: return "\u{f5bd}"
        case .moreAdrRegular: return "\u{f5be}"
        case .moreBold: return "\u{f5bf}"
        case .moreCircleBold: return "\u{f5c0}"
        case .moreCircleFilled: return "\u{f5c1}"
        case .moreCircleLight: return "\u{f5c2}"
        case .moreCircleRegular: return "\u{f5c3}"
        case .moreLight: return "\u{f5c4}"
        case .moreRegular: return "\u{f5c5}"
        case .mouseCursorBold: return "\u{f5c6}"
        case .mouseCursorLight: return "\u{f5c7}"
        case .mouseCursorRegular: return "\u{f5c8}"
        case .moveCallInAdrBold: return "\u{f5c9}"
        case .moveCallInAdrLight: return "\u{f5ca}"
        case .moveCallInAdrRegular: return "\u{f5cb}"
        case .moveCallInIphBold: return "\u{f5cc}"
        case .moveCallInIphLight: return "\u{f5cd}"
        case .moveCallInIphRegular: return "\u{f5ce}"
        case .moveCallInLaptopBold: return "\u{f5cf}"
        case .moveCallInLaptopLight: return "\u{f5d0}"
        case .moveCallInLaptopRegular: return "\u{f5d1}"
        case .moveCallInOutAdrBold: return "\u{f5d2}"
        case .moveCallInOutAdrLight: return "\u{f5d3}"
        case .moveCallInOutAdrRegular: return "\u{f5d4}"
        case .moveCallInOutIphBold: return "\u{f5d5}"
        case .moveCallInOutIphLight: return "\u{f5d6}"
        case .moveCallInOutIphRegular: return "\u{f5d7}"
        case .moveCallInTabletBold: return "\u{f5d8}"
        case .moveCallInTabletLight: return "\u{f5d9}"
        case .moveCallInTabletRegular: return "\u{f5da}"
        case .moveCallOutAdrBold: return "\u{f5db}"
        case .moveCallOutAdrLight: return "\u{f5dc}"
        case .moveCallOutAdrRegular: return "\u{f5dd}"
        case .moveCallOutIphBold: return "\u{f5de}"
        case .moveCallOutIphLight: return "\u{f5df}"
        case .moveCallOutIphRegular: return "\u{f5e0}"
        case .moveCallOutLaptopBold: return "\u{f5e1}"
        case .moveCallOutLaptopLight: return "\u{f5e2}"
        case .moveCallOutLaptopRegular: return "\u{f5e3}"
        case .moveCallOutTabletBold: return "\u{f5e4}"
        case .moveCallOutTabletLight: return "\u{f5e5}"
        case .moveCallOutTabletRegular: return "\u{f5e6}"
        case .multilineChartBold: return "\u{f5e7}"
        case .multilineChartFilled: return "\u{f5e8}"
        case .multilineChartLight: return "\u{f5e9}"
        case .multilineChartRegular: return "\u{f5ea}"
        case .multimediaBold: return "\u{f5eb}"
        case .multimediaFilled: return "\u{f5ec}"
        case .multimediaLight: return "\u{f5ed}"
        case .multimediaRegular: return "\u{f5ee}"
        case .multipledDevicesBold: return "\u{f5ef}"
        case .multipledDevicesLight: return "\u{f5f0}"
        case .multipledDevicesRegular: return "\u{f5f1}"
        case .musicModeBold: return "\u{f5f2}"
        case .musicModeCircleBold: return "\u{f5f3}"
        case .musicModeCircleFilled: return "\u{f5f4}"
        case .musicModeCircleLight: return "\u{f5f5}"
        case .musicModeCircleRegular: return "\u{f5f6}"
        case .musicModeFilled: return "\u{f5f7}"
        case .musicModeLight: return "\u{f5f8}"
        case .musicModeRegular: return "\u{f5f9}"
        case .muteOnEntryBold: return "\u{f5fa}"
        case .muteOnEntryFilled: return "\u{f5fb}"
        case .muteOnEntryLight: return "\u{f5fc}"
        case .muteOnEntryRegular: return "\u{f5fd}"
        case .newVoicemailBold: return "\u{f5fe}"
        case .newVoicemailLight: return "\u{f5ff}"
        case .newVoicemailRegular: return "\u{f600}"
        case .newWhiteboardBold: return "\u{f601}"
        case .newWhiteboardLight: return "\u{f602}"
        case .newWhiteboardRegular: return "\u{f603}"
        case .nextBold: return "\u{f604}"
        case .nextLight: return "\u{f605}"
        case .nextRegular: return "\u{f606}"
        case .noDevicesBold: return "\u{f607}"
        case .noDevicesLight: return "\u{f608}"
        case .noDevicesRegular: return "\u{f609}"
        case .noiseRemovalBold: return "\u{f60a}"
        case .noiseRemovalLight: return "\u{f60b}"
        case .noiseRemovalRegular: return "\u{f60c}"
        case .noteBold: return "\u{f60d}"
        case .noteLight: return "\u{f60e}"
        case .notePptBold: return "\u{f60f}"
        case .notePptLight: return "\u{f610}"
        case .notePptRegular: return "\u{f611}"
        case .noteRegular: return "\u{f612}"
        case .notesBold: return "\u{f613}"
        case .notesLight: return "\u{f614}"
        case .notesRegular: return "\u{f615}"
        case .numberBold: return "\u{f616}"
        case .numberLight: return "\u{f617}"
        case .numberRegular: return "\u{f618}"
        case .oldRemoteBold: return "\u{f619}"
        case .oldRemoteLight: return "\u{f61a}"
        case .oldRemoteRegular: return "\u{f61b}"
        case .oldTouchBold: return "\u{f61c}"
        case .oldTouchLight: return "\u{f61d}"
        case .oldTouchRegular: return "\u{f61e}"
        case .openInFolderBold: return "\u{f61f}"
        case .openInFolderLight: return "\u{f620}"
        case .openInFolderRegular: return "\u{f621}"
        case .openPagesBold: return "\u{f622}"
        case .openPagesLight: return "\u{f623}"
        case .openPagesRegular: return "\u{f624}"
        case .otherNumberBold: return "\u{f625}"
        case .otherNumberLight: return "\u{f626}"
        case .otherNumberRegular: return "\u{f627}"
        case .otherNumberWarningBold: return "\u{f628}"
        case .otherNumberWarningLight: return "\u{f629}"
        case .otherNumberWarningRegular: return "\u{f62a}"
        case .outgoingCallLegacyBold: return "\u{f62b}"
        case .outgoingCallLegacyLight: return "\u{f62c}"
        case .outgoingCallLegacyRegular: return "\u{f62d}"
        case .overflowLeftBold: return "\u{f62e}"
        case .overflowLeftLight: return "\u{f62f}"
        case .overflowLeftRegular: return "\u{f630}"
        case .overflowRightBold: return "\u{f631}"
        case .overflowRightLight: return "\u{f632}"
        case .overflowRightRegular: return "\u{f633}"
        case .pairedCameraBold: return "\u{f634}"
        case .pairedCameraLight: return "\u{f635}"
        case .pairedCameraRegular: return "\u{f636}"
        case .pairedDeviceBold: return "\u{f637}"
        case .pairedDeviceLight: return "\u{f638}"
        case .pairedDeviceRegular: return "\u{f639}"
        case .pairedHandsetBold: return "\u{f63a}"
        case .pairedHandsetLight: return "\u{f63b}"
        case .pairedHandsetRegular: return "\u{f63c}"
        case .pairingBold: return "\u{f63d}"
        case .pairingLight: return "\u{f63e}"
        case .pairingRegular: return "\u{f63f}"
        case .parkedBold: return "\u{f640}"
        case .parkedFilled: return "\u{f641}"
        case .parkedLight: return "\u{f642}"
        case .parkedRegular: return "\u{f643}"
        case .parseBold: return "\u{f644}"
        case .parseLight: return "\u{f645}"
        case .parseRegular: return "\u{f646}"
        case .participantAddBold: return "\u{f647}"
        case .participantAddLight: return "\u{f648}"
        case .participantAddRegular: return "\u{f649}"
        case .participantBlockedBold: return "\u{f64a}"
        case .participantBlockedLight: return "\u{f64b}"
        case .participantBlockedRegular: return "\u{f64c}"
        case .participantBold: return "\u{f64d}"
        case .participantFilled: return "\u{f64e}"
        case .participantLight: return "\u{f64f}"
        case .participantListBold: return "\u{f650}"
        case .participantListFilled: return "\u{f651}"
        case .participantListLight: return "\u{f652}"
        case .participantListRegular: return "\u{f653}"
        case .participantRegular: return "\u{f654}"
        case .participantRemoveBold: return "\u{f655}"
        case .participantRemoveLight: return "\u{f656}"
        case .participantRemoveRegular: return "\u{f657}"
        case .participantUnknownBold: return "\u{f658}"
        case .participantUnknownLight: return "\u{f659}"
        case .participantUnknownRegular: return "\u{f65a}"
        case .passMouseBold: return "\u{f65b}"
        case .passMouseLight: return "\u{f65c}"
        case .passMouseRegular: return "\u{f65d}"
        case .pauseBold: return "\u{f65e}"
        case .pauseFilled: return "\u{f65f}"
        case .pauseLight: return "\u{f660}"
        case .pauseRegular: return "\u{f661}"
        case .penBold: return "\u{f662}"
        case .penFilled: return "\u{f663}"
        case .penLight: return "\u{f664}"
        case .penRegular: return "\u{f665}"
        case .peopleBold: return "\u{f666}"
        case .peopleCircleBold: return "\u{f667}"
        case .peopleCircleFilled: return "\u{f668}"
        case .peopleCircleLight: return "\u{f669}"
        case .peopleCircleRegular: return "\u{f66a}"
        case .peopleFilled: return "\u{f66b}"
        case .peopleInsightsFilled: return "\u{f66c}"
        case .peopleLight: return "\u{f66d}"
        case .peopleRegular: return "\u{f66e}"
        case .phoneAlertBold: return "\u{f66f}"
        case .phoneAlertLight: return "\u{f670}"
        case .phoneAlertRegular: return "\u{f671}"
        case .phoneBold: return "\u{f672}"
        case .phoneFilled: return "\u{f673}"
        case .phoneLight: return "\u{f674}"
        case .phoneMutedBold: return "\u{f675}"
        case .phoneMutedLight: return "\u{f676}"
        case .phoneMutedRegular: return "\u{f677}"
        case .phonePrivateBold: return "\u{f678}"
        case .phonePrivateLight: return "\u{f679}"
        case .phonePrivateRegular: return "\u{f67a}"
        case .phoneRegular: return "\u{f67b}"
        case .phoneReplyAllBold: return "\u{f67c}"
        case .phoneReplyAllLight: return "\u{f67d}"
        case .phoneReplyAllRegular: return "\u{f67e}"
        case .phoneReplyBold: return "\u{f67f}"
        case .phoneReplyLight: return "\u{f680}"
        case .phoneReplyRegular: return "\u{f681}"
        case .phoneSmallFilled: return "\u{f682}"
        case .pickerBold: return "\u{f683}"
        case .pickerLight: return "\u{f684}"
        case .pickerRegular: return "\u{f685}"
        case .pictureInPictureBold: return "\u{f686}"
        case .pictureInPictureLight: return "\u{f687}"
        case .pictureInPictureRegular: return "\u{f688}"
        case .pieChartBold: return "\u{f689}"
        case .pieChartFilled: return "\u{f68a}"
        case .pieChartLight: return "\u{f68b}"
        case .pieChartRegular: return "\u{f68c}"
        case .pinBold: return "\u{f68d}"
        case .pinFilled: return "\u{f68e}"
        case .pinLight: return "\u{f68f}"
        case .pinListActivityColoredBold: return "\u{f690}"
        case .pinListActivityColoredLight: return "\u{f691}"
        case .pinListActivityColoredRegular: return "\u{f692}"
        case .pinListBold: return "\u{f693}"
        case .pinListLight: return "\u{f694}"
        case .pinListRegular: return "\u{f695}"
        case .pinMutedBold: return "\u{f696}"
        case .pinMutedLight: return "\u{f697}"
        case .pinMutedRegular: return "\u{f698}"
        case .pinRegular: return "\u{f699}"
        case .placeholderBold: return "\u{f69a}"
        case .placeholderLight: return "\u{f69b}"
        case .placeholderRegular: return "\u{f69c}"
        case .playBold: return "\u{f69d}"
        case .playFilled: return "\u{f69e}"
        case .playLight: return "\u{f69f}"
        case .playRegular: return "\u{f6a0}"
        case .plugAcBold: return "\u{f6a1}"
        case .plugAcLight: return "\u{f6a2}"
        case .plugAcRegular: return "\u{f6a3}"
        case .plusBold: return "\u{f6a4}"
        case .plusCircleBold: return "\u{f6a5}"
        case .plusCircleFilled: return "\u{f6a6}"
        case .plusCircleLight: return "\u{f6a7}"
        case .plusCircleRegular: return "\u{f6a8}"
        case .plusLight: return "\u{f6a9}"
        case .plusRegular: return "\u{f6aa}"
        case .pmrBold: return "\u{f6ab}"
        case .pmrFilled: return "\u{f6ac}"
        case .pmrLight: return "\u{f6ad}"
        case .pmrRegular: return "\u{f6ae}"
        case .pollBold: return "\u{f6af}"
        case .pollLight: return "\u{f6b0}"
        case .pollRegular: return "\u{f6b1}"
        case .popInBold: return "\u{f6b2}"
        case .popInLight: return "\u{f6b3}"
        case .popInRegular: return "\u{f6b4}"
        case .popOutBold: return "\u{f6b5}"
        case .popOutLight: return "\u{f6b6}"
        case .popOutRegular: return "\u{f6b7}"
        case .popUpBold: return "\u{f6b8}"
        case .popUpLight: return "\u{f6b9}"
        case .popUpRegular: return "\u{f6ba}"
        case .portraitLandscapeBold: return "\u{f6bb}"
        case .portraitLandscapeLight: return "\u{f6bc}"
        case .portraitLandscapeRegular: return "\u{f6bd}"
        case .powerAcBold: return "\u{f6be}"
        case .powerAcLight: return "\u{f6bf}"
        case .powerAcRegular: return "\u{f6c0}"
        case .powerBold: return "\u{f6c1}"
        case .powerLight: return "\u{f6c2}"
        case .powerRegular: return "\u{f6c3}"
        case .presentationBold: return "\u{f6c4}"
        case .presentationLight: return "\u{f6c5}"
        case .presentationRegular: return "\u{f6c6}"
        case .printBold: return "\u{f6c7}"
        case .printLight: return "\u{f6c8}"
        case .printRegular: return "\u{f6c9}"
        case .priorityBadgeFilled: return "\u{f6ca}"
        case .priorityCircleBold: return "\u{f6cb}"
        case .priorityCircleFilled: return "\u{f6cc}"
        case .priorityCircleLight: return "\u{f6cd}"
        case .priorityCircleRegular: return "\u{f6ce}"
        case .priorityCircleTwoBold: return "\u{f6cf}"
        case .priorityCircleTwoFilled: return "\u{f6d0}"
        case .priorityCircleTwoLight: return "\u{f6d1}"
        case .priorityCircleTwoRegular: return "\u{f6d2}"
        case .privacyCircleBold: return "\u{f6d3}"
        case .privacyCircleFilled: return "\u{f6d4}"
        case .privacyCircleLight: return "\u{f6d5}"
        case .privacyCircleRegular: return "\u{f6d6}"
        case .privateBold: return "\u{f6d7}"
        case .privateCircleBold: return "\u{f6d8}"
        case .privateCircleFilled: return "\u{f6d9}"
        case .privateCircleLight: return "\u{f6da}"
        case .privateCircleRegular: return "\u{f6db}"
        case .privateLight: return "\u{f6dc}"
        case .privateMeetingBold: return "\u{f6dd}"
        case .privateMeetingLight: return "\u{f6de}"
        case .privateMeetingRegular: return "\u{f6df}"
        case .privateRegular: return "\u{f6e0}"
        case .productDemoBold: return "\u{f6e1}"
        case .productDemoLight: return "\u{f6e2}"
        case .productDemoRegular: return "\u{f6e3}"
        case .proximityBold: return "\u{f6e4}"
        case .proximityLight: return "\u{f6e5}"
        case .proximityMutedBold: return "\u{f6e6}"
        case .proximityMutedLight: return "\u{f6e7}"
        case .proximityMutedRegular: return "\u{f6e8}"
        case .proximityRegular: return "\u{f6e9}"
        case .proximityVideoBold: return "\u{f6ea}"
        case .proximityVideoLight: return "\u{f6eb}"
        case .proximityVideoRegular: return "\u{f6ec}"
        case .ptoPresenceBold: return "\u{f6ed}"
        case .ptoPresenceFilled: return "\u{f6ee}"
        case .ptoPresenceLight: return "\u{f6ef}"
        case .ptoPresenceRegular: return "\u{f6f0}"
        case .pullCallBold: return "\u{f6f1}"
        case .pullCallLight: return "\u{f6f2}"
        case .pullCallRegular: return "\u{f6f3}"
        case .qABold: return "\u{f6f4}"
        case .qALight: return "\u{f6f5}"
        case .qARegular: return "\u{f6f6}"
        case .qualityBold: return "\u{f6f7}"
        case .qualityLight: return "\u{f6f8}"
        case .qualityRegular: return "\u{f6f9}"
        case .queueContactBold: return "\u{f6fa}"
        case .queueContactLight: return "\u{f6fb}"
        case .queueContactRegular: return "\u{f6fc}"
        case .quietBold: return "\u{f6fd}"
        case .quietHoursPresenceBold: return "\u{f6fe}"
        case .quietHoursPresenceFilled: return "\u{f6ff}"
        case .quietHoursPresenceLight: return "\u{f700}"
        case .quietHoursPresenceRegular: return "\u{f701}"
        case .quietLight: return "\u{f702}"
        case .quietRegular: return "\u{f703}"
        case .raiseHandBold: return "\u{f704}"
        case .raiseHandLight: return "\u{f705}"
        case .raiseHandRegular: return "\u{f706}"
        case .ramBold: return "\u{f707}"
        case .ramLight: return "\u{f708}"
        case .ramRegular: return "\u{f709}"
        case .reactionsBold: return "\u{f70a}"
        case .reactionsFilled: return "\u{f70b}"
        case .reactionsLight: return "\u{f70c}"
        case .reactionsRegular: return "\u{f70d}"
        case .reactivateBold: return "\u{f70e}"
        case .reactivateLight: return "\u{f70f}"
        case .reactivateRegular: return "\u{f710}"
        case .recentsBold: return "\u{f711}"
        case .recentsFilled: return "\u{f712}"
        case .recentsLight: return "\u{f713}"
        case .recentsPresenceBold: return "\u{f714}"
        case .recentsPresenceFilled: return "\u{f715}"
        case .recentsPresenceLight: return "\u{f716}"
        case .recentsPresenceRegular: return "\u{f717}"
        case .recentsPresenceSmallFilled: return "\u{f718}"
        case .recentsRegular: return "\u{f719}"
        case .recordBold: return "\u{f71a}"
        case .recordFilled: return "\u{f71b}"
        case .recordLight: return "\u{f71c}"
        case .recordPausedBold: return "\u{f71d}"
        case .recordPausedFilled: return "\u{f71e}"
        case .recordPausedLight: return "\u{f71f}"
        case .recordPausedRegular: return "\u{f720}"
        case .recordRegular: return "\u{f721}"
        case .recurringBold: return "\u{f722}"
        case .recurringLight: return "\u{f723}"
        case .recurringOffBold: return "\u{f724}"
        case .recurringOffLight: return "\u{f725}"
        case .recurringOffRegular: return "\u{f726}"
        case .recurringRegular: return "\u{f727}"
        case .redialBold: return "\u{f728}"
        case .redialLight: return "\u{f729}"
        case .redialRegular: return "\u{f72a}"
        case .redoBold: return "\u{f72b}"
        case .redoLight: return "\u{f72c}"
        case .redoRegular: return "\u{f72d}"
        case .refreshBold: return "\u{f72e}"
        case .refreshLight: return "\u{f72f}"
        case .refreshRegular: return "\u{f730}"
        case .remoteDesktopControlBold: return "\u{f731}"
        case .remoteDesktopControlFilled: return "\u{f732}"
        case .remoteDesktopControlLight: return "\u{f733}"
        case .remoteDesktopControlRegular: return "\u{f734}"
        case .removeBold: return "\u{f735}"
        case .removeFilled: return "\u{f736}"
        case .removeLight: return "\u{f737}"
        case .removeRegular: return "\u{f738}"
        case .replyBold: return "\u{f739}"
        case .replyFilled: return "\u{f73a}"
        case .replyLight: return "\u{f73b}"
        case .replyListBold: return "\u{f73c}"
        case .replyListLight: return "\u{f73d}"
        case .replyListRegular: return "\u{f73e}"
        case .replyRegular: return "\u{f73f}"
        case .resetBold: return "\u{f740}"
        case .resetLight: return "\u{f741}"
        case .resetRegular: return "\u{f742}"
        case .responsiveMobileBold: return "\u{f743}"
        case .responsiveMobileLight: return "\u{f744}"
        case .responsiveMobileRegular: return "\u{f745}"
        case .restartBold: return "\u{f746}"
        case .restartLight: return "\u{f747}"
        case .restartRegular: return "\u{f748}"
        case .returnBold: return "\u{f749}"
        case .returnLight: return "\u{f74a}"
        case .returnRegular: return "\u{f74b}"
        case .ringtoneBold: return "\u{f74c}"
        case .ringtoneLight: return "\u{f74d}"
        case .ringtoneRegular: return "\u{f74e}"
        case .roomCalendarBold: return "\u{f74f}"
        case .roomCalendarLight: return "\u{f750}"
        case .roomCalendarRegular: return "\u{f751}"
        case .roomLightsBold: return "\u{f752}"
        case .roomLightsFilled: return "\u{f753}"
        case .roomLightsLight: return "\u{f754}"
        case .roomLightsRegular: return "\u{f755}"
        case .rotateContentBold: return "\u{f756}"
        case .rotateContentFilled: return "\u{f757}"
        case .rotateContentLight: return "\u{f758}"
        case .rotateContentRegular: return "\u{f759}"
        case .runningApplicationBold: return "\u{f75a}"
        case .runningApplicationFilled: return "\u{f75b}"
        case .runningApplicationLight: return "\u{f75c}"
        case .runningApplicationRegular: return "\u{f75d}"
        case .saveBold: return "\u{f75e}"
        case .saveLight: return "\u{f75f}"
        case .saveRegular: return "\u{f760}"
        case .scanBold: return "\u{f761}"
        case .scanLight: return "\u{f762}"
        case .scanRegular: return "\u{f763}"
        case .schedulerAvailableBold: return "\u{f764}"
        case .schedulerAvailableLight: return "\u{f765}"
        case .schedulerAvailableRegular: return "\u{f766}"
        case .schedulerNotWorkingHoursBold: return "\u{f767}"
        case .schedulerNotWorkingHoursLight: return "\u{f768}"
        case .schedulerNotWorkingHoursRegular: return "\u{f769}"
        case .schedulerUnavailableBold: return "\u{f76a}"
        case .schedulerUnavailableLight: return "\u{f76b}"
        case .schedulerUnavailableRegular: return "\u{f76c}"
        case .schedulerUnknownBold: return "\u{f76d}"
        case .schedulerUnknownLight: return "\u{f76e}"
        case .schedulerUnknownRegular: return "\u{f76f}"
        case .screenshotBold: return "\u{f770}"
        case .screenshotDocBold: return "\u{f771}"
        case .screenshotDocFilled: return "\u{f772}"
        case .screenshotDocLight: return "\u{f773}"
        case .screenshotDocRegular: return "\u{f774}"
        case .screenshotLight: return "\u{f775}"
        case .screenshotRegular: return "\u{f776}"
        case .searchBold: return "\u{f777}"
        case .searchFilled: return "\u{f778}"
        case .searchLight: return "\u{f779}"
        case .searchRegular: return "\u{f77a}"
        case .secondaryArrowBold: return "\u{f77b}"
        case .secondaryArrowLight: return "\u{f77c}"
        case .secondaryArrowRegular: return "\u{f77d}"
        case .secureCallLockBold: return "\u{f77e}"
        case .secureCallLockFilled: return "\u{f77f}"
        case .secureCallLockLight: return "\u{f780}"
        case .secureCallLockRegular: return "\u{f781}"
        case .secureCallShieldBold: return "\u{f782}"
        case .secureCallShieldFilled: return "\u{f783}"
        case .secureCallShieldLight: return "\u{f784}"
        case .secureCallShieldRegular: return "\u{f785}"
        case .secureCircleBold: return "\u{f786}"
        case .secureCircleFilled: return "\u{f787}"
        case .secureCircleLight: return "\u{f788}"
        case .secureCircleRegular: return "\u{f789}"
        case .secureLockBold: return "\u{f78a}"
        case .secureLockFilled: return "\u{f78b}"
        case .secureLockLight: return "\u{f78c}"
        case .secureLockRegular: return "\u{f78d}"
        case .selectAllBold: return "\u{f78e}"
        case .selectAllFilled: return "\u{f78f}"
        case .selectAllLight: return "\u{f790}"
        case .selectAllRegular: return "\u{f791}"
        case .selectionBold: return "\u{f792}"
        case .selectionLight: return "\u{f793}"
        case .selectionRegular: return "\u{f794}"
        case .sendBold: return "\u{f795}"
        case .sendFilled: return "\u{f796}"
        case .sendLight: return "\u{f797}"
        case .sendRegular: return "\u{f798}"
        case .serverBold: return "\u{f799}"
        case .serverErrorBold: return "\u{f79a}"
        case .serverErrorLight: return "\u{f79b}"
        case .serverErrorRegular: return "\u{f79c}"
        case .serverLight: return "\u{f79d}"
        case .serverRegular: return "\u{f79e}"
        case .servicesBold: return "\u{f79f}"
        case .servicesLight: return "\u{f7a0}"
        case .servicesRegular: return "\u{f7a1}"
        case .setVariableBold: return "\u{f7a2}"
        case .setVariableLight: return "\u{f7a3}"
        case .setVariableRegular: return "\u{f7a4}"
        case .settingsBold: return "\u{f7a5}"
        case .settingsFilled: return "\u{f7a6}"
        case .settingsLight: return "\u{f7a7}"
        case .settingsRegular: return "\u{f7a8}"
        case .setupAssistantBold: return "\u{f7a9}"
        case .setupAssistantLight: return "\u{f7aa}"
        case .setupAssistantRegular: return "\u{f7ab}"
        case .shapeDiagonalLineBold: return "\u{f7ac}"
        case .shapeDiagonalLineLight: return "\u{f7ad}"
        case .shapeDiagonalLineRegular: return "\u{f7ae}"
        case .shapeOvalBold: return "\u{f7af}"
        case .shapeOvalLight: return "\u{f7b0}"
        case .shapeOvalRegular: return "\u{f7b1}"
        case .shapesBold: return "\u{f7b2}"
        case .shapesLight: return "\u{f7b3}"
        case .shapesRegular: return "\u{f7b4}"
        case .shareCNativeAdrBold: return "\u{f7b5}"
        case .shareCNativeAdrLight: return "\u{f7b6}"
        case .shareCNativeAdrRegular: return "\u{f7b7}"
        case .shareCNativeIphBold: return "\u{f7b8}"
        case .shareCNativeIphLight: return "\u{f7b9}"
        case .shareCNativeIphRegular: return "\u{f7ba}"
        case .shareScreenBold: return "\u{f7bb}"
        case .shareScreenFilled: return "\u{f7bc}"
        case .shareScreenLight: return "\u{f7bd}"
        case .shareScreenRegular: return "\u{f7be}"
        case .shareScreenSmallFilled: return "\u{f7bf}"
        case .shareSpaceBold: return "\u{f7c0}"
        case .shareSpaceLight: return "\u{f7c1}"
        case .shareSpaceRegular: return "\u{f7c2}"
        case .shieldBold: return "\u{f7c3}"
        case .shieldLight: return "\u{f7c4}"
        case .shieldRegular: return "\u{f7c5}"
        case .showBold: return "\u{f7c6}"
        case .showFilled: return "\u{f7c7}"
        case .showLight: return "\u{f7c8}"
        case .showRegular: return "\u{f7c9}"
        case .signInBold: return "\u{f7ca}"
        case .signInForcedBold: return "\u{f7cb}"
        case .signInForcedLight: return "\u{f7cc}"
        case .signInForcedRegular: return "\u{f7cd}"
        case .signInLight: return "\u{f7ce}"
        case .signInRegular: return "\u{f7cf}"
        case .signOutBold: return "\u{f7d0}"
        case .signOutLight: return "\u{f7d1}"
        case .signOutRegular: return "\u{f7d2}"
        case .signal0Bold: return "\u{f7d3}"
        case .signal0Light: return "\u{f7d4}"
        case .signal0Regular: return "\u{f7d5}"
        case .signal100Bold: return "\u{f7d6}"
        case .signal100Light: return "\u{f7d7}"
        case .signal100Regular: return "\u{f7d8}"
        case .signal25Bold: return "\u{f7d9}"
        case .signal25Light: return "\u{f7da}"
        case .signal25Regular: return "\u{f7db}"
        case .signal50Bold: return "\u{f7dc}"
        case .signal50Light: return "\u{f7dd}"
        case .signal50Regular: return "\u{f7de}"
        case .signal75Bold: return "\u{f7df}"
        case .signal75Light: return "\u{f7e0}"
        case .signal75Regular: return "\u{f7e1}"
        case .singleNumberReachBold: return "\u{f7e2}"
        case .singleNumberReachLight: return "\u{f7e3}"
        case .singleNumberReachRegular: return "\u{f7e4}"
        case .sipRegistrationInProgressBold: return "\u{f7e5}"
        case .sipRegistrationInProgressFilled: return "\u{f7e6}"
        case .sipRegistrationInProgressLight: return "\u{f7e7}"
        case .sipRegistrationInProgressRegular: return "\u{f7e8}"
        case .skipBold: return "\u{f7e9}"
        case .skipBwBold: return "\u{f7ea}"
        case .skipBwFilled: return "\u{f7eb}"
        case .skipBwLight: return "\u{f7ec}"
        case .skipBwRegular: return "\u{f7ed}"
        case .skipFwBold: return "\u{f7ee}"
        case .skipFwFilled: return "\u{f7ef}"
        case .skipFwLight: return "\u{f7f0}"
        case .skipFwRegular: return "\u{f7f1}"
        case .skipLight: return "\u{f7f2}"
        case .skipRegular: return "\u{f7f3}"
        case .speakerBold: return "\u{f7f4}"
        case .speakerDisconnectedBold: return "\u{f7f5}"
        case .speakerDisconnectedFilled: return "\u{f7f6}"
        case .speakerDisconnectedLight: return "\u{f7f7}"
        case .speakerDisconnectedRegular: return "\u{f7f8}"
        case .speakerFilled: return "\u{f7f9}"
        case .speakerLight: return "\u{f7fa}"
        case .speakerMutedBold: return "\u{f7fb}"
        case .speakerMutedFilled: return "\u{f7fc}"
        case .speakerMutedLight: return "\u{f7fd}"
        case .speakerMutedRegular: return "\u{f7fe}"
        case .speakerOffBold: return "\u{f7ff}"
        case .speakerOffFilled: return "\u{f800}"
        case .speakerOffLight: return "\u{f801}"
        case .speakerOffRegular: return "\u{f802}"
        case .speakerOnColoredBold: return "\u{f803}"
        case .speakerOnColoredLight: return "\u{f804}"
        case .speakerOnColoredRegular: return "\u{f805}"
        case .speakerRegular: return "\u{f806}"
        case .speakerTurnDownBold: return "\u{f807}"
        case .speakerTurnDownFilled: return "\u{f808}"
        case .speakerTurnDownLight: return "\u{f809}"
        case .speakerTurnDownRegular: return "\u{f80a}"
        case .speakerTurnUpBold: return "\u{f80b}"
        case .speakerTurnUpFilled: return "\u{f80c}"
        case .speakerTurnUpLight: return "\u{f80d}"
        case .speakerTurnUpRegular: return "\u{f80e}"
        case .spinnerBold: return "\u{f80f}"
        case .spinnerFilledBold: return "\u{f810}"
        case .spinnerFilledLight: return "\u{f811}"
        case .spinnerFilledRegular: return "\u{f812}"
        case .spinnerLight: return "\u{f813}"
        case .spinnerRegular: return "\u{f814}"
        case .stackedArea100ChartBold: return "\u{f815}"
        case .stackedArea100ChartFilled: return "\u{f816}"
        case .stackedArea100ChartLight: return "\u{f817}"
        case .stackedArea100ChartRegular: return "\u{f818}"
        case .stackedAreaChartBold: return "\u{f819}"
        case .stackedAreaChartFilled: return "\u{f81a}"
        case .stackedAreaChartLight: return "\u{f81b}"
        case .stackedAreaChartRegular: return "\u{f81c}"
        case .stackedBar100ChartBold: return "\u{f81d}"
        case .stackedBar100ChartFilled: return "\u{f81e}"
        case .stackedBar100ChartLight: return "\u{f81f}"
        case .stackedBar100ChartRegular: return "\u{f820}"
        case .stackedBarChartBold: return "\u{f821}"
        case .stackedBarChartFilled: return "\u{f822}"
        case .stackedBarChartLight: return "\u{f823}"
        case .stackedBarChartRegular: return "\u{f824}"
        case .startChatBold: return "\u{f825}"
        case .startChatLight: return "\u{f826}"
        case .startChatRegular: return "\u{f827}"
        case .stickersBold: return "\u{f828}"
        case .stickersLight: return "\u{f829}"
        case .stickersRegular: return "\u{f82a}"
        case .stickiesBold: return "\u{f82b}"
        case .stickiesLight: return "\u{f82c}"
        case .stickiesRegular: return "\u{f82d}"
        case .stopBold: return "\u{f82e}"
        case .stopCircleBold: return "\u{f82f}"
        case .stopCircleFilled: return "\u{f830}"
        case .stopCircleLight: return "\u{f831}"
        case .stopCircleRegular: return "\u{f832}"
        case .stopContentShareBold: return "\u{f833}"
        case .stopContentShareLight: return "\u{f834}"
        case .stopContentShareRegular: return "\u{f835}"
        case .stopFilled: return "\u{f836}"
        case .stopLight: return "\u{f837}"
        case .stopRegular: return "\u{f838}"
        case .storedInfoBold: return "\u{f839}"
        case .storedInfoFilled: return "\u{f83a}"
        case .storedInfoLight: return "\u{f83b}"
        case .storedInfoRegular: return "\u{f83c}"
        case .streamingBold: return "\u{f83d}"
        case .streamingLight: return "\u{f83e}"
        case .streamingRegular: return "\u{f83f}"
        case .strikethroughBold: return "\u{f840}"
        case .strikethroughLight: return "\u{f841}"
        case .strikethroughRegular: return "\u{f842}"
        case .subscriptBold: return "\u{f843}"
        case .subscriptLight: return "\u{f844}"
        case .subscriptRegular: return "\u{f845}"
        case .superscriptBold: return "\u{f846}"
        case .superscriptLight: return "\u{f847}"
        case .superscriptRegular: return "\u{f848}"
        case .sx10Bold: return "\u{f849}"
        case .sx10Light: return "\u{f84a}"
        case .sx10Regular: return "\u{f84b}"
        case .sx20Bold: return "\u{f84c}"
        case .sx20Light: return "\u{f84d}"
        case .sx20Regular: return "\u{f84e}"
        case .sx80CodecBold: return "\u{f84f}"
        case .sx80CodecLight: return "\u{f850}"
        case .sx80CodecRegular: return "\u{f851}"
        case .tableBold: return "\u{f852}"
        case .tableLight: return "\u{f853}"
        case .tableRegular: return "\u{f854}"
        case .tabletBold: return "\u{f855}"
        case .tabletLight: return "\u{f856}"
        case .tabletRegular: return "\u{f857}"
        case .tabsBold: return "\u{f858}"
        case .tabsLight: return "\u{f859}"
        case .tabsRegular: return "\u{f85a}"
        case .tagBold: return "\u{f85b}"
        case .tagLight: return "\u{f85c}"
        case .tagRegular: return "\u{f85d}"
        case .telepresenceAlertBold: return "\u{f85e}"
        case .telepresenceAlertLight: return "\u{f85f}"
        case .telepresenceAlertMutedBold: return "\u{f860}"
        case .telepresenceAlertMutedLight: return "\u{f861}"
        case .telepresenceAlertMutedRegular: return "\u{f862}"
        case .telepresenceAlertRegular: return "\u{f863}"
        case .telepresenceBold: return "\u{f864}"
        case .telepresenceIx5000Bold: return "\u{f865}"
        case .telepresenceIx5000Light: return "\u{f866}"
        case .telepresenceIx5000Regular: return "\u{f867}"
        case .telepresenceLight: return "\u{f868}"
        case .telepresencePrivateBold: return "\u{f869}"
        case .telepresencePrivateLight: return "\u{f86a}"
        case .telepresencePrivateRegular: return "\u{f86b}"
        case .telepresenceRegular: return "\u{f86c}"
        case .temperatureBold: return "\u{f86d}"
        case .temperatureLight: return "\u{f86e}"
        case .temperatureRegular: return "\u{f86f}"
        case .textBold: return "\u{f870}"
        case .textCodeBlockBold: return "\u{f871}"
        case .textCodeBlockLight: return "\u{f872}"
        case .textCodeBlockRegular: return "\u{f873}"
        case .textHighlightBold: return "\u{f874}"
        case .textHighlightLight: return "\u{f875}"
        case .textHighlightRegular: return "\u{f876}"
        case .textLight: return "\u{f877}"
        case .textRegular: return "\u{f878}"
        case .threeDObjectBold: return "\u{f879}"
        case .threeDObjectLight: return "\u{f87a}"
        case .threeDObjectRegular: return "\u{f87b}"
        case .tooFastBold: return "\u{f87c}"
        case .tooFastLight: return "\u{f87d}"
        case .tooFastRegular: return "\u{f87e}"
        case .tooSlowBold: return "\u{f87f}"
        case .tooSlowLight: return "\u{f880}"
        case .tooSlowRegular: return "\u{f881}"
        case .toolsBold: return "\u{f882}"
        case .toolsLight: return "\u{f883}"
        case .toolsRegular: return "\u{f884}"
        case .touch10Bold: return "\u{f885}"
        case .touch10Light: return "\u{f886}"
        case .touch10Regular: return "\u{f887}"
        case .transcriptBold: return "\u{f888}"
        case .transcriptFilled: return "\u{f889}"
        case .transcriptLight: return "\u{f88a}"
        case .transcriptRegular: return "\u{f88b}"
        case .trimBold: return "\u{f88c}"
        case .trimLight: return "\u{f88d}"
        case .trimRegular: return "\u{f88e}"
        case .ucmCloudBold: return "\u{f88f}"
        case .ucmCloudLight: return "\u{f890}"
        case .ucmCloudRegular: return "\u{f891}"
        case .underlineBold: return "\u{f892}"
        case .underlineLight: return "\u{f893}"
        case .underlineRegular: return "\u{f894}"
        case .undoBold: return "\u{f895}"
        case .undoLight: return "\u{f896}"
        case .undoRegular: return "\u{f897}"
        case .unlinkBold: return "\u{f898}"
        case .unlinkLight: return "\u{f899}"
        case .unlinkRegular: return "\u{f89a}"
        case .unreadBold: return "\u{f89b}"
        case .unreadFilled: return "\u{f89c}"
        case .unreadLight: return "\u{f89d}"
        case .unreadRegular: return "\u{f89e}"
        case .unsecureUnlockedBold: return "\u{f89f}"
        case .unsecureUnlockedFilled: return "\u{f8a0}"
        case .unsecureUnlockedLight: return "\u{f8a1}"
        case .unsecureUnlockedRegular: return "\u{f8a2}"
        case .unsortedBold: return "\u{f8a3}"
        case .unsortedLight: return "\u{f8a4}"
        case .unsortedRegular: return "\u{f8a5}"
        case .updateFileShareBold: return "\u{f8a6}"
        case .updateFileShareLight: return "\u{f8a7}"
        case .updateFileShareRegular: return "\u{f8a8}"
        case .upgradeBold: return "\u{f8a9}"
        case .upgradeFilled: return "\u{f8aa}"
        case .upgradeLight: return "\u{f8ab}"
        case .upgradeRegular: return "\u{f8ac}"
        case .uploadBold: return "\u{f8ad}"
        case .uploadLight: return "\u{f8ae}"
        case .uploadRegular: return "\u{f8af}"
        case .usbBold: return "\u{f8b0}"
        case .usbHeadsetBold: return "\u{f8b1}"
        case .usbHeadsetLight: return "\u{f8b2}"
        case .usbHeadsetMutedBold: return "\u{f8b3}"
        case .usbHeadsetMutedLight: return "\u{f8b4}"
        case .usbHeadsetMutedRegular: return "\u{f8b5}"
        case .usbHeadsetRegular: return "\u{f8b6}"
        case .usbLight: return "\u{f8b7}"
        case .usbRegular: return "\u{f8b8}"
        case .userBold: return "\u{f8b9}"
        case .userLight: return "\u{f8ba}"
        case .userRegular: return "\u{f8bb}"
        case .vcsBold: return "\u{f8bc}"
        case .vcsLight: return "\u{f8bd}"
        case .vcsRegular: return "\u{f8be}"
        case .videoBlurBold: return "\u{f8bf}"
        case .videoBlurFilled: return "\u{f8c0}"
        case .videoBlurLight: return "\u{f8c1}"
        case .videoBlurRegular: return "\u{f8c2}"
        case .videoBold: return "\u{f8c3}"
        case .videoEffectBold: return "\u{f8c4}"
        case .videoEffectFilled: return "\u{f8c5}"
        case .videoEffectLight: return "\u{f8c6}"
        case .videoEffectRegular: return "\u{f8c7}"
        case .videoFilled: return "\u{f8c8}"
        case .videoLayoutBold: return "\u{f8c9}"
        case .videoLayoutEqualBold: return "\u{f8ca}"
        case .videoLayoutEqualDualBold: return "\u{f8cb}"
        case .videoLayoutEqualDualLight: return "\u{f8cc}"
        case .videoLayoutEqualDualRegular: return "\u{f8cd}"
        case .videoLayoutEqualFilled: return "\u{f8ce}"
        case .videoLayoutEqualLight: return "\u{f8cf}"
        case .videoLayoutEqualRegular: return "\u{f8d0}"
        case .videoLayoutFilled: return "\u{f8d1}"
        case .videoLayoutLight: return "\u{f8d2}"
        case .videoLayoutOverlayBold: return "\u{f8d3}"
        case .videoLayoutOverlayLight: return "\u{f8d4}"
        case .videoLayoutOverlayRegular: return "\u{f8d5}"
        case .videoLayoutPresenterDominantBold: return "\u{f8d6}"
        case .videoLayoutPresenterDominantLight: return "\u{f8d7}"
        case .videoLayoutPresenterDominantRegular: return "\u{f8d8}"
        case .videoLayoutProminentBold: return "\u{f8d9}"
        case .videoLayoutProminentFilled: return "\u{f8da}"
        case .videoLayoutProminentLight: return "\u{f8db}"
        case .videoLayoutProminentRegular: return "\u{f8dc}"
        case .videoLayoutRegular: return "\u{f8dd}"
        case .videoLayoutShareDominantBold: return "\u{f8de}"
        case .videoLayoutShareDominantLight: return "\u{f8df}"
        case .videoLayoutShareDominantRegular: return "\u{f8e0}"
        case .videoLayoutSingleBold: return "\u{f8e1}"
        case .videoLayoutSingleFilled: return "\u{f8e2}"
        case .videoLayoutSingleLight: return "\u{f8e3}"
        case .videoLayoutSingleRegular: return "\u{f8e4}"
        case .videoLayoutStackBold: return "\u{f8e5}"
        case .videoLayoutStackFilled: return "\u{f8e6}"
        case .videoLayoutStackLight: return "\u{f8e7}"
        case .videoLayoutStackRegular: return "\u{f8e8}"
        case .videoLayoutVideoDominantBold: return "\u{f8e9}"
        case .videoLayoutVideoDominantLight: return "\u{f8ea}"
        case .videoLayoutVideoDominantRegular: return "\u{f8eb}"
        case .videoLight: return "\u{f8ec}"
        case .videoPlusBold: return "\u{f8ed}"
        case .videoPlusFilled: return "\u{f8ee}"
        case .videoPlusLight: return "\u{f8ef}"
        case .videoPlusRegular: return "\u{f8f0}"
        case .videoRegular: return "\u{f8f1}"
        case .videoSpeakerTrackBold: return "\u{f8f2}"
        case .videoSpeakerTrackFilled: return "\u{f8f3}"
        case .videoSpeakerTrackLight: return "\u{f8f4}"
        case .videoSpeakerTrackRegular: return "\u{f8f5}"
        case .viewAllBold: return "\u{f8f6}"
        case .viewAllLight: return "\u{f8f7}"
        case .viewAllRegular: return "\u{f8f8}"
        case .viewListBold: return "\u{f8f9}"
        case .viewListLight: return "\u{f8fa}"
        case .viewListRegular: return "\u{f8fb}"
        case .viewStackedBold: return "\u{f8fc}"
        case .viewStackedLight: return "\u{f8fd}"
        case .viewStackedRegular: return "\u{f8fe}"
        case .viewThumbnailBold: return "\u{f8ff}"
        case .viewThumbnailFilled: return "\u{f900}"
        case .viewThumbnailLight: return "\u{f901}"
        case .viewThumbnailRegular: return "\u{f902}"
        case .voicemailBold: return "\u{f903}"
        case .voicemailFilled: return "\u{f904}"
        case .voicemailLight: return "\u{f905}"
        case .voicemailRegular: return "\u{f906}"
        case .wallpaperBold: return "\u{f907}"
        case .wallpaperLight: return "\u{f908}"
        case .wallpaperRegular: return "\u{f909}"
        case .warningBadgeFilled: return "\u{f90a}"
        case .warningBold: return "\u{f90b}"
        case .warningFilled: return "\u{f90c}"
        case .warningLight: return "\u{f90d}"
        case .warningRegular: return "\u{f90e}"
        case .webexAssistantActiveColored: return "\u{f90f}"
        case .webexAssistantInactiveColored: return "\u{f910}"
        case .webexBoardBold: return "\u{f911}"
        case .webexBoardLight: return "\u{f912}"
        case .webexBoardRegular: return "\u{f913}"
        case .webexCodecPlusBold: return "\u{f914}"
        case .webexCodecPlusLight: return "\u{f915}"
        case .webexCodecPlusRegular: return "\u{f916}"
        case .webexDeskCameraBold: return "\u{f917}"
        case .webexDeskCameraLight: return "\u{f918}"
        case .webexDeskCameraRegular: return "\u{f919}"
        case .webexHelixFilled: return "\u{f91a}"
        case .webexMeetingsBold: return "\u{f91b}"
        case .webexMeetingsFilled: return "\u{f91c}"
        case .webexMeetingsLight: return "\u{f91d}"
        case .webexMeetingsRegular: return "\u{f91e}"
        case .webexQuadCameraBold: return "\u{f91f}"
        case .webexQuadCameraLight: return "\u{f920}"
        case .webexQuadCameraRegular: return "\u{f921}"
        case .webexRoomKitBold: return "\u{f922}"
        case .webexRoomKitLight: return "\u{f923}"
        case .webexRoomKitPlusBold: return "\u{f924}"
        case .webexRoomKitPlusLight: return "\u{f925}"
        case .webexRoomKitPlusRegular: return "\u{f926}"
        case .webexRoomKitRegular: return "\u{f927}"
        case .webexShareBold: return "\u{f928}"
        case .webexShareLight: return "\u{f929}"
        case .webexShareRegular: return "\u{f92a}"
        case .webexTeamsBold: return "\u{f92b}"
        case .webexTeamsFilled: return "\u{f92c}"
        case .webexTeamsLight: return "\u{f92d}"
        case .webexTeamsNewBold: return "\u{f92e}"
        case .webexTeamsNewFilled: return "\u{f92f}"
        case .webexTeamsNewLight: return "\u{f930}"
        case .webexTeamsNewRegular: return "\u{f931}"
        case .webexTeamsRegular: return "\u{f932}"
        case .whiteboardBold: return "\u{f933}"
        case .whiteboardContentBold: return "\u{f934}"
        case .whiteboardContentLight: return "\u{f935}"
        case .whiteboardContentRegular: return "\u{f936}"
        case .whiteboardFilled: return "\u{f937}"
        case .whiteboardLight: return "\u{f938}"
        case .whiteboardRegular: return "\u{f939}"
        case .widgetBold: return "\u{f93a}"
        case .widgetFilled: return "\u{f93b}"
        case .widgetLight: return "\u{f93c}"
        case .widgetRegular: return "\u{f93d}"
        case .wifiBold: return "\u{f93e}"
        case .wifiErrorBold: return "\u{f93f}"
        case .wifiErrorLight: return "\u{f940}"
        case .wifiErrorRegular: return "\u{f941}"
        case .wifiLight: return "\u{f942}"
        case .wifiRegular: return "\u{f943}"
        case .wifiSignalGoodColoredBold: return "\u{f944}"
        case .wifiSignalGoodColoredLight: return "\u{f945}"
        case .wifiSignalGoodColoredRegular: return "\u{f946}"
        case .wifiSignalPoorColoredBold: return "\u{f947}"
        case .wifiSignalPoorColoredLight: return "\u{f948}"
        case .wifiSignalPoorColoredRegular: return "\u{f949}"
        case .wifiSignalUnstableColoredBold: return "\u{f94a}"
        case .wifiSignalUnstableColoredLight: return "\u{f94b}"
        case .wifiSignalUnstableColoredRegular: return "\u{f94c}"
        case .windowCornerScrubBold: return "\u{f94d}"
        case .windowCornerScrubLight: return "\u{f94e}"
        case .windowCornerScrubRegular: return "\u{f94f}"
        case .windowRightCornerScrubBold: return "\u{f950}"
        case .windowRightCornerScrubLight: return "\u{f951}"
        case .windowRightCornerScrubRegular: return "\u{f952}"
        case .windowVerticalScrubBold: return "\u{f953}"
        case .windowVerticalScrubLight: return "\u{f954}"
        case .windowVerticalScrubRegular: return "\u{f955}"
        case .workphoneBold: return "\u{f956}"
        case .workphoneLight: return "\u{f957}"
        case .workphoneRegular: return "\u{f958}"
        case .zoomInBold: return "\u{f959}"
        case .zoomInLight: return "\u{f95a}"
        case .zoomInRegular: return "\u{f95b}"
        case .zoomOutBold: return "\u{f95c}"
        case .zoomOutLight: return "\u{f95d}"
        case .zoomOutRegular: return "\u{f95e}"
