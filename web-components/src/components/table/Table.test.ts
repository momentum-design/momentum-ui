...
describe("Table component", () => {
  ...
  test("should render size", async () => {
    const element = await fixture<Table>(html`<md-table clean zebra sorting tableData="${data}"></md-table>`);
  ...
  test("should render size", async () => {
    const element = await fixture<Table>(html`<md-table sorting tableData="${data}"></md-table>`);
