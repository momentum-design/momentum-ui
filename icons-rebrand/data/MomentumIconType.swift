...
@objc public enum MomentumIconType: Int {
    ...
    public var ligature: String {
        ...
        case .participantListBold: return "\u{f5d8}"
        case .participantListFilled: return "\u{f5d9}"
        case .participantListLight: return "\u{f5da}"
        case .participantListRegular: return "\u{f5db}"
        case .participantRemoveBold: return "\u{f5dc}"
        case .participantRemoveLight: return "\u{f5dd}"
        case .participantRemoveRegular: return "\u{f5de}"
        case .participantUnknownBold: return "\u{f5df}"
        case .participantUnknownLight: return "\u{f5e0}"
        case .participantUnknownRegular: return "\u{f5e1}"
        case .passMouseBold: return "\u{f5e2}"
        case .passMouseLight: return "\u{f5e3}"
        case .passMouseRegular: return "\u{f5e4}"
        case .pauseBold: return "\u{f5e5}"
        case .pauseFilled: return "\u{f5e6}"
        case .pauseLight: return "\u{f5e7}"
        case .pauseRegular: return "\u{f5e8}"
        case .penBold: return "\u{f5e9}"
        case .penFilled: return "\u{f5ea}"
        case .penLight: return "\u{f5eb}"
        case .penRegular: return "\u{f5ec}"
        case .peopleBold: return "\u{f5ed}"
        case .peopleCircleBold: return "\u{f5ee}"
        case .peopleCircleLight: return "\u{f5ef}"
        case .peopleCircleRegular: return "\u{f5f0}"
        case .peopleFilled: return "\u{f5f1}"
        case .peopleLight: return "\u{f5f2}"
        case .peopleRegular: return "\u{f5f3}"
        case .phoneAlertBold: return "\u{f5f4}"
        case .phoneAlertLight: return "\u{f5f5}"
        case .phoneAlertRegular: return "\u{f5f6}"
        case .phoneBold: return "\u{f5f7}"
        case .phoneFilled: return "\u{f5f8}"
        case .phoneLight: return "\u{f5f9}"
        case .phoneMutedBold: return "\u{f5fa}"
        case .phoneMutedLight: return "\u{f5fb}"
        case .phoneMutedRegular: return "\u{f5fc}"
        case .phonePrivateBold: return "\u{f5fd}"
        case .phonePrivateLight: return "\u{f5fe}"
        case .phonePrivateRegular: return "\u{f5ff}"
        case .phoneRegular: return "\u{f600}"
        case .phoneReplyAllBold: return "\u{f601}"
        case .phoneReplyAllLight: return "\u{f602}"
        case .phoneReplyAllRegular: return "\u{f603}"
        case .phoneReplyBold: return "\u{f604}"
        case .phoneReplyLight: return "\u{f605}"
        case .phoneReplyRegular: return "\u{f606}"
        case .pickerBold: return "\u{f607}"
        case .pickerLight: return "\u{f608}"
        case .pickerRegular: return "\u{f609}"
        case .pictureInPictureBold: return "\u{f60a}"
        case .pictureInPictureLight: return "\u{f60b}"
        case .pictureInPictureRegular: return "\u{f60c}"
        case .pieChartBold: return "\u{f60d}"
        case .pieChartFilled: return "\u{f60e}"
        case .pieChartLight: return "\u{f60f}"
        case .pieChartRegular: return "\u{f610}"
        case .pinBold: return "\u{f611}"
        case .pinFilled: return "\u{f612}"
        case .pinLight: return "\u{f613}"
        case .pinListBold: return "\u{f614}"
        case .pinListLight: return "\u{f615}"
        case .pinListRegular: return "\u{f616}"
        case .pinMutedBold: return "\u{f617}"
        case .pinMutedLight: return "\u{f618}"
        case .pinMutedRegular: return "\u{f619}"
        case .pinRegular: return "\u{f61a}"
        case .placeholderBold: return "\u{f61b}"
        case .placeholderLight: return "\u{f61c}"
        case .placeholderRegular: return "\u{f61d}"
        case .playBold: return "\u{f61e}"
        case .playFilled: return "\u{f61f}"
        case .playLight: return "\u{f620}"
        case .playRegular: return "\u{f621}"
        case .plugAcBold: return "\u{f622}"
        case .plugAcLight: return "\u{f623}"
        case .plugAcRegular: return "\u{f624}"
        case .plusBold: return "\u{f625}"
        case .plusCircleBold: return "\u{f626}"
        case .plusCircleFilled: return "\u{f627}"
        case .plusCircleLight: return "\u{f628}"
        case .plusCircleRegular: return "\u{f629}"
        case .plusLight: return "\u{f62a}"
        case .plusRegular: return "\u{f62b}"
        case .pmrBold: return "\u{f62c}"
        case .pmrFilled: return "\u{f62d}"
        case .pmrLight: return "\u{f62e}"
        case .pmrRegular: return "\u{f62f}"
        case .pollBold: return "\u{f630}"
        case .pollLight: return "\u{f631}"
        case .pollRegular: return "\u{f632}"
        case .popInBold: return "\u{f633}"
        case .popInLight: return "\u{f634}"
        case .popInRegular: return "\u{f635}"
        case .popOutBold: return "\u{f636}"
        case .popOutLight: return "\u{f637}"
        case .popOutRegular: return "\u{f638}"
        case .popUpBold: return "\u{f639}"
        case .popUpLight: return "\u{f63a}"
        case .popUpRegular: return "\u{f63b}"
        case .powerAcBold: return "\u{f63c}"
        case .powerAcLight: return "\u{f63d}"
        case .powerAcRegular: return "\u{f63e}"
        case .powerBold: return "\u{f63f}"
        case .powerLight: return "\u{f640}"
        case .powerRegular: return "\u{f641}"
        case .presentationBold: return "\u{f642}"
        case .presentationLight: return "\u{f643}"
        case .presentationRegular: return "\u{f644}"
        case .printBold: return "\u{f645}"
        case .printLight: return "\u{f646}"
        case .printRegular: return "\u{f647}"
        case .priorityCircleBold: return "\u{f648}"
        case .priorityCircleFilled: return "\u{f649}"
        case .priorityCircleLight: return "\u{f64a}"
        case .priorityCircleRegular: return "\u{f64b}"
        case .privacyCircleBold: return "\u{f64c}"
        case .privacyCircleFilled: return "\u{f64d}"
        case .privacyCircleLight: return "\u{f64e}"
        case .privacyCircleRegular: return "\u{f64f}"
        case .privateBold: return "\u{f650}"
        case .privateCircleBold: return "\u{f651}"
        case .privateCircleFilled: return "\u{f652}"
        case .privateCircleLight: return "\u{f653}"
        case .privateCircleRegular: return "\u{f654}"
        case .privateLight: return "\u{f655}"
        case .privateMeetingBold: return "\u{f656}"
        case .privateMeetingLight: return "\u{f657}"
        case .privateMeetingRegular: return "\u{f658}"
        case .privateRegular: return "\u{f659}"
        case .productDemoBold: return "\u{f65a}"
        case .productDemoLight: return "\u{f65b}"
        case .productDemoRegular: return "\u{f65c}"
        case .proximityBold: return "\u{f65d}"
        case .proximityLight: return "\u{f65e}"
        case .proximityMutedBold: return "\u{f65f}"
        case .proximityMutedLight: return "\u{f660}"
        case .proximityMutedRegular: return "\u{f661}"
        case .proximityRegular: return "\u{f662}"
        case .proximityVideoBold: return "\u{f663}"
        case .proximityVideoLight: return "\u{f664}"
        case .proximityVideoRegular: return "\u{f665}"
        case .ptoPresenceBold: return "\u{f666}"
        case .ptoPresenceFilled: return "\u{f667}"
        case .ptoPresenceLight: return "\u{f668}"
        case .ptoPresenceRegular: return "\u{f669}"
        case .pullCallBold: return "\u{f66a}"
        case .pullCallLight: return "\u{f66b}"
        case .pullCallRegular: return "\u{f66c}"
        case .qABold: return "\u{f66d}"
        case .qALight: return "\u{f66e}"
        case .qARegular: return "\u{f66f}"
        case .qualityBold: return "\u{f670}"
        case .qualityLight: return "\u{f671}"
        case .qualityRegular: return "\u{f672}"
        case .queueContactBold: return "\u{f673}"
        case .queueContactLight: return "\u{f674}"
        case .queueContactRegular: return "\u{f675}"
        case .quietBold: return "\u{f676}"
        case .quietHoursPresenceBold: return "\u{f677}"
        case .quietHoursPresenceFilled: return "\u{f678}"
        case .quietHoursPresenceLight: return "\u{f679}"
        case .quietHoursPresenceRegular: return "\u{f67a}"
        case .quietLight: return "\u{f67b}"
        case .quietRegular: return "\u{f67c}"
        case .raiseHandBold: return "\u{f67d}"
        case .raiseHandLight: return "\u{f67e}"
        case .raiseHandRegular: return "\u{f67f}"
        case .ramBold: return "\u{f680}"
        case .ramLight: return "\u{f681}"
        case .ramRegular: return "\u{f682}"
        case .reactionsBold: return "\u{f683}"
        case .reactionsFilled: return "\u{f684}"
        case .reactionsLight: return "\u{f685}"
        case .reactionsRegular: return "\u{f686}"
        case .reactivateBold: return "\u{f687}"
        case .reactivateLight: return "\u{f688}"
        case .reactivateRegular: return "\u{f689}"
        case .recentsBold: return "\u{f68a}"
        case .recentsFilled: return "\u{f68b}"
        case .recentsLight: return "\u{f68c}"
        case .recentsPresenceBold: return "\u{f68d}"
        case .recentsPresenceFilled: return "\u{f68e}"
        case .recentsPresenceLight: return "\u{f68f}"
        case .recentsPresenceRegular: return "\u{f690}"
        case .recentsRegular: return "\u{f691}"
        case .recordBold: return "\u{f692}"
        case .recordFilled: return "\u{f693}"
        case .recordLight: return "\u{f694}"
        case .recordPausedBold: return "\u{f695}"
        case .recordPausedFilled: return "\u{f696}"
        case .recordPausedLight: return "\u{f697}"
        case .recordPausedRegular: return "\u{f698}"
        case .recordRegular: return "\u{f699}"
        case .recurringBold: return "\u{f69a}"
        case .recurringLight: return "\u{f69b}"
        case .recurringOffBold: return "\u{f69c}"
        case .recurringOffLight: return "\u{f69d}"
        case .recurringOffRegular: return "\u{f69e}"
        case .recurringRegular: return "\u{f69f}"
        case .redialBold: return "\u{f6a0}"
        case .redialLight: return "\u{f6a1}"
        case .redialRegular: return "\u{f6a2}"
        case .redoBold: return "\u{f6a3}"
        case .redoLight: return "\u{f6a4}"
        case .redoRegular: return "\u{f6a5}"
        case .refreshBold: return "\u{f6a6}"
        case .refreshLight: return "\u{f6a7}"
        case .refreshRegular: return "\u{f6a8}"
        case .remoteDesktopControlBold: return "\u{f6a9}"
        case .remoteDesktopControlLight: return "\u{f6aa}"
        case .remoteDesktopControlRegular: return "\u{f6ab}"
        case .removeBold: return "\u{f6ac}"
        case .removeFilled: return "\u{f6ad}"
        case .removeLight: return "\u{f6ae}"
        case .removeRegular: return "\u{f6af}"
        case .replyBold: return "\u{f6b0}"
        case .replyFilled: return "\u{f6b1}"
        case .replyLight: return "\u{f6b2}"
        case .replyListBold: return "\u{f6b3}"
        case .replyListLight: return "\u{f6b4}"
        case .replyListRegular: return "\u{f6b5}"
        case .replyRegular: return "\u{f6b6}"
        case .resetBold: return "\u{f6b7}"
        case .resetLight: return "\u{f6b8}"
        case .resetRegular: return "\u{f6b9}"
        case .responsiveMobileBold: return "\u{f6ba}"
        case .responsiveMobileLight: return "\u{f6bb}"
        case .responsiveMobileRegular: return "\u{f6bc}"
        case .restartBold: return "\u{f6bd}"
        case .restartLight: return "\u{f6be}"
        case .restartRegular: return "\u{f6bf}"
        case .returnBold: return "\u{f6c0}"
        case .returnLight: return "\u{f6c1}"
        case .returnRegular: return "\u{f6c2}"
        case .ringtoneBold: return "\u{f6c3}"
        case .ringtoneLight: return "\u{f6c4}"
        case .ringtoneRegular: return "\u{f6c5}"
        case .roomCalendarBold: return "\u{f6c6}"
        case .roomCalendarLight: return "\u{f6c7}"
        case .roomCalendarRegular: return "\u{f6c8}"
        case .roomLightsBold: return "\u{f6c9}"
        case .roomLightsLight: return "\u{f6ca}"
        case .roomLightsRegular: return "\u{f6cb}"
        case .runningApplicationBold: return "\u{f6cc}"
        case .runningApplicationFilled: return "\u{f6cd}"
        case .runningApplicationLight: return "\u{f6ce}"
        case .runningApplicationRegular: return "\u{f6cf}"
        case .saveBold: return "\u{f6d0}"
        case .saveLight: return "\u{f6d1}"
        case .saveRegular: return "\u{f6d2}"
        case .scanBold: return "\u{f6d3}"
        case .scanLight: return "\u{f6d4}"
        case .scanRegular: return "\u{f6d5}"
        case .schedulerAvailableBold: return "\u{f6d6}"
        case .schedulerAvailableLight: return "\u{f6d7}"
        case .schedulerAvailableRegular: return "\u{f6d8}"
        case .schedulerNotWorkingHoursBold: return "\u{f6d9}"
        case .schedulerNotWorkingHoursLight: return "\u{f6da}"
        case .schedulerNotWorkingHoursRegular: return "\u{f6db}"
        case .schedulerUnavailableBold: return "\u{f6dc}"
        case .schedulerUnavailableLight: return "\u{f6dd}"
        case .schedulerUnavailableRegular: return "\u{f6de}"
        case .schedulerUnknownBold: return "\u{f6df}"
        case .schedulerUnknownLight: return "\u{f6e0}"
        case .schedulerUnknownRegular: return "\u{f6e1}"
        case .screenshotBold: return "\u{f6e2}"
        case .screenshotDocBold: return "\u{f6e3}"
        case .screenshotDocFilled: return "\u{f6e4}"
        case .screenshotDocLight: return "\u{f6e5}"
        case .screenshotDocRegular: return "\u{f6e6}"
        case .screenshotLight: return "\u{f6e7}"
        case .screenshotRegular: return "\u{f6e8}"
        case .searchBold: return "\u{f6e9}"
        case .searchLight: return "\u{f6ea}"
        case .searchRegular: return "\u{f6eb}"
        case .secondaryArrowBold: return "\u{f6ec}"
        case .secondaryArrowLight: return "\u{f6ed}"
        case .secondaryArrowRegular: return "\u{f6ee}"
        case .secureCircleBold: return "\u{f6ef}"
        case .secureCircleFilled: return "\u{f6f0}"
        case .secureCircleLight: return "\u{f6f1}"
        case .secureCircleRegular: return "\u{f6f2}"
        case .secureLockBold: return "\u{f6f3}"
        case .secureLockFilled: return "\u{f6f4}"
        case .secureLockLight: return "\u{f6f5}"
        case .secureLockRegular: return "\u{f6f6}"
        case .selectionBold: return "\u{f6f7}"
        case .selectionLight: return "\u{f6f8}"
        case .selectionRegular: return "\u{f6f9}"
        case .sendBold: return "\u{f6fa}"
        case .sendFilled: return "\u{f6fb}"
        case .sendLight: return "\u{f6fc}"
        case .sendRegular: return "\u{f6fd}"
        case .serverBold: return "\u{f6fe}"
        case .serverErrorBold: return "\u{f6ff}"
        case .serverErrorLight: return "\u{f700}"
        case .serverErrorRegular: return "\u{f701}"
        case .serverLight: return "\u{f702}"
        case .serverRegular: return "\u{f703}"
        case .servicesBold: return "\u{f704}"
        case .servicesLight: return "\u{f705}"
        case .servicesRegular: return "\u{f706}"
        case .setVariableBold: return "\u{f707}"
        case .setVariableLight: return "\u{f708}"
        case .setVariableRegular: return "\u{f709}"
        case .settingsBold: return "\u{f70a}"
        case .settingsFilled: return "\u{f70b}"
        case .settingsLight: return "\u{f70c}"
        case .settingsRegular: return "\u{f70d}"
        case .setupAssistantBold: return "\u{f70e}"
        case .setupAssistantLight: return "\u{f70f}"
        case .setupAssistantRegular: return "\u{f710}"
        case .shapesBold: return "\u{f711}"
        case .shapesLight: return "\u{f712}"
        case .shapesRegular: return "\u{f713}"
        case .shareCNativeAdrBold: return "\u{f714}"
        case .shareCNativeAdrLight: return "\u{f715}"
        case .shareCNativeAdrRegular: return "\u{f716}"
        case .shareCNativeIphBold: return "\u{f717}"
        case .shareCNativeIphLight: return "\u{f718}"
        case .shareCNativeIphRegular: return "\u{f719}"
        case .shareScreenBold: return "\u{f71a}"
        case .shareScreenFilled: return "\u{f71b}"
        case .shareScreenLight: return "\u{f71c}"
        case .shareScreenRegular: return "\u{f71d}"
        case .shareSpaceBold: return "\u{f71e}"
        case .shareSpaceLight: return "\u{f71f}"
        case .shareSpaceRegular: return "\u{f720}"
        case .shieldBold: return "\u{f721}"
        case .shieldLight: return "\u{f722}"
        case .shieldRegular: return "\u{f723}"
        case .showBold: return "\u{f724}"
        case .showFilled: return "\u{f725}"
        case .showLight: return "\u{f726}"
        case .showRegular: return "\u{f727}"
        case .signInBold: return "\u{f728}"
        case .signInForcedBold: return "\u{f729}"
        case .signInForcedLight: return "\u{f72a}"
        case .signInForcedRegular: return "\u{f72b}"
        case .signInLight: return "\u{f72c}"
        case .signInRegular: return "\u{f72d}"
        case .signOutBold: return "\u{f72e}"
        case .signOutLight: return "\u{f72f}"
        case .signOutRegular: return "\u{f730}"
        case .signal0Bold: return "\u{f731}"
        case .signal0Light: return "\u{f732}"
        case .signal0Regular: return "\u{f733}"
        case .signal100Bold: return "\u{f734}"
        case .signal100Light: return "\u{f735}"
        case .signal100Regular: return "\u{f736}"
        case .signal25Bold: return "\u{f737}"
        case .signal25Light: return "\u{f738}"
        case .signal25Regular: return "\u{f739}"
        case .signal50Bold: return "\u{f73a}"
        case .signal50Light: return "\u{f73b}"
        case .signal50Regular: return "\u{f73c}"
        case .signal75Bold: return "\u{f73d}"
        case .signal75Light: return "\u{f73e}"
        case .signal75Regular: return "\u{f73f}"
        case .singleNumberReachBold: return "\u{f740}"
        case .singleNumberReachLight: return "\u{f741}"
        case .singleNumberReachRegular: return "\u{f742}"
        case .skipBold: return "\u{f743}"
        case .skipBwBold: return "\u{f744}"
        case .skipBwFilled: return "\u{f745}"
        case .skipBwLight: return "\u{f746}"
        case .skipBwRegular: return "\u{f747}"
        case .skipFwBold: return "\u{f748}"
        case .skipFwFilled: return "\u{f749}"
        case .skipFwLight: return "\u{f74a}"
        case .skipFwRegular: return "\u{f74b}"
        case .skipLight: return "\u{f74c}"
        case .skipRegular: return "\u{f74d}"
        case .speakerBold: return "\u{f74e}"
        case .speakerDisconnectedBold: return "\u{f74f}"
        case .speakerDisconnectedFilled: return "\u{f750}"
        case .speakerDisconnectedLight: return "\u{f751}"
        case .speakerDisconnectedRegular: return "\u{f752}"
        case .speakerFilled: return "\u{f753}"
        case .speakerLight: return "\u{f754}"
        case .speakerMutedBold: return "\u{f755}"
        case .speakerMutedFilled: return "\u{f756}"
        case .speakerMutedLight: return "\u{f757}"
        case .speakerMutedRegular: return "\u{f758}"
        case .speakerOffBold: return "\u{f759}"
        case .speakerOffFilled: return "\u{f75a}"
        case .speakerOffLight: return "\u{f75b}"
        case .speakerOffRegular: return "\u{f75c}"
        case .speakerRegular: return "\u{f75d}"
        case .speakerTurnDownBold: return "\u{f75e}"
        case .speakerTurnDownFilled: return "\u{f75f}"
        case .speakerTurnDownLight: return "\u{f760}"
        case .speakerTurnDownRegular: return "\u{f761}"
        case .speakerTurnUpBold: return "\u{f762}"
        case .speakerTurnUpFilled: return "\u{f763}"
        case .speakerTurnUpLight: return "\u{f764}"
        case .speakerTurnUpRegular: return "\u{f765}"
        case .spinnerBold: return "\u{f766}"
        case .spinnerFilledBold: return "\u{f767}"
        case .spinnerFilledLight: return "\u{f768}"
        case .spinnerFilledRegular: return "\u{f769}"
        case .spinnerLight: return "\u{f76a}"
        case .spinnerRegular: return "\u{f76b}"
        case .stackedArea100ChartBold: return "\u{f76c}"
        case .stackedArea100ChartFilled: return "\u{f76d}"
        case .stackedArea100ChartLight: return "\u{f76e}"
        case .stackedArea100ChartRegular: return "\u{f76f}"
        case .stackedAreaChartBold: return "\u{f770}"
        case .stackedAreaChartFilled: return "\u{f771}"
        case .stackedAreaChartLight: return "\u{f772}"
        case .stackedAreaChartRegular: return "\u{f773}"
        case .stackedBar100ChartBold: return "\u{f774}"
        case .stackedBar100ChartFilled: return "\u{f775}"
        case .stackedBar100ChartLight: return "\u{f776}"
        case .stackedBar100ChartRegular: return "\u{f777}"
        case .stackedBarChartBold: return "\u{f778}"
        case .stackedBarChartFilled: return "\u{f779}"
        case .stackedBarChartLight: return "\u{f77a}"
        case .stackedBarChartRegular: return "\u{f77b}"
        case .startChatBold: return "\u{f77c}"
        case .startChatLight: return "\u{f77d}"
        case .startChatRegular: return "\u{f77e}"
        case .stickersBold: return "\u{f77f}"
        case .stickersLight: return "\u{f780}"
        case .stickersRegular: return "\u{f781}"
        case .stickiesBold: return "\u{f782}"
        case .stickiesLight: return "\u{f783}"
        case .stickiesRegular: return "\u{f784}"
        case .stopBold: return "\u{f785}"
        case .stopCircleBold: return "\u{f786}"
        case .stopCircleFilled: return "\u{f787}"
        case .stopCircleLight: return "\u{f788}"
        case .stopCircleRegular: return "\u{f789}"
        case .stopContentShareBold: return "\u{f78a}"
        case .stopContentShareLight: return "\u{f78b}"
        case .stopContentShareRegular: return "\u{f78c}"
        case .stopFilled: return "\u{f78d}"
        case .stopLight: return "\u{f78e}"
        case .stopRegular: return "\u{f78f}"
        case .storedInfoBold: return "\u{f790}"
        case .storedInfoFilled: return "\u{f791}"
        case .storedInfoLight: return "\u{f792}"
        case .storedInfoRegular: return "\u{f793}"
        case .streamingBold: return "\u{f794}"
        case .streamingLight: return "\u{f795}"
        case .streamingRegular: return "\u{f796}"
        case .strikethroughBold: return "\u{f797}"
        case .strikethroughLight: return "\u{f798}"
        case .strikethroughRegular: return "\u{f799}"
        case .subscriptBold: return "\u{f79a}"
        case .subscriptLight: return "\u{f79b}"
        case .subscriptRegular: return "\u{f79c}"
        case .superscriptBold: return "\u{f79d}"
        case .superscriptLight: return "\u{f79e}"
        case .superscriptRegular: return "\u{f79f}"
        case .sx10Bold: return "\u{f7a0}"
        case .sx10Light: return "\u{f7a1}"
        case .sx10Regular: return "\u{f7a2}"
        case .sx20Bold: return "\u{f7a3}"
        case .sx20Light: return "\u{f7a4}"
        case .sx20Regular: return "\u{f7a5}"
        case .sx80CodecBold: return "\u{f7a6}"
        case .sx80CodecLight: return "\u{f7a7}"
        case .sx80CodecRegular: return "\u{f7a8}"
        case .tableBold: return "\u{f7a9}"
        case .tableLight: return "\u{f7aa}"
        case .tableRegular: return "\u{f7ab}"
        case .tabletBold: return "\u{f7ac}"
        case .tabletLight: return "\u{f7ad}"
        case .tabletRegular: return "\u{f7ae}"
        case .tabsBold: return "\u{f7af}"
        case .tabsLight: return "\u{f7b0}"
        case .tabsRegular: return "\u{f7b1}"
        case .tagBold: return "\u{f7b2}"
        case .tagLight: return "\u{f7b3}"
        case .tagRegular: return "\u{f7b4}"
        case .telepresenceAlertBold: return "\u{f7b5}"
        case .telepresenceAlertLight: return "\u{f7b6}"
        case .telepresenceAlertMutedBold: return "\u{f7b7}"
        case .telepresenceAlertMutedLight: return "\u{f7b8}"
        case .telepresenceAlertMutedRegular: return "\u{f7b9}"
        case .telepresenceAlertRegular: return "\u{f7ba}"
        case .telepresenceBold: return "\u{f7bb}"
        case .telepresenceIx5000Bold: return "\u{f7bc}"
        case .telepresenceIx5000Light: return "\u{f7bd}"
        case .telepresenceIx5000Regular: return "\u{f7be}"
        case .telepresenceLight: return "\u{f7bf}"
        case .telepresencePrivateBold: return "\u{f7c0}"
        case .telepresencePrivateLight: return "\u{f7c1}"
        case .telepresencePrivateRegular: return "\u{f7c2}"
        case .telepresenceRegular: return "\u{f7c3}"
        case .temperatureBold: return "\u{f7c4}"
        case .temperatureLight: return "\u{f7c5}"
        case .temperatureRegular: return "\u{f7c6}"
        case .textBold: return "\u{f7c7}"
        case .textCodeBlockBold: return "\u{f7c8}"
        case .textCodeBlockLight: return "\u{f7c9}"
        case .textCodeBlockRegular: return "\u{f7ca}"
        case .textHighlightBold: return "\u{f7cb}"
        case .textHighlightLight: return "\u{f7cc}"
        case .textHighlightRegular: return "\u{f7cd}"
        case .textLight: return "\u{f7ce}"
        case .textRegular: return "\u{f7cf}"
        case .threeDObjectBold: return "\u{f7d0}"
        case .threeDObjectLight: return "\u{f7d1}"
        case .threeDObjectRegular: return "\u{f7d2}"
        case .tooFastBold: return "\u{f7d3}"
        case .tooFastLight: return "\u{f7d4}"
        case .tooFastRegular: return "\u{f7d5}"
        case .tooSlowBold: return "\u{f7d6}"
        case .tooSlowLight: return "\u{f7d7}"
        case .tooSlowRegular: return "\u{f7d8}"
        case .toolsBold: return "\u{f7d9}"
        case .toolsLight: return "\u{f7da}"
        case .toolsRegular: return "\u{f7db}"
        case .touch10Bold: return "\u{f7dc}"
        case .touch10Light: return "\u{f7dd}"
        case .touch10Regular: return "\u{f7de}"
        case .transcriptBold: return "\u{f7df}"
        case .transcriptLight: return "\u{f7e0}"
        case .transcriptRegular: return "\u{f7e1}"
        case .ucmCloudBold: return "\u{f7e2}"
        case .ucmCloudLight: return "\u{f7e3}"
        case .ucmCloudRegular: return "\u{f7e4}"
        case .underlineBold: return "\u{f7e5}"
        case .underlineLight: return "\u{f7e6}"
        case .underlineRegular: return "\u{f7e7}"
        case .undoBold: return "\u{f7e8}"
        case .undoLight: return "\u{f7e9}"
        case .undoRegular: return "\u{f7ea}"
        case .unlinkBold: return "\u{f7eb}"
        case .unlinkLight: return "\u{f7ec}"
        case .unlinkRegular: return "\u{f7ed}"
        case .unreadBold: return "\u{f7ee}"
        case .unreadFilled: return "\u{f7ef}"
        case .unreadLight: return "\u{f7f0}"
        case .unreadRegular: return "\u{f7f1}"
        case .unsecureUnlockedBold: return "\u{f7f2}"
        case .unsecureUnlockedFilled: return "\u{f7f3}"
        case .unsecureUnlockedLight: return "\u{f7f4}"
        case .unsecureUnlockedRegular: return "\u{f7f5}"
        case .unsortedBold: return "\u{f7f6}"
        case .unsortedLight: return "\u{f7f7}"
        case .unsortedRegular: return "\u{f7f8}"
        case .updateFileShareBold: return "\u{f7f9}"
        case .updateFileShareLight: return "\u{f7fa}"
        case .updateFileShareRegular: return "\u{f7fb}"
        case .uploadBold: return "\u{f7fc}"
        case .uploadLight: return "\u{f7fd}"
        case .uploadRegular: return "\u{f7fe}"
        case .usbBold: return "\u{f7ff}"
        case .usbHeadsetBold: return "\u{f800}"
        case .usbHeadsetLight: return "\u{f801}"
        case .usbHeadsetMutedBold: return "\u{f802}"
        case .usbHeadsetMutedLight: return "\u{f803}"
        case .usbHeadsetMutedRegular: return "\u{f804}"
        case .usbHeadsetRegular: return "\u{f805}"
        case .usbLight: return "\u{f806}"
        case .usbRegular: return "\u{f807}"
        case .userBold: return "\u{f808}"
        case .userLight: return "\u{f809}"
        case .userRegular: return "\u{f80a}"
        case .vcsBold: return "\u{f80b}"
        case .vcsLight: return "\u{f80c}"
        case .vcsRegular: return "\u{f80d}"
        case .videoBlurBold: return "\u{f80e}"
        case .videoBlurFilled: return "\u{f80f}"
        case .videoBlurLight: return "\u{f810}"
        case .videoBlurRegular: return "\u{f811}"
        case .videoBold: return "\u{f812}"
        case .videoEffectBold: return "\u{f813}"
        case .videoEffectFilled: return "\u{f814}"
        case .videoEffectLight: return "\u{f815}"
        case .videoEffectRegular: return "\u{f816}"
        case .videoFilled: return "\u{f817}"
        case .videoLayoutBold: return "\u{f818}"
        case .videoLayoutEqualBold: return "\u{f819}"
        case .videoLayoutEqualFilled: return "\u{f81a}"
        case .videoLayoutEqualLight: return "\u{f81b}"
        case .videoLayoutEqualRegular: return "\u{f81c}"
        case .videoLayoutLight: return "\u{f81d}"
        case .videoLayoutOverlayBold: return "\u{f81e}"
        case .videoLayoutOverlayLight: return "\u{f81f}"
        case .videoLayoutOverlayRegular: return "\u{f820}"
        case .videoLayoutProminentBold: return "\u{f821}"
        case .videoLayoutProminentLight: return "\u{f822}"
        case .videoLayoutProminentRegular: return "\u{f823}"
        case .videoLayoutRegular: return "\u{f824}"
        case .videoLayoutShareDominantBold: return "\u{f825}"
        case .videoLayoutShareDominantLight: return "\u{f826}"
        case .videoLayoutShareDominantRegular: return "\u{f827}"
        case .videoLayoutSingleBold: return "\u{f828}"
        case .videoLayoutSingleLight: return "\u{f829}"
        case .videoLayoutSingleRegular: return "\u{f82a}"
        case .videoLayoutStackBold: return "\u{f82b}"
        case .videoLayoutStackFilled: return "\u{f82c}"
        case .videoLayoutStackLight: return "\u{f82d}"
        case .videoLayoutStackRegular: return "\u{f82e}"
        case .videoLayoutVideoDominantBold: return "\u{f82f}"
        case .videoLayoutVideoDominantLight: return "\u{f830}"
        case .videoLayoutVideoDominantRegular: return "\u{f831}"
        case .videoLight: return "\u{f832}"
        case .videoRegular: return "\u{f833}"
        case .videoSpeakerTrackBold: return "\u{f834}"
        case .videoSpeakerTrackFilled: return "\u{f835}"
        case .videoSpeakerTrackLight: return "\u{f836}"
        case .videoSpeakerTrackRegular: return "\u{f837}"
        case .viewAllBold: return "\u{f838}"
        case .viewAllLight: return "\u{f839}"
        case .viewAllRegular: return "\u{f83a}"
        case .viewListBold: return "\u{f83b}"
        case .viewListLight: return "\u{f83c}"
        case .viewListRegular: return "\u{f83d}"
        case .viewStackedBold: return "\u{f83e}"
        case .viewStackedLight: return "\u{f83f}"
        case .viewStackedRegular: return "\u{f840}"
        case .viewThumbnailBold: return "\u{f841}"
        case .viewThumbnailLight: return "\u{f842}"
        case .viewThumbnailRegular: return "\u{f843}"
        case .voicemailBold: return "\u{f844}"
        case .voicemailFilled: return "\u{f845}"
        case .voicemailLight: return "\u{f846}"
        case .voicemailRegular: return "\u{f847}"
        case .wallpaperBold: return "\u{f848}"
        case .wallpaperLight: return "\u{f849}"
        case .wallpaperRegular: return "\u{f84a}"
        case .warningBold: return "\u{f84b}"
        case .warningFilled: return "\u{f84c}"
        case .warningLight: return "\u{f84d}"
        case .warningRegular: return "\u{f84e}"
        case .webexBoardBold: return "\u{f84f}"
        case .webexBoardLight: return "\u{f850}"
        case .webexBoardRegular: return "\u{f851}"
        case .webexCodecPlusBold: return "\u{f852}"
        case .webexCodecPlusLight: return "\u{f853}"
        case .webexCodecPlusRegular: return "\u{f854}"
        case .webexDeskCameraBold: return "\u{f855}"
        case .webexDeskCameraLight: return "\u{f856}"
        case .webexDeskCameraRegular: return "\u{f857}"
        case .webexMeetingsBold: return "\u{f858}"
        case .webexMeetingsFilled: return "\u{f859}"
        case .webexMeetingsLight: return "\u{f85a}"
        case .webexMeetingsRegular: return "\u{f85b}"
        case .webexQuadCameraBold: return "\u{f85c}"
        case .webexQuadCameraLight: return "\u{f85d}"
        case .webexQuadCameraRegular: return "\u{f85e}"
        case .webexRoomKitBold: return "\u{f85f}"
        case .webexRoomKitLight: return "\u{f860}"
        case .webexRoomKitPlusBold: return "\u{f861}"
        case .webexRoomKitPlusLight: return "\u{f862}"
        case .webexRoomKitPlusRegular: return "\u{f863}"
        case .webexRoomKitRegular: return "\u{f864}"
        case .webexShareBold: return "\u{f865}"
        case .webexShareLight: return "\u{f866}"
        case .webexShareRegular: return "\u{f867}"
        case .webexTeamsBold: return "\u{f868}"
        case .webexTeamsFilled: return "\u{f869}"
        case .webexTeamsLight: return "\u{f86a}"
        case .webexTeamsNewBold: return "\u{f86b}"
        case .webexTeamsNewFilled: return "\u{f86c}"
        case .webexTeamsNewLight: return "\u{f86d}"
        case .webexTeamsNewRegular: return "\u{f86e}"
        case .webexTeamsRegular: return "\u{f86f}"
        case .whiteboardBold: return "\u{f870}"
        case .whiteboardContentBold: return "\u{f871}"
        case .whiteboardContentLight: return "\u{f872}"
        case .whiteboardContentRegular: return "\u{f873}"
        case .whiteboardFilled: return "\u{f874}"
        case .whiteboardLight: return "\u{f875}"
        case .whiteboardRegular: return "\u{f876}"
        case .wifiBold: return "\u{f877}"
        case .wifiErrorBold: return "\u{f878}"
        case .wifiErrorLight: return "\u{f879}"
        case .wifiErrorRegular: return "\u{f87a}"
        case .wifiLight: return "\u{f87b}"
        case .wifiRegular: return "\u{f87c}"
        case .windowCornerScrubBold: return "\u{f87d}"
        case .windowCornerScrubLight: return "\u{f87e}"
        case .windowCornerScrubRegular: return "\u{f87f}"
        case .windowVerticalScrubBold: return "\u{f880}"
        case .windowVerticalScrubLight: return "\u{f881}"
        case .windowVerticalScrubRegular: return "\u{f882}"
        case .workphoneBold: return "\u{f883}"
        case .workphoneLight: return "\u{f884}"
        case .workphoneRegular: return "\u{f885}"
        case .zoomInBold: return "\u{f886}"
        case .zoomInLight: return "\u{f887}"
        case .zoomInRegular: return "\u{f888}"
        case .zoomOutBold: return "\u{f889}"
        case .zoomOutLight: return "\u{f88a}"
        case .zoomOutRegular: return "\u{f88b}"
