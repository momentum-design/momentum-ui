...
@objc public enum MomentumIconsRebrandType: Int {
    ...
    public var ligature: String {
        ...
        case .liveBold: return "\u{f637}"
        case .liveFilled: return "\u{f638}"
        case .liveLight: return "\u{f639}"
        case .liveRegular: return "\u{f63a}"
        case .locationBold: return "\u{f63b}"
        case .locationFilled: return "\u{f63c}"
        case .locationLight: return "\u{f63d}"
        case .locationRegular: return "\u{f63e}"
        case .longTextBoxBold: return "\u{f63f}"
        case .longTextBoxLight: return "\u{f640}"
        case .longTextBoxRegular: return "\u{f641}"
        case .lowerHandBold: return "\u{f642}"
        case .lowerHandLight: return "\u{f643}"
        case .lowerHandRegular: return "\u{f644}"
        case .magicPenBold: return "\u{f645}"
        case .magicPenFilled: return "\u{f646}"
        case .magicPenLight: return "\u{f647}"
        case .magicPenRegular: return "\u{f648}"
        case .markAsUnreadBold: return "\u{f649}"
        case .markAsUnreadLight: return "\u{f64a}"
        case .markAsUnreadRegular: return "\u{f64b}"
        case .markdownBold: return "\u{f64c}"
        case .markdownLight: return "\u{f64d}"
        case .markdownRegular: return "\u{f64e}"
        case .markerBold: return "\u{f64f}"
        case .markerFilled: return "\u{f650}"
        case .markerLight: return "\u{f651}"
        case .markerRegular: return "\u{f652}"
        case .maximizeBold: return "\u{f653}"
        case .maximizeLight: return "\u{f654}"
        case .maximizeRegular: return "\u{f655}"
        case .mediaPlayerBold: return "\u{f656}"
        case .mediaPlayerLight: return "\u{f657}"
        case .mediaPlayerRegular: return "\u{f658}"
        case .mediaQualityGoodBold: return "\u{f659}"
        case .mediaQualityGoodFilled: return "\u{f65a}"
        case .mediaQualityGoodLight: return "\u{f65b}"
        case .mediaQualityGoodRegular: return "\u{f65c}"
        case .mediaQualityPoorBold: return "\u{f65d}"
        case .mediaQualityPoorFilled: return "\u{f65e}"
        case .mediaQualityPoorLight: return "\u{f65f}"
        case .mediaQualityPoorRegular: return "\u{f660}"
        case .mediaQualityUnstableBold: return "\u{f661}"
        case .mediaQualityUnstableFilled: return "\u{f662}"
        case .mediaQualityUnstableLight: return "\u{f663}"
        case .mediaQualityUnstableRegular: return "\u{f664}"
        case .mediumQualityGoodFilled: return "\u{f665}"
        case .mediumQualityPoorFilled: return "\u{f666}"
        case .mediumQualityUnstableFilled: return "\u{f667}"
        case .meetBold: return "\u{f668}"
        case .meetEndBold: return "\u{f669}"
        case .meetEndLight: return "\u{f66a}"
        case .meetEndRegular: return "\u{f66b}"
        case .meetFilled: return "\u{f66c}"
        case .meetLight: return "\u{f66d}"
        case .meetRegular: return "\u{f66e}"
        case .meetingsBold: return "\u{f66f}"
        case .meetingsFilled: return "\u{f670}"
        case .meetingsFocusMonthBold: return "\u{f671}"
        case .meetingsFocusMonthLight: return "\u{f672}"
        case .meetingsFocusMonthRegular: return "\u{f673}"
        case .meetingsFocusOneDayBold: return "\u{f674}"
        case .meetingsFocusOneDayLight: return "\u{f675}"
        case .meetingsFocusOneDayRegular: return "\u{f676}"
        case .meetingsFocusThreeDayBold: return "\u{f677}"
        case .meetingsFocusThreeDayLight: return "\u{f678}"
        case .meetingsFocusThreeDayRegular: return "\u{f679}"
        case .meetingsFocusUpcomingBold: return "\u{f67a}"
        case .meetingsFocusUpcomingLight: return "\u{f67b}"
        case .meetingsFocusUpcomingRegular: return "\u{f67c}"
        case .meetingsFocusWeekBold: return "\u{f67d}"
        case .meetingsFocusWeekLight: return "\u{f67e}"
        case .meetingsFocusWeekRegular: return "\u{f67f}"
        case .meetingsLight: return "\u{f680}"
        case .meetingsPresenceBold: return "\u{f681}"
        case .meetingsPresenceFilled: return "\u{f682}"
        case .meetingsPresenceLight: return "\u{f683}"
        case .meetingsPresenceRegular: return "\u{f684}"
        case .meetingsPresenceSmallFilled: return "\u{f685}"
        case .meetingsRegular: return "\u{f686}"
        case .meetingsTeamActiveBold: return "\u{f687}"
        case .meetingsTeamActiveLight: return "\u{f688}"
        case .meetingsTeamActiveRegular: return "\u{f689}"
        case .meetingsTeamBold: return "\u{f68a}"
        case .meetingsTeamLight: return "\u{f68b}"
        case .meetingsTeamNewBold: return "\u{f68c}"
        case .meetingsTeamNewLight: return "\u{f68d}"
        case .meetingsTeamNewRegular: return "\u{f68e}"
        case .meetingsTeamRegular: return "\u{f68f}"
        case .mentionBold: return "\u{f690}"
        case .mentionLight: return "\u{f691}"
        case .mentionRegular: return "\u{f692}"
        case .messageQueingBold: return "\u{f693}"
        case .messageQueingLight: return "\u{f694}"
        case .messageQueingRegular: return "\u{f695}"
        case .microphoneBold: return "\u{f696}"
        case .microphoneFilled: return "\u{f697}"
        case .microphoneHardMutedBold: return "\u{f698}"
        case .microphoneHardMutedCircleFilled: return "\u{f699}"
        case .microphoneHardMutedColoredBold: return "\u{f69a}"
        case .microphoneHardMutedColoredLight: return "\u{f69b}"
        case .microphoneHardMutedColoredRegular: return "\u{f69c}"
        case .microphoneHardMutedLight: return "\u{f69d}"
        case .microphoneHardMutedRegular: return "\u{f69e}"
        case .microphoneLight: return "\u{f69f}"
        case .microphoneMusicModeColoredBold: return "\u{f6a0}"
        case .microphoneMusicModeColoredLight: return "\u{f6a1}"
        case .microphoneMusicModeColoredRegular: return "\u{f6a2}"
        case .microphoneMutedBold: return "\u{f6a3}"
        case .microphoneMutedFilled: return "\u{f6a4}"
        case .microphoneMutedIndicatorFilled: return "\u{f6a5}"
        case .microphoneMutedLight: return "\u{f6a6}"
        case .microphoneMutedRedBold: return "\u{f6a7}"
        case .microphoneMutedRedFilled: return "\u{f6a8}"
        case .microphoneMutedRedLight: return "\u{f6a9}"
        case .microphoneMutedRedRegular: return "\u{f6aa}"
        case .microphoneMutedRegular: return "\u{f6ab}"
        case .microphoneRegular: return "\u{f6ac}"
        case .minimizeBold: return "\u{f6ad}"
        case .minimizeLight: return "\u{f6ae}"
        case .minimizeRegular: return "\u{f6af}"
        case .minusBold: return "\u{f6b0}"
        case .minusLight: return "\u{f6b1}"
        case .minusRegular: return "\u{f6b2}"
        case .mirrorBold: return "\u{f6b3}"
        case .mirrorFilled: return "\u{f6b4}"
        case .mirrorLight: return "\u{f6b5}"
        case .mirrorRegular: return "\u{f6b6}"
        case .moderatorBold: return "\u{f6b7}"
        case .moderatorLight: return "\u{f6b8}"
        case .moderatorRegular: return "\u{f6b9}"
        case .monitoringBold: return "\u{f6ba}"
        case .monitoringLight: return "\u{f6bb}"
        case .monitoringRegular: return "\u{f6bc}"
        case .monthlyRecurringScheduleNodeBold: return "\u{f6bd}"
        case .monthlyRecurringScheduleNodeLight: return "\u{f6be}"
        case .monthlyRecurringScheduleNodeRegular: return "\u{f6bf}"
        case .moreAdrBold: return "\u{f6c0}"
        case .moreAdrLight: return "\u{f6c1}"
        case .moreAdrRegular: return "\u{f6c2}"
        case .moreBold: return "\u{f6c3}"
        case .moreCircleBold: return "\u{f6c4}"
        case .moreCircleFilled: return "\u{f6c5}"
        case .moreCircleLight: return "\u{f6c6}"
        case .moreCircleRegular: return "\u{f6c7}"
        case .moreCirecleFilled: return "\u{f6c8}"
        case .moreLight: return "\u{f6c9}"
        case .moreRegular: return "\u{f6ca}"
        case .mouseCursorBold: return "\u{f6cb}"
        case .mouseCursorLight: return "\u{f6cc}"
        case .mouseCursorRegular: return "\u{f6cd}"
        case .moveCallInAdrBold: return "\u{f6ce}"
        case .moveCallInAdrLight: return "\u{f6cf}"
        case .moveCallInAdrRegular: return "\u{f6d0}"
        case .moveCallInIphBold: return "\u{f6d1}"
        case .moveCallInIphLight: return "\u{f6d2}"
        case .moveCallInIphRegular: return "\u{f6d3}"
        case .moveCallInLaptopBold: return "\u{f6d4}"
        case .moveCallInLaptopLight: return "\u{f6d5}"
        case .moveCallInLaptopRegular: return "\u{f6d6}"
        case .moveCallInOutAdrBold: return "\u{f6d7}"
        case .moveCallInOutAdrLight: return "\u{f6d8}"
        case .moveCallInOutAdrRegular: return "\u{f6d9}"
        case .moveCallInOutIphBold: return "\u{f6da}"
        case .moveCallInOutIphLight: return "\u{f6db}"
        case .moveCallInOutIphRegular: return "\u{f6dc}"
        case .moveCallInTabletBold: return "\u{f6dd}"
        case .moveCallInTabletLight: return "\u{f6de}"
        case .moveCallInTabletRegular: return "\u{f6df}"
        case .moveCallOutAdrBold: return "\u{f6e0}"
        case .moveCallOutAdrLight: return "\u{f6e1}"
        case .moveCallOutAdrRegular: return "\u{f6e2}"
        case .moveCallOutIphBold: return "\u{f6e3}"
        case .moveCallOutIphLight: return "\u{f6e4}"
        case .moveCallOutIphRegular: return "\u{f6e5}"
        case .moveCallOutLaptopBold: return "\u{f6e6}"
        case .moveCallOutLaptopLight: return "\u{f6e7}"
        case .moveCallOutLaptopRegular: return "\u{f6e8}"
        case .moveCallOutTabletBold: return "\u{f6e9}"
        case .moveCallOutTabletLight: return "\u{f6ea}"
        case .moveCallOutTabletRegular: return "\u{f6eb}"
        case .msTeams: return "\u{f6ec}"
        case .multilineChartBold: return "\u{f6ed}"
        case .multilineChartFilled: return "\u{f6ee}"
        case .multilineChartLight: return "\u{f6ef}"
        case .multilineChartRegular: return "\u{f6f0}"
        case .multimediaBold: return "\u{f6f1}"
        case .multimediaFilled: return "\u{f6f2}"
        case .multimediaLight: return "\u{f6f3}"
        case .multimediaRegular: return "\u{f6f4}"
        case .multipledDevicesBold: return "\u{f6f5}"
        case .multipledDevicesLight: return "\u{f6f6}"
        case .multipledDevicesRegular: return "\u{f6f7}"
        case .musicModeBold: return "\u{f6f8}"
        case .musicModeCircleBold: return "\u{f6f9}"
        case .musicModeCircleFilled: return "\u{f6fa}"
        case .musicModeCircleLight: return "\u{f6fb}"
        case .musicModeCircleRegular: return "\u{f6fc}"
        case .musicModeFilled: return "\u{f6fd}"
        case .musicModeLight: return "\u{f6fe}"
        case .musicModeRegular: return "\u{f6ff}"
        case .muteOnEntryBold: return "\u{f700}"
        case .muteOnEntryFilled: return "\u{f701}"
        case .muteOnEntryLight: return "\u{f702}"
        case .muteOnEntryRegular: return "\u{f703}"
        case .newManagerBold: return "\u{f704}"
        case .newManagerLight: return "\u{f705}"
        case .newManagerRegular: return "\u{f706}"
        case .newTitleBold: return "\u{f707}"
        case .newTitleLight: return "\u{f708}"
        case .newTitleRegular: return "\u{f709}"
        case .newVoicemailBold: return "\u{f70a}"
        case .newVoicemailLight: return "\u{f70b}"
        case .newVoicemailRegular: return "\u{f70c}"
        case .newWhiteboardBold: return "\u{f70d}"
        case .newWhiteboardLight: return "\u{f70e}"
        case .newWhiteboardRegular: return "\u{f70f}"
        case .nextBold: return "\u{f710}"
        case .nextLight: return "\u{f711}"
        case .nextRegular: return "\u{f712}"
        case .noDevicesBold: return "\u{f713}"
        case .noDevicesLight: return "\u{f714}"
        case .noDevicesRegular: return "\u{f715}"
        case .noiseDetectedCanceledFilled: return "\u{f716}"
        case .noiseDetectedFilled: return "\u{f717}"
        case .noiseNoneCanceledFilled: return "\u{f718}"
        case .noiseNoneFilled: return "\u{f719}"
        case .noiseRemovalBold: return "\u{f71a}"
        case .noiseRemovalLight: return "\u{f71b}"
        case .noiseRemovalRegular: return "\u{f71c}"
        case .noteBold: return "\u{f71d}"
        case .noteLight: return "\u{f71e}"
        case .notePptBold: return "\u{f71f}"
        case .notePptLight: return "\u{f720}"
        case .notePptRegular: return "\u{f721}"
        case .noteRegular: return "\u{f722}"
        case .notesBold: return "\u{f723}"
        case .notesLight: return "\u{f724}"
        case .notesRegular: return "\u{f725}"
        case .numberBold: return "\u{f726}"
        case .numberLight: return "\u{f727}"
        case .numberRegular: return "\u{f728}"
        case .oldRemoteBold: return "\u{f729}"
        case .oldRemoteLight: return "\u{f72a}"
        case .oldRemoteRegular: return "\u{f72b}"
        case .oldTouchBold: return "\u{f72c}"
        case .oldTouchLight: return "\u{f72d}"
        case .oldTouchRegular: return "\u{f72e}"
        case .oneColumnBold: return "\u{f72f}"
        case .oneColumnLight: return "\u{f730}"
        case .oneColumnRegular: return "\u{f731}"
        case .openInFolderBold: return "\u{f732}"
        case .openInFolderLight: return "\u{f733}"
        case .openInFolderRegular: return "\u{f734}"
        case .openPagesBold: return "\u{f735}"
        case .openPagesLight: return "\u{f736}"
        case .openPagesRegular: return "\u{f737}"
        case .otherNumberBold: return "\u{f738}"
        case .otherNumberLight: return "\u{f739}"
        case .otherNumberRegular: return "\u{f73a}"
        case .otherNumberWarningBold: return "\u{f73b}"
        case .otherNumberWarningLight: return "\u{f73c}"
        case .otherNumberWarningRegular: return "\u{f73d}"
        case .outgoingCallLegacyBold: return "\u{f73e}"
        case .outgoingCallLegacyLight: return "\u{f73f}"
        case .outgoingCallLegacyRegular: return "\u{f740}"
        case .overflowLeftBold: return "\u{f741}"
        case .overflowLeftLight: return "\u{f742}"
        case .overflowLeftRegular: return "\u{f743}"
        case .overflowRightBold: return "\u{f744}"
        case .overflowRightLight: return "\u{f745}"
        case .overflowRightRegular: return "\u{f746}"
        case .pairedCameraBold: return "\u{f747}"
        case .pairedCameraLight: return "\u{f748}"
        case .pairedCameraRegular: return "\u{f749}"
        case .pairedDeviceBold: return "\u{f74a}"
        case .pairedDeviceLight: return "\u{f74b}"
        case .pairedDeviceRegular: return "\u{f74c}"
        case .pairedHandsetBold: return "\u{f74d}"
        case .pairedHandsetLight: return "\u{f74e}"
        case .pairedHandsetRegular: return "\u{f74f}"
        case .pairingBold: return "\u{f750}"
        case .pairingLight: return "\u{f751}"
        case .pairingRegular: return "\u{f752}"
        case .parkedBold: return "\u{f753}"
        case .parkedFilled: return "\u{f754}"
        case .parkedLight: return "\u{f755}"
        case .parkedRegular: return "\u{f756}"
        case .parseBold: return "\u{f757}"
        case .parseLight: return "\u{f758}"
        case .parseRegular: return "\u{f759}"
        case .partialBold: return "\u{f75a}"
        case .partialLight: return "\u{f75b}"
        case .partialRegular: return "\u{f75c}"
        case .participantAddBold: return "\u{f75d}"
        case .participantAddLight: return "\u{f75e}"
        case .participantAddRegular: return "\u{f75f}"
        case .participantBlockedBold: return "\u{f760}"
        case .participantBlockedLight: return "\u{f761}"
        case .participantBlockedRegular: return "\u{f762}"
        case .participantBold: return "\u{f763}"
        case .participantFilled: return "\u{f764}"
        case .participantLight: return "\u{f765}"
        case .participantListBold: return "\u{f766}"
        case .participantListFilled: return "\u{f767}"
        case .participantListLight: return "\u{f768}"
        case .participantListRegular: return "\u{f769}"
        case .participantRegular: return "\u{f76a}"
        case .participantRemoveBold: return "\u{f76b}"
        case .participantRemoveLight: return "\u{f76c}"
        case .participantRemoveRegular: return "\u{f76d}"
        case .participantUnknownBold: return "\u{f76e}"
        case .participantUnknownLight: return "\u{f76f}"
        case .participantUnknownRegular: return "\u{f770}"
        case .passMouseBold: return "\u{f771}"
        case .passMouseLight: return "\u{f772}"
        case .passMouseRegular: return "\u{f773}"
        case .pauseBold: return "\u{f774}"
        case .pauseFilled: return "\u{f775}"
        case .pauseLight: return "\u{f776}"
        case .pauseRegular: return "\u{f777}"
        case .penBold: return "\u{f778}"
        case .penFilled: return "\u{f779}"
        case .penLight: return "\u{f77a}"
        case .penRegular: return "\u{f77b}"
        case .peopleBold: return "\u{f77c}"
        case .peopleCircleBold: return "\u{f77d}"
        case .peopleCircleFilled: return "\u{f77e}"
        case .peopleCircleLight: return "\u{f77f}"
        case .peopleCircleRegular: return "\u{f780}"
        case .peopleFilled: return "\u{f781}"
        case .peopleInsightsFilled: return "\u{f782}"
        case .peopleLight: return "\u{f783}"
        case .peopleRegular: return "\u{f784}"
        case .phoneAlertBold: return "\u{f785}"
        case .phoneAlertLight: return "\u{f786}"
        case .phoneAlertRegular: return "\u{f787}"
        case .phoneBold: return "\u{f788}"
        case .phoneFilled: return "\u{f789}"
        case .phoneLight: return "\u{f78a}"
        case .phoneMutedBold: return "\u{f78b}"
        case .phoneMutedLight: return "\u{f78c}"
        case .phoneMutedRegular: return "\u{f78d}"
        case .phonePrivateBold: return "\u{f78e}"
        case .phonePrivateLight: return "\u{f78f}"
        case .phonePrivateRegular: return "\u{f790}"
        case .phoneRegular: return "\u{f791}"
        case .phoneReplyAllBold: return "\u{f792}"
        case .phoneReplyAllLight: return "\u{f793}"
        case .phoneReplyAllRegular: return "\u{f794}"
        case .phoneReplyBold: return "\u{f795}"
        case .phoneReplyLight: return "\u{f796}"
        case .phoneReplyRegular: return "\u{f797}"
        case .phoneSmallFilled: return "\u{f798}"
        case .pickerBold: return "\u{f799}"
        case .pickerLight: return "\u{f79a}"
        case .pickerRegular: return "\u{f79b}"
        case .pictureInPictureBold: return "\u{f79c}"
        case .pictureInPictureFilled: return "\u{f79d}"
        case .pictureInPictureLight: return "\u{f79e}"
        case .pictureInPictureRegular: return "\u{f79f}"
        case .pieChartBold: return "\u{f7a0}"
        case .pieChartFilled: return "\u{f7a1}"
        case .pieChartLight: return "\u{f7a2}"
        case .pieChartRegular: return "\u{f7a3}"
        case .pinBold: return "\u{f7a4}"
        case .pinFilled: return "\u{f7a5}"
        case .pinLight: return "\u{f7a6}"
        case .pinListActivityBold: return "\u{f7a7}"
        case .pinListActivityColoredBold: return "\u{f7a8}"
        case .pinListActivityColoredLight: return "\u{f7a9}"
        case .pinListActivityColoredRegular: return "\u{f7aa}"
        case .pinListActivityLight: return "\u{f7ab}"
        case .pinListActivityRegular: return "\u{f7ac}"
        case .pinListBold: return "\u{f7ad}"
        case .pinListLight: return "\u{f7ae}"
        case .pinListRegular: return "\u{f7af}"
        case .pinMutedBold: return "\u{f7b0}"
        case .pinMutedFilled: return "\u{f7b1}"
        case .pinMutedLight: return "\u{f7b2}"
        case .pinMutedRegular: return "\u{f7b3}"
        case .pinRegular: return "\u{f7b4}"
        case .placeholderBold: return "\u{f7b5}"
        case .placeholderLight: return "\u{f7b6}"
        case .placeholderRegular: return "\u{f7b7}"
        case .playBold: return "\u{f7b8}"
        case .playCircleBold: return "\u{f7b9}"
        case .playCircleFilled: return "\u{f7ba}"
        case .playCircleLight: return "\u{f7bb}"
        case .playCircleRegular: return "\u{f7bc}"
        case .playFilled: return "\u{f7bd}"
        case .playLight: return "\u{f7be}"
        case .playRegular: return "\u{f7bf}"
        case .plugAcBold: return "\u{f7c0}"
        case .plugAcLight: return "\u{f7c1}"
        case .plugAcRegular: return "\u{f7c2}"
        case .plusBold: return "\u{f7c3}"
        case .plusCircleBold: return "\u{f7c4}"
        case .plusCircleFilled: return "\u{f7c5}"
        case .plusCircleLight: return "\u{f7c6}"
        case .plusCircleRegular: return "\u{f7c7}"
        case .plusLight: return "\u{f7c8}"
        case .plusRegular: return "\u{f7c9}"
        case .pmrBold: return "\u{f7ca}"
        case .pmrFilled: return "\u{f7cb}"
        case .pmrLight: return "\u{f7cc}"
        case .pmrRegular: return "\u{f7cd}"
        case .pollBold: return "\u{f7ce}"
        case .pollLight: return "\u{f7cf}"
        case .pollRegular: return "\u{f7d0}"
        case .popInBold: return "\u{f7d1}"
        case .popInLight: return "\u{f7d2}"
        case .popInRegular: return "\u{f7d3}"
        case .popOutBold: return "\u{f7d4}"
        case .popOutLight: return "\u{f7d5}"
        case .popOutRegular: return "\u{f7d6}"
        case .popUpBold: return "\u{f7d7}"
        case .popUpLight: return "\u{f7d8}"
        case .popUpRegular: return "\u{f7d9}"
        case .portraitLandscapeBold: return "\u{f7da}"
        case .portraitLandscapeLight: return "\u{f7db}"
        case .portraitLandscapeRegular: return "\u{f7dc}"
        case .powerAcBold: return "\u{f7dd}"
        case .powerAcLight: return "\u{f7de}"
        case .powerAcRegular: return "\u{f7df}"
        case .powerBold: return "\u{f7e0}"
        case .powerLight: return "\u{f7e1}"
        case .powerRegular: return "\u{f7e2}"
        case .preHeaderBold: return "\u{f7e3}"
        case .preHeaderLight: return "\u{f7e4}"
        case .preHeaderRegular: return "\u{f7e5}"
        case .presentationBold: return "\u{f7e6}"
        case .presentationLight: return "\u{f7e7}"
        case .presentationRegular: return "\u{f7e8}"
        case .primaryParticipantBold: return "\u{f7e9}"
        case .primaryParticipantLight: return "\u{f7ea}"
        case .primaryParticipantRegular: return "\u{f7eb}"
        case .printBold: return "\u{f7ec}"
        case .printLight: return "\u{f7ed}"
        case .printRegular: return "\u{f7ee}"
        case .priorityBadgeFilled: return "\u{f7ef}"
        case .priorityCircleBold: return "\u{f7f0}"
        case .priorityCircleFilled: return "\u{f7f1}"
        case .priorityCircleLight: return "\u{f7f2}"
        case .priorityCircleRegular: return "\u{f7f3}"
        case .priorityCircleTwoBold: return "\u{f7f4}"
        case .priorityCircleTwoFilled: return "\u{f7f5}"
        case .priorityCircleTwoLight: return "\u{f7f6}"
        case .priorityCircleTwoRegular: return "\u{f7f7}"
        case .privacyCircleBold: return "\u{f7f8}"
        case .privacyCircleFilled: return "\u{f7f9}"
        case .privacyCircleLight: return "\u{f7fa}"
        case .privacyCircleRegular: return "\u{f7fb}"
        case .privateBold: return "\u{f7fc}"
        case .privateCircleBold: return "\u{f7fd}"
        case .privateCircleFilled: return "\u{f7fe}"
        case .privateCircleLight: return "\u{f7ff}"
        case .privateCircleRegular: return "\u{f800}"
        case .privateLight: return "\u{f801}"
        case .privateMeetingBold: return "\u{f802}"
        case .privateMeetingLight: return "\u{f803}"
        case .privateMeetingRegular: return "\u{f804}"
        case .privateRegular: return "\u{f805}"
        case .productDemoBold: return "\u{f806}"
        case .productDemoLight: return "\u{f807}"
        case .productDemoRegular: return "\u{f808}"
        case .proximityBold: return "\u{f809}"
        case .proximityLight: return "\u{f80a}"
        case .proximityMutedBold: return "\u{f80b}"
        case .proximityMutedLight: return "\u{f80c}"
        case .proximityMutedRegular: return "\u{f80d}"
        case .proximityRegular: return "\u{f80e}"
        case .proximityVideoBold: return "\u{f80f}"
        case .proximityVideoLight: return "\u{f810}"
        case .proximityVideoRegular: return "\u{f811}"
        case .ptoPresenceBold: return "\u{f812}"
        case .ptoPresenceFilled: return "\u{f813}"
        case .ptoPresenceLight: return "\u{f814}"
        case .ptoPresenceRegular: return "\u{f815}"
        case .pullCallBold: return "\u{f816}"
        case .pullCallLight: return "\u{f817}"
        case .pullCallRegular: return "\u{f818}"
        case .qABold: return "\u{f819}"
        case .qALight: return "\u{f81a}"
        case .qARegular: return "\u{f81b}"
        case .qualityBold: return "\u{f81c}"
        case .qualityLight: return "\u{f81d}"
        case .qualityRegular: return "\u{f81e}"
        case .queueContactBold: return "\u{f81f}"
        case .queueContactLight: return "\u{f820}"
        case .queueContactRegular: return "\u{f821}"
        case .quietBold: return "\u{f822}"
        case .quietHoursPresenceBold: return "\u{f823}"
        case .quietHoursPresenceFilled: return "\u{f824}"
        case .quietHoursPresenceLight: return "\u{f825}"
        case .quietHoursPresenceRegular: return "\u{f826}"
        case .quietLight: return "\u{f827}"
        case .quietRegular: return "\u{f828}"
        case .radioButtonGroupBold: return "\u{f829}"
        case .radioButtonGroupLight: return "\u{f82a}"
        case .radioButtonGroupRegular: return "\u{f82b}"
        case .raiseHandBold: return "\u{f82c}"
        case .raiseHandCircleFilled: return "\u{f82d}"
        case .raiseHandFilled: return "\u{f82e}"
        case .raiseHandLight: return "\u{f82f}"
        case .raiseHandRegular: return "\u{f830}"
        case .ramBold: return "\u{f831}"
        case .ramLight: return "\u{f832}"
        case .ramRegular: return "\u{f833}"
        case .reactionsBold: return "\u{f834}"
        case .reactionsFilled: return "\u{f835}"
        case .reactionsLight: return "\u{f836}"
        case .reactionsRegular: return "\u{f837}"
        case .reactivateBold: return "\u{f838}"
        case .reactivateLight: return "\u{f839}"
        case .reactivateRegular: return "\u{f83a}"
        case .recentsBold: return "\u{f83b}"
        case .recentsFilled: return "\u{f83c}"
        case .recentsLight: return "\u{f83d}"
        case .recentsPresenceBold: return "\u{f83e}"
        case .recentsPresenceFilled: return "\u{f83f}"
        case .recentsPresenceLight: return "\u{f840}"
        case .recentsPresenceRegular: return "\u{f841}"
        case .recentsPresenceSmallFilled: return "\u{f842}"
        case .recentsRegular: return "\u{f843}"
        case .recordActiveBold: return "\u{f844}"
        case .recordActiveFilled: return "\u{f845}"
        case .recordActiveLight: return "\u{f846}"
        case .recordActiveRegular: return "\u{f847}"
        case .recordBold: return "\u{f848}"
        case .recordFilled: return "\u{f849}"
        case .recordLight: return "\u{f84a}"
        case .recordPausedBold: return "\u{f84b}"
        case .recordPausedFilled: return "\u{f84c}"
        case .recordPausedLight: return "\u{f84d}"
        case .recordPausedRegular: return "\u{f84e}"
        case .recordRegular: return "\u{f84f}"
        case .recurringBold: return "\u{f850}"
        case .recurringLight: return "\u{f851}"
        case .recurringOffBold: return "\u{f852}"
        case .recurringOffLight: return "\u{f853}"
        case .recurringOffRegular: return "\u{f854}"
        case .recurringRegular: return "\u{f855}"
        case .redialBold: return "\u{f856}"
        case .redialLight: return "\u{f857}"
        case .redialRegular: return "\u{f858}"
        case .redoBold: return "\u{f859}"
        case .redoLight: return "\u{f85a}"
        case .redoRegular: return "\u{f85b}"
        case .refreshBold: return "\u{f85c}"
        case .refreshLight: return "\u{f85d}"
        case .refreshRegular: return "\u{f85e}"
        case .remoteCallBold: return "\u{f85f}"
        case .remoteCallFilled: return "\u{f860}"
        case .remoteCallLight: return "\u{f861}"
        case .remoteCallRegular: return "\u{f862}"
        case .remoteDesktopControlBold: return "\u{f863}"
        case .remoteDesktopControlFilled: return "\u{f864}"
        case .remoteDesktopControlLight: return "\u{f865}"
        case .remoteDesktopControlRegular: return "\u{f866}"
        case .removeBold: return "\u{f867}"
        case .removeFilled: return "\u{f868}"
        case .removeLight: return "\u{f869}"
        case .removeRegular: return "\u{f86a}"
        case .replyBold: return "\u{f86b}"
        case .replyFilled: return "\u{f86c}"
        case .replyLight: return "\u{f86d}"
        case .replyListBold: return "\u{f86e}"
        case .replyListLight: return "\u{f86f}"
        case .replyListRegular: return "\u{f870}"
        case .replyPrivatelyBold: return "\u{f871}"
        case .replyPrivatelyLight: return "\u{f872}"
        case .replyPrivatelyRegular: return "\u{f873}"
        case .replyRegular: return "\u{f874}"
        case .resetBold: return "\u{f875}"
        case .resetLight: return "\u{f876}"
        case .resetRegular: return "\u{f877}"
        case .responsiveMobileBold: return "\u{f878}"
        case .responsiveMobileLight: return "\u{f879}"
        case .responsiveMobileRegular: return "\u{f87a}"
        case .restartBold: return "\u{f87b}"
        case .restartLight: return "\u{f87c}"
        case .restartRegular: return "\u{f87d}"
        case .retrieveCallBold: return "\u{f87e}"
        case .retrieveCallLight: return "\u{f87f}"
        case .retrieveCallRegular: return "\u{f880}"
        case .returnBold: return "\u{f881}"
        case .returnLight: return "\u{f882}"
        case .returnRegular: return "\u{f883}"
        case .ringtoneBold: return "\u{f884}"
        case .ringtoneLight: return "\u{f885}"
        case .ringtoneRegular: return "\u{f886}"
        case .roomCalendarBold: return "\u{f887}"
        case .roomCalendarLight: return "\u{f888}"
        case .roomCalendarRegular: return "\u{f889}"
        case .roomLightsBold: return "\u{f88a}"
        case .roomLightsFilled: return "\u{f88b}"
        case .roomLightsLight: return "\u{f88c}"
        case .roomLightsRegular: return "\u{f88d}"
        case .rotateContentBold: return "\u{f88e}"
        case .rotateContentFilled: return "\u{f88f}"
        case .rotateContentLight: return "\u{f890}"
        case .rotateContentRegular: return "\u{f891}"
        case .ruleBasedBold: return "\u{f892}"
        case .ruleBasedLight: return "\u{f893}"
        case .ruleBasedRegular: return "\u{f894}"
        case .runningApplicationBold: return "\u{f895}"
        case .runningApplicationFilled: return "\u{f896}"
        case .runningApplicationLight: return "\u{f897}"
        case .runningApplicationRegular: return "\u{f898}"
        case .saveBold: return "\u{f899}"
        case .saveLight: return "\u{f89a}"
        case .saveRegular: return "\u{f89b}"
        case .saveTranscriptBold: return "\u{f89c}"
        case .saveTranscriptFilled: return "\u{f89d}"
        case .saveTranscriptLight: return "\u{f89e}"
        case .saveTranscriptRegular: return "\u{f89f}"
        case .scanBold: return "\u{f8a0}"
        case .scanLight: return "\u{f8a1}"
        case .scanRegular: return "\u{f8a2}"
        case .schedulerAvailableBold: return "\u{f8a3}"
        case .schedulerAvailableLight: return "\u{f8a4}"
        case .schedulerAvailableRegular: return "\u{f8a5}"
        case .schedulerNotWorkingHoursBold: return "\u{f8a6}"
        case .schedulerNotWorkingHoursLight: return "\u{f8a7}"
        case .schedulerNotWorkingHoursRegular: return "\u{f8a8}"
        case .schedulerUnavailableBold: return "\u{f8a9}"
        case .schedulerUnavailableLight: return "\u{f8aa}"
        case .schedulerUnavailableRegular: return "\u{f8ab}"
        case .schedulerUnknownBold: return "\u{f8ac}"
        case .schedulerUnknownLight: return "\u{f8ad}"
        case .schedulerUnknownRegular: return "\u{f8ae}"
        case .screenshotBold: return "\u{f8af}"
        case .screenshotDocBold: return "\u{f8b0}"
        case .screenshotDocFilled: return "\u{f8b1}"
        case .screenshotDocLight: return "\u{f8b2}"
        case .screenshotDocRegular: return "\u{f8b3}"
        case .screenshotLight: return "\u{f8b4}"
        case .screenshotRegular: return "\u{f8b5}"
        case .searchBold: return "\u{f8b6}"
        case .searchFilled: return "\u{f8b7}"
        case .searchLight: return "\u{f8b8}"
        case .searchRegular: return "\u{f8b9}"
        case .secondaryArrowBold: return "\u{f8ba}"
        case .secondaryArrowLight: return "\u{f8bb}"
        case .secondaryArrowRegular: return "\u{f8bc}"
        case .secureCallLockBold: return "\u{f8bd}"
        case .secureCallLockFilled: return "\u{f8be}"
        case .secureCallLockLight: return "\u{f8bf}"
        case .secureCallLockRegular: return "\u{f8c0}"
        case .secureCallShieldBold: return "\u{f8c1}"
        case .secureCallShieldFilled: return "\u{f8c2}"
        case .secureCallShieldLight: return "\u{f8c3}"
        case .secureCallShieldRegular: return "\u{f8c4}"
        case .secureCircleBold: return "\u{f8c5}"
        case .secureCircleFilled: return "\u{f8c6}"
        case .secureCircleLight: return "\u{f8c7}"
        case .secureCircleRegular: return "\u{f8c8}"
        case .secureLockBold: return "\u{f8c9}"
        case .secureLockFilled: return "\u{f8ca}"
        case .secureLockLight: return "\u{f8cb}"
        case .secureLockRegular: return "\u{f8cc}"
        case .segmentExcludeFilled: return "\u{f8cd}"
        case .segmentFilterFilled: return "\u{f8ce}"
        case .segmentIncludeFilled: return "\u{f8cf}"
        case .selectAllBold: return "\u{f8d0}"
        case .selectAllFilled: return "\u{f8d1}"
        case .selectAllLight: return "\u{f8d2}"
        case .selectAllRegular: return "\u{f8d3}"
        case .selectionBold: return "\u{f8d4}"
        case .selectionLight: return "\u{f8d5}"
        case .selectionRegular: return "\u{f8d6}"
        case .sendBold: return "\u{f8d7}"
        case .sendFilled: return "\u{f8d8}"
        case .sendLight: return "\u{f8d9}"
        case .sendRegular: return "\u{f8da}"
        case .serverBold: return "\u{f8db}"
        case .serverErrorBold: return "\u{f8dc}"
        case .serverErrorLight: return "\u{f8dd}"
        case .serverErrorRegular: return "\u{f8de}"
        case .serverLight: return "\u{f8df}"
        case .serverRegular: return "\u{f8e0}"
        case .servicesBold: return "\u{f8e1}"
        case .servicesLight: return "\u{f8e2}"
        case .servicesRegular: return "\u{f8e3}"
        case .setVariableBold: return "\u{f8e4}"
        case .setVariableLight: return "\u{f8e5}"
        case .setVariableRegular: return "\u{f8e6}"
        case .settingsBold: return "\u{f8e7}"
        case .settingsFilled: return "\u{f8e8}"
        case .settingsLight: return "\u{f8e9}"
        case .settingsRegular: return "\u{f8ea}"
        case .setupAssistantBold: return "\u{f8eb}"
        case .setupAssistantLight: return "\u{f8ec}"
        case .setupAssistantRegular: return "\u{f8ed}"
        case .sftpBold: return "\u{f8ee}"
        case .sftpLight: return "\u{f8ef}"
        case .sftpRegular: return "\u{f8f0}"
        case .shapeCircleBold: return "\u{f8f1}"
        case .shapeCircleFilled: return "\u{f8f2}"
        case .shapeCircleLight: return "\u{f8f3}"
        case .shapeCircleRegular: return "\u{f8f4}"
        case .shapeDiagonalLineBold: return "\u{f8f5}"
        case .shapeDiagonalLineLight: return "\u{f8f6}"
        case .shapeDiagonalLineRegular: return "\u{f8f7}"
        case .shapeDiamondBold: return "\u{f8f8}"
        case .shapeDiamondFilled: return "\u{f8f9}"
        case .shapeDiamondLight: return "\u{f8fa}"
        case .shapeDiamondRegular: return "\u{f8fb}"
        case .shapeOvalBold: return "\u{f8fc}"
        case .shapeOvalLight: return "\u{f8fd}"
        case .shapeOvalRegular: return "\u{f8fe}"
        case .shapeSquareBold: return "\u{f8ff}"
        case .shapeSquareFilled: return "\u{f900}"
        case .shapeSquareLight: return "\u{f901}"
        case .shapeSquareRegular: return "\u{f902}"
        case .shapeTriangleBold: return "\u{f903}"
        case .shapeTriangleFilled: return "\u{f904}"
        case .shapeTriangleLight: return "\u{f905}"
        case .shapeTriangleRegular: return "\u{f906}"
        case .shapesBold: return "\u{f907}"
        case .shapesLight: return "\u{f908}"
        case .shapesRegular: return "\u{f909}"
        case .shareCNativeAdrBold: return "\u{f90a}"
        case .shareCNativeAdrFilled: return "\u{f90b}"
        case .shareCNativeAdrLight: return "\u{f90c}"
        case .shareCNativeAdrRegular: return "\u{f90d}"
        case .shareCNativeIphBold: return "\u{f90e}"
        case .shareCNativeIphLight: return "\u{f90f}"
        case .shareCNativeIphRegular: return "\u{f910}"
        case .shareScreenBold: return "\u{f911}"
        case .shareScreenFilled: return "\u{f912}"
        case .shareScreenLight: return "\u{f913}"
        case .shareScreenRegular: return "\u{f914}"
        case .shareScreenSmallFilled: return "\u{f915}"
        case .shareSpaceBold: return "\u{f916}"
        case .shareSpaceLight: return "\u{f917}"
        case .shareSpaceRegular: return "\u{f918}"
        case .shieldBold: return "\u{f919}"
        case .shieldLight: return "\u{f91a}"
        case .shieldRegular: return "\u{f91b}"
        case .shoppingCartBold: return "\u{f91c}"
        case .shoppingCartFilled: return "\u{f91d}"
        case .shoppingCartLight: return "\u{f91e}"
        case .shoppingCartRegular: return "\u{f91f}"
        case .shortTextBoxBold: return "\u{f920}"
        case .shortTextBoxLight: return "\u{f921}"
        case .shortTextBoxRegular: return "\u{f922}"
        case .showBold: return "\u{f923}"
        case .showFilled: return "\u{f924}"
        case .showLight: return "\u{f925}"
        case .showRegular: return "\u{f926}"
        case .signInBold: return "\u{f927}"
        case .signInFilled: return "\u{f928}"
        case .signInForcedBold: return "\u{f929}"
        case .signInForcedLight: return "\u{f92a}"
        case .signInForcedRegular: return "\u{f92b}"
        case .signInLight: return "\u{f92c}"
        case .signInRegular: return "\u{f92d}"
        case .signOutBold: return "\u{f92e}"
        case .signOutLight: return "\u{f92f}"
        case .signOutRegular: return "\u{f930}"
        case .signal0Bold: return "\u{f931}"
        case .signal0Light: return "\u{f932}"
        case .signal0Regular: return "\u{f933}"
        case .signal100Bold: return "\u{f934}"
        case .signal100Light: return "\u{f935}"
        case .signal100Regular: return "\u{f936}"
        case .signal25Bold: return "\u{f937}"
        case .signal25Light: return "\u{f938}"
        case .signal25Regular: return "\u{f939}"
        case .signal50Bold: return "\u{f93a}"
        case .signal50Light: return "\u{f93b}"
        case .signal50Regular: return "\u{f93c}"
        case .signal75Bold: return "\u{f93d}"
        case .signal75Light: return "\u{f93e}"
        case .signal75Regular: return "\u{f93f}"
        case .simplePromotionBold: return "\u{f940}"
        case .simplePromotionLight: return "\u{f941}"
        case .simplePromotionRegular: return "\u{f942}"
        case .singleNumberReachBold: return "\u{f943}"
        case .singleNumberReachLight: return "\u{f944}"
        case .singleNumberReachRegular: return "\u{f945}"
        case .sipRegistrationInProgressBold: return "\u{f946}"
        case .sipRegistrationInProgressFilled: return "\u{f947}"
        case .sipRegistrationInProgressLight: return "\u{f948}"
        case .sipRegistrationInProgressRegular: return "\u{f949}"
        case .skipBold: return "\u{f94a}"
        case .skipBwBold: return "\u{f94b}"
        case .skipBwFilled: return "\u{f94c}"
        case .skipBwLight: return "\u{f94d}"
        case .skipBwRegular: return "\u{f94e}"
        case .skipFwBold: return "\u{f94f}"
        case .skipFwFilled: return "\u{f950}"
        case .skipFwLight: return "\u{f951}"
        case .skipFwRegular: return "\u{f952}"
        case .skipLight: return "\u{f953}"
        case .skipRegular: return "\u{f954}"
        case .smsInboundBold: return "\u{f955}"
        case .smsInboundLight: return "\u{f956}"
        case .smsInboundRegular: return "\u{f957}"
        case .smsMessageBold: return "\u{f958}"
        case .smsMessageFilled: return "\u{f959}"
        case .smsMessageLight: return "\u{f95a}"
        case .smsMessageRegular: return "\u{f95b}"
        case .socialAlexaFilled: return "\u{f95c}"
        case .socialFacebookColoredFilled: return "\u{f95d}"
        case .socialFacebookFilled: return "\u{f95e}"
        case .socialFbmessengerColoredFilled: return "\u{f95f}"
        case .socialFbmessengerFilled: return "\u{f960}"
        case .socialInstagramBold: return "\u{f961}"
        case .socialMicrosoftColoredFilled: return "\u{f962}"
        case .socialMicrosoftFilled: return "\u{f963}"
        case .socialMmsFilled: return "\u{f964}"
        case .socialMmsGoldFilled: return "\u{f965}"
        case .socialSmsFilled: return "\u{f966}"
        case .socialSmsMintFilled: return "\u{f967}"
        case .socialTwitterColoredFilled: return "\u{f968}"
        case .socialTwitterFilled: return "\u{f969}"
        case .socialViberBold: return "\u{f96a}"
        case .socialViberColoredBold: return "\u{f96b}"
        case .socialWhatsappBold: return "\u{f96c}"
        case .socialWhatsappColoredFilled: return "\u{f96d}"
        case .sortAscendingBold: return "\u{f96e}"
        case .sortAscendingLight: return "\u{f96f}"
        case .sortAscendingRegular: return "\u{f970}"
        case .sortDescendingBold: return "\u{f971}"
        case .sortDescendingLight: return "\u{f972}"
        case .sortDescendingRegular: return "\u{f973}"
        case .soundDefaultBold: return "\u{f974}"
        case .soundDefaultLight: return "\u{f975}"
        case .soundDefaultRegular: return "\u{f976}"
        case .speakerBold: return "\u{f977}"
        case .speakerDisconnectedBold: return "\u{f978}"
        case .speakerDisconnectedFilled: return "\u{f979}"
        case .speakerDisconnectedLight: return "\u{f97a}"
        case .speakerDisconnectedRegular: return "\u{f97b}"
        case .speakerFilled: return "\u{f97c}"
        case .speakerLight: return "\u{f97d}"
        case .speakerMutedBold: return "\u{f97e}"
        case .speakerMutedFilled: return "\u{f97f}"
        case .speakerMutedLight: return "\u{f980}"
        case .speakerMutedRegular: return "\u{f981}"
        case .speakerOffBold: return "\u{f982}"
        case .speakerOffFilled: return "\u{f983}"
        case .speakerOffLight: return "\u{f984}"
        case .speakerOffRegular: return "\u{f985}"
        case .speakerOnColoredBold: return "\u{f986}"
        case .speakerOnColoredLight: return "\u{f987}"
        case .speakerOnColoredRegular: return "\u{f988}"
        case .speakerRegular: return "\u{f989}"
        case .speakerTurnDownBold: return "\u{f98a}"
        case .speakerTurnDownFilled: return "\u{f98b}"
        case .speakerTurnDownLight: return "\u{f98c}"
        case .speakerTurnDownRegular: return "\u{f98d}"
        case .speakerTurnUpBold: return "\u{f98e}"
        case .speakerTurnUpFilled: return "\u{f98f}"
        case .speakerTurnUpLight: return "\u{f990}"
        case .speakerTurnUpRegular: return "\u{f991}"
        case .spellCheckerBold: return "\u{f992}"
        case .spellCheckerLight: return "\u{f993}"
        case .spellCheckerRegular: return "\u{f994}"
        case .spinnerBold: return "\u{f995}"
        case .spinnerFilledBold: return "\u{f996}"
        case .spinnerFilledLight: return "\u{f997}"
        case .spinnerFilledRegular: return "\u{f998}"
        case .spinnerLight: return "\u{f999}"
        case .spinnerPartialBold: return "\u{f99a}"
        case .spinnerPartialLight: return "\u{f99b}"
        case .spinnerPartialRegular: return "\u{f99c}"
        case .spinnerRegular: return "\u{f99d}"
        case .stackedArea100ChartBold: return "\u{f99e}"
        case .stackedArea100ChartFilled: return "\u{f99f}"
        case .stackedArea100ChartLight: return "\u{f9a0}"
        case .stackedArea100ChartRegular: return "\u{f9a1}"
        case .stackedAreaChartBold: return "\u{f9a2}"
        case .stackedAreaChartFilled: return "\u{f9a3}"
        case .stackedAreaChartLight: return "\u{f9a4}"
        case .stackedAreaChartRegular: return "\u{f9a5}"
        case .stackedBar100ChartBold: return "\u{f9a6}"
        case .stackedBar100ChartFilled: return "\u{f9a7}"
        case .stackedBar100ChartLight: return "\u{f9a8}"
        case .stackedBar100ChartRegular: return "\u{f9a9}"
        case .stackedBarChartBold: return "\u{f9aa}"
        case .stackedBarChartFilled: return "\u{f9ab}"
        case .stackedBarChartLight: return "\u{f9ac}"
        case .stackedBarChartRegular: return "\u{f9ad}"
        case .startChatBold: return "\u{f9ae}"
        case .startChatLight: return "\u{f9af}"
        case .startChatRegular: return "\u{f9b0}"
        case .stethoscopeBold: return "\u{f9b1}"
        case .stethoscopeLight: return "\u{f9b2}"
        case .stethoscopeRegular: return "\u{f9b3}"
        case .stickersBold: return "\u{f9b4}"
        case .stickersLight: return "\u{f9b5}"
        case .stickersRegular: return "\u{f9b6}"
        case .stickiesBold: return "\u{f9b7}"
        case .stickiesLight: return "\u{f9b8}"
        case .stickiesRegular: return "\u{f9b9}"
        case .stopBold: return "\u{f9ba}"
        case .stopCircleBold: return "\u{f9bb}"
        case .stopCircleFilled: return "\u{f9bc}"
        case .stopCircleLight: return "\u{f9bd}"
        case .stopCircleRegular: return "\u{f9be}"
        case .stopContentShareBold: return "\u{f9bf}"
        case .stopContentShareLight: return "\u{f9c0}"
        case .stopContentShareRegular: return "\u{f9c1}"
        case .stopFilled: return "\u{f9c2}"
        case .stopLight: return "\u{f9c3}"
        case .stopRegular: return "\u{f9c4}"
        case .storedInfoBold: return "\u{f9c5}"
        case .storedInfoFilled: return "\u{f9c6}"
        case .storedInfoLight: return "\u{f9c7}"
        case .storedInfoRegular: return "\u{f9c8}"
        case .streamingBold: return "\u{f9c9}"
        case .streamingLight: return "\u{f9ca}"
        case .streamingRegular: return "\u{f9cb}"
        case .strikethroughBold: return "\u{f9cc}"
        case .strikethroughLight: return "\u{f9cd}"
        case .strikethroughRegular: return "\u{f9ce}"
        case .studioModeBold: return "\u{f9cf}"
        case .studioModeLight: return "\u{f9d0}"
        case .studioModeRegular: return "\u{f9d1}"
        case .subscriptBold: return "\u{f9d2}"
        case .subscriptLight: return "\u{f9d3}"
        case .subscriptRegular: return "\u{f9d4}"
        case .superscriptBold: return "\u{f9d5}"
        case .superscriptLight: return "\u{f9d6}"
        case .superscriptRegular: return "\u{f9d7}"
        case .surveyBold: return "\u{f9d8}"
        case .surveyFilled: return "\u{f9d9}"
        case .surveyLight: return "\u{f9da}"
        case .surveyRegular: return "\u{f9db}"
        case .sx10Bold: return "\u{f9dc}"
        case .sx10Light: return "\u{f9dd}"
        case .sx10Regular: return "\u{f9de}"
        case .sx20Bold: return "\u{f9df}"
        case .sx20Light: return "\u{f9e0}"
        case .sx20Regular: return "\u{f9e1}"
        case .sx80CodecBold: return "\u{f9e2}"
        case .sx80CodecLight: return "\u{f9e3}"
        case .sx80CodecRegular: return "\u{f9e4}"
        case .tableBold: return "\u{f9e5}"
        case .tableLight: return "\u{f9e6}"
        case .tableRegular: return "\u{f9e7}"
        case .tabletBold: return "\u{f9e8}"
        case .tabletLight: return "\u{f9e9}"
        case .tabletRegular: return "\u{f9ea}"
        case .tabsBold: return "\u{f9eb}"
        case .tabsLight: return "\u{f9ec}"
        case .tabsRegular: return "\u{f9ed}"
        case .tagBold: return "\u{f9ee}"
        case .tagLight: return "\u{f9ef}"
        case .tagRegular: return "\u{f9f0}"
        case .tapBold: return "\u{f9f1}"
        case .tapFilled: return "\u{f9f2}"
        case .tapLight: return "\u{f9f3}"
        case .tapRegular: return "\u{f9f4}"
        case .telepresenceAlertBold: return "\u{f9f5}"
        case .telepresenceAlertLight: return "\u{f9f6}"
        case .telepresenceAlertMutedBold: return "\u{f9f7}"
        case .telepresenceAlertMutedLight: return "\u{f9f8}"
        case .telepresenceAlertMutedRegular: return "\u{f9f9}"
        case .telepresenceAlertRegular: return "\u{f9fa}"
        case .telepresenceBold: return "\u{f9fb}"
        case .telepresenceIx5000Bold: return "\u{f9fc}"
        case .telepresenceIx5000Light: return "\u{f9fd}"
        case .telepresenceIx5000Regular: return "\u{f9fe}"
        case .telepresenceLight: return "\u{f9ff}"
        case .telepresencePrivateBold: return "\u{fa00}"
        case .telepresencePrivateLight: return "\u{fa01}"
        case .telepresencePrivateRegular: return "\u{fa02}"
        case .telepresenceRegular: return "\u{fa03}"
        case .temperatureBold: return "\u{fa04}"
        case .temperatureLight: return "\u{fa05}"
        case .temperatureRegular: return "\u{fa06}"
        case .textAlignCenterBold: return "\u{fa07}"
        case .textAlignCenterFilled: return "\u{fa08}"
        case .textAlignCenterLight: return "\u{fa09}"
        case .textAlignCenterRegular: return "\u{fa0a}"
        case .textAlignLeftBold: return "\u{fa0b}"
        case .textAlignLeftFilled: return "\u{fa0c}"
        case .textAlignLeftLight: return "\u{fa0d}"
        case .textAlignLeftRegular: return "\u{fa0e}"
        case .textAlignRightBold: return "\u{fa0f}"
        case .textAlignRightFilled: return "\u{fa10}"
        case .textAlignRightLight: return "\u{fa11}"
        case .textAlignRightRegular: return "\u{fa12}"
        case .textBold: return "\u{fa13}"
        case .textCodeBlockBold: return "\u{fa14}"
        case .textCodeBlockLight: return "\u{fa15}"
        case .textCodeBlockRegular: return "\u{fa16}"
        case .textHighlightBold: return "\u{fa17}"
        case .textHighlightLight: return "\u{fa18}"
        case .textHighlightRegular: return "\u{fa19}"
        case .textLight: return "\u{fa1a}"
        case .textRegular: return "\u{fa1b}"
        case .threeColumnBold: return "\u{fa1c}"
        case .threeColumnLight: return "\u{fa1d}"
        case .threeColumnRegular: return "\u{fa1e}"
        case .threeDObjectBold: return "\u{fa1f}"
        case .threeDObjectLight: return "\u{fa20}"
        case .threeDObjectRegular: return "\u{fa21}"
        case .tooFastBold: return "\u{fa22}"
        case .tooFastLight: return "\u{fa23}"
        case .tooFastRegular: return "\u{fa24}"
        case .tooSlowBold: return "\u{fa25}"
        case .tooSlowLight: return "\u{fa26}"
        case .tooSlowRegular: return "\u{fa27}"
        case .toolsBold: return "\u{fa28}"
        case .toolsLight: return "\u{fa29}"
        case .toolsRegular: return "\u{fa2a}"
        case .touch10Bold: return "\u{fa2b}"
        case .touch10Light: return "\u{fa2c}"
        case .touch10Regular: return "\u{fa2d}"
        case .transcriptBold: return "\u{fa2e}"
        case .transcriptFilled: return "\u{fa2f}"
        case .transcriptLight: return "\u{fa30}"
        case .transcriptRegular: return "\u{fa31}"
        case .translateBold: return "\u{fa32}"
        case .translateLight: return "\u{fa33}"
        case .translateRegular: return "\u{fa34}"
        case .trimBold: return "\u{fa35}"
        case .trimLight: return "\u{fa36}"
        case .trimRegular: return "\u{fa37}"
        case .twoColumnBold: return "\u{fa38}"
        case .twoColumnLight: return "\u{fa39}"
        case .twoColumnRegular: return "\u{fa3a}"
        case .ucmCloudBold: return "\u{fa3b}"
        case .ucmCloudLight: return "\u{fa3c}"
        case .ucmCloudRegular: return "\u{fa3d}"
        case .underlineBold: return "\u{fa3e}"
        case .underlineLight: return "\u{fa3f}"
        case .underlineRegular: return "\u{fa40}"
        case .undoBold: return "\u{fa41}"
        case .undoLight: return "\u{fa42}"
        case .undoRegular: return "\u{fa43}"
        case .unlinkBold: return "\u{fa44}"
        case .unlinkLight: return "\u{fa45}"
        case .unlinkRegular: return "\u{fa46}"
        case .unreadBold: return "\u{fa47}"
        case .unreadFilled: return "\u{fa48}"
        case .unreadLight: return "\u{fa49}"
        case .unreadRegular: return "\u{fa4a}"
        case .unsecureUnlockedBold: return "\u{fa4b}"
        case .unsecureUnlockedFilled: return "\u{fa4c}"
        case .unsecureUnlockedLight: return "\u{fa4d}"
        case .unsecureUnlockedRegular: return "\u{fa4e}"
        case .unsortedBold: return "\u{fa4f}"
        case .unsortedLight: return "\u{fa50}"
        case .unsortedRegular: return "\u{fa51}"
        case .updateFileShareBold: return "\u{fa52}"
        case .updateFileShareLight: return "\u{fa53}"
        case .updateFileShareRegular: return "\u{fa54}"
        case .upgradeBold: return "\u{fa55}"
        case .upgradeFilled: return "\u{fa56}"
        case .upgradeLight: return "\u{fa57}"
        case .upgradeRegular: return "\u{fa58}"
        case .uploadBold: return "\u{fa59}"
        case .uploadImageBold: return "\u{fa5a}"
        case .uploadImageLight: return "\u{fa5b}"
        case .uploadImageRegular: return "\u{fa5c}"
        case .uploadLight: return "\u{fa5d}"
        case .uploadRegular: return "\u{fa5e}"
        case .urgentVoicemailBold: return "\u{fa5f}"
        case .urgentVoicemailFilled: return "\u{fa60}"
        case .usbBold: return "\u{fa61}"
        case .usbHeadsetBold: return "\u{fa62}"
        case .usbHeadsetLight: return "\u{fa63}"
        case .usbHeadsetMutedBold: return "\u{fa64}"
        case .usbHeadsetMutedLight: return "\u{fa65}"
        case .usbHeadsetMutedRegular: return "\u{fa66}"
        case .usbHeadsetRegular: return "\u{fa67}"
        case .usbLight: return "\u{fa68}"
        case .usbRegular: return "\u{fa69}"
        case .userBold: return "\u{fa6a}"
        case .userDeactivateBold: return "\u{fa6b}"
        case .userDeactivateLight: return "\u{fa6c}"
        case .userDeactivateRegular: return "\u{fa6d}"
        case .userLight: return "\u{fa6e}"
        case .userRegular: return "\u{fa6f}"
        case .vcsBold: return "\u{fa70}"
        case .vcsLight: return "\u{fa71}"
        case .vcsRegular: return "\u{fa72}"
        case .videoBlurBold: return "\u{fa73}"
        case .videoBlurFilled: return "\u{fa74}"
        case .videoBlurLight: return "\u{fa75}"
        case .videoBlurRegular: return "\u{fa76}"
        case .videoBold: return "\u{fa77}"
        case .videoEffectBold: return "\u{fa78}"
        case .videoEffectFilled: return "\u{fa79}"
        case .videoEffectLight: return "\u{fa7a}"
        case .videoEffectRegular: return "\u{fa7b}"
        case .videoFilled: return "\u{fa7c}"
        case .videoLayoutBold: return "\u{fa7d}"
        case .videoLayoutEqualBold: return "\u{fa7e}"
        case .videoLayoutEqualDualBold: return "\u{fa7f}"
        case .videoLayoutEqualDualLight: return "\u{fa80}"
        case .videoLayoutEqualDualRegular: return "\u{fa81}"
        case .videoLayoutEqualFilled: return "\u{fa82}"
        case .videoLayoutEqualLight: return "\u{fa83}"
        case .videoLayoutEqualRegular: return "\u{fa84}"
        case .videoLayoutFilled: return "\u{fa85}"
        case .videoLayoutLight: return "\u{fa86}"
        case .videoLayoutOverlayBold: return "\u{fa87}"
        case .videoLayoutOverlayLight: return "\u{fa88}"
        case .videoLayoutOverlayRegular: return "\u{fa89}"
        case .videoLayoutPresenterDominantBold: return "\u{fa8a}"
        case .videoLayoutPresenterDominantLight: return "\u{fa8b}"
        case .videoLayoutPresenterDominantRegular: return "\u{fa8c}"
        case .videoLayoutProminentBold: return "\u{fa8d}"
        case .videoLayoutProminentFilled: return "\u{fa8e}"
        case .videoLayoutProminentLight: return "\u{fa8f}"
        case .videoLayoutProminentRegular: return "\u{fa90}"
        case .videoLayoutRegular: return "\u{fa91}"
        case .videoLayoutShareDominantBold: return "\u{fa92}"
        case .videoLayoutShareDominantLight: return "\u{fa93}"
        case .videoLayoutShareDominantRegular: return "\u{fa94}"
        case .videoLayoutSingleBold: return "\u{fa95}"
        case .videoLayoutSingleFilled: return "\u{fa96}"
        case .videoLayoutSingleLight: return "\u{fa97}"
        case .videoLayoutSingleRegular: return "\u{fa98}"
        case .videoLayoutStackBold: return "\u{fa99}"
        case .videoLayoutStackFilled: return "\u{fa9a}"
        case .videoLayoutStackLight: return "\u{fa9b}"
        case .videoLayoutStackRegular: return "\u{fa9c}"
        case .videoLayoutVideoDominantBold: return "\u{fa9d}"
        case .videoLayoutVideoDominantLight: return "\u{fa9e}"
        case .videoLayoutVideoDominantRegular: return "\u{fa9f}"
        case .videoLight: return "\u{faa0}"
        case .videoPlusBold: return "\u{faa1}"
        case .videoPlusFilled: return "\u{faa2}"
        case .videoPlusLight: return "\u{faa3}"
        case .videoPlusRegular: return "\u{faa4}"
        case .videoRegular: return "\u{faa5}"
        case .videoSpeakerTrackBold: return "\u{faa6}"
        case .videoSpeakerTrackFilled: return "\u{faa7}"
        case .videoSpeakerTrackLight: return "\u{faa8}"
        case .videoSpeakerTrackRegular: return "\u{faa9}"
        case .viewAllBold: return "\u{faaa}"
        case .viewAllLight: return "\u{faab}"
        case .viewAllRegular: return "\u{faac}"
        case .viewListBold: return "\u{faad}"
        case .viewListLight: return "\u{faae}"
        case .viewListRegular: return "\u{faaf}"
        case .viewStackedBold: return "\u{fab0}"
        case .viewStackedFilled: return "\u{fab1}"
        case .viewStackedLight: return "\u{fab2}"
        case .viewStackedRegular: return "\u{fab3}"
        case .viewThumbnailBold: return "\u{fab4}"
        case .viewThumbnailFilled: return "\u{fab5}"
        case .viewThumbnailLight: return "\u{fab6}"
        case .viewThumbnailRegular: return "\u{fab7}"
        case .voicemailBold: return "\u{fab8}"
        case .voicemailFilled: return "\u{fab9}"
        case .voicemailLight: return "\u{faba}"
        case .voicemailRegular: return "\u{fabb}"
        case .waffleMenuBold: return "\u{fabc}"
        case .waffleMenuLight: return "\u{fabd}"
        case .waffleMenuRegular: return "\u{fabe}"
        case .waitingroomActiveBold: return "\u{fabf}"
        case .waitingroomActiveLight: return "\u{fac0}"
        case .waitingroomActiveRegular: return "\u{fac1}"
        case .wallpaperBold: return "\u{fac2}"
        case .wallpaperLight: return "\u{fac3}"
        case .wallpaperRegular: return "\u{fac4}"
        case .warningBadgeFilled: return "\u{fac5}"
        case .warningBold: return "\u{fac6}"
        case .warningFilled: return "\u{fac7}"
        case .warningLight: return "\u{fac8}"
        case .warningRegular: return "\u{fac9}"
        case .webexAssistantActiveColored: return "\u{faca}"
        case .webexAssistantInactiveColored: return "\u{facb}"
        case .webexBoardBold: return "\u{facc}"
        case .webexBoardLight: return "\u{facd}"
        case .webexBoardRegular: return "\u{face}"
        case .webexCodecPlusBold: return "\u{facf}"
        case .webexCodecPlusLight: return "\u{fad0}"
        case .webexCodecPlusRegular: return "\u{fad1}"
        case .webexDeskCameraBold: return "\u{fad2}"
        case .webexDeskCameraLight: return "\u{fad3}"
        case .webexDeskCameraRegular: return "\u{fad4}"
        case .webexHelixFilled: return "\u{fad5}"
        case .webexMeetingsBold: return "\u{fad6}"
        case .webexMeetingsFilled: return "\u{fad7}"
        case .webexMeetingsLight: return "\u{fad8}"
        case .webexMeetingsRegular: return "\u{fad9}"
        case .webexQuadCameraBold: return "\u{fada}"
        case .webexQuadCameraLight: return "\u{fadb}"
        case .webexQuadCameraRegular: return "\u{fadc}"
        case .webexRoomKitBold: return "\u{fadd}"
        case .webexRoomKitLight: return "\u{fade}"
        case .webexRoomKitPlusBold: return "\u{fadf}"
        case .webexRoomKitPlusLight: return "\u{fae0}"
        case .webexRoomKitPlusRegular: return "\u{fae1}"
        case .webexRoomKitRegular: return "\u{fae2}"
        case .webexShareBold: return "\u{fae3}"
        case .webexShareLight: return "\u{fae4}"
        case .webexShareRegular: return "\u{fae5}"
        case .webexTeamsBold: return "\u{fae6}"
        case .webexTeamsFilled: return "\u{fae7}"
        case .webexTeamsLight: return "\u{fae8}"
        case .webexTeamsNewBold: return "\u{fae9}"
        case .webexTeamsNewFilled: return "\u{faea}"
        case .webexTeamsNewLight: return "\u{faeb}"
        case .webexTeamsNewRegular: return "\u{faec}"
        case .webexTeamsRegular: return "\u{faed}"
        case .webinarBold: return "\u{faee}"
        case .webinarFilled: return "\u{faef}"
        case .webinarLight: return "\u{faf0}"
        case .webinarRegular: return "\u{faf1}"
        case .weeklyRecurringScheduleNodeBold: return "\u{faf2}"
        case .weeklyRecurringScheduleNodeLight: return "\u{faf3}"
        case .weeklyRecurringScheduleNodeRegular: return "\u{faf4}"
        case .whatsNewBold: return "\u{faf5}"
        case .whatsNewFilled: return "\u{faf6}"
        case .whatsNewLight: return "\u{faf7}"
        case .whatsNewRegular: return "\u{faf8}"
        case .whiteboardBold: return "\u{faf9}"
        case .whiteboardContentBold: return "\u{fafa}"
        case .whiteboardContentLight: return "\u{fafb}"
        case .whiteboardContentRegular: return "\u{fafc}"
        case .whiteboardFilled: return "\u{fafd}"
        case .whiteboardLight: return "\u{fafe}"
        case .whiteboardRegular: return "\u{faff}"
        case .widgetBold: return "\u{fb00}"
        case .widgetFilled: return "\u{fb01}"
        case .widgetLight: return "\u{fb02}"
        case .widgetRegular: return "\u{fb03}"
        case .wifiBold: return "\u{fb04}"
        case .wifiErrorBold: return "\u{fb05}"
        case .wifiErrorLight: return "\u{fb06}"
        case .wifiErrorRegular: return "\u{fb07}"
        case .wifiLight: return "\u{fb08}"
        case .wifiRegular: return "\u{fb09}"
        case .wifiSignalGoodColoredBold: return "\u{fb0a}"
        case .wifiSignalGoodColoredLight: return "\u{fb0b}"
        case .wifiSignalGoodColoredRegular: return "\u{fb0c}"
        case .wifiSignalPoorColoredBold: return "\u{fb0d}"
        case .wifiSignalPoorColoredLight: return "\u{fb0e}"
        case .wifiSignalPoorColoredRegular: return "\u{fb0f}"
        case .wifiSignalUnstableColoredBold: return "\u{fb10}"
        case .wifiSignalUnstableColoredLight: return "\u{fb11}"
        case .wifiSignalUnstableColoredRegular: return "\u{fb12}"
        case .windowCornerScrubBold: return "\u{fb13}"
        case .windowCornerScrubLight: return "\u{fb14}"
        case .windowCornerScrubRegular: return "\u{fb15}"
        case .windowRightCornerScrubBold: return "\u{fb16}"
        case .windowRightCornerScrubLight: return "\u{fb17}"
        case .windowRightCornerScrubRegular: return "\u{fb18}"
        case .windowVerticalScrubBold: return "\u{fb19}"
        case .windowVerticalScrubLight: return "\u{fb1a}"
        case .windowVerticalScrubRegular: return "\u{fb1b}"
        case .workflowDeploymentsBold: return "\u{fb1c}"
        case .workflowDeploymentsFilled: return "\u{fb1d}"
        case .workflowDeploymentsLight: return "\u{fb1e}"
        case .workflowDeploymentsRegular: return "\u{fb1f}"
        case .workphoneBold: return "\u{fb20}"
        case .workphoneLight: return "\u{fb21}"
        case .workphoneRegular: return "\u{fb22}"
        case .zoomInBold: return "\u{fb23}"
        case .zoomInLight: return "\u{fb24}"
        case .zoomInRegular: return "\u{fb25}"
        case .zoomOutBold: return "\u{fb26}"
        case .zoomOutLight: return "\u{fb27}"
        case .zoomOutRegular: return "\u{fb28}"
        case .zoom: return "\u{fb29}"
