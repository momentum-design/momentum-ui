...
@objc public enum MomentumIconsRebrandType: Int {
    ...
    public var ligature: String {
        ...
        case .scanBold: return "\u{f898}"
        case .scanLight: return "\u{f899}"
        case .scanRegular: return "\u{f89a}"
        case .schedulerAvailableBold: return "\u{f89b}"
        case .schedulerAvailableLight: return "\u{f89c}"
        case .schedulerAvailableRegular: return "\u{f89d}"
        case .schedulerNotWorkingHoursBold: return "\u{f89e}"
        case .schedulerNotWorkingHoursLight: return "\u{f89f}"
        case .schedulerNotWorkingHoursRegular: return "\u{f8a0}"
        case .schedulerUnavailableBold: return "\u{f8a1}"
        case .schedulerUnavailableLight: return "\u{f8a2}"
        case .schedulerUnavailableRegular: return "\u{f8a3}"
        case .schedulerUnknownBold: return "\u{f8a4}"
        case .schedulerUnknownLight: return "\u{f8a5}"
        case .schedulerUnknownRegular: return "\u{f8a6}"
        case .screenshotBold: return "\u{f8a7}"
        case .screenshotDocBold: return "\u{f8a8}"
        case .screenshotDocFilled: return "\u{f8a9}"
        case .screenshotDocLight: return "\u{f8aa}"
        case .screenshotDocRegular: return "\u{f8ab}"
        case .screenshotLight: return "\u{f8ac}"
        case .screenshotRegular: return "\u{f8ad}"
        case .searchBold: return "\u{f8ae}"
        case .searchFilled: return "\u{f8af}"
        case .searchLight: return "\u{f8b0}"
        case .searchRegular: return "\u{f8b1}"
        case .secondaryArrowBold: return "\u{f8b2}"
        case .secondaryArrowLight: return "\u{f8b3}"
        case .secondaryArrowRegular: return "\u{f8b4}"
        case .secureCallLockBold: return "\u{f8b5}"
        case .secureCallLockFilled: return "\u{f8b6}"
        case .secureCallLockLight: return "\u{f8b7}"
        case .secureCallLockRegular: return "\u{f8b8}"
        case .secureCallShieldBold: return "\u{f8b9}"
        case .secureCallShieldFilled: return "\u{f8ba}"
        case .secureCallShieldLight: return "\u{f8bb}"
        case .secureCallShieldRegular: return "\u{f8bc}"
        case .secureCircleBold: return "\u{f8bd}"
        case .secureCircleFilled: return "\u{f8be}"
        case .secureCircleLight: return "\u{f8bf}"
        case .secureCircleRegular: return "\u{f8c0}"
        case .secureLockBold: return "\u{f8c1}"
        case .secureLockFilled: return "\u{f8c2}"
        case .secureLockLight: return "\u{f8c3}"
        case .secureLockRegular: return "\u{f8c4}"
        case .segmentExcludeFilled: return "\u{f8c5}"
        case .segmentFilterFilled: return "\u{f8c6}"
        case .segmentIncludeFilled: return "\u{f8c7}"
        case .selectAllBold: return "\u{f8c8}"
        case .selectAllFilled: return "\u{f8c9}"
        case .selectAllLight: return "\u{f8ca}"
        case .selectAllRegular: return "\u{f8cb}"
        case .selectionBold: return "\u{f8cc}"
        case .selectionLight: return "\u{f8cd}"
        case .selectionRegular: return "\u{f8ce}"
        case .sendBold: return "\u{f8cf}"
        case .sendFilled: return "\u{f8d0}"
        case .sendLight: return "\u{f8d1}"
        case .sendRegular: return "\u{f8d2}"
        case .serverBold: return "\u{f8d3}"
        case .serverErrorBold: return "\u{f8d4}"
        case .serverErrorLight: return "\u{f8d5}"
        case .serverErrorRegular: return "\u{f8d6}"
        case .serverLight: return "\u{f8d7}"
        case .serverRegular: return "\u{f8d8}"
        case .servicesBold: return "\u{f8d9}"
        case .servicesLight: return "\u{f8da}"
        case .servicesRegular: return "\u{f8db}"
        case .setVariableBold: return "\u{f8dc}"
        case .setVariableLight: return "\u{f8dd}"
        case .setVariableRegular: return "\u{f8de}"
        case .settingsBold: return "\u{f8df}"
        case .settingsFilled: return "\u{f8e0}"
        case .settingsLight: return "\u{f8e1}"
        case .settingsRegular: return "\u{f8e2}"
        case .setupAssistantBold: return "\u{f8e3}"
        case .setupAssistantLight: return "\u{f8e4}"
        case .setupAssistantRegular: return "\u{f8e5}"
        case .sftpBold: return "\u{f8e6}"
        case .sftpLight: return "\u{f8e7}"
        case .sftpRegular: return "\u{f8e8}"
        case .shapeCircleBold: return "\u{f8e9}"
        case .shapeCircleFilled: return "\u{f8ea}"
        case .shapeCircleLight: return "\u{f8eb}"
        case .shapeCircleRegular: return "\u{f8ec}"
        case .shapeDiagonalLineBold: return "\u{f8ed}"
        case .shapeDiagonalLineLight: return "\u{f8ee}"
        case .shapeDiagonalLineRegular: return "\u{f8ef}"
        case .shapeDiamondBold: return "\u{f8f0}"
        case .shapeDiamondFilled: return "\u{f8f1}"
        case .shapeDiamondLight: return "\u{f8f2}"
        case .shapeDiamondRegular: return "\u{f8f3}"
        case .shapeOvalBold: return "\u{f8f4}"
        case .shapeOvalLight: return "\u{f8f5}"
        case .shapeOvalRegular: return "\u{f8f6}"
        case .shapeSquareBold: return "\u{f8f7}"
        case .shapeSquareFilled: return "\u{f8f8}"
        case .shapeSquareLight: return "\u{f8f9}"
        case .shapeSquareRegular: return "\u{f8fa}"
        case .shapeTriangleBold: return "\u{f8fb}"
        case .shapeTriangleFilled: return "\u{f8fc}"
        case .shapeTriangleLight: return "\u{f8fd}"
        case .shapeTriangleRegular: return "\u{f8fe}"
        case .shapesBold: return "\u{f8ff}"
        case .shapesLight: return "\u{f900}"
        case .shapesRegular: return "\u{f901}"
        case .shareCNativeAdrBold: return "\u{f902}"
        case .shareCNativeAdrLight: return "\u{f903}"
        case .shareCNativeAdrRegular: return "\u{f904}"
        case .shareCNativeIphBold: return "\u{f905}"
        case .shareCNativeIphLight: return "\u{f906}"
        case .shareCNativeIphRegular: return "\u{f907}"
        case .shareScreenBold: return "\u{f908}"
        case .shareScreenFilled: return "\u{f909}"
        case .shareScreenLight: return "\u{f90a}"
        case .shareScreenRegular: return "\u{f90b}"
        case .shareScreenSmallFilled: return "\u{f90c}"
        case .shareSpaceBold: return "\u{f90d}"
        case .shareSpaceLight: return "\u{f90e}"
        case .shareSpaceRegular: return "\u{f90f}"
        case .shieldBold: return "\u{f910}"
        case .shieldLight: return "\u{f911}"
        case .shieldRegular: return "\u{f912}"
        case .shoppingCartBold: return "\u{f913}"
        case .shoppingCartFilled: return "\u{f914}"
        case .shoppingCartLight: return "\u{f915}"
        case .shoppingCartRegular: return "\u{f916}"
        case .shortTextBoxBold: return "\u{f917}"
        case .shortTextBoxLight: return "\u{f918}"
        case .shortTextBoxRegular: return "\u{f919}"
        case .showBold: return "\u{f91a}"
        case .showFilled: return "\u{f91b}"
        case .showLight: return "\u{f91c}"
        case .showRegular: return "\u{f91d}"
        case .signInBold: return "\u{f91e}"
        case .signInFilled: return "\u{f91f}"
        case .signInForcedBold: return "\u{f920}"
        case .signInForcedLight: return "\u{f921}"
        case .signInForcedRegular: return "\u{f922}"
        case .signInLight: return "\u{f923}"
        case .signInRegular: return "\u{f924}"
        case .signOutBold: return "\u{f925}"
        case .signOutLight: return "\u{f926}"
        case .signOutRegular: return "\u{f927}"
        case .signal0Bold: return "\u{f928}"
        case .signal0Light: return "\u{f929}"
        case .signal0Regular: return "\u{f92a}"
        case .signal100Bold: return "\u{f92b}"
        case .signal100Light: return "\u{f92c}"
        case .signal100Regular: return "\u{f92d}"
        case .signal25Bold: return "\u{f92e}"
        case .signal25Light: return "\u{f92f}"
        case .signal25Regular: return "\u{f930}"
        case .signal50Bold: return "\u{f931}"
        case .signal50Light: return "\u{f932}"
        case .signal50Regular: return "\u{f933}"
        case .signal75Bold: return "\u{f934}"
        case .signal75Light: return "\u{f935}"
        case .signal75Regular: return "\u{f936}"
        case .simplePromotionBold: return "\u{f937}"
        case .simplePromotionLight: return "\u{f938}"
        case .simplePromotionRegular: return "\u{f939}"
        case .singleNumberReachBold: return "\u{f93a}"
        case .singleNumberReachLight: return "\u{f93b}"
        case .singleNumberReachRegular: return "\u{f93c}"
        case .sipRegistrationInProgressBold: return "\u{f93d}"
        case .sipRegistrationInProgressFilled: return "\u{f93e}"
        case .sipRegistrationInProgressLight: return "\u{f93f}"
        case .sipRegistrationInProgressRegular: return "\u{f940}"
        case .skipBold: return "\u{f941}"
        case .skipBwBold: return "\u{f942}"
        case .skipBwFilled: return "\u{f943}"
        case .skipBwLight: return "\u{f944}"
        case .skipBwRegular: return "\u{f945}"
        case .skipFwBold: return "\u{f946}"
        case .skipFwFilled: return "\u{f947}"
        case .skipFwLight: return "\u{f948}"
        case .skipFwRegular: return "\u{f949}"
        case .skipLight: return "\u{f94a}"
        case .skipRegular: return "\u{f94b}"
        case .smsInboundBold: return "\u{f94c}"
        case .smsInboundLight: return "\u{f94d}"
        case .smsInboundRegular: return "\u{f94e}"
        case .smsMessageBold: return "\u{f94f}"
        case .smsMessageFilled: return "\u{f950}"
        case .smsMessageLight: return "\u{f951}"
        case .smsMessageRegular: return "\u{f952}"
        case .socialAlexaFilled: return "\u{f953}"
        case .socialFacebookColoredFilled: return "\u{f954}"
        case .socialFacebookFilled: return "\u{f955}"
        case .socialFbmessengerColoredFilled: return "\u{f956}"
        case .socialFbmessengerFilled: return "\u{f957}"
        case .socialInstagramBold: return "\u{f958}"
        case .socialMicrosoftColoredFilled: return "\u{f959}"
        case .socialMicrosoftFilled: return "\u{f95a}"
        case .socialMmsFilled: return "\u{f95b}"
        case .socialMmsGoldFilled: return "\u{f95c}"
        case .socialSmsFilled: return "\u{f95d}"
        case .socialSmsMintFilled: return "\u{f95e}"
        case .socialTwitterColoredFilled: return "\u{f95f}"
        case .socialTwitterFilled: return "\u{f960}"
        case .socialViberBold: return "\u{f961}"
        case .socialViberColoredBold: return "\u{f962}"
        case .socialWhatsappBold: return "\u{f963}"
        case .socialWhatsappColoredFilled: return "\u{f964}"
        case .sortAscendingBold: return "\u{f965}"
        case .sortAscendingLight: return "\u{f966}"
        case .sortAscendingRegular: return "\u{f967}"
        case .sortDescendingBold: return "\u{f968}"
        case .sortDescendingLight: return "\u{f969}"
        case .sortDescendingRegular: return "\u{f96a}"
        case .soundDefaultBold: return "\u{f96b}"
        case .soundDefaultLight: return "\u{f96c}"
        case .soundDefaultRegular: return "\u{f96d}"
        case .speakerBold: return "\u{f96e}"
        case .speakerDisconnectedBold: return "\u{f96f}"
        case .speakerDisconnectedFilled: return "\u{f970}"
        case .speakerDisconnectedLight: return "\u{f971}"
        case .speakerDisconnectedRegular: return "\u{f972}"
        case .speakerFilled: return "\u{f973}"
        case .speakerLight: return "\u{f974}"
        case .speakerMutedBold: return "\u{f975}"
        case .speakerMutedFilled: return "\u{f976}"
        case .speakerMutedLight: return "\u{f977}"
        case .speakerMutedRegular: return "\u{f978}"
        case .speakerOffBold: return "\u{f979}"
        case .speakerOffFilled: return "\u{f97a}"
        case .speakerOffLight: return "\u{f97b}"
        case .speakerOffRegular: return "\u{f97c}"
        case .speakerOnColoredBold: return "\u{f97d}"
        case .speakerOnColoredLight: return "\u{f97e}"
        case .speakerOnColoredRegular: return "\u{f97f}"
        case .speakerRegular: return "\u{f980}"
        case .speakerTurnDownBold: return "\u{f981}"
        case .speakerTurnDownFilled: return "\u{f982}"
        case .speakerTurnDownLight: return "\u{f983}"
        case .speakerTurnDownRegular: return "\u{f984}"
        case .speakerTurnUpBold: return "\u{f985}"
        case .speakerTurnUpFilled: return "\u{f986}"
        case .speakerTurnUpLight: return "\u{f987}"
        case .speakerTurnUpRegular: return "\u{f988}"
        case .spellCheckerBold: return "\u{f989}"
        case .spellCheckerLight: return "\u{f98a}"
        case .spellCheckerRegular: return "\u{f98b}"
        case .spinnerBold: return "\u{f98c}"
        case .spinnerFilledBold: return "\u{f98d}"
        case .spinnerFilledLight: return "\u{f98e}"
        case .spinnerFilledRegular: return "\u{f98f}"
        case .spinnerLight: return "\u{f990}"
        case .spinnerPartialBold: return "\u{f991}"
        case .spinnerPartialLight: return "\u{f992}"
        case .spinnerPartialRegular: return "\u{f993}"
        case .spinnerRegular: return "\u{f994}"
        case .stackedArea100ChartBold: return "\u{f995}"
        case .stackedArea100ChartFilled: return "\u{f996}"
        case .stackedArea100ChartLight: return "\u{f997}"
        case .stackedArea100ChartRegular: return "\u{f998}"
        case .stackedAreaChartBold: return "\u{f999}"
        case .stackedAreaChartFilled: return "\u{f99a}"
        case .stackedAreaChartLight: return "\u{f99b}"
        case .stackedAreaChartRegular: return "\u{f99c}"
        case .stackedBar100ChartBold: return "\u{f99d}"
        case .stackedBar100ChartFilled: return "\u{f99e}"
        case .stackedBar100ChartLight: return "\u{f99f}"
        case .stackedBar100ChartRegular: return "\u{f9a0}"
        case .stackedBarChartBold: return "\u{f9a1}"
        case .stackedBarChartFilled: return "\u{f9a2}"
        case .stackedBarChartLight: return "\u{f9a3}"
        case .stackedBarChartRegular: return "\u{f9a4}"
        case .startChatBold: return "\u{f9a5}"
        case .startChatLight: return "\u{f9a6}"
        case .startChatRegular: return "\u{f9a7}"
        case .stethoscopeBold: return "\u{f9a8}"
        case .stethoscopeLight: return "\u{f9a9}"
        case .stethoscopeRegular: return "\u{f9aa}"
        case .stickersBold: return "\u{f9ab}"
        case .stickersLight: return "\u{f9ac}"
        case .stickersRegular: return "\u{f9ad}"
        case .stickiesBold: return "\u{f9ae}"
        case .stickiesLight: return "\u{f9af}"
        case .stickiesRegular: return "\u{f9b0}"
        case .stopBold: return "\u{f9b1}"
        case .stopCircleBold: return "\u{f9b2}"
        case .stopCircleFilled: return "\u{f9b3}"
        case .stopCircleLight: return "\u{f9b4}"
        case .stopCircleRegular: return "\u{f9b5}"
        case .stopContentShareBold: return "\u{f9b6}"
        case .stopContentShareLight: return "\u{f9b7}"
        case .stopContentShareRegular: return "\u{f9b8}"
        case .stopFilled: return "\u{f9b9}"
        case .stopLight: return "\u{f9ba}"
        case .stopRegular: return "\u{f9bb}"
        case .storedInfoBold: return "\u{f9bc}"
        case .storedInfoFilled: return "\u{f9bd}"
        case .storedInfoLight: return "\u{f9be}"
        case .storedInfoRegular: return "\u{f9bf}"
        case .streamingBold: return "\u{f9c0}"
        case .streamingLight: return "\u{f9c1}"
        case .streamingRegular: return "\u{f9c2}"
        case .strikethroughBold: return "\u{f9c3}"
        case .strikethroughLight: return "\u{f9c4}"
        case .strikethroughRegular: return "\u{f9c5}"
        case .subscriptBold: return "\u{f9c6}"
        case .subscriptLight: return "\u{f9c7}"
        case .subscriptRegular: return "\u{f9c8}"
        case .superscriptBold: return "\u{f9c9}"
        case .superscriptLight: return "\u{f9ca}"
        case .superscriptRegular: return "\u{f9cb}"
        case .surveyBold: return "\u{f9cc}"
        case .surveyFilled: return "\u{f9cd}"
        case .surveyLight: return "\u{f9ce}"
        case .surveyRegular: return "\u{f9cf}"
        case .sx10Bold: return "\u{f9d0}"
        case .sx10Light: return "\u{f9d1}"
        case .sx10Regular: return "\u{f9d2}"
        case .sx20Bold: return "\u{f9d3}"
        case .sx20Light: return "\u{f9d4}"
        case .sx20Regular: return "\u{f9d5}"
        case .sx80CodecBold: return "\u{f9d6}"
        case .sx80CodecLight: return "\u{f9d7}"
        case .sx80CodecRegular: return "\u{f9d8}"
        case .tableBold: return "\u{f9d9}"
        case .tableLight: return "\u{f9da}"
        case .tableRegular: return "\u{f9db}"
        case .tabletBold: return "\u{f9dc}"
        case .tabletLight: return "\u{f9dd}"
        case .tabletRegular: return "\u{f9de}"
        case .tabsBold: return "\u{f9df}"
        case .tabsLight: return "\u{f9e0}"
        case .tabsRegular: return "\u{f9e1}"
        case .tagBold: return "\u{f9e2}"
        case .tagLight: return "\u{f9e3}"
        case .tagRegular: return "\u{f9e4}"
        case .tapBold: return "\u{f9e5}"
        case .tapFilled: return "\u{f9e6}"
        case .tapLight: return "\u{f9e7}"
        case .tapRegular: return "\u{f9e8}"
        case .telepresenceAlertBold: return "\u{f9e9}"
        case .telepresenceAlertLight: return "\u{f9ea}"
        case .telepresenceAlertMutedBold: return "\u{f9eb}"
        case .telepresenceAlertMutedLight: return "\u{f9ec}"
        case .telepresenceAlertMutedRegular: return "\u{f9ed}"
        case .telepresenceAlertRegular: return "\u{f9ee}"
        case .telepresenceBold: return "\u{f9ef}"
        case .telepresenceIx5000Bold: return "\u{f9f0}"
        case .telepresenceIx5000Light: return "\u{f9f1}"
        case .telepresenceIx5000Regular: return "\u{f9f2}"
        case .telepresenceLight: return "\u{f9f3}"
        case .telepresencePrivateBold: return "\u{f9f4}"
        case .telepresencePrivateLight: return "\u{f9f5}"
        case .telepresencePrivateRegular: return "\u{f9f6}"
        case .telepresenceRegular: return "\u{f9f7}"
        case .temperatureBold: return "\u{f9f8}"
        case .temperatureLight: return "\u{f9f9}"
        case .temperatureRegular: return "\u{f9fa}"
        case .textAlignCenterBold: return "\u{f9fb}"
        case .textAlignCenterFilled: return "\u{f9fc}"
        case .textAlignCenterLight: return "\u{f9fd}"
        case .textAlignCenterRegular: return "\u{f9fe}"
        case .textAlignLeftBold: return "\u{f9ff}"
        case .textAlignLeftFilled: return "\u{fa00}"
        case .textAlignLeftLight: return "\u{fa01}"
        case .textAlignLeftRegular: return "\u{fa02}"
        case .textAlignRightBold: return "\u{fa03}"
        case .textAlignRightFilled: return "\u{fa04}"
        case .textAlignRightLight: return "\u{fa05}"
        case .textAlignRightRegular: return "\u{fa06}"
        case .textBold: return "\u{fa07}"
        case .textCodeBlockBold: return "\u{fa08}"
        case .textCodeBlockLight: return "\u{fa09}"
        case .textCodeBlockRegular: return "\u{fa0a}"
        case .textHighlightBold: return "\u{fa0b}"
        case .textHighlightLight: return "\u{fa0c}"
        case .textHighlightRegular: return "\u{fa0d}"
        case .textLight: return "\u{fa0e}"
        case .textRegular: return "\u{fa0f}"
        case .threeColumnBold: return "\u{fa10}"
        case .threeColumnLight: return "\u{fa11}"
        case .threeColumnRegular: return "\u{fa12}"
        case .threeDObjectBold: return "\u{fa13}"
        case .threeDObjectLight: return "\u{fa14}"
        case .threeDObjectRegular: return "\u{fa15}"
        case .tooFastBold: return "\u{fa16}"
        case .tooFastLight: return "\u{fa17}"
        case .tooFastRegular: return "\u{fa18}"
        case .tooSlowBold: return "\u{fa19}"
        case .tooSlowLight: return "\u{fa1a}"
        case .tooSlowRegular: return "\u{fa1b}"
        case .toolsBold: return "\u{fa1c}"
        case .toolsLight: return "\u{fa1d}"
        case .toolsRegular: return "\u{fa1e}"
        case .touch10Bold: return "\u{fa1f}"
        case .touch10Light: return "\u{fa20}"
        case .touch10Regular: return "\u{fa21}"
        case .transcriptBold: return "\u{fa22}"
        case .transcriptFilled: return "\u{fa23}"
        case .transcriptLight: return "\u{fa24}"
        case .transcriptRegular: return "\u{fa25}"
        case .translateBold: return "\u{fa26}"
        case .translateLight: return "\u{fa27}"
        case .translateRegular: return "\u{fa28}"
        case .trimBold: return "\u{fa29}"
        case .trimLight: return "\u{fa2a}"
        case .trimRegular: return "\u{fa2b}"
        case .twoColumnBold: return "\u{fa2c}"
        case .twoColumnLight: return "\u{fa2d}"
        case .twoColumnRegular: return "\u{fa2e}"
        case .ucmCloudBold: return "\u{fa2f}"
        case .ucmCloudLight: return "\u{fa30}"
        case .ucmCloudRegular: return "\u{fa31}"
        case .underlineBold: return "\u{fa32}"
        case .underlineLight: return "\u{fa33}"
        case .underlineRegular: return "\u{fa34}"
        case .undoBold: return "\u{fa35}"
        case .undoLight: return "\u{fa36}"
        case .undoRegular: return "\u{fa37}"
        case .unlinkBold: return "\u{fa38}"
        case .unlinkLight: return "\u{fa39}"
        case .unlinkRegular: return "\u{fa3a}"
        case .unreadBold: return "\u{fa3b}"
        case .unreadFilled: return "\u{fa3c}"
        case .unreadLight: return "\u{fa3d}"
        case .unreadRegular: return "\u{fa3e}"
        case .unsecureUnlockedBold: return "\u{fa3f}"
        case .unsecureUnlockedFilled: return "\u{fa40}"
        case .unsecureUnlockedLight: return "\u{fa41}"
        case .unsecureUnlockedRegular: return "\u{fa42}"
        case .unsortedBold: return "\u{fa43}"
        case .unsortedLight: return "\u{fa44}"
        case .unsortedRegular: return "\u{fa45}"
        case .updateFileShareBold: return "\u{fa46}"
        case .updateFileShareLight: return "\u{fa47}"
        case .updateFileShareRegular: return "\u{fa48}"
        case .upgradeBold: return "\u{fa49}"
        case .upgradeFilled: return "\u{fa4a}"
        case .upgradeLight: return "\u{fa4b}"
        case .upgradeRegular: return "\u{fa4c}"
        case .uploadBold: return "\u{fa4d}"
        case .uploadImageBold: return "\u{fa4e}"
        case .uploadImageLight: return "\u{fa4f}"
        case .uploadImageRegular: return "\u{fa50}"
        case .uploadLight: return "\u{fa51}"
        case .uploadRegular: return "\u{fa52}"
        case .urgentVoicemailBold: return "\u{fa53}"
        case .urgentVoicemailFilled: return "\u{fa54}"
        case .usbBold: return "\u{fa55}"
        case .usbHeadsetBold: return "\u{fa56}"
        case .usbHeadsetLight: return "\u{fa57}"
        case .usbHeadsetMutedBold: return "\u{fa58}"
        case .usbHeadsetMutedLight: return "\u{fa59}"
        case .usbHeadsetMutedRegular: return "\u{fa5a}"
        case .usbHeadsetRegular: return "\u{fa5b}"
        case .usbLight: return "\u{fa5c}"
        case .usbRegular: return "\u{fa5d}"
        case .userBold: return "\u{fa5e}"
        case .userDeactivateBold: return "\u{fa5f}"
        case .userDeactivateLight: return "\u{fa60}"
        case .userDeactivateRegular: return "\u{fa61}"
        case .userLight: return "\u{fa62}"
        case .userRegular: return "\u{fa63}"
        case .vcsBold: return "\u{fa64}"
        case .vcsLight: return "\u{fa65}"
        case .vcsRegular: return "\u{fa66}"
        case .videoBlurBold: return "\u{fa67}"
        case .videoBlurFilled: return "\u{fa68}"
        case .videoBlurLight: return "\u{fa69}"
        case .videoBlurRegular: return "\u{fa6a}"
        case .videoBold: return "\u{fa6b}"
        case .videoEffectBold: return "\u{fa6c}"
        case .videoEffectFilled: return "\u{fa6d}"
        case .videoEffectLight: return "\u{fa6e}"
        case .videoEffectRegular: return "\u{fa6f}"
        case .videoFilled: return "\u{fa70}"
        case .videoLayoutBold: return "\u{fa71}"
        case .videoLayoutEqualBold: return "\u{fa72}"
        case .videoLayoutEqualDualBold: return "\u{fa73}"
        case .videoLayoutEqualDualLight: return "\u{fa74}"
        case .videoLayoutEqualDualRegular: return "\u{fa75}"
        case .videoLayoutEqualFilled: return "\u{fa76}"
        case .videoLayoutEqualLight: return "\u{fa77}"
        case .videoLayoutEqualRegular: return "\u{fa78}"
        case .videoLayoutFilled: return "\u{fa79}"
        case .videoLayoutLight: return "\u{fa7a}"
        case .videoLayoutOverlayBold: return "\u{fa7b}"
        case .videoLayoutOverlayLight: return "\u{fa7c}"
        case .videoLayoutOverlayRegular: return "\u{fa7d}"
        case .videoLayoutPresenterDominantBold: return "\u{fa7e}"
        case .videoLayoutPresenterDominantLight: return "\u{fa7f}"
        case .videoLayoutPresenterDominantRegular: return "\u{fa80}"
        case .videoLayoutProminentBold: return "\u{fa81}"
        case .videoLayoutProminentFilled: return "\u{fa82}"
        case .videoLayoutProminentLight: return "\u{fa83}"
        case .videoLayoutProminentRegular: return "\u{fa84}"
        case .videoLayoutRegular: return "\u{fa85}"
        case .videoLayoutShareDominantBold: return "\u{fa86}"
        case .videoLayoutShareDominantLight: return "\u{fa87}"
        case .videoLayoutShareDominantRegular: return "\u{fa88}"
        case .videoLayoutSingleBold: return "\u{fa89}"
        case .videoLayoutSingleFilled: return "\u{fa8a}"
        case .videoLayoutSingleLight: return "\u{fa8b}"
        case .videoLayoutSingleRegular: return "\u{fa8c}"
        case .videoLayoutStackBold: return "\u{fa8d}"
        case .videoLayoutStackFilled: return "\u{fa8e}"
        case .videoLayoutStackLight: return "\u{fa8f}"
        case .videoLayoutStackRegular: return "\u{fa90}"
        case .videoLayoutVideoDominantBold: return "\u{fa91}"
        case .videoLayoutVideoDominantLight: return "\u{fa92}"
        case .videoLayoutVideoDominantRegular: return "\u{fa93}"
        case .videoLight: return "\u{fa94}"
        case .videoPlusBold: return "\u{fa95}"
        case .videoPlusFilled: return "\u{fa96}"
        case .videoPlusLight: return "\u{fa97}"
        case .videoPlusRegular: return "\u{fa98}"
        case .videoRegular: return "\u{fa99}"
        case .videoSpeakerTrackBold: return "\u{fa9a}"
        case .videoSpeakerTrackFilled: return "\u{fa9b}"
        case .videoSpeakerTrackLight: return "\u{fa9c}"
        case .videoSpeakerTrackRegular: return "\u{fa9d}"
        case .viewAllBold: return "\u{fa9e}"
        case .viewAllLight: return "\u{fa9f}"
        case .viewAllRegular: return "\u{faa0}"
        case .viewListBold: return "\u{faa1}"
        case .viewListLight: return "\u{faa2}"
        case .viewListRegular: return "\u{faa3}"
        case .viewStackedBold: return "\u{faa4}"
        case .viewStackedFilled: return "\u{faa5}"
        case .viewStackedLight: return "\u{faa6}"
        case .viewStackedRegular: return "\u{faa7}"
        case .viewThumbnailBold: return "\u{faa8}"
        case .viewThumbnailFilled: return "\u{faa9}"
        case .viewThumbnailLight: return "\u{faaa}"
        case .viewThumbnailRegular: return "\u{faab}"
        case .voicemailBold: return "\u{faac}"
        case .voicemailFilled: return "\u{faad}"
        case .voicemailLight: return "\u{faae}"
        case .voicemailRegular: return "\u{faaf}"
        case .waffleMenuBold: return "\u{fab0}"
        case .waffleMenuLight: return "\u{fab1}"
        case .waffleMenuRegular: return "\u{fab2}"
        case .waitingroomActiveBold: return "\u{fab3}"
        case .waitingroomActiveLight: return "\u{fab4}"
        case .waitingroomActiveRegular: return "\u{fab5}"
        case .wallpaperBold: return "\u{fab6}"
        case .wallpaperLight: return "\u{fab7}"
        case .wallpaperRegular: return "\u{fab8}"
        case .warningBadgeFilled: return "\u{fab9}"
        case .warningBold: return "\u{faba}"
        case .warningFilled: return "\u{fabb}"
        case .warningLight: return "\u{fabc}"
        case .warningRegular: return "\u{fabd}"
        case .webexAssistantActiveColored: return "\u{fabe}"
        case .webexAssistantInactiveColored: return "\u{fabf}"
        case .webexBoardBold: return "\u{fac0}"
        case .webexBoardLight: return "\u{fac1}"
        case .webexBoardRegular: return "\u{fac2}"
        case .webexCodecPlusBold: return "\u{fac3}"
        case .webexCodecPlusLight: return "\u{fac4}"
        case .webexCodecPlusRegular: return "\u{fac5}"
        case .webexDeskCameraBold: return "\u{fac6}"
        case .webexDeskCameraLight: return "\u{fac7}"
        case .webexDeskCameraRegular: return "\u{fac8}"
        case .webexHelixFilled: return "\u{fac9}"
        case .webexMeetingsBold: return "\u{faca}"
        case .webexMeetingsFilled: return "\u{facb}"
        case .webexMeetingsLight: return "\u{facc}"
        case .webexMeetingsRegular: return "\u{facd}"
        case .webexQuadCameraBold: return "\u{face}"
        case .webexQuadCameraLight: return "\u{facf}"
        case .webexQuadCameraRegular: return "\u{fad0}"
        case .webexRoomKitBold: return "\u{fad1}"
        case .webexRoomKitLight: return "\u{fad2}"
        case .webexRoomKitPlusBold: return "\u{fad3}"
        case .webexRoomKitPlusLight: return "\u{fad4}"
        case .webexRoomKitPlusRegular: return "\u{fad5}"
        case .webexRoomKitRegular: return "\u{fad6}"
        case .webexShareBold: return "\u{fad7}"
        case .webexShareLight: return "\u{fad8}"
        case .webexShareRegular: return "\u{fad9}"
        case .webexTeamsBold: return "\u{fada}"
        case .webexTeamsFilled: return "\u{fadb}"
        case .webexTeamsLight: return "\u{fadc}"
        case .webexTeamsNewBold: return "\u{fadd}"
        case .webexTeamsNewFilled: return "\u{fade}"
        case .webexTeamsNewLight: return "\u{fadf}"
        case .webexTeamsNewRegular: return "\u{fae0}"
        case .webexTeamsRegular: return "\u{fae1}"
        case .webinarBold: return "\u{fae2}"
        case .webinarFilled: return "\u{fae3}"
        case .webinarLight: return "\u{fae4}"
        case .webinarRegular: return "\u{fae5}"
        case .weeklyRecurringScheduleNodeBold: return "\u{fae6}"
        case .weeklyRecurringScheduleNodeLight: return "\u{fae7}"
        case .weeklyRecurringScheduleNodeRegular: return "\u{fae8}"
        case .whiteboardBold: return "\u{fae9}"
        case .whiteboardContentBold: return "\u{faea}"
        case .whiteboardContentLight: return "\u{faeb}"
        case .whiteboardContentRegular: return "\u{faec}"
        case .whiteboardFilled: return "\u{faed}"
        case .whiteboardLight: return "\u{faee}"
        case .whiteboardRegular: return "\u{faef}"
        case .widgetBold: return "\u{faf0}"
        case .widgetFilled: return "\u{faf1}"
        case .widgetLight: return "\u{faf2}"
        case .widgetRegular: return "\u{faf3}"
        case .wifiBold: return "\u{faf4}"
        case .wifiErrorBold: return "\u{faf5}"
        case .wifiErrorLight: return "\u{faf6}"
        case .wifiErrorRegular: return "\u{faf7}"
        case .wifiLight: return "\u{faf8}"
        case .wifiRegular: return "\u{faf9}"
        case .wifiSignalGoodColoredBold: return "\u{fafa}"
        case .wifiSignalGoodColoredLight: return "\u{fafb}"
        case .wifiSignalGoodColoredRegular: return "\u{fafc}"
        case .wifiSignalPoorColoredBold: return "\u{fafd}"
        case .wifiSignalPoorColoredLight: return "\u{fafe}"
        case .wifiSignalPoorColoredRegular: return "\u{faff}"
        case .wifiSignalUnstableColoredBold: return "\u{fb00}"
        case .wifiSignalUnstableColoredLight: return "\u{fb01}"
        case .wifiSignalUnstableColoredRegular: return "\u{fb02}"
        case .windowCornerScrubBold: return "\u{fb03}"
        case .windowCornerScrubLight: return "\u{fb04}"
        case .windowCornerScrubRegular: return "\u{fb05}"
        case .windowRightCornerScrubBold: return "\u{fb06}"
        case .windowRightCornerScrubLight: return "\u{fb07}"
        case .windowRightCornerScrubRegular: return "\u{fb08}"
        case .windowVerticalScrubBold: return "\u{fb09}"
        case .windowVerticalScrubLight: return "\u{fb0a}"
        case .windowVerticalScrubRegular: return "\u{fb0b}"
        case .workflowDeploymentsBold: return "\u{fb0c}"
        case .workflowDeploymentsFilled: return "\u{fb0d}"
        case .workflowDeploymentsLight: return "\u{fb0e}"
        case .workflowDeploymentsRegular: return "\u{fb0f}"
        case .workphoneBold: return "\u{fb10}"
        case .workphoneLight: return "\u{fb11}"
        case .workphoneRegular: return "\u{fb12}"
        case .zoomInBold: return "\u{fb13}"
        case .zoomInLight: return "\u{fb14}"
        case .zoomInRegular: return "\u{fb15}"
        case .zoomOutBold: return "\u{fb16}"
        case .zoomOutLight: return "\u{fb17}"
        case .zoomOutRegular: return "\u{fb18}"
        case .zoom: return "\u{fb19}"
