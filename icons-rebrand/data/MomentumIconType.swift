...
@objc public enum MomentumIconType: Int {
    ...
    public var ligature: String {
        ...
        case .cloudFrameRegular: return "\u{f2bd}"
        case .cloudFramedFilled: return "\u{f2be}"
        case .cloudFramedLight: return "\u{f2bf}"
        case .cloudLight: return "\u{f2c0}"
        case .cloudRegular: return "\u{f2c1}"
        case .cloudUploadBold: return "\u{f2c2}"
        case .cloudUploadLight: return "\u{f2c3}"
        case .cloudUploadRegular: return "\u{f2c4}"
        case .codeBlockBold: return "\u{f2c5}"
        case .codeBlockLight: return "\u{f2c6}"
        case .codeBlockRegular: return "\u{f2c7}"
        case .colorBold: return "\u{f2c8}"
        case .colorLight: return "\u{f2c9}"
        case .colorRegular: return "\u{f2ca}"
        case .commentingBold: return "\u{f2cb}"
        case .commentingFilled: return "\u{f2cc}"
        case .commentingLight: return "\u{f2cd}"
        case .commentingRegular: return "\u{f2ce}"
        case .companyBold: return "\u{f2cf}"
        case .companyLight: return "\u{f2d0}"
        case .companyRegular: return "\u{f2d1}"
        case .computerBold: return "\u{f2d2}"
        case .computerLight: return "\u{f2d3}"
        case .computerRegular: return "\u{f2d4}"
        case .conciergeBold: return "\u{f2d5}"
        case .conciergeLight: return "\u{f2d6}"
        case .conciergeRegular: return "\u{f2d7}"
        case .contactCardBold: return "\u{f2d8}"
        case .contactCardFilled: return "\u{f2d9}"
        case .contactCardLight: return "\u{f2da}"
        case .contactCardRegular: return "\u{f2db}"
        case .contactGroupBold: return "\u{f2dc}"
        case .contactGroupFilled: return "\u{f2dd}"
        case .contactGroupLight: return "\u{f2de}"
        case .contactGroupRegular: return "\u{f2df}"
        case .contactsBold: return "\u{f2e0}"
        case .contactsFilled: return "\u{f2e1}"
        case .contactsLight: return "\u{f2e2}"
        case .contactsRegular: return "\u{f2e3}"
        case .contentDownloadBold: return "\u{f2e4}"
        case .contentDownloadFilled: return "\u{f2e5}"
        case .contentDownloadLight: return "\u{f2e6}"
        case .contentDownloadRegular: return "\u{f2e7}"
        case .contentShareBold: return "\u{f2e8}"
        case .contentShareLight: return "\u{f2e9}"
        case .contentShareRegular: return "\u{f2ea}"
        case .contrastBold: return "\u{f2eb}"
        case .contrastLight: return "\u{f2ec}"
        case .contrastRegular: return "\u{f2ed}"
        case .copyBold: return "\u{f2ee}"
        case .copyLight: return "\u{f2ef}"
        case .copyRegular: return "\u{f2f0}"
        case .cpuBold: return "\u{f2f1}"
        case .cpuLight: return "\u{f2f2}"
        case .cpuRegular: return "\u{f2f3}"
        case .cropBold: return "\u{f2f4}"
        case .cropLight: return "\u{f2f5}"
        case .cropRegular: return "\u{f2f6}"
        case .cucmConnectionBold: return "\u{f2f7}"
        case .cucmConnectionLight: return "\u{f2f8}"
        case .cucmConnectionRegular: return "\u{f2f9}"
        case .dashboardBold: return "\u{f2fa}"
        case .dashboardFilled: return "\u{f2fb}"
        case .dashboardLight: return "\u{f2fc}"
        case .dashboardRegular: return "\u{f2fd}"
        case .deleteBold: return "\u{f2fe}"
        case .deleteLight: return "\u{f2ff}"
        case .deleteRegular: return "\u{f300}"
        case .deskPhoneBold: return "\u{f301}"
        case .deskPhoneLight: return "\u{f302}"
        case .deskPhoneRegular: return "\u{f303}"
        case .deskPhoneWarningBold: return "\u{f304}"
        case .deskPhoneWarningLight: return "\u{f305}"
        case .deskPhoneWarningRegular: return "\u{f306}"
        case .deviceConnectionBold: return "\u{f307}"
        case .deviceConnectionFilled: return "\u{f308}"
        case .deviceConnectionLight: return "\u{f309}"
        case .deviceConnectionRegular: return "\u{f30a}"
        case .diagnosticsBold: return "\u{f30b}"
        case .diagnosticsLight: return "\u{f30c}"
        case .diagnosticsRegular: return "\u{f30d}"
        case .dialpadBold: return "\u{f30e}"
        case .dialpadLight: return "\u{f30f}"
        case .dialpadRegular: return "\u{f310}"
        case .directoryBold: return "\u{f311}"
        case .directoryLight: return "\u{f312}"
        case .directoryRegular: return "\u{f313}"
        case .discBold: return "\u{f314}"
        case .discDisconnectedBold: return "\u{f315}"
        case .discDisconnectedLight: return "\u{f316}"
        case .discDisconnectedRegular: return "\u{f317}"
        case .discLight: return "\u{f318}"
        case .discRegular: return "\u{f319}"
        case .disconnectBold: return "\u{f31a}"
        case .disconnectLight: return "\u{f31b}"
        case .disconnectRegular: return "\u{f31c}"
        case .dislikeBold: return "\u{f31d}"
        case .dislikeFilled: return "\u{f31e}"
        case .dislikeLight: return "\u{f31f}"
        case .dislikeRegular: return "\u{f320}"
        case .displayBold: return "\u{f321}"
        case .displayInputBold: return "\u{f322}"
        case .displayInputLight: return "\u{f323}"
        case .displayInputRegular: return "\u{f324}"
        case .displayLight: return "\u{f325}"
        case .displayRegular: return "\u{f326}"
        case .displayWarningBold: return "\u{f327}"
        case .displayWarningLight: return "\u{f328}"
        case .displayWarningRegular: return "\u{f329}"
        case .dndPresenceBold: return "\u{f32a}"
        case .dndPresenceFilled: return "\u{f32b}"
        case .dndPresenceLight: return "\u{f32c}"
        case .dndPresenceRegular: return "\u{f32d}"
        case .documentBold: return "\u{f32e}"
        case .documentCameraBold: return "\u{f32f}"
        case .documentCameraDisconnectedBold: return "\u{f330}"
        case .documentCameraDisconnectedLight: return "\u{f331}"
        case .documentCameraDisconnectedRegular: return "\u{f332}"
        case .documentCameraLight: return "\u{f333}"
        case .documentCameraRegular: return "\u{f334}"
        case .documentCreateBold: return "\u{f335}"
        case .documentCreateFilled: return "\u{f336}"
        case .documentCreateLight: return "\u{f337}"
        case .documentCreateRegular: return "\u{f338}"
        case .documentFilled: return "\u{f339}"
        case .documentLight: return "\u{f33a}"
        case .documentMoveBold: return "\u{f33b}"
        case .documentMoveFilled: return "\u{f33c}"
        case .documentMoveLight: return "\u{f33d}"
        case .documentMoveRegular: return "\u{f33e}"
        case .documentRegular: return "\u{f33f}"
        case .documentShareBold: return "\u{f340}"
        case .documentShareFilled: return "\u{f341}"
        case .documentShareLight: return "\u{f342}"
        case .documentShareRegular: return "\u{f343}"
        case .donutChartBold: return "\u{f344}"
        case .donutChartFilled: return "\u{f345}"
        case .donutChartLight: return "\u{f346}"
        case .donutChartRegular: return "\u{f347}"
        case .downloadBold: return "\u{f348}"
        case .downloadFilled: return "\u{f349}"
        case .downloadLight: return "\u{f34a}"
        case .downloadRegular: return "\u{f34b}"
        case .dragBold: return "\u{f34c}"
        case .dragLight: return "\u{f34d}"
        case .dragRegular: return "\u{f34e}"
        case .dx70Bold: return "\u{f34f}"
        case .dx70Light: return "\u{f350}"
        case .dx70Regular: return "\u{f351}"
        case .dx80Bold: return "\u{f352}"
        case .dx80Light: return "\u{f353}"
        case .dx80Regular: return "\u{f354}"
        case .editBold: return "\u{f355}"
        case .editLight: return "\u{f356}"
        case .editRegular: return "\u{f357}"
        case .emailBold: return "\u{f358}"
        case .emailFilled: return "\u{f359}"
        case .emailInviteBold: return "\u{f35a}"
        case .emailInviteLight: return "\u{f35b}"
        case .emailInviteRegular: return "\u{f35c}"
        case .emailLight: return "\u{f35d}"
        case .emailReadBold: return "\u{f35e}"
        case .emailReadFilled: return "\u{f35f}"
        case .emailReadLight: return "\u{f360}"
        case .emailReadRegular: return "\u{f361}"
        case .emailRegular: return "\u{f362}"
        case .emojiHappyBold: return "\u{f363}"
        case .emojiHappyFilled: return "\u{f364}"
        case .emojiHappyLight: return "\u{f365}"
        case .emojiHappyRegular: return "\u{f366}"
        case .emojiPassiveBold: return "\u{f367}"
        case .emojiPassiveFilled: return "\u{f368}"
        case .emojiPassiveLight: return "\u{f369}"
        case .emojiPassiveRegular: return "\u{f36a}"
        case .emojiSadBold: return "\u{f36b}"
        case .emojiSadFilled: return "\u{f36c}"
        case .emojiSadLight: return "\u{f36d}"
        case .emojiSadRegular: return "\u{f36e}"
        case .encryptionFilled: return "\u{f36f}"
        case .endRemoteDesktopControlBold: return "\u{f370}"
        case .endRemoteDesktopControlLight: return "\u{f371}"
        case .endRemoteDesktopControlRegular: return "\u{f372}"
        case .endToEndEncryptionFilled: return "\u{f373}"
        case .endpointBlockedBold: return "\u{f374}"
        case .endpointBlockedLight: return "\u{f375}"
        case .endpointBlockedRegular: return "\u{f376}"
        case .endpointBold: return "\u{f377}"
        case .endpointG270Bold: return "\u{f378}"
        case .endpointG270DualBold: return "\u{f379}"
        case .endpointG270DualLight: return "\u{f37a}"
        case .endpointG270DualRegular: return "\u{f37b}"
        case .endpointG270Light: return "\u{f37c}"
        case .endpointG270Regular: return "\u{f37d}"
        case .endpointG2Bold: return "\u{f37e}"
        case .endpointG2Light: return "\u{f37f}"
        case .endpointG2Regular: return "\u{f380}"
        case .endpointG2StandBold: return "\u{f381}"
        case .endpointG2StandLight: return "\u{f382}"
        case .endpointG2StandRegular: return "\u{f383}"
        case .endpointLight: return "\u{f384}"
        case .endpointMx800Bold: return "\u{f385}"
        case .endpointMx800DualBold: return "\u{f386}"
        case .endpointMx800DualLight: return "\u{f387}"
        case .endpointMx800DualRegular: return "\u{f388}"
        case .endpointMx800Light: return "\u{f389}"
        case .endpointMx800Regular: return "\u{f38a}"
        case .endpointRegular: return "\u{f38b}"
        case .endpointStandBold: return "\u{f38c}"
        case .endpointStandLight: return "\u{f38d}"
        case .endpointStandRegular: return "\u{f38e}"
        case .endpointWarningBold: return "\u{f38f}"
        case .endpointWarningLight: return "\u{f390}"
        case .endpointWarningRegular: return "\u{f391}"
        case .enterBold: return "\u{f392}"
        case .enterLight: return "\u{f393}"
        case .enterRegular: return "\u{f394}"
        case .enterRoomBold: return "\u{f395}"
        case .enterRoomLight: return "\u{f396}"
        case .enterRoomRegular: return "\u{f397}"
        case .eraserBold: return "\u{f398}"
        case .eraserFilled: return "\u{f399}"
        case .eraserLight: return "\u{f39a}"
        case .eraserRegular: return "\u{f39b}"
        case .errorLegacyBold: return "\u{f39c}"
        case .errorLegacyFilled: return "\u{f39d}"
        case .errorLegacyLight: return "\u{f39e}"
        case .errorLegacyRegular: return "\u{f39f}"
        case .ethernetBold: return "\u{f3a0}"
        case .ethernetLight: return "\u{f3a1}"
        case .ethernetRegular: return "\u{f3a2}"
        case .exitRoomBold: return "\u{f3a3}"
        case .exitRoomLight: return "\u{f3a4}"
        case .exitRoomRegular: return "\u{f3a5}"
        case .exploreBold: return "\u{f3a6}"
        case .exploreLight: return "\u{f3a7}"
        case .exploreRegular: return "\u{f3a8}"
        case .exportBold: return "\u{f3a9}"
        case .exportLight: return "\u{f3aa}"
        case .exportRegular: return "\u{f3ab}"
        case .extensionMobilityBold: return "\u{f3ac}"
        case .extensionMobilityLight: return "\u{f3ad}"
        case .extensionMobilityRegular: return "\u{f3ae}"
        case .externalMessageBold: return "\u{f3af}"
        case .externalMessageLight: return "\u{f3b0}"
        case .externalMessageRegular: return "\u{f3b1}"
        case .externalUserBold: return "\u{f3b2}"
        case .externalUserLight: return "\u{f3b3}"
        case .externalUserRegular: return "\u{f3b4}"
        case .familyFontBold: return "\u{f3b5}"
        case .familyFontLight: return "\u{f3b6}"
        case .familyFontRegular: return "\u{f3b7}"
        case .fastForwardBold: return "\u{f3b8}"
        case .fastForwardLight: return "\u{f3b9}"
        case .fastForwardRegular: return "\u{f3ba}"
        case .favoriteBold: return "\u{f3bb}"
        case .favoriteFilled: return "\u{f3bc}"
        case .favoriteLight: return "\u{f3bd}"
        case .favoriteRegular: return "\u{f3be}"
        case .favoritesBold: return "\u{f3bf}"
        case .favoritesFilled: return "\u{f3c0}"
        case .favoritesLight: return "\u{f3c1}"
        case .favoritesRegular: return "\u{f3c2}"
        case .fbwBold: return "\u{f3c3}"
        case .fbwFilled: return "\u{f3c4}"
        case .fbwLight: return "\u{f3c5}"
        case .fbwRegular: return "\u{f3c6}"
        case .ffwBold: return "\u{f3c7}"
        case .ffwFilled: return "\u{f3c8}"
        case .ffwLight: return "\u{f3c9}"
        case .ffwRegular: return "\u{f3ca}"
        case .file3DBold: return "\u{f3cb}"
        case .file3DFilled: return "\u{f3cc}"
        case .file3DLight: return "\u{f3cd}"
        case .file3DRegular: return "\u{f3ce}"
        case .fileAnalysisBold: return "\u{f3cf}"
        case .fileAnalysisFilled: return "\u{f3d0}"
        case .fileAnalysisLight: return "\u{f3d1}"
        case .fileAnalysisRegular: return "\u{f3d2}"
        case .fileAnnotationBold: return "\u{f3d3}"
        case .fileAnnotationFilled: return "\u{f3d4}"
        case .fileAnnotationLight: return "\u{f3d5}"
        case .fileAnnotationRegular: return "\u{f3d6}"
        case .fileAudioBold: return "\u{f3d7}"
        case .fileAudioFilled: return "\u{f3d8}"
        case .fileAudioLight: return "\u{f3d9}"
        case .fileAudioRegular: return "\u{f3da}"
        case .fileBugBold: return "\u{f3db}"
        case .fileBugFilled: return "\u{f3dc}"
        case .fileBugLight: return "\u{f3dd}"
        case .fileBugRegular: return "\u{f3de}"
        case .fileCodeBold: return "\u{f3df}"
        case .fileCodeFilled: return "\u{f3e0}"
        case .fileCodeLight: return "\u{f3e1}"
        case .fileCodeRegular: return "\u{f3e2}"
        case .fileDashboardBold: return "\u{f3e3}"
        case .fileDashboardFilled: return "\u{f3e4}"
        case .fileDashboardLight: return "\u{f3e5}"
        case .fileDashboardRegular: return "\u{f3e6}"
        case .fileExcelBold: return "\u{f3e7}"
        case .fileExcelFilled: return "\u{f3e8}"
        case .fileExcelLight: return "\u{f3e9}"
        case .fileExcelRegular: return "\u{f3ea}"
        case .fileGraphBold: return "\u{f3eb}"
        case .fileGraphFilled: return "\u{f3ec}"
        case .fileGraphLight: return "\u{f3ed}"
        case .fileGraphRegular: return "\u{f3ee}"
        case .fileImageBold: return "\u{f3ef}"
        case .fileImageFilled: return "\u{f3f0}"
        case .fileImageLight: return "\u{f3f1}"
        case .fileImageRegular: return "\u{f3f2}"
        case .fileKeynoteBold: return "\u{f3f3}"
        case .fileKeynoteFilled: return "\u{f3f4}"
        case .fileKeynoteLight: return "\u{f3f5}"
        case .fileKeynoteRegular: return "\u{f3f6}"
        case .fileLockedBold: return "\u{f3f7}"
        case .fileLockedFilled: return "\u{f3f8}"
        case .fileLockedLight: return "\u{f3f9}"
        case .fileLockedRegular: return "\u{f3fa}"
        case .fileMissingBold: return "\u{f3fb}"
        case .fileMissingFilled: return "\u{f3fc}"
        case .fileMissingLight: return "\u{f3fd}"
        case .fileMissingRegular: return "\u{f3fe}"
        case .fileMusicBold: return "\u{f3ff}"
        case .fileMusicFilled: return "\u{f400}"
        case .fileMusicLight: return "\u{f401}"
        case .fileMusicRegular: return "\u{f402}"
        case .fileOnenoteBold: return "\u{f403}"
        case .fileOnenoteFilled: return "\u{f404}"
        case .fileOnenoteLight: return "\u{f405}"
        case .fileOnenoteRegular: return "\u{f406}"
        case .filePdfBold: return "\u{f407}"
        case .filePdfFilled: return "\u{f408}"
        case .filePdfLight: return "\u{f409}"
        case .filePdfRegular: return "\u{f40a}"
        case .filePowerpointBold: return "\u{f40b}"
        case .filePowerpointFilled: return "\u{f40c}"
        case .filePowerpointLight: return "\u{f40d}"
        case .filePowerpointRegular: return "\u{f40e}"
        case .fileSpreadsheetBold: return "\u{f40f}"
        case .fileSpreadsheetFilled: return "\u{f410}"
        case .fileSpreadsheetLight: return "\u{f411}"
        case .fileSpreadsheetRegular: return "\u{f412}"
        case .fileTextBold: return "\u{f413}"
        case .fileTextFilled: return "\u{f414}"
        case .fileTextLight: return "\u{f415}"
        case .fileTextRegular: return "\u{f416}"
        case .fileVectorBold: return "\u{f417}"
        case .fileVectorFilled: return "\u{f418}"
        case .fileVectorLight: return "\u{f419}"
        case .fileVectorRegular: return "\u{f41a}"
        case .fileVideoBold: return "\u{f41b}"
        case .fileVideoFilled: return "\u{f41c}"
        case .fileVideoLight: return "\u{f41d}"
        case .fileVideoRegular: return "\u{f41e}"
        case .fileWordBold: return "\u{f41f}"
        case .fileWordFilled: return "\u{f420}"
        case .fileWordLight: return "\u{f421}"
        case .fileWordRegular: return "\u{f422}"
        case .fileZipBold: return "\u{f423}"
        case .fileZipFilled: return "\u{f424}"
        case .fileZipLight: return "\u{f425}"
        case .fileZipRegular: return "\u{f426}"
        case .filesBold: return "\u{f427}"
        case .filesFilled: return "\u{f428}"
        case .filesLight: return "\u{f429}"
        case .filesRegular: return "\u{f42a}"
        case .filterBold: return "\u{f42b}"
        case .filterCircleBold: return "\u{f42c}"
        case .filterCircleFilled: return "\u{f42d}"
        case .filterCircleLight: return "\u{f42e}"
        case .filterCircleRegular: return "\u{f42f}"
        case .filterLight: return "\u{f430}"
        case .filterRegular: return "\u{f431}"
        case .fitToWidthBold: return "\u{f432}"
        case .fitToWidthLight: return "\u{f433}"
        case .fitToWidthRegular: return "\u{f434}"
        case .fitToWindowBold: return "\u{f435}"
        case .fitToWindowExitBold: return "\u{f436}"
        case .fitToWindowExitLight: return "\u{f437}"
        case .fitToWindowExitRegular: return "\u{f438}"
        case .fitToWindowLight: return "\u{f439}"
        case .fitToWindowRegular: return "\u{f43a}"
        case .flagBold: return "\u{f43b}"
        case .flagCircleBold: return "\u{f43c}"
        case .flagCircleFilled: return "\u{f43d}"
        case .flagCircleLight: return "\u{f43e}"
        case .flagCircleRegular: return "\u{f43f}"
        case .flagFilled: return "\u{f440}"
        case .flagLight: return "\u{f441}"
        case .flagRegular: return "\u{f442}"
        case .folderBold: return "\u{f443}"
        case .folderEditBold: return "\u{f444}"
        case .folderEditLight: return "\u{f445}"
        case .folderEditRegular: return "\u{f446}"
        case .folderLight: return "\u{f447}"
        case .folderLockBold: return "\u{f448}"
        case .folderLockLight: return "\u{f449}"
        case .folderLockRegular: return "\u{f44a}"
        case .folderRegular: return "\u{f44b}"
        case .folderViewBold: return "\u{f44c}"
        case .folderViewLight: return "\u{f44d}"
        case .folderViewRegular: return "\u{f44e}"
        case .foodBold: return "\u{f44f}"
        case .foodLight: return "\u{f450}"
        case .foodRegular: return "\u{f451}"
        case .formatBold: return "\u{f452}"
        case .formatControlPanelDraggerBold: return "\u{f453}"
        case .formatControlPanelDraggerLight: return "\u{f454}"
        case .formatControlPanelDraggerRegular: return "\u{f455}"
        case .formatDefaultAppBold: return "\u{f456}"
        case .formatDefaultAppLight: return "\u{f457}"
        case .formatDefaultAppRegular: return "\u{f458}"
        case .formatLight: return "\u{f459}"
        case .formatPanelControlBarBold: return "\u{f45a}"
        case .formatPanelControlBarLight: return "\u{f45b}"
        case .formatPanelControlBarRegular: return "\u{f45c}"
        case .formatPanelControlDownBold: return "\u{f45d}"
        case .formatPanelControlDownLight: return "\u{f45e}"
        case .formatPanelControlDownRegular: return "\u{f45f}"
        case .formatPanelControlLeftBold: return "\u{f460}"
        case .formatPanelControlLeftLight: return "\u{f461}"
        case .formatPanelControlLeftRegular: return "\u{f462}"
        case .formatPanelControlRightBold: return "\u{f463}"
        case .formatPanelControlRightLight: return "\u{f464}"
        case .formatPanelControlRightRegular: return "\u{f465}"
        case .formatPanelControlUpBold: return "\u{f466}"
        case .formatPanelControlUpLight: return "\u{f467}"
        case .formatPanelControlUpRegular: return "\u{f468}"
        case .formatRegular: return "\u{f469}"
        case .formatViewMixedBold: return "\u{f46a}"
        case .formatViewMixedLight: return "\u{f46b}"
        case .formatViewMixedRegular: return "\u{f46c}"
        case .forwardMessageBold: return "\u{f46d}"
        case .forwardMessageFilled: return "\u{f46e}"
        case .forwardMessageLight: return "\u{f46f}"
        case .forwardMessageRegular: return "\u{f470}"
        case .fourWayNavigationBold: return "\u{f471}"
        case .fourWayNavigationLight: return "\u{f472}"
        case .fourWayNavigationRegular: return "\u{f473}"
        case .fullscreenBold: return "\u{f474}"
        case .fullscreenExitBold: return "\u{f475}"
        case .fullscreenExitLight: return "\u{f476}"
        case .fullscreenExitRegular: return "\u{f477}"
        case .fullscreenLight: return "\u{f478}"
        case .fullscreenRegular: return "\u{f479}"
        case .genericDeviceVideoBold: return "\u{f47a}"
        case .genericDeviceVideoFilled: return "\u{f47b}"
        case .genericDeviceVideoLight: return "\u{f47c}"
        case .genericDeviceVideoRegular: return "\u{f47d}"
        case .gifBold: return "\u{f47e}"
        case .gifFilled: return "\u{f47f}"
        case .gifLight: return "\u{f480}"
        case .gifRegular: return "\u{f481}"
        case .guestIssuerBold: return "\u{f482}"
        case .guestIssuerLight: return "\u{f483}"
        case .guestIssuerRegular: return "\u{f484}"
        case .guideBold: return "\u{f485}"
        case .guideLight: return "\u{f486}"
        case .guideRegular: return "\u{f487}"
        case .handlerBold: return "\u{f488}"
        case .handlerLight: return "\u{f489}"
        case .handlerRegular: return "\u{f48a}"
        case .handsetAlertBold: return "\u{f48b}"
        case .handsetAlertFilled: return "\u{f48c}"
        case .handsetAlertLight: return "\u{f48d}"
        case .handsetAlertRegular: return "\u{f48e}"
        case .handsetBold: return "\u{f48f}"
        case .handsetFilled: return "\u{f490}"
        case .handsetLight: return "\u{f491}"
        case .handsetMutedBold: return "\u{f492}"
        case .handsetMutedFilled: return "\u{f493}"
        case .handsetMutedLight: return "\u{f494}"
        case .handsetMutedRegular: return "\u{f495}"
        case .handsetRegular: return "\u{f496}"
        case .handshakeBold: return "\u{f497}"
        case .handshakeLight: return "\u{f498}"
        case .handshakeRegular: return "\u{f499}"
        case .headingOneBold: return "\u{f49a}"
        case .headingOneLight: return "\u{f49b}"
        case .headingOneRegular: return "\u{f49c}"
        case .headingThreeBold: return "\u{f49d}"
        case .headingThreeLight: return "\u{f49e}"
        case .headingThreeRegular: return "\u{f49f}"
        case .headingTwoBold: return "\u{f4a0}"
        case .headingTwoLight: return "\u{f4a1}"
        case .headingTwoRegular: return "\u{f4a2}"
        case .headsetAlertBold: return "\u{f4a3}"
        case .headsetAlertLight: return "\u{f4a4}"
        case .headsetAlertRegular: return "\u{f4a5}"
        case .headsetBold: return "\u{f4a6}"
        case .headsetFilled: return "\u{f4a7}"
        case .headsetLight: return "\u{f4a8}"
        case .headsetMutedBold: return "\u{f4a9}"
        case .headsetMutedLight: return "\u{f4aa}"
        case .headsetMutedRegular: return "\u{f4ab}"
        case .headsetPrivateBold: return "\u{f4ac}"
        case .headsetPrivateLight: return "\u{f4ad}"
        case .headsetPrivateRegular: return "\u{f4ae}"
        case .headsetRegular: return "\u{f4af}"
        case .helpBold: return "\u{f4b0}"
        case .helpCircleActiveFilled: return "\u{f4b1}"
        case .helpCircleBold: return "\u{f4b2}"
        case .helpCircleLight: return "\u{f4b3}"
        case .helpCircleRegular: return "\u{f4b4}"
        case .helpLight: return "\u{f4b5}"
        case .helpRegular: return "\u{f4b6}"
        case .helpdeskBold: return "\u{f4b7}"
        case .helpdeskLight: return "\u{f4b8}"
        case .helpdeskRegular: return "\u{f4b9}"
        case .hideBold: return "\u{f4ba}"
        case .hideFilled: return "\u{f4bb}"
        case .hideLight: return "\u{f4bc}"
        case .hideRegular: return "\u{f4bd}"
        case .homeBold: return "\u{f4be}"
        case .homeFilled: return "\u{f4bf}"
        case .homeLight: return "\u{f4c0}"
        case .homeRegular: return "\u{f4c1}"
        case .horizontalLineBold: return "\u{f4c2}"
        case .horizontalLineLight: return "\u{f4c3}"
        case .horizontalLineRegular: return "\u{f4c4}"
        case .humidityBold: return "\u{f4c5}"
        case .humidityLight: return "\u{f4c6}"
        case .humidityRegular: return "\u{f4c7}"
        case .huntGroupBold: return "\u{f4c8}"
        case .huntGroupFilled: return "\u{f4c9}"
        case .huntGroupLight: return "\u{f4ca}"
        case .huntGroupRegular: return "\u{f4cb}"
        case .importBold: return "\u{f4cc}"
        case .importLight: return "\u{f4cd}"
        case .importRegular: return "\u{f4ce}"
        case .incomingCallLegacyBold: return "\u{f4cf}"
        case .incomingCallLegacyLight: return "\u{f4d0}"
        case .incomingCallLegacyRegular: return "\u{f4d1}"
        case .infoBadgeFilled: return "\u{f4d2}"
        case .infoCircleBold: return "\u{f4d3}"
        case .infoCircleFilled: return "\u{f4d4}"
        case .infoCircleLight: return "\u{f4d5}"
        case .infoCircleRegular: return "\u{f4d6}"
        case .infoCircleTwoBold: return "\u{f4d7}"
        case .infoCircleTwoFilled: return "\u{f4d8}"
        case .infoCircleTwoLight: return "\u{f4d9}"
        case .infoCircleTwoRegular: return "\u{f4da}"
        case .inputBold: return "\u{f4db}"
        case .inputDisconnectedBold: return "\u{f4dc}"
        case .inputDisconnectedLight: return "\u{f4dd}"
        case .inputDisconnectedRegular: return "\u{f4de}"
        case .inputLight: return "\u{f4df}"
        case .inputRegular: return "\u{f4e0}"
        case .integrationsBold: return "\u{f4e1}"
        case .integrationsLight: return "\u{f4e2}"
        case .integrationsRegular: return "\u{f4e3}"
        case .invitedUserBold: return "\u{f4e4}"
        case .invitedUserLight: return "\u{f4e5}"
        case .invitedUserRegular: return "\u{f4e6}"
        case .italicBold: return "\u{f4e7}"
        case .italicLight: return "\u{f4e8}"
        case .italicRegular: return "\u{f4e9}"
        case .joinAudioBold: return "\u{f4ea}"
        case .joinAudioFilled: return "\u{f4eb}"
        case .joinAudioLight: return "\u{f4ec}"
        case .joinAudioRegular: return "\u{f4ed}"
        case .keyboardBold: return "\u{f4ee}"
        case .keyboardCloseBold: return "\u{f4ef}"
        case .keyboardCloseLight: return "\u{f4f0}"
        case .keyboardCloseRegular: return "\u{f4f1}"
        case .keyboardLight: return "\u{f4f2}"
        case .keyboardRegular: return "\u{f4f3}"
        case .languageBold: return "\u{f4f4}"
        case .languageLight: return "\u{f4f5}"
        case .languageRegular: return "\u{f4f6}"
        case .laptopBold: return "\u{f4f7}"
        case .laptopDisconnectedBold: return "\u{f4f8}"
        case .laptopDisconnectedLight: return "\u{f4f9}"
        case .laptopDisconnectedRegular: return "\u{f4fa}"
        case .laptopFilled: return "\u{f4fb}"
        case .laptopLight: return "\u{f4fc}"
        case .laptopRegular: return "\u{f4fd}"
        case .laserPointerBold: return "\u{f4fe}"
        case .laserPointerLight: return "\u{f4ff}"
        case .laserPointerRegular: return "\u{f500}"
        case .launchBold: return "\u{f501}"
        case .launchLight: return "\u{f502}"
        case .launchRegular: return "\u{f503}"
        case .layoutSideBySideVerticalBold: return "\u{f504}"
        case .layoutSideBySideVerticalFilled: return "\u{f505}"
        case .layoutSideBySideVerticalLight: return "\u{f506}"
        case .layoutSideBySideVerticalRegular: return "\u{f507}"
        case .likeBold: return "\u{f508}"
        case .likeFilled: return "\u{f509}"
        case .likeLight: return "\u{f50a}"
        case .likeRegular: return "\u{f50b}"
        case .linkBold: return "\u{f50c}"
        case .linkLight: return "\u{f50d}"
        case .linkRegular: return "\u{f50e}"
        case .listBulletedBold: return "\u{f50f}"
        case .listBulletedLight: return "\u{f510}"
        case .listBulletedRegular: return "\u{f511}"
        case .listMenuBold: return "\u{f512}"
        case .listMenuLight: return "\u{f513}"
        case .listMenuRegular: return "\u{f514}"
        case .listNumberedBold: return "\u{f515}"
        case .listNumberedLight: return "\u{f516}"
        case .listNumberedRegular: return "\u{f517}"
        case .locationBold: return "\u{f518}"
        case .locationFilled: return "\u{f519}"
        case .locationLight: return "\u{f51a}"
        case .locationRegular: return "\u{f51b}"
        case .lowerHandBold: return "\u{f51c}"
        case .lowerHandLight: return "\u{f51d}"
        case .lowerHandRegular: return "\u{f51e}"
        case .markAsUnreadBold: return "\u{f51f}"
        case .markAsUnreadLight: return "\u{f520}"
        case .markAsUnreadRegular: return "\u{f521}"
        case .markdownBold: return "\u{f522}"
        case .markdownLight: return "\u{f523}"
        case .markdownRegular: return "\u{f524}"
        case .markerBold: return "\u{f525}"
        case .markerFilled: return "\u{f526}"
        case .markerLight: return "\u{f527}"
        case .markerRegular: return "\u{f528}"
        case .maximizeBold: return "\u{f529}"
        case .maximizeLight: return "\u{f52a}"
        case .maximizeRegular: return "\u{f52b}"
        case .mediaPlayerBold: return "\u{f52c}"
        case .mediaPlayerLight: return "\u{f52d}"
        case .mediaPlayerRegular: return "\u{f52e}"
        case .mediaQualityGoodBold: return "\u{f52f}"
        case .mediaQualityGoodFilled: return "\u{f530}"
        case .mediaQualityGoodLight: return "\u{f531}"
        case .mediaQualityGoodRegular: return "\u{f532}"
        case .mediaQualityPoorBold: return "\u{f533}"
        case .mediaQualityPoorFilled: return "\u{f534}"
        case .mediaQualityPoorLight: return "\u{f535}"
        case .mediaQualityPoorRegular: return "\u{f536}"
        case .mediaQualityUnstableBold: return "\u{f537}"
        case .mediaQualityUnstableFilled: return "\u{f538}"
        case .mediaQualityUnstableLight: return "\u{f539}"
        case .mediaQualityUnstableRegular: return "\u{f53a}"
        case .meetBold: return "\u{f53b}"
        case .meetEndBold: return "\u{f53c}"
        case .meetEndLight: return "\u{f53d}"
        case .meetEndRegular: return "\u{f53e}"
        case .meetFilled: return "\u{f53f}"
        case .meetLight: return "\u{f540}"
        case .meetRegular: return "\u{f541}"
        case .meetingsBold: return "\u{f542}"
        case .meetingsFilled: return "\u{f543}"
        case .meetingsFocusMonthBold: return "\u{f544}"
        case .meetingsFocusMonthLight: return "\u{f545}"
        case .meetingsFocusMonthRegular: return "\u{f546}"
        case .meetingsFocusOneDayBold: return "\u{f547}"
        case .meetingsFocusOneDayLight: return "\u{f548}"
        case .meetingsFocusOneDayRegular: return "\u{f549}"
        case .meetingsFocusThreeDayBold: return "\u{f54a}"
        case .meetingsFocusThreeDayLight: return "\u{f54b}"
        case .meetingsFocusThreeDayRegular: return "\u{f54c}"
        case .meetingsFocusUpcomingBold: return "\u{f54d}"
        case .meetingsFocusUpcomingLight: return "\u{f54e}"
        case .meetingsFocusUpcomingRegular: return "\u{f54f}"
        case .meetingsFocusWeekBold: return "\u{f550}"
        case .meetingsFocusWeekLight: return "\u{f551}"
        case .meetingsFocusWeekRegular: return "\u{f552}"
        case .meetingsLight: return "\u{f553}"
        case .meetingsPresenceBold: return "\u{f554}"
        case .meetingsPresenceFilled: return "\u{f555}"
        case .meetingsPresenceLight: return "\u{f556}"
        case .meetingsPresenceRegular: return "\u{f557}"
        case .meetingsRegular: return "\u{f558}"
        case .meetingsTeamActiveBold: return "\u{f559}"
        case .meetingsTeamActiveLight: return "\u{f55a}"
        case .meetingsTeamActiveRegular: return "\u{f55b}"
        case .meetingsTeamBold: return "\u{f55c}"
        case .meetingsTeamLight: return "\u{f55d}"
        case .meetingsTeamNewBold: return "\u{f55e}"
        case .meetingsTeamNewLight: return "\u{f55f}"
        case .meetingsTeamNewRegular: return "\u{f560}"
        case .meetingsTeamRegular: return "\u{f561}"
        case .mentionBold: return "\u{f562}"
        case .mentionLight: return "\u{f563}"
        case .mentionRegular: return "\u{f564}"
        case .microphoneBold: return "\u{f565}"
        case .microphoneFilled: return "\u{f566}"
        case .microphoneHardMutedBold: return "\u{f567}"
        case .microphoneHardMutedColoredBold: return "\u{f568}"
        case .microphoneHardMutedColoredLight: return "\u{f569}"
        case .microphoneHardMutedColoredRegular: return "\u{f56a}"
        case .microphoneHardMutedLight: return "\u{f56b}"
        case .microphoneHardMutedRegular: return "\u{f56c}"
        case .microphoneLight: return "\u{f56d}"
        case .microphoneMusicModeColoredBold: return "\u{f56e}"
        case .microphoneMusicModeColoredLight: return "\u{f56f}"
        case .microphoneMusicModeColoredRegular: return "\u{f570}"
        case .microphoneMutedBold: return "\u{f571}"
        case .microphoneMutedFilled: return "\u{f572}"
        case .microphoneMutedLight: return "\u{f573}"
        case .microphoneMutedRegular: return "\u{f574}"
        case .microphoneRegular: return "\u{f575}"
        case .minimizeBold: return "\u{f576}"
        case .minimizeLight: return "\u{f577}"
        case .minimizeRegular: return "\u{f578}"
        case .minusBold: return "\u{f579}"
        case .minusLight: return "\u{f57a}"
        case .minusRegular: return "\u{f57b}"
        case .mirrorBold: return "\u{f57c}"
        case .mirrorFilled: return "\u{f57d}"
        case .mirrorLight: return "\u{f57e}"
        case .mirrorRegular: return "\u{f57f}"
        case .moreAdrBold: return "\u{f580}"
        case .moreAdrLight: return "\u{f581}"
        case .moreAdrRegular: return "\u{f582}"
        case .moreBold: return "\u{f583}"
        case .moreCircleBold: return "\u{f584}"
        case .moreCircleFilled: return "\u{f585}"
        case .moreCircleLight: return "\u{f586}"
        case .moreCircleRegular: return "\u{f587}"
        case .moreLight: return "\u{f588}"
        case .moreRegular: return "\u{f589}"
        case .mouseCursorBold: return "\u{f58a}"
        case .mouseCursorLight: return "\u{f58b}"
        case .mouseCursorRegular: return "\u{f58c}"
        case .moveCallInAdrBold: return "\u{f58d}"
        case .moveCallInAdrLight: return "\u{f58e}"
        case .moveCallInAdrRegular: return "\u{f58f}"
        case .moveCallInIphBold: return "\u{f590}"
        case .moveCallInIphLight: return "\u{f591}"
        case .moveCallInIphRegular: return "\u{f592}"
        case .moveCallInLaptopBold: return "\u{f593}"
        case .moveCallInLaptopLight: return "\u{f594}"
        case .moveCallInLaptopRegular: return "\u{f595}"
        case .moveCallInOutAdrBold: return "\u{f596}"
        case .moveCallInOutAdrLight: return "\u{f597}"
        case .moveCallInOutAdrRegular: return "\u{f598}"
        case .moveCallInOutIphBold: return "\u{f599}"
        case .moveCallInOutIphLight: return "\u{f59a}"
        case .moveCallInOutIphRegular: return "\u{f59b}"
        case .moveCallInTabletBold: return "\u{f59c}"
        case .moveCallInTabletLight: return "\u{f59d}"
        case .moveCallInTabletRegular: return "\u{f59e}"
        case .moveCallOutAdrBold: return "\u{f59f}"
        case .moveCallOutAdrLight: return "\u{f5a0}"
        case .moveCallOutAdrRegular: return "\u{f5a1}"
        case .moveCallOutIphBold: return "\u{f5a2}"
        case .moveCallOutIphLight: return "\u{f5a3}"
        case .moveCallOutIphRegular: return "\u{f5a4}"
        case .moveCallOutLaptopBold: return "\u{f5a5}"
        case .moveCallOutLaptopLight: return "\u{f5a6}"
        case .moveCallOutLaptopRegular: return "\u{f5a7}"
        case .moveCallOutTabletBold: return "\u{f5a8}"
        case .moveCallOutTabletLight: return "\u{f5a9}"
        case .moveCallOutTabletRegular: return "\u{f5aa}"
        case .multilineChartBold: return "\u{f5ab}"
        case .multilineChartFilled: return "\u{f5ac}"
        case .multilineChartLight: return "\u{f5ad}"
        case .multilineChartRegular: return "\u{f5ae}"
        case .multimediaBold: return "\u{f5af}"
        case .multimediaLight: return "\u{f5b0}"
        case .multimediaRegular: return "\u{f5b1}"
        case .multipledDevicesBold: return "\u{f5b2}"
        case .multipledDevicesLight: return "\u{f5b3}"
        case .multipledDevicesRegular: return "\u{f5b4}"
        case .musicModeBold: return "\u{f5b5}"
        case .musicModeCircleBold: return "\u{f5b6}"
        case .musicModeCircleFilled: return "\u{f5b7}"
        case .musicModeCircleLight: return "\u{f5b8}"
        case .musicModeCircleRegular: return "\u{f5b9}"
        case .musicModeFilled: return "\u{f5ba}"
        case .musicModeLight: return "\u{f5bb}"
        case .musicModeRegular: return "\u{f5bc}"
        case .muteOnEntryBold: return "\u{f5bd}"
        case .muteOnEntryFilled: return "\u{f5be}"
        case .muteOnEntryLight: return "\u{f5bf}"
        case .muteOnEntryRegular: return "\u{f5c0}"
        case .newVoicemailBold: return "\u{f5c1}"
        case .newVoicemailLight: return "\u{f5c2}"
        case .newVoicemailRegular: return "\u{f5c3}"
        case .newWhiteboardBold: return "\u{f5c4}"
        case .newWhiteboardLight: return "\u{f5c5}"
        case .newWhiteboardRegular: return "\u{f5c6}"
        case .nextBold: return "\u{f5c7}"
        case .nextLight: return "\u{f5c8}"
        case .nextRegular: return "\u{f5c9}"
        case .noDevicesBold: return "\u{f5ca}"
        case .noDevicesLight: return "\u{f5cb}"
        case .noDevicesRegular: return "\u{f5cc}"
        case .noiseRemovalBold: return "\u{f5cd}"
        case .noiseRemovalLight: return "\u{f5ce}"
        case .noiseRemovalRegular: return "\u{f5cf}"
        case .noteBold: return "\u{f5d0}"
        case .noteLight: return "\u{f5d1}"
        case .notePptBold: return "\u{f5d2}"
        case .notePptLight: return "\u{f5d3}"
        case .notePptRegular: return "\u{f5d4}"
        case .noteRegular: return "\u{f5d5}"
        case .notesBold: return "\u{f5d6}"
        case .notesLight: return "\u{f5d7}"
        case .notesRegular: return "\u{f5d8}"
        case .numberBold: return "\u{f5d9}"
        case .numberLight: return "\u{f5da}"
        case .numberRegular: return "\u{f5db}"
        case .oldRemoteBold: return "\u{f5dc}"
        case .oldRemoteLight: return "\u{f5dd}"
        case .oldRemoteRegular: return "\u{f5de}"
        case .oldTouchBold: return "\u{f5df}"
        case .oldTouchLight: return "\u{f5e0}"
        case .oldTouchRegular: return "\u{f5e1}"
        case .openInFolderBold: return "\u{f5e2}"
        case .openInFolderLight: return "\u{f5e3}"
        case .openInFolderRegular: return "\u{f5e4}"
        case .openPagesBold: return "\u{f5e5}"
        case .openPagesLight: return "\u{f5e6}"
        case .openPagesRegular: return "\u{f5e7}"
        case .otherNumberBold: return "\u{f5e8}"
        case .otherNumberLight: return "\u{f5e9}"
        case .otherNumberRegular: return "\u{f5ea}"
        case .otherNumberWarningBold: return "\u{f5eb}"
        case .otherNumberWarningLight: return "\u{f5ec}"
        case .otherNumberWarningRegular: return "\u{f5ed}"
        case .outgoingCallLegacyBold: return "\u{f5ee}"
        case .outgoingCallLegacyLight: return "\u{f5ef}"
        case .outgoingCallLegacyRegular: return "\u{f5f0}"
        case .overflowLeftBold: return "\u{f5f1}"
        case .overflowLeftLight: return "\u{f5f2}"
        case .overflowLeftRegular: return "\u{f5f3}"
        case .overflowRightBold: return "\u{f5f4}"
        case .overflowRightLight: return "\u{f5f5}"
        case .overflowRightRegular: return "\u{f5f6}"
        case .pairedCameraBold: return "\u{f5f7}"
        case .pairedCameraLight: return "\u{f5f8}"
        case .pairedCameraRegular: return "\u{f5f9}"
        case .pairedDeviceBold: return "\u{f5fa}"
        case .pairedDeviceLight: return "\u{f5fb}"
        case .pairedDeviceRegular: return "\u{f5fc}"
        case .pairedHandsetBold: return "\u{f5fd}"
        case .pairedHandsetLight: return "\u{f5fe}"
        case .pairedHandsetRegular: return "\u{f5ff}"
        case .pairingBold: return "\u{f600}"
        case .pairingLight: return "\u{f601}"
        case .pairingRegular: return "\u{f602}"
        case .parkedBold: return "\u{f603}"
        case .parkedFilled: return "\u{f604}"
        case .parkedLight: return "\u{f605}"
        case .parkedRegular: return "\u{f606}"
        case .parseBold: return "\u{f607}"
        case .parseLight: return "\u{f608}"
        case .parseRegular: return "\u{f609}"
        case .participantAddBold: return "\u{f60a}"
        case .participantAddLight: return "\u{f60b}"
        case .participantAddRegular: return "\u{f60c}"
        case .participantBlockedBold: return "\u{f60d}"
        case .participantBlockedLight: return "\u{f60e}"
        case .participantBlockedRegular: return "\u{f60f}"
        case .participantBold: return "\u{f610}"
        case .participantFilled: return "\u{f611}"
        case .participantLight: return "\u{f612}"
        case .participantListBold: return "\u{f613}"
        case .participantListFilled: return "\u{f614}"
        case .participantListLight: return "\u{f615}"
        case .participantListRegular: return "\u{f616}"
        case .participantRegular: return "\u{f617}"
        case .participantRemoveBold: return "\u{f618}"
        case .participantRemoveLight: return "\u{f619}"
        case .participantRemoveRegular: return "\u{f61a}"
        case .participantUnknownBold: return "\u{f61b}"
        case .participantUnknownLight: return "\u{f61c}"
        case .participantUnknownRegular: return "\u{f61d}"
        case .passMouseBold: return "\u{f61e}"
        case .passMouseLight: return "\u{f61f}"
        case .passMouseRegular: return "\u{f620}"
        case .pauseBold: return "\u{f621}"
        case .pauseFilled: return "\u{f622}"
        case .pauseLight: return "\u{f623}"
        case .pauseRegular: return "\u{f624}"
        case .penBold: return "\u{f625}"
        case .penFilled: return "\u{f626}"
        case .penLight: return "\u{f627}"
        case .penRegular: return "\u{f628}"
        case .peopleBold: return "\u{f629}"
        case .peopleCircleBold: return "\u{f62a}"
        case .peopleCircleFilled: return "\u{f62b}"
        case .peopleCircleLight: return "\u{f62c}"
        case .peopleCircleRegular: return "\u{f62d}"
        case .peopleFilled: return "\u{f62e}"
        case .peopleLight: return "\u{f62f}"
        case .peopleRegular: return "\u{f630}"
        case .phoneAlertBold: return "\u{f631}"
        case .phoneAlertLight: return "\u{f632}"
        case .phoneAlertRegular: return "\u{f633}"
        case .phoneBold: return "\u{f634}"
        case .phoneFilled: return "\u{f635}"
        case .phoneLight: return "\u{f636}"
        case .phoneMutedBold: return "\u{f637}"
        case .phoneMutedLight: return "\u{f638}"
        case .phoneMutedRegular: return "\u{f639}"
        case .phonePrivateBold: return "\u{f63a}"
        case .phonePrivateLight: return "\u{f63b}"
        case .phonePrivateRegular: return "\u{f63c}"
        case .phoneRegular: return "\u{f63d}"
        case .phoneReplyAllBold: return "\u{f63e}"
        case .phoneReplyAllLight: return "\u{f63f}"
        case .phoneReplyAllRegular: return "\u{f640}"
        case .phoneReplyBold: return "\u{f641}"
        case .phoneReplyLight: return "\u{f642}"
        case .phoneReplyRegular: return "\u{f643}"
        case .pickerBold: return "\u{f644}"
        case .pickerLight: return "\u{f645}"
        case .pickerRegular: return "\u{f646}"
        case .pictureInPictureBold: return "\u{f647}"
        case .pictureInPictureLight: return "\u{f648}"
        case .pictureInPictureRegular: return "\u{f649}"
        case .pieChartBold: return "\u{f64a}"
        case .pieChartFilled: return "\u{f64b}"
        case .pieChartLight: return "\u{f64c}"
        case .pieChartRegular: return "\u{f64d}"
        case .pinBold: return "\u{f64e}"
        case .pinFilled: return "\u{f64f}"
        case .pinLight: return "\u{f650}"
        case .pinListBold: return "\u{f651}"
        case .pinListLight: return "\u{f652}"
        case .pinListRegular: return "\u{f653}"
        case .pinMutedBold: return "\u{f654}"
        case .pinMutedLight: return "\u{f655}"
        case .pinMutedRegular: return "\u{f656}"
        case .pinRegular: return "\u{f657}"
        case .placeholderBold: return "\u{f658}"
        case .placeholderLight: return "\u{f659}"
        case .placeholderRegular: return "\u{f65a}"
        case .playBold: return "\u{f65b}"
        case .playFilled: return "\u{f65c}"
        case .playLight: return "\u{f65d}"
        case .playRegular: return "\u{f65e}"
        case .plugAcBold: return "\u{f65f}"
        case .plugAcLight: return "\u{f660}"
        case .plugAcRegular: return "\u{f661}"
        case .plusBold: return "\u{f662}"
        case .plusCircleBold: return "\u{f663}"
        case .plusCircleFilled: return "\u{f664}"
        case .plusCircleLight: return "\u{f665}"
        case .plusCircleRegular: return "\u{f666}"
        case .plusLight: return "\u{f667}"
        case .plusRegular: return "\u{f668}"
        case .pmrBold: return "\u{f669}"
        case .pmrFilled: return "\u{f66a}"
        case .pmrLight: return "\u{f66b}"
        case .pmrRegular: return "\u{f66c}"
        case .pollBold: return "\u{f66d}"
        case .pollLight: return "\u{f66e}"
        case .pollRegular: return "\u{f66f}"
        case .popInBold: return "\u{f670}"
        case .popInLight: return "\u{f671}"
        case .popInRegular: return "\u{f672}"
        case .popOutBold: return "\u{f673}"
        case .popOutLight: return "\u{f674}"
        case .popOutRegular: return "\u{f675}"
        case .popUpBold: return "\u{f676}"
        case .popUpLight: return "\u{f677}"
        case .popUpRegular: return "\u{f678}"
        case .powerAcBold: return "\u{f679}"
        case .powerAcLight: return "\u{f67a}"
        case .powerAcRegular: return "\u{f67b}"
        case .powerBold: return "\u{f67c}"
        case .powerLight: return "\u{f67d}"
        case .powerRegular: return "\u{f67e}"
        case .presentationBold: return "\u{f67f}"
        case .presentationLight: return "\u{f680}"
        case .presentationRegular: return "\u{f681}"
        case .printBold: return "\u{f682}"
        case .printLight: return "\u{f683}"
        case .printRegular: return "\u{f684}"
        case .priorityBadgeFilled: return "\u{f685}"
        case .priorityCircleBold: return "\u{f686}"
        case .priorityCircleFilled: return "\u{f687}"
        case .priorityCircleLight: return "\u{f688}"
        case .priorityCircleRegular: return "\u{f689}"
        case .priorityCircleTwoBold: return "\u{f68a}"
        case .priorityCircleTwoFilled: return "\u{f68b}"
        case .priorityCircleTwoLight: return "\u{f68c}"
        case .priorityCircleTwoRegular: return "\u{f68d}"
        case .privacyCircleBold: return "\u{f68e}"
        case .privacyCircleFilled: return "\u{f68f}"
        case .privacyCircleLight: return "\u{f690}"
        case .privacyCircleRegular: return "\u{f691}"
        case .privateBold: return "\u{f692}"
        case .privateCircleBold: return "\u{f693}"
        case .privateCircleFilled: return "\u{f694}"
        case .privateCircleLight: return "\u{f695}"
        case .privateCircleRegular: return "\u{f696}"
        case .privateLight: return "\u{f697}"
        case .privateMeetingBold: return "\u{f698}"
        case .privateMeetingLight: return "\u{f699}"
        case .privateMeetingRegular: return "\u{f69a}"
        case .privateRegular: return "\u{f69b}"
        case .productDemoBold: return "\u{f69c}"
        case .productDemoLight: return "\u{f69d}"
        case .productDemoRegular: return "\u{f69e}"
        case .proximityBold: return "\u{f69f}"
        case .proximityLight: return "\u{f6a0}"
        case .proximityMutedBold: return "\u{f6a1}"
        case .proximityMutedLight: return "\u{f6a2}"
        case .proximityMutedRegular: return "\u{f6a3}"
        case .proximityRegular: return "\u{f6a4}"
        case .proximityVideoBold: return "\u{f6a5}"
        case .proximityVideoLight: return "\u{f6a6}"
        case .proximityVideoRegular: return "\u{f6a7}"
        case .ptoPresenceBold: return "\u{f6a8}"
        case .ptoPresenceFilled: return "\u{f6a9}"
        case .ptoPresenceLight: return "\u{f6aa}"
        case .ptoPresenceRegular: return "\u{f6ab}"
        case .pullCallBold: return "\u{f6ac}"
        case .pullCallLight: return "\u{f6ad}"
        case .pullCallRegular: return "\u{f6ae}"
        case .qABold: return "\u{f6af}"
        case .qALight: return "\u{f6b0}"
        case .qARegular: return "\u{f6b1}"
        case .qualityBold: return "\u{f6b2}"
        case .qualityLight: return "\u{f6b3}"
        case .qualityRegular: return "\u{f6b4}"
        case .queueContactBold: return "\u{f6b5}"
        case .queueContactLight: return "\u{f6b6}"
        case .queueContactRegular: return "\u{f6b7}"
        case .quietBold: return "\u{f6b8}"
        case .quietHoursPresenceBold: return "\u{f6b9}"
        case .quietHoursPresenceFilled: return "\u{f6ba}"
        case .quietHoursPresenceLight: return "\u{f6bb}"
        case .quietHoursPresenceRegular: return "\u{f6bc}"
        case .quietLight: return "\u{f6bd}"
        case .quietRegular: return "\u{f6be}"
        case .raiseHandBold: return "\u{f6bf}"
        case .raiseHandLight: return "\u{f6c0}"
        case .raiseHandRegular: return "\u{f6c1}"
        case .ramBold: return "\u{f6c2}"
        case .ramLight: return "\u{f6c3}"
        case .ramRegular: return "\u{f6c4}"
        case .reactionsBold: return "\u{f6c5}"
        case .reactionsFilled: return "\u{f6c6}"
        case .reactionsLight: return "\u{f6c7}"
        case .reactionsRegular: return "\u{f6c8}"
        case .reactivateBold: return "\u{f6c9}"
        case .reactivateLight: return "\u{f6ca}"
        case .reactivateRegular: return "\u{f6cb}"
        case .recentsBold: return "\u{f6cc}"
        case .recentsFilled: return "\u{f6cd}"
        case .recentsLight: return "\u{f6ce}"
        case .recentsPresenceBold: return "\u{f6cf}"
        case .recentsPresenceFilled: return "\u{f6d0}"
        case .recentsPresenceLight: return "\u{f6d1}"
        case .recentsPresenceRegular: return "\u{f6d2}"
        case .recentsRegular: return "\u{f6d3}"
        case .recordBold: return "\u{f6d4}"
        case .recordFilled: return "\u{f6d5}"
        case .recordLight: return "\u{f6d6}"
        case .recordPausedBold: return "\u{f6d7}"
        case .recordPausedFilled: return "\u{f6d8}"
        case .recordPausedLight: return "\u{f6d9}"
        case .recordPausedRegular: return "\u{f6da}"
        case .recordRegular: return "\u{f6db}"
        case .recurringBold: return "\u{f6dc}"
        case .recurringLight: return "\u{f6dd}"
        case .recurringOffBold: return "\u{f6de}"
        case .recurringOffLight: return "\u{f6df}"
        case .recurringOffRegular: return "\u{f6e0}"
        case .recurringRegular: return "\u{f6e1}"
        case .redialBold: return "\u{f6e2}"
        case .redialLight: return "\u{f6e3}"
        case .redialRegular: return "\u{f6e4}"
        case .redoBold: return "\u{f6e5}"
        case .redoLight: return "\u{f6e6}"
        case .redoRegular: return "\u{f6e7}"
        case .refreshBold: return "\u{f6e8}"
        case .refreshLight: return "\u{f6e9}"
        case .refreshRegular: return "\u{f6ea}"
        case .remoteDesktopControlBold: return "\u{f6eb}"
        case .remoteDesktopControlFilled: return "\u{f6ec}"
        case .remoteDesktopControlLight: return "\u{f6ed}"
        case .remoteDesktopControlRegular: return "\u{f6ee}"
        case .removeBold: return "\u{f6ef}"
        case .removeFilled: return "\u{f6f0}"
        case .removeLight: return "\u{f6f1}"
        case .removeRegular: return "\u{f6f2}"
        case .replyBold: return "\u{f6f3}"
        case .replyFilled: return "\u{f6f4}"
        case .replyLight: return "\u{f6f5}"
        case .replyListBold: return "\u{f6f6}"
        case .replyListLight: return "\u{f6f7}"
        case .replyListRegular: return "\u{f6f8}"
        case .replyRegular: return "\u{f6f9}"
        case .resetBold: return "\u{f6fa}"
        case .resetLight: return "\u{f6fb}"
        case .resetRegular: return "\u{f6fc}"
        case .responsiveMobileBold: return "\u{f6fd}"
        case .responsiveMobileLight: return "\u{f6fe}"
        case .responsiveMobileRegular: return "\u{f6ff}"
        case .restartBold: return "\u{f700}"
        case .restartLight: return "\u{f701}"
        case .restartRegular: return "\u{f702}"
        case .returnBold: return "\u{f703}"
        case .returnLight: return "\u{f704}"
        case .returnRegular: return "\u{f705}"
        case .ringtoneBold: return "\u{f706}"
        case .ringtoneLight: return "\u{f707}"
        case .ringtoneRegular: return "\u{f708}"
        case .roomCalendarBold: return "\u{f709}"
        case .roomCalendarLight: return "\u{f70a}"
        case .roomCalendarRegular: return "\u{f70b}"
        case .roomLightsBold: return "\u{f70c}"
        case .roomLightsLight: return "\u{f70d}"
        case .roomLightsRegular: return "\u{f70e}"
        case .rotateContentBold: return "\u{f70f}"
        case .rotateContentFilled: return "\u{f710}"
        case .rotateContentLight: return "\u{f711}"
        case .rotateContentRegular: return "\u{f712}"
        case .runningApplicationBold: return "\u{f713}"
        case .runningApplicationFilled: return "\u{f714}"
        case .runningApplicationLight: return "\u{f715}"
        case .runningApplicationRegular: return "\u{f716}"
        case .saveBold: return "\u{f717}"
        case .saveLight: return "\u{f718}"
        case .saveRegular: return "\u{f719}"
        case .scanBold: return "\u{f71a}"
        case .scanLight: return "\u{f71b}"
        case .scanRegular: return "\u{f71c}"
        case .schedulerAvailableBold: return "\u{f71d}"
        case .schedulerAvailableLight: return "\u{f71e}"
        case .schedulerAvailableRegular: return "\u{f71f}"
        case .schedulerNotWorkingHoursBold: return "\u{f720}"
        case .schedulerNotWorkingHoursLight: return "\u{f721}"
        case .schedulerNotWorkingHoursRegular: return "\u{f722}"
        case .schedulerUnavailableBold: return "\u{f723}"
        case .schedulerUnavailableLight: return "\u{f724}"
        case .schedulerUnavailableRegular: return "\u{f725}"
        case .schedulerUnknownBold: return "\u{f726}"
        case .schedulerUnknownLight: return "\u{f727}"
        case .schedulerUnknownRegular: return "\u{f728}"
        case .screenshotBold: return "\u{f729}"
        case .screenshotDocBold: return "\u{f72a}"
        case .screenshotDocFilled: return "\u{f72b}"
        case .screenshotDocLight: return "\u{f72c}"
        case .screenshotDocRegular: return "\u{f72d}"
        case .screenshotLight: return "\u{f72e}"
        case .screenshotRegular: return "\u{f72f}"
        case .searchBold: return "\u{f730}"
        case .searchLight: return "\u{f731}"
        case .searchRegular: return "\u{f732}"
        case .secondaryArrowBold: return "\u{f733}"
        case .secondaryArrowLight: return "\u{f734}"
        case .secondaryArrowRegular: return "\u{f735}"
        case .secureCallLockBold: return "\u{f736}"
        case .secureCallLockFilled: return "\u{f737}"
        case .secureCallLockLight: return "\u{f738}"
        case .secureCallLockRegular: return "\u{f739}"
        case .secureCircleBold: return "\u{f73a}"
        case .secureCircleFilled: return "\u{f73b}"
        case .secureCircleLight: return "\u{f73c}"
        case .secureCircleRegular: return "\u{f73d}"
        case .secureLockBold: return "\u{f73e}"
        case .secureLockFilled: return "\u{f73f}"
        case .secureLockLight: return "\u{f740}"
        case .secureLockRegular: return "\u{f741}"
        case .selectionBold: return "\u{f742}"
        case .selectionLight: return "\u{f743}"
        case .selectionRegular: return "\u{f744}"
        case .sendBold: return "\u{f745}"
        case .sendFilled: return "\u{f746}"
        case .sendLight: return "\u{f747}"
        case .sendRegular: return "\u{f748}"
        case .serverBold: return "\u{f749}"
        case .serverErrorBold: return "\u{f74a}"
        case .serverErrorLight: return "\u{f74b}"
        case .serverErrorRegular: return "\u{f74c}"
        case .serverLight: return "\u{f74d}"
        case .serverRegular: return "\u{f74e}"
        case .servicesBold: return "\u{f74f}"
        case .servicesLight: return "\u{f750}"
        case .servicesRegular: return "\u{f751}"
        case .setVariableBold: return "\u{f752}"
        case .setVariableLight: return "\u{f753}"
        case .setVariableRegular: return "\u{f754}"
        case .settingsBold: return "\u{f755}"
        case .settingsFilled: return "\u{f756}"
        case .settingsLight: return "\u{f757}"
        case .settingsRegular: return "\u{f758}"
        case .setupAssistantBold: return "\u{f759}"
        case .setupAssistantLight: return "\u{f75a}"
        case .setupAssistantRegular: return "\u{f75b}"
        case .shapeDiagonalLineBold: return "\u{f75c}"
        case .shapeDiagonalLineLight: return "\u{f75d}"
        case .shapeDiagonalLineRegular: return "\u{f75e}"
        case .shapeOvalBold: return "\u{f75f}"
        case .shapeOvalLight: return "\u{f760}"
        case .shapeOvalRegular: return "\u{f761}"
        case .shapesBold: return "\u{f762}"
        case .shapesLight: return "\u{f763}"
        case .shapesRegular: return "\u{f764}"
        case .shareCNativeAdrBold: return "\u{f765}"
        case .shareCNativeAdrLight: return "\u{f766}"
        case .shareCNativeAdrRegular: return "\u{f767}"
        case .shareCNativeIphBold: return "\u{f768}"
        case .shareCNativeIphLight: return "\u{f769}"
        case .shareCNativeIphRegular: return "\u{f76a}"
        case .shareScreenBold: return "\u{f76b}"
        case .shareScreenFilled: return "\u{f76c}"
        case .shareScreenLight: return "\u{f76d}"
        case .shareScreenRegular: return "\u{f76e}"
        case .shareSpaceBold: return "\u{f76f}"
        case .shareSpaceLight: return "\u{f770}"
        case .shareSpaceRegular: return "\u{f771}"
        case .shieldBold: return "\u{f772}"
        case .shieldLight: return "\u{f773}"
        case .shieldRegular: return "\u{f774}"
        case .showBold: return "\u{f775}"
        case .showFilled: return "\u{f776}"
        case .showLight: return "\u{f777}"
        case .showRegular: return "\u{f778}"
        case .signInBold: return "\u{f779}"
        case .signInForcedBold: return "\u{f77a}"
        case .signInForcedLight: return "\u{f77b}"
        case .signInForcedRegular: return "\u{f77c}"
        case .signInLight: return "\u{f77d}"
        case .signInRegular: return "\u{f77e}"
        case .signOutBold: return "\u{f77f}"
        case .signOutLight: return "\u{f780}"
        case .signOutRegular: return "\u{f781}"
        case .signal0Bold: return "\u{f782}"
        case .signal0Light: return "\u{f783}"
        case .signal0Regular: return "\u{f784}"
        case .signal100Bold: return "\u{f785}"
        case .signal100Light: return "\u{f786}"
        case .signal100Regular: return "\u{f787}"
        case .signal25Bold: return "\u{f788}"
        case .signal25Light: return "\u{f789}"
        case .signal25Regular: return "\u{f78a}"
        case .signal50Bold: return "\u{f78b}"
        case .signal50Light: return "\u{f78c}"
        case .signal50Regular: return "\u{f78d}"
        case .signal75Bold: return "\u{f78e}"
        case .signal75Light: return "\u{f78f}"
        case .signal75Regular: return "\u{f790}"
        case .singleNumberReachBold: return "\u{f791}"
        case .singleNumberReachLight: return "\u{f792}"
        case .singleNumberReachRegular: return "\u{f793}"
        case .sipRegistrationInProgressBold: return "\u{f794}"
        case .sipRegistrationInProgressFilled: return "\u{f795}"
        case .sipRegistrationInProgressLight: return "\u{f796}"
        case .sipRegistrationInProgressRegular: return "\u{f797}"
        case .skipBold: return "\u{f798}"
        case .skipBwBold: return "\u{f799}"
        case .skipBwFilled: return "\u{f79a}"
        case .skipBwLight: return "\u{f79b}"
        case .skipBwRegular: return "\u{f79c}"
        case .skipFwBold: return "\u{f79d}"
        case .skipFwFilled: return "\u{f79e}"
        case .skipFwLight: return "\u{f79f}"
        case .skipFwRegular: return "\u{f7a0}"
        case .skipLight: return "\u{f7a1}"
        case .skipRegular: return "\u{f7a2}"
        case .speakerBold: return "\u{f7a3}"
        case .speakerDisconnectedBold: return "\u{f7a4}"
        case .speakerDisconnectedFilled: return "\u{f7a5}"
        case .speakerDisconnectedLight: return "\u{f7a6}"
        case .speakerDisconnectedRegular: return "\u{f7a7}"
        case .speakerFilled: return "\u{f7a8}"
        case .speakerLight: return "\u{f7a9}"
        case .speakerMutedBold: return "\u{f7aa}"
        case .speakerMutedFilled: return "\u{f7ab}"
        case .speakerMutedLight: return "\u{f7ac}"
        case .speakerMutedRegular: return "\u{f7ad}"
        case .speakerOffBold: return "\u{f7ae}"
        case .speakerOffFilled: return "\u{f7af}"
        case .speakerOffLight: return "\u{f7b0}"
        case .speakerOffRegular: return "\u{f7b1}"
        case .speakerOnColoredBold: return "\u{f7b2}"
        case .speakerOnColoredLight: return "\u{f7b3}"
        case .speakerOnColoredRegular: return "\u{f7b4}"
        case .speakerRegular: return "\u{f7b5}"
        case .speakerTurnDownBold: return "\u{f7b6}"
        case .speakerTurnDownFilled: return "\u{f7b7}"
        case .speakerTurnDownLight: return "\u{f7b8}"
        case .speakerTurnDownRegular: return "\u{f7b9}"
        case .speakerTurnUpBold: return "\u{f7ba}"
        case .speakerTurnUpFilled: return "\u{f7bb}"
        case .speakerTurnUpLight: return "\u{f7bc}"
        case .speakerTurnUpRegular: return "\u{f7bd}"
        case .spinnerBold: return "\u{f7be}"
        case .spinnerFilledBold: return "\u{f7bf}"
        case .spinnerFilledLight: return "\u{f7c0}"
        case .spinnerFilledRegular: return "\u{f7c1}"
        case .spinnerLight: return "\u{f7c2}"
        case .spinnerRegular: return "\u{f7c3}"
        case .stackedArea100ChartBold: return "\u{f7c4}"
        case .stackedArea100ChartFilled: return "\u{f7c5}"
        case .stackedArea100ChartLight: return "\u{f7c6}"
        case .stackedArea100ChartRegular: return "\u{f7c7}"
        case .stackedAreaChartBold: return "\u{f7c8}"
        case .stackedAreaChartFilled: return "\u{f7c9}"
        case .stackedAreaChartLight: return "\u{f7ca}"
        case .stackedAreaChartRegular: return "\u{f7cb}"
        case .stackedBar100ChartBold: return "\u{f7cc}"
        case .stackedBar100ChartFilled: return "\u{f7cd}"
        case .stackedBar100ChartLight: return "\u{f7ce}"
        case .stackedBar100ChartRegular: return "\u{f7cf}"
        case .stackedBarChartBold: return "\u{f7d0}"
        case .stackedBarChartFilled: return "\u{f7d1}"
        case .stackedBarChartLight: return "\u{f7d2}"
        case .stackedBarChartRegular: return "\u{f7d3}"
        case .startChatBold: return "\u{f7d4}"
        case .startChatLight: return "\u{f7d5}"
        case .startChatRegular: return "\u{f7d6}"
        case .stickersBold: return "\u{f7d7}"
        case .stickersLight: return "\u{f7d8}"
        case .stickersRegular: return "\u{f7d9}"
        case .stickiesBold: return "\u{f7da}"
        case .stickiesLight: return "\u{f7db}"
        case .stickiesRegular: return "\u{f7dc}"
        case .stopBold: return "\u{f7dd}"
        case .stopCircleBold: return "\u{f7de}"
        case .stopCircleFilled: return "\u{f7df}"
        case .stopCircleLight: return "\u{f7e0}"
        case .stopCircleRegular: return "\u{f7e1}"
        case .stopContentShareBold: return "\u{f7e2}"
        case .stopContentShareLight: return "\u{f7e3}"
        case .stopContentShareRegular: return "\u{f7e4}"
        case .stopFilled: return "\u{f7e5}"
        case .stopLight: return "\u{f7e6}"
        case .stopRegular: return "\u{f7e7}"
        case .storedInfoBold: return "\u{f7e8}"
        case .storedInfoFilled: return "\u{f7e9}"
        case .storedInfoLight: return "\u{f7ea}"
        case .storedInfoRegular: return "\u{f7eb}"
        case .streamingBold: return "\u{f7ec}"
        case .streamingLight: return "\u{f7ed}"
        case .streamingRegular: return "\u{f7ee}"
        case .strikethroughBold: return "\u{f7ef}"
        case .strikethroughLight: return "\u{f7f0}"
        case .strikethroughRegular: return "\u{f7f1}"
        case .subscriptBold: return "\u{f7f2}"
        case .subscriptLight: return "\u{f7f3}"
        case .subscriptRegular: return "\u{f7f4}"
        case .superscriptBold: return "\u{f7f5}"
        case .superscriptLight: return "\u{f7f6}"
        case .superscriptRegular: return "\u{f7f7}"
        case .sx10Bold: return "\u{f7f8}"
        case .sx10Light: return "\u{f7f9}"
        case .sx10Regular: return "\u{f7fa}"
        case .sx20Bold: return "\u{f7fb}"
        case .sx20Light: return "\u{f7fc}"
        case .sx20Regular: return "\u{f7fd}"
        case .sx80CodecBold: return "\u{f7fe}"
        case .sx80CodecLight: return "\u{f7ff}"
        case .sx80CodecRegular: return "\u{f800}"
        case .tableBold: return "\u{f801}"
        case .tableLight: return "\u{f802}"
        case .tableRegular: return "\u{f803}"
        case .tabletBold: return "\u{f804}"
        case .tabletLight: return "\u{f805}"
        case .tabletRegular: return "\u{f806}"
        case .tabsBold: return "\u{f807}"
        case .tabsLight: return "\u{f808}"
        case .tabsRegular: return "\u{f809}"
        case .tagBold: return "\u{f80a}"
        case .tagLight: return "\u{f80b}"
        case .tagRegular: return "\u{f80c}"
        case .telepresenceAlertBold: return "\u{f80d}"
        case .telepresenceAlertLight: return "\u{f80e}"
        case .telepresenceAlertMutedBold: return "\u{f80f}"
        case .telepresenceAlertMutedLight: return "\u{f810}"
        case .telepresenceAlertMutedRegular: return "\u{f811}"
        case .telepresenceAlertRegular: return "\u{f812}"
        case .telepresenceBold: return "\u{f813}"
        case .telepresenceIx5000Bold: return "\u{f814}"
        case .telepresenceIx5000Light: return "\u{f815}"
        case .telepresenceIx5000Regular: return "\u{f816}"
        case .telepresenceLight: return "\u{f817}"
        case .telepresencePrivateBold: return "\u{f818}"
        case .telepresencePrivateLight: return "\u{f819}"
        case .telepresencePrivateRegular: return "\u{f81a}"
        case .telepresenceRegular: return "\u{f81b}"
        case .temperatureBold: return "\u{f81c}"
        case .temperatureLight: return "\u{f81d}"
        case .temperatureRegular: return "\u{f81e}"
        case .textBold: return "\u{f81f}"
        case .textCodeBlockBold: return "\u{f820}"
        case .textCodeBlockLight: return "\u{f821}"
        case .textCodeBlockRegular: return "\u{f822}"
        case .textHighlightBold: return "\u{f823}"
        case .textHighlightLight: return "\u{f824}"
        case .textHighlightRegular: return "\u{f825}"
        case .textLight: return "\u{f826}"
        case .textRegular: return "\u{f827}"
        case .threeDObjectBold: return "\u{f828}"
        case .threeDObjectLight: return "\u{f829}"
        case .threeDObjectRegular: return "\u{f82a}"
        case .tooFastBold: return "\u{f82b}"
        case .tooFastLight: return "\u{f82c}"
        case .tooFastRegular: return "\u{f82d}"
        case .tooSlowBold: return "\u{f82e}"
        case .tooSlowLight: return "\u{f82f}"
        case .tooSlowRegular: return "\u{f830}"
        case .toolsBold: return "\u{f831}"
        case .toolsLight: return "\u{f832}"
        case .toolsRegular: return "\u{f833}"
        case .touch10Bold: return "\u{f834}"
        case .touch10Light: return "\u{f835}"
        case .touch10Regular: return "\u{f836}"
        case .transcriptBold: return "\u{f837}"
        case .transcriptLight: return "\u{f838}"
        case .transcriptRegular: return "\u{f839}"
        case .ucmCloudBold: return "\u{f83a}"
        case .ucmCloudLight: return "\u{f83b}"
        case .ucmCloudRegular: return "\u{f83c}"
        case .underlineBold: return "\u{f83d}"
        case .underlineLight: return "\u{f83e}"
        case .underlineRegular: return "\u{f83f}"
        case .undoBold: return "\u{f840}"
        case .undoLight: return "\u{f841}"
        case .undoRegular: return "\u{f842}"
        case .unlinkBold: return "\u{f843}"
        case .unlinkLight: return "\u{f844}"
        case .unlinkRegular: return "\u{f845}"
        case .unreadBold: return "\u{f846}"
        case .unreadFilled: return "\u{f847}"
        case .unreadLight: return "\u{f848}"
        case .unreadRegular: return "\u{f849}"
        case .unsecureUnlockedBold: return "\u{f84a}"
        case .unsecureUnlockedFilled: return "\u{f84b}"
        case .unsecureUnlockedLight: return "\u{f84c}"
        case .unsecureUnlockedRegular: return "\u{f84d}"
        case .unsortedBold: return "\u{f84e}"
        case .unsortedLight: return "\u{f84f}"
        case .unsortedRegular: return "\u{f850}"
        case .updateFileShareBold: return "\u{f851}"
        case .updateFileShareLight: return "\u{f852}"
        case .updateFileShareRegular: return "\u{f853}"
        case .uploadBold: return "\u{f854}"
        case .uploadLight: return "\u{f855}"
        case .uploadRegular: return "\u{f856}"
        case .usbBold: return "\u{f857}"
        case .usbHeadsetBold: return "\u{f858}"
        case .usbHeadsetLight: return "\u{f859}"
        case .usbHeadsetMutedBold: return "\u{f85a}"
        case .usbHeadsetMutedLight: return "\u{f85b}"
        case .usbHeadsetMutedRegular: return "\u{f85c}"
        case .usbHeadsetRegular: return "\u{f85d}"
        case .usbLight: return "\u{f85e}"
        case .usbRegular: return "\u{f85f}"
        case .userBold: return "\u{f860}"
        case .userLight: return "\u{f861}"
        case .userRegular: return "\u{f862}"
        case .vcsBold: return "\u{f863}"
        case .vcsLight: return "\u{f864}"
        case .vcsRegular: return "\u{f865}"
        case .videoBlurBold: return "\u{f866}"
        case .videoBlurFilled: return "\u{f867}"
        case .videoBlurLight: return "\u{f868}"
        case .videoBlurRegular: return "\u{f869}"
        case .videoBold: return "\u{f86a}"
        case .videoEffectBold: return "\u{f86b}"
        case .videoEffectFilled: return "\u{f86c}"
        case .videoEffectLight: return "\u{f86d}"
        case .videoEffectRegular: return "\u{f86e}"
        case .videoFilled: return "\u{f86f}"
        case .videoLayoutBold: return "\u{f870}"
        case .videoLayoutEqualBold: return "\u{f871}"
        case .videoLayoutEqualDualBold: return "\u{f872}"
        case .videoLayoutEqualDualLight: return "\u{f873}"
        case .videoLayoutEqualDualRegular: return "\u{f874}"
        case .videoLayoutEqualFilled: return "\u{f875}"
        case .videoLayoutEqualLight: return "\u{f876}"
        case .videoLayoutEqualRegular: return "\u{f877}"
        case .videoLayoutLight: return "\u{f878}"
        case .videoLayoutOverlayBold: return "\u{f879}"
        case .videoLayoutOverlayLight: return "\u{f87a}"
        case .videoLayoutOverlayRegular: return "\u{f87b}"
        case .videoLayoutProminentBold: return "\u{f87c}"
        case .videoLayoutProminentLight: return "\u{f87d}"
        case .videoLayoutProminentRegular: return "\u{f87e}"
        case .videoLayoutRegular: return "\u{f87f}"
        case .videoLayoutShareDominantBold: return "\u{f880}"
        case .videoLayoutShareDominantLight: return "\u{f881}"
        case .videoLayoutShareDominantRegular: return "\u{f882}"
        case .videoLayoutSingleBold: return "\u{f883}"
        case .videoLayoutSingleLight: return "\u{f884}"
        case .videoLayoutSingleRegular: return "\u{f885}"
        case .videoLayoutStackBold: return "\u{f886}"
        case .videoLayoutStackFilled: return "\u{f887}"
        case .videoLayoutStackLight: return "\u{f888}"
        case .videoLayoutStackRegular: return "\u{f889}"
        case .videoLayoutVideoDominantBold: return "\u{f88a}"
        case .videoLayoutVideoDominantLight: return "\u{f88b}"
        case .videoLayoutVideoDominantRegular: return "\u{f88c}"
        case .videoLight: return "\u{f88d}"
        case .videoPlusBold: return "\u{f88e}"
        case .videoPlusFilled: return "\u{f88f}"
        case .videoPlusLight: return "\u{f890}"
        case .videoPlusRegular: return "\u{f891}"
        case .videoRegular: return "\u{f892}"
        case .videoSpeakerTrackBold: return "\u{f893}"
        case .videoSpeakerTrackFilled: return "\u{f894}"
        case .videoSpeakerTrackLight: return "\u{f895}"
        case .videoSpeakerTrackRegular: return "\u{f896}"
        case .viewAllBold: return "\u{f897}"
        case .viewAllLight: return "\u{f898}"
        case .viewAllRegular: return "\u{f899}"
        case .viewListBold: return "\u{f89a}"
        case .viewListLight: return "\u{f89b}"
        case .viewListRegular: return "\u{f89c}"
        case .viewStackedBold: return "\u{f89d}"
        case .viewStackedLight: return "\u{f89e}"
        case .viewStackedRegular: return "\u{f89f}"
        case .viewThumbnailBold: return "\u{f8a0}"
        case .viewThumbnailLight: return "\u{f8a1}"
        case .viewThumbnailRegular: return "\u{f8a2}"
        case .voicemailBold: return "\u{f8a3}"
        case .voicemailFilled: return "\u{f8a4}"
        case .voicemailLight: return "\u{f8a5}"
        case .voicemailRegular: return "\u{f8a6}"
        case .wallpaperBold: return "\u{f8a7}"
        case .wallpaperLight: return "\u{f8a8}"
        case .wallpaperRegular: return "\u{f8a9}"
        case .warningBold: return "\u{f8aa}"
        case .warningFilled: return "\u{f8ab}"
        case .warningLight: return "\u{f8ac}"
        case .warningRegular: return "\u{f8ad}"
        case .webexBoardBold: return "\u{f8ae}"
        case .webexBoardLight: return "\u{f8af}"
        case .webexBoardRegular: return "\u{f8b0}"
        case .webexCodecPlusBold: return "\u{f8b1}"
        case .webexCodecPlusLight: return "\u{f8b2}"
        case .webexCodecPlusRegular: return "\u{f8b3}"
        case .webexDeskCameraBold: return "\u{f8b4}"
        case .webexDeskCameraLight: return "\u{f8b5}"
        case .webexDeskCameraRegular: return "\u{f8b6}"
        case .webexMeetingsBold: return "\u{f8b7}"
        case .webexMeetingsFilled: return "\u{f8b8}"
        case .webexMeetingsLight: return "\u{f8b9}"
        case .webexMeetingsRegular: return "\u{f8ba}"
        case .webexQuadCameraBold: return "\u{f8bb}"
        case .webexQuadCameraLight: return "\u{f8bc}"
        case .webexQuadCameraRegular: return "\u{f8bd}"
        case .webexRoomKitBold: return "\u{f8be}"
        case .webexRoomKitLight: return "\u{f8bf}"
        case .webexRoomKitPlusBold: return "\u{f8c0}"
        case .webexRoomKitPlusLight: return "\u{f8c1}"
        case .webexRoomKitPlusRegular: return "\u{f8c2}"
        case .webexRoomKitRegular: return "\u{f8c3}"
        case .webexShareBold: return "\u{f8c4}"
        case .webexShareLight: return "\u{f8c5}"
        case .webexShareRegular: return "\u{f8c6}"
        case .webexTeamsBold: return "\u{f8c7}"
        case .webexTeamsFilled: return "\u{f8c8}"
        case .webexTeamsLight: return "\u{f8c9}"
        case .webexTeamsNewBold: return "\u{f8ca}"
        case .webexTeamsNewFilled: return "\u{f8cb}"
        case .webexTeamsNewLight: return "\u{f8cc}"
        case .webexTeamsNewRegular: return "\u{f8cd}"
        case .webexTeamsRegular: return "\u{f8ce}"
        case .whiteboardBold: return "\u{f8cf}"
        case .whiteboardContentBold: return "\u{f8d0}"
        case .whiteboardContentLight: return "\u{f8d1}"
        case .whiteboardContentRegular: return "\u{f8d2}"
        case .whiteboardFilled: return "\u{f8d3}"
        case .whiteboardLight: return "\u{f8d4}"
        case .whiteboardRegular: return "\u{f8d5}"
        case .wifiBold: return "\u{f8d6}"
        case .wifiErrorBold: return "\u{f8d7}"
        case .wifiErrorLight: return "\u{f8d8}"
        case .wifiErrorRegular: return "\u{f8d9}"
        case .wifiLight: return "\u{f8da}"
        case .wifiRegular: return "\u{f8db}"
        case .windowCornerScrubBold: return "\u{f8dc}"
        case .windowCornerScrubLight: return "\u{f8dd}"
        case .windowCornerScrubRegular: return "\u{f8de}"
        case .windowVerticalScrubBold: return "\u{f8df}"
        case .windowVerticalScrubLight: return "\u{f8e0}"
        case .windowVerticalScrubRegular: return "\u{f8e1}"
        case .workphoneBold: return "\u{f8e2}"
        case .workphoneLight: return "\u{f8e3}"
        case .workphoneRegular: return "\u{f8e4}"
        case .zoomInBold: return "\u{f8e5}"
        case .zoomInLight: return "\u{f8e6}"
        case .zoomInRegular: return "\u{f8e7}"
        case .zoomOutBold: return "\u{f8e8}"
        case .zoomOutLight: return "\u{f8e9}"
        case .zoomOutRegular: return "\u{f8ea}"
