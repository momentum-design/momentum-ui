            ...
            export default class CoreExample extends React.Component {
              ...
              // Disabled to ignore Dangerously Setting Inner HTML
                ...
                return <div dangerouslySetInnerHTML={{__html: `    <div class="radio-states medium-4 columns cui--client">
      <h3>Filled</h3>
      <h5><code>.cui-radio<br> .cui-input--filled</code></h5>
      <div class="radio-states">
        ...
        <div class="off-state">
          <div class="cui-input-group cui-radio">
            <input type="radio" value="off-state" class="cui-input cui-radio__input">
            <label class="cui-radio__label">
              <span>Off</span>
            </label>
          </div>
    ...
    <div class="radio-states medium-4 end columns cui--dark cui--client" style="background-color: #333333;">
