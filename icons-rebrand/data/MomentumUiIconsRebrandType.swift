...
@objc public enum MomentumIconsRebrandType: Int {
    ...
    public var ligature: String {
        ...
        case .helpBold: return "\u{f5b5}"
        case .helpCircleActiveFilled: return "\u{f5b6}"
        case .helpCircleBold: return "\u{f5b7}"
        case .helpCircleLight: return "\u{f5b8}"
        case .helpCircleRegular: return "\u{f5b9}"
        case .helpLight: return "\u{f5ba}"
        case .helpRegular: return "\u{f5bb}"
        case .helpdeskBold: return "\u{f5bc}"
        case .helpdeskLight: return "\u{f5bd}"
        case .helpdeskRegular: return "\u{f5be}"
        case .hideBold: return "\u{f5bf}"
        case .hideFilled: return "\u{f5c0}"
        case .hideLight: return "\u{f5c1}"
        case .hideRegular: return "\u{f5c2}"
        case .homeBold: return "\u{f5c3}"
        case .homeFilled: return "\u{f5c4}"
        case .homeLight: return "\u{f5c5}"
        case .homeRegular: return "\u{f5c6}"
        case .horizontalLineBold: return "\u{f5c7}"
        case .horizontalLineLight: return "\u{f5c8}"
        case .horizontalLineRegular: return "\u{f5c9}"
        case .hotelingBold: return "\u{f5ca}"
        case .hotelingFilled: return "\u{f5cb}"
        case .hotelingLight: return "\u{f5cc}"
        case .hotelingRegular: return "\u{f5cd}"
        case .humidityBold: return "\u{f5ce}"
        case .humidityLight: return "\u{f5cf}"
        case .humidityRegular: return "\u{f5d0}"
        case .huntGroupBold: return "\u{f5d1}"
        case .huntGroupFilled: return "\u{f5d2}"
        case .huntGroupLight: return "\u{f5d3}"
        case .huntGroupRegular: return "\u{f5d4}"
        case .importBold: return "\u{f5d5}"
        case .importLight: return "\u{f5d6}"
        case .importRegular: return "\u{f5d7}"
        case .inCommonBold: return "\u{f5d8}"
        case .inCommonLight: return "\u{f5d9}"
        case .inCommonRegular: return "\u{f5da}"
        case .includeBold: return "\u{f5db}"
        case .includeLight: return "\u{f5dc}"
        case .includeRegular: return "\u{f5dd}"
        case .incomingCallLegacyBold: return "\u{f5de}"
        case .incomingCallLegacyFilled: return "\u{f5df}"
        case .incomingCallLegacyLight: return "\u{f5e0}"
        case .incomingCallLegacyRegular: return "\u{f5e1}"
        case .infoBadgeFilled: return "\u{f5e2}"
        case .infoCircleBold: return "\u{f5e3}"
        case .infoCircleFilled: return "\u{f5e4}"
        case .infoCircleLight: return "\u{f5e5}"
        case .infoCircleRegular: return "\u{f5e6}"
        case .infoCircleTwoBold: return "\u{f5e7}"
        case .infoCircleTwoFilled: return "\u{f5e8}"
        case .infoCircleTwoLight: return "\u{f5e9}"
        case .infoCircleTwoRegular: return "\u{f5ea}"
        case .inputBold: return "\u{f5eb}"
        case .inputDisconnectedBold: return "\u{f5ec}"
        case .inputDisconnectedLight: return "\u{f5ed}"
        case .inputDisconnectedRegular: return "\u{f5ee}"
        case .inputLight: return "\u{f5ef}"
        case .inputRegular: return "\u{f5f0}"
        case .insightsBold: return "\u{f5f1}"
        case .insightsLight: return "\u{f5f2}"
        case .insightsRegular: return "\u{f5f3}"
        case .instantScheduleBold: return "\u{f5f4}"
        case .instantScheduleFilled: return "\u{f5f5}"
        case .instantScheduleLight: return "\u{f5f6}"
        case .instantScheduleRegular: return "\u{f5f7}"
        case .integrationsBold: return "\u{f5f8}"
        case .integrationsLight: return "\u{f5f9}"
        case .integrationsRegular: return "\u{f5fa}"
        case .intelligentRoutingBold: return "\u{f5fb}"
        case .intelligentRoutingLight: return "\u{f5fc}"
        case .intelligentRoutingRegular: return "\u{f5fd}"
        case .invitedUserBold: return "\u{f5fe}"
        case .invitedUserLight: return "\u{f5ff}"
        case .invitedUserRegular: return "\u{f600}"
        case .italicBold: return "\u{f601}"
        case .italicLight: return "\u{f602}"
        case .italicRegular: return "\u{f603}"
        case .joinAudioBold: return "\u{f604}"
        case .joinAudioFilled: return "\u{f605}"
        case .joinAudioLight: return "\u{f606}"
        case .joinAudioRegular: return "\u{f607}"
        case .keepInTouchBold: return "\u{f608}"
        case .keepInTouchFilled: return "\u{f609}"
        case .keepInTouchLight: return "\u{f60a}"
        case .keepInTouchRegular: return "\u{f60b}"
        case .keyboardBold: return "\u{f60c}"
        case .keyboardCloseBold: return "\u{f60d}"
        case .keyboardCloseLight: return "\u{f60e}"
        case .keyboardCloseRegular: return "\u{f60f}"
        case .keyboardLight: return "\u{f610}"
        case .keyboardRegular: return "\u{f611}"
        case .languageBold: return "\u{f612}"
        case .languageLight: return "\u{f613}"
        case .languageRegular: return "\u{f614}"
        case .laptopBold: return "\u{f615}"
        case .laptopDisconnectedBold: return "\u{f616}"
        case .laptopDisconnectedLight: return "\u{f617}"
        case .laptopDisconnectedRegular: return "\u{f618}"
        case .laptopFilled: return "\u{f619}"
        case .laptopLight: return "\u{f61a}"
        case .laptopRegular: return "\u{f61b}"
        case .laserPointerBold: return "\u{f61c}"
        case .laserPointerLight: return "\u{f61d}"
        case .laserPointerRegular: return "\u{f61e}"
        case .launchBold: return "\u{f61f}"
        case .launchLight: return "\u{f620}"
        case .launchRegular: return "\u{f621}"
        case .layoutSideBySideVerticalBold: return "\u{f622}"
        case .layoutSideBySideVerticalFilled: return "\u{f623}"
        case .layoutSideBySideVerticalLight: return "\u{f624}"
        case .layoutSideBySideVerticalRegular: return "\u{f625}"
        case .leaveBreakoutSessionBold: return "\u{f626}"
        case .leaveBreakoutSessionLight: return "\u{f627}"
        case .leaveBreakoutSessionRegular: return "\u{f628}"
        case .leaveDeviceBold: return "\u{f629}"
        case .leaveDeviceLight: return "\u{f62a}"
        case .leaveDeviceRegular: return "\u{f62b}"
        case .lightningBold: return "\u{f62c}"
        case .lightningFilled: return "\u{f62d}"
        case .lightningLight: return "\u{f62e}"
        case .lightningRegular: return "\u{f62f}"
        case .likeBold: return "\u{f630}"
        case .likeFilled: return "\u{f631}"
        case .likeLight: return "\u{f632}"
        case .likeRegular: return "\u{f633}"
        case .linkBold: return "\u{f634}"
        case .linkLight: return "\u{f635}"
        case .linkRegular: return "\u{f636}"
        case .listBulletedBold: return "\u{f637}"
        case .listBulletedLight: return "\u{f638}"
        case .listBulletedRegular: return "\u{f639}"
        case .listMenuBold: return "\u{f63a}"
        case .listMenuLight: return "\u{f63b}"
        case .listMenuRegular: return "\u{f63c}"
        case .listNumberedBold: return "\u{f63d}"
        case .listNumberedLight: return "\u{f63e}"
        case .listNumberedRegular: return "\u{f63f}"
        case .liveBold: return "\u{f640}"
        case .liveFilled: return "\u{f641}"
        case .liveLight: return "\u{f642}"
        case .liveRegular: return "\u{f643}"
        case .locationBold: return "\u{f644}"
        case .locationFilled: return "\u{f645}"
        case .locationLight: return "\u{f646}"
        case .locationRegular: return "\u{f647}"
        case .longTextBoxBold: return "\u{f648}"
        case .longTextBoxLight: return "\u{f649}"
        case .longTextBoxRegular: return "\u{f64a}"
        case .lowerHandBold: return "\u{f64b}"
        case .lowerHandLight: return "\u{f64c}"
        case .lowerHandRegular: return "\u{f64d}"
        case .magicPenBold: return "\u{f64e}"
        case .magicPenFilled: return "\u{f64f}"
        case .magicPenLight: return "\u{f650}"
        case .magicPenRegular: return "\u{f651}"
        case .markAsUnreadBold: return "\u{f652}"
        case .markAsUnreadLight: return "\u{f653}"
        case .markAsUnreadRegular: return "\u{f654}"
        case .markdownBold: return "\u{f655}"
        case .markdownLight: return "\u{f656}"
        case .markdownRegular: return "\u{f657}"
        case .markerBold: return "\u{f658}"
        case .markerFilled: return "\u{f659}"
        case .markerLight: return "\u{f65a}"
        case .markerRegular: return "\u{f65b}"
        case .maximizeBold: return "\u{f65c}"
        case .maximizeLight: return "\u{f65d}"
        case .maximizeRegular: return "\u{f65e}"
        case .mediaPlayerBold: return "\u{f65f}"
        case .mediaPlayerLight: return "\u{f660}"
        case .mediaPlayerRegular: return "\u{f661}"
        case .mediaQualityGoodBold: return "\u{f662}"
        case .mediaQualityGoodFilled: return "\u{f663}"
        case .mediaQualityGoodLight: return "\u{f664}"
        case .mediaQualityGoodRegular: return "\u{f665}"
        case .mediaQualityPoorBold: return "\u{f666}"
        case .mediaQualityPoorFilled: return "\u{f667}"
        case .mediaQualityPoorLight: return "\u{f668}"
        case .mediaQualityPoorRegular: return "\u{f669}"
        case .mediaQualityUnstableBold: return "\u{f66a}"
        case .mediaQualityUnstableFilled: return "\u{f66b}"
        case .mediaQualityUnstableLight: return "\u{f66c}"
        case .mediaQualityUnstableRegular: return "\u{f66d}"
        case .mediumQualityGoodFilled: return "\u{f66e}"
        case .mediumQualityPoorFilled: return "\u{f66f}"
        case .mediumQualityUnstableFilled: return "\u{f670}"
        case .meetBold: return "\u{f671}"
        case .meetEndBold: return "\u{f672}"
        case .meetEndLight: return "\u{f673}"
        case .meetEndRegular: return "\u{f674}"
        case .meetFilled: return "\u{f675}"
        case .meetLight: return "\u{f676}"
        case .meetRegular: return "\u{f677}"
        case .meetingsBold: return "\u{f678}"
        case .meetingsFilled: return "\u{f679}"
        case .meetingsFocusMonthBold: return "\u{f67a}"
        case .meetingsFocusMonthLight: return "\u{f67b}"
        case .meetingsFocusMonthRegular: return "\u{f67c}"
        case .meetingsFocusOneDayBold: return "\u{f67d}"
        case .meetingsFocusOneDayLight: return "\u{f67e}"
        case .meetingsFocusOneDayRegular: return "\u{f67f}"
        case .meetingsFocusThreeDayBold: return "\u{f680}"
        case .meetingsFocusThreeDayLight: return "\u{f681}"
        case .meetingsFocusThreeDayRegular: return "\u{f682}"
        case .meetingsFocusUpcomingBold: return "\u{f683}"
        case .meetingsFocusUpcomingLight: return "\u{f684}"
        case .meetingsFocusUpcomingRegular: return "\u{f685}"
        case .meetingsFocusWeekBold: return "\u{f686}"
        case .meetingsFocusWeekLight: return "\u{f687}"
        case .meetingsFocusWeekRegular: return "\u{f688}"
        case .meetingsLight: return "\u{f689}"
        case .meetingsPresenceBold: return "\u{f68a}"
        case .meetingsPresenceFilled: return "\u{f68b}"
        case .meetingsPresenceLight: return "\u{f68c}"
        case .meetingsPresenceRegular: return "\u{f68d}"
        case .meetingsPresenceSmallFilled: return "\u{f68e}"
        case .meetingsRegular: return "\u{f68f}"
        case .meetingsTeamActiveBold: return "\u{f690}"
        case .meetingsTeamActiveLight: return "\u{f691}"
        case .meetingsTeamActiveRegular: return "\u{f692}"
        case .meetingsTeamBold: return "\u{f693}"
        case .meetingsTeamLight: return "\u{f694}"
        case .meetingsTeamNewBold: return "\u{f695}"
        case .meetingsTeamNewLight: return "\u{f696}"
        case .meetingsTeamNewRegular: return "\u{f697}"
        case .meetingsTeamRegular: return "\u{f698}"
        case .mentionBold: return "\u{f699}"
        case .mentionLight: return "\u{f69a}"
        case .mentionRegular: return "\u{f69b}"
        case .messageQueingBold: return "\u{f69c}"
        case .messageQueingLight: return "\u{f69d}"
        case .messageQueingRegular: return "\u{f69e}"
        case .microphoneBold: return "\u{f69f}"
        case .microphoneFilled: return "\u{f6a0}"
        case .microphoneHardMutedBold: return "\u{f6a1}"
        case .microphoneHardMutedCircleFilled: return "\u{f6a2}"
        case .microphoneHardMutedColoredBold: return "\u{f6a3}"
        case .microphoneHardMutedColoredLight: return "\u{f6a4}"
        case .microphoneHardMutedColoredRegular: return "\u{f6a5}"
        case .microphoneHardMutedLight: return "\u{f6a6}"
        case .microphoneHardMutedRegular: return "\u{f6a7}"
        case .microphoneLight: return "\u{f6a8}"
        case .microphoneMusicModeBold: return "\u{f6a9}"
        case .microphoneMusicModeColoredBold: return "\u{f6aa}"
        case .microphoneMusicModeColoredLight: return "\u{f6ab}"
        case .microphoneMusicModeColoredRegular: return "\u{f6ac}"
        case .microphoneMusicModeLight: return "\u{f6ad}"
        case .microphoneMusicModeRegular: return "\u{f6ae}"
        case .microphoneMutedBold: return "\u{f6af}"
        case .microphoneMutedFilled: return "\u{f6b0}"
        case .microphoneMutedIndicatorFilled: return "\u{f6b1}"
        case .microphoneMutedLight: return "\u{f6b2}"
        case .microphoneMutedRedBold: return "\u{f6b3}"
        case .microphoneMutedRedFilled: return "\u{f6b4}"
        case .microphoneMutedRedLight: return "\u{f6b5}"
        case .microphoneMutedRedRegular: return "\u{f6b6}"
        case .microphoneMutedRegular: return "\u{f6b7}"
        case .microphoneOptAllBold: return "\u{f6b8}"
        case .microphoneOptAllLight: return "\u{f6b9}"
        case .microphoneOptAllRegular: return "\u{f6ba}"
        case .microphoneOptMeBold: return "\u{f6bb}"
        case .microphoneOptMeLight: return "\u{f6bc}"
        case .microphoneOptMeRegular: return "\u{f6bd}"
        case .microphoneRegular: return "\u{f6be}"
        case .minimizeBold: return "\u{f6bf}"
        case .minimizeLight: return "\u{f6c0}"
        case .minimizeRegular: return "\u{f6c1}"
        case .minusBold: return "\u{f6c2}"
        case .minusLight: return "\u{f6c3}"
        case .minusRegular: return "\u{f6c4}"
        case .mirrorBold: return "\u{f6c5}"
        case .mirrorFilled: return "\u{f6c6}"
        case .mirrorLight: return "\u{f6c7}"
        case .mirrorRegular: return "\u{f6c8}"
        case .moderatorBold: return "\u{f6c9}"
        case .moderatorLight: return "\u{f6ca}"
        case .moderatorRegular: return "\u{f6cb}"
        case .monitoringBold: return "\u{f6cc}"
        case .monitoringLight: return "\u{f6cd}"
        case .monitoringRegular: return "\u{f6ce}"
        case .monthlyRecurringScheduleNodeBold: return "\u{f6cf}"
        case .monthlyRecurringScheduleNodeLight: return "\u{f6d0}"
        case .monthlyRecurringScheduleNodeRegular: return "\u{f6d1}"
        case .moreAdrBold: return "\u{f6d2}"
        case .moreAdrLight: return "\u{f6d3}"
        case .moreAdrRegular: return "\u{f6d4}"
        case .moreBold: return "\u{f6d5}"
        case .moreCircleBold: return "\u{f6d6}"
        case .moreCircleFilled: return "\u{f6d7}"
        case .moreCircleLight: return "\u{f6d8}"
        case .moreCircleRegular: return "\u{f6d9}"
        case .moreCirecleFilled: return "\u{f6da}"
        case .moreLight: return "\u{f6db}"
        case .moreRegular: return "\u{f6dc}"
        case .mouseCursorBold: return "\u{f6dd}"
        case .mouseCursorLight: return "\u{f6de}"
        case .mouseCursorRegular: return "\u{f6df}"
        case .moveCallInAdrBold: return "\u{f6e0}"
        case .moveCallInAdrLight: return "\u{f6e1}"
        case .moveCallInAdrRegular: return "\u{f6e2}"
        case .moveCallInIphBold: return "\u{f6e3}"
        case .moveCallInIphLight: return "\u{f6e4}"
        case .moveCallInIphRegular: return "\u{f6e5}"
        case .moveCallInLaptopBold: return "\u{f6e6}"
        case .moveCallInLaptopLight: return "\u{f6e7}"
        case .moveCallInLaptopRegular: return "\u{f6e8}"
        case .moveCallInOutAdrBold: return "\u{f6e9}"
        case .moveCallInOutAdrLight: return "\u{f6ea}"
        case .moveCallInOutAdrRegular: return "\u{f6eb}"
        case .moveCallInOutIphBold: return "\u{f6ec}"
        case .moveCallInOutIphLight: return "\u{f6ed}"
        case .moveCallInOutIphRegular: return "\u{f6ee}"
        case .moveCallInTabletBold: return "\u{f6ef}"
        case .moveCallInTabletLight: return "\u{f6f0}"
        case .moveCallInTabletRegular: return "\u{f6f1}"
        case .moveCallOutAdrBold: return "\u{f6f2}"
        case .moveCallOutAdrLight: return "\u{f6f3}"
        case .moveCallOutAdrRegular: return "\u{f6f4}"
        case .moveCallOutIphBold: return "\u{f6f5}"
        case .moveCallOutIphLight: return "\u{f6f6}"
        case .moveCallOutIphRegular: return "\u{f6f7}"
        case .moveCallOutLaptopBold: return "\u{f6f8}"
        case .moveCallOutLaptopLight: return "\u{f6f9}"
        case .moveCallOutLaptopRegular: return "\u{f6fa}"
        case .moveCallOutTabletBold: return "\u{f6fb}"
        case .moveCallOutTabletLight: return "\u{f6fc}"
        case .moveCallOutTabletRegular: return "\u{f6fd}"
        case .msTeams: return "\u{f6fe}"
        case .multilineChartBold: return "\u{f6ff}"
        case .multilineChartFilled: return "\u{f700}"
        case .multilineChartLight: return "\u{f701}"
        case .multilineChartRegular: return "\u{f702}"
        case .multimediaBold: return "\u{f703}"
        case .multimediaFilled: return "\u{f704}"
        case .multimediaLight: return "\u{f705}"
        case .multimediaRegular: return "\u{f706}"
        case .multipledDevicesBold: return "\u{f707}"
        case .multipledDevicesLight: return "\u{f708}"
        case .multipledDevicesRegular: return "\u{f709}"
        case .musicModeBold: return "\u{f70a}"
        case .musicModeCircleBold: return "\u{f70b}"
        case .musicModeCircleFilled: return "\u{f70c}"
        case .musicModeCircleLight: return "\u{f70d}"
        case .musicModeCircleRegular: return "\u{f70e}"
        case .musicModeFilled: return "\u{f70f}"
        case .musicModeLight: return "\u{f710}"
        case .musicModeRegular: return "\u{f711}"
        case .muteOnEntryBold: return "\u{f712}"
        case .muteOnEntryFilled: return "\u{f713}"
        case .muteOnEntryLight: return "\u{f714}"
        case .muteOnEntryRegular: return "\u{f715}"
        case .newManagerBold: return "\u{f716}"
        case .newManagerLight: return "\u{f717}"
        case .newManagerRegular: return "\u{f718}"
        case .newTitleBold: return "\u{f719}"
        case .newTitleLight: return "\u{f71a}"
        case .newTitleRegular: return "\u{f71b}"
        case .newVoicemailBold: return "\u{f71c}"
        case .newVoicemailLight: return "\u{f71d}"
        case .newVoicemailRegular: return "\u{f71e}"
        case .newWhiteboardBold: return "\u{f71f}"
        case .newWhiteboardLight: return "\u{f720}"
        case .newWhiteboardRegular: return "\u{f721}"
        case .nextBold: return "\u{f722}"
        case .nextLight: return "\u{f723}"
        case .nextRegular: return "\u{f724}"
        case .noDevicesBold: return "\u{f725}"
        case .noDevicesLight: return "\u{f726}"
        case .noDevicesRegular: return "\u{f727}"
        case .noiseDetectedCanceledFilled: return "\u{f728}"
        case .noiseDetectedFilled: return "\u{f729}"
        case .noiseNoneCanceledFilled: return "\u{f72a}"
        case .noiseNoneFilled: return "\u{f72b}"
        case .noiseRemovalBold: return "\u{f72c}"
        case .noiseRemovalLight: return "\u{f72d}"
        case .noiseRemovalRegular: return "\u{f72e}"
        case .noteBold: return "\u{f72f}"
        case .noteLight: return "\u{f730}"
        case .notePptBold: return "\u{f731}"
        case .notePptLight: return "\u{f732}"
        case .notePptRegular: return "\u{f733}"
        case .noteRegular: return "\u{f734}"
        case .notesBold: return "\u{f735}"
        case .notesLight: return "\u{f736}"
        case .notesRegular: return "\u{f737}"
        case .numberBold: return "\u{f738}"
        case .numberLight: return "\u{f739}"
        case .numberRegular: return "\u{f73a}"
        case .oldRemoteBold: return "\u{f73b}"
        case .oldRemoteLight: return "\u{f73c}"
        case .oldRemoteRegular: return "\u{f73d}"
        case .oldTouchBold: return "\u{f73e}"
        case .oldTouchLight: return "\u{f73f}"
        case .oldTouchRegular: return "\u{f740}"
        case .oneColumnBold: return "\u{f741}"
        case .oneColumnLight: return "\u{f742}"
        case .oneColumnRegular: return "\u{f743}"
        case .openInFolderBold: return "\u{f744}"
        case .openInFolderLight: return "\u{f745}"
        case .openInFolderRegular: return "\u{f746}"
        case .openPagesBold: return "\u{f747}"
        case .openPagesLight: return "\u{f748}"
        case .openPagesRegular: return "\u{f749}"
        case .otherNumberBold: return "\u{f74a}"
        case .otherNumberLight: return "\u{f74b}"
        case .otherNumberRegular: return "\u{f74c}"
        case .otherNumberWarningBold: return "\u{f74d}"
        case .otherNumberWarningLight: return "\u{f74e}"
        case .otherNumberWarningRegular: return "\u{f74f}"
        case .outgoingCallLegacyBold: return "\u{f750}"
        case .outgoingCallLegacyLight: return "\u{f751}"
        case .outgoingCallLegacyRegular: return "\u{f752}"
        case .overflowLeftBold: return "\u{f753}"
        case .overflowLeftLight: return "\u{f754}"
        case .overflowLeftRegular: return "\u{f755}"
        case .overflowRightBold: return "\u{f756}"
        case .overflowRightLight: return "\u{f757}"
        case .overflowRightRegular: return "\u{f758}"
        case .pairedCameraBold: return "\u{f759}"
        case .pairedCameraLight: return "\u{f75a}"
        case .pairedCameraRegular: return "\u{f75b}"
        case .pairedDeviceBold: return "\u{f75c}"
        case .pairedDeviceLight: return "\u{f75d}"
        case .pairedDeviceRegular: return "\u{f75e}"
        case .pairedHandsetBold: return "\u{f75f}"
        case .pairedHandsetLight: return "\u{f760}"
        case .pairedHandsetRegular: return "\u{f761}"
        case .pairingBold: return "\u{f762}"
        case .pairingLight: return "\u{f763}"
        case .pairingRegular: return "\u{f764}"
        case .parkedBold: return "\u{f765}"
        case .parkedFilled: return "\u{f766}"
        case .parkedLight: return "\u{f767}"
        case .parkedRegular: return "\u{f768}"
        case .parseBold: return "\u{f769}"
        case .parseLight: return "\u{f76a}"
        case .parseRegular: return "\u{f76b}"
        case .partialBold: return "\u{f76c}"
        case .partialLight: return "\u{f76d}"
        case .partialRegular: return "\u{f76e}"
        case .participantAddBold: return "\u{f76f}"
        case .participantAddLight: return "\u{f770}"
        case .participantAddRegular: return "\u{f771}"
        case .participantBlockedBold: return "\u{f772}"
        case .participantBlockedLight: return "\u{f773}"
        case .participantBlockedRegular: return "\u{f774}"
        case .participantBold: return "\u{f775}"
        case .participantFilled: return "\u{f776}"
        case .participantLight: return "\u{f777}"
        case .participantListBold: return "\u{f778}"
        case .participantListFilled: return "\u{f779}"
        case .participantListLight: return "\u{f77a}"
        case .participantListRegular: return "\u{f77b}"
        case .participantRegular: return "\u{f77c}"
        case .participantRemoveBold: return "\u{f77d}"
        case .participantRemoveLight: return "\u{f77e}"
        case .participantRemoveRegular: return "\u{f77f}"
        case .participantUnknownBold: return "\u{f780}"
        case .participantUnknownLight: return "\u{f781}"
        case .participantUnknownRegular: return "\u{f782}"
        case .passMouseBold: return "\u{f783}"
        case .passMouseLight: return "\u{f784}"
        case .passMouseRegular: return "\u{f785}"
        case .pauseBold: return "\u{f786}"
        case .pauseFilled: return "\u{f787}"
        case .pauseLight: return "\u{f788}"
        case .pauseRegular: return "\u{f789}"
        case .penBold: return "\u{f78a}"
        case .penFilled: return "\u{f78b}"
        case .penLight: return "\u{f78c}"
        case .penRegular: return "\u{f78d}"
        case .peopleBold: return "\u{f78e}"
        case .peopleCircleBold: return "\u{f78f}"
        case .peopleCircleFilled: return "\u{f790}"
        case .peopleCircleLight: return "\u{f791}"
        case .peopleCircleRegular: return "\u{f792}"
        case .peopleFilled: return "\u{f793}"
        case .peopleInsightsFilled: return "\u{f794}"
        case .peopleLight: return "\u{f795}"
        case .peopleRegular: return "\u{f796}"
        case .phoneAlertBold: return "\u{f797}"
        case .phoneAlertLight: return "\u{f798}"
        case .phoneAlertRegular: return "\u{f799}"
        case .phoneBold: return "\u{f79a}"
        case .phoneFilled: return "\u{f79b}"
        case .phoneLight: return "\u{f79c}"
        case .phoneMutedBold: return "\u{f79d}"
        case .phoneMutedLight: return "\u{f79e}"
        case .phoneMutedRegular: return "\u{f79f}"
        case .phonePrivateBold: return "\u{f7a0}"
        case .phonePrivateLight: return "\u{f7a1}"
        case .phonePrivateRegular: return "\u{f7a2}"
        case .phoneRegular: return "\u{f7a3}"
        case .phoneReplyAllBold: return "\u{f7a4}"
        case .phoneReplyAllLight: return "\u{f7a5}"
        case .phoneReplyAllRegular: return "\u{f7a6}"
        case .phoneReplyBold: return "\u{f7a7}"
        case .phoneReplyLight: return "\u{f7a8}"
        case .phoneReplyRegular: return "\u{f7a9}"
        case .phoneSmallFilled: return "\u{f7aa}"
        case .pickerBold: return "\u{f7ab}"
        case .pickerLight: return "\u{f7ac}"
        case .pickerRegular: return "\u{f7ad}"
        case .pictureInPictureBold: return "\u{f7ae}"
        case .pictureInPictureFilled: return "\u{f7af}"
        case .pictureInPictureLight: return "\u{f7b0}"
        case .pictureInPictureRegular: return "\u{f7b1}"
        case .pieChartBold: return "\u{f7b2}"
        case .pieChartFilled: return "\u{f7b3}"
        case .pieChartLight: return "\u{f7b4}"
        case .pieChartRegular: return "\u{f7b5}"
        case .pinBold: return "\u{f7b6}"
        case .pinFilled: return "\u{f7b7}"
        case .pinLight: return "\u{f7b8}"
        case .pinListActivityBold: return "\u{f7b9}"
        case .pinListActivityColoredBold: return "\u{f7ba}"
        case .pinListActivityColoredLight: return "\u{f7bb}"
        case .pinListActivityColoredRegular: return "\u{f7bc}"
        case .pinListActivityLight: return "\u{f7bd}"
        case .pinListActivityRegular: return "\u{f7be}"
        case .pinListBold: return "\u{f7bf}"
        case .pinListLight: return "\u{f7c0}"
        case .pinListRegular: return "\u{f7c1}"
        case .pinMutedBold: return "\u{f7c2}"
        case .pinMutedFilled: return "\u{f7c3}"
        case .pinMutedLight: return "\u{f7c4}"
        case .pinMutedRegular: return "\u{f7c5}"
        case .pinRegular: return "\u{f7c6}"
        case .placeholderBold: return "\u{f7c7}"
        case .placeholderLight: return "\u{f7c8}"
        case .placeholderRegular: return "\u{f7c9}"
        case .playBold: return "\u{f7ca}"
        case .playCircleBold: return "\u{f7cb}"
        case .playCircleFilled: return "\u{f7cc}"
        case .playCircleLight: return "\u{f7cd}"
        case .playCircleRegular: return "\u{f7ce}"
        case .playFilled: return "\u{f7cf}"
        case .playLight: return "\u{f7d0}"
        case .playRegular: return "\u{f7d1}"
        case .plugAcBold: return "\u{f7d2}"
        case .plugAcLight: return "\u{f7d3}"
        case .plugAcRegular: return "\u{f7d4}"
        case .plusBold: return "\u{f7d5}"
        case .plusCircleBold: return "\u{f7d6}"
        case .plusCircleFilled: return "\u{f7d7}"
        case .plusCircleLight: return "\u{f7d8}"
        case .plusCircleRegular: return "\u{f7d9}"
        case .plusLight: return "\u{f7da}"
        case .plusRegular: return "\u{f7db}"
        case .pmrBold: return "\u{f7dc}"
        case .pmrFilled: return "\u{f7dd}"
        case .pmrLight: return "\u{f7de}"
        case .pmrRegular: return "\u{f7df}"
        case .pollBold: return "\u{f7e0}"
        case .pollLight: return "\u{f7e1}"
        case .pollRegular: return "\u{f7e2}"
        case .popInBold: return "\u{f7e3}"
        case .popInLight: return "\u{f7e4}"
        case .popInRegular: return "\u{f7e5}"
        case .popOutBold: return "\u{f7e6}"
        case .popOutLight: return "\u{f7e7}"
        case .popOutRegular: return "\u{f7e8}"
        case .popUpBold: return "\u{f7e9}"
        case .popUpLight: return "\u{f7ea}"
        case .popUpRegular: return "\u{f7eb}"
        case .portraitLandscapeBold: return "\u{f7ec}"
        case .portraitLandscapeLight: return "\u{f7ed}"
        case .portraitLandscapeRegular: return "\u{f7ee}"
        case .powerAcBold: return "\u{f7ef}"
        case .powerAcLight: return "\u{f7f0}"
        case .powerAcRegular: return "\u{f7f1}"
        case .powerBold: return "\u{f7f2}"
        case .powerLight: return "\u{f7f3}"
        case .powerRegular: return "\u{f7f4}"
        case .preHeaderBold: return "\u{f7f5}"
        case .preHeaderLight: return "\u{f7f6}"
        case .preHeaderRegular: return "\u{f7f7}"
        case .presentationBold: return "\u{f7f8}"
        case .presentationLight: return "\u{f7f9}"
        case .presentationRegular: return "\u{f7fa}"
        case .primaryParticipantBold: return "\u{f7fb}"
        case .primaryParticipantLight: return "\u{f7fc}"
        case .primaryParticipantRegular: return "\u{f7fd}"
        case .printBold: return "\u{f7fe}"
        case .printLight: return "\u{f7ff}"
        case .printRegular: return "\u{f800}"
        case .priorityBadgeFilled: return "\u{f801}"
        case .priorityCircleBold: return "\u{f802}"
        case .priorityCircleFilled: return "\u{f803}"
        case .priorityCircleLight: return "\u{f804}"
        case .priorityCircleRegular: return "\u{f805}"
        case .priorityCircleTwoBold: return "\u{f806}"
        case .priorityCircleTwoFilled: return "\u{f807}"
        case .priorityCircleTwoLight: return "\u{f808}"
        case .priorityCircleTwoRegular: return "\u{f809}"
        case .privacyCircleBold: return "\u{f80a}"
        case .privacyCircleFilled: return "\u{f80b}"
        case .privacyCircleLight: return "\u{f80c}"
        case .privacyCircleRegular: return "\u{f80d}"
        case .privateBold: return "\u{f80e}"
        case .privateCircleBold: return "\u{f80f}"
        case .privateCircleFilled: return "\u{f810}"
        case .privateCircleLight: return "\u{f811}"
        case .privateCircleRegular: return "\u{f812}"
        case .privateLight: return "\u{f813}"
        case .privateMeetingBold: return "\u{f814}"
        case .privateMeetingLight: return "\u{f815}"
        case .privateMeetingRegular: return "\u{f816}"
        case .privateRegular: return "\u{f817}"
        case .productDemoBold: return "\u{f818}"
        case .productDemoLight: return "\u{f819}"
        case .productDemoRegular: return "\u{f81a}"
        case .proximityBold: return "\u{f81b}"
        case .proximityLight: return "\u{f81c}"
        case .proximityMutedBold: return "\u{f81d}"
        case .proximityMutedLight: return "\u{f81e}"
        case .proximityMutedRegular: return "\u{f81f}"
        case .proximityRegular: return "\u{f820}"
        case .proximityVideoBold: return "\u{f821}"
        case .proximityVideoLight: return "\u{f822}"
        case .proximityVideoRegular: return "\u{f823}"
        case .ptoPresenceBold: return "\u{f824}"
        case .ptoPresenceFilled: return "\u{f825}"
        case .ptoPresenceLight: return "\u{f826}"
        case .ptoPresenceRegular: return "\u{f827}"
        case .pullCallBold: return "\u{f828}"
        case .pullCallLight: return "\u{f829}"
        case .pullCallRegular: return "\u{f82a}"
        case .qABold: return "\u{f82b}"
        case .qALight: return "\u{f82c}"
        case .qARegular: return "\u{f82d}"
        case .qualityBold: return "\u{f82e}"
        case .qualityLight: return "\u{f82f}"
        case .qualityRegular: return "\u{f830}"
        case .queueContactBold: return "\u{f831}"
        case .queueContactLight: return "\u{f832}"
        case .queueContactRegular: return "\u{f833}"
        case .quietBold: return "\u{f834}"
        case .quietHoursPresenceBold: return "\u{f835}"
        case .quietHoursPresenceFilled: return "\u{f836}"
        case .quietHoursPresenceLight: return "\u{f837}"
        case .quietHoursPresenceRegular: return "\u{f838}"
        case .quietLight: return "\u{f839}"
        case .quietRegular: return "\u{f83a}"
        case .radioButtonGroupBold: return "\u{f83b}"
        case .radioButtonGroupLight: return "\u{f83c}"
        case .radioButtonGroupRegular: return "\u{f83d}"
        case .raiseHandBold: return "\u{f83e}"
        case .raiseHandCircleFilled: return "\u{f83f}"
        case .raiseHandFilled: return "\u{f840}"
        case .raiseHandLight: return "\u{f841}"
        case .raiseHandRegular: return "\u{f842}"
        case .ramBold: return "\u{f843}"
        case .ramLight: return "\u{f844}"
        case .ramRegular: return "\u{f845}"
        case .reactionsBold: return "\u{f846}"
        case .reactionsFilled: return "\u{f847}"
        case .reactionsLight: return "\u{f848}"
        case .reactionsRegular: return "\u{f849}"
        case .reactivateBold: return "\u{f84a}"
        case .reactivateLight: return "\u{f84b}"
        case .reactivateRegular: return "\u{f84c}"
        case .recentsBold: return "\u{f84d}"
        case .recentsFilled: return "\u{f84e}"
        case .recentsLight: return "\u{f84f}"
        case .recentsPresenceBold: return "\u{f850}"
        case .recentsPresenceFilled: return "\u{f851}"
        case .recentsPresenceLight: return "\u{f852}"
        case .recentsPresenceRegular: return "\u{f853}"
        case .recentsPresenceSmallFilled: return "\u{f854}"
        case .recentsRegular: return "\u{f855}"
        case .recordActiveBold: return "\u{f856}"
        case .recordActiveFilled: return "\u{f857}"
        case .recordActiveLight: return "\u{f858}"
        case .recordActiveRegular: return "\u{f859}"
        case .recordBold: return "\u{f85a}"
        case .recordFilled: return "\u{f85b}"
        case .recordLight: return "\u{f85c}"
        case .recordPausedBold: return "\u{f85d}"
        case .recordPausedFilled: return "\u{f85e}"
        case .recordPausedLight: return "\u{f85f}"
        case .recordPausedRegular: return "\u{f860}"
        case .recordRegular: return "\u{f861}"
        case .recurringBold: return "\u{f862}"
        case .recurringLight: return "\u{f863}"
        case .recurringOffBold: return "\u{f864}"
        case .recurringOffLight: return "\u{f865}"
        case .recurringOffRegular: return "\u{f866}"
        case .recurringRegular: return "\u{f867}"
        case .redialBold: return "\u{f868}"
        case .redialLight: return "\u{f869}"
        case .redialRegular: return "\u{f86a}"
        case .redoBold: return "\u{f86b}"
        case .redoLight: return "\u{f86c}"
        case .redoRegular: return "\u{f86d}"
        case .refreshBold: return "\u{f86e}"
        case .refreshLight: return "\u{f86f}"
        case .refreshRegular: return "\u{f870}"
        case .remoteCallBold: return "\u{f871}"
        case .remoteCallFilled: return "\u{f872}"
        case .remoteCallLight: return "\u{f873}"
        case .remoteCallRegular: return "\u{f874}"
        case .remoteDesktopControlBold: return "\u{f875}"
        case .remoteDesktopControlFilled: return "\u{f876}"
        case .remoteDesktopControlLight: return "\u{f877}"
        case .remoteDesktopControlRegular: return "\u{f878}"
        case .removeBold: return "\u{f879}"
        case .removeFilled: return "\u{f87a}"
        case .removeLight: return "\u{f87b}"
        case .removeRegular: return "\u{f87c}"
        case .replyBold: return "\u{f87d}"
        case .replyFilled: return "\u{f87e}"
        case .replyLight: return "\u{f87f}"
        case .replyListBold: return "\u{f880}"
        case .replyListLight: return "\u{f881}"
        case .replyListRegular: return "\u{f882}"
        case .replyPrivatelyBold: return "\u{f883}"
        case .replyPrivatelyLight: return "\u{f884}"
        case .replyPrivatelyRegular: return "\u{f885}"
        case .replyRegular: return "\u{f886}"
        case .resetBold: return "\u{f887}"
        case .resetLight: return "\u{f888}"
        case .resetRegular: return "\u{f889}"
        case .responsiveMobileBold: return "\u{f88a}"
        case .responsiveMobileLight: return "\u{f88b}"
        case .responsiveMobileRegular: return "\u{f88c}"
        case .restartBold: return "\u{f88d}"
        case .restartLight: return "\u{f88e}"
        case .restartRegular: return "\u{f88f}"
        case .retrieveCallBold: return "\u{f890}"
        case .retrieveCallLight: return "\u{f891}"
        case .retrieveCallRegular: return "\u{f892}"
        case .returnBold: return "\u{f893}"
        case .returnLight: return "\u{f894}"
        case .returnRegular: return "\u{f895}"
        case .ringtoneBold: return "\u{f896}"
        case .ringtoneLight: return "\u{f897}"
        case .ringtoneRegular: return "\u{f898}"
        case .roomCalendarBold: return "\u{f899}"
        case .roomCalendarLight: return "\u{f89a}"
        case .roomCalendarRegular: return "\u{f89b}"
        case .roomLightsBold: return "\u{f89c}"
        case .roomLightsFilled: return "\u{f89d}"
        case .roomLightsLight: return "\u{f89e}"
        case .roomLightsRegular: return "\u{f89f}"
        case .rotateContentBold: return "\u{f8a0}"
        case .rotateContentFilled: return "\u{f8a1}"
        case .rotateContentLight: return "\u{f8a2}"
        case .rotateContentRegular: return "\u{f8a3}"
        case .ruleBasedBold: return "\u{f8a4}"
        case .ruleBasedLight: return "\u{f8a5}"
        case .ruleBasedRegular: return "\u{f8a6}"
        case .runningApplicationBold: return "\u{f8a7}"
        case .runningApplicationFilled: return "\u{f8a8}"
        case .runningApplicationLight: return "\u{f8a9}"
        case .runningApplicationRegular: return "\u{f8aa}"
        case .saveBold: return "\u{f8ab}"
        case .saveLight: return "\u{f8ac}"
        case .saveRegular: return "\u{f8ad}"
        case .saveTranscriptBold: return "\u{f8ae}"
        case .saveTranscriptFilled: return "\u{f8af}"
        case .saveTranscriptLight: return "\u{f8b0}"
        case .saveTranscriptRegular: return "\u{f8b1}"
        case .scanBold: return "\u{f8b2}"
        case .scanLight: return "\u{f8b3}"
        case .scanRegular: return "\u{f8b4}"
        case .schedulerAvailableBold: return "\u{f8b5}"
        case .schedulerAvailableLight: return "\u{f8b6}"
        case .schedulerAvailableRegular: return "\u{f8b7}"
        case .schedulerNotWorkingHoursBold: return "\u{f8b8}"
        case .schedulerNotWorkingHoursLight: return "\u{f8b9}"
        case .schedulerNotWorkingHoursRegular: return "\u{f8ba}"
        case .schedulerUnavailableBold: return "\u{f8bb}"
        case .schedulerUnavailableLight: return "\u{f8bc}"
        case .schedulerUnavailableRegular: return "\u{f8bd}"
        case .schedulerUnknownBold: return "\u{f8be}"
        case .schedulerUnknownLight: return "\u{f8bf}"
        case .schedulerUnknownRegular: return "\u{f8c0}"
        case .screenshotBold: return "\u{f8c1}"
        case .screenshotDocBold: return "\u{f8c2}"
        case .screenshotDocFilled: return "\u{f8c3}"
        case .screenshotDocLight: return "\u{f8c4}"
        case .screenshotDocRegular: return "\u{f8c5}"
        case .screenshotLight: return "\u{f8c6}"
        case .screenshotRegular: return "\u{f8c7}"
        case .searchBold: return "\u{f8c8}"
        case .searchFilled: return "\u{f8c9}"
        case .searchLight: return "\u{f8ca}"
        case .searchRegular: return "\u{f8cb}"
        case .secondaryArrowBold: return "\u{f8cc}"
        case .secondaryArrowLight: return "\u{f8cd}"
        case .secondaryArrowRegular: return "\u{f8ce}"
        case .secureCallLockBold: return "\u{f8cf}"
        case .secureCallLockFilled: return "\u{f8d0}"
        case .secureCallLockLight: return "\u{f8d1}"
        case .secureCallLockRegular: return "\u{f8d2}"
        case .secureCallShieldBold: return "\u{f8d3}"
        case .secureCallShieldFilled: return "\u{f8d4}"
        case .secureCallShieldLight: return "\u{f8d5}"
        case .secureCallShieldRegular: return "\u{f8d6}"
        case .secureCircleBold: return "\u{f8d7}"
        case .secureCircleFilled: return "\u{f8d8}"
        case .secureCircleLight: return "\u{f8d9}"
        case .secureCircleRegular: return "\u{f8da}"
        case .secureLockBold: return "\u{f8db}"
        case .secureLockFilled: return "\u{f8dc}"
        case .secureLockLight: return "\u{f8dd}"
        case .secureLockRegular: return "\u{f8de}"
        case .segmentExcludeFilled: return "\u{f8df}"
        case .segmentFilterFilled: return "\u{f8e0}"
        case .segmentIncludeFilled: return "\u{f8e1}"
        case .selectAllBold: return "\u{f8e2}"
        case .selectAllFilled: return "\u{f8e3}"
        case .selectAllLight: return "\u{f8e4}"
        case .selectAllRegular: return "\u{f8e5}"
        case .selectionBold: return "\u{f8e6}"
        case .selectionLight: return "\u{f8e7}"
        case .selectionRegular: return "\u{f8e8}"
        case .sendBold: return "\u{f8e9}"
        case .sendFilled: return "\u{f8ea}"
        case .sendLight: return "\u{f8eb}"
        case .sendRegular: return "\u{f8ec}"
        case .serverBold: return "\u{f8ed}"
        case .serverErrorBold: return "\u{f8ee}"
        case .serverErrorLight: return "\u{f8ef}"
        case .serverErrorRegular: return "\u{f8f0}"
        case .serverLight: return "\u{f8f1}"
        case .serverRegular: return "\u{f8f2}"
        case .servicesBold: return "\u{f8f3}"
        case .servicesLight: return "\u{f8f4}"
        case .servicesRegular: return "\u{f8f5}"
        case .setVariableBold: return "\u{f8f6}"
        case .setVariableLight: return "\u{f8f7}"
        case .setVariableRegular: return "\u{f8f8}"
        case .settingsBold: return "\u{f8f9}"
        case .settingsFilled: return "\u{f8fa}"
        case .settingsLight: return "\u{f8fb}"
        case .settingsRegular: return "\u{f8fc}"
        case .setupAssistantBold: return "\u{f8fd}"
        case .setupAssistantLight: return "\u{f8fe}"
        case .setupAssistantRegular: return "\u{f8ff}"
        case .sftpBold: return "\u{f900}"
        case .sftpLight: return "\u{f901}"
        case .sftpRegular: return "\u{f902}"
        case .shapeCircleBold: return "\u{f903}"
        case .shapeCircleFilled: return "\u{f904}"
        case .shapeCircleLight: return "\u{f905}"
        case .shapeCircleRegular: return "\u{f906}"
        case .shapeDiagonalLineBold: return "\u{f907}"
        case .shapeDiagonalLineLight: return "\u{f908}"
        case .shapeDiagonalLineRegular: return "\u{f909}"
        case .shapeDiamondBold: return "\u{f90a}"
        case .shapeDiamondFilled: return "\u{f90b}"
        case .shapeDiamondLight: return "\u{f90c}"
        case .shapeDiamondRegular: return "\u{f90d}"
        case .shapeOvalBold: return "\u{f90e}"
        case .shapeOvalLight: return "\u{f90f}"
        case .shapeOvalRegular: return "\u{f910}"
        case .shapeSquareBold: return "\u{f911}"
        case .shapeSquareFilled: return "\u{f912}"
        case .shapeSquareLight: return "\u{f913}"
        case .shapeSquareRegular: return "\u{f914}"
        case .shapeTriangleBold: return "\u{f915}"
        case .shapeTriangleFilled: return "\u{f916}"
        case .shapeTriangleLight: return "\u{f917}"
        case .shapeTriangleRegular: return "\u{f918}"
        case .shapesBold: return "\u{f919}"
        case .shapesLight: return "\u{f91a}"
        case .shapesRegular: return "\u{f91b}"
        case .shareCNativeAdrBold: return "\u{f91c}"
        case .shareCNativeAdrFilled: return "\u{f91d}"
        case .shareCNativeAdrLight: return "\u{f91e}"
        case .shareCNativeAdrRegular: return "\u{f91f}"
        case .shareCNativeIphBold: return "\u{f920}"
        case .shareCNativeIphLight: return "\u{f921}"
        case .shareCNativeIphRegular: return "\u{f922}"
        case .shareScreenBold: return "\u{f923}"
        case .shareScreenFilled: return "\u{f924}"
        case .shareScreenLight: return "\u{f925}"
        case .shareScreenRegular: return "\u{f926}"
        case .shareScreenSmallFilled: return "\u{f927}"
        case .shareSpaceBold: return "\u{f928}"
        case .shareSpaceLight: return "\u{f929}"
        case .shareSpaceRegular: return "\u{f92a}"
        case .shieldBold: return "\u{f92b}"
        case .shieldLight: return "\u{f92c}"
        case .shieldRegular: return "\u{f92d}"
        case .shoppingCartBold: return "\u{f92e}"
        case .shoppingCartFilled: return "\u{f92f}"
        case .shoppingCartLight: return "\u{f930}"
        case .shoppingCartRegular: return "\u{f931}"
        case .shortTextBoxBold: return "\u{f932}"
        case .shortTextBoxLight: return "\u{f933}"
        case .shortTextBoxRegular: return "\u{f934}"
        case .showBold: return "\u{f935}"
        case .showFilled: return "\u{f936}"
        case .showLight: return "\u{f937}"
        case .showRegular: return "\u{f938}"
        case .signInBold: return "\u{f939}"
        case .signInFilled: return "\u{f93a}"
        case .signInForcedBold: return "\u{f93b}"
        case .signInForcedLight: return "\u{f93c}"
        case .signInForcedRegular: return "\u{f93d}"
        case .signInLight: return "\u{f93e}"
        case .signInRegular: return "\u{f93f}"
        case .signOutBold: return "\u{f940}"
        case .signOutLight: return "\u{f941}"
        case .signOutRegular: return "\u{f942}"
        case .signal0Bold: return "\u{f943}"
        case .signal0Light: return "\u{f944}"
        case .signal0Regular: return "\u{f945}"
        case .signal100Bold: return "\u{f946}"
        case .signal100Light: return "\u{f947}"
        case .signal100Regular: return "\u{f948}"
        case .signal25Bold: return "\u{f949}"
        case .signal25Light: return "\u{f94a}"
        case .signal25Regular: return "\u{f94b}"
        case .signal50Bold: return "\u{f94c}"
        case .signal50Light: return "\u{f94d}"
        case .signal50Regular: return "\u{f94e}"
        case .signal75Bold: return "\u{f94f}"
        case .signal75Light: return "\u{f950}"
        case .signal75Regular: return "\u{f951}"
        case .simplePromotionBold: return "\u{f952}"
        case .simplePromotionLight: return "\u{f953}"
        case .simplePromotionRegular: return "\u{f954}"
        case .singleNumberReachBold: return "\u{f955}"
        case .singleNumberReachLight: return "\u{f956}"
        case .singleNumberReachRegular: return "\u{f957}"
        case .sipRegistrationInProgressBold: return "\u{f958}"
        case .sipRegistrationInProgressFilled: return "\u{f959}"
        case .sipRegistrationInProgressLight: return "\u{f95a}"
        case .sipRegistrationInProgressRegular: return "\u{f95b}"
        case .skipBold: return "\u{f95c}"
        case .skipBwBold: return "\u{f95d}"
        case .skipBwFilled: return "\u{f95e}"
        case .skipBwLight: return "\u{f95f}"
        case .skipBwRegular: return "\u{f960}"
        case .skipFwBold: return "\u{f961}"
        case .skipFwFilled: return "\u{f962}"
        case .skipFwLight: return "\u{f963}"
        case .skipFwRegular: return "\u{f964}"
        case .skipLight: return "\u{f965}"
        case .skipRegular: return "\u{f966}"
        case .smsInboundBold: return "\u{f967}"
        case .smsInboundLight: return "\u{f968}"
        case .smsInboundRegular: return "\u{f969}"
        case .smsMessageBold: return "\u{f96a}"
        case .smsMessageFilled: return "\u{f96b}"
        case .smsMessageLight: return "\u{f96c}"
        case .smsMessageRegular: return "\u{f96d}"
        case .socialAlexaFilled: return "\u{f96e}"
        case .socialFacebookColoredFilled: return "\u{f96f}"
        case .socialFacebookFilled: return "\u{f970}"
        case .socialFbmessengerColoredFilled: return "\u{f971}"
        case .socialFbmessengerFilled: return "\u{f972}"
        case .socialInstagramBold: return "\u{f973}"
        case .socialMicrosoftColoredFilled: return "\u{f974}"
        case .socialMicrosoftFilled: return "\u{f975}"
        case .socialMmsFilled: return "\u{f976}"
        case .socialMmsGoldFilled: return "\u{f977}"
        case .socialSmsFilled: return "\u{f978}"
        case .socialSmsMintFilled: return "\u{f979}"
        case .socialTwitterColoredFilled: return "\u{f97a}"
        case .socialTwitterFilled: return "\u{f97b}"
        case .socialViberBold: return "\u{f97c}"
        case .socialViberColoredBold: return "\u{f97d}"
        case .socialWhatsappBold: return "\u{f97e}"
        case .socialWhatsappColoredFilled: return "\u{f97f}"
        case .sortAscendingBold: return "\u{f980}"
        case .sortAscendingLight: return "\u{f981}"
        case .sortAscendingRegular: return "\u{f982}"
        case .sortDescendingBold: return "\u{f983}"
        case .sortDescendingLight: return "\u{f984}"
        case .sortDescendingRegular: return "\u{f985}"
        case .soundDefaultBold: return "\u{f986}"
        case .soundDefaultLight: return "\u{f987}"
        case .soundDefaultRegular: return "\u{f988}"
        case .speakerBold: return "\u{f989}"
        case .speakerDisconnectedBold: return "\u{f98a}"
        case .speakerDisconnectedFilled: return "\u{f98b}"
        case .speakerDisconnectedLight: return "\u{f98c}"
        case .speakerDisconnectedRegular: return "\u{f98d}"
        case .speakerFilled: return "\u{f98e}"
        case .speakerLight: return "\u{f98f}"
        case .speakerMutedBold: return "\u{f990}"
        case .speakerMutedFilled: return "\u{f991}"
        case .speakerMutedLight: return "\u{f992}"
        case .speakerMutedRegular: return "\u{f993}"
        case .speakerOffBold: return "\u{f994}"
        case .speakerOffFilled: return "\u{f995}"
        case .speakerOffLight: return "\u{f996}"
        case .speakerOffRegular: return "\u{f997}"
        case .speakerOnColoredBold: return "\u{f998}"
        case .speakerOnColoredLight: return "\u{f999}"
        case .speakerOnColoredRegular: return "\u{f99a}"
        case .speakerRegular: return "\u{f99b}"
        case .speakerTurnDownBold: return "\u{f99c}"
        case .speakerTurnDownFilled: return "\u{f99d}"
        case .speakerTurnDownLight: return "\u{f99e}"
        case .speakerTurnDownRegular: return "\u{f99f}"
        case .speakerTurnUpBold: return "\u{f9a0}"
        case .speakerTurnUpFilled: return "\u{f9a1}"
        case .speakerTurnUpLight: return "\u{f9a2}"
        case .speakerTurnUpRegular: return "\u{f9a3}"
        case .spellCheckerBold: return "\u{f9a4}"
        case .spellCheckerLight: return "\u{f9a5}"
        case .spellCheckerRegular: return "\u{f9a6}"
        case .spinnerBold: return "\u{f9a7}"
        case .spinnerFilledBold: return "\u{f9a8}"
        case .spinnerFilledLight: return "\u{f9a9}"
        case .spinnerFilledRegular: return "\u{f9aa}"
        case .spinnerLight: return "\u{f9ab}"
        case .spinnerPartialBold: return "\u{f9ac}"
        case .spinnerPartialLight: return "\u{f9ad}"
        case .spinnerPartialRegular: return "\u{f9ae}"
        case .spinnerRegular: return "\u{f9af}"
        case .stackedArea100ChartBold: return "\u{f9b0}"
        case .stackedArea100ChartFilled: return "\u{f9b1}"
        case .stackedArea100ChartLight: return "\u{f9b2}"
        case .stackedArea100ChartRegular: return "\u{f9b3}"
        case .stackedAreaChartBold: return "\u{f9b4}"
        case .stackedAreaChartFilled: return "\u{f9b5}"
        case .stackedAreaChartLight: return "\u{f9b6}"
        case .stackedAreaChartRegular: return "\u{f9b7}"
        case .stackedBar100ChartBold: return "\u{f9b8}"
        case .stackedBar100ChartFilled: return "\u{f9b9}"
        case .stackedBar100ChartLight: return "\u{f9ba}"
        case .stackedBar100ChartRegular: return "\u{f9bb}"
        case .stackedBarChartBold: return "\u{f9bc}"
        case .stackedBarChartFilled: return "\u{f9bd}"
        case .stackedBarChartLight: return "\u{f9be}"
        case .stackedBarChartRegular: return "\u{f9bf}"
        case .startChatBold: return "\u{f9c0}"
        case .startChatLight: return "\u{f9c1}"
        case .startChatRegular: return "\u{f9c2}"
        case .stethoscopeBold: return "\u{f9c3}"
        case .stethoscopeLight: return "\u{f9c4}"
        case .stethoscopeRegular: return "\u{f9c5}"
        case .stickersBold: return "\u{f9c6}"
        case .stickersLight: return "\u{f9c7}"
        case .stickersRegular: return "\u{f9c8}"
        case .stickiesBold: return "\u{f9c9}"
        case .stickiesLight: return "\u{f9ca}"
        case .stickiesRegular: return "\u{f9cb}"
        case .stopBold: return "\u{f9cc}"
        case .stopCircleBold: return "\u{f9cd}"
        case .stopCircleFilled: return "\u{f9ce}"
        case .stopCircleLight: return "\u{f9cf}"
        case .stopCircleRegular: return "\u{f9d0}"
        case .stopContentShareBold: return "\u{f9d1}"
        case .stopContentShareLight: return "\u{f9d2}"
        case .stopContentShareRegular: return "\u{f9d3}"
        case .stopFilled: return "\u{f9d4}"
        case .stopLight: return "\u{f9d5}"
        case .stopRegular: return "\u{f9d6}"
        case .storedInfoBold: return "\u{f9d7}"
        case .storedInfoFilled: return "\u{f9d8}"
        case .storedInfoLight: return "\u{f9d9}"
        case .storedInfoRegular: return "\u{f9da}"
        case .streamingBold: return "\u{f9db}"
        case .streamingLight: return "\u{f9dc}"
        case .streamingRegular: return "\u{f9dd}"
        case .strikethroughBold: return "\u{f9de}"
        case .strikethroughLight: return "\u{f9df}"
        case .strikethroughRegular: return "\u{f9e0}"
        case .studioModeBold: return "\u{f9e1}"
        case .studioModeLight: return "\u{f9e2}"
        case .studioModeRegular: return "\u{f9e3}"
        case .subscriptBold: return "\u{f9e4}"
        case .subscriptLight: return "\u{f9e5}"
        case .subscriptRegular: return "\u{f9e6}"
        case .superscriptBold: return "\u{f9e7}"
        case .superscriptLight: return "\u{f9e8}"
        case .superscriptRegular: return "\u{f9e9}"
        case .surveyBold: return "\u{f9ea}"
        case .surveyFilled: return "\u{f9eb}"
        case .surveyLight: return "\u{f9ec}"
        case .surveyRegular: return "\u{f9ed}"
        case .sx10Bold: return "\u{f9ee}"
        case .sx10Light: return "\u{f9ef}"
        case .sx10Regular: return "\u{f9f0}"
        case .sx20Bold: return "\u{f9f1}"
        case .sx20Light: return "\u{f9f2}"
        case .sx20Regular: return "\u{f9f3}"
        case .sx80CodecBold: return "\u{f9f4}"
        case .sx80CodecLight: return "\u{f9f5}"
        case .sx80CodecRegular: return "\u{f9f6}"
        case .tableBold: return "\u{f9f7}"
        case .tableLight: return "\u{f9f8}"
        case .tableRegular: return "\u{f9f9}"
        case .tabletBold: return "\u{f9fa}"
        case .tabletLight: return "\u{f9fb}"
        case .tabletRegular: return "\u{f9fc}"
        case .tabsBold: return "\u{f9fd}"
        case .tabsLight: return "\u{f9fe}"
        case .tabsRegular: return "\u{f9ff}"
        case .tagBold: return "\u{fa00}"
        case .tagLight: return "\u{fa01}"
        case .tagRegular: return "\u{fa02}"
        case .tapBold: return "\u{fa03}"
        case .tapFilled: return "\u{fa04}"
        case .tapLight: return "\u{fa05}"
        case .tapRegular: return "\u{fa06}"
        case .telepresenceAlertBold: return "\u{fa07}"
        case .telepresenceAlertLight: return "\u{fa08}"
        case .telepresenceAlertMutedBold: return "\u{fa09}"
        case .telepresenceAlertMutedLight: return "\u{fa0a}"
        case .telepresenceAlertMutedRegular: return "\u{fa0b}"
        case .telepresenceAlertRegular: return "\u{fa0c}"
        case .telepresenceBold: return "\u{fa0d}"
        case .telepresenceIx5000Bold: return "\u{fa0e}"
        case .telepresenceIx5000Light: return "\u{fa0f}"
        case .telepresenceIx5000Regular: return "\u{fa10}"
        case .telepresenceLight: return "\u{fa11}"
        case .telepresencePrivateBold: return "\u{fa12}"
        case .telepresencePrivateLight: return "\u{fa13}"
        case .telepresencePrivateRegular: return "\u{fa14}"
        case .telepresenceRegular: return "\u{fa15}"
        case .temperatureBold: return "\u{fa16}"
        case .temperatureLight: return "\u{fa17}"
        case .temperatureRegular: return "\u{fa18}"
        case .textAlignCenterBold: return "\u{fa19}"
        case .textAlignCenterFilled: return "\u{fa1a}"
        case .textAlignCenterLight: return "\u{fa1b}"
        case .textAlignCenterRegular: return "\u{fa1c}"
        case .textAlignLeftBold: return "\u{fa1d}"
        case .textAlignLeftFilled: return "\u{fa1e}"
        case .textAlignLeftLight: return "\u{fa1f}"
        case .textAlignLeftRegular: return "\u{fa20}"
        case .textAlignRightBold: return "\u{fa21}"
        case .textAlignRightFilled: return "\u{fa22}"
        case .textAlignRightLight: return "\u{fa23}"
        case .textAlignRightRegular: return "\u{fa24}"
        case .textBold: return "\u{fa25}"
        case .textCodeBlockBold: return "\u{fa26}"
        case .textCodeBlockLight: return "\u{fa27}"
        case .textCodeBlockRegular: return "\u{fa28}"
        case .textHighlightBold: return "\u{fa29}"
        case .textHighlightLight: return "\u{fa2a}"
        case .textHighlightRegular: return "\u{fa2b}"
        case .textLight: return "\u{fa2c}"
        case .textRegular: return "\u{fa2d}"
        case .threeColumnBold: return "\u{fa2e}"
        case .threeColumnLight: return "\u{fa2f}"
        case .threeColumnRegular: return "\u{fa30}"
        case .threeDObjectBold: return "\u{fa31}"
        case .threeDObjectLight: return "\u{fa32}"
        case .threeDObjectRegular: return "\u{fa33}"
        case .tooFastBold: return "\u{fa34}"
        case .tooFastLight: return "\u{fa35}"
        case .tooFastRegular: return "\u{fa36}"
        case .tooSlowBold: return "\u{fa37}"
        case .tooSlowLight: return "\u{fa38}"
        case .tooSlowRegular: return "\u{fa39}"
        case .toolsBold: return "\u{fa3a}"
        case .toolsLight: return "\u{fa3b}"
        case .toolsRegular: return "\u{fa3c}"
        case .touch10Bold: return "\u{fa3d}"
        case .touch10Light: return "\u{fa3e}"
        case .touch10Regular: return "\u{fa3f}"
        case .transcriptBold: return "\u{fa40}"
        case .transcriptFilled: return "\u{fa41}"
        case .transcriptLight: return "\u{fa42}"
        case .transcriptRegular: return "\u{fa43}"
        case .translateBold: return "\u{fa44}"
        case .translateLight: return "\u{fa45}"
        case .translateRegular: return "\u{fa46}"
        case .trimBold: return "\u{fa47}"
        case .trimLight: return "\u{fa48}"
        case .trimRegular: return "\u{fa49}"
        case .twoColumnBold: return "\u{fa4a}"
        case .twoColumnLight: return "\u{fa4b}"
        case .twoColumnRegular: return "\u{fa4c}"
        case .ucmCloudBold: return "\u{fa4d}"
        case .ucmCloudLight: return "\u{fa4e}"
        case .ucmCloudRegular: return "\u{fa4f}"
        case .underlineBold: return "\u{fa50}"
        case .underlineLight: return "\u{fa51}"
        case .underlineRegular: return "\u{fa52}"
        case .undoBold: return "\u{fa53}"
        case .undoLight: return "\u{fa54}"
        case .undoRegular: return "\u{fa55}"
        case .unlinkBold: return "\u{fa56}"
        case .unlinkLight: return "\u{fa57}"
        case .unlinkRegular: return "\u{fa58}"
        case .unreadBold: return "\u{fa59}"
        case .unreadFilled: return "\u{fa5a}"
        case .unreadLight: return "\u{fa5b}"
        case .unreadRegular: return "\u{fa5c}"
        case .unsecureUnlockedBold: return "\u{fa5d}"
        case .unsecureUnlockedFilled: return "\u{fa5e}"
        case .unsecureUnlockedLight: return "\u{fa5f}"
        case .unsecureUnlockedRegular: return "\u{fa60}"
        case .unsortedBold: return "\u{fa61}"
        case .unsortedLight: return "\u{fa62}"
        case .unsortedRegular: return "\u{fa63}"
        case .updateFileShareBold: return "\u{fa64}"
        case .updateFileShareLight: return "\u{fa65}"
        case .updateFileShareRegular: return "\u{fa66}"
        case .upgradeBold: return "\u{fa67}"
        case .upgradeFilled: return "\u{fa68}"
        case .upgradeLight: return "\u{fa69}"
        case .upgradeRegular: return "\u{fa6a}"
        case .uploadBold: return "\u{fa6b}"
        case .uploadImageBold: return "\u{fa6c}"
        case .uploadImageLight: return "\u{fa6d}"
        case .uploadImageRegular: return "\u{fa6e}"
        case .uploadLight: return "\u{fa6f}"
        case .uploadRegular: return "\u{fa70}"
        case .urgentVoicemailBold: return "\u{fa71}"
        case .urgentVoicemailFilled: return "\u{fa72}"
        case .usbBold: return "\u{fa73}"
        case .usbHeadsetBold: return "\u{fa74}"
        case .usbHeadsetLight: return "\u{fa75}"
        case .usbHeadsetMutedBold: return "\u{fa76}"
        case .usbHeadsetMutedLight: return "\u{fa77}"
        case .usbHeadsetMutedRegular: return "\u{fa78}"
        case .usbHeadsetRegular: return "\u{fa79}"
        case .usbLight: return "\u{fa7a}"
        case .usbRegular: return "\u{fa7b}"
        case .userBold: return "\u{fa7c}"
        case .userDeactivateBold: return "\u{fa7d}"
        case .userDeactivateLight: return "\u{fa7e}"
        case .userDeactivateRegular: return "\u{fa7f}"
        case .userLight: return "\u{fa80}"
        case .userRegular: return "\u{fa81}"
        case .vcsBold: return "\u{fa82}"
        case .vcsLight: return "\u{fa83}"
        case .vcsRegular: return "\u{fa84}"
        case .videoBlurBold: return "\u{fa85}"
        case .videoBlurFilled: return "\u{fa86}"
        case .videoBlurLight: return "\u{fa87}"
        case .videoBlurRegular: return "\u{fa88}"
        case .videoBold: return "\u{fa89}"
        case .videoEffectBold: return "\u{fa8a}"
        case .videoEffectFilled: return "\u{fa8b}"
        case .videoEffectLight: return "\u{fa8c}"
        case .videoEffectRegular: return "\u{fa8d}"
        case .videoFilled: return "\u{fa8e}"
        case .videoLayoutBold: return "\u{fa8f}"
        case .videoLayoutEqualBold: return "\u{fa90}"
        case .videoLayoutEqualDualBold: return "\u{fa91}"
        case .videoLayoutEqualDualLight: return "\u{fa92}"
        case .videoLayoutEqualDualRegular: return "\u{fa93}"
        case .videoLayoutEqualFilled: return "\u{fa94}"
        case .videoLayoutEqualLight: return "\u{fa95}"
        case .videoLayoutEqualRegular: return "\u{fa96}"
        case .videoLayoutFilled: return "\u{fa97}"
        case .videoLayoutLight: return "\u{fa98}"
        case .videoLayoutOverlayBold: return "\u{fa99}"
        case .videoLayoutOverlayLight: return "\u{fa9a}"
        case .videoLayoutOverlayRegular: return "\u{fa9b}"
        case .videoLayoutPresenterDominantBold: return "\u{fa9c}"
        case .videoLayoutPresenterDominantLight: return "\u{fa9d}"
        case .videoLayoutPresenterDominantRegular: return "\u{fa9e}"
        case .videoLayoutProminentBold: return "\u{fa9f}"
        case .videoLayoutProminentFilled: return "\u{faa0}"
        case .videoLayoutProminentLight: return "\u{faa1}"
        case .videoLayoutProminentRegular: return "\u{faa2}"
        case .videoLayoutRegular: return "\u{faa3}"
        case .videoLayoutShareDominantBold: return "\u{faa4}"
        case .videoLayoutShareDominantLight: return "\u{faa5}"
        case .videoLayoutShareDominantRegular: return "\u{faa6}"
        case .videoLayoutSingleBold: return "\u{faa7}"
        case .videoLayoutSingleFilled: return "\u{faa8}"
        case .videoLayoutSingleLight: return "\u{faa9}"
        case .videoLayoutSingleRegular: return "\u{faaa}"
        case .videoLayoutStackBold: return "\u{faab}"
        case .videoLayoutStackFilled: return "\u{faac}"
        case .videoLayoutStackLight: return "\u{faad}"
        case .videoLayoutStackRegular: return "\u{faae}"
        case .videoLayoutVideoDominantBold: return "\u{faaf}"
        case .videoLayoutVideoDominantLight: return "\u{fab0}"
        case .videoLayoutVideoDominantRegular: return "\u{fab1}"
        case .videoLight: return "\u{fab2}"
        case .videoPlusBold: return "\u{fab3}"
        case .videoPlusFilled: return "\u{fab4}"
        case .videoPlusLight: return "\u{fab5}"
        case .videoPlusRegular: return "\u{fab6}"
        case .videoRegular: return "\u{fab7}"
        case .videoSpeakerTrackBold: return "\u{fab8}"
        case .videoSpeakerTrackFilled: return "\u{fab9}"
        case .videoSpeakerTrackLight: return "\u{faba}"
        case .videoSpeakerTrackRegular: return "\u{fabb}"
        case .viewAllBold: return "\u{fabc}"
        case .viewAllLight: return "\u{fabd}"
        case .viewAllRegular: return "\u{fabe}"
        case .viewListBold: return "\u{fabf}"
        case .viewListLight: return "\u{fac0}"
        case .viewListRegular: return "\u{fac1}"
        case .viewStackedBold: return "\u{fac2}"
        case .viewStackedFilled: return "\u{fac3}"
        case .viewStackedLight: return "\u{fac4}"
        case .viewStackedRegular: return "\u{fac5}"
        case .viewThumbnailBold: return "\u{fac6}"
        case .viewThumbnailFilled: return "\u{fac7}"
        case .viewThumbnailLight: return "\u{fac8}"
        case .viewThumbnailRegular: return "\u{fac9}"
        case .voicemailBold: return "\u{faca}"
        case .voicemailFilled: return "\u{facb}"
        case .voicemailLight: return "\u{facc}"
        case .voicemailRegular: return "\u{facd}"
        case .waffleMenuBold: return "\u{face}"
        case .waffleMenuLight: return "\u{facf}"
        case .waffleMenuRegular: return "\u{fad0}"
        case .waitingroomActiveBold: return "\u{fad1}"
        case .waitingroomActiveLight: return "\u{fad2}"
        case .waitingroomActiveRegular: return "\u{fad3}"
        case .wallpaperBold: return "\u{fad4}"
        case .wallpaperLight: return "\u{fad5}"
        case .wallpaperRegular: return "\u{fad6}"
        case .warningBadgeFilled: return "\u{fad7}"
        case .warningBold: return "\u{fad8}"
        case .warningFilled: return "\u{fad9}"
        case .warningLight: return "\u{fada}"
        case .warningRegular: return "\u{fadb}"
        case .webexAssistantActiveColored: return "\u{fadc}"
        case .webexAssistantActive: return "\u{fadd}"
        case .webexAssistantFlat: return "\u{fade}"
        case .webexAssistantInactiveColored: return "\u{fadf}"
        case .webexAssistantInactive: return "\u{fae0}"
        case .webexAssistant: return "\u{fae1}"
        case .webexBoardBold: return "\u{fae2}"
        case .webexBoardLight: return "\u{fae3}"
        case .webexBoardRegular: return "\u{fae4}"
        case .webexCodecPlusBold: return "\u{fae5}"
        case .webexCodecPlusLight: return "\u{fae6}"
        case .webexCodecPlusRegular: return "\u{fae7}"
        case .webexDeskCameraBold: return "\u{fae8}"
        case .webexDeskCameraLight: return "\u{fae9}"
        case .webexDeskCameraRegular: return "\u{faea}"
        case .webexHelixFilled: return "\u{faeb}"
        case .webexMeetingsBold: return "\u{faec}"
        case .webexMeetingsFilled: return "\u{faed}"
        case .webexMeetingsLight: return "\u{faee}"
        case .webexMeetingsRegular: return "\u{faef}"
        case .webexQuadCameraBold: return "\u{faf0}"
        case .webexQuadCameraLight: return "\u{faf1}"
        case .webexQuadCameraRegular: return "\u{faf2}"
        case .webexRoomKitBold: return "\u{faf3}"
        case .webexRoomKitLight: return "\u{faf4}"
        case .webexRoomKitPlusBold: return "\u{faf5}"
        case .webexRoomKitPlusLight: return "\u{faf6}"
        case .webexRoomKitPlusRegular: return "\u{faf7}"
        case .webexRoomKitRegular: return "\u{faf8}"
        case .webexShareBold: return "\u{faf9}"
        case .webexShareLight: return "\u{fafa}"
        case .webexShareRegular: return "\u{fafb}"
        case .webexTeamsBold: return "\u{fafc}"
        case .webexTeamsFilled: return "\u{fafd}"
        case .webexTeamsLight: return "\u{fafe}"
        case .webexTeamsNewBold: return "\u{faff}"
        case .webexTeamsNewFilled: return "\u{fb00}"
        case .webexTeamsNewLight: return "\u{fb01}"
        case .webexTeamsNewRegular: return "\u{fb02}"
        case .webexTeamsRegular: return "\u{fb03}"
        case .webinarBold: return "\u{fb04}"
        case .webinarFilled: return "\u{fb05}"
        case .webinarLight: return "\u{fb06}"
        case .webinarRegular: return "\u{fb07}"
        case .weeklyRecurringScheduleNodeBold: return "\u{fb08}"
        case .weeklyRecurringScheduleNodeLight: return "\u{fb09}"
        case .weeklyRecurringScheduleNodeRegular: return "\u{fb0a}"
        case .whatsNewBold: return "\u{fb0b}"
        case .whatsNewFilled: return "\u{fb0c}"
        case .whatsNewLight: return "\u{fb0d}"
        case .whatsNewRegular: return "\u{fb0e}"
        case .whiteboardBold: return "\u{fb0f}"
        case .whiteboardContentBold: return "\u{fb10}"
        case .whiteboardContentLight: return "\u{fb11}"
        case .whiteboardContentRegular: return "\u{fb12}"
        case .whiteboardFilled: return "\u{fb13}"
        case .whiteboardLight: return "\u{fb14}"
        case .whiteboardRegular: return "\u{fb15}"
        case .widgetBold: return "\u{fb16}"
        case .widgetFilled: return "\u{fb17}"
        case .widgetLight: return "\u{fb18}"
        case .widgetRegular: return "\u{fb19}"
        case .wifiBold: return "\u{fb1a}"
        case .wifiErrorBold: return "\u{fb1b}"
        case .wifiErrorLight: return "\u{fb1c}"
        case .wifiErrorRegular: return "\u{fb1d}"
        case .wifiLight: return "\u{fb1e}"
        case .wifiRegular: return "\u{fb1f}"
        case .wifiSignalGoodColoredBold: return "\u{fb20}"
        case .wifiSignalGoodColoredLight: return "\u{fb21}"
        case .wifiSignalGoodColoredRegular: return "\u{fb22}"
        case .wifiSignalPoorColoredBold: return "\u{fb23}"
        case .wifiSignalPoorColoredLight: return "\u{fb24}"
        case .wifiSignalPoorColoredRegular: return "\u{fb25}"
        case .wifiSignalUnstableColoredBold: return "\u{fb26}"
        case .wifiSignalUnstableColoredLight: return "\u{fb27}"
        case .wifiSignalUnstableColoredRegular: return "\u{fb28}"
        case .windowCornerScrubBold: return "\u{fb29}"
        case .windowCornerScrubLight: return "\u{fb2a}"
        case .windowCornerScrubRegular: return "\u{fb2b}"
        case .windowRightCornerScrubBold: return "\u{fb2c}"
        case .windowRightCornerScrubLight: return "\u{fb2d}"
        case .windowRightCornerScrubRegular: return "\u{fb2e}"
        case .windowVerticalScrubBold: return "\u{fb2f}"
        case .windowVerticalScrubLight: return "\u{fb30}"
        case .windowVerticalScrubRegular: return "\u{fb31}"
        case .workflowDeploymentsBold: return "\u{fb32}"
        case .workflowDeploymentsFilled: return "\u{fb33}"
        case .workflowDeploymentsLight: return "\u{fb34}"
        case .workflowDeploymentsRegular: return "\u{fb35}"
        case .workphoneBold: return "\u{fb36}"
        case .workphoneLight: return "\u{fb37}"
        case .workphoneRegular: return "\u{fb38}"
        case .zoomInBold: return "\u{fb39}"
        case .zoomInLight: return "\u{fb3a}"
        case .zoomInRegular: return "\u{fb3b}"
        case .zoomOutBold: return "\u{fb3c}"
        case .zoomOutLight: return "\u{fb3d}"
        case .zoomOutRegular: return "\u{fb3e}"
        case .zoom: return "\u{fb3f}"
