...
@objc public enum MomentumIconsRebrandType: Int {
    ...
    public var ligature: String {
        ...
        case .pictureInPictureFilled: return "\u{f724}"
        case .pictureInPictureLight: return "\u{f725}"
        case .pictureInPictureRegular: return "\u{f726}"
        case .pieChartBold: return "\u{f727}"
        case .pieChartFilled: return "\u{f728}"
        case .pieChartLight: return "\u{f729}"
        case .pieChartRegular: return "\u{f72a}"
        case .pinBold: return "\u{f72b}"
        case .pinFilled: return "\u{f72c}"
        case .pinLight: return "\u{f72d}"
        case .pinListActivityBold: return "\u{f72e}"
        case .pinListActivityColoredBold: return "\u{f72f}"
        case .pinListActivityColoredLight: return "\u{f730}"
        case .pinListActivityColoredRegular: return "\u{f731}"
        case .pinListActivityLight: return "\u{f732}"
        case .pinListActivityRegular: return "\u{f733}"
        case .pinListBold: return "\u{f734}"
        case .pinListLight: return "\u{f735}"
        case .pinListRegular: return "\u{f736}"
        case .pinMutedBold: return "\u{f737}"
        case .pinMutedFilled: return "\u{f738}"
        case .pinMutedLight: return "\u{f739}"
        case .pinMutedRegular: return "\u{f73a}"
        case .pinRegular: return "\u{f73b}"
        case .placeholderBold: return "\u{f73c}"
        case .placeholderLight: return "\u{f73d}"
        case .placeholderRegular: return "\u{f73e}"
        case .playBold: return "\u{f73f}"
        case .playFilled: return "\u{f740}"
        case .playLight: return "\u{f741}"
        case .playRegular: return "\u{f742}"
        case .plugAcBold: return "\u{f743}"
        case .plugAcLight: return "\u{f744}"
        case .plugAcRegular: return "\u{f745}"
        case .plusBold: return "\u{f746}"
        case .plusCircleBold: return "\u{f747}"
        case .plusCircleFilled: return "\u{f748}"
        case .plusCircleLight: return "\u{f749}"
        case .plusCircleRegular: return "\u{f74a}"
        case .plusLight: return "\u{f74b}"
        case .plusRegular: return "\u{f74c}"
        case .pmrBold: return "\u{f74d}"
        case .pmrFilled: return "\u{f74e}"
        case .pmrLight: return "\u{f74f}"
        case .pmrRegular: return "\u{f750}"
        case .pollBold: return "\u{f751}"
        case .pollLight: return "\u{f752}"
        case .pollRegular: return "\u{f753}"
        case .popInBold: return "\u{f754}"
        case .popInLight: return "\u{f755}"
        case .popInRegular: return "\u{f756}"
        case .popOutBold: return "\u{f757}"
        case .popOutLight: return "\u{f758}"
        case .popOutRegular: return "\u{f759}"
        case .popUpBold: return "\u{f75a}"
        case .popUpLight: return "\u{f75b}"
        case .popUpRegular: return "\u{f75c}"
        case .portraitLandscapeBold: return "\u{f75d}"
        case .portraitLandscapeLight: return "\u{f75e}"
        case .portraitLandscapeRegular: return "\u{f75f}"
        case .powerAcBold: return "\u{f760}"
        case .powerAcLight: return "\u{f761}"
        case .powerAcRegular: return "\u{f762}"
        case .powerBold: return "\u{f763}"
        case .powerLight: return "\u{f764}"
        case .powerRegular: return "\u{f765}"
        case .preHeaderBold: return "\u{f766}"
        case .preHeaderLight: return "\u{f767}"
        case .preHeaderRegular: return "\u{f768}"
        case .presentationBold: return "\u{f769}"
        case .presentationLight: return "\u{f76a}"
        case .presentationRegular: return "\u{f76b}"
        case .primaryParticipantBold: return "\u{f76c}"
        case .primaryParticipantLight: return "\u{f76d}"
        case .primaryParticipantRegular: return "\u{f76e}"
        case .printBold: return "\u{f76f}"
        case .printLight: return "\u{f770}"
        case .printRegular: return "\u{f771}"
        case .priorityBadgeFilled: return "\u{f772}"
        case .priorityCircleBold: return "\u{f773}"
        case .priorityCircleFilled: return "\u{f774}"
        case .priorityCircleLight: return "\u{f775}"
        case .priorityCircleRegular: return "\u{f776}"
        case .priorityCircleTwoBold: return "\u{f777}"
        case .priorityCircleTwoFilled: return "\u{f778}"
        case .priorityCircleTwoLight: return "\u{f779}"
        case .priorityCircleTwoRegular: return "\u{f77a}"
        case .privacyCircleBold: return "\u{f77b}"
        case .privacyCircleFilled: return "\u{f77c}"
        case .privacyCircleLight: return "\u{f77d}"
        case .privacyCircleRegular: return "\u{f77e}"
        case .privateBold: return "\u{f77f}"
        case .privateCircleBold: return "\u{f780}"
        case .privateCircleFilled: return "\u{f781}"
        case .privateCircleLight: return "\u{f782}"
        case .privateCircleRegular: return "\u{f783}"
        case .privateLight: return "\u{f784}"
        case .privateMeetingBold: return "\u{f785}"
        case .privateMeetingLight: return "\u{f786}"
        case .privateMeetingRegular: return "\u{f787}"
        case .privateRegular: return "\u{f788}"
        case .productDemoBold: return "\u{f789}"
        case .productDemoLight: return "\u{f78a}"
        case .productDemoRegular: return "\u{f78b}"
        case .proximityBold: return "\u{f78c}"
        case .proximityLight: return "\u{f78d}"
        case .proximityMutedBold: return "\u{f78e}"
        case .proximityMutedLight: return "\u{f78f}"
        case .proximityMutedRegular: return "\u{f790}"
        case .proximityRegular: return "\u{f791}"
        case .proximityVideoBold: return "\u{f792}"
        case .proximityVideoLight: return "\u{f793}"
        case .proximityVideoRegular: return "\u{f794}"
        case .ptoPresenceBold: return "\u{f795}"
        case .ptoPresenceFilled: return "\u{f796}"
        case .ptoPresenceLight: return "\u{f797}"
        case .ptoPresenceRegular: return "\u{f798}"
        case .pullCallBold: return "\u{f799}"
        case .pullCallLight: return "\u{f79a}"
        case .pullCallRegular: return "\u{f79b}"
        case .qABold: return "\u{f79c}"
        case .qALight: return "\u{f79d}"
        case .qARegular: return "\u{f79e}"
        case .qualityBold: return "\u{f79f}"
        case .qualityLight: return "\u{f7a0}"
        case .qualityRegular: return "\u{f7a1}"
        case .queueContactBold: return "\u{f7a2}"
        case .queueContactLight: return "\u{f7a3}"
        case .queueContactRegular: return "\u{f7a4}"
        case .quietBold: return "\u{f7a5}"
        case .quietHoursPresenceBold: return "\u{f7a6}"
        case .quietHoursPresenceFilled: return "\u{f7a7}"
        case .quietHoursPresenceLight: return "\u{f7a8}"
        case .quietHoursPresenceRegular: return "\u{f7a9}"
        case .quietLight: return "\u{f7aa}"
        case .quietRegular: return "\u{f7ab}"
        case .radioButtonGroupBold: return "\u{f7ac}"
        case .radioButtonGroupLight: return "\u{f7ad}"
        case .radioButtonGroupRegular: return "\u{f7ae}"
        case .raiseHandBold: return "\u{f7af}"
        case .raiseHandLight: return "\u{f7b0}"
        case .raiseHandRegular: return "\u{f7b1}"
        case .ramBold: return "\u{f7b2}"
        case .ramLight: return "\u{f7b3}"
        case .ramRegular: return "\u{f7b4}"
        case .reactionsBold: return "\u{f7b5}"
        case .reactionsFilled: return "\u{f7b6}"
        case .reactionsLight: return "\u{f7b7}"
        case .reactionsRegular: return "\u{f7b8}"
        case .reactivateBold: return "\u{f7b9}"
        case .reactivateLight: return "\u{f7ba}"
        case .reactivateRegular: return "\u{f7bb}"
        case .recentsBold: return "\u{f7bc}"
        case .recentsFilled: return "\u{f7bd}"
        case .recentsLight: return "\u{f7be}"
        case .recentsPresenceBold: return "\u{f7bf}"
        case .recentsPresenceFilled: return "\u{f7c0}"
        case .recentsPresenceLight: return "\u{f7c1}"
        case .recentsPresenceRegular: return "\u{f7c2}"
        case .recentsPresenceSmallFilled: return "\u{f7c3}"
        case .recentsRegular: return "\u{f7c4}"
        case .recordBold: return "\u{f7c5}"
        case .recordFilled: return "\u{f7c6}"
        case .recordLight: return "\u{f7c7}"
        case .recordPausedBold: return "\u{f7c8}"
        case .recordPausedFilled: return "\u{f7c9}"
        case .recordPausedLight: return "\u{f7ca}"
        case .recordPausedRegular: return "\u{f7cb}"
        case .recordRegular: return "\u{f7cc}"
        case .recurringBold: return "\u{f7cd}"
        case .recurringLight: return "\u{f7ce}"
        case .recurringOffBold: return "\u{f7cf}"
        case .recurringOffLight: return "\u{f7d0}"
        case .recurringOffRegular: return "\u{f7d1}"
        case .recurringRegular: return "\u{f7d2}"
        case .redialBold: return "\u{f7d3}"
        case .redialLight: return "\u{f7d4}"
        case .redialRegular: return "\u{f7d5}"
        case .redoBold: return "\u{f7d6}"
        case .redoLight: return "\u{f7d7}"
        case .redoRegular: return "\u{f7d8}"
        case .refreshBold: return "\u{f7d9}"
        case .refreshLight: return "\u{f7da}"
        case .refreshRegular: return "\u{f7db}"
        case .remoteCallBold: return "\u{f7dc}"
        case .remoteCallFilled: return "\u{f7dd}"
        case .remoteCallLight: return "\u{f7de}"
        case .remoteCallRegular: return "\u{f7df}"
        case .remoteDesktopControlBold: return "\u{f7e0}"
        case .remoteDesktopControlFilled: return "\u{f7e1}"
        case .remoteDesktopControlLight: return "\u{f7e2}"
        case .remoteDesktopControlRegular: return "\u{f7e3}"
        case .removeBold: return "\u{f7e4}"
        case .removeFilled: return "\u{f7e5}"
        case .removeLight: return "\u{f7e6}"
        case .removeRegular: return "\u{f7e7}"
        case .replyBold: return "\u{f7e8}"
        case .replyFilled: return "\u{f7e9}"
        case .replyLight: return "\u{f7ea}"
        case .replyListBold: return "\u{f7eb}"
        case .replyListLight: return "\u{f7ec}"
        case .replyListRegular: return "\u{f7ed}"
        case .replyRegular: return "\u{f7ee}"
        case .resetBold: return "\u{f7ef}"
        case .resetLight: return "\u{f7f0}"
        case .resetRegular: return "\u{f7f1}"
        case .responsiveMobileBold: return "\u{f7f2}"
        case .responsiveMobileLight: return "\u{f7f3}"
        case .responsiveMobileRegular: return "\u{f7f4}"
        case .restartBold: return "\u{f7f5}"
        case .restartLight: return "\u{f7f6}"
        case .restartRegular: return "\u{f7f7}"
        case .retrieveCallBold: return "\u{f7f8}"
        case .retrieveCallLight: return "\u{f7f9}"
        case .retrieveCallRegular: return "\u{f7fa}"
        case .returnBold: return "\u{f7fb}"
        case .returnLight: return "\u{f7fc}"
        case .returnRegular: return "\u{f7fd}"
        case .ringtoneBold: return "\u{f7fe}"
        case .ringtoneLight: return "\u{f7ff}"
        case .ringtoneRegular: return "\u{f800}"
        case .roomCalendarBold: return "\u{f801}"
        case .roomCalendarLight: return "\u{f802}"
        case .roomCalendarRegular: return "\u{f803}"
        case .roomLightsBold: return "\u{f804}"
        case .roomLightsFilled: return "\u{f805}"
        case .roomLightsLight: return "\u{f806}"
        case .roomLightsRegular: return "\u{f807}"
        case .rotateContentBold: return "\u{f808}"
        case .rotateContentFilled: return "\u{f809}"
        case .rotateContentLight: return "\u{f80a}"
        case .rotateContentRegular: return "\u{f80b}"
        case .ruleBasedBold: return "\u{f80c}"
        case .ruleBasedLight: return "\u{f80d}"
        case .ruleBasedRegular: return "\u{f80e}"
        case .runningApplicationBold: return "\u{f80f}"
        case .runningApplicationFilled: return "\u{f810}"
        case .runningApplicationLight: return "\u{f811}"
        case .runningApplicationRegular: return "\u{f812}"
        case .saveBold: return "\u{f813}"
        case .saveLight: return "\u{f814}"
        case .saveRegular: return "\u{f815}"
        case .scanBold: return "\u{f816}"
        case .scanLight: return "\u{f817}"
        case .scanRegular: return "\u{f818}"
        case .schedulerAvailableBold: return "\u{f819}"
        case .schedulerAvailableLight: return "\u{f81a}"
        case .schedulerAvailableRegular: return "\u{f81b}"
        case .schedulerNotWorkingHoursBold: return "\u{f81c}"
        case .schedulerNotWorkingHoursLight: return "\u{f81d}"
        case .schedulerNotWorkingHoursRegular: return "\u{f81e}"
        case .schedulerUnavailableBold: return "\u{f81f}"
        case .schedulerUnavailableLight: return "\u{f820}"
        case .schedulerUnavailableRegular: return "\u{f821}"
        case .schedulerUnknownBold: return "\u{f822}"
        case .schedulerUnknownLight: return "\u{f823}"
        case .schedulerUnknownRegular: return "\u{f824}"
        case .screenshotBold: return "\u{f825}"
        case .screenshotDocBold: return "\u{f826}"
        case .screenshotDocFilled: return "\u{f827}"
        case .screenshotDocLight: return "\u{f828}"
        case .screenshotDocRegular: return "\u{f829}"
        case .screenshotLight: return "\u{f82a}"
        case .screenshotRegular: return "\u{f82b}"
        case .searchBold: return "\u{f82c}"
        case .searchFilled: return "\u{f82d}"
        case .searchLight: return "\u{f82e}"
        case .searchRegular: return "\u{f82f}"
        case .secondaryArrowBold: return "\u{f830}"
        case .secondaryArrowLight: return "\u{f831}"
        case .secondaryArrowRegular: return "\u{f832}"
        case .secureCallLockBold: return "\u{f833}"
        case .secureCallLockFilled: return "\u{f834}"
        case .secureCallLockLight: return "\u{f835}"
        case .secureCallLockRegular: return "\u{f836}"
        case .secureCallShieldBold: return "\u{f837}"
        case .secureCallShieldFilled: return "\u{f838}"
        case .secureCallShieldLight: return "\u{f839}"
        case .secureCallShieldRegular: return "\u{f83a}"
        case .secureCircleBold: return "\u{f83b}"
        case .secureCircleFilled: return "\u{f83c}"
        case .secureCircleLight: return "\u{f83d}"
        case .secureCircleRegular: return "\u{f83e}"
        case .secureLockBold: return "\u{f83f}"
        case .secureLockFilled: return "\u{f840}"
        case .secureLockLight: return "\u{f841}"
        case .secureLockRegular: return "\u{f842}"
        case .selectAllBold: return "\u{f843}"
        case .selectAllFilled: return "\u{f844}"
        case .selectAllLight: return "\u{f845}"
        case .selectAllRegular: return "\u{f846}"
        case .selectionBold: return "\u{f847}"
        case .selectionLight: return "\u{f848}"
        case .selectionRegular: return "\u{f849}"
        case .sendBold: return "\u{f84a}"
        case .sendFilled: return "\u{f84b}"
        case .sendLight: return "\u{f84c}"
        case .sendRegular: return "\u{f84d}"
        case .serverBold: return "\u{f84e}"
        case .serverErrorBold: return "\u{f84f}"
        case .serverErrorLight: return "\u{f850}"
        case .serverErrorRegular: return "\u{f851}"
        case .serverLight: return "\u{f852}"
        case .serverRegular: return "\u{f853}"
        case .servicesBold: return "\u{f854}"
        case .servicesLight: return "\u{f855}"
        case .servicesRegular: return "\u{f856}"
        case .setVariableBold: return "\u{f857}"
        case .setVariableLight: return "\u{f858}"
        case .setVariableRegular: return "\u{f859}"
        case .settingsBold: return "\u{f85a}"
        case .settingsFilled: return "\u{f85b}"
        case .settingsLight: return "\u{f85c}"
        case .settingsRegular: return "\u{f85d}"
        case .setupAssistantBold: return "\u{f85e}"
        case .setupAssistantLight: return "\u{f85f}"
        case .setupAssistantRegular: return "\u{f860}"
        case .sftpBold: return "\u{f861}"
        case .sftpLight: return "\u{f862}"
        case .sftpRegular: return "\u{f863}"
        case .shapeCircleBold: return "\u{f864}"
        case .shapeCircleFilled: return "\u{f865}"
        case .shapeCircleLight: return "\u{f866}"
        case .shapeCircleRegular: return "\u{f867}"
        case .shapeDiagonalLineBold: return "\u{f868}"
        case .shapeDiagonalLineLight: return "\u{f869}"
        case .shapeDiagonalLineRegular: return "\u{f86a}"
        case .shapeDiamondBold: return "\u{f86b}"
        case .shapeDiamondFilled: return "\u{f86c}"
        case .shapeDiamondLight: return "\u{f86d}"
        case .shapeDiamondRegular: return "\u{f86e}"
        case .shapeOvalBold: return "\u{f86f}"
        case .shapeOvalLight: return "\u{f870}"
        case .shapeOvalRegular: return "\u{f871}"
        case .shapeSquareBold: return "\u{f872}"
        case .shapeSquareFilled: return "\u{f873}"
        case .shapeSquareLight: return "\u{f874}"
        case .shapeSquareRegular: return "\u{f875}"
        case .shapeTriangleBold: return "\u{f876}"
        case .shapeTriangleFilled: return "\u{f877}"
        case .shapeTriangleLight: return "\u{f878}"
        case .shapeTriangleRegular: return "\u{f879}"
        case .shapesBold: return "\u{f87a}"
        case .shapesLight: return "\u{f87b}"
        case .shapesRegular: return "\u{f87c}"
        case .shareCNativeAdrBold: return "\u{f87d}"
        case .shareCNativeAdrLight: return "\u{f87e}"
        case .shareCNativeAdrRegular: return "\u{f87f}"
        case .shareCNativeIphBold: return "\u{f880}"
        case .shareCNativeIphLight: return "\u{f881}"
        case .shareCNativeIphRegular: return "\u{f882}"
        case .shareScreenBold: return "\u{f883}"
        case .shareScreenFilled: return "\u{f884}"
        case .shareScreenLight: return "\u{f885}"
        case .shareScreenRegular: return "\u{f886}"
        case .shareScreenSmallFilled: return "\u{f887}"
        case .shareSpaceBold: return "\u{f888}"
        case .shareSpaceLight: return "\u{f889}"
        case .shareSpaceRegular: return "\u{f88a}"
        case .shieldBold: return "\u{f88b}"
        case .shieldLight: return "\u{f88c}"
        case .shieldRegular: return "\u{f88d}"
        case .shortTextBoxBold: return "\u{f88e}"
        case .shortTextBoxLight: return "\u{f88f}"
        case .shortTextBoxRegular: return "\u{f890}"
        case .showBold: return "\u{f891}"
        case .showFilled: return "\u{f892}"
        case .showLight: return "\u{f893}"
        case .showRegular: return "\u{f894}"
        case .signInBold: return "\u{f895}"
        case .signInFilled: return "\u{f896}"
        case .signInForcedBold: return "\u{f897}"
        case .signInForcedLight: return "\u{f898}"
        case .signInForcedRegular: return "\u{f899}"
        case .signInLight: return "\u{f89a}"
        case .signInRegular: return "\u{f89b}"
        case .signOutBold: return "\u{f89c}"
        case .signOutLight: return "\u{f89d}"
        case .signOutRegular: return "\u{f89e}"
        case .signal0Bold: return "\u{f89f}"
        case .signal0Light: return "\u{f8a0}"
        case .signal0Regular: return "\u{f8a1}"
        case .signal100Bold: return "\u{f8a2}"
        case .signal100Light: return "\u{f8a3}"
        case .signal100Regular: return "\u{f8a4}"
        case .signal25Bold: return "\u{f8a5}"
        case .signal25Light: return "\u{f8a6}"
        case .signal25Regular: return "\u{f8a7}"
        case .signal50Bold: return "\u{f8a8}"
        case .signal50Light: return "\u{f8a9}"
        case .signal50Regular: return "\u{f8aa}"
        case .signal75Bold: return "\u{f8ab}"
        case .signal75Light: return "\u{f8ac}"
        case .signal75Regular: return "\u{f8ad}"
        case .simplePromotionBold: return "\u{f8ae}"
        case .simplePromotionLight: return "\u{f8af}"
        case .simplePromotionRegular: return "\u{f8b0}"
        case .singleNumberReachBold: return "\u{f8b1}"
        case .singleNumberReachLight: return "\u{f8b2}"
        case .singleNumberReachRegular: return "\u{f8b3}"
        case .sipRegistrationInProgressBold: return "\u{f8b4}"
        case .sipRegistrationInProgressFilled: return "\u{f8b5}"
        case .sipRegistrationInProgressLight: return "\u{f8b6}"
        case .sipRegistrationInProgressRegular: return "\u{f8b7}"
        case .skipBold: return "\u{f8b8}"
        case .skipBwBold: return "\u{f8b9}"
        case .skipBwFilled: return "\u{f8ba}"
        case .skipBwLight: return "\u{f8bb}"
        case .skipBwRegular: return "\u{f8bc}"
        case .skipFwBold: return "\u{f8bd}"
        case .skipFwFilled: return "\u{f8be}"
        case .skipFwLight: return "\u{f8bf}"
        case .skipFwRegular: return "\u{f8c0}"
        case .skipLight: return "\u{f8c1}"
        case .skipRegular: return "\u{f8c2}"
        case .smsInboundBold: return "\u{f8c3}"
        case .smsInboundLight: return "\u{f8c4}"
        case .smsInboundRegular: return "\u{f8c5}"
        case .socialAlexaFilled: return "\u{f8c6}"
        case .socialFacebookColoredFilled: return "\u{f8c7}"
        case .socialFacebookFilled: return "\u{f8c8}"
        case .socialFbmessengerColoredFilled: return "\u{f8c9}"
        case .socialFbmessengerFilled: return "\u{f8ca}"
        case .socialInstagramBold: return "\u{f8cb}"
        case .socialMicrosoftColoredFilled: return "\u{f8cc}"
        case .socialMicrosoftFilled: return "\u{f8cd}"
        case .socialMmsFilled: return "\u{f8ce}"
        case .socialMmsGoldFilled: return "\u{f8cf}"
        case .socialSmsFilled: return "\u{f8d0}"
        case .socialSmsMintFilled: return "\u{f8d1}"
        case .socialTwitterColoredFilled: return "\u{f8d2}"
        case .socialTwitterFilled: return "\u{f8d3}"
        case .socialViberBold: return "\u{f8d4}"
        case .socialViberColoredBold: return "\u{f8d5}"
        case .socialWhatsappBold: return "\u{f8d6}"
        case .socialWhatsappColoredFilled: return "\u{f8d7}"
        case .sortAscendingBold: return "\u{f8d8}"
        case .sortAscendingLight: return "\u{f8d9}"
        case .sortAscendingRegular: return "\u{f8da}"
        case .sortDescendingBold: return "\u{f8db}"
        case .sortDescendingLight: return "\u{f8dc}"
        case .sortDescendingRegular: return "\u{f8dd}"
        case .soundDefaultBold: return "\u{f8de}"
        case .soundDefaultLight: return "\u{f8df}"
        case .soundDefaultRegular: return "\u{f8e0}"
        case .speakerBold: return "\u{f8e1}"
        case .speakerDisconnectedBold: return "\u{f8e2}"
        case .speakerDisconnectedFilled: return "\u{f8e3}"
        case .speakerDisconnectedLight: return "\u{f8e4}"
        case .speakerDisconnectedRegular: return "\u{f8e5}"
        case .speakerFilled: return "\u{f8e6}"
        case .speakerLight: return "\u{f8e7}"
        case .speakerMutedBold: return "\u{f8e8}"
        case .speakerMutedFilled: return "\u{f8e9}"
        case .speakerMutedLight: return "\u{f8ea}"
        case .speakerMutedRegular: return "\u{f8eb}"
        case .speakerOffBold: return "\u{f8ec}"
        case .speakerOffFilled: return "\u{f8ed}"
        case .speakerOffLight: return "\u{f8ee}"
        case .speakerOffRegular: return "\u{f8ef}"
        case .speakerOnColoredBold: return "\u{f8f0}"
        case .speakerOnColoredLight: return "\u{f8f1}"
        case .speakerOnColoredRegular: return "\u{f8f2}"
        case .speakerRegular: return "\u{f8f3}"
        case .speakerTurnDownBold: return "\u{f8f4}"
        case .speakerTurnDownFilled: return "\u{f8f5}"
        case .speakerTurnDownLight: return "\u{f8f6}"
        case .speakerTurnDownRegular: return "\u{f8f7}"
        case .speakerTurnUpBold: return "\u{f8f8}"
        case .speakerTurnUpFilled: return "\u{f8f9}"
        case .speakerTurnUpLight: return "\u{f8fa}"
        case .speakerTurnUpRegular: return "\u{f8fb}"
        case .spinnerBold: return "\u{f8fc}"
        case .spinnerFilledBold: return "\u{f8fd}"
        case .spinnerFilledLight: return "\u{f8fe}"
        case .spinnerFilledRegular: return "\u{f8ff}"
        case .spinnerLight: return "\u{f900}"
        case .spinnerPartialBold: return "\u{f901}"
        case .spinnerPartialLight: return "\u{f902}"
        case .spinnerPartialRegular: return "\u{f903}"
        case .spinnerRegular: return "\u{f904}"
        case .stackedArea100ChartBold: return "\u{f905}"
        case .stackedArea100ChartFilled: return "\u{f906}"
        case .stackedArea100ChartLight: return "\u{f907}"
        case .stackedArea100ChartRegular: return "\u{f908}"
        case .stackedAreaChartBold: return "\u{f909}"
        case .stackedAreaChartFilled: return "\u{f90a}"
        case .stackedAreaChartLight: return "\u{f90b}"
        case .stackedAreaChartRegular: return "\u{f90c}"
        case .stackedBar100ChartBold: return "\u{f90d}"
        case .stackedBar100ChartFilled: return "\u{f90e}"
        case .stackedBar100ChartLight: return "\u{f90f}"
        case .stackedBar100ChartRegular: return "\u{f910}"
        case .stackedBarChartBold: return "\u{f911}"
        case .stackedBarChartFilled: return "\u{f912}"
        case .stackedBarChartLight: return "\u{f913}"
        case .stackedBarChartRegular: return "\u{f914}"
        case .startChatBold: return "\u{f915}"
        case .startChatLight: return "\u{f916}"
        case .startChatRegular: return "\u{f917}"
        case .stethoscopeBold: return "\u{f918}"
        case .stethoscopeLight: return "\u{f919}"
        case .stethoscopeRegular: return "\u{f91a}"
        case .stickersBold: return "\u{f91b}"
        case .stickersLight: return "\u{f91c}"
        case .stickersRegular: return "\u{f91d}"
        case .stickiesBold: return "\u{f91e}"
        case .stickiesLight: return "\u{f91f}"
        case .stickiesRegular: return "\u{f920}"
        case .stopBold: return "\u{f921}"
        case .stopCircleBold: return "\u{f922}"
        case .stopCircleFilled: return "\u{f923}"
        case .stopCircleLight: return "\u{f924}"
        case .stopCircleRegular: return "\u{f925}"
        case .stopContentShareBold: return "\u{f926}"
        case .stopContentShareLight: return "\u{f927}"
        case .stopContentShareRegular: return "\u{f928}"
        case .stopFilled: return "\u{f929}"
        case .stopLight: return "\u{f92a}"
        case .stopRegular: return "\u{f92b}"
        case .storedInfoBold: return "\u{f92c}"
        case .storedInfoFilled: return "\u{f92d}"
        case .storedInfoLight: return "\u{f92e}"
        case .storedInfoRegular: return "\u{f92f}"
        case .streamingBold: return "\u{f930}"
        case .streamingLight: return "\u{f931}"
        case .streamingRegular: return "\u{f932}"
        case .strikethroughBold: return "\u{f933}"
        case .strikethroughLight: return "\u{f934}"
        case .strikethroughRegular: return "\u{f935}"
        case .subscriptBold: return "\u{f936}"
        case .subscriptLight: return "\u{f937}"
        case .subscriptRegular: return "\u{f938}"
        case .superscriptBold: return "\u{f939}"
        case .superscriptLight: return "\u{f93a}"
        case .superscriptRegular: return "\u{f93b}"
        case .sx10Bold: return "\u{f93c}"
        case .sx10Light: return "\u{f93d}"
        case .sx10Regular: return "\u{f93e}"
        case .sx20Bold: return "\u{f93f}"
        case .sx20Light: return "\u{f940}"
        case .sx20Regular: return "\u{f941}"
        case .sx80CodecBold: return "\u{f942}"
        case .sx80CodecLight: return "\u{f943}"
        case .sx80CodecRegular: return "\u{f944}"
        case .tableBold: return "\u{f945}"
        case .tableLight: return "\u{f946}"
        case .tableRegular: return "\u{f947}"
        case .tabletBold: return "\u{f948}"
        case .tabletLight: return "\u{f949}"
        case .tabletRegular: return "\u{f94a}"
        case .tabsBold: return "\u{f94b}"
        case .tabsLight: return "\u{f94c}"
        case .tabsRegular: return "\u{f94d}"
        case .tagBold: return "\u{f94e}"
        case .tagLight: return "\u{f94f}"
        case .tagRegular: return "\u{f950}"
        case .tapBold: return "\u{f951}"
        case .tapFilled: return "\u{f952}"
        case .tapLight: return "\u{f953}"
        case .tapRegular: return "\u{f954}"
        case .telepresenceAlertBold: return "\u{f955}"
        case .telepresenceAlertLight: return "\u{f956}"
        case .telepresenceAlertMutedBold: return "\u{f957}"
        case .telepresenceAlertMutedLight: return "\u{f958}"
        case .telepresenceAlertMutedRegular: return "\u{f959}"
        case .telepresenceAlertRegular: return "\u{f95a}"
        case .telepresenceBold: return "\u{f95b}"
        case .telepresenceIx5000Bold: return "\u{f95c}"
        case .telepresenceIx5000Light: return "\u{f95d}"
        case .telepresenceIx5000Regular: return "\u{f95e}"
        case .telepresenceLight: return "\u{f95f}"
        case .telepresencePrivateBold: return "\u{f960}"
        case .telepresencePrivateLight: return "\u{f961}"
        case .telepresencePrivateRegular: return "\u{f962}"
        case .telepresenceRegular: return "\u{f963}"
        case .temperatureBold: return "\u{f964}"
        case .temperatureLight: return "\u{f965}"
        case .temperatureRegular: return "\u{f966}"
        case .textAlignCenterBold: return "\u{f967}"
        case .textAlignCenterFilled: return "\u{f968}"
        case .textAlignCenterLight: return "\u{f969}"
        case .textAlignCenterRegular: return "\u{f96a}"
        case .textAlignLeftBold: return "\u{f96b}"
        case .textAlignLeftFilled: return "\u{f96c}"
        case .textAlignLeftLight: return "\u{f96d}"
        case .textAlignLeftRegular: return "\u{f96e}"
        case .textAlignRightBold: return "\u{f96f}"
        case .textAlignRightFilled: return "\u{f970}"
        case .textAlignRightLight: return "\u{f971}"
        case .textAlignRightRegular: return "\u{f972}"
        case .textBold: return "\u{f973}"
        case .textCodeBlockBold: return "\u{f974}"
        case .textCodeBlockLight: return "\u{f975}"
        case .textCodeBlockRegular: return "\u{f976}"
        case .textHighlightBold: return "\u{f977}"
        case .textHighlightLight: return "\u{f978}"
        case .textHighlightRegular: return "\u{f979}"
        case .textLight: return "\u{f97a}"
        case .textRegular: return "\u{f97b}"
        case .threeColumnBold: return "\u{f97c}"
        case .threeColumnLight: return "\u{f97d}"
        case .threeColumnRegular: return "\u{f97e}"
        case .threeDObjectBold: return "\u{f97f}"
        case .threeDObjectLight: return "\u{f980}"
        case .threeDObjectRegular: return "\u{f981}"
        case .tooFastBold: return "\u{f982}"
        case .tooFastLight: return "\u{f983}"
        case .tooFastRegular: return "\u{f984}"
        case .tooSlowBold: return "\u{f985}"
        case .tooSlowLight: return "\u{f986}"
        case .tooSlowRegular: return "\u{f987}"
        case .toolsBold: return "\u{f988}"
        case .toolsLight: return "\u{f989}"
        case .toolsRegular: return "\u{f98a}"
        case .touch10Bold: return "\u{f98b}"
        case .touch10Light: return "\u{f98c}"
        case .touch10Regular: return "\u{f98d}"
        case .transcriptBold: return "\u{f98e}"
        case .transcriptFilled: return "\u{f98f}"
        case .transcriptLight: return "\u{f990}"
        case .transcriptRegular: return "\u{f991}"
        case .translateBold: return "\u{f992}"
        case .translateLight: return "\u{f993}"
        case .translateRegular: return "\u{f994}"
        case .trimBold: return "\u{f995}"
        case .trimLight: return "\u{f996}"
        case .trimRegular: return "\u{f997}"
        case .twoColumnBold: return "\u{f998}"
        case .twoColumnLight: return "\u{f999}"
        case .twoColumnRegular: return "\u{f99a}"
        case .ucmCloudBold: return "\u{f99b}"
        case .ucmCloudLight: return "\u{f99c}"
        case .ucmCloudRegular: return "\u{f99d}"
        case .underlineBold: return "\u{f99e}"
        case .underlineLight: return "\u{f99f}"
        case .underlineRegular: return "\u{f9a0}"
        case .undoBold: return "\u{f9a1}"
        case .undoLight: return "\u{f9a2}"
        case .undoRegular: return "\u{f9a3}"
        case .unlinkBold: return "\u{f9a4}"
        case .unlinkLight: return "\u{f9a5}"
        case .unlinkRegular: return "\u{f9a6}"
        case .unreadBold: return "\u{f9a7}"
        case .unreadFilled: return "\u{f9a8}"
        case .unreadLight: return "\u{f9a9}"
        case .unreadRegular: return "\u{f9aa}"
        case .unsecureUnlockedBold: return "\u{f9ab}"
        case .unsecureUnlockedFilled: return "\u{f9ac}"
        case .unsecureUnlockedLight: return "\u{f9ad}"
        case .unsecureUnlockedRegular: return "\u{f9ae}"
        case .unsortedBold: return "\u{f9af}"
        case .unsortedLight: return "\u{f9b0}"
        case .unsortedRegular: return "\u{f9b1}"
        case .updateFileShareBold: return "\u{f9b2}"
        case .updateFileShareLight: return "\u{f9b3}"
        case .updateFileShareRegular: return "\u{f9b4}"
        case .upgradeBold: return "\u{f9b5}"
        case .upgradeFilled: return "\u{f9b6}"
        case .upgradeLight: return "\u{f9b7}"
        case .upgradeRegular: return "\u{f9b8}"
        case .uploadBold: return "\u{f9b9}"
        case .uploadLight: return "\u{f9ba}"
        case .uploadRegular: return "\u{f9bb}"
        case .urgentVoicemailBold: return "\u{f9bc}"
        case .urgentVoicemailFilled: return "\u{f9bd}"
        case .usbBold: return "\u{f9be}"
        case .usbHeadsetBold: return "\u{f9bf}"
        case .usbHeadsetLight: return "\u{f9c0}"
        case .usbHeadsetMutedBold: return "\u{f9c1}"
        case .usbHeadsetMutedLight: return "\u{f9c2}"
        case .usbHeadsetMutedRegular: return "\u{f9c3}"
        case .usbHeadsetRegular: return "\u{f9c4}"
        case .usbLight: return "\u{f9c5}"
        case .usbRegular: return "\u{f9c6}"
        case .userBold: return "\u{f9c7}"
        case .userDeactivateBold: return "\u{f9c8}"
        case .userDeactivateLight: return "\u{f9c9}"
        case .userDeactivateRegular: return "\u{f9ca}"
        case .userLight: return "\u{f9cb}"
        case .userRegular: return "\u{f9cc}"
        case .vcsBold: return "\u{f9cd}"
        case .vcsLight: return "\u{f9ce}"
        case .vcsRegular: return "\u{f9cf}"
        case .videoBlurBold: return "\u{f9d0}"
        case .videoBlurFilled: return "\u{f9d1}"
        case .videoBlurLight: return "\u{f9d2}"
        case .videoBlurRegular: return "\u{f9d3}"
        case .videoBold: return "\u{f9d4}"
        case .videoEffectBold: return "\u{f9d5}"
        case .videoEffectFilled: return "\u{f9d6}"
        case .videoEffectLight: return "\u{f9d7}"
        case .videoEffectRegular: return "\u{f9d8}"
        case .videoFilled: return "\u{f9d9}"
        case .videoLayoutBold: return "\u{f9da}"
        case .videoLayoutEqualBold: return "\u{f9db}"
        case .videoLayoutEqualDualBold: return "\u{f9dc}"
        case .videoLayoutEqualDualLight: return "\u{f9dd}"
        case .videoLayoutEqualDualRegular: return "\u{f9de}"
        case .videoLayoutEqualFilled: return "\u{f9df}"
        case .videoLayoutEqualLight: return "\u{f9e0}"
        case .videoLayoutEqualRegular: return "\u{f9e1}"
        case .videoLayoutFilled: return "\u{f9e2}"
        case .videoLayoutLight: return "\u{f9e3}"
        case .videoLayoutOverlayBold: return "\u{f9e4}"
        case .videoLayoutOverlayLight: return "\u{f9e5}"
        case .videoLayoutOverlayRegular: return "\u{f9e6}"
        case .videoLayoutPresenterDominantBold: return "\u{f9e7}"
        case .videoLayoutPresenterDominantLight: return "\u{f9e8}"
        case .videoLayoutPresenterDominantRegular: return "\u{f9e9}"
        case .videoLayoutProminentBold: return "\u{f9ea}"
        case .videoLayoutProminentFilled: return "\u{f9eb}"
        case .videoLayoutProminentLight: return "\u{f9ec}"
        case .videoLayoutProminentRegular: return "\u{f9ed}"
        case .videoLayoutRegular: return "\u{f9ee}"
        case .videoLayoutShareDominantBold: return "\u{f9ef}"
        case .videoLayoutShareDominantLight: return "\u{f9f0}"
        case .videoLayoutShareDominantRegular: return "\u{f9f1}"
        case .videoLayoutSingleBold: return "\u{f9f2}"
        case .videoLayoutSingleFilled: return "\u{f9f3}"
        case .videoLayoutSingleLight: return "\u{f9f4}"
        case .videoLayoutSingleRegular: return "\u{f9f5}"
        case .videoLayoutStackBold: return "\u{f9f6}"
        case .videoLayoutStackFilled: return "\u{f9f7}"
        case .videoLayoutStackLight: return "\u{f9f8}"
        case .videoLayoutStackRegular: return "\u{f9f9}"
        case .videoLayoutVideoDominantBold: return "\u{f9fa}"
        case .videoLayoutVideoDominantLight: return "\u{f9fb}"
        case .videoLayoutVideoDominantRegular: return "\u{f9fc}"
        case .videoLight: return "\u{f9fd}"
        case .videoPlusBold: return "\u{f9fe}"
        case .videoPlusFilled: return "\u{f9ff}"
        case .videoPlusLight: return "\u{fa00}"
        case .videoPlusRegular: return "\u{fa01}"
        case .videoRegular: return "\u{fa02}"
        case .videoSpeakerTrackBold: return "\u{fa03}"
        case .videoSpeakerTrackFilled: return "\u{fa04}"
        case .videoSpeakerTrackLight: return "\u{fa05}"
        case .videoSpeakerTrackRegular: return "\u{fa06}"
        case .viewAllBold: return "\u{fa07}"
        case .viewAllLight: return "\u{fa08}"
        case .viewAllRegular: return "\u{fa09}"
        case .viewListBold: return "\u{fa0a}"
        case .viewListLight: return "\u{fa0b}"
        case .viewListRegular: return "\u{fa0c}"
        case .viewStackedBold: return "\u{fa0d}"
        case .viewStackedFilled: return "\u{fa0e}"
        case .viewStackedLight: return "\u{fa0f}"
        case .viewStackedRegular: return "\u{fa10}"
        case .viewThumbnailBold: return "\u{fa11}"
        case .viewThumbnailFilled: return "\u{fa12}"
        case .viewThumbnailLight: return "\u{fa13}"
        case .viewThumbnailRegular: return "\u{fa14}"
        case .voicemailBold: return "\u{fa15}"
        case .voicemailFilled: return "\u{fa16}"
        case .voicemailLight: return "\u{fa17}"
        case .voicemailRegular: return "\u{fa18}"
        case .waffleMenuBold: return "\u{fa19}"
        case .waffleMenuLight: return "\u{fa1a}"
        case .waffleMenuRegular: return "\u{fa1b}"
        case .waitingroomActiveBold: return "\u{fa1c}"
        case .waitingroomActiveLight: return "\u{fa1d}"
        case .waitingroomActiveRegular: return "\u{fa1e}"
        case .wallpaperBold: return "\u{fa1f}"
        case .wallpaperLight: return "\u{fa20}"
        case .wallpaperRegular: return "\u{fa21}"
        case .warningBadgeFilled: return "\u{fa22}"
        case .warningBold: return "\u{fa23}"
        case .warningFilled: return "\u{fa24}"
        case .warningLight: return "\u{fa25}"
        case .warningRegular: return "\u{fa26}"
        case .webexAssistantActiveColored: return "\u{fa27}"
        case .webexAssistantInactiveColored: return "\u{fa28}"
        case .webexBoardBold: return "\u{fa29}"
        case .webexBoardLight: return "\u{fa2a}"
        case .webexBoardRegular: return "\u{fa2b}"
        case .webexCodecPlusBold: return "\u{fa2c}"
        case .webexCodecPlusLight: return "\u{fa2d}"
        case .webexCodecPlusRegular: return "\u{fa2e}"
        case .webexDeskCameraBold: return "\u{fa2f}"
        case .webexDeskCameraLight: return "\u{fa30}"
        case .webexDeskCameraRegular: return "\u{fa31}"
        case .webexHelixFilled: return "\u{fa32}"
        case .webexMeetingsBold: return "\u{fa33}"
        case .webexMeetingsFilled: return "\u{fa34}"
        case .webexMeetingsLight: return "\u{fa35}"
        case .webexMeetingsRegular: return "\u{fa36}"
        case .webexQuadCameraBold: return "\u{fa37}"
        case .webexQuadCameraLight: return "\u{fa38}"
        case .webexQuadCameraRegular: return "\u{fa39}"
        case .webexRoomKitBold: return "\u{fa3a}"
        case .webexRoomKitLight: return "\u{fa3b}"
        case .webexRoomKitPlusBold: return "\u{fa3c}"
        case .webexRoomKitPlusLight: return "\u{fa3d}"
        case .webexRoomKitPlusRegular: return "\u{fa3e}"
        case .webexRoomKitRegular: return "\u{fa3f}"
        case .webexShareBold: return "\u{fa40}"
        case .webexShareLight: return "\u{fa41}"
        case .webexShareRegular: return "\u{fa42}"
        case .webexTeamsBold: return "\u{fa43}"
        case .webexTeamsFilled: return "\u{fa44}"
        case .webexTeamsLight: return "\u{fa45}"
        case .webexTeamsNewBold: return "\u{fa46}"
        case .webexTeamsNewFilled: return "\u{fa47}"
        case .webexTeamsNewLight: return "\u{fa48}"
        case .webexTeamsNewRegular: return "\u{fa49}"
        case .webexTeamsRegular: return "\u{fa4a}"
        case .webinarBold: return "\u{fa4b}"
        case .webinarFilled: return "\u{fa4c}"
        case .webinarLight: return "\u{fa4d}"
        case .webinarRegular: return "\u{fa4e}"
        case .weeklyRecurringScheduleNodeBold: return "\u{fa4f}"
        case .weeklyRecurringScheduleNodeLight: return "\u{fa50}"
        case .weeklyRecurringScheduleNodeRegular: return "\u{fa51}"
        case .whiteboardBold: return "\u{fa52}"
        case .whiteboardContentBold: return "\u{fa53}"
        case .whiteboardContentLight: return "\u{fa54}"
        case .whiteboardContentRegular: return "\u{fa55}"
        case .whiteboardFilled: return "\u{fa56}"
        case .whiteboardLight: return "\u{fa57}"
        case .whiteboardRegular: return "\u{fa58}"
        case .widgetBold: return "\u{fa59}"
        case .widgetFilled: return "\u{fa5a}"
        case .widgetLight: return "\u{fa5b}"
        case .widgetRegular: return "\u{fa5c}"
        case .wifiBold: return "\u{fa5d}"
        case .wifiErrorBold: return "\u{fa5e}"
        case .wifiErrorLight: return "\u{fa5f}"
        case .wifiErrorRegular: return "\u{fa60}"
        case .wifiLight: return "\u{fa61}"
        case .wifiRegular: return "\u{fa62}"
        case .wifiSignalGoodColoredBold: return "\u{fa63}"
        case .wifiSignalGoodColoredLight: return "\u{fa64}"
        case .wifiSignalGoodColoredRegular: return "\u{fa65}"
        case .wifiSignalPoorColoredBold: return "\u{fa66}"
        case .wifiSignalPoorColoredLight: return "\u{fa67}"
        case .wifiSignalPoorColoredRegular: return "\u{fa68}"
        case .wifiSignalUnstableColoredBold: return "\u{fa69}"
        case .wifiSignalUnstableColoredLight: return "\u{fa6a}"
        case .wifiSignalUnstableColoredRegular: return "\u{fa6b}"
        case .windowCornerScrubBold: return "\u{fa6c}"
        case .windowCornerScrubLight: return "\u{fa6d}"
        case .windowCornerScrubRegular: return "\u{fa6e}"
        case .windowRightCornerScrubBold: return "\u{fa6f}"
        case .windowRightCornerScrubLight: return "\u{fa70}"
        case .windowRightCornerScrubRegular: return "\u{fa71}"
        case .windowVerticalScrubBold: return "\u{fa72}"
        case .windowVerticalScrubLight: return "\u{fa73}"
        case .windowVerticalScrubRegular: return "\u{fa74}"
        case .workflowDeploymentsBold: return "\u{fa75}"
        case .workflowDeploymentsLight: return "\u{fa76}"
        case .workflowDeploymentsRegular: return "\u{fa77}"
        case .workphoneBold: return "\u{fa78}"
        case .workphoneLight: return "\u{fa79}"
        case .workphoneRegular: return "\u{fa7a}"
        case .zoomInBold: return "\u{fa7b}"
        case .zoomInLight: return "\u{fa7c}"
        case .zoomInRegular: return "\u{fa7d}"
        case .zoomOutBold: return "\u{fa7e}"
        case .zoomOutLight: return "\u{fa7f}"
        case .zoomOutRegular: return "\u{fa80}"
