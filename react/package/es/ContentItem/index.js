  ...
  _proto.render = function render() {
    ...
    var chosenItem = function chosenItem() {
      if (failedText && type === 'chat') {
        ...
        return /*#__PURE__*/React.createElement(ChatContentItem, _extends({
        ...
        return /*#__PURE__*/React.createElement(FileContentItem, _extends({
          actionNode: actionNode,
          aspect: aspect ? aspect : findAspect(width, height),
          className: className,
          content: content,
        ...
        return /*#__PURE__*/React.createElement(IconContent, _extends({
          actionNode: actionNode,
          className: className,
          icon: icon,
          isProtected: isProtected,
    ...
    return /*#__PURE__*/React.createElement("div", null, chosenItem());
  };
