...
@objc public enum MomentumIconType: Int {
    ...
    public var ligature: String {
        ...
        case .recurring20: return "\u{f95a}"
        case .recurring24: return "\u{f95b}"
        case .recurringOff16: return "\u{f95c}"
        case .redial16: return "\u{f95d}"
        case .redial20: return "\u{f95e}"
        case .redial24: return "\u{f95f}"
        case .redo12: return "\u{f960}"
        case .redo14: return "\u{f961}"
        case .redo16: return "\u{f962}"
        case .refresh10: return "\u{f963}"
        case .refresh12: return "\u{f964}"
        case .refresh16: return "\u{f965}"
        case .refresh18: return "\u{f966}"
        case .refresh20: return "\u{f967}"
        case .refresh24: return "\u{f968}"
        case .remoteDesktopControl14: return "\u{f969}"
        case .remoteDesktopControl16: return "\u{f96a}"
        case .remove12: return "\u{f96b}"
        case .remove16: return "\u{f96c}"
        case .remove20: return "\u{f96d}"
        case .remove24: return "\u{f96e}"
        case .reply10: return "\u{f96f}"
        case .reply12: return "\u{f970}"
        case .reply16: return "\u{f971}"
        case .reply20: return "\u{f972}"
        case .reply24: return "\u{f973}"
        case .replyList12: return "\u{f974}"
        case .replyList16: return "\u{f975}"
        case .replyList20: return "\u{f976}"
        case .report16: return "\u{f977}"
        case .report28: return "\u{f978}"
        case .reset16: return "\u{f979}"
        case .reset24: return "\u{f97a}"
        case .response16: return "\u{f97b}"
        case .responsiveMobile16: return "\u{f97c}"
        case .return12: return "\u{f97d}"
        case .return16: return "\u{f97e}"
        case .ringtone16: return "\u{f97f}"
        case .ringtone24: return "\u{f980}"
        case .roomCalendar24: return "\u{f981}"
        case .roomLights16: return "\u{f982}"
        case .roomLights24: return "\u{f983}"
        case .rotateContent24: return "\u{f984}"
        case .rssCircle24: return "\u{f985}"
        case .rssCircle32: return "\u{f986}"
        case .rssCircle40: return "\u{f987}"
        case .runningApplication16: return "\u{f988}"
        case .runningApplication24: return "\u{f989}"
        case .save12: return "\u{f98a}"
        case .save14: return "\u{f98b}"
        case .save16: return "\u{f98c}"
        case .save24: return "\u{f98d}"
        case .scan20: return "\u{f98e}"
        case .scan24: return "\u{f98f}"
        case .screenToggle10: return "\u{f990}"
        case .screenToggle12: return "\u{f991}"
        case .screenToggle16: return "\u{f992}"
        case .screenToggle20: return "\u{f993}"
        case .screenToggle24: return "\u{f994}"
        case .screenshot12: return "\u{f995}"
        case .screenshot16: return "\u{f996}"
        case .screenshot20: return "\u{f997}"
        case .screenshot24: return "\u{f998}"
        case .search12: return "\u{f999}"
        case .search14: return "\u{f99a}"
        case .search16: return "\u{f99b}"
        case .search18: return "\u{f99c}"
        case .search20: return "\u{f99d}"
        case .search24: return "\u{f99e}"
        case .search28: return "\u{f99f}"
        case .secure12: return "\u{f9a0}"
        case .secure14: return "\u{f9a1}"
        case .secure16: return "\u{f9a2}"
        case .secure20: return "\u{f9a3}"
        case .secure24: return "\u{f9a4}"
        case .secure28: return "\u{f9a5}"
        case .secure8: return "\u{f9a6}"
        case .secureActive12: return "\u{f9a7}"
        case .secureActive14: return "\u{f9a8}"
        case .secureActive16: return "\u{f9a9}"
        case .secureActive20: return "\u{f9aa}"
        case .secureActive24: return "\u{f9ab}"
        case .secureActive28: return "\u{f9ac}"
        case .secureActive8: return "\u{f9ad}"
        case .secureBadge28: return "\u{f9ae}"
        case .secureCircle14: return "\u{f9af}"
        case .secureCircle16: return "\u{f9b0}"
        case .secureCircleActive14: return "\u{f9b1}"
        case .secureCircleActive16: return "\u{f9b2}"
        case .secureFips24: return "\u{f9b3}"
        case .selfview16: return "\u{f9b4}"
        case .selfview20: return "\u{f9b5}"
        case .selfview24: return "\u{f9b6}"
        case .send12: return "\u{f9b7}"
        case .send14: return "\u{f9b8}"
        case .send16: return "\u{f9b9}"
        case .send20: return "\u{f9ba}"
        case .send24: return "\u{f9bb}"
        case .seperate12: return "\u{f9bc}"
        case .seperate16: return "\u{f9bd}"
        case .seperate20: return "\u{f9be}"
        case .seperate24: return "\u{f9bf}"
        case .server16: return "\u{f9c0}"
        case .server24: return "\u{f9c1}"
        case .serverCircle100: return "\u{f9c2}"
        case .serverError16: return "\u{f9c3}"
        case .settings10: return "\u{f9c4}"
        case .settings12: return "\u{f9c5}"
        case .settings14: return "\u{f9c6}"
        case .settings16: return "\u{f9c7}"
        case .settings18: return "\u{f9c8}"
        case .settings20: return "\u{f9c9}"
        case .settings24: return "\u{f9ca}"
        case .settings32: return "\u{f9cb}"
        case .settings8: return "\u{f9cc}"
        case .settingsActive10: return "\u{f9cd}"
        case .settingsActive12: return "\u{f9ce}"
        case .settingsActive14: return "\u{f9cf}"
        case .settingsActive16: return "\u{f9d0}"
        case .settingsActive18: return "\u{f9d1}"
        case .settingsActive20: return "\u{f9d2}"
        case .settingsActive24: return "\u{f9d3}"
        case .settingsActive32: return "\u{f9d4}"
        case .settingsActive8: return "\u{f9d5}"
        case .setupAssistant16: return "\u{f9d6}"
        case .shakeDevice18: return "\u{f9d7}"
        case .shakeDevice20: return "\u{f9d8}"
        case .shapeDiagonalArrowheadDual16: return "\u{f9d9}"
        case .shapeDiagonalArrowheadSingle16: return "\u{f9da}"
        case .shapeDiagonalLine16: return "\u{f9db}"
        case .shapeOval16: return "\u{f9dc}"
        case .shapeSquare16: return "\u{f9dd}"
        case .share12: return "\u{f9de}"
        case .share14: return "\u{f9df}"
        case .share16: return "\u{f9e0}"
        case .share18: return "\u{f9e1}"
        case .share20: return "\u{f9e2}"
        case .share24: return "\u{f9e3}"
        case .share28: return "\u{f9e4}"
        case .share32: return "\u{f9e5}"
        case .shareCNativeAdr14: return "\u{f9e6}"
        case .shareCNativeAdr16: return "\u{f9e7}"
        case .shareCNativeAdr24: return "\u{f9e8}"
        case .shareCNativeIos10: return "\u{f9e9}"
        case .shareCNativeIos12: return "\u{f9ea}"
        case .shareCNativeIos14: return "\u{f9eb}"
        case .shareCNativeIos16: return "\u{f9ec}"
        case .shareCNativeIos20: return "\u{f9ed}"
        case .shareCNativeIos28: return "\u{f9ee}"
        case .shareCNativeIph10: return "\u{f9ef}"
        case .shareCNativeIph12: return "\u{f9f0}"
        case .shareCNativeIph14: return "\u{f9f1}"
        case .shareCNativeIph16: return "\u{f9f2}"
        case .shareCNativeIph20: return "\u{f9f3}"
        case .shareCNativeIph24: return "\u{f9f4}"
        case .shareCNativeIph28: return "\u{f9f5}"
        case .shareScreen10: return "\u{f9f6}"
        case .shareScreen12: return "\u{f9f7}"
        case .shareScreen120: return "\u{f9f8}"
        case .shareScreen124: return "\u{f9f9}"
        case .shareScreen14: return "\u{f9fa}"
        case .shareScreen16: return "\u{f9fb}"
        case .shareScreen18: return "\u{f9fc}"
        case .shareScreen20: return "\u{f9fd}"
        case .shareScreen24: return "\u{f9fe}"
        case .shareScreen26: return "\u{f9ff}"
        case .shareScreen28: return "\u{fa00}"
        case .shareScreen32: return "\u{fa01}"
        case .shareScreen36: return "\u{fa02}"
        case .shareScreen48: return "\u{fa03}"
        case .shareScreen56: return "\u{fa04}"
        case .shareScreen8: return "\u{fa05}"
        case .shareScreenActive14: return "\u{fa06}"
        case .shareScreenActive24: return "\u{fa07}"
        case .shareScreenPresence12: return "\u{fa08}"
        case .shareScreenPresence14: return "\u{fa09}"
        case .shareScreenPresence28: return "\u{fa0a}"
        case .shareScreenPresence8: return "\u{fa0b}"
        case .shareScreenPresenceStroke12: return "\u{fa0c}"
        case .shareScreenPresenceStroke14: return "\u{fa0d}"
        case .shareScreenPresenceStroke16: return "\u{fa0e}"
        case .shareScreenPresenceStroke26: return "\u{fa0f}"
        case .shareScreenPresenceStroke30: return "\u{fa10}"
        case .shareSpace12: return "\u{fa11}"
        case .shareSpace14: return "\u{fa12}"
        case .shareSpace18: return "\u{fa13}"
        case .shareSpace20: return "\u{fa14}"
        case .shareSpace24: return "\u{fa15}"
        case .shield12: return "\u{fa16}"
        case .shield14: return "\u{fa17}"
        case .shield20: return "\u{fa18}"
        case .shield24: return "\u{fa19}"
        case .show12: return "\u{fa1a}"
        case .show16: return "\u{fa1b}"
        case .show20: return "\u{fa1c}"
        case .show24: return "\u{fa1d}"
        case .signIn16: return "\u{fa1e}"
        case .signIn20: return "\u{fa1f}"
        case .signIn24: return "\u{fa20}"
        case .signInForced16: return "\u{fa21}"
        case .signInForced24: return "\u{fa22}"
        case .signOut10: return "\u{fa23}"
        case .signOut12: return "\u{fa24}"
        case .signOut16: return "\u{fa25}"
        case .signOut20: return "\u{fa26}"
        case .signOut24: return "\u{fa27}"
        case .signal016: return "\u{fa28}"
        case .signal10012: return "\u{fa29}"
        case .signal10016: return "\u{fa2a}"
        case .signal2516: return "\u{fa2b}"
        case .signal5016: return "\u{fa2c}"
        case .signal7516: return "\u{fa2d}"
        case .singleNumberReach12: return "\u{fa2e}"
        case .singleNumberReach14: return "\u{fa2f}"
        case .singleNumberReach16: return "\u{fa30}"
        case .singleNumberReach20: return "\u{fa31}"
        case .skip10: return "\u{fa32}"
        case .skip16: return "\u{fa33}"
        case .skip24: return "\u{fa34}"
        case .skipBw16: return "\u{fa35}"
        case .skipBw24: return "\u{fa36}"
        case .skipFw16: return "\u{fa37}"
        case .skipFw24: return "\u{fa38}"
        case .sortDown20: return "\u{fa39}"
        case .sortDown24: return "\u{fa3a}"
        case .sortUp20: return "\u{fa3b}"
        case .sortUp24: return "\u{fa3c}"
        case .space12: return "\u{fa3d}"
        case .space16: return "\u{fa3e}"
        case .spark16: return "\u{fa3f}"
        case .sparkBoard12: return "\u{fa40}"
        case .sparkBoard14: return "\u{fa41}"
        case .sparkBoard16: return "\u{fa42}"
        case .sparkBoard20: return "\u{fa43}"
        case .sparkBoard24: return "\u{fa44}"
        case .sparkBoard28: return "\u{fa45}"
        case .sparkBoard32: return "\u{fa46}"
        case .sparkBoard48: return "\u{fa47}"
        case .sparkQuadCamera16: return "\u{fa48}"
        case .sparkQuadCamera20: return "\u{fa49}"
        case .sparkRoomKit16: return "\u{fa4a}"
        case .sparkRoomKit20: return "\u{fa4b}"
        case .sparkRoomKitPlus16: return "\u{fa4c}"
        case .sparkRoomKitPlus20: return "\u{fa4d}"
        case .sparkShare16: return "\u{fa4e}"
        case .sparkShare20: return "\u{fa4f}"
        case .sparkVoice16: return "\u{fa50}"
        case .sparkVoice20: return "\u{fa51}"
        case .speaker12: return "\u{fa52}"
        case .speaker16: return "\u{fa53}"
        case .speaker20: return "\u{fa54}"
        case .speaker24: return "\u{fa55}"
        case .speaker28: return "\u{fa56}"
        case .speakerBluetooth16: return "\u{fa57}"
        case .speakerDisconnected12: return "\u{fa58}"
        case .speakerDisconnected14: return "\u{fa59}"
        case .speakerDisconnected16: return "\u{fa5a}"
        case .speakerDisconnected20: return "\u{fa5b}"
        case .speakerDisconnected24: return "\u{fa5c}"
        case .speakerDisconnected28: return "\u{fa5d}"
        case .speakerDisconnected36: return "\u{fa5e}"
        case .speakerLineOutLeft16: return "\u{fa5f}"
        case .speakerLineOutRight16: return "\u{fa60}"
        case .speakerMuted12: return "\u{fa61}"
        case .speakerMuted16: return "\u{fa62}"
        case .speakerMuted24: return "\u{fa63}"
        case .speakerMuted28: return "\u{fa64}"
        case .speakerMuted32: return "\u{fa65}"
        case .speakerOff16: return "\u{fa66}"
        case .speakerOff24: return "\u{fa67}"
        case .speakerOff28: return "\u{fa68}"
        case .spinner12: return "\u{fa69}"
        case .spinner14: return "\u{fa6a}"
        case .spinner16: return "\u{fa6b}"
        case .spinner18: return "\u{fa6c}"
        case .spinner20: return "\u{fa6d}"
        case .spinner24: return "\u{fa6e}"
        case .spinner28: return "\u{fa6f}"
        case .spinner32: return "\u{fa70}"
        case .spinner36: return "\u{fa71}"
        case .spinner40: return "\u{fa72}"
        case .spinner48: return "\u{fa73}"
        case .spinner56: return "\u{fa74}"
        case .spinner72: return "\u{fa75}"
        case .spinner8: return "\u{fa76}"
        case .spinner80: return "\u{fa77}"
        case .spinner90: return "\u{fa78}"
        case .spreadsheet16: return "\u{fa79}"
        case .startChat20: return "\u{fa7a}"
        case .stickers16: return "\u{fa7b}"
        case .stickers24: return "\u{fa7c}"
        case .stickies12: return "\u{fa7d}"
        case .stickies16: return "\u{fa7e}"
        case .stickies24: return "\u{fa7f}"
        case .stop10: return "\u{fa80}"
        case .stop12: return "\u{fa81}"
        case .stop16: return "\u{fa82}"
        case .stop20: return "\u{fa83}"
        case .stop24: return "\u{fa84}"
        case .stopCircle12: return "\u{fa85}"
        case .stopCircle16: return "\u{fa86}"
        case .stopCircle20: return "\u{fa87}"
        case .stopCircle24: return "\u{fa88}"
        case .stopContentShare20: return "\u{fa89}"
        case .storedInfo12: return "\u{fa8a}"
        case .storedInfo16: return "\u{fa8b}"
        case .storedInfo20: return "\u{fa8c}"
        case .storedInfo24: return "\u{fa8d}"
        case .storedInfoActive12: return "\u{fa8e}"
        case .storedInfoActive16: return "\u{fa8f}"
        case .storedInfoActive20: return "\u{fa90}"
        case .storedInfoActive24: return "\u{fa91}"
        case .streaming16: return "\u{fa92}"
        case .streaming20: return "\u{fa93}"
        case .streaming24: return "\u{fa94}"
        case .subscribe16: return "\u{fa95}"
        case .swift16: return "\u{fa96}"
        case .sx1016: return "\u{fa97}"
        case .sx1020: return "\u{fa98}"
        case .sx2016: return "\u{fa99}"
        case .sx2020: return "\u{fa9a}"
        case .sx80Codec16: return "\u{fa9b}"
        case .sx80Codec20: return "\u{fa9c}"
        case .tablet16: return "\u{fa9d}"
        case .tablet24: return "\u{fa9e}"
        case .tag12: return "\u{fa9f}"
        case .tag16: return "\u{faa0}"
        case .tag20: return "\u{faa1}"
        case .tap20: return "\u{faa2}"
        case .tasks10: return "\u{faa3}"
        case .tasks12: return "\u{faa4}"
        case .tasks14: return "\u{faa5}"
        case .tasks16: return "\u{faa6}"
        case .tasks18: return "\u{faa7}"
        case .tasks20: return "\u{faa8}"
        case .tasks24: return "\u{faa9}"
        case .tasks26: return "\u{faaa}"
        case .tasks28: return "\u{faab}"
        case .tasks32: return "\u{faac}"
        case .tasks36: return "\u{faad}"
        case .tasks8: return "\u{faae}"
        case .team12: return "\u{faaf}"
        case .team14: return "\u{fab0}"
        case .team16: return "\u{fab1}"
        case .team18: return "\u{fab2}"
        case .team20: return "\u{fab3}"
        case .team24: return "\u{fab4}"
        case .team32: return "\u{fab5}"
        case .teamActive12: return "\u{fab6}"
        case .teamActive14: return "\u{fab7}"
        case .teamActive16: return "\u{fab8}"
        case .teamActive18: return "\u{fab9}"
        case .teamActive20: return "\u{faba}"
        case .teamActive24: return "\u{fabb}"
        case .teamActive32: return "\u{fabc}"
        case .telepresence12: return "\u{fabd}"
        case .telepresence14: return "\u{fabe}"
        case .telepresence16: return "\u{fabf}"
        case .telepresence18: return "\u{fac0}"
        case .telepresence20: return "\u{fac1}"
        case .telepresence24: return "\u{fac2}"
        case .telepresence64: return "\u{fac3}"
        case .telepresenceAlert12: return "\u{fac4}"
        case .telepresenceIx500016: return "\u{fac5}"
        case .telepresenceIx500020: return "\u{fac6}"
        case .telepresenceMuted12: return "\u{fac7}"
        case .telepresenceMuted64: return "\u{fac8}"
        case .telepresenceMutedAlert12: return "\u{fac9}"
        case .telepresencePrivate12: return "\u{faca}"
        case .text10: return "\u{facb}"
        case .text12: return "\u{facc}"
        case .text16: return "\u{facd}"
        case .textAlignLeft16: return "\u{face}"
        case .textAlignRight16: return "\u{facf}"
        case .textBlockquote12: return "\u{fad0}"
        case .textBlockquote16: return "\u{fad1}"
        case .textBlockquote18: return "\u{fad2}"
        case .textBlockquote20: return "\u{fad3}"
        case .textBlockquote8: return "\u{fad4}"
        case .textBold12: return "\u{fad5}"
        case .textBold16: return "\u{fad6}"
        case .textCodeBlock12: return "\u{fad7}"
        case .textCodeBlock16: return "\u{fad8}"
        case .textColor16: return "\u{fad9}"
        case .textFormat10: return "\u{fada}"
        case .textFormat12: return "\u{fadb}"
        case .textFormat16: return "\u{fadc}"
        case .textFormat20: return "\u{fadd}"
        case .textFormat24: return "\u{fade}"
        case .textFormat8: return "\u{fadf}"
        case .textHeading112: return "\u{fae0}"
        case .textHeading116: return "\u{fae1}"
        case .textHeading212: return "\u{fae2}"
        case .textHeading216: return "\u{fae3}"
        case .textHeading312: return "\u{fae4}"
        case .textHeading316: return "\u{fae5}"
        case .textItalic12: return "\u{fae6}"
        case .textItalic16: return "\u{fae7}"
        case .textListBulleted10: return "\u{fae8}"
        case .textListBulleted12: return "\u{fae9}"
        case .textListBulleted16: return "\u{faea}"
        case .textListBulleted8: return "\u{faeb}"
        case .textListNumbered12: return "\u{faec}"
        case .textListNumbered16: return "\u{faed}"
        case .textListNumbered36: return "\u{faee}"
        case .textListNumbered40: return "\u{faef}"
        case .textStrikethrough16: return "\u{faf0}"
        case .textTable16: return "\u{faf1}"
        case .textUnderline12: return "\u{faf2}"
        case .textUnderline16: return "\u{faf3}"
        case .tooFast12: return "\u{faf4}"
        case .tooFast16: return "\u{faf5}"
        case .tooSlow12: return "\u{faf6}"
        case .tooSlow16: return "\u{faf7}"
        case .tools16: return "\u{faf8}"
        case .tools20: return "\u{faf9}"
        case .tools24: return "\u{fafa}"
        case .tools28: return "\u{fafb}"
        case .tools32: return "\u{fafc}"
        case .touch16: return "\u{fafd}"
        case .touch1024: return "\u{fafe}"
        case .transcript16: return "\u{faff}"
        case .transcript20: return "\u{fb00}"
        case .twitter16: return "\u{fb01}"
        case .twitterCircle24: return "\u{fb02}"
        case .twitterCircle32: return "\u{fb03}"
        case .twitterCircle40: return "\u{fb04}"
        case .ucmCloud10: return "\u{fb05}"
        case .ucmCloud16: return "\u{fb06}"
        case .ucmCloud24: return "\u{fb07}"
        case .ucmCloud32: return "\u{fb08}"
        case .undo12: return "\u{fb09}"
        case .undo14: return "\u{fb0a}"
        case .undo16: return "\u{fb0b}"
        case .undo24: return "\u{fb0c}"
        case .unlink20: return "\u{fb0d}"
        case .unreadBadge10: return "\u{fb0e}"
        case .unreadBadge12: return "\u{fb0f}"
        case .unreadBadge16: return "\u{fb10}"
        case .unreadBadge8: return "\u{fb11}"
        case .unsecure12: return "\u{fb12}"
        case .unsecure14: return "\u{fb13}"
        case .unsecure16: return "\u{fb14}"
        case .unsecure24: return "\u{fb15}"
        case .unsecure28: return "\u{fb16}"
        case .upload12: return "\u{fb17}"
        case .upload130: return "\u{fb18}"
        case .upload14: return "\u{fb19}"
        case .upload16: return "\u{fb1a}"
        case .upload18: return "\u{fb1b}"
        case .upload20: return "\u{fb1c}"
        case .upload24: return "\u{fb1d}"
        case .upload28: return "\u{fb1e}"
        case .upload32: return "\u{fb1f}"
        case .upload36: return "\u{fb20}"
        case .usb16: return "\u{fb21}"
        case .user16: return "\u{fb22}"
        case .user20: return "\u{fb23}"
        case .user24: return "\u{fb24}"
        case .user56: return "\u{fb25}"
        case .videoEffect12: return "\u{fb26}"
        case .videoLayout12: return "\u{fb27}"
        case .videoLayout16: return "\u{fb28}"
        case .videoLayoutAuto12: return "\u{fb29}"
        case .videoLayoutAuto16: return "\u{fb2a}"
        case .videoLayoutAuto20: return "\u{fb2b}"
        case .videoLayoutAuto24: return "\u{fb2c}"
        case .videoLayoutEqual12: return "\u{fb2d}"
        case .videoLayoutEqual14: return "\u{fb2e}"
        case .videoLayoutEqual16: return "\u{fb2f}"
        case .videoLayoutEqual20: return "\u{fb30}"
        case .videoLayoutEqual24: return "\u{fb31}"
        case .videoLayoutOverlay12: return "\u{fb32}"
        case .videoLayoutOverlay16: return "\u{fb33}"
        case .videoLayoutOverlay20: return "\u{fb34}"
        case .videoLayoutOverlay24: return "\u{fb35}"
        case .videoLayoutProminent12: return "\u{fb36}"
        case .videoLayoutProminent16: return "\u{fb37}"
        case .videoLayoutProminent20: return "\u{fb38}"
        case .videoLayoutProminent24: return "\u{fb39}"
        case .videoLayoutShareDominant12: return "\u{fb3a}"
        case .videoLayoutShareDominant16: return "\u{fb3b}"
        case .videoLayoutShareDominant20: return "\u{fb3c}"
        case .videoLayoutShareDominant24: return "\u{fb3d}"
        case .videoLayoutSingle16: return "\u{fb3e}"
        case .videoLayoutSingle20: return "\u{fb3f}"
        case .videoLayoutVideoDominant12: return "\u{fb40}"
        case .videoLayoutVideoDominant16: return "\u{fb41}"
        case .videoLayoutVideoDominant20: return "\u{fb42}"
        case .videoLayoutVideoDominant24: return "\u{fb43}"
        case .viewAll12: return "\u{fb44}"
        case .viewAll14: return "\u{fb45}"
        case .viewFeedMultiple16: return "\u{fb46}"
        case .viewFeedPanel16: return "\u{fb47}"
        case .viewFeedSingle16: return "\u{fb48}"
        case .viewList10: return "\u{fb49}"
        case .viewList12: return "\u{fb4a}"
        case .viewList14: return "\u{fb4b}"
        case .viewList16: return "\u{fb4c}"
        case .viewList20: return "\u{fb4d}"
        case .viewList24: return "\u{fb4e}"
        case .viewList28: return "\u{fb4f}"
        case .viewListCircle100: return "\u{fb50}"
        case .viewMixed12: return "\u{fb51}"
        case .viewStack12: return "\u{fb52}"
        case .viewStack14: return "\u{fb53}"
        case .viewStack20: return "\u{fb54}"
        case .viewStack24: return "\u{fb55}"
        case .viewThumbnail12: return "\u{fb56}"
        case .viewThumbnail14: return "\u{fb57}"
        case .viewThumbnail16: return "\u{fb58}"
        case .viewThumbnail20: return "\u{fb59}"
        case .viewThumbnail24: return "\u{fb5a}"
        case .voice20: return "\u{fb5b}"
        case .voicemail10: return "\u{fb5c}"
        case .voicemail14: return "\u{fb5d}"
        case .voicemail16: return "\u{fb5e}"
        case .voicemail18: return "\u{fb5f}"
        case .voicemail20: return "\u{fb60}"
        case .voicemail24: return "\u{fb61}"
        case .voicemail28: return "\u{fb62}"
        case .voicemail8: return "\u{fb63}"
        case .voicemailActive12: return "\u{fb64}"
        case .voicemailActive14: return "\u{fb65}"
        case .voicemailActive16: return "\u{fb66}"
        case .voicemailActive18: return "\u{fb67}"
        case .voicemailActive20: return "\u{fb68}"
        case .voicemailActive24: return "\u{fb69}"
        case .voicemailActive28: return "\u{fb6a}"
        case .wallpaper16: return "\u{fb6b}"
        case .wallpaper20: return "\u{fb6c}"
        case .wallpaper24: return "\u{fb6d}"
        case .wallpaper28: return "\u{fb6e}"
        case .wallpaper32: return "\u{fb6f}"
        case .warning100: return "\u{fb70}"
        case .warning12: return "\u{fb71}"
        case .warning14: return "\u{fb72}"
        case .warning16: return "\u{fb73}"
        case .warning20: return "\u{fb74}"
        case .warning24: return "\u{fb75}"
        case .warning28: return "\u{fb76}"
        case .warning32: return "\u{fb77}"
        case .warning40: return "\u{fb78}"
        case .warning44: return "\u{fb79}"
        case .warning56: return "\u{fb7a}"
        case .warning64: return "\u{fb7b}"
        case .warning72: return "\u{fb7c}"
        case .waveform20: return "\u{fb7d}"
        case .webSharing16: return "\u{fb7e}"
        case .webSharing24: return "\u{fb7f}"
        case .webex10: return "\u{fb80}"
        case .webex16: return "\u{fb81}"
        case .webex24: return "\u{fb82}"
        case .webex48: return "\u{fb83}"
        case .webexBoard12: return "\u{fb84}"
        case .webexBoard14: return "\u{fb85}"
        case .webexBoard16: return "\u{fb86}"
        case .webexBoard20: return "\u{fb87}"
        case .webexBoard24: return "\u{fb88}"
        case .webexBoard28: return "\u{fb89}"
        case .webexBoard32: return "\u{fb8a}"
        case .webexBoard48: return "\u{fb8b}"
        case .webexCalling10: return "\u{fb8c}"
        case .webexCalling12: return "\u{fb8d}"
        case .webexCalling16: return "\u{fb8e}"
        case .webexCalling18: return "\u{fb8f}"
        case .webexCalling20: return "\u{fb90}"
        case .webexCalling24: return "\u{fb91}"
        case .webexCodecPlus16: return "\u{fb92}"
        case .webexCodecPlus20: return "\u{fb93}"
        case .webexInstantMeeting12: return "\u{fb94}"
        case .webexInstantMeeting14: return "\u{fb95}"
        case .webexInstantMeeting16: return "\u{fb96}"
        case .webexInstantMeeting20: return "\u{fb97}"
        case .webexInstantMeeting24: return "\u{fb98}"
        case .webexMeetings10: return "\u{fb99}"
        case .webexMeetings12: return "\u{fb9a}"
        case .webexMeetings14: return "\u{fb9b}"
        case .webexMeetings16: return "\u{fb9c}"
        case .webexMeetings20: return "\u{fb9d}"
        case .webexMeetings24: return "\u{fb9e}"
        case .webexMeetings48: return "\u{fb9f}"
        case .webexQuadCamera16: return "\u{fba0}"
        case .webexQuadCamera20: return "\u{fba1}"
        case .webexRoomKit16: return "\u{fba2}"
        case .webexRoomKit20: return "\u{fba3}"
        case .webexRoomKitPlus16: return "\u{fba4}"
        case .webexRoomKitPlus20: return "\u{fba5}"
        case .webexShare12: return "\u{fba6}"
        case .webexShare14: return "\u{fba7}"
        case .webexShare16: return "\u{fba8}"
        case .webexShare20: return "\u{fba9}"
        case .webexTeams10: return "\u{fbaa}"
        case .webexTeams12: return "\u{fbab}"
        case .webexTeams14: return "\u{fbac}"
        case .webexTeams16: return "\u{fbad}"
        case .webexTeams18: return "\u{fbae}"
        case .webexTeams20: return "\u{fbaf}"
        case .webexVoice16: return "\u{fbb0}"
        case .webexVoice20: return "\u{fbb1}"
        case .webpop12: return "\u{fbb2}"
        case .webpop16: return "\u{fbb3}"
        case .webpop20: return "\u{fbb4}"
        case .webpop24: return "\u{fbb5}"
        case .whiteboard10: return "\u{fbb6}"
        case .whiteboard12: return "\u{fbb7}"
        case .whiteboard14: return "\u{fbb8}"
        case .whiteboard16: return "\u{fbb9}"
        case .whiteboard20: return "\u{fbba}"
        case .whiteboard24: return "\u{fbbb}"
        case .whiteboard26: return "\u{fbbc}"
        case .whiteboard28: return "\u{fbbd}"
        case .whiteboard32: return "\u{fbbe}"
        case .whiteboard36: return "\u{fbbf}"
        case .whiteboard8: return "\u{fbc0}"
        case .whiteboardContent16: return "\u{fbc1}"
        case .whiteboardContent24: return "\u{fbc2}"
        case .widgetsAdr20: return "\u{fbc3}"
        case .wifi12: return "\u{fbc4}"
        case .wifi16: return "\u{fbc5}"
        case .wifi20: return "\u{fbc6}"
        case .wifi24: return "\u{fbc7}"
        case .wifiError12: return "\u{fbc8}"
        case .wifiError16: return "\u{fbc9}"
        case .wikipedia16: return "\u{fbca}"
        case .windowCornerScrub16: return "\u{fbcb}"
        case .windowVerticalScrub16: return "\u{fbcc}"
        case .youtubeCircle24: return "\u{fbcd}"
        case .youtubeCircle32: return "\u{fbce}"
        case .youtubeCircle40: return "\u{fbcf}"
        case .zoomIn12: return "\u{fbd0}"
        case .zoomIn14: return "\u{fbd1}"
        case .zoomIn16: return "\u{fbd2}"
        case .zoomIn20: return "\u{fbd3}"
        case .zoomOut12: return "\u{fbd4}"
        case .zoomOut14: return "\u{fbd5}"
        case .zoomOut16: return "\u{fbd6}"
        case .zoomOut20: return "\u{fbd7}"
