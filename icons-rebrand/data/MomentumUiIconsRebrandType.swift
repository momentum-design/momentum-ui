...
@objc public enum MomentumIconsRebrandType: Int {
    ...
    public var ligature: String {
        ...
        case .sx10Bold: return "\u{f963}"
        case .sx10Light: return "\u{f964}"
        case .sx10Regular: return "\u{f965}"
        case .sx20Bold: return "\u{f966}"
        case .sx20Light: return "\u{f967}"
        case .sx20Regular: return "\u{f968}"
        case .sx80CodecBold: return "\u{f969}"
        case .sx80CodecLight: return "\u{f96a}"
        case .sx80CodecRegular: return "\u{f96b}"
        case .tableBold: return "\u{f96c}"
        case .tableLight: return "\u{f96d}"
        case .tableRegular: return "\u{f96e}"
        case .tabletBold: return "\u{f96f}"
        case .tabletLight: return "\u{f970}"
        case .tabletRegular: return "\u{f971}"
        case .tabsBold: return "\u{f972}"
        case .tabsLight: return "\u{f973}"
        case .tabsRegular: return "\u{f974}"
        case .tagBold: return "\u{f975}"
        case .tagLight: return "\u{f976}"
        case .tagRegular: return "\u{f977}"
        case .tapBold: return "\u{f978}"
        case .tapFilled: return "\u{f979}"
        case .tapLight: return "\u{f97a}"
        case .tapRegular: return "\u{f97b}"
        case .telepresenceAlertBold: return "\u{f97c}"
        case .telepresenceAlertLight: return "\u{f97d}"
        case .telepresenceAlertMutedBold: return "\u{f97e}"
        case .telepresenceAlertMutedLight: return "\u{f97f}"
        case .telepresenceAlertMutedRegular: return "\u{f980}"
        case .telepresenceAlertRegular: return "\u{f981}"
        case .telepresenceBold: return "\u{f982}"
        case .telepresenceIx5000Bold: return "\u{f983}"
        case .telepresenceIx5000Light: return "\u{f984}"
        case .telepresenceIx5000Regular: return "\u{f985}"
        case .telepresenceLight: return "\u{f986}"
        case .telepresencePrivateBold: return "\u{f987}"
        case .telepresencePrivateLight: return "\u{f988}"
        case .telepresencePrivateRegular: return "\u{f989}"
        case .telepresenceRegular: return "\u{f98a}"
        case .temperatureBold: return "\u{f98b}"
        case .temperatureLight: return "\u{f98c}"
        case .temperatureRegular: return "\u{f98d}"
        case .textAlignCenterBold: return "\u{f98e}"
        case .textAlignCenterFilled: return "\u{f98f}"
        case .textAlignCenterLight: return "\u{f990}"
        case .textAlignCenterRegular: return "\u{f991}"
        case .textAlignLeftBold: return "\u{f992}"
        case .textAlignLeftFilled: return "\u{f993}"
        case .textAlignLeftLight: return "\u{f994}"
        case .textAlignLeftRegular: return "\u{f995}"
        case .textAlignRightBold: return "\u{f996}"
        case .textAlignRightFilled: return "\u{f997}"
        case .textAlignRightLight: return "\u{f998}"
        case .textAlignRightRegular: return "\u{f999}"
        case .textBold: return "\u{f99a}"
        case .textCodeBlockBold: return "\u{f99b}"
        case .textCodeBlockLight: return "\u{f99c}"
        case .textCodeBlockRegular: return "\u{f99d}"
        case .textHighlightBold: return "\u{f99e}"
        case .textHighlightLight: return "\u{f99f}"
        case .textHighlightRegular: return "\u{f9a0}"
        case .textLight: return "\u{f9a1}"
        case .textRegular: return "\u{f9a2}"
        case .threeColumnBold: return "\u{f9a3}"
        case .threeColumnLight: return "\u{f9a4}"
        case .threeColumnRegular: return "\u{f9a5}"
        case .threeDObjectBold: return "\u{f9a6}"
        case .threeDObjectLight: return "\u{f9a7}"
        case .threeDObjectRegular: return "\u{f9a8}"
        case .tooFastBold: return "\u{f9a9}"
        case .tooFastLight: return "\u{f9aa}"
        case .tooFastRegular: return "\u{f9ab}"
        case .tooSlowBold: return "\u{f9ac}"
        case .tooSlowLight: return "\u{f9ad}"
        case .tooSlowRegular: return "\u{f9ae}"
        case .toolsBold: return "\u{f9af}"
        case .toolsLight: return "\u{f9b0}"
        case .toolsRegular: return "\u{f9b1}"
        case .touch10Bold: return "\u{f9b2}"
        case .touch10Light: return "\u{f9b3}"
        case .touch10Regular: return "\u{f9b4}"
        case .transcriptBold: return "\u{f9b5}"
        case .transcriptFilled: return "\u{f9b6}"
        case .transcriptLight: return "\u{f9b7}"
        case .transcriptRegular: return "\u{f9b8}"
        case .translateBold: return "\u{f9b9}"
        case .translateLight: return "\u{f9ba}"
        case .translateRegular: return "\u{f9bb}"
        case .trimBold: return "\u{f9bc}"
        case .trimLight: return "\u{f9bd}"
        case .trimRegular: return "\u{f9be}"
        case .twoColumnBold: return "\u{f9bf}"
        case .twoColumnLight: return "\u{f9c0}"
        case .twoColumnRegular: return "\u{f9c1}"
        case .ucmCloudBold: return "\u{f9c2}"
        case .ucmCloudLight: return "\u{f9c3}"
        case .ucmCloudRegular: return "\u{f9c4}"
        case .underlineBold: return "\u{f9c5}"
        case .underlineLight: return "\u{f9c6}"
        case .underlineRegular: return "\u{f9c7}"
        case .undoBold: return "\u{f9c8}"
        case .undoLight: return "\u{f9c9}"
        case .undoRegular: return "\u{f9ca}"
        case .unlinkBold: return "\u{f9cb}"
        case .unlinkLight: return "\u{f9cc}"
        case .unlinkRegular: return "\u{f9cd}"
        case .unreadBold: return "\u{f9ce}"
        case .unreadFilled: return "\u{f9cf}"
        case .unreadLight: return "\u{f9d0}"
        case .unreadRegular: return "\u{f9d1}"
        case .unsecureUnlockedBold: return "\u{f9d2}"
        case .unsecureUnlockedFilled: return "\u{f9d3}"
        case .unsecureUnlockedLight: return "\u{f9d4}"
        case .unsecureUnlockedRegular: return "\u{f9d5}"
        case .unsortedBold: return "\u{f9d6}"
        case .unsortedLight: return "\u{f9d7}"
        case .unsortedRegular: return "\u{f9d8}"
        case .updateFileShareBold: return "\u{f9d9}"
        case .updateFileShareLight: return "\u{f9da}"
        case .updateFileShareRegular: return "\u{f9db}"
        case .upgradeBold: return "\u{f9dc}"
        case .upgradeFilled: return "\u{f9dd}"
        case .upgradeLight: return "\u{f9de}"
        case .upgradeRegular: return "\u{f9df}"
        case .uploadBold: return "\u{f9e0}"
        case .uploadLight: return "\u{f9e1}"
        case .uploadRegular: return "\u{f9e2}"
        case .urgentVoicemailBold: return "\u{f9e3}"
        case .urgentVoicemailFilled: return "\u{f9e4}"
        case .usbBold: return "\u{f9e5}"
        case .usbHeadsetBold: return "\u{f9e6}"
        case .usbHeadsetLight: return "\u{f9e7}"
        case .usbHeadsetMutedBold: return "\u{f9e8}"
        case .usbHeadsetMutedLight: return "\u{f9e9}"
        case .usbHeadsetMutedRegular: return "\u{f9ea}"
        case .usbHeadsetRegular: return "\u{f9eb}"
        case .usbLight: return "\u{f9ec}"
        case .usbRegular: return "\u{f9ed}"
        case .userBold: return "\u{f9ee}"
        case .userDeactivateBold: return "\u{f9ef}"
        case .userDeactivateLight: return "\u{f9f0}"
        case .userDeactivateRegular: return "\u{f9f1}"
        case .userLight: return "\u{f9f2}"
        case .userRegular: return "\u{f9f3}"
        case .vcsBold: return "\u{f9f4}"
        case .vcsLight: return "\u{f9f5}"
        case .vcsRegular: return "\u{f9f6}"
        case .videoBlurBold: return "\u{f9f7}"
        case .videoBlurFilled: return "\u{f9f8}"
        case .videoBlurLight: return "\u{f9f9}"
        case .videoBlurRegular: return "\u{f9fa}"
        case .videoBold: return "\u{f9fb}"
        case .videoEffectBold: return "\u{f9fc}"
        case .videoEffectFilled: return "\u{f9fd}"
        case .videoEffectLight: return "\u{f9fe}"
        case .videoEffectRegular: return "\u{f9ff}"
        case .videoFilled: return "\u{fa00}"
        case .videoLayoutBold: return "\u{fa01}"
        case .videoLayoutEqualBold: return "\u{fa02}"
        case .videoLayoutEqualDualBold: return "\u{fa03}"
        case .videoLayoutEqualDualLight: return "\u{fa04}"
        case .videoLayoutEqualDualRegular: return "\u{fa05}"
        case .videoLayoutEqualFilled: return "\u{fa06}"
        case .videoLayoutEqualLight: return "\u{fa07}"
        case .videoLayoutEqualRegular: return "\u{fa08}"
        case .videoLayoutFilled: return "\u{fa09}"
        case .videoLayoutLight: return "\u{fa0a}"
        case .videoLayoutOverlayBold: return "\u{fa0b}"
        case .videoLayoutOverlayLight: return "\u{fa0c}"
        case .videoLayoutOverlayRegular: return "\u{fa0d}"
        case .videoLayoutPresenterDominantBold: return "\u{fa0e}"
        case .videoLayoutPresenterDominantLight: return "\u{fa0f}"
        case .videoLayoutPresenterDominantRegular: return "\u{fa10}"
        case .videoLayoutProminentBold: return "\u{fa11}"
        case .videoLayoutProminentFilled: return "\u{fa12}"
        case .videoLayoutProminentLight: return "\u{fa13}"
        case .videoLayoutProminentRegular: return "\u{fa14}"
        case .videoLayoutRegular: return "\u{fa15}"
        case .videoLayoutShareDominantBold: return "\u{fa16}"
        case .videoLayoutShareDominantLight: return "\u{fa17}"
        case .videoLayoutShareDominantRegular: return "\u{fa18}"
        case .videoLayoutSingleBold: return "\u{fa19}"
        case .videoLayoutSingleFilled: return "\u{fa1a}"
        case .videoLayoutSingleLight: return "\u{fa1b}"
        case .videoLayoutSingleRegular: return "\u{fa1c}"
        case .videoLayoutStackBold: return "\u{fa1d}"
        case .videoLayoutStackFilled: return "\u{fa1e}"
        case .videoLayoutStackLight: return "\u{fa1f}"
        case .videoLayoutStackRegular: return "\u{fa20}"
        case .videoLayoutVideoDominantBold: return "\u{fa21}"
        case .videoLayoutVideoDominantLight: return "\u{fa22}"
        case .videoLayoutVideoDominantRegular: return "\u{fa23}"
        case .videoLight: return "\u{fa24}"
        case .videoPlusBold: return "\u{fa25}"
        case .videoPlusFilled: return "\u{fa26}"
        case .videoPlusLight: return "\u{fa27}"
        case .videoPlusRegular: return "\u{fa28}"
        case .videoRegular: return "\u{fa29}"
        case .videoSpeakerTrackBold: return "\u{fa2a}"
        case .videoSpeakerTrackFilled: return "\u{fa2b}"
        case .videoSpeakerTrackLight: return "\u{fa2c}"
        case .videoSpeakerTrackRegular: return "\u{fa2d}"
        case .viewAllBold: return "\u{fa2e}"
        case .viewAllLight: return "\u{fa2f}"
        case .viewAllRegular: return "\u{fa30}"
        case .viewListBold: return "\u{fa31}"
        case .viewListLight: return "\u{fa32}"
        case .viewListRegular: return "\u{fa33}"
        case .viewStackedBold: return "\u{fa34}"
        case .viewStackedFilled: return "\u{fa35}"
        case .viewStackedLight: return "\u{fa36}"
        case .viewStackedRegular: return "\u{fa37}"
        case .viewThumbnailBold: return "\u{fa38}"
        case .viewThumbnailFilled: return "\u{fa39}"
        case .viewThumbnailLight: return "\u{fa3a}"
        case .viewThumbnailRegular: return "\u{fa3b}"
        case .voicemailBold: return "\u{fa3c}"
        case .voicemailFilled: return "\u{fa3d}"
        case .voicemailLight: return "\u{fa3e}"
        case .voicemailRegular: return "\u{fa3f}"
        case .waffleMenuBold: return "\u{fa40}"
        case .waffleMenuLight: return "\u{fa41}"
        case .waffleMenuRegular: return "\u{fa42}"
        case .waitingroomActiveBold: return "\u{fa43}"
        case .waitingroomActiveLight: return "\u{fa44}"
        case .waitingroomActiveRegular: return "\u{fa45}"
        case .wallpaperBold: return "\u{fa46}"
        case .wallpaperLight: return "\u{fa47}"
        case .wallpaperRegular: return "\u{fa48}"
        case .warningBadgeFilled: return "\u{fa49}"
        case .warningBold: return "\u{fa4a}"
        case .warningFilled: return "\u{fa4b}"
        case .warningLight: return "\u{fa4c}"
        case .warningRegular: return "\u{fa4d}"
        case .webexAssistantActiveColored: return "\u{fa4e}"
        case .webexAssistantInactiveColored: return "\u{fa4f}"
        case .webexBoardBold: return "\u{fa50}"
        case .webexBoardLight: return "\u{fa51}"
        case .webexBoardRegular: return "\u{fa52}"
        case .webexCodecPlusBold: return "\u{fa53}"
        case .webexCodecPlusLight: return "\u{fa54}"
        case .webexCodecPlusRegular: return "\u{fa55}"
        case .webexDeskCameraBold: return "\u{fa56}"
        case .webexDeskCameraLight: return "\u{fa57}"
        case .webexDeskCameraRegular: return "\u{fa58}"
        case .webexHelixFilled: return "\u{fa59}"
        case .webexMeetingsBold: return "\u{fa5a}"
        case .webexMeetingsFilled: return "\u{fa5b}"
        case .webexMeetingsLight: return "\u{fa5c}"
        case .webexMeetingsRegular: return "\u{fa5d}"
        case .webexQuadCameraBold: return "\u{fa5e}"
        case .webexQuadCameraLight: return "\u{fa5f}"
        case .webexQuadCameraRegular: return "\u{fa60}"
        case .webexRoomKitBold: return "\u{fa61}"
        case .webexRoomKitLight: return "\u{fa62}"
        case .webexRoomKitPlusBold: return "\u{fa63}"
        case .webexRoomKitPlusLight: return "\u{fa64}"
        case .webexRoomKitPlusRegular: return "\u{fa65}"
        case .webexRoomKitRegular: return "\u{fa66}"
        case .webexShareBold: return "\u{fa67}"
        case .webexShareLight: return "\u{fa68}"
        case .webexShareRegular: return "\u{fa69}"
        case .webexTeamsBold: return "\u{fa6a}"
        case .webexTeamsFilled: return "\u{fa6b}"
        case .webexTeamsLight: return "\u{fa6c}"
        case .webexTeamsNewBold: return "\u{fa6d}"
        case .webexTeamsNewFilled: return "\u{fa6e}"
        case .webexTeamsNewLight: return "\u{fa6f}"
        case .webexTeamsNewRegular: return "\u{fa70}"
        case .webexTeamsRegular: return "\u{fa71}"
        case .webinarBold: return "\u{fa72}"
        case .webinarFilled: return "\u{fa73}"
        case .webinarLight: return "\u{fa74}"
        case .webinarRegular: return "\u{fa75}"
        case .weeklyRecurringScheduleNodeBold: return "\u{fa76}"
        case .weeklyRecurringScheduleNodeLight: return "\u{fa77}"
        case .weeklyRecurringScheduleNodeRegular: return "\u{fa78}"
        case .whiteboardBold: return "\u{fa79}"
        case .whiteboardContentBold: return "\u{fa7a}"
        case .whiteboardContentLight: return "\u{fa7b}"
        case .whiteboardContentRegular: return "\u{fa7c}"
        case .whiteboardFilled: return "\u{fa7d}"
        case .whiteboardLight: return "\u{fa7e}"
        case .whiteboardRegular: return "\u{fa7f}"
        case .widgetBold: return "\u{fa80}"
        case .widgetFilled: return "\u{fa81}"
        case .widgetLight: return "\u{fa82}"
        case .widgetRegular: return "\u{fa83}"
        case .wifiBold: return "\u{fa84}"
        case .wifiErrorBold: return "\u{fa85}"
        case .wifiErrorLight: return "\u{fa86}"
        case .wifiErrorRegular: return "\u{fa87}"
        case .wifiLight: return "\u{fa88}"
        case .wifiRegular: return "\u{fa89}"
        case .wifiSignalGoodColoredBold: return "\u{fa8a}"
        case .wifiSignalGoodColoredLight: return "\u{fa8b}"
        case .wifiSignalGoodColoredRegular: return "\u{fa8c}"
        case .wifiSignalPoorColoredBold: return "\u{fa8d}"
        case .wifiSignalPoorColoredLight: return "\u{fa8e}"
        case .wifiSignalPoorColoredRegular: return "\u{fa8f}"
        case .wifiSignalUnstableColoredBold: return "\u{fa90}"
        case .wifiSignalUnstableColoredLight: return "\u{fa91}"
        case .wifiSignalUnstableColoredRegular: return "\u{fa92}"
        case .windowCornerScrubBold: return "\u{fa93}"
        case .windowCornerScrubLight: return "\u{fa94}"
        case .windowCornerScrubRegular: return "\u{fa95}"
        case .windowRightCornerScrubBold: return "\u{fa96}"
        case .windowRightCornerScrubLight: return "\u{fa97}"
        case .windowRightCornerScrubRegular: return "\u{fa98}"
        case .windowVerticalScrubBold: return "\u{fa99}"
        case .windowVerticalScrubLight: return "\u{fa9a}"
        case .windowVerticalScrubRegular: return "\u{fa9b}"
        case .workflowDeploymentsBold: return "\u{fa9c}"
        case .workflowDeploymentsLight: return "\u{fa9d}"
        case .workflowDeploymentsRegular: return "\u{fa9e}"
        case .workphoneBold: return "\u{fa9f}"
        case .workphoneLight: return "\u{faa0}"
        case .workphoneRegular: return "\u{faa1}"
        case .zoomInBold: return "\u{faa2}"
        case .zoomInLight: return "\u{faa3}"
        case .zoomInRegular: return "\u{faa4}"
        case .zoomOutBold: return "\u{faa5}"
        case .zoomOutLight: return "\u{faa6}"
        case .zoomOutRegular: return "\u{faa7}"
        case .zoom: return "\u{faa8}"
