...
var SubMenu = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return _react.default.createElement(_reactUid.UIDFork, null, _react.default.createElement(_reactUid.UIDConsumer, {
      ...
      return _react.default.createElement(_ListContext.default.Consumer, null, function (listContext) {
        ...
        return _react.default.createElement("div", {
          ...
          value: selectContext
        }, _react.default.createElement(_.ListItem, _extends({
          active: cxtActive,
          focusOnLoad: true,
          id: id,
          isReadOnly: isHeader,
          ...
          role: "menuitem"
        }, otherProps), customNode ? customNode : [_react.default.createElement("div", {
          ...
          title: selectedValue,
          key: "content-1"
        }, children && selectedValue), _react.default.createElement("div", {
          className: _prefixer.prefix + "-menu-item__arrow",
          key: "content-2"
        }, children && _react.default.createElement(_.Icon, {
          name: "arrow-right_16"
        }))])), cxtActive && _react.default.createElement(_.EventOverlay, _extends({
          anchorNode: _this2.anchorRef,
          isOpen: cxtActive,
          direction: "right-top",
          closeOnClick: false,
          isContained: true
        }, eventOverlayProps), _react.default.createElement("div", {
          "aria-label": label,
          role: "menu",
