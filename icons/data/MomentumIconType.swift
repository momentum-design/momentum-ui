...
@objc public enum MomentumIconType: Int {
    ...
    public var ligature: String {
        ...
        case .tools28: return "\u{fafa}"
        case .tools32: return "\u{fafb}"
        case .touch16: return "\u{fafc}"
        case .touch1024: return "\u{fafd}"
        case .transcript16: return "\u{fafe}"
        case .transcript20: return "\u{faff}"
        case .twitter16: return "\u{fb00}"
        case .twitterCircle24: return "\u{fb01}"
        case .twitterCircle32: return "\u{fb02}"
        case .twitterCircle40: return "\u{fb03}"
        case .ucmCloud10: return "\u{fb04}"
        case .ucmCloud16: return "\u{fb05}"
        case .ucmCloud24: return "\u{fb06}"
        case .ucmCloud32: return "\u{fb07}"
        case .undo12: return "\u{fb08}"
        case .undo14: return "\u{fb09}"
        case .undo16: return "\u{fb0a}"
        case .undo24: return "\u{fb0b}"
        case .unlink20: return "\u{fb0c}"
        case .unreadBadge10: return "\u{fb0d}"
        case .unreadBadge12: return "\u{fb0e}"
        case .unreadBadge16: return "\u{fb0f}"
        case .unreadBadge8: return "\u{fb10}"
        case .unsecure12: return "\u{fb11}"
        case .unsecure14: return "\u{fb12}"
        case .unsecure16: return "\u{fb13}"
        case .unsecure24: return "\u{fb14}"
        case .unsecure28: return "\u{fb15}"
        case .upload12: return "\u{fb16}"
        case .upload130: return "\u{fb17}"
        case .upload14: return "\u{fb18}"
        case .upload16: return "\u{fb19}"
        case .upload18: return "\u{fb1a}"
        case .upload20: return "\u{fb1b}"
        case .upload24: return "\u{fb1c}"
        case .upload28: return "\u{fb1d}"
        case .upload32: return "\u{fb1e}"
        case .upload36: return "\u{fb1f}"
        case .usb16: return "\u{fb20}"
        case .user16: return "\u{fb21}"
        case .user20: return "\u{fb22}"
        case .user24: return "\u{fb23}"
        case .user56: return "\u{fb24}"
        case .videoEffect12: return "\u{fb25}"
        case .videoLayout12: return "\u{fb26}"
        case .videoLayout16: return "\u{fb27}"
        case .videoLayoutAuto12: return "\u{fb28}"
        case .videoLayoutAuto16: return "\u{fb29}"
        case .videoLayoutAuto20: return "\u{fb2a}"
        case .videoLayoutAuto24: return "\u{fb2b}"
        case .videoLayoutEqual12: return "\u{fb2c}"
        case .videoLayoutEqual14: return "\u{fb2d}"
        case .videoLayoutEqual16: return "\u{fb2e}"
        case .videoLayoutEqual20: return "\u{fb2f}"
        case .videoLayoutEqual24: return "\u{fb30}"
        case .videoLayoutOverlay12: return "\u{fb31}"
        case .videoLayoutOverlay16: return "\u{fb32}"
        case .videoLayoutOverlay20: return "\u{fb33}"
        case .videoLayoutOverlay24: return "\u{fb34}"
        case .videoLayoutProminent12: return "\u{fb35}"
        case .videoLayoutProminent16: return "\u{fb36}"
        case .videoLayoutProminent20: return "\u{fb37}"
        case .videoLayoutProminent24: return "\u{fb38}"
        case .videoLayoutShareDominant12: return "\u{fb39}"
        case .videoLayoutShareDominant16: return "\u{fb3a}"
        case .videoLayoutShareDominant20: return "\u{fb3b}"
        case .videoLayoutShareDominant24: return "\u{fb3c}"
        case .videoLayoutSingle16: return "\u{fb3d}"
        case .videoLayoutSingle20: return "\u{fb3e}"
        case .videoLayoutVideoDominant12: return "\u{fb3f}"
        case .videoLayoutVideoDominant16: return "\u{fb40}"
        case .videoLayoutVideoDominant20: return "\u{fb41}"
        case .videoLayoutVideoDominant24: return "\u{fb42}"
        case .viewAll12: return "\u{fb43}"
        case .viewAll14: return "\u{fb44}"
        case .viewFeedMultiple16: return "\u{fb45}"
        case .viewFeedPanel16: return "\u{fb46}"
        case .viewFeedSingle16: return "\u{fb47}"
        case .viewList10: return "\u{fb48}"
        case .viewList12: return "\u{fb49}"
        case .viewList14: return "\u{fb4a}"
        case .viewList16: return "\u{fb4b}"
        case .viewList20: return "\u{fb4c}"
        case .viewList24: return "\u{fb4d}"
        case .viewList28: return "\u{fb4e}"
        case .viewListCircle100: return "\u{fb4f}"
        case .viewMixed12: return "\u{fb50}"
        case .viewStack12: return "\u{fb51}"
        case .viewStack14: return "\u{fb52}"
        case .viewStack20: return "\u{fb53}"
        case .viewStack24: return "\u{fb54}"
        case .viewThumbnail12: return "\u{fb55}"
        case .viewThumbnail14: return "\u{fb56}"
        case .viewThumbnail16: return "\u{fb57}"
        case .viewThumbnail20: return "\u{fb58}"
        case .viewThumbnail24: return "\u{fb59}"
        case .voice20: return "\u{fb5a}"
        case .voicemail10: return "\u{fb5b}"
        case .voicemail14: return "\u{fb5c}"
        case .voicemail16: return "\u{fb5d}"
        case .voicemail18: return "\u{fb5e}"
        case .voicemail20: return "\u{fb5f}"
        case .voicemail24: return "\u{fb60}"
        case .voicemail28: return "\u{fb61}"
        case .voicemail8: return "\u{fb62}"
        case .voicemailActive12: return "\u{fb63}"
        case .voicemailActive14: return "\u{fb64}"
        case .voicemailActive16: return "\u{fb65}"
        case .voicemailActive18: return "\u{fb66}"
        case .voicemailActive20: return "\u{fb67}"
        case .voicemailActive24: return "\u{fb68}"
        case .voicemailActive28: return "\u{fb69}"
        case .wallpaper16: return "\u{fb6a}"
        case .wallpaper20: return "\u{fb6b}"
        case .wallpaper24: return "\u{fb6c}"
        case .wallpaper28: return "\u{fb6d}"
        case .wallpaper32: return "\u{fb6e}"
        case .warning100: return "\u{fb6f}"
        case .warning12: return "\u{fb70}"
        case .warning14: return "\u{fb71}"
        case .warning16: return "\u{fb72}"
        case .warning20: return "\u{fb73}"
        case .warning24: return "\u{fb74}"
        case .warning28: return "\u{fb75}"
        case .warning32: return "\u{fb76}"
        case .warning40: return "\u{fb77}"
        case .warning44: return "\u{fb78}"
        case .warning56: return "\u{fb79}"
        case .warning64: return "\u{fb7a}"
        case .warning72: return "\u{fb7b}"
        case .waveform20: return "\u{fb7c}"
        case .webSharing16: return "\u{fb7d}"
        case .webSharing24: return "\u{fb7e}"
        case .webex10: return "\u{fb7f}"
        case .webex16: return "\u{fb80}"
        case .webex24: return "\u{fb81}"
        case .webex48: return "\u{fb82}"
        case .webexBoard12: return "\u{fb83}"
        case .webexBoard14: return "\u{fb84}"
        case .webexBoard16: return "\u{fb85}"
        case .webexBoard20: return "\u{fb86}"
        case .webexBoard24: return "\u{fb87}"
        case .webexBoard28: return "\u{fb88}"
        case .webexBoard32: return "\u{fb89}"
        case .webexBoard48: return "\u{fb8a}"
        case .webexCalling10: return "\u{fb8b}"
        case .webexCalling12: return "\u{fb8c}"
        case .webexCalling16: return "\u{fb8d}"
        case .webexCalling18: return "\u{fb8e}"
        case .webexCalling20: return "\u{fb8f}"
        case .webexCalling24: return "\u{fb90}"
        case .webexCodecPlus16: return "\u{fb91}"
        case .webexCodecPlus20: return "\u{fb92}"
        case .webexInstantMeeting12: return "\u{fb93}"
        case .webexInstantMeeting14: return "\u{fb94}"
        case .webexInstantMeeting16: return "\u{fb95}"
        case .webexInstantMeeting20: return "\u{fb96}"
        case .webexInstantMeeting24: return "\u{fb97}"
        case .webexMeetings10: return "\u{fb98}"
        case .webexMeetings12: return "\u{fb99}"
        case .webexMeetings14: return "\u{fb9a}"
        case .webexMeetings16: return "\u{fb9b}"
        case .webexMeetings20: return "\u{fb9c}"
        case .webexMeetings24: return "\u{fb9d}"
        case .webexMeetings48: return "\u{fb9e}"
        case .webexQuadCamera16: return "\u{fb9f}"
        case .webexQuadCamera20: return "\u{fba0}"
        case .webexRoomKit16: return "\u{fba1}"
        case .webexRoomKit20: return "\u{fba2}"
        case .webexRoomKitPlus16: return "\u{fba3}"
        case .webexRoomKitPlus20: return "\u{fba4}"
        case .webexShare12: return "\u{fba5}"
        case .webexShare14: return "\u{fba6}"
        case .webexShare16: return "\u{fba7}"
        case .webexShare20: return "\u{fba8}"
        case .webexTeams10: return "\u{fba9}"
        case .webexTeams12: return "\u{fbaa}"
        case .webexTeams14: return "\u{fbab}"
        case .webexTeams16: return "\u{fbac}"
        case .webexTeams18: return "\u{fbad}"
        case .webexTeams20: return "\u{fbae}"
        case .webexVoice16: return "\u{fbaf}"
        case .webexVoice20: return "\u{fbb0}"
        case .webpop12: return "\u{fbb1}"
        case .webpop16: return "\u{fbb2}"
        case .webpop20: return "\u{fbb3}"
        case .webpop24: return "\u{fbb4}"
        case .whiteboard10: return "\u{fbb5}"
        case .whiteboard12: return "\u{fbb6}"
        case .whiteboard14: return "\u{fbb7}"
        case .whiteboard16: return "\u{fbb8}"
        case .whiteboard20: return "\u{fbb9}"
        case .whiteboard24: return "\u{fbba}"
        case .whiteboard26: return "\u{fbbb}"
        case .whiteboard28: return "\u{fbbc}"
        case .whiteboard32: return "\u{fbbd}"
        case .whiteboard36: return "\u{fbbe}"
        case .whiteboard8: return "\u{fbbf}"
        case .whiteboardContent16: return "\u{fbc0}"
        case .whiteboardContent24: return "\u{fbc1}"
        case .widgetsAdr20: return "\u{fbc2}"
        case .wifi12: return "\u{fbc3}"
        case .wifi16: return "\u{fbc4}"
        case .wifi20: return "\u{fbc5}"
        case .wifi24: return "\u{fbc6}"
        case .wifiError12: return "\u{fbc7}"
        case .wifiError16: return "\u{fbc8}"
        case .wikipedia16: return "\u{fbc9}"
        case .windowCornerScrub16: return "\u{fbca}"
        case .windowVerticalScrub16: return "\u{fbcb}"
        case .youtubeCircle24: return "\u{fbcc}"
        case .youtubeCircle32: return "\u{fbcd}"
        case .youtubeCircle40: return "\u{fbce}"
        case .zoomIn12: return "\u{fbcf}"
        case .zoomIn14: return "\u{fbd0}"
        case .zoomIn16: return "\u{fbd1}"
        case .zoomIn20: return "\u{fbd2}"
        case .zoomOut12: return "\u{fbd3}"
        case .zoomOut14: return "\u{fbd4}"
        case .zoomOut16: return "\u{fbd5}"
        case .zoomOut20: return "\u{fbd6}"
