...
Configure columns and additional features here. Number of columns must match parsed data row length. All object keys provided with `?` (question mark) is optional and can be skipped.
