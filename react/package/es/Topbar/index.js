...
var Topbar = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    var brandNodeChildren = [/*#__PURE__*/React.createElement("div", {
      className: brandClass + "__logo" + ("" + (addPadding && " " + brandClass + "__logo--pad" || '')),
      key: brandClass + "__logo"
    }, image ? image : /*#__PURE__*/React.createElement("i", {
      className: "icon " + icon
    ...
    var getBrandAnchor = function getBrandAnchor() {
      return brandAnchorElement ? /*#__PURE__*/React.cloneElement(brandAnchorElement, {
        className: "" + brandClass + ("" + (brandAnchorElement.props.className && " " + brandAnchorElement.props.className || ''))
      }, brandNodeChildren) : /*#__PURE__*/React.createElement("a", {
        className: brandClass,
        href: anchor
      }, brandNodeChildren);
    };

    var brandNode = /*#__PURE__*/React.createElement("div", {
