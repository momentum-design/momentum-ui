...
@objc public enum MomentumIconsRebrandType: Int {
    ...
    public var ligature: String {
        ...
        case .callMoreBold: return "\u{f28f}"
        case .callMoreLight: return "\u{f290}"
        case .callMoreRegular: return "\u{f291}"
        case .callOutgoingBold: return "\u{f292}"
        case .callOutgoingLight: return "\u{f293}"
        case .callOutgoingRegular: return "\u{f294}"
        case .callPickupBold: return "\u{f295}"
        case .callPickupFilled: return "\u{f296}"
        case .callPickupLight: return "\u{f297}"
        case .callPickupRegular: return "\u{f298}"
        case .callPrivateBold: return "\u{f299}"
        case .callPrivateLight: return "\u{f29a}"
        case .callPrivateRegular: return "\u{f29b}"
        case .callRequestBold: return "\u{f29c}"
        case .callRequestFilled: return "\u{f29d}"
        case .callRequestLight: return "\u{f29e}"
        case .callRequestRegular: return "\u{f29f}"
        case .callReturnBold: return "\u{f2a0}"
        case .callReturnFilled: return "\u{f2a1}"
        case .callReturnLight: return "\u{f2a2}"
        case .callReturnRegular: return "\u{f2a3}"
        case .callRoomBold: return "\u{f2a4}"
        case .callRoomLight: return "\u{f2a5}"
        case .callRoomRegular: return "\u{f2a6}"
        case .callSettingsBold: return "\u{f2a7}"
        case .callSettingsLight: return "\u{f2a8}"
        case .callSettingsRegular: return "\u{f2a9}"
        case .callSplitBold: return "\u{f2aa}"
        case .callSplitLight: return "\u{f2ab}"
        case .callSplitRegular: return "\u{f2ac}"
        case .callSwapBold: return "\u{f2ad}"
        case .callSwapLight: return "\u{f2ae}"
        case .callSwapRegular: return "\u{f2af}"
        case .callVoicemailBold: return "\u{f2b0}"
        case .callVoicemailLight: return "\u{f2b1}"
        case .callVoicemailRegular: return "\u{f2b2}"
        case .callrateBold: return "\u{f2b3}"
        case .callrateLight: return "\u{f2b4}"
        case .callrateRegular: return "\u{f2b5}"
        case .cameraAuxBold: return "\u{f2b6}"
        case .cameraAuxFilled: return "\u{f2b7}"
        case .cameraAuxLight: return "\u{f2b8}"
        case .cameraAuxRegular: return "\u{f2b9}"
        case .cameraBold: return "\u{f2ba}"
        case .cameraFilled: return "\u{f2bb}"
        case .cameraLight: return "\u{f2bc}"
        case .cameraMutedBold: return "\u{f2bd}"
        case .cameraMutedFilled: return "\u{f2be}"
        case .cameraMutedLight: return "\u{f2bf}"
        case .cameraMutedRegular: return "\u{f2c0}"
        case .cameraOnBold: return "\u{f2c1}"
        case .cameraOnColoredBold: return "\u{f2c2}"
        case .cameraOnColoredFilled: return "\u{f2c3}"
        case .cameraOnColoredLight: return "\u{f2c4}"
        case .cameraOnColoredRegular: return "\u{f2c5}"
        case .cameraOnFilled: return "\u{f2c6}"
        case .cameraOnLight: return "\u{f2c7}"
        case .cameraOnRegular: return "\u{f2c8}"
        case .cameraPhotoBold: return "\u{f2c9}"
        case .cameraPhotoFilled: return "\u{f2ca}"
        case .cameraPhotoLight: return "\u{f2cb}"
        case .cameraPhotoRegular: return "\u{f2cc}"
        case .cameraPresenceBold: return "\u{f2cd}"
        case .cameraPresenceFilled: return "\u{f2ce}"
        case .cameraPresenceLight: return "\u{f2cf}"
        case .cameraPresenceRegular: return "\u{f2d0}"
        case .cameraRegular: return "\u{f2d1}"
        case .cameraSwapBold: return "\u{f2d2}"
        case .cameraSwapLight: return "\u{f2d3}"
        case .cameraSwapRegular: return "\u{f2d4}"
        case .cancelBold: return "\u{f2d5}"
        case .cancelLight: return "\u{f2d6}"
        case .cancelRegular: return "\u{f2d7}"
        case .capsLockBold: return "\u{f2d8}"
        case .capsLockLight: return "\u{f2d9}"
        case .capsLockRegular: return "\u{f2da}"
        case .captureRewindBold: return "\u{f2db}"
        case .captureRewindLight: return "\u{f2dc}"
        case .captureRewindRegular: return "\u{f2dd}"
        case .carouselBold: return "\u{f2de}"
        case .carouselLight: return "\u{f2df}"
        case .carouselRegular: return "\u{f2e0}"
        case .carouselTextBold: return "\u{f2e1}"
        case .carouselTextLight: return "\u{f2e2}"
        case .carouselTextRegular: return "\u{f2e3}"
        case .cellularBold: return "\u{f2e4}"
        case .cellularLight: return "\u{f2e5}"
        case .cellularRegular: return "\u{f2e6}"
        case .centerAlignedBold: return "\u{f2e7}"
        case .centerAlignedLight: return "\u{f2e8}"
        case .centerAlignedRegular: return "\u{f2e9}"
        case .centerBold: return "\u{f2ea}"
        case .centerLight: return "\u{f2eb}"
        case .centerRegular: return "\u{f2ec}"
        case .certifiedBold: return "\u{f2ed}"
        case .certifiedLight: return "\u{f2ee}"
        case .certifiedRegular: return "\u{f2ef}"
        case .chPSearchBold: return "\u{f2f0}"
        case .chPSearchLight: return "\u{f2f1}"
        case .chPSearchRegular: return "\u{f2f2}"
        case .channelUssdBold: return "\u{f2f3}"
        case .channelUssdLight: return "\u{f2f4}"
        case .channelUssdRegular: return "\u{f2f5}"
        case .chatBold: return "\u{f2f6}"
        case .chatFilled: return "\u{f2f7}"
        case .chatGroupBold: return "\u{f2f8}"
        case .chatGroupFilled: return "\u{f2f9}"
        case .chatGroupLight: return "\u{f2fa}"
        case .chatGroupRegular: return "\u{f2fb}"
        case .chatLight: return "\u{f2fc}"
        case .chatMuteBold: return "\u{f2fd}"
        case .chatMuteLight: return "\u{f2fe}"
        case .chatMuteRegular: return "\u{f2ff}"
        case .chatOnColoredBold: return "\u{f300}"
        case .chatOnColoredFilled: return "\u{f301}"
        case .chatOnColoredLight: return "\u{f302}"
        case .chatOnColoredRegular: return "\u{f303}"
        case .chatRegular: return "\u{f304}"
        case .checkBold: return "\u{f305}"
        case .checkCircleBadgeFilled: return "\u{f306}"
        case .checkCircleBold: return "\u{f307}"
        case .checkCircleFilled: return "\u{f308}"
        case .checkCircleLight: return "\u{f309}"
        case .checkCircleRegular: return "\u{f30a}"
        case .checkLight: return "\u{f30b}"
        case .checkRegular: return "\u{f30c}"
        case .checkboxGroupBold: return "\u{f30d}"
        case .checkboxGroupLight: return "\u{f30e}"
        case .checkboxGroupRegular: return "\u{f30f}"
        case .clearBold: return "\u{f310}"
        case .clearFilled: return "\u{f311}"
        case .clearLight: return "\u{f312}"
        case .clearRegular: return "\u{f313}"
        case .closeSpaceBold: return "\u{f314}"
        case .closeSpaceLight: return "\u{f315}"
        case .closeSpaceRegular: return "\u{f316}"
        case .closedCaptionBadgeBold: return "\u{f317}"
        case .closedCaptionBadgeLight: return "\u{f318}"
        case .closedCaptionBadgeRegular: return "\u{f319}"
        case .closedCaptionsBold: return "\u{f31a}"
        case .closedCaptionsFilled: return "\u{f31b}"
        case .closedCaptionsLight: return "\u{f31c}"
        case .closedCaptionsRegular: return "\u{f31d}"
        case .cloudBold: return "\u{f31e}"
        case .cloudDownloadBold: return "\u{f31f}"
        case .cloudDownloadLight: return "\u{f320}"
        case .cloudDownloadRegular: return "\u{f321}"
        case .cloudFilled: return "\u{f322}"
        case .cloudFrameBold: return "\u{f323}"
        case .cloudFrameFilled: return "\u{f324}"
        case .cloudFrameRegular: return "\u{f325}"
        case .cloudFramedFilled: return "\u{f326}"
        case .cloudFramedLight: return "\u{f327}"
        case .cloudLight: return "\u{f328}"
        case .cloudMutedBold: return "\u{f329}"
        case .cloudMutedFilled: return "\u{f32a}"
        case .cloudMutedLight: return "\u{f32b}"
        case .cloudMutedRegular: return "\u{f32c}"
        case .cloudRegular: return "\u{f32d}"
        case .cloudUploadBold: return "\u{f32e}"
        case .cloudUploadLight: return "\u{f32f}"
        case .cloudUploadRegular: return "\u{f330}"
        case .codeBlockBold: return "\u{f331}"
        case .codeBlockLight: return "\u{f332}"
        case .codeBlockRegular: return "\u{f333}"
        case .colorBold: return "\u{f334}"
        case .colorLight: return "\u{f335}"
        case .colorRegular: return "\u{f336}"
        case .colourPaletteBold: return "\u{f337}"
        case .colourPaletteFilled: return "\u{f338}"
        case .colourPaletteLight: return "\u{f339}"
        case .colourPaletteRegular: return "\u{f33a}"
        case .commentingBold: return "\u{f33b}"
        case .commentingFilled: return "\u{f33c}"
        case .commentingLight: return "\u{f33d}"
        case .commentingRegular: return "\u{f33e}"
        case .companyBold: return "\u{f33f}"
        case .companyLight: return "\u{f340}"
        case .companyRegular: return "\u{f341}"
        case .completedByTimeBold: return "\u{f342}"
        case .completedByTimeLight: return "\u{f343}"
        case .completedByTimeRegular: return "\u{f344}"
        case .computerBold: return "\u{f345}"
        case .computerLight: return "\u{f346}"
        case .computerRegular: return "\u{f347}"
        case .conciergeBold: return "\u{f348}"
        case .conciergeLight: return "\u{f349}"
        case .conciergeRegular: return "\u{f34a}"
        case .conditionalBlockBold: return "\u{f34b}"
        case .conditionalBlockLight: return "\u{f34c}"
        case .conditionalBlockRegular: return "\u{f34d}"
        case .contactCardBold: return "\u{f34e}"
        case .contactCardFilled: return "\u{f34f}"
        case .contactCardLight: return "\u{f350}"
        case .contactCardRegular: return "\u{f351}"
        case .contactGroupBold: return "\u{f352}"
        case .contactGroupFilled: return "\u{f353}"
        case .contactGroupLight: return "\u{f354}"
        case .contactGroupRegular: return "\u{f355}"
        case .contactsBold: return "\u{f356}"
        case .contactsFilled: return "\u{f357}"
        case .contactsLight: return "\u{f358}"
        case .contactsRegular: return "\u{f359}"
        case .contentDownloadBold: return "\u{f35a}"
        case .contentDownloadFilled: return "\u{f35b}"
        case .contentDownloadLight: return "\u{f35c}"
        case .contentDownloadRegular: return "\u{f35d}"
        case .contentShareBold: return "\u{f35e}"
        case .contentShareLight: return "\u{f35f}"
        case .contentShareRegular: return "\u{f360}"
        case .contrastBold: return "\u{f361}"
        case .contrastLight: return "\u{f362}"
        case .contrastRegular: return "\u{f363}"
        case .copyBold: return "\u{f364}"
        case .copyLight: return "\u{f365}"
        case .copyRegular: return "\u{f366}"
        case .cpuBold: return "\u{f367}"
        case .cpuLight: return "\u{f368}"
        case .cpuRegular: return "\u{f369}"
        case .createAGroupBold: return "\u{f36a}"
        case .createAGroupLight: return "\u{f36b}"
        case .createAGroupRegular: return "\u{f36c}"
        case .cropBold: return "\u{f36d}"
        case .cropLight: return "\u{f36e}"
        case .cropRegular: return "\u{f36f}"
        case .cucmConnectionBold: return "\u{f370}"
        case .cucmConnectionLight: return "\u{f371}"
        case .cucmConnectionRegular: return "\u{f372}"
        case .dailyRecurringScheduleNodeBold: return "\u{f373}"
        case .dailyRecurringScheduleNodeLight: return "\u{f374}"
        case .dailyRecurringScheduleNodeRegular: return "\u{f375}"
        case .dashboardBold: return "\u{f376}"
        case .dashboardFilled: return "\u{f377}"
        case .dashboardLight: return "\u{f378}"
        case .dashboardRegular: return "\u{f379}"
        case .dataManagement1: return "\u{f37a}"
        case .dataManagement2: return "\u{f37b}"
        case .dataManagement: return "\u{f37c}"
        case .deleteBold: return "\u{f37d}"
        case .deleteFilled: return "\u{f37e}"
        case .deleteLight: return "\u{f37f}"
        case .deleteRegular: return "\u{f380}"
        case .deskPhoneBold: return "\u{f381}"
        case .deskPhoneFilled: return "\u{f382}"
        case .deskPhoneLight: return "\u{f383}"
        case .deskPhoneRegular: return "\u{f384}"
        case .deskPhoneWarningBold: return "\u{f385}"
        case .deskPhoneWarningLight: return "\u{f386}"
        case .deskPhoneWarningRegular: return "\u{f387}"
        case .deviceConnectionBold: return "\u{f388}"
        case .deviceConnectionFilled: return "\u{f389}"
        case .deviceConnectionLight: return "\u{f38a}"
        case .deviceConnectionRegular: return "\u{f38b}"
        case .devicePolicyControllerBold: return "\u{f38c}"
        case .devicePolicyControllerLight: return "\u{f38d}"
        case .devicePolicyControllerRegular: return "\u{f38e}"
        case .diagnosticsBold: return "\u{f38f}"
        case .diagnosticsLight: return "\u{f390}"
        case .diagnosticsRegular: return "\u{f391}"
        case .dialpadBold: return "\u{f392}"
        case .dialpadLight: return "\u{f393}"
        case .dialpadRegular: return "\u{f394}"
        case .directionalPadBold: return "\u{f395}"
        case .directionalPadFilled: return "\u{f396}"
        case .directionalPadLight: return "\u{f397}"
        case .directionalPadRegular: return "\u{f398}"
        case .directoryBold: return "\u{f399}"
        case .directoryLight: return "\u{f39a}"
        case .directoryRegular: return "\u{f39b}"
        case .discBold: return "\u{f39c}"
        case .discDisconnectedBold: return "\u{f39d}"
        case .discDisconnectedLight: return "\u{f39e}"
        case .discDisconnectedRegular: return "\u{f39f}"
        case .discLight: return "\u{f3a0}"
        case .discRegular: return "\u{f3a1}"
        case .disconnectBold: return "\u{f3a2}"
        case .disconnectLight: return "\u{f3a3}"
        case .disconnectRegular: return "\u{f3a4}"
        case .dislikeBold: return "\u{f3a5}"
        case .dislikeFilled: return "\u{f3a6}"
        case .dislikeLight: return "\u{f3a7}"
        case .dislikeRegular: return "\u{f3a8}"
        case .displayBold: return "\u{f3a9}"
        case .displayInputBold: return "\u{f3aa}"
        case .displayInputLight: return "\u{f3ab}"
        case .displayInputRegular: return "\u{f3ac}"
        case .displayLight: return "\u{f3ad}"
        case .displayRegular: return "\u{f3ae}"
        case .displayWarningBold: return "\u{f3af}"
        case .displayWarningLight: return "\u{f3b0}"
        case .displayWarningRegular: return "\u{f3b1}"
        case .distributeHorizontalBold: return "\u{f3b2}"
        case .distributeHorizontalFilled: return "\u{f3b3}"
        case .distributeHorizontalLight: return "\u{f3b4}"
        case .distributeHorizontalRegular: return "\u{f3b5}"
        case .distributeVerticallyBold: return "\u{f3b6}"
        case .distributeVerticallyFilled: return "\u{f3b7}"
        case .distributeVerticallyLight: return "\u{f3b8}"
        case .distributeVerticallyRegular: return "\u{f3b9}"
        case .dndPresenceBold: return "\u{f3ba}"
        case .dndPresenceFilled: return "\u{f3bb}"
        case .dndPresenceLight: return "\u{f3bc}"
        case .dndPresenceRegular: return "\u{f3bd}"
        case .dndPresenceSmallFilled: return "\u{f3be}"
        case .documentBold: return "\u{f3bf}"
        case .documentCameraBold: return "\u{f3c0}"
        case .documentCameraDisconnectedBold: return "\u{f3c1}"
        case .documentCameraDisconnectedLight: return "\u{f3c2}"
        case .documentCameraDisconnectedRegular: return "\u{f3c3}"
        case .documentCameraLight: return "\u{f3c4}"
        case .documentCameraRegular: return "\u{f3c5}"
        case .documentCreateBold: return "\u{f3c6}"
        case .documentCreateFilled: return "\u{f3c7}"
        case .documentCreateLight: return "\u{f3c8}"
        case .documentCreateRegular: return "\u{f3c9}"
        case .documentFilled: return "\u{f3ca}"
        case .documentLight: return "\u{f3cb}"
        case .documentMoveBold: return "\u{f3cc}"
        case .documentMoveFilled: return "\u{f3cd}"
        case .documentMoveLight: return "\u{f3ce}"
        case .documentMoveRegular: return "\u{f3cf}"
        case .documentRegular: return "\u{f3d0}"
        case .documentShareBold: return "\u{f3d1}"
        case .documentShareFilled: return "\u{f3d2}"
        case .documentShareLight: return "\u{f3d3}"
        case .documentShareRegular: return "\u{f3d4}"
        case .doneAllBold: return "\u{f3d5}"
        case .doneAllLight: return "\u{f3d6}"
        case .doneAllRegular: return "\u{f3d7}"
        case .donutChartBold: return "\u{f3d8}"
        case .donutChartFilled: return "\u{f3d9}"
        case .donutChartLight: return "\u{f3da}"
        case .donutChartRegular: return "\u{f3db}"
        case .downloadBold: return "\u{f3dc}"
        case .downloadFilled: return "\u{f3dd}"
        case .downloadLight: return "\u{f3de}"
        case .downloadRegular: return "\u{f3df}"
        case .draftBold: return "\u{f3e0}"
        case .draftFilled: return "\u{f3e1}"
        case .draftIndicatorBold: return "\u{f3e2}"
        case .draftIndicatorSmallFilled: return "\u{f3e3}"
        case .draftLight: return "\u{f3e4}"
        case .draftRegular: return "\u{f3e5}"
        case .dragBold: return "\u{f3e6}"
        case .dragLight: return "\u{f3e7}"
        case .dragRegular: return "\u{f3e8}"
        case .dropdownBold: return "\u{f3e9}"
        case .dropdownLight: return "\u{f3ea}"
        case .dropdownRegular: return "\u{f3eb}"
        case .dx70Bold: return "\u{f3ec}"
        case .dx70Light: return "\u{f3ed}"
        case .dx70Regular: return "\u{f3ee}"
        case .dx80Bold: return "\u{f3ef}"
        case .dx80Filled: return "\u{f3f0}"
        case .dx80Light: return "\u{f3f1}"
        case .dx80Regular: return "\u{f3f2}"
        case .editBold: return "\u{f3f3}"
        case .editLight: return "\u{f3f4}"
        case .editRegular: return "\u{f3f5}"
        case .editablePartialBold: return "\u{f3f6}"
        case .editablePartialLight: return "\u{f3f7}"
        case .editablePartialRegular: return "\u{f3f8}"
        case .educationBold: return "\u{f3f9}"
        case .educationFilled: return "\u{f3fa}"
        case .educationLight: return "\u{f3fb}"
        case .educationRegular: return "\u{f3fc}"
        case .emailBold: return "\u{f3fd}"
        case .emailDeliveredBold: return "\u{f3fe}"
        case .emailDeliveredLight: return "\u{f3ff}"
        case .emailDeliveredRegular: return "\u{f400}"
        case .emailFailureBold: return "\u{f401}"
        case .emailFailureLight: return "\u{f402}"
        case .emailFailureRegular: return "\u{f403}"
        case .emailFilled: return "\u{f404}"
        case .emailInviteBold: return "\u{f405}"
        case .emailInviteLight: return "\u{f406}"
        case .emailInviteRegular: return "\u{f407}"
        case .emailLight: return "\u{f408}"
        case .emailReadBold: return "\u{f409}"
        case .emailReadFilled: return "\u{f40a}"
        case .emailReadLight: return "\u{f40b}"
        case .emailReadRegular: return "\u{f40c}"
        case .emailRegular: return "\u{f40d}"
        case .emojiExcitedBold: return "\u{f40e}"
        case .emojiExcitedFilled: return "\u{f40f}"
        case .emojiHappyBold: return "\u{f410}"
        case .emojiHappyFilled: return "\u{f411}"
        case .emojiHappyLight: return "\u{f412}"
        case .emojiHappyRegular: return "\u{f413}"
        case .emojiPassiveBold: return "\u{f414}"
        case .emojiPassiveFilled: return "\u{f415}"
        case .emojiPassiveLight: return "\u{f416}"
        case .emojiPassiveRegular: return "\u{f417}"
        case .emojiSadBold: return "\u{f418}"
        case .emojiSadFilled: return "\u{f419}"
        case .emojiSadLight: return "\u{f41a}"
        case .emojiSadRegular: return "\u{f41b}"
        case .emojiUnhappyBold: return "\u{f41c}"
        case .emojiUnhappyFilled: return "\u{f41d}"
        case .encryptionCircleFilled: return "\u{f41e}"
        case .encryptionFilled: return "\u{f41f}"
        case .endRemoteDesktopControlBold: return "\u{f420}"
        case .endRemoteDesktopControlLight: return "\u{f421}"
        case .endRemoteDesktopControlRegular: return "\u{f422}"
        case .endToEndEncryptionCircleFilled: return "\u{f423}"
        case .endToEndEncryptionFilled: return "\u{f424}"
        case .endpointBlockedBold: return "\u{f425}"
        case .endpointBlockedLight: return "\u{f426}"
        case .endpointBlockedRegular: return "\u{f427}"
        case .endpointBold: return "\u{f428}"
        case .endpointG270Bold: return "\u{f429}"
        case .endpointG270DualBold: return "\u{f42a}"
        case .endpointG270DualLight: return "\u{f42b}"
        case .endpointG270DualRegular: return "\u{f42c}"
        case .endpointG270Light: return "\u{f42d}"
        case .endpointG270Regular: return "\u{f42e}"
        case .endpointG2Bold: return "\u{f42f}"
        case .endpointG2Light: return "\u{f430}"
        case .endpointG2Regular: return "\u{f431}"
        case .endpointG2StandBold: return "\u{f432}"
        case .endpointG2StandLight: return "\u{f433}"
        case .endpointG2StandRegular: return "\u{f434}"
        case .endpointLight: return "\u{f435}"
        case .endpointMx800Bold: return "\u{f436}"
        case .endpointMx800DualBold: return "\u{f437}"
        case .endpointMx800DualLight: return "\u{f438}"
        case .endpointMx800DualRegular: return "\u{f439}"
        case .endpointMx800Light: return "\u{f43a}"
        case .endpointMx800Regular: return "\u{f43b}"
        case .endpointRegular: return "\u{f43c}"
        case .endpointStandBold: return "\u{f43d}"
        case .endpointStandFilled: return "\u{f43e}"
        case .endpointStandLight: return "\u{f43f}"
        case .endpointStandRegular: return "\u{f440}"
        case .endpointWarningBold: return "\u{f441}"
        case .endpointWarningLight: return "\u{f442}"
        case .endpointWarningRegular: return "\u{f443}"
        case .enterBold: return "\u{f444}"
        case .enterLight: return "\u{f445}"
        case .enterRegular: return "\u{f446}"
        case .enterRoomBold: return "\u{f447}"
        case .enterRoomFilled: return "\u{f448}"
        case .enterRoomLight: return "\u{f449}"
        case .enterRoomRegular: return "\u{f44a}"
        case .eraserBold: return "\u{f44b}"
        case .eraserFilled: return "\u{f44c}"
        case .eraserLight: return "\u{f44d}"
        case .eraserRegular: return "\u{f44e}"
        case .errorLegacyBadgeFilled: return "\u{f44f}"
        case .errorLegacyBold: return "\u{f450}"
        case .errorLegacyFilled: return "\u{f451}"
        case .errorLegacyLight: return "\u{f452}"
        case .errorLegacyRegular: return "\u{f453}"
        case .ethernetBold: return "\u{f454}"
        case .ethernetLight: return "\u{f455}"
        case .ethernetRegular: return "\u{f456}"
        case .eventBold: return "\u{f457}"
        case .eventLight: return "\u{f458}"
        case .eventRegular: return "\u{f459}"
        case .exitRoomBold: return "\u{f45a}"
        case .exitRoomLight: return "\u{f45b}"
        case .exitRoomRegular: return "\u{f45c}"
        case .exludeBold: return "\u{f45d}"
        case .exludeLight: return "\u{f45e}"
        case .exludeRegular: return "\u{f45f}"
        case .exploreBold: return "\u{f460}"
        case .exploreLight: return "\u{f461}"
        case .exploreRegular: return "\u{f462}"
        case .exportBold: return "\u{f463}"
        case .exportLight: return "\u{f464}"
        case .exportRegular: return "\u{f465}"
        case .extensionMobilityBold: return "\u{f466}"
        case .extensionMobilityLight: return "\u{f467}"
        case .extensionMobilityRegular: return "\u{f468}"
        case .externalMessageBold: return "\u{f469}"
        case .externalMessageLight: return "\u{f46a}"
        case .externalMessageRegular: return "\u{f46b}"
        case .externalUserBold: return "\u{f46c}"
        case .externalUserLight: return "\u{f46d}"
        case .externalUserRegular: return "\u{f46e}"
        case .familyFontBold: return "\u{f46f}"
        case .familyFontLight: return "\u{f470}"
        case .familyFontRegular: return "\u{f471}"
        case .fastForwardBold: return "\u{f472}"
        case .fastForwardLight: return "\u{f473}"
        case .fastForwardRegular: return "\u{f474}"
        case .favoriteBold: return "\u{f475}"
        case .favoriteFilled: return "\u{f476}"
        case .favoriteLight: return "\u{f477}"
        case .favoriteRegular: return "\u{f478}"
        case .favoritesBold: return "\u{f479}"
        case .favoritesFilled: return "\u{f47a}"
        case .favoritesLight: return "\u{f47b}"
        case .favoritesRegular: return "\u{f47c}"
        case .fbwBold: return "\u{f47d}"
        case .fbwFilled: return "\u{f47e}"
        case .fbwLight: return "\u{f47f}"
        case .fbwRegular: return "\u{f480}"
        case .ffwBold: return "\u{f481}"
        case .ffwFilled: return "\u{f482}"
        case .ffwLight: return "\u{f483}"
        case .ffwRegular: return "\u{f484}"
        case .file3DBold: return "\u{f485}"
        case .file3DFilled: return "\u{f486}"
        case .file3DLight: return "\u{f487}"
        case .file3DRegular: return "\u{f488}"
        case .fileAnalysisBold: return "\u{f489}"
        case .fileAnalysisFilled: return "\u{f48a}"
        case .fileAnalysisLight: return "\u{f48b}"
        case .fileAnalysisRegular: return "\u{f48c}"
        case .fileAnnotationBold: return "\u{f48d}"
        case .fileAnnotationFilled: return "\u{f48e}"
        case .fileAnnotationLight: return "\u{f48f}"
        case .fileAnnotationRegular: return "\u{f490}"
        case .fileAudioBold: return "\u{f491}"
        case .fileAudioFilled: return "\u{f492}"
        case .fileAudioLight: return "\u{f493}"
        case .fileAudioRegular: return "\u{f494}"
        case .fileBugBold: return "\u{f495}"
        case .fileBugFilled: return "\u{f496}"
        case .fileBugLight: return "\u{f497}"
        case .fileBugRegular: return "\u{f498}"
        case .fileCodeBold: return "\u{f499}"
        case .fileCodeFilled: return "\u{f49a}"
        case .fileCodeLight: return "\u{f49b}"
        case .fileCodeRegular: return "\u{f49c}"
        case .fileDashboardBold: return "\u{f49d}"
        case .fileDashboardFilled: return "\u{f49e}"
        case .fileDashboardLight: return "\u{f49f}"
        case .fileDashboardRegular: return "\u{f4a0}"
        case .fileExcelBold: return "\u{f4a1}"
        case .fileExcelFilled: return "\u{f4a2}"
        case .fileExcelLight: return "\u{f4a3}"
        case .fileExcelRegular: return "\u{f4a4}"
        case .fileGraphBold: return "\u{f4a5}"
        case .fileGraphFilled: return "\u{f4a6}"
        case .fileGraphLight: return "\u{f4a7}"
        case .fileGraphRegular: return "\u{f4a8}"
        case .fileImageBold: return "\u{f4a9}"
        case .fileImageFilled: return "\u{f4aa}"
        case .fileImageLight: return "\u{f4ab}"
        case .fileImageNoneBold: return "\u{f4ac}"
        case .fileImageNoneLight: return "\u{f4ad}"
        case .fileImageNoneRegular: return "\u{f4ae}"
        case .fileImageRegular: return "\u{f4af}"
        case .fileKeynoteBold: return "\u{f4b0}"
        case .fileKeynoteFilled: return "\u{f4b1}"
        case .fileKeynoteLight: return "\u{f4b2}"
        case .fileKeynoteRegular: return "\u{f4b3}"
        case .fileLockedBold: return "\u{f4b4}"
        case .fileLockedFilled: return "\u{f4b5}"
        case .fileLockedLight: return "\u{f4b6}"
        case .fileLockedRegular: return "\u{f4b7}"
        case .fileMissingBold: return "\u{f4b8}"
        case .fileMissingFilled: return "\u{f4b9}"
        case .fileMissingLight: return "\u{f4ba}"
        case .fileMissingRegular: return "\u{f4bb}"
        case .fileMusicBold: return "\u{f4bc}"
        case .fileMusicFilled: return "\u{f4bd}"
        case .fileMusicLight: return "\u{f4be}"
        case .fileMusicRegular: return "\u{f4bf}"
        case .fileOnenoteBold: return "\u{f4c0}"
        case .fileOnenoteFilled: return "\u{f4c1}"
        case .fileOnenoteLight: return "\u{f4c2}"
        case .fileOnenoteRegular: return "\u{f4c3}"
        case .filePdfBold: return "\u{f4c4}"
        case .filePdfFilled: return "\u{f4c5}"
        case .filePdfLight: return "\u{f4c6}"
        case .filePdfRegular: return "\u{f4c7}"
        case .filePowerpointBold: return "\u{f4c8}"
        case .filePowerpointFilled: return "\u{f4c9}"
        case .filePowerpointLight: return "\u{f4ca}"
        case .filePowerpointRegular: return "\u{f4cb}"
        case .fileSpreadsheetBold: return "\u{f4cc}"
        case .fileSpreadsheetFilled: return "\u{f4cd}"
        case .fileSpreadsheetLight: return "\u{f4ce}"
        case .fileSpreadsheetRegular: return "\u{f4cf}"
        case .fileTextBold: return "\u{f4d0}"
        case .fileTextFilled: return "\u{f4d1}"
        case .fileTextLight: return "\u{f4d2}"
        case .fileTextRegular: return "\u{f4d3}"
        case .fileVectorBold: return "\u{f4d4}"
        case .fileVectorFilled: return "\u{f4d5}"
        case .fileVectorLight: return "\u{f4d6}"
        case .fileVectorRegular: return "\u{f4d7}"
        case .fileVideoBold: return "\u{f4d8}"
        case .fileVideoFilled: return "\u{f4d9}"
        case .fileVideoLight: return "\u{f4da}"
        case .fileVideoRegular: return "\u{f4db}"
        case .fileWordBold: return "\u{f4dc}"
        case .fileWordFilled: return "\u{f4dd}"
        case .fileWordLight: return "\u{f4de}"
        case .fileWordRegular: return "\u{f4df}"
        case .fileZipBold: return "\u{f4e0}"
        case .fileZipFilled: return "\u{f4e1}"
        case .fileZipLight: return "\u{f4e2}"
        case .fileZipRegular: return "\u{f4e3}"
        case .filesBold: return "\u{f4e4}"
        case .filesFilled: return "\u{f4e5}"
        case .filesLight: return "\u{f4e6}"
        case .filesRegular: return "\u{f4e7}"
        case .fillColourBold: return "\u{f4e8}"
        case .fillColourFilled: return "\u{f4e9}"
        case .fillColourLight: return "\u{f4ea}"
        case .fillColourRegular: return "\u{f4eb}"
        case .filterBold: return "\u{f4ec}"
        case .filterCircleBold: return "\u{f4ed}"
        case .filterCircleFilled: return "\u{f4ee}"
        case .filterCircleLight: return "\u{f4ef}"
        case .filterCircleRegular: return "\u{f4f0}"
        case .filterLight: return "\u{f4f1}"
        case .filterRegular: return "\u{f4f2}"
        case .fitToWidthBold: return "\u{f4f3}"
        case .fitToWidthLight: return "\u{f4f4}"
        case .fitToWidthRegular: return "\u{f4f5}"
        case .fitToWindowBold: return "\u{f4f6}"
        case .fitToWindowExitBold: return "\u{f4f7}"
        case .fitToWindowExitLight: return "\u{f4f8}"
        case .fitToWindowExitRegular: return "\u{f4f9}"
        case .fitToWindowLight: return "\u{f4fa}"
        case .fitToWindowRegular: return "\u{f4fb}"
        case .flagBold: return "\u{f4fc}"
        case .flagCircleBold: return "\u{f4fd}"
        case .flagCircleFilled: return "\u{f4fe}"
        case .flagCircleLight: return "\u{f4ff}"
        case .flagCircleRegular: return "\u{f500}"
        case .flagFilled: return "\u{f501}"
        case .flagLight: return "\u{f502}"
        case .flagRegular: return "\u{f503}"
        case .folderBold: return "\u{f504}"
        case .folderEditBold: return "\u{f505}"
        case .folderEditLight: return "\u{f506}"
        case .folderEditRegular: return "\u{f507}"
        case .folderLight: return "\u{f508}"
        case .folderLockBold: return "\u{f509}"
        case .folderLockLight: return "\u{f50a}"
        case .folderLockRegular: return "\u{f50b}"
        case .folderRegular: return "\u{f50c}"
        case .folderViewBold: return "\u{f50d}"
        case .folderViewLight: return "\u{f50e}"
        case .folderViewRegular: return "\u{f50f}"
        case .followUpBold: return "\u{f510}"
        case .followUpLight: return "\u{f511}"
        case .followUpRegular: return "\u{f512}"
        case .foodBold: return "\u{f513}"
        case .foodLight: return "\u{f514}"
        case .foodRegular: return "\u{f515}"
        case .formatBold: return "\u{f516}"
        case .formatControlPanelDraggerBold: return "\u{f517}"
        case .formatControlPanelDraggerHorizontalBold: return "\u{f518}"
        case .formatControlPanelDraggerHorizontalLight: return "\u{f519}"
        case .formatControlPanelDraggerHorizontalRegular: return "\u{f51a}"
        case .formatControlPanelDraggerLight: return "\u{f51b}"
        case .formatControlPanelDraggerRegular: return "\u{f51c}"
        case .formatDefaultAppBold: return "\u{f51d}"
        case .formatDefaultAppLight: return "\u{f51e}"
        case .formatDefaultAppRegular: return "\u{f51f}"
        case .formatLight: return "\u{f520}"
        case .formatPanelControlBarBold: return "\u{f521}"
        case .formatPanelControlBarLight: return "\u{f522}"
        case .formatPanelControlBarRegular: return "\u{f523}"
        case .formatPanelControlDownBold: return "\u{f524}"
        case .formatPanelControlDownLight: return "\u{f525}"
        case .formatPanelControlDownRegular: return "\u{f526}"
        case .formatPanelControlLeftBold: return "\u{f527}"
        case .formatPanelControlLeftLight: return "\u{f528}"
        case .formatPanelControlLeftRegular: return "\u{f529}"
        case .formatPanelControlRightBold: return "\u{f52a}"
        case .formatPanelControlRightLight: return "\u{f52b}"
        case .formatPanelControlRightRegular: return "\u{f52c}"
        case .formatPanelControlUpBold: return "\u{f52d}"
        case .formatPanelControlUpDownBold: return "\u{f52e}"
        case .formatPanelControlUpDownLight: return "\u{f52f}"
        case .formatPanelControlUpDownRegular: return "\u{f530}"
        case .formatPanelControlUpLight: return "\u{f531}"
        case .formatPanelControlUpRegular: return "\u{f532}"
        case .formatRegular: return "\u{f533}"
        case .formatViewMixedBold: return "\u{f534}"
        case .formatViewMixedLight: return "\u{f535}"
        case .formatViewMixedRegular: return "\u{f536}"
        case .forwardMessageBold: return "\u{f537}"
        case .forwardMessageFilled: return "\u{f538}"
        case .forwardMessageLight: return "\u{f539}"
        case .forwardMessageRegular: return "\u{f53a}"
        case .fourColumnBold: return "\u{f53b}"
        case .fourColumnLight: return "\u{f53c}"
        case .fourColumnRegular: return "\u{f53d}"
        case .fourWayNavigationBold: return "\u{f53e}"
        case .fourWayNavigationLight: return "\u{f53f}"
        case .fourWayNavigationRegular: return "\u{f540}"
        case .frequencyCappingBold: return "\u{f541}"
        case .frequencyCappingLight: return "\u{f542}"
        case .frequencyCappingRegular: return "\u{f543}"
        case .fufillmentBold: return "\u{f544}"
        case .fufillmentLight: return "\u{f545}"
        case .fufillmentRegular: return "\u{f546}"
        case .fullscreenBold: return "\u{f547}"
        case .fullscreenExitBold: return "\u{f548}"
        case .fullscreenExitLight: return "\u{f549}"
        case .fullscreenExitRegular: return "\u{f54a}"
        case .fullscreenLight: return "\u{f54b}"
        case .fullscreenRegular: return "\u{f54c}"
        case .genericDeviceVideoBold: return "\u{f54d}"
        case .genericDeviceVideoFilled: return "\u{f54e}"
        case .genericDeviceVideoLight: return "\u{f54f}"
        case .genericDeviceVideoRegular: return "\u{f550}"
        case .genericDeviceVideoSmallFilled: return "\u{f551}"
        case .gifBold: return "\u{f552}"
        case .gifFilled: return "\u{f553}"
        case .gifHorizontalFilled: return "\u{f554}"
        case .gifLight: return "\u{f555}"
        case .gifRegular: return "\u{f556}"
        case .googleMeet: return "\u{f557}"
        case .greenRoomBold: return "\u{f558}"
        case .greenRoomFilled: return "\u{f559}"
        case .greenRoomLight: return "\u{f55a}"
        case .greenRoomRegular: return "\u{f55b}"
        case .groupBold: return "\u{f55c}"
        case .groupLight: return "\u{f55d}"
        case .groupPickupBold: return "\u{f55e}"
        case .groupPickupFilled: return "\u{f55f}"
        case .groupPickupLight: return "\u{f560}"
        case .groupPickupRegular: return "\u{f561}"
        case .groupRegular: return "\u{f562}"
        case .guestIssuerBold: return "\u{f563}"
        case .guestIssuerLight: return "\u{f564}"
        case .guestIssuerRegular: return "\u{f565}"
        case .guideBold: return "\u{f566}"
        case .guideLight: return "\u{f567}"
        case .guideRegular: return "\u{f568}"
        case .handlerBold: return "\u{f569}"
        case .handlerLight: return "\u{f56a}"
        case .handlerRegular: return "\u{f56b}"
        case .handsetAlertBold: return "\u{f56c}"
        case .handsetAlertFilled: return "\u{f56d}"
        case .handsetAlertLight: return "\u{f56e}"
        case .handsetAlertRegular: return "\u{f56f}"
        case .handsetBold: return "\u{f570}"
        case .handsetFilled: return "\u{f571}"
        case .handsetLight: return "\u{f572}"
        case .handsetMutedBold: return "\u{f573}"
        case .handsetMutedFilled: return "\u{f574}"
        case .handsetMutedLight: return "\u{f575}"
        case .handsetMutedRegular: return "\u{f576}"
        case .handsetRegular: return "\u{f577}"
        case .handshakeBold: return "\u{f578}"
        case .handshakeLight: return "\u{f579}"
        case .handshakeRegular: return "\u{f57a}"
        case .headingOneBold: return "\u{f57b}"
        case .headingOneLight: return "\u{f57c}"
        case .headingOneRegular: return "\u{f57d}"
        case .headingThreeBold: return "\u{f57e}"
        case .headingThreeLight: return "\u{f57f}"
        case .headingThreeRegular: return "\u{f580}"
        case .headingTwoBold: return "\u{f581}"
        case .headingTwoLight: return "\u{f582}"
        case .headingTwoRegular: return "\u{f583}"
        case .headphonesBold: return "\u{f584}"
        case .headphonesFilled: return "\u{f585}"
        case .headphonesLight: return "\u{f586}"
        case .headphonesMutedBold: return "\u{f587}"
        case .headphonesMutedFilled: return "\u{f588}"
        case .headphonesMutedLight: return "\u{f589}"
        case .headphonesMutedRegular: return "\u{f58a}"
        case .headphonesRegular: return "\u{f58b}"
        case .headsetAlertBold: return "\u{f58c}"
        case .headsetAlertLight: return "\u{f58d}"
        case .headsetAlertRegular: return "\u{f58e}"
        case .headsetBold: return "\u{f58f}"
        case .headsetFilled: return "\u{f590}"
        case .headsetLight: return "\u{f591}"
        case .headsetMutedBold: return "\u{f592}"
        case .headsetMutedLight: return "\u{f593}"
        case .headsetMutedRegular: return "\u{f594}"
        case .headsetPrivateBold: return "\u{f595}"
        case .headsetPrivateLight: return "\u{f596}"
        case .headsetPrivateRegular: return "\u{f597}"
        case .headsetRegular: return "\u{f598}"
        case .helpBold: return "\u{f599}"
        case .helpCircleActiveFilled: return "\u{f59a}"
        case .helpCircleBold: return "\u{f59b}"
        case .helpCircleLight: return "\u{f59c}"
        case .helpCircleRegular: return "\u{f59d}"
        case .helpLight: return "\u{f59e}"
        case .helpRegular: return "\u{f59f}"
        case .helpdeskBold: return "\u{f5a0}"
        case .helpdeskLight: return "\u{f5a1}"
        case .helpdeskRegular: return "\u{f5a2}"
        case .hideBold: return "\u{f5a3}"
        case .hideFilled: return "\u{f5a4}"
        case .hideLight: return "\u{f5a5}"
        case .hideRegular: return "\u{f5a6}"
        case .homeBold: return "\u{f5a7}"
        case .homeFilled: return "\u{f5a8}"
        case .homeLight: return "\u{f5a9}"
        case .homeRegular: return "\u{f5aa}"
        case .horizontalLineBold: return "\u{f5ab}"
        case .horizontalLineLight: return "\u{f5ac}"
        case .horizontalLineRegular: return "\u{f5ad}"
        case .hotelingBold: return "\u{f5ae}"
        case .hotelingFilled: return "\u{f5af}"
        case .hotelingLight: return "\u{f5b0}"
        case .hotelingRegular: return "\u{f5b1}"
        case .humidityBold: return "\u{f5b2}"
        case .humidityLight: return "\u{f5b3}"
        case .humidityRegular: return "\u{f5b4}"
        case .huntGroupBold: return "\u{f5b5}"
        case .huntGroupFilled: return "\u{f5b6}"
        case .huntGroupLight: return "\u{f5b7}"
        case .huntGroupRegular: return "\u{f5b8}"
        case .importBold: return "\u{f5b9}"
        case .importLight: return "\u{f5ba}"
        case .importRegular: return "\u{f5bb}"
        case .inCommonBold: return "\u{f5bc}"
        case .inCommonLight: return "\u{f5bd}"
        case .inCommonRegular: return "\u{f5be}"
        case .includeBold: return "\u{f5bf}"
        case .includeLight: return "\u{f5c0}"
        case .includeRegular: return "\u{f5c1}"
        case .incomingCallLegacyBold: return "\u{f5c2}"
        case .incomingCallLegacyFilled: return "\u{f5c3}"
        case .incomingCallLegacyLight: return "\u{f5c4}"
        case .incomingCallLegacyRegular: return "\u{f5c5}"
        case .infoBadgeFilled: return "\u{f5c6}"
        case .infoCircleBold: return "\u{f5c7}"
        case .infoCircleFilled: return "\u{f5c8}"
        case .infoCircleLight: return "\u{f5c9}"
        case .infoCircleRegular: return "\u{f5ca}"
        case .infoCircleTwoBold: return "\u{f5cb}"
        case .infoCircleTwoFilled: return "\u{f5cc}"
        case .infoCircleTwoLight: return "\u{f5cd}"
        case .infoCircleTwoRegular: return "\u{f5ce}"
        case .inputBold: return "\u{f5cf}"
        case .inputDisconnectedBold: return "\u{f5d0}"
        case .inputDisconnectedLight: return "\u{f5d1}"
        case .inputDisconnectedRegular: return "\u{f5d2}"
        case .inputLight: return "\u{f5d3}"
        case .inputRegular: return "\u{f5d4}"
        case .insightsBold: return "\u{f5d5}"
        case .insightsLight: return "\u{f5d6}"
        case .insightsRegular: return "\u{f5d7}"
        case .integrationsBold: return "\u{f5d8}"
        case .integrationsLight: return "\u{f5d9}"
        case .integrationsRegular: return "\u{f5da}"
        case .intelligentRoutingBold: return "\u{f5db}"
        case .intelligentRoutingLight: return "\u{f5dc}"
        case .intelligentRoutingRegular: return "\u{f5dd}"
        case .invitedUserBold: return "\u{f5de}"
        case .invitedUserLight: return "\u{f5df}"
        case .invitedUserRegular: return "\u{f5e0}"
        case .italicBold: return "\u{f5e1}"
        case .italicLight: return "\u{f5e2}"
        case .italicRegular: return "\u{f5e3}"
        case .joinAudioBold: return "\u{f5e4}"
        case .joinAudioFilled: return "\u{f5e5}"
        case .joinAudioLight: return "\u{f5e6}"
        case .joinAudioRegular: return "\u{f5e7}"
        case .keepInTouchBold: return "\u{f5e8}"
        case .keepInTouchFilled: return "\u{f5e9}"
        case .keepInTouchLight: return "\u{f5ea}"
        case .keepInTouchRegular: return "\u{f5eb}"
        case .keyboardBold: return "\u{f5ec}"
        case .keyboardCloseBold: return "\u{f5ed}"
        case .keyboardCloseLight: return "\u{f5ee}"
        case .keyboardCloseRegular: return "\u{f5ef}"
        case .keyboardLight: return "\u{f5f0}"
        case .keyboardRegular: return "\u{f5f1}"
        case .languageBold: return "\u{f5f2}"
        case .languageLight: return "\u{f5f3}"
        case .languageRegular: return "\u{f5f4}"
        case .laptopBold: return "\u{f5f5}"
        case .laptopDisconnectedBold: return "\u{f5f6}"
        case .laptopDisconnectedLight: return "\u{f5f7}"
        case .laptopDisconnectedRegular: return "\u{f5f8}"
        case .laptopFilled: return "\u{f5f9}"
        case .laptopLight: return "\u{f5fa}"
        case .laptopRegular: return "\u{f5fb}"
        case .laserPointerBold: return "\u{f5fc}"
        case .laserPointerLight: return "\u{f5fd}"
        case .laserPointerRegular: return "\u{f5fe}"
        case .launchBold: return "\u{f5ff}"
        case .launchLight: return "\u{f600}"
        case .launchRegular: return "\u{f601}"
        case .layoutSideBySideVerticalBold: return "\u{f602}"
        case .layoutSideBySideVerticalFilled: return "\u{f603}"
        case .layoutSideBySideVerticalLight: return "\u{f604}"
        case .layoutSideBySideVerticalRegular: return "\u{f605}"
        case .leaveBreakoutSessionBold: return "\u{f606}"
        case .leaveBreakoutSessionLight: return "\u{f607}"
        case .leaveBreakoutSessionRegular: return "\u{f608}"
        case .leaveDeviceBold: return "\u{f609}"
        case .leaveDeviceLight: return "\u{f60a}"
        case .leaveDeviceRegular: return "\u{f60b}"
        case .likeBold: return "\u{f60c}"
        case .likeFilled: return "\u{f60d}"
        case .likeLight: return "\u{f60e}"
        case .likeRegular: return "\u{f60f}"
        case .linkBold: return "\u{f610}"
        case .linkLight: return "\u{f611}"
        case .linkRegular: return "\u{f612}"
        case .listBulletedBold: return "\u{f613}"
        case .listBulletedLight: return "\u{f614}"
        case .listBulletedRegular: return "\u{f615}"
        case .listMenuBold: return "\u{f616}"
        case .listMenuLight: return "\u{f617}"
        case .listMenuRegular: return "\u{f618}"
        case .listNumberedBold: return "\u{f619}"
        case .listNumberedLight: return "\u{f61a}"
        case .listNumberedRegular: return "\u{f61b}"
        case .locationBold: return "\u{f61c}"
        case .locationFilled: return "\u{f61d}"
        case .locationLight: return "\u{f61e}"
        case .locationRegular: return "\u{f61f}"
        case .longTextBoxBold: return "\u{f620}"
        case .longTextBoxLight: return "\u{f621}"
        case .longTextBoxRegular: return "\u{f622}"
        case .lowerHandBold: return "\u{f623}"
        case .lowerHandLight: return "\u{f624}"
        case .lowerHandRegular: return "\u{f625}"
        case .magicPenBold: return "\u{f626}"
        case .magicPenFilled: return "\u{f627}"
        case .magicPenLight: return "\u{f628}"
        case .magicPenRegular: return "\u{f629}"
        case .markAsUnreadBold: return "\u{f62a}"
        case .markAsUnreadLight: return "\u{f62b}"
        case .markAsUnreadRegular: return "\u{f62c}"
        case .markdownBold: return "\u{f62d}"
        case .markdownLight: return "\u{f62e}"
        case .markdownRegular: return "\u{f62f}"
        case .markerBold: return "\u{f630}"
        case .markerFilled: return "\u{f631}"
        case .markerLight: return "\u{f632}"
        case .markerRegular: return "\u{f633}"
        case .maximizeBold: return "\u{f634}"
        case .maximizeLight: return "\u{f635}"
        case .maximizeRegular: return "\u{f636}"
        case .mediaPlayerBold: return "\u{f637}"
        case .mediaPlayerLight: return "\u{f638}"
        case .mediaPlayerRegular: return "\u{f639}"
        case .mediaQualityGoodBold: return "\u{f63a}"
        case .mediaQualityGoodFilled: return "\u{f63b}"
        case .mediaQualityGoodLight: return "\u{f63c}"
        case .mediaQualityGoodRegular: return "\u{f63d}"
        case .mediaQualityPoorBold: return "\u{f63e}"
        case .mediaQualityPoorFilled: return "\u{f63f}"
        case .mediaQualityPoorLight: return "\u{f640}"
        case .mediaQualityPoorRegular: return "\u{f641}"
        case .mediaQualityUnstableBold: return "\u{f642}"
        case .mediaQualityUnstableFilled: return "\u{f643}"
        case .mediaQualityUnstableLight: return "\u{f644}"
        case .mediaQualityUnstableRegular: return "\u{f645}"
        case .mediumQualityGoodFilled: return "\u{f646}"
        case .mediumQualityPoorFilled: return "\u{f647}"
        case .mediumQualityUnstableFilled: return "\u{f648}"
        case .meetBold: return "\u{f649}"
        case .meetEndBold: return "\u{f64a}"
        case .meetEndLight: return "\u{f64b}"
        case .meetEndRegular: return "\u{f64c}"
        case .meetFilled: return "\u{f64d}"
        case .meetLight: return "\u{f64e}"
        case .meetRegular: return "\u{f64f}"
        case .meetingsBold: return "\u{f650}"
        case .meetingsFilled: return "\u{f651}"
        case .meetingsFocusMonthBold: return "\u{f652}"
        case .meetingsFocusMonthLight: return "\u{f653}"
        case .meetingsFocusMonthRegular: return "\u{f654}"
        case .meetingsFocusOneDayBold: return "\u{f655}"
        case .meetingsFocusOneDayLight: return "\u{f656}"
        case .meetingsFocusOneDayRegular: return "\u{f657}"
        case .meetingsFocusThreeDayBold: return "\u{f658}"
        case .meetingsFocusThreeDayLight: return "\u{f659}"
        case .meetingsFocusThreeDayRegular: return "\u{f65a}"
        case .meetingsFocusUpcomingBold: return "\u{f65b}"
        case .meetingsFocusUpcomingLight: return "\u{f65c}"
        case .meetingsFocusUpcomingRegular: return "\u{f65d}"
        case .meetingsFocusWeekBold: return "\u{f65e}"
        case .meetingsFocusWeekLight: return "\u{f65f}"
        case .meetingsFocusWeekRegular: return "\u{f660}"
        case .meetingsLight: return "\u{f661}"
        case .meetingsPresenceBold: return "\u{f662}"
        case .meetingsPresenceFilled: return "\u{f663}"
        case .meetingsPresenceLight: return "\u{f664}"
        case .meetingsPresenceRegular: return "\u{f665}"
        case .meetingsPresenceSmallFilled: return "\u{f666}"
        case .meetingsRegular: return "\u{f667}"
        case .meetingsTeamActiveBold: return "\u{f668}"
        case .meetingsTeamActiveLight: return "\u{f669}"
        case .meetingsTeamActiveRegular: return "\u{f66a}"
        case .meetingsTeamBold: return "\u{f66b}"
        case .meetingsTeamLight: return "\u{f66c}"
        case .meetingsTeamNewBold: return "\u{f66d}"
        case .meetingsTeamNewLight: return "\u{f66e}"
        case .meetingsTeamNewRegular: return "\u{f66f}"
        case .meetingsTeamRegular: return "\u{f670}"
        case .mentionBold: return "\u{f671}"
        case .mentionLight: return "\u{f672}"
        case .mentionRegular: return "\u{f673}"
        case .messageQueingBold: return "\u{f674}"
        case .messageQueingLight: return "\u{f675}"
        case .messageQueingRegular: return "\u{f676}"
        case .microphoneBold: return "\u{f677}"
        case .microphoneFilled: return "\u{f678}"
        case .microphoneHardMutedBold: return "\u{f679}"
        case .microphoneHardMutedColoredBold: return "\u{f67a}"
        case .microphoneHardMutedColoredLight: return "\u{f67b}"
        case .microphoneHardMutedColoredRegular: return "\u{f67c}"
        case .microphoneHardMutedLight: return "\u{f67d}"
        case .microphoneHardMutedRegular: return "\u{f67e}"
        case .microphoneLight: return "\u{f67f}"
        case .microphoneMusicModeColoredBold: return "\u{f680}"
        case .microphoneMusicModeColoredLight: return "\u{f681}"
        case .microphoneMusicModeColoredRegular: return "\u{f682}"
        case .microphoneMutedBold: return "\u{f683}"
        case .microphoneMutedFilled: return "\u{f684}"
        case .microphoneMutedIndicatorFilled: return "\u{f685}"
        case .microphoneMutedLight: return "\u{f686}"
        case .microphoneMutedRedBold: return "\u{f687}"
        case .microphoneMutedRedFilled: return "\u{f688}"
        case .microphoneMutedRedLight: return "\u{f689}"
        case .microphoneMutedRedRegular: return "\u{f68a}"
        case .microphoneMutedRegular: return "\u{f68b}"
        case .microphoneRegular: return "\u{f68c}"
        case .minimizeBold: return "\u{f68d}"
        case .minimizeLight: return "\u{f68e}"
        case .minimizeRegular: return "\u{f68f}"
        case .minusBold: return "\u{f690}"
        case .minusLight: return "\u{f691}"
        case .minusRegular: return "\u{f692}"
        case .mirrorBold: return "\u{f693}"
        case .mirrorFilled: return "\u{f694}"
        case .mirrorLight: return "\u{f695}"
        case .mirrorRegular: return "\u{f696}"
        case .moderatorBold: return "\u{f697}"
        case .moderatorLight: return "\u{f698}"
        case .moderatorRegular: return "\u{f699}"
        case .monitoringBold: return "\u{f69a}"
        case .monitoringLight: return "\u{f69b}"
        case .monitoringRegular: return "\u{f69c}"
        case .monthlyRecurringScheduleNodeBold: return "\u{f69d}"
        case .monthlyRecurringScheduleNodeLight: return "\u{f69e}"
        case .monthlyRecurringScheduleNodeRegular: return "\u{f69f}"
        case .moreAdrBold: return "\u{f6a0}"
        case .moreAdrLight: return "\u{f6a1}"
        case .moreAdrRegular: return "\u{f6a2}"
        case .moreBold: return "\u{f6a3}"
        case .moreCircleBold: return "\u{f6a4}"
        case .moreCircleFilled: return "\u{f6a5}"
        case .moreCircleLight: return "\u{f6a6}"
        case .moreCircleRegular: return "\u{f6a7}"
        case .moreCirecleFilled: return "\u{f6a8}"
        case .moreLight: return "\u{f6a9}"
        case .moreRegular: return "\u{f6aa}"
        case .mouseCursorBold: return "\u{f6ab}"
        case .mouseCursorLight: return "\u{f6ac}"
        case .mouseCursorRegular: return "\u{f6ad}"
        case .moveCallInAdrBold: return "\u{f6ae}"
        case .moveCallInAdrLight: return "\u{f6af}"
        case .moveCallInAdrRegular: return "\u{f6b0}"
        case .moveCallInIphBold: return "\u{f6b1}"
        case .moveCallInIphLight: return "\u{f6b2}"
        case .moveCallInIphRegular: return "\u{f6b3}"
        case .moveCallInLaptopBold: return "\u{f6b4}"
        case .moveCallInLaptopLight: return "\u{f6b5}"
        case .moveCallInLaptopRegular: return "\u{f6b6}"
        case .moveCallInOutAdrBold: return "\u{f6b7}"
        case .moveCallInOutAdrLight: return "\u{f6b8}"
        case .moveCallInOutAdrRegular: return "\u{f6b9}"
        case .moveCallInOutIphBold: return "\u{f6ba}"
        case .moveCallInOutIphLight: return "\u{f6bb}"
        case .moveCallInOutIphRegular: return "\u{f6bc}"
        case .moveCallInTabletBold: return "\u{f6bd}"
        case .moveCallInTabletLight: return "\u{f6be}"
        case .moveCallInTabletRegular: return "\u{f6bf}"
        case .moveCallOutAdrBold: return "\u{f6c0}"
        case .moveCallOutAdrLight: return "\u{f6c1}"
        case .moveCallOutAdrRegular: return "\u{f6c2}"
        case .moveCallOutIphBold: return "\u{f6c3}"
        case .moveCallOutIphLight: return "\u{f6c4}"
        case .moveCallOutIphRegular: return "\u{f6c5}"
        case .moveCallOutLaptopBold: return "\u{f6c6}"
        case .moveCallOutLaptopLight: return "\u{f6c7}"
        case .moveCallOutLaptopRegular: return "\u{f6c8}"
        case .moveCallOutTabletBold: return "\u{f6c9}"
        case .moveCallOutTabletLight: return "\u{f6ca}"
        case .moveCallOutTabletRegular: return "\u{f6cb}"
        case .msTeams: return "\u{f6cc}"
        case .multilineChartBold: return "\u{f6cd}"
        case .multilineChartFilled: return "\u{f6ce}"
        case .multilineChartLight: return "\u{f6cf}"
        case .multilineChartRegular: return "\u{f6d0}"
        case .multimediaBold: return "\u{f6d1}"
        case .multimediaFilled: return "\u{f6d2}"
        case .multimediaLight: return "\u{f6d3}"
        case .multimediaRegular: return "\u{f6d4}"
        case .multipledDevicesBold: return "\u{f6d5}"
        case .multipledDevicesLight: return "\u{f6d6}"
        case .multipledDevicesRegular: return "\u{f6d7}"
        case .musicModeBold: return "\u{f6d8}"
        case .musicModeCircleBold: return "\u{f6d9}"
        case .musicModeCircleFilled: return "\u{f6da}"
        case .musicModeCircleLight: return "\u{f6db}"
        case .musicModeCircleRegular: return "\u{f6dc}"
        case .musicModeFilled: return "\u{f6dd}"
        case .musicModeLight: return "\u{f6de}"
        case .musicModeRegular: return "\u{f6df}"
        case .muteOnEntryBold: return "\u{f6e0}"
        case .muteOnEntryFilled: return "\u{f6e1}"
        case .muteOnEntryLight: return "\u{f6e2}"
        case .muteOnEntryRegular: return "\u{f6e3}"
        case .newManagerBold: return "\u{f6e4}"
        case .newManagerLight: return "\u{f6e5}"
        case .newManagerRegular: return "\u{f6e6}"
        case .newTitleBold: return "\u{f6e7}"
        case .newTitleLight: return "\u{f6e8}"
        case .newTitleRegular: return "\u{f6e9}"
        case .newVoicemailBold: return "\u{f6ea}"
        case .newVoicemailLight: return "\u{f6eb}"
        case .newVoicemailRegular: return "\u{f6ec}"
        case .newWhiteboardBold: return "\u{f6ed}"
        case .newWhiteboardLight: return "\u{f6ee}"
        case .newWhiteboardRegular: return "\u{f6ef}"
        case .nextBold: return "\u{f6f0}"
        case .nextLight: return "\u{f6f1}"
        case .nextRegular: return "\u{f6f2}"
        case .noDevicesBold: return "\u{f6f3}"
        case .noDevicesLight: return "\u{f6f4}"
        case .noDevicesRegular: return "\u{f6f5}"
        case .noiseDetectedCanceledFilled: return "\u{f6f6}"
        case .noiseDetectedFilled: return "\u{f6f7}"
        case .noiseNoneCanceledFilled: return "\u{f6f8}"
        case .noiseNoneFilled: return "\u{f6f9}"
        case .noiseRemovalBold: return "\u{f6fa}"
        case .noiseRemovalLight: return "\u{f6fb}"
        case .noiseRemovalRegular: return "\u{f6fc}"
        case .noteBold: return "\u{f6fd}"
        case .noteLight: return "\u{f6fe}"
        case .notePptBold: return "\u{f6ff}"
        case .notePptLight: return "\u{f700}"
        case .notePptRegular: return "\u{f701}"
        case .noteRegular: return "\u{f702}"
        case .notesBold: return "\u{f703}"
        case .notesLight: return "\u{f704}"
        case .notesRegular: return "\u{f705}"
        case .numberBold: return "\u{f706}"
        case .numberLight: return "\u{f707}"
        case .numberRegular: return "\u{f708}"
        case .oldRemoteBold: return "\u{f709}"
        case .oldRemoteLight: return "\u{f70a}"
        case .oldRemoteRegular: return "\u{f70b}"
        case .oldTouchBold: return "\u{f70c}"
        case .oldTouchLight: return "\u{f70d}"
        case .oldTouchRegular: return "\u{f70e}"
        case .oneColumnBold: return "\u{f70f}"
        case .oneColumnLight: return "\u{f710}"
        case .oneColumnRegular: return "\u{f711}"
        case .openInFolderBold: return "\u{f712}"
        case .openInFolderLight: return "\u{f713}"
        case .openInFolderRegular: return "\u{f714}"
        case .openPagesBold: return "\u{f715}"
        case .openPagesLight: return "\u{f716}"
        case .openPagesRegular: return "\u{f717}"
        case .otherNumberBold: return "\u{f718}"
        case .otherNumberLight: return "\u{f719}"
        case .otherNumberRegular: return "\u{f71a}"
        case .otherNumberWarningBold: return "\u{f71b}"
        case .otherNumberWarningLight: return "\u{f71c}"
        case .otherNumberWarningRegular: return "\u{f71d}"
        case .outgoingCallLegacyBold: return "\u{f71e}"
        case .outgoingCallLegacyLight: return "\u{f71f}"
        case .outgoingCallLegacyRegular: return "\u{f720}"
        case .overflowLeftBold: return "\u{f721}"
        case .overflowLeftLight: return "\u{f722}"
        case .overflowLeftRegular: return "\u{f723}"
        case .overflowRightBold: return "\u{f724}"
        case .overflowRightLight: return "\u{f725}"
        case .overflowRightRegular: return "\u{f726}"
        case .pairedCameraBold: return "\u{f727}"
        case .pairedCameraLight: return "\u{f728}"
        case .pairedCameraRegular: return "\u{f729}"
        case .pairedDeviceBold: return "\u{f72a}"
        case .pairedDeviceLight: return "\u{f72b}"
        case .pairedDeviceRegular: return "\u{f72c}"
        case .pairedHandsetBold: return "\u{f72d}"
        case .pairedHandsetLight: return "\u{f72e}"
        case .pairedHandsetRegular: return "\u{f72f}"
        case .pairingBold: return "\u{f730}"
        case .pairingLight: return "\u{f731}"
        case .pairingRegular: return "\u{f732}"
        case .parkedBold: return "\u{f733}"
        case .parkedFilled: return "\u{f734}"
        case .parkedLight: return "\u{f735}"
        case .parkedRegular: return "\u{f736}"
        case .parseBold: return "\u{f737}"
        case .parseLight: return "\u{f738}"
        case .parseRegular: return "\u{f739}"
        case .partialBold: return "\u{f73a}"
        case .partialLight: return "\u{f73b}"
        case .partialRegular: return "\u{f73c}"
        case .participantAddBold: return "\u{f73d}"
        case .participantAddLight: return "\u{f73e}"
        case .participantAddRegular: return "\u{f73f}"
        case .participantBlockedBold: return "\u{f740}"
        case .participantBlockedLight: return "\u{f741}"
        case .participantBlockedRegular: return "\u{f742}"
        case .participantBold: return "\u{f743}"
        case .participantFilled: return "\u{f744}"
        case .participantLight: return "\u{f745}"
        case .participantListBold: return "\u{f746}"
        case .participantListFilled: return "\u{f747}"
        case .participantListLight: return "\u{f748}"
        case .participantListRegular: return "\u{f749}"
        case .participantRegular: return "\u{f74a}"
        case .participantRemoveBold: return "\u{f74b}"
        case .participantRemoveLight: return "\u{f74c}"
        case .participantRemoveRegular: return "\u{f74d}"
        case .participantUnknownBold: return "\u{f74e}"
        case .participantUnknownLight: return "\u{f74f}"
        case .participantUnknownRegular: return "\u{f750}"
        case .passMouseBold: return "\u{f751}"
        case .passMouseLight: return "\u{f752}"
        case .passMouseRegular: return "\u{f753}"
        case .pauseBold: return "\u{f754}"
        case .pauseFilled: return "\u{f755}"
        case .pauseLight: return "\u{f756}"
        case .pauseRegular: return "\u{f757}"
        case .penBold: return "\u{f758}"
        case .penFilled: return "\u{f759}"
        case .penLight: return "\u{f75a}"
        case .penRegular: return "\u{f75b}"
        case .peopleBold: return "\u{f75c}"
        case .peopleCircleBold: return "\u{f75d}"
        case .peopleCircleFilled: return "\u{f75e}"
        case .peopleCircleLight: return "\u{f75f}"
        case .peopleCircleRegular: return "\u{f760}"
        case .peopleFilled: return "\u{f761}"
        case .peopleInsightsFilled: return "\u{f762}"
        case .peopleLight: return "\u{f763}"
        case .peopleRegular: return "\u{f764}"
        case .phoneAlertBold: return "\u{f765}"
        case .phoneAlertLight: return "\u{f766}"
        case .phoneAlertRegular: return "\u{f767}"
        case .phoneBold: return "\u{f768}"
        case .phoneFilled: return "\u{f769}"
        case .phoneLight: return "\u{f76a}"
        case .phoneMutedBold: return "\u{f76b}"
        case .phoneMutedLight: return "\u{f76c}"
        case .phoneMutedRegular: return "\u{f76d}"
        case .phonePrivateBold: return "\u{f76e}"
        case .phonePrivateLight: return "\u{f76f}"
        case .phonePrivateRegular: return "\u{f770}"
        case .phoneRegular: return "\u{f771}"
        case .phoneReplyAllBold: return "\u{f772}"
        case .phoneReplyAllLight: return "\u{f773}"
        case .phoneReplyAllRegular: return "\u{f774}"
        case .phoneReplyBold: return "\u{f775}"
        case .phoneReplyLight: return "\u{f776}"
        case .phoneReplyRegular: return "\u{f777}"
        case .phoneSmallFilled: return "\u{f778}"
        case .pickerBold: return "\u{f779}"
        case .pickerLight: return "\u{f77a}"
        case .pickerRegular: return "\u{f77b}"
        case .pictureInPictureBold: return "\u{f77c}"
        case .pictureInPictureFilled: return "\u{f77d}"
        case .pictureInPictureLight: return "\u{f77e}"
        case .pictureInPictureRegular: return "\u{f77f}"
        case .pieChartBold: return "\u{f780}"
        case .pieChartFilled: return "\u{f781}"
        case .pieChartLight: return "\u{f782}"
        case .pieChartRegular: return "\u{f783}"
        case .pinBold: return "\u{f784}"
        case .pinFilled: return "\u{f785}"
        case .pinLight: return "\u{f786}"
        case .pinListActivityBold: return "\u{f787}"
        case .pinListActivityColoredBold: return "\u{f788}"
        case .pinListActivityColoredLight: return "\u{f789}"
        case .pinListActivityColoredRegular: return "\u{f78a}"
        case .pinListActivityLight: return "\u{f78b}"
        case .pinListActivityRegular: return "\u{f78c}"
        case .pinListBold: return "\u{f78d}"
        case .pinListLight: return "\u{f78e}"
        case .pinListRegular: return "\u{f78f}"
        case .pinMutedBold: return "\u{f790}"
        case .pinMutedFilled: return "\u{f791}"
        case .pinMutedLight: return "\u{f792}"
        case .pinMutedRegular: return "\u{f793}"
        case .pinRegular: return "\u{f794}"
        case .placeholderBold: return "\u{f795}"
        case .placeholderLight: return "\u{f796}"
        case .placeholderRegular: return "\u{f797}"
        case .playBold: return "\u{f798}"
        case .playCircleBold: return "\u{f799}"
        case .playCircleFilled: return "\u{f79a}"
        case .playCircleLight: return "\u{f79b}"
        case .playCircleRegular: return "\u{f79c}"
        case .playFilled: return "\u{f79d}"
        case .playLight: return "\u{f79e}"
        case .playRegular: return "\u{f79f}"
        case .plugAcBold: return "\u{f7a0}"
        case .plugAcLight: return "\u{f7a1}"
        case .plugAcRegular: return "\u{f7a2}"
        case .plusBold: return "\u{f7a3}"
        case .plusCircleBold: return "\u{f7a4}"
        case .plusCircleFilled: return "\u{f7a5}"
        case .plusCircleLight: return "\u{f7a6}"
        case .plusCircleRegular: return "\u{f7a7}"
        case .plusLight: return "\u{f7a8}"
        case .plusRegular: return "\u{f7a9}"
        case .pmrBold: return "\u{f7aa}"
        case .pmrFilled: return "\u{f7ab}"
        case .pmrLight: return "\u{f7ac}"
        case .pmrRegular: return "\u{f7ad}"
        case .pollBold: return "\u{f7ae}"
        case .pollLight: return "\u{f7af}"
        case .pollRegular: return "\u{f7b0}"
        case .popInBold: return "\u{f7b1}"
        case .popInLight: return "\u{f7b2}"
        case .popInRegular: return "\u{f7b3}"
        case .popOutBold: return "\u{f7b4}"
        case .popOutLight: return "\u{f7b5}"
        case .popOutRegular: return "\u{f7b6}"
        case .popUpBold: return "\u{f7b7}"
        case .popUpLight: return "\u{f7b8}"
        case .popUpRegular: return "\u{f7b9}"
        case .portraitLandscapeBold: return "\u{f7ba}"
        case .portraitLandscapeLight: return "\u{f7bb}"
        case .portraitLandscapeRegular: return "\u{f7bc}"
        case .powerAcBold: return "\u{f7bd}"
        case .powerAcLight: return "\u{f7be}"
        case .powerAcRegular: return "\u{f7bf}"
        case .powerBold: return "\u{f7c0}"
        case .powerLight: return "\u{f7c1}"
        case .powerRegular: return "\u{f7c2}"
        case .preHeaderBold: return "\u{f7c3}"
        case .preHeaderLight: return "\u{f7c4}"
        case .preHeaderRegular: return "\u{f7c5}"
        case .presentationBold: return "\u{f7c6}"
        case .presentationLight: return "\u{f7c7}"
        case .presentationRegular: return "\u{f7c8}"
        case .primaryParticipantBold: return "\u{f7c9}"
        case .primaryParticipantLight: return "\u{f7ca}"
        case .primaryParticipantRegular: return "\u{f7cb}"
        case .printBold: return "\u{f7cc}"
        case .printLight: return "\u{f7cd}"
        case .printRegular: return "\u{f7ce}"
        case .priorityBadgeFilled: return "\u{f7cf}"
        case .priorityCircleBold: return "\u{f7d0}"
        case .priorityCircleFilled: return "\u{f7d1}"
        case .priorityCircleLight: return "\u{f7d2}"
        case .priorityCircleRegular: return "\u{f7d3}"
        case .priorityCircleTwoBold: return "\u{f7d4}"
        case .priorityCircleTwoFilled: return "\u{f7d5}"
        case .priorityCircleTwoLight: return "\u{f7d6}"
        case .priorityCircleTwoRegular: return "\u{f7d7}"
        case .privacyCircleBold: return "\u{f7d8}"
        case .privacyCircleFilled: return "\u{f7d9}"
        case .privacyCircleLight: return "\u{f7da}"
        case .privacyCircleRegular: return "\u{f7db}"
        case .privateBold: return "\u{f7dc}"
        case .privateCircleBold: return "\u{f7dd}"
        case .privateCircleFilled: return "\u{f7de}"
        case .privateCircleLight: return "\u{f7df}"
        case .privateCircleRegular: return "\u{f7e0}"
        case .privateLight: return "\u{f7e1}"
        case .privateMeetingBold: return "\u{f7e2}"
        case .privateMeetingLight: return "\u{f7e3}"
        case .privateMeetingRegular: return "\u{f7e4}"
        case .privateRegular: return "\u{f7e5}"
        case .productDemoBold: return "\u{f7e6}"
        case .productDemoLight: return "\u{f7e7}"
        case .productDemoRegular: return "\u{f7e8}"
        case .proximityBold: return "\u{f7e9}"
        case .proximityLight: return "\u{f7ea}"
        case .proximityMutedBold: return "\u{f7eb}"
        case .proximityMutedLight: return "\u{f7ec}"
        case .proximityMutedRegular: return "\u{f7ed}"
        case .proximityRegular: return "\u{f7ee}"
        case .proximityVideoBold: return "\u{f7ef}"
        case .proximityVideoLight: return "\u{f7f0}"
        case .proximityVideoRegular: return "\u{f7f1}"
        case .ptoPresenceBold: return "\u{f7f2}"
        case .ptoPresenceFilled: return "\u{f7f3}"
        case .ptoPresenceLight: return "\u{f7f4}"
        case .ptoPresenceRegular: return "\u{f7f5}"
        case .pullCallBold: return "\u{f7f6}"
        case .pullCallLight: return "\u{f7f7}"
        case .pullCallRegular: return "\u{f7f8}"
        case .qABold: return "\u{f7f9}"
        case .qALight: return "\u{f7fa}"
        case .qARegular: return "\u{f7fb}"
        case .qualityBold: return "\u{f7fc}"
        case .qualityLight: return "\u{f7fd}"
        case .qualityRegular: return "\u{f7fe}"
        case .queueContactBold: return "\u{f7ff}"
        case .queueContactLight: return "\u{f800}"
        case .queueContactRegular: return "\u{f801}"
        case .quietBold: return "\u{f802}"
        case .quietHoursPresenceBold: return "\u{f803}"
        case .quietHoursPresenceFilled: return "\u{f804}"
        case .quietHoursPresenceLight: return "\u{f805}"
        case .quietHoursPresenceRegular: return "\u{f806}"
        case .quietLight: return "\u{f807}"
        case .quietRegular: return "\u{f808}"
        case .radioButtonGroupBold: return "\u{f809}"
        case .radioButtonGroupLight: return "\u{f80a}"
        case .radioButtonGroupRegular: return "\u{f80b}"
        case .raiseHandBold: return "\u{f80c}"
        case .raiseHandFilled: return "\u{f80d}"
        case .raiseHandLight: return "\u{f80e}"
        case .raiseHandRegular: return "\u{f80f}"
        case .ramBold: return "\u{f810}"
        case .ramLight: return "\u{f811}"
        case .ramRegular: return "\u{f812}"
        case .reactionsBold: return "\u{f813}"
        case .reactionsFilled: return "\u{f814}"
        case .reactionsLight: return "\u{f815}"
        case .reactionsRegular: return "\u{f816}"
        case .reactivateBold: return "\u{f817}"
        case .reactivateLight: return "\u{f818}"
        case .reactivateRegular: return "\u{f819}"
        case .recentsBold: return "\u{f81a}"
        case .recentsFilled: return "\u{f81b}"
        case .recentsLight: return "\u{f81c}"
        case .recentsPresenceBold: return "\u{f81d}"
        case .recentsPresenceFilled: return "\u{f81e}"
        case .recentsPresenceLight: return "\u{f81f}"
        case .recentsPresenceRegular: return "\u{f820}"
        case .recentsPresenceSmallFilled: return "\u{f821}"
        case .recentsRegular: return "\u{f822}"
        case .recordActiveBold: return "\u{f823}"
        case .recordActiveFilled: return "\u{f824}"
        case .recordActiveLight: return "\u{f825}"
        case .recordActiveRegular: return "\u{f826}"
        case .recordBold: return "\u{f827}"
        case .recordFilled: return "\u{f828}"
        case .recordLight: return "\u{f829}"
        case .recordPausedBold: return "\u{f82a}"
        case .recordPausedFilled: return "\u{f82b}"
        case .recordPausedLight: return "\u{f82c}"
        case .recordPausedRegular: return "\u{f82d}"
        case .recordRegular: return "\u{f82e}"
        case .recurringBold: return "\u{f82f}"
        case .recurringLight: return "\u{f830}"
        case .recurringOffBold: return "\u{f831}"
        case .recurringOffLight: return "\u{f832}"
        case .recurringOffRegular: return "\u{f833}"
        case .recurringRegular: return "\u{f834}"
        case .redialBold: return "\u{f835}"
        case .redialLight: return "\u{f836}"
        case .redialRegular: return "\u{f837}"
        case .redoBold: return "\u{f838}"
        case .redoLight: return "\u{f839}"
        case .redoRegular: return "\u{f83a}"
        case .refreshBold: return "\u{f83b}"
        case .refreshLight: return "\u{f83c}"
        case .refreshRegular: return "\u{f83d}"
        case .remoteCallBold: return "\u{f83e}"
        case .remoteCallFilled: return "\u{f83f}"
        case .remoteCallLight: return "\u{f840}"
        case .remoteCallRegular: return "\u{f841}"
        case .remoteDesktopControlBold: return "\u{f842}"
        case .remoteDesktopControlFilled: return "\u{f843}"
        case .remoteDesktopControlLight: return "\u{f844}"
        case .remoteDesktopControlRegular: return "\u{f845}"
        case .removeBold: return "\u{f846}"
        case .removeFilled: return "\u{f847}"
        case .removeLight: return "\u{f848}"
        case .removeRegular: return "\u{f849}"
        case .replyBold: return "\u{f84a}"
        case .replyFilled: return "\u{f84b}"
        case .replyLight: return "\u{f84c}"
        case .replyListBold: return "\u{f84d}"
        case .replyListLight: return "\u{f84e}"
        case .replyListRegular: return "\u{f84f}"
        case .replyPrivatelyBold: return "\u{f850}"
        case .replyPrivatelyLight: return "\u{f851}"
        case .replyPrivatelyRegular: return "\u{f852}"
        case .replyRegular: return "\u{f853}"
        case .resetBold: return "\u{f854}"
        case .resetLight: return "\u{f855}"
        case .resetRegular: return "\u{f856}"
        case .responsiveMobileBold: return "\u{f857}"
        case .responsiveMobileLight: return "\u{f858}"
        case .responsiveMobileRegular: return "\u{f859}"
        case .restartBold: return "\u{f85a}"
        case .restartLight: return "\u{f85b}"
        case .restartRegular: return "\u{f85c}"
        case .retrieveCallBold: return "\u{f85d}"
        case .retrieveCallLight: return "\u{f85e}"
        case .retrieveCallRegular: return "\u{f85f}"
        case .returnBold: return "\u{f860}"
        case .returnLight: return "\u{f861}"
        case .returnRegular: return "\u{f862}"
        case .ringtoneBold: return "\u{f863}"
        case .ringtoneLight: return "\u{f864}"
        case .ringtoneRegular: return "\u{f865}"
        case .roomCalendarBold: return "\u{f866}"
        case .roomCalendarLight: return "\u{f867}"
        case .roomCalendarRegular: return "\u{f868}"
        case .roomLightsBold: return "\u{f869}"
        case .roomLightsFilled: return "\u{f86a}"
        case .roomLightsLight: return "\u{f86b}"
        case .roomLightsRegular: return "\u{f86c}"
        case .rotateContentBold: return "\u{f86d}"
        case .rotateContentFilled: return "\u{f86e}"
        case .rotateContentLight: return "\u{f86f}"
        case .rotateContentRegular: return "\u{f870}"
        case .ruleBasedBold: return "\u{f871}"
        case .ruleBasedLight: return "\u{f872}"
        case .ruleBasedRegular: return "\u{f873}"
        case .runningApplicationBold: return "\u{f874}"
        case .runningApplicationFilled: return "\u{f875}"
        case .runningApplicationLight: return "\u{f876}"
        case .runningApplicationRegular: return "\u{f877}"
        case .saveBold: return "\u{f878}"
        case .saveLight: return "\u{f879}"
        case .saveRegular: return "\u{f87a}"
        case .scanBold: return "\u{f87b}"
        case .scanLight: return "\u{f87c}"
        case .scanRegular: return "\u{f87d}"
        case .schedulerAvailableBold: return "\u{f87e}"
        case .schedulerAvailableLight: return "\u{f87f}"
        case .schedulerAvailableRegular: return "\u{f880}"
        case .schedulerNotWorkingHoursBold: return "\u{f881}"
        case .schedulerNotWorkingHoursLight: return "\u{f882}"
        case .schedulerNotWorkingHoursRegular: return "\u{f883}"
        case .schedulerUnavailableBold: return "\u{f884}"
        case .schedulerUnavailableLight: return "\u{f885}"
        case .schedulerUnavailableRegular: return "\u{f886}"
        case .schedulerUnknownBold: return "\u{f887}"
        case .schedulerUnknownLight: return "\u{f888}"
        case .schedulerUnknownRegular: return "\u{f889}"
        case .screenshotBold: return "\u{f88a}"
        case .screenshotDocBold: return "\u{f88b}"
        case .screenshotDocFilled: return "\u{f88c}"
        case .screenshotDocLight: return "\u{f88d}"
        case .screenshotDocRegular: return "\u{f88e}"
        case .screenshotLight: return "\u{f88f}"
        case .screenshotRegular: return "\u{f890}"
        case .searchBold: return "\u{f891}"
        case .searchFilled: return "\u{f892}"
        case .searchLight: return "\u{f893}"
        case .searchRegular: return "\u{f894}"
        case .secondaryArrowBold: return "\u{f895}"
        case .secondaryArrowLight: return "\u{f896}"
        case .secondaryArrowRegular: return "\u{f897}"
        case .secureCallLockBold: return "\u{f898}"
        case .secureCallLockFilled: return "\u{f899}"
        case .secureCallLockLight: return "\u{f89a}"
        case .secureCallLockRegular: return "\u{f89b}"
        case .secureCallShieldBold: return "\u{f89c}"
        case .secureCallShieldFilled: return "\u{f89d}"
        case .secureCallShieldLight: return "\u{f89e}"
        case .secureCallShieldRegular: return "\u{f89f}"
        case .secureCircleBold: return "\u{f8a0}"
        case .secureCircleFilled: return "\u{f8a1}"
        case .secureCircleLight: return "\u{f8a2}"
        case .secureCircleRegular: return "\u{f8a3}"
        case .secureLockBold: return "\u{f8a4}"
        case .secureLockFilled: return "\u{f8a5}"
        case .secureLockLight: return "\u{f8a6}"
        case .secureLockRegular: return "\u{f8a7}"
        case .selectAllBold: return "\u{f8a8}"
        case .selectAllFilled: return "\u{f8a9}"
        case .selectAllLight: return "\u{f8aa}"
        case .selectAllRegular: return "\u{f8ab}"
        case .selectionBold: return "\u{f8ac}"
        case .selectionLight: return "\u{f8ad}"
        case .selectionRegular: return "\u{f8ae}"
        case .sendBold: return "\u{f8af}"
        case .sendFilled: return "\u{f8b0}"
        case .sendLight: return "\u{f8b1}"
        case .sendRegular: return "\u{f8b2}"
        case .serverBold: return "\u{f8b3}"
        case .serverErrorBold: return "\u{f8b4}"
        case .serverErrorLight: return "\u{f8b5}"
        case .serverErrorRegular: return "\u{f8b6}"
        case .serverLight: return "\u{f8b7}"
        case .serverRegular: return "\u{f8b8}"
        case .servicesBold: return "\u{f8b9}"
        case .servicesLight: return "\u{f8ba}"
        case .servicesRegular: return "\u{f8bb}"
        case .setVariableBold: return "\u{f8bc}"
        case .setVariableLight: return "\u{f8bd}"
        case .setVariableRegular: return "\u{f8be}"
        case .settingsBold: return "\u{f8bf}"
        case .settingsFilled: return "\u{f8c0}"
        case .settingsLight: return "\u{f8c1}"
        case .settingsRegular: return "\u{f8c2}"
        case .setupAssistantBold: return "\u{f8c3}"
        case .setupAssistantLight: return "\u{f8c4}"
        case .setupAssistantRegular: return "\u{f8c5}"
        case .sftpBold: return "\u{f8c6}"
        case .sftpLight: return "\u{f8c7}"
        case .sftpRegular: return "\u{f8c8}"
        case .shapeCircleBold: return "\u{f8c9}"
        case .shapeCircleFilled: return "\u{f8ca}"
        case .shapeCircleLight: return "\u{f8cb}"
        case .shapeCircleRegular: return "\u{f8cc}"
        case .shapeDiagonalLineBold: return "\u{f8cd}"
        case .shapeDiagonalLineLight: return "\u{f8ce}"
        case .shapeDiagonalLineRegular: return "\u{f8cf}"
        case .shapeDiamondBold: return "\u{f8d0}"
        case .shapeDiamondFilled: return "\u{f8d1}"
        case .shapeDiamondLight: return "\u{f8d2}"
        case .shapeDiamondRegular: return "\u{f8d3}"
        case .shapeOvalBold: return "\u{f8d4}"
        case .shapeOvalLight: return "\u{f8d5}"
        case .shapeOvalRegular: return "\u{f8d6}"
        case .shapeSquareBold: return "\u{f8d7}"
        case .shapeSquareFilled: return "\u{f8d8}"
        case .shapeSquareLight: return "\u{f8d9}"
        case .shapeSquareRegular: return "\u{f8da}"
        case .shapeTriangleBold: return "\u{f8db}"
        case .shapeTriangleFilled: return "\u{f8dc}"
        case .shapeTriangleLight: return "\u{f8dd}"
        case .shapeTriangleRegular: return "\u{f8de}"
        case .shapesBold: return "\u{f8df}"
        case .shapesLight: return "\u{f8e0}"
        case .shapesRegular: return "\u{f8e1}"
        case .shareCNativeAdrBold: return "\u{f8e2}"
        case .shareCNativeAdrLight: return "\u{f8e3}"
        case .shareCNativeAdrRegular: return "\u{f8e4}"
        case .shareCNativeIphBold: return "\u{f8e5}"
        case .shareCNativeIphLight: return "\u{f8e6}"
        case .shareCNativeIphRegular: return "\u{f8e7}"
        case .shareScreenBold: return "\u{f8e8}"
        case .shareScreenFilled: return "\u{f8e9}"
        case .shareScreenLight: return "\u{f8ea}"
        case .shareScreenRegular: return "\u{f8eb}"
        case .shareScreenSmallFilled: return "\u{f8ec}"
        case .shareSpaceBold: return "\u{f8ed}"
        case .shareSpaceLight: return "\u{f8ee}"
        case .shareSpaceRegular: return "\u{f8ef}"
        case .shieldBold: return "\u{f8f0}"
        case .shieldLight: return "\u{f8f1}"
        case .shieldRegular: return "\u{f8f2}"
        case .shoppingCartBold: return "\u{f8f3}"
        case .shoppingCartFilled: return "\u{f8f4}"
        case .shoppingCartLight: return "\u{f8f5}"
        case .shoppingCartRegular: return "\u{f8f6}"
        case .shortTextBoxBold: return "\u{f8f7}"
        case .shortTextBoxLight: return "\u{f8f8}"
        case .shortTextBoxRegular: return "\u{f8f9}"
        case .showBold: return "\u{f8fa}"
        case .showFilled: return "\u{f8fb}"
        case .showLight: return "\u{f8fc}"
        case .showRegular: return "\u{f8fd}"
        case .signInBold: return "\u{f8fe}"
        case .signInFilled: return "\u{f8ff}"
        case .signInForcedBold: return "\u{f900}"
        case .signInForcedLight: return "\u{f901}"
        case .signInForcedRegular: return "\u{f902}"
        case .signInLight: return "\u{f903}"
        case .signInRegular: return "\u{f904}"
        case .signOutBold: return "\u{f905}"
        case .signOutLight: return "\u{f906}"
        case .signOutRegular: return "\u{f907}"
        case .signal0Bold: return "\u{f908}"
        case .signal0Light: return "\u{f909}"
        case .signal0Regular: return "\u{f90a}"
        case .signal100Bold: return "\u{f90b}"
        case .signal100Light: return "\u{f90c}"
        case .signal100Regular: return "\u{f90d}"
        case .signal25Bold: return "\u{f90e}"
        case .signal25Light: return "\u{f90f}"
        case .signal25Regular: return "\u{f910}"
        case .signal50Bold: return "\u{f911}"
        case .signal50Light: return "\u{f912}"
        case .signal50Regular: return "\u{f913}"
        case .signal75Bold: return "\u{f914}"
        case .signal75Light: return "\u{f915}"
        case .signal75Regular: return "\u{f916}"
        case .simplePromotionBold: return "\u{f917}"
        case .simplePromotionLight: return "\u{f918}"
        case .simplePromotionRegular: return "\u{f919}"
        case .singleNumberReachBold: return "\u{f91a}"
        case .singleNumberReachLight: return "\u{f91b}"
        case .singleNumberReachRegular: return "\u{f91c}"
        case .sipRegistrationInProgressBold: return "\u{f91d}"
        case .sipRegistrationInProgressFilled: return "\u{f91e}"
        case .sipRegistrationInProgressLight: return "\u{f91f}"
        case .sipRegistrationInProgressRegular: return "\u{f920}"
        case .skipBold: return "\u{f921}"
        case .skipBwBold: return "\u{f922}"
        case .skipBwFilled: return "\u{f923}"
        case .skipBwLight: return "\u{f924}"
        case .skipBwRegular: return "\u{f925}"
        case .skipFwBold: return "\u{f926}"
        case .skipFwFilled: return "\u{f927}"
        case .skipFwLight: return "\u{f928}"
        case .skipFwRegular: return "\u{f929}"
        case .skipLight: return "\u{f92a}"
        case .skipRegular: return "\u{f92b}"
        case .smsInboundBold: return "\u{f92c}"
        case .smsInboundLight: return "\u{f92d}"
        case .smsInboundRegular: return "\u{f92e}"
        case .smsMessageBold: return "\u{f92f}"
        case .smsMessageFilled: return "\u{f930}"
        case .smsMessageLight: return "\u{f931}"
        case .smsMessageRegular: return "\u{f932}"
        case .socialAlexaFilled: return "\u{f933}"
        case .socialFacebookColoredFilled: return "\u{f934}"
        case .socialFacebookFilled: return "\u{f935}"
        case .socialFbmessengerColoredFilled: return "\u{f936}"
        case .socialFbmessengerFilled: return "\u{f937}"
        case .socialInstagramBold: return "\u{f938}"
        case .socialMicrosoftColoredFilled: return "\u{f939}"
        case .socialMicrosoftFilled: return "\u{f93a}"
        case .socialMmsFilled: return "\u{f93b}"
        case .socialMmsGoldFilled: return "\u{f93c}"
        case .socialSmsFilled: return "\u{f93d}"
        case .socialSmsMintFilled: return "\u{f93e}"
        case .socialTwitterColoredFilled: return "\u{f93f}"
        case .socialTwitterFilled: return "\u{f940}"
        case .socialViberBold: return "\u{f941}"
        case .socialViberColoredBold: return "\u{f942}"
        case .socialWhatsappBold: return "\u{f943}"
        case .socialWhatsappColoredFilled: return "\u{f944}"
        case .sortAscendingBold: return "\u{f945}"
        case .sortAscendingLight: return "\u{f946}"
        case .sortAscendingRegular: return "\u{f947}"
        case .sortDescendingBold: return "\u{f948}"
        case .sortDescendingLight: return "\u{f949}"
        case .sortDescendingRegular: return "\u{f94a}"
        case .soundDefaultBold: return "\u{f94b}"
        case .soundDefaultLight: return "\u{f94c}"
        case .soundDefaultRegular: return "\u{f94d}"
        case .speakerBold: return "\u{f94e}"
        case .speakerDisconnectedBold: return "\u{f94f}"
        case .speakerDisconnectedFilled: return "\u{f950}"
        case .speakerDisconnectedLight: return "\u{f951}"
        case .speakerDisconnectedRegular: return "\u{f952}"
        case .speakerFilled: return "\u{f953}"
        case .speakerLight: return "\u{f954}"
        case .speakerMutedBold: return "\u{f955}"
        case .speakerMutedFilled: return "\u{f956}"
        case .speakerMutedLight: return "\u{f957}"
        case .speakerMutedRegular: return "\u{f958}"
        case .speakerOffBold: return "\u{f959}"
        case .speakerOffFilled: return "\u{f95a}"
        case .speakerOffLight: return "\u{f95b}"
        case .speakerOffRegular: return "\u{f95c}"
        case .speakerOnColoredBold: return "\u{f95d}"
        case .speakerOnColoredLight: return "\u{f95e}"
        case .speakerOnColoredRegular: return "\u{f95f}"
        case .speakerRegular: return "\u{f960}"
        case .speakerTurnDownBold: return "\u{f961}"
        case .speakerTurnDownFilled: return "\u{f962}"
        case .speakerTurnDownLight: return "\u{f963}"
        case .speakerTurnDownRegular: return "\u{f964}"
        case .speakerTurnUpBold: return "\u{f965}"
        case .speakerTurnUpFilled: return "\u{f966}"
        case .speakerTurnUpLight: return "\u{f967}"
        case .speakerTurnUpRegular: return "\u{f968}"
        case .spinnerBold: return "\u{f969}"
        case .spinnerFilledBold: return "\u{f96a}"
        case .spinnerFilledLight: return "\u{f96b}"
        case .spinnerFilledRegular: return "\u{f96c}"
        case .spinnerLight: return "\u{f96d}"
        case .spinnerPartialBold: return "\u{f96e}"
        case .spinnerPartialLight: return "\u{f96f}"
        case .spinnerPartialRegular: return "\u{f970}"
        case .spinnerRegular: return "\u{f971}"
        case .stackedArea100ChartBold: return "\u{f972}"
        case .stackedArea100ChartFilled: return "\u{f973}"
        case .stackedArea100ChartLight: return "\u{f974}"
        case .stackedArea100ChartRegular: return "\u{f975}"
        case .stackedAreaChartBold: return "\u{f976}"
        case .stackedAreaChartFilled: return "\u{f977}"
        case .stackedAreaChartLight: return "\u{f978}"
        case .stackedAreaChartRegular: return "\u{f979}"
        case .stackedBar100ChartBold: return "\u{f97a}"
        case .stackedBar100ChartFilled: return "\u{f97b}"
        case .stackedBar100ChartLight: return "\u{f97c}"
        case .stackedBar100ChartRegular: return "\u{f97d}"
        case .stackedBarChartBold: return "\u{f97e}"
        case .stackedBarChartFilled: return "\u{f97f}"
        case .stackedBarChartLight: return "\u{f980}"
        case .stackedBarChartRegular: return "\u{f981}"
        case .startChatBold: return "\u{f982}"
        case .startChatLight: return "\u{f983}"
        case .startChatRegular: return "\u{f984}"
        case .stethoscopeBold: return "\u{f985}"
        case .stethoscopeLight: return "\u{f986}"
        case .stethoscopeRegular: return "\u{f987}"
        case .stickersBold: return "\u{f988}"
        case .stickersLight: return "\u{f989}"
        case .stickersRegular: return "\u{f98a}"
        case .stickiesBold: return "\u{f98b}"
        case .stickiesLight: return "\u{f98c}"
        case .stickiesRegular: return "\u{f98d}"
        case .stopBold: return "\u{f98e}"
        case .stopCircleBold: return "\u{f98f}"
        case .stopCircleFilled: return "\u{f990}"
        case .stopCircleLight: return "\u{f991}"
        case .stopCircleRegular: return "\u{f992}"
        case .stopContentShareBold: return "\u{f993}"
        case .stopContentShareLight: return "\u{f994}"
        case .stopContentShareRegular: return "\u{f995}"
        case .stopFilled: return "\u{f996}"
        case .stopLight: return "\u{f997}"
        case .stopRegular: return "\u{f998}"
        case .storedInfoBold: return "\u{f999}"
        case .storedInfoFilled: return "\u{f99a}"
        case .storedInfoLight: return "\u{f99b}"
        case .storedInfoRegular: return "\u{f99c}"
        case .streamingBold: return "\u{f99d}"
        case .streamingLight: return "\u{f99e}"
        case .streamingRegular: return "\u{f99f}"
        case .strikethroughBold: return "\u{f9a0}"
        case .strikethroughLight: return "\u{f9a1}"
        case .strikethroughRegular: return "\u{f9a2}"
        case .subscriptBold: return "\u{f9a3}"
        case .subscriptLight: return "\u{f9a4}"
        case .subscriptRegular: return "\u{f9a5}"
        case .superscriptBold: return "\u{f9a6}"
        case .superscriptLight: return "\u{f9a7}"
        case .superscriptRegular: return "\u{f9a8}"
        case .surveyBold: return "\u{f9a9}"
        case .surveyFilled: return "\u{f9aa}"
        case .surveyLight: return "\u{f9ab}"
        case .surveyRegular: return "\u{f9ac}"
        case .sx10Bold: return "\u{f9ad}"
        case .sx10Light: return "\u{f9ae}"
        case .sx10Regular: return "\u{f9af}"
        case .sx20Bold: return "\u{f9b0}"
        case .sx20Light: return "\u{f9b1}"
        case .sx20Regular: return "\u{f9b2}"
        case .sx80CodecBold: return "\u{f9b3}"
        case .sx80CodecLight: return "\u{f9b4}"
        case .sx80CodecRegular: return "\u{f9b5}"
        case .tableBold: return "\u{f9b6}"
        case .tableLight: return "\u{f9b7}"
        case .tableRegular: return "\u{f9b8}"
        case .tabletBold: return "\u{f9b9}"
        case .tabletLight: return "\u{f9ba}"
        case .tabletRegular: return "\u{f9bb}"
        case .tabsBold: return "\u{f9bc}"
        case .tabsLight: return "\u{f9bd}"
        case .tabsRegular: return "\u{f9be}"
        case .tagBold: return "\u{f9bf}"
        case .tagLight: return "\u{f9c0}"
        case .tagRegular: return "\u{f9c1}"
        case .tapBold: return "\u{f9c2}"
        case .tapFilled: return "\u{f9c3}"
        case .tapLight: return "\u{f9c4}"
        case .tapRegular: return "\u{f9c5}"
        case .telepresenceAlertBold: return "\u{f9c6}"
        case .telepresenceAlertLight: return "\u{f9c7}"
        case .telepresenceAlertMutedBold: return "\u{f9c8}"
        case .telepresenceAlertMutedLight: return "\u{f9c9}"
        case .telepresenceAlertMutedRegular: return "\u{f9ca}"
        case .telepresenceAlertRegular: return "\u{f9cb}"
        case .telepresenceBold: return "\u{f9cc}"
        case .telepresenceIx5000Bold: return "\u{f9cd}"
        case .telepresenceIx5000Light: return "\u{f9ce}"
        case .telepresenceIx5000Regular: return "\u{f9cf}"
        case .telepresenceLight: return "\u{f9d0}"
        case .telepresencePrivateBold: return "\u{f9d1}"
        case .telepresencePrivateLight: return "\u{f9d2}"
        case .telepresencePrivateRegular: return "\u{f9d3}"
        case .telepresenceRegular: return "\u{f9d4}"
        case .temperatureBold: return "\u{f9d5}"
        case .temperatureLight: return "\u{f9d6}"
        case .temperatureRegular: return "\u{f9d7}"
        case .textAlignCenterBold: return "\u{f9d8}"
        case .textAlignCenterFilled: return "\u{f9d9}"
        case .textAlignCenterLight: return "\u{f9da}"
        case .textAlignCenterRegular: return "\u{f9db}"
        case .textAlignLeftBold: return "\u{f9dc}"
        case .textAlignLeftFilled: return "\u{f9dd}"
        case .textAlignLeftLight: return "\u{f9de}"
        case .textAlignLeftRegular: return "\u{f9df}"
        case .textAlignRightBold: return "\u{f9e0}"
        case .textAlignRightFilled: return "\u{f9e1}"
        case .textAlignRightLight: return "\u{f9e2}"
        case .textAlignRightRegular: return "\u{f9e3}"
        case .textBold: return "\u{f9e4}"
        case .textCodeBlockBold: return "\u{f9e5}"
        case .textCodeBlockLight: return "\u{f9e6}"
        case .textCodeBlockRegular: return "\u{f9e7}"
        case .textHighlightBold: return "\u{f9e8}"
        case .textHighlightLight: return "\u{f9e9}"
        case .textHighlightRegular: return "\u{f9ea}"
        case .textLight: return "\u{f9eb}"
        case .textRegular: return "\u{f9ec}"
        case .threeColumnBold: return "\u{f9ed}"
        case .threeColumnLight: return "\u{f9ee}"
        case .threeColumnRegular: return "\u{f9ef}"
        case .threeDObjectBold: return "\u{f9f0}"
        case .threeDObjectLight: return "\u{f9f1}"
        case .threeDObjectRegular: return "\u{f9f2}"
        case .tooFastBold: return "\u{f9f3}"
        case .tooFastLight: return "\u{f9f4}"
        case .tooFastRegular: return "\u{f9f5}"
        case .tooSlowBold: return "\u{f9f6}"
        case .tooSlowLight: return "\u{f9f7}"
        case .tooSlowRegular: return "\u{f9f8}"
        case .toolsBold: return "\u{f9f9}"
        case .toolsLight: return "\u{f9fa}"
        case .toolsRegular: return "\u{f9fb}"
        case .touch10Bold: return "\u{f9fc}"
        case .touch10Light: return "\u{f9fd}"
        case .touch10Regular: return "\u{f9fe}"
        case .transcriptBold: return "\u{f9ff}"
        case .transcriptFilled: return "\u{fa00}"
        case .transcriptLight: return "\u{fa01}"
        case .transcriptRegular: return "\u{fa02}"
        case .translateBold: return "\u{fa03}"
        case .translateLight: return "\u{fa04}"
        case .translateRegular: return "\u{fa05}"
        case .trimBold: return "\u{fa06}"
        case .trimLight: return "\u{fa07}"
        case .trimRegular: return "\u{fa08}"
        case .twoColumnBold: return "\u{fa09}"
        case .twoColumnLight: return "\u{fa0a}"
        case .twoColumnRegular: return "\u{fa0b}"
        case .ucmCloudBold: return "\u{fa0c}"
        case .ucmCloudLight: return "\u{fa0d}"
        case .ucmCloudRegular: return "\u{fa0e}"
        case .underlineBold: return "\u{fa0f}"
        case .underlineLight: return "\u{fa10}"
        case .underlineRegular: return "\u{fa11}"
        case .undoBold: return "\u{fa12}"
        case .undoLight: return "\u{fa13}"
        case .undoRegular: return "\u{fa14}"
        case .unlinkBold: return "\u{fa15}"
        case .unlinkLight: return "\u{fa16}"
        case .unlinkRegular: return "\u{fa17}"
        case .unreadBold: return "\u{fa18}"
        case .unreadFilled: return "\u{fa19}"
        case .unreadLight: return "\u{fa1a}"
        case .unreadRegular: return "\u{fa1b}"
        case .unsecureUnlockedBold: return "\u{fa1c}"
        case .unsecureUnlockedFilled: return "\u{fa1d}"
        case .unsecureUnlockedLight: return "\u{fa1e}"
        case .unsecureUnlockedRegular: return "\u{fa1f}"
        case .unsortedBold: return "\u{fa20}"
        case .unsortedLight: return "\u{fa21}"
        case .unsortedRegular: return "\u{fa22}"
        case .updateFileShareBold: return "\u{fa23}"
        case .updateFileShareLight: return "\u{fa24}"
        case .updateFileShareRegular: return "\u{fa25}"
        case .upgradeBold: return "\u{fa26}"
        case .upgradeFilled: return "\u{fa27}"
        case .upgradeLight: return "\u{fa28}"
        case .upgradeRegular: return "\u{fa29}"
        case .uploadBold: return "\u{fa2a}"
        case .uploadLight: return "\u{fa2b}"
        case .uploadRegular: return "\u{fa2c}"
        case .urgentVoicemailBold: return "\u{fa2d}"
        case .urgentVoicemailFilled: return "\u{fa2e}"
        case .usbBold: return "\u{fa2f}"
        case .usbHeadsetBold: return "\u{fa30}"
        case .usbHeadsetLight: return "\u{fa31}"
        case .usbHeadsetMutedBold: return "\u{fa32}"
        case .usbHeadsetMutedLight: return "\u{fa33}"
        case .usbHeadsetMutedRegular: return "\u{fa34}"
        case .usbHeadsetRegular: return "\u{fa35}"
        case .usbLight: return "\u{fa36}"
        case .usbRegular: return "\u{fa37}"
        case .userBold: return "\u{fa38}"
        case .userDeactivateBold: return "\u{fa39}"
        case .userDeactivateLight: return "\u{fa3a}"
        case .userDeactivateRegular: return "\u{fa3b}"
        case .userLight: return "\u{fa3c}"
        case .userRegular: return "\u{fa3d}"
        case .vcsBold: return "\u{fa3e}"
        case .vcsLight: return "\u{fa3f}"
        case .vcsRegular: return "\u{fa40}"
        case .videoBlurBold: return "\u{fa41}"
        case .videoBlurFilled: return "\u{fa42}"
        case .videoBlurLight: return "\u{fa43}"
        case .videoBlurRegular: return "\u{fa44}"
        case .videoBold: return "\u{fa45}"
        case .videoEffectBold: return "\u{fa46}"
        case .videoEffectFilled: return "\u{fa47}"
        case .videoEffectLight: return "\u{fa48}"
        case .videoEffectRegular: return "\u{fa49}"
        case .videoFilled: return "\u{fa4a}"
        case .videoLayoutBold: return "\u{fa4b}"
        case .videoLayoutEqualBold: return "\u{fa4c}"
        case .videoLayoutEqualDualBold: return "\u{fa4d}"
        case .videoLayoutEqualDualLight: return "\u{fa4e}"
        case .videoLayoutEqualDualRegular: return "\u{fa4f}"
        case .videoLayoutEqualFilled: return "\u{fa50}"
        case .videoLayoutEqualLight: return "\u{fa51}"
        case .videoLayoutEqualRegular: return "\u{fa52}"
        case .videoLayoutFilled: return "\u{fa53}"
        case .videoLayoutLight: return "\u{fa54}"
        case .videoLayoutOverlayBold: return "\u{fa55}"
        case .videoLayoutOverlayLight: return "\u{fa56}"
        case .videoLayoutOverlayRegular: return "\u{fa57}"
        case .videoLayoutPresenterDominantBold: return "\u{fa58}"
        case .videoLayoutPresenterDominantLight: return "\u{fa59}"
        case .videoLayoutPresenterDominantRegular: return "\u{fa5a}"
        case .videoLayoutProminentBold: return "\u{fa5b}"
        case .videoLayoutProminentFilled: return "\u{fa5c}"
        case .videoLayoutProminentLight: return "\u{fa5d}"
        case .videoLayoutProminentRegular: return "\u{fa5e}"
        case .videoLayoutRegular: return "\u{fa5f}"
        case .videoLayoutShareDominantBold: return "\u{fa60}"
        case .videoLayoutShareDominantLight: return "\u{fa61}"
        case .videoLayoutShareDominantRegular: return "\u{fa62}"
        case .videoLayoutSingleBold: return "\u{fa63}"
        case .videoLayoutSingleFilled: return "\u{fa64}"
        case .videoLayoutSingleLight: return "\u{fa65}"
        case .videoLayoutSingleRegular: return "\u{fa66}"
        case .videoLayoutStackBold: return "\u{fa67}"
        case .videoLayoutStackFilled: return "\u{fa68}"
        case .videoLayoutStackLight: return "\u{fa69}"
        case .videoLayoutStackRegular: return "\u{fa6a}"
        case .videoLayoutVideoDominantBold: return "\u{fa6b}"
        case .videoLayoutVideoDominantLight: return "\u{fa6c}"
        case .videoLayoutVideoDominantRegular: return "\u{fa6d}"
        case .videoLight: return "\u{fa6e}"
        case .videoPlusBold: return "\u{fa6f}"
        case .videoPlusFilled: return "\u{fa70}"
        case .videoPlusLight: return "\u{fa71}"
        case .videoPlusRegular: return "\u{fa72}"
        case .videoRegular: return "\u{fa73}"
        case .videoSpeakerTrackBold: return "\u{fa74}"
        case .videoSpeakerTrackFilled: return "\u{fa75}"
        case .videoSpeakerTrackLight: return "\u{fa76}"
        case .videoSpeakerTrackRegular: return "\u{fa77}"
        case .viewAllBold: return "\u{fa78}"
        case .viewAllLight: return "\u{fa79}"
        case .viewAllRegular: return "\u{fa7a}"
        case .viewListBold: return "\u{fa7b}"
        case .viewListLight: return "\u{fa7c}"
        case .viewListRegular: return "\u{fa7d}"
        case .viewStackedBold: return "\u{fa7e}"
        case .viewStackedFilled: return "\u{fa7f}"
        case .viewStackedLight: return "\u{fa80}"
        case .viewStackedRegular: return "\u{fa81}"
        case .viewThumbnailBold: return "\u{fa82}"
        case .viewThumbnailFilled: return "\u{fa83}"
        case .viewThumbnailLight: return "\u{fa84}"
        case .viewThumbnailRegular: return "\u{fa85}"
        case .voicemailBold: return "\u{fa86}"
        case .voicemailFilled: return "\u{fa87}"
        case .voicemailLight: return "\u{fa88}"
        case .voicemailRegular: return "\u{fa89}"
        case .waffleMenuBold: return "\u{fa8a}"
        case .waffleMenuLight: return "\u{fa8b}"
        case .waffleMenuRegular: return "\u{fa8c}"
        case .waitingroomActiveBold: return "\u{fa8d}"
        case .waitingroomActiveLight: return "\u{fa8e}"
        case .waitingroomActiveRegular: return "\u{fa8f}"
        case .wallpaperBold: return "\u{fa90}"
        case .wallpaperLight: return "\u{fa91}"
        case .wallpaperRegular: return "\u{fa92}"
        case .warningBadgeFilled: return "\u{fa93}"
        case .warningBold: return "\u{fa94}"
        case .warningFilled: return "\u{fa95}"
        case .warningLight: return "\u{fa96}"
        case .warningRegular: return "\u{fa97}"
        case .webexAssistantActiveColored: return "\u{fa98}"
        case .webexAssistantInactiveColored: return "\u{fa99}"
        case .webexBoardBold: return "\u{fa9a}"
        case .webexBoardLight: return "\u{fa9b}"
        case .webexBoardRegular: return "\u{fa9c}"
        case .webexCodecPlusBold: return "\u{fa9d}"
        case .webexCodecPlusLight: return "\u{fa9e}"
        case .webexCodecPlusRegular: return "\u{fa9f}"
        case .webexDeskCameraBold: return "\u{faa0}"
        case .webexDeskCameraLight: return "\u{faa1}"
        case .webexDeskCameraRegular: return "\u{faa2}"
        case .webexHelixFilled: return "\u{faa3}"
        case .webexMeetingsBold: return "\u{faa4}"
        case .webexMeetingsFilled: return "\u{faa5}"
        case .webexMeetingsLight: return "\u{faa6}"
        case .webexMeetingsRegular: return "\u{faa7}"
        case .webexQuadCameraBold: return "\u{faa8}"
        case .webexQuadCameraLight: return "\u{faa9}"
        case .webexQuadCameraRegular: return "\u{faaa}"
        case .webexRoomKitBold: return "\u{faab}"
        case .webexRoomKitLight: return "\u{faac}"
        case .webexRoomKitPlusBold: return "\u{faad}"
        case .webexRoomKitPlusLight: return "\u{faae}"
        case .webexRoomKitPlusRegular: return "\u{faaf}"
        case .webexRoomKitRegular: return "\u{fab0}"
        case .webexShareBold: return "\u{fab1}"
        case .webexShareLight: return "\u{fab2}"
        case .webexShareRegular: return "\u{fab3}"
        case .webexTeamsBold: return "\u{fab4}"
        case .webexTeamsFilled: return "\u{fab5}"
        case .webexTeamsLight: return "\u{fab6}"
        case .webexTeamsNewBold: return "\u{fab7}"
        case .webexTeamsNewFilled: return "\u{fab8}"
        case .webexTeamsNewLight: return "\u{fab9}"
        case .webexTeamsNewRegular: return "\u{faba}"
        case .webexTeamsRegular: return "\u{fabb}"
        case .webinarBold: return "\u{fabc}"
        case .webinarFilled: return "\u{fabd}"
        case .webinarLight: return "\u{fabe}"
        case .webinarRegular: return "\u{fabf}"
        case .weeklyRecurringScheduleNodeBold: return "\u{fac0}"
        case .weeklyRecurringScheduleNodeLight: return "\u{fac1}"
        case .weeklyRecurringScheduleNodeRegular: return "\u{fac2}"
        case .whiteboardBold: return "\u{fac3}"
        case .whiteboardContentBold: return "\u{fac4}"
        case .whiteboardContentLight: return "\u{fac5}"
        case .whiteboardContentRegular: return "\u{fac6}"
        case .whiteboardFilled: return "\u{fac7}"
        case .whiteboardLight: return "\u{fac8}"
        case .whiteboardRegular: return "\u{fac9}"
        case .widgetBold: return "\u{faca}"
        case .widgetFilled: return "\u{facb}"
        case .widgetLight: return "\u{facc}"
        case .widgetRegular: return "\u{facd}"
        case .wifiBold: return "\u{face}"
        case .wifiErrorBold: return "\u{facf}"
        case .wifiErrorLight: return "\u{fad0}"
        case .wifiErrorRegular: return "\u{fad1}"
        case .wifiLight: return "\u{fad2}"
        case .wifiRegular: return "\u{fad3}"
        case .wifiSignalGoodColoredBold: return "\u{fad4}"
        case .wifiSignalGoodColoredLight: return "\u{fad5}"
        case .wifiSignalGoodColoredRegular: return "\u{fad6}"
        case .wifiSignalPoorColoredBold: return "\u{fad7}"
        case .wifiSignalPoorColoredLight: return "\u{fad8}"
        case .wifiSignalPoorColoredRegular: return "\u{fad9}"
        case .wifiSignalUnstableColoredBold: return "\u{fada}"
        case .wifiSignalUnstableColoredLight: return "\u{fadb}"
        case .wifiSignalUnstableColoredRegular: return "\u{fadc}"
        case .windowCornerScrubBold: return "\u{fadd}"
        case .windowCornerScrubLight: return "\u{fade}"
        case .windowCornerScrubRegular: return "\u{fadf}"
        case .windowRightCornerScrubBold: return "\u{fae0}"
        case .windowRightCornerScrubLight: return "\u{fae1}"
        case .windowRightCornerScrubRegular: return "\u{fae2}"
        case .windowVerticalScrubBold: return "\u{fae3}"
        case .windowVerticalScrubLight: return "\u{fae4}"
        case .windowVerticalScrubRegular: return "\u{fae5}"
        case .workflowDeploymentsBold: return "\u{fae6}"
        case .workflowDeploymentsLight: return "\u{fae7}"
        case .workflowDeploymentsRegular: return "\u{fae8}"
        case .workphoneBold: return "\u{fae9}"
        case .workphoneLight: return "\u{faea}"
        case .workphoneRegular: return "\u{faeb}"
        case .zoomInBold: return "\u{faec}"
        case .zoomInLight: return "\u{faed}"
        case .zoomInRegular: return "\u{faee}"
        case .zoomOutBold: return "\u{faef}"
        case .zoomOutLight: return "\u{faf0}"
        case .zoomOutRegular: return "\u{faf1}"
        case .zoom: return "\u{faf2}"
