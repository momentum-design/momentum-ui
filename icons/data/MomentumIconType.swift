...
@objc public enum MomentumIconType: Int {
    ...
    public var ligature: String {
        ...
        case .vector: return "\u{fc31}"
        case .videoEffect12: return "\u{fc32}"
        case .videoEffect16: return "\u{fc33}"
        case .videoEffect20: return "\u{fc34}"
        case .videoLayout12: return "\u{fc35}"
        case .videoLayout16: return "\u{fc36}"
        case .videoLayoutAuto12: return "\u{fc37}"
        case .videoLayoutAuto16: return "\u{fc38}"
        case .videoLayoutAuto20: return "\u{fc39}"
        case .videoLayoutAuto24: return "\u{fc3a}"
        case .videoLayoutEqual12: return "\u{fc3b}"
        case .videoLayoutEqual14: return "\u{fc3c}"
        case .videoLayoutEqual16: return "\u{fc3d}"
        case .videoLayoutEqual20: return "\u{fc3e}"
        case .videoLayoutEqual24: return "\u{fc3f}"
        case .videoLayoutEqual28: return "\u{fc40}"
        case .videoLayoutEqualFilled24: return "\u{fc41}"
        case .videoLayoutOverlay12: return "\u{fc42}"
        case .videoLayoutOverlay16: return "\u{fc43}"
        case .videoLayoutOverlay20: return "\u{fc44}"
        case .videoLayoutOverlay24: return "\u{fc45}"
        case .videoLayoutProminent12: return "\u{fc46}"
        case .videoLayoutProminent16: return "\u{fc47}"
        case .videoLayoutProminent20: return "\u{fc48}"
        case .videoLayoutProminent24: return "\u{fc49}"
        case .videoLayoutShareDominant12: return "\u{fc4a}"
        case .videoLayoutShareDominant16: return "\u{fc4b}"
        case .videoLayoutShareDominant20: return "\u{fc4c}"
        case .videoLayoutShareDominant24: return "\u{fc4d}"
        case .videoLayoutSingle12: return "\u{fc4e}"
        case .videoLayoutSingle16: return "\u{fc4f}"
        case .videoLayoutSingle20: return "\u{fc50}"
        case .videoLayoutSingle28: return "\u{fc51}"
        case .videoLayoutStack12: return "\u{fc52}"
        case .videoLayoutStack16: return "\u{fc53}"
        case .videoLayoutStack20: return "\u{fc54}"
        case .videoLayoutStack24: return "\u{fc55}"
        case .videoLayoutStack28: return "\u{fc56}"
        case .videoLayoutStackFilled24: return "\u{fc57}"
        case .videoLayoutVideoDominant12: return "\u{fc58}"
        case .videoLayoutVideoDominant16: return "\u{fc59}"
        case .videoLayoutVideoDominant20: return "\u{fc5a}"
        case .videoLayoutVideoDominant24: return "\u{fc5b}"
        case .viewAll12: return "\u{fc5c}"
        case .viewAll14: return "\u{fc5d}"
        case .viewFeedMultiple16: return "\u{fc5e}"
        case .viewFeedPanel16: return "\u{fc5f}"
        case .viewFeedSingle16: return "\u{fc60}"
        case .viewList10: return "\u{fc61}"
        case .viewList12: return "\u{fc62}"
        case .viewList14: return "\u{fc63}"
        case .viewList16: return "\u{fc64}"
        case .viewList20: return "\u{fc65}"
        case .viewList24: return "\u{fc66}"
        case .viewList28: return "\u{fc67}"
        case .viewListCircle100: return "\u{fc68}"
        case .viewMixed12: return "\u{fc69}"
        case .viewStack12: return "\u{fc6a}"
        case .viewStack14: return "\u{fc6b}"
        case .viewStack20: return "\u{fc6c}"
        case .viewStack24: return "\u{fc6d}"
        case .viewThumbnail12: return "\u{fc6e}"
        case .viewThumbnail14: return "\u{fc6f}"
        case .viewThumbnail16: return "\u{fc70}"
        case .viewThumbnail20: return "\u{fc71}"
        case .viewThumbnail24: return "\u{fc72}"
        case .voice20: return "\u{fc73}"
        case .voicemail10: return "\u{fc74}"
        case .voicemail14: return "\u{fc75}"
        case .voicemail16: return "\u{fc76}"
        case .voicemail18: return "\u{fc77}"
        case .voicemail20: return "\u{fc78}"
        case .voicemail22: return "\u{fc79}"
        case .voicemail24: return "\u{fc7a}"
        case .voicemail28: return "\u{fc7b}"
        case .voicemail8: return "\u{fc7c}"
        case .voicemailActive12: return "\u{fc7d}"
        case .voicemailActive14: return "\u{fc7e}"
        case .voicemailActive16: return "\u{fc7f}"
        case .voicemailActive18: return "\u{fc80}"
        case .voicemailActive20: return "\u{fc81}"
        case .voicemailActive22: return "\u{fc82}"
        case .voicemailActive24: return "\u{fc83}"
        case .voicemailActive28: return "\u{fc84}"
        case .wallpaper16: return "\u{fc85}"
        case .wallpaper20: return "\u{fc86}"
        case .wallpaper24: return "\u{fc87}"
        case .wallpaper28: return "\u{fc88}"
        case .wallpaper32: return "\u{fc89}"
        case .warning100: return "\u{fc8a}"
        case .warning12: return "\u{fc8b}"
        case .warning14: return "\u{fc8c}"
        case .warning16: return "\u{fc8d}"
        case .warning20: return "\u{fc8e}"
        case .warning24: return "\u{fc8f}"
        case .warning28: return "\u{fc90}"
        case .warning32: return "\u{fc91}"
        case .warning40: return "\u{fc92}"
        case .warning44: return "\u{fc93}"
        case .warning56: return "\u{fc94}"
        case .warning64: return "\u{fc95}"
        case .warning72: return "\u{fc96}"
        case .warningActive12: return "\u{fc97}"
        case .warningActive16: return "\u{fc98}"
        case .waveform20: return "\u{fc99}"
        case .webSharing16: return "\u{fc9a}"
        case .webSharing24: return "\u{fc9b}"
        case .webex10: return "\u{fc9c}"
        case .webex16: return "\u{fc9d}"
        case .webex24: return "\u{fc9e}"
        case .webex48: return "\u{fc9f}"
        case .webexBoard12: return "\u{fca0}"
        case .webexBoard14: return "\u{fca1}"
        case .webexBoard16: return "\u{fca2}"
        case .webexBoard20: return "\u{fca3}"
        case .webexBoard24: return "\u{fca4}"
        case .webexBoard28: return "\u{fca5}"
        case .webexBoard32: return "\u{fca6}"
        case .webexBoard48: return "\u{fca7}"
        case .webexCalling10: return "\u{fca8}"
        case .webexCalling12: return "\u{fca9}"
        case .webexCalling16: return "\u{fcaa}"
        case .webexCalling18: return "\u{fcab}"
        case .webexCalling20: return "\u{fcac}"
        case .webexCalling24: return "\u{fcad}"
        case .webexCodecPlus16: return "\u{fcae}"
        case .webexCodecPlus20: return "\u{fcaf}"
        case .webexCommunity20: return "\u{fcb0}"
        case .webexDeskCamera20: return "\u{fcb1}"
        case .webexInstantMeeting12: return "\u{fcb2}"
        case .webexInstantMeeting14: return "\u{fcb3}"
        case .webexInstantMeeting16: return "\u{fcb4}"
        case .webexInstantMeeting20: return "\u{fcb5}"
        case .webexInstantMeeting24: return "\u{fcb6}"
        case .webexMeetings10: return "\u{fcb7}"
        case .webexMeetings12: return "\u{fcb8}"
        case .webexMeetings14: return "\u{fcb9}"
        case .webexMeetings16: return "\u{fcba}"
        case .webexMeetings20: return "\u{fcbb}"
        case .webexMeetings24: return "\u{fcbc}"
        case .webexMeetings48: return "\u{fcbd}"
        case .webexQuadCamera16: return "\u{fcbe}"
        case .webexQuadCamera20: return "\u{fcbf}"
        case .webexRoomKit16: return "\u{fcc0}"
        case .webexRoomKit20: return "\u{fcc1}"
        case .webexRoomKitPlus16: return "\u{fcc2}"
        case .webexRoomKitPlus20: return "\u{fcc3}"
        case .webexShare12: return "\u{fcc4}"
        case .webexShare14: return "\u{fcc5}"
        case .webexShare16: return "\u{fcc6}"
        case .webexShare20: return "\u{fcc7}"
        case .webexTeams10: return "\u{fcc8}"
        case .webexTeams12: return "\u{fcc9}"
        case .webexTeams14: return "\u{fcca}"
        case .webexTeams16: return "\u{fccb}"
        case .webexTeams18: return "\u{fccc}"
        case .webexTeams20: return "\u{fccd}"
        case .webexVoice16: return "\u{fcce}"
        case .webexVoice20: return "\u{fccf}"
        case .webpop12: return "\u{fcd0}"
        case .webpop16: return "\u{fcd1}"
        case .webpop20: return "\u{fcd2}"
        case .webpop24: return "\u{fcd3}"
        case .whatsApp12: return "\u{fcd4}"
        case .whatsApp16: return "\u{fcd5}"
        case .whiteboard10: return "\u{fcd6}"
        case .whiteboard12: return "\u{fcd7}"
        case .whiteboard14: return "\u{fcd8}"
        case .whiteboard16: return "\u{fcd9}"
        case .whiteboard20: return "\u{fcda}"
        case .whiteboard24: return "\u{fcdb}"
        case .whiteboard26: return "\u{fcdc}"
        case .whiteboard28: return "\u{fcdd}"
        case .whiteboard32: return "\u{fcde}"
        case .whiteboard36: return "\u{fcdf}"
        case .whiteboard8: return "\u{fce0}"
        case .whiteboardContent16: return "\u{fce1}"
        case .whiteboardContent24: return "\u{fce2}"
        case .widgetsAdr20: return "\u{fce3}"
        case .wifi12: return "\u{fce4}"
        case .wifi16: return "\u{fce5}"
        case .wifi20: return "\u{fce6}"
        case .wifi24: return "\u{fce7}"
        case .wifiError12: return "\u{fce8}"
        case .wifiError16: return "\u{fce9}"
        case .wifiSelected24: return "\u{fcea}"
        case .wikipedia16: return "\u{fceb}"
        case .windowCornerScrub16: return "\u{fcec}"
        case .windowVerticalScrub16: return "\u{fced}"
        case .youtubeCircle24: return "\u{fcee}"
        case .youtubeCircle32: return "\u{fcef}"
        case .youtubeCircle40: return "\u{fcf0}"
        case .zoomIn12: return "\u{fcf1}"
        case .zoomIn14: return "\u{fcf2}"
        case .zoomIn16: return "\u{fcf3}"
        case .zoomIn20: return "\u{fcf4}"
        case .zoomOut12: return "\u{fcf5}"
        case .zoomOut14: return "\u{fcf6}"
        case .zoomOut16: return "\u{fcf7}"
        case .zoomOut20: return "\u{fcf8}"
