...
@objc public enum MomentumIconsRebrandType: Int {
    ...
    public var ligature: String {
        ...
        case .pinListBold: return "\u{f67a}"
        case .pinListLight: return "\u{f67b}"
        case .pinListRegular: return "\u{f67c}"
        case .pinMutedBold: return "\u{f67d}"
        case .pinMutedLight: return "\u{f67e}"
        case .pinMutedRegular: return "\u{f67f}"
        case .pinRegular: return "\u{f680}"
        case .placeholderBold: return "\u{f681}"
        case .placeholderLight: return "\u{f682}"
        case .placeholderRegular: return "\u{f683}"
        case .playBold: return "\u{f684}"
        case .playFilled: return "\u{f685}"
        case .playLight: return "\u{f686}"
        case .playRegular: return "\u{f687}"
        case .plugAcBold: return "\u{f688}"
        case .plugAcLight: return "\u{f689}"
        case .plugAcRegular: return "\u{f68a}"
        case .plusBold: return "\u{f68b}"
        case .plusCircleBold: return "\u{f68c}"
        case .plusCircleFilled: return "\u{f68d}"
        case .plusCircleLight: return "\u{f68e}"
        case .plusCircleRegular: return "\u{f68f}"
        case .plusLight: return "\u{f690}"
        case .plusRegular: return "\u{f691}"
        case .pmrBold: return "\u{f692}"
        case .pmrFilled: return "\u{f693}"
        case .pmrLight: return "\u{f694}"
        case .pmrRegular: return "\u{f695}"
        case .pollBold: return "\u{f696}"
        case .pollLight: return "\u{f697}"
        case .pollRegular: return "\u{f698}"
        case .popInBold: return "\u{f699}"
        case .popInLight: return "\u{f69a}"
        case .popInRegular: return "\u{f69b}"
        case .popOutBold: return "\u{f69c}"
        case .popOutLight: return "\u{f69d}"
        case .popOutRegular: return "\u{f69e}"
        case .popUpBold: return "\u{f69f}"
        case .popUpLight: return "\u{f6a0}"
        case .popUpRegular: return "\u{f6a1}"
        case .portraitLandscapeBold: return "\u{f6a2}"
        case .portraitLandscapeLight: return "\u{f6a3}"
        case .portraitLandscapeRegular: return "\u{f6a4}"
        case .powerAcBold: return "\u{f6a5}"
        case .powerAcLight: return "\u{f6a6}"
        case .powerAcRegular: return "\u{f6a7}"
        case .powerBold: return "\u{f6a8}"
        case .powerLight: return "\u{f6a9}"
        case .powerRegular: return "\u{f6aa}"
        case .presentationBold: return "\u{f6ab}"
        case .presentationLight: return "\u{f6ac}"
        case .presentationRegular: return "\u{f6ad}"
        case .printBold: return "\u{f6ae}"
        case .printLight: return "\u{f6af}"
        case .printRegular: return "\u{f6b0}"
        case .priorityBadgeFilled: return "\u{f6b1}"
        case .priorityCircleBold: return "\u{f6b2}"
        case .priorityCircleFilled: return "\u{f6b3}"
        case .priorityCircleLight: return "\u{f6b4}"
        case .priorityCircleRegular: return "\u{f6b5}"
        case .priorityCircleTwoBold: return "\u{f6b6}"
        case .priorityCircleTwoFilled: return "\u{f6b7}"
        case .priorityCircleTwoLight: return "\u{f6b8}"
        case .priorityCircleTwoRegular: return "\u{f6b9}"
        case .privacyCircleBold: return "\u{f6ba}"
        case .privacyCircleFilled: return "\u{f6bb}"
        case .privacyCircleLight: return "\u{f6bc}"
        case .privacyCircleRegular: return "\u{f6bd}"
        case .privateBold: return "\u{f6be}"
        case .privateCircleBold: return "\u{f6bf}"
        case .privateCircleFilled: return "\u{f6c0}"
        case .privateCircleLight: return "\u{f6c1}"
        case .privateCircleRegular: return "\u{f6c2}"
        case .privateLight: return "\u{f6c3}"
        case .privateMeetingBold: return "\u{f6c4}"
        case .privateMeetingLight: return "\u{f6c5}"
        case .privateMeetingRegular: return "\u{f6c6}"
        case .privateRegular: return "\u{f6c7}"
        case .productDemoBold: return "\u{f6c8}"
        case .productDemoLight: return "\u{f6c9}"
        case .productDemoRegular: return "\u{f6ca}"
        case .proximityBold: return "\u{f6cb}"
        case .proximityLight: return "\u{f6cc}"
        case .proximityMutedBold: return "\u{f6cd}"
        case .proximityMutedLight: return "\u{f6ce}"
        case .proximityMutedRegular: return "\u{f6cf}"
        case .proximityRegular: return "\u{f6d0}"
        case .proximityVideoBold: return "\u{f6d1}"
        case .proximityVideoLight: return "\u{f6d2}"
        case .proximityVideoRegular: return "\u{f6d3}"
        case .ptoPresenceBold: return "\u{f6d4}"
        case .ptoPresenceFilled: return "\u{f6d5}"
        case .ptoPresenceLight: return "\u{f6d6}"
        case .ptoPresenceRegular: return "\u{f6d7}"
        case .pullCallBold: return "\u{f6d8}"
        case .pullCallLight: return "\u{f6d9}"
        case .pullCallRegular: return "\u{f6da}"
        case .qABold: return "\u{f6db}"
        case .qALight: return "\u{f6dc}"
        case .qARegular: return "\u{f6dd}"
        case .qualityBold: return "\u{f6de}"
        case .qualityLight: return "\u{f6df}"
        case .qualityRegular: return "\u{f6e0}"
        case .queueContactBold: return "\u{f6e1}"
        case .queueContactLight: return "\u{f6e2}"
        case .queueContactRegular: return "\u{f6e3}"
        case .quietBold: return "\u{f6e4}"
        case .quietHoursPresenceBold: return "\u{f6e5}"
        case .quietHoursPresenceFilled: return "\u{f6e6}"
        case .quietHoursPresenceLight: return "\u{f6e7}"
        case .quietHoursPresenceRegular: return "\u{f6e8}"
        case .quietLight: return "\u{f6e9}"
        case .quietRegular: return "\u{f6ea}"
        case .raiseHandBold: return "\u{f6eb}"
        case .raiseHandLight: return "\u{f6ec}"
        case .raiseHandRegular: return "\u{f6ed}"
        case .ramBold: return "\u{f6ee}"
        case .ramLight: return "\u{f6ef}"
        case .ramRegular: return "\u{f6f0}"
        case .reactionsBold: return "\u{f6f1}"
        case .reactionsFilled: return "\u{f6f2}"
        case .reactionsLight: return "\u{f6f3}"
        case .reactionsRegular: return "\u{f6f4}"
        case .reactivateBold: return "\u{f6f5}"
        case .reactivateLight: return "\u{f6f6}"
        case .reactivateRegular: return "\u{f6f7}"
        case .recentsBold: return "\u{f6f8}"
        case .recentsFilled: return "\u{f6f9}"
        case .recentsLight: return "\u{f6fa}"
        case .recentsPresenceBold: return "\u{f6fb}"
        case .recentsPresenceFilled: return "\u{f6fc}"
        case .recentsPresenceLight: return "\u{f6fd}"
        case .recentsPresenceRegular: return "\u{f6fe}"
        case .recentsPresenceSmallFilled: return "\u{f6ff}"
        case .recentsRegular: return "\u{f700}"
        case .recordBold: return "\u{f701}"
        case .recordFilled: return "\u{f702}"
        case .recordLight: return "\u{f703}"
        case .recordPausedBold: return "\u{f704}"
        case .recordPausedFilled: return "\u{f705}"
        case .recordPausedLight: return "\u{f706}"
        case .recordPausedRegular: return "\u{f707}"
        case .recordRegular: return "\u{f708}"
        case .recurringBold: return "\u{f709}"
        case .recurringLight: return "\u{f70a}"
        case .recurringOffBold: return "\u{f70b}"
        case .recurringOffLight: return "\u{f70c}"
        case .recurringOffRegular: return "\u{f70d}"
        case .recurringRegular: return "\u{f70e}"
        case .redialBold: return "\u{f70f}"
        case .redialLight: return "\u{f710}"
        case .redialRegular: return "\u{f711}"
        case .redoBold: return "\u{f712}"
        case .redoLight: return "\u{f713}"
        case .redoRegular: return "\u{f714}"
        case .refreshBold: return "\u{f715}"
        case .refreshLight: return "\u{f716}"
        case .refreshRegular: return "\u{f717}"
        case .remoteDesktopControlBold: return "\u{f718}"
        case .remoteDesktopControlFilled: return "\u{f719}"
        case .remoteDesktopControlLight: return "\u{f71a}"
        case .remoteDesktopControlRegular: return "\u{f71b}"
        case .removeBold: return "\u{f71c}"
        case .removeFilled: return "\u{f71d}"
        case .removeLight: return "\u{f71e}"
        case .removeRegular: return "\u{f71f}"
        case .replyBold: return "\u{f720}"
        case .replyFilled: return "\u{f721}"
        case .replyLight: return "\u{f722}"
        case .replyListBold: return "\u{f723}"
        case .replyListLight: return "\u{f724}"
        case .replyListRegular: return "\u{f725}"
        case .replyRegular: return "\u{f726}"
        case .resetBold: return "\u{f727}"
        case .resetLight: return "\u{f728}"
        case .resetRegular: return "\u{f729}"
        case .responsiveMobileBold: return "\u{f72a}"
        case .responsiveMobileLight: return "\u{f72b}"
        case .responsiveMobileRegular: return "\u{f72c}"
        case .restartBold: return "\u{f72d}"
        case .restartLight: return "\u{f72e}"
        case .restartRegular: return "\u{f72f}"
        case .returnBold: return "\u{f730}"
        case .returnLight: return "\u{f731}"
        case .returnRegular: return "\u{f732}"
        case .ringtoneBold: return "\u{f733}"
        case .ringtoneLight: return "\u{f734}"
        case .ringtoneRegular: return "\u{f735}"
        case .roomCalendarBold: return "\u{f736}"
        case .roomCalendarLight: return "\u{f737}"
        case .roomCalendarRegular: return "\u{f738}"
        case .roomLightsBold: return "\u{f739}"
        case .roomLightsLight: return "\u{f73a}"
        case .roomLightsRegular: return "\u{f73b}"
        case .rotateContentBold: return "\u{f73c}"
        case .rotateContentFilled: return "\u{f73d}"
        case .rotateContentLight: return "\u{f73e}"
        case .rotateContentRegular: return "\u{f73f}"
        case .runningApplicationBold: return "\u{f740}"
        case .runningApplicationFilled: return "\u{f741}"
        case .runningApplicationLight: return "\u{f742}"
        case .runningApplicationRegular: return "\u{f743}"
        case .saveBold: return "\u{f744}"
        case .saveLight: return "\u{f745}"
        case .saveRegular: return "\u{f746}"
        case .scanBold: return "\u{f747}"
        case .scanLight: return "\u{f748}"
        case .scanRegular: return "\u{f749}"
        case .schedulerAvailableBold: return "\u{f74a}"
        case .schedulerAvailableLight: return "\u{f74b}"
        case .schedulerAvailableRegular: return "\u{f74c}"
        case .schedulerNotWorkingHoursBold: return "\u{f74d}"
        case .schedulerNotWorkingHoursLight: return "\u{f74e}"
        case .schedulerNotWorkingHoursRegular: return "\u{f74f}"
        case .schedulerUnavailableBold: return "\u{f750}"
        case .schedulerUnavailableLight: return "\u{f751}"
        case .schedulerUnavailableRegular: return "\u{f752}"
        case .schedulerUnknownBold: return "\u{f753}"
        case .schedulerUnknownLight: return "\u{f754}"
        case .schedulerUnknownRegular: return "\u{f755}"
        case .screenshotBold: return "\u{f756}"
        case .screenshotDocBold: return "\u{f757}"
        case .screenshotDocFilled: return "\u{f758}"
        case .screenshotDocLight: return "\u{f759}"
        case .screenshotDocRegular: return "\u{f75a}"
        case .screenshotLight: return "\u{f75b}"
        case .screenshotRegular: return "\u{f75c}"
        case .searchBold: return "\u{f75d}"
        case .searchLight: return "\u{f75e}"
        case .searchRegular: return "\u{f75f}"
        case .secondaryArrowBold: return "\u{f760}"
        case .secondaryArrowLight: return "\u{f761}"
        case .secondaryArrowRegular: return "\u{f762}"
        case .secureCallLockBold: return "\u{f763}"
        case .secureCallLockFilled: return "\u{f764}"
        case .secureCallLockLight: return "\u{f765}"
        case .secureCallLockRegular: return "\u{f766}"
        case .secureCallShieldBold: return "\u{f767}"
        case .secureCallShieldFilled: return "\u{f768}"
        case .secureCallShieldLight: return "\u{f769}"
        case .secureCallShieldRegular: return "\u{f76a}"
        case .secureCircleBold: return "\u{f76b}"
        case .secureCircleFilled: return "\u{f76c}"
        case .secureCircleLight: return "\u{f76d}"
        case .secureCircleRegular: return "\u{f76e}"
        case .secureLockBold: return "\u{f76f}"
        case .secureLockFilled: return "\u{f770}"
        case .secureLockLight: return "\u{f771}"
        case .secureLockRegular: return "\u{f772}"
        case .selectAllBold: return "\u{f773}"
        case .selectAllFilled: return "\u{f774}"
        case .selectAllLight: return "\u{f775}"
        case .selectAllRegular: return "\u{f776}"
        case .selectionBold: return "\u{f777}"
        case .selectionLight: return "\u{f778}"
        case .selectionRegular: return "\u{f779}"
        case .sendBold: return "\u{f77a}"
        case .sendFilled: return "\u{f77b}"
        case .sendLight: return "\u{f77c}"
        case .sendRegular: return "\u{f77d}"
        case .serverBold: return "\u{f77e}"
        case .serverErrorBold: return "\u{f77f}"
        case .serverErrorLight: return "\u{f780}"
        case .serverErrorRegular: return "\u{f781}"
        case .serverLight: return "\u{f782}"
        case .serverRegular: return "\u{f783}"
        case .servicesBold: return "\u{f784}"
        case .servicesLight: return "\u{f785}"
        case .servicesRegular: return "\u{f786}"
        case .setVariableBold: return "\u{f787}"
        case .setVariableLight: return "\u{f788}"
        case .setVariableRegular: return "\u{f789}"
        case .settingsBold: return "\u{f78a}"
        case .settingsFilled: return "\u{f78b}"
        case .settingsLight: return "\u{f78c}"
        case .settingsRegular: return "\u{f78d}"
        case .setupAssistantBold: return "\u{f78e}"
        case .setupAssistantLight: return "\u{f78f}"
        case .setupAssistantRegular: return "\u{f790}"
        case .shapeDiagonalLineBold: return "\u{f791}"
        case .shapeDiagonalLineLight: return "\u{f792}"
        case .shapeDiagonalLineRegular: return "\u{f793}"
        case .shapeOvalBold: return "\u{f794}"
        case .shapeOvalLight: return "\u{f795}"
        case .shapeOvalRegular: return "\u{f796}"
        case .shapesBold: return "\u{f797}"
        case .shapesLight: return "\u{f798}"
        case .shapesRegular: return "\u{f799}"
        case .shareCNativeAdrBold: return "\u{f79a}"
        case .shareCNativeAdrLight: return "\u{f79b}"
        case .shareCNativeAdrRegular: return "\u{f79c}"
        case .shareCNativeIphBold: return "\u{f79d}"
        case .shareCNativeIphLight: return "\u{f79e}"
        case .shareCNativeIphRegular: return "\u{f79f}"
        case .shareScreenBold: return "\u{f7a0}"
        case .shareScreenFilled: return "\u{f7a1}"
        case .shareScreenLight: return "\u{f7a2}"
        case .shareScreenRegular: return "\u{f7a3}"
        case .shareScreenSmallFilled: return "\u{f7a4}"
        case .shareSpaceBold: return "\u{f7a5}"
        case .shareSpaceLight: return "\u{f7a6}"
        case .shareSpaceRegular: return "\u{f7a7}"
        case .shieldBold: return "\u{f7a8}"
        case .shieldLight: return "\u{f7a9}"
        case .shieldRegular: return "\u{f7aa}"
        case .showBold: return "\u{f7ab}"
        case .showFilled: return "\u{f7ac}"
        case .showLight: return "\u{f7ad}"
        case .showRegular: return "\u{f7ae}"
        case .signInBold: return "\u{f7af}"
        case .signInForcedBold: return "\u{f7b0}"
        case .signInForcedLight: return "\u{f7b1}"
        case .signInForcedRegular: return "\u{f7b2}"
        case .signInLight: return "\u{f7b3}"
        case .signInRegular: return "\u{f7b4}"
        case .signOutBold: return "\u{f7b5}"
        case .signOutLight: return "\u{f7b6}"
        case .signOutRegular: return "\u{f7b7}"
        case .signal0Bold: return "\u{f7b8}"
        case .signal0Light: return "\u{f7b9}"
        case .signal0Regular: return "\u{f7ba}"
        case .signal100Bold: return "\u{f7bb}"
        case .signal100Light: return "\u{f7bc}"
        case .signal100Regular: return "\u{f7bd}"
        case .signal25Bold: return "\u{f7be}"
        case .signal25Light: return "\u{f7bf}"
        case .signal25Regular: return "\u{f7c0}"
        case .signal50Bold: return "\u{f7c1}"
        case .signal50Light: return "\u{f7c2}"
        case .signal50Regular: return "\u{f7c3}"
        case .signal75Bold: return "\u{f7c4}"
        case .signal75Light: return "\u{f7c5}"
        case .signal75Regular: return "\u{f7c6}"
        case .singleNumberReachBold: return "\u{f7c7}"
        case .singleNumberReachLight: return "\u{f7c8}"
        case .singleNumberReachRegular: return "\u{f7c9}"
        case .sipRegistrationInProgressBold: return "\u{f7ca}"
        case .sipRegistrationInProgressFilled: return "\u{f7cb}"
        case .sipRegistrationInProgressLight: return "\u{f7cc}"
        case .sipRegistrationInProgressRegular: return "\u{f7cd}"
        case .skipBold: return "\u{f7ce}"
        case .skipBwBold: return "\u{f7cf}"
        case .skipBwFilled: return "\u{f7d0}"
        case .skipBwLight: return "\u{f7d1}"
        case .skipBwRegular: return "\u{f7d2}"
        case .skipFwBold: return "\u{f7d3}"
        case .skipFwFilled: return "\u{f7d4}"
        case .skipFwLight: return "\u{f7d5}"
        case .skipFwRegular: return "\u{f7d6}"
        case .skipLight: return "\u{f7d7}"
        case .skipRegular: return "\u{f7d8}"
        case .speakerBold: return "\u{f7d9}"
        case .speakerDisconnectedBold: return "\u{f7da}"
        case .speakerDisconnectedFilled: return "\u{f7db}"
        case .speakerDisconnectedLight: return "\u{f7dc}"
        case .speakerDisconnectedRegular: return "\u{f7dd}"
        case .speakerFilled: return "\u{f7de}"
        case .speakerLight: return "\u{f7df}"
        case .speakerMutedBold: return "\u{f7e0}"
        case .speakerMutedFilled: return "\u{f7e1}"
        case .speakerMutedLight: return "\u{f7e2}"
        case .speakerMutedRegular: return "\u{f7e3}"
        case .speakerOffBold: return "\u{f7e4}"
        case .speakerOffFilled: return "\u{f7e5}"
        case .speakerOffLight: return "\u{f7e6}"
        case .speakerOffRegular: return "\u{f7e7}"
        case .speakerOnColoredBold: return "\u{f7e8}"
        case .speakerOnColoredLight: return "\u{f7e9}"
        case .speakerOnColoredRegular: return "\u{f7ea}"
        case .speakerRegular: return "\u{f7eb}"
        case .speakerTurnDownBold: return "\u{f7ec}"
        case .speakerTurnDownFilled: return "\u{f7ed}"
        case .speakerTurnDownLight: return "\u{f7ee}"
        case .speakerTurnDownRegular: return "\u{f7ef}"
        case .speakerTurnUpBold: return "\u{f7f0}"
        case .speakerTurnUpFilled: return "\u{f7f1}"
        case .speakerTurnUpLight: return "\u{f7f2}"
        case .speakerTurnUpRegular: return "\u{f7f3}"
        case .spinnerBold: return "\u{f7f4}"
        case .spinnerFilledBold: return "\u{f7f5}"
        case .spinnerFilledLight: return "\u{f7f6}"
        case .spinnerFilledRegular: return "\u{f7f7}"
        case .spinnerLight: return "\u{f7f8}"
        case .spinnerRegular: return "\u{f7f9}"
        case .stackedArea100ChartBold: return "\u{f7fa}"
        case .stackedArea100ChartFilled: return "\u{f7fb}"
        case .stackedArea100ChartLight: return "\u{f7fc}"
        case .stackedArea100ChartRegular: return "\u{f7fd}"
        case .stackedAreaChartBold: return "\u{f7fe}"
        case .stackedAreaChartFilled: return "\u{f7ff}"
        case .stackedAreaChartLight: return "\u{f800}"
        case .stackedAreaChartRegular: return "\u{f801}"
        case .stackedBar100ChartBold: return "\u{f802}"
        case .stackedBar100ChartFilled: return "\u{f803}"
        case .stackedBar100ChartLight: return "\u{f804}"
        case .stackedBar100ChartRegular: return "\u{f805}"
        case .stackedBarChartBold: return "\u{f806}"
        case .stackedBarChartFilled: return "\u{f807}"
        case .stackedBarChartLight: return "\u{f808}"
        case .stackedBarChartRegular: return "\u{f809}"
        case .startChatBold: return "\u{f80a}"
        case .startChatLight: return "\u{f80b}"
        case .startChatRegular: return "\u{f80c}"
        case .stickersBold: return "\u{f80d}"
        case .stickersLight: return "\u{f80e}"
        case .stickersRegular: return "\u{f80f}"
        case .stickiesBold: return "\u{f810}"
        case .stickiesLight: return "\u{f811}"
        case .stickiesRegular: return "\u{f812}"
        case .stopBold: return "\u{f813}"
        case .stopCircleBold: return "\u{f814}"
        case .stopCircleFilled: return "\u{f815}"
        case .stopCircleLight: return "\u{f816}"
        case .stopCircleRegular: return "\u{f817}"
        case .stopContentShareBold: return "\u{f818}"
        case .stopContentShareLight: return "\u{f819}"
        case .stopContentShareRegular: return "\u{f81a}"
        case .stopFilled: return "\u{f81b}"
        case .stopLight: return "\u{f81c}"
        case .stopRegular: return "\u{f81d}"
        case .storedInfoBold: return "\u{f81e}"
        case .storedInfoFilled: return "\u{f81f}"
        case .storedInfoLight: return "\u{f820}"
        case .storedInfoRegular: return "\u{f821}"
        case .streamingBold: return "\u{f822}"
        case .streamingLight: return "\u{f823}"
        case .streamingRegular: return "\u{f824}"
        case .strikethroughBold: return "\u{f825}"
        case .strikethroughLight: return "\u{f826}"
        case .strikethroughRegular: return "\u{f827}"
        case .subscriptBold: return "\u{f828}"
        case .subscriptLight: return "\u{f829}"
        case .subscriptRegular: return "\u{f82a}"
        case .superscriptBold: return "\u{f82b}"
        case .superscriptLight: return "\u{f82c}"
        case .superscriptRegular: return "\u{f82d}"
        case .sx10Bold: return "\u{f82e}"
        case .sx10Light: return "\u{f82f}"
        case .sx10Regular: return "\u{f830}"
        case .sx20Bold: return "\u{f831}"
        case .sx20Light: return "\u{f832}"
        case .sx20Regular: return "\u{f833}"
        case .sx80CodecBold: return "\u{f834}"
        case .sx80CodecLight: return "\u{f835}"
        case .sx80CodecRegular: return "\u{f836}"
        case .tableBold: return "\u{f837}"
        case .tableLight: return "\u{f838}"
        case .tableRegular: return "\u{f839}"
        case .tabletBold: return "\u{f83a}"
        case .tabletLight: return "\u{f83b}"
        case .tabletRegular: return "\u{f83c}"
        case .tabsBold: return "\u{f83d}"
        case .tabsLight: return "\u{f83e}"
        case .tabsRegular: return "\u{f83f}"
        case .tagBold: return "\u{f840}"
        case .tagLight: return "\u{f841}"
        case .tagRegular: return "\u{f842}"
        case .telepresenceAlertBold: return "\u{f843}"
        case .telepresenceAlertLight: return "\u{f844}"
        case .telepresenceAlertMutedBold: return "\u{f845}"
        case .telepresenceAlertMutedLight: return "\u{f846}"
        case .telepresenceAlertMutedRegular: return "\u{f847}"
        case .telepresenceAlertRegular: return "\u{f848}"
        case .telepresenceBold: return "\u{f849}"
        case .telepresenceIx5000Bold: return "\u{f84a}"
        case .telepresenceIx5000Light: return "\u{f84b}"
        case .telepresenceIx5000Regular: return "\u{f84c}"
        case .telepresenceLight: return "\u{f84d}"
        case .telepresencePrivateBold: return "\u{f84e}"
        case .telepresencePrivateLight: return "\u{f84f}"
        case .telepresencePrivateRegular: return "\u{f850}"
        case .telepresenceRegular: return "\u{f851}"
        case .temperatureBold: return "\u{f852}"
        case .temperatureLight: return "\u{f853}"
        case .temperatureRegular: return "\u{f854}"
        case .textBold: return "\u{f855}"
        case .textCodeBlockBold: return "\u{f856}"
        case .textCodeBlockLight: return "\u{f857}"
        case .textCodeBlockRegular: return "\u{f858}"
        case .textHighlightBold: return "\u{f859}"
        case .textHighlightLight: return "\u{f85a}"
        case .textHighlightRegular: return "\u{f85b}"
        case .textLight: return "\u{f85c}"
        case .textRegular: return "\u{f85d}"
        case .threeDObjectBold: return "\u{f85e}"
        case .threeDObjectLight: return "\u{f85f}"
        case .threeDObjectRegular: return "\u{f860}"
        case .tooFastBold: return "\u{f861}"
        case .tooFastLight: return "\u{f862}"
        case .tooFastRegular: return "\u{f863}"
        case .tooSlowBold: return "\u{f864}"
        case .tooSlowLight: return "\u{f865}"
        case .tooSlowRegular: return "\u{f866}"
        case .toolsBold: return "\u{f867}"
        case .toolsLight: return "\u{f868}"
        case .toolsRegular: return "\u{f869}"
        case .touch10Bold: return "\u{f86a}"
        case .touch10Light: return "\u{f86b}"
        case .touch10Regular: return "\u{f86c}"
        case .transcriptBold: return "\u{f86d}"
        case .transcriptLight: return "\u{f86e}"
        case .transcriptRegular: return "\u{f86f}"
        case .ucmCloudBold: return "\u{f870}"
        case .ucmCloudLight: return "\u{f871}"
        case .ucmCloudRegular: return "\u{f872}"
        case .underlineBold: return "\u{f873}"
        case .underlineLight: return "\u{f874}"
        case .underlineRegular: return "\u{f875}"
        case .undoBold: return "\u{f876}"
        case .undoLight: return "\u{f877}"
        case .undoRegular: return "\u{f878}"
        case .unlinkBold: return "\u{f879}"
        case .unlinkLight: return "\u{f87a}"
        case .unlinkRegular: return "\u{f87b}"
        case .unreadBold: return "\u{f87c}"
        case .unreadFilled: return "\u{f87d}"
        case .unreadLight: return "\u{f87e}"
        case .unreadRegular: return "\u{f87f}"
        case .unsecureUnlockedBold: return "\u{f880}"
        case .unsecureUnlockedFilled: return "\u{f881}"
        case .unsecureUnlockedLight: return "\u{f882}"
        case .unsecureUnlockedRegular: return "\u{f883}"
        case .unsortedBold: return "\u{f884}"
        case .unsortedLight: return "\u{f885}"
        case .unsortedRegular: return "\u{f886}"
        case .updateFileShareBold: return "\u{f887}"
        case .updateFileShareLight: return "\u{f888}"
        case .updateFileShareRegular: return "\u{f889}"
        case .upgradeBold: return "\u{f88a}"
        case .upgradeFilled: return "\u{f88b}"
        case .upgradeLight: return "\u{f88c}"
        case .upgradeRegular: return "\u{f88d}"
        case .uploadBold: return "\u{f88e}"
        case .uploadLight: return "\u{f88f}"
        case .uploadRegular: return "\u{f890}"
        case .usbBold: return "\u{f891}"
        case .usbHeadsetBold: return "\u{f892}"
        case .usbHeadsetLight: return "\u{f893}"
        case .usbHeadsetMutedBold: return "\u{f894}"
        case .usbHeadsetMutedLight: return "\u{f895}"
        case .usbHeadsetMutedRegular: return "\u{f896}"
        case .usbHeadsetRegular: return "\u{f897}"
        case .usbLight: return "\u{f898}"
        case .usbRegular: return "\u{f899}"
        case .userBold: return "\u{f89a}"
        case .userLight: return "\u{f89b}"
        case .userRegular: return "\u{f89c}"
        case .vcsBold: return "\u{f89d}"
        case .vcsLight: return "\u{f89e}"
        case .vcsRegular: return "\u{f89f}"
        case .videoBlurBold: return "\u{f8a0}"
        case .videoBlurFilled: return "\u{f8a1}"
        case .videoBlurLight: return "\u{f8a2}"
        case .videoBlurRegular: return "\u{f8a3}"
        case .videoBold: return "\u{f8a4}"
        case .videoEffectBold: return "\u{f8a5}"
        case .videoEffectFilled: return "\u{f8a6}"
        case .videoEffectLight: return "\u{f8a7}"
        case .videoEffectRegular: return "\u{f8a8}"
        case .videoFilled: return "\u{f8a9}"
        case .videoLayoutBold: return "\u{f8aa}"
        case .videoLayoutEqualBold: return "\u{f8ab}"
        case .videoLayoutEqualDualBold: return "\u{f8ac}"
        case .videoLayoutEqualDualLight: return "\u{f8ad}"
        case .videoLayoutEqualDualRegular: return "\u{f8ae}"
        case .videoLayoutEqualFilled: return "\u{f8af}"
        case .videoLayoutEqualLight: return "\u{f8b0}"
        case .videoLayoutEqualRegular: return "\u{f8b1}"
        case .videoLayoutLight: return "\u{f8b2}"
        case .videoLayoutOverlayBold: return "\u{f8b3}"
        case .videoLayoutOverlayLight: return "\u{f8b4}"
        case .videoLayoutOverlayRegular: return "\u{f8b5}"
        case .videoLayoutProminentBold: return "\u{f8b6}"
        case .videoLayoutProminentLight: return "\u{f8b7}"
        case .videoLayoutProminentRegular: return "\u{f8b8}"
        case .videoLayoutRegular: return "\u{f8b9}"
        case .videoLayoutShareDominantBold: return "\u{f8ba}"
        case .videoLayoutShareDominantLight: return "\u{f8bb}"
        case .videoLayoutShareDominantRegular: return "\u{f8bc}"
        case .videoLayoutSingleBold: return "\u{f8bd}"
        case .videoLayoutSingleFilled: return "\u{f8be}"
        case .videoLayoutSingleLight: return "\u{f8bf}"
        case .videoLayoutSingleRegular: return "\u{f8c0}"
        case .videoLayoutStackBold: return "\u{f8c1}"
        case .videoLayoutStackFilled: return "\u{f8c2}"
        case .videoLayoutStackLight: return "\u{f8c3}"
        case .videoLayoutStackRegular: return "\u{f8c4}"
        case .videoLayoutVideoDominantBold: return "\u{f8c5}"
        case .videoLayoutVideoDominantLight: return "\u{f8c6}"
        case .videoLayoutVideoDominantRegular: return "\u{f8c7}"
        case .videoLight: return "\u{f8c8}"
        case .videoPlusBold: return "\u{f8c9}"
        case .videoPlusFilled: return "\u{f8ca}"
        case .videoPlusLight: return "\u{f8cb}"
        case .videoPlusRegular: return "\u{f8cc}"
        case .videoRegular: return "\u{f8cd}"
        case .videoSpeakerTrackBold: return "\u{f8ce}"
        case .videoSpeakerTrackFilled: return "\u{f8cf}"
        case .videoSpeakerTrackLight: return "\u{f8d0}"
        case .videoSpeakerTrackRegular: return "\u{f8d1}"
        case .viewAllBold: return "\u{f8d2}"
        case .viewAllLight: return "\u{f8d3}"
        case .viewAllRegular: return "\u{f8d4}"
        case .viewListBold: return "\u{f8d5}"
        case .viewListLight: return "\u{f8d6}"
        case .viewListRegular: return "\u{f8d7}"
        case .viewStackedBold: return "\u{f8d8}"
        case .viewStackedLight: return "\u{f8d9}"
        case .viewStackedRegular: return "\u{f8da}"
        case .viewThumbnailBold: return "\u{f8db}"
        case .viewThumbnailLight: return "\u{f8dc}"
        case .viewThumbnailRegular: return "\u{f8dd}"
        case .voicemailBold: return "\u{f8de}"
        case .voicemailFilled: return "\u{f8df}"
        case .voicemailLight: return "\u{f8e0}"
        case .voicemailRegular: return "\u{f8e1}"
        case .wallpaperBold: return "\u{f8e2}"
        case .wallpaperLight: return "\u{f8e3}"
        case .wallpaperRegular: return "\u{f8e4}"
        case .warningBadgeFilled: return "\u{f8e5}"
        case .warningBold: return "\u{f8e6}"
        case .warningFilled: return "\u{f8e7}"
        case .warningLight: return "\u{f8e8}"
        case .warningRegular: return "\u{f8e9}"
        case .webexBoardBold: return "\u{f8ea}"
        case .webexBoardLight: return "\u{f8eb}"
        case .webexBoardRegular: return "\u{f8ec}"
        case .webexCodecPlusBold: return "\u{f8ed}"
        case .webexCodecPlusLight: return "\u{f8ee}"
        case .webexCodecPlusRegular: return "\u{f8ef}"
        case .webexDeskCameraBold: return "\u{f8f0}"
        case .webexDeskCameraLight: return "\u{f8f1}"
        case .webexDeskCameraRegular: return "\u{f8f2}"
        case .webexHelixFilled: return "\u{f8f3}"
        case .webexMeetingsBold: return "\u{f8f4}"
        case .webexMeetingsFilled: return "\u{f8f5}"
        case .webexMeetingsLight: return "\u{f8f6}"
        case .webexMeetingsRegular: return "\u{f8f7}"
        case .webexQuadCameraBold: return "\u{f8f8}"
        case .webexQuadCameraLight: return "\u{f8f9}"
        case .webexQuadCameraRegular: return "\u{f8fa}"
        case .webexRoomKitBold: return "\u{f8fb}"
        case .webexRoomKitLight: return "\u{f8fc}"
        case .webexRoomKitPlusBold: return "\u{f8fd}"
        case .webexRoomKitPlusLight: return "\u{f8fe}"
        case .webexRoomKitPlusRegular: return "\u{f8ff}"
        case .webexRoomKitRegular: return "\u{f900}"
        case .webexShareBold: return "\u{f901}"
        case .webexShareLight: return "\u{f902}"
        case .webexShareRegular: return "\u{f903}"
        case .webexTeamsBold: return "\u{f904}"
        case .webexTeamsFilled: return "\u{f905}"
        case .webexTeamsLight: return "\u{f906}"
        case .webexTeamsNewBold: return "\u{f907}"
        case .webexTeamsNewFilled: return "\u{f908}"
        case .webexTeamsNewLight: return "\u{f909}"
        case .webexTeamsNewRegular: return "\u{f90a}"
        case .webexTeamsRegular: return "\u{f90b}"
        case .whiteboardBold: return "\u{f90c}"
        case .whiteboardContentBold: return "\u{f90d}"
        case .whiteboardContentLight: return "\u{f90e}"
        case .whiteboardContentRegular: return "\u{f90f}"
        case .whiteboardFilled: return "\u{f910}"
        case .whiteboardLight: return "\u{f911}"
        case .whiteboardRegular: return "\u{f912}"
        case .widgetBold: return "\u{f913}"
        case .widgetFilled: return "\u{f914}"
        case .widgetLight: return "\u{f915}"
        case .widgetRegular: return "\u{f916}"
        case .wifiBold: return "\u{f917}"
        case .wifiErrorBold: return "\u{f918}"
        case .wifiErrorLight: return "\u{f919}"
        case .wifiErrorRegular: return "\u{f91a}"
        case .wifiLight: return "\u{f91b}"
        case .wifiRegular: return "\u{f91c}"
        case .windowCornerScrubBold: return "\u{f91d}"
        case .windowCornerScrubLight: return "\u{f91e}"
        case .windowCornerScrubRegular: return "\u{f91f}"
        case .windowVerticalScrubBold: return "\u{f920}"
        case .windowVerticalScrubLight: return "\u{f921}"
        case .windowVerticalScrubRegular: return "\u{f922}"
        case .workphoneBold: return "\u{f923}"
        case .workphoneLight: return "\u{f924}"
        case .workphoneRegular: return "\u{f925}"
        case .zoomInBold: return "\u{f926}"
        case .zoomInLight: return "\u{f927}"
        case .zoomInRegular: return "\u{f928}"
        case .zoomOutBold: return "\u{f929}"
        case .zoomOutLight: return "\u{f92a}"
        case .zoomOutRegular: return "\u{f92b}"
