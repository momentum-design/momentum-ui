...
@objc public enum MomentumIconsRebrandType: Int {
    ...
    public var ligature: String {
        ...
        case .videoLayoutVideoDominantLight: return "\u{fab6}"
        case .videoLayoutVideoDominantRegular: return "\u{fab7}"
        case .videoLight: return "\u{fab8}"
        case .videoPlusBold: return "\u{fab9}"
        case .videoPlusFilled: return "\u{faba}"
        case .videoPlusLight: return "\u{fabb}"
        case .videoPlusRegular: return "\u{fabc}"
        case .videoRegular: return "\u{fabd}"
        case .videoSpeakerTrackBold: return "\u{fabe}"
        case .videoSpeakerTrackFilled: return "\u{fabf}"
        case .videoSpeakerTrackLight: return "\u{fac0}"
        case .videoSpeakerTrackRegular: return "\u{fac1}"
        case .viewAllBold: return "\u{fac2}"
        case .viewAllLight: return "\u{fac3}"
        case .viewAllRegular: return "\u{fac4}"
        case .viewListBold: return "\u{fac5}"
        case .viewListLight: return "\u{fac6}"
        case .viewListRegular: return "\u{fac7}"
        case .viewStackedBold: return "\u{fac8}"
        case .viewStackedFilled: return "\u{fac9}"
        case .viewStackedLight: return "\u{faca}"
        case .viewStackedRegular: return "\u{facb}"
        case .viewThumbnailBold: return "\u{facc}"
        case .viewThumbnailFilled: return "\u{facd}"
        case .viewThumbnailLight: return "\u{face}"
        case .viewThumbnailRegular: return "\u{facf}"
        case .voicemailBold: return "\u{fad0}"
        case .voicemailFilled: return "\u{fad1}"
        case .voicemailLight: return "\u{fad2}"
        case .voicemailRegular: return "\u{fad3}"
        case .waffleMenuBold: return "\u{fad4}"
        case .waffleMenuLight: return "\u{fad5}"
        case .waffleMenuRegular: return "\u{fad6}"
        case .waitingroomActiveBold: return "\u{fad7}"
        case .waitingroomActiveLight: return "\u{fad8}"
        case .waitingroomActiveRegular: return "\u{fad9}"
        case .wallpaperBold: return "\u{fada}"
        case .wallpaperLight: return "\u{fadb}"
        case .wallpaperRegular: return "\u{fadc}"
        case .warningBadgeFilled: return "\u{fadd}"
        case .warningBold: return "\u{fade}"
        case .warningFilled: return "\u{fadf}"
        case .warningLight: return "\u{fae0}"
        case .warningRegular: return "\u{fae1}"
        case .webexAssistantActiveColored: return "\u{fae2}"
        case .webexAssistantActive: return "\u{fae3}"
        case .webexAssistantFlat: return "\u{fae4}"
        case .webexAssistantInactiveColored: return "\u{fae5}"
        case .webexAssistantInactive: return "\u{fae6}"
        case .webexAssistant: return "\u{fae7}"
        case .webexBoardBold: return "\u{fae8}"
        case .webexBoardLight: return "\u{fae9}"
        case .webexBoardRegular: return "\u{faea}"
        case .webexCodecPlusBold: return "\u{faeb}"
        case .webexCodecPlusLight: return "\u{faec}"
        case .webexCodecPlusRegular: return "\u{faed}"
        case .webexDeskCameraBold: return "\u{faee}"
        case .webexDeskCameraLight: return "\u{faef}"
        case .webexDeskCameraRegular: return "\u{faf0}"
        case .webexHelixFilled: return "\u{faf1}"
        case .webexMeetingsBold: return "\u{faf2}"
        case .webexMeetingsFilled: return "\u{faf3}"
        case .webexMeetingsLight: return "\u{faf4}"
        case .webexMeetingsRegular: return "\u{faf5}"
        case .webexQuadCameraBold: return "\u{faf6}"
        case .webexQuadCameraLight: return "\u{faf7}"
        case .webexQuadCameraRegular: return "\u{faf8}"
        case .webexRoomKitBold: return "\u{faf9}"
        case .webexRoomKitLight: return "\u{fafa}"
        case .webexRoomKitPlusBold: return "\u{fafb}"
        case .webexRoomKitPlusLight: return "\u{fafc}"
        case .webexRoomKitPlusRegular: return "\u{fafd}"
        case .webexRoomKitRegular: return "\u{fafe}"
        case .webexShareBold: return "\u{faff}"
        case .webexShareLight: return "\u{fb00}"
        case .webexShareRegular: return "\u{fb01}"
        case .webexTeamsBold: return "\u{fb02}"
        case .webexTeamsFilled: return "\u{fb03}"
        case .webexTeamsLight: return "\u{fb04}"
        case .webexTeamsNewBold: return "\u{fb05}"
        case .webexTeamsNewFilled: return "\u{fb06}"
        case .webexTeamsNewLight: return "\u{fb07}"
        case .webexTeamsNewRegular: return "\u{fb08}"
        case .webexTeamsRegular: return "\u{fb09}"
        case .webinarBold: return "\u{fb0a}"
        case .webinarFilled: return "\u{fb0b}"
        case .webinarLight: return "\u{fb0c}"
        case .webinarRegular: return "\u{fb0d}"
        case .weeklyRecurringScheduleNodeBold: return "\u{fb0e}"
        case .weeklyRecurringScheduleNodeLight: return "\u{fb0f}"
        case .weeklyRecurringScheduleNodeRegular: return "\u{fb10}"
        case .whatsNewBold: return "\u{fb11}"
        case .whatsNewFilled: return "\u{fb12}"
        case .whatsNewLight: return "\u{fb13}"
        case .whatsNewRegular: return "\u{fb14}"
        case .whiteboardBold: return "\u{fb15}"
        case .whiteboardContentBold: return "\u{fb16}"
        case .whiteboardContentLight: return "\u{fb17}"
        case .whiteboardContentRegular: return "\u{fb18}"
        case .whiteboardFilled: return "\u{fb19}"
        case .whiteboardLight: return "\u{fb1a}"
        case .whiteboardRegular: return "\u{fb1b}"
        case .widgetBold: return "\u{fb1c}"
        case .widgetFilled: return "\u{fb1d}"
        case .widgetLight: return "\u{fb1e}"
        case .widgetRegular: return "\u{fb1f}"
        case .wifiBold: return "\u{fb20}"
        case .wifiErrorBold: return "\u{fb21}"
        case .wifiErrorLight: return "\u{fb22}"
        case .wifiErrorRegular: return "\u{fb23}"
        case .wifiLight: return "\u{fb24}"
        case .wifiRegular: return "\u{fb25}"
        case .wifiSignalGoodColoredBold: return "\u{fb26}"
        case .wifiSignalGoodColoredLight: return "\u{fb27}"
        case .wifiSignalGoodColoredRegular: return "\u{fb28}"
        case .wifiSignalPoorColoredBold: return "\u{fb29}"
        case .wifiSignalPoorColoredLight: return "\u{fb2a}"
        case .wifiSignalPoorColoredRegular: return "\u{fb2b}"
        case .wifiSignalUnstableColoredBold: return "\u{fb2c}"
        case .wifiSignalUnstableColoredLight: return "\u{fb2d}"
        case .wifiSignalUnstableColoredRegular: return "\u{fb2e}"
        case .windowCornerScrubBold: return "\u{fb2f}"
        case .windowCornerScrubLight: return "\u{fb30}"
        case .windowCornerScrubRegular: return "\u{fb31}"
        case .windowRightCornerScrubBold: return "\u{fb32}"
        case .windowRightCornerScrubLight: return "\u{fb33}"
        case .windowRightCornerScrubRegular: return "\u{fb34}"
        case .windowVerticalScrubBold: return "\u{fb35}"
        case .windowVerticalScrubLight: return "\u{fb36}"
        case .windowVerticalScrubRegular: return "\u{fb37}"
        case .workflowDeploymentsBold: return "\u{fb38}"
        case .workflowDeploymentsFilled: return "\u{fb39}"
        case .workflowDeploymentsLight: return "\u{fb3a}"
        case .workflowDeploymentsRegular: return "\u{fb3b}"
        case .workphoneBold: return "\u{fb3c}"
        case .workphoneLight: return "\u{fb3d}"
        case .workphoneRegular: return "\u{fb3e}"
        case .zoomInBold: return "\u{fb3f}"
        case .zoomInLight: return "\u{fb40}"
        case .zoomInRegular: return "\u{fb41}"
        case .zoomOutBold: return "\u{fb42}"
        case .zoomOutLight: return "\u{fb43}"
        case .zoomOutRegular: return "\u{fb44}"
        case .zoom: return "\u{fb45}"
