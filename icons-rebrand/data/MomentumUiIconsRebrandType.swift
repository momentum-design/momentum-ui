...
@objc public enum MomentumIconsRebrandType: Int {
    ...
    public var ligature: String {
        ...
        case .integrationsBold: return "\u{f5df}"
        case .integrationsLight: return "\u{f5e0}"
        case .integrationsRegular: return "\u{f5e1}"
        case .intelligentRoutingBold: return "\u{f5e2}"
        case .intelligentRoutingLight: return "\u{f5e3}"
        case .intelligentRoutingRegular: return "\u{f5e4}"
        case .invitedUserBold: return "\u{f5e5}"
        case .invitedUserLight: return "\u{f5e6}"
        case .invitedUserRegular: return "\u{f5e7}"
        case .italicBold: return "\u{f5e8}"
        case .italicLight: return "\u{f5e9}"
        case .italicRegular: return "\u{f5ea}"
        case .joinAudioBold: return "\u{f5eb}"
        case .joinAudioFilled: return "\u{f5ec}"
        case .joinAudioLight: return "\u{f5ed}"
        case .joinAudioRegular: return "\u{f5ee}"
        case .keepInTouchBold: return "\u{f5ef}"
        case .keepInTouchFilled: return "\u{f5f0}"
        case .keepInTouchLight: return "\u{f5f1}"
        case .keepInTouchRegular: return "\u{f5f2}"
        case .keyboardBold: return "\u{f5f3}"
        case .keyboardCloseBold: return "\u{f5f4}"
        case .keyboardCloseLight: return "\u{f5f5}"
        case .keyboardCloseRegular: return "\u{f5f6}"
        case .keyboardLight: return "\u{f5f7}"
        case .keyboardRegular: return "\u{f5f8}"
        case .languageBold: return "\u{f5f9}"
        case .languageLight: return "\u{f5fa}"
        case .languageRegular: return "\u{f5fb}"
        case .laptopBold: return "\u{f5fc}"
        case .laptopDisconnectedBold: return "\u{f5fd}"
        case .laptopDisconnectedLight: return "\u{f5fe}"
        case .laptopDisconnectedRegular: return "\u{f5ff}"
        case .laptopFilled: return "\u{f600}"
        case .laptopLight: return "\u{f601}"
        case .laptopRegular: return "\u{f602}"
        case .laserPointerBold: return "\u{f603}"
        case .laserPointerLight: return "\u{f604}"
        case .laserPointerRegular: return "\u{f605}"
        case .launchBold: return "\u{f606}"
        case .launchLight: return "\u{f607}"
        case .launchRegular: return "\u{f608}"
        case .layoutSideBySideVerticalBold: return "\u{f609}"
        case .layoutSideBySideVerticalFilled: return "\u{f60a}"
        case .layoutSideBySideVerticalLight: return "\u{f60b}"
        case .layoutSideBySideVerticalRegular: return "\u{f60c}"
        case .leaveBreakoutSessionBold: return "\u{f60d}"
        case .leaveBreakoutSessionLight: return "\u{f60e}"
        case .leaveBreakoutSessionRegular: return "\u{f60f}"
        case .leaveDeviceBold: return "\u{f610}"
        case .leaveDeviceLight: return "\u{f611}"
        case .leaveDeviceRegular: return "\u{f612}"
        case .lightningBold: return "\u{f613}"
        case .lightningFilled: return "\u{f614}"
        case .lightningLight: return "\u{f615}"
        case .lightningRegular: return "\u{f616}"
        case .likeBold: return "\u{f617}"
        case .likeFilled: return "\u{f618}"
        case .likeLight: return "\u{f619}"
        case .likeRegular: return "\u{f61a}"
        case .linkBold: return "\u{f61b}"
        case .linkLight: return "\u{f61c}"
        case .linkRegular: return "\u{f61d}"
        case .listBulletedBold: return "\u{f61e}"
        case .listBulletedLight: return "\u{f61f}"
        case .listBulletedRegular: return "\u{f620}"
        case .listMenuBold: return "\u{f621}"
        case .listMenuLight: return "\u{f622}"
        case .listMenuRegular: return "\u{f623}"
        case .listNumberedBold: return "\u{f624}"
        case .listNumberedLight: return "\u{f625}"
        case .listNumberedRegular: return "\u{f626}"
        case .locationBold: return "\u{f627}"
        case .locationFilled: return "\u{f628}"
        case .locationLight: return "\u{f629}"
        case .locationRegular: return "\u{f62a}"
        case .longTextBoxBold: return "\u{f62b}"
        case .longTextBoxLight: return "\u{f62c}"
        case .longTextBoxRegular: return "\u{f62d}"
        case .lowerHandBold: return "\u{f62e}"
        case .lowerHandLight: return "\u{f62f}"
        case .lowerHandRegular: return "\u{f630}"
        case .magicPenBold: return "\u{f631}"
        case .magicPenFilled: return "\u{f632}"
        case .magicPenLight: return "\u{f633}"
        case .magicPenRegular: return "\u{f634}"
        case .markAsUnreadBold: return "\u{f635}"
        case .markAsUnreadLight: return "\u{f636}"
        case .markAsUnreadRegular: return "\u{f637}"
        case .markdownBold: return "\u{f638}"
        case .markdownLight: return "\u{f639}"
        case .markdownRegular: return "\u{f63a}"
        case .markerBold: return "\u{f63b}"
        case .markerFilled: return "\u{f63c}"
        case .markerLight: return "\u{f63d}"
        case .markerRegular: return "\u{f63e}"
        case .maximizeBold: return "\u{f63f}"
        case .maximizeLight: return "\u{f640}"
        case .maximizeRegular: return "\u{f641}"
        case .mediaPlayerBold: return "\u{f642}"
        case .mediaPlayerLight: return "\u{f643}"
        case .mediaPlayerRegular: return "\u{f644}"
        case .mediaQualityGoodBold: return "\u{f645}"
        case .mediaQualityGoodFilled: return "\u{f646}"
        case .mediaQualityGoodLight: return "\u{f647}"
        case .mediaQualityGoodRegular: return "\u{f648}"
        case .mediaQualityPoorBold: return "\u{f649}"
        case .mediaQualityPoorFilled: return "\u{f64a}"
        case .mediaQualityPoorLight: return "\u{f64b}"
        case .mediaQualityPoorRegular: return "\u{f64c}"
        case .mediaQualityUnstableBold: return "\u{f64d}"
        case .mediaQualityUnstableFilled: return "\u{f64e}"
        case .mediaQualityUnstableLight: return "\u{f64f}"
        case .mediaQualityUnstableRegular: return "\u{f650}"
        case .mediumQualityGoodFilled: return "\u{f651}"
        case .mediumQualityPoorFilled: return "\u{f652}"
        case .mediumQualityUnstableFilled: return "\u{f653}"
        case .meetBold: return "\u{f654}"
        case .meetEndBold: return "\u{f655}"
        case .meetEndLight: return "\u{f656}"
        case .meetEndRegular: return "\u{f657}"
        case .meetFilled: return "\u{f658}"
        case .meetLight: return "\u{f659}"
        case .meetRegular: return "\u{f65a}"
        case .meetingsBold: return "\u{f65b}"
        case .meetingsFilled: return "\u{f65c}"
        case .meetingsFocusMonthBold: return "\u{f65d}"
        case .meetingsFocusMonthLight: return "\u{f65e}"
        case .meetingsFocusMonthRegular: return "\u{f65f}"
        case .meetingsFocusOneDayBold: return "\u{f660}"
        case .meetingsFocusOneDayLight: return "\u{f661}"
        case .meetingsFocusOneDayRegular: return "\u{f662}"
        case .meetingsFocusThreeDayBold: return "\u{f663}"
        case .meetingsFocusThreeDayLight: return "\u{f664}"
        case .meetingsFocusThreeDayRegular: return "\u{f665}"
        case .meetingsFocusUpcomingBold: return "\u{f666}"
        case .meetingsFocusUpcomingLight: return "\u{f667}"
        case .meetingsFocusUpcomingRegular: return "\u{f668}"
        case .meetingsFocusWeekBold: return "\u{f669}"
        case .meetingsFocusWeekLight: return "\u{f66a}"
        case .meetingsFocusWeekRegular: return "\u{f66b}"
        case .meetingsLight: return "\u{f66c}"
        case .meetingsPresenceBold: return "\u{f66d}"
        case .meetingsPresenceFilled: return "\u{f66e}"
        case .meetingsPresenceLight: return "\u{f66f}"
        case .meetingsPresenceRegular: return "\u{f670}"
        case .meetingsPresenceSmallFilled: return "\u{f671}"
        case .meetingsRegular: return "\u{f672}"
        case .meetingsTeamActiveBold: return "\u{f673}"
        case .meetingsTeamActiveLight: return "\u{f674}"
        case .meetingsTeamActiveRegular: return "\u{f675}"
        case .meetingsTeamBold: return "\u{f676}"
        case .meetingsTeamLight: return "\u{f677}"
        case .meetingsTeamNewBold: return "\u{f678}"
        case .meetingsTeamNewLight: return "\u{f679}"
        case .meetingsTeamNewRegular: return "\u{f67a}"
        case .meetingsTeamRegular: return "\u{f67b}"
        case .mentionBold: return "\u{f67c}"
        case .mentionLight: return "\u{f67d}"
        case .mentionRegular: return "\u{f67e}"
        case .messageQueingBold: return "\u{f67f}"
        case .messageQueingLight: return "\u{f680}"
        case .messageQueingRegular: return "\u{f681}"
        case .microphoneBold: return "\u{f682}"
        case .microphoneFilled: return "\u{f683}"
        case .microphoneHardMutedBold: return "\u{f684}"
        case .microphoneHardMutedColoredBold: return "\u{f685}"
        case .microphoneHardMutedColoredLight: return "\u{f686}"
        case .microphoneHardMutedColoredRegular: return "\u{f687}"
        case .microphoneHardMutedLight: return "\u{f688}"
        case .microphoneHardMutedRegular: return "\u{f689}"
        case .microphoneLight: return "\u{f68a}"
        case .microphoneMusicModeColoredBold: return "\u{f68b}"
        case .microphoneMusicModeColoredLight: return "\u{f68c}"
        case .microphoneMusicModeColoredRegular: return "\u{f68d}"
        case .microphoneMutedBold: return "\u{f68e}"
        case .microphoneMutedFilled: return "\u{f68f}"
        case .microphoneMutedIndicatorFilled: return "\u{f690}"
        case .microphoneMutedLight: return "\u{f691}"
        case .microphoneMutedRedBold: return "\u{f692}"
        case .microphoneMutedRedFilled: return "\u{f693}"
        case .microphoneMutedRedLight: return "\u{f694}"
        case .microphoneMutedRedRegular: return "\u{f695}"
        case .microphoneMutedRegular: return "\u{f696}"
        case .microphoneRegular: return "\u{f697}"
        case .minimizeBold: return "\u{f698}"
        case .minimizeLight: return "\u{f699}"
        case .minimizeRegular: return "\u{f69a}"
        case .minusBold: return "\u{f69b}"
        case .minusLight: return "\u{f69c}"
        case .minusRegular: return "\u{f69d}"
        case .mirrorBold: return "\u{f69e}"
        case .mirrorFilled: return "\u{f69f}"
        case .mirrorLight: return "\u{f6a0}"
        case .mirrorRegular: return "\u{f6a1}"
        case .moderatorBold: return "\u{f6a2}"
        case .moderatorLight: return "\u{f6a3}"
        case .moderatorRegular: return "\u{f6a4}"
        case .monitoringBold: return "\u{f6a5}"
        case .monitoringLight: return "\u{f6a6}"
        case .monitoringRegular: return "\u{f6a7}"
        case .monthlyRecurringScheduleNodeBold: return "\u{f6a8}"
        case .monthlyRecurringScheduleNodeLight: return "\u{f6a9}"
        case .monthlyRecurringScheduleNodeRegular: return "\u{f6aa}"
        case .moreAdrBold: return "\u{f6ab}"
        case .moreAdrLight: return "\u{f6ac}"
        case .moreAdrRegular: return "\u{f6ad}"
        case .moreBold: return "\u{f6ae}"
        case .moreCircleBold: return "\u{f6af}"
        case .moreCircleFilled: return "\u{f6b0}"
        case .moreCircleLight: return "\u{f6b1}"
        case .moreCircleRegular: return "\u{f6b2}"
        case .moreCirecleFilled: return "\u{f6b3}"
        case .moreLight: return "\u{f6b4}"
        case .moreRegular: return "\u{f6b5}"
        case .mouseCursorBold: return "\u{f6b6}"
        case .mouseCursorLight: return "\u{f6b7}"
        case .mouseCursorRegular: return "\u{f6b8}"
        case .moveCallInAdrBold: return "\u{f6b9}"
        case .moveCallInAdrLight: return "\u{f6ba}"
        case .moveCallInAdrRegular: return "\u{f6bb}"
        case .moveCallInIphBold: return "\u{f6bc}"
        case .moveCallInIphLight: return "\u{f6bd}"
        case .moveCallInIphRegular: return "\u{f6be}"
        case .moveCallInLaptopBold: return "\u{f6bf}"
        case .moveCallInLaptopLight: return "\u{f6c0}"
        case .moveCallInLaptopRegular: return "\u{f6c1}"
        case .moveCallInOutAdrBold: return "\u{f6c2}"
        case .moveCallInOutAdrLight: return "\u{f6c3}"
        case .moveCallInOutAdrRegular: return "\u{f6c4}"
        case .moveCallInOutIphBold: return "\u{f6c5}"
        case .moveCallInOutIphLight: return "\u{f6c6}"
        case .moveCallInOutIphRegular: return "\u{f6c7}"
        case .moveCallInTabletBold: return "\u{f6c8}"
        case .moveCallInTabletLight: return "\u{f6c9}"
        case .moveCallInTabletRegular: return "\u{f6ca}"
        case .moveCallOutAdrBold: return "\u{f6cb}"
        case .moveCallOutAdrLight: return "\u{f6cc}"
        case .moveCallOutAdrRegular: return "\u{f6cd}"
        case .moveCallOutIphBold: return "\u{f6ce}"
        case .moveCallOutIphLight: return "\u{f6cf}"
        case .moveCallOutIphRegular: return "\u{f6d0}"
        case .moveCallOutLaptopBold: return "\u{f6d1}"
        case .moveCallOutLaptopLight: return "\u{f6d2}"
        case .moveCallOutLaptopRegular: return "\u{f6d3}"
        case .moveCallOutTabletBold: return "\u{f6d4}"
        case .moveCallOutTabletLight: return "\u{f6d5}"
        case .moveCallOutTabletRegular: return "\u{f6d6}"
        case .msTeams: return "\u{f6d7}"
        case .multilineChartBold: return "\u{f6d8}"
        case .multilineChartFilled: return "\u{f6d9}"
        case .multilineChartLight: return "\u{f6da}"
        case .multilineChartRegular: return "\u{f6db}"
        case .multimediaBold: return "\u{f6dc}"
        case .multimediaFilled: return "\u{f6dd}"
        case .multimediaLight: return "\u{f6de}"
        case .multimediaRegular: return "\u{f6df}"
        case .multipledDevicesBold: return "\u{f6e0}"
        case .multipledDevicesLight: return "\u{f6e1}"
        case .multipledDevicesRegular: return "\u{f6e2}"
        case .musicModeBold: return "\u{f6e3}"
        case .musicModeCircleBold: return "\u{f6e4}"
        case .musicModeCircleFilled: return "\u{f6e5}"
        case .musicModeCircleLight: return "\u{f6e6}"
        case .musicModeCircleRegular: return "\u{f6e7}"
        case .musicModeFilled: return "\u{f6e8}"
        case .musicModeLight: return "\u{f6e9}"
        case .musicModeRegular: return "\u{f6ea}"
        case .muteOnEntryBold: return "\u{f6eb}"
        case .muteOnEntryFilled: return "\u{f6ec}"
        case .muteOnEntryLight: return "\u{f6ed}"
        case .muteOnEntryRegular: return "\u{f6ee}"
        case .newManagerBold: return "\u{f6ef}"
        case .newManagerLight: return "\u{f6f0}"
        case .newManagerRegular: return "\u{f6f1}"
        case .newTitleBold: return "\u{f6f2}"
        case .newTitleLight: return "\u{f6f3}"
        case .newTitleRegular: return "\u{f6f4}"
        case .newVoicemailBold: return "\u{f6f5}"
        case .newVoicemailLight: return "\u{f6f6}"
        case .newVoicemailRegular: return "\u{f6f7}"
        case .newWhiteboardBold: return "\u{f6f8}"
        case .newWhiteboardLight: return "\u{f6f9}"
        case .newWhiteboardRegular: return "\u{f6fa}"
        case .nextBold: return "\u{f6fb}"
        case .nextLight: return "\u{f6fc}"
        case .nextRegular: return "\u{f6fd}"
        case .noDevicesBold: return "\u{f6fe}"
        case .noDevicesLight: return "\u{f6ff}"
        case .noDevicesRegular: return "\u{f700}"
        case .noiseDetectedCanceledFilled: return "\u{f701}"
        case .noiseDetectedFilled: return "\u{f702}"
        case .noiseNoneCanceledFilled: return "\u{f703}"
        case .noiseNoneFilled: return "\u{f704}"
        case .noiseRemovalBold: return "\u{f705}"
        case .noiseRemovalLight: return "\u{f706}"
        case .noiseRemovalRegular: return "\u{f707}"
        case .noteBold: return "\u{f708}"
        case .noteLight: return "\u{f709}"
        case .notePptBold: return "\u{f70a}"
        case .notePptLight: return "\u{f70b}"
        case .notePptRegular: return "\u{f70c}"
        case .noteRegular: return "\u{f70d}"
        case .notesBold: return "\u{f70e}"
        case .notesLight: return "\u{f70f}"
        case .notesRegular: return "\u{f710}"
        case .numberBold: return "\u{f711}"
        case .numberLight: return "\u{f712}"
        case .numberRegular: return "\u{f713}"
        case .oldRemoteBold: return "\u{f714}"
        case .oldRemoteLight: return "\u{f715}"
        case .oldRemoteRegular: return "\u{f716}"
        case .oldTouchBold: return "\u{f717}"
        case .oldTouchLight: return "\u{f718}"
        case .oldTouchRegular: return "\u{f719}"
        case .oneColumnBold: return "\u{f71a}"
        case .oneColumnLight: return "\u{f71b}"
        case .oneColumnRegular: return "\u{f71c}"
        case .openInFolderBold: return "\u{f71d}"
        case .openInFolderLight: return "\u{f71e}"
        case .openInFolderRegular: return "\u{f71f}"
        case .openPagesBold: return "\u{f720}"
        case .openPagesLight: return "\u{f721}"
        case .openPagesRegular: return "\u{f722}"
        case .otherNumberBold: return "\u{f723}"
        case .otherNumberLight: return "\u{f724}"
        case .otherNumberRegular: return "\u{f725}"
        case .otherNumberWarningBold: return "\u{f726}"
        case .otherNumberWarningLight: return "\u{f727}"
        case .otherNumberWarningRegular: return "\u{f728}"
        case .outgoingCallLegacyBold: return "\u{f729}"
        case .outgoingCallLegacyLight: return "\u{f72a}"
        case .outgoingCallLegacyRegular: return "\u{f72b}"
        case .overflowLeftBold: return "\u{f72c}"
        case .overflowLeftLight: return "\u{f72d}"
        case .overflowLeftRegular: return "\u{f72e}"
        case .overflowRightBold: return "\u{f72f}"
        case .overflowRightLight: return "\u{f730}"
        case .overflowRightRegular: return "\u{f731}"
        case .pairedCameraBold: return "\u{f732}"
        case .pairedCameraLight: return "\u{f733}"
        case .pairedCameraRegular: return "\u{f734}"
        case .pairedDeviceBold: return "\u{f735}"
        case .pairedDeviceLight: return "\u{f736}"
        case .pairedDeviceRegular: return "\u{f737}"
        case .pairedHandsetBold: return "\u{f738}"
        case .pairedHandsetLight: return "\u{f739}"
        case .pairedHandsetRegular: return "\u{f73a}"
        case .pairingBold: return "\u{f73b}"
        case .pairingLight: return "\u{f73c}"
        case .pairingRegular: return "\u{f73d}"
        case .parkedBold: return "\u{f73e}"
        case .parkedFilled: return "\u{f73f}"
        case .parkedLight: return "\u{f740}"
        case .parkedRegular: return "\u{f741}"
        case .parseBold: return "\u{f742}"
        case .parseLight: return "\u{f743}"
        case .parseRegular: return "\u{f744}"
        case .partialBold: return "\u{f745}"
        case .partialLight: return "\u{f746}"
        case .partialRegular: return "\u{f747}"
        case .participantAddBold: return "\u{f748}"
        case .participantAddLight: return "\u{f749}"
        case .participantAddRegular: return "\u{f74a}"
        case .participantBlockedBold: return "\u{f74b}"
        case .participantBlockedLight: return "\u{f74c}"
        case .participantBlockedRegular: return "\u{f74d}"
        case .participantBold: return "\u{f74e}"
        case .participantFilled: return "\u{f74f}"
        case .participantLight: return "\u{f750}"
        case .participantListBold: return "\u{f751}"
        case .participantListFilled: return "\u{f752}"
        case .participantListLight: return "\u{f753}"
        case .participantListRegular: return "\u{f754}"
        case .participantRegular: return "\u{f755}"
        case .participantRemoveBold: return "\u{f756}"
        case .participantRemoveLight: return "\u{f757}"
        case .participantRemoveRegular: return "\u{f758}"
        case .participantUnknownBold: return "\u{f759}"
        case .participantUnknownLight: return "\u{f75a}"
        case .participantUnknownRegular: return "\u{f75b}"
        case .passMouseBold: return "\u{f75c}"
        case .passMouseLight: return "\u{f75d}"
        case .passMouseRegular: return "\u{f75e}"
        case .pauseBold: return "\u{f75f}"
        case .pauseFilled: return "\u{f760}"
        case .pauseLight: return "\u{f761}"
        case .pauseRegular: return "\u{f762}"
        case .penBold: return "\u{f763}"
        case .penFilled: return "\u{f764}"
        case .penLight: return "\u{f765}"
        case .penRegular: return "\u{f766}"
        case .peopleBold: return "\u{f767}"
        case .peopleCircleBold: return "\u{f768}"
        case .peopleCircleFilled: return "\u{f769}"
        case .peopleCircleLight: return "\u{f76a}"
        case .peopleCircleRegular: return "\u{f76b}"
        case .peopleFilled: return "\u{f76c}"
        case .peopleInsightsFilled: return "\u{f76d}"
        case .peopleLight: return "\u{f76e}"
        case .peopleRegular: return "\u{f76f}"
        case .phoneAlertBold: return "\u{f770}"
        case .phoneAlertLight: return "\u{f771}"
        case .phoneAlertRegular: return "\u{f772}"
        case .phoneBold: return "\u{f773}"
        case .phoneFilled: return "\u{f774}"
        case .phoneLight: return "\u{f775}"
        case .phoneMutedBold: return "\u{f776}"
        case .phoneMutedLight: return "\u{f777}"
        case .phoneMutedRegular: return "\u{f778}"
        case .phonePrivateBold: return "\u{f779}"
        case .phonePrivateLight: return "\u{f77a}"
        case .phonePrivateRegular: return "\u{f77b}"
        case .phoneRegular: return "\u{f77c}"
        case .phoneReplyAllBold: return "\u{f77d}"
        case .phoneReplyAllLight: return "\u{f77e}"
        case .phoneReplyAllRegular: return "\u{f77f}"
        case .phoneReplyBold: return "\u{f780}"
        case .phoneReplyLight: return "\u{f781}"
        case .phoneReplyRegular: return "\u{f782}"
        case .phoneSmallFilled: return "\u{f783}"
        case .pickerBold: return "\u{f784}"
        case .pickerLight: return "\u{f785}"
        case .pickerRegular: return "\u{f786}"
        case .pictureInPictureBold: return "\u{f787}"
        case .pictureInPictureFilled: return "\u{f788}"
        case .pictureInPictureLight: return "\u{f789}"
        case .pictureInPictureRegular: return "\u{f78a}"
        case .pieChartBold: return "\u{f78b}"
        case .pieChartFilled: return "\u{f78c}"
        case .pieChartLight: return "\u{f78d}"
        case .pieChartRegular: return "\u{f78e}"
        case .pinBold: return "\u{f78f}"
        case .pinFilled: return "\u{f790}"
        case .pinLight: return "\u{f791}"
        case .pinListActivityBold: return "\u{f792}"
        case .pinListActivityColoredBold: return "\u{f793}"
        case .pinListActivityColoredLight: return "\u{f794}"
        case .pinListActivityColoredRegular: return "\u{f795}"
        case .pinListActivityLight: return "\u{f796}"
        case .pinListActivityRegular: return "\u{f797}"
        case .pinListBold: return "\u{f798}"
        case .pinListLight: return "\u{f799}"
        case .pinListRegular: return "\u{f79a}"
        case .pinMutedBold: return "\u{f79b}"
        case .pinMutedFilled: return "\u{f79c}"
        case .pinMutedLight: return "\u{f79d}"
        case .pinMutedRegular: return "\u{f79e}"
        case .pinRegular: return "\u{f79f}"
        case .placeholderBold: return "\u{f7a0}"
        case .placeholderLight: return "\u{f7a1}"
        case .placeholderRegular: return "\u{f7a2}"
        case .playBold: return "\u{f7a3}"
        case .playCircleBold: return "\u{f7a4}"
        case .playCircleFilled: return "\u{f7a5}"
        case .playCircleLight: return "\u{f7a6}"
        case .playCircleRegular: return "\u{f7a7}"
        case .playFilled: return "\u{f7a8}"
        case .playLight: return "\u{f7a9}"
        case .playRegular: return "\u{f7aa}"
        case .plugAcBold: return "\u{f7ab}"
        case .plugAcLight: return "\u{f7ac}"
        case .plugAcRegular: return "\u{f7ad}"
        case .plusBold: return "\u{f7ae}"
        case .plusCircleBold: return "\u{f7af}"
        case .plusCircleFilled: return "\u{f7b0}"
        case .plusCircleLight: return "\u{f7b1}"
        case .plusCircleRegular: return "\u{f7b2}"
        case .plusLight: return "\u{f7b3}"
        case .plusRegular: return "\u{f7b4}"
        case .pmrBold: return "\u{f7b5}"
        case .pmrFilled: return "\u{f7b6}"
        case .pmrLight: return "\u{f7b7}"
        case .pmrRegular: return "\u{f7b8}"
        case .pollBold: return "\u{f7b9}"
        case .pollLight: return "\u{f7ba}"
        case .pollRegular: return "\u{f7bb}"
        case .popInBold: return "\u{f7bc}"
        case .popInLight: return "\u{f7bd}"
        case .popInRegular: return "\u{f7be}"
        case .popOutBold: return "\u{f7bf}"
        case .popOutLight: return "\u{f7c0}"
        case .popOutRegular: return "\u{f7c1}"
        case .popUpBold: return "\u{f7c2}"
        case .popUpLight: return "\u{f7c3}"
        case .popUpRegular: return "\u{f7c4}"
        case .portraitLandscapeBold: return "\u{f7c5}"
        case .portraitLandscapeLight: return "\u{f7c6}"
        case .portraitLandscapeRegular: return "\u{f7c7}"
        case .powerAcBold: return "\u{f7c8}"
        case .powerAcLight: return "\u{f7c9}"
        case .powerAcRegular: return "\u{f7ca}"
        case .powerBold: return "\u{f7cb}"
        case .powerLight: return "\u{f7cc}"
        case .powerRegular: return "\u{f7cd}"
        case .preHeaderBold: return "\u{f7ce}"
        case .preHeaderLight: return "\u{f7cf}"
        case .preHeaderRegular: return "\u{f7d0}"
        case .presentationBold: return "\u{f7d1}"
        case .presentationLight: return "\u{f7d2}"
        case .presentationRegular: return "\u{f7d3}"
        case .primaryParticipantBold: return "\u{f7d4}"
        case .primaryParticipantLight: return "\u{f7d5}"
        case .primaryParticipantRegular: return "\u{f7d6}"
        case .printBold: return "\u{f7d7}"
        case .printLight: return "\u{f7d8}"
        case .printRegular: return "\u{f7d9}"
        case .priorityBadgeFilled: return "\u{f7da}"
        case .priorityCircleBold: return "\u{f7db}"
        case .priorityCircleFilled: return "\u{f7dc}"
        case .priorityCircleLight: return "\u{f7dd}"
        case .priorityCircleRegular: return "\u{f7de}"
        case .priorityCircleTwoBold: return "\u{f7df}"
        case .priorityCircleTwoFilled: return "\u{f7e0}"
        case .priorityCircleTwoLight: return "\u{f7e1}"
        case .priorityCircleTwoRegular: return "\u{f7e2}"
        case .privacyCircleBold: return "\u{f7e3}"
        case .privacyCircleFilled: return "\u{f7e4}"
        case .privacyCircleLight: return "\u{f7e5}"
        case .privacyCircleRegular: return "\u{f7e6}"
        case .privateBold: return "\u{f7e7}"
        case .privateCircleBold: return "\u{f7e8}"
        case .privateCircleFilled: return "\u{f7e9}"
        case .privateCircleLight: return "\u{f7ea}"
        case .privateCircleRegular: return "\u{f7eb}"
        case .privateLight: return "\u{f7ec}"
        case .privateMeetingBold: return "\u{f7ed}"
        case .privateMeetingLight: return "\u{f7ee}"
        case .privateMeetingRegular: return "\u{f7ef}"
        case .privateRegular: return "\u{f7f0}"
        case .productDemoBold: return "\u{f7f1}"
        case .productDemoLight: return "\u{f7f2}"
        case .productDemoRegular: return "\u{f7f3}"
        case .proximityBold: return "\u{f7f4}"
        case .proximityLight: return "\u{f7f5}"
        case .proximityMutedBold: return "\u{f7f6}"
        case .proximityMutedLight: return "\u{f7f7}"
        case .proximityMutedRegular: return "\u{f7f8}"
        case .proximityRegular: return "\u{f7f9}"
        case .proximityVideoBold: return "\u{f7fa}"
        case .proximityVideoLight: return "\u{f7fb}"
        case .proximityVideoRegular: return "\u{f7fc}"
        case .ptoPresenceBold: return "\u{f7fd}"
        case .ptoPresenceFilled: return "\u{f7fe}"
        case .ptoPresenceLight: return "\u{f7ff}"
        case .ptoPresenceRegular: return "\u{f800}"
        case .pullCallBold: return "\u{f801}"
        case .pullCallLight: return "\u{f802}"
        case .pullCallRegular: return "\u{f803}"
        case .qABold: return "\u{f804}"
        case .qALight: return "\u{f805}"
        case .qARegular: return "\u{f806}"
        case .qualityBold: return "\u{f807}"
        case .qualityLight: return "\u{f808}"
        case .qualityRegular: return "\u{f809}"
        case .queueContactBold: return "\u{f80a}"
        case .queueContactLight: return "\u{f80b}"
        case .queueContactRegular: return "\u{f80c}"
        case .quietBold: return "\u{f80d}"
        case .quietHoursPresenceBold: return "\u{f80e}"
        case .quietHoursPresenceFilled: return "\u{f80f}"
        case .quietHoursPresenceLight: return "\u{f810}"
        case .quietHoursPresenceRegular: return "\u{f811}"
        case .quietLight: return "\u{f812}"
        case .quietRegular: return "\u{f813}"
        case .radioButtonGroupBold: return "\u{f814}"
        case .radioButtonGroupLight: return "\u{f815}"
        case .radioButtonGroupRegular: return "\u{f816}"
        case .raiseHandBold: return "\u{f817}"
        case .raiseHandFilled: return "\u{f818}"
        case .raiseHandLight: return "\u{f819}"
        case .raiseHandRegular: return "\u{f81a}"
        case .ramBold: return "\u{f81b}"
        case .ramLight: return "\u{f81c}"
        case .ramRegular: return "\u{f81d}"
        case .reactionsBold: return "\u{f81e}"
        case .reactionsFilled: return "\u{f81f}"
        case .reactionsLight: return "\u{f820}"
        case .reactionsRegular: return "\u{f821}"
        case .reactivateBold: return "\u{f822}"
        case .reactivateLight: return "\u{f823}"
        case .reactivateRegular: return "\u{f824}"
        case .recentsBold: return "\u{f825}"
        case .recentsFilled: return "\u{f826}"
        case .recentsLight: return "\u{f827}"
        case .recentsPresenceBold: return "\u{f828}"
        case .recentsPresenceFilled: return "\u{f829}"
        case .recentsPresenceLight: return "\u{f82a}"
        case .recentsPresenceRegular: return "\u{f82b}"
        case .recentsPresenceSmallFilled: return "\u{f82c}"
        case .recentsRegular: return "\u{f82d}"
        case .recordActiveBold: return "\u{f82e}"
        case .recordActiveFilled: return "\u{f82f}"
        case .recordActiveLight: return "\u{f830}"
        case .recordActiveRegular: return "\u{f831}"
        case .recordBold: return "\u{f832}"
        case .recordFilled: return "\u{f833}"
        case .recordLight: return "\u{f834}"
        case .recordPausedBold: return "\u{f835}"
        case .recordPausedFilled: return "\u{f836}"
        case .recordPausedLight: return "\u{f837}"
        case .recordPausedRegular: return "\u{f838}"
        case .recordRegular: return "\u{f839}"
        case .recurringBold: return "\u{f83a}"
        case .recurringLight: return "\u{f83b}"
        case .recurringOffBold: return "\u{f83c}"
        case .recurringOffLight: return "\u{f83d}"
        case .recurringOffRegular: return "\u{f83e}"
        case .recurringRegular: return "\u{f83f}"
        case .redialBold: return "\u{f840}"
        case .redialLight: return "\u{f841}"
        case .redialRegular: return "\u{f842}"
        case .redoBold: return "\u{f843}"
        case .redoLight: return "\u{f844}"
        case .redoRegular: return "\u{f845}"
        case .refreshBold: return "\u{f846}"
        case .refreshLight: return "\u{f847}"
        case .refreshRegular: return "\u{f848}"
        case .remoteCallBold: return "\u{f849}"
        case .remoteCallFilled: return "\u{f84a}"
        case .remoteCallLight: return "\u{f84b}"
        case .remoteCallRegular: return "\u{f84c}"
        case .remoteDesktopControlBold: return "\u{f84d}"
        case .remoteDesktopControlFilled: return "\u{f84e}"
        case .remoteDesktopControlLight: return "\u{f84f}"
        case .remoteDesktopControlRegular: return "\u{f850}"
        case .removeBold: return "\u{f851}"
        case .removeFilled: return "\u{f852}"
        case .removeLight: return "\u{f853}"
        case .removeRegular: return "\u{f854}"
        case .replyBold: return "\u{f855}"
        case .replyFilled: return "\u{f856}"
        case .replyLight: return "\u{f857}"
        case .replyListBold: return "\u{f858}"
        case .replyListLight: return "\u{f859}"
        case .replyListRegular: return "\u{f85a}"
        case .replyPrivatelyBold: return "\u{f85b}"
        case .replyPrivatelyLight: return "\u{f85c}"
        case .replyPrivatelyRegular: return "\u{f85d}"
        case .replyRegular: return "\u{f85e}"
        case .resetBold: return "\u{f85f}"
        case .resetLight: return "\u{f860}"
        case .resetRegular: return "\u{f861}"
        case .responsiveMobileBold: return "\u{f862}"
        case .responsiveMobileLight: return "\u{f863}"
        case .responsiveMobileRegular: return "\u{f864}"
        case .restartBold: return "\u{f865}"
        case .restartLight: return "\u{f866}"
        case .restartRegular: return "\u{f867}"
        case .retrieveCallBold: return "\u{f868}"
        case .retrieveCallLight: return "\u{f869}"
        case .retrieveCallRegular: return "\u{f86a}"
        case .returnBold: return "\u{f86b}"
        case .returnLight: return "\u{f86c}"
        case .returnRegular: return "\u{f86d}"
        case .ringtoneBold: return "\u{f86e}"
        case .ringtoneLight: return "\u{f86f}"
        case .ringtoneRegular: return "\u{f870}"
        case .roomCalendarBold: return "\u{f871}"
        case .roomCalendarLight: return "\u{f872}"
        case .roomCalendarRegular: return "\u{f873}"
        case .roomLightsBold: return "\u{f874}"
        case .roomLightsFilled: return "\u{f875}"
        case .roomLightsLight: return "\u{f876}"
        case .roomLightsRegular: return "\u{f877}"
        case .rotateContentBold: return "\u{f878}"
        case .rotateContentFilled: return "\u{f879}"
        case .rotateContentLight: return "\u{f87a}"
        case .rotateContentRegular: return "\u{f87b}"
        case .ruleBasedBold: return "\u{f87c}"
        case .ruleBasedLight: return "\u{f87d}"
        case .ruleBasedRegular: return "\u{f87e}"
        case .runningApplicationBold: return "\u{f87f}"
        case .runningApplicationFilled: return "\u{f880}"
        case .runningApplicationLight: return "\u{f881}"
        case .runningApplicationRegular: return "\u{f882}"
        case .saveBold: return "\u{f883}"
        case .saveLight: return "\u{f884}"
        case .saveRegular: return "\u{f885}"
        case .scanBold: return "\u{f886}"
        case .scanLight: return "\u{f887}"
        case .scanRegular: return "\u{f888}"
        case .schedulerAvailableBold: return "\u{f889}"
        case .schedulerAvailableLight: return "\u{f88a}"
        case .schedulerAvailableRegular: return "\u{f88b}"
        case .schedulerNotWorkingHoursBold: return "\u{f88c}"
        case .schedulerNotWorkingHoursLight: return "\u{f88d}"
        case .schedulerNotWorkingHoursRegular: return "\u{f88e}"
        case .schedulerUnavailableBold: return "\u{f88f}"
        case .schedulerUnavailableLight: return "\u{f890}"
        case .schedulerUnavailableRegular: return "\u{f891}"
        case .schedulerUnknownBold: return "\u{f892}"
        case .schedulerUnknownLight: return "\u{f893}"
        case .schedulerUnknownRegular: return "\u{f894}"
        case .screenshotBold: return "\u{f895}"
        case .screenshotDocBold: return "\u{f896}"
        case .screenshotDocFilled: return "\u{f897}"
        case .screenshotDocLight: return "\u{f898}"
        case .screenshotDocRegular: return "\u{f899}"
        case .screenshotLight: return "\u{f89a}"
        case .screenshotRegular: return "\u{f89b}"
        case .searchBold: return "\u{f89c}"
        case .searchFilled: return "\u{f89d}"
        case .searchLight: return "\u{f89e}"
        case .searchRegular: return "\u{f89f}"
        case .secondaryArrowBold: return "\u{f8a0}"
        case .secondaryArrowLight: return "\u{f8a1}"
        case .secondaryArrowRegular: return "\u{f8a2}"
        case .secureCallLockBold: return "\u{f8a3}"
        case .secureCallLockFilled: return "\u{f8a4}"
        case .secureCallLockLight: return "\u{f8a5}"
        case .secureCallLockRegular: return "\u{f8a6}"
        case .secureCallShieldBold: return "\u{f8a7}"
        case .secureCallShieldFilled: return "\u{f8a8}"
        case .secureCallShieldLight: return "\u{f8a9}"
        case .secureCallShieldRegular: return "\u{f8aa}"
        case .secureCircleBold: return "\u{f8ab}"
        case .secureCircleFilled: return "\u{f8ac}"
        case .secureCircleLight: return "\u{f8ad}"
        case .secureCircleRegular: return "\u{f8ae}"
        case .secureLockBold: return "\u{f8af}"
        case .secureLockFilled: return "\u{f8b0}"
        case .secureLockLight: return "\u{f8b1}"
        case .secureLockRegular: return "\u{f8b2}"
        case .segmentExcludeFilled: return "\u{f8b3}"
        case .segmentFilterFilled: return "\u{f8b4}"
        case .segmentIncludeFilled: return "\u{f8b5}"
        case .selectAllBold: return "\u{f8b6}"
        case .selectAllFilled: return "\u{f8b7}"
        case .selectAllLight: return "\u{f8b8}"
        case .selectAllRegular: return "\u{f8b9}"
        case .selectionBold: return "\u{f8ba}"
        case .selectionLight: return "\u{f8bb}"
        case .selectionRegular: return "\u{f8bc}"
        case .sendBold: return "\u{f8bd}"
        case .sendFilled: return "\u{f8be}"
        case .sendLight: return "\u{f8bf}"
        case .sendRegular: return "\u{f8c0}"
        case .serverBold: return "\u{f8c1}"
        case .serverErrorBold: return "\u{f8c2}"
        case .serverErrorLight: return "\u{f8c3}"
        case .serverErrorRegular: return "\u{f8c4}"
        case .serverLight: return "\u{f8c5}"
        case .serverRegular: return "\u{f8c6}"
        case .servicesBold: return "\u{f8c7}"
        case .servicesLight: return "\u{f8c8}"
        case .servicesRegular: return "\u{f8c9}"
        case .setVariableBold: return "\u{f8ca}"
        case .setVariableLight: return "\u{f8cb}"
        case .setVariableRegular: return "\u{f8cc}"
        case .settingsBold: return "\u{f8cd}"
        case .settingsFilled: return "\u{f8ce}"
        case .settingsLight: return "\u{f8cf}"
        case .settingsRegular: return "\u{f8d0}"
        case .setupAssistantBold: return "\u{f8d1}"
        case .setupAssistantLight: return "\u{f8d2}"
        case .setupAssistantRegular: return "\u{f8d3}"
        case .sftpBold: return "\u{f8d4}"
        case .sftpLight: return "\u{f8d5}"
        case .sftpRegular: return "\u{f8d6}"
        case .shapeCircleBold: return "\u{f8d7}"
        case .shapeCircleFilled: return "\u{f8d8}"
        case .shapeCircleLight: return "\u{f8d9}"
        case .shapeCircleRegular: return "\u{f8da}"
        case .shapeDiagonalLineBold: return "\u{f8db}"
        case .shapeDiagonalLineLight: return "\u{f8dc}"
        case .shapeDiagonalLineRegular: return "\u{f8dd}"
        case .shapeDiamondBold: return "\u{f8de}"
        case .shapeDiamondFilled: return "\u{f8df}"
        case .shapeDiamondLight: return "\u{f8e0}"
        case .shapeDiamondRegular: return "\u{f8e1}"
        case .shapeOvalBold: return "\u{f8e2}"
        case .shapeOvalLight: return "\u{f8e3}"
        case .shapeOvalRegular: return "\u{f8e4}"
        case .shapeSquareBold: return "\u{f8e5}"
        case .shapeSquareFilled: return "\u{f8e6}"
        case .shapeSquareLight: return "\u{f8e7}"
        case .shapeSquareRegular: return "\u{f8e8}"
        case .shapeTriangleBold: return "\u{f8e9}"
        case .shapeTriangleFilled: return "\u{f8ea}"
        case .shapeTriangleLight: return "\u{f8eb}"
        case .shapeTriangleRegular: return "\u{f8ec}"
        case .shapesBold: return "\u{f8ed}"
        case .shapesLight: return "\u{f8ee}"
        case .shapesRegular: return "\u{f8ef}"
        case .shareCNativeAdrBold: return "\u{f8f0}"
        case .shareCNativeAdrLight: return "\u{f8f1}"
        case .shareCNativeAdrRegular: return "\u{f8f2}"
        case .shareCNativeIphBold: return "\u{f8f3}"
        case .shareCNativeIphLight: return "\u{f8f4}"
        case .shareCNativeIphRegular: return "\u{f8f5}"
        case .shareScreenBold: return "\u{f8f6}"
        case .shareScreenFilled: return "\u{f8f7}"
        case .shareScreenLight: return "\u{f8f8}"
        case .shareScreenRegular: return "\u{f8f9}"
        case .shareScreenSmallFilled: return "\u{f8fa}"
        case .shareSpaceBold: return "\u{f8fb}"
        case .shareSpaceLight: return "\u{f8fc}"
        case .shareSpaceRegular: return "\u{f8fd}"
        case .shieldBold: return "\u{f8fe}"
        case .shieldLight: return "\u{f8ff}"
        case .shieldRegular: return "\u{f900}"
        case .shoppingCartBold: return "\u{f901}"
        case .shoppingCartFilled: return "\u{f902}"
        case .shoppingCartLight: return "\u{f903}"
        case .shoppingCartRegular: return "\u{f904}"
        case .shortTextBoxBold: return "\u{f905}"
        case .shortTextBoxLight: return "\u{f906}"
        case .shortTextBoxRegular: return "\u{f907}"
        case .showBold: return "\u{f908}"
        case .showFilled: return "\u{f909}"
        case .showLight: return "\u{f90a}"
        case .showRegular: return "\u{f90b}"
        case .signInBold: return "\u{f90c}"
        case .signInFilled: return "\u{f90d}"
        case .signInForcedBold: return "\u{f90e}"
        case .signInForcedLight: return "\u{f90f}"
        case .signInForcedRegular: return "\u{f910}"
        case .signInLight: return "\u{f911}"
        case .signInRegular: return "\u{f912}"
        case .signOutBold: return "\u{f913}"
        case .signOutLight: return "\u{f914}"
        case .signOutRegular: return "\u{f915}"
        case .signal0Bold: return "\u{f916}"
        case .signal0Light: return "\u{f917}"
        case .signal0Regular: return "\u{f918}"
        case .signal100Bold: return "\u{f919}"
        case .signal100Light: return "\u{f91a}"
        case .signal100Regular: return "\u{f91b}"
        case .signal25Bold: return "\u{f91c}"
        case .signal25Light: return "\u{f91d}"
        case .signal25Regular: return "\u{f91e}"
        case .signal50Bold: return "\u{f91f}"
        case .signal50Light: return "\u{f920}"
        case .signal50Regular: return "\u{f921}"
        case .signal75Bold: return "\u{f922}"
        case .signal75Light: return "\u{f923}"
        case .signal75Regular: return "\u{f924}"
        case .simplePromotionBold: return "\u{f925}"
        case .simplePromotionLight: return "\u{f926}"
        case .simplePromotionRegular: return "\u{f927}"
        case .singleNumberReachBold: return "\u{f928}"
        case .singleNumberReachLight: return "\u{f929}"
        case .singleNumberReachRegular: return "\u{f92a}"
        case .sipRegistrationInProgressBold: return "\u{f92b}"
        case .sipRegistrationInProgressFilled: return "\u{f92c}"
        case .sipRegistrationInProgressLight: return "\u{f92d}"
        case .sipRegistrationInProgressRegular: return "\u{f92e}"
        case .skipBold: return "\u{f92f}"
        case .skipBwBold: return "\u{f930}"
        case .skipBwFilled: return "\u{f931}"
        case .skipBwLight: return "\u{f932}"
        case .skipBwRegular: return "\u{f933}"
        case .skipFwBold: return "\u{f934}"
        case .skipFwFilled: return "\u{f935}"
        case .skipFwLight: return "\u{f936}"
        case .skipFwRegular: return "\u{f937}"
        case .skipLight: return "\u{f938}"
        case .skipRegular: return "\u{f939}"
        case .smsInboundBold: return "\u{f93a}"
        case .smsInboundLight: return "\u{f93b}"
        case .smsInboundRegular: return "\u{f93c}"
        case .smsMessageBold: return "\u{f93d}"
        case .smsMessageFilled: return "\u{f93e}"
        case .smsMessageLight: return "\u{f93f}"
        case .smsMessageRegular: return "\u{f940}"
        case .socialAlexaFilled: return "\u{f941}"
        case .socialFacebookColoredFilled: return "\u{f942}"
        case .socialFacebookFilled: return "\u{f943}"
        case .socialFbmessengerColoredFilled: return "\u{f944}"
        case .socialFbmessengerFilled: return "\u{f945}"
        case .socialInstagramBold: return "\u{f946}"
        case .socialMicrosoftColoredFilled: return "\u{f947}"
        case .socialMicrosoftFilled: return "\u{f948}"
        case .socialMmsFilled: return "\u{f949}"
        case .socialMmsGoldFilled: return "\u{f94a}"
        case .socialSmsFilled: return "\u{f94b}"
        case .socialSmsMintFilled: return "\u{f94c}"
        case .socialTwitterColoredFilled: return "\u{f94d}"
        case .socialTwitterFilled: return "\u{f94e}"
        case .socialViberBold: return "\u{f94f}"
        case .socialViberColoredBold: return "\u{f950}"
        case .socialWhatsappBold: return "\u{f951}"
        case .socialWhatsappColoredFilled: return "\u{f952}"
        case .sortAscendingBold: return "\u{f953}"
        case .sortAscendingLight: return "\u{f954}"
        case .sortAscendingRegular: return "\u{f955}"
        case .sortDescendingBold: return "\u{f956}"
        case .sortDescendingLight: return "\u{f957}"
        case .sortDescendingRegular: return "\u{f958}"
        case .soundDefaultBold: return "\u{f959}"
        case .soundDefaultLight: return "\u{f95a}"
        case .soundDefaultRegular: return "\u{f95b}"
        case .speakerBold: return "\u{f95c}"
        case .speakerDisconnectedBold: return "\u{f95d}"
        case .speakerDisconnectedFilled: return "\u{f95e}"
        case .speakerDisconnectedLight: return "\u{f95f}"
        case .speakerDisconnectedRegular: return "\u{f960}"
        case .speakerFilled: return "\u{f961}"
        case .speakerLight: return "\u{f962}"
        case .speakerMutedBold: return "\u{f963}"
        case .speakerMutedFilled: return "\u{f964}"
        case .speakerMutedLight: return "\u{f965}"
        case .speakerMutedRegular: return "\u{f966}"
        case .speakerOffBold: return "\u{f967}"
        case .speakerOffFilled: return "\u{f968}"
        case .speakerOffLight: return "\u{f969}"
        case .speakerOffRegular: return "\u{f96a}"
        case .speakerOnColoredBold: return "\u{f96b}"
        case .speakerOnColoredLight: return "\u{f96c}"
        case .speakerOnColoredRegular: return "\u{f96d}"
        case .speakerRegular: return "\u{f96e}"
        case .speakerTurnDownBold: return "\u{f96f}"
        case .speakerTurnDownFilled: return "\u{f970}"
        case .speakerTurnDownLight: return "\u{f971}"
        case .speakerTurnDownRegular: return "\u{f972}"
        case .speakerTurnUpBold: return "\u{f973}"
        case .speakerTurnUpFilled: return "\u{f974}"
        case .speakerTurnUpLight: return "\u{f975}"
        case .speakerTurnUpRegular: return "\u{f976}"
        case .spinnerBold: return "\u{f977}"
        case .spinnerFilledBold: return "\u{f978}"
        case .spinnerFilledLight: return "\u{f979}"
        case .spinnerFilledRegular: return "\u{f97a}"
        case .spinnerLight: return "\u{f97b}"
        case .spinnerPartialBold: return "\u{f97c}"
        case .spinnerPartialLight: return "\u{f97d}"
        case .spinnerPartialRegular: return "\u{f97e}"
        case .spinnerRegular: return "\u{f97f}"
        case .stackedArea100ChartBold: return "\u{f980}"
        case .stackedArea100ChartFilled: return "\u{f981}"
        case .stackedArea100ChartLight: return "\u{f982}"
        case .stackedArea100ChartRegular: return "\u{f983}"
        case .stackedAreaChartBold: return "\u{f984}"
        case .stackedAreaChartFilled: return "\u{f985}"
        case .stackedAreaChartLight: return "\u{f986}"
        case .stackedAreaChartRegular: return "\u{f987}"
        case .stackedBar100ChartBold: return "\u{f988}"
        case .stackedBar100ChartFilled: return "\u{f989}"
        case .stackedBar100ChartLight: return "\u{f98a}"
        case .stackedBar100ChartRegular: return "\u{f98b}"
        case .stackedBarChartBold: return "\u{f98c}"
        case .stackedBarChartFilled: return "\u{f98d}"
        case .stackedBarChartLight: return "\u{f98e}"
        case .stackedBarChartRegular: return "\u{f98f}"
        case .startChatBold: return "\u{f990}"
        case .startChatLight: return "\u{f991}"
        case .startChatRegular: return "\u{f992}"
        case .stethoscopeBold: return "\u{f993}"
        case .stethoscopeLight: return "\u{f994}"
        case .stethoscopeRegular: return "\u{f995}"
        case .stickersBold: return "\u{f996}"
        case .stickersLight: return "\u{f997}"
        case .stickersRegular: return "\u{f998}"
        case .stickiesBold: return "\u{f999}"
        case .stickiesLight: return "\u{f99a}"
        case .stickiesRegular: return "\u{f99b}"
        case .stopBold: return "\u{f99c}"
        case .stopCircleBold: return "\u{f99d}"
        case .stopCircleFilled: return "\u{f99e}"
        case .stopCircleLight: return "\u{f99f}"
        case .stopCircleRegular: return "\u{f9a0}"
        case .stopContentShareBold: return "\u{f9a1}"
        case .stopContentShareLight: return "\u{f9a2}"
        case .stopContentShareRegular: return "\u{f9a3}"
        case .stopFilled: return "\u{f9a4}"
        case .stopLight: return "\u{f9a5}"
        case .stopRegular: return "\u{f9a6}"
        case .storedInfoBold: return "\u{f9a7}"
        case .storedInfoFilled: return "\u{f9a8}"
        case .storedInfoLight: return "\u{f9a9}"
        case .storedInfoRegular: return "\u{f9aa}"
        case .streamingBold: return "\u{f9ab}"
        case .streamingLight: return "\u{f9ac}"
        case .streamingRegular: return "\u{f9ad}"
        case .strikethroughBold: return "\u{f9ae}"
        case .strikethroughLight: return "\u{f9af}"
        case .strikethroughRegular: return "\u{f9b0}"
        case .subscriptBold: return "\u{f9b1}"
        case .subscriptLight: return "\u{f9b2}"
        case .subscriptRegular: return "\u{f9b3}"
        case .superscriptBold: return "\u{f9b4}"
        case .superscriptLight: return "\u{f9b5}"
        case .superscriptRegular: return "\u{f9b6}"
        case .surveyBold: return "\u{f9b7}"
        case .surveyFilled: return "\u{f9b8}"
        case .surveyLight: return "\u{f9b9}"
        case .surveyRegular: return "\u{f9ba}"
        case .sx10Bold: return "\u{f9bb}"
        case .sx10Light: return "\u{f9bc}"
        case .sx10Regular: return "\u{f9bd}"
        case .sx20Bold: return "\u{f9be}"
        case .sx20Light: return "\u{f9bf}"
        case .sx20Regular: return "\u{f9c0}"
        case .sx80CodecBold: return "\u{f9c1}"
        case .sx80CodecLight: return "\u{f9c2}"
        case .sx80CodecRegular: return "\u{f9c3}"
        case .tableBold: return "\u{f9c4}"
        case .tableLight: return "\u{f9c5}"
        case .tableRegular: return "\u{f9c6}"
        case .tabletBold: return "\u{f9c7}"
        case .tabletLight: return "\u{f9c8}"
        case .tabletRegular: return "\u{f9c9}"
        case .tabsBold: return "\u{f9ca}"
        case .tabsLight: return "\u{f9cb}"
        case .tabsRegular: return "\u{f9cc}"
        case .tagBold: return "\u{f9cd}"
        case .tagLight: return "\u{f9ce}"
        case .tagRegular: return "\u{f9cf}"
        case .tapBold: return "\u{f9d0}"
        case .tapFilled: return "\u{f9d1}"
        case .tapLight: return "\u{f9d2}"
        case .tapRegular: return "\u{f9d3}"
        case .telepresenceAlertBold: return "\u{f9d4}"
        case .telepresenceAlertLight: return "\u{f9d5}"
        case .telepresenceAlertMutedBold: return "\u{f9d6}"
        case .telepresenceAlertMutedLight: return "\u{f9d7}"
        case .telepresenceAlertMutedRegular: return "\u{f9d8}"
        case .telepresenceAlertRegular: return "\u{f9d9}"
        case .telepresenceBold: return "\u{f9da}"
        case .telepresenceIx5000Bold: return "\u{f9db}"
        case .telepresenceIx5000Light: return "\u{f9dc}"
        case .telepresenceIx5000Regular: return "\u{f9dd}"
        case .telepresenceLight: return "\u{f9de}"
        case .telepresencePrivateBold: return "\u{f9df}"
        case .telepresencePrivateLight: return "\u{f9e0}"
        case .telepresencePrivateRegular: return "\u{f9e1}"
        case .telepresenceRegular: return "\u{f9e2}"
        case .temperatureBold: return "\u{f9e3}"
        case .temperatureLight: return "\u{f9e4}"
        case .temperatureRegular: return "\u{f9e5}"
        case .textAlignCenterBold: return "\u{f9e6}"
        case .textAlignCenterFilled: return "\u{f9e7}"
        case .textAlignCenterLight: return "\u{f9e8}"
        case .textAlignCenterRegular: return "\u{f9e9}"
        case .textAlignLeftBold: return "\u{f9ea}"
        case .textAlignLeftFilled: return "\u{f9eb}"
        case .textAlignLeftLight: return "\u{f9ec}"
        case .textAlignLeftRegular: return "\u{f9ed}"
        case .textAlignRightBold: return "\u{f9ee}"
        case .textAlignRightFilled: return "\u{f9ef}"
        case .textAlignRightLight: return "\u{f9f0}"
        case .textAlignRightRegular: return "\u{f9f1}"
        case .textBold: return "\u{f9f2}"
        case .textCodeBlockBold: return "\u{f9f3}"
        case .textCodeBlockLight: return "\u{f9f4}"
        case .textCodeBlockRegular: return "\u{f9f5}"
        case .textHighlightBold: return "\u{f9f6}"
        case .textHighlightLight: return "\u{f9f7}"
        case .textHighlightRegular: return "\u{f9f8}"
        case .textLight: return "\u{f9f9}"
        case .textRegular: return "\u{f9fa}"
        case .threeColumnBold: return "\u{f9fb}"
        case .threeColumnLight: return "\u{f9fc}"
        case .threeColumnRegular: return "\u{f9fd}"
        case .threeDObjectBold: return "\u{f9fe}"
        case .threeDObjectLight: return "\u{f9ff}"
        case .threeDObjectRegular: return "\u{fa00}"
        case .tooFastBold: return "\u{fa01}"
        case .tooFastLight: return "\u{fa02}"
        case .tooFastRegular: return "\u{fa03}"
        case .tooSlowBold: return "\u{fa04}"
        case .tooSlowLight: return "\u{fa05}"
        case .tooSlowRegular: return "\u{fa06}"
        case .toolsBold: return "\u{fa07}"
        case .toolsLight: return "\u{fa08}"
        case .toolsRegular: return "\u{fa09}"
        case .touch10Bold: return "\u{fa0a}"
        case .touch10Light: return "\u{fa0b}"
        case .touch10Regular: return "\u{fa0c}"
        case .transcriptBold: return "\u{fa0d}"
        case .transcriptFilled: return "\u{fa0e}"
        case .transcriptLight: return "\u{fa0f}"
        case .transcriptRegular: return "\u{fa10}"
        case .translateBold: return "\u{fa11}"
        case .translateLight: return "\u{fa12}"
        case .translateRegular: return "\u{fa13}"
        case .trimBold: return "\u{fa14}"
        case .trimLight: return "\u{fa15}"
        case .trimRegular: return "\u{fa16}"
        case .twoColumnBold: return "\u{fa17}"
        case .twoColumnLight: return "\u{fa18}"
        case .twoColumnRegular: return "\u{fa19}"
        case .ucmCloudBold: return "\u{fa1a}"
        case .ucmCloudLight: return "\u{fa1b}"
        case .ucmCloudRegular: return "\u{fa1c}"
        case .underlineBold: return "\u{fa1d}"
        case .underlineLight: return "\u{fa1e}"
        case .underlineRegular: return "\u{fa1f}"
        case .undoBold: return "\u{fa20}"
        case .undoLight: return "\u{fa21}"
        case .undoRegular: return "\u{fa22}"
        case .unlinkBold: return "\u{fa23}"
        case .unlinkLight: return "\u{fa24}"
        case .unlinkRegular: return "\u{fa25}"
        case .unreadBold: return "\u{fa26}"
        case .unreadFilled: return "\u{fa27}"
        case .unreadLight: return "\u{fa28}"
        case .unreadRegular: return "\u{fa29}"
        case .unsecureUnlockedBold: return "\u{fa2a}"
        case .unsecureUnlockedFilled: return "\u{fa2b}"
        case .unsecureUnlockedLight: return "\u{fa2c}"
        case .unsecureUnlockedRegular: return "\u{fa2d}"
        case .unsortedBold: return "\u{fa2e}"
        case .unsortedLight: return "\u{fa2f}"
        case .unsortedRegular: return "\u{fa30}"
        case .updateFileShareBold: return "\u{fa31}"
        case .updateFileShareLight: return "\u{fa32}"
        case .updateFileShareRegular: return "\u{fa33}"
        case .upgradeBold: return "\u{fa34}"
        case .upgradeFilled: return "\u{fa35}"
        case .upgradeLight: return "\u{fa36}"
        case .upgradeRegular: return "\u{fa37}"
        case .uploadBold: return "\u{fa38}"
        case .uploadLight: return "\u{fa39}"
        case .uploadRegular: return "\u{fa3a}"
        case .urgentVoicemailBold: return "\u{fa3b}"
        case .urgentVoicemailFilled: return "\u{fa3c}"
        case .usbBold: return "\u{fa3d}"
        case .usbHeadsetBold: return "\u{fa3e}"
        case .usbHeadsetLight: return "\u{fa3f}"
        case .usbHeadsetMutedBold: return "\u{fa40}"
        case .usbHeadsetMutedLight: return "\u{fa41}"
        case .usbHeadsetMutedRegular: return "\u{fa42}"
        case .usbHeadsetRegular: return "\u{fa43}"
        case .usbLight: return "\u{fa44}"
        case .usbRegular: return "\u{fa45}"
        case .userBold: return "\u{fa46}"
        case .userDeactivateBold: return "\u{fa47}"
        case .userDeactivateLight: return "\u{fa48}"
        case .userDeactivateRegular: return "\u{fa49}"
        case .userLight: return "\u{fa4a}"
        case .userRegular: return "\u{fa4b}"
        case .vcsBold: return "\u{fa4c}"
        case .vcsLight: return "\u{fa4d}"
        case .vcsRegular: return "\u{fa4e}"
        case .videoBlurBold: return "\u{fa4f}"
        case .videoBlurFilled: return "\u{fa50}"
        case .videoBlurLight: return "\u{fa51}"
        case .videoBlurRegular: return "\u{fa52}"
        case .videoBold: return "\u{fa53}"
        case .videoEffectBold: return "\u{fa54}"
        case .videoEffectFilled: return "\u{fa55}"
        case .videoEffectLight: return "\u{fa56}"
        case .videoEffectRegular: return "\u{fa57}"
        case .videoFilled: return "\u{fa58}"
        case .videoLayoutBold: return "\u{fa59}"
        case .videoLayoutEqualBold: return "\u{fa5a}"
        case .videoLayoutEqualDualBold: return "\u{fa5b}"
        case .videoLayoutEqualDualLight: return "\u{fa5c}"
        case .videoLayoutEqualDualRegular: return "\u{fa5d}"
        case .videoLayoutEqualFilled: return "\u{fa5e}"
        case .videoLayoutEqualLight: return "\u{fa5f}"
        case .videoLayoutEqualRegular: return "\u{fa60}"
        case .videoLayoutFilled: return "\u{fa61}"
        case .videoLayoutLight: return "\u{fa62}"
        case .videoLayoutOverlayBold: return "\u{fa63}"
        case .videoLayoutOverlayLight: return "\u{fa64}"
        case .videoLayoutOverlayRegular: return "\u{fa65}"
        case .videoLayoutPresenterDominantBold: return "\u{fa66}"
        case .videoLayoutPresenterDominantLight: return "\u{fa67}"
        case .videoLayoutPresenterDominantRegular: return "\u{fa68}"
        case .videoLayoutProminentBold: return "\u{fa69}"
        case .videoLayoutProminentFilled: return "\u{fa6a}"
        case .videoLayoutProminentLight: return "\u{fa6b}"
        case .videoLayoutProminentRegular: return "\u{fa6c}"
        case .videoLayoutRegular: return "\u{fa6d}"
        case .videoLayoutShareDominantBold: return "\u{fa6e}"
        case .videoLayoutShareDominantLight: return "\u{fa6f}"
        case .videoLayoutShareDominantRegular: return "\u{fa70}"
        case .videoLayoutSingleBold: return "\u{fa71}"
        case .videoLayoutSingleFilled: return "\u{fa72}"
        case .videoLayoutSingleLight: return "\u{fa73}"
        case .videoLayoutSingleRegular: return "\u{fa74}"
        case .videoLayoutStackBold: return "\u{fa75}"
        case .videoLayoutStackFilled: return "\u{fa76}"
        case .videoLayoutStackLight: return "\u{fa77}"
        case .videoLayoutStackRegular: return "\u{fa78}"
        case .videoLayoutVideoDominantBold: return "\u{fa79}"
        case .videoLayoutVideoDominantLight: return "\u{fa7a}"
        case .videoLayoutVideoDominantRegular: return "\u{fa7b}"
        case .videoLight: return "\u{fa7c}"
        case .videoPlusBold: return "\u{fa7d}"
        case .videoPlusFilled: return "\u{fa7e}"
        case .videoPlusLight: return "\u{fa7f}"
        case .videoPlusRegular: return "\u{fa80}"
        case .videoRegular: return "\u{fa81}"
        case .videoSpeakerTrackBold: return "\u{fa82}"
        case .videoSpeakerTrackFilled: return "\u{fa83}"
        case .videoSpeakerTrackLight: return "\u{fa84}"
        case .videoSpeakerTrackRegular: return "\u{fa85}"
        case .viewAllBold: return "\u{fa86}"
        case .viewAllLight: return "\u{fa87}"
        case .viewAllRegular: return "\u{fa88}"
        case .viewListBold: return "\u{fa89}"
        case .viewListLight: return "\u{fa8a}"
        case .viewListRegular: return "\u{fa8b}"
        case .viewStackedBold: return "\u{fa8c}"
        case .viewStackedFilled: return "\u{fa8d}"
        case .viewStackedLight: return "\u{fa8e}"
        case .viewStackedRegular: return "\u{fa8f}"
        case .viewThumbnailBold: return "\u{fa90}"
        case .viewThumbnailFilled: return "\u{fa91}"
        case .viewThumbnailLight: return "\u{fa92}"
        case .viewThumbnailRegular: return "\u{fa93}"
        case .voicemailBold: return "\u{fa94}"
        case .voicemailFilled: return "\u{fa95}"
        case .voicemailLight: return "\u{fa96}"
        case .voicemailRegular: return "\u{fa97}"
        case .waffleMenuBold: return "\u{fa98}"
        case .waffleMenuLight: return "\u{fa99}"
        case .waffleMenuRegular: return "\u{fa9a}"
        case .waitingroomActiveBold: return "\u{fa9b}"
        case .waitingroomActiveLight: return "\u{fa9c}"
        case .waitingroomActiveRegular: return "\u{fa9d}"
        case .wallpaperBold: return "\u{fa9e}"
        case .wallpaperLight: return "\u{fa9f}"
        case .wallpaperRegular: return "\u{faa0}"
        case .warningBadgeFilled: return "\u{faa1}"
        case .warningBold: return "\u{faa2}"
        case .warningFilled: return "\u{faa3}"
        case .warningLight: return "\u{faa4}"
        case .warningRegular: return "\u{faa5}"
        case .webexAssistantActiveColored: return "\u{faa6}"
        case .webexAssistantInactiveColored: return "\u{faa7}"
        case .webexBoardBold: return "\u{faa8}"
        case .webexBoardLight: return "\u{faa9}"
        case .webexBoardRegular: return "\u{faaa}"
        case .webexCodecPlusBold: return "\u{faab}"
        case .webexCodecPlusLight: return "\u{faac}"
        case .webexCodecPlusRegular: return "\u{faad}"
        case .webexDeskCameraBold: return "\u{faae}"
        case .webexDeskCameraLight: return "\u{faaf}"
        case .webexDeskCameraRegular: return "\u{fab0}"
        case .webexHelixFilled: return "\u{fab1}"
        case .webexMeetingsBold: return "\u{fab2}"
        case .webexMeetingsFilled: return "\u{fab3}"
        case .webexMeetingsLight: return "\u{fab4}"
        case .webexMeetingsRegular: return "\u{fab5}"
        case .webexQuadCameraBold: return "\u{fab6}"
        case .webexQuadCameraLight: return "\u{fab7}"
        case .webexQuadCameraRegular: return "\u{fab8}"
        case .webexRoomKitBold: return "\u{fab9}"
        case .webexRoomKitLight: return "\u{faba}"
        case .webexRoomKitPlusBold: return "\u{fabb}"
        case .webexRoomKitPlusLight: return "\u{fabc}"
        case .webexRoomKitPlusRegular: return "\u{fabd}"
        case .webexRoomKitRegular: return "\u{fabe}"
        case .webexShareBold: return "\u{fabf}"
        case .webexShareLight: return "\u{fac0}"
        case .webexShareRegular: return "\u{fac1}"
        case .webexTeamsBold: return "\u{fac2}"
        case .webexTeamsFilled: return "\u{fac3}"
        case .webexTeamsLight: return "\u{fac4}"
        case .webexTeamsNewBold: return "\u{fac5}"
        case .webexTeamsNewFilled: return "\u{fac6}"
        case .webexTeamsNewLight: return "\u{fac7}"
        case .webexTeamsNewRegular: return "\u{fac8}"
        case .webexTeamsRegular: return "\u{fac9}"
        case .webinarBold: return "\u{faca}"
        case .webinarFilled: return "\u{facb}"
        case .webinarLight: return "\u{facc}"
        case .webinarRegular: return "\u{facd}"
        case .weeklyRecurringScheduleNodeBold: return "\u{face}"
        case .weeklyRecurringScheduleNodeLight: return "\u{facf}"
        case .weeklyRecurringScheduleNodeRegular: return "\u{fad0}"
        case .whiteboardBold: return "\u{fad1}"
        case .whiteboardContentBold: return "\u{fad2}"
        case .whiteboardContentLight: return "\u{fad3}"
        case .whiteboardContentRegular: return "\u{fad4}"
        case .whiteboardFilled: return "\u{fad5}"
        case .whiteboardLight: return "\u{fad6}"
        case .whiteboardRegular: return "\u{fad7}"
        case .widgetBold: return "\u{fad8}"
        case .widgetFilled: return "\u{fad9}"
        case .widgetLight: return "\u{fada}"
        case .widgetRegular: return "\u{fadb}"
        case .wifiBold: return "\u{fadc}"
        case .wifiErrorBold: return "\u{fadd}"
        case .wifiErrorLight: return "\u{fade}"
        case .wifiErrorRegular: return "\u{fadf}"
        case .wifiLight: return "\u{fae0}"
        case .wifiRegular: return "\u{fae1}"
        case .wifiSignalGoodColoredBold: return "\u{fae2}"
        case .wifiSignalGoodColoredLight: return "\u{fae3}"
        case .wifiSignalGoodColoredRegular: return "\u{fae4}"
        case .wifiSignalPoorColoredBold: return "\u{fae5}"
        case .wifiSignalPoorColoredLight: return "\u{fae6}"
        case .wifiSignalPoorColoredRegular: return "\u{fae7}"
        case .wifiSignalUnstableColoredBold: return "\u{fae8}"
        case .wifiSignalUnstableColoredLight: return "\u{fae9}"
        case .wifiSignalUnstableColoredRegular: return "\u{faea}"
        case .windowCornerScrubBold: return "\u{faeb}"
        case .windowCornerScrubLight: return "\u{faec}"
        case .windowCornerScrubRegular: return "\u{faed}"
        case .windowRightCornerScrubBold: return "\u{faee}"
        case .windowRightCornerScrubLight: return "\u{faef}"
        case .windowRightCornerScrubRegular: return "\u{faf0}"
        case .windowVerticalScrubBold: return "\u{faf1}"
        case .windowVerticalScrubLight: return "\u{faf2}"
        case .windowVerticalScrubRegular: return "\u{faf3}"
        case .workflowDeploymentsBold: return "\u{faf4}"
        case .workflowDeploymentsLight: return "\u{faf5}"
        case .workflowDeploymentsRegular: return "\u{faf6}"
        case .workphoneBold: return "\u{faf7}"
        case .workphoneLight: return "\u{faf8}"
        case .workphoneRegular: return "\u{faf9}"
        case .zoomInBold: return "\u{fafa}"
        case .zoomInLight: return "\u{fafb}"
        case .zoomInRegular: return "\u{fafc}"
        case .zoomOutBold: return "\u{fafd}"
        case .zoomOutLight: return "\u{fafe}"
        case .zoomOutRegular: return "\u{faff}"
        case .zoom: return "\u{fb00}"
