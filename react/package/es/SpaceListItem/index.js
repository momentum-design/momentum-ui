...
var SpaceListItem = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _proto.render = function render() {
    ...
    var leftSection = isOverview ? /*#__PURE__*/React.createElement(Avatar, {
    ...
    var rightSection = /*#__PURE__*/React.createElement(ListItemSection, {
      key: "child-2",
      position: "right"
    ...
    var highlightSubheader = function highlightSubheader() {
      ...
      return searchTerm && typeof subheader === 'string' ? subheader.split(re).map(function (ele, idx) {
        return ele.match(re) ? /*#__PURE__*/React.createElement("span", {
          key: "subheader-" + idx,
    ...
    var getHeader = ['search', 'filter', 'flag', 'filter-search'].includes(type) ? [/*#__PURE__*/React.createElement("span", {
      key: "header-0",
      className: "md-list-item__header-main"
    }, header), headerSecondary && /*#__PURE__*/React.createElement("span", {
    ...
    var children = [/*#__PURE__*/React.createElement(ListItemSection, {
      key: "child-0",
      position: "left"
    }, leftSection || /*#__PURE__*/React.createElement(Avatar, {
      title: "NA"
    ...
    }, getHeader), ['search', 'filter', 'flag', 'filter-search'].includes(type) ? /*#__PURE__*/React.createElement(ListItemSection, {
      position: "center",
      className: "md-list-item__result-container"
    }, ['flag'].includes(type) ? /*#__PURE__*/React.createElement(ListItemSection, {
      position: "center",
    ...
    }, highlightSubheader(subheader)), resultRight && /*#__PURE__*/React.createElement(ListItemSection, {
      position: "right",
      className: "md-list-item__attachment--top-right"
    }, resultRight)), attachments && attachments.length && /*#__PURE__*/React.createElement("div", {
      className: "md-list-item__attachment--bottom"
    }, attachments[0])) : /*#__PURE__*/React.createElement("div", {
      className: "md-list-item__result"
    }, highlightSubheader(subheader))) : /*#__PURE__*/React.createElement("div", {
