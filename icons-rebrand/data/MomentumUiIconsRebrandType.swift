...
@objc public enum MomentumIconsRebrandType: Int {
    ...
    public var ligature: String {
        ...
        case .cloudFilled: return "\u{f319}"
        case .cloudFrameBold: return "\u{f31a}"
        case .cloudFrameFilled: return "\u{f31b}"
        case .cloudFrameRegular: return "\u{f31c}"
        case .cloudFramedFilled: return "\u{f31d}"
        case .cloudFramedLight: return "\u{f31e}"
        case .cloudLight: return "\u{f31f}"
        case .cloudMutedBold: return "\u{f320}"
        case .cloudMutedFilled: return "\u{f321}"
        case .cloudMutedLight: return "\u{f322}"
        case .cloudMutedRegular: return "\u{f323}"
        case .cloudRegular: return "\u{f324}"
        case .cloudUploadBold: return "\u{f325}"
        case .cloudUploadLight: return "\u{f326}"
        case .cloudUploadRegular: return "\u{f327}"
        case .codeBlockBold: return "\u{f328}"
        case .codeBlockLight: return "\u{f329}"
        case .codeBlockRegular: return "\u{f32a}"
        case .colorBold: return "\u{f32b}"
        case .colorLight: return "\u{f32c}"
        case .colorRegular: return "\u{f32d}"
        case .colourPaletteBold: return "\u{f32e}"
        case .colourPaletteFilled: return "\u{f32f}"
        case .colourPaletteLight: return "\u{f330}"
        case .colourPaletteRegular: return "\u{f331}"
        case .commentingBold: return "\u{f332}"
        case .commentingFilled: return "\u{f333}"
        case .commentingLight: return "\u{f334}"
        case .commentingRegular: return "\u{f335}"
        case .companyBold: return "\u{f336}"
        case .companyLight: return "\u{f337}"
        case .companyRegular: return "\u{f338}"
        case .completedByTimeBold: return "\u{f339}"
        case .completedByTimeLight: return "\u{f33a}"
        case .completedByTimeRegular: return "\u{f33b}"
        case .computerBold: return "\u{f33c}"
        case .computerLight: return "\u{f33d}"
        case .computerRegular: return "\u{f33e}"
        case .conciergeBold: return "\u{f33f}"
        case .conciergeLight: return "\u{f340}"
        case .conciergeRegular: return "\u{f341}"
        case .conditionalBlockBold: return "\u{f342}"
        case .conditionalBlockLight: return "\u{f343}"
        case .conditionalBlockRegular: return "\u{f344}"
        case .contactCardBold: return "\u{f345}"
        case .contactCardFilled: return "\u{f346}"
        case .contactCardLight: return "\u{f347}"
        case .contactCardRegular: return "\u{f348}"
        case .contactGroupBold: return "\u{f349}"
        case .contactGroupFilled: return "\u{f34a}"
        case .contactGroupLight: return "\u{f34b}"
        case .contactGroupRegular: return "\u{f34c}"
        case .contactsBold: return "\u{f34d}"
        case .contactsFilled: return "\u{f34e}"
        case .contactsLight: return "\u{f34f}"
        case .contactsRegular: return "\u{f350}"
        case .contentDownloadBold: return "\u{f351}"
        case .contentDownloadFilled: return "\u{f352}"
        case .contentDownloadLight: return "\u{f353}"
        case .contentDownloadRegular: return "\u{f354}"
        case .contentShareBold: return "\u{f355}"
        case .contentShareLight: return "\u{f356}"
        case .contentShareRegular: return "\u{f357}"
        case .contrastBold: return "\u{f358}"
        case .contrastLight: return "\u{f359}"
        case .contrastRegular: return "\u{f35a}"
        case .copyBold: return "\u{f35b}"
        case .copyLight: return "\u{f35c}"
        case .copyRegular: return "\u{f35d}"
        case .cpuBold: return "\u{f35e}"
        case .cpuLight: return "\u{f35f}"
        case .cpuRegular: return "\u{f360}"
        case .createAGroupBold: return "\u{f361}"
        case .createAGroupFilled: return "\u{f362}"
        case .createAGroupLight: return "\u{f363}"
        case .createAGroupRegular: return "\u{f364}"
        case .cropBold: return "\u{f365}"
        case .cropLight: return "\u{f366}"
        case .cropRegular: return "\u{f367}"
        case .cucmConnectionBold: return "\u{f368}"
        case .cucmConnectionLight: return "\u{f369}"
        case .cucmConnectionRegular: return "\u{f36a}"
        case .dailyRecurringScheduleNodeBold: return "\u{f36b}"
        case .dailyRecurringScheduleNodeLight: return "\u{f36c}"
        case .dailyRecurringScheduleNodeRegular: return "\u{f36d}"
        case .dashboardBold: return "\u{f36e}"
        case .dashboardFilled: return "\u{f36f}"
        case .dashboardLight: return "\u{f370}"
        case .dashboardRegular: return "\u{f371}"
        case .dataManagement1: return "\u{f372}"
        case .dataManagement2: return "\u{f373}"
        case .dataManagement: return "\u{f374}"
        case .deleteBold: return "\u{f375}"
        case .deleteFilled: return "\u{f376}"
        case .deleteLight: return "\u{f377}"
        case .deleteRegular: return "\u{f378}"
        case .deskPhoneBold: return "\u{f379}"
        case .deskPhoneFilled: return "\u{f37a}"
        case .deskPhoneLight: return "\u{f37b}"
        case .deskPhoneRegular: return "\u{f37c}"
        case .deskPhoneWarningBold: return "\u{f37d}"
        case .deskPhoneWarningLight: return "\u{f37e}"
        case .deskPhoneWarningRegular: return "\u{f37f}"
        case .deviceConnectionBold: return "\u{f380}"
        case .deviceConnectionFilled: return "\u{f381}"
        case .deviceConnectionLight: return "\u{f382}"
        case .deviceConnectionRegular: return "\u{f383}"
        case .devicePolicyControllerBold: return "\u{f384}"
        case .devicePolicyControllerLight: return "\u{f385}"
        case .devicePolicyControllerRegular: return "\u{f386}"
        case .diagnosticsBold: return "\u{f387}"
        case .diagnosticsLight: return "\u{f388}"
        case .diagnosticsRegular: return "\u{f389}"
        case .dialpadBold: return "\u{f38a}"
        case .dialpadLight: return "\u{f38b}"
        case .dialpadRegular: return "\u{f38c}"
        case .directionalPadBold: return "\u{f38d}"
        case .directionalPadFilled: return "\u{f38e}"
        case .directionalPadLight: return "\u{f38f}"
        case .directionalPadRegular: return "\u{f390}"
        case .directoryBold: return "\u{f391}"
        case .directoryLight: return "\u{f392}"
        case .directoryRegular: return "\u{f393}"
        case .discBold: return "\u{f394}"
        case .discDisconnectedBold: return "\u{f395}"
        case .discDisconnectedLight: return "\u{f396}"
        case .discDisconnectedRegular: return "\u{f397}"
        case .discLight: return "\u{f398}"
        case .discRegular: return "\u{f399}"
        case .disconnectBold: return "\u{f39a}"
        case .disconnectLight: return "\u{f39b}"
        case .disconnectRegular: return "\u{f39c}"
        case .dislikeBold: return "\u{f39d}"
        case .dislikeFilled: return "\u{f39e}"
        case .dislikeLight: return "\u{f39f}"
        case .dislikeRegular: return "\u{f3a0}"
        case .displayBold: return "\u{f3a1}"
        case .displayInputBold: return "\u{f3a2}"
        case .displayInputLight: return "\u{f3a3}"
        case .displayInputRegular: return "\u{f3a4}"
        case .displayLight: return "\u{f3a5}"
        case .displayRegular: return "\u{f3a6}"
        case .displayWarningBold: return "\u{f3a7}"
        case .displayWarningLight: return "\u{f3a8}"
        case .displayWarningRegular: return "\u{f3a9}"
        case .distributeHorizontalBold: return "\u{f3aa}"
        case .distributeHorizontalFilled: return "\u{f3ab}"
        case .distributeHorizontalLight: return "\u{f3ac}"
        case .distributeHorizontalRegular: return "\u{f3ad}"
        case .distributeVerticallyBold: return "\u{f3ae}"
        case .distributeVerticallyFilled: return "\u{f3af}"
        case .distributeVerticallyLight: return "\u{f3b0}"
        case .distributeVerticallyRegular: return "\u{f3b1}"
        case .dndPresenceBold: return "\u{f3b2}"
        case .dndPresenceFilled: return "\u{f3b3}"
        case .dndPresenceLight: return "\u{f3b4}"
        case .dndPresenceRegular: return "\u{f3b5}"
        case .dndPresenceSmallFilled: return "\u{f3b6}"
        case .documentBold: return "\u{f3b7}"
        case .documentCameraBold: return "\u{f3b8}"
        case .documentCameraDisconnectedBold: return "\u{f3b9}"
        case .documentCameraDisconnectedLight: return "\u{f3ba}"
        case .documentCameraDisconnectedRegular: return "\u{f3bb}"
        case .documentCameraLight: return "\u{f3bc}"
        case .documentCameraRegular: return "\u{f3bd}"
        case .documentCreateBold: return "\u{f3be}"
        case .documentCreateFilled: return "\u{f3bf}"
        case .documentCreateLight: return "\u{f3c0}"
        case .documentCreateRegular: return "\u{f3c1}"
        case .documentFilled: return "\u{f3c2}"
        case .documentLight: return "\u{f3c3}"
        case .documentMoveBold: return "\u{f3c4}"
        case .documentMoveFilled: return "\u{f3c5}"
        case .documentMoveLight: return "\u{f3c6}"
        case .documentMoveRegular: return "\u{f3c7}"
        case .documentRegular: return "\u{f3c8}"
        case .documentShareBold: return "\u{f3c9}"
        case .documentShareFilled: return "\u{f3ca}"
        case .documentShareLight: return "\u{f3cb}"
        case .documentShareRegular: return "\u{f3cc}"
        case .doneAllBold: return "\u{f3cd}"
        case .doneAllLight: return "\u{f3ce}"
        case .doneAllRegular: return "\u{f3cf}"
        case .donutChartBold: return "\u{f3d0}"
        case .donutChartFilled: return "\u{f3d1}"
        case .donutChartLight: return "\u{f3d2}"
        case .donutChartRegular: return "\u{f3d3}"
        case .downloadBold: return "\u{f3d4}"
        case .downloadFilled: return "\u{f3d5}"
        case .downloadLight: return "\u{f3d6}"
        case .downloadRegular: return "\u{f3d7}"
        case .draftBold: return "\u{f3d8}"
        case .draftFilled: return "\u{f3d9}"
        case .draftIndicatorBold: return "\u{f3da}"
        case .draftIndicatorSmallFilled: return "\u{f3db}"
        case .draftLight: return "\u{f3dc}"
        case .draftRegular: return "\u{f3dd}"
        case .dragBold: return "\u{f3de}"
        case .dragLight: return "\u{f3df}"
        case .dragRegular: return "\u{f3e0}"
        case .dropdownBold: return "\u{f3e1}"
        case .dropdownLight: return "\u{f3e2}"
        case .dropdownRegular: return "\u{f3e3}"
        case .dx70Bold: return "\u{f3e4}"
        case .dx70Light: return "\u{f3e5}"
        case .dx70Regular: return "\u{f3e6}"
        case .dx80Bold: return "\u{f3e7}"
        case .dx80Filled: return "\u{f3e8}"
        case .dx80Light: return "\u{f3e9}"
        case .dx80Regular: return "\u{f3ea}"
        case .editBold: return "\u{f3eb}"
        case .editLight: return "\u{f3ec}"
        case .editRegular: return "\u{f3ed}"
        case .editablePartialBold: return "\u{f3ee}"
        case .editablePartialLight: return "\u{f3ef}"
        case .editablePartialRegular: return "\u{f3f0}"
        case .educationBold: return "\u{f3f1}"
        case .educationFilled: return "\u{f3f2}"
        case .educationLight: return "\u{f3f3}"
        case .educationRegular: return "\u{f3f4}"
        case .emailBold: return "\u{f3f5}"
        case .emailDeliveredBold: return "\u{f3f6}"
        case .emailDeliveredLight: return "\u{f3f7}"
        case .emailDeliveredRegular: return "\u{f3f8}"
        case .emailFailureBold: return "\u{f3f9}"
        case .emailFailureLight: return "\u{f3fa}"
        case .emailFailureRegular: return "\u{f3fb}"
        case .emailFilled: return "\u{f3fc}"
        case .emailInviteBold: return "\u{f3fd}"
        case .emailInviteLight: return "\u{f3fe}"
        case .emailInviteRegular: return "\u{f3ff}"
        case .emailLight: return "\u{f400}"
        case .emailReadBold: return "\u{f401}"
        case .emailReadFilled: return "\u{f402}"
        case .emailReadLight: return "\u{f403}"
        case .emailReadRegular: return "\u{f404}"
        case .emailRegular: return "\u{f405}"
        case .emojiExcitedBold: return "\u{f406}"
        case .emojiExcitedFilled: return "\u{f407}"
        case .emojiHappyBold: return "\u{f408}"
        case .emojiHappyFilled: return "\u{f409}"
        case .emojiHappyLight: return "\u{f40a}"
        case .emojiHappyRegular: return "\u{f40b}"
        case .emojiPassiveBold: return "\u{f40c}"
        case .emojiPassiveFilled: return "\u{f40d}"
        case .emojiPassiveLight: return "\u{f40e}"
        case .emojiPassiveRegular: return "\u{f40f}"
        case .emojiSadBold: return "\u{f410}"
        case .emojiSadFilled: return "\u{f411}"
        case .emojiSadLight: return "\u{f412}"
        case .emojiSadRegular: return "\u{f413}"
        case .emojiUnhappyBold: return "\u{f414}"
        case .emojiUnhappyFilled: return "\u{f415}"
        case .encryptionCircleFilled: return "\u{f416}"
        case .encryptionFilled: return "\u{f417}"
        case .endRemoteDesktopControlBold: return "\u{f418}"
        case .endRemoteDesktopControlLight: return "\u{f419}"
        case .endRemoteDesktopControlRegular: return "\u{f41a}"
        case .endToEndEncryptionCircleFilled: return "\u{f41b}"
        case .endToEndEncryptionFilled: return "\u{f41c}"
        case .endpointBlockedBold: return "\u{f41d}"
        case .endpointBlockedLight: return "\u{f41e}"
        case .endpointBlockedRegular: return "\u{f41f}"
        case .endpointBold: return "\u{f420}"
        case .endpointG270Bold: return "\u{f421}"
        case .endpointG270DualBold: return "\u{f422}"
        case .endpointG270DualLight: return "\u{f423}"
        case .endpointG270DualRegular: return "\u{f424}"
        case .endpointG270Light: return "\u{f425}"
        case .endpointG270Regular: return "\u{f426}"
        case .endpointG2Bold: return "\u{f427}"
        case .endpointG2Light: return "\u{f428}"
        case .endpointG2Regular: return "\u{f429}"
        case .endpointG2StandBold: return "\u{f42a}"
        case .endpointG2StandLight: return "\u{f42b}"
        case .endpointG2StandRegular: return "\u{f42c}"
        case .endpointLight: return "\u{f42d}"
        case .endpointMx800Bold: return "\u{f42e}"
        case .endpointMx800DualBold: return "\u{f42f}"
        case .endpointMx800DualLight: return "\u{f430}"
        case .endpointMx800DualRegular: return "\u{f431}"
        case .endpointMx800Light: return "\u{f432}"
        case .endpointMx800Regular: return "\u{f433}"
        case .endpointRegular: return "\u{f434}"
        case .endpointStandBold: return "\u{f435}"
        case .endpointStandFilled: return "\u{f436}"
        case .endpointStandLight: return "\u{f437}"
        case .endpointStandRegular: return "\u{f438}"
        case .endpointWarningBold: return "\u{f439}"
        case .endpointWarningLight: return "\u{f43a}"
        case .endpointWarningRegular: return "\u{f43b}"
        case .enterBold: return "\u{f43c}"
        case .enterLight: return "\u{f43d}"
        case .enterRegular: return "\u{f43e}"
        case .enterRoomBold: return "\u{f43f}"
        case .enterRoomFilled: return "\u{f440}"
        case .enterRoomLight: return "\u{f441}"
        case .enterRoomRegular: return "\u{f442}"
        case .eraserBold: return "\u{f443}"
        case .eraserFilled: return "\u{f444}"
        case .eraserLight: return "\u{f445}"
        case .eraserRegular: return "\u{f446}"
        case .errorLegacyBadgeFilled: return "\u{f447}"
        case .errorLegacyBold: return "\u{f448}"
        case .errorLegacyFilled: return "\u{f449}"
        case .errorLegacyLight: return "\u{f44a}"
        case .errorLegacyRegular: return "\u{f44b}"
        case .ethernetBold: return "\u{f44c}"
        case .ethernetLight: return "\u{f44d}"
        case .ethernetRegular: return "\u{f44e}"
        case .eventBold: return "\u{f44f}"
        case .eventLight: return "\u{f450}"
        case .eventRegular: return "\u{f451}"
        case .exitRoomBold: return "\u{f452}"
        case .exitRoomLight: return "\u{f453}"
        case .exitRoomRegular: return "\u{f454}"
        case .exludeBold: return "\u{f455}"
        case .exludeLight: return "\u{f456}"
        case .exludeRegular: return "\u{f457}"
        case .exploreBold: return "\u{f458}"
        case .exploreLight: return "\u{f459}"
        case .exploreRegular: return "\u{f45a}"
        case .exportBold: return "\u{f45b}"
        case .exportLight: return "\u{f45c}"
        case .exportRegular: return "\u{f45d}"
        case .extensionMobilityBold: return "\u{f45e}"
        case .extensionMobilityLight: return "\u{f45f}"
        case .extensionMobilityRegular: return "\u{f460}"
        case .externalMessageBold: return "\u{f461}"
        case .externalMessageLight: return "\u{f462}"
        case .externalMessageRegular: return "\u{f463}"
        case .externalUserBold: return "\u{f464}"
        case .externalUserLight: return "\u{f465}"
        case .externalUserRegular: return "\u{f466}"
        case .familyFontBold: return "\u{f467}"
        case .familyFontLight: return "\u{f468}"
        case .familyFontRegular: return "\u{f469}"
        case .fastForwardBold: return "\u{f46a}"
        case .fastForwardLight: return "\u{f46b}"
        case .fastForwardRegular: return "\u{f46c}"
        case .favoriteBold: return "\u{f46d}"
        case .favoriteFilled: return "\u{f46e}"
        case .favoriteLight: return "\u{f46f}"
        case .favoriteRegular: return "\u{f470}"
        case .favoritesBold: return "\u{f471}"
        case .favoritesFilled: return "\u{f472}"
        case .favoritesLight: return "\u{f473}"
        case .favoritesRegular: return "\u{f474}"
        case .fbwBold: return "\u{f475}"
        case .fbwFilled: return "\u{f476}"
        case .fbwLight: return "\u{f477}"
        case .fbwRegular: return "\u{f478}"
        case .ffwBold: return "\u{f479}"
        case .ffwFilled: return "\u{f47a}"
        case .ffwLight: return "\u{f47b}"
        case .ffwRegular: return "\u{f47c}"
        case .file3DBold: return "\u{f47d}"
        case .file3DFilled: return "\u{f47e}"
        case .file3DLight: return "\u{f47f}"
        case .file3DRegular: return "\u{f480}"
        case .fileAnalysisBold: return "\u{f481}"
        case .fileAnalysisFilled: return "\u{f482}"
        case .fileAnalysisLight: return "\u{f483}"
        case .fileAnalysisRegular: return "\u{f484}"
        case .fileAnnotationBold: return "\u{f485}"
        case .fileAnnotationFilled: return "\u{f486}"
        case .fileAnnotationLight: return "\u{f487}"
        case .fileAnnotationRegular: return "\u{f488}"
        case .fileAudioBold: return "\u{f489}"
        case .fileAudioFilled: return "\u{f48a}"
        case .fileAudioLight: return "\u{f48b}"
        case .fileAudioRegular: return "\u{f48c}"
        case .fileBugBold: return "\u{f48d}"
        case .fileBugFilled: return "\u{f48e}"
        case .fileBugLight: return "\u{f48f}"
        case .fileBugRegular: return "\u{f490}"
        case .fileCodeBold: return "\u{f491}"
        case .fileCodeFilled: return "\u{f492}"
        case .fileCodeLight: return "\u{f493}"
        case .fileCodeRegular: return "\u{f494}"
        case .fileDashboardBold: return "\u{f495}"
        case .fileDashboardFilled: return "\u{f496}"
        case .fileDashboardLight: return "\u{f497}"
        case .fileDashboardRegular: return "\u{f498}"
        case .fileExcelBold: return "\u{f499}"
        case .fileExcelFilled: return "\u{f49a}"
        case .fileExcelLight: return "\u{f49b}"
        case .fileExcelRegular: return "\u{f49c}"
        case .fileGraphBold: return "\u{f49d}"
        case .fileGraphFilled: return "\u{f49e}"
        case .fileGraphLight: return "\u{f49f}"
        case .fileGraphRegular: return "\u{f4a0}"
        case .fileImageBold: return "\u{f4a1}"
        case .fileImageFilled: return "\u{f4a2}"
        case .fileImageLight: return "\u{f4a3}"
        case .fileImageRegular: return "\u{f4a4}"
        case .fileKeynoteBold: return "\u{f4a5}"
        case .fileKeynoteFilled: return "\u{f4a6}"
        case .fileKeynoteLight: return "\u{f4a7}"
        case .fileKeynoteRegular: return "\u{f4a8}"
        case .fileLockedBold: return "\u{f4a9}"
        case .fileLockedFilled: return "\u{f4aa}"
        case .fileLockedLight: return "\u{f4ab}"
        case .fileLockedRegular: return "\u{f4ac}"
        case .fileMissingBold: return "\u{f4ad}"
        case .fileMissingFilled: return "\u{f4ae}"
        case .fileMissingLight: return "\u{f4af}"
        case .fileMissingRegular: return "\u{f4b0}"
        case .fileMusicBold: return "\u{f4b1}"
        case .fileMusicFilled: return "\u{f4b2}"
        case .fileMusicLight: return "\u{f4b3}"
        case .fileMusicRegular: return "\u{f4b4}"
        case .fileOnenoteBold: return "\u{f4b5}"
        case .fileOnenoteFilled: return "\u{f4b6}"
        case .fileOnenoteLight: return "\u{f4b7}"
        case .fileOnenoteRegular: return "\u{f4b8}"
        case .filePdfBold: return "\u{f4b9}"
        case .filePdfFilled: return "\u{f4ba}"
        case .filePdfLight: return "\u{f4bb}"
        case .filePdfRegular: return "\u{f4bc}"
        case .filePowerpointBold: return "\u{f4bd}"
        case .filePowerpointFilled: return "\u{f4be}"
        case .filePowerpointLight: return "\u{f4bf}"
        case .filePowerpointRegular: return "\u{f4c0}"
        case .fileSpreadsheetBold: return "\u{f4c1}"
        case .fileSpreadsheetFilled: return "\u{f4c2}"
        case .fileSpreadsheetLight: return "\u{f4c3}"
        case .fileSpreadsheetRegular: return "\u{f4c4}"
        case .fileTextBold: return "\u{f4c5}"
        case .fileTextFilled: return "\u{f4c6}"
        case .fileTextLight: return "\u{f4c7}"
        case .fileTextRegular: return "\u{f4c8}"
        case .fileVectorBold: return "\u{f4c9}"
        case .fileVectorFilled: return "\u{f4ca}"
        case .fileVectorLight: return "\u{f4cb}"
        case .fileVectorRegular: return "\u{f4cc}"
        case .fileVideoBold: return "\u{f4cd}"
        case .fileVideoFilled: return "\u{f4ce}"
        case .fileVideoLight: return "\u{f4cf}"
        case .fileVideoRegular: return "\u{f4d0}"
        case .fileWordBold: return "\u{f4d1}"
        case .fileWordFilled: return "\u{f4d2}"
        case .fileWordLight: return "\u{f4d3}"
        case .fileWordRegular: return "\u{f4d4}"
        case .fileZipBold: return "\u{f4d5}"
        case .fileZipFilled: return "\u{f4d6}"
        case .fileZipLight: return "\u{f4d7}"
        case .fileZipRegular: return "\u{f4d8}"
        case .filesBold: return "\u{f4d9}"
        case .filesFilled: return "\u{f4da}"
        case .filesLight: return "\u{f4db}"
        case .filesRegular: return "\u{f4dc}"
        case .fillColourBold: return "\u{f4dd}"
        case .fillColourFilled: return "\u{f4de}"
        case .fillColourLight: return "\u{f4df}"
        case .fillColourRegular: return "\u{f4e0}"
        case .filterBold: return "\u{f4e1}"
        case .filterCircleBold: return "\u{f4e2}"
        case .filterCircleFilled: return "\u{f4e3}"
        case .filterCircleLight: return "\u{f4e4}"
        case .filterCircleRegular: return "\u{f4e5}"
        case .filterLight: return "\u{f4e6}"
        case .filterRegular: return "\u{f4e7}"
        case .fitToWidthBold: return "\u{f4e8}"
        case .fitToWidthLight: return "\u{f4e9}"
        case .fitToWidthRegular: return "\u{f4ea}"
        case .fitToWindowBold: return "\u{f4eb}"
        case .fitToWindowExitBold: return "\u{f4ec}"
        case .fitToWindowExitLight: return "\u{f4ed}"
        case .fitToWindowExitRegular: return "\u{f4ee}"
        case .fitToWindowLight: return "\u{f4ef}"
        case .fitToWindowRegular: return "\u{f4f0}"
        case .flagBold: return "\u{f4f1}"
        case .flagCircleBold: return "\u{f4f2}"
        case .flagCircleFilled: return "\u{f4f3}"
        case .flagCircleLight: return "\u{f4f4}"
        case .flagCircleRegular: return "\u{f4f5}"
        case .flagFilled: return "\u{f4f6}"
        case .flagLight: return "\u{f4f7}"
        case .flagRegular: return "\u{f4f8}"
        case .folderBold: return "\u{f4f9}"
        case .folderEditBold: return "\u{f4fa}"
        case .folderEditLight: return "\u{f4fb}"
        case .folderEditRegular: return "\u{f4fc}"
        case .folderLight: return "\u{f4fd}"
        case .folderLockBold: return "\u{f4fe}"
        case .folderLockLight: return "\u{f4ff}"
        case .folderLockRegular: return "\u{f500}"
        case .folderRegular: return "\u{f501}"
        case .folderViewBold: return "\u{f502}"
        case .folderViewLight: return "\u{f503}"
        case .folderViewRegular: return "\u{f504}"
        case .followUpBold: return "\u{f505}"
        case .followUpLight: return "\u{f506}"
        case .followUpRegular: return "\u{f507}"
        case .foodBold: return "\u{f508}"
        case .foodLight: return "\u{f509}"
        case .foodRegular: return "\u{f50a}"
        case .formatBold: return "\u{f50b}"
        case .formatControlPanelDraggerBold: return "\u{f50c}"
        case .formatControlPanelDraggerHorizontalBold: return "\u{f50d}"
        case .formatControlPanelDraggerHorizontalLight: return "\u{f50e}"
        case .formatControlPanelDraggerHorizontalRegular: return "\u{f50f}"
        case .formatControlPanelDraggerLight: return "\u{f510}"
        case .formatControlPanelDraggerRegular: return "\u{f511}"
        case .formatDefaultAppBold: return "\u{f512}"
        case .formatDefaultAppLight: return "\u{f513}"
        case .formatDefaultAppRegular: return "\u{f514}"
        case .formatLight: return "\u{f515}"
        case .formatPanelControlBarBold: return "\u{f516}"
        case .formatPanelControlBarLight: return "\u{f517}"
        case .formatPanelControlBarRegular: return "\u{f518}"
        case .formatPanelControlDownBold: return "\u{f519}"
        case .formatPanelControlDownLight: return "\u{f51a}"
        case .formatPanelControlDownRegular: return "\u{f51b}"
        case .formatPanelControlLeftBold: return "\u{f51c}"
        case .formatPanelControlLeftLight: return "\u{f51d}"
        case .formatPanelControlLeftRegular: return "\u{f51e}"
        case .formatPanelControlRightBold: return "\u{f51f}"
        case .formatPanelControlRightLight: return "\u{f520}"
        case .formatPanelControlRightRegular: return "\u{f521}"
        case .formatPanelControlUpBold: return "\u{f522}"
        case .formatPanelControlUpDownBold: return "\u{f523}"
        case .formatPanelControlUpDownLight: return "\u{f524}"
        case .formatPanelControlUpDownRegular: return "\u{f525}"
        case .formatPanelControlUpLight: return "\u{f526}"
        case .formatPanelControlUpRegular: return "\u{f527}"
        case .formatRegular: return "\u{f528}"
        case .formatViewMixedBold: return "\u{f529}"
        case .formatViewMixedLight: return "\u{f52a}"
        case .formatViewMixedRegular: return "\u{f52b}"
        case .forwardMessageBold: return "\u{f52c}"
        case .forwardMessageFilled: return "\u{f52d}"
        case .forwardMessageLight: return "\u{f52e}"
        case .forwardMessageRegular: return "\u{f52f}"
        case .fourColumnBold: return "\u{f530}"
        case .fourColumnLight: return "\u{f531}"
        case .fourColumnRegular: return "\u{f532}"
        case .fourWayNavigationBold: return "\u{f533}"
        case .fourWayNavigationLight: return "\u{f534}"
        case .fourWayNavigationRegular: return "\u{f535}"
        case .frequencyCappingBold: return "\u{f536}"
        case .frequencyCappingLight: return "\u{f537}"
        case .frequencyCappingRegular: return "\u{f538}"
        case .fufillmentBold: return "\u{f539}"
        case .fufillmentLight: return "\u{f53a}"
        case .fufillmentRegular: return "\u{f53b}"
        case .fullscreenBold: return "\u{f53c}"
        case .fullscreenExitBold: return "\u{f53d}"
        case .fullscreenExitLight: return "\u{f53e}"
        case .fullscreenExitRegular: return "\u{f53f}"
        case .fullscreenLight: return "\u{f540}"
        case .fullscreenRegular: return "\u{f541}"
        case .genericDeviceVideoBold: return "\u{f542}"
        case .genericDeviceVideoFilled: return "\u{f543}"
        case .genericDeviceVideoLight: return "\u{f544}"
        case .genericDeviceVideoRegular: return "\u{f545}"
        case .genericDeviceVideoSmallFilled: return "\u{f546}"
        case .gifBold: return "\u{f547}"
        case .gifFilled: return "\u{f548}"
        case .gifLight: return "\u{f549}"
        case .gifRegular: return "\u{f54a}"
        case .googleMeet: return "\u{f54b}"
        case .greenRoomBold: return "\u{f54c}"
        case .greenRoomFilled: return "\u{f54d}"
        case .greenRoomLight: return "\u{f54e}"
        case .greenRoomRegular: return "\u{f54f}"
        case .groupBold: return "\u{f550}"
        case .groupLight: return "\u{f551}"
        case .groupPickupBold: return "\u{f552}"
        case .groupPickupFilled: return "\u{f553}"
        case .groupPickupLight: return "\u{f554}"
        case .groupPickupRegular: return "\u{f555}"
        case .groupRegular: return "\u{f556}"
        case .guestIssuerBold: return "\u{f557}"
        case .guestIssuerLight: return "\u{f558}"
        case .guestIssuerRegular: return "\u{f559}"
        case .guideBold: return "\u{f55a}"
        case .guideLight: return "\u{f55b}"
        case .guideRegular: return "\u{f55c}"
        case .handlerBold: return "\u{f55d}"
        case .handlerLight: return "\u{f55e}"
        case .handlerRegular: return "\u{f55f}"
        case .handsetAlertBold: return "\u{f560}"
        case .handsetAlertFilled: return "\u{f561}"
        case .handsetAlertLight: return "\u{f562}"
        case .handsetAlertRegular: return "\u{f563}"
        case .handsetBold: return "\u{f564}"
        case .handsetFilled: return "\u{f565}"
        case .handsetLight: return "\u{f566}"
        case .handsetMutedBold: return "\u{f567}"
        case .handsetMutedFilled: return "\u{f568}"
        case .handsetMutedLight: return "\u{f569}"
        case .handsetMutedRegular: return "\u{f56a}"
        case .handsetRegular: return "\u{f56b}"
        case .handshakeBold: return "\u{f56c}"
        case .handshakeLight: return "\u{f56d}"
        case .handshakeRegular: return "\u{f56e}"
        case .headingOneBold: return "\u{f56f}"
        case .headingOneLight: return "\u{f570}"
        case .headingOneRegular: return "\u{f571}"
        case .headingThreeBold: return "\u{f572}"
        case .headingThreeLight: return "\u{f573}"
        case .headingThreeRegular: return "\u{f574}"
        case .headingTwoBold: return "\u{f575}"
        case .headingTwoLight: return "\u{f576}"
        case .headingTwoRegular: return "\u{f577}"
        case .headsetAlertBold: return "\u{f578}"
        case .headsetAlertLight: return "\u{f579}"
        case .headsetAlertRegular: return "\u{f57a}"
        case .headsetBold: return "\u{f57b}"
        case .headsetFilled: return "\u{f57c}"
        case .headsetLight: return "\u{f57d}"
        case .headsetMutedBold: return "\u{f57e}"
        case .headsetMutedLight: return "\u{f57f}"
        case .headsetMutedRegular: return "\u{f580}"
        case .headsetPrivateBold: return "\u{f581}"
        case .headsetPrivateLight: return "\u{f582}"
        case .headsetPrivateRegular: return "\u{f583}"
        case .headsetRegular: return "\u{f584}"
        case .helpBold: return "\u{f585}"
        case .helpCircleActiveFilled: return "\u{f586}"
        case .helpCircleBold: return "\u{f587}"
        case .helpCircleLight: return "\u{f588}"
        case .helpCircleRegular: return "\u{f589}"
        case .helpLight: return "\u{f58a}"
        case .helpRegular: return "\u{f58b}"
        case .helpdeskBold: return "\u{f58c}"
        case .helpdeskLight: return "\u{f58d}"
        case .helpdeskRegular: return "\u{f58e}"
        case .hideBold: return "\u{f58f}"
        case .hideFilled: return "\u{f590}"
        case .hideLight: return "\u{f591}"
        case .hideRegular: return "\u{f592}"
        case .homeBold: return "\u{f593}"
        case .homeFilled: return "\u{f594}"
        case .homeLight: return "\u{f595}"
        case .homeRegular: return "\u{f596}"
        case .horizontalLineBold: return "\u{f597}"
        case .horizontalLineLight: return "\u{f598}"
        case .horizontalLineRegular: return "\u{f599}"
        case .hotelingBold: return "\u{f59a}"
        case .hotelingFilled: return "\u{f59b}"
        case .hotelingLight: return "\u{f59c}"
        case .hotelingRegular: return "\u{f59d}"
        case .humidityBold: return "\u{f59e}"
        case .humidityLight: return "\u{f59f}"
        case .humidityRegular: return "\u{f5a0}"
        case .huntGroupBold: return "\u{f5a1}"
        case .huntGroupFilled: return "\u{f5a2}"
        case .huntGroupLight: return "\u{f5a3}"
        case .huntGroupRegular: return "\u{f5a4}"
        case .importBold: return "\u{f5a5}"
        case .importLight: return "\u{f5a6}"
        case .importRegular: return "\u{f5a7}"
        case .inCommonBold: return "\u{f5a8}"
        case .inCommonLight: return "\u{f5a9}"
        case .inCommonRegular: return "\u{f5aa}"
        case .includeBold: return "\u{f5ab}"
        case .includeLight: return "\u{f5ac}"
        case .includeRegular: return "\u{f5ad}"
        case .incomingCallLegacyBold: return "\u{f5ae}"
        case .incomingCallLegacyFilled: return "\u{f5af}"
        case .incomingCallLegacyLight: return "\u{f5b0}"
        case .incomingCallLegacyRegular: return "\u{f5b1}"
        case .infoBadgeFilled: return "\u{f5b2}"
        case .infoCircleBold: return "\u{f5b3}"
        case .infoCircleFilled: return "\u{f5b4}"
        case .infoCircleLight: return "\u{f5b5}"
        case .infoCircleRegular: return "\u{f5b6}"
        case .infoCircleTwoBold: return "\u{f5b7}"
        case .infoCircleTwoFilled: return "\u{f5b8}"
        case .infoCircleTwoLight: return "\u{f5b9}"
        case .infoCircleTwoRegular: return "\u{f5ba}"
        case .inputBold: return "\u{f5bb}"
        case .inputDisconnectedBold: return "\u{f5bc}"
        case .inputDisconnectedLight: return "\u{f5bd}"
        case .inputDisconnectedRegular: return "\u{f5be}"
        case .inputLight: return "\u{f5bf}"
        case .inputRegular: return "\u{f5c0}"
        case .insightsBold: return "\u{f5c1}"
        case .insightsLight: return "\u{f5c2}"
        case .insightsRegular: return "\u{f5c3}"
        case .integrationsBold: return "\u{f5c4}"
        case .integrationsLight: return "\u{f5c5}"
        case .integrationsRegular: return "\u{f5c6}"
        case .intelligentRoutingBold: return "\u{f5c7}"
        case .intelligentRoutingLight: return "\u{f5c8}"
        case .intelligentRoutingRegular: return "\u{f5c9}"
        case .invitedUserBold: return "\u{f5ca}"
        case .invitedUserLight: return "\u{f5cb}"
        case .invitedUserRegular: return "\u{f5cc}"
        case .italicBold: return "\u{f5cd}"
        case .italicLight: return "\u{f5ce}"
        case .italicRegular: return "\u{f5cf}"
        case .joinAudioBold: return "\u{f5d0}"
        case .joinAudioFilled: return "\u{f5d1}"
        case .joinAudioLight: return "\u{f5d2}"
        case .joinAudioRegular: return "\u{f5d3}"
        case .keepInTouchBold: return "\u{f5d4}"
        case .keepInTouchFilled: return "\u{f5d5}"
        case .keepInTouchLight: return "\u{f5d6}"
        case .keepInTouchRegular: return "\u{f5d7}"
        case .keyboardBold: return "\u{f5d8}"
        case .keyboardCloseBold: return "\u{f5d9}"
        case .keyboardCloseLight: return "\u{f5da}"
        case .keyboardCloseRegular: return "\u{f5db}"
        case .keyboardLight: return "\u{f5dc}"
        case .keyboardRegular: return "\u{f5dd}"
        case .languageBold: return "\u{f5de}"
        case .languageLight: return "\u{f5df}"
        case .languageRegular: return "\u{f5e0}"
        case .laptopBold: return "\u{f5e1}"
        case .laptopDisconnectedBold: return "\u{f5e2}"
        case .laptopDisconnectedLight: return "\u{f5e3}"
        case .laptopDisconnectedRegular: return "\u{f5e4}"
        case .laptopFilled: return "\u{f5e5}"
        case .laptopLight: return "\u{f5e6}"
        case .laptopRegular: return "\u{f5e7}"
        case .laserPointerBold: return "\u{f5e8}"
        case .laserPointerLight: return "\u{f5e9}"
        case .laserPointerRegular: return "\u{f5ea}"
        case .launchBold: return "\u{f5eb}"
        case .launchLight: return "\u{f5ec}"
        case .launchRegular: return "\u{f5ed}"
        case .layoutSideBySideVerticalBold: return "\u{f5ee}"
        case .layoutSideBySideVerticalFilled: return "\u{f5ef}"
        case .layoutSideBySideVerticalLight: return "\u{f5f0}"
        case .layoutSideBySideVerticalRegular: return "\u{f5f1}"
        case .leaveBreakoutSessionBold: return "\u{f5f2}"
        case .leaveBreakoutSessionLight: return "\u{f5f3}"
        case .leaveBreakoutSessionRegular: return "\u{f5f4}"
        case .leaveDeviceBold: return "\u{f5f5}"
        case .leaveDeviceLight: return "\u{f5f6}"
        case .leaveDeviceRegular: return "\u{f5f7}"
        case .likeBold: return "\u{f5f8}"
        case .likeFilled: return "\u{f5f9}"
        case .likeLight: return "\u{f5fa}"
        case .likeRegular: return "\u{f5fb}"
        case .linkBold: return "\u{f5fc}"
        case .linkLight: return "\u{f5fd}"
        case .linkRegular: return "\u{f5fe}"
        case .listBulletedBold: return "\u{f5ff}"
        case .listBulletedLight: return "\u{f600}"
        case .listBulletedRegular: return "\u{f601}"
        case .listMenuBold: return "\u{f602}"
        case .listMenuLight: return "\u{f603}"
        case .listMenuRegular: return "\u{f604}"
        case .listNumberedBold: return "\u{f605}"
        case .listNumberedLight: return "\u{f606}"
        case .listNumberedRegular: return "\u{f607}"
        case .locationBold: return "\u{f608}"
        case .locationFilled: return "\u{f609}"
        case .locationLight: return "\u{f60a}"
        case .locationRegular: return "\u{f60b}"
        case .longTextBoxBold: return "\u{f60c}"
        case .longTextBoxLight: return "\u{f60d}"
        case .longTextBoxRegular: return "\u{f60e}"
        case .lowerHandBold: return "\u{f60f}"
        case .lowerHandLight: return "\u{f610}"
        case .lowerHandRegular: return "\u{f611}"
        case .magicPenBold: return "\u{f612}"
        case .magicPenFilled: return "\u{f613}"
        case .magicPenLight: return "\u{f614}"
        case .magicPenRegular: return "\u{f615}"
        case .markAsUnreadBold: return "\u{f616}"
        case .markAsUnreadLight: return "\u{f617}"
        case .markAsUnreadRegular: return "\u{f618}"
        case .markdownBold: return "\u{f619}"
        case .markdownLight: return "\u{f61a}"
        case .markdownRegular: return "\u{f61b}"
        case .markerBold: return "\u{f61c}"
        case .markerFilled: return "\u{f61d}"
        case .markerLight: return "\u{f61e}"
        case .markerRegular: return "\u{f61f}"
        case .maximizeBold: return "\u{f620}"
        case .maximizeLight: return "\u{f621}"
        case .maximizeRegular: return "\u{f622}"
        case .mediaPlayerBold: return "\u{f623}"
        case .mediaPlayerLight: return "\u{f624}"
        case .mediaPlayerRegular: return "\u{f625}"
        case .mediaQualityGoodBold: return "\u{f626}"
        case .mediaQualityGoodFilled: return "\u{f627}"
        case .mediaQualityGoodLight: return "\u{f628}"
        case .mediaQualityGoodRegular: return "\u{f629}"
        case .mediaQualityPoorBold: return "\u{f62a}"
        case .mediaQualityPoorFilled: return "\u{f62b}"
        case .mediaQualityPoorLight: return "\u{f62c}"
        case .mediaQualityPoorRegular: return "\u{f62d}"
        case .mediaQualityUnstableBold: return "\u{f62e}"
        case .mediaQualityUnstableFilled: return "\u{f62f}"
        case .mediaQualityUnstableLight: return "\u{f630}"
        case .mediaQualityUnstableRegular: return "\u{f631}"
        case .mediumQualityGoodFilled: return "\u{f632}"
        case .mediumQualityPoorFilled: return "\u{f633}"
        case .mediumQualityUnstableFilled: return "\u{f634}"
        case .meetBold: return "\u{f635}"
        case .meetEndBold: return "\u{f636}"
        case .meetEndLight: return "\u{f637}"
        case .meetEndRegular: return "\u{f638}"
        case .meetFilled: return "\u{f639}"
        case .meetLight: return "\u{f63a}"
        case .meetRegular: return "\u{f63b}"
        case .meetingsBold: return "\u{f63c}"
        case .meetingsFilled: return "\u{f63d}"
        case .meetingsFocusMonthBold: return "\u{f63e}"
        case .meetingsFocusMonthLight: return "\u{f63f}"
        case .meetingsFocusMonthRegular: return "\u{f640}"
        case .meetingsFocusOneDayBold: return "\u{f641}"
        case .meetingsFocusOneDayLight: return "\u{f642}"
        case .meetingsFocusOneDayRegular: return "\u{f643}"
        case .meetingsFocusThreeDayBold: return "\u{f644}"
        case .meetingsFocusThreeDayLight: return "\u{f645}"
        case .meetingsFocusThreeDayRegular: return "\u{f646}"
        case .meetingsFocusUpcomingBold: return "\u{f647}"
        case .meetingsFocusUpcomingLight: return "\u{f648}"
        case .meetingsFocusUpcomingRegular: return "\u{f649}"
        case .meetingsFocusWeekBold: return "\u{f64a}"
        case .meetingsFocusWeekLight: return "\u{f64b}"
        case .meetingsFocusWeekRegular: return "\u{f64c}"
        case .meetingsLight: return "\u{f64d}"
        case .meetingsPresenceBold: return "\u{f64e}"
        case .meetingsPresenceFilled: return "\u{f64f}"
        case .meetingsPresenceLight: return "\u{f650}"
        case .meetingsPresenceRegular: return "\u{f651}"
        case .meetingsPresenceSmallFilled: return "\u{f652}"
        case .meetingsRegular: return "\u{f653}"
        case .meetingsTeamActiveBold: return "\u{f654}"
        case .meetingsTeamActiveLight: return "\u{f655}"
        case .meetingsTeamActiveRegular: return "\u{f656}"
        case .meetingsTeamBold: return "\u{f657}"
        case .meetingsTeamLight: return "\u{f658}"
        case .meetingsTeamNewBold: return "\u{f659}"
        case .meetingsTeamNewLight: return "\u{f65a}"
        case .meetingsTeamNewRegular: return "\u{f65b}"
        case .meetingsTeamRegular: return "\u{f65c}"
        case .mentionBold: return "\u{f65d}"
        case .mentionLight: return "\u{f65e}"
        case .mentionRegular: return "\u{f65f}"
        case .messageQueingBold: return "\u{f660}"
        case .messageQueingLight: return "\u{f661}"
        case .messageQueingRegular: return "\u{f662}"
        case .microphoneBold: return "\u{f663}"
        case .microphoneFilled: return "\u{f664}"
        case .microphoneHardMutedBold: return "\u{f665}"
        case .microphoneHardMutedColoredBold: return "\u{f666}"
        case .microphoneHardMutedColoredLight: return "\u{f667}"
        case .microphoneHardMutedColoredRegular: return "\u{f668}"
        case .microphoneHardMutedLight: return "\u{f669}"
        case .microphoneHardMutedRegular: return "\u{f66a}"
        case .microphoneLight: return "\u{f66b}"
        case .microphoneMusicModeColoredBold: return "\u{f66c}"
        case .microphoneMusicModeColoredLight: return "\u{f66d}"
        case .microphoneMusicModeColoredRegular: return "\u{f66e}"
        case .microphoneMutedBold: return "\u{f66f}"
        case .microphoneMutedFilled: return "\u{f670}"
        case .microphoneMutedIndicatorFilled: return "\u{f671}"
        case .microphoneMutedLight: return "\u{f672}"
        case .microphoneMutedRedBold: return "\u{f673}"
        case .microphoneMutedRedFilled: return "\u{f674}"
        case .microphoneMutedRedLight: return "\u{f675}"
        case .microphoneMutedRedRegular: return "\u{f676}"
        case .microphoneMutedRegular: return "\u{f677}"
        case .microphoneRegular: return "\u{f678}"
        case .minimizeBold: return "\u{f679}"
        case .minimizeLight: return "\u{f67a}"
        case .minimizeRegular: return "\u{f67b}"
        case .minusBold: return "\u{f67c}"
        case .minusLight: return "\u{f67d}"
        case .minusRegular: return "\u{f67e}"
        case .mirrorBold: return "\u{f67f}"
        case .mirrorFilled: return "\u{f680}"
        case .mirrorLight: return "\u{f681}"
        case .mirrorRegular: return "\u{f682}"
        case .moderatorBold: return "\u{f683}"
        case .moderatorLight: return "\u{f684}"
        case .moderatorRegular: return "\u{f685}"
        case .monitoringBold: return "\u{f686}"
        case .monitoringLight: return "\u{f687}"
        case .monitoringRegular: return "\u{f688}"
        case .monthlyRecurringScheduleNodeBold: return "\u{f689}"
        case .monthlyRecurringScheduleNodeLight: return "\u{f68a}"
        case .monthlyRecurringScheduleNodeRegular: return "\u{f68b}"
        case .moreAdrBold: return "\u{f68c}"
        case .moreAdrLight: return "\u{f68d}"
        case .moreAdrRegular: return "\u{f68e}"
        case .moreBold: return "\u{f68f}"
        case .moreCircleBold: return "\u{f690}"
        case .moreCircleFilled: return "\u{f691}"
        case .moreCircleLight: return "\u{f692}"
        case .moreCircleRegular: return "\u{f693}"
        case .moreCirecleFilled: return "\u{f694}"
        case .moreLight: return "\u{f695}"
        case .moreRegular: return "\u{f696}"
        case .mouseCursorBold: return "\u{f697}"
        case .mouseCursorLight: return "\u{f698}"
        case .mouseCursorRegular: return "\u{f699}"
        case .moveCallInAdrBold: return "\u{f69a}"
        case .moveCallInAdrLight: return "\u{f69b}"
        case .moveCallInAdrRegular: return "\u{f69c}"
        case .moveCallInIphBold: return "\u{f69d}"
        case .moveCallInIphLight: return "\u{f69e}"
        case .moveCallInIphRegular: return "\u{f69f}"
        case .moveCallInLaptopBold: return "\u{f6a0}"
        case .moveCallInLaptopLight: return "\u{f6a1}"
        case .moveCallInLaptopRegular: return "\u{f6a2}"
        case .moveCallInOutAdrBold: return "\u{f6a3}"
        case .moveCallInOutAdrLight: return "\u{f6a4}"
        case .moveCallInOutAdrRegular: return "\u{f6a5}"
        case .moveCallInOutIphBold: return "\u{f6a6}"
        case .moveCallInOutIphLight: return "\u{f6a7}"
        case .moveCallInOutIphRegular: return "\u{f6a8}"
        case .moveCallInTabletBold: return "\u{f6a9}"
        case .moveCallInTabletLight: return "\u{f6aa}"
        case .moveCallInTabletRegular: return "\u{f6ab}"
        case .moveCallOutAdrBold: return "\u{f6ac}"
        case .moveCallOutAdrLight: return "\u{f6ad}"
        case .moveCallOutAdrRegular: return "\u{f6ae}"
        case .moveCallOutIphBold: return "\u{f6af}"
        case .moveCallOutIphLight: return "\u{f6b0}"
        case .moveCallOutIphRegular: return "\u{f6b1}"
        case .moveCallOutLaptopBold: return "\u{f6b2}"
        case .moveCallOutLaptopLight: return "\u{f6b3}"
        case .moveCallOutLaptopRegular: return "\u{f6b4}"
        case .moveCallOutTabletBold: return "\u{f6b5}"
        case .moveCallOutTabletLight: return "\u{f6b6}"
        case .moveCallOutTabletRegular: return "\u{f6b7}"
        case .msTeams: return "\u{f6b8}"
        case .multilineChartBold: return "\u{f6b9}"
        case .multilineChartFilled: return "\u{f6ba}"
        case .multilineChartLight: return "\u{f6bb}"
        case .multilineChartRegular: return "\u{f6bc}"
        case .multimediaBold: return "\u{f6bd}"
        case .multimediaFilled: return "\u{f6be}"
        case .multimediaLight: return "\u{f6bf}"
        case .multimediaRegular: return "\u{f6c0}"
        case .multipledDevicesBold: return "\u{f6c1}"
        case .multipledDevicesLight: return "\u{f6c2}"
        case .multipledDevicesRegular: return "\u{f6c3}"
        case .musicModeBold: return "\u{f6c4}"
        case .musicModeCircleBold: return "\u{f6c5}"
        case .musicModeCircleFilled: return "\u{f6c6}"
        case .musicModeCircleLight: return "\u{f6c7}"
        case .musicModeCircleRegular: return "\u{f6c8}"
        case .musicModeFilled: return "\u{f6c9}"
        case .musicModeLight: return "\u{f6ca}"
        case .musicModeRegular: return "\u{f6cb}"
        case .muteOnEntryBold: return "\u{f6cc}"
        case .muteOnEntryFilled: return "\u{f6cd}"
        case .muteOnEntryLight: return "\u{f6ce}"
        case .muteOnEntryRegular: return "\u{f6cf}"
        case .newManagerBold: return "\u{f6d0}"
        case .newManagerLight: return "\u{f6d1}"
        case .newManagerRegular: return "\u{f6d2}"
        case .newTitleBold: return "\u{f6d3}"
        case .newTitleLight: return "\u{f6d4}"
        case .newTitleRegular: return "\u{f6d5}"
        case .newVoicemailBold: return "\u{f6d6}"
        case .newVoicemailLight: return "\u{f6d7}"
        case .newVoicemailRegular: return "\u{f6d8}"
        case .newWhiteboardBold: return "\u{f6d9}"
        case .newWhiteboardLight: return "\u{f6da}"
        case .newWhiteboardRegular: return "\u{f6db}"
        case .nextBold: return "\u{f6dc}"
        case .nextLight: return "\u{f6dd}"
        case .nextRegular: return "\u{f6de}"
        case .noDevicesBold: return "\u{f6df}"
        case .noDevicesLight: return "\u{f6e0}"
        case .noDevicesRegular: return "\u{f6e1}"
        case .noiseDetectedCanceledFilled: return "\u{f6e2}"
        case .noiseDetectedFilled: return "\u{f6e3}"
        case .noiseNoneCanceledFilled: return "\u{f6e4}"
        case .noiseNoneFilled: return "\u{f6e5}"
        case .noiseRemovalBold: return "\u{f6e6}"
        case .noiseRemovalLight: return "\u{f6e7}"
        case .noiseRemovalRegular: return "\u{f6e8}"
        case .noteBold: return "\u{f6e9}"
        case .noteLight: return "\u{f6ea}"
        case .notePptBold: return "\u{f6eb}"
        case .notePptLight: return "\u{f6ec}"
        case .notePptRegular: return "\u{f6ed}"
        case .noteRegular: return "\u{f6ee}"
        case .notesBold: return "\u{f6ef}"
        case .notesLight: return "\u{f6f0}"
        case .notesRegular: return "\u{f6f1}"
        case .numberBold: return "\u{f6f2}"
        case .numberLight: return "\u{f6f3}"
        case .numberRegular: return "\u{f6f4}"
        case .oldRemoteBold: return "\u{f6f5}"
        case .oldRemoteLight: return "\u{f6f6}"
        case .oldRemoteRegular: return "\u{f6f7}"
        case .oldTouchBold: return "\u{f6f8}"
        case .oldTouchLight: return "\u{f6f9}"
        case .oldTouchRegular: return "\u{f6fa}"
        case .oneColumnBold: return "\u{f6fb}"
        case .oneColumnLight: return "\u{f6fc}"
        case .oneColumnRegular: return "\u{f6fd}"
        case .openInFolderBold: return "\u{f6fe}"
        case .openInFolderLight: return "\u{f6ff}"
        case .openInFolderRegular: return "\u{f700}"
        case .openPagesBold: return "\u{f701}"
        case .openPagesLight: return "\u{f702}"
        case .openPagesRegular: return "\u{f703}"
        case .otherNumberBold: return "\u{f704}"
        case .otherNumberLight: return "\u{f705}"
        case .otherNumberRegular: return "\u{f706}"
        case .otherNumberWarningBold: return "\u{f707}"
        case .otherNumberWarningLight: return "\u{f708}"
        case .otherNumberWarningRegular: return "\u{f709}"
        case .outgoingCallLegacyBold: return "\u{f70a}"
        case .outgoingCallLegacyLight: return "\u{f70b}"
        case .outgoingCallLegacyRegular: return "\u{f70c}"
        case .overflowLeftBold: return "\u{f70d}"
        case .overflowLeftLight: return "\u{f70e}"
        case .overflowLeftRegular: return "\u{f70f}"
        case .overflowRightBold: return "\u{f710}"
        case .overflowRightLight: return "\u{f711}"
        case .overflowRightRegular: return "\u{f712}"
        case .pairedCameraBold: return "\u{f713}"
        case .pairedCameraLight: return "\u{f714}"
        case .pairedCameraRegular: return "\u{f715}"
        case .pairedDeviceBold: return "\u{f716}"
        case .pairedDeviceLight: return "\u{f717}"
        case .pairedDeviceRegular: return "\u{f718}"
        case .pairedHandsetBold: return "\u{f719}"
        case .pairedHandsetLight: return "\u{f71a}"
        case .pairedHandsetRegular: return "\u{f71b}"
        case .pairingBold: return "\u{f71c}"
        case .pairingLight: return "\u{f71d}"
        case .pairingRegular: return "\u{f71e}"
        case .parkedBold: return "\u{f71f}"
        case .parkedFilled: return "\u{f720}"
        case .parkedLight: return "\u{f721}"
        case .parkedRegular: return "\u{f722}"
        case .parseBold: return "\u{f723}"
        case .parseLight: return "\u{f724}"
        case .parseRegular: return "\u{f725}"
        case .partialBold: return "\u{f726}"
        case .partialLight: return "\u{f727}"
        case .partialRegular: return "\u{f728}"
        case .participantAddBold: return "\u{f729}"
        case .participantAddLight: return "\u{f72a}"
        case .participantAddRegular: return "\u{f72b}"
        case .participantBlockedBold: return "\u{f72c}"
        case .participantBlockedLight: return "\u{f72d}"
        case .participantBlockedRegular: return "\u{f72e}"
        case .participantBold: return "\u{f72f}"
        case .participantFilled: return "\u{f730}"
        case .participantLight: return "\u{f731}"
        case .participantListBold: return "\u{f732}"
        case .participantListFilled: return "\u{f733}"
        case .participantListLight: return "\u{f734}"
        case .participantListRegular: return "\u{f735}"
        case .participantRegular: return "\u{f736}"
        case .participantRemoveBold: return "\u{f737}"
        case .participantRemoveLight: return "\u{f738}"
        case .participantRemoveRegular: return "\u{f739}"
        case .participantUnknownBold: return "\u{f73a}"
        case .participantUnknownLight: return "\u{f73b}"
        case .participantUnknownRegular: return "\u{f73c}"
        case .passMouseBold: return "\u{f73d}"
        case .passMouseLight: return "\u{f73e}"
        case .passMouseRegular: return "\u{f73f}"
        case .pauseBold: return "\u{f740}"
        case .pauseFilled: return "\u{f741}"
        case .pauseLight: return "\u{f742}"
        case .pauseRegular: return "\u{f743}"
        case .penBold: return "\u{f744}"
        case .penFilled: return "\u{f745}"
        case .penLight: return "\u{f746}"
        case .penRegular: return "\u{f747}"
        case .peopleBold: return "\u{f748}"
        case .peopleCircleBold: return "\u{f749}"
        case .peopleCircleFilled: return "\u{f74a}"
        case .peopleCircleLight: return "\u{f74b}"
        case .peopleCircleRegular: return "\u{f74c}"
        case .peopleFilled: return "\u{f74d}"
        case .peopleInsightsFilled: return "\u{f74e}"
        case .peopleLight: return "\u{f74f}"
        case .peopleRegular: return "\u{f750}"
        case .phoneAlertBold: return "\u{f751}"
        case .phoneAlertLight: return "\u{f752}"
        case .phoneAlertRegular: return "\u{f753}"
        case .phoneBold: return "\u{f754}"
        case .phoneFilled: return "\u{f755}"
        case .phoneLight: return "\u{f756}"
        case .phoneMutedBold: return "\u{f757}"
        case .phoneMutedLight: return "\u{f758}"
        case .phoneMutedRegular: return "\u{f759}"
        case .phonePrivateBold: return "\u{f75a}"
        case .phonePrivateLight: return "\u{f75b}"
        case .phonePrivateRegular: return "\u{f75c}"
        case .phoneRegular: return "\u{f75d}"
        case .phoneReplyAllBold: return "\u{f75e}"
        case .phoneReplyAllLight: return "\u{f75f}"
        case .phoneReplyAllRegular: return "\u{f760}"
        case .phoneReplyBold: return "\u{f761}"
        case .phoneReplyLight: return "\u{f762}"
        case .phoneReplyRegular: return "\u{f763}"
        case .phoneSmallFilled: return "\u{f764}"
        case .pickerBold: return "\u{f765}"
        case .pickerLight: return "\u{f766}"
        case .pickerRegular: return "\u{f767}"
        case .pictureInPictureBold: return "\u{f768}"
        case .pictureInPictureFilled: return "\u{f769}"
        case .pictureInPictureLight: return "\u{f76a}"
        case .pictureInPictureRegular: return "\u{f76b}"
        case .pieChartBold: return "\u{f76c}"
        case .pieChartFilled: return "\u{f76d}"
        case .pieChartLight: return "\u{f76e}"
        case .pieChartRegular: return "\u{f76f}"
        case .pinBold: return "\u{f770}"
        case .pinFilled: return "\u{f771}"
        case .pinLight: return "\u{f772}"
        case .pinListActivityBold: return "\u{f773}"
        case .pinListActivityColoredBold: return "\u{f774}"
        case .pinListActivityColoredLight: return "\u{f775}"
        case .pinListActivityColoredRegular: return "\u{f776}"
        case .pinListActivityLight: return "\u{f777}"
        case .pinListActivityRegular: return "\u{f778}"
        case .pinListBold: return "\u{f779}"
        case .pinListLight: return "\u{f77a}"
        case .pinListRegular: return "\u{f77b}"
        case .pinMutedBold: return "\u{f77c}"
        case .pinMutedFilled: return "\u{f77d}"
        case .pinMutedLight: return "\u{f77e}"
        case .pinMutedRegular: return "\u{f77f}"
        case .pinRegular: return "\u{f780}"
        case .placeholderBold: return "\u{f781}"
        case .placeholderLight: return "\u{f782}"
        case .placeholderRegular: return "\u{f783}"
        case .playBold: return "\u{f784}"
        case .playFilled: return "\u{f785}"
        case .playLight: return "\u{f786}"
        case .playRegular: return "\u{f787}"
        case .plugAcBold: return "\u{f788}"
        case .plugAcLight: return "\u{f789}"
        case .plugAcRegular: return "\u{f78a}"
        case .plusBold: return "\u{f78b}"
        case .plusCircleBold: return "\u{f78c}"
        case .plusCircleFilled: return "\u{f78d}"
        case .plusCircleLight: return "\u{f78e}"
        case .plusCircleRegular: return "\u{f78f}"
        case .plusLight: return "\u{f790}"
        case .plusRegular: return "\u{f791}"
        case .pmrBold: return "\u{f792}"
        case .pmrFilled: return "\u{f793}"
        case .pmrLight: return "\u{f794}"
        case .pmrRegular: return "\u{f795}"
        case .pollBold: return "\u{f796}"
        case .pollLight: return "\u{f797}"
        case .pollRegular: return "\u{f798}"
        case .popInBold: return "\u{f799}"
        case .popInLight: return "\u{f79a}"
        case .popInRegular: return "\u{f79b}"
        case .popOutBold: return "\u{f79c}"
        case .popOutLight: return "\u{f79d}"
        case .popOutRegular: return "\u{f79e}"
        case .popUpBold: return "\u{f79f}"
        case .popUpLight: return "\u{f7a0}"
        case .popUpRegular: return "\u{f7a1}"
        case .portraitLandscapeBold: return "\u{f7a2}"
        case .portraitLandscapeLight: return "\u{f7a3}"
        case .portraitLandscapeRegular: return "\u{f7a4}"
        case .powerAcBold: return "\u{f7a5}"
        case .powerAcLight: return "\u{f7a6}"
        case .powerAcRegular: return "\u{f7a7}"
        case .powerBold: return "\u{f7a8}"
        case .powerLight: return "\u{f7a9}"
        case .powerRegular: return "\u{f7aa}"
        case .preHeaderBold: return "\u{f7ab}"
        case .preHeaderLight: return "\u{f7ac}"
        case .preHeaderRegular: return "\u{f7ad}"
        case .presentationBold: return "\u{f7ae}"
        case .presentationLight: return "\u{f7af}"
        case .presentationRegular: return "\u{f7b0}"
        case .primaryParticipantBold: return "\u{f7b1}"
        case .primaryParticipantLight: return "\u{f7b2}"
        case .primaryParticipantRegular: return "\u{f7b3}"
        case .printBold: return "\u{f7b4}"
        case .printLight: return "\u{f7b5}"
        case .printRegular: return "\u{f7b6}"
        case .priorityBadgeFilled: return "\u{f7b7}"
        case .priorityCircleBold: return "\u{f7b8}"
        case .priorityCircleFilled: return "\u{f7b9}"
        case .priorityCircleLight: return "\u{f7ba}"
        case .priorityCircleRegular: return "\u{f7bb}"
        case .priorityCircleTwoBold: return "\u{f7bc}"
        case .priorityCircleTwoFilled: return "\u{f7bd}"
        case .priorityCircleTwoLight: return "\u{f7be}"
        case .priorityCircleTwoRegular: return "\u{f7bf}"
        case .privacyCircleBold: return "\u{f7c0}"
        case .privacyCircleFilled: return "\u{f7c1}"
        case .privacyCircleLight: return "\u{f7c2}"
        case .privacyCircleRegular: return "\u{f7c3}"
        case .privateBold: return "\u{f7c4}"
        case .privateCircleBold: return "\u{f7c5}"
        case .privateCircleFilled: return "\u{f7c6}"
        case .privateCircleLight: return "\u{f7c7}"
        case .privateCircleRegular: return "\u{f7c8}"
        case .privateLight: return "\u{f7c9}"
        case .privateMeetingBold: return "\u{f7ca}"
        case .privateMeetingLight: return "\u{f7cb}"
        case .privateMeetingRegular: return "\u{f7cc}"
        case .privateRegular: return "\u{f7cd}"
        case .productDemoBold: return "\u{f7ce}"
        case .productDemoLight: return "\u{f7cf}"
        case .productDemoRegular: return "\u{f7d0}"
        case .proximityBold: return "\u{f7d1}"
        case .proximityLight: return "\u{f7d2}"
        case .proximityMutedBold: return "\u{f7d3}"
        case .proximityMutedLight: return "\u{f7d4}"
        case .proximityMutedRegular: return "\u{f7d5}"
        case .proximityRegular: return "\u{f7d6}"
        case .proximityVideoBold: return "\u{f7d7}"
        case .proximityVideoLight: return "\u{f7d8}"
        case .proximityVideoRegular: return "\u{f7d9}"
        case .ptoPresenceBold: return "\u{f7da}"
        case .ptoPresenceFilled: return "\u{f7db}"
        case .ptoPresenceLight: return "\u{f7dc}"
        case .ptoPresenceRegular: return "\u{f7dd}"
        case .pullCallBold: return "\u{f7de}"
        case .pullCallLight: return "\u{f7df}"
        case .pullCallRegular: return "\u{f7e0}"
        case .qABold: return "\u{f7e1}"
        case .qALight: return "\u{f7e2}"
        case .qARegular: return "\u{f7e3}"
        case .qualityBold: return "\u{f7e4}"
        case .qualityLight: return "\u{f7e5}"
        case .qualityRegular: return "\u{f7e6}"
        case .queueContactBold: return "\u{f7e7}"
        case .queueContactLight: return "\u{f7e8}"
        case .queueContactRegular: return "\u{f7e9}"
        case .quietBold: return "\u{f7ea}"
        case .quietHoursPresenceBold: return "\u{f7eb}"
        case .quietHoursPresenceFilled: return "\u{f7ec}"
        case .quietHoursPresenceLight: return "\u{f7ed}"
        case .quietHoursPresenceRegular: return "\u{f7ee}"
        case .quietLight: return "\u{f7ef}"
        case .quietRegular: return "\u{f7f0}"
        case .radioButtonGroupBold: return "\u{f7f1}"
        case .radioButtonGroupLight: return "\u{f7f2}"
        case .radioButtonGroupRegular: return "\u{f7f3}"
        case .raiseHandBold: return "\u{f7f4}"
        case .raiseHandFilled: return "\u{f7f5}"
        case .raiseHandLight: return "\u{f7f6}"
        case .raiseHandRegular: return "\u{f7f7}"
        case .ramBold: return "\u{f7f8}"
        case .ramLight: return "\u{f7f9}"
        case .ramRegular: return "\u{f7fa}"
        case .reactionsBold: return "\u{f7fb}"
        case .reactionsFilled: return "\u{f7fc}"
        case .reactionsLight: return "\u{f7fd}"
        case .reactionsRegular: return "\u{f7fe}"
        case .reactivateBold: return "\u{f7ff}"
        case .reactivateLight: return "\u{f800}"
        case .reactivateRegular: return "\u{f801}"
        case .recentsBold: return "\u{f802}"
        case .recentsFilled: return "\u{f803}"
        case .recentsLight: return "\u{f804}"
        case .recentsPresenceBold: return "\u{f805}"
        case .recentsPresenceFilled: return "\u{f806}"
        case .recentsPresenceLight: return "\u{f807}"
        case .recentsPresenceRegular: return "\u{f808}"
        case .recentsPresenceSmallFilled: return "\u{f809}"
        case .recentsRegular: return "\u{f80a}"
        case .recordActiveBold: return "\u{f80b}"
        case .recordActiveFilled: return "\u{f80c}"
        case .recordActiveLight: return "\u{f80d}"
        case .recordActiveRegular: return "\u{f80e}"
        case .recordBold: return "\u{f80f}"
        case .recordFilled: return "\u{f810}"
        case .recordLight: return "\u{f811}"
        case .recordPausedBold: return "\u{f812}"
        case .recordPausedFilled: return "\u{f813}"
        case .recordPausedLight: return "\u{f814}"
        case .recordPausedRegular: return "\u{f815}"
        case .recordRegular: return "\u{f816}"
        case .recurringBold: return "\u{f817}"
        case .recurringLight: return "\u{f818}"
        case .recurringOffBold: return "\u{f819}"
        case .recurringOffLight: return "\u{f81a}"
        case .recurringOffRegular: return "\u{f81b}"
        case .recurringRegular: return "\u{f81c}"
        case .redialBold: return "\u{f81d}"
        case .redialLight: return "\u{f81e}"
        case .redialRegular: return "\u{f81f}"
        case .redoBold: return "\u{f820}"
        case .redoLight: return "\u{f821}"
        case .redoRegular: return "\u{f822}"
        case .refreshBold: return "\u{f823}"
        case .refreshLight: return "\u{f824}"
        case .refreshRegular: return "\u{f825}"
        case .remoteCallBold: return "\u{f826}"
        case .remoteCallFilled: return "\u{f827}"
        case .remoteCallLight: return "\u{f828}"
        case .remoteCallRegular: return "\u{f829}"
        case .remoteDesktopControlBold: return "\u{f82a}"
        case .remoteDesktopControlFilled: return "\u{f82b}"
        case .remoteDesktopControlLight: return "\u{f82c}"
        case .remoteDesktopControlRegular: return "\u{f82d}"
        case .removeBold: return "\u{f82e}"
        case .removeFilled: return "\u{f82f}"
        case .removeLight: return "\u{f830}"
        case .removeRegular: return "\u{f831}"
        case .replyBold: return "\u{f832}"
        case .replyFilled: return "\u{f833}"
        case .replyLight: return "\u{f834}"
        case .replyListBold: return "\u{f835}"
        case .replyListLight: return "\u{f836}"
        case .replyListRegular: return "\u{f837}"
        case .replyPrivatelyBold: return "\u{f838}"
        case .replyPrivatelyLight: return "\u{f839}"
        case .replyPrivatelyRegular: return "\u{f83a}"
        case .replyRegular: return "\u{f83b}"
        case .resetBold: return "\u{f83c}"
        case .resetLight: return "\u{f83d}"
        case .resetRegular: return "\u{f83e}"
        case .responsiveMobileBold: return "\u{f83f}"
        case .responsiveMobileLight: return "\u{f840}"
        case .responsiveMobileRegular: return "\u{f841}"
        case .restartBold: return "\u{f842}"
        case .restartLight: return "\u{f843}"
        case .restartRegular: return "\u{f844}"
        case .retrieveCallBold: return "\u{f845}"
        case .retrieveCallLight: return "\u{f846}"
        case .retrieveCallRegular: return "\u{f847}"
        case .returnBold: return "\u{f848}"
        case .returnLight: return "\u{f849}"
        case .returnRegular: return "\u{f84a}"
        case .ringtoneBold: return "\u{f84b}"
        case .ringtoneLight: return "\u{f84c}"
        case .ringtoneRegular: return "\u{f84d}"
        case .roomCalendarBold: return "\u{f84e}"
        case .roomCalendarLight: return "\u{f84f}"
        case .roomCalendarRegular: return "\u{f850}"
        case .roomLightsBold: return "\u{f851}"
        case .roomLightsFilled: return "\u{f852}"
        case .roomLightsLight: return "\u{f853}"
        case .roomLightsRegular: return "\u{f854}"
        case .rotateContentBold: return "\u{f855}"
        case .rotateContentFilled: return "\u{f856}"
        case .rotateContentLight: return "\u{f857}"
        case .rotateContentRegular: return "\u{f858}"
        case .ruleBasedBold: return "\u{f859}"
        case .ruleBasedLight: return "\u{f85a}"
        case .ruleBasedRegular: return "\u{f85b}"
        case .runningApplicationBold: return "\u{f85c}"
        case .runningApplicationFilled: return "\u{f85d}"
        case .runningApplicationLight: return "\u{f85e}"
        case .runningApplicationRegular: return "\u{f85f}"
        case .saveBold: return "\u{f860}"
        case .saveLight: return "\u{f861}"
        case .saveRegular: return "\u{f862}"
        case .scanBold: return "\u{f863}"
        case .scanLight: return "\u{f864}"
        case .scanRegular: return "\u{f865}"
        case .schedulerAvailableBold: return "\u{f866}"
        case .schedulerAvailableLight: return "\u{f867}"
        case .schedulerAvailableRegular: return "\u{f868}"
        case .schedulerNotWorkingHoursBold: return "\u{f869}"
        case .schedulerNotWorkingHoursLight: return "\u{f86a}"
        case .schedulerNotWorkingHoursRegular: return "\u{f86b}"
        case .schedulerUnavailableBold: return "\u{f86c}"
        case .schedulerUnavailableLight: return "\u{f86d}"
        case .schedulerUnavailableRegular: return "\u{f86e}"
        case .schedulerUnknownBold: return "\u{f86f}"
        case .schedulerUnknownLight: return "\u{f870}"
        case .schedulerUnknownRegular: return "\u{f871}"
        case .screenshotBold: return "\u{f872}"
        case .screenshotDocBold: return "\u{f873}"
        case .screenshotDocFilled: return "\u{f874}"
        case .screenshotDocLight: return "\u{f875}"
        case .screenshotDocRegular: return "\u{f876}"
        case .screenshotLight: return "\u{f877}"
        case .screenshotRegular: return "\u{f878}"
        case .searchBold: return "\u{f879}"
        case .searchFilled: return "\u{f87a}"
        case .searchLight: return "\u{f87b}"
        case .searchRegular: return "\u{f87c}"
        case .secondaryArrowBold: return "\u{f87d}"
        case .secondaryArrowLight: return "\u{f87e}"
        case .secondaryArrowRegular: return "\u{f87f}"
        case .secureCallLockBold: return "\u{f880}"
        case .secureCallLockFilled: return "\u{f881}"
        case .secureCallLockLight: return "\u{f882}"
        case .secureCallLockRegular: return "\u{f883}"
        case .secureCallShieldBold: return "\u{f884}"
        case .secureCallShieldFilled: return "\u{f885}"
        case .secureCallShieldLight: return "\u{f886}"
        case .secureCallShieldRegular: return "\u{f887}"
        case .secureCircleBold: return "\u{f888}"
        case .secureCircleFilled: return "\u{f889}"
        case .secureCircleLight: return "\u{f88a}"
        case .secureCircleRegular: return "\u{f88b}"
        case .secureLockBold: return "\u{f88c}"
        case .secureLockFilled: return "\u{f88d}"
        case .secureLockLight: return "\u{f88e}"
        case .secureLockRegular: return "\u{f88f}"
        case .selectAllBold: return "\u{f890}"
        case .selectAllFilled: return "\u{f891}"
        case .selectAllLight: return "\u{f892}"
        case .selectAllRegular: return "\u{f893}"
        case .selectionBold: return "\u{f894}"
        case .selectionLight: return "\u{f895}"
        case .selectionRegular: return "\u{f896}"
        case .sendBold: return "\u{f897}"
        case .sendFilled: return "\u{f898}"
        case .sendLight: return "\u{f899}"
        case .sendRegular: return "\u{f89a}"
        case .serverBold: return "\u{f89b}"
        case .serverErrorBold: return "\u{f89c}"
        case .serverErrorLight: return "\u{f89d}"
        case .serverErrorRegular: return "\u{f89e}"
        case .serverLight: return "\u{f89f}"
        case .serverRegular: return "\u{f8a0}"
        case .servicesBold: return "\u{f8a1}"
        case .servicesLight: return "\u{f8a2}"
        case .servicesRegular: return "\u{f8a3}"
        case .setVariableBold: return "\u{f8a4}"
        case .setVariableLight: return "\u{f8a5}"
        case .setVariableRegular: return "\u{f8a6}"
        case .settingsBold: return "\u{f8a7}"
        case .settingsFilled: return "\u{f8a8}"
        case .settingsLight: return "\u{f8a9}"
        case .settingsRegular: return "\u{f8aa}"
        case .setupAssistantBold: return "\u{f8ab}"
        case .setupAssistantLight: return "\u{f8ac}"
        case .setupAssistantRegular: return "\u{f8ad}"
        case .sftpBold: return "\u{f8ae}"
        case .sftpLight: return "\u{f8af}"
        case .sftpRegular: return "\u{f8b0}"
        case .shapeCircleBold: return "\u{f8b1}"
        case .shapeCircleFilled: return "\u{f8b2}"
        case .shapeCircleLight: return "\u{f8b3}"
        case .shapeCircleRegular: return "\u{f8b4}"
        case .shapeDiagonalLineBold: return "\u{f8b5}"
        case .shapeDiagonalLineLight: return "\u{f8b6}"
        case .shapeDiagonalLineRegular: return "\u{f8b7}"
        case .shapeDiamondBold: return "\u{f8b8}"
        case .shapeDiamondFilled: return "\u{f8b9}"
        case .shapeDiamondLight: return "\u{f8ba}"
        case .shapeDiamondRegular: return "\u{f8bb}"
        case .shapeOvalBold: return "\u{f8bc}"
        case .shapeOvalLight: return "\u{f8bd}"
        case .shapeOvalRegular: return "\u{f8be}"
        case .shapeSquareBold: return "\u{f8bf}"
        case .shapeSquareFilled: return "\u{f8c0}"
        case .shapeSquareLight: return "\u{f8c1}"
        case .shapeSquareRegular: return "\u{f8c2}"
        case .shapeTriangleBold: return "\u{f8c3}"
        case .shapeTriangleFilled: return "\u{f8c4}"
        case .shapeTriangleLight: return "\u{f8c5}"
        case .shapeTriangleRegular: return "\u{f8c6}"
        case .shapesBold: return "\u{f8c7}"
        case .shapesLight: return "\u{f8c8}"
        case .shapesRegular: return "\u{f8c9}"
        case .shareCNativeAdrBold: return "\u{f8ca}"
        case .shareCNativeAdrLight: return "\u{f8cb}"
        case .shareCNativeAdrRegular: return "\u{f8cc}"
        case .shareCNativeIphBold: return "\u{f8cd}"
        case .shareCNativeIphLight: return "\u{f8ce}"
        case .shareCNativeIphRegular: return "\u{f8cf}"
        case .shareScreenBold: return "\u{f8d0}"
        case .shareScreenFilled: return "\u{f8d1}"
        case .shareScreenLight: return "\u{f8d2}"
        case .shareScreenRegular: return "\u{f8d3}"
        case .shareScreenSmallFilled: return "\u{f8d4}"
        case .shareSpaceBold: return "\u{f8d5}"
        case .shareSpaceLight: return "\u{f8d6}"
        case .shareSpaceRegular: return "\u{f8d7}"
        case .shieldBold: return "\u{f8d8}"
        case .shieldLight: return "\u{f8d9}"
        case .shieldRegular: return "\u{f8da}"
        case .shoppingCartBold: return "\u{f8db}"
        case .shoppingCartFilled: return "\u{f8dc}"
        case .shoppingCartLight: return "\u{f8dd}"
        case .shoppingCartRegular: return "\u{f8de}"
        case .shortTextBoxBold: return "\u{f8df}"
        case .shortTextBoxLight: return "\u{f8e0}"
        case .shortTextBoxRegular: return "\u{f8e1}"
        case .showBold: return "\u{f8e2}"
        case .showFilled: return "\u{f8e3}"
        case .showLight: return "\u{f8e4}"
        case .showRegular: return "\u{f8e5}"
        case .signInBold: return "\u{f8e6}"
        case .signInFilled: return "\u{f8e7}"
        case .signInForcedBold: return "\u{f8e8}"
        case .signInForcedLight: return "\u{f8e9}"
        case .signInForcedRegular: return "\u{f8ea}"
        case .signInLight: return "\u{f8eb}"
        case .signInRegular: return "\u{f8ec}"
        case .signOutBold: return "\u{f8ed}"
        case .signOutLight: return "\u{f8ee}"
        case .signOutRegular: return "\u{f8ef}"
        case .signal0Bold: return "\u{f8f0}"
        case .signal0Light: return "\u{f8f1}"
        case .signal0Regular: return "\u{f8f2}"
        case .signal100Bold: return "\u{f8f3}"
        case .signal100Light: return "\u{f8f4}"
        case .signal100Regular: return "\u{f8f5}"
        case .signal25Bold: return "\u{f8f6}"
        case .signal25Light: return "\u{f8f7}"
        case .signal25Regular: return "\u{f8f8}"
        case .signal50Bold: return "\u{f8f9}"
        case .signal50Light: return "\u{f8fa}"
        case .signal50Regular: return "\u{f8fb}"
        case .signal75Bold: return "\u{f8fc}"
        case .signal75Light: return "\u{f8fd}"
        case .signal75Regular: return "\u{f8fe}"
        case .simplePromotionBold: return "\u{f8ff}"
        case .simplePromotionLight: return "\u{f900}"
        case .simplePromotionRegular: return "\u{f901}"
        case .singleNumberReachBold: return "\u{f902}"
        case .singleNumberReachLight: return "\u{f903}"
        case .singleNumberReachRegular: return "\u{f904}"
        case .sipRegistrationInProgressBold: return "\u{f905}"
        case .sipRegistrationInProgressFilled: return "\u{f906}"
        case .sipRegistrationInProgressLight: return "\u{f907}"
        case .sipRegistrationInProgressRegular: return "\u{f908}"
        case .skipBold: return "\u{f909}"
        case .skipBwBold: return "\u{f90a}"
        case .skipBwFilled: return "\u{f90b}"
        case .skipBwLight: return "\u{f90c}"
        case .skipBwRegular: return "\u{f90d}"
        case .skipFwBold: return "\u{f90e}"
        case .skipFwFilled: return "\u{f90f}"
        case .skipFwLight: return "\u{f910}"
        case .skipFwRegular: return "\u{f911}"
        case .skipLight: return "\u{f912}"
        case .skipRegular: return "\u{f913}"
        case .smsInboundBold: return "\u{f914}"
        case .smsInboundLight: return "\u{f915}"
        case .smsInboundRegular: return "\u{f916}"
        case .smsMessageBold: return "\u{f917}"
        case .smsMessageFilled: return "\u{f918}"
        case .smsMessageLight: return "\u{f919}"
        case .smsMessageRegular: return "\u{f91a}"
        case .socialAlexaFilled: return "\u{f91b}"
        case .socialFacebookColoredFilled: return "\u{f91c}"
        case .socialFacebookFilled: return "\u{f91d}"
        case .socialFbmessengerColoredFilled: return "\u{f91e}"
        case .socialFbmessengerFilled: return "\u{f91f}"
        case .socialInstagramBold: return "\u{f920}"
        case .socialMicrosoftColoredFilled: return "\u{f921}"
        case .socialMicrosoftFilled: return "\u{f922}"
        case .socialMmsFilled: return "\u{f923}"
        case .socialMmsGoldFilled: return "\u{f924}"
        case .socialSmsFilled: return "\u{f925}"
        case .socialSmsMintFilled: return "\u{f926}"
        case .socialTwitterColoredFilled: return "\u{f927}"
        case .socialTwitterFilled: return "\u{f928}"
        case .socialViberBold: return "\u{f929}"
        case .socialViberColoredBold: return "\u{f92a}"
        case .socialWhatsappBold: return "\u{f92b}"
        case .socialWhatsappColoredFilled: return "\u{f92c}"
        case .sortAscendingBold: return "\u{f92d}"
        case .sortAscendingLight: return "\u{f92e}"
        case .sortAscendingRegular: return "\u{f92f}"
        case .sortDescendingBold: return "\u{f930}"
        case .sortDescendingLight: return "\u{f931}"
        case .sortDescendingRegular: return "\u{f932}"
        case .soundDefaultBold: return "\u{f933}"
        case .soundDefaultLight: return "\u{f934}"
        case .soundDefaultRegular: return "\u{f935}"
        case .speakerBold: return "\u{f936}"
        case .speakerDisconnectedBold: return "\u{f937}"
        case .speakerDisconnectedFilled: return "\u{f938}"
        case .speakerDisconnectedLight: return "\u{f939}"
        case .speakerDisconnectedRegular: return "\u{f93a}"
        case .speakerFilled: return "\u{f93b}"
        case .speakerLight: return "\u{f93c}"
        case .speakerMutedBold: return "\u{f93d}"
        case .speakerMutedFilled: return "\u{f93e}"
        case .speakerMutedLight: return "\u{f93f}"
        case .speakerMutedRegular: return "\u{f940}"
        case .speakerOffBold: return "\u{f941}"
        case .speakerOffFilled: return "\u{f942}"
        case .speakerOffLight: return "\u{f943}"
        case .speakerOffRegular: return "\u{f944}"
        case .speakerOnColoredBold: return "\u{f945}"
        case .speakerOnColoredLight: return "\u{f946}"
        case .speakerOnColoredRegular: return "\u{f947}"
        case .speakerRegular: return "\u{f948}"
        case .speakerTurnDownBold: return "\u{f949}"
        case .speakerTurnDownFilled: return "\u{f94a}"
        case .speakerTurnDownLight: return "\u{f94b}"
        case .speakerTurnDownRegular: return "\u{f94c}"
        case .speakerTurnUpBold: return "\u{f94d}"
        case .speakerTurnUpFilled: return "\u{f94e}"
        case .speakerTurnUpLight: return "\u{f94f}"
        case .speakerTurnUpRegular: return "\u{f950}"
        case .spinnerBold: return "\u{f951}"
        case .spinnerFilledBold: return "\u{f952}"
        case .spinnerFilledLight: return "\u{f953}"
        case .spinnerFilledRegular: return "\u{f954}"
        case .spinnerLight: return "\u{f955}"
        case .spinnerPartialBold: return "\u{f956}"
        case .spinnerPartialLight: return "\u{f957}"
        case .spinnerPartialRegular: return "\u{f958}"
        case .spinnerRegular: return "\u{f959}"
        case .stackedArea100ChartBold: return "\u{f95a}"
        case .stackedArea100ChartFilled: return "\u{f95b}"
        case .stackedArea100ChartLight: return "\u{f95c}"
        case .stackedArea100ChartRegular: return "\u{f95d}"
        case .stackedAreaChartBold: return "\u{f95e}"
        case .stackedAreaChartFilled: return "\u{f95f}"
        case .stackedAreaChartLight: return "\u{f960}"
        case .stackedAreaChartRegular: return "\u{f961}"
        case .stackedBar100ChartBold: return "\u{f962}"
        case .stackedBar100ChartFilled: return "\u{f963}"
        case .stackedBar100ChartLight: return "\u{f964}"
        case .stackedBar100ChartRegular: return "\u{f965}"
        case .stackedBarChartBold: return "\u{f966}"
        case .stackedBarChartFilled: return "\u{f967}"
        case .stackedBarChartLight: return "\u{f968}"
        case .stackedBarChartRegular: return "\u{f969}"
        case .startChatBold: return "\u{f96a}"
        case .startChatLight: return "\u{f96b}"
        case .startChatRegular: return "\u{f96c}"
        case .stethoscopeBold: return "\u{f96d}"
        case .stethoscopeLight: return "\u{f96e}"
        case .stethoscopeRegular: return "\u{f96f}"
        case .stickersBold: return "\u{f970}"
        case .stickersLight: return "\u{f971}"
        case .stickersRegular: return "\u{f972}"
        case .stickiesBold: return "\u{f973}"
        case .stickiesLight: return "\u{f974}"
        case .stickiesRegular: return "\u{f975}"
        case .stopBold: return "\u{f976}"
        case .stopCircleBold: return "\u{f977}"
        case .stopCircleFilled: return "\u{f978}"
        case .stopCircleLight: return "\u{f979}"
        case .stopCircleRegular: return "\u{f97a}"
        case .stopContentShareBold: return "\u{f97b}"
        case .stopContentShareLight: return "\u{f97c}"
        case .stopContentShareRegular: return "\u{f97d}"
        case .stopFilled: return "\u{f97e}"
        case .stopLight: return "\u{f97f}"
        case .stopRegular: return "\u{f980}"
        case .storedInfoBold: return "\u{f981}"
        case .storedInfoFilled: return "\u{f982}"
        case .storedInfoLight: return "\u{f983}"
        case .storedInfoRegular: return "\u{f984}"
        case .streamingBold: return "\u{f985}"
        case .streamingLight: return "\u{f986}"
        case .streamingRegular: return "\u{f987}"
        case .strikethroughBold: return "\u{f988}"
        case .strikethroughLight: return "\u{f989}"
        case .strikethroughRegular: return "\u{f98a}"
        case .subscriptBold: return "\u{f98b}"
        case .subscriptLight: return "\u{f98c}"
        case .subscriptRegular: return "\u{f98d}"
        case .superscriptBold: return "\u{f98e}"
        case .superscriptLight: return "\u{f98f}"
        case .superscriptRegular: return "\u{f990}"
        case .surveyBold: return "\u{f991}"
        case .surveyFilled: return "\u{f992}"
        case .surveyLight: return "\u{f993}"
        case .surveyRegular: return "\u{f994}"
        case .sx10Bold: return "\u{f995}"
        case .sx10Light: return "\u{f996}"
        case .sx10Regular: return "\u{f997}"
        case .sx20Bold: return "\u{f998}"
        case .sx20Light: return "\u{f999}"
        case .sx20Regular: return "\u{f99a}"
        case .sx80CodecBold: return "\u{f99b}"
        case .sx80CodecLight: return "\u{f99c}"
        case .sx80CodecRegular: return "\u{f99d}"
        case .tableBold: return "\u{f99e}"
        case .tableLight: return "\u{f99f}"
        case .tableRegular: return "\u{f9a0}"
        case .tabletBold: return "\u{f9a1}"
        case .tabletLight: return "\u{f9a2}"
        case .tabletRegular: return "\u{f9a3}"
        case .tabsBold: return "\u{f9a4}"
        case .tabsLight: return "\u{f9a5}"
        case .tabsRegular: return "\u{f9a6}"
        case .tagBold: return "\u{f9a7}"
        case .tagLight: return "\u{f9a8}"
        case .tagRegular: return "\u{f9a9}"
        case .tapBold: return "\u{f9aa}"
        case .tapFilled: return "\u{f9ab}"
        case .tapLight: return "\u{f9ac}"
        case .tapRegular: return "\u{f9ad}"
        case .telepresenceAlertBold: return "\u{f9ae}"
        case .telepresenceAlertLight: return "\u{f9af}"
        case .telepresenceAlertMutedBold: return "\u{f9b0}"
        case .telepresenceAlertMutedLight: return "\u{f9b1}"
        case .telepresenceAlertMutedRegular: return "\u{f9b2}"
        case .telepresenceAlertRegular: return "\u{f9b3}"
        case .telepresenceBold: return "\u{f9b4}"
        case .telepresenceIx5000Bold: return "\u{f9b5}"
        case .telepresenceIx5000Light: return "\u{f9b6}"
        case .telepresenceIx5000Regular: return "\u{f9b7}"
        case .telepresenceLight: return "\u{f9b8}"
        case .telepresencePrivateBold: return "\u{f9b9}"
        case .telepresencePrivateLight: return "\u{f9ba}"
        case .telepresencePrivateRegular: return "\u{f9bb}"
        case .telepresenceRegular: return "\u{f9bc}"
        case .temperatureBold: return "\u{f9bd}"
        case .temperatureLight: return "\u{f9be}"
        case .temperatureRegular: return "\u{f9bf}"
        case .textAlignCenterBold: return "\u{f9c0}"
        case .textAlignCenterFilled: return "\u{f9c1}"
        case .textAlignCenterLight: return "\u{f9c2}"
        case .textAlignCenterRegular: return "\u{f9c3}"
        case .textAlignLeftBold: return "\u{f9c4}"
        case .textAlignLeftFilled: return "\u{f9c5}"
        case .textAlignLeftLight: return "\u{f9c6}"
        case .textAlignLeftRegular: return "\u{f9c7}"
        case .textAlignRightBold: return "\u{f9c8}"
        case .textAlignRightFilled: return "\u{f9c9}"
        case .textAlignRightLight: return "\u{f9ca}"
        case .textAlignRightRegular: return "\u{f9cb}"
        case .textBold: return "\u{f9cc}"
        case .textCodeBlockBold: return "\u{f9cd}"
        case .textCodeBlockLight: return "\u{f9ce}"
        case .textCodeBlockRegular: return "\u{f9cf}"
        case .textHighlightBold: return "\u{f9d0}"
        case .textHighlightLight: return "\u{f9d1}"
        case .textHighlightRegular: return "\u{f9d2}"
        case .textLight: return "\u{f9d3}"
        case .textRegular: return "\u{f9d4}"
        case .threeColumnBold: return "\u{f9d5}"
        case .threeColumnLight: return "\u{f9d6}"
        case .threeColumnRegular: return "\u{f9d7}"
        case .threeDObjectBold: return "\u{f9d8}"
        case .threeDObjectLight: return "\u{f9d9}"
        case .threeDObjectRegular: return "\u{f9da}"
        case .tooFastBold: return "\u{f9db}"
        case .tooFastLight: return "\u{f9dc}"
        case .tooFastRegular: return "\u{f9dd}"
        case .tooSlowBold: return "\u{f9de}"
        case .tooSlowLight: return "\u{f9df}"
        case .tooSlowRegular: return "\u{f9e0}"
        case .toolsBold: return "\u{f9e1}"
        case .toolsLight: return "\u{f9e2}"
        case .toolsRegular: return "\u{f9e3}"
        case .touch10Bold: return "\u{f9e4}"
        case .touch10Light: return "\u{f9e5}"
        case .touch10Regular: return "\u{f9e6}"
        case .transcriptBold: return "\u{f9e7}"
        case .transcriptFilled: return "\u{f9e8}"
        case .transcriptLight: return "\u{f9e9}"
        case .transcriptRegular: return "\u{f9ea}"
        case .translateBold: return "\u{f9eb}"
        case .translateLight: return "\u{f9ec}"
        case .translateRegular: return "\u{f9ed}"
        case .trimBold: return "\u{f9ee}"
        case .trimLight: return "\u{f9ef}"
        case .trimRegular: return "\u{f9f0}"
        case .twoColumnBold: return "\u{f9f1}"
        case .twoColumnLight: return "\u{f9f2}"
        case .twoColumnRegular: return "\u{f9f3}"
        case .ucmCloudBold: return "\u{f9f4}"
        case .ucmCloudLight: return "\u{f9f5}"
        case .ucmCloudRegular: return "\u{f9f6}"
        case .underlineBold: return "\u{f9f7}"
        case .underlineLight: return "\u{f9f8}"
        case .underlineRegular: return "\u{f9f9}"
        case .undoBold: return "\u{f9fa}"
        case .undoLight: return "\u{f9fb}"
        case .undoRegular: return "\u{f9fc}"
        case .unlinkBold: return "\u{f9fd}"
        case .unlinkLight: return "\u{f9fe}"
        case .unlinkRegular: return "\u{f9ff}"
        case .unreadBold: return "\u{fa00}"
        case .unreadFilled: return "\u{fa01}"
        case .unreadLight: return "\u{fa02}"
        case .unreadRegular: return "\u{fa03}"
        case .unsecureUnlockedBold: return "\u{fa04}"
        case .unsecureUnlockedFilled: return "\u{fa05}"
        case .unsecureUnlockedLight: return "\u{fa06}"
        case .unsecureUnlockedRegular: return "\u{fa07}"
        case .unsortedBold: return "\u{fa08}"
        case .unsortedLight: return "\u{fa09}"
        case .unsortedRegular: return "\u{fa0a}"
        case .updateFileShareBold: return "\u{fa0b}"
        case .updateFileShareLight: return "\u{fa0c}"
        case .updateFileShareRegular: return "\u{fa0d}"
        case .upgradeBold: return "\u{fa0e}"
        case .upgradeFilled: return "\u{fa0f}"
        case .upgradeLight: return "\u{fa10}"
        case .upgradeRegular: return "\u{fa11}"
        case .uploadBold: return "\u{fa12}"
        case .uploadLight: return "\u{fa13}"
        case .uploadRegular: return "\u{fa14}"
        case .urgentVoicemailBold: return "\u{fa15}"
        case .urgentVoicemailFilled: return "\u{fa16}"
        case .usbBold: return "\u{fa17}"
        case .usbHeadsetBold: return "\u{fa18}"
        case .usbHeadsetLight: return "\u{fa19}"
        case .usbHeadsetMutedBold: return "\u{fa1a}"
        case .usbHeadsetMutedLight: return "\u{fa1b}"
        case .usbHeadsetMutedRegular: return "\u{fa1c}"
        case .usbHeadsetRegular: return "\u{fa1d}"
        case .usbLight: return "\u{fa1e}"
        case .usbRegular: return "\u{fa1f}"
        case .userBold: return "\u{fa20}"
        case .userDeactivateBold: return "\u{fa21}"
        case .userDeactivateLight: return "\u{fa22}"
        case .userDeactivateRegular: return "\u{fa23}"
        case .userLight: return "\u{fa24}"
        case .userRegular: return "\u{fa25}"
        case .vcsBold: return "\u{fa26}"
        case .vcsLight: return "\u{fa27}"
        case .vcsRegular: return "\u{fa28}"
        case .videoBlurBold: return "\u{fa29}"
        case .videoBlurFilled: return "\u{fa2a}"
        case .videoBlurLight: return "\u{fa2b}"
        case .videoBlurRegular: return "\u{fa2c}"
        case .videoBold: return "\u{fa2d}"
        case .videoEffectBold: return "\u{fa2e}"
        case .videoEffectFilled: return "\u{fa2f}"
        case .videoEffectLight: return "\u{fa30}"
        case .videoEffectRegular: return "\u{fa31}"
        case .videoFilled: return "\u{fa32}"
        case .videoLayoutBold: return "\u{fa33}"
        case .videoLayoutEqualBold: return "\u{fa34}"
        case .videoLayoutEqualDualBold: return "\u{fa35}"
        case .videoLayoutEqualDualLight: return "\u{fa36}"
        case .videoLayoutEqualDualRegular: return "\u{fa37}"
        case .videoLayoutEqualFilled: return "\u{fa38}"
        case .videoLayoutEqualLight: return "\u{fa39}"
        case .videoLayoutEqualRegular: return "\u{fa3a}"
        case .videoLayoutFilled: return "\u{fa3b}"
        case .videoLayoutLight: return "\u{fa3c}"
        case .videoLayoutOverlayBold: return "\u{fa3d}"
        case .videoLayoutOverlayLight: return "\u{fa3e}"
        case .videoLayoutOverlayRegular: return "\u{fa3f}"
        case .videoLayoutPresenterDominantBold: return "\u{fa40}"
        case .videoLayoutPresenterDominantLight: return "\u{fa41}"
        case .videoLayoutPresenterDominantRegular: return "\u{fa42}"
        case .videoLayoutProminentBold: return "\u{fa43}"
        case .videoLayoutProminentFilled: return "\u{fa44}"
        case .videoLayoutProminentLight: return "\u{fa45}"
        case .videoLayoutProminentRegular: return "\u{fa46}"
        case .videoLayoutRegular: return "\u{fa47}"
        case .videoLayoutShareDominantBold: return "\u{fa48}"
        case .videoLayoutShareDominantLight: return "\u{fa49}"
        case .videoLayoutShareDominantRegular: return "\u{fa4a}"
        case .videoLayoutSingleBold: return "\u{fa4b}"
        case .videoLayoutSingleFilled: return "\u{fa4c}"
        case .videoLayoutSingleLight: return "\u{fa4d}"
        case .videoLayoutSingleRegular: return "\u{fa4e}"
        case .videoLayoutStackBold: return "\u{fa4f}"
        case .videoLayoutStackFilled: return "\u{fa50}"
        case .videoLayoutStackLight: return "\u{fa51}"
        case .videoLayoutStackRegular: return "\u{fa52}"
        case .videoLayoutVideoDominantBold: return "\u{fa53}"
        case .videoLayoutVideoDominantLight: return "\u{fa54}"
        case .videoLayoutVideoDominantRegular: return "\u{fa55}"
        case .videoLight: return "\u{fa56}"
        case .videoPlusBold: return "\u{fa57}"
        case .videoPlusFilled: return "\u{fa58}"
        case .videoPlusLight: return "\u{fa59}"
        case .videoPlusRegular: return "\u{fa5a}"
        case .videoRegular: return "\u{fa5b}"
        case .videoSpeakerTrackBold: return "\u{fa5c}"
        case .videoSpeakerTrackFilled: return "\u{fa5d}"
        case .videoSpeakerTrackLight: return "\u{fa5e}"
        case .videoSpeakerTrackRegular: return "\u{fa5f}"
        case .viewAllBold: return "\u{fa60}"
        case .viewAllLight: return "\u{fa61}"
        case .viewAllRegular: return "\u{fa62}"
        case .viewListBold: return "\u{fa63}"
        case .viewListLight: return "\u{fa64}"
        case .viewListRegular: return "\u{fa65}"
        case .viewStackedBold: return "\u{fa66}"
        case .viewStackedFilled: return "\u{fa67}"
        case .viewStackedLight: return "\u{fa68}"
        case .viewStackedRegular: return "\u{fa69}"
        case .viewThumbnailBold: return "\u{fa6a}"
        case .viewThumbnailFilled: return "\u{fa6b}"
        case .viewThumbnailLight: return "\u{fa6c}"
        case .viewThumbnailRegular: return "\u{fa6d}"
        case .voicemailBold: return "\u{fa6e}"
        case .voicemailFilled: return "\u{fa6f}"
        case .voicemailLight: return "\u{fa70}"
        case .voicemailRegular: return "\u{fa71}"
        case .waffleMenuBold: return "\u{fa72}"
        case .waffleMenuLight: return "\u{fa73}"
        case .waffleMenuRegular: return "\u{fa74}"
        case .waitingroomActiveBold: return "\u{fa75}"
        case .waitingroomActiveLight: return "\u{fa76}"
        case .waitingroomActiveRegular: return "\u{fa77}"
        case .wallpaperBold: return "\u{fa78}"
        case .wallpaperLight: return "\u{fa79}"
        case .wallpaperRegular: return "\u{fa7a}"
        case .warningBadgeFilled: return "\u{fa7b}"
        case .warningBold: return "\u{fa7c}"
        case .warningFilled: return "\u{fa7d}"
        case .warningLight: return "\u{fa7e}"
        case .warningRegular: return "\u{fa7f}"
        case .webexAssistantActiveColored: return "\u{fa80}"
        case .webexAssistantInactiveColored: return "\u{fa81}"
        case .webexBoardBold: return "\u{fa82}"
        case .webexBoardLight: return "\u{fa83}"
        case .webexBoardRegular: return "\u{fa84}"
        case .webexCodecPlusBold: return "\u{fa85}"
        case .webexCodecPlusLight: return "\u{fa86}"
        case .webexCodecPlusRegular: return "\u{fa87}"
        case .webexDeskCameraBold: return "\u{fa88}"
        case .webexDeskCameraLight: return "\u{fa89}"
        case .webexDeskCameraRegular: return "\u{fa8a}"
        case .webexHelixFilled: return "\u{fa8b}"
        case .webexMeetingsBold: return "\u{fa8c}"
        case .webexMeetingsFilled: return "\u{fa8d}"
        case .webexMeetingsLight: return "\u{fa8e}"
        case .webexMeetingsRegular: return "\u{fa8f}"
        case .webexQuadCameraBold: return "\u{fa90}"
        case .webexQuadCameraLight: return "\u{fa91}"
        case .webexQuadCameraRegular: return "\u{fa92}"
        case .webexRoomKitBold: return "\u{fa93}"
        case .webexRoomKitLight: return "\u{fa94}"
        case .webexRoomKitPlusBold: return "\u{fa95}"
        case .webexRoomKitPlusLight: return "\u{fa96}"
        case .webexRoomKitPlusRegular: return "\u{fa97}"
        case .webexRoomKitRegular: return "\u{fa98}"
        case .webexShareBold: return "\u{fa99}"
        case .webexShareLight: return "\u{fa9a}"
        case .webexShareRegular: return "\u{fa9b}"
        case .webexTeamsBold: return "\u{fa9c}"
        case .webexTeamsFilled: return "\u{fa9d}"
        case .webexTeamsLight: return "\u{fa9e}"
        case .webexTeamsNewBold: return "\u{fa9f}"
        case .webexTeamsNewFilled: return "\u{faa0}"
        case .webexTeamsNewLight: return "\u{faa1}"
        case .webexTeamsNewRegular: return "\u{faa2}"
        case .webexTeamsRegular: return "\u{faa3}"
        case .webinarBold: return "\u{faa4}"
        case .webinarFilled: return "\u{faa5}"
        case .webinarLight: return "\u{faa6}"
        case .webinarRegular: return "\u{faa7}"
        case .weeklyRecurringScheduleNodeBold: return "\u{faa8}"
        case .weeklyRecurringScheduleNodeLight: return "\u{faa9}"
        case .weeklyRecurringScheduleNodeRegular: return "\u{faaa}"
        case .whiteboardBold: return "\u{faab}"
        case .whiteboardContentBold: return "\u{faac}"
        case .whiteboardContentLight: return "\u{faad}"
        case .whiteboardContentRegular: return "\u{faae}"
        case .whiteboardFilled: return "\u{faaf}"
        case .whiteboardLight: return "\u{fab0}"
        case .whiteboardRegular: return "\u{fab1}"
        case .widgetBold: return "\u{fab2}"
        case .widgetFilled: return "\u{fab3}"
        case .widgetLight: return "\u{fab4}"
        case .widgetRegular: return "\u{fab5}"
        case .wifiBold: return "\u{fab6}"
        case .wifiErrorBold: return "\u{fab7}"
        case .wifiErrorLight: return "\u{fab8}"
        case .wifiErrorRegular: return "\u{fab9}"
        case .wifiLight: return "\u{faba}"
        case .wifiRegular: return "\u{fabb}"
        case .wifiSignalGoodColoredBold: return "\u{fabc}"
        case .wifiSignalGoodColoredLight: return "\u{fabd}"
        case .wifiSignalGoodColoredRegular: return "\u{fabe}"
        case .wifiSignalPoorColoredBold: return "\u{fabf}"
        case .wifiSignalPoorColoredLight: return "\u{fac0}"
        case .wifiSignalPoorColoredRegular: return "\u{fac1}"
        case .wifiSignalUnstableColoredBold: return "\u{fac2}"
        case .wifiSignalUnstableColoredLight: return "\u{fac3}"
        case .wifiSignalUnstableColoredRegular: return "\u{fac4}"
        case .windowCornerScrubBold: return "\u{fac5}"
        case .windowCornerScrubLight: return "\u{fac6}"
        case .windowCornerScrubRegular: return "\u{fac7}"
        case .windowRightCornerScrubBold: return "\u{fac8}"
        case .windowRightCornerScrubLight: return "\u{fac9}"
        case .windowRightCornerScrubRegular: return "\u{faca}"
        case .windowVerticalScrubBold: return "\u{facb}"
        case .windowVerticalScrubLight: return "\u{facc}"
        case .windowVerticalScrubRegular: return "\u{facd}"
        case .workflowDeploymentsBold: return "\u{face}"
        case .workflowDeploymentsLight: return "\u{facf}"
        case .workflowDeploymentsRegular: return "\u{fad0}"
        case .workphoneBold: return "\u{fad1}"
        case .workphoneLight: return "\u{fad2}"
        case .workphoneRegular: return "\u{fad3}"
        case .zoomInBold: return "\u{fad4}"
        case .zoomInLight: return "\u{fad5}"
        case .zoomInRegular: return "\u{fad6}"
        case .zoomOutBold: return "\u{fad7}"
        case .zoomOutLight: return "\u{fad8}"
        case .zoomOutRegular: return "\u{fad9}"
        case .zoom: return "\u{fada}"
