...
var SpaceListMeeting = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _proto.render = function render() {
    var _this$props = this.props,
        ...
        props = _objectWithoutPropertiesLoose(_this$props, ["attendees", "buttonLabel", "childrenLeft", "childrenRight", "className", "eventOverlayProps", "header", "isMessagingOnlyShare", "isBold", "meetingType", "subheader", "title"]);
    ...
    var getLeftSection = function getLeftSection() {
      switch (meetingType) {
        case 'group':
          return _react.default.createElement(_.Avatar, {
    ...
    var getPopoverContent = _react.default.createElement(_.List, null, attendees.map(function (ele, idx) {
      return _react.default.createElement(_.ListItem, {
        key: "attendee-" + idx
      }, _react.default.createElement(_.ListItemSection, {
        position: "left"
      }, ele.node ? ele.node : _react.default.createElement(_.Avatar, {
        size: "small",
        title: ele.title,
    ...
    var children = [_react.default.createElement(_.ListItemSection, {
      key: "child-0",
      position: "left"
    }, childrenLeft || getLeftSection()), _react.default.createElement(_.ListItemSection, {
      key: "child-1",
      position: "center"
    }, _react.default.createElement("div", {
      className: "md-list-item__header"
    ...
    }, subheader)), _react.default.createElement(_.ListItemSection, {
      key: "child-2",
      position: "right"
    }, childrenRight || attendees.length > 0 && _react.default.createElement(_.Popover, _extends({
      ...
      isDynamic: true
    }, eventOverlayProps), _react.default.createElement("span", {
      role: "button",
      tabIndex: 0,
      className: "md-list-item--space-meeting--attendees"
    }, isMessagingOnlyShare ? null : attendees.length, isMessagingOnlyShare ? _react.default.createElement(_.Icon, {
      name: "share-screen_12"
    }) : _react.default.createElement(_.Icon, {
      name: "people_12"
    }))), buttonLabel && _react.default.createElement(_.Button, {
    ...
    return _react.default.createElement(_.ListItem, _extends({
      className: 'md-list-item--space-meeting' + ("" + (isBold && " md-list-item--unread" || '')) + ("" + (className && " " + className || '')),
      id: id,
      title: getTitle,
      type: "space"
    }, otherProps), children);
