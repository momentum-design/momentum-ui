...
@objc public enum CollabIconType: Int {
    ...
    public var ligature: String {
        ...
        case .alert28: return "\u{f142}"
        case .alert36: return "\u{f143}"
        case .alertActive10: return "\u{f144}"
        case .alertActive12: return "\u{f145}"
        case .alertActive16: return "\u{f146}"
        case .alertActive18: return "\u{f147}"
        case .alertActive20: return "\u{f148}"
        case .alertActive24: return "\u{f149}"
        case .alertActive36: return "\u{f14a}"
        case .alertMuted10: return "\u{f14b}"
        case .alertMuted12: return "\u{f14c}"
        case .alertMuted16: return "\u{f14d}"
        case .alertMuted18: return "\u{f14e}"
        case .alertMuted20: return "\u{f14f}"
        case .alertMuted24: return "\u{f150}"
        case .alertMuted28: return "\u{f151}"
        case .alertMuted36: return "\u{f152}"
        case .alertMuted8: return "\u{f153}"
        case .alertMutedActive10: return "\u{f154}"
        case .alertMutedActive12: return "\u{f155}"
        case .alertMutedActive16: return "\u{f156}"
        case .alertMutedActive18: return "\u{f157}"
        case .alertMutedActive20: return "\u{f158}"
        case .alertMutedActive24: return "\u{f159}"
        case .alertMutedActive36: return "\u{f15a}"
        case .alertMutedActive8: return "\u{f15b}"
        case .allowToAnnotate16: return "\u{f15c}"
        case .analysis16: return "\u{f15d}"
        case .analysis20: return "\u{f15e}"
        case .analysis24: return "\u{f15f}"
        case .analysis32: return "\u{f160}"
        case .analysis36: return "\u{f161}"
        case .analysisActive16: return "\u{f162}"
        case .analysisActive20: return "\u{f163}"
        case .analysisActive24: return "\u{f164}"
        case .analysisActive32: return "\u{f165}"
        case .analysisActive36: return "\u{f166}"
        case .angellist16: return "\u{f167}"
        case .annotation10: return "\u{f168}"
        case .annotation12: return "\u{f169}"
        case .annotation14: return "\u{f16a}"
        case .annotation16: return "\u{f16b}"
        case .annotation18: return "\u{f16c}"
        case .annotation20: return "\u{f16d}"
        case .annotation24: return "\u{f16e}"
        case .annotationLegacy16: return "\u{f16f}"
        case .appearance16: return "\u{f170}"
        case .appearance20: return "\u{f171}"
        case .applause12: return "\u{f172}"
        case .applause16: return "\u{f173}"
        case .application12: return "\u{f174}"
        case .application16: return "\u{f175}"
        case .application20: return "\u{f176}"
        case .application24: return "\u{f177}"
        case .application36: return "\u{f178}"
        case .application48: return "\u{f179}"
        case .applicationPanel16: return "\u{f17a}"
        case .applicationPanel20: return "\u{f17b}"
        case .applications16: return "\u{f17c}"
        case .applications24: return "\u{f17d}"
        case .approvals16: return "\u{f17e}"
        case .approvals32: return "\u{f17f}"
        case .archive12: return "\u{f180}"
        case .archive16: return "\u{f181}"
        case .archive20: return "\u{f182}"
        case .archive8: return "\u{f183}"
        case .areaSelector16: return "\u{f184}"
        case .areaSelector20: return "\u{f185}"
        case .arrowCircleDown16: return "\u{f186}"
        case .arrowCircleDown20: return "\u{f187}"
        case .arrowCircleDown24: return "\u{f188}"
        case .arrowCircleLeft16: return "\u{f189}"
        case .arrowCircleLeft20: return "\u{f18a}"
        case .arrowCircleLeft24: return "\u{f18b}"
        case .arrowCircleRight16: return "\u{f18c}"
        case .arrowCircleRight20: return "\u{f18d}"
        case .arrowCircleRight24: return "\u{f18e}"
        case .arrowCircleUp16: return "\u{f18f}"
        case .arrowCircleUp20: return "\u{f190}"
        case .arrowCircleUp24: return "\u{f191}"
        case .arrowDown12: return "\u{f192}"
        case .arrowDown16: return "\u{f193}"
        case .arrowDown18: return "\u{f194}"
        case .arrowDown20: return "\u{f195}"
        case .arrowDown24: return "\u{f196}"
        case .arrowDown28: return "\u{f197}"
        case .arrowDown32: return "\u{f198}"
        case .arrowDown6: return "\u{f199}"
        case .arrowDown8: return "\u{f19a}"
        case .arrowDownOptical10: return "\u{f19b}"
        case .arrowDownOptical12: return "\u{f19c}"
        case .arrowDownOptical14: return "\u{f19d}"
        case .arrowDownOptical16: return "\u{f19e}"
        case .arrowDownOptical18: return "\u{f19f}"
        case .arrowDownOptical20: return "\u{f1a0}"
        case .arrowDownOptical24: return "\u{f1a1}"
        case .arrowDownOptical28: return "\u{f1a2}"
        case .arrowDownOptical32: return "\u{f1a3}"
        case .arrowDownOptical8: return "\u{f1a4}"
        case .arrowFilledDown10: return "\u{f1a5}"
        case .arrowFilledDown12: return "\u{f1a6}"
        case .arrowFilledDown8: return "\u{f1a7}"
        case .arrowFilledUp10: return "\u{f1a8}"
        case .arrowFilledUp12: return "\u{f1a9}"
        case .arrowFilledUp8: return "\u{f1aa}"
        case .arrowLeft12: return "\u{f1ab}"
        case .arrowLeft16: return "\u{f1ac}"
        case .arrowLeft18: return "\u{f1ad}"
        case .arrowLeft20: return "\u{f1ae}"
        case .arrowLeft24: return "\u{f1af}"
        case .arrowLeft28: return "\u{f1b0}"
        case .arrowLeft32: return "\u{f1b1}"
        case .arrowLeft6: return "\u{f1b2}"
        case .arrowLeft8: return "\u{f1b3}"
        case .arrowLeftOptical10: return "\u{f1b4}"
        case .arrowLeftOptical12: return "\u{f1b5}"
        case .arrowLeftOptical14: return "\u{f1b6}"
        case .arrowLeftOptical16: return "\u{f1b7}"
        case .arrowLeftOptical18: return "\u{f1b8}"
        case .arrowLeftOptical20: return "\u{f1b9}"
        case .arrowLeftOptical24: return "\u{f1ba}"
        case .arrowLeftOptical28: return "\u{f1bb}"
        case .arrowLeftOptical32: return "\u{f1bc}"
        case .arrowLeftOptical8: return "\u{f1bd}"
        case .arrowRight12: return "\u{f1be}"
        case .arrowRight16: return "\u{f1bf}"
        case .arrowRight18: return "\u{f1c0}"
        case .arrowRight20: return "\u{f1c1}"
        case .arrowRight24: return "\u{f1c2}"
        case .arrowRight28: return "\u{f1c3}"
        case .arrowRight32: return "\u{f1c4}"
        case .arrowRight6: return "\u{f1c5}"
        case .arrowRight8: return "\u{f1c6}"
        case .arrowRightOptical10: return "\u{f1c7}"
        case .arrowRightOptical12: return "\u{f1c8}"
        case .arrowRightOptical14: return "\u{f1c9}"
        case .arrowRightOptical16: return "\u{f1ca}"
        case .arrowRightOptical18: return "\u{f1cb}"
        case .arrowRightOptical20: return "\u{f1cc}"
        case .arrowRightOptical24: return "\u{f1cd}"
        case .arrowRightOptical28: return "\u{f1ce}"
        case .arrowRightOptical32: return "\u{f1cf}"
        case .arrowRightOptical8: return "\u{f1d0}"
        case .arrowTailDown10: return "\u{f1d1}"
        case .arrowTailDown12: return "\u{f1d2}"
        case .arrowTailDown14: return "\u{f1d3}"
        case .arrowTailDown16: return "\u{f1d4}"
        case .arrowTailDown20: return "\u{f1d5}"
        case .arrowTailDown24: return "\u{f1d6}"
        case .arrowTailDown28: return "\u{f1d7}"
        case .arrowTailDown36: return "\u{f1d8}"
        case .arrowTailUp10: return "\u{f1d9}"
        case .arrowTailUp12: return "\u{f1da}"
        case .arrowTailUp14: return "\u{f1db}"
        case .arrowTailUp16: return "\u{f1dc}"
        case .arrowTailUp20: return "\u{f1dd}"
        case .arrowTailUp24: return "\u{f1de}"
        case .arrowTailUp28: return "\u{f1df}"
        case .arrowTailUp36: return "\u{f1e0}"
        case .arrowUp12: return "\u{f1e1}"
        case .arrowUp16: return "\u{f1e2}"
        case .arrowUp18: return "\u{f1e3}"
        case .arrowUp20: return "\u{f1e4}"
        case .arrowUp24: return "\u{f1e5}"
        case .arrowUp28: return "\u{f1e6}"
        case .arrowUp32: return "\u{f1e7}"
        case .arrowUp6: return "\u{f1e8}"
        case .arrowUp8: return "\u{f1e9}"
        case .arrowUpOptical12: return "\u{f1ea}"
        case .arrowUpOptical14: return "\u{f1eb}"
        case .arrowUpOptical16: return "\u{f1ec}"
        case .arrowUpOptical18: return "\u{f1ed}"
        case .arrowUpOptical20: return "\u{f1ee}"
        case .arrowUpOptical24: return "\u{f1ef}"
        case .arrowUpOptical28: return "\u{f1f0}"
        case .arrowUpOptical32: return "\u{f1f1}"
        case .arrowUpOptical8: return "\u{f1f2}"
        case .assignHost24: return "\u{f1f3}"
        case .assignPrivilege20: return "\u{f1f4}"
        case .attachment12: return "\u{f1f5}"
        case .attachment16: return "\u{f1f6}"
        case .attachment20: return "\u{f1f7}"
        case .audioAndVideoConnection20: return "\u{f1f8}"
        case .audioAndVideoConnection24: return "\u{f1f9}"
        case .audioBroadcast14: return "\u{f1fa}"
        case .audioBroadcast16: return "\u{f1fb}"
        case .audioBroadcast20: return "\u{f1fc}"
        case .audioBroadcast24: return "\u{f1fd}"
        case .audioCall16: return "\u{f1fe}"
        case .audioInput16: return "\u{f1ff}"
        case .audioOptions20: return "\u{f200}"
        case .audioOptions24: return "\u{f201}"
        case .audioOptions28: return "\u{f202}"
        case .audioOptions32: return "\u{f203}"
        case .back10: return "\u{f204}"
        case .back12: return "\u{f205}"
        case .back16: return "\u{f206}"
        case .back20: return "\u{f207}"
        case .back24: return "\u{f208}"
        case .back28: return "\u{f209}"
        case .back36: return "\u{f20a}"
        case .backToFullscreen12: return "\u{f20b}"
        case .backToFullscreen14: return "\u{f20c}"
        case .backToFullscreen16: return "\u{f20d}"
        case .backToFullscreen20: return "\u{f20e}"
        case .backToFullscreen22: return "\u{f20f}"
        case .backToFullscreen24: return "\u{f210}"
        case .backToFullscreenAdr12: return "\u{f211}"
        case .backToFullscreenAdr14: return "\u{f212}"
        case .backToFullscreenAdr16: return "\u{f213}"
        case .backToFullscreenAdr20: return "\u{f214}"
        case .backToFullscreenAdr22: return "\u{f215}"
        case .backToFullscreenAdr24: return "\u{f216}"
        case .backToFullscreenAdr26: return "\u{f217}"
        case .backToFullscreenAdr28: return "\u{f218}"
        case .backspace16: return "\u{f219}"
        case .backspace20: return "\u{f21a}"
        case .backspace24: return "\u{f21b}"
        case .backupData16: return "\u{f21c}"
        case .backupData24: return "\u{f21d}"
        case .battery20: return "\u{f21e}"
        case .battery24: return "\u{f21f}"
        case .blocked12: return "\u{f220}"
        case .blocked14: return "\u{f221}"
        case .blocked16: return "\u{f222}"
        case .blocked18: return "\u{f223}"
        case .blocked20: return "\u{f224}"
        case .blocked24: return "\u{f225}"
        case .blocked28: return "\u{f226}"
        case .blocked32: return "\u{f227}"
        case .blocked36: return "\u{f228}"
        case .blocked40: return "\u{f229}"
        case .blocked48: return "\u{f22a}"
        case .blocked56: return "\u{f22b}"
        case .blocked8: return "\u{f22c}"
        case .blog16: return "\u{f22d}"
        case .bloomberg16: return "\u{f22e}"
        case .bloombergCircle16: return "\u{f22f}"
        case .bluetooth16: return "\u{f230}"
        case .bluetooth24: return "\u{f231}"
        case .bluetoothContainer16: return "\u{f232}"
        case .bluetoothContainerMuted16: return "\u{f233}"
        case .bookmark16: return "\u{f234}"
        case .bot12: return "\u{f235}"
        case .bot14: return "\u{f236}"
        case .bot16: return "\u{f237}"
        case .bot18: return "\u{f238}"
        case .bot20: return "\u{f239}"
        case .bot24: return "\u{f23a}"
        case .bot36: return "\u{f23b}"
        case .bot56: return "\u{f23c}"
        case .botCustomerAssistant16: return "\u{f23d}"
        case .botCustomerAssistant24: return "\u{f23e}"
        case .botCustomerAssistant36: return "\u{f23f}"
        case .botExpertAssistant16: return "\u{f240}"
        case .botExpertAssistant24: return "\u{f241}"
        case .botExpertAssistant36: return "\u{f242}"
        case .box24: return "\u{f243}"
        case .breakoutSession16: return "\u{f244}"
        case .breakoutSession20: return "\u{f245}"
        case .breakoutSession24: return "\u{f246}"
        case .brightness16: return "\u{f247}"
        case .brightness24: return "\u{f248}"
        case .broadcastMessage16: return "\u{f249}"
        case .brokenFile16: return "\u{f24a}"
        case .brokenFile24: return "\u{f24b}"
        case .browser12: return "\u{f24c}"
        case .browser16: return "\u{f24d}"
        case .browser24: return "\u{f24e}"
        case .browser28: return "\u{f24f}"
        case .calendarAdd12: return "\u{f250}"
        case .calendarAdd16: return "\u{f251}"
        case .calendarAdd20: return "\u{f252}"
        case .calendarAdd24: return "\u{f253}"
        case .calendarEmpty16: return "\u{f254}"
        case .calendarEmpty20: return "\u{f255}"
        case .calendarEmpty24: return "\u{f256}"
        case .calendarEmptyActive16: return "\u{f257}"
        case .calendarEmptyActive20: return "\u{f258}"
        case .calendarEmptyActive24: return "\u{f259}"
        case .calendarExternal12: return "\u{f25a}"
        case .calendarExternal16: return "\u{f25b}"
        case .calendarExternal18: return "\u{f25c}"
        case .calendarExternal20: return "\u{f25d}"
        case .calendarExternal24: return "\u{f25e}"
        case .calendarMonth10: return "\u{f25f}"
        case .calendarMonth12: return "\u{f260}"
        case .calendarMonth16: return "\u{f261}"
        case .calendarMonth20: return "\u{f262}"
        case .calendarMonth24: return "\u{f263}"
        case .calendarMonth28: return "\u{f264}"
        case .calendarMonth36: return "\u{f265}"
        case .calendarWeek16: return "\u{f266}"
        case .calendarWeek20: return "\u{f267}"
        case .calendarWeek24: return "\u{f268}"
        case .callForward16: return "\u{f269}"
        case .callForward24: return "\u{f26a}"
        case .callForward28: return "\u{f26b}"
        case .callForwardDivert16: return "\u{f26c}"
        case .callHandling16: return "\u{f26d}"
        case .callHold16: return "\u{f26e}"
        case .callHold20: return "\u{f26f}"
        case .callHold24: return "\u{f270}"
        case .callIncoming12: return "\u{f271}"
        case .callIncoming16: return "\u{f272}"
        case .callIncoming24: return "\u{f273}"
        case .callIncoming8: return "\u{f274}"
        case .callLog14: return "\u{f275}"
        case .callLog16: return "\u{f276}"
        case .callLog24: return "\u{f277}"
        case .callMerge16: return "\u{f278}"
        case .callMerge20: return "\u{f279}"
        case .callMerge24: return "\u{f27a}"
        case .callOutgoing12: return "\u{f27b}"
        case .callOutgoing16: return "\u{f27c}"
        case .callOutgoing24: return "\u{f27d}"
        case .callOutgoing8: return "\u{f27e}"
        case .callPrivate12: return "\u{f27f}"
        case .callPrivate14: return "\u{f280}"
        case .callRequest12: return "\u{f281}"
        case .callRequest14: return "\u{f282}"
        case .callRoom28: return "\u{f283}"
        case .callSwap16: return "\u{f284}"
        case .callSwap20: return "\u{f285}"
        case .callSwap24: return "\u{f286}"
        case .callSwap28: return "\u{f287}"
        case .camera10: return "\u{f288}"
        case .camera12: return "\u{f289}"
        case .camera14: return "\u{f28a}"
        case .camera16: return "\u{f28b}"
        case .camera18: return "\u{f28c}"
        case .camera20: return "\u{f28d}"
        case .camera24: return "\u{f28e}"
        case .camera26: return "\u{f28f}"
        case .camera28: return "\u{f290}"
        case .camera32: return "\u{f291}"
        case .camera36: return "\u{f292}"
        case .camera8: return "\u{f293}"
        case .cameraAux16: return "\u{f294}"
        case .cameraAux24: return "\u{f295}"
        case .cameraGroup16: return "\u{f296}"
        case .cameraGroup24: return "\u{f297}"
        case .cameraMuted12: return "\u{f298}"
        case .cameraMuted14: return "\u{f299}"
        case .cameraMuted16: return "\u{f29a}"
        case .cameraMuted20: return "\u{f29b}"
        case .cameraMuted24: return "\u{f29c}"
        case .cameraMuted28: return "\u{f29d}"
        case .cameraMuted32: return "\u{f29e}"
        case .cameraMuted36: return "\u{f29f}"
        case .cameraMuted8: return "\u{f2a0}"
        case .cameraPhoto16: return "\u{f2a1}"
        case .cameraPhoto20: return "\u{f2a2}"
        case .cameraPhoto24: return "\u{f2a3}"
        case .cameraPhoto32: return "\u{f2a4}"
        case .cameraPhoto48: return "\u{f2a5}"
        case .cameraPhotoSwap16: return "\u{f2a6}"
        case .cameraSwap16: return "\u{f2a7}"
        case .cameraSwap20: return "\u{f2a8}"
        case .cameraSwap24: return "\u{f2a9}"
        case .cancel12: return "\u{f2aa}"
        case .cancel14: return "\u{f2ab}"
        case .cancel16: return "\u{f2ac}"
        case .cancel18: return "\u{f2ad}"
        case .cancel20: return "\u{f2ae}"
        case .cancel24: return "\u{f2af}"
        case .cancel28: return "\u{f2b0}"
        case .cancel36: return "\u{f2b1}"
        case .cancel6: return "\u{f2b2}"
        case .cancel8: return "\u{f2b3}"
        case .certified16: return "\u{f2b4}"
        case .certified24: return "\u{f2b5}"
        case .chat10: return "\u{f2b6}"
        case .chat12: return "\u{f2b7}"
        case .chat14: return "\u{f2b8}"
        case .chat16: return "\u{f2b9}"
        case .chat18: return "\u{f2ba}"
        case .chat20: return "\u{f2bb}"
        case .chat24: return "\u{f2bc}"
        case .chat26: return "\u{f2bd}"
        case .chat28: return "\u{f2be}"
        case .chat32: return "\u{f2bf}"
        case .chat36: return "\u{f2c0}"
        case .chat8: return "\u{f2c1}"
        case .chatActive10: return "\u{f2c2}"
        case .chatActive12: return "\u{f2c3}"
        case .chatActive14: return "\u{f2c4}"
        case .chatActive16: return "\u{f2c5}"
        case .chatActive18: return "\u{f2c6}"
        case .chatActive20: return "\u{f2c7}"
        case .chatActive24: return "\u{f2c8}"
        case .chatActive26: return "\u{f2c9}"
        case .chatActive28: return "\u{f2ca}"
        case .chatActive32: return "\u{f2cb}"
        case .chatActive36: return "\u{f2cc}"
        case .chatActive8: return "\u{f2cd}"
        case .chatGroup12: return "\u{f2ce}"
        case .chatGroup16: return "\u{f2cf}"
        case .chatGroup20: return "\u{f2d0}"
        case .chatGroup32: return "\u{f2d1}"
        case .chatPersistent16: return "\u{f2d2}"
        case .chatPersistent20: return "\u{f2d3}"
        case .chatPersistent24: return "\u{f2d4}"
        case .check10: return "\u{f2d5}"
        case .check12: return "\u{f2d6}"
        case .check14: return "\u{f2d7}"
        case .check16: return "\u{f2d8}"
        case .check18: return "\u{f2d9}"
        case .check20: return "\u{f2da}"
        case .check24: return "\u{f2db}"
        case .check28: return "\u{f2dc}"
        case .check32: return "\u{f2dd}"
        case .check36: return "\u{f2de}"
        case .check40: return "\u{f2df}"
        case .check64: return "\u{f2e0}"
        case .check8: return "\u{f2e1}"
        case .check80: return "\u{f2e2}"
        case .checkCircle100: return "\u{f2e3}"
        case .checkCircle12: return "\u{f2e4}"
        case .checkCircle14: return "\u{f2e5}"
        case .checkCircle16: return "\u{f2e6}"
        case .checkCircle24: return "\u{f2e7}"
        case .checkCircle40: return "\u{f2e8}"
        case .checkCircle44: return "\u{f2e9}"
        case .checkRefresh16: return "\u{f2ea}"
        case .ciscoLogo: return "\u{f2eb}"
        case .clear12: return "\u{f2ec}"
        case .clear14: return "\u{f2ed}"
        case .clear16: return "\u{f2ee}"
        case .clear18: return "\u{f2ef}"
        case .clear20: return "\u{f2f0}"
        case .clear24: return "\u{f2f1}"
        case .clear32: return "\u{f2f2}"
        case .clear44: return "\u{f2f3}"
        case .clearActive12: return "\u{f2f4}"
        case .clearActive14: return "\u{f2f5}"
        case .clearActive16: return "\u{f2f6}"
        case .clearActive18: return "\u{f2f7}"
        case .clearActive24: return "\u{f2f8}"
        case .clearActive32: return "\u{f2f9}"
        case .closeSpace12: return "\u{f2fa}"
        case .closeSpace18: return "\u{f2fb}"
        case .closedCaption12: return "\u{f2fc}"
        case .closedCaption16: return "\u{f2fd}"
        case .closedCaption20: return "\u{f2fe}"
        case .cloud16: return "\u{f2ff}"
        case .cloud24: return "\u{f300}"
        case .cloud32: return "\u{f301}"
        case .cloudUpload16: return "\u{f302}"
        case .cloudUpload20: return "\u{f303}"
        case .company16: return "\u{f304}"
        case .company24: return "\u{f305}"
        case .company32: return "\u{f306}"
        case .computer16: return "\u{f307}"
        case .computer24: return "\u{f308}"
        case .contactCard10: return "\u{f309}"
        case .contactCard12: return "\u{f30a}"
        case .contactCard16: return "\u{f30b}"
        case .contactCard24: return "\u{f30c}"
        case .contentDownload12: return "\u{f30d}"
        case .contentDownload14: return "\u{f30e}"
        case .copy10: return "\u{f30f}"
        case .copy12: return "\u{f310}"
        case .copy14: return "\u{f311}"
        case .copy16: return "\u{f312}"
        case .copy20: return "\u{f313}"
        case .copy24: return "\u{f314}"
        case .crop16: return "\u{f315}"
        case .cucmConnection24: return "\u{f316}"
        case .dataUsage16: return "\u{f317}"
        case .dataUsage18: return "\u{f318}"
        case .dataUsage20: return "\u{f319}"
        case .dataUsage24: return "\u{f31a}"
        case .defaultApp16: return "\u{f31b}"
        case .delete10: return "\u{f31c}"
        case .delete12: return "\u{f31d}"
        case .delete14: return "\u{f31e}"
        case .delete16: return "\u{f31f}"
        case .delete18: return "\u{f320}"
        case .delete20: return "\u{f321}"
        case .delete24: return "\u{f322}"
        case .deskphone12: return "\u{f323}"
        case .deskphone16: return "\u{f324}"
        case .deskphone20: return "\u{f325}"
        case .deskphone24: return "\u{f326}"
        case .deskphone32: return "\u{f327}"
        case .deskphone48: return "\u{f328}"
        case .deviceConnection12: return "\u{f329}"
        case .deviceConnection14: return "\u{f32a}"
        case .deviceConnection16: return "\u{f32b}"
        case .deviceConnection18: return "\u{f32c}"
        case .deviceInRoom100: return "\u{f32d}"
        case .deviceInRoom12: return "\u{f32e}"
        case .deviceInRoom14: return "\u{f32f}"
        case .deviceInRoom16: return "\u{f330}"
        case .deviceInRoom18: return "\u{f331}"
        case .deviceInRoom20: return "\u{f332}"
        case .deviceInRoom24: return "\u{f333}"
        case .deviceInRoom32: return "\u{f334}"
        case .deviceInRoom48: return "\u{f335}"
        case .deviceInRoom56: return "\u{f336}"
        case .deviceInRoom8: return "\u{f337}"
        case .deviceInRoomActive24: return "\u{f338}"
        case .diagnostics16: return "\u{f339}"
        case .diagnostics24: return "\u{f33a}"
        case .diagnostics32: return "\u{f33b}"
        case .diagnosticsCircle100: return "\u{f33c}"
        case .dialpad16: return "\u{f33d}"
        case .dialpad20: return "\u{f33e}"
        case .dialpad24: return "\u{f33f}"
        case .dialpad28: return "\u{f340}"
        case .directory16: return "\u{f341}"
        case .directory20: return "\u{f342}"
        case .directory24: return "\u{f343}"
        case .display16: return "\u{f344}"
        case .display24: return "\u{f345}"
        case .display36: return "\u{f346}"
        case .displayInput24: return "\u{f347}"
        case .dnd12: return "\u{f348}"
        case .dnd120: return "\u{f349}"
        case .dnd124: return "\u{f34a}"
        case .dnd14: return "\u{f34b}"
        case .dnd16: return "\u{f34c}"
        case .dnd18: return "\u{f34d}"
        case .dnd20: return "\u{f34e}"
        case .dnd24: return "\u{f34f}"
        case .dnd26: return "\u{f350}"
        case .dnd28: return "\u{f351}"
        case .dnd32: return "\u{f352}"
        case .dnd36: return "\u{f353}"
        case .dnd40: return "\u{f354}"
        case .dnd48: return "\u{f355}"
        case .dnd56: return "\u{f356}"
        case .dnd8: return "\u{f357}"
        case .dockIn12: return "\u{f358}"
        case .dockIn16: return "\u{f359}"
        case .dockOut12: return "\u{f35a}"
        case .dockOut16: return "\u{f35b}"
        case .document12: return "\u{f35c}"
        case .document14: return "\u{f35d}"
        case .document16: return "\u{f35e}"
        case .document20: return "\u{f35f}"
        case .document24: return "\u{f360}"
        case .document28: return "\u{f361}"
        case .document32: return "\u{f362}"
        case .document36: return "\u{f363}"
        case .document40: return "\u{f364}"
        case .document44: return "\u{f365}"
        case .document72: return "\u{f366}"
        case .documentCreate16: return "\u{f367}"
        case .documentMove16: return "\u{f368}"
        case .documentShare16: return "\u{f369}"
        case .download12: return "\u{f36a}"
        case .download14: return "\u{f36b}"
        case .download16: return "\u{f36c}"
        case .download18: return "\u{f36d}"
        case .download20: return "\u{f36e}"
        case .download24: return "\u{f36f}"
        case .download28: return "\u{f370}"
        case .download32: return "\u{f371}"
        case .downloadCircle100: return "\u{f372}"
        case .drag16: return "\u{f373}"
        case .dx7016: return "\u{f374}"
        case .dx7020: return "\u{f375}"
        case .dx8016: return "\u{f376}"
        case .dx8020: return "\u{f377}"
        case .edit10: return "\u{f378}"
        case .edit12: return "\u{f379}"
        case .edit14: return "\u{f37a}"
        case .edit16: return "\u{f37b}"
        case .edit18: return "\u{f37c}"
        case .edit20: return "\u{f37d}"
        case .edit24: return "\u{f37e}"
        case .edit56: return "\u{f37f}"
        case .email12: return "\u{f380}"
        case .email16: return "\u{f381}"
        case .email20: return "\u{f382}"
        case .email56: return "\u{f383}"
        case .emailCircle24: return "\u{f384}"
        case .emailCircle32: return "\u{f385}"
        case .emailCircle40: return "\u{f386}"
        case .emailInvite100: return "\u{f387}"
        case .emailInvite16: return "\u{f388}"
        case .emailInvite24: return "\u{f389}"
        case .emailInvite32: return "\u{f38a}"
        case .emailRead16: return "\u{f38b}"
        case .emailRead20: return "\u{f38c}"
        case .emailRead24: return "\u{f38d}"
        case .emoticons12: return "\u{f38e}"
        case .emoticons16: return "\u{f38f}"
        case .emoticons20: return "\u{f390}"
        case .emoticons24: return "\u{f391}"
        case .endpoint10: return "\u{f392}"
        case .endpoint12: return "\u{f393}"
        case .endpoint14: return "\u{f394}"
        case .endpoint16: return "\u{f395}"
        case .endpoint20: return "\u{f396}"
        case .endpoint24: return "\u{f397}"
        case .endpoint28: return "\u{f398}"
        case .endpoint32: return "\u{f399}"
        case .endpoint48: return "\u{f39a}"
        case .endpoint56: return "\u{f39b}"
        case .endpoint8: return "\u{f39c}"
        case .endpointG216: return "\u{f39d}"
        case .endpointG220: return "\u{f39e}"
        case .endpointG27016: return "\u{f39f}"
        case .endpointG27020: return "\u{f3a0}"
        case .endpointG270Dual16: return "\u{f3a1}"
        case .endpointG270Dual20: return "\u{f3a2}"
        case .endpointG2Stand16: return "\u{f3a3}"
        case .endpointG2Stand20: return "\u{f3a4}"
        case .endpointMx80016: return "\u{f3a5}"
        case .endpointMx80020: return "\u{f3a6}"
        case .endpointMx800Dual16: return "\u{f3a7}"
        case .endpointMx800Dual20: return "\u{f3a8}"
        case .endpointStand16: return "\u{f3a9}"
        case .endpointStand20: return "\u{f3aa}"
        case .enter16: return "\u{f3ab}"
        case .enterRoom10: return "\u{f3ac}"
        case .enterRoom12: return "\u{f3ad}"
        case .enterRoom16: return "\u{f3ae}"
        case .enterRoom20: return "\u{f3af}"
        case .enterRoom24: return "\u{f3b0}"
        case .enterRoom28: return "\u{f3b1}"
        case .enterRoom8: return "\u{f3b2}"
        case .eraser12: return "\u{f3b3}"
        case .eraser14: return "\u{f3b4}"
        case .eraser16: return "\u{f3b5}"
        case .eraser18: return "\u{f3b6}"
        case .error12: return "\u{f3b7}"
        case .error16: return "\u{f3b8}"
        case .error20: return "\u{f3b9}"
        case .error24: return "\u{f3ba}"
        case .error40: return "\u{f3bb}"
        case .error8: return "\u{f3bc}"
        case .error80: return "\u{f3bd}"
        case .errorLegacy12: return "\u{f3be}"
        case .errorLegacy16: return "\u{f3bf}"
        case .errorLegacy20: return "\u{f3c0}"
        case .errorLegacy24: return "\u{f3c1}"
        case .errorLegacy8: return "\u{f3c2}"
        case .errorLegacy80: return "\u{f3c3}"
        case .ethernet16: return "\u{f3c4}"
        case .ethernet24: return "\u{f3c5}"
        case .exitRoom12: return "\u{f3c6}"
        case .exitRoom16: return "\u{f3c7}"
        case .exitRoom20: return "\u{f3c8}"
        case .exitRoom24: return "\u{f3c9}"
        case .exitRoom28: return "\u{f3ca}"
        case .explore16: return "\u{f3cb}"
        case .export16: return "\u{f3cc}"
        case .export24: return "\u{f3cd}"
        case .extensionMobility16: return "\u{f3ce}"
        case .extensionMobility24: return "\u{f3cf}"
        case .externalUser10: return "\u{f3d0}"
        case .externalUser12: return "\u{f3d1}"
        case .externalUser16: return "\u{f3d2}"
        case .externalUser20: return "\u{f3d3}"
        case .facebook16: return "\u{f3d4}"
        case .facebookBlue12: return "\u{f3d5}"
        case .facebookCircle24: return "\u{f3d6}"
        case .facebookCircle32: return "\u{f3d7}"
        case .facebookCircle40: return "\u{f3d8}"
        case .facebookLogo12: return "\u{f3d9}"
        case .favorite10: return "\u{f3da}"
        case .favorite12: return "\u{f3db}"
        case .favorite14: return "\u{f3dc}"
        case .favorite16: return "\u{f3dd}"
        case .favorite20: return "\u{f3de}"
        case .favorite24: return "\u{f3df}"
        case .favorite28: return "\u{f3e0}"
        case .favorite8: return "\u{f3e1}"
        case .favoriteActive12: return "\u{f3e2}"
        case .favoriteActive14: return "\u{f3e3}"
        case .favoriteActive16: return "\u{f3e4}"
        case .favoriteActive20: return "\u{f3e5}"
        case .favoriteActive24: return "\u{f3e6}"
        case .favoriteActive28: return "\u{f3e7}"
        case .favoriteActive8: return "\u{f3e8}"
        case .favoriteFilled12: return "\u{f3e9}"
        case .favoriteFilled14: return "\u{f3ea}"
        case .favoriteFilled16: return "\u{f3eb}"
        case .favoriteFilled20: return "\u{f3ec}"
        case .favoriteFilled24: return "\u{f3ed}"
        case .favoriteFilled28: return "\u{f3ee}"
        case .favoriteFilled8: return "\u{f3ef}"
        case .fbw16: return "\u{f3f0}"
        case .fbw24: return "\u{f3f1}"
        case .feedback12: return "\u{f3f2}"
        case .feedback14: return "\u{f3f3}"
        case .feedback16: return "\u{f3f4}"
        case .feedback20: return "\u{f3f5}"
        case .feedback72: return "\u{f3f6}"
        case .feedback8: return "\u{f3f7}"
        case .feedbackActive12: return "\u{f3f8}"
        case .feedbackActive14: return "\u{f3f9}"
        case .feedbackActive16: return "\u{f3fa}"
        case .feedbackActive20: return "\u{f3fb}"
        case .feedbackActive8: return "\u{f3fc}"
        case .fileAudio12: return "\u{f3ff}"
        case .fileAudio16: return "\u{f400}"
        case .fileAudio24: return "\u{f401}"
        case .fileAudio28: return "\u{f402}"
        case .fileAudio32: return "\u{f403}"
        case .fileAudio36: return "\u{f404}"
        case .fileAudio40: return "\u{f405}"
        case .fileAudio44: return "\u{f406}"
        case .fileAudio72: return "\u{f407}"
        case .fileGraph12: return "\u{f408}"
        case .fileGraph16: return "\u{f409}"
        case .fileGraph24: return "\u{f40a}"
        case .fileGraph28: return "\u{f40b}"
        case .fileGraph32: return "\u{f40c}"
        case .fileGraph36: return "\u{f40d}"
        case .fileGraph40: return "\u{f40e}"
        case .fileGraph72: return "\u{f40f}"
        case .fileImage12: return "\u{f410}"
        case .fileImage16: return "\u{f411}"
        case .fileImage24: return "\u{f412}"
        case .fileImage28: return "\u{f413}"
        case .fileImage32: return "\u{f414}"
        case .fileImage36: return "\u{f415}"
        case .fileImage40: return "\u{f416}"
        case .fileImage44: return "\u{f417}"
        case .fileImage72: return "\u{f418}"
        case .fileLocked12: return "\u{f419}"
        case .fileLocked24: return "\u{f41a}"
        case .fileLocked32: return "\u{f41b}"
        case .fileLocked36: return "\u{f41c}"
        case .fileLocked40: return "\u{f41d}"
        case .fileMissing16: return "\u{f41e}"
        case .fileMissing24: return "\u{f41f}"
        case .fileMissing36: return "\u{f420}"
        case .filePdf12: return "\u{f421}"
        case .filePdf16: return "\u{f422}"
        case .filePdf24: return "\u{f423}"
        case .filePdf28: return "\u{f424}"
        case .filePdf32: return "\u{f425}"
        case .filePdf36: return "\u{f426}"
        case .filePdf40: return "\u{f427}"
        case .filePdf44: return "\u{f428}"
        case .filePdf72: return "\u{f429}"
        case .fileSpreadsheet12: return "\u{f42a}"
        case .fileSpreadsheet16: return "\u{f42b}"
        case .fileSpreadsheet24: return "\u{f42c}"
        case .fileSpreadsheet28: return "\u{f42d}"
        case .fileSpreadsheet32: return "\u{f42e}"
        case .fileSpreadsheet36: return "\u{f42f}"
        case .fileSpreadsheet40: return "\u{f430}"
        case .fileSpreadsheet44: return "\u{f431}"
        case .fileSpreadsheet72: return "\u{f432}"
        case .fileText12: return "\u{f433}"
        case .fileText16: return "\u{f434}"
        case .fileText20: return "\u{f435}"
        case .fileText24: return "\u{f436}"
        case .fileText28: return "\u{f437}"
        case .fileText32: return "\u{f438}"
        case .fileText36: return "\u{f439}"
        case .fileText40: return "\u{f43a}"
        case .fileText44: return "\u{f43b}"
        case .fileText72: return "\u{f43c}"
        case .fileVideo12: return "\u{f43d}"
        case .fileVideo16: return "\u{f43e}"
        case .fileVideo24: return "\u{f43f}"
        case .fileVideo28: return "\u{f440}"
        case .fileVideo32: return "\u{f441}"
        case .fileVideo36: return "\u{f442}"
        case .fileVideo40: return "\u{f443}"
        case .fileVideo44: return "\u{f444}"
        case .fileVideo72: return "\u{f445}"
        case .fileZip12: return "\u{f446}"
        case .fileZip16: return "\u{f447}"
        case .fileZip24: return "\u{f448}"
        case .fileZip28: return "\u{f449}"
        case .fileZip32: return "\u{f44a}"
        case .fileZip36: return "\u{f44b}"
        case .fileZip40: return "\u{f44c}"
        case .fileZip44: return "\u{f44d}"
        case .fileZip72: return "\u{f44e}"
        case .files10: return "\u{f44f}"
        case .files12: return "\u{f450}"
        case .files14: return "\u{f451}"
        case .files16: return "\u{f452}"
        case .files20: return "\u{f453}"
        case .files24: return "\u{f454}"
        case .files26: return "\u{f455}"
        case .files28: return "\u{f456}"
        case .files32: return "\u{f457}"
        case .files36: return "\u{f458}"
        case .files8: return "\u{f459}"
        case .filterCircle12: return "\u{f45a}"
        case .filterCircle16: return "\u{f45b}"
        case .filterCircle20: return "\u{f45c}"
        case .filterCircleActive20: return "\u{f45d}"
        case .fitToWidth12: return "\u{f45e}"
        case .fitToWindow12: return "\u{f45f}"
        case .fitToWindow16: return "\u{f460}"
        case .fitToWindowExit12: return "\u{f461}"
        case .fitToWindowExit16: return "\u{f462}"
        case .flag10: return "\u{f463}"
        case .flag12: return "\u{f464}"
        case .flag14: return "\u{f465}"
        case .flag16: return "\u{f466}"
        case .flag20: return "\u{f467}"
        case .flag24: return "\u{f468}"
        case .flag64: return "\u{f469}"
        case .flag8: return "\u{f46a}"
        case .flagActive10: return "\u{f46b}"
        case .flagActive12: return "\u{f46c}"
        case .flagActive14: return "\u{f46d}"
        case .flagActive16: return "\u{f46e}"
        case .flagActive20: return "\u{f46f}"
        case .flagActive24: return "\u{f470}"
        case .flagActive8: return "\u{f471}"
        case .flagCircle16: return "\u{f472}"
        case .flow32: return "\u{f473}"
        case .focus3Day24: return "\u{f474}"
        case .focusDay24: return "\u{f475}"
        case .focusMonth24: return "\u{f476}"
        case .focusUpcoming24: return "\u{f477}"
        case .focusWeek24: return "\u{f478}"
