...
var AlertCall = function AlertCall(props) {
  ...
  var getDeviceList = function getDeviceList() {
    return devices.length > 0 && _react.default.createElement(_DeviceListCall.default, _extends({
  ...
  return show && _react.default.createElement("div", _extends({
  ...
  }, getAvatar(), _react.default.createElement("div", {
    className: "md-alert__caller-title"
  }, caller.title), _react.default.createElement("div", {
    className: "md-alert__caller-subtitle"
  }, caller.alt)), _react.default.createElement(_reactUid.UIDReset, null, getDeviceList()), _react.default.createElement("div", {
    className: "md-alert--call--buttons"
  }, onAnswerShare && _react.default.createElement(_.Button, _extends({
    ariaLabel: shareAriaLabel,
    circle: true,
    color: "blue",
    onClick: onAnswerShare,
    size: 44
  }, shareBtnProps), _react.default.createElement(_.Icon, {
    name: "share-screen_24"
  })), onAnswerVideo && _react.default.createElement(_.Button, _extends({
    ariaLabel: videoAriaLabel,
    circle: true,
    color: "green",
    onClick: onAnswerVideo,
    size: 44
  }, videoBtnProps), _react.default.createElement(_.Icon, {
    name: "camera_24"
  })), onAnswerVoice && _react.default.createElement(_.Button, _extends({
    ariaLabel: voiceAriaLabel,
    circle: true,
    color: "green",
    onClick: onAnswerVoice,
    size: 44
  }, voiceBtnProps), _react.default.createElement(_.Icon, {
    name: "handset_24"
    ...
    onClick: onReject,
    size: 44
  }, rejectBtnProps), _react.default.createElement(_.Icon, {
    name: "cancel_24"
  }))));
};
