...
@objc public enum MomentumIconsRebrandType: Int {
    ...
    public var ligature: String {
        ...
        case .selectAllBold: return "\u{f8b3}"
        case .selectAllFilled: return "\u{f8b4}"
        case .selectAllLight: return "\u{f8b5}"
        case .selectAllRegular: return "\u{f8b6}"
        case .selectionBold: return "\u{f8b7}"
        case .selectionLight: return "\u{f8b8}"
        case .selectionRegular: return "\u{f8b9}"
        case .sendBold: return "\u{f8ba}"
        case .sendFilled: return "\u{f8bb}"
        case .sendLight: return "\u{f8bc}"
        case .sendRegular: return "\u{f8bd}"
        case .serverBold: return "\u{f8be}"
        case .serverErrorBold: return "\u{f8bf}"
        case .serverErrorLight: return "\u{f8c0}"
        case .serverErrorRegular: return "\u{f8c1}"
        case .serverLight: return "\u{f8c2}"
        case .serverRegular: return "\u{f8c3}"
        case .servicesBold: return "\u{f8c4}"
        case .servicesLight: return "\u{f8c5}"
        case .servicesRegular: return "\u{f8c6}"
        case .setVariableBold: return "\u{f8c7}"
        case .setVariableLight: return "\u{f8c8}"
        case .setVariableRegular: return "\u{f8c9}"
        case .settingsBold: return "\u{f8ca}"
        case .settingsFilled: return "\u{f8cb}"
        case .settingsLight: return "\u{f8cc}"
        case .settingsRegular: return "\u{f8cd}"
        case .setupAssistantBold: return "\u{f8ce}"
        case .setupAssistantLight: return "\u{f8cf}"
        case .setupAssistantRegular: return "\u{f8d0}"
        case .sftpBold: return "\u{f8d1}"
        case .sftpLight: return "\u{f8d2}"
        case .sftpRegular: return "\u{f8d3}"
        case .shapeCircleBold: return "\u{f8d4}"
        case .shapeCircleFilled: return "\u{f8d5}"
        case .shapeCircleLight: return "\u{f8d6}"
        case .shapeCircleRegular: return "\u{f8d7}"
        case .shapeDiagonalLineBold: return "\u{f8d8}"
        case .shapeDiagonalLineLight: return "\u{f8d9}"
        case .shapeDiagonalLineRegular: return "\u{f8da}"
        case .shapeDiamondBold: return "\u{f8db}"
        case .shapeDiamondFilled: return "\u{f8dc}"
        case .shapeDiamondLight: return "\u{f8dd}"
        case .shapeDiamondRegular: return "\u{f8de}"
        case .shapeOvalBold: return "\u{f8df}"
        case .shapeOvalLight: return "\u{f8e0}"
        case .shapeOvalRegular: return "\u{f8e1}"
        case .shapeSquareBold: return "\u{f8e2}"
        case .shapeSquareFilled: return "\u{f8e3}"
        case .shapeSquareLight: return "\u{f8e4}"
        case .shapeSquareRegular: return "\u{f8e5}"
        case .shapeTriangleBold: return "\u{f8e6}"
        case .shapeTriangleFilled: return "\u{f8e7}"
        case .shapeTriangleLight: return "\u{f8e8}"
        case .shapeTriangleRegular: return "\u{f8e9}"
        case .shapesBold: return "\u{f8ea}"
        case .shapesLight: return "\u{f8eb}"
        case .shapesRegular: return "\u{f8ec}"
        case .shareCNativeAdrBold: return "\u{f8ed}"
        case .shareCNativeAdrLight: return "\u{f8ee}"
        case .shareCNativeAdrRegular: return "\u{f8ef}"
        case .shareCNativeIphBold: return "\u{f8f0}"
        case .shareCNativeIphLight: return "\u{f8f1}"
        case .shareCNativeIphRegular: return "\u{f8f2}"
        case .shareScreenBold: return "\u{f8f3}"
        case .shareScreenFilled: return "\u{f8f4}"
        case .shareScreenLight: return "\u{f8f5}"
        case .shareScreenRegular: return "\u{f8f6}"
        case .shareScreenSmallFilled: return "\u{f8f7}"
        case .shareSpaceBold: return "\u{f8f8}"
        case .shareSpaceLight: return "\u{f8f9}"
        case .shareSpaceRegular: return "\u{f8fa}"
        case .shieldBold: return "\u{f8fb}"
        case .shieldLight: return "\u{f8fc}"
        case .shieldRegular: return "\u{f8fd}"
        case .shoppingCartBold: return "\u{f8fe}"
        case .shoppingCartFilled: return "\u{f8ff}"
        case .shoppingCartLight: return "\u{f900}"
        case .shoppingCartRegular: return "\u{f901}"
        case .shortTextBoxBold: return "\u{f902}"
        case .shortTextBoxLight: return "\u{f903}"
        case .shortTextBoxRegular: return "\u{f904}"
        case .showBold: return "\u{f905}"
        case .showFilled: return "\u{f906}"
        case .showLight: return "\u{f907}"
        case .showRegular: return "\u{f908}"
        case .signInBold: return "\u{f909}"
        case .signInFilled: return "\u{f90a}"
        case .signInForcedBold: return "\u{f90b}"
        case .signInForcedLight: return "\u{f90c}"
        case .signInForcedRegular: return "\u{f90d}"
        case .signInLight: return "\u{f90e}"
        case .signInRegular: return "\u{f90f}"
        case .signOutBold: return "\u{f910}"
        case .signOutLight: return "\u{f911}"
        case .signOutRegular: return "\u{f912}"
        case .signal0Bold: return "\u{f913}"
        case .signal0Light: return "\u{f914}"
        case .signal0Regular: return "\u{f915}"
        case .signal100Bold: return "\u{f916}"
        case .signal100Light: return "\u{f917}"
        case .signal100Regular: return "\u{f918}"
        case .signal25Bold: return "\u{f919}"
        case .signal25Light: return "\u{f91a}"
        case .signal25Regular: return "\u{f91b}"
        case .signal50Bold: return "\u{f91c}"
        case .signal50Light: return "\u{f91d}"
        case .signal50Regular: return "\u{f91e}"
        case .signal75Bold: return "\u{f91f}"
        case .signal75Light: return "\u{f920}"
        case .signal75Regular: return "\u{f921}"
        case .simplePromotionBold: return "\u{f922}"
        case .simplePromotionLight: return "\u{f923}"
        case .simplePromotionRegular: return "\u{f924}"
        case .singleNumberReachBold: return "\u{f925}"
        case .singleNumberReachLight: return "\u{f926}"
        case .singleNumberReachRegular: return "\u{f927}"
        case .sipRegistrationInProgressBold: return "\u{f928}"
        case .sipRegistrationInProgressFilled: return "\u{f929}"
        case .sipRegistrationInProgressLight: return "\u{f92a}"
        case .sipRegistrationInProgressRegular: return "\u{f92b}"
        case .skipBold: return "\u{f92c}"
        case .skipBwBold: return "\u{f92d}"
        case .skipBwFilled: return "\u{f92e}"
        case .skipBwLight: return "\u{f92f}"
        case .skipBwRegular: return "\u{f930}"
        case .skipFwBold: return "\u{f931}"
        case .skipFwFilled: return "\u{f932}"
        case .skipFwLight: return "\u{f933}"
        case .skipFwRegular: return "\u{f934}"
        case .skipLight: return "\u{f935}"
        case .skipRegular: return "\u{f936}"
        case .smsInboundBold: return "\u{f937}"
        case .smsInboundLight: return "\u{f938}"
        case .smsInboundRegular: return "\u{f939}"
        case .smsMessageBold: return "\u{f93a}"
        case .smsMessageFilled: return "\u{f93b}"
        case .smsMessageLight: return "\u{f93c}"
        case .smsMessageRegular: return "\u{f93d}"
        case .socialAlexaFilled: return "\u{f93e}"
        case .socialFacebookColoredFilled: return "\u{f93f}"
        case .socialFacebookFilled: return "\u{f940}"
        case .socialFbmessengerColoredFilled: return "\u{f941}"
        case .socialFbmessengerFilled: return "\u{f942}"
        case .socialInstagramBold: return "\u{f943}"
        case .socialMicrosoftColoredFilled: return "\u{f944}"
        case .socialMicrosoftFilled: return "\u{f945}"
        case .socialMmsFilled: return "\u{f946}"
        case .socialMmsGoldFilled: return "\u{f947}"
        case .socialSmsFilled: return "\u{f948}"
        case .socialSmsMintFilled: return "\u{f949}"
        case .socialTwitterColoredFilled: return "\u{f94a}"
        case .socialTwitterFilled: return "\u{f94b}"
        case .socialViberBold: return "\u{f94c}"
        case .socialViberColoredBold: return "\u{f94d}"
        case .socialWhatsappBold: return "\u{f94e}"
        case .socialWhatsappColoredFilled: return "\u{f94f}"
        case .sortAscendingBold: return "\u{f950}"
        case .sortAscendingLight: return "\u{f951}"
        case .sortAscendingRegular: return "\u{f952}"
        case .sortDescendingBold: return "\u{f953}"
        case .sortDescendingLight: return "\u{f954}"
        case .sortDescendingRegular: return "\u{f955}"
        case .soundDefaultBold: return "\u{f956}"
        case .soundDefaultLight: return "\u{f957}"
        case .soundDefaultRegular: return "\u{f958}"
        case .speakerBold: return "\u{f959}"
        case .speakerDisconnectedBold: return "\u{f95a}"
        case .speakerDisconnectedFilled: return "\u{f95b}"
        case .speakerDisconnectedLight: return "\u{f95c}"
        case .speakerDisconnectedRegular: return "\u{f95d}"
        case .speakerFilled: return "\u{f95e}"
        case .speakerLight: return "\u{f95f}"
        case .speakerMutedBold: return "\u{f960}"
        case .speakerMutedFilled: return "\u{f961}"
        case .speakerMutedLight: return "\u{f962}"
        case .speakerMutedRegular: return "\u{f963}"
        case .speakerOffBold: return "\u{f964}"
        case .speakerOffFilled: return "\u{f965}"
        case .speakerOffLight: return "\u{f966}"
        case .speakerOffRegular: return "\u{f967}"
        case .speakerOnColoredBold: return "\u{f968}"
        case .speakerOnColoredLight: return "\u{f969}"
        case .speakerOnColoredRegular: return "\u{f96a}"
        case .speakerRegular: return "\u{f96b}"
        case .speakerTurnDownBold: return "\u{f96c}"
        case .speakerTurnDownFilled: return "\u{f96d}"
        case .speakerTurnDownLight: return "\u{f96e}"
        case .speakerTurnDownRegular: return "\u{f96f}"
        case .speakerTurnUpBold: return "\u{f970}"
        case .speakerTurnUpFilled: return "\u{f971}"
        case .speakerTurnUpLight: return "\u{f972}"
        case .speakerTurnUpRegular: return "\u{f973}"
        case .spinnerBold: return "\u{f974}"
        case .spinnerFilledBold: return "\u{f975}"
        case .spinnerFilledLight: return "\u{f976}"
        case .spinnerFilledRegular: return "\u{f977}"
        case .spinnerLight: return "\u{f978}"
        case .spinnerPartialBold: return "\u{f979}"
        case .spinnerPartialLight: return "\u{f97a}"
        case .spinnerPartialRegular: return "\u{f97b}"
        case .spinnerRegular: return "\u{f97c}"
        case .stackedArea100ChartBold: return "\u{f97d}"
        case .stackedArea100ChartFilled: return "\u{f97e}"
        case .stackedArea100ChartLight: return "\u{f97f}"
        case .stackedArea100ChartRegular: return "\u{f980}"
        case .stackedAreaChartBold: return "\u{f981}"
        case .stackedAreaChartFilled: return "\u{f982}"
        case .stackedAreaChartLight: return "\u{f983}"
        case .stackedAreaChartRegular: return "\u{f984}"
        case .stackedBar100ChartBold: return "\u{f985}"
        case .stackedBar100ChartFilled: return "\u{f986}"
        case .stackedBar100ChartLight: return "\u{f987}"
        case .stackedBar100ChartRegular: return "\u{f988}"
        case .stackedBarChartBold: return "\u{f989}"
        case .stackedBarChartFilled: return "\u{f98a}"
        case .stackedBarChartLight: return "\u{f98b}"
        case .stackedBarChartRegular: return "\u{f98c}"
        case .startChatBold: return "\u{f98d}"
        case .startChatLight: return "\u{f98e}"
        case .startChatRegular: return "\u{f98f}"
        case .stethoscopeBold: return "\u{f990}"
        case .stethoscopeLight: return "\u{f991}"
        case .stethoscopeRegular: return "\u{f992}"
        case .stickersBold: return "\u{f993}"
        case .stickersLight: return "\u{f994}"
        case .stickersRegular: return "\u{f995}"
        case .stickiesBold: return "\u{f996}"
        case .stickiesLight: return "\u{f997}"
        case .stickiesRegular: return "\u{f998}"
        case .stopBold: return "\u{f999}"
        case .stopCircleBold: return "\u{f99a}"
        case .stopCircleFilled: return "\u{f99b}"
        case .stopCircleLight: return "\u{f99c}"
        case .stopCircleRegular: return "\u{f99d}"
        case .stopContentShareBold: return "\u{f99e}"
        case .stopContentShareLight: return "\u{f99f}"
        case .stopContentShareRegular: return "\u{f9a0}"
        case .stopFilled: return "\u{f9a1}"
        case .stopLight: return "\u{f9a2}"
        case .stopRegular: return "\u{f9a3}"
        case .storedInfoBold: return "\u{f9a4}"
        case .storedInfoFilled: return "\u{f9a5}"
        case .storedInfoLight: return "\u{f9a6}"
        case .storedInfoRegular: return "\u{f9a7}"
        case .streamingBold: return "\u{f9a8}"
        case .streamingLight: return "\u{f9a9}"
        case .streamingRegular: return "\u{f9aa}"
        case .strikethroughBold: return "\u{f9ab}"
        case .strikethroughLight: return "\u{f9ac}"
        case .strikethroughRegular: return "\u{f9ad}"
        case .subscriptBold: return "\u{f9ae}"
        case .subscriptLight: return "\u{f9af}"
        case .subscriptRegular: return "\u{f9b0}"
        case .superscriptBold: return "\u{f9b1}"
        case .superscriptLight: return "\u{f9b2}"
        case .superscriptRegular: return "\u{f9b3}"
        case .surveyBold: return "\u{f9b4}"
        case .surveyFilled: return "\u{f9b5}"
        case .surveyLight: return "\u{f9b6}"
        case .surveyRegular: return "\u{f9b7}"
        case .sx10Bold: return "\u{f9b8}"
        case .sx10Light: return "\u{f9b9}"
        case .sx10Regular: return "\u{f9ba}"
        case .sx20Bold: return "\u{f9bb}"
        case .sx20Light: return "\u{f9bc}"
        case .sx20Regular: return "\u{f9bd}"
        case .sx80CodecBold: return "\u{f9be}"
        case .sx80CodecLight: return "\u{f9bf}"
        case .sx80CodecRegular: return "\u{f9c0}"
        case .tableBold: return "\u{f9c1}"
        case .tableLight: return "\u{f9c2}"
        case .tableRegular: return "\u{f9c3}"
        case .tabletBold: return "\u{f9c4}"
        case .tabletLight: return "\u{f9c5}"
        case .tabletRegular: return "\u{f9c6}"
        case .tabsBold: return "\u{f9c7}"
        case .tabsLight: return "\u{f9c8}"
        case .tabsRegular: return "\u{f9c9}"
        case .tagBold: return "\u{f9ca}"
        case .tagLight: return "\u{f9cb}"
        case .tagRegular: return "\u{f9cc}"
        case .tapBold: return "\u{f9cd}"
        case .tapFilled: return "\u{f9ce}"
        case .tapLight: return "\u{f9cf}"
        case .tapRegular: return "\u{f9d0}"
        case .telepresenceAlertBold: return "\u{f9d1}"
        case .telepresenceAlertLight: return "\u{f9d2}"
        case .telepresenceAlertMutedBold: return "\u{f9d3}"
        case .telepresenceAlertMutedLight: return "\u{f9d4}"
        case .telepresenceAlertMutedRegular: return "\u{f9d5}"
        case .telepresenceAlertRegular: return "\u{f9d6}"
        case .telepresenceBold: return "\u{f9d7}"
        case .telepresenceIx5000Bold: return "\u{f9d8}"
        case .telepresenceIx5000Light: return "\u{f9d9}"
        case .telepresenceIx5000Regular: return "\u{f9da}"
        case .telepresenceLight: return "\u{f9db}"
        case .telepresencePrivateBold: return "\u{f9dc}"
        case .telepresencePrivateLight: return "\u{f9dd}"
        case .telepresencePrivateRegular: return "\u{f9de}"
        case .telepresenceRegular: return "\u{f9df}"
        case .temperatureBold: return "\u{f9e0}"
        case .temperatureLight: return "\u{f9e1}"
        case .temperatureRegular: return "\u{f9e2}"
        case .textAlignCenterBold: return "\u{f9e3}"
        case .textAlignCenterFilled: return "\u{f9e4}"
        case .textAlignCenterLight: return "\u{f9e5}"
        case .textAlignCenterRegular: return "\u{f9e6}"
        case .textAlignLeftBold: return "\u{f9e7}"
        case .textAlignLeftFilled: return "\u{f9e8}"
        case .textAlignLeftLight: return "\u{f9e9}"
        case .textAlignLeftRegular: return "\u{f9ea}"
        case .textAlignRightBold: return "\u{f9eb}"
        case .textAlignRightFilled: return "\u{f9ec}"
        case .textAlignRightLight: return "\u{f9ed}"
        case .textAlignRightRegular: return "\u{f9ee}"
        case .textBold: return "\u{f9ef}"
        case .textCodeBlockBold: return "\u{f9f0}"
        case .textCodeBlockLight: return "\u{f9f1}"
        case .textCodeBlockRegular: return "\u{f9f2}"
        case .textHighlightBold: return "\u{f9f3}"
        case .textHighlightLight: return "\u{f9f4}"
        case .textHighlightRegular: return "\u{f9f5}"
        case .textLight: return "\u{f9f6}"
        case .textRegular: return "\u{f9f7}"
        case .threeColumnBold: return "\u{f9f8}"
        case .threeColumnLight: return "\u{f9f9}"
        case .threeColumnRegular: return "\u{f9fa}"
        case .threeDObjectBold: return "\u{f9fb}"
        case .threeDObjectLight: return "\u{f9fc}"
        case .threeDObjectRegular: return "\u{f9fd}"
        case .tooFastBold: return "\u{f9fe}"
        case .tooFastLight: return "\u{f9ff}"
        case .tooFastRegular: return "\u{fa00}"
        case .tooSlowBold: return "\u{fa01}"
        case .tooSlowLight: return "\u{fa02}"
        case .tooSlowRegular: return "\u{fa03}"
        case .toolsBold: return "\u{fa04}"
        case .toolsLight: return "\u{fa05}"
        case .toolsRegular: return "\u{fa06}"
        case .touch10Bold: return "\u{fa07}"
        case .touch10Light: return "\u{fa08}"
        case .touch10Regular: return "\u{fa09}"
        case .transcriptBold: return "\u{fa0a}"
        case .transcriptFilled: return "\u{fa0b}"
        case .transcriptLight: return "\u{fa0c}"
        case .transcriptRegular: return "\u{fa0d}"
        case .translateBold: return "\u{fa0e}"
        case .translateLight: return "\u{fa0f}"
        case .translateRegular: return "\u{fa10}"
        case .trimBold: return "\u{fa11}"
        case .trimLight: return "\u{fa12}"
        case .trimRegular: return "\u{fa13}"
        case .twoColumnBold: return "\u{fa14}"
        case .twoColumnLight: return "\u{fa15}"
        case .twoColumnRegular: return "\u{fa16}"
        case .ucmCloudBold: return "\u{fa17}"
        case .ucmCloudLight: return "\u{fa18}"
        case .ucmCloudRegular: return "\u{fa19}"
        case .underlineBold: return "\u{fa1a}"
        case .underlineLight: return "\u{fa1b}"
        case .underlineRegular: return "\u{fa1c}"
        case .undoBold: return "\u{fa1d}"
        case .undoLight: return "\u{fa1e}"
        case .undoRegular: return "\u{fa1f}"
        case .unlinkBold: return "\u{fa20}"
        case .unlinkLight: return "\u{fa21}"
        case .unlinkRegular: return "\u{fa22}"
        case .unreadBold: return "\u{fa23}"
        case .unreadFilled: return "\u{fa24}"
        case .unreadLight: return "\u{fa25}"
        case .unreadRegular: return "\u{fa26}"
        case .unsecureUnlockedBold: return "\u{fa27}"
        case .unsecureUnlockedFilled: return "\u{fa28}"
        case .unsecureUnlockedLight: return "\u{fa29}"
        case .unsecureUnlockedRegular: return "\u{fa2a}"
        case .unsortedBold: return "\u{fa2b}"
        case .unsortedLight: return "\u{fa2c}"
        case .unsortedRegular: return "\u{fa2d}"
        case .updateFileShareBold: return "\u{fa2e}"
        case .updateFileShareLight: return "\u{fa2f}"
        case .updateFileShareRegular: return "\u{fa30}"
        case .upgradeBold: return "\u{fa31}"
        case .upgradeFilled: return "\u{fa32}"
        case .upgradeLight: return "\u{fa33}"
        case .upgradeRegular: return "\u{fa34}"
        case .uploadBold: return "\u{fa35}"
        case .uploadLight: return "\u{fa36}"
        case .uploadRegular: return "\u{fa37}"
        case .urgentVoicemailBold: return "\u{fa38}"
        case .urgentVoicemailFilled: return "\u{fa39}"
        case .usbBold: return "\u{fa3a}"
        case .usbHeadsetBold: return "\u{fa3b}"
        case .usbHeadsetLight: return "\u{fa3c}"
        case .usbHeadsetMutedBold: return "\u{fa3d}"
        case .usbHeadsetMutedLight: return "\u{fa3e}"
        case .usbHeadsetMutedRegular: return "\u{fa3f}"
        case .usbHeadsetRegular: return "\u{fa40}"
        case .usbLight: return "\u{fa41}"
        case .usbRegular: return "\u{fa42}"
        case .userBold: return "\u{fa43}"
        case .userDeactivateBold: return "\u{fa44}"
        case .userDeactivateLight: return "\u{fa45}"
        case .userDeactivateRegular: return "\u{fa46}"
        case .userLight: return "\u{fa47}"
        case .userRegular: return "\u{fa48}"
        case .vcsBold: return "\u{fa49}"
        case .vcsLight: return "\u{fa4a}"
        case .vcsRegular: return "\u{fa4b}"
        case .videoBlurBold: return "\u{fa4c}"
        case .videoBlurFilled: return "\u{fa4d}"
        case .videoBlurLight: return "\u{fa4e}"
        case .videoBlurRegular: return "\u{fa4f}"
        case .videoBold: return "\u{fa50}"
        case .videoEffectBold: return "\u{fa51}"
        case .videoEffectFilled: return "\u{fa52}"
        case .videoEffectLight: return "\u{fa53}"
        case .videoEffectRegular: return "\u{fa54}"
        case .videoFilled: return "\u{fa55}"
        case .videoLayoutBold: return "\u{fa56}"
        case .videoLayoutEqualBold: return "\u{fa57}"
        case .videoLayoutEqualDualBold: return "\u{fa58}"
        case .videoLayoutEqualDualLight: return "\u{fa59}"
        case .videoLayoutEqualDualRegular: return "\u{fa5a}"
        case .videoLayoutEqualFilled: return "\u{fa5b}"
        case .videoLayoutEqualLight: return "\u{fa5c}"
        case .videoLayoutEqualRegular: return "\u{fa5d}"
        case .videoLayoutFilled: return "\u{fa5e}"
        case .videoLayoutLight: return "\u{fa5f}"
        case .videoLayoutOverlayBold: return "\u{fa60}"
        case .videoLayoutOverlayLight: return "\u{fa61}"
        case .videoLayoutOverlayRegular: return "\u{fa62}"
        case .videoLayoutPresenterDominantBold: return "\u{fa63}"
        case .videoLayoutPresenterDominantLight: return "\u{fa64}"
        case .videoLayoutPresenterDominantRegular: return "\u{fa65}"
        case .videoLayoutProminentBold: return "\u{fa66}"
        case .videoLayoutProminentFilled: return "\u{fa67}"
        case .videoLayoutProminentLight: return "\u{fa68}"
        case .videoLayoutProminentRegular: return "\u{fa69}"
        case .videoLayoutRegular: return "\u{fa6a}"
        case .videoLayoutShareDominantBold: return "\u{fa6b}"
        case .videoLayoutShareDominantLight: return "\u{fa6c}"
        case .videoLayoutShareDominantRegular: return "\u{fa6d}"
        case .videoLayoutSingleBold: return "\u{fa6e}"
        case .videoLayoutSingleFilled: return "\u{fa6f}"
        case .videoLayoutSingleLight: return "\u{fa70}"
        case .videoLayoutSingleRegular: return "\u{fa71}"
        case .videoLayoutStackBold: return "\u{fa72}"
        case .videoLayoutStackFilled: return "\u{fa73}"
        case .videoLayoutStackLight: return "\u{fa74}"
        case .videoLayoutStackRegular: return "\u{fa75}"
        case .videoLayoutVideoDominantBold: return "\u{fa76}"
        case .videoLayoutVideoDominantLight: return "\u{fa77}"
        case .videoLayoutVideoDominantRegular: return "\u{fa78}"
        case .videoLight: return "\u{fa79}"
        case .videoPlusBold: return "\u{fa7a}"
        case .videoPlusFilled: return "\u{fa7b}"
        case .videoPlusLight: return "\u{fa7c}"
        case .videoPlusRegular: return "\u{fa7d}"
        case .videoRegular: return "\u{fa7e}"
        case .videoSpeakerTrackBold: return "\u{fa7f}"
        case .videoSpeakerTrackFilled: return "\u{fa80}"
        case .videoSpeakerTrackLight: return "\u{fa81}"
        case .videoSpeakerTrackRegular: return "\u{fa82}"
        case .viewAllBold: return "\u{fa83}"
        case .viewAllLight: return "\u{fa84}"
        case .viewAllRegular: return "\u{fa85}"
        case .viewListBold: return "\u{fa86}"
        case .viewListLight: return "\u{fa87}"
        case .viewListRegular: return "\u{fa88}"
        case .viewStackedBold: return "\u{fa89}"
        case .viewStackedFilled: return "\u{fa8a}"
        case .viewStackedLight: return "\u{fa8b}"
        case .viewStackedRegular: return "\u{fa8c}"
        case .viewThumbnailBold: return "\u{fa8d}"
        case .viewThumbnailFilled: return "\u{fa8e}"
        case .viewThumbnailLight: return "\u{fa8f}"
        case .viewThumbnailRegular: return "\u{fa90}"
        case .voicemailBold: return "\u{fa91}"
        case .voicemailFilled: return "\u{fa92}"
        case .voicemailLight: return "\u{fa93}"
        case .voicemailRegular: return "\u{fa94}"
        case .waffleMenuBold: return "\u{fa95}"
        case .waffleMenuLight: return "\u{fa96}"
        case .waffleMenuRegular: return "\u{fa97}"
        case .waitingroomActiveBold: return "\u{fa98}"
        case .waitingroomActiveLight: return "\u{fa99}"
        case .waitingroomActiveRegular: return "\u{fa9a}"
        case .wallpaperBold: return "\u{fa9b}"
        case .wallpaperLight: return "\u{fa9c}"
        case .wallpaperRegular: return "\u{fa9d}"
        case .warningBadgeFilled: return "\u{fa9e}"
        case .warningBold: return "\u{fa9f}"
        case .warningFilled: return "\u{faa0}"
        case .warningLight: return "\u{faa1}"
        case .warningRegular: return "\u{faa2}"
        case .webexAssistantActiveColored: return "\u{faa3}"
        case .webexAssistantInactiveColored: return "\u{faa4}"
        case .webexBoardBold: return "\u{faa5}"
        case .webexBoardLight: return "\u{faa6}"
        case .webexBoardRegular: return "\u{faa7}"
        case .webexCodecPlusBold: return "\u{faa8}"
        case .webexCodecPlusLight: return "\u{faa9}"
        case .webexCodecPlusRegular: return "\u{faaa}"
        case .webexDeskCameraBold: return "\u{faab}"
        case .webexDeskCameraLight: return "\u{faac}"
        case .webexDeskCameraRegular: return "\u{faad}"
        case .webexHelixFilled: return "\u{faae}"
        case .webexMeetingsBold: return "\u{faaf}"
        case .webexMeetingsFilled: return "\u{fab0}"
        case .webexMeetingsLight: return "\u{fab1}"
        case .webexMeetingsRegular: return "\u{fab2}"
        case .webexQuadCameraBold: return "\u{fab3}"
        case .webexQuadCameraLight: return "\u{fab4}"
        case .webexQuadCameraRegular: return "\u{fab5}"
        case .webexRoomKitBold: return "\u{fab6}"
        case .webexRoomKitLight: return "\u{fab7}"
        case .webexRoomKitPlusBold: return "\u{fab8}"
        case .webexRoomKitPlusLight: return "\u{fab9}"
        case .webexRoomKitPlusRegular: return "\u{faba}"
        case .webexRoomKitRegular: return "\u{fabb}"
        case .webexShareBold: return "\u{fabc}"
        case .webexShareLight: return "\u{fabd}"
        case .webexShareRegular: return "\u{fabe}"
        case .webexTeamsBold: return "\u{fabf}"
        case .webexTeamsFilled: return "\u{fac0}"
        case .webexTeamsLight: return "\u{fac1}"
        case .webexTeamsNewBold: return "\u{fac2}"
        case .webexTeamsNewFilled: return "\u{fac3}"
        case .webexTeamsNewLight: return "\u{fac4}"
        case .webexTeamsNewRegular: return "\u{fac5}"
        case .webexTeamsRegular: return "\u{fac6}"
        case .webinarBold: return "\u{fac7}"
        case .webinarFilled: return "\u{fac8}"
        case .webinarLight: return "\u{fac9}"
        case .webinarRegular: return "\u{faca}"
        case .weeklyRecurringScheduleNodeBold: return "\u{facb}"
        case .weeklyRecurringScheduleNodeLight: return "\u{facc}"
        case .weeklyRecurringScheduleNodeRegular: return "\u{facd}"
        case .whiteboardBold: return "\u{face}"
        case .whiteboardContentBold: return "\u{facf}"
        case .whiteboardContentLight: return "\u{fad0}"
        case .whiteboardContentRegular: return "\u{fad1}"
        case .whiteboardFilled: return "\u{fad2}"
        case .whiteboardLight: return "\u{fad3}"
        case .whiteboardRegular: return "\u{fad4}"
        case .widgetBold: return "\u{fad5}"
        case .widgetFilled: return "\u{fad6}"
        case .widgetLight: return "\u{fad7}"
        case .widgetRegular: return "\u{fad8}"
        case .wifiBold: return "\u{fad9}"
        case .wifiErrorBold: return "\u{fada}"
        case .wifiErrorLight: return "\u{fadb}"
        case .wifiErrorRegular: return "\u{fadc}"
        case .wifiLight: return "\u{fadd}"
        case .wifiRegular: return "\u{fade}"
        case .wifiSignalGoodColoredBold: return "\u{fadf}"
        case .wifiSignalGoodColoredLight: return "\u{fae0}"
        case .wifiSignalGoodColoredRegular: return "\u{fae1}"
        case .wifiSignalPoorColoredBold: return "\u{fae2}"
        case .wifiSignalPoorColoredLight: return "\u{fae3}"
        case .wifiSignalPoorColoredRegular: return "\u{fae4}"
        case .wifiSignalUnstableColoredBold: return "\u{fae5}"
        case .wifiSignalUnstableColoredLight: return "\u{fae6}"
        case .wifiSignalUnstableColoredRegular: return "\u{fae7}"
        case .windowCornerScrubBold: return "\u{fae8}"
        case .windowCornerScrubLight: return "\u{fae9}"
        case .windowCornerScrubRegular: return "\u{faea}"
        case .windowRightCornerScrubBold: return "\u{faeb}"
        case .windowRightCornerScrubLight: return "\u{faec}"
        case .windowRightCornerScrubRegular: return "\u{faed}"
        case .windowVerticalScrubBold: return "\u{faee}"
        case .windowVerticalScrubLight: return "\u{faef}"
        case .windowVerticalScrubRegular: return "\u{faf0}"
        case .workflowDeploymentsBold: return "\u{faf1}"
        case .workflowDeploymentsLight: return "\u{faf2}"
        case .workflowDeploymentsRegular: return "\u{faf3}"
        case .workphoneBold: return "\u{faf4}"
        case .workphoneLight: return "\u{faf5}"
        case .workphoneRegular: return "\u{faf6}"
        case .zoomInBold: return "\u{faf7}"
        case .zoomInLight: return "\u{faf8}"
        case .zoomInRegular: return "\u{faf9}"
        case .zoomOutBold: return "\u{fafa}"
        case .zoomOutLight: return "\u{fafb}"
        case .zoomOutRegular: return "\u{fafc}"
        case .zoom: return "\u{fafd}"
