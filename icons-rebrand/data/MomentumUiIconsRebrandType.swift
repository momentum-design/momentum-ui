...
@objc public enum MomentumIconsRebrandType: Int {
    ...
    public var ligature: String {
        ...
        case .pipBold: return "\u{f7e7}"
        case .pipExitBold: return "\u{f7e8}"
        case .pipExitLight: return "\u{f7e9}"
        case .pipExitRegular: return "\u{f7ea}"
        case .pipLight: return "\u{f7eb}"
        case .pipRegular: return "\u{f7ec}"
        case .placeholderBold: return "\u{f7ed}"
        case .placeholderLight: return "\u{f7ee}"
        case .placeholderRegular: return "\u{f7ef}"
        case .playBold: return "\u{f7f0}"
        case .playCircleBold: return "\u{f7f1}"
        case .playCircleFilled: return "\u{f7f2}"
        case .playCircleLight: return "\u{f7f3}"
        case .playCircleRegular: return "\u{f7f4}"
        case .playFilled: return "\u{f7f5}"
        case .playLight: return "\u{f7f6}"
        case .playRegular: return "\u{f7f7}"
        case .plugAcBold: return "\u{f7f8}"
        case .plugAcLight: return "\u{f7f9}"
        case .plugAcRegular: return "\u{f7fa}"
        case .plusBold: return "\u{f7fb}"
        case .plusCircleBold: return "\u{f7fc}"
        case .plusCircleFilled: return "\u{f7fd}"
        case .plusCircleLight: return "\u{f7fe}"
        case .plusCircleRegular: return "\u{f7ff}"
        case .plusLight: return "\u{f800}"
        case .plusRegular: return "\u{f801}"
        case .pmrBold: return "\u{f802}"
        case .pmrFilled: return "\u{f803}"
        case .pmrLight: return "\u{f804}"
        case .pmrRegular: return "\u{f805}"
        case .pollBold: return "\u{f806}"
        case .pollLight: return "\u{f807}"
        case .pollRegular: return "\u{f808}"
        case .popInBold: return "\u{f809}"
        case .popInLight: return "\u{f80a}"
        case .popInRegular: return "\u{f80b}"
        case .popOutBold: return "\u{f80c}"
        case .popOutLight: return "\u{f80d}"
        case .popOutRegular: return "\u{f80e}"
        case .popUpBold: return "\u{f80f}"
        case .popUpLight: return "\u{f810}"
        case .popUpRegular: return "\u{f811}"
        case .portraitLandscapeBold: return "\u{f812}"
        case .portraitLandscapeLight: return "\u{f813}"
        case .portraitLandscapeRegular: return "\u{f814}"
        case .powerAcBold: return "\u{f815}"
        case .powerAcLight: return "\u{f816}"
        case .powerAcRegular: return "\u{f817}"
        case .powerBold: return "\u{f818}"
        case .powerLight: return "\u{f819}"
        case .powerRegular: return "\u{f81a}"
        case .preHeaderBold: return "\u{f81b}"
        case .preHeaderLight: return "\u{f81c}"
        case .preHeaderRegular: return "\u{f81d}"
        case .presentationBold: return "\u{f81e}"
        case .presentationLight: return "\u{f81f}"
        case .presentationRegular: return "\u{f820}"
        case .primaryParticipantBold: return "\u{f821}"
        case .primaryParticipantLight: return "\u{f822}"
        case .primaryParticipantRegular: return "\u{f823}"
        case .printBold: return "\u{f824}"
        case .printLight: return "\u{f825}"
        case .printRegular: return "\u{f826}"
        case .priorityBadgeFilled: return "\u{f827}"
        case .priorityCircleBold: return "\u{f828}"
        case .priorityCircleFilled: return "\u{f829}"
        case .priorityCircleLight: return "\u{f82a}"
        case .priorityCircleRegular: return "\u{f82b}"
        case .priorityCircleTwoBold: return "\u{f82c}"
        case .priorityCircleTwoFilled: return "\u{f82d}"
        case .priorityCircleTwoLight: return "\u{f82e}"
        case .priorityCircleTwoRegular: return "\u{f82f}"
        case .privacyCircleBold: return "\u{f830}"
        case .privacyCircleFilled: return "\u{f831}"
        case .privacyCircleLight: return "\u{f832}"
        case .privacyCircleRegular: return "\u{f833}"
        case .privateBold: return "\u{f834}"
        case .privateCircleBold: return "\u{f835}"
        case .privateCircleFilled: return "\u{f836}"
        case .privateCircleLight: return "\u{f837}"
        case .privateCircleRegular: return "\u{f838}"
        case .privateLight: return "\u{f839}"
        case .privateMeetingBold: return "\u{f83a}"
        case .privateMeetingLight: return "\u{f83b}"
        case .privateMeetingRegular: return "\u{f83c}"
        case .privateRegular: return "\u{f83d}"
        case .productDemoBold: return "\u{f83e}"
        case .productDemoLight: return "\u{f83f}"
        case .productDemoRegular: return "\u{f840}"
        case .proximityBold: return "\u{f841}"
        case .proximityLight: return "\u{f842}"
        case .proximityMutedBold: return "\u{f843}"
        case .proximityMutedLight: return "\u{f844}"
        case .proximityMutedRegular: return "\u{f845}"
        case .proximityRegular: return "\u{f846}"
        case .proximityVideoBold: return "\u{f847}"
        case .proximityVideoLight: return "\u{f848}"
        case .proximityVideoRegular: return "\u{f849}"
        case .ptoPresenceBold: return "\u{f84a}"
        case .ptoPresenceFilled: return "\u{f84b}"
        case .ptoPresenceLight: return "\u{f84c}"
        case .ptoPresenceRegular: return "\u{f84d}"
        case .pullCallBold: return "\u{f84e}"
        case .pullCallLight: return "\u{f84f}"
        case .pullCallRegular: return "\u{f850}"
        case .qABold: return "\u{f851}"
        case .qALight: return "\u{f852}"
        case .qARegular: return "\u{f853}"
        case .qualityBold: return "\u{f854}"
        case .qualityLight: return "\u{f855}"
        case .qualityRegular: return "\u{f856}"
        case .queueContactBold: return "\u{f857}"
        case .queueContactLight: return "\u{f858}"
        case .queueContactRegular: return "\u{f859}"
        case .quietBold: return "\u{f85a}"
        case .quietHoursPresenceBold: return "\u{f85b}"
        case .quietHoursPresenceFilled: return "\u{f85c}"
        case .quietHoursPresenceLight: return "\u{f85d}"
        case .quietHoursPresenceRegular: return "\u{f85e}"
        case .quietLight: return "\u{f85f}"
        case .quietRegular: return "\u{f860}"
        case .radioButtonGroupBold: return "\u{f861}"
        case .radioButtonGroupLight: return "\u{f862}"
        case .radioButtonGroupRegular: return "\u{f863}"
        case .raiseHandBold: return "\u{f864}"
        case .raiseHandCircleFilled: return "\u{f865}"
        case .raiseHandFilled: return "\u{f866}"
        case .raiseHandLight: return "\u{f867}"
        case .raiseHandRegular: return "\u{f868}"
        case .ramBold: return "\u{f869}"
        case .ramLight: return "\u{f86a}"
        case .ramRegular: return "\u{f86b}"
        case .reactionsBold: return "\u{f86c}"
        case .reactionsFilled: return "\u{f86d}"
        case .reactionsLight: return "\u{f86e}"
        case .reactionsRegular: return "\u{f86f}"
        case .reactivateBold: return "\u{f870}"
        case .reactivateLight: return "\u{f871}"
        case .reactivateRegular: return "\u{f872}"
        case .recentsBold: return "\u{f873}"
        case .recentsFilled: return "\u{f874}"
        case .recentsLight: return "\u{f875}"
        case .recentsPresenceBold: return "\u{f876}"
        case .recentsPresenceFilled: return "\u{f877}"
        case .recentsPresenceLight: return "\u{f878}"
        case .recentsPresenceRegular: return "\u{f879}"
        case .recentsPresenceSmallFilled: return "\u{f87a}"
        case .recentsRegular: return "\u{f87b}"
        case .recordActiveBold: return "\u{f87c}"
        case .recordActiveFilled: return "\u{f87d}"
        case .recordActiveLight: return "\u{f87e}"
        case .recordActiveRegular: return "\u{f87f}"
        case .recordBold: return "\u{f880}"
        case .recordFilled: return "\u{f881}"
        case .recordLight: return "\u{f882}"
        case .recordPausedBold: return "\u{f883}"
        case .recordPausedFilled: return "\u{f884}"
        case .recordPausedLight: return "\u{f885}"
        case .recordPausedRegular: return "\u{f886}"
        case .recordRegular: return "\u{f887}"
        case .recurringBold: return "\u{f888}"
        case .recurringLight: return "\u{f889}"
        case .recurringOffBold: return "\u{f88a}"
        case .recurringOffLight: return "\u{f88b}"
        case .recurringOffRegular: return "\u{f88c}"
        case .recurringRegular: return "\u{f88d}"
        case .redialBold: return "\u{f88e}"
        case .redialLight: return "\u{f88f}"
        case .redialRegular: return "\u{f890}"
        case .redoBold: return "\u{f891}"
        case .redoLight: return "\u{f892}"
        case .redoRegular: return "\u{f893}"
        case .refreshBold: return "\u{f894}"
        case .refreshLight: return "\u{f895}"
        case .refreshRegular: return "\u{f896}"
        case .remoteCallBold: return "\u{f897}"
        case .remoteCallFilled: return "\u{f898}"
        case .remoteCallLight: return "\u{f899}"
        case .remoteCallRegular: return "\u{f89a}"
        case .remoteDesktopControlBold: return "\u{f89b}"
        case .remoteDesktopControlFilled: return "\u{f89c}"
        case .remoteDesktopControlLight: return "\u{f89d}"
        case .remoteDesktopControlRegular: return "\u{f89e}"
        case .removeBold: return "\u{f89f}"
        case .removeFilled: return "\u{f8a0}"
        case .removeLight: return "\u{f8a1}"
        case .removeRegular: return "\u{f8a2}"
        case .replyBold: return "\u{f8a3}"
        case .replyFilled: return "\u{f8a4}"
        case .replyLight: return "\u{f8a5}"
        case .replyListBold: return "\u{f8a6}"
        case .replyListLight: return "\u{f8a7}"
        case .replyListRegular: return "\u{f8a8}"
        case .replyPrivatelyBold: return "\u{f8a9}"
        case .replyPrivatelyLight: return "\u{f8aa}"
        case .replyPrivatelyRegular: return "\u{f8ab}"
        case .replyRegular: return "\u{f8ac}"
        case .resetBold: return "\u{f8ad}"
        case .resetLight: return "\u{f8ae}"
        case .resetRegular: return "\u{f8af}"
        case .responsiveMobileBold: return "\u{f8b0}"
        case .responsiveMobileLight: return "\u{f8b1}"
        case .responsiveMobileRegular: return "\u{f8b2}"
        case .restartBold: return "\u{f8b3}"
        case .restartLight: return "\u{f8b4}"
        case .restartRegular: return "\u{f8b5}"
        case .retrieveCallBold: return "\u{f8b6}"
        case .retrieveCallLight: return "\u{f8b7}"
        case .retrieveCallRegular: return "\u{f8b8}"
        case .returnBold: return "\u{f8b9}"
        case .returnLight: return "\u{f8ba}"
        case .returnRegular: return "\u{f8bb}"
        case .ringtoneBold: return "\u{f8bc}"
        case .ringtoneLight: return "\u{f8bd}"
        case .ringtoneRegular: return "\u{f8be}"
        case .roomCalendarBold: return "\u{f8bf}"
        case .roomCalendarLight: return "\u{f8c0}"
        case .roomCalendarRegular: return "\u{f8c1}"
        case .roomLightsBold: return "\u{f8c2}"
        case .roomLightsFilled: return "\u{f8c3}"
        case .roomLightsLight: return "\u{f8c4}"
        case .roomLightsRegular: return "\u{f8c5}"
        case .rotateContentBold: return "\u{f8c6}"
        case .rotateContentFilled: return "\u{f8c7}"
        case .rotateContentLight: return "\u{f8c8}"
        case .rotateContentRegular: return "\u{f8c9}"
        case .ruleBasedBold: return "\u{f8ca}"
        case .ruleBasedLight: return "\u{f8cb}"
        case .ruleBasedRegular: return "\u{f8cc}"
        case .runningApplicationBold: return "\u{f8cd}"
        case .runningApplicationFilled: return "\u{f8ce}"
        case .runningApplicationLight: return "\u{f8cf}"
        case .runningApplicationRegular: return "\u{f8d0}"
        case .saveBold: return "\u{f8d1}"
        case .saveLight: return "\u{f8d2}"
        case .saveRegular: return "\u{f8d3}"
        case .saveTranscriptBold: return "\u{f8d4}"
        case .saveTranscriptFilled: return "\u{f8d5}"
        case .saveTranscriptLight: return "\u{f8d6}"
        case .saveTranscriptRegular: return "\u{f8d7}"
        case .scanBold: return "\u{f8d8}"
        case .scanLight: return "\u{f8d9}"
        case .scanRegular: return "\u{f8da}"
        case .scheduleSendBold: return "\u{f8db}"
        case .scheduleSendFilled: return "\u{f8dc}"
        case .scheduleSendLight: return "\u{f8dd}"
        case .scheduleSendRegular: return "\u{f8de}"
        case .schedulerAvailableBold: return "\u{f8df}"
        case .schedulerAvailableLight: return "\u{f8e0}"
        case .schedulerAvailableRegular: return "\u{f8e1}"
        case .schedulerNotWorkingHoursBold: return "\u{f8e2}"
        case .schedulerNotWorkingHoursLight: return "\u{f8e3}"
        case .schedulerNotWorkingHoursRegular: return "\u{f8e4}"
        case .schedulerUnavailableBold: return "\u{f8e5}"
        case .schedulerUnavailableLight: return "\u{f8e6}"
        case .schedulerUnavailableRegular: return "\u{f8e7}"
        case .schedulerUnknownBold: return "\u{f8e8}"
        case .schedulerUnknownLight: return "\u{f8e9}"
        case .schedulerUnknownRegular: return "\u{f8ea}"
        case .screenshotBold: return "\u{f8eb}"
        case .screenshotDocBold: return "\u{f8ec}"
        case .screenshotDocFilled: return "\u{f8ed}"
        case .screenshotDocLight: return "\u{f8ee}"
        case .screenshotDocRegular: return "\u{f8ef}"
        case .screenshotLight: return "\u{f8f0}"
        case .screenshotRegular: return "\u{f8f1}"
        case .searchBold: return "\u{f8f2}"
        case .searchFilled: return "\u{f8f3}"
        case .searchLight: return "\u{f8f4}"
        case .searchRegular: return "\u{f8f5}"
        case .secondaryArrowBold: return "\u{f8f6}"
        case .secondaryArrowLight: return "\u{f8f7}"
        case .secondaryArrowRegular: return "\u{f8f8}"
        case .secureCallLockBold: return "\u{f8f9}"
        case .secureCallLockFilled: return "\u{f8fa}"
        case .secureCallLockLight: return "\u{f8fb}"
        case .secureCallLockRegular: return "\u{f8fc}"
        case .secureCallShieldBold: return "\u{f8fd}"
        case .secureCallShieldFilled: return "\u{f8fe}"
        case .secureCallShieldLight: return "\u{f8ff}"
        case .secureCallShieldRegular: return "\u{f900}"
        case .secureCircleBold: return "\u{f901}"
        case .secureCircleFilled: return "\u{f902}"
        case .secureCircleLight: return "\u{f903}"
        case .secureCircleRegular: return "\u{f904}"
        case .secureLockBold: return "\u{f905}"
        case .secureLockFilled: return "\u{f906}"
        case .secureLockLight: return "\u{f907}"
        case .secureLockRegular: return "\u{f908}"
        case .segmentExcludeFilled: return "\u{f909}"
        case .segmentFilterFilled: return "\u{f90a}"
        case .segmentIncludeFilled: return "\u{f90b}"
        case .selectAllBold: return "\u{f90c}"
        case .selectAllFilled: return "\u{f90d}"
        case .selectAllLight: return "\u{f90e}"
        case .selectAllRegular: return "\u{f90f}"
        case .selectionBold: return "\u{f910}"
        case .selectionLight: return "\u{f911}"
        case .selectionRegular: return "\u{f912}"
        case .sendBold: return "\u{f913}"
        case .sendFilled: return "\u{f914}"
        case .sendLight: return "\u{f915}"
        case .sendRegular: return "\u{f916}"
        case .serverBold: return "\u{f917}"
        case .serverErrorBold: return "\u{f918}"
        case .serverErrorLight: return "\u{f919}"
        case .serverErrorRegular: return "\u{f91a}"
        case .serverLight: return "\u{f91b}"
        case .serverRegular: return "\u{f91c}"
        case .servicesBold: return "\u{f91d}"
        case .servicesLight: return "\u{f91e}"
        case .servicesRegular: return "\u{f91f}"
        case .setVariableBold: return "\u{f920}"
        case .setVariableLight: return "\u{f921}"
        case .setVariableRegular: return "\u{f922}"
        case .settingsBold: return "\u{f923}"
        case .settingsFilled: return "\u{f924}"
        case .settingsLight: return "\u{f925}"
        case .settingsRegular: return "\u{f926}"
        case .setupAssistantBold: return "\u{f927}"
        case .setupAssistantLight: return "\u{f928}"
        case .setupAssistantRegular: return "\u{f929}"
        case .sftpBold: return "\u{f92a}"
        case .sftpLight: return "\u{f92b}"
        case .sftpRegular: return "\u{f92c}"
        case .shapeCircleBold: return "\u{f92d}"
        case .shapeCircleFilled: return "\u{f92e}"
        case .shapeCircleLight: return "\u{f92f}"
        case .shapeCircleRegular: return "\u{f930}"
        case .shapeDiagonalLineBold: return "\u{f931}"
        case .shapeDiagonalLineLight: return "\u{f932}"
        case .shapeDiagonalLineRegular: return "\u{f933}"
        case .shapeDiamondBold: return "\u{f934}"
        case .shapeDiamondFilled: return "\u{f935}"
        case .shapeDiamondLight: return "\u{f936}"
        case .shapeDiamondRegular: return "\u{f937}"
        case .shapeOvalBold: return "\u{f938}"
        case .shapeOvalLight: return "\u{f939}"
        case .shapeOvalRegular: return "\u{f93a}"
        case .shapeSquareBold: return "\u{f93b}"
        case .shapeSquareFilled: return "\u{f93c}"
        case .shapeSquareLight: return "\u{f93d}"
        case .shapeSquareRegular: return "\u{f93e}"
        case .shapeTriangleBold: return "\u{f93f}"
        case .shapeTriangleFilled: return "\u{f940}"
        case .shapeTriangleLight: return "\u{f941}"
        case .shapeTriangleRegular: return "\u{f942}"
        case .shapesBold: return "\u{f943}"
        case .shapesLight: return "\u{f944}"
        case .shapesRegular: return "\u{f945}"
        case .shareCNativeAdrBold: return "\u{f946}"
        case .shareCNativeAdrFilled: return "\u{f947}"
        case .shareCNativeAdrLight: return "\u{f948}"
        case .shareCNativeAdrRegular: return "\u{f949}"
        case .shareCNativeIphBold: return "\u{f94a}"
        case .shareCNativeIphLight: return "\u{f94b}"
        case .shareCNativeIphRegular: return "\u{f94c}"
        case .shareScreenBold: return "\u{f94d}"
        case .shareScreenFilled: return "\u{f94e}"
        case .shareScreenLight: return "\u{f94f}"
        case .shareScreenRegular: return "\u{f950}"
        case .shareScreenSmallFilled: return "\u{f951}"
        case .shareSpaceBold: return "\u{f952}"
        case .shareSpaceLight: return "\u{f953}"
        case .shareSpaceRegular: return "\u{f954}"
        case .shieldBold: return "\u{f955}"
        case .shieldLight: return "\u{f956}"
        case .shieldRegular: return "\u{f957}"
        case .shoppingCartBold: return "\u{f958}"
        case .shoppingCartFilled: return "\u{f959}"
        case .shoppingCartLight: return "\u{f95a}"
        case .shoppingCartRegular: return "\u{f95b}"
        case .shortTextBoxBold: return "\u{f95c}"
        case .shortTextBoxLight: return "\u{f95d}"
        case .shortTextBoxRegular: return "\u{f95e}"
        case .showBold: return "\u{f95f}"
        case .showFilled: return "\u{f960}"
        case .showLight: return "\u{f961}"
        case .showRegular: return "\u{f962}"
        case .signInBold: return "\u{f963}"
        case .signInFilled: return "\u{f964}"
        case .signInForcedBold: return "\u{f965}"
        case .signInForcedLight: return "\u{f966}"
        case .signInForcedRegular: return "\u{f967}"
        case .signInLight: return "\u{f968}"
        case .signInRegular: return "\u{f969}"
        case .signLangIntBold: return "\u{f96a}"
        case .signLangIntLight: return "\u{f96b}"
        case .signLangIntRegular: return "\u{f96c}"
        case .signOutBold: return "\u{f96d}"
        case .signOutLight: return "\u{f96e}"
        case .signOutRegular: return "\u{f96f}"
        case .signal0Bold: return "\u{f970}"
        case .signal0Light: return "\u{f971}"
        case .signal0Regular: return "\u{f972}"
        case .signal100Bold: return "\u{f973}"
        case .signal100Light: return "\u{f974}"
        case .signal100Regular: return "\u{f975}"
        case .signal25Bold: return "\u{f976}"
        case .signal25Light: return "\u{f977}"
        case .signal25Regular: return "\u{f978}"
        case .signal50Bold: return "\u{f979}"
        case .signal50Light: return "\u{f97a}"
        case .signal50Regular: return "\u{f97b}"
        case .signal75Bold: return "\u{f97c}"
        case .signal75Light: return "\u{f97d}"
        case .signal75Regular: return "\u{f97e}"
        case .simplePromotionBold: return "\u{f97f}"
        case .simplePromotionLight: return "\u{f980}"
        case .simplePromotionRegular: return "\u{f981}"
        case .singleNumberReachBold: return "\u{f982}"
        case .singleNumberReachLight: return "\u{f983}"
        case .singleNumberReachRegular: return "\u{f984}"
        case .sipRegistrationInProgressBold: return "\u{f985}"
        case .sipRegistrationInProgressFilled: return "\u{f986}"
        case .sipRegistrationInProgressLight: return "\u{f987}"
        case .sipRegistrationInProgressRegular: return "\u{f988}"
        case .skipBold: return "\u{f989}"
        case .skipBwBold: return "\u{f98a}"
        case .skipBwFilled: return "\u{f98b}"
        case .skipBwLight: return "\u{f98c}"
        case .skipBwRegular: return "\u{f98d}"
        case .skipFwBold: return "\u{f98e}"
        case .skipFwFilled: return "\u{f98f}"
        case .skipFwLight: return "\u{f990}"
        case .skipFwRegular: return "\u{f991}"
        case .skipLight: return "\u{f992}"
        case .skipRegular: return "\u{f993}"
        case .slidoLogo: return "\u{f994}"
        case .smsInboundBold: return "\u{f995}"
        case .smsInboundLight: return "\u{f996}"
        case .smsInboundRegular: return "\u{f997}"
        case .smsMessageBold: return "\u{f998}"
        case .smsMessageFilled: return "\u{f999}"
        case .smsMessageLight: return "\u{f99a}"
        case .smsMessageRegular: return "\u{f99b}"
        case .socialAlexaFilled: return "\u{f99c}"
        case .socialFacebookColoredFilled: return "\u{f99d}"
        case .socialFacebookFilled: return "\u{f99e}"
        case .socialFbmessengerColoredFilled: return "\u{f99f}"
        case .socialFbmessengerFilled: return "\u{f9a0}"
        case .socialInstagramBold: return "\u{f9a1}"
        case .socialMicrosoftColoredFilled: return "\u{f9a2}"
        case .socialMicrosoftFilled: return "\u{f9a3}"
        case .socialMmsFilled: return "\u{f9a4}"
        case .socialMmsGoldFilled: return "\u{f9a5}"
        case .socialSmsFilled: return "\u{f9a6}"
        case .socialSmsMintFilled: return "\u{f9a7}"
        case .socialTwitterColoredFilled: return "\u{f9a8}"
        case .socialTwitterFilled: return "\u{f9a9}"
        case .socialViberBold: return "\u{f9aa}"
        case .socialViberColoredBold: return "\u{f9ab}"
        case .socialWhatsappBold: return "\u{f9ac}"
        case .socialWhatsappColoredFilled: return "\u{f9ad}"
        case .sortAscendingBold: return "\u{f9ae}"
        case .sortAscendingLight: return "\u{f9af}"
        case .sortAscendingRegular: return "\u{f9b0}"
        case .sortDescendingBold: return "\u{f9b1}"
        case .sortDescendingLight: return "\u{f9b2}"
        case .sortDescendingRegular: return "\u{f9b3}"
        case .soundDefaultBold: return "\u{f9b4}"
        case .soundDefaultLight: return "\u{f9b5}"
        case .soundDefaultRegular: return "\u{f9b6}"
        case .speakerBold: return "\u{f9b7}"
        case .speakerDisconnectedBold: return "\u{f9b8}"
        case .speakerDisconnectedFilled: return "\u{f9b9}"
        case .speakerDisconnectedLight: return "\u{f9ba}"
        case .speakerDisconnectedRegular: return "\u{f9bb}"
        case .speakerFilled: return "\u{f9bc}"
        case .speakerLight: return "\u{f9bd}"
        case .speakerMutedBold: return "\u{f9be}"
        case .speakerMutedFilled: return "\u{f9bf}"
        case .speakerMutedLight: return "\u{f9c0}"
        case .speakerMutedRegular: return "\u{f9c1}"
        case .speakerOffBold: return "\u{f9c2}"
        case .speakerOffFilled: return "\u{f9c3}"
        case .speakerOffLight: return "\u{f9c4}"
        case .speakerOffRegular: return "\u{f9c5}"
        case .speakerOnColoredBold: return "\u{f9c6}"
        case .speakerOnColoredLight: return "\u{f9c7}"
        case .speakerOnColoredRegular: return "\u{f9c8}"
        case .speakerRegular: return "\u{f9c9}"
        case .speakerTurnDownBold: return "\u{f9ca}"
        case .speakerTurnDownFilled: return "\u{f9cb}"
        case .speakerTurnDownLight: return "\u{f9cc}"
        case .speakerTurnDownRegular: return "\u{f9cd}"
        case .speakerTurnUpBold: return "\u{f9ce}"
        case .speakerTurnUpFilled: return "\u{f9cf}"
        case .speakerTurnUpLight: return "\u{f9d0}"
        case .speakerTurnUpRegular: return "\u{f9d1}"
        case .spellCheckerBold: return "\u{f9d2}"
        case .spellCheckerLight: return "\u{f9d3}"
        case .spellCheckerRegular: return "\u{f9d4}"
        case .spinnerBold: return "\u{f9d5}"
        case .spinnerFilledBold: return "\u{f9d6}"
        case .spinnerFilledLight: return "\u{f9d7}"
        case .spinnerFilledRegular: return "\u{f9d8}"
        case .spinnerLight: return "\u{f9d9}"
        case .spinnerPartialBold: return "\u{f9da}"
        case .spinnerPartialLight: return "\u{f9db}"
        case .spinnerPartialRegular: return "\u{f9dc}"
        case .spinnerRegular: return "\u{f9dd}"
        case .stackedArea100ChartBold: return "\u{f9de}"
        case .stackedArea100ChartFilled: return "\u{f9df}"
        case .stackedArea100ChartLight: return "\u{f9e0}"
        case .stackedArea100ChartRegular: return "\u{f9e1}"
        case .stackedAreaChartBold: return "\u{f9e2}"
        case .stackedAreaChartFilled: return "\u{f9e3}"
        case .stackedAreaChartLight: return "\u{f9e4}"
        case .stackedAreaChartRegular: return "\u{f9e5}"
        case .stackedBar100ChartBold: return "\u{f9e6}"
        case .stackedBar100ChartFilled: return "\u{f9e7}"
        case .stackedBar100ChartLight: return "\u{f9e8}"
        case .stackedBar100ChartRegular: return "\u{f9e9}"
        case .stackedBarChartBold: return "\u{f9ea}"
        case .stackedBarChartFilled: return "\u{f9eb}"
        case .stackedBarChartLight: return "\u{f9ec}"
        case .stackedBarChartRegular: return "\u{f9ed}"
        case .startChatBold: return "\u{f9ee}"
        case .startChatLight: return "\u{f9ef}"
        case .startChatRegular: return "\u{f9f0}"
        case .stethoscopeBold: return "\u{f9f1}"
        case .stethoscopeLight: return "\u{f9f2}"
        case .stethoscopeRegular: return "\u{f9f3}"
        case .stickersBold: return "\u{f9f4}"
        case .stickersLight: return "\u{f9f5}"
        case .stickersRegular: return "\u{f9f6}"
        case .stickiesBold: return "\u{f9f7}"
        case .stickiesLight: return "\u{f9f8}"
        case .stickiesRegular: return "\u{f9f9}"
        case .stopBold: return "\u{f9fa}"
        case .stopCircleBold: return "\u{f9fb}"
        case .stopCircleFilled: return "\u{f9fc}"
        case .stopCircleLight: return "\u{f9fd}"
        case .stopCircleRegular: return "\u{f9fe}"
        case .stopContentShareBold: return "\u{f9ff}"
        case .stopContentShareLight: return "\u{fa00}"
        case .stopContentShareRegular: return "\u{fa01}"
        case .stopFilled: return "\u{fa02}"
        case .stopLight: return "\u{fa03}"
        case .stopRegular: return "\u{fa04}"
        case .storedInfoBold: return "\u{fa05}"
        case .storedInfoFilled: return "\u{fa06}"
        case .storedInfoLight: return "\u{fa07}"
        case .storedInfoRegular: return "\u{fa08}"
        case .streamingBold: return "\u{fa09}"
        case .streamingLight: return "\u{fa0a}"
        case .streamingRegular: return "\u{fa0b}"
        case .strikethroughBold: return "\u{fa0c}"
        case .strikethroughLight: return "\u{fa0d}"
        case .strikethroughRegular: return "\u{fa0e}"
        case .studioModeBold: return "\u{fa0f}"
        case .studioModeLight: return "\u{fa10}"
        case .studioModeRegular: return "\u{fa11}"
        case .subscriptBold: return "\u{fa12}"
        case .subscriptLight: return "\u{fa13}"
        case .subscriptRegular: return "\u{fa14}"
        case .superscriptBold: return "\u{fa15}"
        case .superscriptLight: return "\u{fa16}"
        case .superscriptRegular: return "\u{fa17}"
        case .surveyBold: return "\u{fa18}"
        case .surveyFilled: return "\u{fa19}"
        case .surveyLight: return "\u{fa1a}"
        case .surveyRegular: return "\u{fa1b}"
        case .sx10Bold: return "\u{fa1c}"
        case .sx10Light: return "\u{fa1d}"
        case .sx10Regular: return "\u{fa1e}"
        case .sx20Bold: return "\u{fa1f}"
        case .sx20Light: return "\u{fa20}"
        case .sx20Regular: return "\u{fa21}"
        case .sx80CodecBold: return "\u{fa22}"
        case .sx80CodecLight: return "\u{fa23}"
        case .sx80CodecRegular: return "\u{fa24}"
        case .tableBold: return "\u{fa25}"
        case .tableLight: return "\u{fa26}"
        case .tableRegular: return "\u{fa27}"
        case .tabletBold: return "\u{fa28}"
        case .tabletLight: return "\u{fa29}"
        case .tabletRegular: return "\u{fa2a}"
        case .tabsBold: return "\u{fa2b}"
        case .tabsLight: return "\u{fa2c}"
        case .tabsRegular: return "\u{fa2d}"
        case .tagBold: return "\u{fa2e}"
        case .tagLight: return "\u{fa2f}"
        case .tagRegular: return "\u{fa30}"
        case .tapBold: return "\u{fa31}"
        case .tapFilled: return "\u{fa32}"
        case .tapLight: return "\u{fa33}"
        case .tapRegular: return "\u{fa34}"
        case .telepresenceAlertBold: return "\u{fa35}"
        case .telepresenceAlertLight: return "\u{fa36}"
        case .telepresenceAlertMutedBold: return "\u{fa37}"
        case .telepresenceAlertMutedLight: return "\u{fa38}"
        case .telepresenceAlertMutedRegular: return "\u{fa39}"
        case .telepresenceAlertRegular: return "\u{fa3a}"
        case .telepresenceBold: return "\u{fa3b}"
        case .telepresenceIx5000Bold: return "\u{fa3c}"
        case .telepresenceIx5000Light: return "\u{fa3d}"
        case .telepresenceIx5000Regular: return "\u{fa3e}"
        case .telepresenceLight: return "\u{fa3f}"
        case .telepresencePrivateBold: return "\u{fa40}"
        case .telepresencePrivateLight: return "\u{fa41}"
        case .telepresencePrivateRegular: return "\u{fa42}"
        case .telepresenceRegular: return "\u{fa43}"
        case .temperatureBold: return "\u{fa44}"
        case .temperatureLight: return "\u{fa45}"
        case .temperatureRegular: return "\u{fa46}"
        case .textAlignCenterBold: return "\u{fa47}"
        case .textAlignCenterFilled: return "\u{fa48}"
        case .textAlignCenterLight: return "\u{fa49}"
        case .textAlignCenterRegular: return "\u{fa4a}"
        case .textAlignLeftBold: return "\u{fa4b}"
        case .textAlignLeftFilled: return "\u{fa4c}"
        case .textAlignLeftLight: return "\u{fa4d}"
        case .textAlignLeftRegular: return "\u{fa4e}"
        case .textAlignRightBold: return "\u{fa4f}"
        case .textAlignRightFilled: return "\u{fa50}"
        case .textAlignRightLight: return "\u{fa51}"
        case .textAlignRightRegular: return "\u{fa52}"
        case .textBold: return "\u{fa53}"
        case .textCodeBlockBold: return "\u{fa54}"
        case .textCodeBlockLight: return "\u{fa55}"
        case .textCodeBlockRegular: return "\u{fa56}"
        case .textHighlightBold: return "\u{fa57}"
        case .textHighlightLight: return "\u{fa58}"
        case .textHighlightRegular: return "\u{fa59}"
        case .textLight: return "\u{fa5a}"
        case .textRegular: return "\u{fa5b}"
        case .threeColumnBold: return "\u{fa5c}"
        case .threeColumnLight: return "\u{fa5d}"
        case .threeColumnRegular: return "\u{fa5e}"
        case .threeDObjectBold: return "\u{fa5f}"
        case .threeDObjectLight: return "\u{fa60}"
        case .threeDObjectRegular: return "\u{fa61}"
        case .tooFastBold: return "\u{fa62}"
        case .tooFastLight: return "\u{fa63}"
        case .tooFastRegular: return "\u{fa64}"
        case .tooSlowBold: return "\u{fa65}"
        case .tooSlowLight: return "\u{fa66}"
        case .tooSlowRegular: return "\u{fa67}"
        case .toolsBold: return "\u{fa68}"
        case .toolsLight: return "\u{fa69}"
        case .toolsRegular: return "\u{fa6a}"
        case .touch10Bold: return "\u{fa6b}"
        case .touch10Light: return "\u{fa6c}"
        case .touch10Regular: return "\u{fa6d}"
        case .transcriptBold: return "\u{fa6e}"
        case .transcriptFilled: return "\u{fa6f}"
        case .transcriptLight: return "\u{fa70}"
        case .transcriptRegular: return "\u{fa71}"
        case .translateBold: return "\u{fa72}"
        case .translateLight: return "\u{fa73}"
        case .translateRegular: return "\u{fa74}"
        case .trimBold: return "\u{fa75}"
        case .trimLight: return "\u{fa76}"
        case .trimRegular: return "\u{fa77}"
        case .twoColumnBold: return "\u{fa78}"
        case .twoColumnLight: return "\u{fa79}"
        case .twoColumnRegular: return "\u{fa7a}"
        case .ucmCloudBold: return "\u{fa7b}"
        case .ucmCloudLight: return "\u{fa7c}"
        case .ucmCloudRegular: return "\u{fa7d}"
        case .underlineBold: return "\u{fa7e}"
        case .underlineLight: return "\u{fa7f}"
        case .underlineRegular: return "\u{fa80}"
        case .undoBold: return "\u{fa81}"
        case .undoLight: return "\u{fa82}"
        case .undoRegular: return "\u{fa83}"
        case .unlinkBold: return "\u{fa84}"
        case .unlinkLight: return "\u{fa85}"
        case .unlinkRegular: return "\u{fa86}"
        case .unreadBold: return "\u{fa87}"
        case .unreadFilled: return "\u{fa88}"
        case .unreadLight: return "\u{fa89}"
        case .unreadRegular: return "\u{fa8a}"
        case .unsecureUnlockedBold: return "\u{fa8b}"
        case .unsecureUnlockedFilled: return "\u{fa8c}"
        case .unsecureUnlockedLight: return "\u{fa8d}"
        case .unsecureUnlockedRegular: return "\u{fa8e}"
        case .unsortedBold: return "\u{fa8f}"
        case .unsortedLight: return "\u{fa90}"
        case .unsortedRegular: return "\u{fa91}"
        case .updateFileShareBold: return "\u{fa92}"
        case .updateFileShareLight: return "\u{fa93}"
        case .updateFileShareRegular: return "\u{fa94}"
        case .upgradeBold: return "\u{fa95}"
        case .upgradeFilled: return "\u{fa96}"
        case .upgradeLight: return "\u{fa97}"
        case .upgradeRegular: return "\u{fa98}"
        case .uploadBold: return "\u{fa99}"
        case .uploadImageBold: return "\u{fa9a}"
        case .uploadImageLight: return "\u{fa9b}"
        case .uploadImageRegular: return "\u{fa9c}"
        case .uploadLight: return "\u{fa9d}"
        case .uploadRegular: return "\u{fa9e}"
        case .urgentVoicemailBold: return "\u{fa9f}"
        case .urgentVoicemailFilled: return "\u{faa0}"
        case .usbBold: return "\u{faa1}"
        case .usbHeadsetBold: return "\u{faa2}"
        case .usbHeadsetLight: return "\u{faa3}"
        case .usbHeadsetMutedBold: return "\u{faa4}"
        case .usbHeadsetMutedLight: return "\u{faa5}"
        case .usbHeadsetMutedRegular: return "\u{faa6}"
        case .usbHeadsetRegular: return "\u{faa7}"
        case .usbLight: return "\u{faa8}"
        case .usbRegular: return "\u{faa9}"
        case .userBold: return "\u{faaa}"
        case .userDeactivateBold: return "\u{faab}"
        case .userDeactivateLight: return "\u{faac}"
        case .userDeactivateRegular: return "\u{faad}"
        case .userLight: return "\u{faae}"
        case .userRegular: return "\u{faaf}"
        case .vcsBold: return "\u{fab0}"
        case .vcsLight: return "\u{fab1}"
        case .vcsRegular: return "\u{fab2}"
        case .videoBlurBold: return "\u{fab3}"
        case .videoBlurFilled: return "\u{fab4}"
        case .videoBlurLight: return "\u{fab5}"
        case .videoBlurRegular: return "\u{fab6}"
        case .videoBold: return "\u{fab7}"
        case .videoEffectBold: return "\u{fab8}"
        case .videoEffectFilled: return "\u{fab9}"
        case .videoEffectLight: return "\u{faba}"
        case .videoEffectRegular: return "\u{fabb}"
        case .videoFilled: return "\u{fabc}"
        case .videoLayoutBold: return "\u{fabd}"
        case .videoLayoutEqualBold: return "\u{fabe}"
        case .videoLayoutEqualDualBold: return "\u{fabf}"
        case .videoLayoutEqualDualLight: return "\u{fac0}"
        case .videoLayoutEqualDualRegular: return "\u{fac1}"
        case .videoLayoutEqualFilled: return "\u{fac2}"
        case .videoLayoutEqualLight: return "\u{fac3}"
        case .videoLayoutEqualRegular: return "\u{fac4}"
        case .videoLayoutFilled: return "\u{fac5}"
        case .videoLayoutLight: return "\u{fac6}"
        case .videoLayoutOverlayBold: return "\u{fac7}"
        case .videoLayoutOverlayLight: return "\u{fac8}"
        case .videoLayoutOverlayRegular: return "\u{fac9}"
        case .videoLayoutPresenterDominantBold: return "\u{faca}"
        case .videoLayoutPresenterDominantLight: return "\u{facb}"
        case .videoLayoutPresenterDominantRegular: return "\u{facc}"
        case .videoLayoutProminentBold: return "\u{facd}"
        case .videoLayoutProminentFilled: return "\u{face}"
        case .videoLayoutProminentLight: return "\u{facf}"
        case .videoLayoutProminentRegular: return "\u{fad0}"
        case .videoLayoutRegular: return "\u{fad1}"
        case .videoLayoutShareDominantBold: return "\u{fad2}"
        case .videoLayoutShareDominantLight: return "\u{fad3}"
        case .videoLayoutShareDominantRegular: return "\u{fad4}"
        case .videoLayoutSingleBold: return "\u{fad5}"
        case .videoLayoutSingleFilled: return "\u{fad6}"
        case .videoLayoutSingleLight: return "\u{fad7}"
        case .videoLayoutSingleRegular: return "\u{fad8}"
        case .videoLayoutStackBold: return "\u{fad9}"
        case .videoLayoutStackFilled: return "\u{fada}"
        case .videoLayoutStackLight: return "\u{fadb}"
        case .videoLayoutStackRegular: return "\u{fadc}"
        case .videoLayoutVideoDominantBold: return "\u{fadd}"
        case .videoLayoutVideoDominantFilled: return "\u{fade}"
        case .videoLayoutVideoDominantLight: return "\u{fadf}"
        case .videoLayoutVideoDominantRegular: return "\u{fae0}"
        case .videoLight: return "\u{fae1}"
        case .videoPlusBold: return "\u{fae2}"
        case .videoPlusFilled: return "\u{fae3}"
        case .videoPlusLight: return "\u{fae4}"
        case .videoPlusRegular: return "\u{fae5}"
        case .videoRegular: return "\u{fae6}"
        case .videoSpeakerTrackBold: return "\u{fae7}"
        case .videoSpeakerTrackFilled: return "\u{fae8}"
        case .videoSpeakerTrackLight: return "\u{fae9}"
        case .videoSpeakerTrackRegular: return "\u{faea}"
        case .viewAllBold: return "\u{faeb}"
        case .viewAllLight: return "\u{faec}"
        case .viewAllRegular: return "\u{faed}"
        case .viewListBold: return "\u{faee}"
        case .viewListLight: return "\u{faef}"
        case .viewListRegular: return "\u{faf0}"
        case .viewStackedBold: return "\u{faf1}"
        case .viewStackedFilled: return "\u{faf2}"
        case .viewStackedLight: return "\u{faf3}"
        case .viewStackedRegular: return "\u{faf4}"
        case .viewThumbnailBold: return "\u{faf5}"
        case .viewThumbnailFilled: return "\u{faf6}"
        case .viewThumbnailLight: return "\u{faf7}"
        case .viewThumbnailRegular: return "\u{faf8}"
        case .voicemailBold: return "\u{faf9}"
        case .voicemailFilled: return "\u{fafa}"
        case .voicemailLight: return "\u{fafb}"
        case .voicemailRegular: return "\u{fafc}"
        case .waffleMenuBold: return "\u{fafd}"
        case .waffleMenuLight: return "\u{fafe}"
        case .waffleMenuRegular: return "\u{faff}"
        case .waitingroomActiveBold: return "\u{fb00}"
        case .waitingroomActiveLight: return "\u{fb01}"
        case .waitingroomActiveRegular: return "\u{fb02}"
        case .wallpaperBold: return "\u{fb03}"
        case .wallpaperLight: return "\u{fb04}"
        case .wallpaperRegular: return "\u{fb05}"
        case .warningBadgeFilled: return "\u{fb06}"
        case .warningBold: return "\u{fb07}"
        case .warningFilled: return "\u{fb08}"
        case .warningLight: return "\u{fb09}"
        case .warningRegular: return "\u{fb0a}"
        case .webexAssistantActiveColored: return "\u{fb0b}"
        case .webexAssistantActive: return "\u{fb0c}"
        case .webexAssistantFlat: return "\u{fb0d}"
        case .webexAssistantInactiveColored: return "\u{fb0e}"
        case .webexAssistantInactive: return "\u{fb0f}"
        case .webexAssistant: return "\u{fb10}"
        case .webexBoardBold: return "\u{fb11}"
        case .webexBoardLight: return "\u{fb12}"
        case .webexBoardRegular: return "\u{fb13}"
        case .webexCodecPlusBold: return "\u{fb14}"
        case .webexCodecPlusLight: return "\u{fb15}"
        case .webexCodecPlusRegular: return "\u{fb16}"
        case .webexDeskCameraBold: return "\u{fb17}"
        case .webexDeskCameraLight: return "\u{fb18}"
        case .webexDeskCameraRegular: return "\u{fb19}"
        case .webexHelixFilled: return "\u{fb1a}"
        case .webexMeetingsBold: return "\u{fb1b}"
        case .webexMeetingsFilled: return "\u{fb1c}"
        case .webexMeetingsLight: return "\u{fb1d}"
        case .webexMeetingsRegular: return "\u{fb1e}"
        case .webexQuadCameraBold: return "\u{fb1f}"
        case .webexQuadCameraLight: return "\u{fb20}"
        case .webexQuadCameraRegular: return "\u{fb21}"
        case .webexRoomKitBold: return "\u{fb22}"
        case .webexRoomKitLight: return "\u{fb23}"
        case .webexRoomKitPlusBold: return "\u{fb24}"
        case .webexRoomKitPlusLight: return "\u{fb25}"
        case .webexRoomKitPlusRegular: return "\u{fb26}"
        case .webexRoomKitRegular: return "\u{fb27}"
        case .webexShareBold: return "\u{fb28}"
        case .webexShareLight: return "\u{fb29}"
        case .webexShareRegular: return "\u{fb2a}"
        case .webexTeamsBold: return "\u{fb2b}"
        case .webexTeamsFilled: return "\u{fb2c}"
        case .webexTeamsLight: return "\u{fb2d}"
        case .webexTeamsNewBold: return "\u{fb2e}"
        case .webexTeamsNewFilled: return "\u{fb2f}"
        case .webexTeamsNewLight: return "\u{fb30}"
        case .webexTeamsNewRegular: return "\u{fb31}"
        case .webexTeamsRegular: return "\u{fb32}"
        case .webinarBold: return "\u{fb33}"
        case .webinarFilled: return "\u{fb34}"
        case .webinarLight: return "\u{fb35}"
        case .webinarRegular: return "\u{fb36}"
        case .weeklyRecurringScheduleNodeBold: return "\u{fb37}"
        case .weeklyRecurringScheduleNodeLight: return "\u{fb38}"
        case .weeklyRecurringScheduleNodeRegular: return "\u{fb39}"
        case .whatsNewBold: return "\u{fb3a}"
        case .whatsNewFilled: return "\u{fb3b}"
        case .whatsNewLight: return "\u{fb3c}"
        case .whatsNewRegular: return "\u{fb3d}"
        case .whiteboardBold: return "\u{fb3e}"
        case .whiteboardContentBold: return "\u{fb3f}"
        case .whiteboardContentLight: return "\u{fb40}"
        case .whiteboardContentRegular: return "\u{fb41}"
        case .whiteboardFilled: return "\u{fb42}"
        case .whiteboardLight: return "\u{fb43}"
        case .whiteboardRegular: return "\u{fb44}"
        case .widgetBold: return "\u{fb45}"
        case .widgetFilled: return "\u{fb46}"
        case .widgetLight: return "\u{fb47}"
        case .widgetRegular: return "\u{fb48}"
        case .wifiBold: return "\u{fb49}"
        case .wifiErrorBold: return "\u{fb4a}"
        case .wifiErrorLight: return "\u{fb4b}"
        case .wifiErrorRegular: return "\u{fb4c}"
        case .wifiLight: return "\u{fb4d}"
        case .wifiRegular: return "\u{fb4e}"
        case .wifiSignalGoodColoredBold: return "\u{fb4f}"
        case .wifiSignalGoodColoredLight: return "\u{fb50}"
        case .wifiSignalGoodColoredRegular: return "\u{fb51}"
        case .wifiSignalPoorColoredBold: return "\u{fb52}"
        case .wifiSignalPoorColoredLight: return "\u{fb53}"
        case .wifiSignalPoorColoredRegular: return "\u{fb54}"
        case .wifiSignalUnstableColoredBold: return "\u{fb55}"
        case .wifiSignalUnstableColoredLight: return "\u{fb56}"
        case .wifiSignalUnstableColoredRegular: return "\u{fb57}"
        case .windowCornerScrubBold: return "\u{fb58}"
        case .windowCornerScrubLight: return "\u{fb59}"
        case .windowCornerScrubRegular: return "\u{fb5a}"
        case .windowRightCornerScrubBold: return "\u{fb5b}"
        case .windowRightCornerScrubLight: return "\u{fb5c}"
        case .windowRightCornerScrubRegular: return "\u{fb5d}"
        case .windowVerticalScrubBold: return "\u{fb5e}"
        case .windowVerticalScrubLight: return "\u{fb5f}"
        case .windowVerticalScrubRegular: return "\u{fb60}"
        case .workflowDeploymentsBold: return "\u{fb61}"
        case .workflowDeploymentsFilled: return "\u{fb62}"
        case .workflowDeploymentsLight: return "\u{fb63}"
        case .workflowDeploymentsRegular: return "\u{fb64}"
        case .workphoneBold: return "\u{fb65}"
        case .workphoneLight: return "\u{fb66}"
        case .workphoneRegular: return "\u{fb67}"
        case .zoomInBold: return "\u{fb68}"
        case .zoomInLight: return "\u{fb69}"
        case .zoomInRegular: return "\u{fb6a}"
        case .zoomOutBold: return "\u{fb6b}"
        case .zoomOutLight: return "\u{fb6c}"
        case .zoomOutRegular: return "\u{fb6d}"
        case .zoom: return "\u{fb6e}"
