...
@objc public enum MomentumIconType: Int {
    ...
    public var ligature: String {
        ...
        case .screenshot24: return "\u{f8a5}"
        case .search12: return "\u{f8a6}"
        case .search14: return "\u{f8a7}"
        case .search16: return "\u{f8a8}"
        case .search18: return "\u{f8a9}"
        case .search20: return "\u{f8aa}"
        case .search24: return "\u{f8ab}"
        case .search28: return "\u{f8ac}"
        case .secure12: return "\u{f8ad}"
        case .secure14: return "\u{f8ae}"
        case .secure16: return "\u{f8af}"
        case .secure20: return "\u{f8b0}"
        case .secure24: return "\u{f8b1}"
        case .secure28: return "\u{f8b2}"
        case .secure8: return "\u{f8b3}"
        case .secureActive12: return "\u{f8b4}"
        case .secureActive14: return "\u{f8b5}"
        case .secureActive16: return "\u{f8b6}"
        case .secureActive20: return "\u{f8b7}"
        case .secureActive24: return "\u{f8b8}"
        case .secureActive28: return "\u{f8b9}"
        case .secureActive8: return "\u{f8ba}"
        case .secureFips24: return "\u{f8bb}"
        case .selfview16: return "\u{f8bc}"
        case .selfview20: return "\u{f8bd}"
        case .selfview24: return "\u{f8be}"
        case .send12: return "\u{f8bf}"
        case .send14: return "\u{f8c0}"
        case .send16: return "\u{f8c1}"
        case .send20: return "\u{f8c2}"
        case .send24: return "\u{f8c3}"
        case .seperate12: return "\u{f8c4}"
        case .seperate16: return "\u{f8c5}"
        case .seperate20: return "\u{f8c6}"
        case .seperate24: return "\u{f8c7}"
        case .server16: return "\u{f8c8}"
        case .server24: return "\u{f8c9}"
        case .serverCircle100: return "\u{f8ca}"
        case .serverError16: return "\u{f8cb}"
        case .serverProblem16: return "\u{f8cc}"
        case .settings10: return "\u{f8cd}"
        case .settings12: return "\u{f8ce}"
        case .settings14: return "\u{f8cf}"
        case .settings16: return "\u{f8d0}"
        case .settings18: return "\u{f8d1}"
        case .settings20: return "\u{f8d2}"
        case .settings24: return "\u{f8d3}"
        case .settings32: return "\u{f8d4}"
        case .settings8: return "\u{f8d5}"
        case .settingsActive10: return "\u{f8d6}"
        case .settingsActive12: return "\u{f8d7}"
        case .settingsActive14: return "\u{f8d8}"
        case .settingsActive16: return "\u{f8d9}"
        case .settingsActive18: return "\u{f8da}"
        case .settingsActive20: return "\u{f8db}"
        case .settingsActive24: return "\u{f8dc}"
        case .settingsActive32: return "\u{f8dd}"
        case .settingsActive8: return "\u{f8de}"
        case .setupAssistant16: return "\u{f8df}"
        case .shakeDevice18: return "\u{f8e0}"
        case .shakeDevice20: return "\u{f8e1}"
        case .shapeDiagonalArrowheadDual16: return "\u{f8e2}"
        case .shapeDiagonalArrowheadSingle16: return "\u{f8e3}"
        case .shapeDiagonalLine16: return "\u{f8e4}"
        case .shapeOval16: return "\u{f8e5}"
        case .shapeSquare16: return "\u{f8e6}"
        case .share12: return "\u{f8e7}"
        case .share14: return "\u{f8e8}"
        case .share16: return "\u{f8e9}"
        case .share18: return "\u{f8ea}"
        case .share20: return "\u{f8eb}"
        case .share24: return "\u{f8ec}"
        case .share28: return "\u{f8ed}"
        case .share32: return "\u{f8ee}"
        case .shareCNativeAdr14: return "\u{f8ef}"
        case .shareCNativeAdr16: return "\u{f8f0}"
        case .shareCNativeAdr24: return "\u{f8f1}"
        case .shareCNativeIos10: return "\u{f8f2}"
        case .shareCNativeIos12: return "\u{f8f3}"
        case .shareCNativeIos14: return "\u{f8f4}"
        case .shareCNativeIos16: return "\u{f8f5}"
        case .shareCNativeIos20: return "\u{f8f6}"
        case .shareCNativeIos28: return "\u{f8f7}"
        case .shareCNativeIph10: return "\u{f8f8}"
        case .shareCNativeIph12: return "\u{f8f9}"
        case .shareCNativeIph14: return "\u{f8fa}"
        case .shareCNativeIph16: return "\u{f8fb}"
        case .shareCNativeIph20: return "\u{f8fc}"
        case .shareCNativeIph24: return "\u{f8fd}"
        case .shareCNativeIph28: return "\u{f8fe}"
        case .shareScreen10: return "\u{f8ff}"
        case .shareScreen12: return "\u{f900}"
        case .shareScreen120: return "\u{f901}"
        case .shareScreen124: return "\u{f902}"
        case .shareScreen14: return "\u{f903}"
        case .shareScreen16: return "\u{f904}"
        case .shareScreen18: return "\u{f905}"
        case .shareScreen20: return "\u{f906}"
        case .shareScreen24: return "\u{f907}"
        case .shareScreen26: return "\u{f908}"
        case .shareScreen28: return "\u{f909}"
        case .shareScreen32: return "\u{f90a}"
        case .shareScreen36: return "\u{f90b}"
        case .shareScreen48: return "\u{f90c}"
        case .shareScreen56: return "\u{f90d}"
        case .shareScreen8: return "\u{f90e}"
        case .shareSpace12: return "\u{f90f}"
        case .shareSpace14: return "\u{f910}"
        case .shareSpace18: return "\u{f911}"
        case .shareSpace20: return "\u{f912}"
        case .shareSpace24: return "\u{f913}"
        case .show12: return "\u{f914}"
        case .show16: return "\u{f915}"
        case .show20: return "\u{f916}"
        case .show24: return "\u{f917}"
        case .signIn16: return "\u{f918}"
        case .signIn20: return "\u{f919}"
        case .signIn24: return "\u{f91a}"
        case .signInForced16: return "\u{f91b}"
        case .signInForced24: return "\u{f91c}"
        case .signOut10: return "\u{f91d}"
        case .signOut12: return "\u{f91e}"
        case .signOut16: return "\u{f91f}"
        case .signOut20: return "\u{f920}"
        case .signOut24: return "\u{f921}"
        case .signal016: return "\u{f922}"
        case .signal10012: return "\u{f923}"
        case .signal10016: return "\u{f924}"
        case .signal2516: return "\u{f925}"
        case .signal5016: return "\u{f926}"
        case .signal7516: return "\u{f927}"
        case .singleNumberReach12: return "\u{f928}"
        case .singleNumberReach14: return "\u{f929}"
        case .singleNumberReach16: return "\u{f92a}"
        case .singleNumberReach20: return "\u{f92b}"
        case .skip10: return "\u{f92c}"
        case .skip16: return "\u{f92d}"
        case .skip24: return "\u{f92e}"
        case .skipBw16: return "\u{f92f}"
        case .skipBw24: return "\u{f930}"
        case .skipFw16: return "\u{f931}"
        case .skipFw24: return "\u{f932}"
        case .sortDown20: return "\u{f933}"
        case .sortDown24: return "\u{f934}"
        case .sortUp20: return "\u{f935}"
        case .sortUp24: return "\u{f936}"
        case .space12: return "\u{f937}"
        case .space16: return "\u{f938}"
        case .spark16: return "\u{f939}"
        case .sparkBoard12: return "\u{f93a}"
        case .sparkBoard14: return "\u{f93b}"
        case .sparkBoard16: return "\u{f93c}"
        case .sparkBoard20: return "\u{f93d}"
        case .sparkBoard24: return "\u{f93e}"
        case .sparkBoard28: return "\u{f93f}"
        case .sparkBoard32: return "\u{f940}"
        case .sparkBoard48: return "\u{f941}"
        case .sparkQuadCamera16: return "\u{f942}"
        case .sparkQuadCamera20: return "\u{f943}"
        case .sparkRoomKit16: return "\u{f944}"
        case .sparkRoomKit20: return "\u{f945}"
        case .sparkRoomKitPlus16: return "\u{f946}"
        case .sparkRoomKitPlus20: return "\u{f947}"
        case .sparkShare16: return "\u{f948}"
        case .sparkShare20: return "\u{f949}"
        case .sparkVoice16: return "\u{f94a}"
        case .sparkVoice20: return "\u{f94b}"
        case .speaker12: return "\u{f94c}"
        case .speaker16: return "\u{f94d}"
        case .speaker20: return "\u{f94e}"
        case .speaker24: return "\u{f94f}"
        case .speaker28: return "\u{f950}"
        case .speakerBluetooth16: return "\u{f951}"
        case .speakerDisconnected12: return "\u{f952}"
        case .speakerDisconnected14: return "\u{f953}"
        case .speakerDisconnected16: return "\u{f954}"
        case .speakerDisconnected20: return "\u{f955}"
        case .speakerDisconnected24: return "\u{f956}"
        case .speakerDisconnected28: return "\u{f957}"
        case .speakerDisconnected36: return "\u{f958}"
        case .speakerLineOutLeft16: return "\u{f959}"
        case .speakerLineOutRight16: return "\u{f95a}"
        case .speakerMuted12: return "\u{f95b}"
        case .speakerMuted16: return "\u{f95c}"
        case .speakerMuted24: return "\u{f95d}"
        case .speakerMuted28: return "\u{f95e}"
        case .speakerMuted32: return "\u{f95f}"
        case .speakerOff16: return "\u{f960}"
        case .speakerOff24: return "\u{f961}"
        case .speakerOff28: return "\u{f962}"
        case .spinner12: return "\u{f963}"
        case .spinner14: return "\u{f964}"
        case .spinner16: return "\u{f965}"
        case .spinner18: return "\u{f966}"
        case .spinner20: return "\u{f967}"
        case .spinner24: return "\u{f968}"
        case .spinner28: return "\u{f969}"
        case .spinner32: return "\u{f96a}"
        case .spinner36: return "\u{f96b}"
        case .spinner40: return "\u{f96c}"
        case .spinner48: return "\u{f96d}"
        case .spinner56: return "\u{f96e}"
        case .spinner72: return "\u{f96f}"
        case .spinner8: return "\u{f970}"
        case .spinner80: return "\u{f971}"
        case .spinner90: return "\u{f972}"
        case .spreadsheet16: return "\u{f973}"
        case .startChat20: return "\u{f974}"
        case .stickers16: return "\u{f975}"
        case .stickers24: return "\u{f976}"
        case .stickies12: return "\u{f977}"
        case .stickies16: return "\u{f978}"
        case .stickies24: return "\u{f979}"
        case .stop10: return "\u{f97a}"
        case .stop12: return "\u{f97b}"
        case .stop16: return "\u{f97c}"
        case .stop20: return "\u{f97d}"
        case .stop24: return "\u{f97e}"
        case .stopCircle12: return "\u{f97f}"
        case .stopCircle16: return "\u{f980}"
        case .stopCircle20: return "\u{f981}"
        case .stopCircle24: return "\u{f982}"
        case .stopContentShare20: return "\u{f983}"
        case .storedInfo12: return "\u{f984}"
        case .storedInfo16: return "\u{f985}"
        case .storedInfo20: return "\u{f986}"
        case .storedInfo24: return "\u{f987}"
        case .storedInfoActive12: return "\u{f988}"
        case .storedInfoActive16: return "\u{f989}"
        case .storedInfoActive20: return "\u{f98a}"
        case .storedInfoActive24: return "\u{f98b}"
        case .streaming16: return "\u{f98c}"
        case .streaming20: return "\u{f98d}"
        case .streaming24: return "\u{f98e}"
        case .subscribe16: return "\u{f98f}"
        case .swift16: return "\u{f990}"
        case .sx1016: return "\u{f991}"
        case .sx1020: return "\u{f992}"
        case .sx2016: return "\u{f993}"
        case .sx2020: return "\u{f994}"
        case .sx80Codec16: return "\u{f995}"
        case .sx80Codec20: return "\u{f996}"
        case .tablet16: return "\u{f997}"
        case .tablet24: return "\u{f998}"
        case .tag12: return "\u{f999}"
        case .tag16: return "\u{f99a}"
        case .tag20: return "\u{f99b}"
        case .tasks10: return "\u{f99c}"
        case .tasks12: return "\u{f99d}"
        case .tasks14: return "\u{f99e}"
        case .tasks16: return "\u{f99f}"
        case .tasks18: return "\u{f9a0}"
        case .tasks20: return "\u{f9a1}"
        case .tasks24: return "\u{f9a2}"
        case .tasks26: return "\u{f9a3}"
        case .tasks28: return "\u{f9a4}"
        case .tasks32: return "\u{f9a5}"
        case .tasks36: return "\u{f9a6}"
        case .tasks8: return "\u{f9a7}"
        case .team12: return "\u{f9a8}"
        case .team14: return "\u{f9a9}"
        case .team16: return "\u{f9aa}"
        case .team18: return "\u{f9ab}"
        case .team20: return "\u{f9ac}"
        case .team24: return "\u{f9ad}"
        case .team32: return "\u{f9ae}"
        case .teamActive12: return "\u{f9af}"
        case .teamActive14: return "\u{f9b0}"
        case .teamActive16: return "\u{f9b1}"
        case .teamActive18: return "\u{f9b2}"
        case .teamActive20: return "\u{f9b3}"
        case .teamActive24: return "\u{f9b4}"
        case .teamActive32: return "\u{f9b5}"
        case .telepresence12: return "\u{f9b6}"
        case .telepresence16: return "\u{f9b7}"
        case .telepresence18: return "\u{f9b8}"
        case .telepresence20: return "\u{f9b9}"
        case .telepresence24: return "\u{f9ba}"
        case .telepresence64: return "\u{f9bb}"
        case .telepresenceAlert12: return "\u{f9bc}"
        case .telepresenceIx500016: return "\u{f9bd}"
        case .telepresenceIx500020: return "\u{f9be}"
        case .telepresenceMuted12: return "\u{f9bf}"
        case .telepresenceMuted64: return "\u{f9c0}"
        case .telepresenceMutedAlert12: return "\u{f9c1}"
        case .telepresencePrivate12: return "\u{f9c2}"
        case .text10: return "\u{f9c3}"
        case .text12: return "\u{f9c4}"
        case .text16: return "\u{f9c5}"
        case .textAlignLeft16: return "\u{f9c6}"
        case .textAlignRight16: return "\u{f9c7}"
        case .textBlockquote12: return "\u{f9c8}"
        case .textBlockquote16: return "\u{f9c9}"
        case .textBlockquote18: return "\u{f9ca}"
        case .textBlockquote20: return "\u{f9cb}"
        case .textBlockquote8: return "\u{f9cc}"
        case .textBlockquoteRounded20: return "\u{f9cd}"
        case .textBold12: return "\u{f9ce}"
        case .textBold16: return "\u{f9cf}"
        case .textCodeBlock12: return "\u{f9d0}"
        case .textCodeBlock16: return "\u{f9d1}"
        case .textColor16: return "\u{f9d2}"
        case .textFormat10: return "\u{f9d3}"
        case .textFormat12: return "\u{f9d4}"
        case .textFormat16: return "\u{f9d5}"
        case .textFormat20: return "\u{f9d6}"
        case .textFormat24: return "\u{f9d7}"
        case .textFormat8: return "\u{f9d8}"
        case .textHeading112: return "\u{f9d9}"
        case .textHeading116: return "\u{f9da}"
        case .textHeading212: return "\u{f9db}"
        case .textHeading216: return "\u{f9dc}"
        case .textHeading312: return "\u{f9dd}"
        case .textHeading316: return "\u{f9de}"
        case .textItalic12: return "\u{f9df}"
        case .textItalic16: return "\u{f9e0}"
        case .textListBulleted10: return "\u{f9e1}"
        case .textListBulleted12: return "\u{f9e2}"
        case .textListBulleted16: return "\u{f9e3}"
        case .textListBulleted8: return "\u{f9e4}"
        case .textListNumbered12: return "\u{f9e5}"
        case .textListNumbered16: return "\u{f9e6}"
        case .textListNumbered36: return "\u{f9e7}"
        case .textListNumbered40: return "\u{f9e8}"
        case .textStrikethrough16: return "\u{f9e9}"
        case .textTable16: return "\u{f9ea}"
        case .textUnderline12: return "\u{f9eb}"
        case .textUnderline16: return "\u{f9ec}"
        case .tooFast12: return "\u{f9ed}"
        case .tooFast16: return "\u{f9ee}"
        case .tooSlow12: return "\u{f9ef}"
        case .tooSlow16: return "\u{f9f0}"
        case .tools16: return "\u{f9f1}"
        case .tools20: return "\u{f9f2}"
        case .tools24: return "\u{f9f3}"
        case .tools32: return "\u{f9f4}"
        case .touch16: return "\u{f9f5}"
        case .touch1024: return "\u{f9f6}"
        case .transcript16: return "\u{f9f7}"
        case .twitter16: return "\u{f9f8}"
        case .twitterCircle24: return "\u{f9f9}"
        case .twitterCircle32: return "\u{f9fa}"
        case .twitterCircle40: return "\u{f9fb}"
        case .ucmCloud16: return "\u{f9fc}"
        case .ucmCloud24: return "\u{f9fd}"
        case .ucmCloud32: return "\u{f9fe}"
        case .undo12: return "\u{f9ff}"
        case .undo14: return "\u{fa00}"
        case .undo16: return "\u{fa01}"
        case .undo24: return "\u{fa02}"
        case .unlink20: return "\u{fa03}"
        case .unreadBadge10: return "\u{fa04}"
        case .unreadBadge12: return "\u{fa05}"
        case .unreadBadge16: return "\u{fa06}"
        case .unreadBadge8: return "\u{fa07}"
        case .unsecure12: return "\u{fa08}"
        case .unsecure14: return "\u{fa09}"
        case .unsecure16: return "\u{fa0a}"
        case .unsecure24: return "\u{fa0b}"
        case .unsecure28: return "\u{fa0c}"
        case .upload12: return "\u{fa0d}"
        case .upload130: return "\u{fa0e}"
        case .upload14: return "\u{fa0f}"
        case .upload16: return "\u{fa10}"
        case .upload18: return "\u{fa11}"
        case .upload20: return "\u{fa12}"
        case .upload24: return "\u{fa13}"
        case .upload28: return "\u{fa14}"
        case .upload32: return "\u{fa15}"
        case .upload36: return "\u{fa16}"
        case .usb16: return "\u{fa17}"
        case .user16: return "\u{fa18}"
        case .user20: return "\u{fa19}"
        case .user24: return "\u{fa1a}"
        case .user56: return "\u{fa1b}"
        case .videoEffect12: return "\u{fa1c}"
        case .videoLayout12: return "\u{fa1d}"
        case .videoLayout16: return "\u{fa1e}"
        case .videoLayoutAuto12: return "\u{fa1f}"
        case .videoLayoutAuto16: return "\u{fa20}"
        case .videoLayoutAuto20: return "\u{fa21}"
        case .videoLayoutAuto24: return "\u{fa22}"
        case .videoLayoutEqual12: return "\u{fa23}"
        case .videoLayoutEqual14: return "\u{fa24}"
        case .videoLayoutEqual16: return "\u{fa25}"
        case .videoLayoutEqual20: return "\u{fa26}"
        case .videoLayoutEqual24: return "\u{fa27}"
        case .videoLayoutOverlay12: return "\u{fa28}"
        case .videoLayoutOverlay16: return "\u{fa29}"
        case .videoLayoutOverlay20: return "\u{fa2a}"
        case .videoLayoutOverlay24: return "\u{fa2b}"
        case .videoLayoutProminent12: return "\u{fa2c}"
        case .videoLayoutProminent16: return "\u{fa2d}"
        case .videoLayoutProminent20: return "\u{fa2e}"
        case .videoLayoutProminent24: return "\u{fa2f}"
        case .videoLayoutShareDominant12: return "\u{fa30}"
        case .videoLayoutShareDominant16: return "\u{fa31}"
        case .videoLayoutShareDominant20: return "\u{fa32}"
        case .videoLayoutShareDominant24: return "\u{fa33}"
        case .videoLayoutSingle16: return "\u{fa34}"
        case .videoLayoutSingle20: return "\u{fa35}"
        case .videoLayoutVideoDominant12: return "\u{fa36}"
        case .videoLayoutVideoDominant16: return "\u{fa37}"
        case .videoLayoutVideoDominant20: return "\u{fa38}"
        case .videoLayoutVideoDominant24: return "\u{fa39}"
        case .viewAll12: return "\u{fa3a}"
        case .viewAll14: return "\u{fa3b}"
        case .viewFeedMultiple16: return "\u{fa3c}"
        case .viewFeedPanel16: return "\u{fa3d}"
        case .viewFeedSingle16: return "\u{fa3e}"
        case .viewList10: return "\u{fa3f}"
        case .viewList12: return "\u{fa40}"
        case .viewList14: return "\u{fa41}"
        case .viewList16: return "\u{fa42}"
        case .viewList20: return "\u{fa43}"
        case .viewList24: return "\u{fa44}"
        case .viewList28: return "\u{fa45}"
        case .viewListCircle100: return "\u{fa46}"
        case .viewMixed12: return "\u{fa47}"
        case .viewStack12: return "\u{fa48}"
        case .viewStack14: return "\u{fa49}"
        case .viewStack20: return "\u{fa4a}"
        case .viewStack24: return "\u{fa4b}"
        case .viewThumbnail12: return "\u{fa4c}"
        case .viewThumbnail14: return "\u{fa4d}"
        case .viewThumbnail16: return "\u{fa4e}"
        case .viewThumbnail20: return "\u{fa4f}"
        case .viewThumbnail24: return "\u{fa50}"
        case .voicemail10: return "\u{fa51}"
        case .voicemail14: return "\u{fa52}"
        case .voicemail16: return "\u{fa53}"
        case .voicemail18: return "\u{fa54}"
        case .voicemail20: return "\u{fa55}"
        case .voicemail24: return "\u{fa56}"
        case .voicemail28: return "\u{fa57}"
        case .voicemail8: return "\u{fa58}"
        case .voicemailActive12: return "\u{fa59}"
        case .voicemailActive14: return "\u{fa5a}"
        case .voicemailActive16: return "\u{fa5b}"
        case .voicemailActive18: return "\u{fa5c}"
        case .voicemailActive20: return "\u{fa5d}"
        case .voicemailActive24: return "\u{fa5e}"
        case .voicemailActive28: return "\u{fa5f}"
        case .wallpaper16: return "\u{fa60}"
        case .wallpaper20: return "\u{fa61}"
        case .wallpaper24: return "\u{fa62}"
        case .wallpaper28: return "\u{fa63}"
        case .wallpaper32: return "\u{fa64}"
        case .warning100: return "\u{fa65}"
        case .warning12: return "\u{fa66}"
        case .warning14: return "\u{fa67}"
        case .warning16: return "\u{fa68}"
        case .warning20: return "\u{fa69}"
        case .warning24: return "\u{fa6a}"
        case .warning28: return "\u{fa6b}"
        case .warning32: return "\u{fa6c}"
        case .warning40: return "\u{fa6d}"
        case .warning44: return "\u{fa6e}"
        case .warning56: return "\u{fa6f}"
        case .warning64: return "\u{fa70}"
        case .warning72: return "\u{fa71}"
        case .webSharing16: return "\u{fa72}"
        case .webSharing24: return "\u{fa73}"
        case .webex10: return "\u{fa74}"
        case .webex16: return "\u{fa75}"
        case .webex24: return "\u{fa76}"
        case .webex48: return "\u{fa77}"
        case .webexBoard12: return "\u{fa78}"
        case .webexBoard14: return "\u{fa79}"
        case .webexBoard16: return "\u{fa7a}"
        case .webexBoard20: return "\u{fa7b}"
        case .webexBoard24: return "\u{fa7c}"
        case .webexBoard28: return "\u{fa7d}"
        case .webexBoard32: return "\u{fa7e}"
        case .webexBoard48: return "\u{fa7f}"
        case .webexCalling10: return "\u{fa80}"
        case .webexCalling12: return "\u{fa81}"
        case .webexCalling16: return "\u{fa82}"
        case .webexCalling18: return "\u{fa83}"
        case .webexCalling20: return "\u{fa84}"
        case .webexCalling24: return "\u{fa85}"
        case .webexCodecPlus16: return "\u{fa86}"
        case .webexCodecPlus20: return "\u{fa87}"
        case .webexInstantMeeting12: return "\u{fa88}"
        case .webexInstantMeeting14: return "\u{fa89}"
        case .webexInstantMeeting16: return "\u{fa8a}"
        case .webexInstantMeeting20: return "\u{fa8b}"
        case .webexInstantMeeting24: return "\u{fa8c}"
        case .webexMeetings10: return "\u{fa8d}"
        case .webexMeetings12: return "\u{fa8e}"
        case .webexMeetings14: return "\u{fa8f}"
        case .webexMeetings16: return "\u{fa90}"
        case .webexMeetings20: return "\u{fa91}"
        case .webexMeetings24: return "\u{fa92}"
        case .webexMeetings48: return "\u{fa93}"
        case .webexQuadCamera16: return "\u{fa94}"
        case .webexQuadCamera20: return "\u{fa95}"
        case .webexRoomKit16: return "\u{fa96}"
        case .webexRoomKit20: return "\u{fa97}"
        case .webexRoomKitPlus16: return "\u{fa98}"
        case .webexRoomKitPlus20: return "\u{fa99}"
        case .webexShare12: return "\u{fa9a}"
        case .webexShare14: return "\u{fa9b}"
        case .webexShare16: return "\u{fa9c}"
        case .webexShare20: return "\u{fa9d}"
        case .webexTeams10: return "\u{fa9e}"
        case .webexTeams12: return "\u{fa9f}"
        case .webexTeams14: return "\u{faa0}"
        case .webexTeams16: return "\u{faa1}"
        case .webexTeams18: return "\u{faa2}"
        case .webexTeams20: return "\u{faa3}"
        case .webexVoice16: return "\u{faa4}"
        case .webexVoice20: return "\u{faa5}"
        case .webpop12: return "\u{faa6}"
        case .webpop16: return "\u{faa7}"
        case .webpop20: return "\u{faa8}"
        case .webpop24: return "\u{faa9}"
        case .whiteboard10: return "\u{faaa}"
        case .whiteboard12: return "\u{faab}"
        case .whiteboard14: return "\u{faac}"
        case .whiteboard16: return "\u{faad}"
        case .whiteboard20: return "\u{faae}"
        case .whiteboard24: return "\u{faaf}"
        case .whiteboard26: return "\u{fab0}"
        case .whiteboard28: return "\u{fab1}"
        case .whiteboard32: return "\u{fab2}"
        case .whiteboard36: return "\u{fab3}"
        case .whiteboard8: return "\u{fab4}"
        case .whiteboardContent16: return "\u{fab5}"
        case .whiteboardContent24: return "\u{fab6}"
        case .widgetsAdr20: return "\u{fab7}"
        case .wifi12: return "\u{fab8}"
        case .wifi16: return "\u{fab9}"
        case .wifi20: return "\u{faba}"
        case .wifi24: return "\u{fabb}"
        case .wifiError12: return "\u{fabc}"
        case .wifiError16: return "\u{fabd}"
        case .wikipedia16: return "\u{fabe}"
        case .windowCornerScrub16: return "\u{fabf}"
        case .windowVerticalScrub16: return "\u{fac0}"
        case .youtubeCircle24: return "\u{fac1}"
        case .youtubeCircle32: return "\u{fac2}"
        case .youtubeCircle40: return "\u{fac3}"
        case .zoomIn12: return "\u{fac4}"
        case .zoomIn14: return "\u{fac5}"
        case .zoomIn16: return "\u{fac6}"
        case .zoomIn20: return "\u{fac7}"
        case .zoomOut12: return "\u{fac8}"
        case .zoomOut14: return "\u{fac9}"
        case .zoomOut16: return "\u{faca}"
        case .zoomOut20: return "\u{facb}"
