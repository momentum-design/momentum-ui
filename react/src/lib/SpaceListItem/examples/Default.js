    ...
    return(
      <div className="medium-4 columns">
        <List style={{backgroundColor: 'black'}}>
          ...
          <SpaceListItem header='Type(flag)-attachments' attachments={[<span key={1}><Icon name='document_12' />  <span>Ideas.pdf</span></span>]} subheader='resultRight=node, attachments=[node]' headerSecondary='12/03/2018' type='flag' resultRight={<Icon name='flag-active_12'/>}/>
