...
var Popover = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    var otherProps = (0, _omit.default)(_extends({}, props), ['delay', 'doesAnchorToggle', 'hideDelay', 'hoverDelay', 'onClose', 'showDelay', 'startOpen']);
    ...
    var getTriggers = function getTriggers() {
      ...
      switch (popoverTrigger) {
        case 'MouseEnter':
          ...
          triggerProps.onFocus = includeFocusOnHover && _this2.handleFocus;
          triggerProps.onBlur = includeFocusOnHover && _this2.handleBlur;
          break;
    ...
    var anchorWithTriggers = function anchorWithTriggers() {
      return children && _react.default.cloneElement(children, getTriggers());
    };

    return _react.default.createElement(_react.default.Fragment, null, anchorWithTriggers(), isOpen && _react.default.createElement(_.EventOverlay, _extends({
