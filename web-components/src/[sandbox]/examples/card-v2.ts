  ...
  render() {
    ...
    <div>
      ...
      <div class="card-v2-container">
        <h3>Default</h3>
        <md-card-v2 identifier="fac3aaf3-677c-4380-bbd5-c2e407514c43" state="default" header="Longest waiting in queue" data="00:12:11" info="Longest waiting in queue" .expandable=${true}>
        </md-card-v2>

        <h3>Inactive</h3>
        <md-card-v2 identifier="aaa43a56-ec31-4d70-a77c-c797a1239777" state="inactive" header="Avg. handling time" data="00:19:20" info="Avg. handling time" .expandable=${false}>
        </md-card-v2>
      </div>

      <div class="card-v2-wide-container">
        <h3>Expanded View</h3>
        <md-card-v2 identifier="7002dad2-ed43-4937-a790-48ab8e916d1a" state="inactive" header="Abandoned" data="80" info="Abandoned" .expandable=${false}>
        </md-card-v2>
      </div>
      </div>
    `;
...
export const cardV2Template = html`
  <card-v2-template-sandbox></card-v2-template-sandbox>
`;
