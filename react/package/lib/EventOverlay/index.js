...
var EventOverlay = /*#__PURE__*/function (_React$Component) {
  ...
  function EventOverlay() {
    ...
    _this.handleAllowClickAway = function (e) {
      ...
      return _this.container && !anchorNode.contains(e.target) && !_reactDom.default.findDOMNode(_this.container).contains(e.target) && _this.handleClickAway(e);
    };
    ...
    _this.handleCloseOnClick = function (e) {
      ...
      return closeOnClick && _this.container && _reactDom.default.findDOMNode(_this.container).contains(e.target) && _this.handleClickAway(e);
    };
    ...
    _this.handleKeyDown = function (e) {
      ...
      return _this.container && anchorNode && !anchorNode.contains(e.target) && !_reactDom.default.findDOMNode(_this.container).contains(e.target) && _this.handleClickAway(e);
    };
  ...
  _proto.render = function render() {
    ...
    var contentNodes = isOpen && _react.default.createElement("div", {
    ...
    var withFocusLock = function withFocusLock(content) {
      return shouldLockFocus ? _react.default.createElement(_reactFocusLock.default, focusLockProps, content) : content;
    };

    var withPortal = function withPortal(content) {
      return portalNode ? _reactDom.default.createPortal(content, portalNode) : content;
    };
