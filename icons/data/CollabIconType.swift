...
@objc public enum CollabIconType: Int {
    ...
    public var ligature: String {
        ...
        case .infoI10: return "\u{f4c7}"
        case .infoI12: return "\u{f4c8}"
        case .infoI8: return "\u{f4c9}"
        case .input10: return "\u{f4ca}"
        case .input12: return "\u{f4cb}"
        case .input14: return "\u{f4cc}"
        case .input16: return "\u{f4cd}"
        case .input24: return "\u{f4ce}"
        case .input26: return "\u{f4cf}"
        case .input28: return "\u{f4d0}"
        case .input36: return "\u{f4d1}"
        case .input8: return "\u{f4d2}"
        case .jabber16: return "\u{f4d3}"
        case .keyboard16: return "\u{f4d4}"
        case .keyboard20: return "\u{f4d5}"
        case .keyboard24: return "\u{f4d6}"
        case .keyboard28: return "\u{f4d7}"
        case .keyboardClose16: return "\u{f4d8}"
        case .keyboardClose24: return "\u{f4d9}"
        case .language16: return "\u{f4da}"
        case .language24: return "\u{f4db}"
        case .language40: return "\u{f4dc}"
        case .laptop12: return "\u{f4dd}"
        case .laptop16: return "\u{f4de}"
        case .laptop20: return "\u{f4df}"
        case .laptop24: return "\u{f4e0}"
        case .laptop48: return "\u{f4e1}"
        case .laserPointer16: return "\u{f4e2}"
        case .launch32: return "\u{f4e3}"
        case .layoutEqualDual12: return "\u{f4e4}"
        case .layoutEqualDual16: return "\u{f4e5}"
        case .layoutEqualDual20: return "\u{f4e6}"
        case .layoutEqualDual24: return "\u{f4e7}"
        case .layoutSideBySideHorizonal16: return "\u{f4e8}"
        case .layoutSideBySideVertical16: return "\u{f4e9}"
        case .layoutStacked16: return "\u{f4ea}"
        case .like16: return "\u{f4eb}"
        case .link10: return "\u{f4ec}"
        case .link12: return "\u{f4ed}"
        case .link16: return "\u{f4ee}"
        case .link24: return "\u{f4ef}"
        case .linkedinCircle24: return "\u{f4f0}"
        case .linkedinCircle32: return "\u{f4f1}"
        case .linkedinCircle40: return "\u{f4f2}"
        case .listMenu12: return "\u{f4f3}"
        case .listMenu16: return "\u{f4f4}"
        case .listMenu18: return "\u{f4f5}"
        case .listMenu20: return "\u{f4f6}"
        case .listMenu24: return "\u{f4f7}"
        case .listMenu28: return "\u{f4f8}"
        case .location10: return "\u{f4f9}"
        case .location16: return "\u{f4fa}"
        case .location18: return "\u{f4fb}"
        case .location20: return "\u{f4fc}"
        case .location24: return "\u{f4fd}"
        case .location28: return "\u{f4fe}"
        case .location32: return "\u{f4ff}"
        case .markdown16: return "\u{f500}"
        case .markdown20: return "\u{f501}"
        case .marker12: return "\u{f502}"
        case .marker14: return "\u{f503}"
        case .marker16: return "\u{f504}"
        case .marker18: return "\u{f505}"
        case .maximize12: return "\u{f506}"
        case .maximize14: return "\u{f507}"
        case .maximize16: return "\u{f508}"
        case .maximize20: return "\u{f509}"
        case .maximize24: return "\u{f50a}"
        case .maximize28: return "\u{f50b}"
        case .meet12: return "\u{f50c}"
        case .meet120: return "\u{f50d}"
        case .meet124: return "\u{f50e}"
        case .meet16: return "\u{f50f}"
        case .meet18: return "\u{f510}"
        case .meet20: return "\u{f511}"
        case .meet24: return "\u{f512}"
        case .meet26: return "\u{f513}"
        case .meet32: return "\u{f514}"
        case .meet48: return "\u{f515}"
        case .meet56: return "\u{f516}"
        case .meetings10: return "\u{f517}"
        case .meetings12: return "\u{f518}"
        case .meetings14: return "\u{f519}"
        case .meetings16: return "\u{f51a}"
        case .meetings18: return "\u{f51b}"
        case .meetings20: return "\u{f51c}"
        case .meetings24: return "\u{f51d}"
        case .meetings26: return "\u{f51e}"
        case .meetings28: return "\u{f51f}"
        case .meetings32: return "\u{f520}"
        case .meetings36: return "\u{f521}"
        case .meetings8: return "\u{f522}"
        case .meetingsActive10: return "\u{f523}"
        case .meetingsActive12: return "\u{f524}"
        case .meetingsActive14: return "\u{f525}"
        case .meetingsActive16: return "\u{f526}"
        case .meetingsActive18: return "\u{f527}"
        case .meetingsActive20: return "\u{f528}"
        case .meetingsActive24: return "\u{f529}"
        case .meetingsActive26: return "\u{f52a}"
        case .meetingsActive28: return "\u{f52b}"
        case .meetingsActive32: return "\u{f52c}"
        case .meetingsActive36: return "\u{f52d}"
        case .meetingsActive8: return "\u{f52e}"
        case .mention10: return "\u{f52f}"
        case .mention12: return "\u{f530}"
        case .mention14: return "\u{f531}"
        case .mention16: return "\u{f532}"
        case .mention18: return "\u{f533}"
        case .mention20: return "\u{f534}"
        case .mention24: return "\u{f535}"
        case .mention8: return "\u{f536}"
        case .microphone10: return "\u{f537}"
        case .microphone12: return "\u{f538}"
        case .microphone14: return "\u{f539}"
        case .microphone16: return "\u{f53a}"
        case .microphone18: return "\u{f53b}"
        case .microphone20: return "\u{f53c}"
        case .microphone24: return "\u{f53d}"
        case .microphone28: return "\u{f53e}"
        case .microphone36: return "\u{f53f}"
        case .microphoneMuted10: return "\u{f540}"
        case .microphoneMuted12: return "\u{f541}"
        case .microphoneMuted14: return "\u{f542}"
        case .microphoneMuted16: return "\u{f543}"
        case .microphoneMuted18: return "\u{f544}"
        case .microphoneMuted20: return "\u{f545}"
        case .microphoneMuted24: return "\u{f546}"
        case .microphoneMuted28: return "\u{f547}"
        case .microphoneMuted36: return "\u{f548}"
        case .mindMap24: return "\u{f549}"
        case .minimize12: return "\u{f54a}"
        case .minimize14: return "\u{f54b}"
        case .minimize16: return "\u{f54c}"
        case .minimize20: return "\u{f54d}"
        case .minimize24: return "\u{f54e}"
        case .minimize28: return "\u{f54f}"
        case .minus12: return "\u{f550}"
        case .minus14: return "\u{f551}"
        case .minus16: return "\u{f552}"
        case .minus18: return "\u{f553}"
        case .minus20: return "\u{f554}"
        case .minus24: return "\u{f555}"
        case .minus28: return "\u{f556}"
        case .minus8: return "\u{f557}"
        case .more12: return "\u{f558}"
        case .more14: return "\u{f559}"
        case .more16: return "\u{f55a}"
        case .more20: return "\u{f55b}"
        case .more24: return "\u{f55c}"
        case .more28: return "\u{f55d}"
        case .moreAdr12: return "\u{f55e}"
        case .moreAdr16: return "\u{f55f}"
        case .moreAdr20: return "\u{f560}"
        case .moreAdr24: return "\u{f561}"
        case .moreAdr28: return "\u{f562}"
        case .moreAndroid12: return "\u{f563}"
        case .moreAndroid16: return "\u{f564}"
        case .moreAndroid20: return "\u{f565}"
        case .moreAndroid24: return "\u{f566}"
        case .moreAndroid28: return "\u{f567}"
        case .moreCircle12: return "\u{f568}"
        case .moreCircle16: return "\u{f569}"
        case .mouseCursor16: return "\u{f56a}"
        case .moveCallInAdr12: return "\u{f56b}"
        case .moveCallInAdr16: return "\u{f56c}"
        case .moveCallInAdr18: return "\u{f56d}"
        case .moveCallInAdr20: return "\u{f56e}"
        case .moveCallInAdr24: return "\u{f56f}"
        case .moveCallInAdr28: return "\u{f570}"
        case .moveCallInIph12: return "\u{f571}"
        case .moveCallInIph16: return "\u{f572}"
        case .moveCallInIph18: return "\u{f573}"
        case .moveCallInIph20: return "\u{f574}"
        case .moveCallInIph24: return "\u{f575}"
        case .moveCallInIph28: return "\u{f576}"
        case .moveCallInLaptop12: return "\u{f577}"
        case .moveCallInLaptop16: return "\u{f578}"
        case .moveCallInLaptop18: return "\u{f579}"
        case .moveCallInLaptop20: return "\u{f57a}"
        case .moveCallInLaptop24: return "\u{f57b}"
        case .moveCallInLaptop28: return "\u{f57c}"
        case .moveCallInTablet12: return "\u{f57d}"
        case .moveCallInTablet18: return "\u{f57e}"
        case .moveCallInTablet20: return "\u{f57f}"
        case .moveCallInTablet24: return "\u{f580}"
        case .moveCallInTablet28: return "\u{f581}"
        case .moveCallOutAdr12: return "\u{f582}"
        case .moveCallOutAdr16: return "\u{f583}"
        case .moveCallOutAdr18: return "\u{f584}"
        case .moveCallOutAdr20: return "\u{f585}"
        case .moveCallOutAdr24: return "\u{f586}"
        case .moveCallOutAdr28: return "\u{f587}"
        case .moveCallOutIph12: return "\u{f588}"
        case .moveCallOutIph16: return "\u{f589}"
        case .moveCallOutIph18: return "\u{f58a}"
        case .moveCallOutIph20: return "\u{f58b}"
        case .moveCallOutIph24: return "\u{f58c}"
        case .moveCallOutIph28: return "\u{f58d}"
        case .moveCallOutLaptop12: return "\u{f58e}"
        case .moveCallOutLaptop16: return "\u{f58f}"
        case .moveCallOutLaptop18: return "\u{f590}"
        case .moveCallOutLaptop20: return "\u{f591}"
        case .moveCallOutLaptop24: return "\u{f592}"
        case .moveCallOutLaptop28: return "\u{f593}"
        case .moveCallOutTablet12: return "\u{f594}"
        case .moveCallOutTablet18: return "\u{f595}"
        case .moveCallOutTablet20: return "\u{f596}"
        case .moveCallOutTablet24: return "\u{f597}"
        case .moveCallOutTablet28: return "\u{f598}"
        case .multimedia16: return "\u{f599}"
        case .multimedia20: return "\u{f59a}"
        case .multipleDevices28: return "\u{f59b}"
        case .multipleDevices64: return "\u{f59c}"
        case .muteOnEntry16: return "\u{f59d}"
        case .newWhiteboard12: return "\u{f59e}"
        case .newWhiteboard16: return "\u{f59f}"
        case .next10: return "\u{f5a0}"
        case .next12: return "\u{f5a1}"
        case .next16: return "\u{f5a2}"
        case .next18: return "\u{f5a3}"
        case .next20: return "\u{f5a4}"
        case .next24: return "\u{f5a5}"
        case .next28: return "\u{f5a6}"
        case .next36: return "\u{f5a7}"
        case .note16: return "\u{f5a8}"
        case .note20: return "\u{f5a9}"
        case .notePpt16: return "\u{f5aa}"
        case .notePpt20: return "\u{f5ab}"
        case .notepad16: return "\u{f5ac}"
        case .notes10: return "\u{f5ad}"
        case .notes12: return "\u{f5ae}"
        case .notes14: return "\u{f5af}"
        case .notes16: return "\u{f5b0}"
        case .notes20: return "\u{f5b1}"
        case .notes24: return "\u{f5b2}"
        case .notes26: return "\u{f5b3}"
        case .notes36: return "\u{f5b4}"
        case .notes8: return "\u{f5b5}"
        case .openInFolder10: return "\u{f5b6}"
        case .openInFolder12: return "\u{f5b7}"
        case .openInFolder14: return "\u{f5b8}"
        case .openPages14: return "\u{f5b9}"
        case .openPages16: return "\u{f5ba}"
        case .openPages24: return "\u{f5bb}"
        case .openPages36: return "\u{f5bc}"
        case .otherNumber12: return "\u{f5bd}"
        case .otherNumber16: return "\u{f5be}"
        case .outgoingCallLegacy16: return "\u{f5bf}"
        case .pairedCamera16: return "\u{f5c0}"
        case .pairedCamera24: return "\u{f5c1}"
        case .pairedCamera28: return "\u{f5c2}"
        case .pairedDevice16: return "\u{f5c3}"
        case .pairedHandset16: return "\u{f5c4}"
        case .pairedHandset24: return "\u{f5c5}"
        case .pairing14: return "\u{f5c6}"
        case .pairing16: return "\u{f5c7}"
        case .pairing20: return "\u{f5c8}"
        case .pairing24: return "\u{f5c9}"
        case .pairing28: return "\u{f5ca}"
        case .pairing56: return "\u{f5cb}"
        case .panelControlBar36: return "\u{f5cc}"
        case .panelControlDown12: return "\u{f5cd}"
        case .panelControlDown24: return "\u{f5ce}"
        case .panelControlDown28: return "\u{f5cf}"
        case .panelControlDown36: return "\u{f5d0}"
        case .panelControlDownIph12: return "\u{f5d1}"
        case .panelControlDownIph24: return "\u{f5d2}"
        case .panelControlDownIph36: return "\u{f5d3}"
        case .panelControlDragger14: return "\u{f5d4}"
        case .panelControlLeft12: return "\u{f5d5}"
        case .panelControlLeft16: return "\u{f5d6}"
        case .panelControlLeft24: return "\u{f5d7}"
        case .panelControlLeft36: return "\u{f5d8}"
        case .panelControlLeftIph12: return "\u{f5d9}"
        case .panelControlLeftIph24: return "\u{f5da}"
        case .panelControlLeftIph36: return "\u{f5db}"
        case .panelControlRight12: return "\u{f5dc}"
        case .panelControlRight16: return "\u{f5dd}"
        case .panelControlRight24: return "\u{f5de}"
        case .panelControlRight36: return "\u{f5df}"
        case .panelControlRightIph12: return "\u{f5e0}"
        case .panelControlRightIph24: return "\u{f5e1}"
        case .panelControlRightIph36: return "\u{f5e2}"
        case .panelControlThinDown12: return "\u{f5e3}"
        case .panelControlThinDown24: return "\u{f5e4}"
        case .panelControlThinDown28: return "\u{f5e5}"
        case .panelControlThinLeft12: return "\u{f5e6}"
        case .panelControlThinLeft24: return "\u{f5e7}"
        case .panelControlThinRight12: return "\u{f5e8}"
        case .panelControlThinRight24: return "\u{f5e9}"
        case .panelControlThinUp12: return "\u{f5ea}"
        case .panelControlThinUp24: return "\u{f5eb}"
        case .panelControlThinUp28: return "\u{f5ec}"
        case .panelControlThinnerLeft24: return "\u{f5ed}"
        case .panelControlThinnerRight24: return "\u{f5ee}"
        case .panelControlUp12: return "\u{f5ef}"
        case .panelControlUp24: return "\u{f5f0}"
        case .panelControlUp28: return "\u{f5f1}"
        case .panelControlUp36: return "\u{f5f2}"
        case .panelControlUpIph12: return "\u{f5f3}"
        case .panelControlUpIph24: return "\u{f5f4}"
        case .panelControlUpIph36: return "\u{f5f5}"
        case .parked16: return "\u{f5f6}"
        case .parked20: return "\u{f5f7}"
        case .parked24: return "\u{f5f8}"
        case .participantAdd12: return "\u{f5f9}"
        case .participantAdd16: return "\u{f5fa}"
        case .participantAdd20: return "\u{f5fb}"
        case .participantAdd24: return "\u{f5fc}"
        case .participantAdd28: return "\u{f5fd}"
        case .participantAdd56: return "\u{f5fe}"
        case .participantListLegacy16: return "\u{f5ff}"
        case .participantListLegacy20: return "\u{f600}"
        case .participantListLegacy24: return "\u{f601}"
        case .participantListLegacy28: return "\u{f602}"
        case .participantListLegacy32: return "\u{f603}"
        case .participantListLegacy56: return "\u{f604}"
        case .participantListLegacy64: return "\u{f605}"
        case .participantListLegacy80: return "\u{f606}"
        case .participantListLegacyOptical16: return "\u{f607}"
        case .participantListLegacyOptical20: return "\u{f608}"
        case .participantListLegacyOptical22: return "\u{f609}"
        case .participantListLegacyOptical26: return "\u{f60a}"
        case .participantListLegacyOptical28: return "\u{f60b}"
        case .participantListLegacyOptical32: return "\u{f60c}"
        case .participantListLegacyOptical56: return "\u{f60d}"
        case .participantListLegacyOptical64: return "\u{f60e}"
        case .participantListLegacyOptical80: return "\u{f60f}"
        case .participantRemove12: return "\u{f610}"
        case .participantRemove16: return "\u{f611}"
        case .participantRemove20: return "\u{f612}"
        case .participantRemove24: return "\u{f613}"
        case .participantRemove28: return "\u{f614}"
        case .participantRemove56: return "\u{f615}"
        case .passMouse12: return "\u{f616}"
        case .passMouse16: return "\u{f617}"
        case .passMouse20: return "\u{f618}"
        case .pause10: return "\u{f619}"
        case .pause12: return "\u{f61a}"
        case .pause16: return "\u{f61b}"
        case .pause20: return "\u{f61c}"
        case .pause24: return "\u{f61d}"
        case .pause32: return "\u{f61e}"
        case .pause8: return "\u{f61f}"
        case .pauseCircle16: return "\u{f620}"
        case .pauseCircle20: return "\u{f621}"
        case .pauseCircle24: return "\u{f622}"
        case .pdf12: return "\u{f623}"
        case .pdf28: return "\u{f624}"
        case .pdf44: return "\u{f625}"
        case .pdf72: return "\u{f626}"
        case .pen12: return "\u{f627}"
        case .pen14: return "\u{f628}"
        case .pen16: return "\u{f629}"
        case .pen18: return "\u{f62a}"
        case .people10: return "\u{f62b}"
        case .people12: return "\u{f62c}"
        case .people14: return "\u{f62d}"
        case .people16: return "\u{f62e}"
        case .people20: return "\u{f62f}"
        case .people24: return "\u{f630}"
        case .people26: return "\u{f631}"
        case .people28: return "\u{f632}"
        case .people32: return "\u{f633}"
        case .people36: return "\u{f634}"
        case .people8: return "\u{f635}"
        case .peopleCircle16: return "\u{f636}"
        case .peopleCircle20: return "\u{f637}"
        case .peopleCircle24: return "\u{f638}"
        case .phoneAdr12: return "\u{f639}"
        case .phoneAdr16: return "\u{f63a}"
        case .phoneAdr20: return "\u{f63b}"
        case .phoneAdr24: return "\u{f63c}"
        case .phoneAndroid12: return "\u{f63d}"
        case .phoneAndroid16: return "\u{f63e}"
        case .phoneAndroid24: return "\u{f63f}"
        case .phoneIos12: return "\u{f640}"
        case .phoneIos16: return "\u{f641}"
        case .phoneIos24: return "\u{f642}"
        case .phoneIosMuted12: return "\u{f643}"
        case .phoneIph12: return "\u{f644}"
        case .phoneIph16: return "\u{f645}"
        case .phoneIph20: return "\u{f646}"
        case .phoneIph24: return "\u{f647}"
        case .phoneIphAlert12: return "\u{f648}"
        case .phoneIphMuted12: return "\u{f649}"
        case .phoneIphMutedAlert12: return "\u{f64a}"
        case .phoneIphPrivate12: return "\u{f64b}"
        case .picker14: return "\u{f64c}"
        case .picker16: return "\u{f64d}"
        case .picker18: return "\u{f64e}"
        case .pictureInPicture12: return "\u{f64f}"
        case .pictureInPicture16: return "\u{f650}"
        case .pictureInPicture20: return "\u{f651}"
        case .pictureInPicture24: return "\u{f652}"
        case .pin10: return "\u{f653}"
        case .pin12: return "\u{f654}"
        case .pin14: return "\u{f655}"
        case .pin16: return "\u{f656}"
        case .pin18: return "\u{f657}"
        case .pin20: return "\u{f658}"
        case .pin24: return "\u{f659}"
        case .pinMuted10: return "\u{f65a}"
        case .pinMuted12: return "\u{f65b}"
        case .pinMuted14: return "\u{f65c}"
        case .pinMuted16: return "\u{f65d}"
        case .pinMuted18: return "\u{f65e}"
        case .pinMuted20: return "\u{f65f}"
        case .pinMuted24: return "\u{f660}"
        case .play12: return "\u{f661}"
        case .play16: return "\u{f662}"
        case .play20: return "\u{f663}"
        case .play24: return "\u{f664}"
        case .play28: return "\u{f665}"
        case .play32: return "\u{f666}"
        case .playCircle16: return "\u{f667}"
        case .playCircle20: return "\u{f668}"
        case .playCircle24: return "\u{f669}"
        case .playCircle28: return "\u{f66a}"
        case .playCircle32: return "\u{f66b}"
        case .plugAc24: return "\u{f66c}"
        case .plus12: return "\u{f66d}"
        case .plus14: return "\u{f66e}"
        case .plus16: return "\u{f66f}"
        case .plus18: return "\u{f670}"
        case .plus20: return "\u{f671}"
        case .plus24: return "\u{f672}"
        case .plus28: return "\u{f673}"
        case .plus8: return "\u{f674}"
        case .pmr12: return "\u{f675}"
        case .pmr16: return "\u{f676}"
        case .pmr20: return "\u{f677}"
        case .pmr24: return "\u{f678}"
        case .poll12: return "\u{f679}"
        case .poll16: return "\u{f67a}"
        case .poll20: return "\u{f67b}"
        case .poll24: return "\u{f67c}"
        case .poll36: return "\u{f67d}"
        case .popIn12: return "\u{f67e}"
        case .popIn16: return "\u{f67f}"
        case .popIn20: return "\u{f680}"
        case .popIn24: return "\u{f681}"
        case .popOut12: return "\u{f682}"
        case .popOut16: return "\u{f683}"
        case .popOut20: return "\u{f684}"
        case .popOut24: return "\u{f685}"
        case .popUp12: return "\u{f686}"
        case .popUp24: return "\u{f687}"
        case .powerAc16: return "\u{f688}"
        case .powerApps32: return "\u{f689}"
        case .presentation16: return "\u{f68a}"
        case .presentation24: return "\u{f68b}"
        case .print16: return "\u{f68c}"
        case .priority12: return "\u{f68d}"
        case .priority16: return "\u{f68e}"
        case .priority18: return "\u{f68f}"
        case .priority20: return "\u{f690}"
        case .priority24: return "\u{f691}"
        case .priority28: return "\u{f692}"
        case .priority32: return "\u{f693}"
        case .priority40: return "\u{f694}"
        case .priority44: return "\u{f695}"
        case .priority72: return "\u{f696}"
        case .private10: return "\u{f697}"
        case .private12: return "\u{f698}"
        case .private14: return "\u{f699}"
        case .private16: return "\u{f69a}"
        case .private20: return "\u{f69b}"
        case .private24: return "\u{f69c}"
        case .private28: return "\u{f69d}"
        case .private8: return "\u{f69e}"
        case .privateCircle100: return "\u{f69f}"
        case .privateCircle16: return "\u{f6a0}"
        case .privateCircle20: return "\u{f6a1}"
        case .privateCircle24: return "\u{f6a2}"
        case .privateCircle48: return "\u{f6a3}"
        case .privateCircle56: return "\u{f6a4}"
        case .privateCircleActive16: return "\u{f6a5}"
        case .privateCircleActive20: return "\u{f6a6}"
        case .privateCircleActive24: return "\u{f6a7}"
        case .proBadge28: return "\u{f6a8}"
        case .proximity12: return "\u{f6a9}"
        case .proximity16: return "\u{f6aa}"
        case .proximity20: return "\u{f6ab}"
        case .proximity24: return "\u{f6ac}"
        case .proximity28: return "\u{f6ad}"
        case .proximityMuted12: return "\u{f6ae}"
        case .proximityMuted16: return "\u{f6af}"
        case .proximityMuted24: return "\u{f6b0}"
        case .proximityMuted28: return "\u{f6b1}"
        case .pto12: return "\u{f6b2}"
        case .pto120: return "\u{f6b3}"
        case .pto124: return "\u{f6b4}"
        case .pto14: return "\u{f6b5}"
        case .pto16: return "\u{f6b6}"
        case .pto18: return "\u{f6b7}"
        case .pto20: return "\u{f6b8}"
        case .pto24: return "\u{f6b9}"
        case .pto26: return "\u{f6ba}"
        case .pto28: return "\u{f6bb}"
        case .pto32: return "\u{f6bc}"
        case .pto48: return "\u{f6bd}"
        case .pto56: return "\u{f6be}"
        case .pto8: return "\u{f6bf}"
        case .qA16: return "\u{f6c0}"
        case .qA20: return "\u{f6c1}"
        case .qA24: return "\u{f6c2}"
        case .qA36: return "\u{f6c3}"
        case .quality16: return "\u{f6c4}"
        case .quality24: return "\u{f6c5}"
        case .quiet16: return "\u{f6c6}"
        case .quiet20: return "\u{f6c7}"
        case .quiet32: return "\u{f6c8}"
        case .quiet8: return "\u{f6c9}"
        case .raiseHand12: return "\u{f6ca}"
        case .raiseHand16: return "\u{f6cb}"
        case .raiseHand20: return "\u{f6cc}"
        case .raiseHand24: return "\u{f6cd}"
        case .reactions12: return "\u{f6ce}"
        case .reactions16: return "\u{f6cf}"
        case .recents12: return "\u{f6d0}"
        case .recents14: return "\u{f6d1}"
        case .recents16: return "\u{f6d2}"
        case .recents20: return "\u{f6d3}"
        case .recents24: return "\u{f6d4}"
        case .record12: return "\u{f6d5}"
        case .record14: return "\u{f6d6}"
        case .record16: return "\u{f6d7}"
        case .record20: return "\u{f6d8}"
        case .record24: return "\u{f6d9}"
        case .record28: return "\u{f6da}"
        case .recordActive12: return "\u{f6db}"
        case .recordActive14: return "\u{f6dc}"
        case .recordActive16: return "\u{f6dd}"
        case .recordActive20: return "\u{f6de}"
        case .recordActive24: return "\u{f6df}"
        case .recordActiveBg12: return "\u{f6e0}"
        case .recordActiveBg14: return "\u{f6e1}"
        case .recordActiveBg16: return "\u{f6e2}"
        case .recordActiveBg20: return "\u{f6e3}"
        case .recordActiveBg24: return "\u{f6e4}"
        case .recordActiveCircle12: return "\u{f6e5}"
        case .recordActiveCircle14: return "\u{f6e6}"
        case .recordActiveCircle16: return "\u{f6e7}"
        case .recordActiveCircle20: return "\u{f6e8}"
        case .recordActiveCircle24: return "\u{f6e9}"
        case .recurring12: return "\u{f6ea}"
        case .recurring14: return "\u{f6eb}"
        case .recurring16: return "\u{f6ec}"
        case .recurring24: return "\u{f6ed}"
        case .redial16: return "\u{f6ee}"
        case .redial20: return "\u{f6ef}"
        case .redial24: return "\u{f6f0}"
        case .redo12: return "\u{f6f1}"
        case .redo14: return "\u{f6f2}"
        case .redo16: return "\u{f6f3}"
        case .refresh12: return "\u{f6f4}"
        case .refresh16: return "\u{f6f5}"
        case .refresh18: return "\u{f6f6}"
        case .refresh24: return "\u{f6f7}"
        case .remove12: return "\u{f6f8}"
        case .remove16: return "\u{f6f9}"
        case .remove20: return "\u{f6fa}"
        case .remove24: return "\u{f6fb}"
        case .reply12: return "\u{f6fc}"
        case .report16: return "\u{f6fd}"
        case .reset16: return "\u{f6fe}"
        case .reset24: return "\u{f6ff}"
        case .responsiveMobile16: return "\u{f700}"
        case .return12: return "\u{f701}"
        case .return16: return "\u{f702}"
        case .ringtone16: return "\u{f703}"
        case .ringtone24: return "\u{f704}"
        case .roomLights16: return "\u{f705}"
        case .roomLights24: return "\u{f706}"
        case .rssCircle24: return "\u{f707}"
        case .rssCircle32: return "\u{f708}"
        case .rssCircle40: return "\u{f709}"
        case .runningApplication16: return "\u{f70a}"
        case .runningApplication24: return "\u{f70b}"
        case .save12: return "\u{f70c}"
        case .save14: return "\u{f70d}"
        case .save16: return "\u{f70e}"
        case .save24: return "\u{f70f}"
        case .screenToggle12: return "\u{f710}"
        case .screenToggle16: return "\u{f711}"
        case .screenToggle20: return "\u{f712}"
        case .screenToggle24: return "\u{f713}"
        case .screenshot16: return "\u{f714}"
        case .screenshot20: return "\u{f715}"
        case .search12: return "\u{f716}"
        case .search16: return "\u{f717}"
        case .search18: return "\u{f718}"
        case .search20: return "\u{f719}"
        case .search24: return "\u{f71a}"
        case .search28: return "\u{f71b}"
        case .secure12: return "\u{f71c}"
        case .secure16: return "\u{f71d}"
        case .secure20: return "\u{f71e}"
        case .secure24: return "\u{f71f}"
        case .secure28: return "\u{f720}"
        case .secure8: return "\u{f721}"
        case .secureActive12: return "\u{f722}"
        case .secureActive16: return "\u{f723}"
        case .secureActive20: return "\u{f724}"
        case .secureActive24: return "\u{f725}"
        case .secureActive28: return "\u{f726}"
        case .secureActive8: return "\u{f727}"
        case .selfview16: return "\u{f728}"
        case .selfview24: return "\u{f729}"
        case .send12: return "\u{f72a}"
        case .send14: return "\u{f72b}"
        case .send16: return "\u{f72c}"
        case .send20: return "\u{f72d}"
        case .send24: return "\u{f72e}"
        case .seperate12: return "\u{f72f}"
        case .seperate16: return "\u{f730}"
        case .seperate20: return "\u{f731}"
        case .seperate24: return "\u{f732}"
        case .server16: return "\u{f733}"
        case .server24: return "\u{f734}"
        case .serverCircle100: return "\u{f735}"
        case .settings10: return "\u{f736}"
        case .settings12: return "\u{f737}"
        case .settings14: return "\u{f738}"
        case .settings16: return "\u{f739}"
        case .settings18: return "\u{f73a}"
        case .settings20: return "\u{f73b}"
        case .settings24: return "\u{f73c}"
        case .settings32: return "\u{f73d}"
        case .settings8: return "\u{f73e}"
        case .settingsActive10: return "\u{f73f}"
        case .settingsActive12: return "\u{f740}"
        case .settingsActive14: return "\u{f741}"
        case .settingsActive16: return "\u{f742}"
        case .settingsActive18: return "\u{f743}"
        case .settingsActive20: return "\u{f744}"
        case .settingsActive24: return "\u{f745}"
        case .settingsActive32: return "\u{f746}"
        case .settingsActive8: return "\u{f747}"
        case .setupAssistant16: return "\u{f748}"
        case .shakeDevice18: return "\u{f749}"
        case .shakeDevice20: return "\u{f74a}"
        case .shapeDiagonalArrowheadDual16: return "\u{f74b}"
        case .shapeDiagonalArrowheadSingle16: return "\u{f74c}"
        case .shapeDiagonalLine16: return "\u{f74d}"
        case .shapeOval16: return "\u{f74e}"
        case .shapeSquare16: return "\u{f74f}"
        case .share12: return "\u{f750}"
        case .share14: return "\u{f751}"
        case .share16: return "\u{f752}"
        case .share18: return "\u{f753}"
        case .share20: return "\u{f754}"
        case .share24: return "\u{f755}"
        case .share28: return "\u{f756}"
        case .share32: return "\u{f757}"
        case .shareCNativeAdr14: return "\u{f758}"
        case .shareCNativeAdr16: return "\u{f759}"
        case .shareCNativeAdr24: return "\u{f75a}"
        case .shareCNativeIos10: return "\u{f75b}"
        case .shareCNativeIos12: return "\u{f75c}"
        case .shareCNativeIos14: return "\u{f75d}"
        case .shareCNativeIos16: return "\u{f75e}"
        case .shareCNativeIos20: return "\u{f75f}"
        case .shareCNativeIos28: return "\u{f760}"
        case .shareCNativeIph10: return "\u{f761}"
        case .shareCNativeIph12: return "\u{f762}"
        case .shareCNativeIph14: return "\u{f763}"
        case .shareCNativeIph16: return "\u{f764}"
        case .shareCNativeIph20: return "\u{f765}"
        case .shareCNativeIph24: return "\u{f766}"
        case .shareCNativeIph28: return "\u{f767}"
        case .shareScreen10: return "\u{f768}"
        case .shareScreen12: return "\u{f769}"
        case .shareScreen120: return "\u{f76a}"
        case .shareScreen124: return "\u{f76b}"
        case .shareScreen14: return "\u{f76c}"
        case .shareScreen16: return "\u{f76d}"
        case .shareScreen18: return "\u{f76e}"
        case .shareScreen20: return "\u{f76f}"
        case .shareScreen24: return "\u{f770}"
        case .shareScreen26: return "\u{f771}"
        case .shareScreen28: return "\u{f772}"
        case .shareScreen32: return "\u{f773}"
        case .shareScreen36: return "\u{f774}"
        case .shareScreen48: return "\u{f775}"
        case .shareScreen56: return "\u{f776}"
        case .shareScreen8: return "\u{f777}"
        case .shareSpace12: return "\u{f778}"
        case .shareSpace14: return "\u{f779}"
        case .shareSpace18: return "\u{f77a}"
        case .shareSpace20: return "\u{f77b}"
        case .shareSpace24: return "\u{f77c}"
        case .show12: return "\u{f77d}"
        case .show16: return "\u{f77e}"
        case .show20: return "\u{f77f}"
        case .show24: return "\u{f780}"
        case .signIn16: return "\u{f781}"
        case .signIn20: return "\u{f782}"
        case .signIn24: return "\u{f783}"
        case .signInForced16: return "\u{f784}"
        case .signInForced24: return "\u{f785}"
        case .signOut10: return "\u{f786}"
        case .signOut12: return "\u{f787}"
        case .signOut16: return "\u{f788}"
        case .signOut24: return "\u{f789}"
        case .signal016: return "\u{f78a}"
        case .signal10016: return "\u{f78b}"
        case .signal2516: return "\u{f78c}"
        case .signal5016: return "\u{f78d}"
        case .signal7516: return "\u{f78e}"
        case .singleNumberReach12: return "\u{f78f}"
        case .singleNumberReach16: return "\u{f790}"
        case .skip10: return "\u{f791}"
        case .skip16: return "\u{f792}"
        case .skip24: return "\u{f793}"
        case .skipBw16: return "\u{f794}"
        case .skipBw24: return "\u{f795}"
        case .skipFw16: return "\u{f796}"
        case .skipFw24: return "\u{f797}"
        case .space16: return "\u{f798}"
        case .spark16: return "\u{f799}"
        case .sparkBoard12: return "\u{f79a}"
        case .sparkBoard14: return "\u{f79b}"
        case .sparkBoard16: return "\u{f79c}"
        case .sparkBoard20: return "\u{f79d}"
        case .sparkBoard24: return "\u{f79e}"
        case .sparkBoard28: return "\u{f79f}"
        case .sparkBoard32: return "\u{f7a0}"
        case .sparkBoard48: return "\u{f7a1}"
        case .sparkQuadCamera16: return "\u{f7a2}"
        case .sparkQuadCamera20: return "\u{f7a3}"
        case .sparkRoomKit16: return "\u{f7a4}"
        case .sparkRoomKit20: return "\u{f7a5}"
        case .sparkRoomKitPlus16: return "\u{f7a6}"
        case .sparkRoomKitPlus20: return "\u{f7a7}"
        case .sparkShare16: return "\u{f7a8}"
        case .sparkShare20: return "\u{f7a9}"
        case .sparkVoice16: return "\u{f7aa}"
        case .sparkVoice20: return "\u{f7ab}"
        case .speaker12: return "\u{f7ac}"
        case .speaker16: return "\u{f7ad}"
        case .speaker20: return "\u{f7ae}"
        case .speaker24: return "\u{f7af}"
        case .speaker28: return "\u{f7b0}"
        case .speakerBluetooth16: return "\u{f7b1}"
        case .speakerDisconnected12: return "\u{f7b2}"
        case .speakerDisconnected14: return "\u{f7b3}"
        case .speakerDisconnected16: return "\u{f7b4}"
        case .speakerDisconnected20: return "\u{f7b5}"
        case .speakerDisconnected24: return "\u{f7b6}"
        case .speakerDisconnected28: return "\u{f7b7}"
        case .speakerLineOutLeft16: return "\u{f7b8}"
        case .speakerLineOutRight16: return "\u{f7b9}"
        case .speakerMuted12: return "\u{f7ba}"
        case .speakerMuted16: return "\u{f7bb}"
        case .speakerMuted24: return "\u{f7bc}"
        case .speakerMuted28: return "\u{f7bd}"
        case .speakerOff16: return "\u{f7be}"
        case .speakerOff24: return "\u{f7bf}"
        case .speakerOff28: return "\u{f7c0}"
        case .spinner12: return "\u{f7c1}"
        case .spinner14: return "\u{f7c2}"
        case .spinner16: return "\u{f7c3}"
        case .spinner18: return "\u{f7c4}"
        case .spinner20: return "\u{f7c5}"
        case .spinner24: return "\u{f7c6}"
        case .spinner28: return "\u{f7c7}"
        case .spinner32: return "\u{f7c8}"
        case .spinner36: return "\u{f7c9}"
        case .spinner40: return "\u{f7ca}"
        case .spinner48: return "\u{f7cb}"
        case .spinner56: return "\u{f7cc}"
        case .spinner8: return "\u{f7cd}"
        case .spinner80: return "\u{f7ce}"
        case .spreadsheet16: return "\u{f7cf}"
        case .stickers16: return "\u{f7d0}"
        case .stickers24: return "\u{f7d1}"
        case .stickies12: return "\u{f7d2}"
        case .stickies16: return "\u{f7d3}"
        case .stickies24: return "\u{f7d4}"
        case .stop16: return "\u{f7d5}"
        case .stop20: return "\u{f7d6}"
        case .stop24: return "\u{f7d7}"
        case .stopCircle16: return "\u{f7d8}"
        case .stopCircle20: return "\u{f7d9}"
        case .stopCircle24: return "\u{f7da}"
        case .storedInfo16: return "\u{f7db}"
        case .storedInfo20: return "\u{f7dc}"
        case .storedInfo24: return "\u{f7dd}"
        case .streaming16: return "\u{f7de}"
        case .streaming20: return "\u{f7df}"
        case .streaming24: return "\u{f7e0}"
        case .subscribe16: return "\u{f7e1}"
        case .swift16: return "\u{f7e2}"
        case .sx1016: return "\u{f7e3}"
        case .sx1020: return "\u{f7e4}"
        case .sx2016: return "\u{f7e5}"
        case .sx2020: return "\u{f7e6}"
        case .sx80Codec16: return "\u{f7e7}"
        case .sx80Codec20: return "\u{f7e8}"
        case .tablet16: return "\u{f7e9}"
        case .tablet24: return "\u{f7ea}"
        case .tag16: return "\u{f7eb}"
        case .tag20: return "\u{f7ec}"
        case .tasks10: return "\u{f7ed}"
        case .tasks12: return "\u{f7ee}"
        case .tasks14: return "\u{f7ef}"
        case .tasks16: return "\u{f7f0}"
        case .tasks18: return "\u{f7f1}"
        case .tasks20: return "\u{f7f2}"
        case .tasks24: return "\u{f7f3}"
        case .tasks26: return "\u{f7f4}"
        case .tasks28: return "\u{f7f5}"
        case .tasks32: return "\u{f7f6}"
        case .tasks36: return "\u{f7f7}"
        case .tasks8: return "\u{f7f8}"
        case .team12: return "\u{f7f9}"
        case .team14: return "\u{f7fa}"
        case .team16: return "\u{f7fb}"
        case .team18: return "\u{f7fc}"
        case .team20: return "\u{f7fd}"
        case .team24: return "\u{f7fe}"
        case .team32: return "\u{f7ff}"
        case .teamActive12: return "\u{f800}"
        case .teamActive14: return "\u{f801}"
        case .teamActive16: return "\u{f802}"
        case .teamActive20: return "\u{f803}"
        case .teamActive24: return "\u{f804}"
        case .teamActive32: return "\u{f805}"
        case .telepresence12: return "\u{f806}"
        case .telepresence16: return "\u{f807}"
        case .telepresence20: return "\u{f808}"
        case .telepresence24: return "\u{f809}"
        case .telepresence64: return "\u{f80a}"
        case .telepresenceAlert12: return "\u{f80b}"
        case .telepresenceIx500016: return "\u{f80c}"
        case .telepresenceIx500020: return "\u{f80d}"
        case .telepresenceMuted12: return "\u{f80e}"
        case .telepresenceMuted64: return "\u{f80f}"
        case .telepresenceMutedAlert12: return "\u{f810}"
        case .telepresencePrivate12: return "\u{f811}"
        case .text10: return "\u{f812}"
        case .text12: return "\u{f813}"
        case .textAlignLeft16: return "\u{f814}"
        case .textAlignRight16: return "\u{f815}"
        case .textBlockquote12: return "\u{f816}"
        case .textBlockquote16: return "\u{f817}"
        case .textBlockquote8: return "\u{f818}"
        case .textBold12: return "\u{f819}"
        case .textBold16: return "\u{f81a}"
        case .textCodeBlock12: return "\u{f81b}"
        case .textCodeBlock16: return "\u{f81c}"
        case .textColor16: return "\u{f81d}"
        case .textFormat12: return "\u{f81e}"
        case .textFormat16: return "\u{f81f}"
        case .textFormat8: return "\u{f820}"
        case .textHeading112: return "\u{f821}"
        case .textHeading116: return "\u{f822}"
        case .textHeading212: return "\u{f823}"
        case .textHeading216: return "\u{f824}"
        case .textHeading312: return "\u{f825}"
        case .textHeading316: return "\u{f826}"
        case .textItalic12: return "\u{f827}"
        case .textItalic16: return "\u{f828}"
        case .textListBulleted12: return "\u{f829}"
        case .textListBulleted16: return "\u{f82a}"
        case .textListBulleted8: return "\u{f82b}"
        case .textListNumbered12: return "\u{f82c}"
        case .textListNumbered16: return "\u{f82d}"
        case .textStrikethrough16: return "\u{f82e}"
        case .textTable16: return "\u{f82f}"
        case .textUnderline12: return "\u{f830}"
        case .textUnderline16: return "\u{f831}"
        case .tooFast12: return "\u{f832}"
        case .tooFast16: return "\u{f833}"
        case .tooSlow12: return "\u{f834}"
        case .tooSlow16: return "\u{f835}"
        case .tools16: return "\u{f836}"
        case .tools24: return "\u{f837}"
        case .tools32: return "\u{f838}"
        case .touch16: return "\u{f839}"
        case .touch1024: return "\u{f83a}"
        case .transcript16: return "\u{f83b}"
        case .twitterCircle24: return "\u{f83c}"
        case .twitterCircle32: return "\u{f83d}"
        case .twitterCircle40: return "\u{f83e}"
        case .undo12: return "\u{f83f}"
        case .undo14: return "\u{f840}"
        case .undo16: return "\u{f841}"
        case .unreadBadge10: return "\u{f842}"
        case .unreadBadge12: return "\u{f843}"
        case .unreadBadge16: return "\u{f844}"
        case .unreadBadge8: return "\u{f845}"
        case .unsecure12: return "\u{f846}"
        case .unsecure16: return "\u{f847}"
        case .unsecure24: return "\u{f848}"
        case .unsecure28: return "\u{f849}"
        case .upload12: return "\u{f84a}"
        case .upload14: return "\u{f84b}"
        case .upload16: return "\u{f84c}"
        case .upload18: return "\u{f84d}"
        case .upload20: return "\u{f84e}"
        case .upload24: return "\u{f84f}"
        case .upload28: return "\u{f850}"
        case .upload32: return "\u{f851}"
        case .upload36: return "\u{f852}"
        case .usb16: return "\u{f853}"
        case .user16: return "\u{f854}"
        case .user20: return "\u{f855}"
        case .user24: return "\u{f856}"
        case .user56: return "\u{f857}"
        case .videoLayout12: return "\u{f858}"
        case .videoLayout16: return "\u{f859}"
        case .videoLayoutAuto12: return "\u{f85a}"
        case .videoLayoutAuto16: return "\u{f85b}"
        case .videoLayoutAuto20: return "\u{f85c}"
        case .videoLayoutAuto24: return "\u{f85d}"
        case .videoLayoutEqual12: return "\u{f85e}"
        case .videoLayoutEqual16: return "\u{f85f}"
        case .videoLayoutEqual20: return "\u{f860}"
        case .videoLayoutEqual24: return "\u{f861}"
        case .videoLayoutOverlay12: return "\u{f862}"
        case .videoLayoutOverlay16: return "\u{f863}"
        case .videoLayoutOverlay20: return "\u{f864}"
        case .videoLayoutOverlay24: return "\u{f865}"
        case .videoLayoutProminent12: return "\u{f866}"
        case .videoLayoutProminent16: return "\u{f867}"
        case .videoLayoutProminent20: return "\u{f868}"
        case .videoLayoutProminent24: return "\u{f869}"
        case .videoLayoutShareDominant12: return "\u{f86a}"
        case .videoLayoutShareDominant16: return "\u{f86b}"
        case .videoLayoutShareDominant20: return "\u{f86c}"
        case .videoLayoutShareDominant24: return "\u{f86d}"
        case .videoLayoutSingle16: return "\u{f86e}"
        case .videoLayoutSingle20: return "\u{f86f}"
        case .videoLayoutVideoDominant12: return "\u{f870}"
        case .videoLayoutVideoDominant16: return "\u{f871}"
        case .videoLayoutVideoDominant20: return "\u{f872}"
        case .videoLayoutVideoDominant24: return "\u{f873}"
        case .viewAll12: return "\u{f874}"
        case .viewAll14: return "\u{f875}"
        case .viewFeedMultiple16: return "\u{f876}"
        case .viewFeedPanel16: return "\u{f877}"
        case .viewFeedSingle16: return "\u{f878}"
        case .viewList12: return "\u{f879}"
        case .viewList14: return "\u{f87a}"
        case .viewList16: return "\u{f87b}"
        case .viewList20: return "\u{f87c}"
        case .viewList24: return "\u{f87d}"
        case .viewList28: return "\u{f87e}"
        case .viewListCircle100: return "\u{f87f}"
        case .viewMixed12: return "\u{f880}"
        case .viewStack12: return "\u{f881}"
        case .viewStack14: return "\u{f882}"
        case .viewStack20: return "\u{f883}"
        case .viewStack24: return "\u{f884}"
        case .viewThumbnail12: return "\u{f885}"
        case .viewThumbnail14: return "\u{f886}"
        case .viewThumbnail16: return "\u{f887}"
        case .viewThumbnail20: return "\u{f888}"
        case .viewThumbnail24: return "\u{f889}"
        case .voicemail16: return "\u{f88a}"
        case .voicemail20: return "\u{f88b}"
        case .voicemail24: return "\u{f88c}"
        case .voicemail28: return "\u{f88d}"
        case .wallpaper16: return "\u{f88e}"
        case .wallpaper20: return "\u{f88f}"
        case .wallpaper24: return "\u{f890}"
        case .wallpaper28: return "\u{f891}"
        case .wallpaper32: return "\u{f892}"
        case .warning100: return "\u{f893}"
        case .warning12: return "\u{f894}"
        case .warning16: return "\u{f895}"
        case .warning20: return "\u{f896}"
        case .warning24: return "\u{f897}"
        case .warning28: return "\u{f898}"
        case .warning32: return "\u{f899}"
        case .warning40: return "\u{f89a}"
        case .warning44: return "\u{f89b}"
        case .warning56: return "\u{f89c}"
        case .warning64: return "\u{f89d}"
        case .warning72: return "\u{f89e}"
        case .webSharing16: return "\u{f89f}"
        case .webSharing24: return "\u{f8a0}"
        case .webex10: return "\u{f8a1}"
        case .webex16: return "\u{f8a2}"
        case .webex24: return "\u{f8a3}"
        case .webex48: return "\u{f8a4}"
        case .webexBoard12: return "\u{f8a5}"
        case .webexBoard14: return "\u{f8a6}"
        case .webexBoard16: return "\u{f8a7}"
        case .webexBoard20: return "\u{f8a8}"
        case .webexBoard24: return "\u{f8a9}"
        case .webexBoard28: return "\u{f8aa}"
        case .webexBoard32: return "\u{f8ab}"
        case .webexBoard48: return "\u{f8ac}"
        case .webexCodecPlus16: return "\u{f8ad}"
        case .webexCodecPlus20: return "\u{f8ae}"
        case .webexInstantMeeting16: return "\u{f8af}"
        case .webexInstantMeeting20: return "\u{f8b0}"
        case .webexInstantMeeting24: return "\u{f8b1}"
        case .webexMeetings10: return "\u{f8b2}"
        case .webexMeetings12: return "\u{f8b3}"
        case .webexMeetings16: return "\u{f8b4}"
        case .webexMeetings20: return "\u{f8b5}"
        case .webexMeetings24: return "\u{f8b6}"
        case .webexMeetings48: return "\u{f8b7}"
        case .webexQuadCamera16: return "\u{f8b8}"
        case .webexQuadCamera20: return "\u{f8b9}"
        case .webexRoomKit16: return "\u{f8ba}"
        case .webexRoomKit20: return "\u{f8bb}"
        case .webexRoomKitPlus16: return "\u{f8bc}"
        case .webexRoomKitPlus20: return "\u{f8bd}"
        case .webexShare16: return "\u{f8be}"
        case .webexShare20: return "\u{f8bf}"
        case .webexTeams10: return "\u{f8c0}"
        case .webexTeams12: return "\u{f8c1}"
        case .webexTeams16: return "\u{f8c2}"
        case .webexTeams18: return "\u{f8c3}"
        case .webexVoice16: return "\u{f8c4}"
        case .webexVoice20: return "\u{f8c5}"
        case .whiteboard10: return "\u{f8c6}"
        case .whiteboard12: return "\u{f8c7}"
        case .whiteboard14: return "\u{f8c8}"
        case .whiteboard16: return "\u{f8c9}"
        case .whiteboard24: return "\u{f8ca}"
        case .whiteboard26: return "\u{f8cb}"
        case .whiteboard28: return "\u{f8cc}"
        case .whiteboard32: return "\u{f8cd}"
        case .whiteboard36: return "\u{f8ce}"
        case .whiteboard8: return "\u{f8cf}"
        case .whiteboardContent16: return "\u{f8d0}"
        case .whiteboardContent24: return "\u{f8d1}"
        case .wifi16: return "\u{f8d2}"
        case .wifi20: return "\u{f8d3}"
        case .wifi24: return "\u{f8d4}"
        case .windowCornerScrub16: return "\u{f8d5}"
        case .windowVerticalScrub16: return "\u{f8d6}"
        case .youtubeCircle24: return "\u{f8d7}"
        case .youtubeCircle32: return "\u{f8d8}"
        case .youtubeCircle40: return "\u{f8d9}"
        case .zoomIn12: return "\u{f8da}"
        case .zoomIn16: return "\u{f8db}"
        case .zoomOut12: return "\u{f8dc}"
        case .zoomOut16: return "\u{f8dd}"
        }
    }
}
