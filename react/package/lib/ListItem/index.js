...
var ListItem = /*#__PURE__*/function (_React$Component) {
    ...
    _this.handleBlur = function (e) {
      ...
      if (focusLockTabbableChildren) {
        if (e.target && e.relatedTarget) {
          ...
          var listItemNode = _reactDom.default.findDOMNode(_assertThisInitialized(_this));
  ...
  _proto.render = function render() {
    ...
    var _this$props5 = this.props,
        ...
        props = _objectWithoutPropertiesLoose(_this$props5, ["active", "children", "className", "customAnchorNode", "customRefProp", "disabled", "eventKey", "focus", "isReadOnly", "keyboardKey", "label", "link", "refName", "role", "separator", "title", "type"]);

    var keyboardNavKey = (0, _SelectableContext.makeKeyboardKey)(keyboardKey || title || label);
    var otherProps = (0, _omit.default)(_extends({}, props), ['focusLockTabbableChildren', 'focusLockTabbableChildrenProps', 'focusOnLoad', 'id', 'itemIndex', 'onBlur', 'onClick', 'onKeyDown', 'parentKeyDown', 'parentOnSelect', 'value']);
    ...
    var addRefToAnchor = function addRefToAnchor(cxtProps) {
      return /*#__PURE__*/_react.default.cloneElement(customAnchorNode, setProps(cxtProps), children || customAnchorNode.props.children || label);
    };

    var createElement = function createElement(cxtProps) {
      return /*#__PURE__*/_react.default.createElement(link ? 'a' : 'div', setProps(cxtProps), children || label);
    };
