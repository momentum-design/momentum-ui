...
@objc public enum MomentumIconsRebrandType: Int {
    ...
    public var ligature: String {
        ...
        case .checkCircleLight: return "\u{f2ed}"
        case .checkCircleRegular: return "\u{f2ee}"
        case .checkCircleBadgeFilled: return "\u{f2ef}"
        case .checkCircleBold: return "\u{f2f0}"
        case .checkCircleFilled: return "\u{f2f1}"
        case .checkCircleLight: return "\u{f2f2}"
        case .checkCircleRegular: return "\u{f2f3}"
        case .checkLight: return "\u{f2f4}"
        case .checkRegular: return "\u{f2f5}"
        case .checkboxGroupBold: return "\u{f2f6}"
        case .checkboxGroupLight: return "\u{f2f7}"
        case .checkboxGroupRegular: return "\u{f2f8}"
        case .clearBold: return "\u{f2f9}"
        case .clearFilled: return "\u{f2fa}"
        case .clearLight: return "\u{f2fb}"
        case .clearRegular: return "\u{f2fc}"
        case .closeSpaceBold: return "\u{f2fd}"
        case .closeSpaceLight: return "\u{f2fe}"
        case .closeSpaceRegular: return "\u{f2ff}"
        case .closedCaptionBadgeBold: return "\u{f300}"
        case .closedCaptionBadgeLight: return "\u{f301}"
        case .closedCaptionBadgeRegular: return "\u{f302}"
        case .closedCaptionsBold: return "\u{f303}"
        case .closedCaptionsFilled: return "\u{f304}"
        case .closedCaptionsLight: return "\u{f305}"
        case .closedCaptionsRegular: return "\u{f306}"
        case .cloudBold: return "\u{f307}"
        case .cloudFilled: return "\u{f308}"
        case .cloudFrameBold: return "\u{f309}"
        case .cloudFrameFilled: return "\u{f30a}"
        case .cloudFrameRegular: return "\u{f30b}"
        case .cloudFramedFilled: return "\u{f30c}"
        case .cloudFramedLight: return "\u{f30d}"
        case .cloudLight: return "\u{f30e}"
        case .cloudMutedBold: return "\u{f30f}"
        case .cloudMutedFilled: return "\u{f310}"
        case .cloudMutedLight: return "\u{f311}"
        case .cloudMutedRegular: return "\u{f312}"
        case .cloudRegular: return "\u{f313}"
        case .cloudUploadBold: return "\u{f314}"
        case .cloudUploadLight: return "\u{f315}"
        case .cloudUploadRegular: return "\u{f316}"
        case .codeBlockBold: return "\u{f317}"
        case .codeBlockLight: return "\u{f318}"
        case .codeBlockRegular: return "\u{f319}"
        case .colorBold: return "\u{f31a}"
        case .colorLight: return "\u{f31b}"
        case .colorRegular: return "\u{f31c}"
        case .colourPaletteBold: return "\u{f31d}"
        case .colourPaletteFilled: return "\u{f31e}"
        case .colourPaletteLight: return "\u{f31f}"
        case .colourPaletteRegular: return "\u{f320}"
        case .commentingBold: return "\u{f321}"
        case .commentingFilled: return "\u{f322}"
        case .commentingLight: return "\u{f323}"
        case .commentingRegular: return "\u{f324}"
        case .companyBold: return "\u{f325}"
        case .companyLight: return "\u{f326}"
        case .companyRegular: return "\u{f327}"
        case .completedByTimeBold: return "\u{f328}"
        case .completedByTimeLight: return "\u{f329}"
        case .completedByTimeRegular: return "\u{f32a}"
        case .computerBold: return "\u{f32b}"
        case .computerLight: return "\u{f32c}"
        case .computerRegular: return "\u{f32d}"
        case .conciergeBold: return "\u{f32e}"
        case .conciergeLight: return "\u{f32f}"
        case .conciergeRegular: return "\u{f330}"
        case .conditionalBlockBold: return "\u{f331}"
        case .conditionalBlockLight: return "\u{f332}"
        case .conditionalBlockRegular: return "\u{f333}"
        case .contactCardBold: return "\u{f334}"
        case .contactCardFilled: return "\u{f335}"
        case .contactCardLight: return "\u{f336}"
        case .contactCardRegular: return "\u{f337}"
        case .contactGroupBold: return "\u{f338}"
        case .contactGroupFilled: return "\u{f339}"
        case .contactGroupLight: return "\u{f33a}"
        case .contactGroupRegular: return "\u{f33b}"
        case .contactsBold: return "\u{f33c}"
        case .contactsFilled: return "\u{f33d}"
        case .contactsLight: return "\u{f33e}"
        case .contactsRegular: return "\u{f33f}"
        case .contentDownloadBold: return "\u{f340}"
        case .contentDownloadFilled: return "\u{f341}"
        case .contentDownloadLight: return "\u{f342}"
        case .contentDownloadRegular: return "\u{f343}"
        case .contentShareBold: return "\u{f344}"
        case .contentShareLight: return "\u{f345}"
        case .contentShareRegular: return "\u{f346}"
        case .contrastBold: return "\u{f347}"
        case .contrastLight: return "\u{f348}"
        case .contrastRegular: return "\u{f349}"
        case .copyBold: return "\u{f34a}"
        case .copyLight: return "\u{f34b}"
        case .copyRegular: return "\u{f34c}"
        case .cpuBold: return "\u{f34d}"
        case .cpuLight: return "\u{f34e}"
        case .cpuRegular: return "\u{f34f}"
        case .createAGroupBold: return "\u{f350}"
        case .createAGroupFilled: return "\u{f351}"
        case .createAGroupLight: return "\u{f352}"
        case .createAGroupRegular: return "\u{f353}"
        case .cropBold: return "\u{f354}"
        case .cropLight: return "\u{f355}"
        case .cropRegular: return "\u{f356}"
        case .cucmConnectionBold: return "\u{f357}"
        case .cucmConnectionLight: return "\u{f358}"
        case .cucmConnectionRegular: return "\u{f359}"
        case .dailyRecurringScheduleNodeBold: return "\u{f35a}"
        case .dailyRecurringScheduleNodeLight: return "\u{f35b}"
        case .dailyRecurringScheduleNodeRegular: return "\u{f35c}"
        case .dashboardBold: return "\u{f35d}"
        case .dashboardFilled: return "\u{f35e}"
        case .dashboardLight: return "\u{f35f}"
        case .dashboardRegular: return "\u{f360}"
        case .dataManagement1: return "\u{f361}"
        case .dataManagement2: return "\u{f362}"
        case .dataManagement: return "\u{f363}"
        case .deleteBold: return "\u{f364}"
        case .deleteFilled: return "\u{f365}"
        case .deleteLight: return "\u{f366}"
        case .deleteRegular: return "\u{f367}"
        case .deskPhoneBold: return "\u{f368}"
        case .deskPhoneFilled: return "\u{f369}"
        case .deskPhoneLight: return "\u{f36a}"
        case .deskPhoneRegular: return "\u{f36b}"
        case .deskPhoneWarningBold: return "\u{f36c}"
        case .deskPhoneWarningLight: return "\u{f36d}"
        case .deskPhoneWarningRegular: return "\u{f36e}"
        case .deviceConnectionBold: return "\u{f36f}"
        case .deviceConnectionFilled: return "\u{f370}"
        case .deviceConnectionLight: return "\u{f371}"
        case .deviceConnectionRegular: return "\u{f372}"
        case .devicePolicyControllerBold: return "\u{f373}"
        case .devicePolicyControllerLight: return "\u{f374}"
        case .devicePolicyControllerRegular: return "\u{f375}"
        case .diagnosticsBold: return "\u{f376}"
        case .diagnosticsLight: return "\u{f377}"
        case .diagnosticsRegular: return "\u{f378}"
        case .dialpadBold: return "\u{f379}"
        case .dialpadLight: return "\u{f37a}"
        case .dialpadRegular: return "\u{f37b}"
        case .directionalPadBold: return "\u{f37c}"
        case .directionalPadFilled: return "\u{f37d}"
        case .directionalPadLight: return "\u{f37e}"
        case .directionalPadRegular: return "\u{f37f}"
        case .directoryBold: return "\u{f380}"
        case .directoryLight: return "\u{f381}"
        case .directoryRegular: return "\u{f382}"
        case .discBold: return "\u{f383}"
        case .discDisconnectedBold: return "\u{f384}"
        case .discDisconnectedLight: return "\u{f385}"
        case .discDisconnectedRegular: return "\u{f386}"
        case .discLight: return "\u{f387}"
        case .discRegular: return "\u{f388}"
        case .disconnectBold: return "\u{f389}"
        case .disconnectLight: return "\u{f38a}"
        case .disconnectRegular: return "\u{f38b}"
        case .dislikeBold: return "\u{f38c}"
        case .dislikeFilled: return "\u{f38d}"
        case .dislikeLight: return "\u{f38e}"
        case .dislikeRegular: return "\u{f38f}"
        case .displayBold: return "\u{f390}"
        case .displayInputBold: return "\u{f391}"
        case .displayInputLight: return "\u{f392}"
        case .displayInputRegular: return "\u{f393}"
        case .displayLight: return "\u{f394}"
        case .displayRegular: return "\u{f395}"
        case .displayWarningBold: return "\u{f396}"
        case .displayWarningLight: return "\u{f397}"
        case .displayWarningRegular: return "\u{f398}"
        case .dndPresenceBold: return "\u{f399}"
        case .dndPresenceFilled: return "\u{f39a}"
        case .dndPresenceLight: return "\u{f39b}"
        case .dndPresenceRegular: return "\u{f39c}"
        case .dndPresenceSmallFilled: return "\u{f39d}"
        case .documentBold: return "\u{f39e}"
        case .documentCameraBold: return "\u{f39f}"
        case .documentCameraDisconnectedBold: return "\u{f3a0}"
        case .documentCameraDisconnectedLight: return "\u{f3a1}"
        case .documentCameraDisconnectedRegular: return "\u{f3a2}"
        case .documentCameraLight: return "\u{f3a3}"
        case .documentCameraRegular: return "\u{f3a4}"
        case .documentCreateBold: return "\u{f3a5}"
        case .documentCreateFilled: return "\u{f3a6}"
        case .documentCreateLight: return "\u{f3a7}"
        case .documentCreateRegular: return "\u{f3a8}"
        case .documentFilled: return "\u{f3a9}"
        case .documentLight: return "\u{f3aa}"
        case .documentMoveBold: return "\u{f3ab}"
        case .documentMoveFilled: return "\u{f3ac}"
        case .documentMoveLight: return "\u{f3ad}"
        case .documentMoveRegular: return "\u{f3ae}"
        case .documentRegular: return "\u{f3af}"
        case .documentShareBold: return "\u{f3b0}"
        case .documentShareFilled: return "\u{f3b1}"
        case .documentShareLight: return "\u{f3b2}"
        case .documentShareRegular: return "\u{f3b3}"
        case .doneAllBold: return "\u{f3b4}"
        case .doneAllLight: return "\u{f3b5}"
        case .doneAllRegular: return "\u{f3b6}"
        case .donutChartBold: return "\u{f3b7}"
        case .donutChartFilled: return "\u{f3b8}"
        case .donutChartLight: return "\u{f3b9}"
        case .donutChartRegular: return "\u{f3ba}"
        case .downloadBold: return "\u{f3bb}"
        case .downloadFilled: return "\u{f3bc}"
        case .downloadLight: return "\u{f3bd}"
        case .downloadRegular: return "\u{f3be}"
        case .draftBold: return "\u{f3bf}"
        case .draftFilled: return "\u{f3c0}"
        case .draftIndicatorBold: return "\u{f3c1}"
        case .draftIndicatorSmallFilled: return "\u{f3c2}"
        case .draftLight: return "\u{f3c3}"
        case .draftRegular: return "\u{f3c4}"
        case .dragBold: return "\u{f3c5}"
        case .dragLight: return "\u{f3c6}"
        case .dragRegular: return "\u{f3c7}"
        case .dropdownBold: return "\u{f3c8}"
        case .dropdownLight: return "\u{f3c9}"
        case .dropdownRegular: return "\u{f3ca}"
        case .dx70Bold: return "\u{f3cb}"
        case .dx70Light: return "\u{f3cc}"
        case .dx70Regular: return "\u{f3cd}"
        case .dx80Bold: return "\u{f3ce}"
        case .dx80Filled: return "\u{f3cf}"
        case .dx80Light: return "\u{f3d0}"
        case .dx80Regular: return "\u{f3d1}"
        case .editBold: return "\u{f3d2}"
        case .editLight: return "\u{f3d3}"
        case .editRegular: return "\u{f3d4}"
        case .editablePartialBold: return "\u{f3d5}"
        case .editablePartialLight: return "\u{f3d6}"
        case .editablePartialRegular: return "\u{f3d7}"
        case .educationBold: return "\u{f3d8}"
        case .educationFilled: return "\u{f3d9}"
        case .educationLight: return "\u{f3da}"
        case .educationRegular: return "\u{f3db}"
        case .emailBold: return "\u{f3dc}"
        case .emailDeliveredBold: return "\u{f3dd}"
        case .emailDeliveredLight: return "\u{f3de}"
        case .emailDeliveredRegular: return "\u{f3df}"
        case .emailFailureBold: return "\u{f3e0}"
        case .emailFailureLight: return "\u{f3e1}"
        case .emailFailureRegular: return "\u{f3e2}"
        case .emailFilled: return "\u{f3e3}"
        case .emailInviteBold: return "\u{f3e4}"
        case .emailInviteLight: return "\u{f3e5}"
        case .emailInviteRegular: return "\u{f3e6}"
        case .emailLight: return "\u{f3e7}"
        case .emailReadBold: return "\u{f3e8}"
        case .emailReadFilled: return "\u{f3e9}"
        case .emailReadLight: return "\u{f3ea}"
        case .emailReadRegular: return "\u{f3eb}"
        case .emailRegular: return "\u{f3ec}"
        case .emojiExcitedBold: return "\u{f3ed}"
        case .emojiExcitedFilled: return "\u{f3ee}"
        case .emojiHappyBold: return "\u{f3ef}"
        case .emojiHappyFilled: return "\u{f3f0}"
        case .emojiHappyLight: return "\u{f3f1}"
        case .emojiHappyRegular: return "\u{f3f2}"
        case .emojiPassiveBold: return "\u{f3f3}"
        case .emojiPassiveFilled: return "\u{f3f4}"
        case .emojiPassiveLight: return "\u{f3f5}"
        case .emojiPassiveRegular: return "\u{f3f6}"
        case .emojiSadBold: return "\u{f3f7}"
        case .emojiSadFilled: return "\u{f3f8}"
        case .emojiSadLight: return "\u{f3f9}"
        case .emojiSadRegular: return "\u{f3fa}"
        case .emojiUnhappyBold: return "\u{f3fb}"
        case .emojiUnhappyFilled: return "\u{f3fc}"
        case .encryptionCircleFilled: return "\u{f3fd}"
        case .encryptionFilled: return "\u{f3fe}"
        case .endRemoteDesktopControlBold: return "\u{f3ff}"
        case .endRemoteDesktopControlLight: return "\u{f400}"
        case .endRemoteDesktopControlRegular: return "\u{f401}"
        case .endToEndEncryptionCircleFilled: return "\u{f402}"
        case .endToEndEncryptionFilled: return "\u{f403}"
        case .endpointBlockedBold: return "\u{f404}"
        case .endpointBlockedLight: return "\u{f405}"
        case .endpointBlockedRegular: return "\u{f406}"
        case .endpointBold: return "\u{f407}"
        case .endpointG270Bold: return "\u{f408}"
        case .endpointG270DualBold: return "\u{f409}"
        case .endpointG270DualLight: return "\u{f40a}"
        case .endpointG270DualRegular: return "\u{f40b}"
        case .endpointG270Light: return "\u{f40c}"
        case .endpointG270Regular: return "\u{f40d}"
        case .endpointG2Bold: return "\u{f40e}"
        case .endpointG2Light: return "\u{f40f}"
        case .endpointG2Regular: return "\u{f410}"
        case .endpointG2StandBold: return "\u{f411}"
        case .endpointG2StandLight: return "\u{f412}"
        case .endpointG2StandRegular: return "\u{f413}"
        case .endpointLight: return "\u{f414}"
        case .endpointMx800Bold: return "\u{f415}"
        case .endpointMx800DualBold: return "\u{f416}"
        case .endpointMx800DualLight: return "\u{f417}"
        case .endpointMx800DualRegular: return "\u{f418}"
        case .endpointMx800Light: return "\u{f419}"
        case .endpointMx800Regular: return "\u{f41a}"
        case .endpointRegular: return "\u{f41b}"
        case .endpointStandBold: return "\u{f41c}"
        case .endpointStandFilled: return "\u{f41d}"
        case .endpointStandLight: return "\u{f41e}"
        case .endpointStandRegular: return "\u{f41f}"
        case .endpointWarningBold: return "\u{f420}"
        case .endpointWarningLight: return "\u{f421}"
        case .endpointWarningRegular: return "\u{f422}"
        case .enterBold: return "\u{f423}"
        case .enterLight: return "\u{f424}"
        case .enterRegular: return "\u{f425}"
        case .enterRoomBold: return "\u{f426}"
        case .enterRoomFilled: return "\u{f427}"
        case .enterRoomLight: return "\u{f428}"
        case .enterRoomRegular: return "\u{f429}"
        case .eraserBold: return "\u{f42a}"
        case .eraserFilled: return "\u{f42b}"
        case .eraserLight: return "\u{f42c}"
        case .eraserRegular: return "\u{f42d}"
        case .errorLegacyBadgeFilled: return "\u{f42e}"
        case .errorLegacyBold: return "\u{f42f}"
        case .errorLegacyFilled: return "\u{f430}"
        case .errorLegacyLight: return "\u{f431}"
        case .errorLegacyRegular: return "\u{f432}"
        case .ethernetBold: return "\u{f433}"
        case .ethernetLight: return "\u{f434}"
        case .ethernetRegular: return "\u{f435}"
        case .eventBold: return "\u{f436}"
        case .eventLight: return "\u{f437}"
        case .eventRegular: return "\u{f438}"
        case .exitRoomBold: return "\u{f439}"
        case .exitRoomLight: return "\u{f43a}"
        case .exitRoomRegular: return "\u{f43b}"
        case .exludeBold: return "\u{f43c}"
        case .exludeLight: return "\u{f43d}"
        case .exludeRegular: return "\u{f43e}"
        case .exploreBold: return "\u{f43f}"
        case .exploreLight: return "\u{f440}"
        case .exploreRegular: return "\u{f441}"
        case .exportBold: return "\u{f442}"
        case .exportLight: return "\u{f443}"
        case .exportRegular: return "\u{f444}"
        case .extensionMobilityBold: return "\u{f445}"
        case .extensionMobilityLight: return "\u{f446}"
        case .extensionMobilityRegular: return "\u{f447}"
        case .externalMessageBold: return "\u{f448}"
        case .externalMessageLight: return "\u{f449}"
        case .externalMessageRegular: return "\u{f44a}"
        case .externalUserBold: return "\u{f44b}"
        case .externalUserLight: return "\u{f44c}"
        case .externalUserRegular: return "\u{f44d}"
        case .familyFontBold: return "\u{f44e}"
        case .familyFontLight: return "\u{f44f}"
        case .familyFontRegular: return "\u{f450}"
        case .fastForwardBold: return "\u{f451}"
        case .fastForwardLight: return "\u{f452}"
        case .fastForwardRegular: return "\u{f453}"
        case .favoriteBold: return "\u{f454}"
        case .favoriteFilled: return "\u{f455}"
        case .favoriteLight: return "\u{f456}"
        case .favoriteRegular: return "\u{f457}"
        case .favoritesBold: return "\u{f458}"
        case .favoritesFilled: return "\u{f459}"
        case .favoritesLight: return "\u{f45a}"
        case .favoritesRegular: return "\u{f45b}"
        case .fbwBold: return "\u{f45c}"
        case .fbwFilled: return "\u{f45d}"
        case .fbwLight: return "\u{f45e}"
        case .fbwRegular: return "\u{f45f}"
        case .ffwBold: return "\u{f460}"
        case .ffwFilled: return "\u{f461}"
        case .ffwLight: return "\u{f462}"
        case .ffwRegular: return "\u{f463}"
        case .file3DBold: return "\u{f464}"
        case .file3DFilled: return "\u{f465}"
        case .file3DLight: return "\u{f466}"
        case .file3DRegular: return "\u{f467}"
        case .fileAnalysisBold: return "\u{f468}"
        case .fileAnalysisFilled: return "\u{f469}"
        case .fileAnalysisLight: return "\u{f46a}"
        case .fileAnalysisRegular: return "\u{f46b}"
        case .fileAnnotationBold: return "\u{f46c}"
        case .fileAnnotationFilled: return "\u{f46d}"
        case .fileAnnotationLight: return "\u{f46e}"
        case .fileAnnotationRegular: return "\u{f46f}"
        case .fileAudioBold: return "\u{f470}"
        case .fileAudioFilled: return "\u{f471}"
        case .fileAudioLight: return "\u{f472}"
        case .fileAudioRegular: return "\u{f473}"
        case .fileBugBold: return "\u{f474}"
        case .fileBugFilled: return "\u{f475}"
        case .fileBugLight: return "\u{f476}"
        case .fileBugRegular: return "\u{f477}"
        case .fileCodeBold: return "\u{f478}"
        case .fileCodeFilled: return "\u{f479}"
        case .fileCodeLight: return "\u{f47a}"
        case .fileCodeRegular: return "\u{f47b}"
        case .fileDashboardBold: return "\u{f47c}"
        case .fileDashboardFilled: return "\u{f47d}"
        case .fileDashboardLight: return "\u{f47e}"
        case .fileDashboardRegular: return "\u{f47f}"
        case .fileExcelBold: return "\u{f480}"
        case .fileExcelFilled: return "\u{f481}"
        case .fileExcelLight: return "\u{f482}"
        case .fileExcelRegular: return "\u{f483}"
        case .fileGraphBold: return "\u{f484}"
        case .fileGraphFilled: return "\u{f485}"
        case .fileGraphLight: return "\u{f486}"
        case .fileGraphRegular: return "\u{f487}"
        case .fileImageBold: return "\u{f488}"
        case .fileImageFilled: return "\u{f489}"
        case .fileImageLight: return "\u{f48a}"
        case .fileImageRegular: return "\u{f48b}"
        case .fileKeynoteBold: return "\u{f48c}"
        case .fileKeynoteFilled: return "\u{f48d}"
        case .fileKeynoteLight: return "\u{f48e}"
        case .fileKeynoteRegular: return "\u{f48f}"
        case .fileLockedBold: return "\u{f490}"
        case .fileLockedFilled: return "\u{f491}"
        case .fileLockedLight: return "\u{f492}"
        case .fileLockedRegular: return "\u{f493}"
        case .fileMissingBold: return "\u{f494}"
        case .fileMissingFilled: return "\u{f495}"
        case .fileMissingLight: return "\u{f496}"
        case .fileMissingRegular: return "\u{f497}"
        case .fileMusicBold: return "\u{f498}"
        case .fileMusicFilled: return "\u{f499}"
        case .fileMusicLight: return "\u{f49a}"
        case .fileMusicRegular: return "\u{f49b}"
        case .fileOnenoteBold: return "\u{f49c}"
        case .fileOnenoteFilled: return "\u{f49d}"
        case .fileOnenoteLight: return "\u{f49e}"
        case .fileOnenoteRegular: return "\u{f49f}"
        case .filePdfBold: return "\u{f4a0}"
        case .filePdfFilled: return "\u{f4a1}"
        case .filePdfLight: return "\u{f4a2}"
        case .filePdfRegular: return "\u{f4a3}"
        case .filePowerpointBold: return "\u{f4a4}"
        case .filePowerpointFilled: return "\u{f4a5}"
        case .filePowerpointLight: return "\u{f4a6}"
        case .filePowerpointRegular: return "\u{f4a7}"
        case .fileSpreadsheetBold: return "\u{f4a8}"
        case .fileSpreadsheetFilled: return "\u{f4a9}"
        case .fileSpreadsheetLight: return "\u{f4aa}"
        case .fileSpreadsheetRegular: return "\u{f4ab}"
        case .fileTextBold: return "\u{f4ac}"
        case .fileTextFilled: return "\u{f4ad}"
        case .fileTextLight: return "\u{f4ae}"
        case .fileTextRegular: return "\u{f4af}"
        case .fileVectorBold: return "\u{f4b0}"
        case .fileVectorFilled: return "\u{f4b1}"
        case .fileVectorLight: return "\u{f4b2}"
        case .fileVectorRegular: return "\u{f4b3}"
        case .fileVideoBold: return "\u{f4b4}"
        case .fileVideoFilled: return "\u{f4b5}"
        case .fileVideoLight: return "\u{f4b6}"
        case .fileVideoRegular: return "\u{f4b7}"
        case .fileWordBold: return "\u{f4b8}"
        case .fileWordFilled: return "\u{f4b9}"
        case .fileWordLight: return "\u{f4ba}"
        case .fileWordRegular: return "\u{f4bb}"
        case .fileZipBold: return "\u{f4bc}"
        case .fileZipFilled: return "\u{f4bd}"
        case .fileZipLight: return "\u{f4be}"
        case .fileZipRegular: return "\u{f4bf}"
        case .filesBold: return "\u{f4c0}"
        case .filesFilled: return "\u{f4c1}"
        case .filesLight: return "\u{f4c2}"
        case .filesRegular: return "\u{f4c3}"
        case .fillColourBold: return "\u{f4c4}"
        case .fillColourFilled: return "\u{f4c5}"
        case .fillColourLight: return "\u{f4c6}"
        case .fillColourRegular: return "\u{f4c7}"
        case .filterBold: return "\u{f4c8}"
        case .filterCircleBold: return "\u{f4c9}"
        case .filterCircleFilled: return "\u{f4ca}"
        case .filterCircleLight: return "\u{f4cb}"
        case .filterCircleRegular: return "\u{f4cc}"
        case .filterLight: return "\u{f4cd}"
        case .filterRegular: return "\u{f4ce}"
        case .fitToWidthBold: return "\u{f4cf}"
        case .fitToWidthLight: return "\u{f4d0}"
        case .fitToWidthRegular: return "\u{f4d1}"
        case .fitToWindowBold: return "\u{f4d2}"
        case .fitToWindowExitBold: return "\u{f4d3}"
        case .fitToWindowExitLight: return "\u{f4d4}"
        case .fitToWindowExitRegular: return "\u{f4d5}"
        case .fitToWindowLight: return "\u{f4d6}"
        case .fitToWindowRegular: return "\u{f4d7}"
        case .flagBold: return "\u{f4d8}"
        case .flagCircleBold: return "\u{f4d9}"
        case .flagCircleFilled: return "\u{f4da}"
        case .flagCircleLight: return "\u{f4db}"
        case .flagCircleRegular: return "\u{f4dc}"
        case .flagFilled: return "\u{f4dd}"
        case .flagLight: return "\u{f4de}"
        case .flagRegular: return "\u{f4df}"
        case .folderBold: return "\u{f4e0}"
        case .folderEditBold: return "\u{f4e1}"
        case .folderEditLight: return "\u{f4e2}"
        case .folderEditRegular: return "\u{f4e3}"
        case .folderLight: return "\u{f4e4}"
        case .folderLockBold: return "\u{f4e5}"
        case .folderLockLight: return "\u{f4e6}"
        case .folderLockRegular: return "\u{f4e7}"
        case .folderRegular: return "\u{f4e8}"
        case .folderViewBold: return "\u{f4e9}"
        case .folderViewLight: return "\u{f4ea}"
        case .folderViewRegular: return "\u{f4eb}"
        case .followUpBold: return "\u{f4ec}"
        case .followUpLight: return "\u{f4ed}"
        case .followUpRegular: return "\u{f4ee}"
        case .foodBold: return "\u{f4ef}"
        case .foodLight: return "\u{f4f0}"
        case .foodRegular: return "\u{f4f1}"
        case .formatBold: return "\u{f4f2}"
        case .formatControlPanelDraggerBold: return "\u{f4f3}"
        case .formatControlPanelDraggerHorizontalBold: return "\u{f4f4}"
        case .formatControlPanelDraggerHorizontalLight: return "\u{f4f5}"
        case .formatControlPanelDraggerHorizontalRegular: return "\u{f4f6}"
        case .formatControlPanelDraggerLight: return "\u{f4f7}"
        case .formatControlPanelDraggerRegular: return "\u{f4f8}"
        case .formatDefaultAppBold: return "\u{f4f9}"
        case .formatDefaultAppLight: return "\u{f4fa}"
        case .formatDefaultAppRegular: return "\u{f4fb}"
        case .formatLight: return "\u{f4fc}"
        case .formatPanelControlBarBold: return "\u{f4fd}"
        case .formatPanelControlBarLight: return "\u{f4fe}"
        case .formatPanelControlBarRegular: return "\u{f4ff}"
        case .formatPanelControlDownBold: return "\u{f500}"
        case .formatPanelControlDownLight: return "\u{f501}"
        case .formatPanelControlDownRegular: return "\u{f502}"
        case .formatPanelControlLeftBold: return "\u{f503}"
        case .formatPanelControlLeftLight: return "\u{f504}"
        case .formatPanelControlLeftRegular: return "\u{f505}"
        case .formatPanelControlRightBold: return "\u{f506}"
        case .formatPanelControlRightLight: return "\u{f507}"
        case .formatPanelControlRightRegular: return "\u{f508}"
        case .formatPanelControlUpBold: return "\u{f509}"
        case .formatPanelControlUpDownBold: return "\u{f50a}"
        case .formatPanelControlUpDownLight: return "\u{f50b}"
        case .formatPanelControlUpDownRegular: return "\u{f50c}"
        case .formatPanelControlUpLight: return "\u{f50d}"
        case .formatPanelControlUpRegular: return "\u{f50e}"
        case .formatRegular: return "\u{f50f}"
        case .formatViewMixedBold: return "\u{f510}"
        case .formatViewMixedLight: return "\u{f511}"
        case .formatViewMixedRegular: return "\u{f512}"
        case .forwardMessageBold: return "\u{f513}"
        case .forwardMessageFilled: return "\u{f514}"
        case .forwardMessageLight: return "\u{f515}"
        case .forwardMessageRegular: return "\u{f516}"
        case .fourColumnBold: return "\u{f517}"
        case .fourColumnLight: return "\u{f518}"
        case .fourColumnRegular: return "\u{f519}"
        case .fourWayNavigationBold: return "\u{f51a}"
        case .fourWayNavigationLight: return "\u{f51b}"
        case .fourWayNavigationRegular: return "\u{f51c}"
        case .frequencyCappingBold: return "\u{f51d}"
        case .frequencyCappingLight: return "\u{f51e}"
        case .frequencyCappingRegular: return "\u{f51f}"
        case .fufillmentBold: return "\u{f520}"
        case .fufillmentLight: return "\u{f521}"
        case .fufillmentRegular: return "\u{f522}"
        case .fullscreenBold: return "\u{f523}"
        case .fullscreenExitBold: return "\u{f524}"
        case .fullscreenExitLight: return "\u{f525}"
        case .fullscreenExitRegular: return "\u{f526}"
        case .fullscreenLight: return "\u{f527}"
        case .fullscreenRegular: return "\u{f528}"
        case .genericDeviceVideoBold: return "\u{f529}"
        case .genericDeviceVideoFilled: return "\u{f52a}"
        case .genericDeviceVideoLight: return "\u{f52b}"
        case .genericDeviceVideoRegular: return "\u{f52c}"
        case .genericDeviceVideoSmallFilled: return "\u{f52d}"
        case .gifBold: return "\u{f52e}"
        case .gifFilled: return "\u{f52f}"
        case .gifLight: return "\u{f530}"
        case .gifRegular: return "\u{f531}"
        case .googleMeet: return "\u{f532}"
        case .greenRoomBold: return "\u{f533}"
        case .greenRoomFilled: return "\u{f534}"
        case .greenRoomLight: return "\u{f535}"
        case .greenRoomRegular: return "\u{f536}"
        case .groupBold: return "\u{f537}"
        case .groupLight: return "\u{f538}"
        case .groupPickupLight: return "\u{f539}"
        case .groupPickupBold: return "\u{f53a}"
        case .groupPickupFilled: return "\u{f53b}"
        case .groupPickupRegular: return "\u{f53c}"
        case .groupRegular: return "\u{f53d}"
        case .guestIssuerBold: return "\u{f53e}"
        case .guestIssuerLight: return "\u{f53f}"
        case .guestIssuerRegular: return "\u{f540}"
        case .guideBold: return "\u{f541}"
        case .guideLight: return "\u{f542}"
        case .guideRegular: return "\u{f543}"
        case .handlerBold: return "\u{f544}"
        case .handlerLight: return "\u{f545}"
        case .handlerRegular: return "\u{f546}"
        case .handsetAlertBold: return "\u{f547}"
        case .handsetAlertFilled: return "\u{f548}"
        case .handsetAlertLight: return "\u{f549}"
        case .handsetAlertRegular: return "\u{f54a}"
        case .handsetBold: return "\u{f54b}"
        case .handsetFilled: return "\u{f54c}"
        case .handsetLight: return "\u{f54d}"
        case .handsetMutedBold: return "\u{f54e}"
        case .handsetMutedFilled: return "\u{f54f}"
        case .handsetMutedLight: return "\u{f550}"
        case .handsetMutedRegular: return "\u{f551}"
        case .handsetRegular: return "\u{f552}"
        case .handshakeBold: return "\u{f553}"
        case .handshakeLight: return "\u{f554}"
        case .handshakeRegular: return "\u{f555}"
        case .headingOneBold: return "\u{f556}"
        case .headingOneLight: return "\u{f557}"
        case .headingOneRegular: return "\u{f558}"
        case .headingThreeBold: return "\u{f559}"
        case .headingThreeLight: return "\u{f55a}"
        case .headingThreeRegular: return "\u{f55b}"
        case .headingTwoBold: return "\u{f55c}"
        case .headingTwoLight: return "\u{f55d}"
        case .headingTwoRegular: return "\u{f55e}"
        case .headsetAlertBold: return "\u{f55f}"
        case .headsetAlertLight: return "\u{f560}"
        case .headsetAlertRegular: return "\u{f561}"
        case .headsetBold: return "\u{f562}"
        case .headsetFilled: return "\u{f563}"
        case .headsetLight: return "\u{f564}"
        case .headsetMutedBold: return "\u{f565}"
        case .headsetMutedLight: return "\u{f566}"
        case .headsetMutedRegular: return "\u{f567}"
        case .headsetPrivateBold: return "\u{f568}"
        case .headsetPrivateLight: return "\u{f569}"
        case .headsetPrivateRegular: return "\u{f56a}"
        case .headsetRegular: return "\u{f56b}"
        case .helpBold: return "\u{f56c}"
        case .helpCircleActiveFilled: return "\u{f56d}"
        case .helpCircleBold: return "\u{f56e}"
        case .helpCircleLight: return "\u{f56f}"
        case .helpCircleRegular: return "\u{f570}"
        case .helpLight: return "\u{f571}"
        case .helpRegular: return "\u{f572}"
        case .helpdeskBold: return "\u{f573}"
        case .helpdeskLight: return "\u{f574}"
        case .helpdeskRegular: return "\u{f575}"
        case .hideBold: return "\u{f576}"
        case .hideFilled: return "\u{f577}"
        case .hideLight: return "\u{f578}"
        case .hideRegular: return "\u{f579}"
        case .homeBold: return "\u{f57a}"
        case .homeFilled: return "\u{f57b}"
        case .homeLight: return "\u{f57c}"
        case .homeRegular: return "\u{f57d}"
        case .horizontalLineBold: return "\u{f57e}"
        case .horizontalLineLight: return "\u{f57f}"
        case .horizontalLineRegular: return "\u{f580}"
        case .hotelingBold: return "\u{f581}"
        case .hotelingFilled: return "\u{f582}"
        case .hotelingLight: return "\u{f583}"
        case .hotelingRegular: return "\u{f584}"
        case .humidityBold: return "\u{f585}"
        case .humidityLight: return "\u{f586}"
        case .humidityRegular: return "\u{f587}"
        case .huntGroupBold: return "\u{f588}"
        case .huntGroupFilled: return "\u{f589}"
        case .huntGroupLight: return "\u{f58a}"
        case .huntGroupRegular: return "\u{f58b}"
        case .importBold: return "\u{f58c}"
        case .importLight: return "\u{f58d}"
        case .importRegular: return "\u{f58e}"
        case .inCommonBold: return "\u{f58f}"
        case .inCommonLight: return "\u{f590}"
        case .inCommonRegular: return "\u{f591}"
        case .includeBold: return "\u{f592}"
        case .includeLight: return "\u{f593}"
        case .includeRegular: return "\u{f594}"
        case .incomingCallLegacyBold: return "\u{f595}"
        case .incomingCallLegacyFilled: return "\u{f596}"
        case .incomingCallLegacyLight: return "\u{f597}"
        case .incomingCallLegacyRegular: return "\u{f598}"
        case .infoBadgeFilled: return "\u{f599}"
        case .infoCircleBold: return "\u{f59a}"
        case .infoCircleFilled: return "\u{f59b}"
        case .infoCircleLight: return "\u{f59c}"
        case .infoCircleRegular: return "\u{f59d}"
        case .infoCircleTwoBold: return "\u{f59e}"
        case .infoCircleTwoFilled: return "\u{f59f}"
        case .infoCircleTwoLight: return "\u{f5a0}"
        case .infoCircleTwoRegular: return "\u{f5a1}"
        case .inputBold: return "\u{f5a2}"
        case .inputDisconnectedBold: return "\u{f5a3}"
        case .inputDisconnectedLight: return "\u{f5a4}"
        case .inputDisconnectedRegular: return "\u{f5a5}"
        case .inputLight: return "\u{f5a6}"
        case .inputRegular: return "\u{f5a7}"
        case .insightsBold: return "\u{f5a8}"
        case .insightsLight: return "\u{f5a9}"
        case .insightsRegular: return "\u{f5aa}"
        case .integrationsBold: return "\u{f5ab}"
        case .integrationsLight: return "\u{f5ac}"
        case .integrationsRegular: return "\u{f5ad}"
        case .intelligentRoutingBold: return "\u{f5ae}"
        case .intelligentRoutingLight: return "\u{f5af}"
        case .intelligentRoutingRegular: return "\u{f5b0}"
        case .invitedUserBold: return "\u{f5b1}"
        case .invitedUserLight: return "\u{f5b2}"
        case .invitedUserRegular: return "\u{f5b3}"
        case .italicBold: return "\u{f5b4}"
        case .italicLight: return "\u{f5b5}"
        case .italicRegular: return "\u{f5b6}"
        case .joinAudioBold: return "\u{f5b7}"
        case .joinAudioFilled: return "\u{f5b8}"
        case .joinAudioLight: return "\u{f5b9}"
        case .joinAudioRegular: return "\u{f5ba}"
        case .keepInTouchBold: return "\u{f5bb}"
        case .keepInTouchFilled: return "\u{f5bc}"
        case .keepInTouchLight: return "\u{f5bd}"
        case .keepInTouchRegular: return "\u{f5be}"
        case .keyboardBold: return "\u{f5bf}"
        case .keyboardCloseBold: return "\u{f5c0}"
        case .keyboardCloseLight: return "\u{f5c1}"
        case .keyboardCloseRegular: return "\u{f5c2}"
        case .keyboardLight: return "\u{f5c3}"
        case .keyboardRegular: return "\u{f5c4}"
        case .languageBold: return "\u{f5c5}"
        case .languageLight: return "\u{f5c6}"
        case .languageRegular: return "\u{f5c7}"
        case .laptopBold: return "\u{f5c8}"
        case .laptopDisconnectedBold: return "\u{f5c9}"
        case .laptopDisconnectedLight: return "\u{f5ca}"
        case .laptopDisconnectedRegular: return "\u{f5cb}"
        case .laptopFilled: return "\u{f5cc}"
        case .laptopLight: return "\u{f5cd}"
        case .laptopRegular: return "\u{f5ce}"
        case .laserPointerBold: return "\u{f5cf}"
        case .laserPointerLight: return "\u{f5d0}"
        case .laserPointerRegular: return "\u{f5d1}"
        case .launchBold: return "\u{f5d2}"
        case .launchLight: return "\u{f5d3}"
        case .launchRegular: return "\u{f5d4}"
        case .layoutSideBySideVerticalBold: return "\u{f5d5}"
        case .layoutSideBySideVerticalFilled: return "\u{f5d6}"
        case .layoutSideBySideVerticalLight: return "\u{f5d7}"
        case .layoutSideBySideVerticalRegular: return "\u{f5d8}"
        case .leaveBreakoutSessionBold: return "\u{f5d9}"
        case .leaveBreakoutSessionLight: return "\u{f5da}"
        case .leaveBreakoutSessionRegular: return "\u{f5db}"
        case .leaveDeviceBold: return "\u{f5dc}"
        case .leaveDeviceLight: return "\u{f5dd}"
        case .leaveDeviceRegular: return "\u{f5de}"
        case .likeBold: return "\u{f5df}"
        case .likeFilled: return "\u{f5e0}"
        case .likeLight: return "\u{f5e1}"
        case .likeRegular: return "\u{f5e2}"
        case .linkBold: return "\u{f5e3}"
        case .linkLight: return "\u{f5e4}"
        case .linkRegular: return "\u{f5e5}"
        case .listBulletedBold: return "\u{f5e6}"
        case .listBulletedLight: return "\u{f5e7}"
        case .listBulletedRegular: return "\u{f5e8}"
        case .listMenuBold: return "\u{f5e9}"
        case .listMenuLight: return "\u{f5ea}"
        case .listMenuRegular: return "\u{f5eb}"
        case .listNumberedBold: return "\u{f5ec}"
        case .listNumberedLight: return "\u{f5ed}"
        case .listNumberedRegular: return "\u{f5ee}"
        case .locationBold: return "\u{f5ef}"
        case .locationFilled: return "\u{f5f0}"
        case .locationLight: return "\u{f5f1}"
        case .locationRegular: return "\u{f5f2}"
        case .longTextBoxBold: return "\u{f5f3}"
        case .longTextBoxLight: return "\u{f5f4}"
        case .longTextBoxRegular: return "\u{f5f5}"
        case .lowerHandBold: return "\u{f5f6}"
        case .lowerHandLight: return "\u{f5f7}"
        case .lowerHandRegular: return "\u{f5f8}"
        case .magicPenBold: return "\u{f5f9}"
        case .magicPenFilled: return "\u{f5fa}"
        case .magicPenLight: return "\u{f5fb}"
        case .magicPenRegular: return "\u{f5fc}"
        case .markAsUnreadBold: return "\u{f5fd}"
        case .markAsUnreadLight: return "\u{f5fe}"
        case .markAsUnreadRegular: return "\u{f5ff}"
        case .markdownBold: return "\u{f600}"
        case .markdownLight: return "\u{f601}"
        case .markdownRegular: return "\u{f602}"
        case .markerBold: return "\u{f603}"
        case .markerFilled: return "\u{f604}"
        case .markerLight: return "\u{f605}"
        case .markerRegular: return "\u{f606}"
        case .maximizeBold: return "\u{f607}"
        case .maximizeLight: return "\u{f608}"
        case .maximizeRegular: return "\u{f609}"
        case .mediaPlayerBold: return "\u{f60a}"
        case .mediaPlayerLight: return "\u{f60b}"
        case .mediaPlayerRegular: return "\u{f60c}"
        case .mediaQualityGoodBold: return "\u{f60d}"
        case .mediaQualityGoodFilled: return "\u{f60e}"
        case .mediaQualityGoodLight: return "\u{f60f}"
        case .mediaQualityGoodRegular: return "\u{f610}"
        case .mediaQualityPoorBold: return "\u{f611}"
        case .mediaQualityPoorFilled: return "\u{f612}"
        case .mediaQualityPoorLight: return "\u{f613}"
        case .mediaQualityPoorRegular: return "\u{f614}"
        case .mediaQualityUnstableBold: return "\u{f615}"
        case .mediaQualityUnstableFilled: return "\u{f616}"
        case .mediaQualityUnstableLight: return "\u{f617}"
        case .mediaQualityUnstableRegular: return "\u{f618}"
        case .mediumQualityGoodFilled: return "\u{f619}"
        case .mediumQualityPoorFilled: return "\u{f61a}"
        case .mediumQualityUnstableFilled: return "\u{f61b}"
        case .meetBold: return "\u{f61c}"
        case .meetEndBold: return "\u{f61d}"
        case .meetEndLight: return "\u{f61e}"
        case .meetEndRegular: return "\u{f61f}"
        case .meetFilled: return "\u{f620}"
        case .meetLight: return "\u{f621}"
        case .meetRegular: return "\u{f622}"
        case .meetingsBold: return "\u{f623}"
        case .meetingsFilled: return "\u{f624}"
        case .meetingsFocusMonthBold: return "\u{f625}"
        case .meetingsFocusMonthLight: return "\u{f626}"
        case .meetingsFocusMonthRegular: return "\u{f627}"
        case .meetingsFocusOneDayBold: return "\u{f628}"
        case .meetingsFocusOneDayLight: return "\u{f629}"
        case .meetingsFocusOneDayRegular: return "\u{f62a}"
        case .meetingsFocusThreeDayBold: return "\u{f62b}"
        case .meetingsFocusThreeDayLight: return "\u{f62c}"
        case .meetingsFocusThreeDayRegular: return "\u{f62d}"
        case .meetingsFocusUpcomingBold: return "\u{f62e}"
        case .meetingsFocusUpcomingLight: return "\u{f62f}"
        case .meetingsFocusUpcomingRegular: return "\u{f630}"
        case .meetingsFocusWeekBold: return "\u{f631}"
        case .meetingsFocusWeekLight: return "\u{f632}"
        case .meetingsFocusWeekRegular: return "\u{f633}"
        case .meetingsLight: return "\u{f634}"
        case .meetingsPresenceBold: return "\u{f635}"
        case .meetingsPresenceFilled: return "\u{f636}"
        case .meetingsPresenceLight: return "\u{f637}"
        case .meetingsPresenceRegular: return "\u{f638}"
        case .meetingsPresenceSmallFilled: return "\u{f639}"
        case .meetingsRegular: return "\u{f63a}"
        case .meetingsTeamActiveBold: return "\u{f63b}"
        case .meetingsTeamActiveLight: return "\u{f63c}"
        case .meetingsTeamActiveRegular: return "\u{f63d}"
        case .meetingsTeamBold: return "\u{f63e}"
        case .meetingsTeamLight: return "\u{f63f}"
        case .meetingsTeamNewBold: return "\u{f640}"
        case .meetingsTeamNewLight: return "\u{f641}"
        case .meetingsTeamNewRegular: return "\u{f642}"
        case .meetingsTeamRegular: return "\u{f643}"
        case .mentionBold: return "\u{f644}"
        case .mentionLight: return "\u{f645}"
        case .mentionRegular: return "\u{f646}"
        case .messageQueingBold: return "\u{f647}"
        case .messageQueingLight: return "\u{f648}"
        case .messageQueingRegular: return "\u{f649}"
        case .microphoneBold: return "\u{f64a}"
        case .microphoneFilled: return "\u{f64b}"
        case .microphoneHardMutedBold: return "\u{f64c}"
        case .microphoneHardMutedColoredBold: return "\u{f64d}"
        case .microphoneHardMutedColoredLight: return "\u{f64e}"
        case .microphoneHardMutedColoredRegular: return "\u{f64f}"
        case .microphoneHardMutedLight: return "\u{f650}"
        case .microphoneHardMutedRegular: return "\u{f651}"
        case .microphoneLight: return "\u{f652}"
        case .microphoneMusicModeColoredBold: return "\u{f653}"
        case .microphoneMusicModeColoredLight: return "\u{f654}"
        case .microphoneMusicModeColoredRegular: return "\u{f655}"
        case .microphoneMutedBold: return "\u{f656}"
        case .microphoneMutedFilled: return "\u{f657}"
        case .microphoneMutedIndicatorFilled: return "\u{f658}"
        case .microphoneMutedLight: return "\u{f659}"
        case .microphoneMutedRedBold: return "\u{f65a}"
        case .microphoneMutedRedFilled: return "\u{f65b}"
        case .microphoneMutedRedLight: return "\u{f65c}"
        case .microphoneMutedRedRegular: return "\u{f65d}"
        case .microphoneMutedRegular: return "\u{f65e}"
        case .microphoneRegular: return "\u{f65f}"
        case .minimizeBold: return "\u{f660}"
        case .minimizeLight: return "\u{f661}"
        case .minimizeRegular: return "\u{f662}"
        case .minusBold: return "\u{f663}"
        case .minusLight: return "\u{f664}"
        case .minusRegular: return "\u{f665}"
        case .mirrorBold: return "\u{f666}"
        case .mirrorFilled: return "\u{f667}"
        case .mirrorLight: return "\u{f668}"
        case .mirrorRegular: return "\u{f669}"
        case .moderatorBold: return "\u{f66a}"
        case .moderatorLight: return "\u{f66b}"
        case .moderatorRegular: return "\u{f66c}"
        case .monitoringBold: return "\u{f66d}"
        case .monitoringLight: return "\u{f66e}"
        case .monitoringRegular: return "\u{f66f}"
        case .monthlyRecurringScheduleNodeBold: return "\u{f670}"
        case .monthlyRecurringScheduleNodeLight: return "\u{f671}"
        case .monthlyRecurringScheduleNodeRegular: return "\u{f672}"
        case .moreAdrBold: return "\u{f673}"
        case .moreAdrLight: return "\u{f674}"
        case .moreAdrRegular: return "\u{f675}"
        case .moreBold: return "\u{f676}"
        case .moreCircleBold: return "\u{f677}"
        case .moreCircleFilled: return "\u{f678}"
        case .moreCircleLight: return "\u{f679}"
        case .moreCircleRegular: return "\u{f67a}"
        case .moreCirecleFilled: return "\u{f67b}"
        case .moreLight: return "\u{f67c}"
        case .moreRegular: return "\u{f67d}"
        case .mouseCursorBold: return "\u{f67e}"
        case .mouseCursorLight: return "\u{f67f}"
        case .mouseCursorRegular: return "\u{f680}"
        case .moveCallInAdrBold: return "\u{f681}"
        case .moveCallInAdrLight: return "\u{f682}"
        case .moveCallInAdrRegular: return "\u{f683}"
        case .moveCallInIphBold: return "\u{f684}"
        case .moveCallInIphLight: return "\u{f685}"
        case .moveCallInIphRegular: return "\u{f686}"
        case .moveCallInLaptopBold: return "\u{f687}"
        case .moveCallInLaptopLight: return "\u{f688}"
        case .moveCallInLaptopRegular: return "\u{f689}"
        case .moveCallInOutAdrBold: return "\u{f68a}"
        case .moveCallInOutAdrLight: return "\u{f68b}"
        case .moveCallInOutAdrRegular: return "\u{f68c}"
        case .moveCallInOutIphBold: return "\u{f68d}"
        case .moveCallInOutIphLight: return "\u{f68e}"
        case .moveCallInOutIphRegular: return "\u{f68f}"
        case .moveCallInTabletBold: return "\u{f690}"
        case .moveCallInTabletLight: return "\u{f691}"
        case .moveCallInTabletRegular: return "\u{f692}"
        case .moveCallOutAdrBold: return "\u{f693}"
        case .moveCallOutAdrLight: return "\u{f694}"
        case .moveCallOutAdrRegular: return "\u{f695}"
        case .moveCallOutIphBold: return "\u{f696}"
        case .moveCallOutIphLight: return "\u{f697}"
        case .moveCallOutIphRegular: return "\u{f698}"
        case .moveCallOutLaptopBold: return "\u{f699}"
        case .moveCallOutLaptopLight: return "\u{f69a}"
        case .moveCallOutLaptopRegular: return "\u{f69b}"
        case .moveCallOutTabletBold: return "\u{f69c}"
        case .moveCallOutTabletLight: return "\u{f69d}"
        case .moveCallOutTabletRegular: return "\u{f69e}"
        case .msTeams: return "\u{f69f}"
        case .multilineChartBold: return "\u{f6a0}"
        case .multilineChartFilled: return "\u{f6a1}"
        case .multilineChartLight: return "\u{f6a2}"
        case .multilineChartRegular: return "\u{f6a3}"
        case .multimediaBold: return "\u{f6a4}"
        case .multimediaFilled: return "\u{f6a5}"
        case .multimediaLight: return "\u{f6a6}"
        case .multimediaRegular: return "\u{f6a7}"
        case .multipledDevicesBold: return "\u{f6a8}"
        case .multipledDevicesLight: return "\u{f6a9}"
        case .multipledDevicesRegular: return "\u{f6aa}"
        case .musicModeBold: return "\u{f6ab}"
        case .musicModeCircleBold: return "\u{f6ac}"
        case .musicModeCircleFilled: return "\u{f6ad}"
        case .musicModeCircleLight: return "\u{f6ae}"
        case .musicModeCircleRegular: return "\u{f6af}"
        case .musicModeFilled: return "\u{f6b0}"
        case .musicModeLight: return "\u{f6b1}"
        case .musicModeRegular: return "\u{f6b2}"
        case .muteOnEntryBold: return "\u{f6b3}"
        case .muteOnEntryFilled: return "\u{f6b4}"
        case .muteOnEntryLight: return "\u{f6b5}"
        case .muteOnEntryRegular: return "\u{f6b6}"
        case .newManagerBold: return "\u{f6b7}"
        case .newManagerLight: return "\u{f6b8}"
        case .newManagerRegular: return "\u{f6b9}"
        case .newTitleBold: return "\u{f6ba}"
        case .newTitleLight: return "\u{f6bb}"
        case .newTitleRegular: return "\u{f6bc}"
        case .newVoicemailBold: return "\u{f6bd}"
        case .newVoicemailLight: return "\u{f6be}"
        case .newVoicemailRegular: return "\u{f6bf}"
        case .newWhiteboardBold: return "\u{f6c0}"
        case .newWhiteboardLight: return "\u{f6c1}"
        case .newWhiteboardRegular: return "\u{f6c2}"
        case .nextBold: return "\u{f6c3}"
        case .nextLight: return "\u{f6c4}"
        case .nextRegular: return "\u{f6c5}"
        case .noDevicesBold: return "\u{f6c6}"
        case .noDevicesLight: return "\u{f6c7}"
        case .noDevicesRegular: return "\u{f6c8}"
        case .noiseDetectedCanceledFilled: return "\u{f6c9}"
        case .noiseDetectedFilled: return "\u{f6ca}"
        case .noiseNoneCanceledFilled: return "\u{f6cb}"
        case .noiseNoneFilled: return "\u{f6cc}"
        case .noiseRemovalBold: return "\u{f6cd}"
        case .noiseRemovalLight: return "\u{f6ce}"
        case .noiseRemovalRegular: return "\u{f6cf}"
        case .noteBold: return "\u{f6d0}"
        case .noteLight: return "\u{f6d1}"
        case .notePptBold: return "\u{f6d2}"
        case .notePptLight: return "\u{f6d3}"
        case .notePptRegular: return "\u{f6d4}"
        case .noteRegular: return "\u{f6d5}"
        case .notesBold: return "\u{f6d6}"
        case .notesLight: return "\u{f6d7}"
        case .notesRegular: return "\u{f6d8}"
        case .numberBold: return "\u{f6d9}"
        case .numberLight: return "\u{f6da}"
        case .numberRegular: return "\u{f6db}"
        case .oldRemoteBold: return "\u{f6dc}"
        case .oldRemoteLight: return "\u{f6dd}"
        case .oldRemoteRegular: return "\u{f6de}"
        case .oldTouchBold: return "\u{f6df}"
        case .oldTouchLight: return "\u{f6e0}"
        case .oldTouchRegular: return "\u{f6e1}"
        case .oneColumnBold: return "\u{f6e2}"
        case .oneColumnLight: return "\u{f6e3}"
        case .oneColumnRegular: return "\u{f6e4}"
        case .openInFolderBold: return "\u{f6e5}"
        case .openInFolderLight: return "\u{f6e6}"
        case .openInFolderRegular: return "\u{f6e7}"
        case .openPagesBold: return "\u{f6e8}"
        case .openPagesLight: return "\u{f6e9}"
        case .openPagesRegular: return "\u{f6ea}"
        case .otherNumberBold: return "\u{f6eb}"
        case .otherNumberLight: return "\u{f6ec}"
        case .otherNumberRegular: return "\u{f6ed}"
        case .otherNumberWarningBold: return "\u{f6ee}"
        case .otherNumberWarningLight: return "\u{f6ef}"
        case .otherNumberWarningRegular: return "\u{f6f0}"
        case .outgoingCallLegacyBold: return "\u{f6f1}"
        case .outgoingCallLegacyLight: return "\u{f6f2}"
        case .outgoingCallLegacyRegular: return "\u{f6f3}"
        case .overflowLeftBold: return "\u{f6f4}"
        case .overflowLeftLight: return "\u{f6f5}"
        case .overflowLeftRegular: return "\u{f6f6}"
        case .overflowRightBold: return "\u{f6f7}"
        case .overflowRightLight: return "\u{f6f8}"
        case .overflowRightRegular: return "\u{f6f9}"
        case .pairedCameraBold: return "\u{f6fa}"
        case .pairedCameraLight: return "\u{f6fb}"
        case .pairedCameraRegular: return "\u{f6fc}"
        case .pairedDeviceBold: return "\u{f6fd}"
        case .pairedDeviceLight: return "\u{f6fe}"
        case .pairedDeviceRegular: return "\u{f6ff}"
        case .pairedHandsetBold: return "\u{f700}"
        case .pairedHandsetLight: return "\u{f701}"
        case .pairedHandsetRegular: return "\u{f702}"
        case .pairingBold: return "\u{f703}"
        case .pairingLight: return "\u{f704}"
        case .pairingRegular: return "\u{f705}"
        case .parkedBold: return "\u{f706}"
        case .parkedFilled: return "\u{f707}"
        case .parkedLight: return "\u{f708}"
        case .parkedRegular: return "\u{f709}"
        case .parseBold: return "\u{f70a}"
        case .parseLight: return "\u{f70b}"
        case .parseRegular: return "\u{f70c}"
        case .partialBold: return "\u{f70d}"
        case .partialLight: return "\u{f70e}"
        case .partialRegular: return "\u{f70f}"
        case .participantAddBold: return "\u{f710}"
        case .participantAddLight: return "\u{f711}"
        case .participantAddRegular: return "\u{f712}"
        case .participantBlockedBold: return "\u{f713}"
        case .participantBlockedLight: return "\u{f714}"
        case .participantBlockedRegular: return "\u{f715}"
        case .participantBold: return "\u{f716}"
        case .participantFilled: return "\u{f717}"
        case .participantLight: return "\u{f718}"
        case .participantListBold: return "\u{f719}"
        case .participantListFilled: return "\u{f71a}"
        case .participantListLight: return "\u{f71b}"
        case .participantListRegular: return "\u{f71c}"
        case .participantRegular: return "\u{f71d}"
        case .participantRemoveBold: return "\u{f71e}"
        case .participantRemoveLight: return "\u{f71f}"
        case .participantRemoveRegular: return "\u{f720}"
        case .participantUnknownBold: return "\u{f721}"
        case .participantUnknownLight: return "\u{f722}"
        case .participantUnknownRegular: return "\u{f723}"
        case .passMouseBold: return "\u{f724}"
        case .passMouseLight: return "\u{f725}"
        case .passMouseRegular: return "\u{f726}"
        case .pauseBold: return "\u{f727}"
        case .pauseFilled: return "\u{f728}"
        case .pauseLight: return "\u{f729}"
        case .pauseRegular: return "\u{f72a}"
        case .penBold: return "\u{f72b}"
        case .penFilled: return "\u{f72c}"
        case .penLight: return "\u{f72d}"
        case .penRegular: return "\u{f72e}"
        case .peopleBold: return "\u{f72f}"
        case .peopleCircleBold: return "\u{f730}"
        case .peopleCircleFilled: return "\u{f731}"
        case .peopleCircleLight: return "\u{f732}"
        case .peopleCircleRegular: return "\u{f733}"
        case .peopleFilled: return "\u{f734}"
        case .peopleInsightsFilled: return "\u{f735}"
        case .peopleLight: return "\u{f736}"
        case .peopleRegular: return "\u{f737}"
        case .phoneAlertBold: return "\u{f738}"
        case .phoneAlertLight: return "\u{f739}"
        case .phoneAlertRegular: return "\u{f73a}"
        case .phoneBold: return "\u{f73b}"
        case .phoneFilled: return "\u{f73c}"
        case .phoneLight: return "\u{f73d}"
        case .phoneMutedBold: return "\u{f73e}"
        case .phoneMutedLight: return "\u{f73f}"
        case .phoneMutedRegular: return "\u{f740}"
        case .phonePrivateBold: return "\u{f741}"
        case .phonePrivateLight: return "\u{f742}"
        case .phonePrivateRegular: return "\u{f743}"
        case .phoneRegular: return "\u{f744}"
        case .phoneReplyAllBold: return "\u{f745}"
        case .phoneReplyAllLight: return "\u{f746}"
        case .phoneReplyAllRegular: return "\u{f747}"
        case .phoneReplyBold: return "\u{f748}"
        case .phoneReplyLight: return "\u{f749}"
        case .phoneReplyRegular: return "\u{f74a}"
        case .phoneSmallFilled: return "\u{f74b}"
        case .pickerBold: return "\u{f74c}"
        case .pickerLight: return "\u{f74d}"
        case .pickerRegular: return "\u{f74e}"
        case .pictureInPictureBold: return "\u{f74f}"
        case .pictureInPictureFilled: return "\u{f750}"
        case .pictureInPictureLight: return "\u{f751}"
        case .pictureInPictureRegular: return "\u{f752}"
        case .pieChartBold: return "\u{f753}"
        case .pieChartFilled: return "\u{f754}"
        case .pieChartLight: return "\u{f755}"
        case .pieChartRegular: return "\u{f756}"
        case .pinBold: return "\u{f757}"
        case .pinFilled: return "\u{f758}"
        case .pinLight: return "\u{f759}"
        case .pinListActivityBold: return "\u{f75a}"
        case .pinListActivityColoredBold: return "\u{f75b}"
        case .pinListActivityColoredLight: return "\u{f75c}"
        case .pinListActivityColoredRegular: return "\u{f75d}"
        case .pinListActivityLight: return "\u{f75e}"
        case .pinListActivityRegular: return "\u{f75f}"
        case .pinListBold: return "\u{f760}"
        case .pinListLight: return "\u{f761}"
        case .pinListRegular: return "\u{f762}"
        case .pinMutedBold: return "\u{f763}"
        case .pinMutedFilled: return "\u{f764}"
        case .pinMutedLight: return "\u{f765}"
        case .pinMutedRegular: return "\u{f766}"
        case .pinRegular: return "\u{f767}"
        case .placeholderBold: return "\u{f768}"
        case .placeholderLight: return "\u{f769}"
        case .placeholderRegular: return "\u{f76a}"
        case .playBold: return "\u{f76b}"
        case .playFilled: return "\u{f76c}"
        case .playLight: return "\u{f76d}"
        case .playRegular: return "\u{f76e}"
        case .plugAcBold: return "\u{f76f}"
        case .plugAcLight: return "\u{f770}"
        case .plugAcRegular: return "\u{f771}"
        case .plusBold: return "\u{f772}"
        case .plusCircleBold: return "\u{f773}"
        case .plusCircleFilled: return "\u{f774}"
        case .plusCircleLight: return "\u{f775}"
        case .plusCircleRegular: return "\u{f776}"
        case .plusLight: return "\u{f777}"
        case .plusRegular: return "\u{f778}"
        case .pmrBold: return "\u{f779}"
        case .pmrFilled: return "\u{f77a}"
        case .pmrLight: return "\u{f77b}"
        case .pmrRegular: return "\u{f77c}"
        case .pollBold: return "\u{f77d}"
        case .pollLight: return "\u{f77e}"
        case .pollRegular: return "\u{f77f}"
        case .popInBold: return "\u{f780}"
        case .popInLight: return "\u{f781}"
        case .popInRegular: return "\u{f782}"
        case .popOutBold: return "\u{f783}"
        case .popOutLight: return "\u{f784}"
        case .popOutRegular: return "\u{f785}"
        case .popUpBold: return "\u{f786}"
        case .popUpLight: return "\u{f787}"
        case .popUpRegular: return "\u{f788}"
        case .portraitLandscapeBold: return "\u{f789}"
        case .portraitLandscapeLight: return "\u{f78a}"
        case .portraitLandscapeRegular: return "\u{f78b}"
        case .powerAcBold: return "\u{f78c}"
        case .powerAcLight: return "\u{f78d}"
        case .powerAcRegular: return "\u{f78e}"
        case .powerBold: return "\u{f78f}"
        case .powerLight: return "\u{f790}"
        case .powerRegular: return "\u{f791}"
        case .preHeaderBold: return "\u{f792}"
        case .preHeaderLight: return "\u{f793}"
        case .preHeaderRegular: return "\u{f794}"
        case .presentationBold: return "\u{f795}"
        case .presentationLight: return "\u{f796}"
        case .presentationRegular: return "\u{f797}"
        case .primaryParticipantBold: return "\u{f798}"
        case .primaryParticipantLight: return "\u{f799}"
        case .primaryParticipantRegular: return "\u{f79a}"
        case .printBold: return "\u{f79b}"
        case .printLight: return "\u{f79c}"
        case .printRegular: return "\u{f79d}"
        case .priorityBadgeFilled: return "\u{f79e}"
        case .priorityCircleBold: return "\u{f79f}"
        case .priorityCircleFilled: return "\u{f7a0}"
        case .priorityCircleLight: return "\u{f7a1}"
        case .priorityCircleRegular: return "\u{f7a2}"
        case .priorityCircleTwoBold: return "\u{f7a3}"
        case .priorityCircleTwoFilled: return "\u{f7a4}"
        case .priorityCircleTwoLight: return "\u{f7a5}"
        case .priorityCircleTwoRegular: return "\u{f7a6}"
        case .privacyCircleBold: return "\u{f7a7}"
        case .privacyCircleFilled: return "\u{f7a8}"
        case .privacyCircleLight: return "\u{f7a9}"
        case .privacyCircleRegular: return "\u{f7aa}"
        case .privateBold: return "\u{f7ab}"
        case .privateCircleBold: return "\u{f7ac}"
        case .privateCircleFilled: return "\u{f7ad}"
        case .privateCircleLight: return "\u{f7ae}"
        case .privateCircleRegular: return "\u{f7af}"
        case .privateLight: return "\u{f7b0}"
        case .privateMeetingBold: return "\u{f7b1}"
        case .privateMeetingLight: return "\u{f7b2}"
        case .privateMeetingRegular: return "\u{f7b3}"
        case .privateRegular: return "\u{f7b4}"
        case .productDemoBold: return "\u{f7b5}"
        case .productDemoLight: return "\u{f7b6}"
        case .productDemoRegular: return "\u{f7b7}"
        case .proximityBold: return "\u{f7b8}"
        case .proximityLight: return "\u{f7b9}"
        case .proximityMutedBold: return "\u{f7ba}"
        case .proximityMutedLight: return "\u{f7bb}"
        case .proximityMutedRegular: return "\u{f7bc}"
        case .proximityRegular: return "\u{f7bd}"
        case .proximityVideoBold: return "\u{f7be}"
        case .proximityVideoLight: return "\u{f7bf}"
        case .proximityVideoRegular: return "\u{f7c0}"
        case .ptoPresenceBold: return "\u{f7c1}"
        case .ptoPresenceFilled: return "\u{f7c2}"
        case .ptoPresenceLight: return "\u{f7c3}"
        case .ptoPresenceRegular: return "\u{f7c4}"
        case .pullCallBold: return "\u{f7c5}"
        case .pullCallLight: return "\u{f7c6}"
        case .pullCallRegular: return "\u{f7c7}"
        case .qABold: return "\u{f7c8}"
        case .qALight: return "\u{f7c9}"
        case .qARegular: return "\u{f7ca}"
        case .qualityBold: return "\u{f7cb}"
        case .qualityLight: return "\u{f7cc}"
        case .qualityRegular: return "\u{f7cd}"
        case .queueContactBold: return "\u{f7ce}"
        case .queueContactLight: return "\u{f7cf}"
        case .queueContactRegular: return "\u{f7d0}"
        case .quietBold: return "\u{f7d1}"
        case .quietHoursPresenceBold: return "\u{f7d2}"
        case .quietHoursPresenceFilled: return "\u{f7d3}"
        case .quietHoursPresenceLight: return "\u{f7d4}"
        case .quietHoursPresenceRegular: return "\u{f7d5}"
        case .quietLight: return "\u{f7d6}"
        case .quietRegular: return "\u{f7d7}"
        case .radioButtonGroupBold: return "\u{f7d8}"
        case .radioButtonGroupLight: return "\u{f7d9}"
        case .radioButtonGroupRegular: return "\u{f7da}"
        case .raiseHandBold: return "\u{f7db}"
        case .raiseHandFilled: return "\u{f7dc}"
        case .raiseHandLight: return "\u{f7dd}"
        case .raiseHandRegular: return "\u{f7de}"
        case .ramBold: return "\u{f7df}"
        case .ramLight: return "\u{f7e0}"
        case .ramRegular: return "\u{f7e1}"
        case .reactionsBold: return "\u{f7e2}"
        case .reactionsFilled: return "\u{f7e3}"
        case .reactionsLight: return "\u{f7e4}"
        case .reactionsRegular: return "\u{f7e5}"
        case .reactivateBold: return "\u{f7e6}"
        case .reactivateLight: return "\u{f7e7}"
        case .reactivateRegular: return "\u{f7e8}"
        case .recentsBold: return "\u{f7e9}"
        case .recentsFilled: return "\u{f7ea}"
        case .recentsLight: return "\u{f7eb}"
        case .recentsPresenceBold: return "\u{f7ec}"
        case .recentsPresenceFilled: return "\u{f7ed}"
        case .recentsPresenceLight: return "\u{f7ee}"
        case .recentsPresenceRegular: return "\u{f7ef}"
        case .recentsPresenceSmallFilled: return "\u{f7f0}"
        case .recentsRegular: return "\u{f7f1}"
        case .recordActiveBold: return "\u{f7f2}"
        case .recordActiveFilled: return "\u{f7f3}"
        case .recordActiveLight: return "\u{f7f4}"
        case .recordActiveRegular: return "\u{f7f5}"
        case .recordBold: return "\u{f7f6}"
        case .recordFilled: return "\u{f7f7}"
        case .recordLight: return "\u{f7f8}"
        case .recordPausedBold: return "\u{f7f9}"
        case .recordPausedFilled: return "\u{f7fa}"
        case .recordPausedLight: return "\u{f7fb}"
        case .recordPausedRegular: return "\u{f7fc}"
        case .recordRegular: return "\u{f7fd}"
        case .recurringBold: return "\u{f7fe}"
        case .recurringLight: return "\u{f7ff}"
        case .recurringOffBold: return "\u{f800}"
        case .recurringOffLight: return "\u{f801}"
        case .recurringOffRegular: return "\u{f802}"
        case .recurringRegular: return "\u{f803}"
        case .redialBold: return "\u{f804}"
        case .redialLight: return "\u{f805}"
        case .redialRegular: return "\u{f806}"
        case .redoBold: return "\u{f807}"
        case .redoLight: return "\u{f808}"
        case .redoRegular: return "\u{f809}"
        case .refreshBold: return "\u{f80a}"
        case .refreshLight: return "\u{f80b}"
        case .refreshRegular: return "\u{f80c}"
        case .remoteCallBold: return "\u{f80d}"
        case .remoteCallFilled: return "\u{f80e}"
        case .remoteCallLight: return "\u{f80f}"
        case .remoteCallRegular: return "\u{f810}"
        case .remoteDesktopControlBold: return "\u{f811}"
        case .remoteDesktopControlFilled: return "\u{f812}"
        case .remoteDesktopControlLight: return "\u{f813}"
        case .remoteDesktopControlRegular: return "\u{f814}"
        case .removeBold: return "\u{f815}"
        case .removeFilled: return "\u{f816}"
        case .removeLight: return "\u{f817}"
        case .removeRegular: return "\u{f818}"
        case .replyBold: return "\u{f819}"
        case .replyFilled: return "\u{f81a}"
        case .replyLight: return "\u{f81b}"
        case .replyListBold: return "\u{f81c}"
        case .replyListLight: return "\u{f81d}"
        case .replyListRegular: return "\u{f81e}"
        case .replyRegular: return "\u{f81f}"
        case .resetBold: return "\u{f820}"
        case .resetLight: return "\u{f821}"
        case .resetRegular: return "\u{f822}"
        case .responsiveMobileBold: return "\u{f823}"
        case .responsiveMobileLight: return "\u{f824}"
        case .responsiveMobileRegular: return "\u{f825}"
        case .restartBold: return "\u{f826}"
        case .restartLight: return "\u{f827}"
        case .restartRegular: return "\u{f828}"
        case .retrieveCallBold: return "\u{f829}"
        case .retrieveCallLight: return "\u{f82a}"
        case .retrieveCallRegular: return "\u{f82b}"
        case .returnBold: return "\u{f82c}"
        case .returnLight: return "\u{f82d}"
        case .returnRegular: return "\u{f82e}"
        case .ringtoneBold: return "\u{f82f}"
        case .ringtoneLight: return "\u{f830}"
        case .ringtoneRegular: return "\u{f831}"
        case .roomCalendarBold: return "\u{f832}"
        case .roomCalendarLight: return "\u{f833}"
        case .roomCalendarRegular: return "\u{f834}"
        case .roomLightsBold: return "\u{f835}"
        case .roomLightsFilled: return "\u{f836}"
        case .roomLightsLight: return "\u{f837}"
        case .roomLightsRegular: return "\u{f838}"
        case .rotateContentBold: return "\u{f839}"
        case .rotateContentFilled: return "\u{f83a}"
        case .rotateContentLight: return "\u{f83b}"
        case .rotateContentRegular: return "\u{f83c}"
        case .ruleBasedBold: return "\u{f83d}"
        case .ruleBasedLight: return "\u{f83e}"
        case .ruleBasedRegular: return "\u{f83f}"
        case .runningApplicationBold: return "\u{f840}"
        case .runningApplicationFilled: return "\u{f841}"
        case .runningApplicationLight: return "\u{f842}"
        case .runningApplicationRegular: return "\u{f843}"
        case .saveBold: return "\u{f844}"
        case .saveLight: return "\u{f845}"
        case .saveRegular: return "\u{f846}"
        case .scanBold: return "\u{f847}"
        case .scanLight: return "\u{f848}"
        case .scanRegular: return "\u{f849}"
        case .schedulerAvailableBold: return "\u{f84a}"
        case .schedulerAvailableLight: return "\u{f84b}"
        case .schedulerAvailableRegular: return "\u{f84c}"
        case .schedulerNotWorkingHoursBold: return "\u{f84d}"
        case .schedulerNotWorkingHoursLight: return "\u{f84e}"
        case .schedulerNotWorkingHoursRegular: return "\u{f84f}"
        case .schedulerUnavailableBold: return "\u{f850}"
        case .schedulerUnavailableLight: return "\u{f851}"
        case .schedulerUnavailableRegular: return "\u{f852}"
        case .schedulerUnknownBold: return "\u{f853}"
        case .schedulerUnknownLight: return "\u{f854}"
        case .schedulerUnknownRegular: return "\u{f855}"
        case .screenshotBold: return "\u{f856}"
        case .screenshotDocBold: return "\u{f857}"
        case .screenshotDocFilled: return "\u{f858}"
        case .screenshotDocLight: return "\u{f859}"
        case .screenshotDocRegular: return "\u{f85a}"
        case .screenshotLight: return "\u{f85b}"
        case .screenshotRegular: return "\u{f85c}"
        case .searchBold: return "\u{f85d}"
        case .searchFilled: return "\u{f85e}"
        case .searchLight: return "\u{f85f}"
        case .searchRegular: return "\u{f860}"
        case .secondaryArrowBold: return "\u{f861}"
        case .secondaryArrowLight: return "\u{f862}"
        case .secondaryArrowRegular: return "\u{f863}"
        case .secureCallLockBold: return "\u{f864}"
        case .secureCallLockFilled: return "\u{f865}"
        case .secureCallLockLight: return "\u{f866}"
        case .secureCallLockRegular: return "\u{f867}"
        case .secureCallShieldBold: return "\u{f868}"
        case .secureCallShieldFilled: return "\u{f869}"
        case .secureCallShieldLight: return "\u{f86a}"
        case .secureCallShieldRegular: return "\u{f86b}"
        case .secureCircleBold: return "\u{f86c}"
        case .secureCircleFilled: return "\u{f86d}"
        case .secureCircleLight: return "\u{f86e}"
        case .secureCircleRegular: return "\u{f86f}"
        case .secureLockBold: return "\u{f870}"
        case .secureLockFilled: return "\u{f871}"
        case .secureLockLight: return "\u{f872}"
        case .secureLockRegular: return "\u{f873}"
        case .selectAllBold: return "\u{f874}"
        case .selectAllFilled: return "\u{f875}"
        case .selectAllLight: return "\u{f876}"
        case .selectAllRegular: return "\u{f877}"
        case .selectionBold: return "\u{f878}"
        case .selectionLight: return "\u{f879}"
        case .selectionRegular: return "\u{f87a}"
        case .sendBold: return "\u{f87b}"
        case .sendFilled: return "\u{f87c}"
        case .sendLight: return "\u{f87d}"
        case .sendRegular: return "\u{f87e}"
        case .serverBold: return "\u{f87f}"
        case .serverErrorBold: return "\u{f880}"
        case .serverErrorLight: return "\u{f881}"
        case .serverErrorRegular: return "\u{f882}"
        case .serverLight: return "\u{f883}"
        case .serverRegular: return "\u{f884}"
        case .servicesBold: return "\u{f885}"
        case .servicesLight: return "\u{f886}"
        case .servicesRegular: return "\u{f887}"
        case .setVariableBold: return "\u{f888}"
        case .setVariableLight: return "\u{f889}"
        case .setVariableRegular: return "\u{f88a}"
        case .settingsBold: return "\u{f88b}"
        case .settingsFilled: return "\u{f88c}"
        case .settingsLight: return "\u{f88d}"
        case .settingsRegular: return "\u{f88e}"
        case .setupAssistantBold: return "\u{f88f}"
        case .setupAssistantLight: return "\u{f890}"
        case .setupAssistantRegular: return "\u{f891}"
        case .sftpBold: return "\u{f892}"
        case .sftpLight: return "\u{f893}"
        case .sftpRegular: return "\u{f894}"
        case .shapeCircleBold: return "\u{f895}"
        case .shapeCircleFilled: return "\u{f896}"
        case .shapeCircleLight: return "\u{f897}"
        case .shapeCircleRegular: return "\u{f898}"
        case .shapeDiagonalLineBold: return "\u{f899}"
        case .shapeDiagonalLineLight: return "\u{f89a}"
        case .shapeDiagonalLineRegular: return "\u{f89b}"
        case .shapeDiamondBold: return "\u{f89c}"
        case .shapeDiamondFilled: return "\u{f89d}"
        case .shapeDiamondLight: return "\u{f89e}"
        case .shapeDiamondRegular: return "\u{f89f}"
        case .shapeOvalBold: return "\u{f8a0}"
        case .shapeOvalLight: return "\u{f8a1}"
        case .shapeOvalRegular: return "\u{f8a2}"
        case .shapeSquareBold: return "\u{f8a3}"
        case .shapeSquareFilled: return "\u{f8a4}"
        case .shapeSquareLight: return "\u{f8a5}"
        case .shapeSquareRegular: return "\u{f8a6}"
        case .shapeTriangleBold: return "\u{f8a7}"
        case .shapeTriangleFilled: return "\u{f8a8}"
        case .shapeTriangleLight: return "\u{f8a9}"
        case .shapeTriangleRegular: return "\u{f8aa}"
        case .shapesBold: return "\u{f8ab}"
        case .shapesLight: return "\u{f8ac}"
        case .shapesRegular: return "\u{f8ad}"
        case .shareCNativeAdrBold: return "\u{f8ae}"
        case .shareCNativeAdrLight: return "\u{f8af}"
        case .shareCNativeAdrRegular: return "\u{f8b0}"
        case .shareCNativeIphBold: return "\u{f8b1}"
        case .shareCNativeIphLight: return "\u{f8b2}"
        case .shareCNativeIphRegular: return "\u{f8b3}"
        case .shareScreenBold: return "\u{f8b4}"
        case .shareScreenFilled: return "\u{f8b5}"
        case .shareScreenLight: return "\u{f8b6}"
        case .shareScreenRegular: return "\u{f8b7}"
        case .shareScreenSmallFilled: return "\u{f8b8}"
        case .shareSpaceBold: return "\u{f8b9}"
        case .shareSpaceLight: return "\u{f8ba}"
        case .shareSpaceRegular: return "\u{f8bb}"
        case .shieldBold: return "\u{f8bc}"
        case .shieldLight: return "\u{f8bd}"
        case .shieldRegular: return "\u{f8be}"
        case .shortTextBoxBold: return "\u{f8bf}"
        case .shortTextBoxLight: return "\u{f8c0}"
        case .shortTextBoxRegular: return "\u{f8c1}"
        case .showBold: return "\u{f8c2}"
        case .showFilled: return "\u{f8c3}"
        case .showLight: return "\u{f8c4}"
        case .showRegular: return "\u{f8c5}"
        case .signInBold: return "\u{f8c6}"
        case .signInFilled: return "\u{f8c7}"
        case .signInForcedBold: return "\u{f8c8}"
        case .signInForcedLight: return "\u{f8c9}"
        case .signInForcedRegular: return "\u{f8ca}"
        case .signInLight: return "\u{f8cb}"
        case .signInRegular: return "\u{f8cc}"
        case .signOutBold: return "\u{f8cd}"
        case .signOutLight: return "\u{f8ce}"
        case .signOutRegular: return "\u{f8cf}"
        case .signal0Bold: return "\u{f8d0}"
        case .signal0Light: return "\u{f8d1}"
        case .signal0Regular: return "\u{f8d2}"
        case .signal100Bold: return "\u{f8d3}"
        case .signal100Light: return "\u{f8d4}"
        case .signal100Regular: return "\u{f8d5}"
        case .signal25Bold: return "\u{f8d6}"
        case .signal25Light: return "\u{f8d7}"
        case .signal25Regular: return "\u{f8d8}"
        case .signal50Bold: return "\u{f8d9}"
        case .signal50Light: return "\u{f8da}"
        case .signal50Regular: return "\u{f8db}"
        case .signal75Bold: return "\u{f8dc}"
        case .signal75Light: return "\u{f8dd}"
        case .signal75Regular: return "\u{f8de}"
        case .simplePromotionBold: return "\u{f8df}"
        case .simplePromotionLight: return "\u{f8e0}"
        case .simplePromotionRegular: return "\u{f8e1}"
        case .singleNumberReachBold: return "\u{f8e2}"
        case .singleNumberReachLight: return "\u{f8e3}"
        case .singleNumberReachRegular: return "\u{f8e4}"
        case .sipRegistrationInProgressBold: return "\u{f8e5}"
        case .sipRegistrationInProgressFilled: return "\u{f8e6}"
        case .sipRegistrationInProgressLight: return "\u{f8e7}"
        case .sipRegistrationInProgressRegular: return "\u{f8e8}"
        case .skipBold: return "\u{f8e9}"
        case .skipBwBold: return "\u{f8ea}"
        case .skipBwFilled: return "\u{f8eb}"
        case .skipBwLight: return "\u{f8ec}"
        case .skipBwRegular: return "\u{f8ed}"
        case .skipFwBold: return "\u{f8ee}"
        case .skipFwFilled: return "\u{f8ef}"
        case .skipFwLight: return "\u{f8f0}"
        case .skipFwRegular: return "\u{f8f1}"
        case .skipLight: return "\u{f8f2}"
        case .skipRegular: return "\u{f8f3}"
        case .smsInboundBold: return "\u{f8f4}"
        case .smsInboundLight: return "\u{f8f5}"
        case .smsInboundRegular: return "\u{f8f6}"
        case .socialAlexaFilled: return "\u{f8f7}"
        case .socialFacebookColoredFilled: return "\u{f8f8}"
        case .socialFacebookFilled: return "\u{f8f9}"
        case .socialFbmessengerColoredFilled: return "\u{f8fa}"
        case .socialFbmessengerFilled: return "\u{f8fb}"
        case .socialInstagramBold: return "\u{f8fc}"
        case .socialMicrosoftColoredFilled: return "\u{f8fd}"
        case .socialMicrosoftFilled: return "\u{f8fe}"
        case .socialMmsFilled: return "\u{f8ff}"
        case .socialMmsGoldFilled: return "\u{f900}"
        case .socialSmsFilled: return "\u{f901}"
        case .socialSmsMintFilled: return "\u{f902}"
        case .socialTwitterColoredFilled: return "\u{f903}"
        case .socialTwitterFilled: return "\u{f904}"
        case .socialViberBold: return "\u{f905}"
        case .socialViberColoredBold: return "\u{f906}"
        case .socialWhatsappBold: return "\u{f907}"
        case .socialWhatsappColoredFilled: return "\u{f908}"
        case .sortAscendingBold: return "\u{f909}"
        case .sortAscendingLight: return "\u{f90a}"
        case .sortAscendingRegular: return "\u{f90b}"
        case .sortDescendingBold: return "\u{f90c}"
        case .sortDescendingLight: return "\u{f90d}"
        case .sortDescendingRegular: return "\u{f90e}"
        case .soundDefaultBold: return "\u{f90f}"
        case .soundDefaultLight: return "\u{f910}"
        case .soundDefaultRegular: return "\u{f911}"
        case .speakerBold: return "\u{f912}"
        case .speakerDisconnectedBold: return "\u{f913}"
        case .speakerDisconnectedFilled: return "\u{f914}"
        case .speakerDisconnectedLight: return "\u{f915}"
        case .speakerDisconnectedRegular: return "\u{f916}"
        case .speakerFilled: return "\u{f917}"
        case .speakerLight: return "\u{f918}"
        case .speakerMutedBold: return "\u{f919}"
        case .speakerMutedFilled: return "\u{f91a}"
        case .speakerMutedLight: return "\u{f91b}"
        case .speakerMutedRegular: return "\u{f91c}"
        case .speakerOffBold: return "\u{f91d}"
        case .speakerOffFilled: return "\u{f91e}"
        case .speakerOffLight: return "\u{f91f}"
        case .speakerOffRegular: return "\u{f920}"
        case .speakerOnColoredBold: return "\u{f921}"
        case .speakerOnColoredLight: return "\u{f922}"
        case .speakerOnColoredRegular: return "\u{f923}"
        case .speakerRegular: return "\u{f924}"
        case .speakerTurnDownBold: return "\u{f925}"
        case .speakerTurnDownFilled: return "\u{f926}"
        case .speakerTurnDownLight: return "\u{f927}"
        case .speakerTurnDownRegular: return "\u{f928}"
        case .speakerTurnUpBold: return "\u{f929}"
        case .speakerTurnUpFilled: return "\u{f92a}"
        case .speakerTurnUpLight: return "\u{f92b}"
        case .speakerTurnUpRegular: return "\u{f92c}"
        case .spinnerBold: return "\u{f92d}"
        case .spinnerFilledBold: return "\u{f92e}"
        case .spinnerFilledLight: return "\u{f92f}"
        case .spinnerFilledRegular: return "\u{f930}"
        case .spinnerLight: return "\u{f931}"
        case .spinnerPartialBold: return "\u{f932}"
        case .spinnerPartialLight: return "\u{f933}"
        case .spinnerPartialRegular: return "\u{f934}"
        case .spinnerRegular: return "\u{f935}"
        case .stackedArea100ChartBold: return "\u{f936}"
        case .stackedArea100ChartFilled: return "\u{f937}"
        case .stackedArea100ChartLight: return "\u{f938}"
        case .stackedArea100ChartRegular: return "\u{f939}"
        case .stackedAreaChartBold: return "\u{f93a}"
        case .stackedAreaChartFilled: return "\u{f93b}"
        case .stackedAreaChartLight: return "\u{f93c}"
        case .stackedAreaChartRegular: return "\u{f93d}"
        case .stackedBar100ChartBold: return "\u{f93e}"
        case .stackedBar100ChartFilled: return "\u{f93f}"
        case .stackedBar100ChartLight: return "\u{f940}"
        case .stackedBar100ChartRegular: return "\u{f941}"
        case .stackedBarChartBold: return "\u{f942}"
        case .stackedBarChartFilled: return "\u{f943}"
        case .stackedBarChartLight: return "\u{f944}"
        case .stackedBarChartRegular: return "\u{f945}"
        case .startChatBold: return "\u{f946}"
        case .startChatLight: return "\u{f947}"
        case .startChatRegular: return "\u{f948}"
        case .stethoscopeBold: return "\u{f949}"
        case .stethoscopeLight: return "\u{f94a}"
        case .stethoscopeRegular: return "\u{f94b}"
        case .stickersBold: return "\u{f94c}"
        case .stickersLight: return "\u{f94d}"
        case .stickersRegular: return "\u{f94e}"
        case .stickiesBold: return "\u{f94f}"
        case .stickiesLight: return "\u{f950}"
        case .stickiesRegular: return "\u{f951}"
        case .stopBold: return "\u{f952}"
        case .stopCircleBold: return "\u{f953}"
        case .stopCircleFilled: return "\u{f954}"
        case .stopCircleLight: return "\u{f955}"
        case .stopCircleRegular: return "\u{f956}"
        case .stopContentShareBold: return "\u{f957}"
        case .stopContentShareLight: return "\u{f958}"
        case .stopContentShareRegular: return "\u{f959}"
        case .stopFilled: return "\u{f95a}"
        case .stopLight: return "\u{f95b}"
        case .stopRegular: return "\u{f95c}"
        case .storedInfoBold: return "\u{f95d}"
        case .storedInfoFilled: return "\u{f95e}"
        case .storedInfoLight: return "\u{f95f}"
        case .storedInfoRegular: return "\u{f960}"
        case .streamingBold: return "\u{f961}"
        case .streamingLight: return "\u{f962}"
        case .streamingRegular: return "\u{f963}"
        case .strikethroughBold: return "\u{f964}"
        case .strikethroughLight: return "\u{f965}"
        case .strikethroughRegular: return "\u{f966}"
        case .subscriptBold: return "\u{f967}"
        case .subscriptLight: return "\u{f968}"
        case .subscriptRegular: return "\u{f969}"
        case .superscriptBold: return "\u{f96a}"
        case .superscriptLight: return "\u{f96b}"
        case .superscriptRegular: return "\u{f96c}"
        case .surveyBold: return "\u{f96d}"
        case .surveyFilled: return "\u{f96e}"
        case .surveyLight: return "\u{f96f}"
        case .surveyRegular: return "\u{f970}"
        case .surveyBold: return "\u{f971}"
        case .surveyFilled: return "\u{f972}"
        case .surveyLight: return "\u{f973}"
        case .surveyRegular: return "\u{f974}"
        case .sx10Bold: return "\u{f975}"
        case .sx10Light: return "\u{f976}"
        case .sx10Regular: return "\u{f977}"
        case .sx20Bold: return "\u{f978}"
        case .sx20Light: return "\u{f979}"
        case .sx20Regular: return "\u{f97a}"
        case .sx80CodecBold: return "\u{f97b}"
        case .sx80CodecLight: return "\u{f97c}"
        case .sx80CodecRegular: return "\u{f97d}"
        case .tableBold: return "\u{f97e}"
        case .tableLight: return "\u{f97f}"
        case .tableRegular: return "\u{f980}"
        case .tabletBold: return "\u{f981}"
        case .tabletLight: return "\u{f982}"
        case .tabletRegular: return "\u{f983}"
        case .tabsBold: return "\u{f984}"
        case .tabsLight: return "\u{f985}"
        case .tabsRegular: return "\u{f986}"
        case .tagBold: return "\u{f987}"
        case .tagLight: return "\u{f988}"
        case .tagRegular: return "\u{f989}"
        case .tapBold: return "\u{f98a}"
        case .tapFilled: return "\u{f98b}"
        case .tapLight: return "\u{f98c}"
        case .tapRegular: return "\u{f98d}"
        case .telepresenceAlertBold: return "\u{f98e}"
        case .telepresenceAlertLight: return "\u{f98f}"
        case .telepresenceAlertMutedBold: return "\u{f990}"
        case .telepresenceAlertMutedLight: return "\u{f991}"
        case .telepresenceAlertMutedRegular: return "\u{f992}"
        case .telepresenceAlertRegular: return "\u{f993}"
        case .telepresenceBold: return "\u{f994}"
        case .telepresenceIx5000Bold: return "\u{f995}"
        case .telepresenceIx5000Light: return "\u{f996}"
        case .telepresenceIx5000Regular: return "\u{f997}"
        case .telepresenceLight: return "\u{f998}"
        case .telepresencePrivateBold: return "\u{f999}"
        case .telepresencePrivateLight: return "\u{f99a}"
        case .telepresencePrivateRegular: return "\u{f99b}"
        case .telepresenceRegular: return "\u{f99c}"
        case .temperatureBold: return "\u{f99d}"
        case .temperatureLight: return "\u{f99e}"
        case .temperatureRegular: return "\u{f99f}"
        case .textAlignCenterBold: return "\u{f9a0}"
        case .textAlignCenterFilled: return "\u{f9a1}"
        case .textAlignCenterLight: return "\u{f9a2}"
        case .textAlignCenterRegular: return "\u{f9a3}"
        case .textAlignLeftBold: return "\u{f9a4}"
        case .textAlignLeftFilled: return "\u{f9a5}"
        case .textAlignLeftLight: return "\u{f9a6}"
        case .textAlignLeftRegular: return "\u{f9a7}"
        case .textAlignRightBold: return "\u{f9a8}"
        case .textAlignRightFilled: return "\u{f9a9}"
        case .textAlignRightLight: return "\u{f9aa}"
        case .textAlignRightRegular: return "\u{f9ab}"
        case .textBold: return "\u{f9ac}"
        case .textCodeBlockBold: return "\u{f9ad}"
        case .textCodeBlockLight: return "\u{f9ae}"
        case .textCodeBlockRegular: return "\u{f9af}"
        case .textHighlightBold: return "\u{f9b0}"
        case .textHighlightLight: return "\u{f9b1}"
        case .textHighlightRegular: return "\u{f9b2}"
        case .textLight: return "\u{f9b3}"
        case .textRegular: return "\u{f9b4}"
        case .threeColumnBold: return "\u{f9b5}"
        case .threeColumnLight: return "\u{f9b6}"
        case .threeColumnRegular: return "\u{f9b7}"
        case .threeDObjectBold: return "\u{f9b8}"
        case .threeDObjectLight: return "\u{f9b9}"
        case .threeDObjectRegular: return "\u{f9ba}"
        case .tooFastBold: return "\u{f9bb}"
        case .tooFastLight: return "\u{f9bc}"
        case .tooFastRegular: return "\u{f9bd}"
        case .tooSlowBold: return "\u{f9be}"
        case .tooSlowLight: return "\u{f9bf}"
        case .tooSlowRegular: return "\u{f9c0}"
        case .toolsBold: return "\u{f9c1}"
        case .toolsLight: return "\u{f9c2}"
        case .toolsRegular: return "\u{f9c3}"
        case .touch10Bold: return "\u{f9c4}"
        case .touch10Light: return "\u{f9c5}"
        case .touch10Regular: return "\u{f9c6}"
        case .transcriptBold: return "\u{f9c7}"
        case .transcriptFilled: return "\u{f9c8}"
        case .transcriptLight: return "\u{f9c9}"
        case .transcriptRegular: return "\u{f9ca}"
        case .translateBold: return "\u{f9cb}"
        case .translateLight: return "\u{f9cc}"
        case .translateRegular: return "\u{f9cd}"
        case .trimBold: return "\u{f9ce}"
        case .trimLight: return "\u{f9cf}"
        case .trimRegular: return "\u{f9d0}"
        case .twoColumnBold: return "\u{f9d1}"
        case .twoColumnLight: return "\u{f9d2}"
        case .twoColumnRegular: return "\u{f9d3}"
        case .ucmCloudBold: return "\u{f9d4}"
        case .ucmCloudLight: return "\u{f9d5}"
        case .ucmCloudRegular: return "\u{f9d6}"
        case .underlineBold: return "\u{f9d7}"
        case .underlineLight: return "\u{f9d8}"
        case .underlineRegular: return "\u{f9d9}"
        case .undoBold: return "\u{f9da}"
        case .undoLight: return "\u{f9db}"
        case .undoRegular: return "\u{f9dc}"
        case .unlinkBold: return "\u{f9dd}"
        case .unlinkLight: return "\u{f9de}"
        case .unlinkRegular: return "\u{f9df}"
        case .unreadBold: return "\u{f9e0}"
        case .unreadFilled: return "\u{f9e1}"
        case .unreadLight: return "\u{f9e2}"
        case .unreadRegular: return "\u{f9e3}"
        case .unsecureUnlockedBold: return "\u{f9e4}"
        case .unsecureUnlockedFilled: return "\u{f9e5}"
        case .unsecureUnlockedLight: return "\u{f9e6}"
        case .unsecureUnlockedRegular: return "\u{f9e7}"
        case .unsortedBold: return "\u{f9e8}"
        case .unsortedLight: return "\u{f9e9}"
        case .unsortedRegular: return "\u{f9ea}"
        case .updateFileShareBold: return "\u{f9eb}"
        case .updateFileShareLight: return "\u{f9ec}"
        case .updateFileShareRegular: return "\u{f9ed}"
        case .upgradeBold: return "\u{f9ee}"
        case .upgradeFilled: return "\u{f9ef}"
        case .upgradeLight: return "\u{f9f0}"
        case .upgradeRegular: return "\u{f9f1}"
        case .uploadBold: return "\u{f9f2}"
        case .uploadLight: return "\u{f9f3}"
        case .uploadRegular: return "\u{f9f4}"
        case .urgentVoicemailBold: return "\u{f9f5}"
        case .urgentVoicemailFilled: return "\u{f9f6}"
        case .usbBold: return "\u{f9f7}"
        case .usbHeadsetBold: return "\u{f9f8}"
        case .usbHeadsetLight: return "\u{f9f9}"
        case .usbHeadsetMutedBold: return "\u{f9fa}"
        case .usbHeadsetMutedLight: return "\u{f9fb}"
        case .usbHeadsetMutedRegular: return "\u{f9fc}"
        case .usbHeadsetRegular: return "\u{f9fd}"
        case .usbLight: return "\u{f9fe}"
        case .usbRegular: return "\u{f9ff}"
        case .userBold: return "\u{fa00}"
        case .userDeactivateBold: return "\u{fa01}"
        case .userDeactivateLight: return "\u{fa02}"
        case .userDeactivateRegular: return "\u{fa03}"
        case .userLight: return "\u{fa04}"
        case .userRegular: return "\u{fa05}"
        case .vcsBold: return "\u{fa06}"
        case .vcsLight: return "\u{fa07}"
        case .vcsRegular: return "\u{fa08}"
        case .videoBlurBold: return "\u{fa09}"
        case .videoBlurFilled: return "\u{fa0a}"
        case .videoBlurLight: return "\u{fa0b}"
        case .videoBlurRegular: return "\u{fa0c}"
        case .videoBold: return "\u{fa0d}"
        case .videoEffectBold: return "\u{fa0e}"
        case .videoEffectFilled: return "\u{fa0f}"
        case .videoEffectLight: return "\u{fa10}"
        case .videoEffectRegular: return "\u{fa11}"
        case .videoFilled: return "\u{fa12}"
        case .videoLayoutBold: return "\u{fa13}"
        case .videoLayoutEqualBold: return "\u{fa14}"
        case .videoLayoutEqualDualBold: return "\u{fa15}"
        case .videoLayoutEqualDualLight: return "\u{fa16}"
        case .videoLayoutEqualDualRegular: return "\u{fa17}"
        case .videoLayoutEqualFilled: return "\u{fa18}"
        case .videoLayoutEqualLight: return "\u{fa19}"
        case .videoLayoutEqualRegular: return "\u{fa1a}"
        case .videoLayoutFilled: return "\u{fa1b}"
        case .videoLayoutLight: return "\u{fa1c}"
        case .videoLayoutOverlayBold: return "\u{fa1d}"
        case .videoLayoutOverlayLight: return "\u{fa1e}"
        case .videoLayoutOverlayRegular: return "\u{fa1f}"
        case .videoLayoutPresenterDominantBold: return "\u{fa20}"
        case .videoLayoutPresenterDominantLight: return "\u{fa21}"
        case .videoLayoutPresenterDominantRegular: return "\u{fa22}"
        case .videoLayoutProminentBold: return "\u{fa23}"
        case .videoLayoutProminentFilled: return "\u{fa24}"
        case .videoLayoutProminentLight: return "\u{fa25}"
        case .videoLayoutProminentRegular: return "\u{fa26}"
        case .videoLayoutRegular: return "\u{fa27}"
        case .videoLayoutShareDominantBold: return "\u{fa28}"
        case .videoLayoutShareDominantLight: return "\u{fa29}"
        case .videoLayoutShareDominantRegular: return "\u{fa2a}"
        case .videoLayoutSingleBold: return "\u{fa2b}"
        case .videoLayoutSingleFilled: return "\u{fa2c}"
        case .videoLayoutSingleLight: return "\u{fa2d}"
        case .videoLayoutSingleRegular: return "\u{fa2e}"
        case .videoLayoutStackBold: return "\u{fa2f}"
        case .videoLayoutStackFilled: return "\u{fa30}"
        case .videoLayoutStackLight: return "\u{fa31}"
        case .videoLayoutStackRegular: return "\u{fa32}"
        case .videoLayoutVideoDominantBold: return "\u{fa33}"
        case .videoLayoutVideoDominantLight: return "\u{fa34}"
        case .videoLayoutVideoDominantRegular: return "\u{fa35}"
        case .videoLight: return "\u{fa36}"
        case .videoPlusBold: return "\u{fa37}"
        case .videoPlusFilled: return "\u{fa38}"
        case .videoPlusLight: return "\u{fa39}"
        case .videoPlusRegular: return "\u{fa3a}"
        case .videoRegular: return "\u{fa3b}"
        case .videoSpeakerTrackBold: return "\u{fa3c}"
        case .videoSpeakerTrackFilled: return "\u{fa3d}"
        case .videoSpeakerTrackLight: return "\u{fa3e}"
        case .videoSpeakerTrackRegular: return "\u{fa3f}"
        case .viewAllBold: return "\u{fa40}"
        case .viewAllLight: return "\u{fa41}"
        case .viewAllRegular: return "\u{fa42}"
        case .viewListBold: return "\u{fa43}"
        case .viewListLight: return "\u{fa44}"
        case .viewListRegular: return "\u{fa45}"
        case .viewStackedBold: return "\u{fa46}"
        case .viewStackedFilled: return "\u{fa47}"
        case .viewStackedLight: return "\u{fa48}"
        case .viewStackedRegular: return "\u{fa49}"
        case .viewThumbnailBold: return "\u{fa4a}"
        case .viewThumbnailFilled: return "\u{fa4b}"
        case .viewThumbnailLight: return "\u{fa4c}"
        case .viewThumbnailRegular: return "\u{fa4d}"
        case .voicemailBold: return "\u{fa4e}"
        case .voicemailFilled: return "\u{fa4f}"
        case .voicemailLight: return "\u{fa50}"
        case .voicemailRegular: return "\u{fa51}"
        case .waffleMenuBold: return "\u{fa52}"
        case .waffleMenuLight: return "\u{fa53}"
        case .waffleMenuRegular: return "\u{fa54}"
        case .waitingroomActiveBold: return "\u{fa55}"
        case .waitingroomActiveLight: return "\u{fa56}"
        case .waitingroomActiveRegular: return "\u{fa57}"
        case .wallpaperBold: return "\u{fa58}"
        case .wallpaperLight: return "\u{fa59}"
        case .wallpaperRegular: return "\u{fa5a}"
        case .warningBadgeFilled: return "\u{fa5b}"
        case .warningBold: return "\u{fa5c}"
        case .warningFilled: return "\u{fa5d}"
        case .warningLight: return "\u{fa5e}"
        case .warningRegular: return "\u{fa5f}"
        case .webexAssistantActiveColored: return "\u{fa60}"
        case .webexAssistantInactiveColored: return "\u{fa61}"
        case .webexBoardBold: return "\u{fa62}"
        case .webexBoardLight: return "\u{fa63}"
        case .webexBoardRegular: return "\u{fa64}"
        case .webexCodecPlusBold: return "\u{fa65}"
        case .webexCodecPlusLight: return "\u{fa66}"
        case .webexCodecPlusRegular: return "\u{fa67}"
        case .webexDeskCameraBold: return "\u{fa68}"
        case .webexDeskCameraLight: return "\u{fa69}"
        case .webexDeskCameraRegular: return "\u{fa6a}"
        case .webexHelixFilled: return "\u{fa6b}"
        case .webexMeetingsBold: return "\u{fa6c}"
        case .webexMeetingsFilled: return "\u{fa6d}"
        case .webexMeetingsLight: return "\u{fa6e}"
        case .webexMeetingsRegular: return "\u{fa6f}"
        case .webexQuadCameraBold: return "\u{fa70}"
        case .webexQuadCameraLight: return "\u{fa71}"
        case .webexQuadCameraRegular: return "\u{fa72}"
        case .webexRoomKitBold: return "\u{fa73}"
        case .webexRoomKitLight: return "\u{fa74}"
        case .webexRoomKitPlusBold: return "\u{fa75}"
        case .webexRoomKitPlusLight: return "\u{fa76}"
        case .webexRoomKitPlusRegular: return "\u{fa77}"
        case .webexRoomKitRegular: return "\u{fa78}"
        case .webexShareBold: return "\u{fa79}"
        case .webexShareLight: return "\u{fa7a}"
        case .webexShareRegular: return "\u{fa7b}"
        case .webexTeamsBold: return "\u{fa7c}"
        case .webexTeamsFilled: return "\u{fa7d}"
        case .webexTeamsLight: return "\u{fa7e}"
        case .webexTeamsNewBold: return "\u{fa7f}"
        case .webexTeamsNewFilled: return "\u{fa80}"
        case .webexTeamsNewLight: return "\u{fa81}"
        case .webexTeamsNewRegular: return "\u{fa82}"
        case .webexTeamsRegular: return "\u{fa83}"
        case .webinarBold: return "\u{fa84}"
        case .webinarFilled: return "\u{fa85}"
        case .webinarLight: return "\u{fa86}"
        case .webinarRegular: return "\u{fa87}"
        case .weeklyRecurringScheduleNodeBold: return "\u{fa88}"
        case .weeklyRecurringScheduleNodeLight: return "\u{fa89}"
        case .weeklyRecurringScheduleNodeRegular: return "\u{fa8a}"
        case .whiteboardBold: return "\u{fa8b}"
        case .whiteboardContentBold: return "\u{fa8c}"
        case .whiteboardContentLight: return "\u{fa8d}"
        case .whiteboardContentRegular: return "\u{fa8e}"
        case .whiteboardFilled: return "\u{fa8f}"
        case .whiteboardLight: return "\u{fa90}"
        case .whiteboardRegular: return "\u{fa91}"
        case .widgetBold: return "\u{fa92}"
        case .widgetFilled: return "\u{fa93}"
        case .widgetLight: return "\u{fa94}"
        case .widgetRegular: return "\u{fa95}"
        case .wifiBold: return "\u{fa96}"
        case .wifiErrorBold: return "\u{fa97}"
        case .wifiErrorLight: return "\u{fa98}"
        case .wifiErrorRegular: return "\u{fa99}"
        case .wifiLight: return "\u{fa9a}"
        case .wifiRegular: return "\u{fa9b}"
        case .wifiSignalGoodColoredBold: return "\u{fa9c}"
        case .wifiSignalGoodColoredLight: return "\u{fa9d}"
        case .wifiSignalGoodColoredRegular: return "\u{fa9e}"
        case .wifiSignalPoorColoredBold: return "\u{fa9f}"
        case .wifiSignalPoorColoredLight: return "\u{faa0}"
        case .wifiSignalPoorColoredRegular: return "\u{faa1}"
        case .wifiSignalUnstableColoredBold: return "\u{faa2}"
        case .wifiSignalUnstableColoredLight: return "\u{faa3}"
        case .wifiSignalUnstableColoredRegular: return "\u{faa4}"
        case .windowCornerScrubBold: return "\u{faa5}"
        case .windowCornerScrubLight: return "\u{faa6}"
        case .windowCornerScrubRegular: return "\u{faa7}"
        case .windowRightCornerScrubBold: return "\u{faa8}"
        case .windowRightCornerScrubLight: return "\u{faa9}"
        case .windowRightCornerScrubRegular: return "\u{faaa}"
        case .windowVerticalScrubBold: return "\u{faab}"
        case .windowVerticalScrubLight: return "\u{faac}"
        case .windowVerticalScrubRegular: return "\u{faad}"
        case .workflowDeploymentsBold: return "\u{faae}"
        case .workflowDeploymentsLight: return "\u{faaf}"
        case .workflowDeploymentsRegular: return "\u{fab0}"
        case .workphoneBold: return "\u{fab1}"
        case .workphoneLight: return "\u{fab2}"
        case .workphoneRegular: return "\u{fab3}"
        case .zoomInBold: return "\u{fab4}"
        case .zoomInLight: return "\u{fab5}"
        case .zoomInRegular: return "\u{fab6}"
        case .zoomOutBold: return "\u{fab7}"
        case .zoomOutLight: return "\u{fab8}"
        case .zoomOutRegular: return "\u{fab9}"
        case .zoom: return "\u{faba}"
    ...
    public var filename: String {
        ...
        case .alignHorizontalCenterBold: return "align-horizontal-center_bold"
        case .alignHorizontalCenterFilled: return "align-horizontal-center_filled"
        case .alignHorizontalCenterLight: return "align-horizontal-center_light"
        case .alignHorizontalCenterRegular: return "align-horizontal-center_regular"
        ...
        case .alignVerticalCenterBold: return "align-vertical-center_bold"
        case .alignVerticalCenterFilled: return "align-vertical-center_filled"
        case .alignVerticalCenterLight: return "align-vertical-center_light"
        case .alignVerticalCenterRegular: return "align-vertical-center_regular"
        ...
        case .checkCircleLight: return "check-circle_light"
        case .checkCircleRegular: return "check-circle_regular"
        ...
        case .recordActiveBold: return "record-active_bold"
        case .recordActiveFilled: return "record-active_filled"
        case .recordActiveLight: return "record-active_light"
        case .recordActiveRegular: return "record-active_regular"
