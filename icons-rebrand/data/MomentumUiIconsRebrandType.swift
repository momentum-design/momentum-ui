...
@objc public enum MomentumIconsRebrandType: Int, CaseIterable {
    ...
    public var ligature: String {
        ...
        case .devicePolicyControllerBold: return "\u{f3a9}"
        case .devicePolicyControllerLight: return "\u{f3aa}"
        case .devicePolicyControllerRegular: return "\u{f3ab}"
        case .diagnosticsBold: return "\u{f3ac}"
        case .diagnosticsLight: return "\u{f3ad}"
        case .diagnosticsRegular: return "\u{f3ae}"
        case .dialpadBold: return "\u{f3af}"
        case .dialpadLight: return "\u{f3b0}"
        case .dialpadRegular: return "\u{f3b1}"
        case .directionalPadBold: return "\u{f3b2}"
        case .directionalPadFilled: return "\u{f3b3}"
        case .directionalPadLight: return "\u{f3b4}"
        case .directionalPadRegular: return "\u{f3b5}"
        case .directoryBold: return "\u{f3b6}"
        case .directoryLight: return "\u{f3b7}"
        case .directoryRegular: return "\u{f3b8}"
        case .disappearingPenBold: return "\u{f3b9}"
        case .disappearingPenLight: return "\u{f3ba}"
        case .disappearingPenRegular: return "\u{f3bb}"
        case .discBold: return "\u{f3bc}"
        case .discDisconnectedBold: return "\u{f3bd}"
        case .discDisconnectedLight: return "\u{f3be}"
        case .discDisconnectedRegular: return "\u{f3bf}"
        case .discLight: return "\u{f3c0}"
        case .discRegular: return "\u{f3c1}"
        case .disconnectBold: return "\u{f3c2}"
        case .disconnectFilled: return "\u{f3c3}"
        case .disconnectLight: return "\u{f3c4}"
        case .disconnectRegular: return "\u{f3c5}"
        case .dislikeBold: return "\u{f3c6}"
        case .dislikeFilled: return "\u{f3c7}"
        case .dislikeLight: return "\u{f3c8}"
        case .dislikeRegular: return "\u{f3c9}"
        case .displayBold: return "\u{f3ca}"
        case .displayInputBold: return "\u{f3cb}"
        case .displayInputLight: return "\u{f3cc}"
        case .displayInputRegular: return "\u{f3cd}"
        case .displayLight: return "\u{f3ce}"
        case .displayRegular: return "\u{f3cf}"
        case .displayWarningBold: return "\u{f3d0}"
        case .displayWarningLight: return "\u{f3d1}"
        case .displayWarningRegular: return "\u{f3d2}"
        case .distributeHorizontalBold: return "\u{f3d3}"
        case .distributeHorizontalFilled: return "\u{f3d4}"
        case .distributeHorizontalLight: return "\u{f3d5}"
        case .distributeHorizontalRegular: return "\u{f3d6}"
        case .distributeVerticallyBold: return "\u{f3d7}"
        case .distributeVerticallyFilled: return "\u{f3d8}"
        case .distributeVerticallyLight: return "\u{f3d9}"
        case .distributeVerticallyRegular: return "\u{f3da}"
        case .dndPresenceBold: return "\u{f3db}"
        case .dndPresenceFilled: return "\u{f3dc}"
        case .dndPresenceLight: return "\u{f3dd}"
        case .dndPresenceRegular: return "\u{f3de}"
        case .dndPresenceSmallFilled: return "\u{f3df}"
        case .documentBold: return "\u{f3e0}"
        case .documentCameraBold: return "\u{f3e1}"
        case .documentCameraDisconnectedBold: return "\u{f3e2}"
        case .documentCameraDisconnectedLight: return "\u{f3e3}"
        case .documentCameraDisconnectedRegular: return "\u{f3e4}"
        case .documentCameraLight: return "\u{f3e5}"
        case .documentCameraRegular: return "\u{f3e6}"
        case .documentCreateBold: return "\u{f3e7}"
        case .documentCreateFilled: return "\u{f3e8}"
        case .documentCreateLight: return "\u{f3e9}"
        case .documentCreateRegular: return "\u{f3ea}"
        case .documentFilled: return "\u{f3eb}"
        case .documentLight: return "\u{f3ec}"
        case .documentMoveBold: return "\u{f3ed}"
        case .documentMoveFilled: return "\u{f3ee}"
        case .documentMoveLight: return "\u{f3ef}"
        case .documentMoveRegular: return "\u{f3f0}"
        case .documentRegular: return "\u{f3f1}"
        case .documentShareBold: return "\u{f3f2}"
        case .documentShareFilled: return "\u{f3f3}"
        case .documentShareLight: return "\u{f3f4}"
        case .documentShareRegular: return "\u{f3f5}"
        case .doneAllBold: return "\u{f3f6}"
        case .doneAllLight: return "\u{f3f7}"
        case .doneAllRegular: return "\u{f3f8}"
        case .donutChartBold: return "\u{f3f9}"
        case .donutChartFilled: return "\u{f3fa}"
        case .donutChartLight: return "\u{f3fb}"
        case .donutChartRegular: return "\u{f3fc}"
        case .downloadBold: return "\u{f3fd}"
        case .downloadFilled: return "\u{f3fe}"
        case .downloadLight: return "\u{f3ff}"
        case .downloadRegular: return "\u{f400}"
        case .draftBold: return "\u{f401}"
        case .draftFilled: return "\u{f402}"
        case .draftIndicatorBold: return "\u{f403}"
        case .draftIndicatorSmallFilled: return "\u{f404}"
        case .draftLight: return "\u{f405}"
        case .draftRegular: return "\u{f406}"
        case .dragBold: return "\u{f407}"
        case .dragLight: return "\u{f408}"
        case .dragRegular: return "\u{f409}"
        case .dropdownBold: return "\u{f40a}"
        case .dropdownLight: return "\u{f40b}"
        case .dropdownRegular: return "\u{f40c}"
        case .dx70Bold: return "\u{f40d}"
        case .dx70Light: return "\u{f40e}"
        case .dx70Regular: return "\u{f40f}"
        case .dx80Bold: return "\u{f410}"
        case .dx80Filled: return "\u{f411}"
        case .dx80Light: return "\u{f412}"
        case .dx80Regular: return "\u{f413}"
        case .editBold: return "\u{f414}"
        case .editLight: return "\u{f415}"
        case .editRegular: return "\u{f416}"
        case .editablePartialBold: return "\u{f417}"
        case .editablePartialLight: return "\u{f418}"
        case .editablePartialRegular: return "\u{f419}"
        case .educationBold: return "\u{f41a}"
        case .educationFilled: return "\u{f41b}"
        case .educationLight: return "\u{f41c}"
        case .educationRegular: return "\u{f41d}"
        case .emailBold: return "\u{f41e}"
        case .emailDeliveredBold: return "\u{f41f}"
        case .emailDeliveredLight: return "\u{f420}"
        case .emailDeliveredRegular: return "\u{f421}"
        case .emailFailureBold: return "\u{f422}"
        case .emailFailureLight: return "\u{f423}"
        case .emailFailureRegular: return "\u{f424}"
        case .emailFilled: return "\u{f425}"
        case .emailInviteBold: return "\u{f426}"
        case .emailInviteLight: return "\u{f427}"
        case .emailInviteRegular: return "\u{f428}"
        case .emailLight: return "\u{f429}"
        case .emailReadBold: return "\u{f42a}"
        case .emailReadFilled: return "\u{f42b}"
        case .emailReadLight: return "\u{f42c}"
        case .emailReadRegular: return "\u{f42d}"
        case .emailRegular: return "\u{f42e}"
        case .emojiExcitedBold: return "\u{f42f}"
        case .emojiExcitedFilled: return "\u{f430}"
        case .emojiHappyBold: return "\u{f431}"
        case .emojiHappyFilled: return "\u{f432}"
        case .emojiHappyLight: return "\u{f433}"
        case .emojiHappyRegular: return "\u{f434}"
        case .emojiPassiveBold: return "\u{f435}"
        case .emojiPassiveFilled: return "\u{f436}"
        case .emojiPassiveLight: return "\u{f437}"
        case .emojiPassiveRegular: return "\u{f438}"
        case .emojiSadBold: return "\u{f439}"
        case .emojiSadFilled: return "\u{f43a}"
        case .emojiSadLight: return "\u{f43b}"
        case .emojiSadRegular: return "\u{f43c}"
        case .emojiUnhappyBold: return "\u{f43d}"
        case .emojiUnhappyFilled: return "\u{f43e}"
        case .encryptionCircleFilled: return "\u{f43f}"
        case .encryptionFilled: return "\u{f440}"
        case .endRemoteDesktopControlBold: return "\u{f441}"
        case .endRemoteDesktopControlLight: return "\u{f442}"
        case .endRemoteDesktopControlRegular: return "\u{f443}"
        case .endToEndEncryptionCircleFilled: return "\u{f444}"
        case .endToEndEncryptionFilled: return "\u{f445}"
        case .endpointBlockedBold: return "\u{f446}"
        case .endpointBlockedLight: return "\u{f447}"
        case .endpointBlockedRegular: return "\u{f448}"
        case .endpointBold: return "\u{f449}"
        case .endpointG270Bold: return "\u{f44a}"
        case .endpointG270DualBold: return "\u{f44b}"
        case .endpointG270DualLight: return "\u{f44c}"
        case .endpointG270DualRegular: return "\u{f44d}"
        case .endpointG270Light: return "\u{f44e}"
        case .endpointG270Regular: return "\u{f44f}"
        case .endpointG2Bold: return "\u{f450}"
        case .endpointG2Light: return "\u{f451}"
        case .endpointG2Regular: return "\u{f452}"
        case .endpointG2StandBold: return "\u{f453}"
        case .endpointG2StandLight: return "\u{f454}"
        case .endpointG2StandRegular: return "\u{f455}"
        case .endpointLight: return "\u{f456}"
        case .endpointMx800Bold: return "\u{f457}"
        case .endpointMx800DualBold: return "\u{f458}"
        case .endpointMx800DualLight: return "\u{f459}"
        case .endpointMx800DualRegular: return "\u{f45a}"
        case .endpointMx800Light: return "\u{f45b}"
        case .endpointMx800Regular: return "\u{f45c}"
        case .endpointRegular: return "\u{f45d}"
        case .endpointStandBold: return "\u{f45e}"
        case .endpointStandFilled: return "\u{f45f}"
        case .endpointStandLight: return "\u{f460}"
        case .endpointStandRegular: return "\u{f461}"
        case .endpointWarningBold: return "\u{f462}"
        case .endpointWarningLight: return "\u{f463}"
        case .endpointWarningRegular: return "\u{f464}"
        case .enterBold: return "\u{f465}"
        case .enterLight: return "\u{f466}"
        case .enterRegular: return "\u{f467}"
        case .enterRoomBold: return "\u{f468}"
        case .enterRoomFilled: return "\u{f469}"
        case .enterRoomLight: return "\u{f46a}"
        case .enterRoomRegular: return "\u{f46b}"
        case .eraserBold: return "\u{f46c}"
        case .eraserFilled: return "\u{f46d}"
        case .eraserLight: return "\u{f46e}"
        case .eraserRegular: return "\u{f46f}"
        case .errorLegacyBadgeFilled: return "\u{f470}"
        case .errorLegacyBold: return "\u{f471}"
        case .errorLegacyFilled: return "\u{f472}"
        case .errorLegacyLight: return "\u{f473}"
        case .errorLegacyRegular: return "\u{f474}"
        case .ethernetBold: return "\u{f475}"
        case .ethernetLight: return "\u{f476}"
        case .ethernetRegular: return "\u{f477}"
        case .eventBold: return "\u{f478}"
        case .eventLight: return "\u{f479}"
        case .eventRegular: return "\u{f47a}"
        case .exchangeBold: return "\u{f47b}"
        case .exchangeLight: return "\u{f47c}"
        case .exchangeRegular: return "\u{f47d}"
        case .exitRoomBold: return "\u{f47e}"
        case .exitRoomLight: return "\u{f47f}"
        case .exitRoomRegular: return "\u{f480}"
        case .exludeBold: return "\u{f481}"
        case .exludeLight: return "\u{f482}"
        case .exludeRegular: return "\u{f483}"
        case .exploreBold: return "\u{f484}"
        case .exploreLight: return "\u{f485}"
        case .exploreRegular: return "\u{f486}"
        case .exportBold: return "\u{f487}"
        case .exportLight: return "\u{f488}"
        case .exportRegular: return "\u{f489}"
        case .extensionMobilityBold: return "\u{f48a}"
        case .extensionMobilityLight: return "\u{f48b}"
        case .extensionMobilityRegular: return "\u{f48c}"
        case .externalMessageBold: return "\u{f48d}"
        case .externalMessageLight: return "\u{f48e}"
        case .externalMessageRegular: return "\u{f48f}"
        case .externalUserBold: return "\u{f490}"
        case .externalUserLight: return "\u{f491}"
        case .externalUserRegular: return "\u{f492}"
        case .familyFontBold: return "\u{f493}"
        case .familyFontLight: return "\u{f494}"
        case .familyFontRegular: return "\u{f495}"
        case .fastForwardBold: return "\u{f496}"
        case .fastForwardLight: return "\u{f497}"
        case .fastForwardRegular: return "\u{f498}"
        case .favoriteApps192CobaltLime: return "\u{f499}"
        case .favoriteApps192: return "\u{f49a}"
        case .favoriteBold: return "\u{f49b}"
        case .favoriteFilled: return "\u{f49c}"
        case .favoriteLight: return "\u{f49d}"
        case .favoriteRegular: return "\u{f49e}"
        case .favoritesBold: return "\u{f49f}"
        case .favoritesFilled: return "\u{f4a0}"
        case .favoritesLight: return "\u{f4a1}"
        case .favoritesRegular: return "\u{f4a2}"
        case .fbwBold: return "\u{f4a3}"
        case .fbwFilled: return "\u{f4a4}"
        case .fbwLight: return "\u{f4a5}"
        case .fbwRegular: return "\u{f4a6}"
        case .ffwBold: return "\u{f4a7}"
        case .ffwFilled: return "\u{f4a8}"
        case .ffwLight: return "\u{f4a9}"
        case .ffwRegular: return "\u{f4aa}"
        case .file3DBold: return "\u{f4ab}"
        case .file3DFilled: return "\u{f4ac}"
        case .file3DLight: return "\u{f4ad}"
        case .file3DRegular: return "\u{f4ae}"
        case .fileAnalysisBold: return "\u{f4af}"
        case .fileAnalysisFilled: return "\u{f4b0}"
        case .fileAnalysisLight: return "\u{f4b1}"
        case .fileAnalysisRegular: return "\u{f4b2}"
        case .fileAnnotationBold: return "\u{f4b3}"
        case .fileAnnotationFilled: return "\u{f4b4}"
        case .fileAnnotationLight: return "\u{f4b5}"
        case .fileAnnotationRegular: return "\u{f4b6}"
        case .fileAudioBold: return "\u{f4b7}"
        case .fileAudioFilled: return "\u{f4b8}"
        case .fileAudioLight: return "\u{f4b9}"
        case .fileAudioRegular: return "\u{f4ba}"
        case .fileBugBold: return "\u{f4bb}"
        case .fileBugFilled: return "\u{f4bc}"
        case .fileBugLight: return "\u{f4bd}"
        case .fileBugRegular: return "\u{f4be}"
        case .fileCodeBold: return "\u{f4bf}"
        case .fileCodeFilled: return "\u{f4c0}"
        case .fileCodeLight: return "\u{f4c1}"
        case .fileCodeRegular: return "\u{f4c2}"
        case .fileDashboardBold: return "\u{f4c3}"
        case .fileDashboardFilled: return "\u{f4c4}"
        case .fileDashboardLight: return "\u{f4c5}"
        case .fileDashboardRegular: return "\u{f4c6}"
        case .fileExcelBold: return "\u{f4c7}"
        case .fileExcelFilled: return "\u{f4c8}"
        case .fileExcelLight: return "\u{f4c9}"
        case .fileExcelRegular: return "\u{f4ca}"
        case .fileGraphBold: return "\u{f4cb}"
        case .fileGraphFilled: return "\u{f4cc}"
        case .fileGraphLight: return "\u{f4cd}"
        case .fileGraphRegular: return "\u{f4ce}"
        case .fileImageBold: return "\u{f4cf}"
        case .fileImageFilled: return "\u{f4d0}"
        case .fileImageLight: return "\u{f4d1}"
        case .fileImageNoneBold: return "\u{f4d2}"
        case .fileImageNoneLight: return "\u{f4d3}"
        case .fileImageNoneRegular: return "\u{f4d4}"
        case .fileImageRegular: return "\u{f4d5}"
        case .fileKeynoteBold: return "\u{f4d6}"
        case .fileKeynoteFilled: return "\u{f4d7}"
        case .fileKeynoteLight: return "\u{f4d8}"
        case .fileKeynoteRegular: return "\u{f4d9}"
        case .fileLockedBold: return "\u{f4da}"
        case .fileLockedFilled: return "\u{f4db}"
        case .fileLockedLight: return "\u{f4dc}"
        case .fileLockedRegular: return "\u{f4dd}"
        case .fileMissingBold: return "\u{f4de}"
        case .fileMissingFilled: return "\u{f4df}"
        case .fileMissingLight: return "\u{f4e0}"
        case .fileMissingRegular: return "\u{f4e1}"
        case .fileMusicBold: return "\u{f4e2}"
        case .fileMusicFilled: return "\u{f4e3}"
        case .fileMusicLight: return "\u{f4e4}"
        case .fileMusicRegular: return "\u{f4e5}"
        case .fileOnenoteBold: return "\u{f4e6}"
        case .fileOnenoteFilled: return "\u{f4e7}"
        case .fileOnenoteLight: return "\u{f4e8}"
        case .fileOnenoteRegular: return "\u{f4e9}"
        case .filePdfBold: return "\u{f4ea}"
        case .filePdfFilled: return "\u{f4eb}"
        case .filePdfLight: return "\u{f4ec}"
        case .filePdfRegular: return "\u{f4ed}"
        case .filePowerpointBold: return "\u{f4ee}"
        case .filePowerpointFilled: return "\u{f4ef}"
        case .filePowerpointLight: return "\u{f4f0}"
        case .filePowerpointRegular: return "\u{f4f1}"
        case .fileSpreadsheetBold: return "\u{f4f2}"
        case .fileSpreadsheetFilled: return "\u{f4f3}"
        case .fileSpreadsheetLight: return "\u{f4f4}"
        case .fileSpreadsheetRegular: return "\u{f4f5}"
        case .fileTextBold: return "\u{f4f6}"
        case .fileTextFilled: return "\u{f4f7}"
        case .fileTextLight: return "\u{f4f8}"
        case .fileTextRegular: return "\u{f4f9}"
        case .fileVectorBold: return "\u{f4fa}"
        case .fileVectorFilled: return "\u{f4fb}"
        case .fileVectorLight: return "\u{f4fc}"
        case .fileVectorRegular: return "\u{f4fd}"
        case .fileVideoBold: return "\u{f4fe}"
        case .fileVideoFilled: return "\u{f4ff}"
        case .fileVideoLight: return "\u{f500}"
        case .fileVideoRegular: return "\u{f501}"
        case .fileWordBold: return "\u{f502}"
        case .fileWordFilled: return "\u{f503}"
        case .fileWordLight: return "\u{f504}"
        case .fileWordRegular: return "\u{f505}"
        case .fileZipBold: return "\u{f506}"
        case .fileZipFilled: return "\u{f507}"
        case .fileZipLight: return "\u{f508}"
        case .fileZipRegular: return "\u{f509}"
        case .filesBold: return "\u{f50a}"
        case .filesFilled: return "\u{f50b}"
        case .filesLight: return "\u{f50c}"
        case .filesRegular: return "\u{f50d}"
        case .fillColourBold: return "\u{f50e}"
        case .fillColourFilled: return "\u{f50f}"
        case .fillColourLight: return "\u{f510}"
        case .fillColourRegular: return "\u{f511}"
        case .filterBold: return "\u{f512}"
        case .filterCircleBold: return "\u{f513}"
        case .filterCircleFilled: return "\u{f514}"
        case .filterCircleLight: return "\u{f515}"
        case .filterCircleRegular: return "\u{f516}"
        case .filterLight: return "\u{f517}"
        case .filterRegular: return "\u{f518}"
        case .fitToWidthBold: return "\u{f519}"
        case .fitToWidthLight: return "\u{f51a}"
        case .fitToWidthRegular: return "\u{f51b}"
        case .fitToWindowBold: return "\u{f51c}"
        case .fitToWindowExitBold: return "\u{f51d}"
        case .fitToWindowExitLight: return "\u{f51e}"
        case .fitToWindowExitRegular: return "\u{f51f}"
        case .fitToWindowLight: return "\u{f520}"
        case .fitToWindowRegular: return "\u{f521}"
        case .flagBold: return "\u{f522}"
        case .flagCircleBold: return "\u{f523}"
        case .flagCircleFilled: return "\u{f524}"
        case .flagCircleLight: return "\u{f525}"
        case .flagCircleRegular: return "\u{f526}"
        case .flagFilled: return "\u{f527}"
        case .flagLight: return "\u{f528}"
        case .flagRegular: return "\u{f529}"
        case .folderBold: return "\u{f52a}"
        case .folderEditBold: return "\u{f52b}"
        case .folderEditLight: return "\u{f52c}"
        case .folderEditRegular: return "\u{f52d}"
        case .folderLight: return "\u{f52e}"
        case .folderLockBold: return "\u{f52f}"
        case .folderLockLight: return "\u{f530}"
        case .folderLockRegular: return "\u{f531}"
        case .folderRegular: return "\u{f532}"
        case .folderViewBold: return "\u{f533}"
        case .folderViewLight: return "\u{f534}"
        case .folderViewRegular: return "\u{f535}"
        case .followUpBold: return "\u{f536}"
        case .followUpLight: return "\u{f537}"
        case .followUpRegular: return "\u{f538}"
        case .foodBold: return "\u{f539}"
        case .foodLight: return "\u{f53a}"
        case .foodRegular: return "\u{f53b}"
        case .formatBold: return "\u{f53c}"
        case .formatControlPanelDraggerBold: return "\u{f53d}"
        case .formatControlPanelDraggerHorizontalBold: return "\u{f53e}"
        case .formatControlPanelDraggerHorizontalLight: return "\u{f53f}"
        case .formatControlPanelDraggerHorizontalRegular: return "\u{f540}"
        case .formatControlPanelDraggerLight: return "\u{f541}"
        case .formatControlPanelDraggerRegular: return "\u{f542}"
        case .formatDefaultAppBold: return "\u{f543}"
        case .formatDefaultAppLight: return "\u{f544}"
        case .formatDefaultAppRegular: return "\u{f545}"
        case .formatLight: return "\u{f546}"
        case .formatPanelControlBarBold: return "\u{f547}"
        case .formatPanelControlBarLight: return "\u{f548}"
        case .formatPanelControlBarRegular: return "\u{f549}"
        case .formatPanelControlDownBold: return "\u{f54a}"
        case .formatPanelControlDownLight: return "\u{f54b}"
        case .formatPanelControlDownRegular: return "\u{f54c}"
        case .formatPanelControlLeftBold: return "\u{f54d}"
        case .formatPanelControlLeftLight: return "\u{f54e}"
        case .formatPanelControlLeftRegular: return "\u{f54f}"
        case .formatPanelControlRightBold: return "\u{f550}"
        case .formatPanelControlRightLight: return "\u{f551}"
        case .formatPanelControlRightRegular: return "\u{f552}"
        case .formatPanelControlUpBold: return "\u{f553}"
        case .formatPanelControlUpDownBold: return "\u{f554}"
        case .formatPanelControlUpDownLight: return "\u{f555}"
        case .formatPanelControlUpDownRegular: return "\u{f556}"
        case .formatPanelControlUpLight: return "\u{f557}"
        case .formatPanelControlUpRegular: return "\u{f558}"
        case .formatRegular: return "\u{f559}"
        case .formatViewMixedBold: return "\u{f55a}"
        case .formatViewMixedLight: return "\u{f55b}"
        case .formatViewMixedRegular: return "\u{f55c}"
        case .forwardMessageBold: return "\u{f55d}"
        case .forwardMessageFilled: return "\u{f55e}"
        case .forwardMessageLight: return "\u{f55f}"
        case .forwardMessageRegular: return "\u{f560}"
        case .fourColumnBold: return "\u{f561}"
        case .fourColumnLight: return "\u{f562}"
        case .fourColumnRegular: return "\u{f563}"
        case .fourWayNavigationBold: return "\u{f564}"
        case .fourWayNavigationLight: return "\u{f565}"
        case .fourWayNavigationRegular: return "\u{f566}"
        case .frequencyCappingBold: return "\u{f567}"
        case .frequencyCappingLight: return "\u{f568}"
        case .frequencyCappingRegular: return "\u{f569}"
        case .fufillmentBold: return "\u{f56a}"
        case .fufillmentLight: return "\u{f56b}"
        case .fufillmentRegular: return "\u{f56c}"
        case .fullscreenBold: return "\u{f56d}"
        case .fullscreenExitBold: return "\u{f56e}"
        case .fullscreenExitLight: return "\u{f56f}"
        case .fullscreenExitRegular: return "\u{f570}"
        case .fullscreenLight: return "\u{f571}"
        case .fullscreenRegular: return "\u{f572}"
        case .genericDeviceVideoBold: return "\u{f573}"
        case .genericDeviceVideoFilled: return "\u{f574}"
        case .genericDeviceVideoLight: return "\u{f575}"
        case .genericDeviceVideoRegular: return "\u{f576}"
        case .genericDeviceVideoSmallFilled: return "\u{f577}"
        case .gifBold: return "\u{f578}"
        case .gifFilled: return "\u{f579}"
        case .gifHorizontalFilled: return "\u{f57a}"
        case .gifLight: return "\u{f57b}"
        case .gifRegular: return "\u{f57c}"
        case .googleMeet: return "\u{f57d}"
        case .grabberBold: return "\u{f57e}"
        case .grabberLight: return "\u{f57f}"
        case .grabberRegular: return "\u{f580}"
        case .greenRoomBold: return "\u{f581}"
        case .greenRoomFilled: return "\u{f582}"
        case .greenRoomLight: return "\u{f583}"
        case .greenRoomRegular: return "\u{f584}"
        case .groupBold: return "\u{f585}"
        case .groupLight: return "\u{f586}"
        case .groupPickupBold: return "\u{f587}"
        case .groupPickupFilled: return "\u{f588}"
        case .groupPickupLight: return "\u{f589}"
        case .groupPickupRegular: return "\u{f58a}"
        case .groupRegular: return "\u{f58b}"
        case .guestIssuerBold: return "\u{f58c}"
        case .guestIssuerLight: return "\u{f58d}"
        case .guestIssuerRegular: return "\u{f58e}"
        case .guideBold: return "\u{f58f}"
        case .guideLight: return "\u{f590}"
        case .guideRegular: return "\u{f591}"
        case .handlerBold: return "\u{f592}"
        case .handlerLight: return "\u{f593}"
        case .handlerRegular: return "\u{f594}"
        case .handsetAlertBold: return "\u{f595}"
        case .handsetAlertFilled: return "\u{f596}"
        case .handsetAlertLight: return "\u{f597}"
        case .handsetAlertRegular: return "\u{f598}"
        case .handsetBold: return "\u{f599}"
        case .handsetFilled: return "\u{f59a}"
        case .handsetLight: return "\u{f59b}"
        case .handsetMutedBold: return "\u{f59c}"
        case .handsetMutedFilled: return "\u{f59d}"
        case .handsetMutedLight: return "\u{f59e}"
        case .handsetMutedRegular: return "\u{f59f}"
        case .handsetRegular: return "\u{f5a0}"
        case .handshakeBold: return "\u{f5a1}"
        case .handshakeLight: return "\u{f5a2}"
        case .handshakeRegular: return "\u{f5a3}"
        case .headingOneBold: return "\u{f5a4}"
        case .headingOneLight: return "\u{f5a5}"
        case .headingOneRegular: return "\u{f5a6}"
        case .headingThreeBold: return "\u{f5a7}"
        case .headingThreeLight: return "\u{f5a8}"
        case .headingThreeRegular: return "\u{f5a9}"
        case .headingTwoBold: return "\u{f5aa}"
        case .headingTwoLight: return "\u{f5ab}"
        case .headingTwoRegular: return "\u{f5ac}"
        case .headphonesBold: return "\u{f5ad}"
        case .headphonesFilled: return "\u{f5ae}"
        case .headphonesLight: return "\u{f5af}"
        case .headphonesMutedBold: return "\u{f5b0}"
        case .headphonesMutedFilled: return "\u{f5b1}"
        case .headphonesMutedLight: return "\u{f5b2}"
        case .headphonesMutedRegular: return "\u{f5b3}"
        case .headphonesRegular: return "\u{f5b4}"
        case .headsetAlertBold: return "\u{f5b5}"
        case .headsetAlertLight: return "\u{f5b6}"
        case .headsetAlertRegular: return "\u{f5b7}"
        case .headsetBold: return "\u{f5b8}"
        case .headsetFilled: return "\u{f5b9}"
        case .headsetLight: return "\u{f5ba}"
        case .headsetMutedBold: return "\u{f5bb}"
        case .headsetMutedLight: return "\u{f5bc}"
        case .headsetMutedRegular: return "\u{f5bd}"
        case .headsetPrivateBold: return "\u{f5be}"
        case .headsetPrivateLight: return "\u{f5bf}"
        case .headsetPrivateRegular: return "\u{f5c0}"
        case .headsetRegular: return "\u{f5c1}"
        case .hearingImpairedBold: return "\u{f5c2}"
        case .hearingImpairedLight: return "\u{f5c3}"
        case .hearingImpairedRegular: return "\u{f5c4}"
        case .helpBold: return "\u{f5c5}"
        case .helpCircleActiveFilled: return "\u{f5c6}"
        case .helpCircleBold: return "\u{f5c7}"
        case .helpCircleLight: return "\u{f5c8}"
        case .helpCircleRegular: return "\u{f5c9}"
        case .helpLight: return "\u{f5ca}"
        case .helpRegular: return "\u{f5cb}"
        case .helpdeskBold: return "\u{f5cc}"
        case .helpdeskFilled: return "\u{f5cd}"
        case .helpdeskLight: return "\u{f5ce}"
        case .helpdeskRegular: return "\u{f5cf}"
        case .hideBold: return "\u{f5d0}"
        case .hideFilled: return "\u{f5d1}"
        case .hideLight: return "\u{f5d2}"
        case .hideRegular: return "\u{f5d3}"
        case .homeBold: return "\u{f5d4}"
        case .homeFilled: return "\u{f5d5}"
        case .homeLight: return "\u{f5d6}"
        case .homeRegular: return "\u{f5d7}"
        case .horizontalLineBold: return "\u{f5d8}"
        case .horizontalLineLight: return "\u{f5d9}"
        case .horizontalLineRegular: return "\u{f5da}"
        case .hotelingBold: return "\u{f5db}"
        case .hotelingFilled: return "\u{f5dc}"
        case .hotelingLight: return "\u{f5dd}"
        case .hotelingRegular: return "\u{f5de}"
        case .humidityBold: return "\u{f5df}"
        case .humidityLight: return "\u{f5e0}"
        case .humidityRegular: return "\u{f5e1}"
        case .huntGroupBold: return "\u{f5e2}"
        case .huntGroupFilled: return "\u{f5e3}"
        case .huntGroupLight: return "\u{f5e4}"
        case .huntGroupRegular: return "\u{f5e5}"
        case .importBold: return "\u{f5e6}"
        case .importLight: return "\u{f5e7}"
        case .importRegular: return "\u{f5e8}"
        case .inCommonBold: return "\u{f5e9}"
        case .inCommonLight: return "\u{f5ea}"
        case .inCommonRegular: return "\u{f5eb}"
        case .includeBold: return "\u{f5ec}"
        case .includeLight: return "\u{f5ed}"
        case .includeRegular: return "\u{f5ee}"
        case .incomingCallLegacyBold: return "\u{f5ef}"
        case .incomingCallLegacyFilled: return "\u{f5f0}"
        case .incomingCallLegacyLight: return "\u{f5f1}"
        case .incomingCallLegacyRegular: return "\u{f5f2}"
        case .infoBadgeFilled: return "\u{f5f3}"
        case .infoCircleBold: return "\u{f5f4}"
        case .infoCircleFilled: return "\u{f5f5}"
        case .infoCircleLight: return "\u{f5f6}"
        case .infoCircleRegular: return "\u{f5f7}"
        case .infoCircleTwoBold: return "\u{f5f8}"
        case .infoCircleTwoFilled: return "\u{f5f9}"
        case .infoCircleTwoLight: return "\u{f5fa}"
        case .infoCircleTwoRegular: return "\u{f5fb}"
        case .inputBold: return "\u{f5fc}"
        case .inputDisconnectedBold: return "\u{f5fd}"
        case .inputDisconnectedLight: return "\u{f5fe}"
        case .inputDisconnectedRegular: return "\u{f5ff}"
        case .inputLight: return "\u{f600}"
        case .inputRegular: return "\u{f601}"
        case .insightsBold: return "\u{f602}"
        case .insightsLight: return "\u{f603}"
        case .insightsRegular: return "\u{f604}"
        case .instantScheduleBold: return "\u{f605}"
        case .instantScheduleFilled: return "\u{f606}"
        case .instantScheduleLight: return "\u{f607}"
        case .instantScheduleRegular: return "\u{f608}"
        case .integrationsBold: return "\u{f609}"
        case .integrationsLight: return "\u{f60a}"
        case .integrationsRegular: return "\u{f60b}"
        case .intelligentRoutingBold: return "\u{f60c}"
        case .intelligentRoutingLight: return "\u{f60d}"
        case .intelligentRoutingRegular: return "\u{f60e}"
        case .invitedUserBold: return "\u{f60f}"
        case .invitedUserLight: return "\u{f610}"
        case .invitedUserRegular: return "\u{f611}"
        case .italicBold: return "\u{f612}"
        case .italicLight: return "\u{f613}"
        case .italicRegular: return "\u{f614}"
        case .joinAudioBold: return "\u{f615}"
        case .joinAudioFilled: return "\u{f616}"
        case .joinAudioLight: return "\u{f617}"
        case .joinAudioRegular: return "\u{f618}"
        case .keepInTouchBold: return "\u{f619}"
        case .keepInTouchFilled: return "\u{f61a}"
        case .keepInTouchLight: return "\u{f61b}"
        case .keepInTouchRegular: return "\u{f61c}"
        case .keyboardBold: return "\u{f61d}"
        case .keyboardCloseBold: return "\u{f61e}"
        case .keyboardCloseLight: return "\u{f61f}"
        case .keyboardCloseRegular: return "\u{f620}"
        case .keyboardLight: return "\u{f621}"
        case .keyboardRegular: return "\u{f622}"
        case .languageBold: return "\u{f623}"
        case .languageLight: return "\u{f624}"
        case .languageRegular: return "\u{f625}"
        case .laptopBold: return "\u{f626}"
        case .laptopDisconnectedBold: return "\u{f627}"
        case .laptopDisconnectedLight: return "\u{f628}"
        case .laptopDisconnectedRegular: return "\u{f629}"
        case .laptopFilled: return "\u{f62a}"
        case .laptopLight: return "\u{f62b}"
        case .laptopRegular: return "\u{f62c}"
        case .laserPointerBold: return "\u{f62d}"
        case .laserPointerLight: return "\u{f62e}"
        case .laserPointerRegular: return "\u{f62f}"
        case .launchBold: return "\u{f630}"
        case .launchLight: return "\u{f631}"
        case .launchRegular: return "\u{f632}"
        case .layoutSideBySideVerticalBold: return "\u{f633}"
        case .layoutSideBySideVerticalFilled: return "\u{f634}"
        case .layoutSideBySideVerticalLight: return "\u{f635}"
        case .layoutSideBySideVerticalRegular: return "\u{f636}"
        case .leaveBreakoutSessionBold: return "\u{f637}"
        case .leaveBreakoutSessionLight: return "\u{f638}"
        case .leaveBreakoutSessionRegular: return "\u{f639}"
        case .leaveDeviceBold: return "\u{f63a}"
        case .leaveDeviceLight: return "\u{f63b}"
        case .leaveDeviceRegular: return "\u{f63c}"
        case .lightningBold: return "\u{f63d}"
        case .lightningFilled: return "\u{f63e}"
        case .lightningLight: return "\u{f63f}"
        case .lightningRegular: return "\u{f640}"
        case .likeBold: return "\u{f641}"
        case .likeFilled: return "\u{f642}"
        case .likeLight: return "\u{f643}"
        case .likeRegular: return "\u{f644}"
        case .linkBold: return "\u{f645}"
        case .linkLight: return "\u{f646}"
        case .linkRegular: return "\u{f647}"
        case .listBulletedBold: return "\u{f648}"
        case .listBulletedLight: return "\u{f649}"
        case .listBulletedRegular: return "\u{f64a}"
        case .listMenuBold: return "\u{f64b}"
        case .listMenuLight: return "\u{f64c}"
        case .listMenuRegular: return "\u{f64d}"
        case .listNumberedBold: return "\u{f64e}"
        case .listNumberedLight: return "\u{f64f}"
        case .listNumberedRegular: return "\u{f650}"
        case .liveBold: return "\u{f651}"
        case .liveFilled: return "\u{f652}"
        case .liveLight: return "\u{f653}"
        case .liveRegular: return "\u{f654}"
        case .locationBold: return "\u{f655}"
        case .locationFilled: return "\u{f656}"
        case .locationLight: return "\u{f657}"
        case .locationRegular: return "\u{f658}"
        case .longTextBoxBold: return "\u{f659}"
        case .longTextBoxLight: return "\u{f65a}"
        case .longTextBoxRegular: return "\u{f65b}"
        case .lowerHandBold: return "\u{f65c}"
        case .lowerHandLight: return "\u{f65d}"
        case .lowerHandRegular: return "\u{f65e}"
        case .magicPenBold: return "\u{f65f}"
        case .magicPenFilled: return "\u{f660}"
        case .magicPenLight: return "\u{f661}"
        case .magicPenRegular: return "\u{f662}"
        case .markAsUnreadBold: return "\u{f663}"
        case .markAsUnreadLight: return "\u{f664}"
        case .markAsUnreadRegular: return "\u{f665}"
        case .markdownBold: return "\u{f666}"
        case .markdownLight: return "\u{f667}"
        case .markdownRegular: return "\u{f668}"
        case .markerBold: return "\u{f669}"
        case .markerFilled: return "\u{f66a}"
        case .markerLight: return "\u{f66b}"
        case .markerRegular: return "\u{f66c}"
        case .maximizeBold: return "\u{f66d}"
        case .maximizeLight: return "\u{f66e}"
        case .maximizeRegular: return "\u{f66f}"
        case .mediaPlayerBold: return "\u{f670}"
        case .mediaPlayerLight: return "\u{f671}"
        case .mediaPlayerRegular: return "\u{f672}"
        case .mediaQualityGoodBold: return "\u{f673}"
        case .mediaQualityGoodFilled: return "\u{f674}"
        case .mediaQualityGoodLight: return "\u{f675}"
        case .mediaQualityGoodRegular: return "\u{f676}"
        case .mediaQualityPoorBold: return "\u{f677}"
        case .mediaQualityPoorFilled: return "\u{f678}"
        case .mediaQualityPoorLight: return "\u{f679}"
        case .mediaQualityPoorRegular: return "\u{f67a}"
        case .mediaQualityUnstableBold: return "\u{f67b}"
        case .mediaQualityUnstableFilled: return "\u{f67c}"
        case .mediaQualityUnstableLight: return "\u{f67d}"
        case .mediaQualityUnstableRegular: return "\u{f67e}"
        case .mediumQualityGoodFilled: return "\u{f67f}"
        case .mediumQualityPoorFilled: return "\u{f680}"
        case .mediumQualityUnstableFilled: return "\u{f681}"
        case .meetBold: return "\u{f682}"
        case .meetEndBold: return "\u{f683}"
        case .meetEndLight: return "\u{f684}"
        case .meetEndRegular: return "\u{f685}"
        case .meetFilled: return "\u{f686}"
        case .meetLight: return "\u{f687}"
        case .meetRegular: return "\u{f688}"
        case .meetingsBold: return "\u{f689}"
        case .meetingsFilled: return "\u{f68a}"
        case .meetingsFocusMonthBold: return "\u{f68b}"
        case .meetingsFocusMonthLight: return "\u{f68c}"
        case .meetingsFocusMonthRegular: return "\u{f68d}"
        case .meetingsFocusOneDayBold: return "\u{f68e}"
        case .meetingsFocusOneDayLight: return "\u{f68f}"
        case .meetingsFocusOneDayRegular: return "\u{f690}"
        case .meetingsFocusThreeDayBold: return "\u{f691}"
        case .meetingsFocusThreeDayLight: return "\u{f692}"
        case .meetingsFocusThreeDayRegular: return "\u{f693}"
        case .meetingsFocusUpcomingBold: return "\u{f694}"
        case .meetingsFocusUpcomingLight: return "\u{f695}"
        case .meetingsFocusUpcomingRegular: return "\u{f696}"
        case .meetingsFocusWeekBold: return "\u{f697}"
        case .meetingsFocusWeekLight: return "\u{f698}"
        case .meetingsFocusWeekRegular: return "\u{f699}"
        case .meetingsLight: return "\u{f69a}"
        case .meetingsPresenceBold: return "\u{f69b}"
        case .meetingsPresenceFilled: return "\u{f69c}"
        case .meetingsPresenceLight: return "\u{f69d}"
        case .meetingsPresenceRegular: return "\u{f69e}"
        case .meetingsPresenceSmallFilled: return "\u{f69f}"
        case .meetingsRegular: return "\u{f6a0}"
        case .meetingsTeamActiveBold: return "\u{f6a1}"
        case .meetingsTeamActiveLight: return "\u{f6a2}"
        case .meetingsTeamActiveRegular: return "\u{f6a3}"
        case .meetingsTeamBold: return "\u{f6a4}"
        case .meetingsTeamLight: return "\u{f6a5}"
        case .meetingsTeamNewBold: return "\u{f6a6}"
        case .meetingsTeamNewLight: return "\u{f6a7}"
        case .meetingsTeamNewRegular: return "\u{f6a8}"
        case .meetingsTeamRegular: return "\u{f6a9}"
        case .mentionBold: return "\u{f6aa}"
        case .mentionLight: return "\u{f6ab}"
        case .mentionRegular: return "\u{f6ac}"
        case .messageQueingBold: return "\u{f6ad}"
        case .messageQueingLight: return "\u{f6ae}"
        case .messageQueingRegular: return "\u{f6af}"
        case .microphoneBold: return "\u{f6b0}"
        case .microphoneFilled: return "\u{f6b1}"
        case .microphoneHardMutedBold: return "\u{f6b2}"
        case .microphoneHardMutedCircleFilled: return "\u{f6b3}"
        case .microphoneHardMutedColoredBold: return "\u{f6b4}"
        case .microphoneHardMutedColoredLight: return "\u{f6b5}"
        case .microphoneHardMutedColoredRegular: return "\u{f6b6}"
        case .microphoneHardMutedLight: return "\u{f6b7}"
        case .microphoneHardMutedRegular: return "\u{f6b8}"
        case .microphoneLight: return "\u{f6b9}"
        case .microphoneMusicModeBold: return "\u{f6ba}"
        case .microphoneMusicModeColoredBold: return "\u{f6bb}"
        case .microphoneMusicModeColoredLight: return "\u{f6bc}"
        case .microphoneMusicModeColoredRegular: return "\u{f6bd}"
        case .microphoneMusicModeLight: return "\u{f6be}"
        case .microphoneMusicModeRegular: return "\u{f6bf}"
        case .microphoneMutedBold: return "\u{f6c0}"
        case .microphoneMutedFilled: return "\u{f6c1}"
        case .microphoneMutedIndicatorFilled: return "\u{f6c2}"
        case .microphoneMutedLight: return "\u{f6c3}"
        case .microphoneMutedRedBold: return "\u{f6c4}"
        case .microphoneMutedRedFilled: return "\u{f6c5}"
        case .microphoneMutedRedLight: return "\u{f6c6}"
        case .microphoneMutedRedRegular: return "\u{f6c7}"
        case .microphoneMutedRegular: return "\u{f6c8}"
        case .microphoneOptAllBold: return "\u{f6c9}"
        case .microphoneOptAllLight: return "\u{f6ca}"
        case .microphoneOptAllMutedBold: return "\u{f6cb}"
        case .microphoneOptAllMutedLight: return "\u{f6cc}"
        case .microphoneOptAllMutedRegular: return "\u{f6cd}"
        case .microphoneOptAllOnColoredBold: return "\u{f6ce}"
        case .microphoneOptAllOnColoredLight: return "\u{f6cf}"
        case .microphoneOptAllOnColoredRegular: return "\u{f6d0}"
        case .microphoneOptAllRegular: return "\u{f6d1}"
        case .microphoneOptMeBold: return "\u{f6d2}"
        case .microphoneOptMeLight: return "\u{f6d3}"
        case .microphoneOptMeMutedBold: return "\u{f6d4}"
        case .microphoneOptMeMutedLight: return "\u{f6d5}"
        case .microphoneOptMeMutedRegular: return "\u{f6d6}"
        case .microphoneOptMeOnColoredBold: return "\u{f6d7}"
        case .microphoneOptMeOnColoredLight: return "\u{f6d8}"
        case .microphoneOptMeOnColoredRegular: return "\u{f6d9}"
        case .microphoneOptMeRegular: return "\u{f6da}"
        case .microphoneRegular: return "\u{f6db}"
        case .minimizeBold: return "\u{f6dc}"
        case .minimizeLight: return "\u{f6dd}"
        case .minimizeRegular: return "\u{f6de}"
        case .minusBold: return "\u{f6df}"
        case .minusLight: return "\u{f6e0}"
        case .minusRegular: return "\u{f6e1}"
        case .mirrorBold: return "\u{f6e2}"
        case .mirrorFilled: return "\u{f6e3}"
        case .mirrorLight: return "\u{f6e4}"
        case .mirrorRegular: return "\u{f6e5}"
        case .moderatorBold: return "\u{f6e6}"
        case .moderatorLight: return "\u{f6e7}"
        case .moderatorRegular: return "\u{f6e8}"
        case .monitoringBold: return "\u{f6e9}"
        case .monitoringLight: return "\u{f6ea}"
        case .monitoringRegular: return "\u{f6eb}"
        case .monthlyRecurringScheduleNodeBold: return "\u{f6ec}"
        case .monthlyRecurringScheduleNodeLight: return "\u{f6ed}"
        case .monthlyRecurringScheduleNodeRegular: return "\u{f6ee}"
        case .moreAdrBold: return "\u{f6ef}"
        case .moreAdrLight: return "\u{f6f0}"
        case .moreAdrRegular: return "\u{f6f1}"
        case .moreBold: return "\u{f6f2}"
        case .moreCircleBold: return "\u{f6f3}"
        case .moreCircleFilled: return "\u{f6f4}"
        case .moreCircleLight: return "\u{f6f5}"
        case .moreCircleRegular: return "\u{f6f6}"
        case .moreCirecleFilled: return "\u{f6f7}"
        case .moreLight: return "\u{f6f8}"
        case .moreRegular: return "\u{f6f9}"
        case .mouseCursorBold: return "\u{f6fa}"
        case .mouseCursorLight: return "\u{f6fb}"
        case .mouseCursorRegular: return "\u{f6fc}"
        case .moveCallInAdrBold: return "\u{f6fd}"
        case .moveCallInAdrLight: return "\u{f6fe}"
        case .moveCallInAdrRegular: return "\u{f6ff}"
        case .moveCallInIphBold: return "\u{f700}"
        case .moveCallInIphLight: return "\u{f701}"
        case .moveCallInIphRegular: return "\u{f702}"
        case .moveCallInLaptopBold: return "\u{f703}"
        case .moveCallInLaptopLight: return "\u{f704}"
        case .moveCallInLaptopRegular: return "\u{f705}"
        case .moveCallInOutAdrBold: return "\u{f706}"
        case .moveCallInOutAdrLight: return "\u{f707}"
        case .moveCallInOutAdrRegular: return "\u{f708}"
        case .moveCallInOutIphBold: return "\u{f709}"
        case .moveCallInOutIphLight: return "\u{f70a}"
        case .moveCallInOutIphRegular: return "\u{f70b}"
        case .moveCallInTabletBold: return "\u{f70c}"
        case .moveCallInTabletLight: return "\u{f70d}"
        case .moveCallInTabletRegular: return "\u{f70e}"
        case .moveCallOutAdrBold: return "\u{f70f}"
        case .moveCallOutAdrLight: return "\u{f710}"
        case .moveCallOutAdrRegular: return "\u{f711}"
        case .moveCallOutIphBold: return "\u{f712}"
        case .moveCallOutIphLight: return "\u{f713}"
        case .moveCallOutIphRegular: return "\u{f714}"
        case .moveCallOutLaptopBold: return "\u{f715}"
        case .moveCallOutLaptopLight: return "\u{f716}"
        case .moveCallOutLaptopRegular: return "\u{f717}"
        case .moveCallOutTabletBold: return "\u{f718}"
        case .moveCallOutTabletLight: return "\u{f719}"
        case .moveCallOutTabletRegular: return "\u{f71a}"
        case .msTeams: return "\u{f71b}"
        case .multilineChartBold: return "\u{f71c}"
        case .multilineChartFilled: return "\u{f71d}"
        case .multilineChartLight: return "\u{f71e}"
        case .multilineChartRegular: return "\u{f71f}"
        case .multimediaBold: return "\u{f720}"
        case .multimediaFilled: return "\u{f721}"
        case .multimediaLight: return "\u{f722}"
        case .multimediaRegular: return "\u{f723}"
        case .multipledDevicesBold: return "\u{f724}"
        case .multipledDevicesLight: return "\u{f725}"
        case .multipledDevicesRegular: return "\u{f726}"
        case .musicModeBold: return "\u{f727}"
        case .musicModeCircleBold: return "\u{f728}"
        case .musicModeCircleFilled: return "\u{f729}"
        case .musicModeCircleLight: return "\u{f72a}"
        case .musicModeCircleRegular: return "\u{f72b}"
        case .musicModeFilled: return "\u{f72c}"
        case .musicModeLight: return "\u{f72d}"
        case .musicModeRegular: return "\u{f72e}"
        case .muteOnEntryBold: return "\u{f72f}"
        case .muteOnEntryFilled: return "\u{f730}"
        case .muteOnEntryLight: return "\u{f731}"
        case .muteOnEntryRegular: return "\u{f732}"
        case .newManagerBold: return "\u{f733}"
        case .newManagerLight: return "\u{f734}"
        case .newManagerRegular: return "\u{f735}"
        case .newTitleBold: return "\u{f736}"
        case .newTitleLight: return "\u{f737}"
        case .newTitleRegular: return "\u{f738}"
        case .newVoicemailBold: return "\u{f739}"
        case .newVoicemailLight: return "\u{f73a}"
        case .newVoicemailRegular: return "\u{f73b}"
        case .newWhiteboardBold: return "\u{f73c}"
        case .newWhiteboardLight: return "\u{f73d}"
        case .newWhiteboardRegular: return "\u{f73e}"
        case .nextBold: return "\u{f73f}"
        case .nextLight: return "\u{f740}"
        case .nextRegular: return "\u{f741}"
        case .noDevicesBold: return "\u{f742}"
        case .noDevicesLight: return "\u{f743}"
        case .noDevicesRegular: return "\u{f744}"
        case .noiseDetectedCanceledFilled: return "\u{f745}"
        case .noiseDetectedFilled: return "\u{f746}"
        case .noiseNoneCanceledFilled: return "\u{f747}"
        case .noiseNoneFilled: return "\u{f748}"
        case .noiseRemovalBold: return "\u{f749}"
        case .noiseRemovalLight: return "\u{f74a}"
        case .noiseRemovalRegular: return "\u{f74b}"
        case .noteBold: return "\u{f74c}"
        case .noteLight: return "\u{f74d}"
        case .notePptBold: return "\u{f74e}"
        case .notePptLight: return "\u{f74f}"
        case .notePptRegular: return "\u{f750}"
        case .noteRegular: return "\u{f751}"
        case .notesBold: return "\u{f752}"
        case .notesLight: return "\u{f753}"
        case .notesRegular: return "\u{f754}"
        case .numberBold: return "\u{f755}"
        case .numberLight: return "\u{f756}"
        case .numberRegular: return "\u{f757}"
        case .oldRemoteBold: return "\u{f758}"
        case .oldRemoteLight: return "\u{f759}"
        case .oldRemoteRegular: return "\u{f75a}"
        case .oldTouchBold: return "\u{f75b}"
        case .oldTouchLight: return "\u{f75c}"
        case .oldTouchRegular: return "\u{f75d}"
        case .oneColumnBold: return "\u{f75e}"
        case .oneColumnLight: return "\u{f75f}"
        case .oneColumnRegular: return "\u{f760}"
        case .openInFolderBold: return "\u{f761}"
        case .openInFolderLight: return "\u{f762}"
        case .openInFolderRegular: return "\u{f763}"
        case .openPagesBold: return "\u{f764}"
        case .openPagesLight: return "\u{f765}"
        case .openPagesRegular: return "\u{f766}"
        case .otherNumberBold: return "\u{f767}"
        case .otherNumberLight: return "\u{f768}"
        case .otherNumberRegular: return "\u{f769}"
        case .otherNumberWarningBold: return "\u{f76a}"
        case .otherNumberWarningLight: return "\u{f76b}"
        case .otherNumberWarningRegular: return "\u{f76c}"
        case .outgoingCallLegacyBold: return "\u{f76d}"
        case .outgoingCallLegacyLight: return "\u{f76e}"
        case .outgoingCallLegacyRegular: return "\u{f76f}"
        case .overflowLeftBold: return "\u{f770}"
        case .overflowLeftLight: return "\u{f771}"
        case .overflowLeftRegular: return "\u{f772}"
        case .overflowRightBold: return "\u{f773}"
        case .overflowRightLight: return "\u{f774}"
        case .overflowRightRegular: return "\u{f775}"
        case .pairedCameraBold: return "\u{f776}"
        case .pairedCameraLight: return "\u{f777}"
        case .pairedCameraRegular: return "\u{f778}"
        case .pairedDeviceBold: return "\u{f779}"
        case .pairedDeviceLight: return "\u{f77a}"
        case .pairedDeviceRegular: return "\u{f77b}"
        case .pairedHandsetBold: return "\u{f77c}"
        case .pairedHandsetLight: return "\u{f77d}"
        case .pairedHandsetRegular: return "\u{f77e}"
        case .pairingBold: return "\u{f77f}"
        case .pairingLight: return "\u{f780}"
        case .pairingRegular: return "\u{f781}"
        case .parkedBold: return "\u{f782}"
        case .parkedFilled: return "\u{f783}"
        case .parkedLight: return "\u{f784}"
        case .parkedRegular: return "\u{f785}"
        case .parseBold: return "\u{f786}"
        case .parseLight: return "\u{f787}"
        case .parseRegular: return "\u{f788}"
        case .partialBold: return "\u{f789}"
        case .partialLight: return "\u{f78a}"
        case .partialRegular: return "\u{f78b}"
        case .participantAddBold: return "\u{f78c}"
        case .participantAddLight: return "\u{f78d}"
        case .participantAddRegular: return "\u{f78e}"
        case .participantBlockedBold: return "\u{f78f}"
        case .participantBlockedLight: return "\u{f790}"
        case .participantBlockedRegular: return "\u{f791}"
        case .participantBold: return "\u{f792}"
        case .participantFilled: return "\u{f793}"
        case .participantLight: return "\u{f794}"
        case .participantListBold: return "\u{f795}"
        case .participantListFilled: return "\u{f796}"
        case .participantListLight: return "\u{f797}"
        case .participantListRegular: return "\u{f798}"
        case .participantRegular: return "\u{f799}"
        case .participantRemoveBold: return "\u{f79a}"
        case .participantRemoveLight: return "\u{f79b}"
        case .participantRemoveRegular: return "\u{f79c}"
        case .participantUnknownBold: return "\u{f79d}"
        case .participantUnknownLight: return "\u{f79e}"
        case .participantUnknownRegular: return "\u{f79f}"
        case .passMouseBold: return "\u{f7a0}"
        case .passMouseLight: return "\u{f7a1}"
        case .passMouseRegular: return "\u{f7a2}"
        case .pauseBold: return "\u{f7a3}"
        case .pauseFilled: return "\u{f7a4}"
        case .pauseLight: return "\u{f7a5}"
        case .pauseRegular: return "\u{f7a6}"
        case .penBold: return "\u{f7a7}"
        case .penFilled: return "\u{f7a8}"
        case .penLight: return "\u{f7a9}"
        case .penRegular: return "\u{f7aa}"
        case .peopleBold: return "\u{f7ab}"
        case .peopleCircleBold: return "\u{f7ac}"
        case .peopleCircleFilled: return "\u{f7ad}"
        case .peopleCircleLight: return "\u{f7ae}"
        case .peopleCircleRegular: return "\u{f7af}"
        case .peopleFilled: return "\u{f7b0}"
        case .peopleInsightsFilled: return "\u{f7b1}"
        case .peopleLight: return "\u{f7b2}"
        case .peopleRegular: return "\u{f7b3}"
        case .phoneAlertBold: return "\u{f7b4}"
        case .phoneAlertLight: return "\u{f7b5}"
        case .phoneAlertRegular: return "\u{f7b6}"
        case .phoneBold: return "\u{f7b7}"
        case .phoneFilled: return "\u{f7b8}"
        case .phoneLight: return "\u{f7b9}"
        case .phoneMutedBold: return "\u{f7ba}"
        case .phoneMutedLight: return "\u{f7bb}"
        case .phoneMutedRegular: return "\u{f7bc}"
        case .phonePrivateBold: return "\u{f7bd}"
        case .phonePrivateLight: return "\u{f7be}"
        case .phonePrivateRegular: return "\u{f7bf}"
        case .phoneRegular: return "\u{f7c0}"
        case .phoneReplyAllBold: return "\u{f7c1}"
        case .phoneReplyAllLight: return "\u{f7c2}"
        case .phoneReplyAllRegular: return "\u{f7c3}"
        case .phoneReplyBold: return "\u{f7c4}"
        case .phoneReplyLight: return "\u{f7c5}"
        case .phoneReplyRegular: return "\u{f7c6}"
        case .phoneSmallFilled: return "\u{f7c7}"
        case .pickerBold: return "\u{f7c8}"
        case .pickerLight: return "\u{f7c9}"
        case .pickerRegular: return "\u{f7ca}"
        case .pictureInPictureBold: return "\u{f7cb}"
        case .pictureInPictureFilled: return "\u{f7cc}"
        case .pictureInPictureLight: return "\u{f7cd}"
        case .pictureInPictureRegular: return "\u{f7ce}"
        case .pieChartBold: return "\u{f7cf}"
        case .pieChartFilled: return "\u{f7d0}"
        case .pieChartLight: return "\u{f7d1}"
        case .pieChartRegular: return "\u{f7d2}"
        case .pinBold: return "\u{f7d3}"
        case .pinFilled: return "\u{f7d4}"
        case .pinLight: return "\u{f7d5}"
        case .pinListActivityBold: return "\u{f7d6}"
        case .pinListActivityColoredBold: return "\u{f7d7}"
        case .pinListActivityColoredLight: return "\u{f7d8}"
        case .pinListActivityColoredRegular: return "\u{f7d9}"
        case .pinListActivityLight: return "\u{f7da}"
        case .pinListActivityRegular: return "\u{f7db}"
        case .pinListBold: return "\u{f7dc}"
        case .pinListLight: return "\u{f7dd}"
        case .pinListRegular: return "\u{f7de}"
        case .pinMutedBold: return "\u{f7df}"
        case .pinMutedFilled: return "\u{f7e0}"
        case .pinMutedLight: return "\u{f7e1}"
        case .pinMutedRegular: return "\u{f7e2}"
        case .pinRegular: return "\u{f7e3}"
        case .placeholderBold: return "\u{f7e4}"
        case .placeholderLight: return "\u{f7e5}"
        case .placeholderRegular: return "\u{f7e6}"
        case .playBold: return "\u{f7e7}"
        case .playCircleBold: return "\u{f7e8}"
        case .playCircleFilled: return "\u{f7e9}"
        case .playCircleLight: return "\u{f7ea}"
        case .playCircleRegular: return "\u{f7eb}"
        case .playFilled: return "\u{f7ec}"
        case .playLight: return "\u{f7ed}"
        case .playRegular: return "\u{f7ee}"
        case .plugAcBold: return "\u{f7ef}"
        case .plugAcLight: return "\u{f7f0}"
        case .plugAcRegular: return "\u{f7f1}"
        case .plusBold: return "\u{f7f2}"
        case .plusCircleBold: return "\u{f7f3}"
        case .plusCircleFilled: return "\u{f7f4}"
        case .plusCircleLight: return "\u{f7f5}"
        case .plusCircleRegular: return "\u{f7f6}"
        case .plusLight: return "\u{f7f7}"
        case .plusRegular: return "\u{f7f8}"
        case .pmrBold: return "\u{f7f9}"
        case .pmrFilled: return "\u{f7fa}"
        case .pmrLight: return "\u{f7fb}"
        case .pmrRegular: return "\u{f7fc}"
        case .pollBold: return "\u{f7fd}"
        case .pollLight: return "\u{f7fe}"
        case .pollRegular: return "\u{f7ff}"
        case .popInBold: return "\u{f800}"
        case .popInLight: return "\u{f801}"
        case .popInRegular: return "\u{f802}"
        case .popOutBold: return "\u{f803}"
        case .popOutLight: return "\u{f804}"
        case .popOutRegular: return "\u{f805}"
        case .popUpBold: return "\u{f806}"
        case .popUpLight: return "\u{f807}"
        case .popUpRegular: return "\u{f808}"
        case .portraitLandscapeBold: return "\u{f809}"
        case .portraitLandscapeLight: return "\u{f80a}"
        case .portraitLandscapeRegular: return "\u{f80b}"
        case .powerAcBold: return "\u{f80c}"
        case .powerAcLight: return "\u{f80d}"
        case .powerAcRegular: return "\u{f80e}"
        case .powerBold: return "\u{f80f}"
        case .powerLight: return "\u{f810}"
        case .powerRegular: return "\u{f811}"
        case .preHeaderBold: return "\u{f812}"
        case .preHeaderLight: return "\u{f813}"
        case .preHeaderRegular: return "\u{f814}"
        case .presentationBold: return "\u{f815}"
        case .presentationLight: return "\u{f816}"
        case .presentationRegular: return "\u{f817}"
        case .primaryParticipantBold: return "\u{f818}"
        case .primaryParticipantLight: return "\u{f819}"
        case .primaryParticipantRegular: return "\u{f81a}"
        case .printBold: return "\u{f81b}"
        case .printLight: return "\u{f81c}"
        case .printRegular: return "\u{f81d}"
        case .priorityBadgeFilled: return "\u{f81e}"
        case .priorityCircleBold: return "\u{f81f}"
        case .priorityCircleFilled: return "\u{f820}"
        case .priorityCircleLight: return "\u{f821}"
        case .priorityCircleRegular: return "\u{f822}"
        case .priorityCircleTwoBold: return "\u{f823}"
        case .priorityCircleTwoFilled: return "\u{f824}"
        case .priorityCircleTwoLight: return "\u{f825}"
        case .priorityCircleTwoRegular: return "\u{f826}"
        case .privacyCircleBold: return "\u{f827}"
        case .privacyCircleFilled: return "\u{f828}"
        case .privacyCircleLight: return "\u{f829}"
        case .privacyCircleRegular: return "\u{f82a}"
        case .privateBold: return "\u{f82b}"
        case .privateCircleBold: return "\u{f82c}"
        case .privateCircleFilled: return "\u{f82d}"
        case .privateCircleLight: return "\u{f82e}"
        case .privateCircleRegular: return "\u{f82f}"
        case .privateLight: return "\u{f830}"
        case .privateMeetingBold: return "\u{f831}"
        case .privateMeetingLight: return "\u{f832}"
        case .privateMeetingRegular: return "\u{f833}"
        case .privateRegular: return "\u{f834}"
        case .productDemoBold: return "\u{f835}"
        case .productDemoLight: return "\u{f836}"
        case .productDemoRegular: return "\u{f837}"
        case .proximityBold: return "\u{f838}"
        case .proximityLight: return "\u{f839}"
        case .proximityMutedBold: return "\u{f83a}"
        case .proximityMutedLight: return "\u{f83b}"
        case .proximityMutedRegular: return "\u{f83c}"
        case .proximityRegular: return "\u{f83d}"
        case .proximityVideoBold: return "\u{f83e}"
        case .proximityVideoLight: return "\u{f83f}"
        case .proximityVideoRegular: return "\u{f840}"
        case .ptoPresenceBold: return "\u{f841}"
        case .ptoPresenceFilled: return "\u{f842}"
        case .ptoPresenceLight: return "\u{f843}"
        case .ptoPresenceRegular: return "\u{f844}"
        case .pullCallBold: return "\u{f845}"
        case .pullCallLight: return "\u{f846}"
        case .pullCallRegular: return "\u{f847}"
        case .qABold: return "\u{f848}"
        case .qALight: return "\u{f849}"
        case .qARegular: return "\u{f84a}"
        case .qualityBold: return "\u{f84b}"
        case .qualityLight: return "\u{f84c}"
        case .qualityRegular: return "\u{f84d}"
        case .queueContactBold: return "\u{f84e}"
        case .queueContactLight: return "\u{f84f}"
        case .queueContactRegular: return "\u{f850}"
        case .quietBold: return "\u{f851}"
        case .quietHoursPresenceBold: return "\u{f852}"
        case .quietHoursPresenceFilled: return "\u{f853}"
        case .quietHoursPresenceLight: return "\u{f854}"
        case .quietHoursPresenceRegular: return "\u{f855}"
        case .quietLight: return "\u{f856}"
        case .quietRegular: return "\u{f857}"
        case .radioButtonGroupBold: return "\u{f858}"
        case .radioButtonGroupLight: return "\u{f859}"
        case .radioButtonGroupRegular: return "\u{f85a}"
        case .raiseHandBold: return "\u{f85b}"
        case .raiseHandCircleFilled: return "\u{f85c}"
        case .raiseHandFilled: return "\u{f85d}"
        case .raiseHandLight: return "\u{f85e}"
        case .raiseHandRegular: return "\u{f85f}"
        case .ramBold: return "\u{f860}"
        case .ramLight: return "\u{f861}"
        case .ramRegular: return "\u{f862}"
        case .reactionsBold: return "\u{f863}"
        case .reactionsFilled: return "\u{f864}"
        case .reactionsLight: return "\u{f865}"
        case .reactionsRegular: return "\u{f866}"
        case .reactivateBold: return "\u{f867}"
        case .reactivateLight: return "\u{f868}"
        case .reactivateRegular: return "\u{f869}"
        case .recentsBold: return "\u{f86a}"
        case .recentsFilled: return "\u{f86b}"
        case .recentsLight: return "\u{f86c}"
        case .recentsPresenceBold: return "\u{f86d}"
        case .recentsPresenceFilled: return "\u{f86e}"
        case .recentsPresenceLight: return "\u{f86f}"
        case .recentsPresenceRegular: return "\u{f870}"
        case .recentsPresenceSmallFilled: return "\u{f871}"
        case .recentsRegular: return "\u{f872}"
        case .recordActiveBold: return "\u{f873}"
        case .recordActiveFilled: return "\u{f874}"
        case .recordActiveLight: return "\u{f875}"
        case .recordActiveRegular: return "\u{f876}"
        case .recordBold: return "\u{f877}"
        case .recordFilled: return "\u{f878}"
        case .recordLight: return "\u{f879}"
        case .recordPausedBold: return "\u{f87a}"
        case .recordPausedFilled: return "\u{f87b}"
        case .recordPausedLight: return "\u{f87c}"
        case .recordPausedRegular: return "\u{f87d}"
        case .recordRegular: return "\u{f87e}"
        case .recurringBold: return "\u{f87f}"
        case .recurringLight: return "\u{f880}"
        case .recurringOffBold: return "\u{f881}"
        case .recurringOffLight: return "\u{f882}"
        case .recurringOffRegular: return "\u{f883}"
        case .recurringRegular: return "\u{f884}"
        case .redialBold: return "\u{f885}"
        case .redialLight: return "\u{f886}"
        case .redialRegular: return "\u{f887}"
        case .redoBold: return "\u{f888}"
        case .redoLight: return "\u{f889}"
        case .redoRegular: return "\u{f88a}"
        case .refreshBold: return "\u{f88b}"
        case .refreshLight: return "\u{f88c}"
        case .refreshRegular: return "\u{f88d}"
        case .remoteCallBold: return "\u{f88e}"
        case .remoteCallFilled: return "\u{f88f}"
        case .remoteCallLight: return "\u{f890}"
        case .remoteCallRegular: return "\u{f891}"
        case .remoteDesktopControlBold: return "\u{f892}"
        case .remoteDesktopControlFilled: return "\u{f893}"
        case .remoteDesktopControlLight: return "\u{f894}"
        case .remoteDesktopControlRegular: return "\u{f895}"
        case .removeBold: return "\u{f896}"
        case .removeFilled: return "\u{f897}"
        case .removeLight: return "\u{f898}"
        case .removeRegular: return "\u{f899}"
        case .replyBold: return "\u{f89a}"
        case .replyFilled: return "\u{f89b}"
        case .replyLight: return "\u{f89c}"
        case .replyListBold: return "\u{f89d}"
        case .replyListLight: return "\u{f89e}"
        case .replyListRegular: return "\u{f89f}"
        case .replyPrivatelyBold: return "\u{f8a0}"
        case .replyPrivatelyLight: return "\u{f8a1}"
        case .replyPrivatelyRegular: return "\u{f8a2}"
        case .replyRegular: return "\u{f8a3}"
        case .resetBold: return "\u{f8a4}"
        case .resetLight: return "\u{f8a5}"
        case .resetRegular: return "\u{f8a6}"
        case .responsiveMobileBold: return "\u{f8a7}"
        case .responsiveMobileLight: return "\u{f8a8}"
        case .responsiveMobileRegular: return "\u{f8a9}"
        case .restartBold: return "\u{f8aa}"
        case .restartLight: return "\u{f8ab}"
        case .restartRegular: return "\u{f8ac}"
        case .retrieveCallBold: return "\u{f8ad}"
        case .retrieveCallLight: return "\u{f8ae}"
        case .retrieveCallRegular: return "\u{f8af}"
        case .returnBold: return "\u{f8b0}"
        case .returnLight: return "\u{f8b1}"
        case .returnRegular: return "\u{f8b2}"
        case .ringtoneBold: return "\u{f8b3}"
        case .ringtoneLight: return "\u{f8b4}"
        case .ringtoneRegular: return "\u{f8b5}"
        case .roomCalendarBold: return "\u{f8b6}"
        case .roomCalendarLight: return "\u{f8b7}"
        case .roomCalendarRegular: return "\u{f8b8}"
        case .roomLightsBold: return "\u{f8b9}"
        case .roomLightsFilled: return "\u{f8ba}"
        case .roomLightsLight: return "\u{f8bb}"
        case .roomLightsRegular: return "\u{f8bc}"
        case .rotateContentBold: return "\u{f8bd}"
        case .rotateContentFilled: return "\u{f8be}"
        case .rotateContentLight: return "\u{f8bf}"
        case .rotateContentRegular: return "\u{f8c0}"
        case .ruleBasedBold: return "\u{f8c1}"
        case .ruleBasedLight: return "\u{f8c2}"
        case .ruleBasedRegular: return "\u{f8c3}"
        case .runningApplicationBold: return "\u{f8c4}"
        case .runningApplicationFilled: return "\u{f8c5}"
        case .runningApplicationLight: return "\u{f8c6}"
        case .runningApplicationRegular: return "\u{f8c7}"
        case .saveBold: return "\u{f8c8}"
        case .saveLight: return "\u{f8c9}"
        case .saveRegular: return "\u{f8ca}"
        case .saveTranscriptBold: return "\u{f8cb}"
        case .saveTranscriptFilled: return "\u{f8cc}"
        case .saveTranscriptLight: return "\u{f8cd}"
        case .saveTranscriptRegular: return "\u{f8ce}"
        case .scanBold: return "\u{f8cf}"
        case .scanLight: return "\u{f8d0}"
        case .scanRegular: return "\u{f8d1}"
        case .scheduleSendBold: return "\u{f8d2}"
        case .scheduleSendFilled: return "\u{f8d3}"
        case .scheduleSendLight: return "\u{f8d4}"
        case .scheduleSendRegular: return "\u{f8d5}"
        case .schedulerAvailableBold: return "\u{f8d6}"
        case .schedulerAvailableLight: return "\u{f8d7}"
        case .schedulerAvailableRegular: return "\u{f8d8}"
        case .schedulerNotWorkingHoursBold: return "\u{f8d9}"
        case .schedulerNotWorkingHoursLight: return "\u{f8da}"
        case .schedulerNotWorkingHoursRegular: return "\u{f8db}"
        case .schedulerUnavailableBold: return "\u{f8dc}"
        case .schedulerUnavailableLight: return "\u{f8dd}"
        case .schedulerUnavailableRegular: return "\u{f8de}"
        case .schedulerUnknownBold: return "\u{f8df}"
        case .schedulerUnknownLight: return "\u{f8e0}"
        case .schedulerUnknownRegular: return "\u{f8e1}"
        case .screenshotBold: return "\u{f8e2}"
        case .screenshotDocBold: return "\u{f8e3}"
        case .screenshotDocFilled: return "\u{f8e4}"
        case .screenshotDocLight: return "\u{f8e5}"
        case .screenshotDocRegular: return "\u{f8e6}"
        case .screenshotLight: return "\u{f8e7}"
        case .screenshotRegular: return "\u{f8e8}"
        case .searchBold: return "\u{f8e9}"
        case .searchFilled: return "\u{f8ea}"
        case .searchLight: return "\u{f8eb}"
        case .searchRegular: return "\u{f8ec}"
        case .secondaryArrowBold: return "\u{f8ed}"
        case .secondaryArrowLight: return "\u{f8ee}"
        case .secondaryArrowRegular: return "\u{f8ef}"
        case .secureCallLockBold: return "\u{f8f0}"
        case .secureCallLockFilled: return "\u{f8f1}"
        case .secureCallLockLight: return "\u{f8f2}"
        case .secureCallLockRegular: return "\u{f8f3}"
        case .secureCallShieldBold: return "\u{f8f4}"
        case .secureCallShieldFilled: return "\u{f8f5}"
        case .secureCallShieldLight: return "\u{f8f6}"
        case .secureCallShieldRegular: return "\u{f8f7}"
        case .secureCircleBold: return "\u{f8f8}"
        case .secureCircleFilled: return "\u{f8f9}"
        case .secureCircleLight: return "\u{f8fa}"
        case .secureCircleRegular: return "\u{f8fb}"
        case .secureLockBold: return "\u{f8fc}"
        case .secureLockFilled: return "\u{f8fd}"
        case .secureLockLight: return "\u{f8fe}"
        case .secureLockRegular: return "\u{f8ff}"
        case .segmentExcludeFilled: return "\u{f900}"
        case .segmentFilterFilled: return "\u{f901}"
        case .segmentIncludeFilled: return "\u{f902}"
        case .selectAllBold: return "\u{f903}"
        case .selectAllFilled: return "\u{f904}"
        case .selectAllLight: return "\u{f905}"
        case .selectAllRegular: return "\u{f906}"
        case .selectionBold: return "\u{f907}"
        case .selectionLight: return "\u{f908}"
        case .selectionRegular: return "\u{f909}"
        case .sendBold: return "\u{f90a}"
        case .sendFilled: return "\u{f90b}"
        case .sendLight: return "\u{f90c}"
        case .sendRegular: return "\u{f90d}"
        case .serverBold: return "\u{f90e}"
        case .serverErrorBold: return "\u{f90f}"
        case .serverErrorLight: return "\u{f910}"
        case .serverErrorRegular: return "\u{f911}"
        case .serverLight: return "\u{f912}"
        case .serverRegular: return "\u{f913}"
        case .servicesBold: return "\u{f914}"
        case .servicesLight: return "\u{f915}"
        case .servicesRegular: return "\u{f916}"
        case .setVariableBold: return "\u{f917}"
        case .setVariableLight: return "\u{f918}"
        case .setVariableRegular: return "\u{f919}"
        case .settingsBold: return "\u{f91a}"
        case .settingsFilled: return "\u{f91b}"
        case .settingsLight: return "\u{f91c}"
        case .settingsRegular: return "\u{f91d}"
        case .setupAssistantBold: return "\u{f91e}"
        case .setupAssistantLight: return "\u{f91f}"
        case .setupAssistantRegular: return "\u{f920}"
        case .sftpBold: return "\u{f921}"
        case .sftpLight: return "\u{f922}"
        case .sftpRegular: return "\u{f923}"
        case .shapeCircleBold: return "\u{f924}"
        case .shapeCircleFilled: return "\u{f925}"
        case .shapeCircleLight: return "\u{f926}"
        case .shapeCircleRegular: return "\u{f927}"
        case .shapeDiagonalLineBold: return "\u{f928}"
        case .shapeDiagonalLineLight: return "\u{f929}"
        case .shapeDiagonalLineRegular: return "\u{f92a}"
        case .shapeDiamondBold: return "\u{f92b}"
        case .shapeDiamondFilled: return "\u{f92c}"
        case .shapeDiamondLight: return "\u{f92d}"
        case .shapeDiamondRegular: return "\u{f92e}"
        case .shapeOvalBold: return "\u{f92f}"
        case .shapeOvalLight: return "\u{f930}"
        case .shapeOvalRegular: return "\u{f931}"
        case .shapeSquareBold: return "\u{f932}"
        case .shapeSquareFilled: return "\u{f933}"
        case .shapeSquareLight: return "\u{f934}"
        case .shapeSquareRegular: return "\u{f935}"
        case .shapeTriangleBold: return "\u{f936}"
        case .shapeTriangleFilled: return "\u{f937}"
        case .shapeTriangleLight: return "\u{f938}"
        case .shapeTriangleRegular: return "\u{f939}"
        case .shapesBold: return "\u{f93a}"
        case .shapesLight: return "\u{f93b}"
        case .shapesRegular: return "\u{f93c}"
        case .shareCNativeAdrBold: return "\u{f93d}"
        case .shareCNativeAdrFilled: return "\u{f93e}"
        case .shareCNativeAdrLight: return "\u{f93f}"
        case .shareCNativeAdrRegular: return "\u{f940}"
        case .shareCNativeIphBold: return "\u{f941}"
        case .shareCNativeIphLight: return "\u{f942}"
        case .shareCNativeIphRegular: return "\u{f943}"
        case .shareScreenBold: return "\u{f944}"
        case .shareScreenFilled: return "\u{f945}"
        case .shareScreenLight: return "\u{f946}"
        case .shareScreenRegular: return "\u{f947}"
        case .shareScreenSmallFilled: return "\u{f948}"
        case .shareSpaceBold: return "\u{f949}"
        case .shareSpaceLight: return "\u{f94a}"
        case .shareSpaceRegular: return "\u{f94b}"
        case .shieldBold: return "\u{f94c}"
        case .shieldLight: return "\u{f94d}"
        case .shieldRegular: return "\u{f94e}"
        case .shoppingCartBold: return "\u{f94f}"
        case .shoppingCartFilled: return "\u{f950}"
        case .shoppingCartLight: return "\u{f951}"
        case .shoppingCartRegular: return "\u{f952}"
        case .shortTextBoxBold: return "\u{f953}"
        case .shortTextBoxLight: return "\u{f954}"
        case .shortTextBoxRegular: return "\u{f955}"
        case .showBold: return "\u{f956}"
        case .showFilled: return "\u{f957}"
        case .showLight: return "\u{f958}"
        case .showRegular: return "\u{f959}"
        case .signInBold: return "\u{f95a}"
        case .signInFilled: return "\u{f95b}"
        case .signInForcedBold: return "\u{f95c}"
        case .signInForcedLight: return "\u{f95d}"
        case .signInForcedRegular: return "\u{f95e}"
        case .signInLight: return "\u{f95f}"
        case .signInRegular: return "\u{f960}"
        case .signLangIntBold: return "\u{f961}"
        case .signLangIntLight: return "\u{f962}"
        case .signLangIntRegular: return "\u{f963}"
        case .signOutBold: return "\u{f964}"
        case .signOutLight: return "\u{f965}"
        case .signOutRegular: return "\u{f966}"
        case .signal0Bold: return "\u{f967}"
        case .signal0Light: return "\u{f968}"
        case .signal0Regular: return "\u{f969}"
        case .signal100Bold: return "\u{f96a}"
        case .signal100Light: return "\u{f96b}"
        case .signal100Regular: return "\u{f96c}"
        case .signal25Bold: return "\u{f96d}"
        case .signal25Light: return "\u{f96e}"
        case .signal25Regular: return "\u{f96f}"
        case .signal50Bold: return "\u{f970}"
        case .signal50Light: return "\u{f971}"
        case .signal50Regular: return "\u{f972}"
        case .signal75Bold: return "\u{f973}"
        case .signal75Light: return "\u{f974}"
        case .signal75Regular: return "\u{f975}"
        case .simplePromotionBold: return "\u{f976}"
        case .simplePromotionLight: return "\u{f977}"
        case .simplePromotionRegular: return "\u{f978}"
        case .singleNumberReachBold: return "\u{f979}"
        case .singleNumberReachLight: return "\u{f97a}"
        case .singleNumberReachRegular: return "\u{f97b}"
        case .sipRegistrationInProgressBold: return "\u{f97c}"
        case .sipRegistrationInProgressFilled: return "\u{f97d}"
        case .sipRegistrationInProgressLight: return "\u{f97e}"
        case .sipRegistrationInProgressRegular: return "\u{f97f}"
        case .skipBold: return "\u{f980}"
        case .skipBwBold: return "\u{f981}"
        case .skipBwFilled: return "\u{f982}"
        case .skipBwLight: return "\u{f983}"
        case .skipBwRegular: return "\u{f984}"
        case .skipFwBold: return "\u{f985}"
        case .skipFwFilled: return "\u{f986}"
        case .skipFwLight: return "\u{f987}"
        case .skipFwRegular: return "\u{f988}"
        case .skipLight: return "\u{f989}"
        case .skipRegular: return "\u{f98a}"
        case .slidoLogo: return "\u{f98b}"
        case .smsInboundBold: return "\u{f98c}"
        case .smsInboundLight: return "\u{f98d}"
        case .smsInboundRegular: return "\u{f98e}"
        case .smsMessageBold: return "\u{f98f}"
        case .smsMessageFilled: return "\u{f990}"
        case .smsMessageLight: return "\u{f991}"
        case .smsMessageRegular: return "\u{f992}"
        case .socialAlexaFilled: return "\u{f993}"
        case .socialFacebookColoredFilled: return "\u{f994}"
        case .socialFacebookFilled: return "\u{f995}"
        case .socialFbmessengerColoredFilled: return "\u{f996}"
        case .socialFbmessengerFilled: return "\u{f997}"
        case .socialInstagramBold: return "\u{f998}"
        case .socialMicrosoftColoredFilled: return "\u{f999}"
        case .socialMicrosoftFilled: return "\u{f99a}"
        case .socialMmsFilled: return "\u{f99b}"
        case .socialMmsGoldFilled: return "\u{f99c}"
        case .socialSmsFilled: return "\u{f99d}"
        case .socialSmsMintFilled: return "\u{f99e}"
        case .socialTwitterColoredFilled: return "\u{f99f}"
        case .socialTwitterFilled: return "\u{f9a0}"
        case .socialViberBold: return "\u{f9a1}"
        case .socialViberColoredBold: return "\u{f9a2}"
        case .socialWhatsappBold: return "\u{f9a3}"
        case .socialWhatsappColoredFilled: return "\u{f9a4}"
        case .sortAscendingBold: return "\u{f9a5}"
        case .sortAscendingLight: return "\u{f9a6}"
        case .sortAscendingRegular: return "\u{f9a7}"
        case .sortDescendingBold: return "\u{f9a8}"
        case .sortDescendingLight: return "\u{f9a9}"
        case .sortDescendingRegular: return "\u{f9aa}"
        case .soundDefaultBold: return "\u{f9ab}"
        case .soundDefaultLight: return "\u{f9ac}"
        case .soundDefaultRegular: return "\u{f9ad}"
        case .speakerBold: return "\u{f9ae}"
        case .speakerDisconnectedBold: return "\u{f9af}"
        case .speakerDisconnectedFilled: return "\u{f9b0}"
        case .speakerDisconnectedLight: return "\u{f9b1}"
        case .speakerDisconnectedRegular: return "\u{f9b2}"
        case .speakerFilled: return "\u{f9b3}"
        case .speakerLight: return "\u{f9b4}"
        case .speakerMutedBold: return "\u{f9b5}"
        case .speakerMutedFilled: return "\u{f9b6}"
        case .speakerMutedLight: return "\u{f9b7}"
        case .speakerMutedRegular: return "\u{f9b8}"
        case .speakerOffBold: return "\u{f9b9}"
        case .speakerOffFilled: return "\u{f9ba}"
        case .speakerOffLight: return "\u{f9bb}"
        case .speakerOffRegular: return "\u{f9bc}"
        case .speakerOnColoredBold: return "\u{f9bd}"
        case .speakerOnColoredLight: return "\u{f9be}"
        case .speakerOnColoredRegular: return "\u{f9bf}"
        case .speakerRegular: return "\u{f9c0}"
        case .speakerTurnDownBold: return "\u{f9c1}"
        case .speakerTurnDownFilled: return "\u{f9c2}"
        case .speakerTurnDownLight: return "\u{f9c3}"
        case .speakerTurnDownRegular: return "\u{f9c4}"
        case .speakerTurnUpBold: return "\u{f9c5}"
        case .speakerTurnUpFilled: return "\u{f9c6}"
        case .speakerTurnUpLight: return "\u{f9c7}"
        case .speakerTurnUpRegular: return "\u{f9c8}"
        case .spellCheckerBold: return "\u{f9c9}"
        case .spellCheckerLight: return "\u{f9ca}"
        case .spellCheckerRegular: return "\u{f9cb}"
        case .spinnerBold: return "\u{f9cc}"
        case .spinnerFilledBold: return "\u{f9cd}"
        case .spinnerFilledLight: return "\u{f9ce}"
        case .spinnerFilledRegular: return "\u{f9cf}"
        case .spinnerLight: return "\u{f9d0}"
        case .spinnerPartialBold: return "\u{f9d1}"
        case .spinnerPartialLight: return "\u{f9d2}"
        case .spinnerPartialRegular: return "\u{f9d3}"
        case .spinnerRegular: return "\u{f9d4}"
        case .stackedArea100ChartBold: return "\u{f9d5}"
        case .stackedArea100ChartFilled: return "\u{f9d6}"
        case .stackedArea100ChartLight: return "\u{f9d7}"
        case .stackedArea100ChartRegular: return "\u{f9d8}"
        case .stackedAreaChartBold: return "\u{f9d9}"
        case .stackedAreaChartFilled: return "\u{f9da}"
        case .stackedAreaChartLight: return "\u{f9db}"
        case .stackedAreaChartRegular: return "\u{f9dc}"
        case .stackedBar100ChartBold: return "\u{f9dd}"
        case .stackedBar100ChartFilled: return "\u{f9de}"
        case .stackedBar100ChartLight: return "\u{f9df}"
        case .stackedBar100ChartRegular: return "\u{f9e0}"
        case .stackedBarChartBold: return "\u{f9e1}"
        case .stackedBarChartFilled: return "\u{f9e2}"
        case .stackedBarChartLight: return "\u{f9e3}"
        case .stackedBarChartRegular: return "\u{f9e4}"
        case .startChatBold: return "\u{f9e5}"
        case .startChatLight: return "\u{f9e6}"
        case .startChatRegular: return "\u{f9e7}"
        case .stethoscopeBold: return "\u{f9e8}"
        case .stethoscopeLight: return "\u{f9e9}"
        case .stethoscopeRegular: return "\u{f9ea}"
        case .stickersBold: return "\u{f9eb}"
        case .stickersLight: return "\u{f9ec}"
        case .stickersRegular: return "\u{f9ed}"
        case .stickiesBold: return "\u{f9ee}"
        case .stickiesLight: return "\u{f9ef}"
        case .stickiesRegular: return "\u{f9f0}"
        case .stopBold: return "\u{f9f1}"
        case .stopCircleBold: return "\u{f9f2}"
        case .stopCircleFilled: return "\u{f9f3}"
        case .stopCircleLight: return "\u{f9f4}"
        case .stopCircleRegular: return "\u{f9f5}"
        case .stopContentShareBold: return "\u{f9f6}"
        case .stopContentShareLight: return "\u{f9f7}"
        case .stopContentShareRegular: return "\u{f9f8}"
        case .stopFilled: return "\u{f9f9}"
        case .stopLight: return "\u{f9fa}"
        case .stopRegular: return "\u{f9fb}"
        case .storedInfoBold: return "\u{f9fc}"
        case .storedInfoFilled: return "\u{f9fd}"
        case .storedInfoLight: return "\u{f9fe}"
        case .storedInfoRegular: return "\u{f9ff}"
        case .streamingBold: return "\u{fa00}"
        case .streamingLight: return "\u{fa01}"
        case .streamingRegular: return "\u{fa02}"
        case .strikethroughBold: return "\u{fa03}"
        case .strikethroughLight: return "\u{fa04}"
        case .strikethroughRegular: return "\u{fa05}"
        case .studioModeBold: return "\u{fa06}"
        case .studioModeLight: return "\u{fa07}"
        case .studioModeRegular: return "\u{fa08}"
        case .subscriptBold: return "\u{fa09}"
        case .subscriptLight: return "\u{fa0a}"
        case .subscriptRegular: return "\u{fa0b}"
        case .superscriptBold: return "\u{fa0c}"
        case .superscriptLight: return "\u{fa0d}"
        case .superscriptRegular: return "\u{fa0e}"
        case .surveyBold: return "\u{fa0f}"
        case .surveyFilled: return "\u{fa10}"
        case .surveyLight: return "\u{fa11}"
        case .surveyRegular: return "\u{fa12}"
        case .sx10Bold: return "\u{fa13}"
        case .sx10Light: return "\u{fa14}"
        case .sx10Regular: return "\u{fa15}"
        case .sx20Bold: return "\u{fa16}"
        case .sx20Light: return "\u{fa17}"
        case .sx20Regular: return "\u{fa18}"
        case .sx80CodecBold: return "\u{fa19}"
        case .sx80CodecLight: return "\u{fa1a}"
        case .sx80CodecRegular: return "\u{fa1b}"
        case .tableBold: return "\u{fa1c}"
        case .tableLight: return "\u{fa1d}"
        case .tableRegular: return "\u{fa1e}"
        case .tabletBold: return "\u{fa1f}"
        case .tabletLight: return "\u{fa20}"
        case .tabletRegular: return "\u{fa21}"
        case .tabsBold: return "\u{fa22}"
        case .tabsLight: return "\u{fa23}"
        case .tabsRegular: return "\u{fa24}"
        case .tagBold: return "\u{fa25}"
        case .tagLight: return "\u{fa26}"
        case .tagRegular: return "\u{fa27}"
        case .tapBold: return "\u{fa28}"
        case .tapFilled: return "\u{fa29}"
        case .tapLight: return "\u{fa2a}"
        case .tapRegular: return "\u{fa2b}"
        case .telepresenceAlertBold: return "\u{fa2c}"
        case .telepresenceAlertLight: return "\u{fa2d}"
        case .telepresenceAlertMutedBold: return "\u{fa2e}"
        case .telepresenceAlertMutedLight: return "\u{fa2f}"
        case .telepresenceAlertMutedRegular: return "\u{fa30}"
        case .telepresenceAlertRegular: return "\u{fa31}"
        case .telepresenceBold: return "\u{fa32}"
        case .telepresenceIx5000Bold: return "\u{fa33}"
        case .telepresenceIx5000Light: return "\u{fa34}"
        case .telepresenceIx5000Regular: return "\u{fa35}"
        case .telepresenceLight: return "\u{fa36}"
        case .telepresencePrivateBold: return "\u{fa37}"
        case .telepresencePrivateLight: return "\u{fa38}"
        case .telepresencePrivateRegular: return "\u{fa39}"
        case .telepresenceRegular: return "\u{fa3a}"
        case .temperatureBold: return "\u{fa3b}"
        case .temperatureLight: return "\u{fa3c}"
        case .temperatureRegular: return "\u{fa3d}"
        case .textAlignCenterBold: return "\u{fa3e}"
        case .textAlignCenterFilled: return "\u{fa3f}"
        case .textAlignCenterLight: return "\u{fa40}"
        case .textAlignCenterRegular: return "\u{fa41}"
        case .textAlignLeftBold: return "\u{fa42}"
        case .textAlignLeftFilled: return "\u{fa43}"
        case .textAlignLeftLight: return "\u{fa44}"
        case .textAlignLeftRegular: return "\u{fa45}"
        case .textAlignRightBold: return "\u{fa46}"
        case .textAlignRightFilled: return "\u{fa47}"
        case .textAlignRightLight: return "\u{fa48}"
        case .textAlignRightRegular: return "\u{fa49}"
        case .textBold: return "\u{fa4a}"
        case .textCodeBlockBold: return "\u{fa4b}"
        case .textCodeBlockLight: return "\u{fa4c}"
        case .textCodeBlockRegular: return "\u{fa4d}"
        case .textHighlightBold: return "\u{fa4e}"
        case .textHighlightLight: return "\u{fa4f}"
        case .textHighlightRegular: return "\u{fa50}"
        case .textLight: return "\u{fa51}"
        case .textRegular: return "\u{fa52}"
        case .threeColumnBold: return "\u{fa53}"
        case .threeColumnLight: return "\u{fa54}"
        case .threeColumnRegular: return "\u{fa55}"
        case .threeDObjectBold: return "\u{fa56}"
        case .threeDObjectLight: return "\u{fa57}"
        case .threeDObjectRegular: return "\u{fa58}"
        case .tooFastBold: return "\u{fa59}"
        case .tooFastLight: return "\u{fa5a}"
        case .tooFastRegular: return "\u{fa5b}"
        case .tooSlowBold: return "\u{fa5c}"
        case .tooSlowLight: return "\u{fa5d}"
        case .tooSlowRegular: return "\u{fa5e}"
        case .toolsBold: return "\u{fa5f}"
        case .toolsLight: return "\u{fa60}"
        case .toolsRegular: return "\u{fa61}"
        case .touch10Bold: return "\u{fa62}"
        case .touch10Light: return "\u{fa63}"
        case .touch10Regular: return "\u{fa64}"
        case .transcriptBold: return "\u{fa65}"
        case .transcriptFilled: return "\u{fa66}"
        case .transcriptLight: return "\u{fa67}"
        case .transcriptRegular: return "\u{fa68}"
        case .translateBold: return "\u{fa69}"
        case .translateLight: return "\u{fa6a}"
        case .translateRegular: return "\u{fa6b}"
        case .trimBold: return "\u{fa6c}"
        case .trimLight: return "\u{fa6d}"
        case .trimRegular: return "\u{fa6e}"
        case .twoColumnBold: return "\u{fa6f}"
        case .twoColumnLight: return "\u{fa70}"
        case .twoColumnRegular: return "\u{fa71}"
        case .ucmCloudBold: return "\u{fa72}"
        case .ucmCloudLight: return "\u{fa73}"
        case .ucmCloudRegular: return "\u{fa74}"
        case .underlineBold: return "\u{fa75}"
        case .underlineLight: return "\u{fa76}"
        case .underlineRegular: return "\u{fa77}"
        case .undoBold: return "\u{fa78}"
        case .undoLight: return "\u{fa79}"
        case .undoRegular: return "\u{fa7a}"
        case .unlinkBold: return "\u{fa7b}"
        case .unlinkLight: return "\u{fa7c}"
        case .unlinkRegular: return "\u{fa7d}"
        case .unreadBold: return "\u{fa7e}"
        case .unreadFilled: return "\u{fa7f}"
        case .unreadLight: return "\u{fa80}"
        case .unreadRegular: return "\u{fa81}"
        case .unsecureUnlockedBold: return "\u{fa82}"
        case .unsecureUnlockedFilled: return "\u{fa83}"
        case .unsecureUnlockedLight: return "\u{fa84}"
        case .unsecureUnlockedRegular: return "\u{fa85}"
        case .unsortedBold: return "\u{fa86}"
        case .unsortedLight: return "\u{fa87}"
        case .unsortedRegular: return "\u{fa88}"
        case .updateFileShareBold: return "\u{fa89}"
        case .updateFileShareLight: return "\u{fa8a}"
        case .updateFileShareRegular: return "\u{fa8b}"
        case .upgradeBold: return "\u{fa8c}"
        case .upgradeFilled: return "\u{fa8d}"
        case .upgradeLight: return "\u{fa8e}"
        case .upgradeRegular: return "\u{fa8f}"
        case .uploadBold: return "\u{fa90}"
        case .uploadImageBold: return "\u{fa91}"
        case .uploadImageLight: return "\u{fa92}"
        case .uploadImageRegular: return "\u{fa93}"
        case .uploadLight: return "\u{fa94}"
        case .uploadRegular: return "\u{fa95}"
        case .urgentVoicemailBold: return "\u{fa96}"
        case .urgentVoicemailFilled: return "\u{fa97}"
        case .usbBold: return "\u{fa98}"
        case .usbHeadsetBold: return "\u{fa99}"
        case .usbHeadsetLight: return "\u{fa9a}"
        case .usbHeadsetMutedBold: return "\u{fa9b}"
        case .usbHeadsetMutedLight: return "\u{fa9c}"
        case .usbHeadsetMutedRegular: return "\u{fa9d}"
        case .usbHeadsetRegular: return "\u{fa9e}"
        case .usbLight: return "\u{fa9f}"
        case .usbRegular: return "\u{faa0}"
        case .userBold: return "\u{faa1}"
        case .userDeactivateBold: return "\u{faa2}"
        case .userDeactivateLight: return "\u{faa3}"
        case .userDeactivateRegular: return "\u{faa4}"
        case .userLight: return "\u{faa5}"
        case .userRegular: return "\u{faa6}"
        case .vcsBold: return "\u{faa7}"
        case .vcsLight: return "\u{faa8}"
        case .vcsRegular: return "\u{faa9}"
        case .videoBlurBold: return "\u{faaa}"
        case .videoBlurFilled: return "\u{faab}"
        case .videoBlurLight: return "\u{faac}"
        case .videoBlurRegular: return "\u{faad}"
        case .videoBold: return "\u{faae}"
        case .videoEffectBold: return "\u{faaf}"
        case .videoEffectFilled: return "\u{fab0}"
        case .videoEffectLight: return "\u{fab1}"
        case .videoEffectRegular: return "\u{fab2}"
        case .videoFilled: return "\u{fab3}"
        case .videoLayoutBold: return "\u{fab4}"
        case .videoLayoutEqualBold: return "\u{fab5}"
        case .videoLayoutEqualDualBold: return "\u{fab6}"
        case .videoLayoutEqualDualLight: return "\u{fab7}"
        case .videoLayoutEqualDualRegular: return "\u{fab8}"
        case .videoLayoutEqualFilled: return "\u{fab9}"
        case .videoLayoutEqualLight: return "\u{faba}"
        case .videoLayoutEqualRegular: return "\u{fabb}"
        case .videoLayoutFilled: return "\u{fabc}"
        case .videoLayoutLight: return "\u{fabd}"
        case .videoLayoutOverlayBold: return "\u{fabe}"
        case .videoLayoutOverlayLight: return "\u{fabf}"
        case .videoLayoutOverlayRegular: return "\u{fac0}"
        case .videoLayoutPresenterDominantBold: return "\u{fac1}"
        case .videoLayoutPresenterDominantLight: return "\u{fac2}"
        case .videoLayoutPresenterDominantRegular: return "\u{fac3}"
        case .videoLayoutProminentBold: return "\u{fac4}"
        case .videoLayoutProminentFilled: return "\u{fac5}"
        case .videoLayoutProminentLight: return "\u{fac6}"
        case .videoLayoutProminentRegular: return "\u{fac7}"
        case .videoLayoutRegular: return "\u{fac8}"
        case .videoLayoutShareDominantBold: return "\u{fac9}"
        case .videoLayoutShareDominantLight: return "\u{faca}"
        case .videoLayoutShareDominantRegular: return "\u{facb}"
        case .videoLayoutSingleBold: return "\u{facc}"
        case .videoLayoutSingleFilled: return "\u{facd}"
        case .videoLayoutSingleLight: return "\u{face}"
        case .videoLayoutSingleRegular: return "\u{facf}"
        case .videoLayoutStackBold: return "\u{fad0}"
        case .videoLayoutStackFilled: return "\u{fad1}"
        case .videoLayoutStackLight: return "\u{fad2}"
        case .videoLayoutStackRegular: return "\u{fad3}"
        case .videoLayoutVideoDominantBold: return "\u{fad4}"
        case .videoLayoutVideoDominantFilled: return "\u{fad5}"
        case .videoLayoutVideoDominantLight: return "\u{fad6}"
        case .videoLayoutVideoDominantRegular: return "\u{fad7}"
        case .videoLight: return "\u{fad8}"
        case .videoPlusBold: return "\u{fad9}"
        case .videoPlusFilled: return "\u{fada}"
        case .videoPlusLight: return "\u{fadb}"
        case .videoPlusRegular: return "\u{fadc}"
        case .videoRegular: return "\u{fadd}"
        case .videoSpeakerTrackBold: return "\u{fade}"
        case .videoSpeakerTrackFilled: return "\u{fadf}"
        case .videoSpeakerTrackLight: return "\u{fae0}"
        case .videoSpeakerTrackRegular: return "\u{fae1}"
        case .viewAllBold: return "\u{fae2}"
        case .viewAllLight: return "\u{fae3}"
        case .viewAllRegular: return "\u{fae4}"
        case .viewListBold: return "\u{fae5}"
        case .viewListLight: return "\u{fae6}"
        case .viewListRegular: return "\u{fae7}"
        case .viewStackedBold: return "\u{fae8}"
        case .viewStackedFilled: return "\u{fae9}"
        case .viewStackedLight: return "\u{faea}"
        case .viewStackedRegular: return "\u{faeb}"
        case .viewThumbnailBold: return "\u{faec}"
        case .viewThumbnailFilled: return "\u{faed}"
        case .viewThumbnailLight: return "\u{faee}"
        case .viewThumbnailRegular: return "\u{faef}"
        case .voicemailBold: return "\u{faf0}"
        case .voicemailFilled: return "\u{faf1}"
        case .voicemailLight: return "\u{faf2}"
        case .voicemailRegular: return "\u{faf3}"
        case .waffleMenuBold: return "\u{faf4}"
        case .waffleMenuLight: return "\u{faf5}"
        case .waffleMenuRegular: return "\u{faf6}"
        case .waitingroomActiveBold: return "\u{faf7}"
        case .waitingroomActiveLight: return "\u{faf8}"
        case .waitingroomActiveRegular: return "\u{faf9}"
        case .wallpaperBold: return "\u{fafa}"
        case .wallpaperLight: return "\u{fafb}"
        case .wallpaperRegular: return "\u{fafc}"
        case .warningBadgeFilled: return "\u{fafd}"
        case .warningBold: return "\u{fafe}"
        case .warningFilled: return "\u{faff}"
        case .warningLight: return "\u{fb00}"
        case .warningRegular: return "\u{fb01}"
        case .webexAssistantActiveColored: return "\u{fb02}"
        case .webexAssistantActive: return "\u{fb03}"
        case .webexAssistantFlat: return "\u{fb04}"
        case .webexAssistantInactiveColored: return "\u{fb05}"
        case .webexAssistantInactive: return "\u{fb06}"
        case .webexAssistant: return "\u{fb07}"
        case .webexBoardBold: return "\u{fb08}"
        case .webexBoardLight: return "\u{fb09}"
        case .webexBoardRegular: return "\u{fb0a}"
        case .webexCodecPlusBold: return "\u{fb0b}"
        case .webexCodecPlusLight: return "\u{fb0c}"
        case .webexCodecPlusRegular: return "\u{fb0d}"
        case .webexDeskCameraBold: return "\u{fb0e}"
        case .webexDeskCameraLight: return "\u{fb0f}"
        case .webexDeskCameraRegular: return "\u{fb10}"
        case .webexHelixFilled: return "\u{fb11}"
        case .webexMeetingsBold: return "\u{fb12}"
        case .webexMeetingsFilled: return "\u{fb13}"
        case .webexMeetingsLight: return "\u{fb14}"
        case .webexMeetingsRegular: return "\u{fb15}"
        case .webexQuadCameraBold: return "\u{fb16}"
        case .webexQuadCameraLight: return "\u{fb17}"
        case .webexQuadCameraRegular: return "\u{fb18}"
        case .webexRoomKitBold: return "\u{fb19}"
        case .webexRoomKitLight: return "\u{fb1a}"
        case .webexRoomKitPlusBold: return "\u{fb1b}"
        case .webexRoomKitPlusLight: return "\u{fb1c}"
        case .webexRoomKitPlusRegular: return "\u{fb1d}"
        case .webexRoomKitRegular: return "\u{fb1e}"
        case .webexShareBold: return "\u{fb1f}"
        case .webexShareLight: return "\u{fb20}"
        case .webexShareRegular: return "\u{fb21}"
        case .webexTeamsBold: return "\u{fb22}"
        case .webexTeamsFilled: return "\u{fb23}"
        case .webexTeamsLight: return "\u{fb24}"
        case .webexTeamsNewBold: return "\u{fb25}"
        case .webexTeamsNewFilled: return "\u{fb26}"
        case .webexTeamsNewLight: return "\u{fb27}"
        case .webexTeamsNewRegular: return "\u{fb28}"
        case .webexTeamsRegular: return "\u{fb29}"
        case .webinarBold: return "\u{fb2a}"
        case .webinarFilled: return "\u{fb2b}"
        case .webinarLight: return "\u{fb2c}"
        case .webinarRegular: return "\u{fb2d}"
        case .weeklyRecurringScheduleNodeBold: return "\u{fb2e}"
        case .weeklyRecurringScheduleNodeLight: return "\u{fb2f}"
        case .weeklyRecurringScheduleNodeRegular: return "\u{fb30}"
        case .whatsNewBold: return "\u{fb31}"
        case .whatsNewFilled: return "\u{fb32}"
        case .whatsNewLight: return "\u{fb33}"
        case .whatsNewRegular: return "\u{fb34}"
        case .whiteboardBold: return "\u{fb35}"
        case .whiteboardContentBold: return "\u{fb36}"
        case .whiteboardContentLight: return "\u{fb37}"
        case .whiteboardContentRegular: return "\u{fb38}"
        case .whiteboardFilled: return "\u{fb39}"
        case .whiteboardLight: return "\u{fb3a}"
        case .whiteboardRegular: return "\u{fb3b}"
        case .widgetBold: return "\u{fb3c}"
        case .widgetFilled: return "\u{fb3d}"
        case .widgetLight: return "\u{fb3e}"
        case .widgetRegular: return "\u{fb3f}"
        case .wifiBold: return "\u{fb40}"
        case .wifiErrorBold: return "\u{fb41}"
        case .wifiErrorLight: return "\u{fb42}"
        case .wifiErrorRegular: return "\u{fb43}"
        case .wifiLight: return "\u{fb44}"
        case .wifiRegular: return "\u{fb45}"
        case .wifiSignalGoodColoredBold: return "\u{fb46}"
        case .wifiSignalGoodColoredLight: return "\u{fb47}"
        case .wifiSignalGoodColoredRegular: return "\u{fb48}"
        case .wifiSignalPoorColoredBold: return "\u{fb49}"
        case .wifiSignalPoorColoredLight: return "\u{fb4a}"
        case .wifiSignalPoorColoredRegular: return "\u{fb4b}"
        case .wifiSignalUnstableColoredBold: return "\u{fb4c}"
        case .wifiSignalUnstableColoredLight: return "\u{fb4d}"
        case .wifiSignalUnstableColoredRegular: return "\u{fb4e}"
        case .windowCornerScrubBold: return "\u{fb4f}"
        case .windowCornerScrubLight: return "\u{fb50}"
        case .windowCornerScrubRegular: return "\u{fb51}"
        case .windowRightCornerScrubBold: return "\u{fb52}"
        case .windowRightCornerScrubLight: return "\u{fb53}"
        case .windowRightCornerScrubRegular: return "\u{fb54}"
        case .windowVerticalScrubBold: return "\u{fb55}"
        case .windowVerticalScrubLight: return "\u{fb56}"
        case .windowVerticalScrubRegular: return "\u{fb57}"
        case .workflowDeploymentsBold: return "\u{fb58}"
        case .workflowDeploymentsFilled: return "\u{fb59}"
        case .workflowDeploymentsLight: return "\u{fb5a}"
        case .workflowDeploymentsRegular: return "\u{fb5b}"
        case .workphoneBold: return "\u{fb5c}"
        case .workphoneLight: return "\u{fb5d}"
        case .workphoneRegular: return "\u{fb5e}"
        case .zoomInBold: return "\u{fb5f}"
        case .zoomInLight: return "\u{fb60}"
        case .zoomInRegular: return "\u{fb61}"
        case .zoomOutBold: return "\u{fb62}"
        case .zoomOutLight: return "\u{fb63}"
        case .zoomOutRegular: return "\u{fb64}"
        case .zoom: return "\u{fb65}"
