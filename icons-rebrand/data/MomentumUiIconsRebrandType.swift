...
@objc public enum MomentumIconsRebrandType: Int {
    ...
    public var ligature: String {
        ...
        case .fileImageNoneBold: return "\u{f4a6}"
        case .fileImageNoneLight: return "\u{f4a7}"
        case .fileImageNoneRegular: return "\u{f4a8}"
        case .fileImageRegular: return "\u{f4a9}"
        case .fileKeynoteBold: return "\u{f4aa}"
        case .fileKeynoteFilled: return "\u{f4ab}"
        case .fileKeynoteLight: return "\u{f4ac}"
        case .fileKeynoteRegular: return "\u{f4ad}"
        case .fileLockedBold: return "\u{f4ae}"
        case .fileLockedFilled: return "\u{f4af}"
        case .fileLockedLight: return "\u{f4b0}"
        case .fileLockedRegular: return "\u{f4b1}"
        case .fileMissingBold: return "\u{f4b2}"
        case .fileMissingFilled: return "\u{f4b3}"
        case .fileMissingLight: return "\u{f4b4}"
        case .fileMissingRegular: return "\u{f4b5}"
        case .fileMusicBold: return "\u{f4b6}"
        case .fileMusicFilled: return "\u{f4b7}"
        case .fileMusicLight: return "\u{f4b8}"
        case .fileMusicRegular: return "\u{f4b9}"
        case .fileOnenoteBold: return "\u{f4ba}"
        case .fileOnenoteFilled: return "\u{f4bb}"
        case .fileOnenoteLight: return "\u{f4bc}"
        case .fileOnenoteRegular: return "\u{f4bd}"
        case .filePdfBold: return "\u{f4be}"
        case .filePdfFilled: return "\u{f4bf}"
        case .filePdfLight: return "\u{f4c0}"
        case .filePdfRegular: return "\u{f4c1}"
        case .filePowerpointBold: return "\u{f4c2}"
        case .filePowerpointFilled: return "\u{f4c3}"
        case .filePowerpointLight: return "\u{f4c4}"
        case .filePowerpointRegular: return "\u{f4c5}"
        case .fileSpreadsheetBold: return "\u{f4c6}"
        case .fileSpreadsheetFilled: return "\u{f4c7}"
        case .fileSpreadsheetLight: return "\u{f4c8}"
        case .fileSpreadsheetRegular: return "\u{f4c9}"
        case .fileTextBold: return "\u{f4ca}"
        case .fileTextFilled: return "\u{f4cb}"
        case .fileTextLight: return "\u{f4cc}"
        case .fileTextRegular: return "\u{f4cd}"
        case .fileVectorBold: return "\u{f4ce}"
        case .fileVectorFilled: return "\u{f4cf}"
        case .fileVectorLight: return "\u{f4d0}"
        case .fileVectorRegular: return "\u{f4d1}"
        case .fileVideoBold: return "\u{f4d2}"
        case .fileVideoFilled: return "\u{f4d3}"
        case .fileVideoLight: return "\u{f4d4}"
        case .fileVideoRegular: return "\u{f4d5}"
        case .fileWordBold: return "\u{f4d6}"
        case .fileWordFilled: return "\u{f4d7}"
        case .fileWordLight: return "\u{f4d8}"
        case .fileWordRegular: return "\u{f4d9}"
        case .fileZipBold: return "\u{f4da}"
        case .fileZipFilled: return "\u{f4db}"
        case .fileZipLight: return "\u{f4dc}"
        case .fileZipRegular: return "\u{f4dd}"
        case .filesBold: return "\u{f4de}"
        case .filesFilled: return "\u{f4df}"
        case .filesLight: return "\u{f4e0}"
        case .filesRegular: return "\u{f4e1}"
        case .fillColourBold: return "\u{f4e2}"
        case .fillColourFilled: return "\u{f4e3}"
        case .fillColourLight: return "\u{f4e4}"
        case .fillColourRegular: return "\u{f4e5}"
        case .filterBold: return "\u{f4e6}"
        case .filterCircleBold: return "\u{f4e7}"
        case .filterCircleFilled: return "\u{f4e8}"
        case .filterCircleLight: return "\u{f4e9}"
        case .filterCircleRegular: return "\u{f4ea}"
        case .filterLight: return "\u{f4eb}"
        case .filterRegular: return "\u{f4ec}"
        case .fitToWidthBold: return "\u{f4ed}"
        case .fitToWidthLight: return "\u{f4ee}"
        case .fitToWidthRegular: return "\u{f4ef}"
        case .fitToWindowBold: return "\u{f4f0}"
        case .fitToWindowExitBold: return "\u{f4f1}"
        case .fitToWindowExitLight: return "\u{f4f2}"
        case .fitToWindowExitRegular: return "\u{f4f3}"
        case .fitToWindowLight: return "\u{f4f4}"
        case .fitToWindowRegular: return "\u{f4f5}"
        case .flagBold: return "\u{f4f6}"
        case .flagCircleBold: return "\u{f4f7}"
        case .flagCircleFilled: return "\u{f4f8}"
        case .flagCircleLight: return "\u{f4f9}"
        case .flagCircleRegular: return "\u{f4fa}"
        case .flagFilled: return "\u{f4fb}"
        case .flagLight: return "\u{f4fc}"
        case .flagRegular: return "\u{f4fd}"
        case .folderBold: return "\u{f4fe}"
        case .folderEditBold: return "\u{f4ff}"
        case .folderEditLight: return "\u{f500}"
        case .folderEditRegular: return "\u{f501}"
        case .folderLight: return "\u{f502}"
        case .folderLockBold: return "\u{f503}"
        case .folderLockLight: return "\u{f504}"
        case .folderLockRegular: return "\u{f505}"
        case .folderRegular: return "\u{f506}"
        case .folderViewBold: return "\u{f507}"
        case .folderViewLight: return "\u{f508}"
        case .folderViewRegular: return "\u{f509}"
        case .followUpBold: return "\u{f50a}"
        case .followUpLight: return "\u{f50b}"
        case .followUpRegular: return "\u{f50c}"
        case .foodBold: return "\u{f50d}"
        case .foodLight: return "\u{f50e}"
        case .foodRegular: return "\u{f50f}"
        case .formatBold: return "\u{f510}"
        case .formatControlPanelDraggerBold: return "\u{f511}"
        case .formatControlPanelDraggerHorizontalBold: return "\u{f512}"
        case .formatControlPanelDraggerHorizontalLight: return "\u{f513}"
        case .formatControlPanelDraggerHorizontalRegular: return "\u{f514}"
        case .formatControlPanelDraggerLight: return "\u{f515}"
        case .formatControlPanelDraggerRegular: return "\u{f516}"
        case .formatDefaultAppBold: return "\u{f517}"
        case .formatDefaultAppLight: return "\u{f518}"
        case .formatDefaultAppRegular: return "\u{f519}"
        case .formatLight: return "\u{f51a}"
        case .formatPanelControlBarBold: return "\u{f51b}"
        case .formatPanelControlBarLight: return "\u{f51c}"
        case .formatPanelControlBarRegular: return "\u{f51d}"
        case .formatPanelControlDownBold: return "\u{f51e}"
        case .formatPanelControlDownLight: return "\u{f51f}"
        case .formatPanelControlDownRegular: return "\u{f520}"
        case .formatPanelControlLeftBold: return "\u{f521}"
        case .formatPanelControlLeftLight: return "\u{f522}"
        case .formatPanelControlLeftRegular: return "\u{f523}"
        case .formatPanelControlRightBold: return "\u{f524}"
        case .formatPanelControlRightLight: return "\u{f525}"
        case .formatPanelControlRightRegular: return "\u{f526}"
        case .formatPanelControlUpBold: return "\u{f527}"
        case .formatPanelControlUpDownBold: return "\u{f528}"
        case .formatPanelControlUpDownLight: return "\u{f529}"
        case .formatPanelControlUpDownRegular: return "\u{f52a}"
        case .formatPanelControlUpLight: return "\u{f52b}"
        case .formatPanelControlUpRegular: return "\u{f52c}"
        case .formatRegular: return "\u{f52d}"
        case .formatViewMixedBold: return "\u{f52e}"
        case .formatViewMixedLight: return "\u{f52f}"
        case .formatViewMixedRegular: return "\u{f530}"
        case .forwardMessageBold: return "\u{f531}"
        case .forwardMessageFilled: return "\u{f532}"
        case .forwardMessageLight: return "\u{f533}"
        case .forwardMessageRegular: return "\u{f534}"
        case .fourColumnBold: return "\u{f535}"
        case .fourColumnLight: return "\u{f536}"
        case .fourColumnRegular: return "\u{f537}"
        case .fourWayNavigationBold: return "\u{f538}"
        case .fourWayNavigationLight: return "\u{f539}"
        case .fourWayNavigationRegular: return "\u{f53a}"
        case .frequencyCappingBold: return "\u{f53b}"
        case .frequencyCappingLight: return "\u{f53c}"
        case .frequencyCappingRegular: return "\u{f53d}"
        case .fufillmentBold: return "\u{f53e}"
        case .fufillmentLight: return "\u{f53f}"
        case .fufillmentRegular: return "\u{f540}"
        case .fullscreenBold: return "\u{f541}"
        case .fullscreenExitBold: return "\u{f542}"
        case .fullscreenExitLight: return "\u{f543}"
        case .fullscreenExitRegular: return "\u{f544}"
        case .fullscreenLight: return "\u{f545}"
        case .fullscreenRegular: return "\u{f546}"
        case .genericDeviceVideoBold: return "\u{f547}"
        case .genericDeviceVideoFilled: return "\u{f548}"
        case .genericDeviceVideoLight: return "\u{f549}"
        case .genericDeviceVideoRegular: return "\u{f54a}"
        case .genericDeviceVideoSmallFilled: return "\u{f54b}"
        case .gifBold: return "\u{f54c}"
        case .gifFilled: return "\u{f54d}"
        case .gifHorizontalFilled: return "\u{f54e}"
        case .gifLight: return "\u{f54f}"
        case .gifRegular: return "\u{f550}"
        case .googleMeet: return "\u{f551}"
        case .greenRoomBold: return "\u{f552}"
        case .greenRoomFilled: return "\u{f553}"
        case .greenRoomLight: return "\u{f554}"
        case .greenRoomRegular: return "\u{f555}"
        case .groupBold: return "\u{f556}"
        case .groupLight: return "\u{f557}"
        case .groupPickupBold: return "\u{f558}"
        case .groupPickupFilled: return "\u{f559}"
        case .groupPickupLight: return "\u{f55a}"
        case .groupPickupRegular: return "\u{f55b}"
        case .groupRegular: return "\u{f55c}"
        case .guestIssuerBold: return "\u{f55d}"
        case .guestIssuerLight: return "\u{f55e}"
        case .guestIssuerRegular: return "\u{f55f}"
        case .guideBold: return "\u{f560}"
        case .guideLight: return "\u{f561}"
        case .guideRegular: return "\u{f562}"
        case .handlerBold: return "\u{f563}"
        case .handlerLight: return "\u{f564}"
        case .handlerRegular: return "\u{f565}"
        case .handsetAlertBold: return "\u{f566}"
        case .handsetAlertFilled: return "\u{f567}"
        case .handsetAlertLight: return "\u{f568}"
        case .handsetAlertRegular: return "\u{f569}"
        case .handsetBold: return "\u{f56a}"
        case .handsetFilled: return "\u{f56b}"
        case .handsetLight: return "\u{f56c}"
        case .handsetMutedBold: return "\u{f56d}"
        case .handsetMutedFilled: return "\u{f56e}"
        case .handsetMutedLight: return "\u{f56f}"
        case .handsetMutedRegular: return "\u{f570}"
        case .handsetRegular: return "\u{f571}"
        case .handshakeBold: return "\u{f572}"
        case .handshakeLight: return "\u{f573}"
        case .handshakeRegular: return "\u{f574}"
        case .headingOneBold: return "\u{f575}"
        case .headingOneLight: return "\u{f576}"
        case .headingOneRegular: return "\u{f577}"
        case .headingThreeBold: return "\u{f578}"
        case .headingThreeLight: return "\u{f579}"
        case .headingThreeRegular: return "\u{f57a}"
        case .headingTwoBold: return "\u{f57b}"
        case .headingTwoLight: return "\u{f57c}"
        case .headingTwoRegular: return "\u{f57d}"
        case .headsetAlertBold: return "\u{f57e}"
        case .headsetAlertLight: return "\u{f57f}"
        case .headsetAlertRegular: return "\u{f580}"
        case .headsetBold: return "\u{f581}"
        case .headsetFilled: return "\u{f582}"
        case .headsetLight: return "\u{f583}"
        case .headsetMutedBold: return "\u{f584}"
        case .headsetMutedLight: return "\u{f585}"
        case .headsetMutedRegular: return "\u{f586}"
        case .headsetPrivateBold: return "\u{f587}"
        case .headsetPrivateLight: return "\u{f588}"
        case .headsetPrivateRegular: return "\u{f589}"
        case .headsetRegular: return "\u{f58a}"
        case .helpBold: return "\u{f58b}"
        case .helpCircleActiveFilled: return "\u{f58c}"
        case .helpCircleBold: return "\u{f58d}"
        case .helpCircleLight: return "\u{f58e}"
        case .helpCircleRegular: return "\u{f58f}"
        case .helpLight: return "\u{f590}"
        case .helpRegular: return "\u{f591}"
        case .helpdeskBold: return "\u{f592}"
        case .helpdeskLight: return "\u{f593}"
        case .helpdeskRegular: return "\u{f594}"
        case .hideBold: return "\u{f595}"
        case .hideFilled: return "\u{f596}"
        case .hideLight: return "\u{f597}"
        case .hideRegular: return "\u{f598}"
        case .homeBold: return "\u{f599}"
        case .homeFilled: return "\u{f59a}"
        case .homeLight: return "\u{f59b}"
        case .homeRegular: return "\u{f59c}"
        case .horizontalLineBold: return "\u{f59d}"
        case .horizontalLineLight: return "\u{f59e}"
        case .horizontalLineRegular: return "\u{f59f}"
        case .hotelingBold: return "\u{f5a0}"
        case .hotelingFilled: return "\u{f5a1}"
        case .hotelingLight: return "\u{f5a2}"
        case .hotelingRegular: return "\u{f5a3}"
        case .humidityBold: return "\u{f5a4}"
        case .humidityLight: return "\u{f5a5}"
        case .humidityRegular: return "\u{f5a6}"
        case .huntGroupBold: return "\u{f5a7}"
        case .huntGroupFilled: return "\u{f5a8}"
        case .huntGroupLight: return "\u{f5a9}"
        case .huntGroupRegular: return "\u{f5aa}"
        case .importBold: return "\u{f5ab}"
        case .importLight: return "\u{f5ac}"
        case .importRegular: return "\u{f5ad}"
        case .inCommonBold: return "\u{f5ae}"
        case .inCommonLight: return "\u{f5af}"
        case .inCommonRegular: return "\u{f5b0}"
        case .includeBold: return "\u{f5b1}"
        case .includeLight: return "\u{f5b2}"
        case .includeRegular: return "\u{f5b3}"
        case .incomingCallLegacyBold: return "\u{f5b4}"
        case .incomingCallLegacyFilled: return "\u{f5b5}"
        case .incomingCallLegacyLight: return "\u{f5b6}"
        case .incomingCallLegacyRegular: return "\u{f5b7}"
        case .infoBadgeFilled: return "\u{f5b8}"
        case .infoCircleBold: return "\u{f5b9}"
        case .infoCircleFilled: return "\u{f5ba}"
        case .infoCircleLight: return "\u{f5bb}"
        case .infoCircleRegular: return "\u{f5bc}"
        case .infoCircleTwoBold: return "\u{f5bd}"
        case .infoCircleTwoFilled: return "\u{f5be}"
        case .infoCircleTwoLight: return "\u{f5bf}"
        case .infoCircleTwoRegular: return "\u{f5c0}"
        case .inputBold: return "\u{f5c1}"
        case .inputDisconnectedBold: return "\u{f5c2}"
        case .inputDisconnectedLight: return "\u{f5c3}"
        case .inputDisconnectedRegular: return "\u{f5c4}"
        case .inputLight: return "\u{f5c5}"
        case .inputRegular: return "\u{f5c6}"
        case .insightsBold: return "\u{f5c7}"
        case .insightsLight: return "\u{f5c8}"
        case .insightsRegular: return "\u{f5c9}"
        case .integrationsBold: return "\u{f5ca}"
        case .integrationsLight: return "\u{f5cb}"
        case .integrationsRegular: return "\u{f5cc}"
        case .intelligentRoutingBold: return "\u{f5cd}"
        case .intelligentRoutingLight: return "\u{f5ce}"
        case .intelligentRoutingRegular: return "\u{f5cf}"
        case .invitedUserBold: return "\u{f5d0}"
        case .invitedUserLight: return "\u{f5d1}"
        case .invitedUserRegular: return "\u{f5d2}"
        case .italicBold: return "\u{f5d3}"
        case .italicLight: return "\u{f5d4}"
        case .italicRegular: return "\u{f5d5}"
        case .joinAudioBold: return "\u{f5d6}"
        case .joinAudioFilled: return "\u{f5d7}"
        case .joinAudioLight: return "\u{f5d8}"
        case .joinAudioRegular: return "\u{f5d9}"
        case .keepInTouchBold: return "\u{f5da}"
        case .keepInTouchFilled: return "\u{f5db}"
        case .keepInTouchLight: return "\u{f5dc}"
        case .keepInTouchRegular: return "\u{f5dd}"
        case .keyboardBold: return "\u{f5de}"
        case .keyboardCloseBold: return "\u{f5df}"
        case .keyboardCloseLight: return "\u{f5e0}"
        case .keyboardCloseRegular: return "\u{f5e1}"
        case .keyboardLight: return "\u{f5e2}"
        case .keyboardRegular: return "\u{f5e3}"
        case .languageBold: return "\u{f5e4}"
        case .languageLight: return "\u{f5e5}"
        case .languageRegular: return "\u{f5e6}"
        case .laptopBold: return "\u{f5e7}"
        case .laptopDisconnectedBold: return "\u{f5e8}"
        case .laptopDisconnectedLight: return "\u{f5e9}"
        case .laptopDisconnectedRegular: return "\u{f5ea}"
        case .laptopFilled: return "\u{f5eb}"
        case .laptopLight: return "\u{f5ec}"
        case .laptopRegular: return "\u{f5ed}"
        case .laserPointerBold: return "\u{f5ee}"
        case .laserPointerLight: return "\u{f5ef}"
        case .laserPointerRegular: return "\u{f5f0}"
        case .launchBold: return "\u{f5f1}"
        case .launchLight: return "\u{f5f2}"
        case .launchRegular: return "\u{f5f3}"
        case .layoutSideBySideVerticalBold: return "\u{f5f4}"
        case .layoutSideBySideVerticalFilled: return "\u{f5f5}"
        case .layoutSideBySideVerticalLight: return "\u{f5f6}"
        case .layoutSideBySideVerticalRegular: return "\u{f5f7}"
        case .leaveBreakoutSessionBold: return "\u{f5f8}"
        case .leaveBreakoutSessionLight: return "\u{f5f9}"
        case .leaveBreakoutSessionRegular: return "\u{f5fa}"
        case .leaveDeviceBold: return "\u{f5fb}"
        case .leaveDeviceLight: return "\u{f5fc}"
        case .leaveDeviceRegular: return "\u{f5fd}"
        case .likeBold: return "\u{f5fe}"
        case .likeFilled: return "\u{f5ff}"
        case .likeLight: return "\u{f600}"
        case .likeRegular: return "\u{f601}"
        case .linkBold: return "\u{f602}"
        case .linkLight: return "\u{f603}"
        case .linkRegular: return "\u{f604}"
        case .listBulletedBold: return "\u{f605}"
        case .listBulletedLight: return "\u{f606}"
        case .listBulletedRegular: return "\u{f607}"
        case .listMenuBold: return "\u{f608}"
        case .listMenuLight: return "\u{f609}"
        case .listMenuRegular: return "\u{f60a}"
        case .listNumberedBold: return "\u{f60b}"
        case .listNumberedLight: return "\u{f60c}"
        case .listNumberedRegular: return "\u{f60d}"
        case .locationBold: return "\u{f60e}"
        case .locationFilled: return "\u{f60f}"
        case .locationLight: return "\u{f610}"
        case .locationRegular: return "\u{f611}"
        case .longTextBoxBold: return "\u{f612}"
        case .longTextBoxLight: return "\u{f613}"
        case .longTextBoxRegular: return "\u{f614}"
        case .lowerHandBold: return "\u{f615}"
        case .lowerHandLight: return "\u{f616}"
        case .lowerHandRegular: return "\u{f617}"
        case .magicPenBold: return "\u{f618}"
        case .magicPenFilled: return "\u{f619}"
        case .magicPenLight: return "\u{f61a}"
        case .magicPenRegular: return "\u{f61b}"
        case .markAsUnreadBold: return "\u{f61c}"
        case .markAsUnreadLight: return "\u{f61d}"
        case .markAsUnreadRegular: return "\u{f61e}"
        case .markdownBold: return "\u{f61f}"
        case .markdownLight: return "\u{f620}"
        case .markdownRegular: return "\u{f621}"
        case .markerBold: return "\u{f622}"
        case .markerFilled: return "\u{f623}"
        case .markerLight: return "\u{f624}"
        case .markerRegular: return "\u{f625}"
        case .maximizeBold: return "\u{f626}"
        case .maximizeLight: return "\u{f627}"
        case .maximizeRegular: return "\u{f628}"
        case .mediaPlayerBold: return "\u{f629}"
        case .mediaPlayerLight: return "\u{f62a}"
        case .mediaPlayerRegular: return "\u{f62b}"
        case .mediaQualityGoodBold: return "\u{f62c}"
        case .mediaQualityGoodFilled: return "\u{f62d}"
        case .mediaQualityGoodLight: return "\u{f62e}"
        case .mediaQualityGoodRegular: return "\u{f62f}"
        case .mediaQualityPoorBold: return "\u{f630}"
        case .mediaQualityPoorFilled: return "\u{f631}"
        case .mediaQualityPoorLight: return "\u{f632}"
        case .mediaQualityPoorRegular: return "\u{f633}"
        case .mediaQualityUnstableBold: return "\u{f634}"
        case .mediaQualityUnstableFilled: return "\u{f635}"
        case .mediaQualityUnstableLight: return "\u{f636}"
        case .mediaQualityUnstableRegular: return "\u{f637}"
        case .mediumQualityGoodFilled: return "\u{f638}"
        case .mediumQualityPoorFilled: return "\u{f639}"
        case .mediumQualityUnstableFilled: return "\u{f63a}"
        case .meetBold: return "\u{f63b}"
        case .meetEndBold: return "\u{f63c}"
        case .meetEndLight: return "\u{f63d}"
        case .meetEndRegular: return "\u{f63e}"
        case .meetFilled: return "\u{f63f}"
        case .meetLight: return "\u{f640}"
        case .meetRegular: return "\u{f641}"
        case .meetingsBold: return "\u{f642}"
        case .meetingsFilled: return "\u{f643}"
        case .meetingsFocusMonthBold: return "\u{f644}"
        case .meetingsFocusMonthLight: return "\u{f645}"
        case .meetingsFocusMonthRegular: return "\u{f646}"
        case .meetingsFocusOneDayBold: return "\u{f647}"
        case .meetingsFocusOneDayLight: return "\u{f648}"
        case .meetingsFocusOneDayRegular: return "\u{f649}"
        case .meetingsFocusThreeDayBold: return "\u{f64a}"
        case .meetingsFocusThreeDayLight: return "\u{f64b}"
        case .meetingsFocusThreeDayRegular: return "\u{f64c}"
        case .meetingsFocusUpcomingBold: return "\u{f64d}"
        case .meetingsFocusUpcomingLight: return "\u{f64e}"
        case .meetingsFocusUpcomingRegular: return "\u{f64f}"
        case .meetingsFocusWeekBold: return "\u{f650}"
        case .meetingsFocusWeekLight: return "\u{f651}"
        case .meetingsFocusWeekRegular: return "\u{f652}"
        case .meetingsLight: return "\u{f653}"
        case .meetingsPresenceBold: return "\u{f654}"
        case .meetingsPresenceFilled: return "\u{f655}"
        case .meetingsPresenceLight: return "\u{f656}"
        case .meetingsPresenceRegular: return "\u{f657}"
        case .meetingsPresenceSmallFilled: return "\u{f658}"
        case .meetingsRegular: return "\u{f659}"
        case .meetingsTeamActiveBold: return "\u{f65a}"
        case .meetingsTeamActiveLight: return "\u{f65b}"
        case .meetingsTeamActiveRegular: return "\u{f65c}"
        case .meetingsTeamBold: return "\u{f65d}"
        case .meetingsTeamLight: return "\u{f65e}"
        case .meetingsTeamNewBold: return "\u{f65f}"
        case .meetingsTeamNewLight: return "\u{f660}"
        case .meetingsTeamNewRegular: return "\u{f661}"
        case .meetingsTeamRegular: return "\u{f662}"
        case .mentionBold: return "\u{f663}"
        case .mentionLight: return "\u{f664}"
        case .mentionRegular: return "\u{f665}"
        case .messageQueingBold: return "\u{f666}"
        case .messageQueingLight: return "\u{f667}"
        case .messageQueingRegular: return "\u{f668}"
        case .microphoneBold: return "\u{f669}"
        case .microphoneFilled: return "\u{f66a}"
        case .microphoneHardMutedBold: return "\u{f66b}"
        case .microphoneHardMutedColoredBold: return "\u{f66c}"
        case .microphoneHardMutedColoredLight: return "\u{f66d}"
        case .microphoneHardMutedColoredRegular: return "\u{f66e}"
        case .microphoneHardMutedLight: return "\u{f66f}"
        case .microphoneHardMutedRegular: return "\u{f670}"
        case .microphoneLight: return "\u{f671}"
        case .microphoneMusicModeColoredBold: return "\u{f672}"
        case .microphoneMusicModeColoredLight: return "\u{f673}"
        case .microphoneMusicModeColoredRegular: return "\u{f674}"
        case .microphoneMutedBold: return "\u{f675}"
        case .microphoneMutedFilled: return "\u{f676}"
        case .microphoneMutedIndicatorFilled: return "\u{f677}"
        case .microphoneMutedLight: return "\u{f678}"
        case .microphoneMutedRedBold: return "\u{f679}"
        case .microphoneMutedRedFilled: return "\u{f67a}"
        case .microphoneMutedRedLight: return "\u{f67b}"
        case .microphoneMutedRedRegular: return "\u{f67c}"
        case .microphoneMutedRegular: return "\u{f67d}"
        case .microphoneRegular: return "\u{f67e}"
        case .minimizeBold: return "\u{f67f}"
        case .minimizeLight: return "\u{f680}"
        case .minimizeRegular: return "\u{f681}"
        case .minusBold: return "\u{f682}"
        case .minusLight: return "\u{f683}"
        case .minusRegular: return "\u{f684}"
        case .mirrorBold: return "\u{f685}"
        case .mirrorFilled: return "\u{f686}"
        case .mirrorLight: return "\u{f687}"
        case .mirrorRegular: return "\u{f688}"
        case .moderatorBold: return "\u{f689}"
        case .moderatorLight: return "\u{f68a}"
        case .moderatorRegular: return "\u{f68b}"
        case .monitoringBold: return "\u{f68c}"
        case .monitoringLight: return "\u{f68d}"
        case .monitoringRegular: return "\u{f68e}"
        case .monthlyRecurringScheduleNodeBold: return "\u{f68f}"
        case .monthlyRecurringScheduleNodeLight: return "\u{f690}"
        case .monthlyRecurringScheduleNodeRegular: return "\u{f691}"
        case .moreAdrBold: return "\u{f692}"
        case .moreAdrLight: return "\u{f693}"
        case .moreAdrRegular: return "\u{f694}"
        case .moreBold: return "\u{f695}"
        case .moreCircleBold: return "\u{f696}"
        case .moreCircleFilled: return "\u{f697}"
        case .moreCircleLight: return "\u{f698}"
        case .moreCircleRegular: return "\u{f699}"
        case .moreCirecleFilled: return "\u{f69a}"
        case .moreLight: return "\u{f69b}"
        case .moreRegular: return "\u{f69c}"
        case .mouseCursorBold: return "\u{f69d}"
        case .mouseCursorLight: return "\u{f69e}"
        case .mouseCursorRegular: return "\u{f69f}"
        case .moveCallInAdrBold: return "\u{f6a0}"
        case .moveCallInAdrLight: return "\u{f6a1}"
        case .moveCallInAdrRegular: return "\u{f6a2}"
        case .moveCallInIphBold: return "\u{f6a3}"
        case .moveCallInIphLight: return "\u{f6a4}"
        case .moveCallInIphRegular: return "\u{f6a5}"
        case .moveCallInLaptopBold: return "\u{f6a6}"
        case .moveCallInLaptopLight: return "\u{f6a7}"
        case .moveCallInLaptopRegular: return "\u{f6a8}"
        case .moveCallInOutAdrBold: return "\u{f6a9}"
        case .moveCallInOutAdrLight: return "\u{f6aa}"
        case .moveCallInOutAdrRegular: return "\u{f6ab}"
        case .moveCallInOutIphBold: return "\u{f6ac}"
        case .moveCallInOutIphLight: return "\u{f6ad}"
        case .moveCallInOutIphRegular: return "\u{f6ae}"
        case .moveCallInTabletBold: return "\u{f6af}"
        case .moveCallInTabletLight: return "\u{f6b0}"
        case .moveCallInTabletRegular: return "\u{f6b1}"
        case .moveCallOutAdrBold: return "\u{f6b2}"
        case .moveCallOutAdrLight: return "\u{f6b3}"
        case .moveCallOutAdrRegular: return "\u{f6b4}"
        case .moveCallOutIphBold: return "\u{f6b5}"
        case .moveCallOutIphLight: return "\u{f6b6}"
        case .moveCallOutIphRegular: return "\u{f6b7}"
        case .moveCallOutLaptopBold: return "\u{f6b8}"
        case .moveCallOutLaptopLight: return "\u{f6b9}"
        case .moveCallOutLaptopRegular: return "\u{f6ba}"
        case .moveCallOutTabletBold: return "\u{f6bb}"
        case .moveCallOutTabletLight: return "\u{f6bc}"
        case .moveCallOutTabletRegular: return "\u{f6bd}"
        case .msTeams: return "\u{f6be}"
        case .multilineChartBold: return "\u{f6bf}"
        case .multilineChartFilled: return "\u{f6c0}"
        case .multilineChartLight: return "\u{f6c1}"
        case .multilineChartRegular: return "\u{f6c2}"
        case .multimediaBold: return "\u{f6c3}"
        case .multimediaFilled: return "\u{f6c4}"
        case .multimediaLight: return "\u{f6c5}"
        case .multimediaRegular: return "\u{f6c6}"
        case .multipledDevicesBold: return "\u{f6c7}"
        case .multipledDevicesLight: return "\u{f6c8}"
        case .multipledDevicesRegular: return "\u{f6c9}"
        case .musicModeBold: return "\u{f6ca}"
        case .musicModeCircleBold: return "\u{f6cb}"
        case .musicModeCircleFilled: return "\u{f6cc}"
        case .musicModeCircleLight: return "\u{f6cd}"
        case .musicModeCircleRegular: return "\u{f6ce}"
        case .musicModeFilled: return "\u{f6cf}"
        case .musicModeLight: return "\u{f6d0}"
        case .musicModeRegular: return "\u{f6d1}"
        case .muteOnEntryBold: return "\u{f6d2}"
        case .muteOnEntryFilled: return "\u{f6d3}"
        case .muteOnEntryLight: return "\u{f6d4}"
        case .muteOnEntryRegular: return "\u{f6d5}"
        case .newManagerBold: return "\u{f6d6}"
        case .newManagerLight: return "\u{f6d7}"
        case .newManagerRegular: return "\u{f6d8}"
        case .newTitleBold: return "\u{f6d9}"
        case .newTitleLight: return "\u{f6da}"
        case .newTitleRegular: return "\u{f6db}"
        case .newVoicemailBold: return "\u{f6dc}"
        case .newVoicemailLight: return "\u{f6dd}"
        case .newVoicemailRegular: return "\u{f6de}"
        case .newWhiteboardBold: return "\u{f6df}"
        case .newWhiteboardLight: return "\u{f6e0}"
        case .newWhiteboardRegular: return "\u{f6e1}"
        case .nextBold: return "\u{f6e2}"
        case .nextLight: return "\u{f6e3}"
        case .nextRegular: return "\u{f6e4}"
        case .noDevicesBold: return "\u{f6e5}"
        case .noDevicesLight: return "\u{f6e6}"
        case .noDevicesRegular: return "\u{f6e7}"
        case .noiseDetectedCanceledFilled: return "\u{f6e8}"
        case .noiseDetectedFilled: return "\u{f6e9}"
        case .noiseNoneCanceledFilled: return "\u{f6ea}"
        case .noiseNoneFilled: return "\u{f6eb}"
        case .noiseRemovalBold: return "\u{f6ec}"
        case .noiseRemovalLight: return "\u{f6ed}"
        case .noiseRemovalRegular: return "\u{f6ee}"
        case .noteBold: return "\u{f6ef}"
        case .noteLight: return "\u{f6f0}"
        case .notePptBold: return "\u{f6f1}"
        case .notePptLight: return "\u{f6f2}"
        case .notePptRegular: return "\u{f6f3}"
        case .noteRegular: return "\u{f6f4}"
        case .notesBold: return "\u{f6f5}"
        case .notesLight: return "\u{f6f6}"
        case .notesRegular: return "\u{f6f7}"
        case .numberBold: return "\u{f6f8}"
        case .numberLight: return "\u{f6f9}"
        case .numberRegular: return "\u{f6fa}"
        case .oldRemoteBold: return "\u{f6fb}"
        case .oldRemoteLight: return "\u{f6fc}"
        case .oldRemoteRegular: return "\u{f6fd}"
        case .oldTouchBold: return "\u{f6fe}"
        case .oldTouchLight: return "\u{f6ff}"
        case .oldTouchRegular: return "\u{f700}"
        case .oneColumnBold: return "\u{f701}"
        case .oneColumnLight: return "\u{f702}"
        case .oneColumnRegular: return "\u{f703}"
        case .openInFolderBold: return "\u{f704}"
        case .openInFolderLight: return "\u{f705}"
        case .openInFolderRegular: return "\u{f706}"
        case .openPagesBold: return "\u{f707}"
        case .openPagesLight: return "\u{f708}"
        case .openPagesRegular: return "\u{f709}"
        case .otherNumberBold: return "\u{f70a}"
        case .otherNumberLight: return "\u{f70b}"
        case .otherNumberRegular: return "\u{f70c}"
        case .otherNumberWarningBold: return "\u{f70d}"
        case .otherNumberWarningLight: return "\u{f70e}"
        case .otherNumberWarningRegular: return "\u{f70f}"
        case .outgoingCallLegacyBold: return "\u{f710}"
        case .outgoingCallLegacyLight: return "\u{f711}"
        case .outgoingCallLegacyRegular: return "\u{f712}"
        case .overflowLeftBold: return "\u{f713}"
        case .overflowLeftLight: return "\u{f714}"
        case .overflowLeftRegular: return "\u{f715}"
        case .overflowRightBold: return "\u{f716}"
        case .overflowRightLight: return "\u{f717}"
        case .overflowRightRegular: return "\u{f718}"
        case .pairedCameraBold: return "\u{f719}"
        case .pairedCameraLight: return "\u{f71a}"
        case .pairedCameraRegular: return "\u{f71b}"
        case .pairedDeviceBold: return "\u{f71c}"
        case .pairedDeviceLight: return "\u{f71d}"
        case .pairedDeviceRegular: return "\u{f71e}"
        case .pairedHandsetBold: return "\u{f71f}"
        case .pairedHandsetLight: return "\u{f720}"
        case .pairedHandsetRegular: return "\u{f721}"
        case .pairingBold: return "\u{f722}"
        case .pairingLight: return "\u{f723}"
        case .pairingRegular: return "\u{f724}"
        case .parkedBold: return "\u{f725}"
        case .parkedFilled: return "\u{f726}"
        case .parkedLight: return "\u{f727}"
        case .parkedRegular: return "\u{f728}"
        case .parseBold: return "\u{f729}"
        case .parseLight: return "\u{f72a}"
        case .parseRegular: return "\u{f72b}"
        case .partialBold: return "\u{f72c}"
        case .partialLight: return "\u{f72d}"
        case .partialRegular: return "\u{f72e}"
        case .participantAddBold: return "\u{f72f}"
        case .participantAddLight: return "\u{f730}"
        case .participantAddRegular: return "\u{f731}"
        case .participantBlockedBold: return "\u{f732}"
        case .participantBlockedLight: return "\u{f733}"
        case .participantBlockedRegular: return "\u{f734}"
        case .participantBold: return "\u{f735}"
        case .participantFilled: return "\u{f736}"
        case .participantLight: return "\u{f737}"
        case .participantListBold: return "\u{f738}"
        case .participantListFilled: return "\u{f739}"
        case .participantListLight: return "\u{f73a}"
        case .participantListRegular: return "\u{f73b}"
        case .participantRegular: return "\u{f73c}"
        case .participantRemoveBold: return "\u{f73d}"
        case .participantRemoveLight: return "\u{f73e}"
        case .participantRemoveRegular: return "\u{f73f}"
        case .participantUnknownBold: return "\u{f740}"
        case .participantUnknownLight: return "\u{f741}"
        case .participantUnknownRegular: return "\u{f742}"
        case .passMouseBold: return "\u{f743}"
        case .passMouseLight: return "\u{f744}"
        case .passMouseRegular: return "\u{f745}"
        case .pauseBold: return "\u{f746}"
        case .pauseFilled: return "\u{f747}"
        case .pauseLight: return "\u{f748}"
        case .pauseRegular: return "\u{f749}"
        case .penBold: return "\u{f74a}"
        case .penFilled: return "\u{f74b}"
        case .penLight: return "\u{f74c}"
        case .penRegular: return "\u{f74d}"
        case .peopleBold: return "\u{f74e}"
        case .peopleCircleBold: return "\u{f74f}"
        case .peopleCircleFilled: return "\u{f750}"
        case .peopleCircleLight: return "\u{f751}"
        case .peopleCircleRegular: return "\u{f752}"
        case .peopleFilled: return "\u{f753}"
        case .peopleInsightsFilled: return "\u{f754}"
        case .peopleLight: return "\u{f755}"
        case .peopleRegular: return "\u{f756}"
        case .phoneAlertBold: return "\u{f757}"
        case .phoneAlertLight: return "\u{f758}"
        case .phoneAlertRegular: return "\u{f759}"
        case .phoneBold: return "\u{f75a}"
        case .phoneFilled: return "\u{f75b}"
        case .phoneLight: return "\u{f75c}"
        case .phoneMutedBold: return "\u{f75d}"
        case .phoneMutedLight: return "\u{f75e}"
        case .phoneMutedRegular: return "\u{f75f}"
        case .phonePrivateBold: return "\u{f760}"
        case .phonePrivateLight: return "\u{f761}"
        case .phonePrivateRegular: return "\u{f762}"
        case .phoneRegular: return "\u{f763}"
        case .phoneReplyAllBold: return "\u{f764}"
        case .phoneReplyAllLight: return "\u{f765}"
        case .phoneReplyAllRegular: return "\u{f766}"
        case .phoneReplyBold: return "\u{f767}"
        case .phoneReplyLight: return "\u{f768}"
        case .phoneReplyRegular: return "\u{f769}"
        case .phoneSmallFilled: return "\u{f76a}"
        case .pickerBold: return "\u{f76b}"
        case .pickerLight: return "\u{f76c}"
        case .pickerRegular: return "\u{f76d}"
        case .pictureInPictureBold: return "\u{f76e}"
        case .pictureInPictureFilled: return "\u{f76f}"
        case .pictureInPictureLight: return "\u{f770}"
        case .pictureInPictureRegular: return "\u{f771}"
        case .pieChartBold: return "\u{f772}"
        case .pieChartFilled: return "\u{f773}"
        case .pieChartLight: return "\u{f774}"
        case .pieChartRegular: return "\u{f775}"
        case .pinBold: return "\u{f776}"
        case .pinFilled: return "\u{f777}"
        case .pinLight: return "\u{f778}"
        case .pinListActivityBold: return "\u{f779}"
        case .pinListActivityColoredBold: return "\u{f77a}"
        case .pinListActivityColoredLight: return "\u{f77b}"
        case .pinListActivityColoredRegular: return "\u{f77c}"
        case .pinListActivityLight: return "\u{f77d}"
        case .pinListActivityRegular: return "\u{f77e}"
        case .pinListBold: return "\u{f77f}"
        case .pinListLight: return "\u{f780}"
        case .pinListRegular: return "\u{f781}"
        case .pinMutedBold: return "\u{f782}"
        case .pinMutedFilled: return "\u{f783}"
        case .pinMutedLight: return "\u{f784}"
        case .pinMutedRegular: return "\u{f785}"
        case .pinRegular: return "\u{f786}"
        case .placeholderBold: return "\u{f787}"
        case .placeholderLight: return "\u{f788}"
        case .placeholderRegular: return "\u{f789}"
        case .playBold: return "\u{f78a}"
        case .playCircleBold: return "\u{f78b}"
        case .playCircleFilled: return "\u{f78c}"
        case .playCircleLight: return "\u{f78d}"
        case .playCircleRegular: return "\u{f78e}"
        case .playFilled: return "\u{f78f}"
        case .playLight: return "\u{f790}"
        case .playRegular: return "\u{f791}"
        case .plugAcBold: return "\u{f792}"
        case .plugAcLight: return "\u{f793}"
        case .plugAcRegular: return "\u{f794}"
        case .plusBold: return "\u{f795}"
        case .plusCircleBold: return "\u{f796}"
        case .plusCircleFilled: return "\u{f797}"
        case .plusCircleLight: return "\u{f798}"
        case .plusCircleRegular: return "\u{f799}"
        case .plusLight: return "\u{f79a}"
        case .plusRegular: return "\u{f79b}"
        case .pmrBold: return "\u{f79c}"
        case .pmrFilled: return "\u{f79d}"
        case .pmrLight: return "\u{f79e}"
        case .pmrRegular: return "\u{f79f}"
        case .pollBold: return "\u{f7a0}"
        case .pollLight: return "\u{f7a1}"
        case .pollRegular: return "\u{f7a2}"
        case .popInBold: return "\u{f7a3}"
        case .popInLight: return "\u{f7a4}"
        case .popInRegular: return "\u{f7a5}"
        case .popOutBold: return "\u{f7a6}"
        case .popOutLight: return "\u{f7a7}"
        case .popOutRegular: return "\u{f7a8}"
        case .popUpBold: return "\u{f7a9}"
        case .popUpLight: return "\u{f7aa}"
        case .popUpRegular: return "\u{f7ab}"
        case .portraitLandscapeBold: return "\u{f7ac}"
        case .portraitLandscapeLight: return "\u{f7ad}"
        case .portraitLandscapeRegular: return "\u{f7ae}"
        case .powerAcBold: return "\u{f7af}"
        case .powerAcLight: return "\u{f7b0}"
        case .powerAcRegular: return "\u{f7b1}"
        case .powerBold: return "\u{f7b2}"
        case .powerLight: return "\u{f7b3}"
        case .powerRegular: return "\u{f7b4}"
        case .preHeaderBold: return "\u{f7b5}"
        case .preHeaderLight: return "\u{f7b6}"
        case .preHeaderRegular: return "\u{f7b7}"
        case .presentationBold: return "\u{f7b8}"
        case .presentationLight: return "\u{f7b9}"
        case .presentationRegular: return "\u{f7ba}"
        case .primaryParticipantBold: return "\u{f7bb}"
        case .primaryParticipantLight: return "\u{f7bc}"
        case .primaryParticipantRegular: return "\u{f7bd}"
        case .printBold: return "\u{f7be}"
        case .printLight: return "\u{f7bf}"
        case .printRegular: return "\u{f7c0}"
        case .priorityBadgeFilled: return "\u{f7c1}"
        case .priorityCircleBold: return "\u{f7c2}"
        case .priorityCircleFilled: return "\u{f7c3}"
        case .priorityCircleLight: return "\u{f7c4}"
        case .priorityCircleRegular: return "\u{f7c5}"
        case .priorityCircleTwoBold: return "\u{f7c6}"
        case .priorityCircleTwoFilled: return "\u{f7c7}"
        case .priorityCircleTwoLight: return "\u{f7c8}"
        case .priorityCircleTwoRegular: return "\u{f7c9}"
        case .privacyCircleBold: return "\u{f7ca}"
        case .privacyCircleFilled: return "\u{f7cb}"
        case .privacyCircleLight: return "\u{f7cc}"
        case .privacyCircleRegular: return "\u{f7cd}"
        case .privateBold: return "\u{f7ce}"
        case .privateCircleBold: return "\u{f7cf}"
        case .privateCircleFilled: return "\u{f7d0}"
        case .privateCircleLight: return "\u{f7d1}"
        case .privateCircleRegular: return "\u{f7d2}"
        case .privateLight: return "\u{f7d3}"
        case .privateMeetingBold: return "\u{f7d4}"
        case .privateMeetingLight: return "\u{f7d5}"
        case .privateMeetingRegular: return "\u{f7d6}"
        case .privateRegular: return "\u{f7d7}"
        case .productDemoBold: return "\u{f7d8}"
        case .productDemoLight: return "\u{f7d9}"
        case .productDemoRegular: return "\u{f7da}"
        case .proximityBold: return "\u{f7db}"
        case .proximityLight: return "\u{f7dc}"
        case .proximityMutedBold: return "\u{f7dd}"
        case .proximityMutedLight: return "\u{f7de}"
        case .proximityMutedRegular: return "\u{f7df}"
        case .proximityRegular: return "\u{f7e0}"
        case .proximityVideoBold: return "\u{f7e1}"
        case .proximityVideoLight: return "\u{f7e2}"
        case .proximityVideoRegular: return "\u{f7e3}"
        case .ptoPresenceBold: return "\u{f7e4}"
        case .ptoPresenceFilled: return "\u{f7e5}"
        case .ptoPresenceLight: return "\u{f7e6}"
        case .ptoPresenceRegular: return "\u{f7e7}"
        case .pullCallBold: return "\u{f7e8}"
        case .pullCallLight: return "\u{f7e9}"
        case .pullCallRegular: return "\u{f7ea}"
        case .qABold: return "\u{f7eb}"
        case .qALight: return "\u{f7ec}"
        case .qARegular: return "\u{f7ed}"
        case .qualityBold: return "\u{f7ee}"
        case .qualityLight: return "\u{f7ef}"
        case .qualityRegular: return "\u{f7f0}"
        case .queueContactBold: return "\u{f7f1}"
        case .queueContactLight: return "\u{f7f2}"
        case .queueContactRegular: return "\u{f7f3}"
        case .quietBold: return "\u{f7f4}"
        case .quietHoursPresenceBold: return "\u{f7f5}"
        case .quietHoursPresenceFilled: return "\u{f7f6}"
        case .quietHoursPresenceLight: return "\u{f7f7}"
        case .quietHoursPresenceRegular: return "\u{f7f8}"
        case .quietLight: return "\u{f7f9}"
        case .quietRegular: return "\u{f7fa}"
        case .radioButtonGroupBold: return "\u{f7fb}"
        case .radioButtonGroupLight: return "\u{f7fc}"
        case .radioButtonGroupRegular: return "\u{f7fd}"
        case .raiseHandBold: return "\u{f7fe}"
        case .raiseHandFilled: return "\u{f7ff}"
        case .raiseHandLight: return "\u{f800}"
        case .raiseHandRegular: return "\u{f801}"
        case .ramBold: return "\u{f802}"
        case .ramLight: return "\u{f803}"
        case .ramRegular: return "\u{f804}"
        case .reactionsBold: return "\u{f805}"
        case .reactionsFilled: return "\u{f806}"
        case .reactionsLight: return "\u{f807}"
        case .reactionsRegular: return "\u{f808}"
        case .reactivateBold: return "\u{f809}"
        case .reactivateLight: return "\u{f80a}"
        case .reactivateRegular: return "\u{f80b}"
        case .recentsBold: return "\u{f80c}"
        case .recentsFilled: return "\u{f80d}"
        case .recentsLight: return "\u{f80e}"
        case .recentsPresenceBold: return "\u{f80f}"
        case .recentsPresenceFilled: return "\u{f810}"
        case .recentsPresenceLight: return "\u{f811}"
        case .recentsPresenceRegular: return "\u{f812}"
        case .recentsPresenceSmallFilled: return "\u{f813}"
        case .recentsRegular: return "\u{f814}"
        case .recordActiveBold: return "\u{f815}"
        case .recordActiveFilled: return "\u{f816}"
        case .recordActiveLight: return "\u{f817}"
        case .recordActiveRegular: return "\u{f818}"
        case .recordBold: return "\u{f819}"
        case .recordFilled: return "\u{f81a}"
        case .recordLight: return "\u{f81b}"
        case .recordPausedBold: return "\u{f81c}"
        case .recordPausedFilled: return "\u{f81d}"
        case .recordPausedLight: return "\u{f81e}"
        case .recordPausedRegular: return "\u{f81f}"
        case .recordRegular: return "\u{f820}"
        case .recurringBold: return "\u{f821}"
        case .recurringLight: return "\u{f822}"
        case .recurringOffBold: return "\u{f823}"
        case .recurringOffLight: return "\u{f824}"
        case .recurringOffRegular: return "\u{f825}"
        case .recurringRegular: return "\u{f826}"
        case .redialBold: return "\u{f827}"
        case .redialLight: return "\u{f828}"
        case .redialRegular: return "\u{f829}"
        case .redoBold: return "\u{f82a}"
        case .redoLight: return "\u{f82b}"
        case .redoRegular: return "\u{f82c}"
        case .refreshBold: return "\u{f82d}"
        case .refreshLight: return "\u{f82e}"
        case .refreshRegular: return "\u{f82f}"
        case .remoteCallBold: return "\u{f830}"
        case .remoteCallFilled: return "\u{f831}"
        case .remoteCallLight: return "\u{f832}"
        case .remoteCallRegular: return "\u{f833}"
        case .remoteDesktopControlBold: return "\u{f834}"
        case .remoteDesktopControlFilled: return "\u{f835}"
        case .remoteDesktopControlLight: return "\u{f836}"
        case .remoteDesktopControlRegular: return "\u{f837}"
        case .removeBold: return "\u{f838}"
        case .removeFilled: return "\u{f839}"
        case .removeLight: return "\u{f83a}"
        case .removeRegular: return "\u{f83b}"
        case .replyBold: return "\u{f83c}"
        case .replyFilled: return "\u{f83d}"
        case .replyLight: return "\u{f83e}"
        case .replyListBold: return "\u{f83f}"
        case .replyListLight: return "\u{f840}"
        case .replyListRegular: return "\u{f841}"
        case .replyPrivatelyBold: return "\u{f842}"
        case .replyPrivatelyLight: return "\u{f843}"
        case .replyPrivatelyRegular: return "\u{f844}"
        case .replyRegular: return "\u{f845}"
        case .resetBold: return "\u{f846}"
        case .resetLight: return "\u{f847}"
        case .resetRegular: return "\u{f848}"
        case .responsiveMobileBold: return "\u{f849}"
        case .responsiveMobileLight: return "\u{f84a}"
        case .responsiveMobileRegular: return "\u{f84b}"
        case .restartBold: return "\u{f84c}"
        case .restartLight: return "\u{f84d}"
        case .restartRegular: return "\u{f84e}"
        case .retrieveCallBold: return "\u{f84f}"
        case .retrieveCallLight: return "\u{f850}"
        case .retrieveCallRegular: return "\u{f851}"
        case .returnBold: return "\u{f852}"
        case .returnLight: return "\u{f853}"
        case .returnRegular: return "\u{f854}"
        case .ringtoneBold: return "\u{f855}"
        case .ringtoneLight: return "\u{f856}"
        case .ringtoneRegular: return "\u{f857}"
        case .roomCalendarBold: return "\u{f858}"
        case .roomCalendarLight: return "\u{f859}"
        case .roomCalendarRegular: return "\u{f85a}"
        case .roomLightsBold: return "\u{f85b}"
        case .roomLightsFilled: return "\u{f85c}"
        case .roomLightsLight: return "\u{f85d}"
        case .roomLightsRegular: return "\u{f85e}"
        case .rotateContentBold: return "\u{f85f}"
        case .rotateContentFilled: return "\u{f860}"
        case .rotateContentLight: return "\u{f861}"
        case .rotateContentRegular: return "\u{f862}"
        case .ruleBasedBold: return "\u{f863}"
        case .ruleBasedLight: return "\u{f864}"
        case .ruleBasedRegular: return "\u{f865}"
        case .runningApplicationBold: return "\u{f866}"
        case .runningApplicationFilled: return "\u{f867}"
        case .runningApplicationLight: return "\u{f868}"
        case .runningApplicationRegular: return "\u{f869}"
        case .saveBold: return "\u{f86a}"
        case .saveLight: return "\u{f86b}"
        case .saveRegular: return "\u{f86c}"
        case .scanBold: return "\u{f86d}"
        case .scanLight: return "\u{f86e}"
        case .scanRegular: return "\u{f86f}"
        case .schedulerAvailableBold: return "\u{f870}"
        case .schedulerAvailableLight: return "\u{f871}"
        case .schedulerAvailableRegular: return "\u{f872}"
        case .schedulerNotWorkingHoursBold: return "\u{f873}"
        case .schedulerNotWorkingHoursLight: return "\u{f874}"
        case .schedulerNotWorkingHoursRegular: return "\u{f875}"
        case .schedulerUnavailableBold: return "\u{f876}"
        case .schedulerUnavailableLight: return "\u{f877}"
        case .schedulerUnavailableRegular: return "\u{f878}"
        case .schedulerUnknownBold: return "\u{f879}"
        case .schedulerUnknownLight: return "\u{f87a}"
        case .schedulerUnknownRegular: return "\u{f87b}"
        case .screenshotBold: return "\u{f87c}"
        case .screenshotDocBold: return "\u{f87d}"
        case .screenshotDocFilled: return "\u{f87e}"
        case .screenshotDocLight: return "\u{f87f}"
        case .screenshotDocRegular: return "\u{f880}"
        case .screenshotLight: return "\u{f881}"
        case .screenshotRegular: return "\u{f882}"
        case .searchBold: return "\u{f883}"
        case .searchFilled: return "\u{f884}"
        case .searchLight: return "\u{f885}"
        case .searchRegular: return "\u{f886}"
        case .secondaryArrowBold: return "\u{f887}"
        case .secondaryArrowLight: return "\u{f888}"
        case .secondaryArrowRegular: return "\u{f889}"
        case .secureCallLockBold: return "\u{f88a}"
        case .secureCallLockFilled: return "\u{f88b}"
        case .secureCallLockLight: return "\u{f88c}"
        case .secureCallLockRegular: return "\u{f88d}"
        case .secureCallShieldBold: return "\u{f88e}"
        case .secureCallShieldFilled: return "\u{f88f}"
        case .secureCallShieldLight: return "\u{f890}"
        case .secureCallShieldRegular: return "\u{f891}"
        case .secureCircleBold: return "\u{f892}"
        case .secureCircleFilled: return "\u{f893}"
        case .secureCircleLight: return "\u{f894}"
        case .secureCircleRegular: return "\u{f895}"
        case .secureLockBold: return "\u{f896}"
        case .secureLockFilled: return "\u{f897}"
        case .secureLockLight: return "\u{f898}"
        case .secureLockRegular: return "\u{f899}"
        case .selectAllBold: return "\u{f89a}"
        case .selectAllFilled: return "\u{f89b}"
        case .selectAllLight: return "\u{f89c}"
        case .selectAllRegular: return "\u{f89d}"
        case .selectionBold: return "\u{f89e}"
        case .selectionLight: return "\u{f89f}"
        case .selectionRegular: return "\u{f8a0}"
        case .sendBold: return "\u{f8a1}"
        case .sendFilled: return "\u{f8a2}"
        case .sendLight: return "\u{f8a3}"
        case .sendRegular: return "\u{f8a4}"
        case .serverBold: return "\u{f8a5}"
        case .serverErrorBold: return "\u{f8a6}"
        case .serverErrorLight: return "\u{f8a7}"
        case .serverErrorRegular: return "\u{f8a8}"
        case .serverLight: return "\u{f8a9}"
        case .serverRegular: return "\u{f8aa}"
        case .servicesBold: return "\u{f8ab}"
        case .servicesLight: return "\u{f8ac}"
        case .servicesRegular: return "\u{f8ad}"
        case .setVariableBold: return "\u{f8ae}"
        case .setVariableLight: return "\u{f8af}"
        case .setVariableRegular: return "\u{f8b0}"
        case .settingsBold: return "\u{f8b1}"
        case .settingsFilled: return "\u{f8b2}"
        case .settingsLight: return "\u{f8b3}"
        case .settingsRegular: return "\u{f8b4}"
        case .setupAssistantBold: return "\u{f8b5}"
        case .setupAssistantLight: return "\u{f8b6}"
        case .setupAssistantRegular: return "\u{f8b7}"
        case .sftpBold: return "\u{f8b8}"
        case .sftpLight: return "\u{f8b9}"
        case .sftpRegular: return "\u{f8ba}"
        case .shapeCircleBold: return "\u{f8bb}"
        case .shapeCircleFilled: return "\u{f8bc}"
        case .shapeCircleLight: return "\u{f8bd}"
        case .shapeCircleRegular: return "\u{f8be}"
        case .shapeDiagonalLineBold: return "\u{f8bf}"
        case .shapeDiagonalLineLight: return "\u{f8c0}"
        case .shapeDiagonalLineRegular: return "\u{f8c1}"
        case .shapeDiamondBold: return "\u{f8c2}"
        case .shapeDiamondFilled: return "\u{f8c3}"
        case .shapeDiamondLight: return "\u{f8c4}"
        case .shapeDiamondRegular: return "\u{f8c5}"
        case .shapeOvalBold: return "\u{f8c6}"
        case .shapeOvalLight: return "\u{f8c7}"
        case .shapeOvalRegular: return "\u{f8c8}"
        case .shapeSquareBold: return "\u{f8c9}"
        case .shapeSquareFilled: return "\u{f8ca}"
        case .shapeSquareLight: return "\u{f8cb}"
        case .shapeSquareRegular: return "\u{f8cc}"
        case .shapeTriangleBold: return "\u{f8cd}"
        case .shapeTriangleFilled: return "\u{f8ce}"
        case .shapeTriangleLight: return "\u{f8cf}"
        case .shapeTriangleRegular: return "\u{f8d0}"
        case .shapesBold: return "\u{f8d1}"
        case .shapesLight: return "\u{f8d2}"
        case .shapesRegular: return "\u{f8d3}"
        case .shareCNativeAdrBold: return "\u{f8d4}"
        case .shareCNativeAdrLight: return "\u{f8d5}"
        case .shareCNativeAdrRegular: return "\u{f8d6}"
        case .shareCNativeIphBold: return "\u{f8d7}"
        case .shareCNativeIphLight: return "\u{f8d8}"
        case .shareCNativeIphRegular: return "\u{f8d9}"
        case .shareScreenBold: return "\u{f8da}"
        case .shareScreenFilled: return "\u{f8db}"
        case .shareScreenLight: return "\u{f8dc}"
        case .shareScreenRegular: return "\u{f8dd}"
        case .shareScreenSmallFilled: return "\u{f8de}"
        case .shareSpaceBold: return "\u{f8df}"
        case .shareSpaceLight: return "\u{f8e0}"
        case .shareSpaceRegular: return "\u{f8e1}"
        case .shieldBold: return "\u{f8e2}"
        case .shieldLight: return "\u{f8e3}"
        case .shieldRegular: return "\u{f8e4}"
        case .shoppingCartBold: return "\u{f8e5}"
        case .shoppingCartFilled: return "\u{f8e6}"
        case .shoppingCartLight: return "\u{f8e7}"
        case .shoppingCartRegular: return "\u{f8e8}"
        case .shortTextBoxBold: return "\u{f8e9}"
        case .shortTextBoxLight: return "\u{f8ea}"
        case .shortTextBoxRegular: return "\u{f8eb}"
        case .showBold: return "\u{f8ec}"
        case .showFilled: return "\u{f8ed}"
        case .showLight: return "\u{f8ee}"
        case .showRegular: return "\u{f8ef}"
        case .signInBold: return "\u{f8f0}"
        case .signInFilled: return "\u{f8f1}"
        case .signInForcedBold: return "\u{f8f2}"
        case .signInForcedLight: return "\u{f8f3}"
        case .signInForcedRegular: return "\u{f8f4}"
        case .signInLight: return "\u{f8f5}"
        case .signInRegular: return "\u{f8f6}"
        case .signOutBold: return "\u{f8f7}"
        case .signOutLight: return "\u{f8f8}"
        case .signOutRegular: return "\u{f8f9}"
        case .signal0Bold: return "\u{f8fa}"
        case .signal0Light: return "\u{f8fb}"
        case .signal0Regular: return "\u{f8fc}"
        case .signal100Bold: return "\u{f8fd}"
        case .signal100Light: return "\u{f8fe}"
        case .signal100Regular: return "\u{f8ff}"
        case .signal25Bold: return "\u{f900}"
        case .signal25Light: return "\u{f901}"
        case .signal25Regular: return "\u{f902}"
        case .signal50Bold: return "\u{f903}"
        case .signal50Light: return "\u{f904}"
        case .signal50Regular: return "\u{f905}"
        case .signal75Bold: return "\u{f906}"
        case .signal75Light: return "\u{f907}"
        case .signal75Regular: return "\u{f908}"
        case .simplePromotionBold: return "\u{f909}"
        case .simplePromotionLight: return "\u{f90a}"
        case .simplePromotionRegular: return "\u{f90b}"
        case .singleNumberReachBold: return "\u{f90c}"
        case .singleNumberReachLight: return "\u{f90d}"
        case .singleNumberReachRegular: return "\u{f90e}"
        case .sipRegistrationInProgressBold: return "\u{f90f}"
        case .sipRegistrationInProgressFilled: return "\u{f910}"
        case .sipRegistrationInProgressLight: return "\u{f911}"
        case .sipRegistrationInProgressRegular: return "\u{f912}"
        case .skipBold: return "\u{f913}"
        case .skipBwBold: return "\u{f914}"
        case .skipBwFilled: return "\u{f915}"
        case .skipBwLight: return "\u{f916}"
        case .skipBwRegular: return "\u{f917}"
        case .skipFwBold: return "\u{f918}"
        case .skipFwFilled: return "\u{f919}"
        case .skipFwLight: return "\u{f91a}"
        case .skipFwRegular: return "\u{f91b}"
        case .skipLight: return "\u{f91c}"
        case .skipRegular: return "\u{f91d}"
        case .smsInboundBold: return "\u{f91e}"
        case .smsInboundLight: return "\u{f91f}"
        case .smsInboundRegular: return "\u{f920}"
        case .smsMessageBold: return "\u{f921}"
        case .smsMessageFilled: return "\u{f922}"
        case .smsMessageLight: return "\u{f923}"
        case .smsMessageRegular: return "\u{f924}"
        case .socialAlexaFilled: return "\u{f925}"
        case .socialFacebookColoredFilled: return "\u{f926}"
        case .socialFacebookFilled: return "\u{f927}"
        case .socialFbmessengerColoredFilled: return "\u{f928}"
        case .socialFbmessengerFilled: return "\u{f929}"
        case .socialInstagramBold: return "\u{f92a}"
        case .socialMicrosoftColoredFilled: return "\u{f92b}"
        case .socialMicrosoftFilled: return "\u{f92c}"
        case .socialMmsFilled: return "\u{f92d}"
        case .socialMmsGoldFilled: return "\u{f92e}"
        case .socialSmsFilled: return "\u{f92f}"
        case .socialSmsMintFilled: return "\u{f930}"
        case .socialTwitterColoredFilled: return "\u{f931}"
        case .socialTwitterFilled: return "\u{f932}"
        case .socialViberBold: return "\u{f933}"
        case .socialViberColoredBold: return "\u{f934}"
        case .socialWhatsappBold: return "\u{f935}"
        case .socialWhatsappColoredFilled: return "\u{f936}"
        case .sortAscendingBold: return "\u{f937}"
        case .sortAscendingLight: return "\u{f938}"
        case .sortAscendingRegular: return "\u{f939}"
        case .sortDescendingBold: return "\u{f93a}"
        case .sortDescendingLight: return "\u{f93b}"
        case .sortDescendingRegular: return "\u{f93c}"
        case .soundDefaultBold: return "\u{f93d}"
        case .soundDefaultLight: return "\u{f93e}"
        case .soundDefaultRegular: return "\u{f93f}"
        case .speakerBold: return "\u{f940}"
        case .speakerDisconnectedBold: return "\u{f941}"
        case .speakerDisconnectedFilled: return "\u{f942}"
        case .speakerDisconnectedLight: return "\u{f943}"
        case .speakerDisconnectedRegular: return "\u{f944}"
        case .speakerFilled: return "\u{f945}"
        case .speakerLight: return "\u{f946}"
        case .speakerMutedBold: return "\u{f947}"
        case .speakerMutedFilled: return "\u{f948}"
        case .speakerMutedLight: return "\u{f949}"
        case .speakerMutedRegular: return "\u{f94a}"
        case .speakerOffBold: return "\u{f94b}"
        case .speakerOffFilled: return "\u{f94c}"
        case .speakerOffLight: return "\u{f94d}"
        case .speakerOffRegular: return "\u{f94e}"
        case .speakerOnColoredBold: return "\u{f94f}"
        case .speakerOnColoredLight: return "\u{f950}"
        case .speakerOnColoredRegular: return "\u{f951}"
        case .speakerRegular: return "\u{f952}"
        case .speakerTurnDownBold: return "\u{f953}"
        case .speakerTurnDownFilled: return "\u{f954}"
        case .speakerTurnDownLight: return "\u{f955}"
        case .speakerTurnDownRegular: return "\u{f956}"
        case .speakerTurnUpBold: return "\u{f957}"
        case .speakerTurnUpFilled: return "\u{f958}"
        case .speakerTurnUpLight: return "\u{f959}"
        case .speakerTurnUpRegular: return "\u{f95a}"
        case .spinnerBold: return "\u{f95b}"
        case .spinnerFilledBold: return "\u{f95c}"
        case .spinnerFilledLight: return "\u{f95d}"
        case .spinnerFilledRegular: return "\u{f95e}"
        case .spinnerLight: return "\u{f95f}"
        case .spinnerPartialBold: return "\u{f960}"
        case .spinnerPartialLight: return "\u{f961}"
        case .spinnerPartialRegular: return "\u{f962}"
        case .spinnerRegular: return "\u{f963}"
        case .stackedArea100ChartBold: return "\u{f964}"
        case .stackedArea100ChartFilled: return "\u{f965}"
        case .stackedArea100ChartLight: return "\u{f966}"
        case .stackedArea100ChartRegular: return "\u{f967}"
        case .stackedAreaChartBold: return "\u{f968}"
        case .stackedAreaChartFilled: return "\u{f969}"
        case .stackedAreaChartLight: return "\u{f96a}"
        case .stackedAreaChartRegular: return "\u{f96b}"
        case .stackedBar100ChartBold: return "\u{f96c}"
        case .stackedBar100ChartFilled: return "\u{f96d}"
        case .stackedBar100ChartLight: return "\u{f96e}"
        case .stackedBar100ChartRegular: return "\u{f96f}"
        case .stackedBarChartBold: return "\u{f970}"
        case .stackedBarChartFilled: return "\u{f971}"
        case .stackedBarChartLight: return "\u{f972}"
        case .stackedBarChartRegular: return "\u{f973}"
        case .startChatBold: return "\u{f974}"
        case .startChatLight: return "\u{f975}"
        case .startChatRegular: return "\u{f976}"
        case .stethoscopeBold: return "\u{f977}"
        case .stethoscopeLight: return "\u{f978}"
        case .stethoscopeRegular: return "\u{f979}"
        case .stickersBold: return "\u{f97a}"
        case .stickersLight: return "\u{f97b}"
        case .stickersRegular: return "\u{f97c}"
        case .stickiesBold: return "\u{f97d}"
        case .stickiesLight: return "\u{f97e}"
        case .stickiesRegular: return "\u{f97f}"
        case .stopBold: return "\u{f980}"
        case .stopCircleBold: return "\u{f981}"
        case .stopCircleFilled: return "\u{f982}"
        case .stopCircleLight: return "\u{f983}"
        case .stopCircleRegular: return "\u{f984}"
        case .stopContentShareBold: return "\u{f985}"
        case .stopContentShareLight: return "\u{f986}"
        case .stopContentShareRegular: return "\u{f987}"
        case .stopFilled: return "\u{f988}"
        case .stopLight: return "\u{f989}"
        case .stopRegular: return "\u{f98a}"
        case .storedInfoBold: return "\u{f98b}"
        case .storedInfoFilled: return "\u{f98c}"
        case .storedInfoLight: return "\u{f98d}"
        case .storedInfoRegular: return "\u{f98e}"
        case .streamingBold: return "\u{f98f}"
        case .streamingLight: return "\u{f990}"
        case .streamingRegular: return "\u{f991}"
        case .strikethroughBold: return "\u{f992}"
        case .strikethroughLight: return "\u{f993}"
        case .strikethroughRegular: return "\u{f994}"
        case .subscriptBold: return "\u{f995}"
        case .subscriptLight: return "\u{f996}"
        case .subscriptRegular: return "\u{f997}"
        case .superscriptBold: return "\u{f998}"
        case .superscriptLight: return "\u{f999}"
        case .superscriptRegular: return "\u{f99a}"
        case .surveyBold: return "\u{f99b}"
        case .surveyFilled: return "\u{f99c}"
        case .surveyLight: return "\u{f99d}"
        case .surveyRegular: return "\u{f99e}"
        case .sx10Bold: return "\u{f99f}"
        case .sx10Light: return "\u{f9a0}"
        case .sx10Regular: return "\u{f9a1}"
        case .sx20Bold: return "\u{f9a2}"
        case .sx20Light: return "\u{f9a3}"
        case .sx20Regular: return "\u{f9a4}"
        case .sx80CodecBold: return "\u{f9a5}"
        case .sx80CodecLight: return "\u{f9a6}"
        case .sx80CodecRegular: return "\u{f9a7}"
        case .tableBold: return "\u{f9a8}"
        case .tableLight: return "\u{f9a9}"
        case .tableRegular: return "\u{f9aa}"
        case .tabletBold: return "\u{f9ab}"
        case .tabletLight: return "\u{f9ac}"
        case .tabletRegular: return "\u{f9ad}"
        case .tabsBold: return "\u{f9ae}"
        case .tabsLight: return "\u{f9af}"
        case .tabsRegular: return "\u{f9b0}"
        case .tagBold: return "\u{f9b1}"
        case .tagLight: return "\u{f9b2}"
        case .tagRegular: return "\u{f9b3}"
        case .tapBold: return "\u{f9b4}"
        case .tapFilled: return "\u{f9b5}"
        case .tapLight: return "\u{f9b6}"
        case .tapRegular: return "\u{f9b7}"
        case .telepresenceAlertBold: return "\u{f9b8}"
        case .telepresenceAlertLight: return "\u{f9b9}"
        case .telepresenceAlertMutedBold: return "\u{f9ba}"
        case .telepresenceAlertMutedLight: return "\u{f9bb}"
        case .telepresenceAlertMutedRegular: return "\u{f9bc}"
        case .telepresenceAlertRegular: return "\u{f9bd}"
        case .telepresenceBold: return "\u{f9be}"
        case .telepresenceIx5000Bold: return "\u{f9bf}"
        case .telepresenceIx5000Light: return "\u{f9c0}"
        case .telepresenceIx5000Regular: return "\u{f9c1}"
        case .telepresenceLight: return "\u{f9c2}"
        case .telepresencePrivateBold: return "\u{f9c3}"
        case .telepresencePrivateLight: return "\u{f9c4}"
        case .telepresencePrivateRegular: return "\u{f9c5}"
        case .telepresenceRegular: return "\u{f9c6}"
        case .temperatureBold: return "\u{f9c7}"
        case .temperatureLight: return "\u{f9c8}"
        case .temperatureRegular: return "\u{f9c9}"
        case .textAlignCenterBold: return "\u{f9ca}"
        case .textAlignCenterFilled: return "\u{f9cb}"
        case .textAlignCenterLight: return "\u{f9cc}"
        case .textAlignCenterRegular: return "\u{f9cd}"
        case .textAlignLeftBold: return "\u{f9ce}"
        case .textAlignLeftFilled: return "\u{f9cf}"
        case .textAlignLeftLight: return "\u{f9d0}"
        case .textAlignLeftRegular: return "\u{f9d1}"
        case .textAlignRightBold: return "\u{f9d2}"
        case .textAlignRightFilled: return "\u{f9d3}"
        case .textAlignRightLight: return "\u{f9d4}"
        case .textAlignRightRegular: return "\u{f9d5}"
        case .textBold: return "\u{f9d6}"
        case .textCodeBlockBold: return "\u{f9d7}"
        case .textCodeBlockLight: return "\u{f9d8}"
        case .textCodeBlockRegular: return "\u{f9d9}"
        case .textHighlightBold: return "\u{f9da}"
        case .textHighlightLight: return "\u{f9db}"
        case .textHighlightRegular: return "\u{f9dc}"
        case .textLight: return "\u{f9dd}"
        case .textRegular: return "\u{f9de}"
        case .threeColumnBold: return "\u{f9df}"
        case .threeColumnLight: return "\u{f9e0}"
        case .threeColumnRegular: return "\u{f9e1}"
        case .threeDObjectBold: return "\u{f9e2}"
        case .threeDObjectLight: return "\u{f9e3}"
        case .threeDObjectRegular: return "\u{f9e4}"
        case .tooFastBold: return "\u{f9e5}"
        case .tooFastLight: return "\u{f9e6}"
        case .tooFastRegular: return "\u{f9e7}"
        case .tooSlowBold: return "\u{f9e8}"
        case .tooSlowLight: return "\u{f9e9}"
        case .tooSlowRegular: return "\u{f9ea}"
        case .toolsBold: return "\u{f9eb}"
        case .toolsLight: return "\u{f9ec}"
        case .toolsRegular: return "\u{f9ed}"
        case .touch10Bold: return "\u{f9ee}"
        case .touch10Light: return "\u{f9ef}"
        case .touch10Regular: return "\u{f9f0}"
        case .transcriptBold: return "\u{f9f1}"
        case .transcriptFilled: return "\u{f9f2}"
        case .transcriptLight: return "\u{f9f3}"
        case .transcriptRegular: return "\u{f9f4}"
        case .translateBold: return "\u{f9f5}"
        case .translateLight: return "\u{f9f6}"
        case .translateRegular: return "\u{f9f7}"
        case .trimBold: return "\u{f9f8}"
        case .trimLight: return "\u{f9f9}"
        case .trimRegular: return "\u{f9fa}"
        case .twoColumnBold: return "\u{f9fb}"
        case .twoColumnLight: return "\u{f9fc}"
        case .twoColumnRegular: return "\u{f9fd}"
        case .ucmCloudBold: return "\u{f9fe}"
        case .ucmCloudLight: return "\u{f9ff}"
        case .ucmCloudRegular: return "\u{fa00}"
        case .underlineBold: return "\u{fa01}"
        case .underlineLight: return "\u{fa02}"
        case .underlineRegular: return "\u{fa03}"
        case .undoBold: return "\u{fa04}"
        case .undoLight: return "\u{fa05}"
        case .undoRegular: return "\u{fa06}"
        case .unlinkBold: return "\u{fa07}"
        case .unlinkLight: return "\u{fa08}"
        case .unlinkRegular: return "\u{fa09}"
        case .unreadBold: return "\u{fa0a}"
        case .unreadFilled: return "\u{fa0b}"
        case .unreadLight: return "\u{fa0c}"
        case .unreadRegular: return "\u{fa0d}"
        case .unsecureUnlockedBold: return "\u{fa0e}"
        case .unsecureUnlockedFilled: return "\u{fa0f}"
        case .unsecureUnlockedLight: return "\u{fa10}"
        case .unsecureUnlockedRegular: return "\u{fa11}"
        case .unsortedBold: return "\u{fa12}"
        case .unsortedLight: return "\u{fa13}"
        case .unsortedRegular: return "\u{fa14}"
        case .updateFileShareBold: return "\u{fa15}"
        case .updateFileShareLight: return "\u{fa16}"
        case .updateFileShareRegular: return "\u{fa17}"
        case .upgradeBold: return "\u{fa18}"
        case .upgradeFilled: return "\u{fa19}"
        case .upgradeLight: return "\u{fa1a}"
        case .upgradeRegular: return "\u{fa1b}"
        case .uploadBold: return "\u{fa1c}"
        case .uploadLight: return "\u{fa1d}"
        case .uploadRegular: return "\u{fa1e}"
        case .urgentVoicemailBold: return "\u{fa1f}"
        case .urgentVoicemailFilled: return "\u{fa20}"
        case .usbBold: return "\u{fa21}"
        case .usbHeadsetBold: return "\u{fa22}"
        case .usbHeadsetLight: return "\u{fa23}"
        case .usbHeadsetMutedBold: return "\u{fa24}"
        case .usbHeadsetMutedLight: return "\u{fa25}"
        case .usbHeadsetMutedRegular: return "\u{fa26}"
        case .usbHeadsetRegular: return "\u{fa27}"
        case .usbLight: return "\u{fa28}"
        case .usbRegular: return "\u{fa29}"
        case .userBold: return "\u{fa2a}"
        case .userDeactivateBold: return "\u{fa2b}"
        case .userDeactivateLight: return "\u{fa2c}"
        case .userDeactivateRegular: return "\u{fa2d}"
        case .userLight: return "\u{fa2e}"
        case .userRegular: return "\u{fa2f}"
        case .vcsBold: return "\u{fa30}"
        case .vcsLight: return "\u{fa31}"
        case .vcsRegular: return "\u{fa32}"
        case .videoBlurBold: return "\u{fa33}"
        case .videoBlurFilled: return "\u{fa34}"
        case .videoBlurLight: return "\u{fa35}"
        case .videoBlurRegular: return "\u{fa36}"
        case .videoBold: return "\u{fa37}"
        case .videoEffectBold: return "\u{fa38}"
        case .videoEffectFilled: return "\u{fa39}"
        case .videoEffectLight: return "\u{fa3a}"
        case .videoEffectRegular: return "\u{fa3b}"
        case .videoFilled: return "\u{fa3c}"
        case .videoLayoutBold: return "\u{fa3d}"
        case .videoLayoutEqualBold: return "\u{fa3e}"
        case .videoLayoutEqualDualBold: return "\u{fa3f}"
        case .videoLayoutEqualDualLight: return "\u{fa40}"
        case .videoLayoutEqualDualRegular: return "\u{fa41}"
        case .videoLayoutEqualFilled: return "\u{fa42}"
        case .videoLayoutEqualLight: return "\u{fa43}"
        case .videoLayoutEqualRegular: return "\u{fa44}"
        case .videoLayoutFilled: return "\u{fa45}"
        case .videoLayoutLight: return "\u{fa46}"
        case .videoLayoutOverlayBold: return "\u{fa47}"
        case .videoLayoutOverlayLight: return "\u{fa48}"
        case .videoLayoutOverlayRegular: return "\u{fa49}"
        case .videoLayoutPresenterDominantBold: return "\u{fa4a}"
        case .videoLayoutPresenterDominantLight: return "\u{fa4b}"
        case .videoLayoutPresenterDominantRegular: return "\u{fa4c}"
        case .videoLayoutProminentBold: return "\u{fa4d}"
        case .videoLayoutProminentFilled: return "\u{fa4e}"
        case .videoLayoutProminentLight: return "\u{fa4f}"
        case .videoLayoutProminentRegular: return "\u{fa50}"
        case .videoLayoutRegular: return "\u{fa51}"
        case .videoLayoutShareDominantBold: return "\u{fa52}"
        case .videoLayoutShareDominantLight: return "\u{fa53}"
        case .videoLayoutShareDominantRegular: return "\u{fa54}"
        case .videoLayoutSingleBold: return "\u{fa55}"
        case .videoLayoutSingleFilled: return "\u{fa56}"
        case .videoLayoutSingleLight: return "\u{fa57}"
        case .videoLayoutSingleRegular: return "\u{fa58}"
        case .videoLayoutStackBold: return "\u{fa59}"
        case .videoLayoutStackFilled: return "\u{fa5a}"
        case .videoLayoutStackLight: return "\u{fa5b}"
        case .videoLayoutStackRegular: return "\u{fa5c}"
        case .videoLayoutVideoDominantBold: return "\u{fa5d}"
        case .videoLayoutVideoDominantLight: return "\u{fa5e}"
        case .videoLayoutVideoDominantRegular: return "\u{fa5f}"
        case .videoLight: return "\u{fa60}"
        case .videoPlusBold: return "\u{fa61}"
        case .videoPlusFilled: return "\u{fa62}"
        case .videoPlusLight: return "\u{fa63}"
        case .videoPlusRegular: return "\u{fa64}"
        case .videoRegular: return "\u{fa65}"
        case .videoSpeakerTrackBold: return "\u{fa66}"
        case .videoSpeakerTrackFilled: return "\u{fa67}"
        case .videoSpeakerTrackLight: return "\u{fa68}"
        case .videoSpeakerTrackRegular: return "\u{fa69}"
        case .viewAllBold: return "\u{fa6a}"
        case .viewAllLight: return "\u{fa6b}"
        case .viewAllRegular: return "\u{fa6c}"
        case .viewListBold: return "\u{fa6d}"
        case .viewListLight: return "\u{fa6e}"
        case .viewListRegular: return "\u{fa6f}"
        case .viewStackedBold: return "\u{fa70}"
        case .viewStackedFilled: return "\u{fa71}"
        case .viewStackedLight: return "\u{fa72}"
        case .viewStackedRegular: return "\u{fa73}"
        case .viewThumbnailBold: return "\u{fa74}"
        case .viewThumbnailFilled: return "\u{fa75}"
        case .viewThumbnailLight: return "\u{fa76}"
        case .viewThumbnailRegular: return "\u{fa77}"
        case .voicemailBold: return "\u{fa78}"
        case .voicemailFilled: return "\u{fa79}"
        case .voicemailLight: return "\u{fa7a}"
        case .voicemailRegular: return "\u{fa7b}"
        case .waffleMenuBold: return "\u{fa7c}"
        case .waffleMenuLight: return "\u{fa7d}"
        case .waffleMenuRegular: return "\u{fa7e}"
        case .waitingroomActiveBold: return "\u{fa7f}"
        case .waitingroomActiveLight: return "\u{fa80}"
        case .waitingroomActiveRegular: return "\u{fa81}"
        case .wallpaperBold: return "\u{fa82}"
        case .wallpaperLight: return "\u{fa83}"
        case .wallpaperRegular: return "\u{fa84}"
        case .warningBadgeFilled: return "\u{fa85}"
        case .warningBold: return "\u{fa86}"
        case .warningFilled: return "\u{fa87}"
        case .warningLight: return "\u{fa88}"
        case .warningRegular: return "\u{fa89}"
        case .webexAssistantActiveColored: return "\u{fa8a}"
        case .webexAssistantInactiveColored: return "\u{fa8b}"
        case .webexBoardBold: return "\u{fa8c}"
        case .webexBoardLight: return "\u{fa8d}"
        case .webexBoardRegular: return "\u{fa8e}"
        case .webexCodecPlusBold: return "\u{fa8f}"
        case .webexCodecPlusLight: return "\u{fa90}"
        case .webexCodecPlusRegular: return "\u{fa91}"
        case .webexDeskCameraBold: return "\u{fa92}"
        case .webexDeskCameraLight: return "\u{fa93}"
        case .webexDeskCameraRegular: return "\u{fa94}"
        case .webexHelixFilled: return "\u{fa95}"
        case .webexMeetingsBold: return "\u{fa96}"
        case .webexMeetingsFilled: return "\u{fa97}"
        case .webexMeetingsLight: return "\u{fa98}"
        case .webexMeetingsRegular: return "\u{fa99}"
        case .webexQuadCameraBold: return "\u{fa9a}"
        case .webexQuadCameraLight: return "\u{fa9b}"
        case .webexQuadCameraRegular: return "\u{fa9c}"
        case .webexRoomKitBold: return "\u{fa9d}"
        case .webexRoomKitLight: return "\u{fa9e}"
        case .webexRoomKitPlusBold: return "\u{fa9f}"
        case .webexRoomKitPlusLight: return "\u{faa0}"
        case .webexRoomKitPlusRegular: return "\u{faa1}"
        case .webexRoomKitRegular: return "\u{faa2}"
        case .webexShareBold: return "\u{faa3}"
        case .webexShareLight: return "\u{faa4}"
        case .webexShareRegular: return "\u{faa5}"
        case .webexTeamsBold: return "\u{faa6}"
        case .webexTeamsFilled: return "\u{faa7}"
        case .webexTeamsLight: return "\u{faa8}"
        case .webexTeamsNewBold: return "\u{faa9}"
        case .webexTeamsNewFilled: return "\u{faaa}"
        case .webexTeamsNewLight: return "\u{faab}"
        case .webexTeamsNewRegular: return "\u{faac}"
        case .webexTeamsRegular: return "\u{faad}"
        case .webinarBold: return "\u{faae}"
        case .webinarFilled: return "\u{faaf}"
        case .webinarLight: return "\u{fab0}"
        case .webinarRegular: return "\u{fab1}"
        case .weeklyRecurringScheduleNodeBold: return "\u{fab2}"
        case .weeklyRecurringScheduleNodeLight: return "\u{fab3}"
        case .weeklyRecurringScheduleNodeRegular: return "\u{fab4}"
        case .whiteboardBold: return "\u{fab5}"
        case .whiteboardContentBold: return "\u{fab6}"
        case .whiteboardContentLight: return "\u{fab7}"
        case .whiteboardContentRegular: return "\u{fab8}"
        case .whiteboardFilled: return "\u{fab9}"
        case .whiteboardLight: return "\u{faba}"
        case .whiteboardRegular: return "\u{fabb}"
        case .widgetBold: return "\u{fabc}"
        case .widgetFilled: return "\u{fabd}"
        case .widgetLight: return "\u{fabe}"
        case .widgetRegular: return "\u{fabf}"
        case .wifiBold: return "\u{fac0}"
        case .wifiErrorBold: return "\u{fac1}"
        case .wifiErrorLight: return "\u{fac2}"
        case .wifiErrorRegular: return "\u{fac3}"
        case .wifiLight: return "\u{fac4}"
        case .wifiRegular: return "\u{fac5}"
        case .wifiSignalGoodColoredBold: return "\u{fac6}"
        case .wifiSignalGoodColoredLight: return "\u{fac7}"
        case .wifiSignalGoodColoredRegular: return "\u{fac8}"
        case .wifiSignalPoorColoredBold: return "\u{fac9}"
        case .wifiSignalPoorColoredLight: return "\u{faca}"
        case .wifiSignalPoorColoredRegular: return "\u{facb}"
        case .wifiSignalUnstableColoredBold: return "\u{facc}"
        case .wifiSignalUnstableColoredLight: return "\u{facd}"
        case .wifiSignalUnstableColoredRegular: return "\u{face}"
        case .windowCornerScrubBold: return "\u{facf}"
        case .windowCornerScrubLight: return "\u{fad0}"
        case .windowCornerScrubRegular: return "\u{fad1}"
        case .windowRightCornerScrubBold: return "\u{fad2}"
        case .windowRightCornerScrubLight: return "\u{fad3}"
        case .windowRightCornerScrubRegular: return "\u{fad4}"
        case .windowVerticalScrubBold: return "\u{fad5}"
        case .windowVerticalScrubLight: return "\u{fad6}"
        case .windowVerticalScrubRegular: return "\u{fad7}"
        case .workflowDeploymentsBold: return "\u{fad8}"
        case .workflowDeploymentsLight: return "\u{fad9}"
        case .workflowDeploymentsRegular: return "\u{fada}"
        case .workphoneBold: return "\u{fadb}"
        case .workphoneLight: return "\u{fadc}"
        case .workphoneRegular: return "\u{fadd}"
        case .zoomInBold: return "\u{fade}"
        case .zoomInLight: return "\u{fadf}"
        case .zoomInRegular: return "\u{fae0}"
        case .zoomOutBold: return "\u{fae1}"
        case .zoomOutLight: return "\u{fae2}"
        case .zoomOutRegular: return "\u{fae3}"
        case .zoom: return "\u{fae4}"
