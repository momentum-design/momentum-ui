...
var ComboBox = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    var input = _react.default.createElement(InputComp, _extends({
    ...
    var renderFilteredOption = filteredOptions && filteredOptions.map(function (option, i) {
      return _react.default.cloneElement(option, _extends({
        active: i === focus,
        key: i,
    ...
    var dropdownElement = this.anchorNode && isOpen && _react.default.createElement(_.EventOverlay, _extends({
      allowClickAway: true,
      anchorNode: this.anchorNode,
      close: this.hidePopover,
      isOpen: isOpen
    }, otherProps), _react.default.createElement("div", _extends({
