...
@objc public enum MomentumIconsRebrandType: Int {
    ...
    public var ligature: String {
        ...
        case .createAGroupLight: return "\u{f362}"
        case .createAGroupRegular: return "\u{f363}"
        case .cropBold: return "\u{f364}"
        case .cropLight: return "\u{f365}"
        case .cropRegular: return "\u{f366}"
        case .cucmConnectionBold: return "\u{f367}"
        case .cucmConnectionLight: return "\u{f368}"
        case .cucmConnectionRegular: return "\u{f369}"
        case .dailyRecurringScheduleNodeBold: return "\u{f36a}"
        case .dailyRecurringScheduleNodeLight: return "\u{f36b}"
        case .dailyRecurringScheduleNodeRegular: return "\u{f36c}"
        case .dashboardBold: return "\u{f36d}"
        case .dashboardFilled: return "\u{f36e}"
        case .dashboardLight: return "\u{f36f}"
        case .dashboardRegular: return "\u{f370}"
        case .dataManagement1: return "\u{f371}"
        case .dataManagement2: return "\u{f372}"
        case .dataManagement: return "\u{f373}"
        case .deleteBold: return "\u{f374}"
        case .deleteFilled: return "\u{f375}"
        case .deleteLight: return "\u{f376}"
        case .deleteRegular: return "\u{f377}"
        case .deskPhoneBold: return "\u{f378}"
        case .deskPhoneFilled: return "\u{f379}"
        case .deskPhoneLight: return "\u{f37a}"
        case .deskPhoneRegular: return "\u{f37b}"
        case .deskPhoneWarningBold: return "\u{f37c}"
        case .deskPhoneWarningLight: return "\u{f37d}"
        case .deskPhoneWarningRegular: return "\u{f37e}"
        case .deviceConnectionBold: return "\u{f37f}"
        case .deviceConnectionFilled: return "\u{f380}"
        case .deviceConnectionLight: return "\u{f381}"
        case .deviceConnectionRegular: return "\u{f382}"
        case .devicePolicyControllerBold: return "\u{f383}"
        case .devicePolicyControllerLight: return "\u{f384}"
        case .devicePolicyControllerRegular: return "\u{f385}"
        case .diagnosticsBold: return "\u{f386}"
        case .diagnosticsLight: return "\u{f387}"
        case .diagnosticsRegular: return "\u{f388}"
        case .dialpadBold: return "\u{f389}"
        case .dialpadLight: return "\u{f38a}"
        case .dialpadRegular: return "\u{f38b}"
        case .directionalPadBold: return "\u{f38c}"
        case .directionalPadFilled: return "\u{f38d}"
        case .directionalPadLight: return "\u{f38e}"
        case .directionalPadRegular: return "\u{f38f}"
        case .directoryBold: return "\u{f390}"
        case .directoryLight: return "\u{f391}"
        case .directoryRegular: return "\u{f392}"
        case .discBold: return "\u{f393}"
        case .discDisconnectedBold: return "\u{f394}"
        case .discDisconnectedLight: return "\u{f395}"
        case .discDisconnectedRegular: return "\u{f396}"
        case .discLight: return "\u{f397}"
        case .discRegular: return "\u{f398}"
        case .disconnectBold: return "\u{f399}"
        case .disconnectLight: return "\u{f39a}"
        case .disconnectRegular: return "\u{f39b}"
        case .dislikeBold: return "\u{f39c}"
        case .dislikeFilled: return "\u{f39d}"
        case .dislikeLight: return "\u{f39e}"
        case .dislikeRegular: return "\u{f39f}"
        case .displayBold: return "\u{f3a0}"
        case .displayInputBold: return "\u{f3a1}"
        case .displayInputLight: return "\u{f3a2}"
        case .displayInputRegular: return "\u{f3a3}"
        case .displayLight: return "\u{f3a4}"
        case .displayRegular: return "\u{f3a5}"
        case .displayWarningBold: return "\u{f3a6}"
        case .displayWarningLight: return "\u{f3a7}"
        case .displayWarningRegular: return "\u{f3a8}"
        case .distributeHorizontalBold: return "\u{f3a9}"
        case .distributeHorizontalFilled: return "\u{f3aa}"
        case .distributeHorizontalLight: return "\u{f3ab}"
        case .distributeHorizontalRegular: return "\u{f3ac}"
        case .distributeVerticallyBold: return "\u{f3ad}"
        case .distributeVerticallyFilled: return "\u{f3ae}"
        case .distributeVerticallyLight: return "\u{f3af}"
        case .distributeVerticallyRegular: return "\u{f3b0}"
        case .dndPresenceBold: return "\u{f3b1}"
        case .dndPresenceFilled: return "\u{f3b2}"
        case .dndPresenceLight: return "\u{f3b3}"
        case .dndPresenceRegular: return "\u{f3b4}"
        case .dndPresenceSmallFilled: return "\u{f3b5}"
        case .documentBold: return "\u{f3b6}"
        case .documentCameraBold: return "\u{f3b7}"
        case .documentCameraDisconnectedBold: return "\u{f3b8}"
        case .documentCameraDisconnectedLight: return "\u{f3b9}"
        case .documentCameraDisconnectedRegular: return "\u{f3ba}"
        case .documentCameraLight: return "\u{f3bb}"
        case .documentCameraRegular: return "\u{f3bc}"
        case .documentCreateBold: return "\u{f3bd}"
        case .documentCreateFilled: return "\u{f3be}"
        case .documentCreateLight: return "\u{f3bf}"
        case .documentCreateRegular: return "\u{f3c0}"
        case .documentFilled: return "\u{f3c1}"
        case .documentLight: return "\u{f3c2}"
        case .documentMoveBold: return "\u{f3c3}"
        case .documentMoveFilled: return "\u{f3c4}"
        case .documentMoveLight: return "\u{f3c5}"
        case .documentMoveRegular: return "\u{f3c6}"
        case .documentRegular: return "\u{f3c7}"
        case .documentShareBold: return "\u{f3c8}"
        case .documentShareFilled: return "\u{f3c9}"
        case .documentShareLight: return "\u{f3ca}"
        case .documentShareRegular: return "\u{f3cb}"
        case .doneAllBold: return "\u{f3cc}"
        case .doneAllLight: return "\u{f3cd}"
        case .doneAllRegular: return "\u{f3ce}"
        case .donutChartBold: return "\u{f3cf}"
        case .donutChartFilled: return "\u{f3d0}"
        case .donutChartLight: return "\u{f3d1}"
        case .donutChartRegular: return "\u{f3d2}"
        case .downloadBold: return "\u{f3d3}"
        case .downloadFilled: return "\u{f3d4}"
        case .downloadLight: return "\u{f3d5}"
        case .downloadRegular: return "\u{f3d6}"
        case .draftBold: return "\u{f3d7}"
        case .draftFilled: return "\u{f3d8}"
        case .draftIndicatorBold: return "\u{f3d9}"
        case .draftIndicatorSmallFilled: return "\u{f3da}"
        case .draftLight: return "\u{f3db}"
        case .draftRegular: return "\u{f3dc}"
        case .dragBold: return "\u{f3dd}"
        case .dragLight: return "\u{f3de}"
        case .dragRegular: return "\u{f3df}"
        case .dropdownBold: return "\u{f3e0}"
        case .dropdownLight: return "\u{f3e1}"
        case .dropdownRegular: return "\u{f3e2}"
        case .dx70Bold: return "\u{f3e3}"
        case .dx70Light: return "\u{f3e4}"
        case .dx70Regular: return "\u{f3e5}"
        case .dx80Bold: return "\u{f3e6}"
        case .dx80Filled: return "\u{f3e7}"
        case .dx80Light: return "\u{f3e8}"
        case .dx80Regular: return "\u{f3e9}"
        case .editBold: return "\u{f3ea}"
        case .editLight: return "\u{f3eb}"
        case .editRegular: return "\u{f3ec}"
        case .editablePartialBold: return "\u{f3ed}"
        case .editablePartialLight: return "\u{f3ee}"
        case .editablePartialRegular: return "\u{f3ef}"
        case .educationBold: return "\u{f3f0}"
        case .educationFilled: return "\u{f3f1}"
        case .educationLight: return "\u{f3f2}"
        case .educationRegular: return "\u{f3f3}"
        case .emailBold: return "\u{f3f4}"
        case .emailDeliveredBold: return "\u{f3f5}"
        case .emailDeliveredLight: return "\u{f3f6}"
        case .emailDeliveredRegular: return "\u{f3f7}"
        case .emailFailureBold: return "\u{f3f8}"
        case .emailFailureLight: return "\u{f3f9}"
        case .emailFailureRegular: return "\u{f3fa}"
        case .emailFilled: return "\u{f3fb}"
        case .emailInviteBold: return "\u{f3fc}"
        case .emailInviteLight: return "\u{f3fd}"
        case .emailInviteRegular: return "\u{f3fe}"
        case .emailLight: return "\u{f3ff}"
        case .emailReadBold: return "\u{f400}"
        case .emailReadFilled: return "\u{f401}"
        case .emailReadLight: return "\u{f402}"
        case .emailReadRegular: return "\u{f403}"
        case .emailRegular: return "\u{f404}"
        case .emojiExcitedBold: return "\u{f405}"
        case .emojiExcitedFilled: return "\u{f406}"
        case .emojiHappyBold: return "\u{f407}"
        case .emojiHappyFilled: return "\u{f408}"
        case .emojiHappyLight: return "\u{f409}"
        case .emojiHappyRegular: return "\u{f40a}"
        case .emojiPassiveBold: return "\u{f40b}"
        case .emojiPassiveFilled: return "\u{f40c}"
        case .emojiPassiveLight: return "\u{f40d}"
        case .emojiPassiveRegular: return "\u{f40e}"
        case .emojiSadBold: return "\u{f40f}"
        case .emojiSadFilled: return "\u{f410}"
        case .emojiSadLight: return "\u{f411}"
        case .emojiSadRegular: return "\u{f412}"
        case .emojiUnhappyBold: return "\u{f413}"
        case .emojiUnhappyFilled: return "\u{f414}"
        case .encryptionCircleFilled: return "\u{f415}"
        case .encryptionFilled: return "\u{f416}"
        case .endRemoteDesktopControlBold: return "\u{f417}"
        case .endRemoteDesktopControlLight: return "\u{f418}"
        case .endRemoteDesktopControlRegular: return "\u{f419}"
        case .endToEndEncryptionCircleFilled: return "\u{f41a}"
        case .endToEndEncryptionFilled: return "\u{f41b}"
        case .endpointBlockedBold: return "\u{f41c}"
        case .endpointBlockedLight: return "\u{f41d}"
        case .endpointBlockedRegular: return "\u{f41e}"
        case .endpointBold: return "\u{f41f}"
        case .endpointG270Bold: return "\u{f420}"
        case .endpointG270DualBold: return "\u{f421}"
        case .endpointG270DualLight: return "\u{f422}"
        case .endpointG270DualRegular: return "\u{f423}"
        case .endpointG270Light: return "\u{f424}"
        case .endpointG270Regular: return "\u{f425}"
        case .endpointG2Bold: return "\u{f426}"
        case .endpointG2Light: return "\u{f427}"
        case .endpointG2Regular: return "\u{f428}"
        case .endpointG2StandBold: return "\u{f429}"
        case .endpointG2StandLight: return "\u{f42a}"
        case .endpointG2StandRegular: return "\u{f42b}"
        case .endpointLight: return "\u{f42c}"
        case .endpointMx800Bold: return "\u{f42d}"
        case .endpointMx800DualBold: return "\u{f42e}"
        case .endpointMx800DualLight: return "\u{f42f}"
        case .endpointMx800DualRegular: return "\u{f430}"
        case .endpointMx800Light: return "\u{f431}"
        case .endpointMx800Regular: return "\u{f432}"
        case .endpointRegular: return "\u{f433}"
        case .endpointStandBold: return "\u{f434}"
        case .endpointStandFilled: return "\u{f435}"
        case .endpointStandLight: return "\u{f436}"
        case .endpointStandRegular: return "\u{f437}"
        case .endpointWarningBold: return "\u{f438}"
        case .endpointWarningLight: return "\u{f439}"
        case .endpointWarningRegular: return "\u{f43a}"
        case .enterBold: return "\u{f43b}"
        case .enterLight: return "\u{f43c}"
        case .enterRegular: return "\u{f43d}"
        case .enterRoomBold: return "\u{f43e}"
        case .enterRoomFilled: return "\u{f43f}"
        case .enterRoomLight: return "\u{f440}"
        case .enterRoomRegular: return "\u{f441}"
        case .eraserBold: return "\u{f442}"
        case .eraserFilled: return "\u{f443}"
        case .eraserLight: return "\u{f444}"
        case .eraserRegular: return "\u{f445}"
        case .errorLegacyBadgeFilled: return "\u{f446}"
        case .errorLegacyBold: return "\u{f447}"
        case .errorLegacyFilled: return "\u{f448}"
        case .errorLegacyLight: return "\u{f449}"
        case .errorLegacyRegular: return "\u{f44a}"
        case .ethernetBold: return "\u{f44b}"
        case .ethernetLight: return "\u{f44c}"
        case .ethernetRegular: return "\u{f44d}"
        case .eventBold: return "\u{f44e}"
        case .eventLight: return "\u{f44f}"
        case .eventRegular: return "\u{f450}"
        case .exitRoomBold: return "\u{f451}"
        case .exitRoomLight: return "\u{f452}"
        case .exitRoomRegular: return "\u{f453}"
        case .exludeBold: return "\u{f454}"
        case .exludeLight: return "\u{f455}"
        case .exludeRegular: return "\u{f456}"
        case .exploreBold: return "\u{f457}"
        case .exploreLight: return "\u{f458}"
        case .exploreRegular: return "\u{f459}"
        case .exportBold: return "\u{f45a}"
        case .exportLight: return "\u{f45b}"
        case .exportRegular: return "\u{f45c}"
        case .extensionMobilityBold: return "\u{f45d}"
        case .extensionMobilityLight: return "\u{f45e}"
        case .extensionMobilityRegular: return "\u{f45f}"
        case .externalMessageBold: return "\u{f460}"
        case .externalMessageLight: return "\u{f461}"
        case .externalMessageRegular: return "\u{f462}"
        case .externalUserBold: return "\u{f463}"
        case .externalUserLight: return "\u{f464}"
        case .externalUserRegular: return "\u{f465}"
        case .familyFontBold: return "\u{f466}"
        case .familyFontLight: return "\u{f467}"
        case .familyFontRegular: return "\u{f468}"
        case .fastForwardBold: return "\u{f469}"
        case .fastForwardLight: return "\u{f46a}"
        case .fastForwardRegular: return "\u{f46b}"
        case .favoriteBold: return "\u{f46c}"
        case .favoriteFilled: return "\u{f46d}"
        case .favoriteLight: return "\u{f46e}"
        case .favoriteRegular: return "\u{f46f}"
        case .favoritesBold: return "\u{f470}"
        case .favoritesFilled: return "\u{f471}"
        case .favoritesLight: return "\u{f472}"
        case .favoritesRegular: return "\u{f473}"
        case .fbwBold: return "\u{f474}"
        case .fbwFilled: return "\u{f475}"
        case .fbwLight: return "\u{f476}"
        case .fbwRegular: return "\u{f477}"
        case .ffwBold: return "\u{f478}"
        case .ffwFilled: return "\u{f479}"
        case .ffwLight: return "\u{f47a}"
        case .ffwRegular: return "\u{f47b}"
        case .file3DBold: return "\u{f47c}"
        case .file3DFilled: return "\u{f47d}"
        case .file3DLight: return "\u{f47e}"
        case .file3DRegular: return "\u{f47f}"
        case .fileAnalysisBold: return "\u{f480}"
        case .fileAnalysisFilled: return "\u{f481}"
        case .fileAnalysisLight: return "\u{f482}"
        case .fileAnalysisRegular: return "\u{f483}"
        case .fileAnnotationBold: return "\u{f484}"
        case .fileAnnotationFilled: return "\u{f485}"
        case .fileAnnotationLight: return "\u{f486}"
        case .fileAnnotationRegular: return "\u{f487}"
        case .fileAudioBold: return "\u{f488}"
        case .fileAudioFilled: return "\u{f489}"
        case .fileAudioLight: return "\u{f48a}"
        case .fileAudioRegular: return "\u{f48b}"
        case .fileBugBold: return "\u{f48c}"
        case .fileBugFilled: return "\u{f48d}"
        case .fileBugLight: return "\u{f48e}"
        case .fileBugRegular: return "\u{f48f}"
        case .fileCodeBold: return "\u{f490}"
        case .fileCodeFilled: return "\u{f491}"
        case .fileCodeLight: return "\u{f492}"
        case .fileCodeRegular: return "\u{f493}"
        case .fileDashboardBold: return "\u{f494}"
        case .fileDashboardFilled: return "\u{f495}"
        case .fileDashboardLight: return "\u{f496}"
        case .fileDashboardRegular: return "\u{f497}"
        case .fileExcelBold: return "\u{f498}"
        case .fileExcelFilled: return "\u{f499}"
        case .fileExcelLight: return "\u{f49a}"
        case .fileExcelRegular: return "\u{f49b}"
        case .fileGraphBold: return "\u{f49c}"
        case .fileGraphFilled: return "\u{f49d}"
        case .fileGraphLight: return "\u{f49e}"
        case .fileGraphRegular: return "\u{f49f}"
        case .fileImageBold: return "\u{f4a0}"
        case .fileImageFilled: return "\u{f4a1}"
        case .fileImageLight: return "\u{f4a2}"
        case .fileImageRegular: return "\u{f4a3}"
        case .fileKeynoteBold: return "\u{f4a4}"
        case .fileKeynoteFilled: return "\u{f4a5}"
        case .fileKeynoteLight: return "\u{f4a6}"
        case .fileKeynoteRegular: return "\u{f4a7}"
        case .fileLockedBold: return "\u{f4a8}"
        case .fileLockedFilled: return "\u{f4a9}"
        case .fileLockedLight: return "\u{f4aa}"
        case .fileLockedRegular: return "\u{f4ab}"
        case .fileMissingBold: return "\u{f4ac}"
        case .fileMissingFilled: return "\u{f4ad}"
        case .fileMissingLight: return "\u{f4ae}"
        case .fileMissingRegular: return "\u{f4af}"
        case .fileMusicBold: return "\u{f4b0}"
        case .fileMusicFilled: return "\u{f4b1}"
        case .fileMusicLight: return "\u{f4b2}"
        case .fileMusicRegular: return "\u{f4b3}"
        case .fileOnenoteBold: return "\u{f4b4}"
        case .fileOnenoteFilled: return "\u{f4b5}"
        case .fileOnenoteLight: return "\u{f4b6}"
        case .fileOnenoteRegular: return "\u{f4b7}"
        case .filePdfBold: return "\u{f4b8}"
        case .filePdfFilled: return "\u{f4b9}"
        case .filePdfLight: return "\u{f4ba}"
        case .filePdfRegular: return "\u{f4bb}"
        case .filePowerpointBold: return "\u{f4bc}"
        case .filePowerpointFilled: return "\u{f4bd}"
        case .filePowerpointLight: return "\u{f4be}"
        case .filePowerpointRegular: return "\u{f4bf}"
        case .fileSpreadsheetBold: return "\u{f4c0}"
        case .fileSpreadsheetFilled: return "\u{f4c1}"
        case .fileSpreadsheetLight: return "\u{f4c2}"
        case .fileSpreadsheetRegular: return "\u{f4c3}"
        case .fileTextBold: return "\u{f4c4}"
        case .fileTextFilled: return "\u{f4c5}"
        case .fileTextLight: return "\u{f4c6}"
        case .fileTextRegular: return "\u{f4c7}"
        case .fileVectorBold: return "\u{f4c8}"
        case .fileVectorFilled: return "\u{f4c9}"
        case .fileVectorLight: return "\u{f4ca}"
        case .fileVectorRegular: return "\u{f4cb}"
        case .fileVideoBold: return "\u{f4cc}"
        case .fileVideoFilled: return "\u{f4cd}"
        case .fileVideoLight: return "\u{f4ce}"
        case .fileVideoRegular: return "\u{f4cf}"
        case .fileWordBold: return "\u{f4d0}"
        case .fileWordFilled: return "\u{f4d1}"
        case .fileWordLight: return "\u{f4d2}"
        case .fileWordRegular: return "\u{f4d3}"
        case .fileZipBold: return "\u{f4d4}"
        case .fileZipFilled: return "\u{f4d5}"
        case .fileZipLight: return "\u{f4d6}"
        case .fileZipRegular: return "\u{f4d7}"
        case .filesBold: return "\u{f4d8}"
        case .filesFilled: return "\u{f4d9}"
        case .filesLight: return "\u{f4da}"
        case .filesRegular: return "\u{f4db}"
        case .fillColourBold: return "\u{f4dc}"
        case .fillColourFilled: return "\u{f4dd}"
        case .fillColourLight: return "\u{f4de}"
        case .fillColourRegular: return "\u{f4df}"
        case .filterBold: return "\u{f4e0}"
        case .filterCircleBold: return "\u{f4e1}"
        case .filterCircleFilled: return "\u{f4e2}"
        case .filterCircleLight: return "\u{f4e3}"
        case .filterCircleRegular: return "\u{f4e4}"
        case .filterLight: return "\u{f4e5}"
        case .filterRegular: return "\u{f4e6}"
        case .fitToWidthBold: return "\u{f4e7}"
        case .fitToWidthLight: return "\u{f4e8}"
        case .fitToWidthRegular: return "\u{f4e9}"
        case .fitToWindowBold: return "\u{f4ea}"
        case .fitToWindowExitBold: return "\u{f4eb}"
        case .fitToWindowExitLight: return "\u{f4ec}"
        case .fitToWindowExitRegular: return "\u{f4ed}"
        case .fitToWindowLight: return "\u{f4ee}"
        case .fitToWindowRegular: return "\u{f4ef}"
        case .flagBold: return "\u{f4f0}"
        case .flagCircleBold: return "\u{f4f1}"
        case .flagCircleFilled: return "\u{f4f2}"
        case .flagCircleLight: return "\u{f4f3}"
        case .flagCircleRegular: return "\u{f4f4}"
        case .flagFilled: return "\u{f4f5}"
        case .flagLight: return "\u{f4f6}"
        case .flagRegular: return "\u{f4f7}"
        case .folderBold: return "\u{f4f8}"
        case .folderEditBold: return "\u{f4f9}"
        case .folderEditLight: return "\u{f4fa}"
        case .folderEditRegular: return "\u{f4fb}"
        case .folderLight: return "\u{f4fc}"
        case .folderLockBold: return "\u{f4fd}"
        case .folderLockLight: return "\u{f4fe}"
        case .folderLockRegular: return "\u{f4ff}"
        case .folderRegular: return "\u{f500}"
        case .folderViewBold: return "\u{f501}"
        case .folderViewLight: return "\u{f502}"
        case .folderViewRegular: return "\u{f503}"
        case .followUpBold: return "\u{f504}"
        case .followUpLight: return "\u{f505}"
        case .followUpRegular: return "\u{f506}"
        case .foodBold: return "\u{f507}"
        case .foodLight: return "\u{f508}"
        case .foodRegular: return "\u{f509}"
        case .formatBold: return "\u{f50a}"
        case .formatControlPanelDraggerBold: return "\u{f50b}"
        case .formatControlPanelDraggerHorizontalBold: return "\u{f50c}"
        case .formatControlPanelDraggerHorizontalLight: return "\u{f50d}"
        case .formatControlPanelDraggerHorizontalRegular: return "\u{f50e}"
        case .formatControlPanelDraggerLight: return "\u{f50f}"
        case .formatControlPanelDraggerRegular: return "\u{f510}"
        case .formatDefaultAppBold: return "\u{f511}"
        case .formatDefaultAppLight: return "\u{f512}"
        case .formatDefaultAppRegular: return "\u{f513}"
        case .formatLight: return "\u{f514}"
        case .formatPanelControlBarBold: return "\u{f515}"
        case .formatPanelControlBarLight: return "\u{f516}"
        case .formatPanelControlBarRegular: return "\u{f517}"
        case .formatPanelControlDownBold: return "\u{f518}"
        case .formatPanelControlDownLight: return "\u{f519}"
        case .formatPanelControlDownRegular: return "\u{f51a}"
        case .formatPanelControlLeftBold: return "\u{f51b}"
        case .formatPanelControlLeftLight: return "\u{f51c}"
        case .formatPanelControlLeftRegular: return "\u{f51d}"
        case .formatPanelControlRightBold: return "\u{f51e}"
        case .formatPanelControlRightLight: return "\u{f51f}"
        case .formatPanelControlRightRegular: return "\u{f520}"
        case .formatPanelControlUpBold: return "\u{f521}"
        case .formatPanelControlUpDownBold: return "\u{f522}"
        case .formatPanelControlUpDownLight: return "\u{f523}"
        case .formatPanelControlUpDownRegular: return "\u{f524}"
        case .formatPanelControlUpLight: return "\u{f525}"
        case .formatPanelControlUpRegular: return "\u{f526}"
        case .formatRegular: return "\u{f527}"
        case .formatViewMixedBold: return "\u{f528}"
        case .formatViewMixedLight: return "\u{f529}"
        case .formatViewMixedRegular: return "\u{f52a}"
        case .forwardMessageBold: return "\u{f52b}"
        case .forwardMessageFilled: return "\u{f52c}"
        case .forwardMessageLight: return "\u{f52d}"
        case .forwardMessageRegular: return "\u{f52e}"
        case .fourColumnBold: return "\u{f52f}"
        case .fourColumnLight: return "\u{f530}"
        case .fourColumnRegular: return "\u{f531}"
        case .fourWayNavigationBold: return "\u{f532}"
        case .fourWayNavigationLight: return "\u{f533}"
        case .fourWayNavigationRegular: return "\u{f534}"
        case .frequencyCappingBold: return "\u{f535}"
        case .frequencyCappingLight: return "\u{f536}"
        case .frequencyCappingRegular: return "\u{f537}"
        case .fufillmentBold: return "\u{f538}"
        case .fufillmentLight: return "\u{f539}"
        case .fufillmentRegular: return "\u{f53a}"
        case .fullscreenBold: return "\u{f53b}"
        case .fullscreenExitBold: return "\u{f53c}"
        case .fullscreenExitLight: return "\u{f53d}"
        case .fullscreenExitRegular: return "\u{f53e}"
        case .fullscreenLight: return "\u{f53f}"
        case .fullscreenRegular: return "\u{f540}"
        case .genericDeviceVideoBold: return "\u{f541}"
        case .genericDeviceVideoFilled: return "\u{f542}"
        case .genericDeviceVideoLight: return "\u{f543}"
        case .genericDeviceVideoRegular: return "\u{f544}"
        case .genericDeviceVideoSmallFilled: return "\u{f545}"
        case .gifBold: return "\u{f546}"
        case .gifFilled: return "\u{f547}"
        case .gifLight: return "\u{f548}"
        case .gifRegular: return "\u{f549}"
        case .googleMeet: return "\u{f54a}"
        case .greenRoomBold: return "\u{f54b}"
        case .greenRoomFilled: return "\u{f54c}"
        case .greenRoomLight: return "\u{f54d}"
        case .greenRoomRegular: return "\u{f54e}"
        case .groupBold: return "\u{f54f}"
        case .groupLight: return "\u{f550}"
        case .groupPickupBold: return "\u{f551}"
        case .groupPickupFilled: return "\u{f552}"
        case .groupPickupLight: return "\u{f553}"
        case .groupPickupRegular: return "\u{f554}"
        case .groupRegular: return "\u{f555}"
        case .guestIssuerBold: return "\u{f556}"
        case .guestIssuerLight: return "\u{f557}"
        case .guestIssuerRegular: return "\u{f558}"
        case .guideBold: return "\u{f559}"
        case .guideLight: return "\u{f55a}"
        case .guideRegular: return "\u{f55b}"
        case .handlerBold: return "\u{f55c}"
        case .handlerLight: return "\u{f55d}"
        case .handlerRegular: return "\u{f55e}"
        case .handsetAlertBold: return "\u{f55f}"
        case .handsetAlertFilled: return "\u{f560}"
        case .handsetAlertLight: return "\u{f561}"
        case .handsetAlertRegular: return "\u{f562}"
        case .handsetBold: return "\u{f563}"
        case .handsetFilled: return "\u{f564}"
        case .handsetLight: return "\u{f565}"
        case .handsetMutedBold: return "\u{f566}"
        case .handsetMutedFilled: return "\u{f567}"
        case .handsetMutedLight: return "\u{f568}"
        case .handsetMutedRegular: return "\u{f569}"
        case .handsetRegular: return "\u{f56a}"
        case .handshakeBold: return "\u{f56b}"
        case .handshakeLight: return "\u{f56c}"
        case .handshakeRegular: return "\u{f56d}"
        case .headingOneBold: return "\u{f56e}"
        case .headingOneLight: return "\u{f56f}"
        case .headingOneRegular: return "\u{f570}"
        case .headingThreeBold: return "\u{f571}"
        case .headingThreeLight: return "\u{f572}"
        case .headingThreeRegular: return "\u{f573}"
        case .headingTwoBold: return "\u{f574}"
        case .headingTwoLight: return "\u{f575}"
        case .headingTwoRegular: return "\u{f576}"
        case .headsetAlertBold: return "\u{f577}"
        case .headsetAlertLight: return "\u{f578}"
        case .headsetAlertRegular: return "\u{f579}"
        case .headsetBold: return "\u{f57a}"
        case .headsetFilled: return "\u{f57b}"
        case .headsetLight: return "\u{f57c}"
        case .headsetMutedBold: return "\u{f57d}"
        case .headsetMutedLight: return "\u{f57e}"
        case .headsetMutedRegular: return "\u{f57f}"
        case .headsetPrivateBold: return "\u{f580}"
        case .headsetPrivateLight: return "\u{f581}"
        case .headsetPrivateRegular: return "\u{f582}"
        case .headsetRegular: return "\u{f583}"
        case .helpBold: return "\u{f584}"
        case .helpCircleActiveFilled: return "\u{f585}"
        case .helpCircleBold: return "\u{f586}"
        case .helpCircleLight: return "\u{f587}"
        case .helpCircleRegular: return "\u{f588}"
        case .helpLight: return "\u{f589}"
        case .helpRegular: return "\u{f58a}"
        case .helpdeskBold: return "\u{f58b}"
        case .helpdeskLight: return "\u{f58c}"
        case .helpdeskRegular: return "\u{f58d}"
        case .hideBold: return "\u{f58e}"
        case .hideFilled: return "\u{f58f}"
        case .hideLight: return "\u{f590}"
        case .hideRegular: return "\u{f591}"
        case .homeBold: return "\u{f592}"
        case .homeFilled: return "\u{f593}"
        case .homeLight: return "\u{f594}"
        case .homeRegular: return "\u{f595}"
        case .horizontalLineBold: return "\u{f596}"
        case .horizontalLineLight: return "\u{f597}"
        case .horizontalLineRegular: return "\u{f598}"
        case .hotelingBold: return "\u{f599}"
        case .hotelingFilled: return "\u{f59a}"
        case .hotelingLight: return "\u{f59b}"
        case .hotelingRegular: return "\u{f59c}"
        case .humidityBold: return "\u{f59d}"
        case .humidityLight: return "\u{f59e}"
        case .humidityRegular: return "\u{f59f}"
        case .huntGroupBold: return "\u{f5a0}"
        case .huntGroupFilled: return "\u{f5a1}"
        case .huntGroupLight: return "\u{f5a2}"
        case .huntGroupRegular: return "\u{f5a3}"
        case .importBold: return "\u{f5a4}"
        case .importLight: return "\u{f5a5}"
        case .importRegular: return "\u{f5a6}"
        case .inCommonBold: return "\u{f5a7}"
        case .inCommonLight: return "\u{f5a8}"
        case .inCommonRegular: return "\u{f5a9}"
        case .includeBold: return "\u{f5aa}"
        case .includeLight: return "\u{f5ab}"
        case .includeRegular: return "\u{f5ac}"
        case .incomingCallLegacyBold: return "\u{f5ad}"
        case .incomingCallLegacyFilled: return "\u{f5ae}"
        case .incomingCallLegacyLight: return "\u{f5af}"
        case .incomingCallLegacyRegular: return "\u{f5b0}"
        case .infoBadgeFilled: return "\u{f5b1}"
        case .infoCircleBold: return "\u{f5b2}"
        case .infoCircleFilled: return "\u{f5b3}"
        case .infoCircleLight: return "\u{f5b4}"
        case .infoCircleRegular: return "\u{f5b5}"
        case .infoCircleTwoBold: return "\u{f5b6}"
        case .infoCircleTwoFilled: return "\u{f5b7}"
        case .infoCircleTwoLight: return "\u{f5b8}"
        case .infoCircleTwoRegular: return "\u{f5b9}"
        case .inputBold: return "\u{f5ba}"
        case .inputDisconnectedBold: return "\u{f5bb}"
        case .inputDisconnectedLight: return "\u{f5bc}"
        case .inputDisconnectedRegular: return "\u{f5bd}"
        case .inputLight: return "\u{f5be}"
        case .inputRegular: return "\u{f5bf}"
        case .insightsBold: return "\u{f5c0}"
        case .insightsLight: return "\u{f5c1}"
        case .insightsRegular: return "\u{f5c2}"
        case .integrationsBold: return "\u{f5c3}"
        case .integrationsLight: return "\u{f5c4}"
        case .integrationsRegular: return "\u{f5c5}"
        case .intelligentRoutingBold: return "\u{f5c6}"
        case .intelligentRoutingLight: return "\u{f5c7}"
        case .intelligentRoutingRegular: return "\u{f5c8}"
        case .invitedUserBold: return "\u{f5c9}"
        case .invitedUserLight: return "\u{f5ca}"
        case .invitedUserRegular: return "\u{f5cb}"
        case .italicBold: return "\u{f5cc}"
        case .italicLight: return "\u{f5cd}"
        case .italicRegular: return "\u{f5ce}"
        case .joinAudioBold: return "\u{f5cf}"
        case .joinAudioFilled: return "\u{f5d0}"
        case .joinAudioLight: return "\u{f5d1}"
        case .joinAudioRegular: return "\u{f5d2}"
        case .keepInTouchBold: return "\u{f5d3}"
        case .keepInTouchFilled: return "\u{f5d4}"
        case .keepInTouchLight: return "\u{f5d5}"
        case .keepInTouchRegular: return "\u{f5d6}"
        case .keyboardBold: return "\u{f5d7}"
        case .keyboardCloseBold: return "\u{f5d8}"
        case .keyboardCloseLight: return "\u{f5d9}"
        case .keyboardCloseRegular: return "\u{f5da}"
        case .keyboardLight: return "\u{f5db}"
        case .keyboardRegular: return "\u{f5dc}"
        case .languageBold: return "\u{f5dd}"
        case .languageLight: return "\u{f5de}"
        case .languageRegular: return "\u{f5df}"
        case .laptopBold: return "\u{f5e0}"
        case .laptopDisconnectedBold: return "\u{f5e1}"
        case .laptopDisconnectedLight: return "\u{f5e2}"
        case .laptopDisconnectedRegular: return "\u{f5e3}"
        case .laptopFilled: return "\u{f5e4}"
        case .laptopLight: return "\u{f5e5}"
        case .laptopRegular: return "\u{f5e6}"
        case .laserPointerBold: return "\u{f5e7}"
        case .laserPointerLight: return "\u{f5e8}"
        case .laserPointerRegular: return "\u{f5e9}"
        case .launchBold: return "\u{f5ea}"
        case .launchLight: return "\u{f5eb}"
        case .launchRegular: return "\u{f5ec}"
        case .layoutSideBySideVerticalBold: return "\u{f5ed}"
        case .layoutSideBySideVerticalFilled: return "\u{f5ee}"
        case .layoutSideBySideVerticalLight: return "\u{f5ef}"
        case .layoutSideBySideVerticalRegular: return "\u{f5f0}"
        case .leaveBreakoutSessionBold: return "\u{f5f1}"
        case .leaveBreakoutSessionLight: return "\u{f5f2}"
        case .leaveBreakoutSessionRegular: return "\u{f5f3}"
        case .leaveDeviceBold: return "\u{f5f4}"
        case .leaveDeviceLight: return "\u{f5f5}"
        case .leaveDeviceRegular: return "\u{f5f6}"
        case .likeBold: return "\u{f5f7}"
        case .likeFilled: return "\u{f5f8}"
        case .likeLight: return "\u{f5f9}"
        case .likeRegular: return "\u{f5fa}"
        case .linkBold: return "\u{f5fb}"
        case .linkLight: return "\u{f5fc}"
        case .linkRegular: return "\u{f5fd}"
        case .listBulletedBold: return "\u{f5fe}"
        case .listBulletedLight: return "\u{f5ff}"
        case .listBulletedRegular: return "\u{f600}"
        case .listMenuBold: return "\u{f601}"
        case .listMenuLight: return "\u{f602}"
        case .listMenuRegular: return "\u{f603}"
        case .listNumberedBold: return "\u{f604}"
        case .listNumberedLight: return "\u{f605}"
        case .listNumberedRegular: return "\u{f606}"
        case .locationBold: return "\u{f607}"
        case .locationFilled: return "\u{f608}"
        case .locationLight: return "\u{f609}"
        case .locationRegular: return "\u{f60a}"
        case .longTextBoxBold: return "\u{f60b}"
        case .longTextBoxLight: return "\u{f60c}"
        case .longTextBoxRegular: return "\u{f60d}"
        case .lowerHandBold: return "\u{f60e}"
        case .lowerHandLight: return "\u{f60f}"
        case .lowerHandRegular: return "\u{f610}"
        case .magicPenBold: return "\u{f611}"
        case .magicPenFilled: return "\u{f612}"
        case .magicPenLight: return "\u{f613}"
        case .magicPenRegular: return "\u{f614}"
        case .markAsUnreadBold: return "\u{f615}"
        case .markAsUnreadLight: return "\u{f616}"
        case .markAsUnreadRegular: return "\u{f617}"
        case .markdownBold: return "\u{f618}"
        case .markdownLight: return "\u{f619}"
        case .markdownRegular: return "\u{f61a}"
        case .markerBold: return "\u{f61b}"
        case .markerFilled: return "\u{f61c}"
        case .markerLight: return "\u{f61d}"
        case .markerRegular: return "\u{f61e}"
        case .maximizeBold: return "\u{f61f}"
        case .maximizeLight: return "\u{f620}"
        case .maximizeRegular: return "\u{f621}"
        case .mediaPlayerBold: return "\u{f622}"
        case .mediaPlayerLight: return "\u{f623}"
        case .mediaPlayerRegular: return "\u{f624}"
        case .mediaQualityGoodBold: return "\u{f625}"
        case .mediaQualityGoodFilled: return "\u{f626}"
        case .mediaQualityGoodLight: return "\u{f627}"
        case .mediaQualityGoodRegular: return "\u{f628}"
        case .mediaQualityPoorBold: return "\u{f629}"
        case .mediaQualityPoorFilled: return "\u{f62a}"
        case .mediaQualityPoorLight: return "\u{f62b}"
        case .mediaQualityPoorRegular: return "\u{f62c}"
        case .mediaQualityUnstableBold: return "\u{f62d}"
        case .mediaQualityUnstableFilled: return "\u{f62e}"
        case .mediaQualityUnstableLight: return "\u{f62f}"
        case .mediaQualityUnstableRegular: return "\u{f630}"
        case .mediumQualityGoodFilled: return "\u{f631}"
        case .mediumQualityPoorFilled: return "\u{f632}"
        case .mediumQualityUnstableFilled: return "\u{f633}"
        case .meetBold: return "\u{f634}"
        case .meetEndBold: return "\u{f635}"
        case .meetEndLight: return "\u{f636}"
        case .meetEndRegular: return "\u{f637}"
        case .meetFilled: return "\u{f638}"
        case .meetLight: return "\u{f639}"
        case .meetRegular: return "\u{f63a}"
        case .meetingsBold: return "\u{f63b}"
        case .meetingsFilled: return "\u{f63c}"
        case .meetingsFocusMonthBold: return "\u{f63d}"
        case .meetingsFocusMonthLight: return "\u{f63e}"
        case .meetingsFocusMonthRegular: return "\u{f63f}"
        case .meetingsFocusOneDayBold: return "\u{f640}"
        case .meetingsFocusOneDayLight: return "\u{f641}"
        case .meetingsFocusOneDayRegular: return "\u{f642}"
        case .meetingsFocusThreeDayBold: return "\u{f643}"
        case .meetingsFocusThreeDayLight: return "\u{f644}"
        case .meetingsFocusThreeDayRegular: return "\u{f645}"
        case .meetingsFocusUpcomingBold: return "\u{f646}"
        case .meetingsFocusUpcomingLight: return "\u{f647}"
        case .meetingsFocusUpcomingRegular: return "\u{f648}"
        case .meetingsFocusWeekBold: return "\u{f649}"
        case .meetingsFocusWeekLight: return "\u{f64a}"
        case .meetingsFocusWeekRegular: return "\u{f64b}"
        case .meetingsLight: return "\u{f64c}"
        case .meetingsPresenceBold: return "\u{f64d}"
        case .meetingsPresenceFilled: return "\u{f64e}"
        case .meetingsPresenceLight: return "\u{f64f}"
        case .meetingsPresenceRegular: return "\u{f650}"
        case .meetingsPresenceSmallFilled: return "\u{f651}"
        case .meetingsRegular: return "\u{f652}"
        case .meetingsTeamActiveBold: return "\u{f653}"
        case .meetingsTeamActiveLight: return "\u{f654}"
        case .meetingsTeamActiveRegular: return "\u{f655}"
        case .meetingsTeamBold: return "\u{f656}"
        case .meetingsTeamLight: return "\u{f657}"
        case .meetingsTeamNewBold: return "\u{f658}"
        case .meetingsTeamNewLight: return "\u{f659}"
        case .meetingsTeamNewRegular: return "\u{f65a}"
        case .meetingsTeamRegular: return "\u{f65b}"
        case .mentionBold: return "\u{f65c}"
        case .mentionLight: return "\u{f65d}"
        case .mentionRegular: return "\u{f65e}"
        case .messageQueingBold: return "\u{f65f}"
        case .messageQueingLight: return "\u{f660}"
        case .messageQueingRegular: return "\u{f661}"
        case .microphoneBold: return "\u{f662}"
        case .microphoneFilled: return "\u{f663}"
        case .microphoneHardMutedBold: return "\u{f664}"
        case .microphoneHardMutedColoredBold: return "\u{f665}"
        case .microphoneHardMutedColoredLight: return "\u{f666}"
        case .microphoneHardMutedColoredRegular: return "\u{f667}"
        case .microphoneHardMutedLight: return "\u{f668}"
        case .microphoneHardMutedRegular: return "\u{f669}"
        case .microphoneLight: return "\u{f66a}"
        case .microphoneMusicModeColoredBold: return "\u{f66b}"
        case .microphoneMusicModeColoredLight: return "\u{f66c}"
        case .microphoneMusicModeColoredRegular: return "\u{f66d}"
        case .microphoneMutedBold: return "\u{f66e}"
        case .microphoneMutedFilled: return "\u{f66f}"
        case .microphoneMutedIndicatorFilled: return "\u{f670}"
        case .microphoneMutedLight: return "\u{f671}"
        case .microphoneMutedRedBold: return "\u{f672}"
        case .microphoneMutedRedFilled: return "\u{f673}"
        case .microphoneMutedRedLight: return "\u{f674}"
        case .microphoneMutedRedRegular: return "\u{f675}"
        case .microphoneMutedRegular: return "\u{f676}"
        case .microphoneRegular: return "\u{f677}"
        case .minimizeBold: return "\u{f678}"
        case .minimizeLight: return "\u{f679}"
        case .minimizeRegular: return "\u{f67a}"
        case .minusBold: return "\u{f67b}"
        case .minusLight: return "\u{f67c}"
        case .minusRegular: return "\u{f67d}"
        case .mirrorBold: return "\u{f67e}"
        case .mirrorFilled: return "\u{f67f}"
        case .mirrorLight: return "\u{f680}"
        case .mirrorRegular: return "\u{f681}"
        case .moderatorBold: return "\u{f682}"
        case .moderatorLight: return "\u{f683}"
        case .moderatorRegular: return "\u{f684}"
        case .monitoringBold: return "\u{f685}"
        case .monitoringLight: return "\u{f686}"
        case .monitoringRegular: return "\u{f687}"
        case .monthlyRecurringScheduleNodeBold: return "\u{f688}"
        case .monthlyRecurringScheduleNodeLight: return "\u{f689}"
        case .monthlyRecurringScheduleNodeRegular: return "\u{f68a}"
        case .moreAdrBold: return "\u{f68b}"
        case .moreAdrLight: return "\u{f68c}"
        case .moreAdrRegular: return "\u{f68d}"
        case .moreBold: return "\u{f68e}"
        case .moreCircleBold: return "\u{f68f}"
        case .moreCircleFilled: return "\u{f690}"
        case .moreCircleLight: return "\u{f691}"
        case .moreCircleRegular: return "\u{f692}"
        case .moreCirecleFilled: return "\u{f693}"
        case .moreLight: return "\u{f694}"
        case .moreRegular: return "\u{f695}"
        case .mouseCursorBold: return "\u{f696}"
        case .mouseCursorLight: return "\u{f697}"
        case .mouseCursorRegular: return "\u{f698}"
        case .moveCallInAdrBold: return "\u{f699}"
        case .moveCallInAdrLight: return "\u{f69a}"
        case .moveCallInAdrRegular: return "\u{f69b}"
        case .moveCallInIphBold: return "\u{f69c}"
        case .moveCallInIphLight: return "\u{f69d}"
        case .moveCallInIphRegular: return "\u{f69e}"
        case .moveCallInLaptopBold: return "\u{f69f}"
        case .moveCallInLaptopLight: return "\u{f6a0}"
        case .moveCallInLaptopRegular: return "\u{f6a1}"
        case .moveCallInOutAdrBold: return "\u{f6a2}"
        case .moveCallInOutAdrLight: return "\u{f6a3}"
        case .moveCallInOutAdrRegular: return "\u{f6a4}"
        case .moveCallInOutIphBold: return "\u{f6a5}"
        case .moveCallInOutIphLight: return "\u{f6a6}"
        case .moveCallInOutIphRegular: return "\u{f6a7}"
        case .moveCallInTabletBold: return "\u{f6a8}"
        case .moveCallInTabletLight: return "\u{f6a9}"
        case .moveCallInTabletRegular: return "\u{f6aa}"
        case .moveCallOutAdrBold: return "\u{f6ab}"
        case .moveCallOutAdrLight: return "\u{f6ac}"
        case .moveCallOutAdrRegular: return "\u{f6ad}"
        case .moveCallOutIphBold: return "\u{f6ae}"
        case .moveCallOutIphLight: return "\u{f6af}"
        case .moveCallOutIphRegular: return "\u{f6b0}"
        case .moveCallOutLaptopBold: return "\u{f6b1}"
        case .moveCallOutLaptopLight: return "\u{f6b2}"
        case .moveCallOutLaptopRegular: return "\u{f6b3}"
        case .moveCallOutTabletBold: return "\u{f6b4}"
        case .moveCallOutTabletLight: return "\u{f6b5}"
        case .moveCallOutTabletRegular: return "\u{f6b6}"
        case .msTeams: return "\u{f6b7}"
        case .multilineChartBold: return "\u{f6b8}"
        case .multilineChartFilled: return "\u{f6b9}"
        case .multilineChartLight: return "\u{f6ba}"
        case .multilineChartRegular: return "\u{f6bb}"
        case .multimediaBold: return "\u{f6bc}"
        case .multimediaFilled: return "\u{f6bd}"
        case .multimediaLight: return "\u{f6be}"
        case .multimediaRegular: return "\u{f6bf}"
        case .multipledDevicesBold: return "\u{f6c0}"
        case .multipledDevicesLight: return "\u{f6c1}"
        case .multipledDevicesRegular: return "\u{f6c2}"
        case .musicModeBold: return "\u{f6c3}"
        case .musicModeCircleBold: return "\u{f6c4}"
        case .musicModeCircleFilled: return "\u{f6c5}"
        case .musicModeCircleLight: return "\u{f6c6}"
        case .musicModeCircleRegular: return "\u{f6c7}"
        case .musicModeFilled: return "\u{f6c8}"
        case .musicModeLight: return "\u{f6c9}"
        case .musicModeRegular: return "\u{f6ca}"
        case .muteOnEntryBold: return "\u{f6cb}"
        case .muteOnEntryFilled: return "\u{f6cc}"
        case .muteOnEntryLight: return "\u{f6cd}"
        case .muteOnEntryRegular: return "\u{f6ce}"
        case .newManagerBold: return "\u{f6cf}"
        case .newManagerLight: return "\u{f6d0}"
        case .newManagerRegular: return "\u{f6d1}"
        case .newTitleBold: return "\u{f6d2}"
        case .newTitleLight: return "\u{f6d3}"
        case .newTitleRegular: return "\u{f6d4}"
        case .newVoicemailBold: return "\u{f6d5}"
        case .newVoicemailLight: return "\u{f6d6}"
        case .newVoicemailRegular: return "\u{f6d7}"
        case .newWhiteboardBold: return "\u{f6d8}"
        case .newWhiteboardLight: return "\u{f6d9}"
        case .newWhiteboardRegular: return "\u{f6da}"
        case .nextBold: return "\u{f6db}"
        case .nextLight: return "\u{f6dc}"
        case .nextRegular: return "\u{f6dd}"
        case .noDevicesBold: return "\u{f6de}"
        case .noDevicesLight: return "\u{f6df}"
        case .noDevicesRegular: return "\u{f6e0}"
        case .noiseDetectedCanceledFilled: return "\u{f6e1}"
        case .noiseDetectedFilled: return "\u{f6e2}"
        case .noiseNoneCanceledFilled: return "\u{f6e3}"
        case .noiseNoneFilled: return "\u{f6e4}"
        case .noiseRemovalBold: return "\u{f6e5}"
        case .noiseRemovalLight: return "\u{f6e6}"
        case .noiseRemovalRegular: return "\u{f6e7}"
        case .noteBold: return "\u{f6e8}"
        case .noteLight: return "\u{f6e9}"
        case .notePptBold: return "\u{f6ea}"
        case .notePptLight: return "\u{f6eb}"
        case .notePptRegular: return "\u{f6ec}"
        case .noteRegular: return "\u{f6ed}"
        case .notesBold: return "\u{f6ee}"
        case .notesLight: return "\u{f6ef}"
        case .notesRegular: return "\u{f6f0}"
        case .numberBold: return "\u{f6f1}"
        case .numberLight: return "\u{f6f2}"
        case .numberRegular: return "\u{f6f3}"
        case .oldRemoteBold: return "\u{f6f4}"
        case .oldRemoteLight: return "\u{f6f5}"
        case .oldRemoteRegular: return "\u{f6f6}"
        case .oldTouchBold: return "\u{f6f7}"
        case .oldTouchLight: return "\u{f6f8}"
        case .oldTouchRegular: return "\u{f6f9}"
        case .oneColumnBold: return "\u{f6fa}"
        case .oneColumnLight: return "\u{f6fb}"
        case .oneColumnRegular: return "\u{f6fc}"
        case .openInFolderBold: return "\u{f6fd}"
        case .openInFolderLight: return "\u{f6fe}"
        case .openInFolderRegular: return "\u{f6ff}"
        case .openPagesBold: return "\u{f700}"
        case .openPagesLight: return "\u{f701}"
        case .openPagesRegular: return "\u{f702}"
        case .otherNumberBold: return "\u{f703}"
        case .otherNumberLight: return "\u{f704}"
        case .otherNumberRegular: return "\u{f705}"
        case .otherNumberWarningBold: return "\u{f706}"
        case .otherNumberWarningLight: return "\u{f707}"
        case .otherNumberWarningRegular: return "\u{f708}"
        case .outgoingCallLegacyBold: return "\u{f709}"
        case .outgoingCallLegacyLight: return "\u{f70a}"
        case .outgoingCallLegacyRegular: return "\u{f70b}"
        case .overflowLeftBold: return "\u{f70c}"
        case .overflowLeftLight: return "\u{f70d}"
        case .overflowLeftRegular: return "\u{f70e}"
        case .overflowRightBold: return "\u{f70f}"
        case .overflowRightLight: return "\u{f710}"
        case .overflowRightRegular: return "\u{f711}"
        case .pairedCameraBold: return "\u{f712}"
        case .pairedCameraLight: return "\u{f713}"
        case .pairedCameraRegular: return "\u{f714}"
        case .pairedDeviceBold: return "\u{f715}"
        case .pairedDeviceLight: return "\u{f716}"
        case .pairedDeviceRegular: return "\u{f717}"
        case .pairedHandsetBold: return "\u{f718}"
        case .pairedHandsetLight: return "\u{f719}"
        case .pairedHandsetRegular: return "\u{f71a}"
        case .pairingBold: return "\u{f71b}"
        case .pairingLight: return "\u{f71c}"
        case .pairingRegular: return "\u{f71d}"
        case .parkedBold: return "\u{f71e}"
        case .parkedFilled: return "\u{f71f}"
        case .parkedLight: return "\u{f720}"
        case .parkedRegular: return "\u{f721}"
        case .parseBold: return "\u{f722}"
        case .parseLight: return "\u{f723}"
        case .parseRegular: return "\u{f724}"
        case .partialBold: return "\u{f725}"
        case .partialLight: return "\u{f726}"
        case .partialRegular: return "\u{f727}"
        case .participantAddBold: return "\u{f728}"
        case .participantAddLight: return "\u{f729}"
        case .participantAddRegular: return "\u{f72a}"
        case .participantBlockedBold: return "\u{f72b}"
        case .participantBlockedLight: return "\u{f72c}"
        case .participantBlockedRegular: return "\u{f72d}"
        case .participantBold: return "\u{f72e}"
        case .participantFilled: return "\u{f72f}"
        case .participantLight: return "\u{f730}"
        case .participantListBold: return "\u{f731}"
        case .participantListFilled: return "\u{f732}"
        case .participantListLight: return "\u{f733}"
        case .participantListRegular: return "\u{f734}"
        case .participantRegular: return "\u{f735}"
        case .participantRemoveBold: return "\u{f736}"
        case .participantRemoveLight: return "\u{f737}"
        case .participantRemoveRegular: return "\u{f738}"
        case .participantUnknownBold: return "\u{f739}"
        case .participantUnknownLight: return "\u{f73a}"
        case .participantUnknownRegular: return "\u{f73b}"
        case .passMouseBold: return "\u{f73c}"
        case .passMouseLight: return "\u{f73d}"
        case .passMouseRegular: return "\u{f73e}"
        case .pauseBold: return "\u{f73f}"
        case .pauseFilled: return "\u{f740}"
        case .pauseLight: return "\u{f741}"
        case .pauseRegular: return "\u{f742}"
        case .penBold: return "\u{f743}"
        case .penFilled: return "\u{f744}"
        case .penLight: return "\u{f745}"
        case .penRegular: return "\u{f746}"
        case .peopleBold: return "\u{f747}"
        case .peopleCircleBold: return "\u{f748}"
        case .peopleCircleFilled: return "\u{f749}"
        case .peopleCircleLight: return "\u{f74a}"
        case .peopleCircleRegular: return "\u{f74b}"
        case .peopleFilled: return "\u{f74c}"
        case .peopleInsightsFilled: return "\u{f74d}"
        case .peopleLight: return "\u{f74e}"
        case .peopleRegular: return "\u{f74f}"
        case .phoneAlertBold: return "\u{f750}"
        case .phoneAlertLight: return "\u{f751}"
        case .phoneAlertRegular: return "\u{f752}"
        case .phoneBold: return "\u{f753}"
        case .phoneFilled: return "\u{f754}"
        case .phoneLight: return "\u{f755}"
        case .phoneMutedBold: return "\u{f756}"
        case .phoneMutedLight: return "\u{f757}"
        case .phoneMutedRegular: return "\u{f758}"
        case .phonePrivateBold: return "\u{f759}"
        case .phonePrivateLight: return "\u{f75a}"
        case .phonePrivateRegular: return "\u{f75b}"
        case .phoneRegular: return "\u{f75c}"
        case .phoneReplyAllBold: return "\u{f75d}"
        case .phoneReplyAllLight: return "\u{f75e}"
        case .phoneReplyAllRegular: return "\u{f75f}"
        case .phoneReplyBold: return "\u{f760}"
        case .phoneReplyLight: return "\u{f761}"
        case .phoneReplyRegular: return "\u{f762}"
        case .phoneSmallFilled: return "\u{f763}"
        case .pickerBold: return "\u{f764}"
        case .pickerLight: return "\u{f765}"
        case .pickerRegular: return "\u{f766}"
        case .pictureInPictureBold: return "\u{f767}"
        case .pictureInPictureFilled: return "\u{f768}"
        case .pictureInPictureLight: return "\u{f769}"
        case .pictureInPictureRegular: return "\u{f76a}"
        case .pieChartBold: return "\u{f76b}"
        case .pieChartFilled: return "\u{f76c}"
        case .pieChartLight: return "\u{f76d}"
        case .pieChartRegular: return "\u{f76e}"
        case .pinBold: return "\u{f76f}"
        case .pinFilled: return "\u{f770}"
        case .pinLight: return "\u{f771}"
        case .pinListActivityBold: return "\u{f772}"
        case .pinListActivityColoredBold: return "\u{f773}"
        case .pinListActivityColoredLight: return "\u{f774}"
        case .pinListActivityColoredRegular: return "\u{f775}"
        case .pinListActivityLight: return "\u{f776}"
        case .pinListActivityRegular: return "\u{f777}"
        case .pinListBold: return "\u{f778}"
        case .pinListLight: return "\u{f779}"
        case .pinListRegular: return "\u{f77a}"
        case .pinMutedBold: return "\u{f77b}"
        case .pinMutedFilled: return "\u{f77c}"
        case .pinMutedLight: return "\u{f77d}"
        case .pinMutedRegular: return "\u{f77e}"
        case .pinRegular: return "\u{f77f}"
        case .placeholderBold: return "\u{f780}"
        case .placeholderLight: return "\u{f781}"
        case .placeholderRegular: return "\u{f782}"
        case .playBold: return "\u{f783}"
        case .playFilled: return "\u{f784}"
        case .playLight: return "\u{f785}"
        case .playRegular: return "\u{f786}"
        case .plugAcBold: return "\u{f787}"
        case .plugAcLight: return "\u{f788}"
        case .plugAcRegular: return "\u{f789}"
        case .plusBold: return "\u{f78a}"
        case .plusCircleBold: return "\u{f78b}"
        case .plusCircleFilled: return "\u{f78c}"
        case .plusCircleLight: return "\u{f78d}"
        case .plusCircleRegular: return "\u{f78e}"
        case .plusLight: return "\u{f78f}"
        case .plusRegular: return "\u{f790}"
        case .pmrBold: return "\u{f791}"
        case .pmrFilled: return "\u{f792}"
        case .pmrLight: return "\u{f793}"
        case .pmrRegular: return "\u{f794}"
        case .pollBold: return "\u{f795}"
        case .pollLight: return "\u{f796}"
        case .pollRegular: return "\u{f797}"
        case .popInBold: return "\u{f798}"
        case .popInLight: return "\u{f799}"
        case .popInRegular: return "\u{f79a}"
        case .popOutBold: return "\u{f79b}"
        case .popOutLight: return "\u{f79c}"
        case .popOutRegular: return "\u{f79d}"
        case .popUpBold: return "\u{f79e}"
        case .popUpLight: return "\u{f79f}"
        case .popUpRegular: return "\u{f7a0}"
        case .portraitLandscapeBold: return "\u{f7a1}"
        case .portraitLandscapeLight: return "\u{f7a2}"
        case .portraitLandscapeRegular: return "\u{f7a3}"
        case .powerAcBold: return "\u{f7a4}"
        case .powerAcLight: return "\u{f7a5}"
        case .powerAcRegular: return "\u{f7a6}"
        case .powerBold: return "\u{f7a7}"
        case .powerLight: return "\u{f7a8}"
        case .powerRegular: return "\u{f7a9}"
        case .preHeaderBold: return "\u{f7aa}"
        case .preHeaderLight: return "\u{f7ab}"
        case .preHeaderRegular: return "\u{f7ac}"
        case .presentationBold: return "\u{f7ad}"
        case .presentationLight: return "\u{f7ae}"
        case .presentationRegular: return "\u{f7af}"
        case .primaryParticipantBold: return "\u{f7b0}"
        case .primaryParticipantLight: return "\u{f7b1}"
        case .primaryParticipantRegular: return "\u{f7b2}"
        case .printBold: return "\u{f7b3}"
        case .printLight: return "\u{f7b4}"
        case .printRegular: return "\u{f7b5}"
        case .priorityBadgeFilled: return "\u{f7b6}"
        case .priorityCircleBold: return "\u{f7b7}"
        case .priorityCircleFilled: return "\u{f7b8}"
        case .priorityCircleLight: return "\u{f7b9}"
        case .priorityCircleRegular: return "\u{f7ba}"
        case .priorityCircleTwoBold: return "\u{f7bb}"
        case .priorityCircleTwoFilled: return "\u{f7bc}"
        case .priorityCircleTwoLight: return "\u{f7bd}"
        case .priorityCircleTwoRegular: return "\u{f7be}"
        case .privacyCircleBold: return "\u{f7bf}"
        case .privacyCircleFilled: return "\u{f7c0}"
        case .privacyCircleLight: return "\u{f7c1}"
        case .privacyCircleRegular: return "\u{f7c2}"
        case .privateBold: return "\u{f7c3}"
        case .privateCircleBold: return "\u{f7c4}"
        case .privateCircleFilled: return "\u{f7c5}"
        case .privateCircleLight: return "\u{f7c6}"
        case .privateCircleRegular: return "\u{f7c7}"
        case .privateLight: return "\u{f7c8}"
        case .privateMeetingBold: return "\u{f7c9}"
        case .privateMeetingLight: return "\u{f7ca}"
        case .privateMeetingRegular: return "\u{f7cb}"
        case .privateRegular: return "\u{f7cc}"
        case .productDemoBold: return "\u{f7cd}"
        case .productDemoLight: return "\u{f7ce}"
        case .productDemoRegular: return "\u{f7cf}"
        case .proximityBold: return "\u{f7d0}"
        case .proximityLight: return "\u{f7d1}"
        case .proximityMutedBold: return "\u{f7d2}"
        case .proximityMutedLight: return "\u{f7d3}"
        case .proximityMutedRegular: return "\u{f7d4}"
        case .proximityRegular: return "\u{f7d5}"
        case .proximityVideoBold: return "\u{f7d6}"
        case .proximityVideoLight: return "\u{f7d7}"
        case .proximityVideoRegular: return "\u{f7d8}"
        case .ptoPresenceBold: return "\u{f7d9}"
        case .ptoPresenceFilled: return "\u{f7da}"
        case .ptoPresenceLight: return "\u{f7db}"
        case .ptoPresenceRegular: return "\u{f7dc}"
        case .pullCallBold: return "\u{f7dd}"
        case .pullCallLight: return "\u{f7de}"
        case .pullCallRegular: return "\u{f7df}"
        case .qABold: return "\u{f7e0}"
        case .qALight: return "\u{f7e1}"
        case .qARegular: return "\u{f7e2}"
        case .qualityBold: return "\u{f7e3}"
        case .qualityLight: return "\u{f7e4}"
        case .qualityRegular: return "\u{f7e5}"
        case .queueContactBold: return "\u{f7e6}"
        case .queueContactLight: return "\u{f7e7}"
        case .queueContactRegular: return "\u{f7e8}"
        case .quietBold: return "\u{f7e9}"
        case .quietHoursPresenceBold: return "\u{f7ea}"
        case .quietHoursPresenceFilled: return "\u{f7eb}"
        case .quietHoursPresenceLight: return "\u{f7ec}"
        case .quietHoursPresenceRegular: return "\u{f7ed}"
        case .quietLight: return "\u{f7ee}"
        case .quietRegular: return "\u{f7ef}"
        case .radioButtonGroupBold: return "\u{f7f0}"
        case .radioButtonGroupLight: return "\u{f7f1}"
        case .radioButtonGroupRegular: return "\u{f7f2}"
        case .raiseHandBold: return "\u{f7f3}"
        case .raiseHandFilled: return "\u{f7f4}"
        case .raiseHandLight: return "\u{f7f5}"
        case .raiseHandRegular: return "\u{f7f6}"
        case .ramBold: return "\u{f7f7}"
        case .ramLight: return "\u{f7f8}"
        case .ramRegular: return "\u{f7f9}"
        case .reactionsBold: return "\u{f7fa}"
        case .reactionsFilled: return "\u{f7fb}"
        case .reactionsLight: return "\u{f7fc}"
        case .reactionsRegular: return "\u{f7fd}"
        case .reactivateBold: return "\u{f7fe}"
        case .reactivateLight: return "\u{f7ff}"
        case .reactivateRegular: return "\u{f800}"
        case .recentsBold: return "\u{f801}"
        case .recentsFilled: return "\u{f802}"
        case .recentsLight: return "\u{f803}"
        case .recentsPresenceBold: return "\u{f804}"
        case .recentsPresenceFilled: return "\u{f805}"
        case .recentsPresenceLight: return "\u{f806}"
        case .recentsPresenceRegular: return "\u{f807}"
        case .recentsPresenceSmallFilled: return "\u{f808}"
        case .recentsRegular: return "\u{f809}"
        case .recordActiveBold: return "\u{f80a}"
        case .recordActiveFilled: return "\u{f80b}"
        case .recordActiveLight: return "\u{f80c}"
        case .recordActiveRegular: return "\u{f80d}"
        case .recordBold: return "\u{f80e}"
        case .recordFilled: return "\u{f80f}"
        case .recordLight: return "\u{f810}"
        case .recordPausedBold: return "\u{f811}"
        case .recordPausedFilled: return "\u{f812}"
        case .recordPausedLight: return "\u{f813}"
        case .recordPausedRegular: return "\u{f814}"
        case .recordRegular: return "\u{f815}"
        case .recurringBold: return "\u{f816}"
        case .recurringLight: return "\u{f817}"
        case .recurringOffBold: return "\u{f818}"
        case .recurringOffLight: return "\u{f819}"
        case .recurringOffRegular: return "\u{f81a}"
        case .recurringRegular: return "\u{f81b}"
        case .redialBold: return "\u{f81c}"
        case .redialLight: return "\u{f81d}"
        case .redialRegular: return "\u{f81e}"
        case .redoBold: return "\u{f81f}"
        case .redoLight: return "\u{f820}"
        case .redoRegular: return "\u{f821}"
        case .refreshBold: return "\u{f822}"
        case .refreshLight: return "\u{f823}"
        case .refreshRegular: return "\u{f824}"
        case .remoteCallBold: return "\u{f825}"
        case .remoteCallFilled: return "\u{f826}"
        case .remoteCallLight: return "\u{f827}"
        case .remoteCallRegular: return "\u{f828}"
        case .remoteDesktopControlBold: return "\u{f829}"
        case .remoteDesktopControlFilled: return "\u{f82a}"
        case .remoteDesktopControlLight: return "\u{f82b}"
        case .remoteDesktopControlRegular: return "\u{f82c}"
        case .removeBold: return "\u{f82d}"
        case .removeFilled: return "\u{f82e}"
        case .removeLight: return "\u{f82f}"
        case .removeRegular: return "\u{f830}"
        case .replyBold: return "\u{f831}"
        case .replyFilled: return "\u{f832}"
        case .replyLight: return "\u{f833}"
        case .replyListBold: return "\u{f834}"
        case .replyListLight: return "\u{f835}"
        case .replyListRegular: return "\u{f836}"
        case .replyPrivatelyBold: return "\u{f837}"
        case .replyPrivatelyLight: return "\u{f838}"
        case .replyPrivatelyRegular: return "\u{f839}"
        case .replyRegular: return "\u{f83a}"
        case .resetBold: return "\u{f83b}"
        case .resetLight: return "\u{f83c}"
        case .resetRegular: return "\u{f83d}"
        case .responsiveMobileBold: return "\u{f83e}"
        case .responsiveMobileLight: return "\u{f83f}"
        case .responsiveMobileRegular: return "\u{f840}"
        case .restartBold: return "\u{f841}"
        case .restartLight: return "\u{f842}"
        case .restartRegular: return "\u{f843}"
        case .retrieveCallBold: return "\u{f844}"
        case .retrieveCallLight: return "\u{f845}"
        case .retrieveCallRegular: return "\u{f846}"
        case .returnBold: return "\u{f847}"
        case .returnLight: return "\u{f848}"
        case .returnRegular: return "\u{f849}"
        case .ringtoneBold: return "\u{f84a}"
        case .ringtoneLight: return "\u{f84b}"
        case .ringtoneRegular: return "\u{f84c}"
        case .roomCalendarBold: return "\u{f84d}"
        case .roomCalendarLight: return "\u{f84e}"
        case .roomCalendarRegular: return "\u{f84f}"
        case .roomLightsBold: return "\u{f850}"
        case .roomLightsFilled: return "\u{f851}"
        case .roomLightsLight: return "\u{f852}"
        case .roomLightsRegular: return "\u{f853}"
        case .rotateContentBold: return "\u{f854}"
        case .rotateContentFilled: return "\u{f855}"
        case .rotateContentLight: return "\u{f856}"
        case .rotateContentRegular: return "\u{f857}"
        case .ruleBasedBold: return "\u{f858}"
        case .ruleBasedLight: return "\u{f859}"
        case .ruleBasedRegular: return "\u{f85a}"
        case .runningApplicationBold: return "\u{f85b}"
        case .runningApplicationFilled: return "\u{f85c}"
        case .runningApplicationLight: return "\u{f85d}"
        case .runningApplicationRegular: return "\u{f85e}"
        case .saveBold: return "\u{f85f}"
        case .saveLight: return "\u{f860}"
        case .saveRegular: return "\u{f861}"
        case .scanBold: return "\u{f862}"
        case .scanLight: return "\u{f863}"
        case .scanRegular: return "\u{f864}"
        case .schedulerAvailableBold: return "\u{f865}"
        case .schedulerAvailableLight: return "\u{f866}"
        case .schedulerAvailableRegular: return "\u{f867}"
        case .schedulerNotWorkingHoursBold: return "\u{f868}"
        case .schedulerNotWorkingHoursLight: return "\u{f869}"
        case .schedulerNotWorkingHoursRegular: return "\u{f86a}"
        case .schedulerUnavailableBold: return "\u{f86b}"
        case .schedulerUnavailableLight: return "\u{f86c}"
        case .schedulerUnavailableRegular: return "\u{f86d}"
        case .schedulerUnknownBold: return "\u{f86e}"
        case .schedulerUnknownLight: return "\u{f86f}"
        case .schedulerUnknownRegular: return "\u{f870}"
        case .screenshotBold: return "\u{f871}"
        case .screenshotDocBold: return "\u{f872}"
        case .screenshotDocFilled: return "\u{f873}"
        case .screenshotDocLight: return "\u{f874}"
        case .screenshotDocRegular: return "\u{f875}"
        case .screenshotLight: return "\u{f876}"
        case .screenshotRegular: return "\u{f877}"
        case .searchBold: return "\u{f878}"
        case .searchFilled: return "\u{f879}"
        case .searchLight: return "\u{f87a}"
        case .searchRegular: return "\u{f87b}"
        case .secondaryArrowBold: return "\u{f87c}"
        case .secondaryArrowLight: return "\u{f87d}"
        case .secondaryArrowRegular: return "\u{f87e}"
        case .secureCallLockBold: return "\u{f87f}"
        case .secureCallLockFilled: return "\u{f880}"
        case .secureCallLockLight: return "\u{f881}"
        case .secureCallLockRegular: return "\u{f882}"
        case .secureCallShieldBold: return "\u{f883}"
        case .secureCallShieldFilled: return "\u{f884}"
        case .secureCallShieldLight: return "\u{f885}"
        case .secureCallShieldRegular: return "\u{f886}"
        case .secureCircleBold: return "\u{f887}"
        case .secureCircleFilled: return "\u{f888}"
        case .secureCircleLight: return "\u{f889}"
        case .secureCircleRegular: return "\u{f88a}"
        case .secureLockBold: return "\u{f88b}"
        case .secureLockFilled: return "\u{f88c}"
        case .secureLockLight: return "\u{f88d}"
        case .secureLockRegular: return "\u{f88e}"
        case .selectAllBold: return "\u{f88f}"
        case .selectAllFilled: return "\u{f890}"
        case .selectAllLight: return "\u{f891}"
        case .selectAllRegular: return "\u{f892}"
        case .selectionBold: return "\u{f893}"
        case .selectionLight: return "\u{f894}"
        case .selectionRegular: return "\u{f895}"
        case .sendBold: return "\u{f896}"
        case .sendFilled: return "\u{f897}"
        case .sendLight: return "\u{f898}"
        case .sendRegular: return "\u{f899}"
        case .serverBold: return "\u{f89a}"
        case .serverErrorBold: return "\u{f89b}"
        case .serverErrorLight: return "\u{f89c}"
        case .serverErrorRegular: return "\u{f89d}"
        case .serverLight: return "\u{f89e}"
        case .serverRegular: return "\u{f89f}"
        case .servicesBold: return "\u{f8a0}"
        case .servicesLight: return "\u{f8a1}"
        case .servicesRegular: return "\u{f8a2}"
        case .setVariableBold: return "\u{f8a3}"
        case .setVariableLight: return "\u{f8a4}"
        case .setVariableRegular: return "\u{f8a5}"
        case .settingsBold: return "\u{f8a6}"
        case .settingsFilled: return "\u{f8a7}"
        case .settingsLight: return "\u{f8a8}"
        case .settingsRegular: return "\u{f8a9}"
        case .setupAssistantBold: return "\u{f8aa}"
        case .setupAssistantLight: return "\u{f8ab}"
        case .setupAssistantRegular: return "\u{f8ac}"
        case .sftpBold: return "\u{f8ad}"
        case .sftpLight: return "\u{f8ae}"
        case .sftpRegular: return "\u{f8af}"
        case .shapeCircleBold: return "\u{f8b0}"
        case .shapeCircleFilled: return "\u{f8b1}"
        case .shapeCircleLight: return "\u{f8b2}"
        case .shapeCircleRegular: return "\u{f8b3}"
        case .shapeDiagonalLineBold: return "\u{f8b4}"
        case .shapeDiagonalLineLight: return "\u{f8b5}"
        case .shapeDiagonalLineRegular: return "\u{f8b6}"
        case .shapeDiamondBold: return "\u{f8b7}"
        case .shapeDiamondFilled: return "\u{f8b8}"
        case .shapeDiamondLight: return "\u{f8b9}"
        case .shapeDiamondRegular: return "\u{f8ba}"
        case .shapeOvalBold: return "\u{f8bb}"
        case .shapeOvalLight: return "\u{f8bc}"
        case .shapeOvalRegular: return "\u{f8bd}"
        case .shapeSquareBold: return "\u{f8be}"
        case .shapeSquareFilled: return "\u{f8bf}"
        case .shapeSquareLight: return "\u{f8c0}"
        case .shapeSquareRegular: return "\u{f8c1}"
        case .shapeTriangleBold: return "\u{f8c2}"
        case .shapeTriangleFilled: return "\u{f8c3}"
        case .shapeTriangleLight: return "\u{f8c4}"
        case .shapeTriangleRegular: return "\u{f8c5}"
        case .shapesBold: return "\u{f8c6}"
        case .shapesLight: return "\u{f8c7}"
        case .shapesRegular: return "\u{f8c8}"
        case .shareCNativeAdrBold: return "\u{f8c9}"
        case .shareCNativeAdrLight: return "\u{f8ca}"
        case .shareCNativeAdrRegular: return "\u{f8cb}"
        case .shareCNativeIphBold: return "\u{f8cc}"
        case .shareCNativeIphLight: return "\u{f8cd}"
        case .shareCNativeIphRegular: return "\u{f8ce}"
        case .shareScreenBold: return "\u{f8cf}"
        case .shareScreenFilled: return "\u{f8d0}"
        case .shareScreenLight: return "\u{f8d1}"
        case .shareScreenRegular: return "\u{f8d2}"
        case .shareScreenSmallFilled: return "\u{f8d3}"
        case .shareSpaceBold: return "\u{f8d4}"
        case .shareSpaceLight: return "\u{f8d5}"
        case .shareSpaceRegular: return "\u{f8d6}"
        case .shieldBold: return "\u{f8d7}"
        case .shieldLight: return "\u{f8d8}"
        case .shieldRegular: return "\u{f8d9}"
        case .shoppingCartBold: return "\u{f8da}"
        case .shoppingCartFilled: return "\u{f8db}"
        case .shoppingCartLight: return "\u{f8dc}"
        case .shoppingCartRegular: return "\u{f8dd}"
        case .shortTextBoxBold: return "\u{f8de}"
        case .shortTextBoxLight: return "\u{f8df}"
        case .shortTextBoxRegular: return "\u{f8e0}"
        case .showBold: return "\u{f8e1}"
        case .showFilled: return "\u{f8e2}"
        case .showLight: return "\u{f8e3}"
        case .showRegular: return "\u{f8e4}"
        case .signInBold: return "\u{f8e5}"
        case .signInFilled: return "\u{f8e6}"
        case .signInForcedBold: return "\u{f8e7}"
        case .signInForcedLight: return "\u{f8e8}"
        case .signInForcedRegular: return "\u{f8e9}"
        case .signInLight: return "\u{f8ea}"
        case .signInRegular: return "\u{f8eb}"
        case .signOutBold: return "\u{f8ec}"
        case .signOutLight: return "\u{f8ed}"
        case .signOutRegular: return "\u{f8ee}"
        case .signal0Bold: return "\u{f8ef}"
        case .signal0Light: return "\u{f8f0}"
        case .signal0Regular: return "\u{f8f1}"
        case .signal100Bold: return "\u{f8f2}"
        case .signal100Light: return "\u{f8f3}"
        case .signal100Regular: return "\u{f8f4}"
        case .signal25Bold: return "\u{f8f5}"
        case .signal25Light: return "\u{f8f6}"
        case .signal25Regular: return "\u{f8f7}"
        case .signal50Bold: return "\u{f8f8}"
        case .signal50Light: return "\u{f8f9}"
        case .signal50Regular: return "\u{f8fa}"
        case .signal75Bold: return "\u{f8fb}"
        case .signal75Light: return "\u{f8fc}"
        case .signal75Regular: return "\u{f8fd}"
        case .simplePromotionBold: return "\u{f8fe}"
        case .simplePromotionLight: return "\u{f8ff}"
        case .simplePromotionRegular: return "\u{f900}"
        case .singleNumberReachBold: return "\u{f901}"
        case .singleNumberReachLight: return "\u{f902}"
        case .singleNumberReachRegular: return "\u{f903}"
        case .sipRegistrationInProgressBold: return "\u{f904}"
        case .sipRegistrationInProgressFilled: return "\u{f905}"
        case .sipRegistrationInProgressLight: return "\u{f906}"
        case .sipRegistrationInProgressRegular: return "\u{f907}"
        case .skipBold: return "\u{f908}"
        case .skipBwBold: return "\u{f909}"
        case .skipBwFilled: return "\u{f90a}"
        case .skipBwLight: return "\u{f90b}"
        case .skipBwRegular: return "\u{f90c}"
        case .skipFwBold: return "\u{f90d}"
        case .skipFwFilled: return "\u{f90e}"
        case .skipFwLight: return "\u{f90f}"
        case .skipFwRegular: return "\u{f910}"
        case .skipLight: return "\u{f911}"
        case .skipRegular: return "\u{f912}"
        case .smsInboundBold: return "\u{f913}"
        case .smsInboundLight: return "\u{f914}"
        case .smsInboundRegular: return "\u{f915}"
        case .smsMessageBold: return "\u{f916}"
        case .smsMessageFilled: return "\u{f917}"
        case .smsMessageLight: return "\u{f918}"
        case .smsMessageRegular: return "\u{f919}"
        case .socialAlexaFilled: return "\u{f91a}"
        case .socialFacebookColoredFilled: return "\u{f91b}"
        case .socialFacebookFilled: return "\u{f91c}"
        case .socialFbmessengerColoredFilled: return "\u{f91d}"
        case .socialFbmessengerFilled: return "\u{f91e}"
        case .socialInstagramBold: return "\u{f91f}"
        case .socialMicrosoftColoredFilled: return "\u{f920}"
        case .socialMicrosoftFilled: return "\u{f921}"
        case .socialMmsFilled: return "\u{f922}"
        case .socialMmsGoldFilled: return "\u{f923}"
        case .socialSmsFilled: return "\u{f924}"
        case .socialSmsMintFilled: return "\u{f925}"
        case .socialTwitterColoredFilled: return "\u{f926}"
        case .socialTwitterFilled: return "\u{f927}"
        case .socialViberBold: return "\u{f928}"
        case .socialViberColoredBold: return "\u{f929}"
        case .socialWhatsappBold: return "\u{f92a}"
        case .socialWhatsappColoredFilled: return "\u{f92b}"
        case .sortAscendingBold: return "\u{f92c}"
        case .sortAscendingLight: return "\u{f92d}"
        case .sortAscendingRegular: return "\u{f92e}"
        case .sortDescendingBold: return "\u{f92f}"
        case .sortDescendingLight: return "\u{f930}"
        case .sortDescendingRegular: return "\u{f931}"
        case .soundDefaultBold: return "\u{f932}"
        case .soundDefaultLight: return "\u{f933}"
        case .soundDefaultRegular: return "\u{f934}"
        case .speakerBold: return "\u{f935}"
        case .speakerDisconnectedBold: return "\u{f936}"
        case .speakerDisconnectedFilled: return "\u{f937}"
        case .speakerDisconnectedLight: return "\u{f938}"
        case .speakerDisconnectedRegular: return "\u{f939}"
        case .speakerFilled: return "\u{f93a}"
        case .speakerLight: return "\u{f93b}"
        case .speakerMutedBold: return "\u{f93c}"
        case .speakerMutedFilled: return "\u{f93d}"
        case .speakerMutedLight: return "\u{f93e}"
        case .speakerMutedRegular: return "\u{f93f}"
        case .speakerOffBold: return "\u{f940}"
        case .speakerOffFilled: return "\u{f941}"
        case .speakerOffLight: return "\u{f942}"
        case .speakerOffRegular: return "\u{f943}"
        case .speakerOnColoredBold: return "\u{f944}"
        case .speakerOnColoredLight: return "\u{f945}"
        case .speakerOnColoredRegular: return "\u{f946}"
        case .speakerRegular: return "\u{f947}"
        case .speakerTurnDownBold: return "\u{f948}"
        case .speakerTurnDownFilled: return "\u{f949}"
        case .speakerTurnDownLight: return "\u{f94a}"
        case .speakerTurnDownRegular: return "\u{f94b}"
        case .speakerTurnUpBold: return "\u{f94c}"
        case .speakerTurnUpFilled: return "\u{f94d}"
        case .speakerTurnUpLight: return "\u{f94e}"
        case .speakerTurnUpRegular: return "\u{f94f}"
        case .spinnerBold: return "\u{f950}"
        case .spinnerFilledBold: return "\u{f951}"
        case .spinnerFilledLight: return "\u{f952}"
        case .spinnerFilledRegular: return "\u{f953}"
        case .spinnerLight: return "\u{f954}"
        case .spinnerPartialBold: return "\u{f955}"
        case .spinnerPartialLight: return "\u{f956}"
        case .spinnerPartialRegular: return "\u{f957}"
        case .spinnerRegular: return "\u{f958}"
        case .stackedArea100ChartBold: return "\u{f959}"
        case .stackedArea100ChartFilled: return "\u{f95a}"
        case .stackedArea100ChartLight: return "\u{f95b}"
        case .stackedArea100ChartRegular: return "\u{f95c}"
        case .stackedAreaChartBold: return "\u{f95d}"
        case .stackedAreaChartFilled: return "\u{f95e}"
        case .stackedAreaChartLight: return "\u{f95f}"
        case .stackedAreaChartRegular: return "\u{f960}"
        case .stackedBar100ChartBold: return "\u{f961}"
        case .stackedBar100ChartFilled: return "\u{f962}"
        case .stackedBar100ChartLight: return "\u{f963}"
        case .stackedBar100ChartRegular: return "\u{f964}"
        case .stackedBarChartBold: return "\u{f965}"
        case .stackedBarChartFilled: return "\u{f966}"
        case .stackedBarChartLight: return "\u{f967}"
        case .stackedBarChartRegular: return "\u{f968}"
        case .startChatBold: return "\u{f969}"
        case .startChatLight: return "\u{f96a}"
        case .startChatRegular: return "\u{f96b}"
        case .stethoscopeBold: return "\u{f96c}"
        case .stethoscopeLight: return "\u{f96d}"
        case .stethoscopeRegular: return "\u{f96e}"
        case .stickersBold: return "\u{f96f}"
        case .stickersLight: return "\u{f970}"
        case .stickersRegular: return "\u{f971}"
        case .stickiesBold: return "\u{f972}"
        case .stickiesLight: return "\u{f973}"
        case .stickiesRegular: return "\u{f974}"
        case .stopBold: return "\u{f975}"
        case .stopCircleBold: return "\u{f976}"
        case .stopCircleFilled: return "\u{f977}"
        case .stopCircleLight: return "\u{f978}"
        case .stopCircleRegular: return "\u{f979}"
        case .stopContentShareBold: return "\u{f97a}"
        case .stopContentShareLight: return "\u{f97b}"
        case .stopContentShareRegular: return "\u{f97c}"
        case .stopFilled: return "\u{f97d}"
        case .stopLight: return "\u{f97e}"
        case .stopRegular: return "\u{f97f}"
        case .storedInfoBold: return "\u{f980}"
        case .storedInfoFilled: return "\u{f981}"
        case .storedInfoLight: return "\u{f982}"
        case .storedInfoRegular: return "\u{f983}"
        case .streamingBold: return "\u{f984}"
        case .streamingLight: return "\u{f985}"
        case .streamingRegular: return "\u{f986}"
        case .strikethroughBold: return "\u{f987}"
        case .strikethroughLight: return "\u{f988}"
        case .strikethroughRegular: return "\u{f989}"
        case .subscriptBold: return "\u{f98a}"
        case .subscriptLight: return "\u{f98b}"
        case .subscriptRegular: return "\u{f98c}"
        case .superscriptBold: return "\u{f98d}"
        case .superscriptLight: return "\u{f98e}"
        case .superscriptRegular: return "\u{f98f}"
        case .surveyBold: return "\u{f990}"
        case .surveyFilled: return "\u{f991}"
        case .surveyLight: return "\u{f992}"
        case .surveyRegular: return "\u{f993}"
        case .sx10Bold: return "\u{f994}"
        case .sx10Light: return "\u{f995}"
        case .sx10Regular: return "\u{f996}"
        case .sx20Bold: return "\u{f997}"
        case .sx20Light: return "\u{f998}"
        case .sx20Regular: return "\u{f999}"
        case .sx80CodecBold: return "\u{f99a}"
        case .sx80CodecLight: return "\u{f99b}"
        case .sx80CodecRegular: return "\u{f99c}"
        case .tableBold: return "\u{f99d}"
        case .tableLight: return "\u{f99e}"
        case .tableRegular: return "\u{f99f}"
        case .tabletBold: return "\u{f9a0}"
        case .tabletLight: return "\u{f9a1}"
        case .tabletRegular: return "\u{f9a2}"
        case .tabsBold: return "\u{f9a3}"
        case .tabsLight: return "\u{f9a4}"
        case .tabsRegular: return "\u{f9a5}"
        case .tagBold: return "\u{f9a6}"
        case .tagLight: return "\u{f9a7}"
        case .tagRegular: return "\u{f9a8}"
        case .tapBold: return "\u{f9a9}"
        case .tapFilled: return "\u{f9aa}"
        case .tapLight: return "\u{f9ab}"
        case .tapRegular: return "\u{f9ac}"
        case .telepresenceAlertBold: return "\u{f9ad}"
        case .telepresenceAlertLight: return "\u{f9ae}"
        case .telepresenceAlertMutedBold: return "\u{f9af}"
        case .telepresenceAlertMutedLight: return "\u{f9b0}"
        case .telepresenceAlertMutedRegular: return "\u{f9b1}"
        case .telepresenceAlertRegular: return "\u{f9b2}"
        case .telepresenceBold: return "\u{f9b3}"
        case .telepresenceIx5000Bold: return "\u{f9b4}"
        case .telepresenceIx5000Light: return "\u{f9b5}"
        case .telepresenceIx5000Regular: return "\u{f9b6}"
        case .telepresenceLight: return "\u{f9b7}"
        case .telepresencePrivateBold: return "\u{f9b8}"
        case .telepresencePrivateLight: return "\u{f9b9}"
        case .telepresencePrivateRegular: return "\u{f9ba}"
        case .telepresenceRegular: return "\u{f9bb}"
        case .temperatureBold: return "\u{f9bc}"
        case .temperatureLight: return "\u{f9bd}"
        case .temperatureRegular: return "\u{f9be}"
        case .textAlignCenterBold: return "\u{f9bf}"
        case .textAlignCenterFilled: return "\u{f9c0}"
        case .textAlignCenterLight: return "\u{f9c1}"
        case .textAlignCenterRegular: return "\u{f9c2}"
        case .textAlignLeftBold: return "\u{f9c3}"
        case .textAlignLeftFilled: return "\u{f9c4}"
        case .textAlignLeftLight: return "\u{f9c5}"
        case .textAlignLeftRegular: return "\u{f9c6}"
        case .textAlignRightBold: return "\u{f9c7}"
        case .textAlignRightFilled: return "\u{f9c8}"
        case .textAlignRightLight: return "\u{f9c9}"
        case .textAlignRightRegular: return "\u{f9ca}"
        case .textBold: return "\u{f9cb}"
        case .textCodeBlockBold: return "\u{f9cc}"
        case .textCodeBlockLight: return "\u{f9cd}"
        case .textCodeBlockRegular: return "\u{f9ce}"
        case .textHighlightBold: return "\u{f9cf}"
        case .textHighlightLight: return "\u{f9d0}"
        case .textHighlightRegular: return "\u{f9d1}"
        case .textLight: return "\u{f9d2}"
        case .textRegular: return "\u{f9d3}"
        case .threeColumnBold: return "\u{f9d4}"
        case .threeColumnLight: return "\u{f9d5}"
        case .threeColumnRegular: return "\u{f9d6}"
        case .threeDObjectBold: return "\u{f9d7}"
        case .threeDObjectLight: return "\u{f9d8}"
        case .threeDObjectRegular: return "\u{f9d9}"
        case .tooFastBold: return "\u{f9da}"
        case .tooFastLight: return "\u{f9db}"
        case .tooFastRegular: return "\u{f9dc}"
        case .tooSlowBold: return "\u{f9dd}"
        case .tooSlowLight: return "\u{f9de}"
        case .tooSlowRegular: return "\u{f9df}"
        case .toolsBold: return "\u{f9e0}"
        case .toolsLight: return "\u{f9e1}"
        case .toolsRegular: return "\u{f9e2}"
        case .touch10Bold: return "\u{f9e3}"
        case .touch10Light: return "\u{f9e4}"
        case .touch10Regular: return "\u{f9e5}"
        case .transcriptBold: return "\u{f9e6}"
        case .transcriptFilled: return "\u{f9e7}"
        case .transcriptLight: return "\u{f9e8}"
        case .transcriptRegular: return "\u{f9e9}"
        case .translateBold: return "\u{f9ea}"
        case .translateLight: return "\u{f9eb}"
        case .translateRegular: return "\u{f9ec}"
        case .trimBold: return "\u{f9ed}"
        case .trimLight: return "\u{f9ee}"
        case .trimRegular: return "\u{f9ef}"
        case .twoColumnBold: return "\u{f9f0}"
        case .twoColumnLight: return "\u{f9f1}"
        case .twoColumnRegular: return "\u{f9f2}"
        case .ucmCloudBold: return "\u{f9f3}"
        case .ucmCloudLight: return "\u{f9f4}"
        case .ucmCloudRegular: return "\u{f9f5}"
        case .underlineBold: return "\u{f9f6}"
        case .underlineLight: return "\u{f9f7}"
        case .underlineRegular: return "\u{f9f8}"
        case .undoBold: return "\u{f9f9}"
        case .undoLight: return "\u{f9fa}"
        case .undoRegular: return "\u{f9fb}"
        case .unlinkBold: return "\u{f9fc}"
        case .unlinkLight: return "\u{f9fd}"
        case .unlinkRegular: return "\u{f9fe}"
        case .unreadBold: return "\u{f9ff}"
        case .unreadFilled: return "\u{fa00}"
        case .unreadLight: return "\u{fa01}"
        case .unreadRegular: return "\u{fa02}"
        case .unsecureUnlockedBold: return "\u{fa03}"
        case .unsecureUnlockedFilled: return "\u{fa04}"
        case .unsecureUnlockedLight: return "\u{fa05}"
        case .unsecureUnlockedRegular: return "\u{fa06}"
        case .unsortedBold: return "\u{fa07}"
        case .unsortedLight: return "\u{fa08}"
        case .unsortedRegular: return "\u{fa09}"
        case .updateFileShareBold: return "\u{fa0a}"
        case .updateFileShareLight: return "\u{fa0b}"
        case .updateFileShareRegular: return "\u{fa0c}"
        case .upgradeBold: return "\u{fa0d}"
        case .upgradeFilled: return "\u{fa0e}"
        case .upgradeLight: return "\u{fa0f}"
        case .upgradeRegular: return "\u{fa10}"
        case .uploadBold: return "\u{fa11}"
        case .uploadLight: return "\u{fa12}"
        case .uploadRegular: return "\u{fa13}"
        case .urgentVoicemailBold: return "\u{fa14}"
        case .urgentVoicemailFilled: return "\u{fa15}"
        case .usbBold: return "\u{fa16}"
        case .usbHeadsetBold: return "\u{fa17}"
        case .usbHeadsetLight: return "\u{fa18}"
        case .usbHeadsetMutedBold: return "\u{fa19}"
        case .usbHeadsetMutedLight: return "\u{fa1a}"
        case .usbHeadsetMutedRegular: return "\u{fa1b}"
        case .usbHeadsetRegular: return "\u{fa1c}"
        case .usbLight: return "\u{fa1d}"
        case .usbRegular: return "\u{fa1e}"
        case .userBold: return "\u{fa1f}"
        case .userDeactivateBold: return "\u{fa20}"
        case .userDeactivateLight: return "\u{fa21}"
        case .userDeactivateRegular: return "\u{fa22}"
        case .userLight: return "\u{fa23}"
        case .userRegular: return "\u{fa24}"
        case .vcsBold: return "\u{fa25}"
        case .vcsLight: return "\u{fa26}"
        case .vcsRegular: return "\u{fa27}"
        case .videoBlurBold: return "\u{fa28}"
        case .videoBlurFilled: return "\u{fa29}"
        case .videoBlurLight: return "\u{fa2a}"
        case .videoBlurRegular: return "\u{fa2b}"
        case .videoBold: return "\u{fa2c}"
        case .videoEffectBold: return "\u{fa2d}"
        case .videoEffectFilled: return "\u{fa2e}"
        case .videoEffectLight: return "\u{fa2f}"
        case .videoEffectRegular: return "\u{fa30}"
        case .videoFilled: return "\u{fa31}"
        case .videoLayoutBold: return "\u{fa32}"
        case .videoLayoutEqualBold: return "\u{fa33}"
        case .videoLayoutEqualDualBold: return "\u{fa34}"
        case .videoLayoutEqualDualLight: return "\u{fa35}"
        case .videoLayoutEqualDualRegular: return "\u{fa36}"
        case .videoLayoutEqualFilled: return "\u{fa37}"
        case .videoLayoutEqualLight: return "\u{fa38}"
        case .videoLayoutEqualRegular: return "\u{fa39}"
        case .videoLayoutFilled: return "\u{fa3a}"
        case .videoLayoutLight: return "\u{fa3b}"
        case .videoLayoutOverlayBold: return "\u{fa3c}"
        case .videoLayoutOverlayLight: return "\u{fa3d}"
        case .videoLayoutOverlayRegular: return "\u{fa3e}"
        case .videoLayoutPresenterDominantBold: return "\u{fa3f}"
        case .videoLayoutPresenterDominantLight: return "\u{fa40}"
        case .videoLayoutPresenterDominantRegular: return "\u{fa41}"
        case .videoLayoutProminentBold: return "\u{fa42}"
        case .videoLayoutProminentFilled: return "\u{fa43}"
        case .videoLayoutProminentLight: return "\u{fa44}"
        case .videoLayoutProminentRegular: return "\u{fa45}"
        case .videoLayoutRegular: return "\u{fa46}"
        case .videoLayoutShareDominantBold: return "\u{fa47}"
        case .videoLayoutShareDominantLight: return "\u{fa48}"
        case .videoLayoutShareDominantRegular: return "\u{fa49}"
        case .videoLayoutSingleBold: return "\u{fa4a}"
        case .videoLayoutSingleFilled: return "\u{fa4b}"
        case .videoLayoutSingleLight: return "\u{fa4c}"
        case .videoLayoutSingleRegular: return "\u{fa4d}"
        case .videoLayoutStackBold: return "\u{fa4e}"
        case .videoLayoutStackFilled: return "\u{fa4f}"
        case .videoLayoutStackLight: return "\u{fa50}"
        case .videoLayoutStackRegular: return "\u{fa51}"
        case .videoLayoutVideoDominantBold: return "\u{fa52}"
        case .videoLayoutVideoDominantLight: return "\u{fa53}"
        case .videoLayoutVideoDominantRegular: return "\u{fa54}"
        case .videoLight: return "\u{fa55}"
        case .videoPlusBold: return "\u{fa56}"
        case .videoPlusFilled: return "\u{fa57}"
        case .videoPlusLight: return "\u{fa58}"
        case .videoPlusRegular: return "\u{fa59}"
        case .videoRegular: return "\u{fa5a}"
        case .videoSpeakerTrackBold: return "\u{fa5b}"
        case .videoSpeakerTrackFilled: return "\u{fa5c}"
        case .videoSpeakerTrackLight: return "\u{fa5d}"
        case .videoSpeakerTrackRegular: return "\u{fa5e}"
        case .viewAllBold: return "\u{fa5f}"
        case .viewAllLight: return "\u{fa60}"
        case .viewAllRegular: return "\u{fa61}"
        case .viewListBold: return "\u{fa62}"
        case .viewListLight: return "\u{fa63}"
        case .viewListRegular: return "\u{fa64}"
        case .viewStackedBold: return "\u{fa65}"
        case .viewStackedFilled: return "\u{fa66}"
        case .viewStackedLight: return "\u{fa67}"
        case .viewStackedRegular: return "\u{fa68}"
        case .viewThumbnailBold: return "\u{fa69}"
        case .viewThumbnailFilled: return "\u{fa6a}"
        case .viewThumbnailLight: return "\u{fa6b}"
        case .viewThumbnailRegular: return "\u{fa6c}"
        case .voicemailBold: return "\u{fa6d}"
        case .voicemailFilled: return "\u{fa6e}"
        case .voicemailLight: return "\u{fa6f}"
        case .voicemailRegular: return "\u{fa70}"
        case .waffleMenuBold: return "\u{fa71}"
        case .waffleMenuLight: return "\u{fa72}"
        case .waffleMenuRegular: return "\u{fa73}"
        case .waitingroomActiveBold: return "\u{fa74}"
        case .waitingroomActiveLight: return "\u{fa75}"
        case .waitingroomActiveRegular: return "\u{fa76}"
        case .wallpaperBold: return "\u{fa77}"
        case .wallpaperLight: return "\u{fa78}"
        case .wallpaperRegular: return "\u{fa79}"
        case .warningBadgeFilled: return "\u{fa7a}"
        case .warningBold: return "\u{fa7b}"
        case .warningFilled: return "\u{fa7c}"
        case .warningLight: return "\u{fa7d}"
        case .warningRegular: return "\u{fa7e}"
        case .webexAssistantActiveColored: return "\u{fa7f}"
        case .webexAssistantInactiveColored: return "\u{fa80}"
        case .webexBoardBold: return "\u{fa81}"
        case .webexBoardLight: return "\u{fa82}"
        case .webexBoardRegular: return "\u{fa83}"
        case .webexCodecPlusBold: return "\u{fa84}"
        case .webexCodecPlusLight: return "\u{fa85}"
        case .webexCodecPlusRegular: return "\u{fa86}"
        case .webexDeskCameraBold: return "\u{fa87}"
        case .webexDeskCameraLight: return "\u{fa88}"
        case .webexDeskCameraRegular: return "\u{fa89}"
        case .webexHelixFilled: return "\u{fa8a}"
        case .webexMeetingsBold: return "\u{fa8b}"
        case .webexMeetingsFilled: return "\u{fa8c}"
        case .webexMeetingsLight: return "\u{fa8d}"
        case .webexMeetingsRegular: return "\u{fa8e}"
        case .webexQuadCameraBold: return "\u{fa8f}"
        case .webexQuadCameraLight: return "\u{fa90}"
        case .webexQuadCameraRegular: return "\u{fa91}"
        case .webexRoomKitBold: return "\u{fa92}"
        case .webexRoomKitLight: return "\u{fa93}"
        case .webexRoomKitPlusBold: return "\u{fa94}"
        case .webexRoomKitPlusLight: return "\u{fa95}"
        case .webexRoomKitPlusRegular: return "\u{fa96}"
        case .webexRoomKitRegular: return "\u{fa97}"
        case .webexShareBold: return "\u{fa98}"
        case .webexShareLight: return "\u{fa99}"
        case .webexShareRegular: return "\u{fa9a}"
        case .webexTeamsBold: return "\u{fa9b}"
        case .webexTeamsFilled: return "\u{fa9c}"
        case .webexTeamsLight: return "\u{fa9d}"
        case .webexTeamsNewBold: return "\u{fa9e}"
        case .webexTeamsNewFilled: return "\u{fa9f}"
        case .webexTeamsNewLight: return "\u{faa0}"
        case .webexTeamsNewRegular: return "\u{faa1}"
        case .webexTeamsRegular: return "\u{faa2}"
        case .webinarBold: return "\u{faa3}"
        case .webinarFilled: return "\u{faa4}"
        case .webinarLight: return "\u{faa5}"
        case .webinarRegular: return "\u{faa6}"
        case .weeklyRecurringScheduleNodeBold: return "\u{faa7}"
        case .weeklyRecurringScheduleNodeLight: return "\u{faa8}"
        case .weeklyRecurringScheduleNodeRegular: return "\u{faa9}"
        case .whiteboardBold: return "\u{faaa}"
        case .whiteboardContentBold: return "\u{faab}"
        case .whiteboardContentLight: return "\u{faac}"
        case .whiteboardContentRegular: return "\u{faad}"
        case .whiteboardFilled: return "\u{faae}"
        case .whiteboardLight: return "\u{faaf}"
        case .whiteboardRegular: return "\u{fab0}"
        case .widgetBold: return "\u{fab1}"
        case .widgetFilled: return "\u{fab2}"
        case .widgetLight: return "\u{fab3}"
        case .widgetRegular: return "\u{fab4}"
        case .wifiBold: return "\u{fab5}"
        case .wifiErrorBold: return "\u{fab6}"
        case .wifiErrorLight: return "\u{fab7}"
        case .wifiErrorRegular: return "\u{fab8}"
        case .wifiLight: return "\u{fab9}"
        case .wifiRegular: return "\u{faba}"
        case .wifiSignalGoodColoredBold: return "\u{fabb}"
        case .wifiSignalGoodColoredLight: return "\u{fabc}"
        case .wifiSignalGoodColoredRegular: return "\u{fabd}"
        case .wifiSignalPoorColoredBold: return "\u{fabe}"
        case .wifiSignalPoorColoredLight: return "\u{fabf}"
        case .wifiSignalPoorColoredRegular: return "\u{fac0}"
        case .wifiSignalUnstableColoredBold: return "\u{fac1}"
        case .wifiSignalUnstableColoredLight: return "\u{fac2}"
        case .wifiSignalUnstableColoredRegular: return "\u{fac3}"
        case .windowCornerScrubBold: return "\u{fac4}"
        case .windowCornerScrubLight: return "\u{fac5}"
        case .windowCornerScrubRegular: return "\u{fac6}"
        case .windowRightCornerScrubBold: return "\u{fac7}"
        case .windowRightCornerScrubLight: return "\u{fac8}"
        case .windowRightCornerScrubRegular: return "\u{fac9}"
        case .windowVerticalScrubBold: return "\u{faca}"
        case .windowVerticalScrubLight: return "\u{facb}"
        case .windowVerticalScrubRegular: return "\u{facc}"
        case .workflowDeploymentsBold: return "\u{facd}"
        case .workflowDeploymentsLight: return "\u{face}"
        case .workflowDeploymentsRegular: return "\u{facf}"
        case .workphoneBold: return "\u{fad0}"
        case .workphoneLight: return "\u{fad1}"
        case .workphoneRegular: return "\u{fad2}"
        case .zoomInBold: return "\u{fad3}"
        case .zoomInLight: return "\u{fad4}"
        case .zoomInRegular: return "\u{fad5}"
        case .zoomOutBold: return "\u{fad6}"
        case .zoomOutLight: return "\u{fad7}"
        case .zoomOutRegular: return "\u{fad8}"
        case .zoom: return "\u{fad9}"
