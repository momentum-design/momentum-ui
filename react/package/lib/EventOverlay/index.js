...
var EventOverlay = /*#__PURE__*/function (_React$Component) {
  ...
  function EventOverlay() {
    ...
    _this.addHandlers = function () {
      ...
      var element = _reactDom.default.findDOMNode(_this.container);
    ...
    _this.findOverflow = function (node, searchProps) {
      return searchProps.reduce(function (agg, prop) {
        var overflowElement = window.getComputedStyle(_reactDom.default.findDOMNode(node))[prop];
    ...
    _this.focusOnAnchorNode = function () {
      ...
      var domAnchorNode = anchorNode && (anchorNode.props ? anchorNode.props.onClick : false) && _reactDom.default.findDOMNode(anchorNode);
    ...
    _this.handleAllowClickAway = function (e) {
      ...
      var anchorNode = _reactDom.default.findDOMNode(_this.props.anchorNode);

      return _this.container && !anchorNode.contains(eventTarget) && !_reactDom.default.findDOMNode(_this.container).contains(eventTarget) && _this.handleClickAway(e);
    };
    ...
    _this.handleCloseOnClick = function (e) {
      ...
      return closeOnClick && _this.container && _reactDom.default.findDOMNode(_this.container).contains(eventTarget) && _this.handleClickAway(e);
    };
    ...
    _this.handleKeyDown = function (e) {
      ...
      return _this.container && anchorNode && !anchorNode.contains(eventTarget) && !_reactDom.default.findDOMNode(_this.container).contains(eventTarget) && _this.handleClickAway(e);
    };
    ...
    _this.isVisible = function () {
      ...
      var anchorElement = _reactDom.default.findDOMNode(anchorNode);
    ...
    _this.setBoundingBox = function (side, targetNode, anchorPosition) {
      ...
      var arrowDims = showArrow && _reactDom.default.findDOMNode(_this.arrow).getBoundingClientRect();
    ...
    _this.setHorizontalClass = function (alignment, anchor, elementBoundingRect, elementParent) {
      ...
      var arrowWidth = showArrow ? _reactDom.default.findDOMNode(_this.arrow).getBoundingClientRect().width : 0;
      var offsetWidth = targetOffset.horizontal || 0;
      var totalWidth = anchorRight + elementWidth + arrowWidth + offsetWidth;

      var elementParents = _this.findParents(elementParent);

      var scrollParent = scrollParentID ? _react.default.findDOMNode(scrollParentID) : _this.findScrollParent(elementParents, ['overflow', 'overflow-x']);
    ...
    _this.setVerticalClass = function (alignment, anchor, elementBoundingRect, elementParent) {
      ...
      var arrowHeight = showArrow ? _reactDom.default.findDOMNode(_this.arrow).getBoundingClientRect().height : 0;
      var offsetHeight = targetOffset.vertical || 0;
  ...
  _proto.render = function render() {
    ...
    var otherProps = (0, _omit.default)(_extends({}, props), ['absoluteParentID', 'allowClickAway', 'anchorNode', 'boundingParentID', 'checkOverflow', 'close', 'closeOnClick', 'direction', 'isDynamic', 'isContained', 'scrollParentID', 'targetOffset', 'transformParentID']);

    var contentNodes = isOpen && /*#__PURE__*/_react.default.createElement("div", {
    ...
    var withFocusLock = function withFocusLock(content) {
      return shouldLockFocus ? /*#__PURE__*/_react.default.createElement(_reactFocusLock.default, focusLockProps, content) : content;
    };

    var withPortal = function withPortal(content) {
      return portalNode ? /*#__PURE__*/_reactDom.default.createPortal(content, portalNode) : content;
    };
...
EventOverlay.propTypes = {
  ...
  absoluteParentID: _propTypes.default.string,
  ...
  anchorNode: _propTypes.default.object,

  /** @prop Set the id of the boundingParent | null */
  boundingParentID: _propTypes.default.string,

  /** @prop Set to determine if dom ancestors have overflow property | false */
  checkOverflow: _propTypes.default.bool,
  ...
  direction: _propTypes.default.oneOf(['top-center', 'left-center', 'right-center', 'bottom-center', 'top-left', 'top-right', 'bottom-left', 'bottom-right', 'left-top', 'left-bottom', 'right-top', 'right-bottom']),

  /** @prop Props to be passed to focus lock component | null */
  focusLockProps: _propTypes.default.object,

  /** @prop Determines if the overlay is contained in bounding ancestor | '' */
  isContained: _propTypes.default.oneOf([true, false, 'horizontal', 'vertical', 'both', '']),
  ...
  portalNode: _propTypes.default.oneOfType([_propTypes.default.node, _propTypes.default.instanceOf(Element)]),

  /** @prop Set the id of the scrollParent | null */
  scrollParentID: _propTypes.default.string,

  /** @prop Determines if focus should be locked to overlay | false */
  shouldLockFocus: _propTypes.default.bool,
  ...
  transformParentID: _propTypes.default.string
};
EventOverlay.displayName = 'EventOverlay';
var _default = EventOverlay;
