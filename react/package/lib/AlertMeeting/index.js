...
var AlertMeeting = function AlertMeeting(props) {
  ...
  var renderAvatar = function renderAvatar() {
    if (avatar) {
      ...
      if (attendees.length >= 2) {
        return /*#__PURE__*/_react.default.createElement(_.CompositeAvatar, null, /*#__PURE__*/_react.default.createElement(_.Avatar, _extends({
          alt: attendees[0].alt,
          src: attendees[0].src,
          title: attendees[0].title
        }, attendees[0].props)), /*#__PURE__*/_react.default.createElement(_.Avatar, _extends({
          alt: attendees[1].alt,
          src: attendees[1].src,
  ...
  return show && /*#__PURE__*/_react.default.createElement("div", _extends({
    ...
    role: 'button'
  }, otherProps), renderAvatar(), /*#__PURE__*/_react.default.createElement("div", {
    ...
    title: message
  }, message)), onSnooze && /*#__PURE__*/_react.default.createElement("div", {
    ...
    onClick: onSnooze,
    size: 44
  }, snoozeBtnProps), /*#__PURE__*/_react.default.createElement(_.Icon, {
    name: "alarm_16"
  }))), /*#__PURE__*/_react.default.createElement("div", {
    className: "md-alert__button"
  }, /*#__PURE__*/_react.default.createElement(_.Button, _extends({
    ...
    onClick: onHide,
    size: 44
  }, closeBtnProps), /*#__PURE__*/_react.default.createElement(_.Icon, {
    name: "cancel_16"
  }))));
};
