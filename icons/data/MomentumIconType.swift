...
@objc public enum MomentumIconType: Int {
    ...
    public var ligature: String {
        ...
        case .import12: return "\u{f6c9}"
        case .import16: return "\u{f6ca}"
        case .import24: return "\u{f6cb}"
        case .incognito18: return "\u{f6cc}"
        case .incognito24: return "\u{f6cd}"
        case .incognito40: return "\u{f6ce}"
        case .incomingCallActive12: return "\u{f6cf}"
        case .incomingCallActive16: return "\u{f6d0}"
        case .incomingCallLegacy12: return "\u{f6d1}"
        case .incomingCallLegacy16: return "\u{f6d2}"
        case .incomingCallLegacy20: return "\u{f6d3}"
        case .incomingCallLegacy36: return "\u{f6d4}"
        case .incomingCallSelected20: return "\u{f6d5}"
        case .incomingCallSelected24: return "\u{f6d6}"
        case .indeterminateCircleActive16: return "\u{f6d7}"
        case .info12: return "\u{f6d8}"
        case .info14: return "\u{f6d9}"
        case .info16: return "\u{f6da}"
        case .info18: return "\u{f6db}"
        case .info20: return "\u{f6dc}"
        case .info24: return "\u{f6dd}"
        case .info28: return "\u{f6de}"
        case .info32: return "\u{f6df}"
        case .info40: return "\u{f6e0}"
        case .info44: return "\u{f6e1}"
        case .info72: return "\u{f6e2}"
        case .info8: return "\u{f6e3}"
        case .infoActive12: return "\u{f6e4}"
        case .infoActive16: return "\u{f6e5}"
        case .infoActive18: return "\u{f6e6}"
        case .infoActive20: return "\u{f6e7}"
        case .infoActive24: return "\u{f6e8}"
        case .infoActive28: return "\u{f6e9}"
        case .infoActive32: return "\u{f6ea}"
        case .infoActive40: return "\u{f6eb}"
        case .infoActive44: return "\u{f6ec}"
        case .infoActive72: return "\u{f6ed}"
        case .infoActiveTwo12: return "\u{f6ee}"
        case .infoActiveTwo14: return "\u{f6ef}"
        case .infoActiveTwo16: return "\u{f6f0}"
        case .infoI10: return "\u{f6f1}"
        case .infoI12: return "\u{f6f2}"
        case .infoI20: return "\u{f6f3}"
        case .infoI8: return "\u{f6f4}"
        case .input10: return "\u{f6f5}"
        case .input12: return "\u{f6f6}"
        case .input14: return "\u{f6f7}"
        case .input16: return "\u{f6f8}"
        case .input24: return "\u{f6f9}"
        case .input26: return "\u{f6fa}"
        case .input28: return "\u{f6fb}"
        case .input36: return "\u{f6fc}"
        case .input8: return "\u{f6fd}"
        case .instagramCircle24: return "\u{f6fe}"
        case .instagramCircle32: return "\u{f6ff}"
        case .integrations16: return "\u{f700}"
        case .integrations24: return "\u{f701}"
        case .invitedUser16: return "\u{f702}"
        case .invitedUser32: return "\u{f703}"
        case .invitedUser56: return "\u{f704}"
        case .jabber14: return "\u{f705}"
        case .jabber16: return "\u{f706}"
        case .jabberHub16: return "\u{f707}"
        case .joinAudio12: return "\u{f708}"
        case .joinAudio16: return "\u{f709}"
        case .joinAudio20: return "\u{f70a}"
        case .joinAudio24: return "\u{f70b}"
        case .keyboard16: return "\u{f70c}"
        case .keyboard20: return "\u{f70d}"
        case .keyboard24: return "\u{f70e}"
        case .keyboard28: return "\u{f70f}"
        case .keyboardClose16: return "\u{f710}"
        case .keyboardClose24: return "\u{f711}"
        case .language12: return "\u{f712}"
        case .language16: return "\u{f713}"
        case .language20: return "\u{f714}"
        case .language24: return "\u{f715}"
        case .language28: return "\u{f716}"
        case .language40: return "\u{f717}"
        case .laptop12: return "\u{f718}"
        case .laptop16: return "\u{f719}"
        case .laptop20: return "\u{f71a}"
        case .laptop24: return "\u{f71b}"
        case .laptop48: return "\u{f71c}"
        case .laptop72: return "\u{f71d}"
        case .laserPointer16: return "\u{f71e}"
        case .launch12: return "\u{f71f}"
        case .launch16: return "\u{f720}"
        case .launch20: return "\u{f721}"
        case .launch32: return "\u{f722}"
        case .layoutEqualDual12: return "\u{f723}"
        case .layoutEqualDual16: return "\u{f724}"
        case .layoutEqualDual20: return "\u{f725}"
        case .layoutEqualDual24: return "\u{f726}"
        case .layoutSideBySideHorizonal16: return "\u{f727}"
        case .layoutSideBySideVertical12: return "\u{f728}"
        case .layoutSideBySideVertical16: return "\u{f729}"
        case .layoutSideBySideVertical24: return "\u{f72a}"
        case .layoutStacked12: return "\u{f72b}"
        case .layoutStacked16: return "\u{f72c}"
        case .layoutStacked28: return "\u{f72d}"
        case .leaveBreakoutSession16: return "\u{f72e}"
        case .like12: return "\u{f72f}"
        case .like16: return "\u{f730}"
        case .like24: return "\u{f731}"
        case .link10: return "\u{f732}"
        case .link12: return "\u{f733}"
        case .link14: return "\u{f734}"
        case .link16: return "\u{f735}"
        case .link18: return "\u{f736}"
        case .link20: return "\u{f737}"
        case .link24: return "\u{f738}"
        case .linkedin16: return "\u{f739}"
        case .linkedinCircle24: return "\u{f73a}"
        case .linkedinCircle32: return "\u{f73b}"
        case .linkedinCircle40: return "\u{f73c}"
        case .listMenu12: return "\u{f73d}"
        case .listMenu16: return "\u{f73e}"
        case .listMenu18: return "\u{f73f}"
        case .listMenu20: return "\u{f740}"
        case .listMenu24: return "\u{f741}"
        case .listMenu28: return "\u{f742}"
        case .location10: return "\u{f743}"
        case .location16: return "\u{f744}"
        case .location18: return "\u{f745}"
        case .location20: return "\u{f746}"
        case .location24: return "\u{f747}"
        case .location28: return "\u{f748}"
        case .location32: return "\u{f749}"
        case .lock10: return "\u{f74a}"
        case .lock12: return "\u{f74b}"
        case .lock24: return "\u{f74c}"
        case .lock8: return "\u{f74d}"
        case .lowerHand12: return "\u{f74e}"
        case .lowerHand16: return "\u{f74f}"
        case .lowerHand20: return "\u{f750}"
        case .markAsRead12: return "\u{f751}"
        case .markAsUnread12: return "\u{f752}"
        case .markAsUnread20: return "\u{f753}"
        case .markdown16: return "\u{f754}"
        case .markdown20: return "\u{f755}"
        case .marker12: return "\u{f756}"
        case .marker14: return "\u{f757}"
        case .marker16: return "\u{f758}"
        case .marker18: return "\u{f759}"
        case .maximize12: return "\u{f75a}"
        case .maximize14: return "\u{f75b}"
        case .maximize16: return "\u{f75c}"
        case .maximize20: return "\u{f75d}"
        case .maximize24: return "\u{f75e}"
        case .maximize28: return "\u{f75f}"
        case .meet10: return "\u{f760}"
        case .meet12: return "\u{f761}"
        case .meet120: return "\u{f762}"
        case .meet124: return "\u{f763}"
        case .meet14: return "\u{f764}"
        case .meet16: return "\u{f765}"
        case .meet18: return "\u{f766}"
        case .meet20: return "\u{f767}"
        case .meet24: return "\u{f768}"
        case .meet26: return "\u{f769}"
        case .meet32: return "\u{f76a}"
        case .meet48: return "\u{f76b}"
        case .meet56: return "\u{f76c}"
        case .meetEnd16: return "\u{f76d}"
        case .meetingControls16: return "\u{f76e}"
        case .meetings10: return "\u{f76f}"
        case .meetings12: return "\u{f770}"
        case .meetings14: return "\u{f771}"
        case .meetings16: return "\u{f772}"
        case .meetings18: return "\u{f773}"
        case .meetings20: return "\u{f774}"
        case .meetings24: return "\u{f775}"
        case .meetings26: return "\u{f776}"
        case .meetings28: return "\u{f777}"
        case .meetings32: return "\u{f778}"
        case .meetings36: return "\u{f779}"
        case .meetings8: return "\u{f77a}"
        case .meetingsActive10: return "\u{f77b}"
        case .meetingsActive12: return "\u{f77c}"
        case .meetingsActive14: return "\u{f77d}"
        case .meetingsActive16: return "\u{f77e}"
        case .meetingsActive18: return "\u{f77f}"
        case .meetingsActive20: return "\u{f780}"
        case .meetingsActive24: return "\u{f781}"
        case .meetingsActive26: return "\u{f782}"
        case .meetingsActive28: return "\u{f783}"
        case .meetingsActive32: return "\u{f784}"
        case .meetingsActive36: return "\u{f785}"
        case .meetingsActive8: return "\u{f786}"
        case .meetingsPresence12: return "\u{f787}"
        case .meetingsPresence14: return "\u{f788}"
        case .meetingsPresence24: return "\u{f789}"
        case .meetingsPresence28: return "\u{f78a}"
        case .meetingsPresence8: return "\u{f78b}"
        case .meetingsPresenceStroke10: return "\u{f78c}"
        case .meetingsPresenceStroke14: return "\u{f78d}"
        case .meetingsPresenceStroke16: return "\u{f78e}"
        case .meetingsPresenceStroke26: return "\u{f78f}"
        case .meetingsPresenceStroke30: return "\u{f790}"
        case .mention10: return "\u{f791}"
        case .mention12: return "\u{f792}"
        case .mention14: return "\u{f793}"
        case .mention16: return "\u{f794}"
        case .mention18: return "\u{f795}"
        case .mention20: return "\u{f796}"
        case .mention24: return "\u{f797}"
        case .mention8: return "\u{f798}"
        case .messenger12: return "\u{f799}"
        case .messenger16: return "\u{f79a}"
        case .microphone10: return "\u{f79b}"
        case .microphone12: return "\u{f79c}"
        case .microphone14: return "\u{f79d}"
        case .microphone16: return "\u{f79e}"
        case .microphone18: return "\u{f79f}"
        case .microphone20: return "\u{f7a0}"
        case .microphone24: return "\u{f7a1}"
        case .microphone28: return "\u{f7a2}"
        case .microphone36: return "\u{f7a3}"
        case .microphone8: return "\u{f7a4}"
        case .microphoneMuted10: return "\u{f7a5}"
        case .microphoneMuted12: return "\u{f7a6}"
        case .microphoneMuted14: return "\u{f7a7}"
        case .microphoneMuted16: return "\u{f7a8}"
        case .microphoneMuted18: return "\u{f7a9}"
        case .microphoneMuted20: return "\u{f7aa}"
        case .microphoneMuted24: return "\u{f7ab}"
        case .microphoneMuted28: return "\u{f7ac}"
        case .microphoneMuted32: return "\u{f7ad}"
        case .microphoneMuted36: return "\u{f7ae}"
        case .microphoneMuted8: return "\u{f7af}"
        case .microphoneOn16: return "\u{f7b0}"
        case .microphoneOn20: return "\u{f7b1}"
        case .microphoneOn24: return "\u{f7b2}"
        case .mindMap24: return "\u{f7b3}"
        case .minimize12: return "\u{f7b4}"
        case .minimize14: return "\u{f7b5}"
        case .minimize16: return "\u{f7b6}"
        case .minimize20: return "\u{f7b7}"
        case .minimize24: return "\u{f7b8}"
        case .minimize28: return "\u{f7b9}"
        case .minus12: return "\u{f7ba}"
        case .minus14: return "\u{f7bb}"
        case .minus16: return "\u{f7bc}"
        case .minus18: return "\u{f7bd}"
        case .minus20: return "\u{f7be}"
        case .minus24: return "\u{f7bf}"
        case .minus28: return "\u{f7c0}"
        case .minus8: return "\u{f7c1}"
        case .mirror12: return "\u{f7c2}"
        case .mirror16: return "\u{f7c3}"
        case .moderator16: return "\u{f7c4}"
        case .moderator56: return "\u{f7c5}"
        case .moderator80: return "\u{f7c6}"
        case .more10: return "\u{f7c7}"
        case .more12: return "\u{f7c8}"
        case .more14: return "\u{f7c9}"
        case .more16: return "\u{f7ca}"
        case .more18: return "\u{f7cb}"
        case .more20: return "\u{f7cc}"
        case .more24: return "\u{f7cd}"
        case .more28: return "\u{f7ce}"
        case .moreAdr12: return "\u{f7cf}"
        case .moreAdr16: return "\u{f7d0}"
        case .moreAdr20: return "\u{f7d1}"
        case .moreAdr24: return "\u{f7d2}"
        case .moreAdr28: return "\u{f7d3}"
        case .moreAndroid12: return "\u{f7d4}"
        case .moreAndroid16: return "\u{f7d5}"
        case .moreAndroid20: return "\u{f7d6}"
        case .moreAndroid24: return "\u{f7d7}"
        case .moreAndroid28: return "\u{f7d8}"
        case .moreCircle12: return "\u{f7d9}"
        case .moreCircle140: return "\u{f7da}"
        case .moreCircle16: return "\u{f7db}"
        case .moreCircle20: return "\u{f7dc}"
        case .moreCircleActive20: return "\u{f7dd}"
        case .mouseCursor16: return "\u{f7de}"
        case .moveCallInAdr12: return "\u{f7df}"
        case .moveCallInAdr16: return "\u{f7e0}"
        case .moveCallInAdr18: return "\u{f7e1}"
        case .moveCallInAdr20: return "\u{f7e2}"
        case .moveCallInAdr24: return "\u{f7e3}"
        case .moveCallInAdr28: return "\u{f7e4}"
        case .moveCallInIph12: return "\u{f7e5}"
        case .moveCallInIph16: return "\u{f7e6}"
        case .moveCallInIph18: return "\u{f7e7}"
        case .moveCallInIph20: return "\u{f7e8}"
        case .moveCallInIph24: return "\u{f7e9}"
        case .moveCallInIph28: return "\u{f7ea}"
        case .moveCallInLaptop12: return "\u{f7eb}"
        case .moveCallInLaptop16: return "\u{f7ec}"
        case .moveCallInLaptop18: return "\u{f7ed}"
        case .moveCallInLaptop20: return "\u{f7ee}"
        case .moveCallInLaptop24: return "\u{f7ef}"
        case .moveCallInLaptop28: return "\u{f7f0}"
        case .moveCallInOutAdr28: return "\u{f7f1}"
        case .moveCallInOutIph28: return "\u{f7f2}"
        case .moveCallInTablet12: return "\u{f7f3}"
        case .moveCallInTablet18: return "\u{f7f4}"
        case .moveCallInTablet20: return "\u{f7f5}"
        case .moveCallInTablet24: return "\u{f7f6}"
        case .moveCallInTablet28: return "\u{f7f7}"
        case .moveCallOutAdr12: return "\u{f7f8}"
        case .moveCallOutAdr16: return "\u{f7f9}"
        case .moveCallOutAdr18: return "\u{f7fa}"
        case .moveCallOutAdr20: return "\u{f7fb}"
        case .moveCallOutAdr24: return "\u{f7fc}"
        case .moveCallOutAdr28: return "\u{f7fd}"
        case .moveCallOutIph12: return "\u{f7fe}"
        case .moveCallOutIph16: return "\u{f7ff}"
        case .moveCallOutIph18: return "\u{f800}"
        case .moveCallOutIph20: return "\u{f801}"
        case .moveCallOutIph24: return "\u{f802}"
        case .moveCallOutIph28: return "\u{f803}"
        case .moveCallOutLaptop12: return "\u{f804}"
        case .moveCallOutLaptop16: return "\u{f805}"
        case .moveCallOutLaptop18: return "\u{f806}"
        case .moveCallOutLaptop20: return "\u{f807}"
        case .moveCallOutLaptop24: return "\u{f808}"
        case .moveCallOutLaptop28: return "\u{f809}"
        case .moveCallOutTablet12: return "\u{f80a}"
        case .moveCallOutTablet18: return "\u{f80b}"
        case .moveCallOutTablet20: return "\u{f80c}"
        case .moveCallOutTablet24: return "\u{f80d}"
        case .moveCallOutTablet28: return "\u{f80e}"
        case .multilineChart16: return "\u{f80f}"
        case .multilineChart20: return "\u{f810}"
        case .multimedia16: return "\u{f811}"
        case .multimedia20: return "\u{f812}"
        case .multipleDevices16: return "\u{f813}"
        case .multipleDevices20: return "\u{f814}"
        case .multipleDevices24: return "\u{f815}"
        case .multipleDevices28: return "\u{f816}"
        case .multipleDevices64: return "\u{f817}"
        case .musicMode12: return "\u{f818}"
        case .musicMode16: return "\u{f819}"
        case .musicMode24: return "\u{f81a}"
        case .musicMode8: return "\u{f81b}"
        case .muteOnEntry16: return "\u{f81c}"
        case .newIdea16: return "\u{f81d}"
        case .newIdea24: return "\u{f81e}"
        case .newVoicemail16: return "\u{f81f}"
        case .newVoicemail20: return "\u{f820}"
        case .newVoicemail24: return "\u{f821}"
        case .newWhiteboard12: return "\u{f822}"
        case .newWhiteboard16: return "\u{f823}"
        case .next10: return "\u{f824}"
        case .next12: return "\u{f825}"
        case .next14: return "\u{f826}"
        case .next16: return "\u{f827}"
        case .next18: return "\u{f828}"
        case .next20: return "\u{f829}"
        case .next24: return "\u{f82a}"
        case .next28: return "\u{f82b}"
        case .next36: return "\u{f82c}"
        case .noDevices28: return "\u{f82d}"
        case .noPhoneWarning20: return "\u{f82e}"
        case .noPhoneWarning24: return "\u{f82f}"
        case .noiseRemoval12: return "\u{f830}"
        case .note16: return "\u{f831}"
        case .note20: return "\u{f832}"
        case .note24: return "\u{f833}"
        case .notePpt16: return "\u{f834}"
        case .notePpt20: return "\u{f835}"
        case .notepad16: return "\u{f836}"
        case .notes10: return "\u{f837}"
        case .notes12: return "\u{f838}"
        case .notes14: return "\u{f839}"
        case .notes16: return "\u{f83a}"
        case .notes20: return "\u{f83b}"
        case .notes24: return "\u{f83c}"
        case .notes26: return "\u{f83d}"
        case .notes28: return "\u{f83e}"
        case .notes36: return "\u{f83f}"
        case .notes8: return "\u{f840}"
        case .oneToOneZoom16: return "\u{f841}"
        case .openInFolder10: return "\u{f842}"
        case .openInFolder12: return "\u{f843}"
        case .openInFolder14: return "\u{f844}"
        case .openInFolder16: return "\u{f845}"
        case .openInFolder20: return "\u{f846}"
        case .openPages12: return "\u{f847}"
        case .openPages14: return "\u{f848}"
        case .openPages16: return "\u{f849}"
        case .openPages24: return "\u{f84a}"
        case .openPages36: return "\u{f84b}"
        case .otherNumber12: return "\u{f84c}"
        case .otherNumber14: return "\u{f84d}"
        case .otherNumber16: return "\u{f84e}"
        case .otherNumber20: return "\u{f84f}"
        case .otherNumberWarning16: return "\u{f850}"
        case .outgoingCallActive12: return "\u{f851}"
        case .outgoingCallActive16: return "\u{f852}"
        case .outgoingCallLegacy12: return "\u{f853}"
        case .outgoingCallLegacy16: return "\u{f854}"
        case .outgoingCallLegacy20: return "\u{f855}"
        case .outgoingCallLegacy36: return "\u{f856}"
        case .outgoingCallSelected20: return "\u{f857}"
        case .outgoingCallSelected24: return "\u{f858}"
        case .overflowLeft16: return "\u{f859}"
        case .overflowRight16: return "\u{f85a}"
        case .pairedCamera16: return "\u{f85b}"
        case .pairedCamera24: return "\u{f85c}"
        case .pairedCamera28: return "\u{f85d}"
        case .pairedDevice16: return "\u{f85e}"
        case .pairedDevice24: return "\u{f85f}"
        case .pairedDevice56: return "\u{f860}"
        case .pairedDevice96: return "\u{f861}"
        case .pairedHandset16: return "\u{f862}"
        case .pairedHandset24: return "\u{f863}"
        case .pairing14: return "\u{f864}"
        case .pairing16: return "\u{f865}"
        case .pairing20: return "\u{f866}"
        case .pairing24: return "\u{f867}"
        case .pairing28: return "\u{f868}"
        case .pairing56: return "\u{f869}"
        case .panelControlBar36: return "\u{f86a}"
        case .panelControlDown12: return "\u{f86b}"
        case .panelControlDown24: return "\u{f86c}"
        case .panelControlDown28: return "\u{f86d}"
        case .panelControlDown36: return "\u{f86e}"
        case .panelControlDownIph12: return "\u{f86f}"
        case .panelControlDownIph24: return "\u{f870}"
        case .panelControlDownIph36: return "\u{f871}"
        case .panelControlDragger14: return "\u{f872}"
        case .panelControlDragger16: return "\u{f873}"
        case .panelControlLeft12: return "\u{f874}"
        case .panelControlLeft16: return "\u{f875}"
        case .panelControlLeft24: return "\u{f876}"
        case .panelControlLeft36: return "\u{f877}"
        case .panelControlLeftIph12: return "\u{f878}"
        case .panelControlLeftIph24: return "\u{f879}"
        case .panelControlLeftIph36: return "\u{f87a}"
        case .panelControlRight12: return "\u{f87b}"
        case .panelControlRight16: return "\u{f87c}"
        case .panelControlRight24: return "\u{f87d}"
        case .panelControlRight36: return "\u{f87e}"
        case .panelControlRightIph12: return "\u{f87f}"
        case .panelControlRightIph24: return "\u{f880}"
        case .panelControlRightIph36: return "\u{f881}"
        case .panelControlThinDown12: return "\u{f882}"
        case .panelControlThinDown24: return "\u{f883}"
        case .panelControlThinDown28: return "\u{f884}"
        case .panelControlThinLeft12: return "\u{f885}"
        case .panelControlThinLeft24: return "\u{f886}"
        case .panelControlThinRight12: return "\u{f887}"
        case .panelControlThinRight24: return "\u{f888}"
        case .panelControlThinUp12: return "\u{f889}"
        case .panelControlThinUp24: return "\u{f88a}"
        case .panelControlThinUp28: return "\u{f88b}"
        case .panelControlThinnerLeft24: return "\u{f88c}"
        case .panelControlThinnerRight24: return "\u{f88d}"
        case .panelControlUp12: return "\u{f88e}"
        case .panelControlUp24: return "\u{f88f}"
        case .panelControlUp28: return "\u{f890}"
        case .panelControlUp36: return "\u{f891}"
        case .panelControlUpIph12: return "\u{f892}"
        case .panelControlUpIph24: return "\u{f893}"
        case .panelControlUpIph36: return "\u{f894}"
        case .parked16: return "\u{f895}"
        case .parked20: return "\u{f896}"
        case .parked24: return "\u{f897}"
        case .parse16: return "\u{f898}"
        case .parse20: return "\u{f899}"
        case .participantAdd12: return "\u{f89a}"
        case .participantAdd14: return "\u{f89b}"
        case .participantAdd16: return "\u{f89c}"
        case .participantAdd20: return "\u{f89d}"
        case .participantAdd24: return "\u{f89e}"
        case .participantAdd28: return "\u{f89f}"
        case .participantAdd56: return "\u{f8a0}"
        case .participantBlocked12: return "\u{f8a1}"
        case .participantBlocked14: return "\u{f8a2}"
        case .participantList12: return "\u{f8a3}"
        case .participantList14: return "\u{f8a4}"
        case .participantList16: return "\u{f8a5}"
        case .participantList18: return "\u{f8a6}"
        case .participantList20: return "\u{f8a7}"
        case .participantList22: return "\u{f8a8}"
        case .participantList24: return "\u{f8a9}"
        case .participantList26: return "\u{f8aa}"
        case .participantList28: return "\u{f8ab}"
        case .participantList32: return "\u{f8ac}"
        case .participantList56: return "\u{f8ad}"
        case .participantList64: return "\u{f8ae}"
        case .participantList80: return "\u{f8af}"
        case .participantListLegacy16: return "\u{f8b0}"
        case .participantListLegacy20: return "\u{f8b1}"
        case .participantListLegacy24: return "\u{f8b2}"
        case .participantListLegacy28: return "\u{f8b3}"
        case .participantListLegacy32: return "\u{f8b4}"
        case .participantListLegacy56: return "\u{f8b5}"
        case .participantListLegacy64: return "\u{f8b6}"
        case .participantListLegacy80: return "\u{f8b7}"
        case .participantListLegacyOptical16: return "\u{f8b8}"
        case .participantListLegacyOptical20: return "\u{f8b9}"
        case .participantListLegacyOptical22: return "\u{f8ba}"
        case .participantListLegacyOptical26: return "\u{f8bb}"
        case .participantListLegacyOptical28: return "\u{f8bc}"
        case .participantListLegacyOptical32: return "\u{f8bd}"
        case .participantListLegacyOptical56: return "\u{f8be}"
        case .participantListLegacyOptical64: return "\u{f8bf}"
        case .participantListLegacyOptical80: return "\u{f8c0}"
        case .participantRemove12: return "\u{f8c1}"
        case .participantRemove14: return "\u{f8c2}"
        case .participantRemove16: return "\u{f8c3}"
        case .participantRemove20: return "\u{f8c4}"
        case .participantRemove24: return "\u{f8c5}"
        case .participantRemove28: return "\u{f8c6}"
        case .participantRemove56: return "\u{f8c7}"
        case .participantUnknown14: return "\u{f8c8}"
        case .participantWait16: return "\u{f8c9}"
        case .passMouse12: return "\u{f8ca}"
        case .passMouse16: return "\u{f8cb}"
        case .passMouse20: return "\u{f8cc}"
        case .pause10: return "\u{f8cd}"
        case .pause12: return "\u{f8ce}"
        case .pause120: return "\u{f8cf}"
        case .pause124: return "\u{f8d0}"
        case .pause14: return "\u{f8d1}"
        case .pause16: return "\u{f8d2}"
        case .pause18: return "\u{f8d3}"
        case .pause20: return "\u{f8d4}"
        case .pause24: return "\u{f8d5}"
        case .pause26: return "\u{f8d6}"
        case .pause32: return "\u{f8d7}"
        case .pause48: return "\u{f8d8}"
        case .pause56: return "\u{f8d9}"
        case .pause8: return "\u{f8da}"
        case .pauseCircle12: return "\u{f8db}"
        case .pauseCircle16: return "\u{f8dc}"
        case .pauseCircle20: return "\u{f8dd}"
        case .pauseCircle24: return "\u{f8de}"
        case .pauseCircleActive16: return "\u{f8df}"
        case .pauseCircleActive24: return "\u{f8e0}"
        case .pen12: return "\u{f8e1}"
        case .pen14: return "\u{f8e2}"
        case .pen16: return "\u{f8e3}"
        case .pen18: return "\u{f8e4}"
        case .pen24: return "\u{f8e5}"
        case .pen8: return "\u{f8e6}"
        case .people10: return "\u{f8e7}"
        case .people12: return "\u{f8e8}"
        case .people120: return "\u{f8e9}"
        case .people14: return "\u{f8ea}"
        case .people16: return "\u{f8eb}"
        case .people18: return "\u{f8ec}"
        case .people20: return "\u{f8ed}"
        case .people24: return "\u{f8ee}"
        case .people26: return "\u{f8ef}"
        case .people28: return "\u{f8f0}"
        case .people32: return "\u{f8f1}"
        case .people36: return "\u{f8f2}"
        case .people8: return "\u{f8f3}"
        case .peopleActive10: return "\u{f8f4}"
        case .peopleActive12: return "\u{f8f5}"
        case .peopleActive14: return "\u{f8f6}"
        case .peopleActive16: return "\u{f8f7}"
        case .peopleActive18: return "\u{f8f8}"
        case .peopleActive20: return "\u{f8f9}"
        case .peopleActive24: return "\u{f8fa}"
        case .peopleActive26: return "\u{f8fb}"
        case .peopleActive28: return "\u{f8fc}"
        case .peopleActive32: return "\u{f8fd}"
        case .peopleActive36: return "\u{f8fe}"
        case .peopleActive8: return "\u{f8ff}"
        case .peopleCircle16: return "\u{f900}"
        case .peopleCircle20: return "\u{f901}"
        case .peopleCircle24: return "\u{f902}"
        case .peopleInsight20: return "\u{f903}"
        case .peopleInsight24: return "\u{f904}"
        case .peopleInsightActive20: return "\u{f905}"
        case .peopleInsightActive24: return "\u{f906}"
        case .phoneAdr12: return "\u{f907}"
        case .phoneAdr16: return "\u{f908}"
        case .phoneAdr20: return "\u{f909}"
        case .phoneAdr24: return "\u{f90a}"
        case .phoneAndroid12: return "\u{f90b}"
        case .phoneAndroid16: return "\u{f90c}"
        case .phoneAndroid24: return "\u{f90d}"
        case .phoneIos12: return "\u{f90e}"
        case .phoneIos16: return "\u{f90f}"
        case .phoneIos24: return "\u{f910}"
        case .phoneIosMuted12: return "\u{f911}"
        case .phoneIph12: return "\u{f912}"
        case .phoneIph16: return "\u{f913}"
        case .phoneIph20: return "\u{f914}"
        case .phoneIph24: return "\u{f915}"
        case .phoneIphAlert12: return "\u{f916}"
        case .phoneIphMuted12: return "\u{f917}"
        case .phoneIphMutedAlert12: return "\u{f918}"
        case .phoneIphPrivate12: return "\u{f919}"
        case .phoneReply16: return "\u{f91a}"
        case .phoneReply20: return "\u{f91b}"
        case .phoneReplyAll16: return "\u{f91c}"
        case .phoneReplyAll20: return "\u{f91d}"
        case .picker14: return "\u{f91e}"
        case .picker16: return "\u{f91f}"
        case .picker18: return "\u{f920}"
        case .pictureInPicture12: return "\u{f921}"
        case .pictureInPicture16: return "\u{f922}"
        case .pictureInPicture20: return "\u{f923}"
        case .pictureInPicture24: return "\u{f924}"
        case .pieChart16: return "\u{f925}"
        case .pieChart20: return "\u{f926}"
        case .pin10: return "\u{f927}"
        case .pin12: return "\u{f928}"
        case .pin14: return "\u{f929}"
        case .pin16: return "\u{f92a}"
        case .pin18: return "\u{f92b}"
        case .pin20: return "\u{f92c}"
        case .pin24: return "\u{f92d}"
        case .pinActive10: return "\u{f92e}"
        case .pinActive20: return "\u{f92f}"
        case .pinList12: return "\u{f930}"
        case .pinList16: return "\u{f931}"
        case .pinList20: return "\u{f932}"
        case .pinMuted10: return "\u{f933}"
        case .pinMuted12: return "\u{f934}"
        case .pinMuted14: return "\u{f935}"
        case .pinMuted16: return "\u{f936}"
        case .pinMuted18: return "\u{f937}"
        case .pinMuted20: return "\u{f938}"
        case .pinMuted24: return "\u{f939}"
        case .placeholder10: return "\u{f93a}"
        case .placeholder12: return "\u{f93b}"
        case .placeholder14: return "\u{f93c}"
        case .placeholder16: return "\u{f93d}"
        case .placeholder18: return "\u{f93e}"
        case .placeholder20: return "\u{f93f}"
        case .placeholder24: return "\u{f940}"
        case .placeholder28: return "\u{f941}"
        case .placeholder32: return "\u{f942}"
        case .placeholder36: return "\u{f943}"
        case .placeholder40: return "\u{f944}"
        case .placeholder48: return "\u{f945}"
        case .placeholder56: return "\u{f946}"
        case .placeholder8: return "\u{f947}"
        case .play12: return "\u{f948}"
        case .play14: return "\u{f949}"
        case .play16: return "\u{f94a}"
        case .play20: return "\u{f94b}"
        case .play24: return "\u{f94c}"
        case .play28: return "\u{f94d}"
        case .play32: return "\u{f94e}"
        case .playCircle12: return "\u{f94f}"
        case .playCircle16: return "\u{f950}"
        case .playCircle20: return "\u{f951}"
        case .playCircle24: return "\u{f952}"
        case .playCircle28: return "\u{f953}"
        case .playCircle32: return "\u{f954}"
        case .plugAc24: return "\u{f955}"
        case .plus12: return "\u{f956}"
        case .plus14: return "\u{f957}"
        case .plus16: return "\u{f958}"
        case .plus18: return "\u{f959}"
        case .plus20: return "\u{f95a}"
        case .plus24: return "\u{f95b}"
        case .plus28: return "\u{f95c}"
        case .plus8: return "\u{f95d}"
        case .plusCircle24: return "\u{f95e}"
        case .plusCircleActive12: return "\u{f95f}"
        case .plusCircleActive20: return "\u{f960}"
        case .plusCircleActive24: return "\u{f961}"
        case .pmr10: return "\u{f962}"
        case .pmr12: return "\u{f963}"
        case .pmr14: return "\u{f964}"
        case .pmr16: return "\u{f965}"
        case .pmr18: return "\u{f966}"
        case .pmr20: return "\u{f967}"
        case .pmr24: return "\u{f968}"
        case .pmr32: return "\u{f969}"
        case .pmr36: return "\u{f96a}"
        case .pmrLegacy10: return "\u{f96b}"
        case .pmrLegacy12: return "\u{f96c}"
        case .pmrLegacy14: return "\u{f96d}"
        case .pmrLegacy16: return "\u{f96e}"
        case .pmrLegacy18: return "\u{f96f}"
        case .pmrLegacy20: return "\u{f970}"
        case .pmrLegacy24: return "\u{f971}"
        case .pmrLegacy32: return "\u{f972}"
        case .pmrLegacy36: return "\u{f973}"
        case .poll12: return "\u{f974}"
        case .poll16: return "\u{f975}"
        case .poll20: return "\u{f976}"
        case .poll24: return "\u{f977}"
        case .poll36: return "\u{f978}"
        case .popIn10: return "\u{f979}"
        case .popIn12: return "\u{f97a}"
        case .popIn16: return "\u{f97b}"
        case .popIn20: return "\u{f97c}"
        case .popIn24: return "\u{f97d}"
        case .popIn8: return "\u{f97e}"
        case .popOut10: return "\u{f97f}"
        case .popOut12: return "\u{f980}"
        case .popOut16: return "\u{f981}"
        case .popOut20: return "\u{f982}"
        case .popOut24: return "\u{f983}"
        case .popOut8: return "\u{f984}"
        case .popUp12: return "\u{f985}"
        case .popUp24: return "\u{f986}"
        case .powerAc16: return "\u{f987}"
        case .powerApps32: return "\u{f988}"
        case .presentation16: return "\u{f989}"
        case .presentation20: return "\u{f98a}"
        case .presentation24: return "\u{f98b}"
        case .print10: return "\u{f98c}"
        case .print12: return "\u{f98d}"
        case .print16: return "\u{f98e}"
        case .priority12: return "\u{f98f}"
        case .priority14: return "\u{f990}"
        case .priority16: return "\u{f991}"
        case .priority18: return "\u{f992}"
        case .priority20: return "\u{f993}"
        case .priority24: return "\u{f994}"
        case .priority28: return "\u{f995}"
        case .priority32: return "\u{f996}"
        case .priority40: return "\u{f997}"
        case .priority44: return "\u{f998}"
        case .priority72: return "\u{f999}"
        case .priorityActive16: return "\u{f99a}"
        case .priorityActiveTwo12: return "\u{f99b}"
        case .priorityActiveTwo14: return "\u{f99c}"
        case .priorityActiveTwo16: return "\u{f99d}"
        case .privacy16: return "\u{f99e}"
        case .privacy20: return "\u{f99f}"
        case .private10: return "\u{f9a0}"
        case .private12: return "\u{f9a1}"
        case .private14: return "\u{f9a2}"
        case .private16: return "\u{f9a3}"
        case .private20: return "\u{f9a4}"
        case .private24: return "\u{f9a5}"
        case .private28: return "\u{f9a6}"
        case .private8: return "\u{f9a7}"
        case .privateCircle100: return "\u{f9a8}"
        case .privateCircle14: return "\u{f9a9}"
        case .privateCircle16: return "\u{f9aa}"
        case .privateCircle20: return "\u{f9ab}"
        case .privateCircle24: return "\u{f9ac}"
        case .privateCircle48: return "\u{f9ad}"
        case .privateCircle56: return "\u{f9ae}"
        case .privateCircle80: return "\u{f9af}"
        case .privateCircleActive16: return "\u{f9b0}"
        case .privateCircleActive20: return "\u{f9b1}"
        case .privateCircleActive24: return "\u{f9b2}"
        case .privateMeeting12: return "\u{f9b3}"
        case .privateMeeting14: return "\u{f9b4}"
        case .privateMeeting16: return "\u{f9b5}"
        case .privateMeeting20: return "\u{f9b6}"
        case .proBadge28: return "\u{f9b7}"
        case .productDemo16: return "\u{f9b8}"
        case .proximity12: return "\u{f9b9}"
        case .proximity16: return "\u{f9ba}"
        case .proximity20: return "\u{f9bb}"
        case .proximity24: return "\u{f9bc}"
        case .proximity28: return "\u{f9bd}"
        case .proximityMuted12: return "\u{f9be}"
        case .proximityMuted16: return "\u{f9bf}"
        case .proximityMuted24: return "\u{f9c0}"
        case .proximityMuted28: return "\u{f9c1}"
        case .proximityVideo12: return "\u{f9c2}"
        case .proximityVideo14: return "\u{f9c3}"
        case .proximityVideo16: return "\u{f9c4}"
        case .proximityVideo20: return "\u{f9c5}"
        case .proximityVideo24: return "\u{f9c6}"
        case .proximityVideo26: return "\u{f9c7}"
        case .pto12: return "\u{f9c8}"
        case .pto120: return "\u{f9c9}"
        case .pto124: return "\u{f9ca}"
        case .pto14: return "\u{f9cb}"
        case .pto16: return "\u{f9cc}"
        case .pto18: return "\u{f9cd}"
        case .pto20: return "\u{f9ce}"
        case .pto24: return "\u{f9cf}"
        case .pto26: return "\u{f9d0}"
        case .pto28: return "\u{f9d1}"
        case .pto32: return "\u{f9d2}"
        case .pto40: return "\u{f9d3}"
        case .pto48: return "\u{f9d4}"
        case .pto56: return "\u{f9d5}"
        case .pto8: return "\u{f9d6}"
        case .pullCall12: return "\u{f9d7}"
        case .pullCall14: return "\u{f9d8}"
        case .pullCall16: return "\u{f9d9}"
        case .pullCall24: return "\u{f9da}"
        case .qA16: return "\u{f9db}"
        case .qA20: return "\u{f9dc}"
        case .qA24: return "\u{f9dd}"
        case .qA36: return "\u{f9de}"
        case .quality16: return "\u{f9df}"
        case .quality24: return "\u{f9e0}"
        case .queue14: return "\u{f9e1}"
        case .queueContact: return "\u{f9e2}"
        case .queueContact14: return "\u{f9e3}"
        case .queueContact20: return "\u{f9e4}"
        case .queueLookup16: return "\u{f9e5}"
        case .quiet16: return "\u{f9e6}"
        case .quiet20: return "\u{f9e7}"
        case .quiet32: return "\u{f9e8}"
        case .quiet8: return "\u{f9e9}"
        case .raiseHand12: return "\u{f9ea}"
        case .raiseHand16: return "\u{f9eb}"
        case .raiseHand20: return "\u{f9ec}"
        case .raiseHand24: return "\u{f9ed}"
        case .ram16: return "\u{f9ee}"
        case .reactions12: return "\u{f9ef}"
        case .reactions16: return "\u{f9f0}"
        case .reactions20: return "\u{f9f1}"
        case .realTimeTranslation24: return "\u{f9f2}"
        case .recents12: return "\u{f9f3}"
        case .recents14: return "\u{f9f4}"
        case .recents16: return "\u{f9f5}"
        case .recents18: return "\u{f9f6}"
        case .recents20: return "\u{f9f7}"
        case .recents24: return "\u{f9f8}"
        case .recents80: return "\u{f9f9}"
        case .recentsActive14: return "\u{f9fa}"
        case .recentsActive24: return "\u{f9fb}"
        case .recentsPresence12: return "\u{f9fc}"
        case .recentsPresence14: return "\u{f9fd}"
        case .recentsPresence24: return "\u{f9fe}"
        case .recentsPresence28: return "\u{f9ff}"
        case .recentsPresence8: return "\u{fa00}"
        case .recentsPresenceStroke10: return "\u{fa01}"
        case .recentsPresenceStroke14: return "\u{fa02}"
        case .recentsPresenceStroke16: return "\u{fa03}"
        case .recentsPresenceStroke26: return "\u{fa04}"
        case .recentsPresenceStroke30: return "\u{fa05}"
        case .record12: return "\u{fa06}"
        case .record14: return "\u{fa07}"
        case .record16: return "\u{fa08}"
        case .record20: return "\u{fa09}"
        case .record24: return "\u{fa0a}"
        case .record28: return "\u{fa0b}"
        case .recordActive12: return "\u{fa0c}"
        case .recordActive14: return "\u{fa0d}"
        case .recordActive16: return "\u{fa0e}"
        case .recordActive20: return "\u{fa0f}"
        case .recordActive24: return "\u{fa10}"
        case .recordActiveBg12: return "\u{fa11}"
        case .recordActiveBg14: return "\u{fa12}"
        case .recordActiveBg16: return "\u{fa13}"
        case .recordActiveBg20: return "\u{fa14}"
        case .recordActiveBg24: return "\u{fa15}"
        case .recordActiveCircle12: return "\u{fa16}"
        case .recordActiveCircle14: return "\u{fa17}"
        case .recordActiveCircle16: return "\u{fa18}"
        case .recordActiveCircle20: return "\u{fa19}"
        case .recordActiveCircle24: return "\u{fa1a}"
        case .recurring12: return "\u{fa1b}"
        case .recurring14: return "\u{fa1c}"
        case .recurring16: return "\u{fa1d}"
        case .recurring20: return "\u{fa1e}"
        case .recurring24: return "\u{fa1f}"
        case .recurringOff12: return "\u{fa20}"
        case .recurringOff16: return "\u{fa21}"
        case .redial16: return "\u{fa22}"
        case .redial20: return "\u{fa23}"
        case .redial24: return "\u{fa24}"
        case .redo12: return "\u{fa25}"
        case .redo14: return "\u{fa26}"
        case .redo16: return "\u{fa27}"
        case .refresh10: return "\u{fa28}"
        case .refresh12: return "\u{fa29}"
        case .refresh16: return "\u{fa2a}"
        case .refresh18: return "\u{fa2b}"
        case .refresh20: return "\u{fa2c}"
        case .refresh24: return "\u{fa2d}"
        case .remoteDesktopControl10: return "\u{fa2e}"
        case .remoteDesktopControl12: return "\u{fa2f}"
        case .remoteDesktopControl14: return "\u{fa30}"
        case .remoteDesktopControl16: return "\u{fa31}"
        case .remoteDesktopControl24: return "\u{fa32}"
        case .remoteDesktopControlActive10: return "\u{fa33}"
        case .remoteDesktopControlActive12: return "\u{fa34}"
        case .remove12: return "\u{fa35}"
        case .remove14: return "\u{fa36}"
        case .remove16: return "\u{fa37}"
        case .remove20: return "\u{fa38}"
        case .remove24: return "\u{fa39}"
        case .reply10: return "\u{fa3a}"
        case .reply12: return "\u{fa3b}"
        case .reply16: return "\u{fa3c}"
        case .reply20: return "\u{fa3d}"
        case .reply24: return "\u{fa3e}"
        case .replyList12: return "\u{fa3f}"
        case .replyList16: return "\u{fa40}"
        case .replyList20: return "\u{fa41}"
        case .report16: return "\u{fa42}"
        case .report28: return "\u{fa43}"
        case .reset16: return "\u{fa44}"
        case .reset24: return "\u{fa45}"
        case .response16: return "\u{fa46}"
        case .responsiveMobile16: return "\u{fa47}"
        case .retrieveCall14: return "\u{fa48}"
        case .retrieveCall16: return "\u{fa49}"
        case .return12: return "\u{fa4a}"
        case .return16: return "\u{fa4b}"
        case .ringtone16: return "\u{fa4c}"
        case .ringtone24: return "\u{fa4d}"
        case .roomCalendar24: return "\u{fa4e}"
        case .roomLights16: return "\u{fa4f}"
        case .roomLights24: return "\u{fa50}"
        case .rotateContent12: return "\u{fa51}"
        case .rotateContent16: return "\u{fa52}"
        case .rotateContent24: return "\u{fa53}"
        case .rotateLandscape16: return "\u{fa54}"
        case .rssCircle24: return "\u{fa55}"
        case .rssCircle32: return "\u{fa56}"
        case .rssCircle40: return "\u{fa57}"
        case .runningApplication16: return "\u{fa58}"
        case .runningApplication24: return "\u{fa59}"
        case .save12: return "\u{fa5a}"
        case .save14: return "\u{fa5b}"
        case .save16: return "\u{fa5c}"
        case .save24: return "\u{fa5d}"
        case .scan20: return "\u{fa5e}"
        case .scan24: return "\u{fa5f}"
        case .schedulerAvailable14: return "\u{fa60}"
        case .schedulerAvailable16: return "\u{fa61}"
        case .schedulerNotWorkingHours14: return "\u{fa62}"
        case .schedulerNotWorkingHours16: return "\u{fa63}"
        case .schedulerUnavailable14: return "\u{fa64}"
        case .schedulerUnavailable16: return "\u{fa65}"
        case .schedulerUnknown14: return "\u{fa66}"
        case .schedulerUnknown16: return "\u{fa67}"
        case .screenToggle10: return "\u{fa68}"
        case .screenToggle12: return "\u{fa69}"
        case .screenToggle16: return "\u{fa6a}"
        case .screenToggle20: return "\u{fa6b}"
        case .screenToggle24: return "\u{fa6c}"
        case .screenshot12: return "\u{fa6d}"
        case .screenshot16: return "\u{fa6e}"
        case .screenshot20: return "\u{fa6f}"
        case .screenshot24: return "\u{fa70}"
        case .search12: return "\u{fa71}"
        case .search14: return "\u{fa72}"
        case .search16: return "\u{fa73}"
        case .search18: return "\u{fa74}"
        case .search20: return "\u{fa75}"
        case .search24: return "\u{fa76}"
        case .search28: return "\u{fa77}"
        case .secure10: return "\u{fa78}"
        case .secure12: return "\u{fa79}"
        case .secure14: return "\u{fa7a}"
        case .secure16: return "\u{fa7b}"
        case .secure20: return "\u{fa7c}"
        case .secure24: return "\u{fa7d}"
        case .secure28: return "\u{fa7e}"
        case .secure8: return "\u{fa7f}"
        case .secureActive12: return "\u{fa80}"
        case .secureActive14: return "\u{fa81}"
        case .secureActive16: return "\u{fa82}"
        case .secureActive20: return "\u{fa83}"
        case .secureActive24: return "\u{fa84}"
        case .secureActive28: return "\u{fa85}"
        case .secureActive8: return "\u{fa86}"
        case .secureBadge28: return "\u{fa87}"
        case .secureCircle14: return "\u{fa88}"
        case .secureCircle16: return "\u{fa89}"
        case .secureCircleActive14: return "\u{fa8a}"
        case .secureCircleActive16: return "\u{fa8b}"
        case .secureFips24: return "\u{fa8c}"
        case .selfview16: return "\u{fa8d}"
        case .selfview20: return "\u{fa8e}"
        case .selfview24: return "\u{fa8f}"
        case .send12: return "\u{fa90}"
        case .send14: return "\u{fa91}"
        case .send16: return "\u{fa92}"
        case .send20: return "\u{fa93}"
        case .send24: return "\u{fa94}"
        case .seperate12: return "\u{fa95}"
        case .seperate16: return "\u{fa96}"
        case .seperate20: return "\u{fa97}"
        case .seperate24: return "\u{fa98}"
        case .server16: return "\u{fa99}"
        case .server24: return "\u{fa9a}"
        case .serverCircle100: return "\u{fa9b}"
        case .serverError16: return "\u{fa9c}"
        case .setVariable16: return "\u{fa9d}"
        case .setVariable20: return "\u{fa9e}"
        case .settings10: return "\u{fa9f}"
        case .settings12: return "\u{faa0}"
        case .settings14: return "\u{faa1}"
        case .settings16: return "\u{faa2}"
        case .settings18: return "\u{faa3}"
        case .settings20: return "\u{faa4}"
        case .settings24: return "\u{faa5}"
        case .settings32: return "\u{faa6}"
        case .settings8: return "\u{faa7}"
        case .settingsActive10: return "\u{faa8}"
        case .settingsActive12: return "\u{faa9}"
        case .settingsActive14: return "\u{faaa}"
        case .settingsActive16: return "\u{faab}"
        case .settingsActive18: return "\u{faac}"
        case .settingsActive20: return "\u{faad}"
        case .settingsActive24: return "\u{faae}"
        case .settingsActive32: return "\u{faaf}"
        case .settingsActive8: return "\u{fab0}"
        case .setupAssistant16: return "\u{fab1}"
        case .shakeDevice18: return "\u{fab2}"
        case .shakeDevice20: return "\u{fab3}"
        case .shapeCircle20: return "\u{fab4}"
        case .shapeCone20: return "\u{fab5}"
        case .shapeCylinder20: return "\u{fab6}"
        case .shapeDiagonalArrowheadDual16: return "\u{fab7}"
        case .shapeDiagonalArrowheadSingle16: return "\u{fab8}"
        case .shapeDiagonalArrowheadSingle20: return "\u{fab9}"
        case .shapeDiagonalLine16: return "\u{faba}"
        case .shapeDiagonalLine20: return "\u{fabb}"
        case .shapeOval16: return "\u{fabc}"
        case .shapeOval20: return "\u{fabd}"
        case .shapePolygon20: return "\u{fabe}"
        case .shapeSphere20: return "\u{fabf}"
        case .shapeSquare16: return "\u{fac0}"
        case .shapeSquare20: return "\u{fac1}"
        case .shapes16: return "\u{fac2}"
        case .share12: return "\u{fac3}"
        case .share14: return "\u{fac4}"
        case .share16: return "\u{fac5}"
        case .share18: return "\u{fac6}"
        case .share20: return "\u{fac7}"
        case .share24: return "\u{fac8}"
        case .share28: return "\u{fac9}"
        case .share32: return "\u{faca}"
        case .shareCNativeAdr12: return "\u{facb}"
        case .shareCNativeAdr14: return "\u{facc}"
        case .shareCNativeAdr16: return "\u{facd}"
        case .shareCNativeAdr24: return "\u{face}"
        case .shareCNativeIos10: return "\u{facf}"
        case .shareCNativeIos12: return "\u{fad0}"
        case .shareCNativeIos14: return "\u{fad1}"
        case .shareCNativeIos16: return "\u{fad2}"
        case .shareCNativeIos20: return "\u{fad3}"
        case .shareCNativeIos28: return "\u{fad4}"
        case .shareCNativeIph10: return "\u{fad5}"
        case .shareCNativeIph12: return "\u{fad6}"
        case .shareCNativeIph14: return "\u{fad7}"
        case .shareCNativeIph16: return "\u{fad8}"
        case .shareCNativeIph20: return "\u{fad9}"
        case .shareCNativeIph24: return "\u{fada}"
        case .shareCNativeIph28: return "\u{fadb}"
        case .shareScreen10: return "\u{fadc}"
        case .shareScreen12: return "\u{fadd}"
        case .shareScreen120: return "\u{fade}"
        case .shareScreen124: return "\u{fadf}"
        case .shareScreen14: return "\u{fae0}"
        case .shareScreen16: return "\u{fae1}"
        case .shareScreen18: return "\u{fae2}"
        case .shareScreen20: return "\u{fae3}"
        case .shareScreen24: return "\u{fae4}"
        case .shareScreen26: return "\u{fae5}"
        case .shareScreen28: return "\u{fae6}"
        case .shareScreen32: return "\u{fae7}"
        case .shareScreen36: return "\u{fae8}"
        case .shareScreen48: return "\u{fae9}"
        case .shareScreen56: return "\u{faea}"
        case .shareScreen8: return "\u{faeb}"
        case .shareScreenActive14: return "\u{faec}"
        case .shareScreenActive24: return "\u{faed}"
        case .shareScreenPresence12: return "\u{faee}"
        case .shareScreenPresence14: return "\u{faef}"
        case .shareScreenPresence28: return "\u{faf0}"
        case .shareScreenPresence8: return "\u{faf1}"
        case .shareScreenPresenceStroke12: return "\u{faf2}"
        case .shareScreenPresenceStroke14: return "\u{faf3}"
        case .shareScreenPresenceStroke16: return "\u{faf4}"
        case .shareScreenPresenceStroke26: return "\u{faf5}"
        case .shareScreenPresenceStroke30: return "\u{faf6}"
        case .shareSpace12: return "\u{faf7}"
        case .shareSpace14: return "\u{faf8}"
        case .shareSpace18: return "\u{faf9}"
        case .shareSpace20: return "\u{fafa}"
        case .shareSpace24: return "\u{fafb}"
        case .shield12: return "\u{fafc}"
        case .shield14: return "\u{fafd}"
        case .shield20: return "\u{fafe}"
        case .shield24: return "\u{faff}"
        case .show12: return "\u{fb00}"
        case .show16: return "\u{fb01}"
        case .show20: return "\u{fb02}"
        case .show24: return "\u{fb03}"
        case .sideBySideActive24: return "\u{fb04}"
        case .signIn16: return "\u{fb05}"
        case .signIn20: return "\u{fb06}"
        case .signIn24: return "\u{fb07}"
        case .signInForced16: return "\u{fb08}"
        case .signInForced24: return "\u{fb09}"
        case .signOut10: return "\u{fb0a}"
        case .signOut12: return "\u{fb0b}"
        case .signOut16: return "\u{fb0c}"
        case .signOut20: return "\u{fb0d}"
        case .signOut24: return "\u{fb0e}"
        case .signal016: return "\u{fb0f}"
        case .signal10012: return "\u{fb10}"
        case .signal10016: return "\u{fb11}"
        case .signal2516: return "\u{fb12}"
        case .signal5016: return "\u{fb13}"
        case .signal7516: return "\u{fb14}"
        case .singleNumberReach12: return "\u{fb15}"
        case .singleNumberReach14: return "\u{fb16}"
        case .singleNumberReach16: return "\u{fb17}"
        case .singleNumberReach20: return "\u{fb18}"
        case .skip10: return "\u{fb19}"
        case .skip16: return "\u{fb1a}"
        case .skip24: return "\u{fb1b}"
        case .skipBw16: return "\u{fb1c}"
        case .skipBw24: return "\u{fb1d}"
        case .skipFw16: return "\u{fb1e}"
        case .skipFw24: return "\u{fb1f}"
        case .sms12: return "\u{fb20}"
        case .sms16: return "\u{fb21}"
        case .sortDown12: return "\u{fb22}"
        case .sortDown16: return "\u{fb23}"
        case .sortDown20: return "\u{fb24}"
        case .sortDown24: return "\u{fb25}"
        case .sortUp20: return "\u{fb26}"
        case .sortUp24: return "\u{fb27}"
        case .space12: return "\u{fb28}"
        case .space16: return "\u{fb29}"
        case .spark16: return "\u{fb2a}"
        case .sparkBoard12: return "\u{fb2b}"
        case .sparkBoard14: return "\u{fb2c}"
        case .sparkBoard16: return "\u{fb2d}"
        case .sparkBoard20: return "\u{fb2e}"
        case .sparkBoard24: return "\u{fb2f}"
        case .sparkBoard28: return "\u{fb30}"
        case .sparkBoard32: return "\u{fb31}"
        case .sparkBoard48: return "\u{fb32}"
        case .sparkQuadCamera16: return "\u{fb33}"
        case .sparkQuadCamera20: return "\u{fb34}"
        case .sparkRoomKit16: return "\u{fb35}"
        case .sparkRoomKit20: return "\u{fb36}"
        case .sparkRoomKitPlus16: return "\u{fb37}"
        case .sparkRoomKitPlus20: return "\u{fb38}"
        case .sparkShare16: return "\u{fb39}"
        case .sparkShare20: return "\u{fb3a}"
        case .sparkVoice16: return "\u{fb3b}"
        case .sparkVoice20: return "\u{fb3c}"
        case .speaker12: return "\u{fb3d}"
        case .speaker16: return "\u{fb3e}"
        case .speaker20: return "\u{fb3f}"
        case .speaker24: return "\u{fb40}"
        case .speaker28: return "\u{fb41}"
        case .speakerBluetooth16: return "\u{fb42}"
        case .speakerDisconnected12: return "\u{fb43}"
        case .speakerDisconnected14: return "\u{fb44}"
        case .speakerDisconnected16: return "\u{fb45}"
        case .speakerDisconnected20: return "\u{fb46}"
        case .speakerDisconnected24: return "\u{fb47}"
        case .speakerDisconnected28: return "\u{fb48}"
        case .speakerDisconnected36: return "\u{fb49}"
        case .speakerLineOutLeft16: return "\u{fb4a}"
        case .speakerLineOutRight16: return "\u{fb4b}"
        case .speakerMuted12: return "\u{fb4c}"
        case .speakerMuted14: return "\u{fb4d}"
        case .speakerMuted16: return "\u{fb4e}"
        case .speakerMuted24: return "\u{fb4f}"
        case .speakerMuted28: return "\u{fb50}"
        case .speakerMuted32: return "\u{fb51}"
        case .speakerOff16: return "\u{fb52}"
        case .speakerOff24: return "\u{fb53}"
        case .speakerOff28: return "\u{fb54}"
        case .speakerTurnDown16: return "\u{fb55}"
        case .speakerTurnUp16: return "\u{fb56}"
        case .spinner12: return "\u{fb57}"
        case .spinner14: return "\u{fb58}"
        case .spinner16: return "\u{fb59}"
        case .spinner18: return "\u{fb5a}"
        case .spinner20: return "\u{fb5b}"
        case .spinner24: return "\u{fb5c}"
        case .spinner28: return "\u{fb5d}"
        case .spinner32: return "\u{fb5e}"
        case .spinner36: return "\u{fb5f}"
        case .spinner40: return "\u{fb60}"
        case .spinner48: return "\u{fb61}"
        case .spinner56: return "\u{fb62}"
        case .spinner72: return "\u{fb63}"
        case .spinner8: return "\u{fb64}"
        case .spinner80: return "\u{fb65}"
        case .spinner90: return "\u{fb66}"
        case .spreadsheet16: return "\u{fb67}"
        case .stackedArea100Chart16: return "\u{fb68}"
        case .stackedAreaChart16: return "\u{fb69}"
        case .stackedBar100Chart16: return "\u{fb6a}"
        case .stackedBarChart16: return "\u{fb6b}"
        case .startChat20: return "\u{fb6c}"
        case .startChat24: return "\u{fb6d}"
        case .stickers16: return "\u{fb6e}"
        case .stickers24: return "\u{fb6f}"
        case .stickies12: return "\u{fb70}"
        case .stickies16: return "\u{fb71}"
        case .stickies24: return "\u{fb72}"
        case .stop10: return "\u{fb73}"
        case .stop12: return "\u{fb74}"
        case .stop16: return "\u{fb75}"
        case .stop20: return "\u{fb76}"
        case .stop24: return "\u{fb77}"
        case .stopCircle12: return "\u{fb78}"
        case .stopCircle16: return "\u{fb79}"
        case .stopCircle20: return "\u{fb7a}"
        case .stopCircle24: return "\u{fb7b}"
        case .stopContentShare20: return "\u{fb7c}"
        case .storedInfo12: return "\u{fb7d}"
        case .storedInfo16: return "\u{fb7e}"
        case .storedInfo20: return "\u{fb7f}"
        case .storedInfo24: return "\u{fb80}"
        case .storedInfoActive12: return "\u{fb81}"
        case .storedInfoActive16: return "\u{fb82}"
        case .storedInfoActive20: return "\u{fb83}"
        case .storedInfoActive24: return "\u{fb84}"
        case .streaming16: return "\u{fb85}"
        case .streaming20: return "\u{fb86}"
        case .streaming24: return "\u{fb87}"
        case .subscribe16: return "\u{fb88}"
        case .subscript12: return "\u{fb89}"
        case .subscript16: return "\u{fb8a}"
        case .superscript12: return "\u{fb8b}"
        case .superscript16: return "\u{fb8c}"
        case .swift16: return "\u{fb8d}"
        case .sx1016: return "\u{fb8e}"
        case .sx1020: return "\u{fb8f}"
        case .sx2016: return "\u{fb90}"
        case .sx2020: return "\u{fb91}"
        case .sx80Codec16: return "\u{fb92}"
        case .sx80Codec20: return "\u{fb93}"
        case .tablet12: return "\u{fb94}"
        case .tablet16: return "\u{fb95}"
        case .tablet24: return "\u{fb96}"
        case .tabs16: return "\u{fb97}"
        case .tabs24: return "\u{fb98}"
        case .tag12: return "\u{fb99}"
        case .tag16: return "\u{fb9a}"
        case .tag20: return "\u{fb9b}"
        case .tap20: return "\u{fb9c}"
        case .tasks10: return "\u{fb9d}"
        case .tasks12: return "\u{fb9e}"
        case .tasks14: return "\u{fb9f}"
        case .tasks16: return "\u{fba0}"
        case .tasks18: return "\u{fba1}"
        case .tasks20: return "\u{fba2}"
        case .tasks24: return "\u{fba3}"
        case .tasks26: return "\u{fba4}"
        case .tasks28: return "\u{fba5}"
        case .tasks32: return "\u{fba6}"
        case .tasks36: return "\u{fba7}"
        case .tasks8: return "\u{fba8}"
        case .team12: return "\u{fba9}"
        case .team14: return "\u{fbaa}"
        case .team16: return "\u{fbab}"
        case .team18: return "\u{fbac}"
        case .team20: return "\u{fbad}"
        case .team24: return "\u{fbae}"
        case .team32: return "\u{fbaf}"
        case .teamActive12: return "\u{fbb0}"
        case .teamActive14: return "\u{fbb1}"
        case .teamActive16: return "\u{fbb2}"
        case .teamActive18: return "\u{fbb3}"
        case .teamActive20: return "\u{fbb4}"
        case .teamActive24: return "\u{fbb5}"
        case .teamActive32: return "\u{fbb6}"
        case .teamNew24: return "\u{fbb7}"
        case .telepresence12: return "\u{fbb8}"
        case .telepresence14: return "\u{fbb9}"
        case .telepresence16: return "\u{fbba}"
        case .telepresence18: return "\u{fbbb}"
        case .telepresence20: return "\u{fbbc}"
        case .telepresence24: return "\u{fbbd}"
        case .telepresence64: return "\u{fbbe}"
        case .telepresenceAlert12: return "\u{fbbf}"
        case .telepresenceIx500016: return "\u{fbc0}"
        case .telepresenceIx500020: return "\u{fbc1}"
        case .telepresenceMuted12: return "\u{fbc2}"
        case .telepresenceMuted64: return "\u{fbc3}"
        case .telepresenceMutedAlert12: return "\u{fbc4}"
        case .telepresencePrivate12: return "\u{fbc5}"
        case .temperature14: return "\u{fbc6}"
        case .text10: return "\u{fbc7}"
        case .text12: return "\u{fbc8}"
        case .text16: return "\u{fbc9}"
        case .textAlignLeft16: return "\u{fbca}"
        case .textAlignRight16: return "\u{fbcb}"
        case .textBlockquote12: return "\u{fbcc}"
        case .textBlockquote16: return "\u{fbcd}"
        case .textBlockquote18: return "\u{fbce}"
        case .textBlockquote20: return "\u{fbcf}"
        case .textBlockquote8: return "\u{fbd0}"
        case .textBold12: return "\u{fbd1}"
        case .textBold16: return "\u{fbd2}"
        case .textBold24: return "\u{fbd3}"
        case .textCodeBlock12: return "\u{fbd4}"
        case .textCodeBlock16: return "\u{fbd5}"
        case .textCodeBlock24: return "\u{fbd6}"
        case .textCodeInline12: return "\u{fbd7}"
        case .textCodeInline16: return "\u{fbd8}"
        case .textColor12: return "\u{fbd9}"
        case .textColor16: return "\u{fbda}"
        case .textFormat10: return "\u{fbdb}"
        case .textFormat12: return "\u{fbdc}"
        case .textFormat16: return "\u{fbdd}"
        case .textFormat20: return "\u{fbde}"
        case .textFormat24: return "\u{fbdf}"
        case .textFormat8: return "\u{fbe0}"
        case .textHeading112: return "\u{fbe1}"
        case .textHeading116: return "\u{fbe2}"
        case .textHeading212: return "\u{fbe3}"
        case .textHeading216: return "\u{fbe4}"
        case .textHeading312: return "\u{fbe5}"
        case .textHeading316: return "\u{fbe6}"
        case .textHighlight12: return "\u{fbe7}"
        case .textHighlight16: return "\u{fbe8}"
        case .textIndentDecrease12: return "\u{fbe9}"
        case .textIndentIncrease12: return "\u{fbea}"
        case .textItalic12: return "\u{fbeb}"
        case .textItalic16: return "\u{fbec}"
        case .textItalic24: return "\u{fbed}"
        case .textListBulleted10: return "\u{fbee}"
        case .textListBulleted12: return "\u{fbef}"
        case .textListBulleted16: return "\u{fbf0}"
        case .textListBulleted24: return "\u{fbf1}"
        case .textListBulleted8: return "\u{fbf2}"
        case .textListNumbered12: return "\u{fbf3}"
        case .textListNumbered16: return "\u{fbf4}"
        case .textListNumbered24: return "\u{fbf5}"
        case .textListNumbered36: return "\u{fbf6}"
        case .textListNumbered40: return "\u{fbf7}"
        case .textStrikethrough12: return "\u{fbf8}"
        case .textStrikethrough16: return "\u{fbf9}"
        case .textTable12: return "\u{fbfa}"
        case .textTable16: return "\u{fbfb}"
        case .textUnderline12: return "\u{fbfc}"
        case .textUnderline16: return "\u{fbfd}"
        case .textUnderline24: return "\u{fbfe}"
        case .tooFast12: return "\u{fbff}"
        case .tooFast16: return "\u{fc00}"
        case .tooSlow12: return "\u{fc01}"
        case .tooSlow16: return "\u{fc02}"
        case .tools16: return "\u{fc03}"
        case .tools20: return "\u{fc04}"
        case .tools24: return "\u{fc05}"
        case .tools28: return "\u{fc06}"
        case .tools32: return "\u{fc07}"
        case .touch16: return "\u{fc08}"
        case .touch1024: return "\u{fc09}"
        case .transcript16: return "\u{fc0a}"
        case .transcript20: return "\u{fc0b}"
        case .trending10: return "\u{fc0c}"
        case .twitter12: return "\u{fc0d}"
        case .twitter16: return "\u{fc0e}"
        case .twitterCircle24: return "\u{fc0f}"
        case .twitterCircle32: return "\u{fc10}"
        case .twitterCircle40: return "\u{fc11}"
        case .ucmCloud10: return "\u{fc12}"
        case .ucmCloud16: return "\u{fc13}"
        case .ucmCloud24: return "\u{fc14}"
        case .ucmCloud32: return "\u{fc15}"
        case .unassignPhoneNumber16: return "\u{fc16}"
        case .undo12: return "\u{fc17}"
        case .undo14: return "\u{fc18}"
        case .undo16: return "\u{fc19}"
        case .undo24: return "\u{fc1a}"
        case .unlink20: return "\u{fc1b}"
        case .unreadBadge10: return "\u{fc1c}"
        case .unreadBadge12: return "\u{fc1d}"
        case .unreadBadge16: return "\u{fc1e}"
        case .unreadBadge8: return "\u{fc1f}"
        case .unsecure12: return "\u{fc20}"
        case .unsecure14: return "\u{fc21}"
        case .unsecure16: return "\u{fc22}"
        case .unsecure24: return "\u{fc23}"
        case .unsecure28: return "\u{fc24}"
        case .unsorted10: return "\u{fc25}"
        case .unsorted16: return "\u{fc26}"
        case .unsorted24: return "\u{fc27}"
        case .updateFileShare12: return "\u{fc28}"
        case .updateFileShare16: return "\u{fc29}"
        case .updateFileShare24: return "\u{fc2a}"
        case .upgrade20: return "\u{fc2b}"
        case .upload12: return "\u{fc2c}"
        case .upload130: return "\u{fc2d}"
        case .upload14: return "\u{fc2e}"
        case .upload16: return "\u{fc2f}"
        case .upload18: return "\u{fc30}"
        case .upload20: return "\u{fc31}"
        case .upload24: return "\u{fc32}"
        case .upload28: return "\u{fc33}"
        case .upload32: return "\u{fc34}"
        case .upload36: return "\u{fc35}"
        case .usb16: return "\u{fc36}"
        case .user16: return "\u{fc37}"
        case .user20: return "\u{fc38}"
        case .user24: return "\u{fc39}"
        case .user56: return "\u{fc3a}"
        case .videoEffect12: return "\u{fc3b}"
        case .videoEffect16: return "\u{fc3c}"
        case .videoEffect20: return "\u{fc3d}"
        case .videoLayout12: return "\u{fc3e}"
        case .videoLayout16: return "\u{fc3f}"
        case .videoLayoutAuto12: return "\u{fc40}"
        case .videoLayoutAuto16: return "\u{fc41}"
        case .videoLayoutAuto20: return "\u{fc42}"
        case .videoLayoutAuto24: return "\u{fc43}"
        case .videoLayoutEqual12: return "\u{fc44}"
        case .videoLayoutEqual14: return "\u{fc45}"
        case .videoLayoutEqual16: return "\u{fc46}"
        case .videoLayoutEqual20: return "\u{fc47}"
        case .videoLayoutEqual24: return "\u{fc48}"
        case .videoLayoutEqual28: return "\u{fc49}"
        case .videoLayoutEqualFilled24: return "\u{fc4a}"
        case .videoLayoutOverlay12: return "\u{fc4b}"
        case .videoLayoutOverlay16: return "\u{fc4c}"
        case .videoLayoutOverlay20: return "\u{fc4d}"
        case .videoLayoutOverlay24: return "\u{fc4e}"
        case .videoLayoutProminent12: return "\u{fc4f}"
        case .videoLayoutProminent16: return "\u{fc50}"
        case .videoLayoutProminent20: return "\u{fc51}"
        case .videoLayoutProminent24: return "\u{fc52}"
        case .videoLayoutShareDominant12: return "\u{fc53}"
        case .videoLayoutShareDominant16: return "\u{fc54}"
        case .videoLayoutShareDominant20: return "\u{fc55}"
        case .videoLayoutShareDominant24: return "\u{fc56}"
        case .videoLayoutSingle12: return "\u{fc57}"
        case .videoLayoutSingle16: return "\u{fc58}"
        case .videoLayoutSingle20: return "\u{fc59}"
        case .videoLayoutSingle28: return "\u{fc5a}"
        case .videoLayoutStack12: return "\u{fc5b}"
        case .videoLayoutStack16: return "\u{fc5c}"
        case .videoLayoutStack20: return "\u{fc5d}"
        case .videoLayoutStack24: return "\u{fc5e}"
        case .videoLayoutStack28: return "\u{fc5f}"
        case .videoLayoutStackFilled24: return "\u{fc60}"
        case .videoLayoutVideoDominant12: return "\u{fc61}"
        case .videoLayoutVideoDominant16: return "\u{fc62}"
        case .videoLayoutVideoDominant20: return "\u{fc63}"
        case .videoLayoutVideoDominant24: return "\u{fc64}"
        case .viewAll12: return "\u{fc65}"
        case .viewAll14: return "\u{fc66}"
        case .viewFeedMultiple16: return "\u{fc67}"
        case .viewFeedPanel16: return "\u{fc68}"
        case .viewFeedSingle16: return "\u{fc69}"
        case .viewList10: return "\u{fc6a}"
        case .viewList12: return "\u{fc6b}"
        case .viewList14: return "\u{fc6c}"
        case .viewList16: return "\u{fc6d}"
        case .viewList20: return "\u{fc6e}"
        case .viewList24: return "\u{fc6f}"
        case .viewList28: return "\u{fc70}"
        case .viewListCircle100: return "\u{fc71}"
        case .viewMixed12: return "\u{fc72}"
        case .viewStack12: return "\u{fc73}"
        case .viewStack14: return "\u{fc74}"
        case .viewStack20: return "\u{fc75}"
        case .viewStack24: return "\u{fc76}"
        case .viewThumbnail12: return "\u{fc77}"
        case .viewThumbnail14: return "\u{fc78}"
        case .viewThumbnail16: return "\u{fc79}"
        case .viewThumbnail20: return "\u{fc7a}"
        case .viewThumbnail24: return "\u{fc7b}"
        case .voice20: return "\u{fc7c}"
        case .voicemail10: return "\u{fc7d}"
        case .voicemail14: return "\u{fc7e}"
        case .voicemail16: return "\u{fc7f}"
        case .voicemail18: return "\u{fc80}"
        case .voicemail20: return "\u{fc81}"
        case .voicemail22: return "\u{fc82}"
        case .voicemail24: return "\u{fc83}"
        case .voicemail28: return "\u{fc84}"
        case .voicemail8: return "\u{fc85}"
        case .voicemailActive12: return "\u{fc86}"
        case .voicemailActive14: return "\u{fc87}"
        case .voicemailActive16: return "\u{fc88}"
        case .voicemailActive18: return "\u{fc89}"
        case .voicemailActive20: return "\u{fc8a}"
        case .voicemailActive22: return "\u{fc8b}"
        case .voicemailActive24: return "\u{fc8c}"
        case .voicemailActive28: return "\u{fc8d}"
        case .wallpaper16: return "\u{fc8e}"
        case .wallpaper20: return "\u{fc8f}"
        case .wallpaper24: return "\u{fc90}"
        case .wallpaper28: return "\u{fc91}"
        case .wallpaper32: return "\u{fc92}"
        case .warning100: return "\u{fc93}"
        case .warning12: return "\u{fc94}"
        case .warning14: return "\u{fc95}"
        case .warning16: return "\u{fc96}"
        case .warning20: return "\u{fc97}"
        case .warning24: return "\u{fc98}"
        case .warning28: return "\u{fc99}"
        case .warning32: return "\u{fc9a}"
        case .warning40: return "\u{fc9b}"
        case .warning44: return "\u{fc9c}"
        case .warning56: return "\u{fc9d}"
        case .warning64: return "\u{fc9e}"
        case .warning72: return "\u{fc9f}"
        case .warningActive12: return "\u{fca0}"
        case .warningActive16: return "\u{fca1}"
        case .waveform20: return "\u{fca2}"
        case .webSharing16: return "\u{fca3}"
        case .webSharing24: return "\u{fca4}"
        case .webex10: return "\u{fca5}"
        case .webex16: return "\u{fca6}"
        case .webex24: return "\u{fca7}"
        case .webex48: return "\u{fca8}"
        case .webexBoard12: return "\u{fca9}"
        case .webexBoard14: return "\u{fcaa}"
        case .webexBoard16: return "\u{fcab}"
        case .webexBoard20: return "\u{fcac}"
        case .webexBoard24: return "\u{fcad}"
        case .webexBoard28: return "\u{fcae}"
        case .webexBoard32: return "\u{fcaf}"
        case .webexBoard48: return "\u{fcb0}"
        case .webexCalling10: return "\u{fcb1}"
        case .webexCalling12: return "\u{fcb2}"
        case .webexCalling16: return "\u{fcb3}"
        case .webexCalling18: return "\u{fcb4}"
        case .webexCalling20: return "\u{fcb5}"
        case .webexCalling24: return "\u{fcb6}"
        case .webexCodecPlus16: return "\u{fcb7}"
        case .webexCodecPlus20: return "\u{fcb8}"
        case .webexCommunity20: return "\u{fcb9}"
        case .webexDeskCamera20: return "\u{fcba}"
        case .webexInstantMeeting12: return "\u{fcbb}"
        case .webexInstantMeeting14: return "\u{fcbc}"
        case .webexInstantMeeting16: return "\u{fcbd}"
        case .webexInstantMeeting20: return "\u{fcbe}"
        case .webexInstantMeeting24: return "\u{fcbf}"
        case .webexMeetings10: return "\u{fcc0}"
        case .webexMeetings12: return "\u{fcc1}"
        case .webexMeetings14: return "\u{fcc2}"
        case .webexMeetings16: return "\u{fcc3}"
        case .webexMeetings20: return "\u{fcc4}"
        case .webexMeetings24: return "\u{fcc5}"
        case .webexMeetings48: return "\u{fcc6}"
        case .webexQuadCamera16: return "\u{fcc7}"
        case .webexQuadCamera20: return "\u{fcc8}"
        case .webexRoomKit16: return "\u{fcc9}"
        case .webexRoomKit20: return "\u{fcca}"
        case .webexRoomKitPlus16: return "\u{fccb}"
        case .webexRoomKitPlus20: return "\u{fccc}"
        case .webexShare12: return "\u{fccd}"
        case .webexShare14: return "\u{fcce}"
        case .webexShare16: return "\u{fccf}"
        case .webexShare20: return "\u{fcd0}"
        case .webexTeams10: return "\u{fcd1}"
        case .webexTeams12: return "\u{fcd2}"
        case .webexTeams14: return "\u{fcd3}"
        case .webexTeams16: return "\u{fcd4}"
        case .webexTeams18: return "\u{fcd5}"
        case .webexTeams20: return "\u{fcd6}"
        case .webexVoice16: return "\u{fcd7}"
        case .webexVoice20: return "\u{fcd8}"
        case .webpop12: return "\u{fcd9}"
        case .webpop16: return "\u{fcda}"
        case .webpop20: return "\u{fcdb}"
        case .webpop24: return "\u{fcdc}"
        case .whatsApp12: return "\u{fcdd}"
        case .whatsApp16: return "\u{fcde}"
        case .whiteboard10: return "\u{fcdf}"
        case .whiteboard12: return "\u{fce0}"
        case .whiteboard14: return "\u{fce1}"
        case .whiteboard16: return "\u{fce2}"
        case .whiteboard20: return "\u{fce3}"
        case .whiteboard24: return "\u{fce4}"
        case .whiteboard26: return "\u{fce5}"
        case .whiteboard28: return "\u{fce6}"
        case .whiteboard32: return "\u{fce7}"
        case .whiteboard36: return "\u{fce8}"
        case .whiteboard8: return "\u{fce9}"
        case .whiteboardContent16: return "\u{fcea}"
        case .whiteboardContent24: return "\u{fceb}"
        case .widgetsAdr20: return "\u{fcec}"
        case .wifi12: return "\u{fced}"
        case .wifi16: return "\u{fcee}"
        case .wifi20: return "\u{fcef}"
        case .wifi24: return "\u{fcf0}"
        case .wifiError12: return "\u{fcf1}"
        case .wifiError16: return "\u{fcf2}"
        case .wifiSelected24: return "\u{fcf3}"
        case .wikipedia16: return "\u{fcf4}"
        case .windowCornerScrub16: return "\u{fcf5}"
        case .windowVerticalScrub16: return "\u{fcf6}"
        case .youtubeCircle24: return "\u{fcf7}"
        case .youtubeCircle32: return "\u{fcf8}"
        case .youtubeCircle40: return "\u{fcf9}"
        case .zoomIn12: return "\u{fcfa}"
        case .zoomIn14: return "\u{fcfb}"
        case .zoomIn16: return "\u{fcfc}"
        case .zoomIn20: return "\u{fcfd}"
        case .zoomOut12: return "\u{fcfe}"
        case .zoomOut14: return "\u{fcff}"
        case .zoomOut16: return "\u{fd00}"
        case .zoomOut20: return "\u{fd01}"
