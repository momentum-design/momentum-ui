...
var Topbar = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    var brandNodeChildren = [_react.default.createElement("div", {
      className: brandClass + "__logo" + ("" + (addPadding && " " + brandClass + "__logo--pad" || '')),
      key: brandClass + "__logo"
    }, image ? image : _react.default.createElement("i", {
      className: "icon " + icon
    }))].concat(title && _react.default.createElement("div", {
      className: brandClass + "__title",
      key: brandClass + "__title"
    }, title));

    var getBrandAnchor = function getBrandAnchor() {
      return brandAnchorElement ? _react.default.cloneElement(brandAnchorElement, {
        className: "" + brandClass + ("" + (brandAnchorElement.props.className && " " + brandAnchorElement.props.className || ''))
      }, brandNodeChildren) : _react.default.createElement("a", {
        className: brandClass,
        href: anchor
      }, brandNodeChildren);
    };

    var brandNode = _react.default.createElement("div", {
