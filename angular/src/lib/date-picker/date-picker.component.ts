import { Component, OnInit, Input, Output, EventEmitter, HostBinding, HostListener, ViewContainerRef, TemplateRef, ViewChild } from '@angular/core';
...
@Component({
  ...
  `,
  styles: [
    '.cui-datepicker__month-container{display: block !important;}'
  ],
...
export class DatePickerComponent implements OnInit {
  ...
  @HostBinding('class') get classes(): string {
    return 'cui-datepicker-container'+
  ...
  @HostListener('click', ['$event']) stopClick(e){
    e.stopPropagation();
    e.preventDefault();
    return false;
  }

  @HostListener('window:click', ['$event']) windowClick(e){
