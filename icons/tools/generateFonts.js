...
function generateNamesJSON(OPTIONS) {
  return new Promise((resolve, reject) => {
    ...
    webfontsGenerator(options, function(error, result) {
      if (error) {
        reject(console.error('iconNames.json FAIL!', error));
      }
...
function generatePathScss(OPTIONS) {
  return new Promise((resolve, reject) => {
    ...
    webfontsGenerator(options, function(error, result) {
      if (error) {
        reject(console.error('path.scss FAIL!', error));
      }
...
function generateIconsScss(OPTIONS) {
  return new Promise((resolve, reject) => {
    ...
    webfontsGenerator(options, function(error, result) {
      if (error) {
        reject(console.error('icons.scss FAIL!', error));
      }
...
function generatePlaceholdersScss(OPTIONS) {
  return new Promise((resolve, reject) => {
    ...
    webfontsGenerator(options, function(error, result) {
      if (error) {
        reject(console.error('placeholders.scss FAIL!', error));
      }
...
function generateMixinsScss(OPTIONS) {
  return new Promise((resolve, reject) => {
    ...
    webfontsGenerator(options, function(error, result) {
      if (error) {
        reject(console.error('mixins.scss FAIL!', error));
      }
...
function generateIconType(OPTIONS) {
  return new Promise((resolve, reject) => {
    ...
    webfontsGenerator(options, function(error, result) {
      if (error) {
        reject(console.error('CollabIconType.swift', error));
      }
...
function generateVariablesScss(OPTIONS) {
  return new Promise((resolve, reject) => {
    ...
    webfontsGenerator(options, function(error, result) {
      if (error) {
        reject(console.error('variables.scss FAIL!', error));
      }
...
function generateFonts() {
  return new Promise(resolve => {
    glob(['svg/**/*.svg'], (er, files) => {
      ...
      const generatePromises = [generatePathScss, generateIconsScss, generateVariablesScss, generatePlaceholdersScss, generateMixinsScss, generateIconType, generateNamesJSON];
