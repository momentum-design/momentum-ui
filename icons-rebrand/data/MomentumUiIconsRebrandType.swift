...
@objc public enum MomentumIconsRebrandType: Int {
    ...
    public var ligature: String {
        ...
        case .analysisBold: return "\u{f161}"
        case .analysisFilled: return "\u{f162}"
        case .analysisLight: return "\u{f163}"
        case .analysisRegular: return "\u{f164}"
        case .annotateBold: return "\u{f165}"
        case .annotateFilled: return "\u{f166}"
        case .annotateLight: return "\u{f167}"
        case .annotateRegular: return "\u{f168}"
        case .announcementBold: return "\u{f169}"
        case .announcementFilled: return "\u{f16a}"
        case .announcementLight: return "\u{f16b}"
        case .announcementMutedBold: return "\u{f16c}"
        case .announcementMutedFilled: return "\u{f16d}"
        case .announcementMutedLight: return "\u{f16e}"
        case .announcementMutedRegular: return "\u{f16f}"
        case .announcementRegular: return "\u{f170}"
        case .appearanceBold: return "\u{f171}"
        case .appearanceLight: return "\u{f172}"
        case .appearanceRegular: return "\u{f173}"
        case .applauseBold: return "\u{f174}"
        case .applauseLight: return "\u{f175}"
        case .applauseRegular: return "\u{f176}"
        case .applicationBold: return "\u{f177}"
        case .applicationLight: return "\u{f178}"
        case .applicationPanelBold: return "\u{f179}"
        case .applicationPanelLight: return "\u{f17a}"
        case .applicationPanelRegular: return "\u{f17b}"
        case .applicationRegular: return "\u{f17c}"
        case .applicationsBold: return "\u{f17d}"
        case .applicationsLight: return "\u{f17e}"
        case .applicationsRegular: return "\u{f17f}"
        case .approvalPendingBold: return "\u{f180}"
        case .approvalPendingLight: return "\u{f181}"
        case .approvalPendingRegular: return "\u{f182}"
        case .approvalsBold: return "\u{f183}"
        case .approvalsLight: return "\u{f184}"
        case .approvalsRegular: return "\u{f185}"
        case .appsBold: return "\u{f186}"
        case .appsFilled: return "\u{f187}"
        case .appsLight: return "\u{f188}"
        case .appsRegular: return "\u{f189}"
        case .archiveBold: return "\u{f18a}"
        case .archiveLight: return "\u{f18b}"
        case .archiveRegular: return "\u{f18c}"
        case .areaChartBold: return "\u{f18d}"
        case .areaChartFilled: return "\u{f18e}"
        case .areaChartLight: return "\u{f18f}"
        case .areaChartRegular: return "\u{f190}"
        case .areaSelectorBold: return "\u{f191}"
        case .areaSelectorLight: return "\u{f192}"
        case .areaSelectorRegular: return "\u{f193}"
        case .arrowCircleDownBold: return "\u{f194}"
        case .arrowCircleDownFilled: return "\u{f195}"
        case .arrowCircleDownLight: return "\u{f196}"
        case .arrowCircleDownRegular: return "\u{f197}"
        case .arrowCircleLeftBold: return "\u{f198}"
        case .arrowCircleLeftFilled: return "\u{f199}"
        case .arrowCircleLeftLight: return "\u{f19a}"
        case .arrowCircleLeftRegular: return "\u{f19b}"
        case .arrowCircleRightBold: return "\u{f19c}"
        case .arrowCircleRightFilled: return "\u{f19d}"
        case .arrowCircleRightLight: return "\u{f19e}"
        case .arrowCircleRightRegular: return "\u{f19f}"
        case .arrowCircleUpBold: return "\u{f1a0}"
        case .arrowCircleUpFilled: return "\u{f1a1}"
        case .arrowCircleUpLight: return "\u{f1a2}"
        case .arrowCircleUpRegular: return "\u{f1a3}"
        case .arrowDownBold: return "\u{f1a4}"
        case .arrowDownFilled: return "\u{f1a5}"
        case .arrowDownLight: return "\u{f1a6}"
        case .arrowDownOpticalRegular: return "\u{f1a7}"
        case .arrowLeftBold: return "\u{f1a8}"
        case .arrowLeftFilled: return "\u{f1a9}"
        case .arrowLeftLight: return "\u{f1aa}"
        case .arrowLeftRegular: return "\u{f1ab}"
        case .arrowRightBold: return "\u{f1ac}"
        case .arrowRightFilled: return "\u{f1ad}"
        case .arrowRightLight: return "\u{f1ae}"
        case .arrowRightRegular: return "\u{f1af}"
        case .arrowTailDownBold: return "\u{f1b0}"
        case .arrowTailDownLight: return "\u{f1b1}"
        case .arrowTailDownRegular: return "\u{f1b2}"
        case .arrowTailUpBold: return "\u{f1b3}"
        case .arrowTailUpLight: return "\u{f1b4}"
        case .arrowTailUpRegular: return "\u{f1b5}"
        case .arrowUpBold: return "\u{f1b6}"
        case .arrowUpFilled: return "\u{f1b7}"
        case .arrowUpLight: return "\u{f1b8}"
        case .arrowUpRegular: return "\u{f1b9}"
        case .askForHelpBold: return "\u{f1ba}"
        case .askForHelpFilled: return "\u{f1bb}"
        case .askForHelpLight: return "\u{f1bc}"
        case .askForHelpRegular: return "\u{f1bd}"
        case .assetsBold: return "\u{f1be}"
        case .assetsLight: return "\u{f1bf}"
        case .assetsRegular: return "\u{f1c0}"
        case .assignHostBold: return "\u{f1c1}"
        case .assignHostLight: return "\u{f1c2}"
        case .assignHostRegular: return "\u{f1c3}"
        case .assignPrivilegeBold: return "\u{f1c4}"
        case .assignPrivilegeLight: return "\u{f1c5}"
        case .assignPrivilegeRegular: return "\u{f1c6}"
        case .attachmentBold: return "\u{f1c7}"
        case .attachmentLight: return "\u{f1c8}"
        case .attachmentRegular: return "\u{f1c9}"
        case .audioBroadcastBold: return "\u{f1ca}"
        case .audioBroadcastLight: return "\u{f1cb}"
        case .audioBroadcastRegular: return "\u{f1cc}"
        case .audioCallBold: return "\u{f1cd}"
        case .audioCallFilled: return "\u{f1ce}"
        case .audioCallLight: return "\u{f1cf}"
        case .audioCallRegular: return "\u{f1d0}"
        case .audioMicrophoneOnBold: return "\u{f1d1}"
        case .audioMicrophoneOnColoredBold: return "\u{f1d2}"
        case .audioMicrophoneOnColoredLight: return "\u{f1d3}"
        case .audioMicrophoneOnColoredRegular: return "\u{f1d4}"
        case .audioMicrophoneOnGreenBold: return "\u{f1d5}"
        case .audioMicrophoneOnGreenColoredBold: return "\u{f1d6}"
        case .audioMicrophoneOnGreenColoredLight: return "\u{f1d7}"
        case .audioMicrophoneOnGreenColoredRegular: return "\u{f1d8}"
        case .audioMicrophoneOnGreenLight: return "\u{f1d9}"
        case .audioMicrophoneOnGreenRegular: return "\u{f1da}"
        case .audioMicrophoneOnLight: return "\u{f1db}"
        case .audioMicrophoneOnRegular: return "\u{f1dc}"
        case .audioOnlyBold: return "\u{f1dd}"
        case .audioOnlyLight: return "\u{f1de}"
        case .audioOnlyRegular: return "\u{f1df}"
        case .audioOptionsBold: return "\u{f1e0}"
        case .audioOptionsFilled: return "\u{f1e1}"
        case .audioOptionsLight: return "\u{f1e2}"
        case .audioOptionsRegular: return "\u{f1e3}"
        case .automationFilled: return "\u{f1e4}"
        case .automationLight: return "\u{f1e5}"
        case .automationRegular: return "\u{f1e6}"
        case .backBold: return "\u{f1e7}"
        case .backLight: return "\u{f1e8}"
        case .backRegular: return "\u{f1e9}"
        case .backToFullScreenBold: return "\u{f1ea}"
        case .backToFullScreenLight: return "\u{f1eb}"
        case .backToFullScreenRegular: return "\u{f1ec}"
        case .backlightBold: return "\u{f1ed}"
        case .backlightLight: return "\u{f1ee}"
        case .backlightRegular: return "\u{f1ef}"
        case .backspaceBold: return "\u{f1f0}"
        case .backspaceLight: return "\u{f1f1}"
        case .backspaceRegular: return "\u{f1f2}"
        case .backupDataBold: return "\u{f1f3}"
        case .backupDataLight: return "\u{f1f4}"
        case .backupDataRegular: return "\u{f1f5}"
        case .barcodeBold: return "\u{f1f6}"
        case .barcodeLight: return "\u{f1f7}"
        case .barcodeRegular: return "\u{f1f8}"
        case .bargeCallBold: return "\u{f1f9}"
        case .bargeCallLight: return "\u{f1fa}"
        case .bargeCallRegular: return "\u{f1fb}"
        case .bargeCallSilentBold: return "\u{f1fc}"
        case .bargeCallSilentLight: return "\u{f1fd}"
        case .bargeCallSilentRegular: return "\u{f1fe}"
        case .batteryChargingBold: return "\u{f1ff}"
        case .batteryChargingLight: return "\u{f200}"
        case .batteryChargingRegular: return "\u{f201}"
        case .batteryEmptyBold: return "\u{f202}"
        case .batteryEmptyLight: return "\u{f203}"
        case .batteryEmptyRegular: return "\u{f204}"
        case .batteryHighBold: return "\u{f205}"
        case .batteryHighLight: return "\u{f206}"
        case .batteryHighRegular: return "\u{f207}"
        case .batteryLowBold: return "\u{f208}"
        case .batteryLowLight: return "\u{f209}"
        case .batteryLowRegular: return "\u{f20a}"
        case .batteryMediumBold: return "\u{f20b}"
        case .batteryMediumLight: return "\u{f20c}"
        case .batteryMediumRegular: return "\u{f20d}"
        case .bitmojiConnectBold: return "\u{f20e}"
        case .bitmojiConnectLight: return "\u{f20f}"
        case .bitmojiConnectRegular: return "\u{f210}"
        case .bitmojiConnectedBold: return "\u{f211}"
        case .bitmojiConnectedFilled: return "\u{f212}"
        case .bitmojiConnectedLight: return "\u{f213}"
        case .bitmojiConnectedRegular: return "\u{f214}"
        case .blockQuoteBold: return "\u{f215}"
        case .blockQuoteLight: return "\u{f216}"
        case .blockQuoteRegular: return "\u{f217}"
        case .blockedBold: return "\u{f218}"
        case .blockedLight: return "\u{f219}"
        case .blockedRegular: return "\u{f21a}"
        case .bluetoothBold: return "\u{f21b}"
        case .bluetoothContainerMutedBold: return "\u{f21c}"
        case .bluetoothContainerMutedLight: return "\u{f21d}"
        case .bluetoothContainerMutedRegular: return "\u{f21e}"
        case .bluetoothLight: return "\u{f21f}"
        case .bluetoothRegular: return "\u{f220}"
        case .boldBold: return "\u{f221}"
        case .boldLight: return "\u{f222}"
        case .boldRegular: return "\u{f223}"
        case .bookmarkBold: return "\u{f224}"
        case .bookmarkLight: return "\u{f225}"
        case .bookmarkRegular: return "\u{f226}"
        case .botActiveBold: return "\u{f227}"
        case .botActiveLight: return "\u{f228}"
        case .botActiveRegular: return "\u{f229}"
        case .botCustomerAssistantBold: return "\u{f22a}"
        case .botCustomerAssistantLight: return "\u{f22b}"
        case .botCustomerAssistantRegular: return "\u{f22c}"
        case .botExpertAssistantBold: return "\u{f22d}"
        case .botExpertAssistantLight: return "\u{f22e}"
        case .botExpertAssistantRegular: return "\u{f22f}"
        case .botInactiveBold: return "\u{f230}"
        case .botInactiveLight: return "\u{f231}"
        case .botInactiveRegular: return "\u{f232}"
        case .boxBold: return "\u{f233}"
        case .boxLight: return "\u{f234}"
        case .boxRegular: return "\u{f235}"
        case .breakoutSessionBold: return "\u{f236}"
        case .breakoutSessionFilled: return "\u{f237}"
        case .breakoutSessionLight: return "\u{f238}"
        case .breakoutSessionRegular: return "\u{f239}"
        case .brightnessBold: return "\u{f23a}"
        case .brightnessHighBold: return "\u{f23b}"
        case .brightnessHighLight: return "\u{f23c}"
        case .brightnessHighRegular: return "\u{f23d}"
        case .brightnessLight: return "\u{f23e}"
        case .brightnessRegular: return "\u{f23f}"
        case .brokenFileBold: return "\u{f240}"
        case .brokenFileFilled: return "\u{f241}"
        case .brokenFileLight: return "\u{f242}"
        case .brokenFileRegular: return "\u{f243}"
        case .browserBold: return "\u{f244}"
        case .browserLight: return "\u{f245}"
        case .browserRegular: return "\u{f246}"
        case .busyPresenceBold: return "\u{f247}"
        case .busyPresenceLight: return "\u{f248}"
        case .busyPresenceRegular: return "\u{f249}"
        case .button100Bold: return "\u{f24a}"
        case .button100Light: return "\u{f24b}"
        case .button100Regular: return "\u{f24c}"
        case .calendarAddBold: return "\u{f24d}"
        case .calendarAddFilled: return "\u{f24e}"
        case .calendarAddLight: return "\u{f24f}"
        case .calendarAddRegular: return "\u{f250}"
        case .calendarDayBold: return "\u{f251}"
        case .calendarDayFilled: return "\u{f252}"
        case .calendarDayLight: return "\u{f253}"
        case .calendarDayRegular: return "\u{f254}"
        case .calendarEmptyBold: return "\u{f255}"
        case .calendarEmptyFilled: return "\u{f256}"
        case .calendarEmptyLight: return "\u{f257}"
        case .calendarEmptyRegular: return "\u{f258}"
        case .calendarExternalBold: return "\u{f259}"
        case .calendarExternalLight: return "\u{f25a}"
        case .calendarExternalRegular: return "\u{f25b}"
        case .calendarMonthBold: return "\u{f25c}"
        case .calendarMonthFilled: return "\u{f25d}"
        case .calendarMonthLight: return "\u{f25e}"
        case .calendarMonthRegular: return "\u{f25f}"
        case .calendarWeekBold: return "\u{f260}"
        case .calendarWeekFilled: return "\u{f261}"
        case .calendarWeekLight: return "\u{f262}"
        case .calendarWeekRegular: return "\u{f263}"
        case .calendarWeekViewBold: return "\u{f264}"
        case .calendarWeekViewFilled: return "\u{f265}"
        case .calendarWeekViewLight: return "\u{f266}"
        case .calendarWeekViewRegular: return "\u{f267}"
        case .calendarWorkWeekBold: return "\u{f268}"
        case .calendarWorkWeekFilled: return "\u{f269}"
        case .calendarWorkWeekLight: return "\u{f26a}"
        case .calendarWorkWeekRegular: return "\u{f26b}"
        case .callBlindTransferBold: return "\u{f26c}"
        case .callBlindTransferLight: return "\u{f26d}"
        case .callBlindTransferRegular: return "\u{f26e}"
        case .callForwardSettingsBold: return "\u{f26f}"
        case .callForwardSettingsFilled: return "\u{f270}"
        case .callForwardSettingsLight: return "\u{f271}"
        case .callForwardSettingsRegular: return "\u{f272}"
        case .callHandlingBold: return "\u{f273}"
        case .callHandlingLight: return "\u{f274}"
        case .callHandlingRegular: return "\u{f275}"
        case .callHoldBold: return "\u{f276}"
        case .callHoldFilled: return "\u{f277}"
        case .callHoldLight: return "\u{f278}"
        case .callHoldRegular: return "\u{f279}"
        case .callIncomingBold: return "\u{f27a}"
        case .callIncomingLight: return "\u{f27b}"
        case .callIncomingRegular: return "\u{f27c}"
        case .callListBold: return "\u{f27d}"
        case .callListLight: return "\u{f27e}"
        case .callListRegular: return "\u{f27f}"
        case .callMergeBold: return "\u{f280}"
        case .callMergeLight: return "\u{f281}"
        case .callMergeRegular: return "\u{f282}"
        case .callOutgoingBold: return "\u{f283}"
        case .callOutgoingLight: return "\u{f284}"
        case .callOutgoingRegular: return "\u{f285}"
        case .callPickupBold: return "\u{f286}"
        case .callPickupFilled: return "\u{f287}"
        case .callPickupLight: return "\u{f288}"
        case .callPickupRegular: return "\u{f289}"
        case .callPrivateBold: return "\u{f28a}"
        case .callPrivateLight: return "\u{f28b}"
        case .callPrivateRegular: return "\u{f28c}"
        case .callRequestBold: return "\u{f28d}"
        case .callRequestFilled: return "\u{f28e}"
        case .callRequestLight: return "\u{f28f}"
        case .callRequestRegular: return "\u{f290}"
        case .callReturnBold: return "\u{f291}"
        case .callReturnFilled: return "\u{f292}"
        case .callReturnLight: return "\u{f293}"
        case .callReturnRegular: return "\u{f294}"
        case .callRoomBold: return "\u{f295}"
        case .callRoomLight: return "\u{f296}"
        case .callRoomRegular: return "\u{f297}"
        case .callSettingsBold: return "\u{f298}"
        case .callSettingsLight: return "\u{f299}"
        case .callSettingsRegular: return "\u{f29a}"
        case .callSplitBold: return "\u{f29b}"
        case .callSplitLight: return "\u{f29c}"
        case .callSplitRegular: return "\u{f29d}"
        case .callSwapBold: return "\u{f29e}"
        case .callSwapLight: return "\u{f29f}"
        case .callSwapRegular: return "\u{f2a0}"
        case .callVoicemailBold: return "\u{f2a1}"
        case .callVoicemailLight: return "\u{f2a2}"
        case .callVoicemailRegular: return "\u{f2a3}"
        case .callrateBold: return "\u{f2a4}"
        case .callrateLight: return "\u{f2a5}"
        case .callrateRegular: return "\u{f2a6}"
        case .cameraAuxBold: return "\u{f2a7}"
        case .cameraAuxFilled: return "\u{f2a8}"
        case .cameraAuxLight: return "\u{f2a9}"
        case .cameraAuxRegular: return "\u{f2aa}"
        case .cameraBold: return "\u{f2ab}"
        case .cameraFilled: return "\u{f2ac}"
        case .cameraLight: return "\u{f2ad}"
        case .cameraMutedBold: return "\u{f2ae}"
        case .cameraMutedFilled: return "\u{f2af}"
        case .cameraMutedLight: return "\u{f2b0}"
        case .cameraMutedRegular: return "\u{f2b1}"
        case .cameraOnBold: return "\u{f2b2}"
        case .cameraOnColoredBold: return "\u{f2b3}"
        case .cameraOnColoredFilled: return "\u{f2b4}"
        case .cameraOnColoredLight: return "\u{f2b5}"
        case .cameraOnColoredRegular: return "\u{f2b6}"
        case .cameraOnFilled: return "\u{f2b7}"
        case .cameraOnLight: return "\u{f2b8}"
        case .cameraOnRegular: return "\u{f2b9}"
        case .cameraPhotoBold: return "\u{f2ba}"
        case .cameraPhotoFilled: return "\u{f2bb}"
        case .cameraPhotoLight: return "\u{f2bc}"
        case .cameraPhotoRegular: return "\u{f2bd}"
        case .cameraPresenceBold: return "\u{f2be}"
        case .cameraPresenceFilled: return "\u{f2bf}"
        case .cameraPresenceLight: return "\u{f2c0}"
        case .cameraPresenceRegular: return "\u{f2c1}"
        case .cameraRegular: return "\u{f2c2}"
        case .cameraSwapBold: return "\u{f2c3}"
        case .cameraSwapLight: return "\u{f2c4}"
        case .cameraSwapRegular: return "\u{f2c5}"
        case .cancelBold: return "\u{f2c6}"
        case .cancelLight: return "\u{f2c7}"
        case .cancelRegular: return "\u{f2c8}"
        case .capsLockBold: return "\u{f2c9}"
        case .capsLockLight: return "\u{f2ca}"
        case .capsLockRegular: return "\u{f2cb}"
        case .captureRewindBold: return "\u{f2cc}"
        case .captureRewindLight: return "\u{f2cd}"
        case .captureRewindRegular: return "\u{f2ce}"
        case .carouselBold: return "\u{f2cf}"
        case .carouselLight: return "\u{f2d0}"
        case .carouselRegular: return "\u{f2d1}"
        case .carouselTextBold: return "\u{f2d2}"
        case .carouselTextLight: return "\u{f2d3}"
        case .carouselTextRegular: return "\u{f2d4}"
        case .cellularBold: return "\u{f2d5}"
        case .cellularLight: return "\u{f2d6}"
        case .cellularRegular: return "\u{f2d7}"
        case .centerAlignedBold: return "\u{f2d8}"
        case .centerAlignedLight: return "\u{f2d9}"
        case .centerAlignedRegular: return "\u{f2da}"
        case .centerBold: return "\u{f2db}"
        case .centerLight: return "\u{f2dc}"
        case .centerRegular: return "\u{f2dd}"
        case .certifiedBold: return "\u{f2de}"
        case .certifiedLight: return "\u{f2df}"
        case .certifiedRegular: return "\u{f2e0}"
        case .chPSearchBold: return "\u{f2e1}"
        case .chPSearchLight: return "\u{f2e2}"
        case .chPSearchRegular: return "\u{f2e3}"
        case .channelUssdBold: return "\u{f2e4}"
        case .channelUssdLight: return "\u{f2e5}"
        case .channelUssdRegular: return "\u{f2e6}"
        case .chatBold: return "\u{f2e7}"
        case .chatFilled: return "\u{f2e8}"
        case .chatGroupBold: return "\u{f2e9}"
        case .chatGroupFilled: return "\u{f2ea}"
        case .chatGroupLight: return "\u{f2eb}"
        case .chatGroupRegular: return "\u{f2ec}"
        case .chatLight: return "\u{f2ed}"
        case .chatMuteBold: return "\u{f2ee}"
        case .chatMuteLight: return "\u{f2ef}"
        case .chatMuteRegular: return "\u{f2f0}"
        case .chatOnColoredBold: return "\u{f2f1}"
        case .chatOnColoredFilled: return "\u{f2f2}"
        case .chatOnColoredLight: return "\u{f2f3}"
        case .chatOnColoredRegular: return "\u{f2f4}"
        case .chatRegular: return "\u{f2f5}"
        case .checkBold: return "\u{f2f6}"
        case .checkCircleBadgeFilled: return "\u{f2f7}"
        case .checkCircleBold: return "\u{f2f8}"
        case .checkCircleFilled: return "\u{f2f9}"
        case .checkCircleLight: return "\u{f2fa}"
        case .checkCircleRegular: return "\u{f2fb}"
        case .checkLight: return "\u{f2fc}"
        case .checkRegular: return "\u{f2fd}"
        case .checkboxGroupBold: return "\u{f2fe}"
        case .checkboxGroupLight: return "\u{f2ff}"
        case .checkboxGroupRegular: return "\u{f300}"
        case .clearBold: return "\u{f301}"
        case .clearFilled: return "\u{f302}"
        case .clearLight: return "\u{f303}"
        case .clearRegular: return "\u{f304}"
        case .closeSpaceBold: return "\u{f305}"
        case .closeSpaceLight: return "\u{f306}"
        case .closeSpaceRegular: return "\u{f307}"
        case .closedCaptionBadgeBold: return "\u{f308}"
        case .closedCaptionBadgeLight: return "\u{f309}"
        case .closedCaptionBadgeRegular: return "\u{f30a}"
        case .closedCaptionsBold: return "\u{f30b}"
        case .closedCaptionsFilled: return "\u{f30c}"
        case .closedCaptionsLight: return "\u{f30d}"
        case .closedCaptionsRegular: return "\u{f30e}"
        case .cloudBold: return "\u{f30f}"
        case .cloudFilled: return "\u{f310}"
        case .cloudFrameBold: return "\u{f311}"
        case .cloudFrameFilled: return "\u{f312}"
        case .cloudFrameRegular: return "\u{f313}"
        case .cloudFramedFilled: return "\u{f314}"
        case .cloudFramedLight: return "\u{f315}"
        case .cloudLight: return "\u{f316}"
        case .cloudMutedBold: return "\u{f317}"
        case .cloudMutedFilled: return "\u{f318}"
        case .cloudMutedLight: return "\u{f319}"
        case .cloudMutedRegular: return "\u{f31a}"
        case .cloudRegular: return "\u{f31b}"
        case .cloudUploadBold: return "\u{f31c}"
        case .cloudUploadLight: return "\u{f31d}"
        case .cloudUploadRegular: return "\u{f31e}"
        case .codeBlockBold: return "\u{f31f}"
        case .codeBlockLight: return "\u{f320}"
        case .codeBlockRegular: return "\u{f321}"
        case .colorBold: return "\u{f322}"
        case .colorLight: return "\u{f323}"
        case .colorRegular: return "\u{f324}"
        case .colourPaletteBold: return "\u{f325}"
        case .colourPaletteFilled: return "\u{f326}"
        case .colourPaletteLight: return "\u{f327}"
        case .colourPaletteRegular: return "\u{f328}"
        case .commentingBold: return "\u{f329}"
        case .commentingFilled: return "\u{f32a}"
        case .commentingLight: return "\u{f32b}"
        case .commentingRegular: return "\u{f32c}"
        case .companyBold: return "\u{f32d}"
        case .companyLight: return "\u{f32e}"
        case .companyRegular: return "\u{f32f}"
        case .completedByTimeBold: return "\u{f330}"
        case .completedByTimeLight: return "\u{f331}"
        case .completedByTimeRegular: return "\u{f332}"
        case .computerBold: return "\u{f333}"
        case .computerLight: return "\u{f334}"
        case .computerRegular: return "\u{f335}"
        case .conciergeBold: return "\u{f336}"
        case .conciergeLight: return "\u{f337}"
        case .conciergeRegular: return "\u{f338}"
        case .conditionalBlockBold: return "\u{f339}"
        case .conditionalBlockLight: return "\u{f33a}"
        case .conditionalBlockRegular: return "\u{f33b}"
        case .contactCardBold: return "\u{f33c}"
        case .contactCardFilled: return "\u{f33d}"
        case .contactCardLight: return "\u{f33e}"
        case .contactCardRegular: return "\u{f33f}"
        case .contactGroupBold: return "\u{f340}"
        case .contactGroupFilled: return "\u{f341}"
        case .contactGroupLight: return "\u{f342}"
        case .contactGroupRegular: return "\u{f343}"
        case .contactsBold: return "\u{f344}"
        case .contactsFilled: return "\u{f345}"
        case .contactsLight: return "\u{f346}"
        case .contactsRegular: return "\u{f347}"
        case .contentDownloadBold: return "\u{f348}"
        case .contentDownloadFilled: return "\u{f349}"
        case .contentDownloadLight: return "\u{f34a}"
        case .contentDownloadRegular: return "\u{f34b}"
        case .contentShareBold: return "\u{f34c}"
        case .contentShareLight: return "\u{f34d}"
        case .contentShareRegular: return "\u{f34e}"
        case .contrastBold: return "\u{f34f}"
        case .contrastLight: return "\u{f350}"
        case .contrastRegular: return "\u{f351}"
        case .copyBold: return "\u{f352}"
        case .copyLight: return "\u{f353}"
        case .copyRegular: return "\u{f354}"
        case .cpuBold: return "\u{f355}"
        case .cpuLight: return "\u{f356}"
        case .cpuRegular: return "\u{f357}"
        case .createAGroupBold: return "\u{f358}"
        case .createAGroupFilled: return "\u{f359}"
        case .createAGroupLight: return "\u{f35a}"
        case .createAGroupRegular: return "\u{f35b}"
        case .cropBold: return "\u{f35c}"
        case .cropLight: return "\u{f35d}"
        case .cropRegular: return "\u{f35e}"
        case .cucmConnectionBold: return "\u{f35f}"
        case .cucmConnectionLight: return "\u{f360}"
        case .cucmConnectionRegular: return "\u{f361}"
        case .dailyRecurringScheduleNodeBold: return "\u{f362}"
        case .dailyRecurringScheduleNodeLight: return "\u{f363}"
        case .dailyRecurringScheduleNodeRegular: return "\u{f364}"
        case .dashboardBold: return "\u{f365}"
        case .dashboardFilled: return "\u{f366}"
        case .dashboardLight: return "\u{f367}"
        case .dashboardRegular: return "\u{f368}"
        case .dataManagement1: return "\u{f369}"
        case .dataManagement2: return "\u{f36a}"
        case .dataManagement: return "\u{f36b}"
        case .deleteBold: return "\u{f36c}"
        case .deleteFilled: return "\u{f36d}"
        case .deleteLight: return "\u{f36e}"
        case .deleteRegular: return "\u{f36f}"
        case .deskPhoneBold: return "\u{f370}"
        case .deskPhoneFilled: return "\u{f371}"
        case .deskPhoneLight: return "\u{f372}"
        case .deskPhoneRegular: return "\u{f373}"
        case .deskPhoneWarningBold: return "\u{f374}"
        case .deskPhoneWarningLight: return "\u{f375}"
        case .deskPhoneWarningRegular: return "\u{f376}"
        case .deviceConnectionBold: return "\u{f377}"
        case .deviceConnectionFilled: return "\u{f378}"
        case .deviceConnectionLight: return "\u{f379}"
        case .deviceConnectionRegular: return "\u{f37a}"
        case .devicePolicyControllerBold: return "\u{f37b}"
        case .devicePolicyControllerLight: return "\u{f37c}"
        case .devicePolicyControllerRegular: return "\u{f37d}"
        case .diagnosticsBold: return "\u{f37e}"
        case .diagnosticsLight: return "\u{f37f}"
        case .diagnosticsRegular: return "\u{f380}"
        case .dialpadBold: return "\u{f381}"
        case .dialpadLight: return "\u{f382}"
        case .dialpadRegular: return "\u{f383}"
        case .directionalPadBold: return "\u{f384}"
        case .directionalPadFilled: return "\u{f385}"
        case .directionalPadLight: return "\u{f386}"
        case .directionalPadRegular: return "\u{f387}"
        case .directoryBold: return "\u{f388}"
        case .directoryLight: return "\u{f389}"
        case .directoryRegular: return "\u{f38a}"
        case .discBold: return "\u{f38b}"
        case .discDisconnectedBold: return "\u{f38c}"
        case .discDisconnectedLight: return "\u{f38d}"
        case .discDisconnectedRegular: return "\u{f38e}"
        case .discLight: return "\u{f38f}"
        case .discRegular: return "\u{f390}"
        case .disconnectBold: return "\u{f391}"
        case .disconnectLight: return "\u{f392}"
        case .disconnectRegular: return "\u{f393}"
        case .dislikeBold: return "\u{f394}"
        case .dislikeFilled: return "\u{f395}"
        case .dislikeLight: return "\u{f396}"
        case .dislikeRegular: return "\u{f397}"
        case .displayBold: return "\u{f398}"
        case .displayInputBold: return "\u{f399}"
        case .displayInputLight: return "\u{f39a}"
        case .displayInputRegular: return "\u{f39b}"
        case .displayLight: return "\u{f39c}"
        case .displayRegular: return "\u{f39d}"
        case .displayWarningBold: return "\u{f39e}"
        case .displayWarningLight: return "\u{f39f}"
        case .displayWarningRegular: return "\u{f3a0}"
        case .distributeHorizontalBold: return "\u{f3a1}"
        case .distributeHorizontalFilled: return "\u{f3a2}"
        case .distributeHorizontalLight: return "\u{f3a3}"
        case .distributeHorizontalRegular: return "\u{f3a4}"
        case .distributeVerticallyBold: return "\u{f3a5}"
        case .distributeVerticallyFilled: return "\u{f3a6}"
        case .distributeVerticallyLight: return "\u{f3a7}"
        case .distributeVerticallyRegular: return "\u{f3a8}"
        case .dndPresenceBold: return "\u{f3a9}"
        case .dndPresenceFilled: return "\u{f3aa}"
        case .dndPresenceLight: return "\u{f3ab}"
        case .dndPresenceRegular: return "\u{f3ac}"
        case .dndPresenceSmallFilled: return "\u{f3ad}"
        case .documentBold: return "\u{f3ae}"
        case .documentCameraBold: return "\u{f3af}"
        case .documentCameraDisconnectedBold: return "\u{f3b0}"
        case .documentCameraDisconnectedLight: return "\u{f3b1}"
        case .documentCameraDisconnectedRegular: return "\u{f3b2}"
        case .documentCameraLight: return "\u{f3b3}"
        case .documentCameraRegular: return "\u{f3b4}"
        case .documentCreateBold: return "\u{f3b5}"
        case .documentCreateFilled: return "\u{f3b6}"
        case .documentCreateLight: return "\u{f3b7}"
        case .documentCreateRegular: return "\u{f3b8}"
        case .documentFilled: return "\u{f3b9}"
        case .documentLight: return "\u{f3ba}"
        case .documentMoveBold: return "\u{f3bb}"
        case .documentMoveFilled: return "\u{f3bc}"
        case .documentMoveLight: return "\u{f3bd}"
        case .documentMoveRegular: return "\u{f3be}"
        case .documentRegular: return "\u{f3bf}"
        case .documentShareBold: return "\u{f3c0}"
        case .documentShareFilled: return "\u{f3c1}"
        case .documentShareLight: return "\u{f3c2}"
        case .documentShareRegular: return "\u{f3c3}"
        case .doneAllBold: return "\u{f3c4}"
        case .doneAllLight: return "\u{f3c5}"
        case .doneAllRegular: return "\u{f3c6}"
        case .donutChartBold: return "\u{f3c7}"
        case .donutChartFilled: return "\u{f3c8}"
        case .donutChartLight: return "\u{f3c9}"
        case .donutChartRegular: return "\u{f3ca}"
        case .downloadBold: return "\u{f3cb}"
        case .downloadFilled: return "\u{f3cc}"
        case .downloadLight: return "\u{f3cd}"
        case .downloadRegular: return "\u{f3ce}"
        case .draftBold: return "\u{f3cf}"
        case .draftFilled: return "\u{f3d0}"
        case .draftIndicatorBold: return "\u{f3d1}"
        case .draftIndicatorSmallFilled: return "\u{f3d2}"
        case .draftLight: return "\u{f3d3}"
        case .draftRegular: return "\u{f3d4}"
        case .dragBold: return "\u{f3d5}"
        case .dragLight: return "\u{f3d6}"
        case .dragRegular: return "\u{f3d7}"
        case .dropdownBold: return "\u{f3d8}"
        case .dropdownLight: return "\u{f3d9}"
        case .dropdownRegular: return "\u{f3da}"
        case .dx70Bold: return "\u{f3db}"
        case .dx70Light: return "\u{f3dc}"
        case .dx70Regular: return "\u{f3dd}"
        case .dx80Bold: return "\u{f3de}"
        case .dx80Filled: return "\u{f3df}"
        case .dx80Light: return "\u{f3e0}"
        case .dx80Regular: return "\u{f3e1}"
        case .editBold: return "\u{f3e2}"
        case .editLight: return "\u{f3e3}"
        case .editRegular: return "\u{f3e4}"
        case .editablePartialBold: return "\u{f3e5}"
        case .editablePartialLight: return "\u{f3e6}"
        case .editablePartialRegular: return "\u{f3e7}"
        case .educationBold: return "\u{f3e8}"
        case .educationFilled: return "\u{f3e9}"
        case .educationLight: return "\u{f3ea}"
        case .educationRegular: return "\u{f3eb}"
        case .emailBold: return "\u{f3ec}"
        case .emailDeliveredBold: return "\u{f3ed}"
        case .emailDeliveredLight: return "\u{f3ee}"
        case .emailDeliveredRegular: return "\u{f3ef}"
        case .emailFailureBold: return "\u{f3f0}"
        case .emailFailureLight: return "\u{f3f1}"
        case .emailFailureRegular: return "\u{f3f2}"
        case .emailFilled: return "\u{f3f3}"
        case .emailInviteBold: return "\u{f3f4}"
        case .emailInviteLight: return "\u{f3f5}"
        case .emailInviteRegular: return "\u{f3f6}"
        case .emailLight: return "\u{f3f7}"
        case .emailReadBold: return "\u{f3f8}"
        case .emailReadFilled: return "\u{f3f9}"
        case .emailReadLight: return "\u{f3fa}"
        case .emailReadRegular: return "\u{f3fb}"
        case .emailRegular: return "\u{f3fc}"
        case .emojiExcitedBold: return "\u{f3fd}"
        case .emojiExcitedFilled: return "\u{f3fe}"
        case .emojiHappyBold: return "\u{f3ff}"
        case .emojiHappyFilled: return "\u{f400}"
        case .emojiHappyLight: return "\u{f401}"
        case .emojiHappyRegular: return "\u{f402}"
        case .emojiPassiveBold: return "\u{f403}"
        case .emojiPassiveFilled: return "\u{f404}"
        case .emojiPassiveLight: return "\u{f405}"
        case .emojiPassiveRegular: return "\u{f406}"
        case .emojiSadBold: return "\u{f407}"
        case .emojiSadFilled: return "\u{f408}"
        case .emojiSadLight: return "\u{f409}"
        case .emojiSadRegular: return "\u{f40a}"
        case .emojiUnhappyBold: return "\u{f40b}"
        case .emojiUnhappyFilled: return "\u{f40c}"
        case .encryptionCircleFilled: return "\u{f40d}"
        case .encryptionFilled: return "\u{f40e}"
        case .endRemoteDesktopControlBold: return "\u{f40f}"
        case .endRemoteDesktopControlLight: return "\u{f410}"
        case .endRemoteDesktopControlRegular: return "\u{f411}"
        case .endToEndEncryptionCircleFilled: return "\u{f412}"
        case .endToEndEncryptionFilled: return "\u{f413}"
        case .endpointBlockedBold: return "\u{f414}"
        case .endpointBlockedLight: return "\u{f415}"
        case .endpointBlockedRegular: return "\u{f416}"
        case .endpointBold: return "\u{f417}"
        case .endpointG270Bold: return "\u{f418}"
        case .endpointG270DualBold: return "\u{f419}"
        case .endpointG270DualLight: return "\u{f41a}"
        case .endpointG270DualRegular: return "\u{f41b}"
        case .endpointG270Light: return "\u{f41c}"
        case .endpointG270Regular: return "\u{f41d}"
        case .endpointG2Bold: return "\u{f41e}"
        case .endpointG2Light: return "\u{f41f}"
        case .endpointG2Regular: return "\u{f420}"
        case .endpointG2StandBold: return "\u{f421}"
        case .endpointG2StandLight: return "\u{f422}"
        case .endpointG2StandRegular: return "\u{f423}"
        case .endpointLight: return "\u{f424}"
        case .endpointMx800Bold: return "\u{f425}"
        case .endpointMx800DualBold: return "\u{f426}"
        case .endpointMx800DualLight: return "\u{f427}"
        case .endpointMx800DualRegular: return "\u{f428}"
        case .endpointMx800Light: return "\u{f429}"
        case .endpointMx800Regular: return "\u{f42a}"
        case .endpointRegular: return "\u{f42b}"
        case .endpointStandBold: return "\u{f42c}"
        case .endpointStandFilled: return "\u{f42d}"
        case .endpointStandLight: return "\u{f42e}"
        case .endpointStandRegular: return "\u{f42f}"
        case .endpointWarningBold: return "\u{f430}"
        case .endpointWarningLight: return "\u{f431}"
        case .endpointWarningRegular: return "\u{f432}"
        case .enterBold: return "\u{f433}"
        case .enterLight: return "\u{f434}"
        case .enterRegular: return "\u{f435}"
        case .enterRoomBold: return "\u{f436}"
        case .enterRoomFilled: return "\u{f437}"
        case .enterRoomLight: return "\u{f438}"
        case .enterRoomRegular: return "\u{f439}"
        case .eraserBold: return "\u{f43a}"
        case .eraserFilled: return "\u{f43b}"
        case .eraserLight: return "\u{f43c}"
        case .eraserRegular: return "\u{f43d}"
        case .errorLegacyBadgeFilled: return "\u{f43e}"
        case .errorLegacyBold: return "\u{f43f}"
        case .errorLegacyFilled: return "\u{f440}"
        case .errorLegacyLight: return "\u{f441}"
        case .errorLegacyRegular: return "\u{f442}"
        case .ethernetBold: return "\u{f443}"
        case .ethernetLight: return "\u{f444}"
        case .ethernetRegular: return "\u{f445}"
        case .eventBold: return "\u{f446}"
        case .eventLight: return "\u{f447}"
        case .eventRegular: return "\u{f448}"
        case .exitRoomBold: return "\u{f449}"
        case .exitRoomLight: return "\u{f44a}"
        case .exitRoomRegular: return "\u{f44b}"
        case .exludeBold: return "\u{f44c}"
        case .exludeLight: return "\u{f44d}"
        case .exludeRegular: return "\u{f44e}"
        case .exploreBold: return "\u{f44f}"
        case .exploreLight: return "\u{f450}"
        case .exploreRegular: return "\u{f451}"
        case .exportBold: return "\u{f452}"
        case .exportLight: return "\u{f453}"
        case .exportRegular: return "\u{f454}"
        case .extensionMobilityBold: return "\u{f455}"
        case .extensionMobilityLight: return "\u{f456}"
        case .extensionMobilityRegular: return "\u{f457}"
        case .externalMessageBold: return "\u{f458}"
        case .externalMessageLight: return "\u{f459}"
        case .externalMessageRegular: return "\u{f45a}"
        case .externalUserBold: return "\u{f45b}"
        case .externalUserLight: return "\u{f45c}"
        case .externalUserRegular: return "\u{f45d}"
        case .familyFontBold: return "\u{f45e}"
        case .familyFontLight: return "\u{f45f}"
        case .familyFontRegular: return "\u{f460}"
        case .fastForwardBold: return "\u{f461}"
        case .fastForwardLight: return "\u{f462}"
        case .fastForwardRegular: return "\u{f463}"
        case .favoriteBold: return "\u{f464}"
        case .favoriteFilled: return "\u{f465}"
        case .favoriteLight: return "\u{f466}"
        case .favoriteRegular: return "\u{f467}"
        case .favoritesBold: return "\u{f468}"
        case .favoritesFilled: return "\u{f469}"
        case .favoritesLight: return "\u{f46a}"
        case .favoritesRegular: return "\u{f46b}"
        case .fbwBold: return "\u{f46c}"
        case .fbwFilled: return "\u{f46d}"
        case .fbwLight: return "\u{f46e}"
        case .fbwRegular: return "\u{f46f}"
        case .ffwBold: return "\u{f470}"
        case .ffwFilled: return "\u{f471}"
        case .ffwLight: return "\u{f472}"
        case .ffwRegular: return "\u{f473}"
        case .file3DBold: return "\u{f474}"
        case .file3DFilled: return "\u{f475}"
        case .file3DLight: return "\u{f476}"
        case .file3DRegular: return "\u{f477}"
        case .fileAnalysisBold: return "\u{f478}"
        case .fileAnalysisFilled: return "\u{f479}"
        case .fileAnalysisLight: return "\u{f47a}"
        case .fileAnalysisRegular: return "\u{f47b}"
        case .fileAnnotationBold: return "\u{f47c}"
        case .fileAnnotationFilled: return "\u{f47d}"
        case .fileAnnotationLight: return "\u{f47e}"
        case .fileAnnotationRegular: return "\u{f47f}"
        case .fileAudioBold: return "\u{f480}"
        case .fileAudioFilled: return "\u{f481}"
        case .fileAudioLight: return "\u{f482}"
        case .fileAudioRegular: return "\u{f483}"
        case .fileBugBold: return "\u{f484}"
        case .fileBugFilled: return "\u{f485}"
        case .fileBugLight: return "\u{f486}"
        case .fileBugRegular: return "\u{f487}"
        case .fileCodeBold: return "\u{f488}"
        case .fileCodeFilled: return "\u{f489}"
        case .fileCodeLight: return "\u{f48a}"
        case .fileCodeRegular: return "\u{f48b}"
        case .fileDashboardBold: return "\u{f48c}"
        case .fileDashboardFilled: return "\u{f48d}"
        case .fileDashboardLight: return "\u{f48e}"
        case .fileDashboardRegular: return "\u{f48f}"
        case .fileExcelBold: return "\u{f490}"
        case .fileExcelFilled: return "\u{f491}"
        case .fileExcelLight: return "\u{f492}"
        case .fileExcelRegular: return "\u{f493}"
        case .fileGraphBold: return "\u{f494}"
        case .fileGraphFilled: return "\u{f495}"
        case .fileGraphLight: return "\u{f496}"
        case .fileGraphRegular: return "\u{f497}"
        case .fileImageBold: return "\u{f498}"
        case .fileImageFilled: return "\u{f499}"
        case .fileImageLight: return "\u{f49a}"
        case .fileImageRegular: return "\u{f49b}"
        case .fileKeynoteBold: return "\u{f49c}"
        case .fileKeynoteFilled: return "\u{f49d}"
        case .fileKeynoteLight: return "\u{f49e}"
        case .fileKeynoteRegular: return "\u{f49f}"
        case .fileLockedBold: return "\u{f4a0}"
        case .fileLockedFilled: return "\u{f4a1}"
        case .fileLockedLight: return "\u{f4a2}"
        case .fileLockedRegular: return "\u{f4a3}"
        case .fileMissingBold: return "\u{f4a4}"
        case .fileMissingFilled: return "\u{f4a5}"
        case .fileMissingLight: return "\u{f4a6}"
        case .fileMissingRegular: return "\u{f4a7}"
        case .fileMusicBold: return "\u{f4a8}"
        case .fileMusicFilled: return "\u{f4a9}"
        case .fileMusicLight: return "\u{f4aa}"
        case .fileMusicRegular: return "\u{f4ab}"
        case .fileOnenoteBold: return "\u{f4ac}"
        case .fileOnenoteFilled: return "\u{f4ad}"
        case .fileOnenoteLight: return "\u{f4ae}"
        case .fileOnenoteRegular: return "\u{f4af}"
        case .filePdfBold: return "\u{f4b0}"
        case .filePdfFilled: return "\u{f4b1}"
        case .filePdfLight: return "\u{f4b2}"
        case .filePdfRegular: return "\u{f4b3}"
        case .filePowerpointBold: return "\u{f4b4}"
        case .filePowerpointFilled: return "\u{f4b5}"
        case .filePowerpointLight: return "\u{f4b6}"
        case .filePowerpointRegular: return "\u{f4b7}"
        case .fileSpreadsheetBold: return "\u{f4b8}"
        case .fileSpreadsheetFilled: return "\u{f4b9}"
        case .fileSpreadsheetLight: return "\u{f4ba}"
        case .fileSpreadsheetRegular: return "\u{f4bb}"
        case .fileTextBold: return "\u{f4bc}"
        case .fileTextFilled: return "\u{f4bd}"
        case .fileTextLight: return "\u{f4be}"
        case .fileTextRegular: return "\u{f4bf}"
        case .fileVectorBold: return "\u{f4c0}"
        case .fileVectorFilled: return "\u{f4c1}"
        case .fileVectorLight: return "\u{f4c2}"
        case .fileVectorRegular: return "\u{f4c3}"
        case .fileVideoBold: return "\u{f4c4}"
        case .fileVideoFilled: return "\u{f4c5}"
        case .fileVideoLight: return "\u{f4c6}"
        case .fileVideoRegular: return "\u{f4c7}"
        case .fileWordBold: return "\u{f4c8}"
        case .fileWordFilled: return "\u{f4c9}"
        case .fileWordLight: return "\u{f4ca}"
        case .fileWordRegular: return "\u{f4cb}"
        case .fileZipBold: return "\u{f4cc}"
        case .fileZipFilled: return "\u{f4cd}"
        case .fileZipLight: return "\u{f4ce}"
        case .fileZipRegular: return "\u{f4cf}"
        case .filesBold: return "\u{f4d0}"
        case .filesFilled: return "\u{f4d1}"
        case .filesLight: return "\u{f4d2}"
        case .filesRegular: return "\u{f4d3}"
        case .fillColourBold: return "\u{f4d4}"
        case .fillColourFilled: return "\u{f4d5}"
        case .fillColourLight: return "\u{f4d6}"
        case .fillColourRegular: return "\u{f4d7}"
        case .filterBold: return "\u{f4d8}"
        case .filterCircleBold: return "\u{f4d9}"
        case .filterCircleFilled: return "\u{f4da}"
        case .filterCircleLight: return "\u{f4db}"
        case .filterCircleRegular: return "\u{f4dc}"
        case .filterLight: return "\u{f4dd}"
        case .filterRegular: return "\u{f4de}"
        case .fitToWidthBold: return "\u{f4df}"
        case .fitToWidthLight: return "\u{f4e0}"
        case .fitToWidthRegular: return "\u{f4e1}"
        case .fitToWindowBold: return "\u{f4e2}"
        case .fitToWindowExitBold: return "\u{f4e3}"
        case .fitToWindowExitLight: return "\u{f4e4}"
        case .fitToWindowExitRegular: return "\u{f4e5}"
        case .fitToWindowLight: return "\u{f4e6}"
        case .fitToWindowRegular: return "\u{f4e7}"
        case .flagBold: return "\u{f4e8}"
        case .flagCircleBold: return "\u{f4e9}"
        case .flagCircleFilled: return "\u{f4ea}"
        case .flagCircleLight: return "\u{f4eb}"
        case .flagCircleRegular: return "\u{f4ec}"
        case .flagFilled: return "\u{f4ed}"
        case .flagLight: return "\u{f4ee}"
        case .flagRegular: return "\u{f4ef}"
        case .folderBold: return "\u{f4f0}"
        case .folderEditBold: return "\u{f4f1}"
        case .folderEditLight: return "\u{f4f2}"
        case .folderEditRegular: return "\u{f4f3}"
        case .folderLight: return "\u{f4f4}"
        case .folderLockBold: return "\u{f4f5}"
        case .folderLockLight: return "\u{f4f6}"
        case .folderLockRegular: return "\u{f4f7}"
        case .folderRegular: return "\u{f4f8}"
        case .folderViewBold: return "\u{f4f9}"
        case .folderViewLight: return "\u{f4fa}"
        case .folderViewRegular: return "\u{f4fb}"
        case .followUpBold: return "\u{f4fc}"
        case .followUpLight: return "\u{f4fd}"
        case .followUpRegular: return "\u{f4fe}"
        case .foodBold: return "\u{f4ff}"
        case .foodLight: return "\u{f500}"
        case .foodRegular: return "\u{f501}"
        case .formatBold: return "\u{f502}"
        case .formatControlPanelDraggerBold: return "\u{f503}"
        case .formatControlPanelDraggerHorizontalBold: return "\u{f504}"
        case .formatControlPanelDraggerHorizontalLight: return "\u{f505}"
        case .formatControlPanelDraggerHorizontalRegular: return "\u{f506}"
        case .formatControlPanelDraggerLight: return "\u{f507}"
        case .formatControlPanelDraggerRegular: return "\u{f508}"
        case .formatDefaultAppBold: return "\u{f509}"
        case .formatDefaultAppLight: return "\u{f50a}"
        case .formatDefaultAppRegular: return "\u{f50b}"
        case .formatLight: return "\u{f50c}"
        case .formatPanelControlBarBold: return "\u{f50d}"
        case .formatPanelControlBarLight: return "\u{f50e}"
        case .formatPanelControlBarRegular: return "\u{f50f}"
        case .formatPanelControlDownBold: return "\u{f510}"
        case .formatPanelControlDownLight: return "\u{f511}"
        case .formatPanelControlDownRegular: return "\u{f512}"
        case .formatPanelControlLeftBold: return "\u{f513}"
        case .formatPanelControlLeftLight: return "\u{f514}"
        case .formatPanelControlLeftRegular: return "\u{f515}"
        case .formatPanelControlRightBold: return "\u{f516}"
        case .formatPanelControlRightLight: return "\u{f517}"
        case .formatPanelControlRightRegular: return "\u{f518}"
        case .formatPanelControlUpBold: return "\u{f519}"
        case .formatPanelControlUpDownBold: return "\u{f51a}"
        case .formatPanelControlUpDownLight: return "\u{f51b}"
        case .formatPanelControlUpDownRegular: return "\u{f51c}"
        case .formatPanelControlUpLight: return "\u{f51d}"
        case .formatPanelControlUpRegular: return "\u{f51e}"
        case .formatRegular: return "\u{f51f}"
        case .formatViewMixedBold: return "\u{f520}"
        case .formatViewMixedLight: return "\u{f521}"
        case .formatViewMixedRegular: return "\u{f522}"
        case .forwardMessageBold: return "\u{f523}"
        case .forwardMessageFilled: return "\u{f524}"
        case .forwardMessageLight: return "\u{f525}"
        case .forwardMessageRegular: return "\u{f526}"
        case .fourColumnBold: return "\u{f527}"
        case .fourColumnLight: return "\u{f528}"
        case .fourColumnRegular: return "\u{f529}"
        case .fourWayNavigationBold: return "\u{f52a}"
        case .fourWayNavigationLight: return "\u{f52b}"
        case .fourWayNavigationRegular: return "\u{f52c}"
        case .frequencyCappingBold: return "\u{f52d}"
        case .frequencyCappingLight: return "\u{f52e}"
        case .frequencyCappingRegular: return "\u{f52f}"
        case .fufillmentBold: return "\u{f530}"
        case .fufillmentLight: return "\u{f531}"
        case .fufillmentRegular: return "\u{f532}"
        case .fullscreenBold: return "\u{f533}"
        case .fullscreenExitBold: return "\u{f534}"
        case .fullscreenExitLight: return "\u{f535}"
        case .fullscreenExitRegular: return "\u{f536}"
        case .fullscreenLight: return "\u{f537}"
        case .fullscreenRegular: return "\u{f538}"
        case .genericDeviceVideoBold: return "\u{f539}"
        case .genericDeviceVideoFilled: return "\u{f53a}"
        case .genericDeviceVideoLight: return "\u{f53b}"
        case .genericDeviceVideoRegular: return "\u{f53c}"
        case .genericDeviceVideoSmallFilled: return "\u{f53d}"
        case .gifBold: return "\u{f53e}"
        case .gifFilled: return "\u{f53f}"
        case .gifLight: return "\u{f540}"
        case .gifRegular: return "\u{f541}"
        case .googleMeet: return "\u{f542}"
        case .greenRoomBold: return "\u{f543}"
        case .greenRoomFilled: return "\u{f544}"
        case .greenRoomLight: return "\u{f545}"
        case .greenRoomRegular: return "\u{f546}"
        case .groupBold: return "\u{f547}"
        case .groupLight: return "\u{f548}"
        case .groupPickupBold: return "\u{f549}"
        case .groupPickupFilled: return "\u{f54a}"
        case .groupPickupLight: return "\u{f54b}"
        case .groupPickupRegular: return "\u{f54c}"
        case .groupRegular: return "\u{f54d}"
        case .guestIssuerBold: return "\u{f54e}"
        case .guestIssuerLight: return "\u{f54f}"
        case .guestIssuerRegular: return "\u{f550}"
        case .guideBold: return "\u{f551}"
        case .guideLight: return "\u{f552}"
        case .guideRegular: return "\u{f553}"
        case .handlerBold: return "\u{f554}"
        case .handlerLight: return "\u{f555}"
        case .handlerRegular: return "\u{f556}"
        case .handsetAlertBold: return "\u{f557}"
        case .handsetAlertFilled: return "\u{f558}"
        case .handsetAlertLight: return "\u{f559}"
        case .handsetAlertRegular: return "\u{f55a}"
        case .handsetBold: return "\u{f55b}"
        case .handsetFilled: return "\u{f55c}"
        case .handsetLight: return "\u{f55d}"
        case .handsetMutedBold: return "\u{f55e}"
        case .handsetMutedFilled: return "\u{f55f}"
        case .handsetMutedLight: return "\u{f560}"
        case .handsetMutedRegular: return "\u{f561}"
        case .handsetRegular: return "\u{f562}"
        case .handshakeBold: return "\u{f563}"
        case .handshakeLight: return "\u{f564}"
        case .handshakeRegular: return "\u{f565}"
        case .headingOneBold: return "\u{f566}"
        case .headingOneLight: return "\u{f567}"
        case .headingOneRegular: return "\u{f568}"
        case .headingThreeBold: return "\u{f569}"
        case .headingThreeLight: return "\u{f56a}"
        case .headingThreeRegular: return "\u{f56b}"
        case .headingTwoBold: return "\u{f56c}"
        case .headingTwoLight: return "\u{f56d}"
        case .headingTwoRegular: return "\u{f56e}"
        case .headsetAlertBold: return "\u{f56f}"
        case .headsetAlertLight: return "\u{f570}"
        case .headsetAlertRegular: return "\u{f571}"
        case .headsetBold: return "\u{f572}"
        case .headsetFilled: return "\u{f573}"
        case .headsetLight: return "\u{f574}"
        case .headsetMutedBold: return "\u{f575}"
        case .headsetMutedLight: return "\u{f576}"
        case .headsetMutedRegular: return "\u{f577}"
        case .headsetPrivateBold: return "\u{f578}"
        case .headsetPrivateLight: return "\u{f579}"
        case .headsetPrivateRegular: return "\u{f57a}"
        case .headsetRegular: return "\u{f57b}"
        case .helpBold: return "\u{f57c}"
        case .helpCircleActiveFilled: return "\u{f57d}"
        case .helpCircleBold: return "\u{f57e}"
        case .helpCircleLight: return "\u{f57f}"
        case .helpCircleRegular: return "\u{f580}"
        case .helpLight: return "\u{f581}"
        case .helpRegular: return "\u{f582}"
        case .helpdeskBold: return "\u{f583}"
        case .helpdeskLight: return "\u{f584}"
        case .helpdeskRegular: return "\u{f585}"
        case .hideBold: return "\u{f586}"
        case .hideFilled: return "\u{f587}"
        case .hideLight: return "\u{f588}"
        case .hideRegular: return "\u{f589}"
        case .homeBold: return "\u{f58a}"
        case .homeFilled: return "\u{f58b}"
        case .homeLight: return "\u{f58c}"
        case .homeRegular: return "\u{f58d}"
        case .horizontalLineBold: return "\u{f58e}"
        case .horizontalLineLight: return "\u{f58f}"
        case .horizontalLineRegular: return "\u{f590}"
        case .hotelingBold: return "\u{f591}"
        case .hotelingFilled: return "\u{f592}"
        case .hotelingLight: return "\u{f593}"
        case .hotelingRegular: return "\u{f594}"
        case .humidityBold: return "\u{f595}"
        case .humidityLight: return "\u{f596}"
        case .humidityRegular: return "\u{f597}"
        case .huntGroupBold: return "\u{f598}"
        case .huntGroupFilled: return "\u{f599}"
        case .huntGroupLight: return "\u{f59a}"
        case .huntGroupRegular: return "\u{f59b}"
        case .importBold: return "\u{f59c}"
        case .importLight: return "\u{f59d}"
        case .importRegular: return "\u{f59e}"
        case .inCommonBold: return "\u{f59f}"
        case .inCommonLight: return "\u{f5a0}"
        case .inCommonRegular: return "\u{f5a1}"
        case .includeBold: return "\u{f5a2}"
        case .includeLight: return "\u{f5a3}"
        case .includeRegular: return "\u{f5a4}"
        case .incomingCallLegacyBold: return "\u{f5a5}"
        case .incomingCallLegacyFilled: return "\u{f5a6}"
        case .incomingCallLegacyLight: return "\u{f5a7}"
        case .incomingCallLegacyRegular: return "\u{f5a8}"
        case .infoBadgeFilled: return "\u{f5a9}"
        case .infoCircleBold: return "\u{f5aa}"
        case .infoCircleFilled: return "\u{f5ab}"
        case .infoCircleLight: return "\u{f5ac}"
        case .infoCircleRegular: return "\u{f5ad}"
        case .infoCircleTwoBold: return "\u{f5ae}"
        case .infoCircleTwoFilled: return "\u{f5af}"
        case .infoCircleTwoLight: return "\u{f5b0}"
        case .infoCircleTwoRegular: return "\u{f5b1}"
        case .inputBold: return "\u{f5b2}"
        case .inputDisconnectedBold: return "\u{f5b3}"
        case .inputDisconnectedLight: return "\u{f5b4}"
        case .inputDisconnectedRegular: return "\u{f5b5}"
        case .inputLight: return "\u{f5b6}"
        case .inputRegular: return "\u{f5b7}"
        case .insightsBold: return "\u{f5b8}"
        case .insightsLight: return "\u{f5b9}"
        case .insightsRegular: return "\u{f5ba}"
        case .integrationsBold: return "\u{f5bb}"
        case .integrationsLight: return "\u{f5bc}"
        case .integrationsRegular: return "\u{f5bd}"
        case .intelligentRoutingBold: return "\u{f5be}"
        case .intelligentRoutingLight: return "\u{f5bf}"
        case .intelligentRoutingRegular: return "\u{f5c0}"
        case .invitedUserBold: return "\u{f5c1}"
        case .invitedUserLight: return "\u{f5c2}"
        case .invitedUserRegular: return "\u{f5c3}"
        case .italicBold: return "\u{f5c4}"
        case .italicLight: return "\u{f5c5}"
        case .italicRegular: return "\u{f5c6}"
        case .joinAudioBold: return "\u{f5c7}"
        case .joinAudioFilled: return "\u{f5c8}"
        case .joinAudioLight: return "\u{f5c9}"
        case .joinAudioRegular: return "\u{f5ca}"
        case .keepInTouchBold: return "\u{f5cb}"
        case .keepInTouchFilled: return "\u{f5cc}"
        case .keepInTouchLight: return "\u{f5cd}"
        case .keepInTouchRegular: return "\u{f5ce}"
        case .keyboardBold: return "\u{f5cf}"
        case .keyboardCloseBold: return "\u{f5d0}"
        case .keyboardCloseLight: return "\u{f5d1}"
        case .keyboardCloseRegular: return "\u{f5d2}"
        case .keyboardLight: return "\u{f5d3}"
        case .keyboardRegular: return "\u{f5d4}"
        case .languageBold: return "\u{f5d5}"
        case .languageLight: return "\u{f5d6}"
        case .languageRegular: return "\u{f5d7}"
        case .laptopBold: return "\u{f5d8}"
        case .laptopDisconnectedBold: return "\u{f5d9}"
        case .laptopDisconnectedLight: return "\u{f5da}"
        case .laptopDisconnectedRegular: return "\u{f5db}"
        case .laptopFilled: return "\u{f5dc}"
        case .laptopLight: return "\u{f5dd}"
        case .laptopRegular: return "\u{f5de}"
        case .laserPointerBold: return "\u{f5df}"
        case .laserPointerLight: return "\u{f5e0}"
        case .laserPointerRegular: return "\u{f5e1}"
        case .launchBold: return "\u{f5e2}"
        case .launchLight: return "\u{f5e3}"
        case .launchRegular: return "\u{f5e4}"
        case .layoutSideBySideVerticalBold: return "\u{f5e5}"
        case .layoutSideBySideVerticalFilled: return "\u{f5e6}"
        case .layoutSideBySideVerticalLight: return "\u{f5e7}"
        case .layoutSideBySideVerticalRegular: return "\u{f5e8}"
        case .leaveBreakoutSessionBold: return "\u{f5e9}"
        case .leaveBreakoutSessionLight: return "\u{f5ea}"
        case .leaveBreakoutSessionRegular: return "\u{f5eb}"
        case .leaveDeviceBold: return "\u{f5ec}"
        case .leaveDeviceLight: return "\u{f5ed}"
        case .leaveDeviceRegular: return "\u{f5ee}"
        case .likeBold: return "\u{f5ef}"
        case .likeFilled: return "\u{f5f0}"
        case .likeLight: return "\u{f5f1}"
        case .likeRegular: return "\u{f5f2}"
        case .linkBold: return "\u{f5f3}"
        case .linkLight: return "\u{f5f4}"
        case .linkRegular: return "\u{f5f5}"
        case .listBulletedBold: return "\u{f5f6}"
        case .listBulletedLight: return "\u{f5f7}"
        case .listBulletedRegular: return "\u{f5f8}"
        case .listMenuBold: return "\u{f5f9}"
        case .listMenuLight: return "\u{f5fa}"
        case .listMenuRegular: return "\u{f5fb}"
        case .listNumberedBold: return "\u{f5fc}"
        case .listNumberedLight: return "\u{f5fd}"
        case .listNumberedRegular: return "\u{f5fe}"
        case .locationBold: return "\u{f5ff}"
        case .locationFilled: return "\u{f600}"
        case .locationLight: return "\u{f601}"
        case .locationRegular: return "\u{f602}"
        case .longTextBoxBold: return "\u{f603}"
        case .longTextBoxLight: return "\u{f604}"
        case .longTextBoxRegular: return "\u{f605}"
        case .lowerHandBold: return "\u{f606}"
        case .lowerHandLight: return "\u{f607}"
        case .lowerHandRegular: return "\u{f608}"
        case .magicPenBold: return "\u{f609}"
        case .magicPenFilled: return "\u{f60a}"
        case .magicPenLight: return "\u{f60b}"
        case .magicPenRegular: return "\u{f60c}"
        case .markAsUnreadBold: return "\u{f60d}"
        case .markAsUnreadLight: return "\u{f60e}"
        case .markAsUnreadRegular: return "\u{f60f}"
        case .markdownBold: return "\u{f610}"
        case .markdownLight: return "\u{f611}"
        case .markdownRegular: return "\u{f612}"
        case .markerBold: return "\u{f613}"
        case .markerFilled: return "\u{f614}"
        case .markerLight: return "\u{f615}"
        case .markerRegular: return "\u{f616}"
        case .maximizeBold: return "\u{f617}"
        case .maximizeLight: return "\u{f618}"
        case .maximizeRegular: return "\u{f619}"
        case .mediaPlayerBold: return "\u{f61a}"
        case .mediaPlayerLight: return "\u{f61b}"
        case .mediaPlayerRegular: return "\u{f61c}"
        case .mediaQualityGoodBold: return "\u{f61d}"
        case .mediaQualityGoodFilled: return "\u{f61e}"
        case .mediaQualityGoodLight: return "\u{f61f}"
        case .mediaQualityGoodRegular: return "\u{f620}"
        case .mediaQualityPoorBold: return "\u{f621}"
        case .mediaQualityPoorFilled: return "\u{f622}"
        case .mediaQualityPoorLight: return "\u{f623}"
        case .mediaQualityPoorRegular: return "\u{f624}"
        case .mediaQualityUnstableBold: return "\u{f625}"
        case .mediaQualityUnstableFilled: return "\u{f626}"
        case .mediaQualityUnstableLight: return "\u{f627}"
        case .mediaQualityUnstableRegular: return "\u{f628}"
        case .mediumQualityGoodFilled: return "\u{f629}"
        case .mediumQualityPoorFilled: return "\u{f62a}"
        case .mediumQualityUnstableFilled: return "\u{f62b}"
        case .meetBold: return "\u{f62c}"
        case .meetEndBold: return "\u{f62d}"
        case .meetEndLight: return "\u{f62e}"
        case .meetEndRegular: return "\u{f62f}"
        case .meetFilled: return "\u{f630}"
        case .meetLight: return "\u{f631}"
        case .meetRegular: return "\u{f632}"
        case .meetingsBold: return "\u{f633}"
        case .meetingsFilled: return "\u{f634}"
        case .meetingsFocusMonthBold: return "\u{f635}"
        case .meetingsFocusMonthLight: return "\u{f636}"
        case .meetingsFocusMonthRegular: return "\u{f637}"
        case .meetingsFocusOneDayBold: return "\u{f638}"
        case .meetingsFocusOneDayLight: return "\u{f639}"
        case .meetingsFocusOneDayRegular: return "\u{f63a}"
        case .meetingsFocusThreeDayBold: return "\u{f63b}"
        case .meetingsFocusThreeDayLight: return "\u{f63c}"
        case .meetingsFocusThreeDayRegular: return "\u{f63d}"
        case .meetingsFocusUpcomingBold: return "\u{f63e}"
        case .meetingsFocusUpcomingLight: return "\u{f63f}"
        case .meetingsFocusUpcomingRegular: return "\u{f640}"
        case .meetingsFocusWeekBold: return "\u{f641}"
        case .meetingsFocusWeekLight: return "\u{f642}"
        case .meetingsFocusWeekRegular: return "\u{f643}"
        case .meetingsLight: return "\u{f644}"
        case .meetingsPresenceBold: return "\u{f645}"
        case .meetingsPresenceFilled: return "\u{f646}"
        case .meetingsPresenceLight: return "\u{f647}"
        case .meetingsPresenceRegular: return "\u{f648}"
        case .meetingsPresenceSmallFilled: return "\u{f649}"
        case .meetingsRegular: return "\u{f64a}"
        case .meetingsTeamActiveBold: return "\u{f64b}"
        case .meetingsTeamActiveLight: return "\u{f64c}"
        case .meetingsTeamActiveRegular: return "\u{f64d}"
        case .meetingsTeamBold: return "\u{f64e}"
        case .meetingsTeamLight: return "\u{f64f}"
        case .meetingsTeamNewBold: return "\u{f650}"
        case .meetingsTeamNewLight: return "\u{f651}"
        case .meetingsTeamNewRegular: return "\u{f652}"
        case .meetingsTeamRegular: return "\u{f653}"
        case .mentionBold: return "\u{f654}"
        case .mentionLight: return "\u{f655}"
        case .mentionRegular: return "\u{f656}"
        case .messageQueingBold: return "\u{f657}"
        case .messageQueingLight: return "\u{f658}"
        case .messageQueingRegular: return "\u{f659}"
        case .microphoneBold: return "\u{f65a}"
        case .microphoneFilled: return "\u{f65b}"
        case .microphoneHardMutedBold: return "\u{f65c}"
        case .microphoneHardMutedColoredBold: return "\u{f65d}"
        case .microphoneHardMutedColoredLight: return "\u{f65e}"
        case .microphoneHardMutedColoredRegular: return "\u{f65f}"
        case .microphoneHardMutedLight: return "\u{f660}"
        case .microphoneHardMutedRegular: return "\u{f661}"
        case .microphoneLight: return "\u{f662}"
        case .microphoneMusicModeColoredBold: return "\u{f663}"
        case .microphoneMusicModeColoredLight: return "\u{f664}"
        case .microphoneMusicModeColoredRegular: return "\u{f665}"
        case .microphoneMutedBold: return "\u{f666}"
        case .microphoneMutedFilled: return "\u{f667}"
        case .microphoneMutedIndicatorFilled: return "\u{f668}"
        case .microphoneMutedLight: return "\u{f669}"
        case .microphoneMutedRedBold: return "\u{f66a}"
        case .microphoneMutedRedFilled: return "\u{f66b}"
        case .microphoneMutedRedLight: return "\u{f66c}"
        case .microphoneMutedRedRegular: return "\u{f66d}"
        case .microphoneMutedRegular: return "\u{f66e}"
        case .microphoneRegular: return "\u{f66f}"
        case .minimizeBold: return "\u{f670}"
        case .minimizeLight: return "\u{f671}"
        case .minimizeRegular: return "\u{f672}"
        case .minusBold: return "\u{f673}"
        case .minusLight: return "\u{f674}"
        case .minusRegular: return "\u{f675}"
        case .mirrorBold: return "\u{f676}"
        case .mirrorFilled: return "\u{f677}"
        case .mirrorLight: return "\u{f678}"
        case .mirrorRegular: return "\u{f679}"
        case .moderatorBold: return "\u{f67a}"
        case .moderatorLight: return "\u{f67b}"
        case .moderatorRegular: return "\u{f67c}"
        case .monitoringBold: return "\u{f67d}"
        case .monitoringLight: return "\u{f67e}"
        case .monitoringRegular: return "\u{f67f}"
        case .monthlyRecurringScheduleNodeBold: return "\u{f680}"
        case .monthlyRecurringScheduleNodeLight: return "\u{f681}"
        case .monthlyRecurringScheduleNodeRegular: return "\u{f682}"
        case .moreAdrBold: return "\u{f683}"
        case .moreAdrLight: return "\u{f684}"
        case .moreAdrRegular: return "\u{f685}"
        case .moreBold: return "\u{f686}"
        case .moreCircleBold: return "\u{f687}"
        case .moreCircleFilled: return "\u{f688}"
        case .moreCircleLight: return "\u{f689}"
        case .moreCircleRegular: return "\u{f68a}"
        case .moreCirecleFilled: return "\u{f68b}"
        case .moreLight: return "\u{f68c}"
        case .moreRegular: return "\u{f68d}"
        case .mouseCursorBold: return "\u{f68e}"
        case .mouseCursorLight: return "\u{f68f}"
        case .mouseCursorRegular: return "\u{f690}"
        case .moveCallInAdrBold: return "\u{f691}"
        case .moveCallInAdrLight: return "\u{f692}"
        case .moveCallInAdrRegular: return "\u{f693}"
        case .moveCallInIphBold: return "\u{f694}"
        case .moveCallInIphLight: return "\u{f695}"
        case .moveCallInIphRegular: return "\u{f696}"
        case .moveCallInLaptopBold: return "\u{f697}"
        case .moveCallInLaptopLight: return "\u{f698}"
        case .moveCallInLaptopRegular: return "\u{f699}"
        case .moveCallInOutAdrBold: return "\u{f69a}"
        case .moveCallInOutAdrLight: return "\u{f69b}"
        case .moveCallInOutAdrRegular: return "\u{f69c}"
        case .moveCallInOutIphBold: return "\u{f69d}"
        case .moveCallInOutIphLight: return "\u{f69e}"
        case .moveCallInOutIphRegular: return "\u{f69f}"
        case .moveCallInTabletBold: return "\u{f6a0}"
        case .moveCallInTabletLight: return "\u{f6a1}"
        case .moveCallInTabletRegular: return "\u{f6a2}"
        case .moveCallOutAdrBold: return "\u{f6a3}"
        case .moveCallOutAdrLight: return "\u{f6a4}"
        case .moveCallOutAdrRegular: return "\u{f6a5}"
        case .moveCallOutIphBold: return "\u{f6a6}"
        case .moveCallOutIphLight: return "\u{f6a7}"
        case .moveCallOutIphRegular: return "\u{f6a8}"
        case .moveCallOutLaptopBold: return "\u{f6a9}"
        case .moveCallOutLaptopLight: return "\u{f6aa}"
        case .moveCallOutLaptopRegular: return "\u{f6ab}"
        case .moveCallOutTabletBold: return "\u{f6ac}"
        case .moveCallOutTabletLight: return "\u{f6ad}"
        case .moveCallOutTabletRegular: return "\u{f6ae}"
        case .msTeams: return "\u{f6af}"
        case .multilineChartBold: return "\u{f6b0}"
        case .multilineChartFilled: return "\u{f6b1}"
        case .multilineChartLight: return "\u{f6b2}"
        case .multilineChartRegular: return "\u{f6b3}"
        case .multimediaBold: return "\u{f6b4}"
        case .multimediaFilled: return "\u{f6b5}"
        case .multimediaLight: return "\u{f6b6}"
        case .multimediaRegular: return "\u{f6b7}"
        case .multipledDevicesBold: return "\u{f6b8}"
        case .multipledDevicesLight: return "\u{f6b9}"
        case .multipledDevicesRegular: return "\u{f6ba}"
        case .musicModeBold: return "\u{f6bb}"
        case .musicModeCircleBold: return "\u{f6bc}"
        case .musicModeCircleFilled: return "\u{f6bd}"
        case .musicModeCircleLight: return "\u{f6be}"
        case .musicModeCircleRegular: return "\u{f6bf}"
        case .musicModeFilled: return "\u{f6c0}"
        case .musicModeLight: return "\u{f6c1}"
        case .musicModeRegular: return "\u{f6c2}"
        case .muteOnEntryBold: return "\u{f6c3}"
        case .muteOnEntryFilled: return "\u{f6c4}"
        case .muteOnEntryLight: return "\u{f6c5}"
        case .muteOnEntryRegular: return "\u{f6c6}"
        case .newManagerBold: return "\u{f6c7}"
        case .newManagerLight: return "\u{f6c8}"
        case .newManagerRegular: return "\u{f6c9}"
        case .newTitleBold: return "\u{f6ca}"
        case .newTitleLight: return "\u{f6cb}"
        case .newTitleRegular: return "\u{f6cc}"
        case .newVoicemailBold: return "\u{f6cd}"
        case .newVoicemailLight: return "\u{f6ce}"
        case .newVoicemailRegular: return "\u{f6cf}"
        case .newWhiteboardBold: return "\u{f6d0}"
        case .newWhiteboardLight: return "\u{f6d1}"
        case .newWhiteboardRegular: return "\u{f6d2}"
        case .nextBold: return "\u{f6d3}"
        case .nextLight: return "\u{f6d4}"
        case .nextRegular: return "\u{f6d5}"
        case .noDevicesBold: return "\u{f6d6}"
        case .noDevicesLight: return "\u{f6d7}"
        case .noDevicesRegular: return "\u{f6d8}"
        case .noiseDetectedCanceledFilled: return "\u{f6d9}"
        case .noiseDetectedFilled: return "\u{f6da}"
        case .noiseNoneCanceledFilled: return "\u{f6db}"
        case .noiseNoneFilled: return "\u{f6dc}"
        case .noiseRemovalBold: return "\u{f6dd}"
        case .noiseRemovalLight: return "\u{f6de}"
        case .noiseRemovalRegular: return "\u{f6df}"
        case .noteBold: return "\u{f6e0}"
        case .noteLight: return "\u{f6e1}"
        case .notePptBold: return "\u{f6e2}"
        case .notePptLight: return "\u{f6e3}"
        case .notePptRegular: return "\u{f6e4}"
        case .noteRegular: return "\u{f6e5}"
        case .notesBold: return "\u{f6e6}"
        case .notesLight: return "\u{f6e7}"
        case .notesRegular: return "\u{f6e8}"
        case .numberBold: return "\u{f6e9}"
        case .numberLight: return "\u{f6ea}"
        case .numberRegular: return "\u{f6eb}"
        case .oldRemoteBold: return "\u{f6ec}"
        case .oldRemoteLight: return "\u{f6ed}"
        case .oldRemoteRegular: return "\u{f6ee}"
        case .oldTouchBold: return "\u{f6ef}"
        case .oldTouchLight: return "\u{f6f0}"
        case .oldTouchRegular: return "\u{f6f1}"
        case .oneColumnBold: return "\u{f6f2}"
        case .oneColumnLight: return "\u{f6f3}"
        case .oneColumnRegular: return "\u{f6f4}"
        case .openInFolderBold: return "\u{f6f5}"
        case .openInFolderLight: return "\u{f6f6}"
        case .openInFolderRegular: return "\u{f6f7}"
        case .openPagesBold: return "\u{f6f8}"
        case .openPagesLight: return "\u{f6f9}"
        case .openPagesRegular: return "\u{f6fa}"
        case .otherNumberBold: return "\u{f6fb}"
        case .otherNumberLight: return "\u{f6fc}"
        case .otherNumberRegular: return "\u{f6fd}"
        case .otherNumberWarningBold: return "\u{f6fe}"
        case .otherNumberWarningLight: return "\u{f6ff}"
        case .otherNumberWarningRegular: return "\u{f700}"
        case .outgoingCallLegacyBold: return "\u{f701}"
        case .outgoingCallLegacyLight: return "\u{f702}"
        case .outgoingCallLegacyRegular: return "\u{f703}"
        case .overflowLeftBold: return "\u{f704}"
        case .overflowLeftLight: return "\u{f705}"
        case .overflowLeftRegular: return "\u{f706}"
        case .overflowRightBold: return "\u{f707}"
        case .overflowRightLight: return "\u{f708}"
        case .overflowRightRegular: return "\u{f709}"
        case .pairedCameraBold: return "\u{f70a}"
        case .pairedCameraLight: return "\u{f70b}"
        case .pairedCameraRegular: return "\u{f70c}"
        case .pairedDeviceBold: return "\u{f70d}"
        case .pairedDeviceLight: return "\u{f70e}"
        case .pairedDeviceRegular: return "\u{f70f}"
        case .pairedHandsetBold: return "\u{f710}"
        case .pairedHandsetLight: return "\u{f711}"
        case .pairedHandsetRegular: return "\u{f712}"
        case .pairingBold: return "\u{f713}"
        case .pairingLight: return "\u{f714}"
        case .pairingRegular: return "\u{f715}"
        case .parkedBold: return "\u{f716}"
        case .parkedFilled: return "\u{f717}"
        case .parkedLight: return "\u{f718}"
        case .parkedRegular: return "\u{f719}"
        case .parseBold: return "\u{f71a}"
        case .parseLight: return "\u{f71b}"
        case .parseRegular: return "\u{f71c}"
        case .partialBold: return "\u{f71d}"
        case .partialLight: return "\u{f71e}"
        case .partialRegular: return "\u{f71f}"
        case .participantAddBold: return "\u{f720}"
        case .participantAddLight: return "\u{f721}"
        case .participantAddRegular: return "\u{f722}"
        case .participantBlockedBold: return "\u{f723}"
        case .participantBlockedLight: return "\u{f724}"
        case .participantBlockedRegular: return "\u{f725}"
        case .participantBold: return "\u{f726}"
        case .participantFilled: return "\u{f727}"
        case .participantLight: return "\u{f728}"
        case .participantListBold: return "\u{f729}"
        case .participantListFilled: return "\u{f72a}"
        case .participantListLight: return "\u{f72b}"
        case .participantListRegular: return "\u{f72c}"
        case .participantRegular: return "\u{f72d}"
        case .participantRemoveBold: return "\u{f72e}"
        case .participantRemoveLight: return "\u{f72f}"
        case .participantRemoveRegular: return "\u{f730}"
        case .participantUnknownBold: return "\u{f731}"
        case .participantUnknownLight: return "\u{f732}"
        case .participantUnknownRegular: return "\u{f733}"
        case .passMouseBold: return "\u{f734}"
        case .passMouseLight: return "\u{f735}"
        case .passMouseRegular: return "\u{f736}"
        case .pauseBold: return "\u{f737}"
        case .pauseFilled: return "\u{f738}"
        case .pauseLight: return "\u{f739}"
        case .pauseRegular: return "\u{f73a}"
        case .penBold: return "\u{f73b}"
        case .penFilled: return "\u{f73c}"
        case .penLight: return "\u{f73d}"
        case .penRegular: return "\u{f73e}"
        case .peopleBold: return "\u{f73f}"
        case .peopleCircleBold: return "\u{f740}"
        case .peopleCircleFilled: return "\u{f741}"
        case .peopleCircleLight: return "\u{f742}"
        case .peopleCircleRegular: return "\u{f743}"
        case .peopleFilled: return "\u{f744}"
        case .peopleInsightsFilled: return "\u{f745}"
        case .peopleLight: return "\u{f746}"
        case .peopleRegular: return "\u{f747}"
        case .phoneAlertBold: return "\u{f748}"
        case .phoneAlertLight: return "\u{f749}"
        case .phoneAlertRegular: return "\u{f74a}"
        case .phoneBold: return "\u{f74b}"
        case .phoneFilled: return "\u{f74c}"
        case .phoneLight: return "\u{f74d}"
        case .phoneMutedBold: return "\u{f74e}"
        case .phoneMutedLight: return "\u{f74f}"
        case .phoneMutedRegular: return "\u{f750}"
        case .phonePrivateBold: return "\u{f751}"
        case .phonePrivateLight: return "\u{f752}"
        case .phonePrivateRegular: return "\u{f753}"
        case .phoneRegular: return "\u{f754}"
        case .phoneReplyAllBold: return "\u{f755}"
        case .phoneReplyAllLight: return "\u{f756}"
        case .phoneReplyAllRegular: return "\u{f757}"
        case .phoneReplyBold: return "\u{f758}"
        case .phoneReplyLight: return "\u{f759}"
        case .phoneReplyRegular: return "\u{f75a}"
        case .phoneSmallFilled: return "\u{f75b}"
        case .pickerBold: return "\u{f75c}"
        case .pickerLight: return "\u{f75d}"
        case .pickerRegular: return "\u{f75e}"
        case .pictureInPictureBold: return "\u{f75f}"
        case .pictureInPictureFilled: return "\u{f760}"
        case .pictureInPictureLight: return "\u{f761}"
        case .pictureInPictureRegular: return "\u{f762}"
        case .pieChartBold: return "\u{f763}"
        case .pieChartFilled: return "\u{f764}"
        case .pieChartLight: return "\u{f765}"
        case .pieChartRegular: return "\u{f766}"
        case .pinBold: return "\u{f767}"
        case .pinFilled: return "\u{f768}"
        case .pinLight: return "\u{f769}"
        case .pinListActivityBold: return "\u{f76a}"
        case .pinListActivityColoredBold: return "\u{f76b}"
        case .pinListActivityColoredLight: return "\u{f76c}"
        case .pinListActivityColoredRegular: return "\u{f76d}"
        case .pinListActivityLight: return "\u{f76e}"
        case .pinListActivityRegular: return "\u{f76f}"
        case .pinListBold: return "\u{f770}"
        case .pinListLight: return "\u{f771}"
        case .pinListRegular: return "\u{f772}"
        case .pinMutedBold: return "\u{f773}"
        case .pinMutedFilled: return "\u{f774}"
        case .pinMutedLight: return "\u{f775}"
        case .pinMutedRegular: return "\u{f776}"
        case .pinRegular: return "\u{f777}"
        case .placeholderBold: return "\u{f778}"
        case .placeholderLight: return "\u{f779}"
        case .placeholderRegular: return "\u{f77a}"
        case .playBold: return "\u{f77b}"
        case .playFilled: return "\u{f77c}"
        case .playLight: return "\u{f77d}"
        case .playRegular: return "\u{f77e}"
        case .plugAcBold: return "\u{f77f}"
        case .plugAcLight: return "\u{f780}"
        case .plugAcRegular: return "\u{f781}"
        case .plusBold: return "\u{f782}"
        case .plusCircleBold: return "\u{f783}"
        case .plusCircleFilled: return "\u{f784}"
        case .plusCircleLight: return "\u{f785}"
        case .plusCircleRegular: return "\u{f786}"
        case .plusLight: return "\u{f787}"
        case .plusRegular: return "\u{f788}"
        case .pmrBold: return "\u{f789}"
        case .pmrFilled: return "\u{f78a}"
        case .pmrLight: return "\u{f78b}"
        case .pmrRegular: return "\u{f78c}"
        case .pollBold: return "\u{f78d}"
        case .pollLight: return "\u{f78e}"
        case .pollRegular: return "\u{f78f}"
        case .popInBold: return "\u{f790}"
        case .popInLight: return "\u{f791}"
        case .popInRegular: return "\u{f792}"
        case .popOutBold: return "\u{f793}"
        case .popOutLight: return "\u{f794}"
        case .popOutRegular: return "\u{f795}"
        case .popUpBold: return "\u{f796}"
        case .popUpLight: return "\u{f797}"
        case .popUpRegular: return "\u{f798}"
        case .portraitLandscapeBold: return "\u{f799}"
        case .portraitLandscapeLight: return "\u{f79a}"
        case .portraitLandscapeRegular: return "\u{f79b}"
        case .powerAcBold: return "\u{f79c}"
        case .powerAcLight: return "\u{f79d}"
        case .powerAcRegular: return "\u{f79e}"
        case .powerBold: return "\u{f79f}"
        case .powerLight: return "\u{f7a0}"
        case .powerRegular: return "\u{f7a1}"
        case .preHeaderBold: return "\u{f7a2}"
        case .preHeaderLight: return "\u{f7a3}"
        case .preHeaderRegular: return "\u{f7a4}"
        case .presentationBold: return "\u{f7a5}"
        case .presentationLight: return "\u{f7a6}"
        case .presentationRegular: return "\u{f7a7}"
        case .primaryParticipantBold: return "\u{f7a8}"
        case .primaryParticipantLight: return "\u{f7a9}"
        case .primaryParticipantRegular: return "\u{f7aa}"
        case .printBold: return "\u{f7ab}"
        case .printLight: return "\u{f7ac}"
        case .printRegular: return "\u{f7ad}"
        case .priorityBadgeFilled: return "\u{f7ae}"
        case .priorityCircleBold: return "\u{f7af}"
        case .priorityCircleFilled: return "\u{f7b0}"
        case .priorityCircleLight: return "\u{f7b1}"
        case .priorityCircleRegular: return "\u{f7b2}"
        case .priorityCircleTwoBold: return "\u{f7b3}"
        case .priorityCircleTwoFilled: return "\u{f7b4}"
        case .priorityCircleTwoLight: return "\u{f7b5}"
        case .priorityCircleTwoRegular: return "\u{f7b6}"
        case .privacyCircleBold: return "\u{f7b7}"
        case .privacyCircleFilled: return "\u{f7b8}"
        case .privacyCircleLight: return "\u{f7b9}"
        case .privacyCircleRegular: return "\u{f7ba}"
        case .privateBold: return "\u{f7bb}"
        case .privateCircleBold: return "\u{f7bc}"
        case .privateCircleFilled: return "\u{f7bd}"
        case .privateCircleLight: return "\u{f7be}"
        case .privateCircleRegular: return "\u{f7bf}"
        case .privateLight: return "\u{f7c0}"
        case .privateMeetingBold: return "\u{f7c1}"
        case .privateMeetingLight: return "\u{f7c2}"
        case .privateMeetingRegular: return "\u{f7c3}"
        case .privateRegular: return "\u{f7c4}"
        case .productDemoBold: return "\u{f7c5}"
        case .productDemoLight: return "\u{f7c6}"
        case .productDemoRegular: return "\u{f7c7}"
        case .proximityBold: return "\u{f7c8}"
        case .proximityLight: return "\u{f7c9}"
        case .proximityMutedBold: return "\u{f7ca}"
        case .proximityMutedLight: return "\u{f7cb}"
        case .proximityMutedRegular: return "\u{f7cc}"
        case .proximityRegular: return "\u{f7cd}"
        case .proximityVideoBold: return "\u{f7ce}"
        case .proximityVideoLight: return "\u{f7cf}"
        case .proximityVideoRegular: return "\u{f7d0}"
        case .ptoPresenceBold: return "\u{f7d1}"
        case .ptoPresenceFilled: return "\u{f7d2}"
        case .ptoPresenceLight: return "\u{f7d3}"
        case .ptoPresenceRegular: return "\u{f7d4}"
        case .pullCallBold: return "\u{f7d5}"
        case .pullCallLight: return "\u{f7d6}"
        case .pullCallRegular: return "\u{f7d7}"
        case .qABold: return "\u{f7d8}"
        case .qALight: return "\u{f7d9}"
        case .qARegular: return "\u{f7da}"
        case .qualityBold: return "\u{f7db}"
        case .qualityLight: return "\u{f7dc}"
        case .qualityRegular: return "\u{f7dd}"
        case .queueContactBold: return "\u{f7de}"
        case .queueContactLight: return "\u{f7df}"
        case .queueContactRegular: return "\u{f7e0}"
        case .quietBold: return "\u{f7e1}"
        case .quietHoursPresenceBold: return "\u{f7e2}"
        case .quietHoursPresenceFilled: return "\u{f7e3}"
        case .quietHoursPresenceLight: return "\u{f7e4}"
        case .quietHoursPresenceRegular: return "\u{f7e5}"
        case .quietLight: return "\u{f7e6}"
        case .quietRegular: return "\u{f7e7}"
        case .radioButtonGroupBold: return "\u{f7e8}"
        case .radioButtonGroupLight: return "\u{f7e9}"
        case .radioButtonGroupRegular: return "\u{f7ea}"
        case .raiseHandBold: return "\u{f7eb}"
        case .raiseHandFilled: return "\u{f7ec}"
        case .raiseHandLight: return "\u{f7ed}"
        case .raiseHandRegular: return "\u{f7ee}"
        case .ramBold: return "\u{f7ef}"
        case .ramLight: return "\u{f7f0}"
        case .ramRegular: return "\u{f7f1}"
        case .reactionsBold: return "\u{f7f2}"
        case .reactionsFilled: return "\u{f7f3}"
        case .reactionsLight: return "\u{f7f4}"
        case .reactionsRegular: return "\u{f7f5}"
        case .reactivateBold: return "\u{f7f6}"
        case .reactivateLight: return "\u{f7f7}"
        case .reactivateRegular: return "\u{f7f8}"
        case .recentsBold: return "\u{f7f9}"
        case .recentsFilled: return "\u{f7fa}"
        case .recentsLight: return "\u{f7fb}"
        case .recentsPresenceBold: return "\u{f7fc}"
        case .recentsPresenceFilled: return "\u{f7fd}"
        case .recentsPresenceLight: return "\u{f7fe}"
        case .recentsPresenceRegular: return "\u{f7ff}"
        case .recentsPresenceSmallFilled: return "\u{f800}"
        case .recentsRegular: return "\u{f801}"
        case .recordActiveBold: return "\u{f802}"
        case .recordActiveFilled: return "\u{f803}"
        case .recordActiveLight: return "\u{f804}"
        case .recordActiveRegular: return "\u{f805}"
        case .recordBold: return "\u{f806}"
        case .recordFilled: return "\u{f807}"
        case .recordLight: return "\u{f808}"
        case .recordPausedBold: return "\u{f809}"
        case .recordPausedFilled: return "\u{f80a}"
        case .recordPausedLight: return "\u{f80b}"
        case .recordPausedRegular: return "\u{f80c}"
        case .recordRegular: return "\u{f80d}"
        case .recurringBold: return "\u{f80e}"
        case .recurringLight: return "\u{f80f}"
        case .recurringOffBold: return "\u{f810}"
        case .recurringOffLight: return "\u{f811}"
        case .recurringOffRegular: return "\u{f812}"
        case .recurringRegular: return "\u{f813}"
        case .redialBold: return "\u{f814}"
        case .redialLight: return "\u{f815}"
        case .redialRegular: return "\u{f816}"
        case .redoBold: return "\u{f817}"
        case .redoLight: return "\u{f818}"
        case .redoRegular: return "\u{f819}"
        case .refreshBold: return "\u{f81a}"
        case .refreshLight: return "\u{f81b}"
        case .refreshRegular: return "\u{f81c}"
        case .remoteCallBold: return "\u{f81d}"
        case .remoteCallFilled: return "\u{f81e}"
        case .remoteCallLight: return "\u{f81f}"
        case .remoteCallRegular: return "\u{f820}"
        case .remoteDesktopControlBold: return "\u{f821}"
        case .remoteDesktopControlFilled: return "\u{f822}"
        case .remoteDesktopControlLight: return "\u{f823}"
        case .remoteDesktopControlRegular: return "\u{f824}"
        case .removeBold: return "\u{f825}"
        case .removeFilled: return "\u{f826}"
        case .removeLight: return "\u{f827}"
        case .removeRegular: return "\u{f828}"
        case .replyBold: return "\u{f829}"
        case .replyFilled: return "\u{f82a}"
        case .replyLight: return "\u{f82b}"
        case .replyListBold: return "\u{f82c}"
        case .replyListLight: return "\u{f82d}"
        case .replyListRegular: return "\u{f82e}"
        case .replyPrivatelyBold: return "\u{f82f}"
        case .replyPrivatelyLight: return "\u{f830}"
        case .replyPrivatelyRegular: return "\u{f831}"
        case .replyRegular: return "\u{f832}"
        case .resetBold: return "\u{f833}"
        case .resetLight: return "\u{f834}"
        case .resetRegular: return "\u{f835}"
        case .responsiveMobileBold: return "\u{f836}"
        case .responsiveMobileLight: return "\u{f837}"
        case .responsiveMobileRegular: return "\u{f838}"
        case .restartBold: return "\u{f839}"
        case .restartLight: return "\u{f83a}"
        case .restartRegular: return "\u{f83b}"
        case .retrieveCallBold: return "\u{f83c}"
        case .retrieveCallLight: return "\u{f83d}"
        case .retrieveCallRegular: return "\u{f83e}"
        case .returnBold: return "\u{f83f}"
        case .returnLight: return "\u{f840}"
        case .returnRegular: return "\u{f841}"
        case .ringtoneBold: return "\u{f842}"
        case .ringtoneLight: return "\u{f843}"
        case .ringtoneRegular: return "\u{f844}"
        case .roomCalendarBold: return "\u{f845}"
        case .roomCalendarLight: return "\u{f846}"
        case .roomCalendarRegular: return "\u{f847}"
        case .roomLightsBold: return "\u{f848}"
        case .roomLightsFilled: return "\u{f849}"
        case .roomLightsLight: return "\u{f84a}"
        case .roomLightsRegular: return "\u{f84b}"
        case .rotateContentBold: return "\u{f84c}"
        case .rotateContentFilled: return "\u{f84d}"
        case .rotateContentLight: return "\u{f84e}"
        case .rotateContentRegular: return "\u{f84f}"
        case .ruleBasedBold: return "\u{f850}"
        case .ruleBasedLight: return "\u{f851}"
        case .ruleBasedRegular: return "\u{f852}"
        case .runningApplicationBold: return "\u{f853}"
        case .runningApplicationFilled: return "\u{f854}"
        case .runningApplicationLight: return "\u{f855}"
        case .runningApplicationRegular: return "\u{f856}"
        case .saveBold: return "\u{f857}"
        case .saveLight: return "\u{f858}"
        case .saveRegular: return "\u{f859}"
        case .scanBold: return "\u{f85a}"
        case .scanLight: return "\u{f85b}"
        case .scanRegular: return "\u{f85c}"
        case .schedulerAvailableBold: return "\u{f85d}"
        case .schedulerAvailableLight: return "\u{f85e}"
        case .schedulerAvailableRegular: return "\u{f85f}"
        case .schedulerNotWorkingHoursBold: return "\u{f860}"
        case .schedulerNotWorkingHoursLight: return "\u{f861}"
        case .schedulerNotWorkingHoursRegular: return "\u{f862}"
        case .schedulerUnavailableBold: return "\u{f863}"
        case .schedulerUnavailableLight: return "\u{f864}"
        case .schedulerUnavailableRegular: return "\u{f865}"
        case .schedulerUnknownBold: return "\u{f866}"
        case .schedulerUnknownLight: return "\u{f867}"
        case .schedulerUnknownRegular: return "\u{f868}"
        case .screenshotBold: return "\u{f869}"
        case .screenshotDocBold: return "\u{f86a}"
        case .screenshotDocFilled: return "\u{f86b}"
        case .screenshotDocLight: return "\u{f86c}"
        case .screenshotDocRegular: return "\u{f86d}"
        case .screenshotLight: return "\u{f86e}"
        case .screenshotRegular: return "\u{f86f}"
        case .searchBold: return "\u{f870}"
        case .searchFilled: return "\u{f871}"
        case .searchLight: return "\u{f872}"
        case .searchRegular: return "\u{f873}"
        case .secondaryArrowBold: return "\u{f874}"
        case .secondaryArrowLight: return "\u{f875}"
        case .secondaryArrowRegular: return "\u{f876}"
        case .secureCallLockBold: return "\u{f877}"
        case .secureCallLockFilled: return "\u{f878}"
        case .secureCallLockLight: return "\u{f879}"
        case .secureCallLockRegular: return "\u{f87a}"
        case .secureCallShieldBold: return "\u{f87b}"
        case .secureCallShieldFilled: return "\u{f87c}"
        case .secureCallShieldLight: return "\u{f87d}"
        case .secureCallShieldRegular: return "\u{f87e}"
        case .secureCircleBold: return "\u{f87f}"
        case .secureCircleFilled: return "\u{f880}"
        case .secureCircleLight: return "\u{f881}"
        case .secureCircleRegular: return "\u{f882}"
        case .secureLockBold: return "\u{f883}"
        case .secureLockFilled: return "\u{f884}"
        case .secureLockLight: return "\u{f885}"
        case .secureLockRegular: return "\u{f886}"
        case .selectAllBold: return "\u{f887}"
        case .selectAllFilled: return "\u{f888}"
        case .selectAllLight: return "\u{f889}"
        case .selectAllRegular: return "\u{f88a}"
        case .selectionBold: return "\u{f88b}"
        case .selectionLight: return "\u{f88c}"
        case .selectionRegular: return "\u{f88d}"
        case .sendBold: return "\u{f88e}"
        case .sendFilled: return "\u{f88f}"
        case .sendLight: return "\u{f890}"
        case .sendRegular: return "\u{f891}"
        case .serverBold: return "\u{f892}"
        case .serverErrorBold: return "\u{f893}"
        case .serverErrorLight: return "\u{f894}"
        case .serverErrorRegular: return "\u{f895}"
        case .serverLight: return "\u{f896}"
        case .serverRegular: return "\u{f897}"
        case .servicesBold: return "\u{f898}"
        case .servicesLight: return "\u{f899}"
        case .servicesRegular: return "\u{f89a}"
        case .setVariableBold: return "\u{f89b}"
        case .setVariableLight: return "\u{f89c}"
        case .setVariableRegular: return "\u{f89d}"
        case .settingsBold: return "\u{f89e}"
        case .settingsFilled: return "\u{f89f}"
        case .settingsLight: return "\u{f8a0}"
        case .settingsRegular: return "\u{f8a1}"
        case .setupAssistantBold: return "\u{f8a2}"
        case .setupAssistantLight: return "\u{f8a3}"
        case .setupAssistantRegular: return "\u{f8a4}"
        case .sftpBold: return "\u{f8a5}"
        case .sftpLight: return "\u{f8a6}"
        case .sftpRegular: return "\u{f8a7}"
        case .shapeCircleBold: return "\u{f8a8}"
        case .shapeCircleFilled: return "\u{f8a9}"
        case .shapeCircleLight: return "\u{f8aa}"
        case .shapeCircleRegular: return "\u{f8ab}"
        case .shapeDiagonalLineBold: return "\u{f8ac}"
        case .shapeDiagonalLineLight: return "\u{f8ad}"
        case .shapeDiagonalLineRegular: return "\u{f8ae}"
        case .shapeDiamondBold: return "\u{f8af}"
        case .shapeDiamondFilled: return "\u{f8b0}"
        case .shapeDiamondLight: return "\u{f8b1}"
        case .shapeDiamondRegular: return "\u{f8b2}"
        case .shapeOvalBold: return "\u{f8b3}"
        case .shapeOvalLight: return "\u{f8b4}"
        case .shapeOvalRegular: return "\u{f8b5}"
        case .shapeSquareBold: return "\u{f8b6}"
        case .shapeSquareFilled: return "\u{f8b7}"
        case .shapeSquareLight: return "\u{f8b8}"
        case .shapeSquareRegular: return "\u{f8b9}"
        case .shapeTriangleBold: return "\u{f8ba}"
        case .shapeTriangleFilled: return "\u{f8bb}"
        case .shapeTriangleLight: return "\u{f8bc}"
        case .shapeTriangleRegular: return "\u{f8bd}"
        case .shapesBold: return "\u{f8be}"
        case .shapesLight: return "\u{f8bf}"
        case .shapesRegular: return "\u{f8c0}"
        case .shareCNativeAdrBold: return "\u{f8c1}"
        case .shareCNativeAdrLight: return "\u{f8c2}"
        case .shareCNativeAdrRegular: return "\u{f8c3}"
        case .shareCNativeIphBold: return "\u{f8c4}"
        case .shareCNativeIphLight: return "\u{f8c5}"
        case .shareCNativeIphRegular: return "\u{f8c6}"
        case .shareScreenBold: return "\u{f8c7}"
        case .shareScreenFilled: return "\u{f8c8}"
        case .shareScreenLight: return "\u{f8c9}"
        case .shareScreenRegular: return "\u{f8ca}"
        case .shareScreenSmallFilled: return "\u{f8cb}"
        case .shareSpaceBold: return "\u{f8cc}"
        case .shareSpaceLight: return "\u{f8cd}"
        case .shareSpaceRegular: return "\u{f8ce}"
        case .shieldBold: return "\u{f8cf}"
        case .shieldLight: return "\u{f8d0}"
        case .shieldRegular: return "\u{f8d1}"
        case .shoppingCartBold: return "\u{f8d2}"
        case .shoppingCartFilled: return "\u{f8d3}"
        case .shoppingCartLight: return "\u{f8d4}"
        case .shoppingCartRegular: return "\u{f8d5}"
        case .shortTextBoxBold: return "\u{f8d6}"
        case .shortTextBoxLight: return "\u{f8d7}"
        case .shortTextBoxRegular: return "\u{f8d8}"
        case .showBold: return "\u{f8d9}"
        case .showFilled: return "\u{f8da}"
        case .showLight: return "\u{f8db}"
        case .showRegular: return "\u{f8dc}"
        case .signInBold: return "\u{f8dd}"
        case .signInFilled: return "\u{f8de}"
        case .signInForcedBold: return "\u{f8df}"
        case .signInForcedLight: return "\u{f8e0}"
        case .signInForcedRegular: return "\u{f8e1}"
        case .signInLight: return "\u{f8e2}"
        case .signInRegular: return "\u{f8e3}"
        case .signOutBold: return "\u{f8e4}"
        case .signOutLight: return "\u{f8e5}"
        case .signOutRegular: return "\u{f8e6}"
        case .signal0Bold: return "\u{f8e7}"
        case .signal0Light: return "\u{f8e8}"
        case .signal0Regular: return "\u{f8e9}"
        case .signal100Bold: return "\u{f8ea}"
        case .signal100Light: return "\u{f8eb}"
        case .signal100Regular: return "\u{f8ec}"
        case .signal25Bold: return "\u{f8ed}"
        case .signal25Light: return "\u{f8ee}"
        case .signal25Regular: return "\u{f8ef}"
        case .signal50Bold: return "\u{f8f0}"
        case .signal50Light: return "\u{f8f1}"
        case .signal50Regular: return "\u{f8f2}"
        case .signal75Bold: return "\u{f8f3}"
        case .signal75Light: return "\u{f8f4}"
        case .signal75Regular: return "\u{f8f5}"
        case .simplePromotionBold: return "\u{f8f6}"
        case .simplePromotionLight: return "\u{f8f7}"
        case .simplePromotionRegular: return "\u{f8f8}"
        case .singleNumberReachBold: return "\u{f8f9}"
        case .singleNumberReachLight: return "\u{f8fa}"
        case .singleNumberReachRegular: return "\u{f8fb}"
        case .sipRegistrationInProgressBold: return "\u{f8fc}"
        case .sipRegistrationInProgressFilled: return "\u{f8fd}"
        case .sipRegistrationInProgressLight: return "\u{f8fe}"
        case .sipRegistrationInProgressRegular: return "\u{f8ff}"
        case .skipBold: return "\u{f900}"
        case .skipBwBold: return "\u{f901}"
        case .skipBwFilled: return "\u{f902}"
        case .skipBwLight: return "\u{f903}"
        case .skipBwRegular: return "\u{f904}"
        case .skipFwBold: return "\u{f905}"
        case .skipFwFilled: return "\u{f906}"
        case .skipFwLight: return "\u{f907}"
        case .skipFwRegular: return "\u{f908}"
        case .skipLight: return "\u{f909}"
        case .skipRegular: return "\u{f90a}"
        case .smsInboundBold: return "\u{f90b}"
        case .smsInboundLight: return "\u{f90c}"
        case .smsInboundRegular: return "\u{f90d}"
        case .socialAlexaFilled: return "\u{f90e}"
        case .socialFacebookColoredFilled: return "\u{f90f}"
        case .socialFacebookFilled: return "\u{f910}"
        case .socialFbmessengerColoredFilled: return "\u{f911}"
        case .socialFbmessengerFilled: return "\u{f912}"
        case .socialInstagramBold: return "\u{f913}"
        case .socialMicrosoftColoredFilled: return "\u{f914}"
        case .socialMicrosoftFilled: return "\u{f915}"
        case .socialMmsFilled: return "\u{f916}"
        case .socialMmsGoldFilled: return "\u{f917}"
        case .socialSmsFilled: return "\u{f918}"
        case .socialSmsMintFilled: return "\u{f919}"
        case .socialTwitterColoredFilled: return "\u{f91a}"
        case .socialTwitterFilled: return "\u{f91b}"
        case .socialViberBold: return "\u{f91c}"
        case .socialViberColoredBold: return "\u{f91d}"
        case .socialWhatsappBold: return "\u{f91e}"
        case .socialWhatsappColoredFilled: return "\u{f91f}"
        case .sortAscendingBold: return "\u{f920}"
        case .sortAscendingLight: return "\u{f921}"
        case .sortAscendingRegular: return "\u{f922}"
        case .sortDescendingBold: return "\u{f923}"
        case .sortDescendingLight: return "\u{f924}"
        case .sortDescendingRegular: return "\u{f925}"
        case .soundDefaultBold: return "\u{f926}"
        case .soundDefaultLight: return "\u{f927}"
        case .soundDefaultRegular: return "\u{f928}"
        case .speakerBold: return "\u{f929}"
        case .speakerDisconnectedBold: return "\u{f92a}"
        case .speakerDisconnectedFilled: return "\u{f92b}"
        case .speakerDisconnectedLight: return "\u{f92c}"
        case .speakerDisconnectedRegular: return "\u{f92d}"
        case .speakerFilled: return "\u{f92e}"
        case .speakerLight: return "\u{f92f}"
        case .speakerMutedBold: return "\u{f930}"
        case .speakerMutedFilled: return "\u{f931}"
        case .speakerMutedLight: return "\u{f932}"
        case .speakerMutedRegular: return "\u{f933}"
        case .speakerOffBold: return "\u{f934}"
        case .speakerOffFilled: return "\u{f935}"
        case .speakerOffLight: return "\u{f936}"
        case .speakerOffRegular: return "\u{f937}"
        case .speakerOnColoredBold: return "\u{f938}"
        case .speakerOnColoredLight: return "\u{f939}"
        case .speakerOnColoredRegular: return "\u{f93a}"
        case .speakerRegular: return "\u{f93b}"
        case .speakerTurnDownBold: return "\u{f93c}"
        case .speakerTurnDownFilled: return "\u{f93d}"
        case .speakerTurnDownLight: return "\u{f93e}"
        case .speakerTurnDownRegular: return "\u{f93f}"
        case .speakerTurnUpBold: return "\u{f940}"
        case .speakerTurnUpFilled: return "\u{f941}"
        case .speakerTurnUpLight: return "\u{f942}"
        case .speakerTurnUpRegular: return "\u{f943}"
        case .spinnerBold: return "\u{f944}"
        case .spinnerFilledBold: return "\u{f945}"
        case .spinnerFilledLight: return "\u{f946}"
        case .spinnerFilledRegular: return "\u{f947}"
        case .spinnerLight: return "\u{f948}"
        case .spinnerPartialBold: return "\u{f949}"
        case .spinnerPartialLight: return "\u{f94a}"
        case .spinnerPartialRegular: return "\u{f94b}"
        case .spinnerRegular: return "\u{f94c}"
        case .stackedArea100ChartBold: return "\u{f94d}"
        case .stackedArea100ChartFilled: return "\u{f94e}"
        case .stackedArea100ChartLight: return "\u{f94f}"
        case .stackedArea100ChartRegular: return "\u{f950}"
        case .stackedAreaChartBold: return "\u{f951}"
        case .stackedAreaChartFilled: return "\u{f952}"
        case .stackedAreaChartLight: return "\u{f953}"
        case .stackedAreaChartRegular: return "\u{f954}"
        case .stackedBar100ChartBold: return "\u{f955}"
        case .stackedBar100ChartFilled: return "\u{f956}"
        case .stackedBar100ChartLight: return "\u{f957}"
        case .stackedBar100ChartRegular: return "\u{f958}"
        case .stackedBarChartBold: return "\u{f959}"
        case .stackedBarChartFilled: return "\u{f95a}"
        case .stackedBarChartLight: return "\u{f95b}"
        case .stackedBarChartRegular: return "\u{f95c}"
        case .startChatBold: return "\u{f95d}"
        case .startChatLight: return "\u{f95e}"
        case .startChatRegular: return "\u{f95f}"
        case .stethoscopeBold: return "\u{f960}"
        case .stethoscopeLight: return "\u{f961}"
        case .stethoscopeRegular: return "\u{f962}"
        case .stickersBold: return "\u{f963}"
        case .stickersLight: return "\u{f964}"
        case .stickersRegular: return "\u{f965}"
        case .stickiesBold: return "\u{f966}"
        case .stickiesLight: return "\u{f967}"
        case .stickiesRegular: return "\u{f968}"
        case .stopBold: return "\u{f969}"
        case .stopCircleBold: return "\u{f96a}"
        case .stopCircleFilled: return "\u{f96b}"
        case .stopCircleLight: return "\u{f96c}"
        case .stopCircleRegular: return "\u{f96d}"
        case .stopContentShareBold: return "\u{f96e}"
        case .stopContentShareLight: return "\u{f96f}"
        case .stopContentShareRegular: return "\u{f970}"
        case .stopFilled: return "\u{f971}"
        case .stopLight: return "\u{f972}"
        case .stopRegular: return "\u{f973}"
        case .storedInfoBold: return "\u{f974}"
        case .storedInfoFilled: return "\u{f975}"
        case .storedInfoLight: return "\u{f976}"
        case .storedInfoRegular: return "\u{f977}"
        case .streamingBold: return "\u{f978}"
        case .streamingLight: return "\u{f979}"
        case .streamingRegular: return "\u{f97a}"
        case .strikethroughBold: return "\u{f97b}"
        case .strikethroughLight: return "\u{f97c}"
        case .strikethroughRegular: return "\u{f97d}"
        case .subscriptBold: return "\u{f97e}"
        case .subscriptLight: return "\u{f97f}"
        case .subscriptRegular: return "\u{f980}"
        case .superscriptBold: return "\u{f981}"
        case .superscriptLight: return "\u{f982}"
        case .superscriptRegular: return "\u{f983}"
        case .surveyBold: return "\u{f984}"
        case .surveyFilled: return "\u{f985}"
        case .surveyLight: return "\u{f986}"
        case .surveyRegular: return "\u{f987}"
        case .sx10Bold: return "\u{f988}"
        case .sx10Light: return "\u{f989}"
        case .sx10Regular: return "\u{f98a}"
        case .sx20Bold: return "\u{f98b}"
        case .sx20Light: return "\u{f98c}"
        case .sx20Regular: return "\u{f98d}"
        case .sx80CodecBold: return "\u{f98e}"
        case .sx80CodecLight: return "\u{f98f}"
        case .sx80CodecRegular: return "\u{f990}"
        case .tableBold: return "\u{f991}"
        case .tableLight: return "\u{f992}"
        case .tableRegular: return "\u{f993}"
        case .tabletBold: return "\u{f994}"
        case .tabletLight: return "\u{f995}"
        case .tabletRegular: return "\u{f996}"
        case .tabsBold: return "\u{f997}"
        case .tabsLight: return "\u{f998}"
        case .tabsRegular: return "\u{f999}"
        case .tagBold: return "\u{f99a}"
        case .tagLight: return "\u{f99b}"
        case .tagRegular: return "\u{f99c}"
        case .tapBold: return "\u{f99d}"
        case .tapFilled: return "\u{f99e}"
        case .tapLight: return "\u{f99f}"
        case .tapRegular: return "\u{f9a0}"
        case .telepresenceAlertBold: return "\u{f9a1}"
        case .telepresenceAlertLight: return "\u{f9a2}"
        case .telepresenceAlertMutedBold: return "\u{f9a3}"
        case .telepresenceAlertMutedLight: return "\u{f9a4}"
        case .telepresenceAlertMutedRegular: return "\u{f9a5}"
        case .telepresenceAlertRegular: return "\u{f9a6}"
        case .telepresenceBold: return "\u{f9a7}"
        case .telepresenceIx5000Bold: return "\u{f9a8}"
        case .telepresenceIx5000Light: return "\u{f9a9}"
        case .telepresenceIx5000Regular: return "\u{f9aa}"
        case .telepresenceLight: return "\u{f9ab}"
        case .telepresencePrivateBold: return "\u{f9ac}"
        case .telepresencePrivateLight: return "\u{f9ad}"
        case .telepresencePrivateRegular: return "\u{f9ae}"
        case .telepresenceRegular: return "\u{f9af}"
        case .temperatureBold: return "\u{f9b0}"
        case .temperatureLight: return "\u{f9b1}"
        case .temperatureRegular: return "\u{f9b2}"
        case .textAlignCenterBold: return "\u{f9b3}"
        case .textAlignCenterFilled: return "\u{f9b4}"
        case .textAlignCenterLight: return "\u{f9b5}"
        case .textAlignCenterRegular: return "\u{f9b6}"
        case .textAlignLeftBold: return "\u{f9b7}"
        case .textAlignLeftFilled: return "\u{f9b8}"
        case .textAlignLeftLight: return "\u{f9b9}"
        case .textAlignLeftRegular: return "\u{f9ba}"
        case .textAlignRightBold: return "\u{f9bb}"
        case .textAlignRightFilled: return "\u{f9bc}"
        case .textAlignRightLight: return "\u{f9bd}"
        case .textAlignRightRegular: return "\u{f9be}"
        case .textBold: return "\u{f9bf}"
        case .textCodeBlockBold: return "\u{f9c0}"
        case .textCodeBlockLight: return "\u{f9c1}"
        case .textCodeBlockRegular: return "\u{f9c2}"
        case .textHighlightBold: return "\u{f9c3}"
        case .textHighlightLight: return "\u{f9c4}"
        case .textHighlightRegular: return "\u{f9c5}"
        case .textLight: return "\u{f9c6}"
        case .textRegular: return "\u{f9c7}"
        case .threeColumnBold: return "\u{f9c8}"
        case .threeColumnLight: return "\u{f9c9}"
        case .threeColumnRegular: return "\u{f9ca}"
        case .threeDObjectBold: return "\u{f9cb}"
        case .threeDObjectLight: return "\u{f9cc}"
        case .threeDObjectRegular: return "\u{f9cd}"
        case .tooFastBold: return "\u{f9ce}"
        case .tooFastLight: return "\u{f9cf}"
        case .tooFastRegular: return "\u{f9d0}"
        case .tooSlowBold: return "\u{f9d1}"
        case .tooSlowLight: return "\u{f9d2}"
        case .tooSlowRegular: return "\u{f9d3}"
        case .toolsBold: return "\u{f9d4}"
        case .toolsLight: return "\u{f9d5}"
        case .toolsRegular: return "\u{f9d6}"
        case .touch10Bold: return "\u{f9d7}"
        case .touch10Light: return "\u{f9d8}"
        case .touch10Regular: return "\u{f9d9}"
        case .transcriptBold: return "\u{f9da}"
        case .transcriptFilled: return "\u{f9db}"
        case .transcriptLight: return "\u{f9dc}"
        case .transcriptRegular: return "\u{f9dd}"
        case .translateBold: return "\u{f9de}"
        case .translateLight: return "\u{f9df}"
        case .translateRegular: return "\u{f9e0}"
        case .trimBold: return "\u{f9e1}"
        case .trimLight: return "\u{f9e2}"
        case .trimRegular: return "\u{f9e3}"
        case .twoColumnBold: return "\u{f9e4}"
        case .twoColumnLight: return "\u{f9e5}"
        case .twoColumnRegular: return "\u{f9e6}"
        case .ucmCloudBold: return "\u{f9e7}"
        case .ucmCloudLight: return "\u{f9e8}"
        case .ucmCloudRegular: return "\u{f9e9}"
        case .underlineBold: return "\u{f9ea}"
        case .underlineLight: return "\u{f9eb}"
        case .underlineRegular: return "\u{f9ec}"
        case .undoBold: return "\u{f9ed}"
        case .undoLight: return "\u{f9ee}"
        case .undoRegular: return "\u{f9ef}"
        case .unlinkBold: return "\u{f9f0}"
        case .unlinkLight: return "\u{f9f1}"
        case .unlinkRegular: return "\u{f9f2}"
        case .unreadBold: return "\u{f9f3}"
        case .unreadFilled: return "\u{f9f4}"
        case .unreadLight: return "\u{f9f5}"
        case .unreadRegular: return "\u{f9f6}"
        case .unsecureUnlockedBold: return "\u{f9f7}"
        case .unsecureUnlockedFilled: return "\u{f9f8}"
        case .unsecureUnlockedLight: return "\u{f9f9}"
        case .unsecureUnlockedRegular: return "\u{f9fa}"
        case .unsortedBold: return "\u{f9fb}"
        case .unsortedLight: return "\u{f9fc}"
        case .unsortedRegular: return "\u{f9fd}"
        case .updateFileShareBold: return "\u{f9fe}"
        case .updateFileShareLight: return "\u{f9ff}"
        case .updateFileShareRegular: return "\u{fa00}"
        case .upgradeBold: return "\u{fa01}"
        case .upgradeFilled: return "\u{fa02}"
        case .upgradeLight: return "\u{fa03}"
        case .upgradeRegular: return "\u{fa04}"
        case .uploadBold: return "\u{fa05}"
        case .uploadLight: return "\u{fa06}"
        case .uploadRegular: return "\u{fa07}"
        case .urgentVoicemailBold: return "\u{fa08}"
        case .urgentVoicemailFilled: return "\u{fa09}"
        case .usbBold: return "\u{fa0a}"
        case .usbHeadsetBold: return "\u{fa0b}"
        case .usbHeadsetLight: return "\u{fa0c}"
        case .usbHeadsetMutedBold: return "\u{fa0d}"
        case .usbHeadsetMutedLight: return "\u{fa0e}"
        case .usbHeadsetMutedRegular: return "\u{fa0f}"
        case .usbHeadsetRegular: return "\u{fa10}"
        case .usbLight: return "\u{fa11}"
        case .usbRegular: return "\u{fa12}"
        case .userBold: return "\u{fa13}"
        case .userDeactivateBold: return "\u{fa14}"
        case .userDeactivateLight: return "\u{fa15}"
        case .userDeactivateRegular: return "\u{fa16}"
        case .userLight: return "\u{fa17}"
        case .userRegular: return "\u{fa18}"
        case .vcsBold: return "\u{fa19}"
        case .vcsLight: return "\u{fa1a}"
        case .vcsRegular: return "\u{fa1b}"
        case .videoBlurBold: return "\u{fa1c}"
        case .videoBlurFilled: return "\u{fa1d}"
        case .videoBlurLight: return "\u{fa1e}"
        case .videoBlurRegular: return "\u{fa1f}"
        case .videoBold: return "\u{fa20}"
        case .videoEffectBold: return "\u{fa21}"
        case .videoEffectFilled: return "\u{fa22}"
        case .videoEffectLight: return "\u{fa23}"
        case .videoEffectRegular: return "\u{fa24}"
        case .videoFilled: return "\u{fa25}"
        case .videoLayoutBold: return "\u{fa26}"
        case .videoLayoutEqualBold: return "\u{fa27}"
        case .videoLayoutEqualDualBold: return "\u{fa28}"
        case .videoLayoutEqualDualLight: return "\u{fa29}"
        case .videoLayoutEqualDualRegular: return "\u{fa2a}"
        case .videoLayoutEqualFilled: return "\u{fa2b}"
        case .videoLayoutEqualLight: return "\u{fa2c}"
        case .videoLayoutEqualRegular: return "\u{fa2d}"
        case .videoLayoutFilled: return "\u{fa2e}"
        case .videoLayoutLight: return "\u{fa2f}"
        case .videoLayoutOverlayBold: return "\u{fa30}"
        case .videoLayoutOverlayLight: return "\u{fa31}"
        case .videoLayoutOverlayRegular: return "\u{fa32}"
        case .videoLayoutPresenterDominantBold: return "\u{fa33}"
        case .videoLayoutPresenterDominantLight: return "\u{fa34}"
        case .videoLayoutPresenterDominantRegular: return "\u{fa35}"
        case .videoLayoutProminentBold: return "\u{fa36}"
        case .videoLayoutProminentFilled: return "\u{fa37}"
        case .videoLayoutProminentLight: return "\u{fa38}"
        case .videoLayoutProminentRegular: return "\u{fa39}"
        case .videoLayoutRegular: return "\u{fa3a}"
        case .videoLayoutShareDominantBold: return "\u{fa3b}"
        case .videoLayoutShareDominantLight: return "\u{fa3c}"
        case .videoLayoutShareDominantRegular: return "\u{fa3d}"
        case .videoLayoutSingleBold: return "\u{fa3e}"
        case .videoLayoutSingleFilled: return "\u{fa3f}"
        case .videoLayoutSingleLight: return "\u{fa40}"
        case .videoLayoutSingleRegular: return "\u{fa41}"
        case .videoLayoutStackBold: return "\u{fa42}"
        case .videoLayoutStackFilled: return "\u{fa43}"
        case .videoLayoutStackLight: return "\u{fa44}"
        case .videoLayoutStackRegular: return "\u{fa45}"
        case .videoLayoutVideoDominantBold: return "\u{fa46}"
        case .videoLayoutVideoDominantLight: return "\u{fa47}"
        case .videoLayoutVideoDominantRegular: return "\u{fa48}"
        case .videoLight: return "\u{fa49}"
        case .videoPlusBold: return "\u{fa4a}"
        case .videoPlusFilled: return "\u{fa4b}"
        case .videoPlusLight: return "\u{fa4c}"
        case .videoPlusRegular: return "\u{fa4d}"
        case .videoRegular: return "\u{fa4e}"
        case .videoSpeakerTrackBold: return "\u{fa4f}"
        case .videoSpeakerTrackFilled: return "\u{fa50}"
        case .videoSpeakerTrackLight: return "\u{fa51}"
        case .videoSpeakerTrackRegular: return "\u{fa52}"
        case .viewAllBold: return "\u{fa53}"
        case .viewAllLight: return "\u{fa54}"
        case .viewAllRegular: return "\u{fa55}"
        case .viewListBold: return "\u{fa56}"
        case .viewListLight: return "\u{fa57}"
        case .viewListRegular: return "\u{fa58}"
        case .viewStackedBold: return "\u{fa59}"
        case .viewStackedFilled: return "\u{fa5a}"
        case .viewStackedLight: return "\u{fa5b}"
        case .viewStackedRegular: return "\u{fa5c}"
        case .viewThumbnailBold: return "\u{fa5d}"
        case .viewThumbnailFilled: return "\u{fa5e}"
        case .viewThumbnailLight: return "\u{fa5f}"
        case .viewThumbnailRegular: return "\u{fa60}"
        case .voicemailBold: return "\u{fa61}"
        case .voicemailFilled: return "\u{fa62}"
        case .voicemailLight: return "\u{fa63}"
        case .voicemailRegular: return "\u{fa64}"
        case .waffleMenuBold: return "\u{fa65}"
        case .waffleMenuLight: return "\u{fa66}"
        case .waffleMenuRegular: return "\u{fa67}"
        case .waitingroomActiveBold: return "\u{fa68}"
        case .waitingroomActiveLight: return "\u{fa69}"
        case .waitingroomActiveRegular: return "\u{fa6a}"
        case .wallpaperBold: return "\u{fa6b}"
        case .wallpaperLight: return "\u{fa6c}"
        case .wallpaperRegular: return "\u{fa6d}"
        case .warningBadgeFilled: return "\u{fa6e}"
        case .warningBold: return "\u{fa6f}"
        case .warningFilled: return "\u{fa70}"
        case .warningLight: return "\u{fa71}"
        case .warningRegular: return "\u{fa72}"
        case .webexAssistantActiveColored: return "\u{fa73}"
        case .webexAssistantInactiveColored: return "\u{fa74}"
        case .webexBoardBold: return "\u{fa75}"
        case .webexBoardLight: return "\u{fa76}"
        case .webexBoardRegular: return "\u{fa77}"
        case .webexCodecPlusBold: return "\u{fa78}"
        case .webexCodecPlusLight: return "\u{fa79}"
        case .webexCodecPlusRegular: return "\u{fa7a}"
        case .webexDeskCameraBold: return "\u{fa7b}"
        case .webexDeskCameraLight: return "\u{fa7c}"
        case .webexDeskCameraRegular: return "\u{fa7d}"
        case .webexHelixFilled: return "\u{fa7e}"
        case .webexMeetingsBold: return "\u{fa7f}"
        case .webexMeetingsFilled: return "\u{fa80}"
        case .webexMeetingsLight: return "\u{fa81}"
        case .webexMeetingsRegular: return "\u{fa82}"
        case .webexQuadCameraBold: return "\u{fa83}"
        case .webexQuadCameraLight: return "\u{fa84}"
        case .webexQuadCameraRegular: return "\u{fa85}"
        case .webexRoomKitBold: return "\u{fa86}"
        case .webexRoomKitLight: return "\u{fa87}"
        case .webexRoomKitPlusBold: return "\u{fa88}"
        case .webexRoomKitPlusLight: return "\u{fa89}"
        case .webexRoomKitPlusRegular: return "\u{fa8a}"
        case .webexRoomKitRegular: return "\u{fa8b}"
        case .webexShareBold: return "\u{fa8c}"
        case .webexShareLight: return "\u{fa8d}"
        case .webexShareRegular: return "\u{fa8e}"
        case .webexTeamsBold: return "\u{fa8f}"
        case .webexTeamsFilled: return "\u{fa90}"
        case .webexTeamsLight: return "\u{fa91}"
        case .webexTeamsNewBold: return "\u{fa92}"
        case .webexTeamsNewFilled: return "\u{fa93}"
        case .webexTeamsNewLight: return "\u{fa94}"
        case .webexTeamsNewRegular: return "\u{fa95}"
        case .webexTeamsRegular: return "\u{fa96}"
        case .webinarBold: return "\u{fa97}"
        case .webinarFilled: return "\u{fa98}"
        case .webinarLight: return "\u{fa99}"
        case .webinarRegular: return "\u{fa9a}"
        case .weeklyRecurringScheduleNodeBold: return "\u{fa9b}"
        case .weeklyRecurringScheduleNodeLight: return "\u{fa9c}"
        case .weeklyRecurringScheduleNodeRegular: return "\u{fa9d}"
        case .whiteboardBold: return "\u{fa9e}"
        case .whiteboardContentBold: return "\u{fa9f}"
        case .whiteboardContentLight: return "\u{faa0}"
        case .whiteboardContentRegular: return "\u{faa1}"
        case .whiteboardFilled: return "\u{faa2}"
        case .whiteboardLight: return "\u{faa3}"
        case .whiteboardRegular: return "\u{faa4}"
        case .widgetBold: return "\u{faa5}"
        case .widgetFilled: return "\u{faa6}"
        case .widgetLight: return "\u{faa7}"
        case .widgetRegular: return "\u{faa8}"
        case .wifiBold: return "\u{faa9}"
        case .wifiErrorBold: return "\u{faaa}"
        case .wifiErrorLight: return "\u{faab}"
        case .wifiErrorRegular: return "\u{faac}"
        case .wifiLight: return "\u{faad}"
        case .wifiRegular: return "\u{faae}"
        case .wifiSignalGoodColoredBold: return "\u{faaf}"
        case .wifiSignalGoodColoredLight: return "\u{fab0}"
        case .wifiSignalGoodColoredRegular: return "\u{fab1}"
        case .wifiSignalPoorColoredBold: return "\u{fab2}"
        case .wifiSignalPoorColoredLight: return "\u{fab3}"
        case .wifiSignalPoorColoredRegular: return "\u{fab4}"
        case .wifiSignalUnstableColoredBold: return "\u{fab5}"
        case .wifiSignalUnstableColoredLight: return "\u{fab6}"
        case .wifiSignalUnstableColoredRegular: return "\u{fab7}"
        case .windowCornerScrubBold: return "\u{fab8}"
        case .windowCornerScrubLight: return "\u{fab9}"
        case .windowCornerScrubRegular: return "\u{faba}"
        case .windowRightCornerScrubBold: return "\u{fabb}"
        case .windowRightCornerScrubLight: return "\u{fabc}"
        case .windowRightCornerScrubRegular: return "\u{fabd}"
        case .windowVerticalScrubBold: return "\u{fabe}"
        case .windowVerticalScrubLight: return "\u{fabf}"
        case .windowVerticalScrubRegular: return "\u{fac0}"
        case .workflowDeploymentsBold: return "\u{fac1}"
        case .workflowDeploymentsLight: return "\u{fac2}"
        case .workflowDeploymentsRegular: return "\u{fac3}"
        case .workphoneBold: return "\u{fac4}"
        case .workphoneLight: return "\u{fac5}"
        case .workphoneRegular: return "\u{fac6}"
        case .zoomInBold: return "\u{fac7}"
        case .zoomInLight: return "\u{fac8}"
        case .zoomInRegular: return "\u{fac9}"
        case .zoomOutBold: return "\u{faca}"
        case .zoomOutLight: return "\u{facb}"
        case .zoomOutRegular: return "\u{facc}"
        case .zoom: return "\u{facd}"
