...
import {Tab, TAB_CROSS_WIDTH, TabClickEvent} from "./Tab";
        ...
        >
          ...
          >
            ${repeat(
              ...
              tab => nanoid(10),
              tab => {
                if (tab.localName === "md-tab-advance") {
                  return html`
                    <md-tab-advance
                      ...
                      icon-style="${tab.getAttribute('icon-style')}"
                      label-style="${tab.getAttribute('label-style')}"
                      .tooltip="${tab.getAttribute('tooltip')}"
                      .label="${tab.getAttribute('label')}"
                      .icon="${tab.getAttribute('icon')}"
                      .img="${tab.getAttribute('img')}"
                      .img-size="${tab.getAttribute('img-size')}"
