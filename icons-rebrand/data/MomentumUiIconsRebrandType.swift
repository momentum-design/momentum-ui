...
@objc public enum MomentumIconsRebrandType: Int {
    ...
    public var ligature: String {
        ...
        case .helpdeskLight: return "\u{f5cd}"
        case .helpdeskRegular: return "\u{f5ce}"
        case .hideBold: return "\u{f5cf}"
        case .hideFilled: return "\u{f5d0}"
        case .hideLight: return "\u{f5d1}"
        case .hideRegular: return "\u{f5d2}"
        case .homeBold: return "\u{f5d3}"
        case .homeFilled: return "\u{f5d4}"
        case .homeLight: return "\u{f5d5}"
        case .homeRegular: return "\u{f5d6}"
        case .horizontalLineBold: return "\u{f5d7}"
        case .horizontalLineLight: return "\u{f5d8}"
        case .horizontalLineRegular: return "\u{f5d9}"
        case .hotelingBold: return "\u{f5da}"
        case .hotelingFilled: return "\u{f5db}"
        case .hotelingLight: return "\u{f5dc}"
        case .hotelingRegular: return "\u{f5dd}"
        case .humidityBold: return "\u{f5de}"
        case .humidityLight: return "\u{f5df}"
        case .humidityRegular: return "\u{f5e0}"
        case .huntGroupBold: return "\u{f5e1}"
        case .huntGroupFilled: return "\u{f5e2}"
        case .huntGroupLight: return "\u{f5e3}"
        case .huntGroupRegular: return "\u{f5e4}"
        case .importBold: return "\u{f5e5}"
        case .importLight: return "\u{f5e6}"
        case .importRegular: return "\u{f5e7}"
        case .inCommonBold: return "\u{f5e8}"
        case .inCommonLight: return "\u{f5e9}"
        case .inCommonRegular: return "\u{f5ea}"
        case .includeBold: return "\u{f5eb}"
        case .includeLight: return "\u{f5ec}"
        case .includeRegular: return "\u{f5ed}"
        case .incomingCallLegacyBold: return "\u{f5ee}"
        case .incomingCallLegacyFilled: return "\u{f5ef}"
        case .incomingCallLegacyLight: return "\u{f5f0}"
        case .incomingCallLegacyRegular: return "\u{f5f1}"
        case .infoBadgeFilled: return "\u{f5f2}"
        case .infoCircleBold: return "\u{f5f3}"
        case .infoCircleFilled: return "\u{f5f4}"
        case .infoCircleLight: return "\u{f5f5}"
        case .infoCircleRegular: return "\u{f5f6}"
        case .infoCircleTwoBold: return "\u{f5f7}"
        case .infoCircleTwoFilled: return "\u{f5f8}"
        case .infoCircleTwoLight: return "\u{f5f9}"
        case .infoCircleTwoRegular: return "\u{f5fa}"
        case .inputBold: return "\u{f5fb}"
        case .inputDisconnectedBold: return "\u{f5fc}"
        case .inputDisconnectedLight: return "\u{f5fd}"
        case .inputDisconnectedRegular: return "\u{f5fe}"
        case .inputLight: return "\u{f5ff}"
        case .inputRegular: return "\u{f600}"
        case .insightsBold: return "\u{f601}"
        case .insightsLight: return "\u{f602}"
        case .insightsRegular: return "\u{f603}"
        case .instantScheduleBold: return "\u{f604}"
        case .instantScheduleFilled: return "\u{f605}"
        case .instantScheduleLight: return "\u{f606}"
        case .instantScheduleRegular: return "\u{f607}"
        case .integrationsBold: return "\u{f608}"
        case .integrationsLight: return "\u{f609}"
        case .integrationsRegular: return "\u{f60a}"
        case .intelligentRoutingBold: return "\u{f60b}"
        case .intelligentRoutingLight: return "\u{f60c}"
        case .intelligentRoutingRegular: return "\u{f60d}"
        case .invitedUserBold: return "\u{f60e}"
        case .invitedUserLight: return "\u{f60f}"
        case .invitedUserRegular: return "\u{f610}"
        case .italicBold: return "\u{f611}"
        case .italicLight: return "\u{f612}"
        case .italicRegular: return "\u{f613}"
        case .joinAudioBold: return "\u{f614}"
        case .joinAudioFilled: return "\u{f615}"
        case .joinAudioLight: return "\u{f616}"
        case .joinAudioRegular: return "\u{f617}"
        case .keepInTouchBold: return "\u{f618}"
        case .keepInTouchFilled: return "\u{f619}"
        case .keepInTouchLight: return "\u{f61a}"
        case .keepInTouchRegular: return "\u{f61b}"
        case .keyboardBold: return "\u{f61c}"
        case .keyboardCloseBold: return "\u{f61d}"
        case .keyboardCloseLight: return "\u{f61e}"
        case .keyboardCloseRegular: return "\u{f61f}"
        case .keyboardLight: return "\u{f620}"
        case .keyboardRegular: return "\u{f621}"
        case .languageBold: return "\u{f622}"
        case .languageLight: return "\u{f623}"
        case .languageRegular: return "\u{f624}"
        case .laptopBold: return "\u{f625}"
        case .laptopDisconnectedBold: return "\u{f626}"
        case .laptopDisconnectedLight: return "\u{f627}"
        case .laptopDisconnectedRegular: return "\u{f628}"
        case .laptopFilled: return "\u{f629}"
        case .laptopLight: return "\u{f62a}"
        case .laptopRegular: return "\u{f62b}"
        case .laserPointerBold: return "\u{f62c}"
        case .laserPointerLight: return "\u{f62d}"
        case .laserPointerRegular: return "\u{f62e}"
        case .launchBold: return "\u{f62f}"
        case .launchLight: return "\u{f630}"
        case .launchRegular: return "\u{f631}"
        case .layoutSideBySideVerticalBold: return "\u{f632}"
        case .layoutSideBySideVerticalFilled: return "\u{f633}"
        case .layoutSideBySideVerticalLight: return "\u{f634}"
        case .layoutSideBySideVerticalRegular: return "\u{f635}"
        case .leaveBreakoutSessionBold: return "\u{f636}"
        case .leaveBreakoutSessionLight: return "\u{f637}"
        case .leaveBreakoutSessionRegular: return "\u{f638}"
        case .leaveDeviceBold: return "\u{f639}"
        case .leaveDeviceLight: return "\u{f63a}"
        case .leaveDeviceRegular: return "\u{f63b}"
        case .lightningBold: return "\u{f63c}"
        case .lightningFilled: return "\u{f63d}"
        case .lightningLight: return "\u{f63e}"
        case .lightningRegular: return "\u{f63f}"
        case .likeBold: return "\u{f640}"
        case .likeFilled: return "\u{f641}"
        case .likeLight: return "\u{f642}"
        case .likeRegular: return "\u{f643}"
        case .linkBold: return "\u{f644}"
        case .linkLight: return "\u{f645}"
        case .linkRegular: return "\u{f646}"
        case .listBulletedBold: return "\u{f647}"
        case .listBulletedLight: return "\u{f648}"
        case .listBulletedRegular: return "\u{f649}"
        case .listMenuBold: return "\u{f64a}"
        case .listMenuLight: return "\u{f64b}"
        case .listMenuRegular: return "\u{f64c}"
        case .listNumberedBold: return "\u{f64d}"
        case .listNumberedLight: return "\u{f64e}"
        case .listNumberedRegular: return "\u{f64f}"
        case .liveBold: return "\u{f650}"
        case .liveFilled: return "\u{f651}"
        case .liveLight: return "\u{f652}"
        case .liveRegular: return "\u{f653}"
        case .locationBold: return "\u{f654}"
        case .locationFilled: return "\u{f655}"
        case .locationLight: return "\u{f656}"
        case .locationRegular: return "\u{f657}"
        case .longTextBoxBold: return "\u{f658}"
        case .longTextBoxLight: return "\u{f659}"
        case .longTextBoxRegular: return "\u{f65a}"
        case .lowerHandBold: return "\u{f65b}"
        case .lowerHandLight: return "\u{f65c}"
        case .lowerHandRegular: return "\u{f65d}"
        case .magicPenBold: return "\u{f65e}"
        case .magicPenFilled: return "\u{f65f}"
        case .magicPenLight: return "\u{f660}"
        case .magicPenRegular: return "\u{f661}"
        case .markAsUnreadBold: return "\u{f662}"
        case .markAsUnreadLight: return "\u{f663}"
        case .markAsUnreadRegular: return "\u{f664}"
        case .markdownBold: return "\u{f665}"
        case .markdownLight: return "\u{f666}"
        case .markdownRegular: return "\u{f667}"
        case .markerBold: return "\u{f668}"
        case .markerFilled: return "\u{f669}"
        case .markerLight: return "\u{f66a}"
        case .markerRegular: return "\u{f66b}"
        case .maximizeBold: return "\u{f66c}"
        case .maximizeLight: return "\u{f66d}"
        case .maximizeRegular: return "\u{f66e}"
        case .mediaPlayerBold: return "\u{f66f}"
        case .mediaPlayerLight: return "\u{f670}"
        case .mediaPlayerRegular: return "\u{f671}"
        case .mediaQualityGoodBold: return "\u{f672}"
        case .mediaQualityGoodFilled: return "\u{f673}"
        case .mediaQualityGoodLight: return "\u{f674}"
        case .mediaQualityGoodRegular: return "\u{f675}"
        case .mediaQualityPoorBold: return "\u{f676}"
        case .mediaQualityPoorFilled: return "\u{f677}"
        case .mediaQualityPoorLight: return "\u{f678}"
        case .mediaQualityPoorRegular: return "\u{f679}"
        case .mediaQualityUnstableBold: return "\u{f67a}"
        case .mediaQualityUnstableFilled: return "\u{f67b}"
        case .mediaQualityUnstableLight: return "\u{f67c}"
        case .mediaQualityUnstableRegular: return "\u{f67d}"
        case .mediumQualityGoodFilled: return "\u{f67e}"
        case .mediumQualityPoorFilled: return "\u{f67f}"
        case .mediumQualityUnstableFilled: return "\u{f680}"
        case .meetBold: return "\u{f681}"
        case .meetEndBold: return "\u{f682}"
        case .meetEndLight: return "\u{f683}"
        case .meetEndRegular: return "\u{f684}"
        case .meetFilled: return "\u{f685}"
        case .meetLight: return "\u{f686}"
        case .meetRegular: return "\u{f687}"
        case .meetingsBold: return "\u{f688}"
        case .meetingsFilled: return "\u{f689}"
        case .meetingsFocusMonthBold: return "\u{f68a}"
        case .meetingsFocusMonthLight: return "\u{f68b}"
        case .meetingsFocusMonthRegular: return "\u{f68c}"
        case .meetingsFocusOneDayBold: return "\u{f68d}"
        case .meetingsFocusOneDayLight: return "\u{f68e}"
        case .meetingsFocusOneDayRegular: return "\u{f68f}"
        case .meetingsFocusThreeDayBold: return "\u{f690}"
        case .meetingsFocusThreeDayLight: return "\u{f691}"
        case .meetingsFocusThreeDayRegular: return "\u{f692}"
        case .meetingsFocusUpcomingBold: return "\u{f693}"
        case .meetingsFocusUpcomingLight: return "\u{f694}"
        case .meetingsFocusUpcomingRegular: return "\u{f695}"
        case .meetingsFocusWeekBold: return "\u{f696}"
        case .meetingsFocusWeekLight: return "\u{f697}"
        case .meetingsFocusWeekRegular: return "\u{f698}"
        case .meetingsLight: return "\u{f699}"
        case .meetingsPresenceBold: return "\u{f69a}"
        case .meetingsPresenceFilled: return "\u{f69b}"
        case .meetingsPresenceLight: return "\u{f69c}"
        case .meetingsPresenceRegular: return "\u{f69d}"
        case .meetingsPresenceSmallFilled: return "\u{f69e}"
        case .meetingsRegular: return "\u{f69f}"
        case .meetingsTeamActiveBold: return "\u{f6a0}"
        case .meetingsTeamActiveLight: return "\u{f6a1}"
        case .meetingsTeamActiveRegular: return "\u{f6a2}"
        case .meetingsTeamBold: return "\u{f6a3}"
        case .meetingsTeamLight: return "\u{f6a4}"
        case .meetingsTeamNewBold: return "\u{f6a5}"
        case .meetingsTeamNewLight: return "\u{f6a6}"
        case .meetingsTeamNewRegular: return "\u{f6a7}"
        case .meetingsTeamRegular: return "\u{f6a8}"
        case .mentionBold: return "\u{f6a9}"
        case .mentionLight: return "\u{f6aa}"
        case .mentionRegular: return "\u{f6ab}"
        case .messageQueingBold: return "\u{f6ac}"
        case .messageQueingLight: return "\u{f6ad}"
        case .messageQueingRegular: return "\u{f6ae}"
        case .microphoneBold: return "\u{f6af}"
        case .microphoneFilled: return "\u{f6b0}"
        case .microphoneHardMutedBold: return "\u{f6b1}"
        case .microphoneHardMutedCircleFilled: return "\u{f6b2}"
        case .microphoneHardMutedColoredBold: return "\u{f6b3}"
        case .microphoneHardMutedColoredLight: return "\u{f6b4}"
        case .microphoneHardMutedColoredRegular: return "\u{f6b5}"
        case .microphoneHardMutedLight: return "\u{f6b6}"
        case .microphoneHardMutedRegular: return "\u{f6b7}"
        case .microphoneLight: return "\u{f6b8}"
        case .microphoneMusicModeBold: return "\u{f6b9}"
        case .microphoneMusicModeColoredBold: return "\u{f6ba}"
        case .microphoneMusicModeColoredLight: return "\u{f6bb}"
        case .microphoneMusicModeColoredRegular: return "\u{f6bc}"
        case .microphoneMusicModeLight: return "\u{f6bd}"
        case .microphoneMusicModeRegular: return "\u{f6be}"
        case .microphoneMutedBold: return "\u{f6bf}"
        case .microphoneMutedFilled: return "\u{f6c0}"
        case .microphoneMutedIndicatorFilled: return "\u{f6c1}"
        case .microphoneMutedLight: return "\u{f6c2}"
        case .microphoneMutedRedBold: return "\u{f6c3}"
        case .microphoneMutedRedFilled: return "\u{f6c4}"
        case .microphoneMutedRedLight: return "\u{f6c5}"
        case .microphoneMutedRedRegular: return "\u{f6c6}"
        case .microphoneMutedRegular: return "\u{f6c7}"
        case .microphoneOptAllBold: return "\u{f6c8}"
        case .microphoneOptAllLight: return "\u{f6c9}"
        case .microphoneOptAllMutedBold: return "\u{f6ca}"
        case .microphoneOptAllMutedLight: return "\u{f6cb}"
        case .microphoneOptAllMutedRegular: return "\u{f6cc}"
        case .microphoneOptAllOnColoredBold: return "\u{f6cd}"
        case .microphoneOptAllOnColoredLight: return "\u{f6ce}"
        case .microphoneOptAllOnColoredRegular: return "\u{f6cf}"
        case .microphoneOptAllRegular: return "\u{f6d0}"
        case .microphoneOptMeBold: return "\u{f6d1}"
        case .microphoneOptMeLight: return "\u{f6d2}"
        case .microphoneOptMeMutedBold: return "\u{f6d3}"
        case .microphoneOptMeMutedLight: return "\u{f6d4}"
        case .microphoneOptMeMutedRegular: return "\u{f6d5}"
        case .microphoneOptMeOnColoredBold: return "\u{f6d6}"
        case .microphoneOptMeOnColoredLight: return "\u{f6d7}"
        case .microphoneOptMeOnColoredRegular: return "\u{f6d8}"
        case .microphoneOptMeRegular: return "\u{f6d9}"
        case .microphoneRegular: return "\u{f6da}"
        case .minimizeBold: return "\u{f6db}"
        case .minimizeLight: return "\u{f6dc}"
        case .minimizeRegular: return "\u{f6dd}"
        case .minusBold: return "\u{f6de}"
        case .minusLight: return "\u{f6df}"
        case .minusRegular: return "\u{f6e0}"
        case .mirrorBold: return "\u{f6e1}"
        case .mirrorFilled: return "\u{f6e2}"
        case .mirrorLight: return "\u{f6e3}"
        case .mirrorRegular: return "\u{f6e4}"
        case .moderatorBold: return "\u{f6e5}"
        case .moderatorLight: return "\u{f6e6}"
        case .moderatorRegular: return "\u{f6e7}"
        case .monitoringBold: return "\u{f6e8}"
        case .monitoringLight: return "\u{f6e9}"
        case .monitoringRegular: return "\u{f6ea}"
        case .monthlyRecurringScheduleNodeBold: return "\u{f6eb}"
        case .monthlyRecurringScheduleNodeLight: return "\u{f6ec}"
        case .monthlyRecurringScheduleNodeRegular: return "\u{f6ed}"
        case .moreAdrBold: return "\u{f6ee}"
        case .moreAdrLight: return "\u{f6ef}"
        case .moreAdrRegular: return "\u{f6f0}"
        case .moreBold: return "\u{f6f1}"
        case .moreCircleBold: return "\u{f6f2}"
        case .moreCircleFilled: return "\u{f6f3}"
        case .moreCircleLight: return "\u{f6f4}"
        case .moreCircleRegular: return "\u{f6f5}"
        case .moreCirecleFilled: return "\u{f6f6}"
        case .moreLight: return "\u{f6f7}"
        case .moreRegular: return "\u{f6f8}"
        case .mouseCursorBold: return "\u{f6f9}"
        case .mouseCursorLight: return "\u{f6fa}"
        case .mouseCursorRegular: return "\u{f6fb}"
        case .moveCallInAdrBold: return "\u{f6fc}"
        case .moveCallInAdrLight: return "\u{f6fd}"
        case .moveCallInAdrRegular: return "\u{f6fe}"
        case .moveCallInIphBold: return "\u{f6ff}"
        case .moveCallInIphLight: return "\u{f700}"
        case .moveCallInIphRegular: return "\u{f701}"
        case .moveCallInLaptopBold: return "\u{f702}"
        case .moveCallInLaptopLight: return "\u{f703}"
        case .moveCallInLaptopRegular: return "\u{f704}"
        case .moveCallInOutAdrBold: return "\u{f705}"
        case .moveCallInOutAdrLight: return "\u{f706}"
        case .moveCallInOutAdrRegular: return "\u{f707}"
        case .moveCallInOutIphBold: return "\u{f708}"
        case .moveCallInOutIphLight: return "\u{f709}"
        case .moveCallInOutIphRegular: return "\u{f70a}"
        case .moveCallInTabletBold: return "\u{f70b}"
        case .moveCallInTabletLight: return "\u{f70c}"
        case .moveCallInTabletRegular: return "\u{f70d}"
        case .moveCallOutAdrBold: return "\u{f70e}"
        case .moveCallOutAdrLight: return "\u{f70f}"
        case .moveCallOutAdrRegular: return "\u{f710}"
        case .moveCallOutIphBold: return "\u{f711}"
        case .moveCallOutIphLight: return "\u{f712}"
        case .moveCallOutIphRegular: return "\u{f713}"
        case .moveCallOutLaptopBold: return "\u{f714}"
        case .moveCallOutLaptopLight: return "\u{f715}"
        case .moveCallOutLaptopRegular: return "\u{f716}"
        case .moveCallOutTabletBold: return "\u{f717}"
        case .moveCallOutTabletLight: return "\u{f718}"
        case .moveCallOutTabletRegular: return "\u{f719}"
        case .msTeams: return "\u{f71a}"
        case .multilineChartBold: return "\u{f71b}"
        case .multilineChartFilled: return "\u{f71c}"
        case .multilineChartLight: return "\u{f71d}"
        case .multilineChartRegular: return "\u{f71e}"
        case .multimediaBold: return "\u{f71f}"
        case .multimediaFilled: return "\u{f720}"
        case .multimediaLight: return "\u{f721}"
        case .multimediaRegular: return "\u{f722}"
        case .multipledDevicesBold: return "\u{f723}"
        case .multipledDevicesLight: return "\u{f724}"
        case .multipledDevicesRegular: return "\u{f725}"
        case .musicModeBold: return "\u{f726}"
        case .musicModeCircleBold: return "\u{f727}"
        case .musicModeCircleFilled: return "\u{f728}"
        case .musicModeCircleLight: return "\u{f729}"
        case .musicModeCircleRegular: return "\u{f72a}"
        case .musicModeFilled: return "\u{f72b}"
        case .musicModeLight: return "\u{f72c}"
        case .musicModeRegular: return "\u{f72d}"
        case .muteOnEntryBold: return "\u{f72e}"
        case .muteOnEntryFilled: return "\u{f72f}"
        case .muteOnEntryLight: return "\u{f730}"
        case .muteOnEntryRegular: return "\u{f731}"
        case .newManagerBold: return "\u{f732}"
        case .newManagerLight: return "\u{f733}"
        case .newManagerRegular: return "\u{f734}"
        case .newTitleBold: return "\u{f735}"
        case .newTitleLight: return "\u{f736}"
        case .newTitleRegular: return "\u{f737}"
        case .newVoicemailBold: return "\u{f738}"
        case .newVoicemailLight: return "\u{f739}"
        case .newVoicemailRegular: return "\u{f73a}"
        case .newWhiteboardBold: return "\u{f73b}"
        case .newWhiteboardLight: return "\u{f73c}"
        case .newWhiteboardRegular: return "\u{f73d}"
        case .nextBold: return "\u{f73e}"
        case .nextLight: return "\u{f73f}"
        case .nextRegular: return "\u{f740}"
        case .noDevicesBold: return "\u{f741}"
        case .noDevicesLight: return "\u{f742}"
        case .noDevicesRegular: return "\u{f743}"
        case .noiseDetectedCanceledFilled: return "\u{f744}"
        case .noiseDetectedFilled: return "\u{f745}"
        case .noiseNoneCanceledFilled: return "\u{f746}"
        case .noiseNoneFilled: return "\u{f747}"
        case .noiseRemovalBold: return "\u{f748}"
        case .noiseRemovalLight: return "\u{f749}"
        case .noiseRemovalRegular: return "\u{f74a}"
        case .noteBold: return "\u{f74b}"
        case .noteLight: return "\u{f74c}"
        case .notePptBold: return "\u{f74d}"
        case .notePptLight: return "\u{f74e}"
        case .notePptRegular: return "\u{f74f}"
        case .noteRegular: return "\u{f750}"
        case .notesBold: return "\u{f751}"
        case .notesLight: return "\u{f752}"
        case .notesRegular: return "\u{f753}"
        case .numberBold: return "\u{f754}"
        case .numberLight: return "\u{f755}"
        case .numberRegular: return "\u{f756}"
        case .oldRemoteBold: return "\u{f757}"
        case .oldRemoteLight: return "\u{f758}"
        case .oldRemoteRegular: return "\u{f759}"
        case .oldTouchBold: return "\u{f75a}"
        case .oldTouchLight: return "\u{f75b}"
        case .oldTouchRegular: return "\u{f75c}"
        case .oneColumnBold: return "\u{f75d}"
        case .oneColumnLight: return "\u{f75e}"
        case .oneColumnRegular: return "\u{f75f}"
        case .openInFolderBold: return "\u{f760}"
        case .openInFolderLight: return "\u{f761}"
        case .openInFolderRegular: return "\u{f762}"
        case .openPagesBold: return "\u{f763}"
        case .openPagesLight: return "\u{f764}"
        case .openPagesRegular: return "\u{f765}"
        case .otherNumberBold: return "\u{f766}"
        case .otherNumberLight: return "\u{f767}"
        case .otherNumberRegular: return "\u{f768}"
        case .otherNumberWarningBold: return "\u{f769}"
        case .otherNumberWarningLight: return "\u{f76a}"
        case .otherNumberWarningRegular: return "\u{f76b}"
        case .outgoingCallLegacyBold: return "\u{f76c}"
        case .outgoingCallLegacyLight: return "\u{f76d}"
        case .outgoingCallLegacyRegular: return "\u{f76e}"
        case .overflowLeftBold: return "\u{f76f}"
        case .overflowLeftLight: return "\u{f770}"
        case .overflowLeftRegular: return "\u{f771}"
        case .overflowRightBold: return "\u{f772}"
        case .overflowRightLight: return "\u{f773}"
        case .overflowRightRegular: return "\u{f774}"
        case .pairedCameraBold: return "\u{f775}"
        case .pairedCameraLight: return "\u{f776}"
        case .pairedCameraRegular: return "\u{f777}"
        case .pairedDeviceBold: return "\u{f778}"
        case .pairedDeviceLight: return "\u{f779}"
        case .pairedDeviceRegular: return "\u{f77a}"
        case .pairedHandsetBold: return "\u{f77b}"
        case .pairedHandsetLight: return "\u{f77c}"
        case .pairedHandsetRegular: return "\u{f77d}"
        case .pairingBold: return "\u{f77e}"
        case .pairingLight: return "\u{f77f}"
        case .pairingRegular: return "\u{f780}"
        case .parkedBold: return "\u{f781}"
        case .parkedFilled: return "\u{f782}"
        case .parkedLight: return "\u{f783}"
        case .parkedRegular: return "\u{f784}"
        case .parseBold: return "\u{f785}"
        case .parseLight: return "\u{f786}"
        case .parseRegular: return "\u{f787}"
        case .partialBold: return "\u{f788}"
        case .partialLight: return "\u{f789}"
        case .partialRegular: return "\u{f78a}"
        case .participantAddBold: return "\u{f78b}"
        case .participantAddLight: return "\u{f78c}"
        case .participantAddRegular: return "\u{f78d}"
        case .participantBlockedBold: return "\u{f78e}"
        case .participantBlockedLight: return "\u{f78f}"
        case .participantBlockedRegular: return "\u{f790}"
        case .participantBold: return "\u{f791}"
        case .participantFilled: return "\u{f792}"
        case .participantLight: return "\u{f793}"
        case .participantListBold: return "\u{f794}"
        case .participantListFilled: return "\u{f795}"
        case .participantListLight: return "\u{f796}"
        case .participantListRegular: return "\u{f797}"
        case .participantRegular: return "\u{f798}"
        case .participantRemoveBold: return "\u{f799}"
        case .participantRemoveLight: return "\u{f79a}"
        case .participantRemoveRegular: return "\u{f79b}"
        case .participantUnknownBold: return "\u{f79c}"
        case .participantUnknownLight: return "\u{f79d}"
        case .participantUnknownRegular: return "\u{f79e}"
        case .passMouseBold: return "\u{f79f}"
        case .passMouseLight: return "\u{f7a0}"
        case .passMouseRegular: return "\u{f7a1}"
        case .pauseBold: return "\u{f7a2}"
        case .pauseFilled: return "\u{f7a3}"
        case .pauseLight: return "\u{f7a4}"
        case .pauseRegular: return "\u{f7a5}"
        case .penBold: return "\u{f7a6}"
        case .penFilled: return "\u{f7a7}"
        case .penLight: return "\u{f7a8}"
        case .penRegular: return "\u{f7a9}"
        case .peopleBold: return "\u{f7aa}"
        case .peopleCircleBold: return "\u{f7ab}"
        case .peopleCircleFilled: return "\u{f7ac}"
        case .peopleCircleLight: return "\u{f7ad}"
        case .peopleCircleRegular: return "\u{f7ae}"
        case .peopleFilled: return "\u{f7af}"
        case .peopleInsightsFilled: return "\u{f7b0}"
        case .peopleLight: return "\u{f7b1}"
        case .peopleRegular: return "\u{f7b2}"
        case .phoneAlertBold: return "\u{f7b3}"
        case .phoneAlertLight: return "\u{f7b4}"
        case .phoneAlertRegular: return "\u{f7b5}"
        case .phoneBold: return "\u{f7b6}"
        case .phoneFilled: return "\u{f7b7}"
        case .phoneLight: return "\u{f7b8}"
        case .phoneMutedBold: return "\u{f7b9}"
        case .phoneMutedLight: return "\u{f7ba}"
        case .phoneMutedRegular: return "\u{f7bb}"
        case .phonePrivateBold: return "\u{f7bc}"
        case .phonePrivateLight: return "\u{f7bd}"
        case .phonePrivateRegular: return "\u{f7be}"
        case .phoneRegular: return "\u{f7bf}"
        case .phoneReplyAllBold: return "\u{f7c0}"
        case .phoneReplyAllLight: return "\u{f7c1}"
        case .phoneReplyAllRegular: return "\u{f7c2}"
        case .phoneReplyBold: return "\u{f7c3}"
        case .phoneReplyLight: return "\u{f7c4}"
        case .phoneReplyRegular: return "\u{f7c5}"
        case .phoneSmallFilled: return "\u{f7c6}"
        case .pickerBold: return "\u{f7c7}"
        case .pickerLight: return "\u{f7c8}"
        case .pickerRegular: return "\u{f7c9}"
        case .pictureInPictureBold: return "\u{f7ca}"
        case .pictureInPictureFilled: return "\u{f7cb}"
        case .pictureInPictureLight: return "\u{f7cc}"
        case .pictureInPictureRegular: return "\u{f7cd}"
        case .pieChartBold: return "\u{f7ce}"
        case .pieChartFilled: return "\u{f7cf}"
        case .pieChartLight: return "\u{f7d0}"
        case .pieChartRegular: return "\u{f7d1}"
        case .pinBold: return "\u{f7d2}"
        case .pinFilled: return "\u{f7d3}"
        case .pinLight: return "\u{f7d4}"
        case .pinListActivityBold: return "\u{f7d5}"
        case .pinListActivityColoredBold: return "\u{f7d6}"
        case .pinListActivityColoredLight: return "\u{f7d7}"
        case .pinListActivityColoredRegular: return "\u{f7d8}"
        case .pinListActivityLight: return "\u{f7d9}"
        case .pinListActivityRegular: return "\u{f7da}"
        case .pinListBold: return "\u{f7db}"
        case .pinListLight: return "\u{f7dc}"
        case .pinListRegular: return "\u{f7dd}"
        case .pinMutedBold: return "\u{f7de}"
        case .pinMutedFilled: return "\u{f7df}"
        case .pinMutedLight: return "\u{f7e0}"
        case .pinMutedRegular: return "\u{f7e1}"
        case .pinRegular: return "\u{f7e2}"
        case .placeholderBold: return "\u{f7e3}"
        case .placeholderLight: return "\u{f7e4}"
        case .placeholderRegular: return "\u{f7e5}"
        case .playBold: return "\u{f7e6}"
        case .playCircleBold: return "\u{f7e7}"
        case .playCircleFilled: return "\u{f7e8}"
        case .playCircleLight: return "\u{f7e9}"
        case .playCircleRegular: return "\u{f7ea}"
        case .playFilled: return "\u{f7eb}"
        case .playLight: return "\u{f7ec}"
        case .playRegular: return "\u{f7ed}"
        case .plugAcBold: return "\u{f7ee}"
        case .plugAcLight: return "\u{f7ef}"
        case .plugAcRegular: return "\u{f7f0}"
        case .plusBold: return "\u{f7f1}"
        case .plusCircleBold: return "\u{f7f2}"
        case .plusCircleFilled: return "\u{f7f3}"
        case .plusCircleLight: return "\u{f7f4}"
        case .plusCircleRegular: return "\u{f7f5}"
        case .plusLight: return "\u{f7f6}"
        case .plusRegular: return "\u{f7f7}"
        case .pmrBold: return "\u{f7f8}"
        case .pmrFilled: return "\u{f7f9}"
        case .pmrLight: return "\u{f7fa}"
        case .pmrRegular: return "\u{f7fb}"
        case .pollBold: return "\u{f7fc}"
        case .pollLight: return "\u{f7fd}"
        case .pollRegular: return "\u{f7fe}"
        case .popInBold: return "\u{f7ff}"
        case .popInLight: return "\u{f800}"
        case .popInRegular: return "\u{f801}"
        case .popOutBold: return "\u{f802}"
        case .popOutLight: return "\u{f803}"
        case .popOutRegular: return "\u{f804}"
        case .popUpBold: return "\u{f805}"
        case .popUpLight: return "\u{f806}"
        case .popUpRegular: return "\u{f807}"
        case .portraitLandscapeBold: return "\u{f808}"
        case .portraitLandscapeLight: return "\u{f809}"
        case .portraitLandscapeRegular: return "\u{f80a}"
        case .powerAcBold: return "\u{f80b}"
        case .powerAcLight: return "\u{f80c}"
        case .powerAcRegular: return "\u{f80d}"
        case .powerBold: return "\u{f80e}"
        case .powerLight: return "\u{f80f}"
        case .powerRegular: return "\u{f810}"
        case .preHeaderBold: return "\u{f811}"
        case .preHeaderLight: return "\u{f812}"
        case .preHeaderRegular: return "\u{f813}"
        case .presentationBold: return "\u{f814}"
        case .presentationLight: return "\u{f815}"
        case .presentationRegular: return "\u{f816}"
        case .primaryParticipantBold: return "\u{f817}"
        case .primaryParticipantLight: return "\u{f818}"
        case .primaryParticipantRegular: return "\u{f819}"
        case .printBold: return "\u{f81a}"
        case .printLight: return "\u{f81b}"
        case .printRegular: return "\u{f81c}"
        case .priorityBadgeFilled: return "\u{f81d}"
        case .priorityCircleBold: return "\u{f81e}"
        case .priorityCircleFilled: return "\u{f81f}"
        case .priorityCircleLight: return "\u{f820}"
        case .priorityCircleRegular: return "\u{f821}"
        case .priorityCircleTwoBold: return "\u{f822}"
        case .priorityCircleTwoFilled: return "\u{f823}"
        case .priorityCircleTwoLight: return "\u{f824}"
        case .priorityCircleTwoRegular: return "\u{f825}"
        case .privacyCircleBold: return "\u{f826}"
        case .privacyCircleFilled: return "\u{f827}"
        case .privacyCircleLight: return "\u{f828}"
        case .privacyCircleRegular: return "\u{f829}"
        case .privateBold: return "\u{f82a}"
        case .privateCircleBold: return "\u{f82b}"
        case .privateCircleFilled: return "\u{f82c}"
        case .privateCircleLight: return "\u{f82d}"
        case .privateCircleRegular: return "\u{f82e}"
        case .privateLight: return "\u{f82f}"
        case .privateMeetingBold: return "\u{f830}"
        case .privateMeetingLight: return "\u{f831}"
        case .privateMeetingRegular: return "\u{f832}"
        case .privateRegular: return "\u{f833}"
        case .productDemoBold: return "\u{f834}"
        case .productDemoLight: return "\u{f835}"
        case .productDemoRegular: return "\u{f836}"
        case .proximityBold: return "\u{f837}"
        case .proximityLight: return "\u{f838}"
        case .proximityMutedBold: return "\u{f839}"
        case .proximityMutedLight: return "\u{f83a}"
        case .proximityMutedRegular: return "\u{f83b}"
        case .proximityRegular: return "\u{f83c}"
        case .proximityVideoBold: return "\u{f83d}"
        case .proximityVideoLight: return "\u{f83e}"
        case .proximityVideoRegular: return "\u{f83f}"
        case .ptoPresenceBold: return "\u{f840}"
        case .ptoPresenceFilled: return "\u{f841}"
        case .ptoPresenceLight: return "\u{f842}"
        case .ptoPresenceRegular: return "\u{f843}"
        case .pullCallBold: return "\u{f844}"
        case .pullCallLight: return "\u{f845}"
        case .pullCallRegular: return "\u{f846}"
        case .qABold: return "\u{f847}"
        case .qALight: return "\u{f848}"
        case .qARegular: return "\u{f849}"
        case .qualityBold: return "\u{f84a}"
        case .qualityLight: return "\u{f84b}"
        case .qualityRegular: return "\u{f84c}"
        case .queueContactBold: return "\u{f84d}"
        case .queueContactLight: return "\u{f84e}"
        case .queueContactRegular: return "\u{f84f}"
        case .quietBold: return "\u{f850}"
        case .quietHoursPresenceBold: return "\u{f851}"
        case .quietHoursPresenceFilled: return "\u{f852}"
        case .quietHoursPresenceLight: return "\u{f853}"
        case .quietHoursPresenceRegular: return "\u{f854}"
        case .quietLight: return "\u{f855}"
        case .quietRegular: return "\u{f856}"
        case .radioButtonGroupBold: return "\u{f857}"
        case .radioButtonGroupLight: return "\u{f858}"
        case .radioButtonGroupRegular: return "\u{f859}"
        case .raiseHandBold: return "\u{f85a}"
        case .raiseHandCircleFilled: return "\u{f85b}"
        case .raiseHandFilled: return "\u{f85c}"
        case .raiseHandLight: return "\u{f85d}"
        case .raiseHandRegular: return "\u{f85e}"
        case .ramBold: return "\u{f85f}"
        case .ramLight: return "\u{f860}"
        case .ramRegular: return "\u{f861}"
        case .reactionsBold: return "\u{f862}"
        case .reactionsFilled: return "\u{f863}"
        case .reactionsLight: return "\u{f864}"
        case .reactionsRegular: return "\u{f865}"
        case .reactivateBold: return "\u{f866}"
        case .reactivateLight: return "\u{f867}"
        case .reactivateRegular: return "\u{f868}"
        case .recentsBold: return "\u{f869}"
        case .recentsFilled: return "\u{f86a}"
        case .recentsLight: return "\u{f86b}"
        case .recentsPresenceBold: return "\u{f86c}"
        case .recentsPresenceFilled: return "\u{f86d}"
        case .recentsPresenceLight: return "\u{f86e}"
        case .recentsPresenceRegular: return "\u{f86f}"
        case .recentsPresenceSmallFilled: return "\u{f870}"
        case .recentsRegular: return "\u{f871}"
        case .recordActiveBold: return "\u{f872}"
        case .recordActiveFilled: return "\u{f873}"
        case .recordActiveLight: return "\u{f874}"
        case .recordActiveRegular: return "\u{f875}"
        case .recordBold: return "\u{f876}"
        case .recordFilled: return "\u{f877}"
        case .recordLight: return "\u{f878}"
        case .recordPausedBold: return "\u{f879}"
        case .recordPausedFilled: return "\u{f87a}"
        case .recordPausedLight: return "\u{f87b}"
        case .recordPausedRegular: return "\u{f87c}"
        case .recordRegular: return "\u{f87d}"
        case .recurringBold: return "\u{f87e}"
        case .recurringLight: return "\u{f87f}"
        case .recurringOffBold: return "\u{f880}"
        case .recurringOffLight: return "\u{f881}"
        case .recurringOffRegular: return "\u{f882}"
        case .recurringRegular: return "\u{f883}"
        case .redialBold: return "\u{f884}"
        case .redialLight: return "\u{f885}"
        case .redialRegular: return "\u{f886}"
        case .redoBold: return "\u{f887}"
        case .redoLight: return "\u{f888}"
        case .redoRegular: return "\u{f889}"
        case .refreshBold: return "\u{f88a}"
        case .refreshLight: return "\u{f88b}"
        case .refreshRegular: return "\u{f88c}"
        case .remoteCallBold: return "\u{f88d}"
        case .remoteCallFilled: return "\u{f88e}"
        case .remoteCallLight: return "\u{f88f}"
        case .remoteCallRegular: return "\u{f890}"
        case .remoteDesktopControlBold: return "\u{f891}"
        case .remoteDesktopControlFilled: return "\u{f892}"
        case .remoteDesktopControlLight: return "\u{f893}"
        case .remoteDesktopControlRegular: return "\u{f894}"
        case .removeBold: return "\u{f895}"
        case .removeFilled: return "\u{f896}"
        case .removeLight: return "\u{f897}"
        case .removeRegular: return "\u{f898}"
        case .replyBold: return "\u{f899}"
        case .replyFilled: return "\u{f89a}"
        case .replyLight: return "\u{f89b}"
        case .replyListBold: return "\u{f89c}"
        case .replyListLight: return "\u{f89d}"
        case .replyListRegular: return "\u{f89e}"
        case .replyPrivatelyBold: return "\u{f89f}"
        case .replyPrivatelyLight: return "\u{f8a0}"
        case .replyPrivatelyRegular: return "\u{f8a1}"
        case .replyRegular: return "\u{f8a2}"
        case .resetBold: return "\u{f8a3}"
        case .resetLight: return "\u{f8a4}"
        case .resetRegular: return "\u{f8a5}"
        case .responsiveMobileBold: return "\u{f8a6}"
        case .responsiveMobileLight: return "\u{f8a7}"
        case .responsiveMobileRegular: return "\u{f8a8}"
        case .restartBold: return "\u{f8a9}"
        case .restartLight: return "\u{f8aa}"
        case .restartRegular: return "\u{f8ab}"
        case .retrieveCallBold: return "\u{f8ac}"
        case .retrieveCallLight: return "\u{f8ad}"
        case .retrieveCallRegular: return "\u{f8ae}"
        case .returnBold: return "\u{f8af}"
        case .returnLight: return "\u{f8b0}"
        case .returnRegular: return "\u{f8b1}"
        case .ringtoneBold: return "\u{f8b2}"
        case .ringtoneLight: return "\u{f8b3}"
        case .ringtoneRegular: return "\u{f8b4}"
        case .roomCalendarBold: return "\u{f8b5}"
        case .roomCalendarLight: return "\u{f8b6}"
        case .roomCalendarRegular: return "\u{f8b7}"
        case .roomLightsBold: return "\u{f8b8}"
        case .roomLightsFilled: return "\u{f8b9}"
        case .roomLightsLight: return "\u{f8ba}"
        case .roomLightsRegular: return "\u{f8bb}"
        case .rotateContentBold: return "\u{f8bc}"
        case .rotateContentFilled: return "\u{f8bd}"
        case .rotateContentLight: return "\u{f8be}"
        case .rotateContentRegular: return "\u{f8bf}"
        case .ruleBasedBold: return "\u{f8c0}"
        case .ruleBasedLight: return "\u{f8c1}"
        case .ruleBasedRegular: return "\u{f8c2}"
        case .runningApplicationBold: return "\u{f8c3}"
        case .runningApplicationFilled: return "\u{f8c4}"
        case .runningApplicationLight: return "\u{f8c5}"
        case .runningApplicationRegular: return "\u{f8c6}"
        case .saveBold: return "\u{f8c7}"
        case .saveLight: return "\u{f8c8}"
        case .saveRegular: return "\u{f8c9}"
        case .saveTranscriptBold: return "\u{f8ca}"
        case .saveTranscriptFilled: return "\u{f8cb}"
        case .saveTranscriptLight: return "\u{f8cc}"
        case .saveTranscriptRegular: return "\u{f8cd}"
        case .scanBold: return "\u{f8ce}"
        case .scanLight: return "\u{f8cf}"
        case .scanRegular: return "\u{f8d0}"
        case .schedulerAvailableBold: return "\u{f8d1}"
        case .schedulerAvailableLight: return "\u{f8d2}"
        case .schedulerAvailableRegular: return "\u{f8d3}"
        case .schedulerNotWorkingHoursBold: return "\u{f8d4}"
        case .schedulerNotWorkingHoursLight: return "\u{f8d5}"
        case .schedulerNotWorkingHoursRegular: return "\u{f8d6}"
        case .schedulerUnavailableBold: return "\u{f8d7}"
        case .schedulerUnavailableLight: return "\u{f8d8}"
        case .schedulerUnavailableRegular: return "\u{f8d9}"
        case .schedulerUnknownBold: return "\u{f8da}"
        case .schedulerUnknownLight: return "\u{f8db}"
        case .schedulerUnknownRegular: return "\u{f8dc}"
        case .screenshotBold: return "\u{f8dd}"
        case .screenshotDocBold: return "\u{f8de}"
        case .screenshotDocFilled: return "\u{f8df}"
        case .screenshotDocLight: return "\u{f8e0}"
        case .screenshotDocRegular: return "\u{f8e1}"
        case .screenshotLight: return "\u{f8e2}"
        case .screenshotRegular: return "\u{f8e3}"
        case .searchBold: return "\u{f8e4}"
        case .searchFilled: return "\u{f8e5}"
        case .searchLight: return "\u{f8e6}"
        case .searchRegular: return "\u{f8e7}"
        case .secondaryArrowBold: return "\u{f8e8}"
        case .secondaryArrowLight: return "\u{f8e9}"
        case .secondaryArrowRegular: return "\u{f8ea}"
        case .secureCallLockBold: return "\u{f8eb}"
        case .secureCallLockFilled: return "\u{f8ec}"
        case .secureCallLockLight: return "\u{f8ed}"
        case .secureCallLockRegular: return "\u{f8ee}"
        case .secureCallShieldBold: return "\u{f8ef}"
        case .secureCallShieldFilled: return "\u{f8f0}"
        case .secureCallShieldLight: return "\u{f8f1}"
        case .secureCallShieldRegular: return "\u{f8f2}"
        case .secureCircleBold: return "\u{f8f3}"
        case .secureCircleFilled: return "\u{f8f4}"
        case .secureCircleLight: return "\u{f8f5}"
        case .secureCircleRegular: return "\u{f8f6}"
        case .secureLockBold: return "\u{f8f7}"
        case .secureLockFilled: return "\u{f8f8}"
        case .secureLockLight: return "\u{f8f9}"
        case .secureLockRegular: return "\u{f8fa}"
        case .segmentExcludeFilled: return "\u{f8fb}"
        case .segmentFilterFilled: return "\u{f8fc}"
        case .segmentIncludeFilled: return "\u{f8fd}"
        case .selectAllBold: return "\u{f8fe}"
        case .selectAllFilled: return "\u{f8ff}"
        case .selectAllLight: return "\u{f900}"
        case .selectAllRegular: return "\u{f901}"
        case .selectionBold: return "\u{f902}"
        case .selectionLight: return "\u{f903}"
        case .selectionRegular: return "\u{f904}"
        case .sendBold: return "\u{f905}"
        case .sendFilled: return "\u{f906}"
        case .sendLight: return "\u{f907}"
        case .sendRegular: return "\u{f908}"
        case .serverBold: return "\u{f909}"
        case .serverErrorBold: return "\u{f90a}"
        case .serverErrorLight: return "\u{f90b}"
        case .serverErrorRegular: return "\u{f90c}"
        case .serverLight: return "\u{f90d}"
        case .serverRegular: return "\u{f90e}"
        case .servicesBold: return "\u{f90f}"
        case .servicesLight: return "\u{f910}"
        case .servicesRegular: return "\u{f911}"
        case .setVariableBold: return "\u{f912}"
        case .setVariableLight: return "\u{f913}"
        case .setVariableRegular: return "\u{f914}"
        case .settingsBold: return "\u{f915}"
        case .settingsFilled: return "\u{f916}"
        case .settingsLight: return "\u{f917}"
        case .settingsRegular: return "\u{f918}"
        case .setupAssistantBold: return "\u{f919}"
        case .setupAssistantLight: return "\u{f91a}"
        case .setupAssistantRegular: return "\u{f91b}"
        case .sftpBold: return "\u{f91c}"
        case .sftpLight: return "\u{f91d}"
        case .sftpRegular: return "\u{f91e}"
        case .shapeCircleBold: return "\u{f91f}"
        case .shapeCircleFilled: return "\u{f920}"
        case .shapeCircleLight: return "\u{f921}"
        case .shapeCircleRegular: return "\u{f922}"
        case .shapeDiagonalLineBold: return "\u{f923}"
        case .shapeDiagonalLineLight: return "\u{f924}"
        case .shapeDiagonalLineRegular: return "\u{f925}"
        case .shapeDiamondBold: return "\u{f926}"
        case .shapeDiamondFilled: return "\u{f927}"
        case .shapeDiamondLight: return "\u{f928}"
        case .shapeDiamondRegular: return "\u{f929}"
        case .shapeOvalBold: return "\u{f92a}"
        case .shapeOvalLight: return "\u{f92b}"
        case .shapeOvalRegular: return "\u{f92c}"
        case .shapeSquareBold: return "\u{f92d}"
        case .shapeSquareFilled: return "\u{f92e}"
        case .shapeSquareLight: return "\u{f92f}"
        case .shapeSquareRegular: return "\u{f930}"
        case .shapeTriangleBold: return "\u{f931}"
        case .shapeTriangleFilled: return "\u{f932}"
        case .shapeTriangleLight: return "\u{f933}"
        case .shapeTriangleRegular: return "\u{f934}"
        case .shapesBold: return "\u{f935}"
        case .shapesLight: return "\u{f936}"
        case .shapesRegular: return "\u{f937}"
        case .shareCNativeAdrBold: return "\u{f938}"
        case .shareCNativeAdrFilled: return "\u{f939}"
        case .shareCNativeAdrLight: return "\u{f93a}"
        case .shareCNativeAdrRegular: return "\u{f93b}"
        case .shareCNativeIphBold: return "\u{f93c}"
        case .shareCNativeIphLight: return "\u{f93d}"
        case .shareCNativeIphRegular: return "\u{f93e}"
        case .shareScreenBold: return "\u{f93f}"
        case .shareScreenFilled: return "\u{f940}"
        case .shareScreenLight: return "\u{f941}"
        case .shareScreenRegular: return "\u{f942}"
        case .shareScreenSmallFilled: return "\u{f943}"
        case .shareSpaceBold: return "\u{f944}"
        case .shareSpaceLight: return "\u{f945}"
        case .shareSpaceRegular: return "\u{f946}"
        case .shieldBold: return "\u{f947}"
        case .shieldLight: return "\u{f948}"
        case .shieldRegular: return "\u{f949}"
        case .shoppingCartBold: return "\u{f94a}"
        case .shoppingCartFilled: return "\u{f94b}"
        case .shoppingCartLight: return "\u{f94c}"
        case .shoppingCartRegular: return "\u{f94d}"
        case .shortTextBoxBold: return "\u{f94e}"
        case .shortTextBoxLight: return "\u{f94f}"
        case .shortTextBoxRegular: return "\u{f950}"
        case .showBold: return "\u{f951}"
        case .showFilled: return "\u{f952}"
        case .showLight: return "\u{f953}"
        case .showRegular: return "\u{f954}"
        case .signInBold: return "\u{f955}"
        case .signInFilled: return "\u{f956}"
        case .signInForcedBold: return "\u{f957}"
        case .signInForcedLight: return "\u{f958}"
        case .signInForcedRegular: return "\u{f959}"
        case .signInLight: return "\u{f95a}"
        case .signInRegular: return "\u{f95b}"
        case .signLangIntBold: return "\u{f95c}"
        case .signLangIntLight: return "\u{f95d}"
        case .signLangIntRegular: return "\u{f95e}"
        case .signOutBold: return "\u{f95f}"
        case .signOutLight: return "\u{f960}"
        case .signOutRegular: return "\u{f961}"
        case .signal0Bold: return "\u{f962}"
        case .signal0Light: return "\u{f963}"
        case .signal0Regular: return "\u{f964}"
        case .signal100Bold: return "\u{f965}"
        case .signal100Light: return "\u{f966}"
        case .signal100Regular: return "\u{f967}"
        case .signal25Bold: return "\u{f968}"
        case .signal25Light: return "\u{f969}"
        case .signal25Regular: return "\u{f96a}"
        case .signal50Bold: return "\u{f96b}"
        case .signal50Light: return "\u{f96c}"
        case .signal50Regular: return "\u{f96d}"
        case .signal75Bold: return "\u{f96e}"
        case .signal75Light: return "\u{f96f}"
        case .signal75Regular: return "\u{f970}"
        case .simplePromotionBold: return "\u{f971}"
        case .simplePromotionLight: return "\u{f972}"
        case .simplePromotionRegular: return "\u{f973}"
        case .singleNumberReachBold: return "\u{f974}"
        case .singleNumberReachLight: return "\u{f975}"
        case .singleNumberReachRegular: return "\u{f976}"
        case .sipRegistrationInProgressBold: return "\u{f977}"
        case .sipRegistrationInProgressFilled: return "\u{f978}"
        case .sipRegistrationInProgressLight: return "\u{f979}"
        case .sipRegistrationInProgressRegular: return "\u{f97a}"
        case .skipBold: return "\u{f97b}"
        case .skipBwBold: return "\u{f97c}"
        case .skipBwFilled: return "\u{f97d}"
        case .skipBwLight: return "\u{f97e}"
        case .skipBwRegular: return "\u{f97f}"
        case .skipFwBold: return "\u{f980}"
        case .skipFwFilled: return "\u{f981}"
        case .skipFwLight: return "\u{f982}"
        case .skipFwRegular: return "\u{f983}"
        case .skipLight: return "\u{f984}"
        case .skipRegular: return "\u{f985}"
        case .slidoLogo: return "\u{f986}"
        case .smsInboundBold: return "\u{f987}"
        case .smsInboundLight: return "\u{f988}"
        case .smsInboundRegular: return "\u{f989}"
        case .smsMessageBold: return "\u{f98a}"
        case .smsMessageFilled: return "\u{f98b}"
        case .smsMessageLight: return "\u{f98c}"
        case .smsMessageRegular: return "\u{f98d}"
        case .socialAlexaFilled: return "\u{f98e}"
        case .socialFacebookColoredFilled: return "\u{f98f}"
        case .socialFacebookFilled: return "\u{f990}"
        case .socialFbmessengerColoredFilled: return "\u{f991}"
        case .socialFbmessengerFilled: return "\u{f992}"
        case .socialInstagramBold: return "\u{f993}"
        case .socialMicrosoftColoredFilled: return "\u{f994}"
        case .socialMicrosoftFilled: return "\u{f995}"
        case .socialMmsFilled: return "\u{f996}"
        case .socialMmsGoldFilled: return "\u{f997}"
        case .socialSmsFilled: return "\u{f998}"
        case .socialSmsMintFilled: return "\u{f999}"
        case .socialTwitterColoredFilled: return "\u{f99a}"
        case .socialTwitterFilled: return "\u{f99b}"
        case .socialViberBold: return "\u{f99c}"
        case .socialViberColoredBold: return "\u{f99d}"
        case .socialWhatsappBold: return "\u{f99e}"
        case .socialWhatsappColoredFilled: return "\u{f99f}"
        case .sortAscendingBold: return "\u{f9a0}"
        case .sortAscendingLight: return "\u{f9a1}"
        case .sortAscendingRegular: return "\u{f9a2}"
        case .sortDescendingBold: return "\u{f9a3}"
        case .sortDescendingLight: return "\u{f9a4}"
        case .sortDescendingRegular: return "\u{f9a5}"
        case .soundDefaultBold: return "\u{f9a6}"
        case .soundDefaultLight: return "\u{f9a7}"
        case .soundDefaultRegular: return "\u{f9a8}"
        case .speakerBold: return "\u{f9a9}"
        case .speakerDisconnectedBold: return "\u{f9aa}"
        case .speakerDisconnectedFilled: return "\u{f9ab}"
        case .speakerDisconnectedLight: return "\u{f9ac}"
        case .speakerDisconnectedRegular: return "\u{f9ad}"
        case .speakerFilled: return "\u{f9ae}"
        case .speakerLight: return "\u{f9af}"
        case .speakerMutedBold: return "\u{f9b0}"
        case .speakerMutedFilled: return "\u{f9b1}"
        case .speakerMutedLight: return "\u{f9b2}"
        case .speakerMutedRegular: return "\u{f9b3}"
        case .speakerOffBold: return "\u{f9b4}"
        case .speakerOffFilled: return "\u{f9b5}"
        case .speakerOffLight: return "\u{f9b6}"
        case .speakerOffRegular: return "\u{f9b7}"
        case .speakerOnColoredBold: return "\u{f9b8}"
        case .speakerOnColoredLight: return "\u{f9b9}"
        case .speakerOnColoredRegular: return "\u{f9ba}"
        case .speakerRegular: return "\u{f9bb}"
        case .speakerTurnDownBold: return "\u{f9bc}"
        case .speakerTurnDownFilled: return "\u{f9bd}"
        case .speakerTurnDownLight: return "\u{f9be}"
        case .speakerTurnDownRegular: return "\u{f9bf}"
        case .speakerTurnUpBold: return "\u{f9c0}"
        case .speakerTurnUpFilled: return "\u{f9c1}"
        case .speakerTurnUpLight: return "\u{f9c2}"
        case .speakerTurnUpRegular: return "\u{f9c3}"
        case .spellCheckerBold: return "\u{f9c4}"
        case .spellCheckerLight: return "\u{f9c5}"
        case .spellCheckerRegular: return "\u{f9c6}"
        case .spinnerBold: return "\u{f9c7}"
        case .spinnerFilledBold: return "\u{f9c8}"
        case .spinnerFilledLight: return "\u{f9c9}"
        case .spinnerFilledRegular: return "\u{f9ca}"
        case .spinnerLight: return "\u{f9cb}"
        case .spinnerPartialBold: return "\u{f9cc}"
        case .spinnerPartialLight: return "\u{f9cd}"
        case .spinnerPartialRegular: return "\u{f9ce}"
        case .spinnerRegular: return "\u{f9cf}"
        case .stackedArea100ChartBold: return "\u{f9d0}"
        case .stackedArea100ChartFilled: return "\u{f9d1}"
        case .stackedArea100ChartLight: return "\u{f9d2}"
        case .stackedArea100ChartRegular: return "\u{f9d3}"
        case .stackedAreaChartBold: return "\u{f9d4}"
        case .stackedAreaChartFilled: return "\u{f9d5}"
        case .stackedAreaChartLight: return "\u{f9d6}"
        case .stackedAreaChartRegular: return "\u{f9d7}"
        case .stackedBar100ChartBold: return "\u{f9d8}"
        case .stackedBar100ChartFilled: return "\u{f9d9}"
        case .stackedBar100ChartLight: return "\u{f9da}"
        case .stackedBar100ChartRegular: return "\u{f9db}"
        case .stackedBarChartBold: return "\u{f9dc}"
        case .stackedBarChartFilled: return "\u{f9dd}"
        case .stackedBarChartLight: return "\u{f9de}"
        case .stackedBarChartRegular: return "\u{f9df}"
        case .startChatBold: return "\u{f9e0}"
        case .startChatLight: return "\u{f9e1}"
        case .startChatRegular: return "\u{f9e2}"
        case .stethoscopeBold: return "\u{f9e3}"
        case .stethoscopeLight: return "\u{f9e4}"
        case .stethoscopeRegular: return "\u{f9e5}"
        case .stickersBold: return "\u{f9e6}"
        case .stickersLight: return "\u{f9e7}"
        case .stickersRegular: return "\u{f9e8}"
        case .stickiesBold: return "\u{f9e9}"
        case .stickiesLight: return "\u{f9ea}"
        case .stickiesRegular: return "\u{f9eb}"
        case .stopBold: return "\u{f9ec}"
        case .stopCircleBold: return "\u{f9ed}"
        case .stopCircleFilled: return "\u{f9ee}"
        case .stopCircleLight: return "\u{f9ef}"
        case .stopCircleRegular: return "\u{f9f0}"
        case .stopContentShareBold: return "\u{f9f1}"
        case .stopContentShareLight: return "\u{f9f2}"
        case .stopContentShareRegular: return "\u{f9f3}"
        case .stopFilled: return "\u{f9f4}"
        case .stopLight: return "\u{f9f5}"
        case .stopRegular: return "\u{f9f6}"
        case .storedInfoBold: return "\u{f9f7}"
        case .storedInfoFilled: return "\u{f9f8}"
        case .storedInfoLight: return "\u{f9f9}"
        case .storedInfoRegular: return "\u{f9fa}"
        case .streamingBold: return "\u{f9fb}"
        case .streamingLight: return "\u{f9fc}"
        case .streamingRegular: return "\u{f9fd}"
        case .strikethroughBold: return "\u{f9fe}"
        case .strikethroughLight: return "\u{f9ff}"
        case .strikethroughRegular: return "\u{fa00}"
        case .studioModeBold: return "\u{fa01}"
        case .studioModeLight: return "\u{fa02}"
        case .studioModeRegular: return "\u{fa03}"
        case .subscriptBold: return "\u{fa04}"
        case .subscriptLight: return "\u{fa05}"
        case .subscriptRegular: return "\u{fa06}"
        case .superscriptBold: return "\u{fa07}"
        case .superscriptLight: return "\u{fa08}"
        case .superscriptRegular: return "\u{fa09}"
        case .surveyBold: return "\u{fa0a}"
        case .surveyFilled: return "\u{fa0b}"
        case .surveyLight: return "\u{fa0c}"
        case .surveyRegular: return "\u{fa0d}"
        case .sx10Bold: return "\u{fa0e}"
        case .sx10Light: return "\u{fa0f}"
        case .sx10Regular: return "\u{fa10}"
        case .sx20Bold: return "\u{fa11}"
        case .sx20Light: return "\u{fa12}"
        case .sx20Regular: return "\u{fa13}"
        case .sx80CodecBold: return "\u{fa14}"
        case .sx80CodecLight: return "\u{fa15}"
        case .sx80CodecRegular: return "\u{fa16}"
        case .tableBold: return "\u{fa17}"
        case .tableLight: return "\u{fa18}"
        case .tableRegular: return "\u{fa19}"
        case .tabletBold: return "\u{fa1a}"
        case .tabletLight: return "\u{fa1b}"
        case .tabletRegular: return "\u{fa1c}"
        case .tabsBold: return "\u{fa1d}"
        case .tabsLight: return "\u{fa1e}"
        case .tabsRegular: return "\u{fa1f}"
        case .tagBold: return "\u{fa20}"
        case .tagLight: return "\u{fa21}"
        case .tagRegular: return "\u{fa22}"
        case .tapBold: return "\u{fa23}"
        case .tapFilled: return "\u{fa24}"
        case .tapLight: return "\u{fa25}"
        case .tapRegular: return "\u{fa26}"
        case .telepresenceAlertBold: return "\u{fa27}"
        case .telepresenceAlertLight: return "\u{fa28}"
        case .telepresenceAlertMutedBold: return "\u{fa29}"
        case .telepresenceAlertMutedLight: return "\u{fa2a}"
        case .telepresenceAlertMutedRegular: return "\u{fa2b}"
        case .telepresenceAlertRegular: return "\u{fa2c}"
        case .telepresenceBold: return "\u{fa2d}"
        case .telepresenceIx5000Bold: return "\u{fa2e}"
        case .telepresenceIx5000Light: return "\u{fa2f}"
        case .telepresenceIx5000Regular: return "\u{fa30}"
        case .telepresenceLight: return "\u{fa31}"
        case .telepresencePrivateBold: return "\u{fa32}"
        case .telepresencePrivateLight: return "\u{fa33}"
        case .telepresencePrivateRegular: return "\u{fa34}"
        case .telepresenceRegular: return "\u{fa35}"
        case .temperatureBold: return "\u{fa36}"
        case .temperatureLight: return "\u{fa37}"
        case .temperatureRegular: return "\u{fa38}"
        case .textAlignCenterBold: return "\u{fa39}"
        case .textAlignCenterFilled: return "\u{fa3a}"
        case .textAlignCenterLight: return "\u{fa3b}"
        case .textAlignCenterRegular: return "\u{fa3c}"
        case .textAlignLeftBold: return "\u{fa3d}"
        case .textAlignLeftFilled: return "\u{fa3e}"
        case .textAlignLeftLight: return "\u{fa3f}"
        case .textAlignLeftRegular: return "\u{fa40}"
        case .textAlignRightBold: return "\u{fa41}"
        case .textAlignRightFilled: return "\u{fa42}"
        case .textAlignRightLight: return "\u{fa43}"
        case .textAlignRightRegular: return "\u{fa44}"
        case .textBold: return "\u{fa45}"
        case .textCodeBlockBold: return "\u{fa46}"
        case .textCodeBlockLight: return "\u{fa47}"
        case .textCodeBlockRegular: return "\u{fa48}"
        case .textHighlightBold: return "\u{fa49}"
        case .textHighlightLight: return "\u{fa4a}"
        case .textHighlightRegular: return "\u{fa4b}"
        case .textLight: return "\u{fa4c}"
        case .textRegular: return "\u{fa4d}"
        case .threeColumnBold: return "\u{fa4e}"
        case .threeColumnLight: return "\u{fa4f}"
        case .threeColumnRegular: return "\u{fa50}"
        case .threeDObjectBold: return "\u{fa51}"
        case .threeDObjectLight: return "\u{fa52}"
        case .threeDObjectRegular: return "\u{fa53}"
        case .tooFastBold: return "\u{fa54}"
        case .tooFastLight: return "\u{fa55}"
        case .tooFastRegular: return "\u{fa56}"
        case .tooSlowBold: return "\u{fa57}"
        case .tooSlowLight: return "\u{fa58}"
        case .tooSlowRegular: return "\u{fa59}"
        case .toolsBold: return "\u{fa5a}"
        case .toolsLight: return "\u{fa5b}"
        case .toolsRegular: return "\u{fa5c}"
        case .touch10Bold: return "\u{fa5d}"
        case .touch10Light: return "\u{fa5e}"
        case .touch10Regular: return "\u{fa5f}"
        case .transcriptBold: return "\u{fa60}"
        case .transcriptFilled: return "\u{fa61}"
        case .transcriptLight: return "\u{fa62}"
        case .transcriptRegular: return "\u{fa63}"
        case .translateBold: return "\u{fa64}"
        case .translateLight: return "\u{fa65}"
        case .translateRegular: return "\u{fa66}"
        case .trimBold: return "\u{fa67}"
        case .trimLight: return "\u{fa68}"
        case .trimRegular: return "\u{fa69}"
        case .twoColumnBold: return "\u{fa6a}"
        case .twoColumnLight: return "\u{fa6b}"
        case .twoColumnRegular: return "\u{fa6c}"
        case .ucmCloudBold: return "\u{fa6d}"
        case .ucmCloudLight: return "\u{fa6e}"
        case .ucmCloudRegular: return "\u{fa6f}"
        case .underlineBold: return "\u{fa70}"
        case .underlineLight: return "\u{fa71}"
        case .underlineRegular: return "\u{fa72}"
        case .undoBold: return "\u{fa73}"
        case .undoLight: return "\u{fa74}"
        case .undoRegular: return "\u{fa75}"
        case .unlinkBold: return "\u{fa76}"
        case .unlinkLight: return "\u{fa77}"
        case .unlinkRegular: return "\u{fa78}"
        case .unreadBold: return "\u{fa79}"
        case .unreadFilled: return "\u{fa7a}"
        case .unreadLight: return "\u{fa7b}"
        case .unreadRegular: return "\u{fa7c}"
        case .unsecureUnlockedBold: return "\u{fa7d}"
        case .unsecureUnlockedFilled: return "\u{fa7e}"
        case .unsecureUnlockedLight: return "\u{fa7f}"
        case .unsecureUnlockedRegular: return "\u{fa80}"
        case .unsortedBold: return "\u{fa81}"
        case .unsortedLight: return "\u{fa82}"
        case .unsortedRegular: return "\u{fa83}"
        case .updateFileShareBold: return "\u{fa84}"
        case .updateFileShareLight: return "\u{fa85}"
        case .updateFileShareRegular: return "\u{fa86}"
        case .upgradeBold: return "\u{fa87}"
        case .upgradeFilled: return "\u{fa88}"
        case .upgradeLight: return "\u{fa89}"
        case .upgradeRegular: return "\u{fa8a}"
        case .uploadBold: return "\u{fa8b}"
        case .uploadImageBold: return "\u{fa8c}"
        case .uploadImageLight: return "\u{fa8d}"
        case .uploadImageRegular: return "\u{fa8e}"
        case .uploadLight: return "\u{fa8f}"
        case .uploadRegular: return "\u{fa90}"
        case .urgentVoicemailBold: return "\u{fa91}"
        case .urgentVoicemailFilled: return "\u{fa92}"
        case .usbBold: return "\u{fa93}"
        case .usbHeadsetBold: return "\u{fa94}"
        case .usbHeadsetLight: return "\u{fa95}"
        case .usbHeadsetMutedBold: return "\u{fa96}"
        case .usbHeadsetMutedLight: return "\u{fa97}"
        case .usbHeadsetMutedRegular: return "\u{fa98}"
        case .usbHeadsetRegular: return "\u{fa99}"
        case .usbLight: return "\u{fa9a}"
        case .usbRegular: return "\u{fa9b}"
        case .userBold: return "\u{fa9c}"
        case .userDeactivateBold: return "\u{fa9d}"
        case .userDeactivateLight: return "\u{fa9e}"
        case .userDeactivateRegular: return "\u{fa9f}"
        case .userLight: return "\u{faa0}"
        case .userRegular: return "\u{faa1}"
        case .vcsBold: return "\u{faa2}"
        case .vcsLight: return "\u{faa3}"
        case .vcsRegular: return "\u{faa4}"
        case .videoBlurBold: return "\u{faa5}"
        case .videoBlurFilled: return "\u{faa6}"
        case .videoBlurLight: return "\u{faa7}"
        case .videoBlurRegular: return "\u{faa8}"
        case .videoBold: return "\u{faa9}"
        case .videoEffectBold: return "\u{faaa}"
        case .videoEffectFilled: return "\u{faab}"
        case .videoEffectLight: return "\u{faac}"
        case .videoEffectRegular: return "\u{faad}"
        case .videoFilled: return "\u{faae}"
        case .videoLayoutBold: return "\u{faaf}"
        case .videoLayoutEqualBold: return "\u{fab0}"
        case .videoLayoutEqualDualBold: return "\u{fab1}"
        case .videoLayoutEqualDualLight: return "\u{fab2}"
        case .videoLayoutEqualDualRegular: return "\u{fab3}"
        case .videoLayoutEqualFilled: return "\u{fab4}"
        case .videoLayoutEqualLight: return "\u{fab5}"
        case .videoLayoutEqualRegular: return "\u{fab6}"
        case .videoLayoutFilled: return "\u{fab7}"
        case .videoLayoutLight: return "\u{fab8}"
        case .videoLayoutOverlayBold: return "\u{fab9}"
        case .videoLayoutOverlayLight: return "\u{faba}"
        case .videoLayoutOverlayRegular: return "\u{fabb}"
        case .videoLayoutPresenterDominantBold: return "\u{fabc}"
        case .videoLayoutPresenterDominantLight: return "\u{fabd}"
        case .videoLayoutPresenterDominantRegular: return "\u{fabe}"
        case .videoLayoutProminentBold: return "\u{fabf}"
        case .videoLayoutProminentFilled: return "\u{fac0}"
        case .videoLayoutProminentLight: return "\u{fac1}"
        case .videoLayoutProminentRegular: return "\u{fac2}"
        case .videoLayoutRegular: return "\u{fac3}"
        case .videoLayoutShareDominantBold: return "\u{fac4}"
        case .videoLayoutShareDominantLight: return "\u{fac5}"
        case .videoLayoutShareDominantRegular: return "\u{fac6}"
        case .videoLayoutSingleBold: return "\u{fac7}"
        case .videoLayoutSingleFilled: return "\u{fac8}"
        case .videoLayoutSingleLight: return "\u{fac9}"
        case .videoLayoutSingleRegular: return "\u{faca}"
        case .videoLayoutStackBold: return "\u{facb}"
        case .videoLayoutStackFilled: return "\u{facc}"
        case .videoLayoutStackLight: return "\u{facd}"
        case .videoLayoutStackRegular: return "\u{face}"
        case .videoLayoutVideoDominantBold: return "\u{facf}"
        case .videoLayoutVideoDominantFilled: return "\u{fad0}"
        case .videoLayoutVideoDominantLight: return "\u{fad1}"
        case .videoLayoutVideoDominantRegular: return "\u{fad2}"
        case .videoLight: return "\u{fad3}"
        case .videoPlusBold: return "\u{fad4}"
        case .videoPlusFilled: return "\u{fad5}"
        case .videoPlusLight: return "\u{fad6}"
        case .videoPlusRegular: return "\u{fad7}"
        case .videoRegular: return "\u{fad8}"
        case .videoSpeakerTrackBold: return "\u{fad9}"
        case .videoSpeakerTrackFilled: return "\u{fada}"
        case .videoSpeakerTrackLight: return "\u{fadb}"
        case .videoSpeakerTrackRegular: return "\u{fadc}"
        case .viewAllBold: return "\u{fadd}"
        case .viewAllLight: return "\u{fade}"
        case .viewAllRegular: return "\u{fadf}"
        case .viewListBold: return "\u{fae0}"
        case .viewListLight: return "\u{fae1}"
        case .viewListRegular: return "\u{fae2}"
        case .viewStackedBold: return "\u{fae3}"
        case .viewStackedFilled: return "\u{fae4}"
        case .viewStackedLight: return "\u{fae5}"
        case .viewStackedRegular: return "\u{fae6}"
        case .viewThumbnailBold: return "\u{fae7}"
        case .viewThumbnailFilled: return "\u{fae8}"
        case .viewThumbnailLight: return "\u{fae9}"
        case .viewThumbnailRegular: return "\u{faea}"
        case .voicemailBold: return "\u{faeb}"
        case .voicemailFilled: return "\u{faec}"
        case .voicemailLight: return "\u{faed}"
        case .voicemailRegular: return "\u{faee}"
        case .waffleMenuBold: return "\u{faef}"
        case .waffleMenuLight: return "\u{faf0}"
        case .waffleMenuRegular: return "\u{faf1}"
        case .waitingroomActiveBold: return "\u{faf2}"
        case .waitingroomActiveLight: return "\u{faf3}"
        case .waitingroomActiveRegular: return "\u{faf4}"
        case .wallpaperBold: return "\u{faf5}"
        case .wallpaperLight: return "\u{faf6}"
        case .wallpaperRegular: return "\u{faf7}"
        case .warningBadgeFilled: return "\u{faf8}"
        case .warningBold: return "\u{faf9}"
        case .warningFilled: return "\u{fafa}"
        case .warningLight: return "\u{fafb}"
        case .warningRegular: return "\u{fafc}"
        case .webexAssistantActiveColored: return "\u{fafd}"
        case .webexAssistantActive: return "\u{fafe}"
        case .webexAssistantFlat: return "\u{faff}"
        case .webexAssistantInactiveColored: return "\u{fb00}"
        case .webexAssistantInactive: return "\u{fb01}"
        case .webexAssistant: return "\u{fb02}"
        case .webexBoardBold: return "\u{fb03}"
        case .webexBoardLight: return "\u{fb04}"
        case .webexBoardRegular: return "\u{fb05}"
        case .webexCodecPlusBold: return "\u{fb06}"
        case .webexCodecPlusLight: return "\u{fb07}"
        case .webexCodecPlusRegular: return "\u{fb08}"
        case .webexDeskCameraBold: return "\u{fb09}"
        case .webexDeskCameraLight: return "\u{fb0a}"
        case .webexDeskCameraRegular: return "\u{fb0b}"
        case .webexHelixFilled: return "\u{fb0c}"
        case .webexMeetingsBold: return "\u{fb0d}"
        case .webexMeetingsFilled: return "\u{fb0e}"
        case .webexMeetingsLight: return "\u{fb0f}"
        case .webexMeetingsRegular: return "\u{fb10}"
        case .webexQuadCameraBold: return "\u{fb11}"
        case .webexQuadCameraLight: return "\u{fb12}"
        case .webexQuadCameraRegular: return "\u{fb13}"
        case .webexRoomKitBold: return "\u{fb14}"
        case .webexRoomKitLight: return "\u{fb15}"
        case .webexRoomKitPlusBold: return "\u{fb16}"
        case .webexRoomKitPlusLight: return "\u{fb17}"
        case .webexRoomKitPlusRegular: return "\u{fb18}"
        case .webexRoomKitRegular: return "\u{fb19}"
        case .webexShareBold: return "\u{fb1a}"
        case .webexShareLight: return "\u{fb1b}"
        case .webexShareRegular: return "\u{fb1c}"
        case .webexTeamsBold: return "\u{fb1d}"
        case .webexTeamsFilled: return "\u{fb1e}"
        case .webexTeamsLight: return "\u{fb1f}"
        case .webexTeamsNewBold: return "\u{fb20}"
        case .webexTeamsNewFilled: return "\u{fb21}"
        case .webexTeamsNewLight: return "\u{fb22}"
        case .webexTeamsNewRegular: return "\u{fb23}"
        case .webexTeamsRegular: return "\u{fb24}"
        case .webinarBold: return "\u{fb25}"
        case .webinarFilled: return "\u{fb26}"
        case .webinarLight: return "\u{fb27}"
        case .webinarRegular: return "\u{fb28}"
        case .weeklyRecurringScheduleNodeBold: return "\u{fb29}"
        case .weeklyRecurringScheduleNodeLight: return "\u{fb2a}"
        case .weeklyRecurringScheduleNodeRegular: return "\u{fb2b}"
        case .whatsNewBold: return "\u{fb2c}"
        case .whatsNewFilled: return "\u{fb2d}"
        case .whatsNewLight: return "\u{fb2e}"
        case .whatsNewRegular: return "\u{fb2f}"
        case .whiteboardBold: return "\u{fb30}"
        case .whiteboardContentBold: return "\u{fb31}"
        case .whiteboardContentLight: return "\u{fb32}"
        case .whiteboardContentRegular: return "\u{fb33}"
        case .whiteboardFilled: return "\u{fb34}"
        case .whiteboardLight: return "\u{fb35}"
        case .whiteboardRegular: return "\u{fb36}"
        case .widgetBold: return "\u{fb37}"
        case .widgetFilled: return "\u{fb38}"
        case .widgetLight: return "\u{fb39}"
        case .widgetRegular: return "\u{fb3a}"
        case .wifiBold: return "\u{fb3b}"
        case .wifiErrorBold: return "\u{fb3c}"
        case .wifiErrorLight: return "\u{fb3d}"
        case .wifiErrorRegular: return "\u{fb3e}"
        case .wifiLight: return "\u{fb3f}"
        case .wifiRegular: return "\u{fb40}"
        case .wifiSignalGoodColoredBold: return "\u{fb41}"
        case .wifiSignalGoodColoredLight: return "\u{fb42}"
        case .wifiSignalGoodColoredRegular: return "\u{fb43}"
        case .wifiSignalPoorColoredBold: return "\u{fb44}"
        case .wifiSignalPoorColoredLight: return "\u{fb45}"
        case .wifiSignalPoorColoredRegular: return "\u{fb46}"
        case .wifiSignalUnstableColoredBold: return "\u{fb47}"
        case .wifiSignalUnstableColoredLight: return "\u{fb48}"
        case .wifiSignalUnstableColoredRegular: return "\u{fb49}"
        case .windowCornerScrubBold: return "\u{fb4a}"
        case .windowCornerScrubLight: return "\u{fb4b}"
        case .windowCornerScrubRegular: return "\u{fb4c}"
        case .windowRightCornerScrubBold: return "\u{fb4d}"
        case .windowRightCornerScrubLight: return "\u{fb4e}"
        case .windowRightCornerScrubRegular: return "\u{fb4f}"
        case .windowVerticalScrubBold: return "\u{fb50}"
        case .windowVerticalScrubLight: return "\u{fb51}"
        case .windowVerticalScrubRegular: return "\u{fb52}"
        case .workflowDeploymentsBold: return "\u{fb53}"
        case .workflowDeploymentsFilled: return "\u{fb54}"
        case .workflowDeploymentsLight: return "\u{fb55}"
        case .workflowDeploymentsRegular: return "\u{fb56}"
        case .workphoneBold: return "\u{fb57}"
        case .workphoneLight: return "\u{fb58}"
        case .workphoneRegular: return "\u{fb59}"
        case .zoomInBold: return "\u{fb5a}"
        case .zoomInLight: return "\u{fb5b}"
        case .zoomInRegular: return "\u{fb5c}"
        case .zoomOutBold: return "\u{fb5d}"
        case .zoomOutLight: return "\u{fb5e}"
        case .zoomOutRegular: return "\u{fb5f}"
        case .zoom: return "\u{fb60}"
