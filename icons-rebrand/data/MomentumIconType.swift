...
@objc public enum MomentumIconType: Int {
    ...
    public var ligature: String {
        ...
        case .genericDeviceVideoLight: return "\u{f458}"
        case .genericDeviceVideoRegular: return "\u{f459}"
        case .gifBold: return "\u{f45a}"
        case .gifFilled: return "\u{f45b}"
        case .gifLight: return "\u{f45c}"
        case .gifRegular: return "\u{f45d}"
        case .guestIssuerBold: return "\u{f45e}"
        case .guestIssuerLight: return "\u{f45f}"
        case .guestIssuerRegular: return "\u{f460}"
        case .guideBold: return "\u{f461}"
        case .guideLight: return "\u{f462}"
        case .guideRegular: return "\u{f463}"
        case .handsetAlertBold: return "\u{f464}"
        case .handsetAlertFilled: return "\u{f465}"
        case .handsetAlertLight: return "\u{f466}"
        case .handsetAlertRegular: return "\u{f467}"
        case .handsetBold: return "\u{f468}"
        case .handsetFilled: return "\u{f469}"
        case .handsetLight: return "\u{f46a}"
        case .handsetMutedBold: return "\u{f46b}"
        case .handsetMutedFilled: return "\u{f46c}"
        case .handsetMutedLight: return "\u{f46d}"
        case .handsetMutedRegular: return "\u{f46e}"
        case .handsetRegular: return "\u{f46f}"
        case .handshakeBold: return "\u{f470}"
        case .handshakeLight: return "\u{f471}"
        case .handshakeRegular: return "\u{f472}"
        case .headingOneBold: return "\u{f473}"
        case .headingOneLight: return "\u{f474}"
        case .headingOneRegular: return "\u{f475}"
        case .headingThreeBold: return "\u{f476}"
        case .headingThreeLight: return "\u{f477}"
        case .headingThreeRegular: return "\u{f478}"
        case .headingTwoBold: return "\u{f479}"
        case .headingTwoLight: return "\u{f47a}"
        case .headingTwoRegular: return "\u{f47b}"
        case .headsetAlertBold: return "\u{f47c}"
        case .headsetAlertLight: return "\u{f47d}"
        case .headsetAlertRegular: return "\u{f47e}"
        case .headsetBold: return "\u{f47f}"
        case .headsetLight: return "\u{f480}"
        case .headsetMutedBold: return "\u{f481}"
        case .headsetMutedLight: return "\u{f482}"
        case .headsetMutedRegular: return "\u{f483}"
        case .headsetPrivateBold: return "\u{f484}"
        case .headsetPrivateLight: return "\u{f485}"
        case .headsetPrivateRegular: return "\u{f486}"
        case .headsetRegular: return "\u{f487}"
        case .helpBold: return "\u{f488}"
        case .helpCircleActiveFilled: return "\u{f489}"
        case .helpCircleBold: return "\u{f48a}"
        case .helpCircleLight: return "\u{f48b}"
        case .helpCircleRegular: return "\u{f48c}"
        case .helpLight: return "\u{f48d}"
        case .helpRegular: return "\u{f48e}"
        case .helpdeskBold: return "\u{f48f}"
        case .helpdeskLight: return "\u{f490}"
        case .helpdeskRegular: return "\u{f491}"
        case .hideBold: return "\u{f492}"
        case .hideFilled: return "\u{f493}"
        case .hideLight: return "\u{f494}"
        case .hideRegular: return "\u{f495}"
        case .homeBold: return "\u{f496}"
        case .homeFilled: return "\u{f497}"
        case .homeLight: return "\u{f498}"
        case .homeRegular: return "\u{f499}"
        case .horizontalLineBold: return "\u{f49a}"
        case .horizontalLineLight: return "\u{f49b}"
        case .horizontalLineRegular: return "\u{f49c}"
        case .humidityBold: return "\u{f49d}"
        case .humidityLight: return "\u{f49e}"
        case .humidityRegular: return "\u{f49f}"
        case .huntGroupBold: return "\u{f4a0}"
        case .huntGroupLight: return "\u{f4a1}"
        case .huntGroupRegular: return "\u{f4a2}"
        case .importBold: return "\u{f4a3}"
        case .importLight: return "\u{f4a4}"
        case .importRegular: return "\u{f4a5}"
        case .incomingCallLegacyBold: return "\u{f4a6}"
        case .incomingCallLegacyLight: return "\u{f4a7}"
        case .incomingCallLegacyRegular: return "\u{f4a8}"
        case .infoCircleBold: return "\u{f4a9}"
        case .infoCircleFilled: return "\u{f4aa}"
        case .infoCircleLight: return "\u{f4ab}"
        case .infoCircleRegular: return "\u{f4ac}"
        case .inputBold: return "\u{f4ad}"
        case .inputDisconnectedBold: return "\u{f4ae}"
        case .inputDisconnectedLight: return "\u{f4af}"
        case .inputDisconnectedRegular: return "\u{f4b0}"
        case .inputLight: return "\u{f4b1}"
        case .inputRegular: return "\u{f4b2}"
        case .integrationsBold: return "\u{f4b3}"
        case .integrationsLight: return "\u{f4b4}"
        case .integrationsRegular: return "\u{f4b5}"
        case .invitedUserBold: return "\u{f4b6}"
        case .invitedUserLight: return "\u{f4b7}"
        case .invitedUserRegular: return "\u{f4b8}"
        case .italicBold: return "\u{f4b9}"
        case .italicLight: return "\u{f4ba}"
        case .italicRegular: return "\u{f4bb}"
        case .joinAudioBold: return "\u{f4bc}"
        case .joinAudioFilled: return "\u{f4bd}"
        case .joinAudioLight: return "\u{f4be}"
        case .joinAudioRegular: return "\u{f4bf}"
        case .keyboardBold: return "\u{f4c0}"
        case .keyboardCloseBold: return "\u{f4c1}"
        case .keyboardCloseLight: return "\u{f4c2}"
        case .keyboardCloseRegular: return "\u{f4c3}"
        case .keyboardLight: return "\u{f4c4}"
        case .keyboardRegular: return "\u{f4c5}"
        case .languageBold: return "\u{f4c6}"
        case .languageLight: return "\u{f4c7}"
        case .languageRegular: return "\u{f4c8}"
        case .laptopBold: return "\u{f4c9}"
        case .laptopDisconnectedBold: return "\u{f4ca}"
        case .laptopDisconnectedLight: return "\u{f4cb}"
        case .laptopDisconnectedRegular: return "\u{f4cc}"
        case .laptopLight: return "\u{f4cd}"
        case .laptopRegular: return "\u{f4ce}"
        case .laserPointerBold: return "\u{f4cf}"
        case .laserPointerLight: return "\u{f4d0}"
        case .laserPointerRegular: return "\u{f4d1}"
        case .launchBold: return "\u{f4d2}"
        case .launchLight: return "\u{f4d3}"
        case .launchRegular: return "\u{f4d4}"
        case .layoutSideBySideVerticalBold: return "\u{f4d5}"
        case .layoutSideBySideVerticalFilled: return "\u{f4d6}"
        case .layoutSideBySideVerticalLight: return "\u{f4d7}"
        case .layoutSideBySideVerticalRegular: return "\u{f4d8}"
        case .likeBold: return "\u{f4d9}"
        case .likeFilled: return "\u{f4da}"
        case .likeLight: return "\u{f4db}"
        case .likeRegular: return "\u{f4dc}"
        case .linkBold: return "\u{f4dd}"
        case .linkLight: return "\u{f4de}"
        case .linkRegular: return "\u{f4df}"
        case .listBulletedBold: return "\u{f4e0}"
        case .listBulletedLight: return "\u{f4e1}"
        case .listBulletedRegular: return "\u{f4e2}"
        case .listMenuBold: return "\u{f4e3}"
        case .listMenuLight: return "\u{f4e4}"
        case .listMenuRegular: return "\u{f4e5}"
        case .listNumberedBold: return "\u{f4e6}"
        case .listNumberedLight: return "\u{f4e7}"
        case .listNumberedRegular: return "\u{f4e8}"
        case .locationBold: return "\u{f4e9}"
        case .locationFilled: return "\u{f4ea}"
        case .locationLight: return "\u{f4eb}"
        case .locationRegular: return "\u{f4ec}"
        case .lowerHandBold: return "\u{f4ed}"
        case .lowerHandLight: return "\u{f4ee}"
        case .lowerHandRegular: return "\u{f4ef}"
        case .markAsUnreadBold: return "\u{f4f0}"
        case .markAsUnreadLight: return "\u{f4f1}"
        case .markAsUnreadRegular: return "\u{f4f2}"
        case .markdownBold: return "\u{f4f3}"
        case .markdownLight: return "\u{f4f4}"
        case .markdownRegular: return "\u{f4f5}"
        case .markerBold: return "\u{f4f6}"
        case .markerFilled: return "\u{f4f7}"
        case .markerLight: return "\u{f4f8}"
        case .markerRegular: return "\u{f4f9}"
        case .maximizeBold: return "\u{f4fa}"
        case .maximizeLight: return "\u{f4fb}"
        case .maximizeRegular: return "\u{f4fc}"
        case .mediaPlayerBold: return "\u{f4fd}"
        case .mediaPlayerLight: return "\u{f4fe}"
        case .mediaPlayerRegular: return "\u{f4ff}"
        case .meetBold: return "\u{f500}"
        case .meetEndBold: return "\u{f501}"
        case .meetEndLight: return "\u{f502}"
        case .meetEndRegular: return "\u{f503}"
        case .meetFilled: return "\u{f504}"
        case .meetLight: return "\u{f505}"
        case .meetRegular: return "\u{f506}"
        case .meetingsBold: return "\u{f507}"
        case .meetingsFilled: return "\u{f508}"
        case .meetingsFocusMonthBold: return "\u{f509}"
        case .meetingsFocusMonthLight: return "\u{f50a}"
        case .meetingsFocusMonthRegular: return "\u{f50b}"
        case .meetingsFocusOneDayBold: return "\u{f50c}"
        case .meetingsFocusOneDayLight: return "\u{f50d}"
        case .meetingsFocusOneDayRegular: return "\u{f50e}"
        case .meetingsFocusThreeDayBold: return "\u{f50f}"
        case .meetingsFocusThreeDayLight: return "\u{f510}"
        case .meetingsFocusThreeDayRegular: return "\u{f511}"
        case .meetingsFocusUpcomingBold: return "\u{f512}"
        case .meetingsFocusUpcomingLight: return "\u{f513}"
        case .meetingsFocusUpcomingRegular: return "\u{f514}"
        case .meetingsFocusWeekBold: return "\u{f515}"
        case .meetingsFocusWeekLight: return "\u{f516}"
        case .meetingsFocusWeekRegular: return "\u{f517}"
        case .meetingsLight: return "\u{f518}"
        case .meetingsPresenceBold: return "\u{f519}"
        case .meetingsPresenceFilled: return "\u{f51a}"
        case .meetingsPresenceLight: return "\u{f51b}"
        case .meetingsPresenceRegular: return "\u{f51c}"
        case .meetingsRegular: return "\u{f51d}"
        case .meetingsTeamActiveBold: return "\u{f51e}"
        case .meetingsTeamActiveLight: return "\u{f51f}"
        case .meetingsTeamActiveRegular: return "\u{f520}"
        case .meetingsTeamBold: return "\u{f521}"
        case .meetingsTeamLight: return "\u{f522}"
        case .meetingsTeamNewBold: return "\u{f523}"
        case .meetingsTeamNewLight: return "\u{f524}"
        case .meetingsTeamNewRegular: return "\u{f525}"
        case .meetingsTeamRegular: return "\u{f526}"
        case .mentionBold: return "\u{f527}"
        case .mentionLight: return "\u{f528}"
        case .mentionRegular: return "\u{f529}"
        case .microphoneBold: return "\u{f52a}"
        case .microphoneFilled: return "\u{f52b}"
        case .microphoneHardMutedBold: return "\u{f52c}"
        case .microphoneHardMutedLight: return "\u{f52d}"
        case .microphoneHardMutedRegular: return "\u{f52e}"
        case .microphoneLight: return "\u{f52f}"
        case .microphoneMutedBold: return "\u{f530}"
        case .microphoneMutedFilled: return "\u{f531}"
        case .microphoneMutedLight: return "\u{f532}"
        case .microphoneMutedRegular: return "\u{f533}"
        case .microphoneRegular: return "\u{f534}"
        case .minimizeBold: return "\u{f535}"
        case .minimizeLight: return "\u{f536}"
        case .minimizeRegular: return "\u{f537}"
        case .minusBold: return "\u{f538}"
        case .minusLight: return "\u{f539}"
        case .minusRegular: return "\u{f53a}"
        case .mirrorBold: return "\u{f53b}"
        case .mirrorFilled: return "\u{f53c}"
        case .mirrorLight: return "\u{f53d}"
        case .mirrorRegular: return "\u{f53e}"
        case .moreAdrBold: return "\u{f53f}"
        case .moreAdrLight: return "\u{f540}"
        case .moreAdrRegular: return "\u{f541}"
        case .moreBold: return "\u{f542}"
        case .moreCircleBold: return "\u{f543}"
        case .moreCircleFilled: return "\u{f544}"
        case .moreCircleLight: return "\u{f545}"
        case .moreCircleRegular: return "\u{f546}"
        case .moreLight: return "\u{f547}"
        case .moreRegular: return "\u{f548}"
        case .mouseCursorBold: return "\u{f549}"
        case .mouseCursorLight: return "\u{f54a}"
        case .mouseCursorRegular: return "\u{f54b}"
        case .moveCallInAdrBold: return "\u{f54c}"
        case .moveCallInAdrLight: return "\u{f54d}"
        case .moveCallInAdrRegular: return "\u{f54e}"
        case .moveCallInIphBold: return "\u{f54f}"
        case .moveCallInIphLight: return "\u{f550}"
        case .moveCallInIphRegular: return "\u{f551}"
        case .moveCallInLaptopBold: return "\u{f552}"
        case .moveCallInLaptopLight: return "\u{f553}"
        case .moveCallInLaptopRegular: return "\u{f554}"
        case .moveCallInOutAdrBold: return "\u{f555}"
        case .moveCallInOutAdrLight: return "\u{f556}"
        case .moveCallInOutAdrRegular: return "\u{f557}"
        case .moveCallInOutIphBold: return "\u{f558}"
        case .moveCallInOutIphLight: return "\u{f559}"
        case .moveCallInOutIphRegular: return "\u{f55a}"
        case .moveCallInTabletBold: return "\u{f55b}"
        case .moveCallInTabletLight: return "\u{f55c}"
        case .moveCallInTabletRegular: return "\u{f55d}"
        case .moveCallOutAdrBold: return "\u{f55e}"
        case .moveCallOutAdrLight: return "\u{f55f}"
        case .moveCallOutAdrRegular: return "\u{f560}"
        case .moveCallOutIphBold: return "\u{f561}"
        case .moveCallOutIphLight: return "\u{f562}"
        case .moveCallOutIphRegular: return "\u{f563}"
        case .moveCallOutLaptopBold: return "\u{f564}"
        case .moveCallOutLaptopLight: return "\u{f565}"
        case .moveCallOutLaptopRegular: return "\u{f566}"
        case .moveCallOutTabletBold: return "\u{f567}"
        case .moveCallOutTabletLight: return "\u{f568}"
        case .moveCallOutTabletRegular: return "\u{f569}"
        case .multilineChartBold: return "\u{f56a}"
        case .multilineChartFilled: return "\u{f56b}"
        case .multilineChartLight: return "\u{f56c}"
        case .multilineChartRegular: return "\u{f56d}"
        case .multimediaBold: return "\u{f56e}"
        case .multimediaLight: return "\u{f56f}"
        case .multimediaRegular: return "\u{f570}"
        case .multipledDevicesBold: return "\u{f571}"
        case .multipledDevicesLight: return "\u{f572}"
        case .multipledDevicesRegular: return "\u{f573}"
        case .musicModeBold: return "\u{f574}"
        case .musicModeFilled: return "\u{f575}"
        case .musicModeLight: return "\u{f576}"
        case .musicModeRegular: return "\u{f577}"
        case .muteOnEntryBold: return "\u{f578}"
        case .muteOnEntryFilled: return "\u{f579}"
        case .muteOnEntryLight: return "\u{f57a}"
        case .muteOnEntryRegular: return "\u{f57b}"
        case .newVoicemailBold: return "\u{f57c}"
        case .newVoicemailLight: return "\u{f57d}"
        case .newVoicemailRegular: return "\u{f57e}"
        case .newWhiteboardBold: return "\u{f57f}"
        case .newWhiteboardLight: return "\u{f580}"
        case .newWhiteboardRegular: return "\u{f581}"
        case .nextBold: return "\u{f582}"
        case .nextLight: return "\u{f583}"
        case .nextRegular: return "\u{f584}"
        case .noDevicesBold: return "\u{f585}"
        case .noDevicesLight: return "\u{f586}"
        case .noDevicesRegular: return "\u{f587}"
        case .noteBold: return "\u{f588}"
        case .noteLight: return "\u{f589}"
        case .notePptBold: return "\u{f58a}"
        case .notePptLight: return "\u{f58b}"
        case .notePptRegular: return "\u{f58c}"
        case .noteRegular: return "\u{f58d}"
        case .notesBold: return "\u{f58e}"
        case .notesLight: return "\u{f58f}"
        case .notesRegular: return "\u{f590}"
        case .numberBold: return "\u{f591}"
        case .numberLight: return "\u{f592}"
        case .numberRegular: return "\u{f593}"
        case .oldRemoteBold: return "\u{f594}"
        case .oldRemoteLight: return "\u{f595}"
        case .oldRemoteRegular: return "\u{f596}"
        case .oldTouchBold: return "\u{f597}"
        case .oldTouchLight: return "\u{f598}"
        case .oldTouchRegular: return "\u{f599}"
        case .openInFolderBold: return "\u{f59a}"
        case .openInFolderLight: return "\u{f59b}"
        case .openInFolderRegular: return "\u{f59c}"
        case .openPagesBold: return "\u{f59d}"
        case .openPagesLight: return "\u{f59e}"
        case .openPagesRegular: return "\u{f59f}"
        case .otherNumberBold: return "\u{f5a0}"
        case .otherNumberLight: return "\u{f5a1}"
        case .otherNumberRegular: return "\u{f5a2}"
        case .otherNumberWarningBold: return "\u{f5a3}"
        case .otherNumberWarningLight: return "\u{f5a4}"
        case .otherNumberWarningRegular: return "\u{f5a5}"
        case .outgoingCallLegacyBold: return "\u{f5a6}"
        case .outgoingCallLegacyLight: return "\u{f5a7}"
        case .outgoingCallLegacyRegular: return "\u{f5a8}"
        case .overflowLeftBold: return "\u{f5a9}"
        case .overflowLeftLight: return "\u{f5aa}"
        case .overflowLeftRegular: return "\u{f5ab}"
        case .overflowRightBold: return "\u{f5ac}"
        case .overflowRightLight: return "\u{f5ad}"
        case .overflowRightRegular: return "\u{f5ae}"
        case .pairedCameraBold: return "\u{f5af}"
        case .pairedCameraLight: return "\u{f5b0}"
        case .pairedCameraRegular: return "\u{f5b1}"
        case .pairedDeviceBold: return "\u{f5b2}"
        case .pairedDeviceLight: return "\u{f5b3}"
        case .pairedDeviceRegular: return "\u{f5b4}"
        case .pairedHandsetBold: return "\u{f5b5}"
        case .pairedHandsetLight: return "\u{f5b6}"
        case .pairedHandsetRegular: return "\u{f5b7}"
        case .pairingBold: return "\u{f5b8}"
        case .pairingLight: return "\u{f5b9}"
        case .pairingRegular: return "\u{f5ba}"
        case .parkedBold: return "\u{f5bb}"
        case .parkedLight: return "\u{f5bc}"
        case .parkedRegular: return "\u{f5bd}"
        case .parseBold: return "\u{f5be}"
        case .parseLight: return "\u{f5bf}"
        case .parseRegular: return "\u{f5c0}"
        case .participantAddBold: return "\u{f5c1}"
        case .participantAddLight: return "\u{f5c2}"
        case .participantAddRegular: return "\u{f5c3}"
        case .participantBlockedBold: return "\u{f5c4}"
        case .participantBlockedLight: return "\u{f5c5}"
        case .participantBlockedRegular: return "\u{f5c6}"
        case .participantListBold: return "\u{f5c7}"
        case .participantListFilled: return "\u{f5c8}"
        case .participantListLight: return "\u{f5c9}"
        case .participantListRegular: return "\u{f5ca}"
        case .participantRemoveBold: return "\u{f5cb}"
        case .participantRemoveLight: return "\u{f5cc}"
        case .participantRemoveRegular: return "\u{f5cd}"
        case .participantUnknownBold: return "\u{f5ce}"
        case .participantUnknownLight: return "\u{f5cf}"
        case .participantUnknownRegular: return "\u{f5d0}"
        case .passMouseBold: return "\u{f5d1}"
        case .passMouseLight: return "\u{f5d2}"
        case .passMouseRegular: return "\u{f5d3}"
        case .pauseBold: return "\u{f5d4}"
        case .pauseFilled: return "\u{f5d5}"
        case .pauseLight: return "\u{f5d6}"
        case .pauseRegular: return "\u{f5d7}"
        case .penBold: return "\u{f5d8}"
        case .penFilled: return "\u{f5d9}"
        case .penLight: return "\u{f5da}"
        case .penRegular: return "\u{f5db}"
        case .peopleBold: return "\u{f5dc}"
        case .peopleCircleBold: return "\u{f5dd}"
        case .peopleCircleLight: return "\u{f5de}"
        case .peopleCircleRegular: return "\u{f5df}"
        case .peopleFilled: return "\u{f5e0}"
        case .peopleLight: return "\u{f5e1}"
        case .peopleRegular: return "\u{f5e2}"
        case .phoneAlertBold: return "\u{f5e3}"
        case .phoneAlertLight: return "\u{f5e4}"
        case .phoneAlertRegular: return "\u{f5e5}"
        case .phoneBold: return "\u{f5e6}"
        case .phoneLight: return "\u{f5e7}"
        case .phoneMutedBold: return "\u{f5e8}"
        case .phoneMutedLight: return "\u{f5e9}"
        case .phoneMutedRegular: return "\u{f5ea}"
        case .phonePrivateBold: return "\u{f5eb}"
        case .phonePrivateLight: return "\u{f5ec}"
        case .phonePrivateRegular: return "\u{f5ed}"
        case .phoneRegular: return "\u{f5ee}"
        case .phoneReplyAllBold: return "\u{f5ef}"
        case .phoneReplyAllLight: return "\u{f5f0}"
        case .phoneReplyAllRegular: return "\u{f5f1}"
        case .phoneReplyBold: return "\u{f5f2}"
        case .phoneReplyLight: return "\u{f5f3}"
        case .phoneReplyRegular: return "\u{f5f4}"
        case .pickerBold: return "\u{f5f5}"
        case .pickerLight: return "\u{f5f6}"
        case .pickerRegular: return "\u{f5f7}"
        case .pictureInPictureBold: return "\u{f5f8}"
        case .pictureInPictureLight: return "\u{f5f9}"
        case .pictureInPictureRegular: return "\u{f5fa}"
        case .pieChartBold: return "\u{f5fb}"
        case .pieChartFilled: return "\u{f5fc}"
        case .pieChartLight: return "\u{f5fd}"
        case .pieChartRegular: return "\u{f5fe}"
        case .pinBold: return "\u{f5ff}"
        case .pinFilled: return "\u{f600}"
        case .pinLight: return "\u{f601}"
        case .pinListBold: return "\u{f602}"
        case .pinListLight: return "\u{f603}"
        case .pinListRegular: return "\u{f604}"
        case .pinMutedBold: return "\u{f605}"
        case .pinMutedLight: return "\u{f606}"
        case .pinMutedRegular: return "\u{f607}"
        case .pinRegular: return "\u{f608}"
        case .placeholderBold: return "\u{f609}"
        case .placeholderLight: return "\u{f60a}"
        case .placeholderRegular: return "\u{f60b}"
        case .playBold: return "\u{f60c}"
        case .playFilled: return "\u{f60d}"
        case .playLight: return "\u{f60e}"
        case .playRegular: return "\u{f60f}"
        case .plugAcBold: return "\u{f610}"
        case .plugAcLight: return "\u{f611}"
        case .plugAcRegular: return "\u{f612}"
        case .plusBold: return "\u{f613}"
        case .plusCircleBold: return "\u{f614}"
        case .plusCircleFilled: return "\u{f615}"
        case .plusCircleLight: return "\u{f616}"
        case .plusCircleRegular: return "\u{f617}"
        case .plusLight: return "\u{f618}"
        case .plusRegular: return "\u{f619}"
        case .pmrBold: return "\u{f61a}"
        case .pmrFilled: return "\u{f61b}"
        case .pmrLight: return "\u{f61c}"
        case .pmrRegular: return "\u{f61d}"
        case .pollBold: return "\u{f61e}"
        case .pollLight: return "\u{f61f}"
        case .pollRegular: return "\u{f620}"
        case .popInBold: return "\u{f621}"
        case .popInLight: return "\u{f622}"
        case .popInRegular: return "\u{f623}"
        case .popOutBold: return "\u{f624}"
        case .popOutLight: return "\u{f625}"
        case .popOutRegular: return "\u{f626}"
        case .popUpBold: return "\u{f627}"
        case .popUpLight: return "\u{f628}"
        case .popUpRegular: return "\u{f629}"
        case .powerAcBold: return "\u{f62a}"
        case .powerAcLight: return "\u{f62b}"
        case .powerAcRegular: return "\u{f62c}"
        case .powerBold: return "\u{f62d}"
        case .powerLight: return "\u{f62e}"
        case .powerRegular: return "\u{f62f}"
        case .presentationBold: return "\u{f630}"
        case .presentationLight: return "\u{f631}"
        case .presentationRegular: return "\u{f632}"
        case .printBold: return "\u{f633}"
        case .printLight: return "\u{f634}"
        case .printRegular: return "\u{f635}"
        case .priorityCircleBold: return "\u{f636}"
        case .priorityCircleFilled: return "\u{f637}"
        case .priorityCircleLight: return "\u{f638}"
        case .priorityCircleRegular: return "\u{f639}"
        case .privacyCircleBold: return "\u{f63a}"
        case .privacyCircleFilled: return "\u{f63b}"
        case .privacyCircleLight: return "\u{f63c}"
        case .privacyCircleRegular: return "\u{f63d}"
        case .privateBold: return "\u{f63e}"
        case .privateCircleBold: return "\u{f63f}"
        case .privateCircleFilled: return "\u{f640}"
        case .privateCircleLight: return "\u{f641}"
        case .privateCircleRegular: return "\u{f642}"
        case .privateLight: return "\u{f643}"
        case .privateMeetingBold: return "\u{f644}"
        case .privateMeetingLight: return "\u{f645}"
        case .privateMeetingRegular: return "\u{f646}"
        case .privateRegular: return "\u{f647}"
        case .productDemoBold: return "\u{f648}"
        case .productDemoLight: return "\u{f649}"
        case .productDemoRegular: return "\u{f64a}"
        case .proximityBold: return "\u{f64b}"
        case .proximityLight: return "\u{f64c}"
        case .proximityMutedBold: return "\u{f64d}"
        case .proximityMutedLight: return "\u{f64e}"
        case .proximityMutedRegular: return "\u{f64f}"
        case .proximityRegular: return "\u{f650}"
        case .proximityVideoBold: return "\u{f651}"
        case .proximityVideoLight: return "\u{f652}"
        case .proximityVideoRegular: return "\u{f653}"
        case .ptoPresenceBold: return "\u{f654}"
        case .ptoPresenceFilled: return "\u{f655}"
        case .ptoPresenceLight: return "\u{f656}"
        case .ptoPresenceRegular: return "\u{f657}"
        case .pullCallBold: return "\u{f658}"
        case .pullCallLight: return "\u{f659}"
        case .pullCallRegular: return "\u{f65a}"
        case .qABold: return "\u{f65b}"
        case .qALight: return "\u{f65c}"
        case .qARegular: return "\u{f65d}"
        case .qualityBold: return "\u{f65e}"
        case .qualityLight: return "\u{f65f}"
        case .qualityRegular: return "\u{f660}"
        case .queueContactBold: return "\u{f661}"
        case .queueContactLight: return "\u{f662}"
        case .queueContactRegular: return "\u{f663}"
        case .quietBold: return "\u{f664}"
        case .quietHoursPresenceBold: return "\u{f665}"
        case .quietHoursPresenceFilled: return "\u{f666}"
        case .quietHoursPresenceLight: return "\u{f667}"
        case .quietHoursPresenceRegular: return "\u{f668}"
        case .quietLight: return "\u{f669}"
        case .quietRegular: return "\u{f66a}"
        case .raiseHandBold: return "\u{f66b}"
        case .raiseHandLight: return "\u{f66c}"
        case .raiseHandRegular: return "\u{f66d}"
        case .ramBold: return "\u{f66e}"
        case .ramLight: return "\u{f66f}"
        case .ramRegular: return "\u{f670}"
        case .reactionsBold: return "\u{f671}"
        case .reactionsFilled: return "\u{f672}"
        case .reactionsLight: return "\u{f673}"
        case .reactionsRegular: return "\u{f674}"
        case .reactivateBold: return "\u{f675}"
        case .reactivateLight: return "\u{f676}"
        case .reactivateRegular: return "\u{f677}"
        case .recentsBold: return "\u{f678}"
        case .recentsFilled: return "\u{f679}"
        case .recentsLight: return "\u{f67a}"
        case .recentsPresenceBold: return "\u{f67b}"
        case .recentsPresenceFilled: return "\u{f67c}"
        case .recentsPresenceLight: return "\u{f67d}"
        case .recentsPresenceRegular: return "\u{f67e}"
        case .recentsRegular: return "\u{f67f}"
        case .recordBold: return "\u{f680}"
        case .recordFilled: return "\u{f681}"
        case .recordLight: return "\u{f682}"
        case .recordPausedBold: return "\u{f683}"
        case .recordPausedFilled: return "\u{f684}"
        case .recordPausedLight: return "\u{f685}"
        case .recordPausedRegular: return "\u{f686}"
        case .recordRegular: return "\u{f687}"
        case .recurringBold: return "\u{f688}"
        case .recurringLight: return "\u{f689}"
        case .recurringOffBold: return "\u{f68a}"
        case .recurringOffLight: return "\u{f68b}"
        case .recurringOffRegular: return "\u{f68c}"
        case .recurringRegular: return "\u{f68d}"
        case .redialBold: return "\u{f68e}"
        case .redialLight: return "\u{f68f}"
        case .redialRegular: return "\u{f690}"
        case .redoBold: return "\u{f691}"
        case .redoLight: return "\u{f692}"
        case .redoRegular: return "\u{f693}"
        case .refreshBold: return "\u{f694}"
        case .refreshLight: return "\u{f695}"
        case .refreshRegular: return "\u{f696}"
        case .remoteDesktopControlBold: return "\u{f697}"
        case .remoteDesktopControlLight: return "\u{f698}"
        case .remoteDesktopControlRegular: return "\u{f699}"
        case .removeBold: return "\u{f69a}"
        case .removeFilled: return "\u{f69b}"
        case .removeLight: return "\u{f69c}"
        case .removeRegular: return "\u{f69d}"
        case .replyBold: return "\u{f69e}"
        case .replyFilled: return "\u{f69f}"
        case .replyLight: return "\u{f6a0}"
        case .replyListBold: return "\u{f6a1}"
        case .replyListLight: return "\u{f6a2}"
        case .replyListRegular: return "\u{f6a3}"
        case .replyRegular: return "\u{f6a4}"
        case .resetBold: return "\u{f6a5}"
        case .resetLight: return "\u{f6a6}"
        case .resetRegular: return "\u{f6a7}"
        case .responsiveMobileBold: return "\u{f6a8}"
        case .responsiveMobileLight: return "\u{f6a9}"
        case .responsiveMobileRegular: return "\u{f6aa}"
        case .restartBold: return "\u{f6ab}"
        case .restartLight: return "\u{f6ac}"
        case .restartRegular: return "\u{f6ad}"
        case .returnBold: return "\u{f6ae}"
        case .returnLight: return "\u{f6af}"
        case .returnRegular: return "\u{f6b0}"
        case .ringtoneBold: return "\u{f6b1}"
        case .ringtoneLight: return "\u{f6b2}"
        case .ringtoneRegular: return "\u{f6b3}"
        case .roomCalendarBold: return "\u{f6b4}"
        case .roomCalendarLight: return "\u{f6b5}"
        case .roomCalendarRegular: return "\u{f6b6}"
        case .roomLightsBold: return "\u{f6b7}"
        case .roomLightsLight: return "\u{f6b8}"
        case .roomLightsRegular: return "\u{f6b9}"
        case .runningApplicationBold: return "\u{f6ba}"
        case .runningApplicationFilled: return "\u{f6bb}"
        case .runningApplicationLight: return "\u{f6bc}"
        case .runningApplicationRegular: return "\u{f6bd}"
        case .saveBold: return "\u{f6be}"
        case .saveLight: return "\u{f6bf}"
        case .saveRegular: return "\u{f6c0}"
        case .scanBold: return "\u{f6c1}"
        case .scanLight: return "\u{f6c2}"
        case .scanRegular: return "\u{f6c3}"
        case .schedulerAvailableBold: return "\u{f6c4}"
        case .schedulerAvailableLight: return "\u{f6c5}"
        case .schedulerAvailableRegular: return "\u{f6c6}"
        case .schedulerNotWorkingHoursBold: return "\u{f6c7}"
        case .schedulerNotWorkingHoursLight: return "\u{f6c8}"
        case .schedulerNotWorkingHoursRegular: return "\u{f6c9}"
        case .schedulerUnavailableBold: return "\u{f6ca}"
        case .schedulerUnavailableLight: return "\u{f6cb}"
        case .schedulerUnavailableRegular: return "\u{f6cc}"
        case .schedulerUnknownBold: return "\u{f6cd}"
        case .schedulerUnknownLight: return "\u{f6ce}"
        case .schedulerUnknownRegular: return "\u{f6cf}"
        case .screenshotBold: return "\u{f6d0}"
        case .screenshotDocBold: return "\u{f6d1}"
        case .screenshotDocFilled: return "\u{f6d2}"
        case .screenshotDocLight: return "\u{f6d3}"
        case .screenshotDocRegular: return "\u{f6d4}"
        case .screenshotLight: return "\u{f6d5}"
        case .screenshotRegular: return "\u{f6d6}"
        case .searchBold: return "\u{f6d7}"
        case .searchLight: return "\u{f6d8}"
        case .searchRegular: return "\u{f6d9}"
        case .secondaryArrowBold: return "\u{f6da}"
        case .secondaryArrowLight: return "\u{f6db}"
        case .secondaryArrowRegular: return "\u{f6dc}"
        case .secureCircleBold: return "\u{f6dd}"
        case .secureCircleFilled: return "\u{f6de}"
        case .secureCircleLight: return "\u{f6df}"
        case .secureCircleRegular: return "\u{f6e0}"
        case .secureLockBold: return "\u{f6e1}"
        case .secureLockFilled: return "\u{f6e2}"
        case .secureLockLight: return "\u{f6e3}"
        case .secureLockRegular: return "\u{f6e4}"
        case .selectionBold: return "\u{f6e5}"
        case .selectionLight: return "\u{f6e6}"
        case .selectionRegular: return "\u{f6e7}"
        case .sendBold: return "\u{f6e8}"
        case .sendFilled: return "\u{f6e9}"
        case .sendLight: return "\u{f6ea}"
        case .sendRegular: return "\u{f6eb}"
        case .serverBold: return "\u{f6ec}"
        case .serverErrorBold: return "\u{f6ed}"
        case .serverErrorLight: return "\u{f6ee}"
        case .serverErrorRegular: return "\u{f6ef}"
        case .serverLight: return "\u{f6f0}"
        case .serverRegular: return "\u{f6f1}"
        case .servicesBold: return "\u{f6f2}"
        case .servicesLight: return "\u{f6f3}"
        case .servicesRegular: return "\u{f6f4}"
        case .setVariableBold: return "\u{f6f5}"
        case .setVariableLight: return "\u{f6f6}"
        case .setVariableRegular: return "\u{f6f7}"
        case .settingsBold: return "\u{f6f8}"
        case .settingsFilled: return "\u{f6f9}"
        case .settingsLight: return "\u{f6fa}"
        case .settingsRegular: return "\u{f6fb}"
        case .setupAssistantBold: return "\u{f6fc}"
        case .setupAssistantLight: return "\u{f6fd}"
        case .setupAssistantRegular: return "\u{f6fe}"
        case .shapesBold: return "\u{f6ff}"
        case .shapesLight: return "\u{f700}"
        case .shapesRegular: return "\u{f701}"
        case .shareCNativeAdrBold: return "\u{f702}"
        case .shareCNativeAdrLight: return "\u{f703}"
        case .shareCNativeAdrRegular: return "\u{f704}"
        case .shareCNativeIphBold: return "\u{f705}"
        case .shareCNativeIphLight: return "\u{f706}"
        case .shareCNativeIphRegular: return "\u{f707}"
        case .shareScreenBold: return "\u{f708}"
        case .shareScreenFilled: return "\u{f709}"
        case .shareScreenLight: return "\u{f70a}"
        case .shareScreenRegular: return "\u{f70b}"
        case .shareSpaceBold: return "\u{f70c}"
        case .shareSpaceLight: return "\u{f70d}"
        case .shareSpaceRegular: return "\u{f70e}"
        case .shieldBold: return "\u{f70f}"
        case .shieldLight: return "\u{f710}"
        case .shieldRegular: return "\u{f711}"
        case .showBold: return "\u{f712}"
        case .showFilled: return "\u{f713}"
        case .showLight: return "\u{f714}"
        case .showRegular: return "\u{f715}"
        case .signInBold: return "\u{f716}"
        case .signInForcedBold: return "\u{f717}"
        case .signInForcedLight: return "\u{f718}"
        case .signInForcedRegular: return "\u{f719}"
        case .signInLight: return "\u{f71a}"
        case .signInRegular: return "\u{f71b}"
        case .signOutBold: return "\u{f71c}"
        case .signOutLight: return "\u{f71d}"
        case .signOutRegular: return "\u{f71e}"
        case .signal0Bold: return "\u{f71f}"
        case .signal0Light: return "\u{f720}"
        case .signal0Regular: return "\u{f721}"
        case .signal100Bold: return "\u{f722}"
        case .signal100Light: return "\u{f723}"
        case .signal100Regular: return "\u{f724}"
        case .signal25Bold: return "\u{f725}"
        case .signal25Light: return "\u{f726}"
        case .signal25Regular: return "\u{f727}"
        case .signal50Bold: return "\u{f728}"
        case .signal50Light: return "\u{f729}"
        case .signal50Regular: return "\u{f72a}"
        case .signal75Bold: return "\u{f72b}"
        case .signal75Light: return "\u{f72c}"
        case .signal75Regular: return "\u{f72d}"
        case .singleNumberReachBold: return "\u{f72e}"
        case .singleNumberReachLight: return "\u{f72f}"
        case .singleNumberReachRegular: return "\u{f730}"
        case .skipBold: return "\u{f731}"
        case .skipBwBold: return "\u{f732}"
        case .skipBwFilled: return "\u{f733}"
        case .skipBwLight: return "\u{f734}"
        case .skipBwRegular: return "\u{f735}"
        case .skipFwBold: return "\u{f736}"
        case .skipFwFilled: return "\u{f737}"
        case .skipFwLight: return "\u{f738}"
        case .skipFwRegular: return "\u{f739}"
        case .skipLight: return "\u{f73a}"
        case .skipRegular: return "\u{f73b}"
        case .speakerBold: return "\u{f73c}"
        case .speakerDisconnectedBold: return "\u{f73d}"
        case .speakerDisconnectedFilled: return "\u{f73e}"
        case .speakerDisconnectedLight: return "\u{f73f}"
        case .speakerDisconnectedRegular: return "\u{f740}"
        case .speakerFilled: return "\u{f741}"
        case .speakerLight: return "\u{f742}"
        case .speakerMutedBold: return "\u{f743}"
        case .speakerMutedFilled: return "\u{f744}"
        case .speakerMutedLight: return "\u{f745}"
        case .speakerMutedRegular: return "\u{f746}"
        case .speakerOffBold: return "\u{f747}"
        case .speakerOffFilled: return "\u{f748}"
        case .speakerOffLight: return "\u{f749}"
        case .speakerOffRegular: return "\u{f74a}"
        case .speakerRegular: return "\u{f74b}"
        case .speakerTurnDownBold: return "\u{f74c}"
        case .speakerTurnDownFilled: return "\u{f74d}"
        case .speakerTurnDownLight: return "\u{f74e}"
        case .speakerTurnDownRegular: return "\u{f74f}"
        case .speakerTurnUpBold: return "\u{f750}"
        case .speakerTurnUpFilled: return "\u{f751}"
        case .speakerTurnUpLight: return "\u{f752}"
        case .speakerTurnUpRegular: return "\u{f753}"
        case .spinnerBold: return "\u{f754}"
        case .spinnerFilledBold: return "\u{f755}"
        case .spinnerFilledLight: return "\u{f756}"
        case .spinnerFilledRegular: return "\u{f757}"
        case .spinnerLight: return "\u{f758}"
        case .spinnerRegular: return "\u{f759}"
        case .stackedArea100ChartBold: return "\u{f75a}"
        case .stackedArea100ChartFilled: return "\u{f75b}"
        case .stackedArea100ChartLight: return "\u{f75c}"
        case .stackedArea100ChartRegular: return "\u{f75d}"
        case .stackedAreaChartBold: return "\u{f75e}"
        case .stackedAreaChartFilled: return "\u{f75f}"
        case .stackedAreaChartLight: return "\u{f760}"
        case .stackedAreaChartRegular: return "\u{f761}"
        case .stackedBar100ChartBold: return "\u{f762}"
        case .stackedBar100ChartFilled: return "\u{f763}"
        case .stackedBar100ChartLight: return "\u{f764}"
        case .stackedBar100ChartRegular: return "\u{f765}"
        case .stackedBarChartBold: return "\u{f766}"
        case .stackedBarChartFilled: return "\u{f767}"
        case .stackedBarChartLight: return "\u{f768}"
        case .stackedBarChartRegular: return "\u{f769}"
        case .startChatBold: return "\u{f76a}"
        case .startChatLight: return "\u{f76b}"
        case .startChatRegular: return "\u{f76c}"
        case .stickersBold: return "\u{f76d}"
        case .stickersLight: return "\u{f76e}"
        case .stickersRegular: return "\u{f76f}"
        case .stickiesBold: return "\u{f770}"
        case .stickiesLight: return "\u{f771}"
        case .stickiesRegular: return "\u{f772}"
        case .stopBold: return "\u{f773}"
        case .stopCircleBold: return "\u{f774}"
        case .stopCircleFilled: return "\u{f775}"
        case .stopCircleLight: return "\u{f776}"
        case .stopCircleRegular: return "\u{f777}"
        case .stopContentShareBold: return "\u{f778}"
        case .stopContentShareLight: return "\u{f779}"
        case .stopContentShareRegular: return "\u{f77a}"
        case .stopFilled: return "\u{f77b}"
        case .stopLight: return "\u{f77c}"
        case .stopRegular: return "\u{f77d}"
        case .storedInfoBold: return "\u{f77e}"
        case .storedInfoFilled: return "\u{f77f}"
        case .storedInfoLight: return "\u{f780}"
        case .storedInfoRegular: return "\u{f781}"
        case .streamingBold: return "\u{f782}"
        case .streamingLight: return "\u{f783}"
        case .streamingRegular: return "\u{f784}"
        case .strikethroughBold: return "\u{f785}"
        case .strikethroughLight: return "\u{f786}"
        case .strikethroughRegular: return "\u{f787}"
        case .subscriptBold: return "\u{f788}"
        case .subscriptLight: return "\u{f789}"
        case .subscriptRegular: return "\u{f78a}"
        case .superscriptBold: return "\u{f78b}"
        case .superscriptLight: return "\u{f78c}"
        case .superscriptRegular: return "\u{f78d}"
        case .sx10Bold: return "\u{f78e}"
        case .sx10Light: return "\u{f78f}"
        case .sx10Regular: return "\u{f790}"
        case .sx20Bold: return "\u{f791}"
        case .sx20Light: return "\u{f792}"
        case .sx20Regular: return "\u{f793}"
        case .sx80CodecBold: return "\u{f794}"
        case .sx80CodecLight: return "\u{f795}"
        case .sx80CodecRegular: return "\u{f796}"
        case .tableBold: return "\u{f797}"
        case .tableLight: return "\u{f798}"
        case .tableRegular: return "\u{f799}"
        case .tabletBold: return "\u{f79a}"
        case .tabletLight: return "\u{f79b}"
        case .tabletRegular: return "\u{f79c}"
        case .tabsBold: return "\u{f79d}"
        case .tabsLight: return "\u{f79e}"
        case .tabsRegular: return "\u{f79f}"
        case .tagBold: return "\u{f7a0}"
        case .tagLight: return "\u{f7a1}"
        case .tagRegular: return "\u{f7a2}"
        case .telepresenceAlertBold: return "\u{f7a3}"
        case .telepresenceAlertLight: return "\u{f7a4}"
        case .telepresenceAlertMutedBold: return "\u{f7a5}"
        case .telepresenceAlertMutedLight: return "\u{f7a6}"
        case .telepresenceAlertMutedRegular: return "\u{f7a7}"
        case .telepresenceAlertRegular: return "\u{f7a8}"
        case .telepresenceBold: return "\u{f7a9}"
        case .telepresenceIx5000Bold: return "\u{f7aa}"
        case .telepresenceIx5000Light: return "\u{f7ab}"
        case .telepresenceIx5000Regular: return "\u{f7ac}"
        case .telepresenceLight: return "\u{f7ad}"
        case .telepresencePrivateBold: return "\u{f7ae}"
        case .telepresencePrivateLight: return "\u{f7af}"
        case .telepresencePrivateRegular: return "\u{f7b0}"
        case .telepresenceRegular: return "\u{f7b1}"
        case .temperatureBold: return "\u{f7b2}"
        case .temperatureLight: return "\u{f7b3}"
        case .temperatureRegular: return "\u{f7b4}"
        case .textBold: return "\u{f7b5}"
        case .textCodeBlockBold: return "\u{f7b6}"
        case .textCodeBlockLight: return "\u{f7b7}"
        case .textCodeBlockRegular: return "\u{f7b8}"
        case .textHighlightBold: return "\u{f7b9}"
        case .textHighlightLight: return "\u{f7ba}"
        case .textHighlightRegular: return "\u{f7bb}"
        case .textLight: return "\u{f7bc}"
        case .textRegular: return "\u{f7bd}"
        case .threeDObjectBold: return "\u{f7be}"
        case .threeDObjectLight: return "\u{f7bf}"
        case .threeDObjectRegular: return "\u{f7c0}"
        case .tooFastBold: return "\u{f7c1}"
        case .tooFastLight: return "\u{f7c2}"
        case .tooFastRegular: return "\u{f7c3}"
        case .tooSlowBold: return "\u{f7c4}"
        case .tooSlowLight: return "\u{f7c5}"
        case .tooSlowRegular: return "\u{f7c6}"
        case .toolsBold: return "\u{f7c7}"
        case .toolsLight: return "\u{f7c8}"
        case .toolsRegular: return "\u{f7c9}"
        case .touch10Bold: return "\u{f7ca}"
        case .touch10Light: return "\u{f7cb}"
        case .touch10Regular: return "\u{f7cc}"
        case .transcriptBold: return "\u{f7cd}"
        case .transcriptLight: return "\u{f7ce}"
        case .transcriptRegular: return "\u{f7cf}"
        case .ucmCloudBold: return "\u{f7d0}"
        case .ucmCloudLight: return "\u{f7d1}"
        case .ucmCloudRegular: return "\u{f7d2}"
        case .underlineBold: return "\u{f7d3}"
        case .underlineLight: return "\u{f7d4}"
        case .underlineRegular: return "\u{f7d5}"
        case .undoBold: return "\u{f7d6}"
        case .undoLight: return "\u{f7d7}"
        case .undoRegular: return "\u{f7d8}"
        case .unlinkBold: return "\u{f7d9}"
        case .unlinkLight: return "\u{f7da}"
        case .unlinkRegular: return "\u{f7db}"
        case .unreadBold: return "\u{f7dc}"
        case .unreadFilled: return "\u{f7dd}"
        case .unreadLight: return "\u{f7de}"
        case .unreadRegular: return "\u{f7df}"
        case .unsecureUnlockedBold: return "\u{f7e0}"
        case .unsecureUnlockedFilled: return "\u{f7e1}"
        case .unsecureUnlockedLight: return "\u{f7e2}"
        case .unsecureUnlockedRegular: return "\u{f7e3}"
        case .unsortedBold: return "\u{f7e4}"
        case .unsortedLight: return "\u{f7e5}"
        case .unsortedRegular: return "\u{f7e6}"
        case .updateFileShareBold: return "\u{f7e7}"
        case .updateFileShareLight: return "\u{f7e8}"
        case .updateFileShareRegular: return "\u{f7e9}"
        case .uploadBold: return "\u{f7ea}"
        case .uploadLight: return "\u{f7eb}"
        case .uploadRegular: return "\u{f7ec}"
        case .usbBold: return "\u{f7ed}"
        case .usbHeadsetBold: return "\u{f7ee}"
        case .usbHeadsetLight: return "\u{f7ef}"
        case .usbHeadsetMutedBold: return "\u{f7f0}"
        case .usbHeadsetMutedLight: return "\u{f7f1}"
        case .usbHeadsetMutedRegular: return "\u{f7f2}"
        case .usbHeadsetRegular: return "\u{f7f3}"
        case .usbLight: return "\u{f7f4}"
        case .usbRegular: return "\u{f7f5}"
        case .userBold: return "\u{f7f6}"
        case .userLight: return "\u{f7f7}"
        case .userRegular: return "\u{f7f8}"
        case .vcsBold: return "\u{f7f9}"
        case .vcsLight: return "\u{f7fa}"
        case .vcsRegular: return "\u{f7fb}"
        case .videoBlurBold: return "\u{f7fc}"
        case .videoBlurFilled: return "\u{f7fd}"
        case .videoBlurLight: return "\u{f7fe}"
        case .videoBlurRegular: return "\u{f7ff}"
        case .videoBold: return "\u{f800}"
        case .videoEffectBold: return "\u{f801}"
        case .videoEffectFilled: return "\u{f802}"
        case .videoEffectLight: return "\u{f803}"
        case .videoEffectRegular: return "\u{f804}"
        case .videoFilled: return "\u{f805}"
        case .videoLayoutBold: return "\u{f806}"
        case .videoLayoutEqualBold: return "\u{f807}"
        case .videoLayoutEqualFilled: return "\u{f808}"
        case .videoLayoutEqualLight: return "\u{f809}"
        case .videoLayoutEqualRegular: return "\u{f80a}"
        case .videoLayoutLight: return "\u{f80b}"
        case .videoLayoutOverlayBold: return "\u{f80c}"
        case .videoLayoutOverlayLight: return "\u{f80d}"
        case .videoLayoutOverlayRegular: return "\u{f80e}"
        case .videoLayoutProminentBold: return "\u{f80f}"
        case .videoLayoutProminentLight: return "\u{f810}"
        case .videoLayoutProminentRegular: return "\u{f811}"
        case .videoLayoutRegular: return "\u{f812}"
        case .videoLayoutShareDominantBold: return "\u{f813}"
        case .videoLayoutShareDominantLight: return "\u{f814}"
        case .videoLayoutShareDominantRegular: return "\u{f815}"
        case .videoLayoutSingleBold: return "\u{f816}"
        case .videoLayoutSingleLight: return "\u{f817}"
        case .videoLayoutSingleRegular: return "\u{f818}"
        case .videoLayoutStackBold: return "\u{f819}"
        case .videoLayoutStackFilled: return "\u{f81a}"
        case .videoLayoutStackLight: return "\u{f81b}"
        case .videoLayoutStackRegular: return "\u{f81c}"
        case .videoLayoutVideoDominantBold: return "\u{f81d}"
        case .videoLayoutVideoDominantLight: return "\u{f81e}"
        case .videoLayoutVideoDominantRegular: return "\u{f81f}"
        case .videoLight: return "\u{f820}"
        case .videoRegular: return "\u{f821}"
        case .videoSpeakerTrackBold: return "\u{f822}"
        case .videoSpeakerTrackFilled: return "\u{f823}"
        case .videoSpeakerTrackLight: return "\u{f824}"
        case .videoSpeakerTrackRegular: return "\u{f825}"
        case .viewAllBold: return "\u{f826}"
        case .viewAllLight: return "\u{f827}"
        case .viewAllRegular: return "\u{f828}"
        case .viewListBold: return "\u{f829}"
        case .viewListLight: return "\u{f82a}"
        case .viewListRegular: return "\u{f82b}"
        case .viewStackedBold: return "\u{f82c}"
        case .viewStackedLight: return "\u{f82d}"
        case .viewStackedRegular: return "\u{f82e}"
        case .viewThumbnailBold: return "\u{f82f}"
        case .viewThumbnailLight: return "\u{f830}"
        case .viewThumbnailRegular: return "\u{f831}"
        case .voicemailBold: return "\u{f832}"
        case .voicemailFilled: return "\u{f833}"
        case .voicemailLight: return "\u{f834}"
        case .voicemailRegular: return "\u{f835}"
        case .wallpaperBold: return "\u{f836}"
        case .wallpaperLight: return "\u{f837}"
        case .wallpaperRegular: return "\u{f838}"
        case .warningBold: return "\u{f839}"
        case .warningFilled: return "\u{f83a}"
        case .warningLight: return "\u{f83b}"
        case .warningRegular: return "\u{f83c}"
        case .webexBoardBold: return "\u{f83d}"
        case .webexBoardLight: return "\u{f83e}"
        case .webexBoardRegular: return "\u{f83f}"
        case .webexCodecPlusBold: return "\u{f840}"
        case .webexCodecPlusLight: return "\u{f841}"
        case .webexCodecPlusRegular: return "\u{f842}"
        case .webexDeskCameraBold: return "\u{f843}"
        case .webexDeskCameraLight: return "\u{f844}"
        case .webexDeskCameraRegular: return "\u{f845}"
        case .webexMeetingsBold: return "\u{f846}"
        case .webexMeetingsFilled: return "\u{f847}"
        case .webexMeetingsLight: return "\u{f848}"
        case .webexMeetingsRegular: return "\u{f849}"
        case .webexQuadCameraBold: return "\u{f84a}"
        case .webexQuadCameraLight: return "\u{f84b}"
        case .webexQuadCameraRegular: return "\u{f84c}"
        case .webexRoomKitBold: return "\u{f84d}"
        case .webexRoomKitLight: return "\u{f84e}"
        case .webexRoomKitPlusBold: return "\u{f84f}"
        case .webexRoomKitPlusLight: return "\u{f850}"
        case .webexRoomKitPlusRegular: return "\u{f851}"
        case .webexRoomKitRegular: return "\u{f852}"
        case .webexShareBold: return "\u{f853}"
        case .webexShareLight: return "\u{f854}"
        case .webexShareRegular: return "\u{f855}"
        case .webexTeamsBold: return "\u{f856}"
        case .webexTeamsFilled: return "\u{f857}"
        case .webexTeamsLight: return "\u{f858}"
        case .webexTeamsNewBold: return "\u{f859}"
        case .webexTeamsNewFilled: return "\u{f85a}"
        case .webexTeamsNewLight: return "\u{f85b}"
        case .webexTeamsNewRegular: return "\u{f85c}"
        case .webexTeamsRegular: return "\u{f85d}"
        case .whiteboardBold: return "\u{f85e}"
        case .whiteboardContentBold: return "\u{f85f}"
        case .whiteboardContentLight: return "\u{f860}"
        case .whiteboardContentRegular: return "\u{f861}"
        case .whiteboardFilled: return "\u{f862}"
        case .whiteboardLight: return "\u{f863}"
        case .whiteboardRegular: return "\u{f864}"
        case .wifiBold: return "\u{f865}"
        case .wifiErrorBold: return "\u{f866}"
        case .wifiErrorLight: return "\u{f867}"
        case .wifiErrorRegular: return "\u{f868}"
        case .wifiLight: return "\u{f869}"
        case .wifiRegular: return "\u{f86a}"
        case .windowCornerScrubBold: return "\u{f86b}"
        case .windowCornerScrubLight: return "\u{f86c}"
        case .windowCornerScrubRegular: return "\u{f86d}"
        case .windowVerticalScrubBold: return "\u{f86e}"
        case .windowVerticalScrubLight: return "\u{f86f}"
        case .windowVerticalScrubRegular: return "\u{f870}"
        case .workphoneBold: return "\u{f871}"
        case .workphoneLight: return "\u{f872}"
        case .workphoneRegular: return "\u{f873}"
        case .zoomInBold: return "\u{f874}"
        case .zoomInLight: return "\u{f875}"
        case .zoomInRegular: return "\u{f876}"
        case .zoomOutBold: return "\u{f877}"
        case .zoomOutLight: return "\u{f878}"
        case .zoomOutRegular: return "\u{f879}"
