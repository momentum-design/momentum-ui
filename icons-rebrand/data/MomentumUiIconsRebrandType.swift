...
@objc public enum MomentumIconsRebrandType: Int {
    ...
    public var ligature: String {
        ...
        case .surveyBold: return "\u{f96f}"
        case .surveyFilled: return "\u{f970}"
        case .surveyLight: return "\u{f971}"
        case .surveyRegular: return "\u{f972}"
        case .sx10Bold: return "\u{f973}"
        case .sx10Light: return "\u{f974}"
        case .sx10Regular: return "\u{f975}"
        case .sx20Bold: return "\u{f976}"
        case .sx20Light: return "\u{f977}"
        case .sx20Regular: return "\u{f978}"
        case .sx80CodecBold: return "\u{f979}"
        case .sx80CodecLight: return "\u{f97a}"
        case .sx80CodecRegular: return "\u{f97b}"
        case .tableBold: return "\u{f97c}"
        case .tableLight: return "\u{f97d}"
        case .tableRegular: return "\u{f97e}"
        case .tabletBold: return "\u{f97f}"
        case .tabletLight: return "\u{f980}"
        case .tabletRegular: return "\u{f981}"
        case .tabsBold: return "\u{f982}"
        case .tabsLight: return "\u{f983}"
        case .tabsRegular: return "\u{f984}"
        case .tagBold: return "\u{f985}"
        case .tagLight: return "\u{f986}"
        case .tagRegular: return "\u{f987}"
        case .tapBold: return "\u{f988}"
        case .tapFilled: return "\u{f989}"
        case .tapLight: return "\u{f98a}"
        case .tapRegular: return "\u{f98b}"
        case .telepresenceAlertBold: return "\u{f98c}"
        case .telepresenceAlertLight: return "\u{f98d}"
        case .telepresenceAlertMutedBold: return "\u{f98e}"
        case .telepresenceAlertMutedLight: return "\u{f98f}"
        case .telepresenceAlertMutedRegular: return "\u{f990}"
        case .telepresenceAlertRegular: return "\u{f991}"
        case .telepresenceBold: return "\u{f992}"
        case .telepresenceIx5000Bold: return "\u{f993}"
        case .telepresenceIx5000Light: return "\u{f994}"
        case .telepresenceIx5000Regular: return "\u{f995}"
        case .telepresenceLight: return "\u{f996}"
        case .telepresencePrivateBold: return "\u{f997}"
        case .telepresencePrivateLight: return "\u{f998}"
        case .telepresencePrivateRegular: return "\u{f999}"
        case .telepresenceRegular: return "\u{f99a}"
        case .temperatureBold: return "\u{f99b}"
        case .temperatureLight: return "\u{f99c}"
        case .temperatureRegular: return "\u{f99d}"
        case .textAlignCenterBold: return "\u{f99e}"
        case .textAlignCenterFilled: return "\u{f99f}"
        case .textAlignCenterLight: return "\u{f9a0}"
        case .textAlignCenterRegular: return "\u{f9a1}"
        case .textAlignLeftBold: return "\u{f9a2}"
        case .textAlignLeftFilled: return "\u{f9a3}"
        case .textAlignLeftLight: return "\u{f9a4}"
        case .textAlignLeftRegular: return "\u{f9a5}"
        case .textAlignRightBold: return "\u{f9a6}"
        case .textAlignRightFilled: return "\u{f9a7}"
        case .textAlignRightLight: return "\u{f9a8}"
        case .textAlignRightRegular: return "\u{f9a9}"
        case .textBold: return "\u{f9aa}"
        case .textCodeBlockBold: return "\u{f9ab}"
        case .textCodeBlockLight: return "\u{f9ac}"
        case .textCodeBlockRegular: return "\u{f9ad}"
        case .textHighlightBold: return "\u{f9ae}"
        case .textHighlightLight: return "\u{f9af}"
        case .textHighlightRegular: return "\u{f9b0}"
        case .textLight: return "\u{f9b1}"
        case .textRegular: return "\u{f9b2}"
        case .threeColumnBold: return "\u{f9b3}"
        case .threeColumnLight: return "\u{f9b4}"
        case .threeColumnRegular: return "\u{f9b5}"
        case .threeDObjectBold: return "\u{f9b6}"
        case .threeDObjectLight: return "\u{f9b7}"
        case .threeDObjectRegular: return "\u{f9b8}"
        case .tooFastBold: return "\u{f9b9}"
        case .tooFastLight: return "\u{f9ba}"
        case .tooFastRegular: return "\u{f9bb}"
        case .tooSlowBold: return "\u{f9bc}"
        case .tooSlowLight: return "\u{f9bd}"
        case .tooSlowRegular: return "\u{f9be}"
        case .toolsBold: return "\u{f9bf}"
        case .toolsLight: return "\u{f9c0}"
        case .toolsRegular: return "\u{f9c1}"
        case .touch10Bold: return "\u{f9c2}"
        case .touch10Light: return "\u{f9c3}"
        case .touch10Regular: return "\u{f9c4}"
        case .transcriptBold: return "\u{f9c5}"
        case .transcriptFilled: return "\u{f9c6}"
        case .transcriptLight: return "\u{f9c7}"
        case .transcriptRegular: return "\u{f9c8}"
        case .translateBold: return "\u{f9c9}"
        case .translateLight: return "\u{f9ca}"
        case .translateRegular: return "\u{f9cb}"
        case .trimBold: return "\u{f9cc}"
        case .trimLight: return "\u{f9cd}"
        case .trimRegular: return "\u{f9ce}"
        case .twoColumnBold: return "\u{f9cf}"
        case .twoColumnLight: return "\u{f9d0}"
        case .twoColumnRegular: return "\u{f9d1}"
        case .ucmCloudBold: return "\u{f9d2}"
        case .ucmCloudLight: return "\u{f9d3}"
        case .ucmCloudRegular: return "\u{f9d4}"
        case .underlineBold: return "\u{f9d5}"
        case .underlineLight: return "\u{f9d6}"
        case .underlineRegular: return "\u{f9d7}"
        case .undoBold: return "\u{f9d8}"
        case .undoLight: return "\u{f9d9}"
        case .undoRegular: return "\u{f9da}"
        case .unlinkBold: return "\u{f9db}"
        case .unlinkLight: return "\u{f9dc}"
        case .unlinkRegular: return "\u{f9dd}"
        case .unreadBold: return "\u{f9de}"
        case .unreadFilled: return "\u{f9df}"
        case .unreadLight: return "\u{f9e0}"
        case .unreadRegular: return "\u{f9e1}"
        case .unsecureUnlockedBold: return "\u{f9e2}"
        case .unsecureUnlockedFilled: return "\u{f9e3}"
        case .unsecureUnlockedLight: return "\u{f9e4}"
        case .unsecureUnlockedRegular: return "\u{f9e5}"
        case .unsortedBold: return "\u{f9e6}"
        case .unsortedLight: return "\u{f9e7}"
        case .unsortedRegular: return "\u{f9e8}"
        case .updateFileShareBold: return "\u{f9e9}"
        case .updateFileShareLight: return "\u{f9ea}"
        case .updateFileShareRegular: return "\u{f9eb}"
        case .upgradeBold: return "\u{f9ec}"
        case .upgradeFilled: return "\u{f9ed}"
        case .upgradeLight: return "\u{f9ee}"
        case .upgradeRegular: return "\u{f9ef}"
        case .uploadBold: return "\u{f9f0}"
        case .uploadLight: return "\u{f9f1}"
        case .uploadRegular: return "\u{f9f2}"
        case .urgentVoicemailBold: return "\u{f9f3}"
        case .urgentVoicemailFilled: return "\u{f9f4}"
        case .usbBold: return "\u{f9f5}"
        case .usbHeadsetBold: return "\u{f9f6}"
        case .usbHeadsetLight: return "\u{f9f7}"
        case .usbHeadsetMutedBold: return "\u{f9f8}"
        case .usbHeadsetMutedLight: return "\u{f9f9}"
        case .usbHeadsetMutedRegular: return "\u{f9fa}"
        case .usbHeadsetRegular: return "\u{f9fb}"
        case .usbLight: return "\u{f9fc}"
        case .usbRegular: return "\u{f9fd}"
        case .userBold: return "\u{f9fe}"
        case .userDeactivateBold: return "\u{f9ff}"
        case .userDeactivateLight: return "\u{fa00}"
        case .userDeactivateRegular: return "\u{fa01}"
        case .userLight: return "\u{fa02}"
        case .userRegular: return "\u{fa03}"
        case .vcsBold: return "\u{fa04}"
        case .vcsLight: return "\u{fa05}"
        case .vcsRegular: return "\u{fa06}"
        case .videoBlurBold: return "\u{fa07}"
        case .videoBlurFilled: return "\u{fa08}"
        case .videoBlurLight: return "\u{fa09}"
        case .videoBlurRegular: return "\u{fa0a}"
        case .videoBold: return "\u{fa0b}"
        case .videoEffectBold: return "\u{fa0c}"
        case .videoEffectFilled: return "\u{fa0d}"
        case .videoEffectLight: return "\u{fa0e}"
        case .videoEffectRegular: return "\u{fa0f}"
        case .videoFilled: return "\u{fa10}"
        case .videoLayoutBold: return "\u{fa11}"
        case .videoLayoutEqualBold: return "\u{fa12}"
        case .videoLayoutEqualDualBold: return "\u{fa13}"
        case .videoLayoutEqualDualLight: return "\u{fa14}"
        case .videoLayoutEqualDualRegular: return "\u{fa15}"
        case .videoLayoutEqualFilled: return "\u{fa16}"
        case .videoLayoutEqualLight: return "\u{fa17}"
        case .videoLayoutEqualRegular: return "\u{fa18}"
        case .videoLayoutFilled: return "\u{fa19}"
        case .videoLayoutLight: return "\u{fa1a}"
        case .videoLayoutOverlayBold: return "\u{fa1b}"
        case .videoLayoutOverlayLight: return "\u{fa1c}"
        case .videoLayoutOverlayRegular: return "\u{fa1d}"
        case .videoLayoutPresenterDominantBold: return "\u{fa1e}"
        case .videoLayoutPresenterDominantLight: return "\u{fa1f}"
        case .videoLayoutPresenterDominantRegular: return "\u{fa20}"
        case .videoLayoutProminentBold: return "\u{fa21}"
        case .videoLayoutProminentFilled: return "\u{fa22}"
        case .videoLayoutProminentLight: return "\u{fa23}"
        case .videoLayoutProminentRegular: return "\u{fa24}"
        case .videoLayoutRegular: return "\u{fa25}"
        case .videoLayoutShareDominantBold: return "\u{fa26}"
        case .videoLayoutShareDominantLight: return "\u{fa27}"
        case .videoLayoutShareDominantRegular: return "\u{fa28}"
        case .videoLayoutSingleBold: return "\u{fa29}"
        case .videoLayoutSingleFilled: return "\u{fa2a}"
        case .videoLayoutSingleLight: return "\u{fa2b}"
        case .videoLayoutSingleRegular: return "\u{fa2c}"
        case .videoLayoutStackBold: return "\u{fa2d}"
        case .videoLayoutStackFilled: return "\u{fa2e}"
        case .videoLayoutStackLight: return "\u{fa2f}"
        case .videoLayoutStackRegular: return "\u{fa30}"
        case .videoLayoutVideoDominantBold: return "\u{fa31}"
        case .videoLayoutVideoDominantLight: return "\u{fa32}"
        case .videoLayoutVideoDominantRegular: return "\u{fa33}"
        case .videoLight: return "\u{fa34}"
        case .videoPlusBold: return "\u{fa35}"
        case .videoPlusFilled: return "\u{fa36}"
        case .videoPlusLight: return "\u{fa37}"
        case .videoPlusRegular: return "\u{fa38}"
        case .videoRegular: return "\u{fa39}"
        case .videoSpeakerTrackBold: return "\u{fa3a}"
        case .videoSpeakerTrackFilled: return "\u{fa3b}"
        case .videoSpeakerTrackLight: return "\u{fa3c}"
        case .videoSpeakerTrackRegular: return "\u{fa3d}"
        case .viewAllBold: return "\u{fa3e}"
        case .viewAllLight: return "\u{fa3f}"
        case .viewAllRegular: return "\u{fa40}"
        case .viewListBold: return "\u{fa41}"
        case .viewListLight: return "\u{fa42}"
        case .viewListRegular: return "\u{fa43}"
        case .viewStackedBold: return "\u{fa44}"
        case .viewStackedFilled: return "\u{fa45}"
        case .viewStackedLight: return "\u{fa46}"
        case .viewStackedRegular: return "\u{fa47}"
        case .viewThumbnailBold: return "\u{fa48}"
        case .viewThumbnailFilled: return "\u{fa49}"
        case .viewThumbnailLight: return "\u{fa4a}"
        case .viewThumbnailRegular: return "\u{fa4b}"
        case .voicemailBold: return "\u{fa4c}"
        case .voicemailFilled: return "\u{fa4d}"
        case .voicemailLight: return "\u{fa4e}"
        case .voicemailRegular: return "\u{fa4f}"
        case .waffleMenuBold: return "\u{fa50}"
        case .waffleMenuLight: return "\u{fa51}"
        case .waffleMenuRegular: return "\u{fa52}"
        case .waitingroomActiveBold: return "\u{fa53}"
        case .waitingroomActiveLight: return "\u{fa54}"
        case .waitingroomActiveRegular: return "\u{fa55}"
        case .wallpaperBold: return "\u{fa56}"
        case .wallpaperLight: return "\u{fa57}"
        case .wallpaperRegular: return "\u{fa58}"
        case .warningBadgeFilled: return "\u{fa59}"
        case .warningBold: return "\u{fa5a}"
        case .warningFilled: return "\u{fa5b}"
        case .warningLight: return "\u{fa5c}"
        case .warningRegular: return "\u{fa5d}"
        case .webexAssistantActiveColored: return "\u{fa5e}"
        case .webexAssistantInactiveColored: return "\u{fa5f}"
        case .webexBoardBold: return "\u{fa60}"
        case .webexBoardLight: return "\u{fa61}"
        case .webexBoardRegular: return "\u{fa62}"
        case .webexCodecPlusBold: return "\u{fa63}"
        case .webexCodecPlusLight: return "\u{fa64}"
        case .webexCodecPlusRegular: return "\u{fa65}"
        case .webexDeskCameraBold: return "\u{fa66}"
        case .webexDeskCameraLight: return "\u{fa67}"
        case .webexDeskCameraRegular: return "\u{fa68}"
        case .webexHelixFilled: return "\u{fa69}"
        case .webexMeetingsBold: return "\u{fa6a}"
        case .webexMeetingsFilled: return "\u{fa6b}"
        case .webexMeetingsLight: return "\u{fa6c}"
        case .webexMeetingsRegular: return "\u{fa6d}"
        case .webexQuadCameraBold: return "\u{fa6e}"
        case .webexQuadCameraLight: return "\u{fa6f}"
        case .webexQuadCameraRegular: return "\u{fa70}"
        case .webexRoomKitBold: return "\u{fa71}"
        case .webexRoomKitLight: return "\u{fa72}"
        case .webexRoomKitPlusBold: return "\u{fa73}"
        case .webexRoomKitPlusLight: return "\u{fa74}"
        case .webexRoomKitPlusRegular: return "\u{fa75}"
        case .webexRoomKitRegular: return "\u{fa76}"
        case .webexShareBold: return "\u{fa77}"
        case .webexShareLight: return "\u{fa78}"
        case .webexShareRegular: return "\u{fa79}"
        case .webexTeamsBold: return "\u{fa7a}"
        case .webexTeamsFilled: return "\u{fa7b}"
        case .webexTeamsLight: return "\u{fa7c}"
        case .webexTeamsNewBold: return "\u{fa7d}"
        case .webexTeamsNewFilled: return "\u{fa7e}"
        case .webexTeamsNewLight: return "\u{fa7f}"
        case .webexTeamsNewRegular: return "\u{fa80}"
        case .webexTeamsRegular: return "\u{fa81}"
        case .webinarBold: return "\u{fa82}"
        case .webinarFilled: return "\u{fa83}"
        case .webinarLight: return "\u{fa84}"
        case .webinarRegular: return "\u{fa85}"
        case .weeklyRecurringScheduleNodeBold: return "\u{fa86}"
        case .weeklyRecurringScheduleNodeLight: return "\u{fa87}"
        case .weeklyRecurringScheduleNodeRegular: return "\u{fa88}"
        case .whiteboardBold: return "\u{fa89}"
        case .whiteboardContentBold: return "\u{fa8a}"
        case .whiteboardContentLight: return "\u{fa8b}"
        case .whiteboardContentRegular: return "\u{fa8c}"
        case .whiteboardFilled: return "\u{fa8d}"
        case .whiteboardLight: return "\u{fa8e}"
        case .whiteboardRegular: return "\u{fa8f}"
        case .widgetBold: return "\u{fa90}"
        case .widgetFilled: return "\u{fa91}"
        case .widgetLight: return "\u{fa92}"
        case .widgetRegular: return "\u{fa93}"
        case .wifiBold: return "\u{fa94}"
        case .wifiErrorBold: return "\u{fa95}"
        case .wifiErrorLight: return "\u{fa96}"
        case .wifiErrorRegular: return "\u{fa97}"
        case .wifiLight: return "\u{fa98}"
        case .wifiRegular: return "\u{fa99}"
        case .wifiSignalGoodColoredBold: return "\u{fa9a}"
        case .wifiSignalGoodColoredLight: return "\u{fa9b}"
        case .wifiSignalGoodColoredRegular: return "\u{fa9c}"
        case .wifiSignalPoorColoredBold: return "\u{fa9d}"
        case .wifiSignalPoorColoredLight: return "\u{fa9e}"
        case .wifiSignalPoorColoredRegular: return "\u{fa9f}"
        case .wifiSignalUnstableColoredBold: return "\u{faa0}"
        case .wifiSignalUnstableColoredLight: return "\u{faa1}"
        case .wifiSignalUnstableColoredRegular: return "\u{faa2}"
        case .windowCornerScrubBold: return "\u{faa3}"
        case .windowCornerScrubLight: return "\u{faa4}"
        case .windowCornerScrubRegular: return "\u{faa5}"
        case .windowRightCornerScrubBold: return "\u{faa6}"
        case .windowRightCornerScrubLight: return "\u{faa7}"
        case .windowRightCornerScrubRegular: return "\u{faa8}"
        case .windowVerticalScrubBold: return "\u{faa9}"
        case .windowVerticalScrubLight: return "\u{faaa}"
        case .windowVerticalScrubRegular: return "\u{faab}"
        case .workflowDeploymentsBold: return "\u{faac}"
        case .workflowDeploymentsLight: return "\u{faad}"
        case .workflowDeploymentsRegular: return "\u{faae}"
        case .workphoneBold: return "\u{faaf}"
        case .workphoneLight: return "\u{fab0}"
        case .workphoneRegular: return "\u{fab1}"
        case .zoomInBold: return "\u{fab2}"
        case .zoomInLight: return "\u{fab3}"
        case .zoomInRegular: return "\u{fab4}"
        case .zoomOutBold: return "\u{fab5}"
        case .zoomOutLight: return "\u{fab6}"
        case .zoomOutRegular: return "\u{fab7}"
        case .zoom: return "\u{fab8}"
