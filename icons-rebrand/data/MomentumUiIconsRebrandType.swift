...
@objc public enum MomentumIconsRebrandType: Int {
    ...
    public var ligature: String {
        ...
        case .microphoneMutedRegular: return "\u{f5a9}"
        case .microphoneRegular: return "\u{f5aa}"
        case .minimizeBold: return "\u{f5ab}"
        case .minimizeLight: return "\u{f5ac}"
        case .minimizeRegular: return "\u{f5ad}"
        case .minusBold: return "\u{f5ae}"
        case .minusLight: return "\u{f5af}"
        case .minusRegular: return "\u{f5b0}"
        case .mirrorBold: return "\u{f5b1}"
        case .mirrorFilled: return "\u{f5b2}"
        case .mirrorLight: return "\u{f5b3}"
        case .mirrorRegular: return "\u{f5b4}"
        case .monitoringBold: return "\u{f5b5}"
        case .monitoringLight: return "\u{f5b6}"
        case .monitoringRegular: return "\u{f5b7}"
        case .moreAdrBold: return "\u{f5b8}"
        case .moreAdrLight: return "\u{f5b9}"
        case .moreAdrRegular: return "\u{f5ba}"
        case .moreBold: return "\u{f5bb}"
        case .moreCircleBold: return "\u{f5bc}"
        case .moreCircleFilled: return "\u{f5bd}"
        case .moreCircleLight: return "\u{f5be}"
        case .moreCircleRegular: return "\u{f5bf}"
        case .moreLight: return "\u{f5c0}"
        case .moreRegular: return "\u{f5c1}"
        case .mouseCursorBold: return "\u{f5c2}"
        case .mouseCursorLight: return "\u{f5c3}"
        case .mouseCursorRegular: return "\u{f5c4}"
        case .moveCallInAdrBold: return "\u{f5c5}"
        case .moveCallInAdrLight: return "\u{f5c6}"
        case .moveCallInAdrRegular: return "\u{f5c7}"
        case .moveCallInIphBold: return "\u{f5c8}"
        case .moveCallInIphLight: return "\u{f5c9}"
        case .moveCallInIphRegular: return "\u{f5ca}"
        case .moveCallInLaptopBold: return "\u{f5cb}"
        case .moveCallInLaptopLight: return "\u{f5cc}"
        case .moveCallInLaptopRegular: return "\u{f5cd}"
        case .moveCallInOutAdrBold: return "\u{f5ce}"
        case .moveCallInOutAdrLight: return "\u{f5cf}"
        case .moveCallInOutAdrRegular: return "\u{f5d0}"
        case .moveCallInOutIphBold: return "\u{f5d1}"
        case .moveCallInOutIphLight: return "\u{f5d2}"
        case .moveCallInOutIphRegular: return "\u{f5d3}"
        case .moveCallInTabletBold: return "\u{f5d4}"
        case .moveCallInTabletLight: return "\u{f5d5}"
        case .moveCallInTabletRegular: return "\u{f5d6}"
        case .moveCallOutAdrBold: return "\u{f5d7}"
        case .moveCallOutAdrLight: return "\u{f5d8}"
        case .moveCallOutAdrRegular: return "\u{f5d9}"
        case .moveCallOutIphBold: return "\u{f5da}"
        case .moveCallOutIphLight: return "\u{f5db}"
        case .moveCallOutIphRegular: return "\u{f5dc}"
        case .moveCallOutLaptopBold: return "\u{f5dd}"
        case .moveCallOutLaptopLight: return "\u{f5de}"
        case .moveCallOutLaptopRegular: return "\u{f5df}"
        case .moveCallOutTabletBold: return "\u{f5e0}"
        case .moveCallOutTabletLight: return "\u{f5e1}"
        case .moveCallOutTabletRegular: return "\u{f5e2}"
        case .multilineChartBold: return "\u{f5e3}"
        case .multilineChartFilled: return "\u{f5e4}"
        case .multilineChartLight: return "\u{f5e5}"
        case .multilineChartRegular: return "\u{f5e6}"
        case .multimediaBold: return "\u{f5e7}"
        case .multimediaFilled: return "\u{f5e8}"
        case .multimediaLight: return "\u{f5e9}"
        case .multimediaRegular: return "\u{f5ea}"
        case .multipledDevicesBold: return "\u{f5eb}"
        case .multipledDevicesLight: return "\u{f5ec}"
        case .multipledDevicesRegular: return "\u{f5ed}"
        case .musicModeBold: return "\u{f5ee}"
        case .musicModeCircleBold: return "\u{f5ef}"
        case .musicModeCircleFilled: return "\u{f5f0}"
        case .musicModeCircleLight: return "\u{f5f1}"
        case .musicModeCircleRegular: return "\u{f5f2}"
        case .musicModeFilled: return "\u{f5f3}"
        case .musicModeLight: return "\u{f5f4}"
        case .musicModeRegular: return "\u{f5f5}"
        case .muteOnEntryBold: return "\u{f5f6}"
        case .muteOnEntryFilled: return "\u{f5f7}"
        case .muteOnEntryLight: return "\u{f5f8}"
        case .muteOnEntryRegular: return "\u{f5f9}"
        case .newVoicemailBold: return "\u{f5fa}"
        case .newVoicemailLight: return "\u{f5fb}"
        case .newVoicemailRegular: return "\u{f5fc}"
        case .newWhiteboardBold: return "\u{f5fd}"
        case .newWhiteboardLight: return "\u{f5fe}"
        case .newWhiteboardRegular: return "\u{f5ff}"
        case .nextBold: return "\u{f600}"
        case .nextLight: return "\u{f601}"
        case .nextRegular: return "\u{f602}"
        case .noDevicesBold: return "\u{f603}"
        case .noDevicesLight: return "\u{f604}"
        case .noDevicesRegular: return "\u{f605}"
        case .noiseRemovalBold: return "\u{f606}"
        case .noiseRemovalLight: return "\u{f607}"
        case .noiseRemovalRegular: return "\u{f608}"
        case .noteBold: return "\u{f609}"
        case .noteLight: return "\u{f60a}"
        case .notePptBold: return "\u{f60b}"
        case .notePptLight: return "\u{f60c}"
        case .notePptRegular: return "\u{f60d}"
        case .noteRegular: return "\u{f60e}"
        case .notesBold: return "\u{f60f}"
        case .notesLight: return "\u{f610}"
        case .notesRegular: return "\u{f611}"
        case .numberBold: return "\u{f612}"
        case .numberLight: return "\u{f613}"
        case .numberRegular: return "\u{f614}"
        case .oldRemoteBold: return "\u{f615}"
        case .oldRemoteLight: return "\u{f616}"
        case .oldRemoteRegular: return "\u{f617}"
        case .oldTouchBold: return "\u{f618}"
        case .oldTouchLight: return "\u{f619}"
        case .oldTouchRegular: return "\u{f61a}"
        case .openInFolderBold: return "\u{f61b}"
        case .openInFolderLight: return "\u{f61c}"
        case .openInFolderRegular: return "\u{f61d}"
        case .openPagesBold: return "\u{f61e}"
        case .openPagesLight: return "\u{f61f}"
        case .openPagesRegular: return "\u{f620}"
        case .otherNumberBold: return "\u{f621}"
        case .otherNumberLight: return "\u{f622}"
        case .otherNumberRegular: return "\u{f623}"
        case .otherNumberWarningBold: return "\u{f624}"
        case .otherNumberWarningLight: return "\u{f625}"
        case .otherNumberWarningRegular: return "\u{f626}"
        case .outgoingCallLegacyBold: return "\u{f627}"
        case .outgoingCallLegacyLight: return "\u{f628}"
        case .outgoingCallLegacyRegular: return "\u{f629}"
        case .overflowLeftBold: return "\u{f62a}"
        case .overflowLeftLight: return "\u{f62b}"
        case .overflowLeftRegular: return "\u{f62c}"
        case .overflowRightBold: return "\u{f62d}"
        case .overflowRightLight: return "\u{f62e}"
        case .overflowRightRegular: return "\u{f62f}"
        case .pairedCameraBold: return "\u{f630}"
        case .pairedCameraLight: return "\u{f631}"
        case .pairedCameraRegular: return "\u{f632}"
        case .pairedDeviceBold: return "\u{f633}"
        case .pairedDeviceLight: return "\u{f634}"
        case .pairedDeviceRegular: return "\u{f635}"
        case .pairedHandsetBold: return "\u{f636}"
        case .pairedHandsetLight: return "\u{f637}"
        case .pairedHandsetRegular: return "\u{f638}"
        case .pairingBold: return "\u{f639}"
        case .pairingLight: return "\u{f63a}"
        case .pairingRegular: return "\u{f63b}"
        case .parkedBold: return "\u{f63c}"
        case .parkedFilled: return "\u{f63d}"
        case .parkedLight: return "\u{f63e}"
        case .parkedRegular: return "\u{f63f}"
        case .parseBold: return "\u{f640}"
        case .parseLight: return "\u{f641}"
        case .parseRegular: return "\u{f642}"
        case .participantAddBold: return "\u{f643}"
        case .participantAddLight: return "\u{f644}"
        case .participantAddRegular: return "\u{f645}"
        case .participantBlockedBold: return "\u{f646}"
        case .participantBlockedLight: return "\u{f647}"
        case .participantBlockedRegular: return "\u{f648}"
        case .participantBold: return "\u{f649}"
        case .participantFilled: return "\u{f64a}"
        case .participantLight: return "\u{f64b}"
        case .participantListBold: return "\u{f64c}"
        case .participantListFilled: return "\u{f64d}"
        case .participantListLight: return "\u{f64e}"
        case .participantListRegular: return "\u{f64f}"
        case .participantRegular: return "\u{f650}"
        case .participantRemoveBold: return "\u{f651}"
        case .participantRemoveLight: return "\u{f652}"
        case .participantRemoveRegular: return "\u{f653}"
        case .participantUnknownBold: return "\u{f654}"
        case .participantUnknownLight: return "\u{f655}"
        case .participantUnknownRegular: return "\u{f656}"
        case .passMouseBold: return "\u{f657}"
        case .passMouseLight: return "\u{f658}"
        case .passMouseRegular: return "\u{f659}"
        case .pauseBold: return "\u{f65a}"
        case .pauseFilled: return "\u{f65b}"
        case .pauseLight: return "\u{f65c}"
        case .pauseRegular: return "\u{f65d}"
        case .penBold: return "\u{f65e}"
        case .penFilled: return "\u{f65f}"
        case .penLight: return "\u{f660}"
        case .penRegular: return "\u{f661}"
        case .peopleBold: return "\u{f662}"
        case .peopleCircleBold: return "\u{f663}"
        case .peopleCircleFilled: return "\u{f664}"
        case .peopleCircleLight: return "\u{f665}"
        case .peopleCircleRegular: return "\u{f666}"
        case .peopleFilled: return "\u{f667}"
        case .peopleInsightsFilled: return "\u{f668}"
        case .peopleLight: return "\u{f669}"
        case .peopleRegular: return "\u{f66a}"
        case .phoneAlertBold: return "\u{f66b}"
        case .phoneAlertLight: return "\u{f66c}"
        case .phoneAlertRegular: return "\u{f66d}"
        case .phoneBold: return "\u{f66e}"
        case .phoneFilled: return "\u{f66f}"
        case .phoneLight: return "\u{f670}"
        case .phoneMutedBold: return "\u{f671}"
        case .phoneMutedLight: return "\u{f672}"
        case .phoneMutedRegular: return "\u{f673}"
        case .phonePrivateBold: return "\u{f674}"
        case .phonePrivateLight: return "\u{f675}"
        case .phonePrivateRegular: return "\u{f676}"
        case .phoneRegular: return "\u{f677}"
        case .phoneReplyAllBold: return "\u{f678}"
        case .phoneReplyAllLight: return "\u{f679}"
        case .phoneReplyAllRegular: return "\u{f67a}"
        case .phoneReplyBold: return "\u{f67b}"
        case .phoneReplyLight: return "\u{f67c}"
        case .phoneReplyRegular: return "\u{f67d}"
        case .phoneSmallFilled: return "\u{f67e}"
        case .pickerBold: return "\u{f67f}"
        case .pickerLight: return "\u{f680}"
        case .pickerRegular: return "\u{f681}"
        case .pictureInPictureBold: return "\u{f682}"
        case .pictureInPictureLight: return "\u{f683}"
        case .pictureInPictureRegular: return "\u{f684}"
        case .pieChartBold: return "\u{f685}"
        case .pieChartFilled: return "\u{f686}"
        case .pieChartLight: return "\u{f687}"
        case .pieChartRegular: return "\u{f688}"
        case .pinBold: return "\u{f689}"
        case .pinFilled: return "\u{f68a}"
        case .pinLight: return "\u{f68b}"
        case .pinListActivityColoredBold: return "\u{f68c}"
        case .pinListActivityColoredLight: return "\u{f68d}"
        case .pinListActivityColoredRegular: return "\u{f68e}"
        case .pinListBold: return "\u{f68f}"
        case .pinListLight: return "\u{f690}"
        case .pinListRegular: return "\u{f691}"
        case .pinMutedBold: return "\u{f692}"
        case .pinMutedLight: return "\u{f693}"
        case .pinMutedRegular: return "\u{f694}"
        case .pinRegular: return "\u{f695}"
        case .placeholderBold: return "\u{f696}"
        case .placeholderLight: return "\u{f697}"
        case .placeholderRegular: return "\u{f698}"
        case .playBold: return "\u{f699}"
        case .playFilled: return "\u{f69a}"
        case .playLight: return "\u{f69b}"
        case .playRegular: return "\u{f69c}"
        case .plugAcBold: return "\u{f69d}"
        case .plugAcLight: return "\u{f69e}"
        case .plugAcRegular: return "\u{f69f}"
        case .plusBold: return "\u{f6a0}"
        case .plusCircleBold: return "\u{f6a1}"
        case .plusCircleFilled: return "\u{f6a2}"
        case .plusCircleLight: return "\u{f6a3}"
        case .plusCircleRegular: return "\u{f6a4}"
        case .plusLight: return "\u{f6a5}"
        case .plusRegular: return "\u{f6a6}"
        case .pmrBold: return "\u{f6a7}"
        case .pmrFilled: return "\u{f6a8}"
        case .pmrLight: return "\u{f6a9}"
        case .pmrRegular: return "\u{f6aa}"
        case .pollBold: return "\u{f6ab}"
        case .pollLight: return "\u{f6ac}"
        case .pollRegular: return "\u{f6ad}"
        case .popInBold: return "\u{f6ae}"
        case .popInLight: return "\u{f6af}"
        case .popInRegular: return "\u{f6b0}"
        case .popOutBold: return "\u{f6b1}"
        case .popOutLight: return "\u{f6b2}"
        case .popOutRegular: return "\u{f6b3}"
        case .popUpBold: return "\u{f6b4}"
        case .popUpLight: return "\u{f6b5}"
        case .popUpRegular: return "\u{f6b6}"
        case .portraitLandscapeBold: return "\u{f6b7}"
        case .portraitLandscapeLight: return "\u{f6b8}"
        case .portraitLandscapeRegular: return "\u{f6b9}"
        case .powerAcBold: return "\u{f6ba}"
        case .powerAcLight: return "\u{f6bb}"
        case .powerAcRegular: return "\u{f6bc}"
        case .powerBold: return "\u{f6bd}"
        case .powerLight: return "\u{f6be}"
        case .powerRegular: return "\u{f6bf}"
        case .presentationBold: return "\u{f6c0}"
        case .presentationLight: return "\u{f6c1}"
        case .presentationRegular: return "\u{f6c2}"
        case .printBold: return "\u{f6c3}"
        case .printLight: return "\u{f6c4}"
        case .printRegular: return "\u{f6c5}"
        case .priorityBadgeFilled: return "\u{f6c6}"
        case .priorityCircleBold: return "\u{f6c7}"
        case .priorityCircleFilled: return "\u{f6c8}"
        case .priorityCircleLight: return "\u{f6c9}"
        case .priorityCircleRegular: return "\u{f6ca}"
        case .priorityCircleTwoBold: return "\u{f6cb}"
        case .priorityCircleTwoFilled: return "\u{f6cc}"
        case .priorityCircleTwoLight: return "\u{f6cd}"
        case .priorityCircleTwoRegular: return "\u{f6ce}"
        case .privacyCircleBold: return "\u{f6cf}"
        case .privacyCircleFilled: return "\u{f6d0}"
        case .privacyCircleLight: return "\u{f6d1}"
        case .privacyCircleRegular: return "\u{f6d2}"
        case .privateBold: return "\u{f6d3}"
        case .privateCircleBold: return "\u{f6d4}"
        case .privateCircleFilled: return "\u{f6d5}"
        case .privateCircleLight: return "\u{f6d6}"
        case .privateCircleRegular: return "\u{f6d7}"
        case .privateLight: return "\u{f6d8}"
        case .privateMeetingBold: return "\u{f6d9}"
        case .privateMeetingLight: return "\u{f6da}"
        case .privateMeetingRegular: return "\u{f6db}"
        case .privateRegular: return "\u{f6dc}"
        case .productDemoBold: return "\u{f6dd}"
        case .productDemoLight: return "\u{f6de}"
        case .productDemoRegular: return "\u{f6df}"
        case .proximityBold: return "\u{f6e0}"
        case .proximityLight: return "\u{f6e1}"
        case .proximityMutedBold: return "\u{f6e2}"
        case .proximityMutedLight: return "\u{f6e3}"
        case .proximityMutedRegular: return "\u{f6e4}"
        case .proximityRegular: return "\u{f6e5}"
        case .proximityVideoBold: return "\u{f6e6}"
        case .proximityVideoLight: return "\u{f6e7}"
        case .proximityVideoRegular: return "\u{f6e8}"
        case .ptoPresenceBold: return "\u{f6e9}"
        case .ptoPresenceFilled: return "\u{f6ea}"
        case .ptoPresenceLight: return "\u{f6eb}"
        case .ptoPresenceRegular: return "\u{f6ec}"
        case .pullCallBold: return "\u{f6ed}"
        case .pullCallLight: return "\u{f6ee}"
        case .pullCallRegular: return "\u{f6ef}"
        case .qABold: return "\u{f6f0}"
        case .qALight: return "\u{f6f1}"
        case .qARegular: return "\u{f6f2}"
        case .qualityBold: return "\u{f6f3}"
        case .qualityLight: return "\u{f6f4}"
        case .qualityRegular: return "\u{f6f5}"
        case .queueContactBold: return "\u{f6f6}"
        case .queueContactLight: return "\u{f6f7}"
        case .queueContactRegular: return "\u{f6f8}"
        case .quietBold: return "\u{f6f9}"
        case .quietHoursPresenceBold: return "\u{f6fa}"
        case .quietHoursPresenceFilled: return "\u{f6fb}"
        case .quietHoursPresenceLight: return "\u{f6fc}"
        case .quietHoursPresenceRegular: return "\u{f6fd}"
        case .quietLight: return "\u{f6fe}"
        case .quietRegular: return "\u{f6ff}"
        case .raiseHandBold: return "\u{f700}"
        case .raiseHandLight: return "\u{f701}"
        case .raiseHandRegular: return "\u{f702}"
        case .ramBold: return "\u{f703}"
        case .ramLight: return "\u{f704}"
        case .ramRegular: return "\u{f705}"
        case .reactionsBold: return "\u{f706}"
        case .reactionsFilled: return "\u{f707}"
        case .reactionsLight: return "\u{f708}"
        case .reactionsRegular: return "\u{f709}"
        case .reactivateBold: return "\u{f70a}"
        case .reactivateLight: return "\u{f70b}"
        case .reactivateRegular: return "\u{f70c}"
        case .recentsBold: return "\u{f70d}"
        case .recentsFilled: return "\u{f70e}"
        case .recentsLight: return "\u{f70f}"
        case .recentsPresenceBold: return "\u{f710}"
        case .recentsPresenceFilled: return "\u{f711}"
        case .recentsPresenceLight: return "\u{f712}"
        case .recentsPresenceRegular: return "\u{f713}"
        case .recentsPresenceSmallFilled: return "\u{f714}"
        case .recentsRegular: return "\u{f715}"
        case .recordBold: return "\u{f716}"
        case .recordFilled: return "\u{f717}"
        case .recordLight: return "\u{f718}"
        case .recordPausedBold: return "\u{f719}"
        case .recordPausedFilled: return "\u{f71a}"
        case .recordPausedLight: return "\u{f71b}"
        case .recordPausedRegular: return "\u{f71c}"
        case .recordRegular: return "\u{f71d}"
        case .recurringBold: return "\u{f71e}"
        case .recurringLight: return "\u{f71f}"
        case .recurringOffBold: return "\u{f720}"
        case .recurringOffLight: return "\u{f721}"
        case .recurringOffRegular: return "\u{f722}"
        case .recurringRegular: return "\u{f723}"
        case .redialBold: return "\u{f724}"
        case .redialLight: return "\u{f725}"
        case .redialRegular: return "\u{f726}"
        case .redoBold: return "\u{f727}"
        case .redoLight: return "\u{f728}"
        case .redoRegular: return "\u{f729}"
        case .refreshBold: return "\u{f72a}"
        case .refreshLight: return "\u{f72b}"
        case .refreshRegular: return "\u{f72c}"
        case .remoteDesktopControlBold: return "\u{f72d}"
        case .remoteDesktopControlFilled: return "\u{f72e}"
        case .remoteDesktopControlLight: return "\u{f72f}"
        case .remoteDesktopControlRegular: return "\u{f730}"
        case .removeBold: return "\u{f731}"
        case .removeFilled: return "\u{f732}"
        case .removeLight: return "\u{f733}"
        case .removeRegular: return "\u{f734}"
        case .replyBold: return "\u{f735}"
        case .replyFilled: return "\u{f736}"
        case .replyLight: return "\u{f737}"
        case .replyListBold: return "\u{f738}"
        case .replyListLight: return "\u{f739}"
        case .replyListRegular: return "\u{f73a}"
        case .replyRegular: return "\u{f73b}"
        case .resetBold: return "\u{f73c}"
        case .resetLight: return "\u{f73d}"
        case .resetRegular: return "\u{f73e}"
        case .responsiveMobileBold: return "\u{f73f}"
        case .responsiveMobileLight: return "\u{f740}"
        case .responsiveMobileRegular: return "\u{f741}"
        case .restartBold: return "\u{f742}"
        case .restartLight: return "\u{f743}"
        case .restartRegular: return "\u{f744}"
        case .returnBold: return "\u{f745}"
        case .returnLight: return "\u{f746}"
        case .returnRegular: return "\u{f747}"
        case .ringtoneBold: return "\u{f748}"
        case .ringtoneLight: return "\u{f749}"
        case .ringtoneRegular: return "\u{f74a}"
        case .roomCalendarBold: return "\u{f74b}"
        case .roomCalendarLight: return "\u{f74c}"
        case .roomCalendarRegular: return "\u{f74d}"
        case .roomLightsBold: return "\u{f74e}"
        case .roomLightsFilled: return "\u{f74f}"
        case .roomLightsLight: return "\u{f750}"
        case .roomLightsRegular: return "\u{f751}"
        case .rotateContentBold: return "\u{f752}"
        case .rotateContentFilled: return "\u{f753}"
        case .rotateContentLight: return "\u{f754}"
        case .rotateContentRegular: return "\u{f755}"
        case .runningApplicationBold: return "\u{f756}"
        case .runningApplicationFilled: return "\u{f757}"
        case .runningApplicationLight: return "\u{f758}"
        case .runningApplicationRegular: return "\u{f759}"
        case .saveBold: return "\u{f75a}"
        case .saveLight: return "\u{f75b}"
        case .saveRegular: return "\u{f75c}"
        case .scanBold: return "\u{f75d}"
        case .scanLight: return "\u{f75e}"
        case .scanRegular: return "\u{f75f}"
        case .schedulerAvailableBold: return "\u{f760}"
        case .schedulerAvailableLight: return "\u{f761}"
        case .schedulerAvailableRegular: return "\u{f762}"
        case .schedulerNotWorkingHoursBold: return "\u{f763}"
        case .schedulerNotWorkingHoursLight: return "\u{f764}"
        case .schedulerNotWorkingHoursRegular: return "\u{f765}"
        case .schedulerUnavailableBold: return "\u{f766}"
        case .schedulerUnavailableLight: return "\u{f767}"
        case .schedulerUnavailableRegular: return "\u{f768}"
        case .schedulerUnknownBold: return "\u{f769}"
        case .schedulerUnknownLight: return "\u{f76a}"
        case .schedulerUnknownRegular: return "\u{f76b}"
        case .screenshotBold: return "\u{f76c}"
        case .screenshotDocBold: return "\u{f76d}"
        case .screenshotDocFilled: return "\u{f76e}"
        case .screenshotDocLight: return "\u{f76f}"
        case .screenshotDocRegular: return "\u{f770}"
        case .screenshotLight: return "\u{f771}"
        case .screenshotRegular: return "\u{f772}"
        case .searchBold: return "\u{f773}"
        case .searchFilled: return "\u{f774}"
        case .searchLight: return "\u{f775}"
        case .searchRegular: return "\u{f776}"
        case .secondaryArrowBold: return "\u{f777}"
        case .secondaryArrowLight: return "\u{f778}"
        case .secondaryArrowRegular: return "\u{f779}"
        case .secureCallLockBold: return "\u{f77a}"
        case .secureCallLockFilled: return "\u{f77b}"
        case .secureCallLockLight: return "\u{f77c}"
        case .secureCallLockRegular: return "\u{f77d}"
        case .secureCallShieldBold: return "\u{f77e}"
        case .secureCallShieldFilled: return "\u{f77f}"
        case .secureCallShieldLight: return "\u{f780}"
        case .secureCallShieldRegular: return "\u{f781}"
        case .secureCircleBold: return "\u{f782}"
        case .secureCircleFilled: return "\u{f783}"
        case .secureCircleLight: return "\u{f784}"
        case .secureCircleRegular: return "\u{f785}"
        case .secureLockBold: return "\u{f786}"
        case .secureLockFilled: return "\u{f787}"
        case .secureLockLight: return "\u{f788}"
        case .secureLockRegular: return "\u{f789}"
        case .selectAllBold: return "\u{f78a}"
        case .selectAllFilled: return "\u{f78b}"
        case .selectAllLight: return "\u{f78c}"
        case .selectAllRegular: return "\u{f78d}"
        case .selectionBold: return "\u{f78e}"
        case .selectionLight: return "\u{f78f}"
        case .selectionRegular: return "\u{f790}"
        case .sendBold: return "\u{f791}"
        case .sendFilled: return "\u{f792}"
        case .sendLight: return "\u{f793}"
        case .sendRegular: return "\u{f794}"
        case .serverBold: return "\u{f795}"
        case .serverErrorBold: return "\u{f796}"
        case .serverErrorLight: return "\u{f797}"
        case .serverErrorRegular: return "\u{f798}"
        case .serverLight: return "\u{f799}"
        case .serverRegular: return "\u{f79a}"
        case .servicesBold: return "\u{f79b}"
        case .servicesLight: return "\u{f79c}"
        case .servicesRegular: return "\u{f79d}"
        case .setVariableBold: return "\u{f79e}"
        case .setVariableLight: return "\u{f79f}"
        case .setVariableRegular: return "\u{f7a0}"
        case .settingsBold: return "\u{f7a1}"
        case .settingsFilled: return "\u{f7a2}"
        case .settingsLight: return "\u{f7a3}"
        case .settingsRegular: return "\u{f7a4}"
        case .setupAssistantBold: return "\u{f7a5}"
        case .setupAssistantLight: return "\u{f7a6}"
        case .setupAssistantRegular: return "\u{f7a7}"
        case .shapeDiagonalLineBold: return "\u{f7a8}"
        case .shapeDiagonalLineLight: return "\u{f7a9}"
        case .shapeDiagonalLineRegular: return "\u{f7aa}"
        case .shapeOvalBold: return "\u{f7ab}"
        case .shapeOvalLight: return "\u{f7ac}"
        case .shapeOvalRegular: return "\u{f7ad}"
        case .shapesBold: return "\u{f7ae}"
        case .shapesLight: return "\u{f7af}"
        case .shapesRegular: return "\u{f7b0}"
        case .shareCNativeAdrBold: return "\u{f7b1}"
        case .shareCNativeAdrLight: return "\u{f7b2}"
        case .shareCNativeAdrRegular: return "\u{f7b3}"
        case .shareCNativeIphBold: return "\u{f7b4}"
        case .shareCNativeIphLight: return "\u{f7b5}"
        case .shareCNativeIphRegular: return "\u{f7b6}"
        case .shareScreenBold: return "\u{f7b7}"
        case .shareScreenFilled: return "\u{f7b8}"
        case .shareScreenLight: return "\u{f7b9}"
        case .shareScreenRegular: return "\u{f7ba}"
        case .shareScreenSmallFilled: return "\u{f7bb}"
        case .shareSpaceBold: return "\u{f7bc}"
        case .shareSpaceLight: return "\u{f7bd}"
        case .shareSpaceRegular: return "\u{f7be}"
        case .shieldBold: return "\u{f7bf}"
        case .shieldLight: return "\u{f7c0}"
        case .shieldRegular: return "\u{f7c1}"
        case .showBold: return "\u{f7c2}"
        case .showFilled: return "\u{f7c3}"
        case .showLight: return "\u{f7c4}"
        case .showRegular: return "\u{f7c5}"
        case .signInBold: return "\u{f7c6}"
        case .signInForcedBold: return "\u{f7c7}"
        case .signInForcedLight: return "\u{f7c8}"
        case .signInForcedRegular: return "\u{f7c9}"
        case .signInLight: return "\u{f7ca}"
        case .signInRegular: return "\u{f7cb}"
        case .signOutBold: return "\u{f7cc}"
        case .signOutLight: return "\u{f7cd}"
        case .signOutRegular: return "\u{f7ce}"
        case .signal0Bold: return "\u{f7cf}"
        case .signal0Light: return "\u{f7d0}"
        case .signal0Regular: return "\u{f7d1}"
        case .signal100Bold: return "\u{f7d2}"
        case .signal100Light: return "\u{f7d3}"
        case .signal100Regular: return "\u{f7d4}"
        case .signal25Bold: return "\u{f7d5}"
        case .signal25Light: return "\u{f7d6}"
        case .signal25Regular: return "\u{f7d7}"
        case .signal50Bold: return "\u{f7d8}"
        case .signal50Light: return "\u{f7d9}"
        case .signal50Regular: return "\u{f7da}"
        case .signal75Bold: return "\u{f7db}"
        case .signal75Light: return "\u{f7dc}"
        case .signal75Regular: return "\u{f7dd}"
        case .singleNumberReachBold: return "\u{f7de}"
        case .singleNumberReachLight: return "\u{f7df}"
        case .singleNumberReachRegular: return "\u{f7e0}"
        case .sipRegistrationInProgressBold: return "\u{f7e1}"
        case .sipRegistrationInProgressFilled: return "\u{f7e2}"
        case .sipRegistrationInProgressLight: return "\u{f7e3}"
        case .sipRegistrationInProgressRegular: return "\u{f7e4}"
        case .skipBold: return "\u{f7e5}"
        case .skipBwBold: return "\u{f7e6}"
        case .skipBwFilled: return "\u{f7e7}"
        case .skipBwLight: return "\u{f7e8}"
        case .skipBwRegular: return "\u{f7e9}"
        case .skipFwBold: return "\u{f7ea}"
        case .skipFwFilled: return "\u{f7eb}"
        case .skipFwLight: return "\u{f7ec}"
        case .skipFwRegular: return "\u{f7ed}"
        case .skipLight: return "\u{f7ee}"
        case .skipRegular: return "\u{f7ef}"
        case .speakerBold: return "\u{f7f0}"
        case .speakerDisconnectedBold: return "\u{f7f1}"
        case .speakerDisconnectedFilled: return "\u{f7f2}"
        case .speakerDisconnectedLight: return "\u{f7f3}"
        case .speakerDisconnectedRegular: return "\u{f7f4}"
        case .speakerFilled: return "\u{f7f5}"
        case .speakerLight: return "\u{f7f6}"
        case .speakerMutedBold: return "\u{f7f7}"
        case .speakerMutedFilled: return "\u{f7f8}"
        case .speakerMutedLight: return "\u{f7f9}"
        case .speakerMutedRegular: return "\u{f7fa}"
        case .speakerOffBold: return "\u{f7fb}"
        case .speakerOffFilled: return "\u{f7fc}"
        case .speakerOffLight: return "\u{f7fd}"
        case .speakerOffRegular: return "\u{f7fe}"
        case .speakerOnColoredBold: return "\u{f7ff}"
        case .speakerOnColoredLight: return "\u{f800}"
        case .speakerOnColoredRegular: return "\u{f801}"
        case .speakerRegular: return "\u{f802}"
        case .speakerTurnDownBold: return "\u{f803}"
        case .speakerTurnDownFilled: return "\u{f804}"
        case .speakerTurnDownLight: return "\u{f805}"
        case .speakerTurnDownRegular: return "\u{f806}"
        case .speakerTurnUpBold: return "\u{f807}"
        case .speakerTurnUpFilled: return "\u{f808}"
        case .speakerTurnUpLight: return "\u{f809}"
        case .speakerTurnUpRegular: return "\u{f80a}"
        case .spinnerBold: return "\u{f80b}"
        case .spinnerFilledBold: return "\u{f80c}"
        case .spinnerFilledLight: return "\u{f80d}"
        case .spinnerFilledRegular: return "\u{f80e}"
        case .spinnerLight: return "\u{f80f}"
        case .spinnerRegular: return "\u{f810}"
        case .stackedArea100ChartBold: return "\u{f811}"
        case .stackedArea100ChartFilled: return "\u{f812}"
        case .stackedArea100ChartLight: return "\u{f813}"
        case .stackedArea100ChartRegular: return "\u{f814}"
        case .stackedAreaChartBold: return "\u{f815}"
        case .stackedAreaChartFilled: return "\u{f816}"
        case .stackedAreaChartLight: return "\u{f817}"
        case .stackedAreaChartRegular: return "\u{f818}"
        case .stackedBar100ChartBold: return "\u{f819}"
        case .stackedBar100ChartFilled: return "\u{f81a}"
        case .stackedBar100ChartLight: return "\u{f81b}"
        case .stackedBar100ChartRegular: return "\u{f81c}"
        case .stackedBarChartBold: return "\u{f81d}"
        case .stackedBarChartFilled: return "\u{f81e}"
        case .stackedBarChartLight: return "\u{f81f}"
        case .stackedBarChartRegular: return "\u{f820}"
        case .startChatBold: return "\u{f821}"
        case .startChatLight: return "\u{f822}"
        case .startChatRegular: return "\u{f823}"
        case .stickersBold: return "\u{f824}"
        case .stickersLight: return "\u{f825}"
        case .stickersRegular: return "\u{f826}"
        case .stickiesBold: return "\u{f827}"
        case .stickiesLight: return "\u{f828}"
        case .stickiesRegular: return "\u{f829}"
        case .stopBold: return "\u{f82a}"
        case .stopCircleBold: return "\u{f82b}"
        case .stopCircleFilled: return "\u{f82c}"
        case .stopCircleLight: return "\u{f82d}"
        case .stopCircleRegular: return "\u{f82e}"
        case .stopContentShareBold: return "\u{f82f}"
        case .stopContentShareLight: return "\u{f830}"
        case .stopContentShareRegular: return "\u{f831}"
        case .stopFilled: return "\u{f832}"
        case .stopLight: return "\u{f833}"
        case .stopRegular: return "\u{f834}"
        case .storedInfoBold: return "\u{f835}"
        case .storedInfoFilled: return "\u{f836}"
        case .storedInfoLight: return "\u{f837}"
        case .storedInfoRegular: return "\u{f838}"
        case .streamingBold: return "\u{f839}"
        case .streamingLight: return "\u{f83a}"
        case .streamingRegular: return "\u{f83b}"
        case .strikethroughBold: return "\u{f83c}"
        case .strikethroughLight: return "\u{f83d}"
        case .strikethroughRegular: return "\u{f83e}"
        case .subscriptBold: return "\u{f83f}"
        case .subscriptLight: return "\u{f840}"
        case .subscriptRegular: return "\u{f841}"
        case .superscriptBold: return "\u{f842}"
        case .superscriptLight: return "\u{f843}"
        case .superscriptRegular: return "\u{f844}"
        case .sx10Bold: return "\u{f845}"
        case .sx10Light: return "\u{f846}"
        case .sx10Regular: return "\u{f847}"
        case .sx20Bold: return "\u{f848}"
        case .sx20Light: return "\u{f849}"
        case .sx20Regular: return "\u{f84a}"
        case .sx80CodecBold: return "\u{f84b}"
        case .sx80CodecLight: return "\u{f84c}"
        case .sx80CodecRegular: return "\u{f84d}"
        case .tableBold: return "\u{f84e}"
        case .tableLight: return "\u{f84f}"
        case .tableRegular: return "\u{f850}"
        case .tabletBold: return "\u{f851}"
        case .tabletLight: return "\u{f852}"
        case .tabletRegular: return "\u{f853}"
        case .tabsBold: return "\u{f854}"
        case .tabsLight: return "\u{f855}"
        case .tabsRegular: return "\u{f856}"
        case .tagBold: return "\u{f857}"
        case .tagLight: return "\u{f858}"
        case .tagRegular: return "\u{f859}"
        case .telepresenceAlertBold: return "\u{f85a}"
        case .telepresenceAlertLight: return "\u{f85b}"
        case .telepresenceAlertMutedBold: return "\u{f85c}"
        case .telepresenceAlertMutedLight: return "\u{f85d}"
        case .telepresenceAlertMutedRegular: return "\u{f85e}"
        case .telepresenceAlertRegular: return "\u{f85f}"
        case .telepresenceBold: return "\u{f860}"
        case .telepresenceIx5000Bold: return "\u{f861}"
        case .telepresenceIx5000Light: return "\u{f862}"
        case .telepresenceIx5000Regular: return "\u{f863}"
        case .telepresenceLight: return "\u{f864}"
        case .telepresencePrivateBold: return "\u{f865}"
        case .telepresencePrivateLight: return "\u{f866}"
        case .telepresencePrivateRegular: return "\u{f867}"
        case .telepresenceRegular: return "\u{f868}"
        case .temperatureBold: return "\u{f869}"
        case .temperatureLight: return "\u{f86a}"
        case .temperatureRegular: return "\u{f86b}"
        case .textBold: return "\u{f86c}"
        case .textCodeBlockBold: return "\u{f86d}"
        case .textCodeBlockLight: return "\u{f86e}"
        case .textCodeBlockRegular: return "\u{f86f}"
        case .textHighlightBold: return "\u{f870}"
        case .textHighlightLight: return "\u{f871}"
        case .textHighlightRegular: return "\u{f872}"
        case .textLight: return "\u{f873}"
        case .textRegular: return "\u{f874}"
        case .threeDObjectBold: return "\u{f875}"
        case .threeDObjectLight: return "\u{f876}"
        case .threeDObjectRegular: return "\u{f877}"
        case .tooFastBold: return "\u{f878}"
        case .tooFastLight: return "\u{f879}"
        case .tooFastRegular: return "\u{f87a}"
        case .tooSlowBold: return "\u{f87b}"
        case .tooSlowLight: return "\u{f87c}"
        case .tooSlowRegular: return "\u{f87d}"
        case .toolsBold: return "\u{f87e}"
        case .toolsLight: return "\u{f87f}"
        case .toolsRegular: return "\u{f880}"
        case .touch10Bold: return "\u{f881}"
        case .touch10Light: return "\u{f882}"
        case .touch10Regular: return "\u{f883}"
        case .transcriptBold: return "\u{f884}"
        case .transcriptFilled: return "\u{f885}"
        case .transcriptLight: return "\u{f886}"
        case .transcriptRegular: return "\u{f887}"
        case .trimBold: return "\u{f888}"
        case .trimLight: return "\u{f889}"
        case .trimRegular: return "\u{f88a}"
        case .ucmCloudBold: return "\u{f88b}"
        case .ucmCloudLight: return "\u{f88c}"
        case .ucmCloudRegular: return "\u{f88d}"
        case .underlineBold: return "\u{f88e}"
        case .underlineLight: return "\u{f88f}"
        case .underlineRegular: return "\u{f890}"
        case .undoBold: return "\u{f891}"
        case .undoLight: return "\u{f892}"
        case .undoRegular: return "\u{f893}"
        case .unlinkBold: return "\u{f894}"
        case .unlinkLight: return "\u{f895}"
        case .unlinkRegular: return "\u{f896}"
        case .unreadBold: return "\u{f897}"
        case .unreadFilled: return "\u{f898}"
        case .unreadLight: return "\u{f899}"
        case .unreadRegular: return "\u{f89a}"
        case .unsecureUnlockedBold: return "\u{f89b}"
        case .unsecureUnlockedFilled: return "\u{f89c}"
        case .unsecureUnlockedLight: return "\u{f89d}"
        case .unsecureUnlockedRegular: return "\u{f89e}"
        case .unsortedBold: return "\u{f89f}"
        case .unsortedLight: return "\u{f8a0}"
        case .unsortedRegular: return "\u{f8a1}"
        case .updateFileShareBold: return "\u{f8a2}"
        case .updateFileShareLight: return "\u{f8a3}"
        case .updateFileShareRegular: return "\u{f8a4}"
        case .upgradeBold: return "\u{f8a5}"
        case .upgradeFilled: return "\u{f8a6}"
        case .upgradeLight: return "\u{f8a7}"
        case .upgradeRegular: return "\u{f8a8}"
        case .uploadBold: return "\u{f8a9}"
        case .uploadLight: return "\u{f8aa}"
        case .uploadRegular: return "\u{f8ab}"
        case .usbBold: return "\u{f8ac}"
        case .usbHeadsetBold: return "\u{f8ad}"
        case .usbHeadsetLight: return "\u{f8ae}"
        case .usbHeadsetMutedBold: return "\u{f8af}"
        case .usbHeadsetMutedLight: return "\u{f8b0}"
        case .usbHeadsetMutedRegular: return "\u{f8b1}"
        case .usbHeadsetRegular: return "\u{f8b2}"
        case .usbLight: return "\u{f8b3}"
        case .usbRegular: return "\u{f8b4}"
        case .userBold: return "\u{f8b5}"
        case .userLight: return "\u{f8b6}"
        case .userRegular: return "\u{f8b7}"
        case .vcsBold: return "\u{f8b8}"
        case .vcsLight: return "\u{f8b9}"
        case .vcsRegular: return "\u{f8ba}"
        case .videoBlurBold: return "\u{f8bb}"
        case .videoBlurFilled: return "\u{f8bc}"
        case .videoBlurLight: return "\u{f8bd}"
        case .videoBlurRegular: return "\u{f8be}"
        case .videoBold: return "\u{f8bf}"
        case .videoEffectBold: return "\u{f8c0}"
        case .videoEffectFilled: return "\u{f8c1}"
        case .videoEffectLight: return "\u{f8c2}"
        case .videoEffectRegular: return "\u{f8c3}"
        case .videoFilled: return "\u{f8c4}"
        case .videoLayoutBold: return "\u{f8c5}"
        case .videoLayoutEqualBold: return "\u{f8c6}"
        case .videoLayoutEqualDualBold: return "\u{f8c7}"
        case .videoLayoutEqualDualLight: return "\u{f8c8}"
        case .videoLayoutEqualDualRegular: return "\u{f8c9}"
        case .videoLayoutEqualFilled: return "\u{f8ca}"
        case .videoLayoutEqualLight: return "\u{f8cb}"
        case .videoLayoutEqualRegular: return "\u{f8cc}"
        case .videoLayoutFilled: return "\u{f8cd}"
        case .videoLayoutLight: return "\u{f8ce}"
        case .videoLayoutOverlayBold: return "\u{f8cf}"
        case .videoLayoutOverlayLight: return "\u{f8d0}"
        case .videoLayoutOverlayRegular: return "\u{f8d1}"
        case .videoLayoutPresenterDominantBold: return "\u{f8d2}"
        case .videoLayoutPresenterDominantLight: return "\u{f8d3}"
        case .videoLayoutPresenterDominantRegular: return "\u{f8d4}"
        case .videoLayoutProminentBold: return "\u{f8d5}"
        case .videoLayoutProminentFilled: return "\u{f8d6}"
        case .videoLayoutProminentLight: return "\u{f8d7}"
        case .videoLayoutProminentRegular: return "\u{f8d8}"
        case .videoLayoutRegular: return "\u{f8d9}"
        case .videoLayoutShareDominantBold: return "\u{f8da}"
        case .videoLayoutShareDominantLight: return "\u{f8db}"
        case .videoLayoutShareDominantRegular: return "\u{f8dc}"
        case .videoLayoutSingleBold: return "\u{f8dd}"
        case .videoLayoutSingleFilled: return "\u{f8de}"
        case .videoLayoutSingleLight: return "\u{f8df}"
        case .videoLayoutSingleRegular: return "\u{f8e0}"
        case .videoLayoutStackBold: return "\u{f8e1}"
        case .videoLayoutStackFilled: return "\u{f8e2}"
        case .videoLayoutStackLight: return "\u{f8e3}"
        case .videoLayoutStackRegular: return "\u{f8e4}"
        case .videoLayoutVideoDominantBold: return "\u{f8e5}"
        case .videoLayoutVideoDominantLight: return "\u{f8e6}"
        case .videoLayoutVideoDominantRegular: return "\u{f8e7}"
        case .videoLight: return "\u{f8e8}"
        case .videoPlusBold: return "\u{f8e9}"
        case .videoPlusFilled: return "\u{f8ea}"
        case .videoPlusLight: return "\u{f8eb}"
        case .videoPlusRegular: return "\u{f8ec}"
        case .videoRegular: return "\u{f8ed}"
        case .videoSpeakerTrackBold: return "\u{f8ee}"
        case .videoSpeakerTrackFilled: return "\u{f8ef}"
        case .videoSpeakerTrackLight: return "\u{f8f0}"
        case .videoSpeakerTrackRegular: return "\u{f8f1}"
        case .viewAllBold: return "\u{f8f2}"
        case .viewAllLight: return "\u{f8f3}"
        case .viewAllRegular: return "\u{f8f4}"
        case .viewListBold: return "\u{f8f5}"
        case .viewListLight: return "\u{f8f6}"
        case .viewListRegular: return "\u{f8f7}"
        case .viewStackedBold: return "\u{f8f8}"
        case .viewStackedLight: return "\u{f8f9}"
        case .viewStackedRegular: return "\u{f8fa}"
        case .viewThumbnailBold: return "\u{f8fb}"
        case .viewThumbnailFilled: return "\u{f8fc}"
        case .viewThumbnailLight: return "\u{f8fd}"
        case .viewThumbnailRegular: return "\u{f8fe}"
        case .voicemailBold: return "\u{f8ff}"
        case .voicemailFilled: return "\u{f900}"
        case .voicemailLight: return "\u{f901}"
        case .voicemailRegular: return "\u{f902}"
        case .wallpaperBold: return "\u{f903}"
        case .wallpaperLight: return "\u{f904}"
        case .wallpaperRegular: return "\u{f905}"
        case .warningBadgeFilled: return "\u{f906}"
        case .warningBold: return "\u{f907}"
        case .warningFilled: return "\u{f908}"
        case .warningLight: return "\u{f909}"
        case .warningRegular: return "\u{f90a}"
        case .webexAssistantActiveColored: return "\u{f90b}"
        case .webexAssistantInactiveColored: return "\u{f90c}"
        case .webexBoardBold: return "\u{f90d}"
        case .webexBoardLight: return "\u{f90e}"
        case .webexBoardRegular: return "\u{f90f}"
        case .webexCodecPlusBold: return "\u{f910}"
        case .webexCodecPlusLight: return "\u{f911}"
        case .webexCodecPlusRegular: return "\u{f912}"
        case .webexDeskCameraBold: return "\u{f913}"
        case .webexDeskCameraLight: return "\u{f914}"
        case .webexDeskCameraRegular: return "\u{f915}"
        case .webexHelixFilled: return "\u{f916}"
        case .webexMeetingsBold: return "\u{f917}"
        case .webexMeetingsFilled: return "\u{f918}"
        case .webexMeetingsLight: return "\u{f919}"
        case .webexMeetingsRegular: return "\u{f91a}"
        case .webexQuadCameraBold: return "\u{f91b}"
        case .webexQuadCameraLight: return "\u{f91c}"
        case .webexQuadCameraRegular: return "\u{f91d}"
        case .webexRoomKitBold: return "\u{f91e}"
        case .webexRoomKitLight: return "\u{f91f}"
        case .webexRoomKitPlusBold: return "\u{f920}"
        case .webexRoomKitPlusLight: return "\u{f921}"
        case .webexRoomKitPlusRegular: return "\u{f922}"
        case .webexRoomKitRegular: return "\u{f923}"
        case .webexShareBold: return "\u{f924}"
        case .webexShareLight: return "\u{f925}"
        case .webexShareRegular: return "\u{f926}"
        case .webexTeamsBold: return "\u{f927}"
        case .webexTeamsFilled: return "\u{f928}"
        case .webexTeamsLight: return "\u{f929}"
        case .webexTeamsNewBold: return "\u{f92a}"
        case .webexTeamsNewFilled: return "\u{f92b}"
        case .webexTeamsNewLight: return "\u{f92c}"
        case .webexTeamsNewRegular: return "\u{f92d}"
        case .webexTeamsRegular: return "\u{f92e}"
        case .whiteboardBold: return "\u{f92f}"
        case .whiteboardContentBold: return "\u{f930}"
        case .whiteboardContentLight: return "\u{f931}"
        case .whiteboardContentRegular: return "\u{f932}"
        case .whiteboardFilled: return "\u{f933}"
        case .whiteboardLight: return "\u{f934}"
        case .whiteboardRegular: return "\u{f935}"
        case .widgetBold: return "\u{f936}"
        case .widgetFilled: return "\u{f937}"
        case .widgetLight: return "\u{f938}"
        case .widgetRegular: return "\u{f939}"
        case .wifiBold: return "\u{f93a}"
        case .wifiErrorBold: return "\u{f93b}"
        case .wifiErrorLight: return "\u{f93c}"
        case .wifiErrorRegular: return "\u{f93d}"
        case .wifiLight: return "\u{f93e}"
        case .wifiRegular: return "\u{f93f}"
        case .wifiSignalGoodColoredBold: return "\u{f940}"
        case .wifiSignalGoodColoredLight: return "\u{f941}"
        case .wifiSignalGoodColoredRegular: return "\u{f942}"
        case .wifiSignalPoorColoredBold: return "\u{f943}"
        case .wifiSignalPoorColoredLight: return "\u{f944}"
        case .wifiSignalPoorColoredRegular: return "\u{f945}"
        case .wifiSignalUnstableColoredBold: return "\u{f946}"
        case .wifiSignalUnstableColoredLight: return "\u{f947}"
        case .wifiSignalUnstableColoredRegular: return "\u{f948}"
        case .windowCornerScrubBold: return "\u{f949}"
        case .windowCornerScrubLight: return "\u{f94a}"
        case .windowCornerScrubRegular: return "\u{f94b}"
        case .windowRightCornerScrubBold: return "\u{f94c}"
        case .windowRightCornerScrubLight: return "\u{f94d}"
        case .windowRightCornerScrubRegular: return "\u{f94e}"
        case .windowVerticalScrubBold: return "\u{f94f}"
        case .windowVerticalScrubLight: return "\u{f950}"
        case .windowVerticalScrubRegular: return "\u{f951}"
        case .workphoneBold: return "\u{f952}"
        case .workphoneLight: return "\u{f953}"
        case .workphoneRegular: return "\u{f954}"
        case .zoomInBold: return "\u{f955}"
        case .zoomInLight: return "\u{f956}"
        case .zoomInRegular: return "\u{f957}"
        case .zoomOutBold: return "\u{f958}"
        case .zoomOutLight: return "\u{f959}"
        case .zoomOutRegular: return "\u{f95a}"
