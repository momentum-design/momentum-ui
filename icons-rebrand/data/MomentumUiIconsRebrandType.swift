...
@objc public enum MomentumIconsRebrandType: Int {
    ...
    public var ligature: String {
        ...
        case .noiseRemovalBold: return "\u{f69d}"
        case .noiseRemovalLight: return "\u{f69e}"
        case .noiseRemovalRegular: return "\u{f69f}"
        case .noteBold: return "\u{f6a0}"
        case .noteLight: return "\u{f6a1}"
        case .notePptBold: return "\u{f6a2}"
        case .notePptLight: return "\u{f6a3}"
        case .notePptRegular: return "\u{f6a4}"
        case .noteRegular: return "\u{f6a5}"
        case .notesBold: return "\u{f6a6}"
        case .notesLight: return "\u{f6a7}"
        case .notesRegular: return "\u{f6a8}"
        case .numberBold: return "\u{f6a9}"
        case .numberLight: return "\u{f6aa}"
        case .numberRegular: return "\u{f6ab}"
        case .oldRemoteBold: return "\u{f6ac}"
        case .oldRemoteLight: return "\u{f6ad}"
        case .oldRemoteRegular: return "\u{f6ae}"
        case .oldTouchBold: return "\u{f6af}"
        case .oldTouchLight: return "\u{f6b0}"
        case .oldTouchRegular: return "\u{f6b1}"
        case .oneColumnBold: return "\u{f6b2}"
        case .oneColumnLight: return "\u{f6b3}"
        case .oneColumnRegular: return "\u{f6b4}"
        case .openInFolderBold: return "\u{f6b5}"
        case .openInFolderLight: return "\u{f6b6}"
        case .openInFolderRegular: return "\u{f6b7}"
        case .openPagesBold: return "\u{f6b8}"
        case .openPagesLight: return "\u{f6b9}"
        case .openPagesRegular: return "\u{f6ba}"
        case .otherNumberBold: return "\u{f6bb}"
        case .otherNumberLight: return "\u{f6bc}"
        case .otherNumberRegular: return "\u{f6bd}"
        case .otherNumberWarningBold: return "\u{f6be}"
        case .otherNumberWarningLight: return "\u{f6bf}"
        case .otherNumberWarningRegular: return "\u{f6c0}"
        case .outgoingCallLegacyBold: return "\u{f6c1}"
        case .outgoingCallLegacyLight: return "\u{f6c2}"
        case .outgoingCallLegacyRegular: return "\u{f6c3}"
        case .overflowLeftBold: return "\u{f6c4}"
        case .overflowLeftLight: return "\u{f6c5}"
        case .overflowLeftRegular: return "\u{f6c6}"
        case .overflowRightBold: return "\u{f6c7}"
        case .overflowRightLight: return "\u{f6c8}"
        case .overflowRightRegular: return "\u{f6c9}"
        case .pairedCameraBold: return "\u{f6ca}"
        case .pairedCameraLight: return "\u{f6cb}"
        case .pairedCameraRegular: return "\u{f6cc}"
        case .pairedDeviceBold: return "\u{f6cd}"
        case .pairedDeviceLight: return "\u{f6ce}"
        case .pairedDeviceRegular: return "\u{f6cf}"
        case .pairedHandsetBold: return "\u{f6d0}"
        case .pairedHandsetLight: return "\u{f6d1}"
        case .pairedHandsetRegular: return "\u{f6d2}"
        case .pairingBold: return "\u{f6d3}"
        case .pairingLight: return "\u{f6d4}"
        case .pairingRegular: return "\u{f6d5}"
        case .parkedBold: return "\u{f6d6}"
        case .parkedFilled: return "\u{f6d7}"
        case .parkedLight: return "\u{f6d8}"
        case .parkedRegular: return "\u{f6d9}"
        case .parseBold: return "\u{f6da}"
        case .parseLight: return "\u{f6db}"
        case .parseRegular: return "\u{f6dc}"
        case .partialBold: return "\u{f6dd}"
        case .partialLight: return "\u{f6de}"
        case .partialRegular: return "\u{f6df}"
        case .participantAddBold: return "\u{f6e0}"
        case .participantAddLight: return "\u{f6e1}"
        case .participantAddRegular: return "\u{f6e2}"
        case .participantBlockedBold: return "\u{f6e3}"
        case .participantBlockedLight: return "\u{f6e4}"
        case .participantBlockedRegular: return "\u{f6e5}"
        case .participantBold: return "\u{f6e6}"
        case .participantFilled: return "\u{f6e7}"
        case .participantLight: return "\u{f6e8}"
        case .participantListBold: return "\u{f6e9}"
        case .participantListFilled: return "\u{f6ea}"
        case .participantListLight: return "\u{f6eb}"
        case .participantListRegular: return "\u{f6ec}"
        case .participantRegular: return "\u{f6ed}"
        case .participantRemoveBold: return "\u{f6ee}"
        case .participantRemoveLight: return "\u{f6ef}"
        case .participantRemoveRegular: return "\u{f6f0}"
        case .participantUnknownBold: return "\u{f6f1}"
        case .participantUnknownLight: return "\u{f6f2}"
        case .participantUnknownRegular: return "\u{f6f3}"
        case .passMouseBold: return "\u{f6f4}"
        case .passMouseLight: return "\u{f6f5}"
        case .passMouseRegular: return "\u{f6f6}"
        case .pauseBold: return "\u{f6f7}"
        case .pauseFilled: return "\u{f6f8}"
        case .pauseLight: return "\u{f6f9}"
        case .pauseRegular: return "\u{f6fa}"
        case .penBold: return "\u{f6fb}"
        case .penFilled: return "\u{f6fc}"
        case .penLight: return "\u{f6fd}"
        case .penRegular: return "\u{f6fe}"
        case .peopleBold: return "\u{f6ff}"
        case .peopleCircleBold: return "\u{f700}"
        case .peopleCircleFilled: return "\u{f701}"
        case .peopleCircleLight: return "\u{f702}"
        case .peopleCircleRegular: return "\u{f703}"
        case .peopleFilled: return "\u{f704}"
        case .peopleInsightsFilled: return "\u{f705}"
        case .peopleLight: return "\u{f706}"
        case .peopleRegular: return "\u{f707}"
        case .phoneAlertBold: return "\u{f708}"
        case .phoneAlertLight: return "\u{f709}"
        case .phoneAlertRegular: return "\u{f70a}"
        case .phoneBold: return "\u{f70b}"
        case .phoneFilled: return "\u{f70c}"
        case .phoneLight: return "\u{f70d}"
        case .phoneMutedBold: return "\u{f70e}"
        case .phoneMutedLight: return "\u{f70f}"
        case .phoneMutedRegular: return "\u{f710}"
        case .phonePrivateBold: return "\u{f711}"
        case .phonePrivateLight: return "\u{f712}"
        case .phonePrivateRegular: return "\u{f713}"
        case .phoneRegular: return "\u{f714}"
        case .phoneReplyAllBold: return "\u{f715}"
        case .phoneReplyAllLight: return "\u{f716}"
        case .phoneReplyAllRegular: return "\u{f717}"
        case .phoneReplyBold: return "\u{f718}"
        case .phoneReplyLight: return "\u{f719}"
        case .phoneReplyRegular: return "\u{f71a}"
        case .phoneSmallFilled: return "\u{f71b}"
        case .pickerBold: return "\u{f71c}"
        case .pickerLight: return "\u{f71d}"
        case .pickerRegular: return "\u{f71e}"
        case .pictureInPictureBold: return "\u{f71f}"
        case .pictureInPictureLight: return "\u{f720}"
        case .pictureInPictureRegular: return "\u{f721}"
        case .pieChartBold: return "\u{f722}"
        case .pieChartFilled: return "\u{f723}"
        case .pieChartLight: return "\u{f724}"
        case .pieChartRegular: return "\u{f725}"
        case .pinBold: return "\u{f726}"
        case .pinFilled: return "\u{f727}"
        case .pinLight: return "\u{f728}"
        case .pinListActivityBold: return "\u{f729}"
        case .pinListActivityColoredBold: return "\u{f72a}"
        case .pinListActivityColoredLight: return "\u{f72b}"
        case .pinListActivityColoredRegular: return "\u{f72c}"
        case .pinListActivityLight: return "\u{f72d}"
        case .pinListActivityRegular: return "\u{f72e}"
        case .pinListBold: return "\u{f72f}"
        case .pinListLight: return "\u{f730}"
        case .pinListRegular: return "\u{f731}"
        case .pinMutedBold: return "\u{f732}"
        case .pinMutedFilled: return "\u{f733}"
        case .pinMutedLight: return "\u{f734}"
        case .pinMutedRegular: return "\u{f735}"
        case .pinRegular: return "\u{f736}"
        case .placeholderBold: return "\u{f737}"
        case .placeholderLight: return "\u{f738}"
        case .placeholderRegular: return "\u{f739}"
        case .playBold: return "\u{f73a}"
        case .playFilled: return "\u{f73b}"
        case .playLight: return "\u{f73c}"
        case .playRegular: return "\u{f73d}"
        case .plugAcBold: return "\u{f73e}"
        case .plugAcLight: return "\u{f73f}"
        case .plugAcRegular: return "\u{f740}"
        case .plusBold: return "\u{f741}"
        case .plusCircleBold: return "\u{f742}"
        case .plusCircleFilled: return "\u{f743}"
        case .plusCircleLight: return "\u{f744}"
        case .plusCircleRegular: return "\u{f745}"
        case .plusLight: return "\u{f746}"
        case .plusRegular: return "\u{f747}"
        case .pmrBold: return "\u{f748}"
        case .pmrFilled: return "\u{f749}"
        case .pmrLight: return "\u{f74a}"
        case .pmrRegular: return "\u{f74b}"
        case .pollBold: return "\u{f74c}"
        case .pollLight: return "\u{f74d}"
        case .pollRegular: return "\u{f74e}"
        case .popInBold: return "\u{f74f}"
        case .popInLight: return "\u{f750}"
        case .popInRegular: return "\u{f751}"
        case .popOutBold: return "\u{f752}"
        case .popOutLight: return "\u{f753}"
        case .popOutRegular: return "\u{f754}"
        case .popUpBold: return "\u{f755}"
        case .popUpLight: return "\u{f756}"
        case .popUpRegular: return "\u{f757}"
        case .portraitLandscapeBold: return "\u{f758}"
        case .portraitLandscapeLight: return "\u{f759}"
        case .portraitLandscapeRegular: return "\u{f75a}"
        case .powerAcBold: return "\u{f75b}"
        case .powerAcLight: return "\u{f75c}"
        case .powerAcRegular: return "\u{f75d}"
        case .powerBold: return "\u{f75e}"
        case .powerLight: return "\u{f75f}"
        case .powerRegular: return "\u{f760}"
        case .preHeaderBold: return "\u{f761}"
        case .preHeaderLight: return "\u{f762}"
        case .preHeaderRegular: return "\u{f763}"
        case .presentationBold: return "\u{f764}"
        case .presentationLight: return "\u{f765}"
        case .presentationRegular: return "\u{f766}"
        case .primaryParticipantBold: return "\u{f767}"
        case .primaryParticipantLight: return "\u{f768}"
        case .primaryParticipantRegular: return "\u{f769}"
        case .printBold: return "\u{f76a}"
        case .printLight: return "\u{f76b}"
        case .printRegular: return "\u{f76c}"
        case .priorityBadgeFilled: return "\u{f76d}"
        case .priorityCircleBold: return "\u{f76e}"
        case .priorityCircleFilled: return "\u{f76f}"
        case .priorityCircleLight: return "\u{f770}"
        case .priorityCircleRegular: return "\u{f771}"
        case .priorityCircleTwoBold: return "\u{f772}"
        case .priorityCircleTwoFilled: return "\u{f773}"
        case .priorityCircleTwoLight: return "\u{f774}"
        case .priorityCircleTwoRegular: return "\u{f775}"
        case .privacyCircleBold: return "\u{f776}"
        case .privacyCircleFilled: return "\u{f777}"
        case .privacyCircleLight: return "\u{f778}"
        case .privacyCircleRegular: return "\u{f779}"
        case .privateBold: return "\u{f77a}"
        case .privateCircleBold: return "\u{f77b}"
        case .privateCircleFilled: return "\u{f77c}"
        case .privateCircleLight: return "\u{f77d}"
        case .privateCircleRegular: return "\u{f77e}"
        case .privateLight: return "\u{f77f}"
        case .privateMeetingBold: return "\u{f780}"
        case .privateMeetingLight: return "\u{f781}"
        case .privateMeetingRegular: return "\u{f782}"
        case .privateRegular: return "\u{f783}"
        case .productDemoBold: return "\u{f784}"
        case .productDemoLight: return "\u{f785}"
        case .productDemoRegular: return "\u{f786}"
        case .proximityBold: return "\u{f787}"
        case .proximityLight: return "\u{f788}"
        case .proximityMutedBold: return "\u{f789}"
        case .proximityMutedLight: return "\u{f78a}"
        case .proximityMutedRegular: return "\u{f78b}"
        case .proximityRegular: return "\u{f78c}"
        case .proximityVideoBold: return "\u{f78d}"
        case .proximityVideoLight: return "\u{f78e}"
        case .proximityVideoRegular: return "\u{f78f}"
        case .ptoPresenceBold: return "\u{f790}"
        case .ptoPresenceFilled: return "\u{f791}"
        case .ptoPresenceLight: return "\u{f792}"
        case .ptoPresenceRegular: return "\u{f793}"
        case .pullCallBold: return "\u{f794}"
        case .pullCallLight: return "\u{f795}"
        case .pullCallRegular: return "\u{f796}"
        case .qABold: return "\u{f797}"
        case .qALight: return "\u{f798}"
        case .qARegular: return "\u{f799}"
        case .qualityBold: return "\u{f79a}"
        case .qualityLight: return "\u{f79b}"
        case .qualityRegular: return "\u{f79c}"
        case .queueContactBold: return "\u{f79d}"
        case .queueContactLight: return "\u{f79e}"
        case .queueContactRegular: return "\u{f79f}"
        case .quietBold: return "\u{f7a0}"
        case .quietHoursPresenceBold: return "\u{f7a1}"
        case .quietHoursPresenceFilled: return "\u{f7a2}"
        case .quietHoursPresenceLight: return "\u{f7a3}"
        case .quietHoursPresenceRegular: return "\u{f7a4}"
        case .quietLight: return "\u{f7a5}"
        case .quietRegular: return "\u{f7a6}"
        case .radioButtonGroupBold: return "\u{f7a7}"
        case .radioButtonGroupLight: return "\u{f7a8}"
        case .radioButtonGroupRegular: return "\u{f7a9}"
        case .raiseHandBold: return "\u{f7aa}"
        case .raiseHandLight: return "\u{f7ab}"
        case .raiseHandRegular: return "\u{f7ac}"
        case .ramBold: return "\u{f7ad}"
        case .ramLight: return "\u{f7ae}"
        case .ramRegular: return "\u{f7af}"
        case .reactionsBold: return "\u{f7b0}"
        case .reactionsFilled: return "\u{f7b1}"
        case .reactionsLight: return "\u{f7b2}"
        case .reactionsRegular: return "\u{f7b3}"
        case .reactivateBold: return "\u{f7b4}"
        case .reactivateLight: return "\u{f7b5}"
        case .reactivateRegular: return "\u{f7b6}"
        case .recentsBold: return "\u{f7b7}"
        case .recentsFilled: return "\u{f7b8}"
        case .recentsLight: return "\u{f7b9}"
        case .recentsPresenceBold: return "\u{f7ba}"
        case .recentsPresenceFilled: return "\u{f7bb}"
        case .recentsPresenceLight: return "\u{f7bc}"
        case .recentsPresenceRegular: return "\u{f7bd}"
        case .recentsPresenceSmallFilled: return "\u{f7be}"
        case .recentsRegular: return "\u{f7bf}"
        case .recordBold: return "\u{f7c0}"
        case .recordFilled: return "\u{f7c1}"
        case .recordLight: return "\u{f7c2}"
        case .recordPausedBold: return "\u{f7c3}"
        case .recordPausedFilled: return "\u{f7c4}"
        case .recordPausedLight: return "\u{f7c5}"
        case .recordPausedRegular: return "\u{f7c6}"
        case .recordRegular: return "\u{f7c7}"
        case .recurringBold: return "\u{f7c8}"
        case .recurringLight: return "\u{f7c9}"
        case .recurringOffBold: return "\u{f7ca}"
        case .recurringOffLight: return "\u{f7cb}"
        case .recurringOffRegular: return "\u{f7cc}"
        case .recurringRegular: return "\u{f7cd}"
        case .redialBold: return "\u{f7ce}"
        case .redialLight: return "\u{f7cf}"
        case .redialRegular: return "\u{f7d0}"
        case .redoBold: return "\u{f7d1}"
        case .redoLight: return "\u{f7d2}"
        case .redoRegular: return "\u{f7d3}"
        case .refreshBold: return "\u{f7d4}"
        case .refreshLight: return "\u{f7d5}"
        case .refreshRegular: return "\u{f7d6}"
        case .remoteCallBold: return "\u{f7d7}"
        case .remoteCallFilled: return "\u{f7d8}"
        case .remoteCallLight: return "\u{f7d9}"
        case .remoteCallRegular: return "\u{f7da}"
        case .remoteDesktopControlBold: return "\u{f7db}"
        case .remoteDesktopControlFilled: return "\u{f7dc}"
        case .remoteDesktopControlLight: return "\u{f7dd}"
        case .remoteDesktopControlRegular: return "\u{f7de}"
        case .removeBold: return "\u{f7df}"
        case .removeFilled: return "\u{f7e0}"
        case .removeLight: return "\u{f7e1}"
        case .removeRegular: return "\u{f7e2}"
        case .replyBold: return "\u{f7e3}"
        case .replyFilled: return "\u{f7e4}"
        case .replyLight: return "\u{f7e5}"
        case .replyListBold: return "\u{f7e6}"
        case .replyListLight: return "\u{f7e7}"
        case .replyListRegular: return "\u{f7e8}"
        case .replyRegular: return "\u{f7e9}"
        case .resetBold: return "\u{f7ea}"
        case .resetLight: return "\u{f7eb}"
        case .resetRegular: return "\u{f7ec}"
        case .responsiveMobileBold: return "\u{f7ed}"
        case .responsiveMobileLight: return "\u{f7ee}"
        case .responsiveMobileRegular: return "\u{f7ef}"
        case .restartBold: return "\u{f7f0}"
        case .restartLight: return "\u{f7f1}"
        case .restartRegular: return "\u{f7f2}"
        case .retrieveCallBold: return "\u{f7f3}"
        case .retrieveCallLight: return "\u{f7f4}"
        case .retrieveCallRegular: return "\u{f7f5}"
        case .returnBold: return "\u{f7f6}"
        case .returnLight: return "\u{f7f7}"
        case .returnRegular: return "\u{f7f8}"
        case .ringtoneBold: return "\u{f7f9}"
        case .ringtoneLight: return "\u{f7fa}"
        case .ringtoneRegular: return "\u{f7fb}"
        case .roomCalendarBold: return "\u{f7fc}"
        case .roomCalendarLight: return "\u{f7fd}"
        case .roomCalendarRegular: return "\u{f7fe}"
        case .roomLightsBold: return "\u{f7ff}"
        case .roomLightsFilled: return "\u{f800}"
        case .roomLightsLight: return "\u{f801}"
        case .roomLightsRegular: return "\u{f802}"
        case .rotateContentBold: return "\u{f803}"
        case .rotateContentFilled: return "\u{f804}"
        case .rotateContentLight: return "\u{f805}"
        case .rotateContentRegular: return "\u{f806}"
        case .ruleBasedBold: return "\u{f807}"
        case .ruleBasedLight: return "\u{f808}"
        case .ruleBasedRegular: return "\u{f809}"
        case .runningApplicationBold: return "\u{f80a}"
        case .runningApplicationFilled: return "\u{f80b}"
        case .runningApplicationLight: return "\u{f80c}"
        case .runningApplicationRegular: return "\u{f80d}"
        case .saveBold: return "\u{f80e}"
        case .saveLight: return "\u{f80f}"
        case .saveRegular: return "\u{f810}"
        case .scanBold: return "\u{f811}"
        case .scanLight: return "\u{f812}"
        case .scanRegular: return "\u{f813}"
        case .schedulerAvailableBold: return "\u{f814}"
        case .schedulerAvailableLight: return "\u{f815}"
        case .schedulerAvailableRegular: return "\u{f816}"
        case .schedulerNotWorkingHoursBold: return "\u{f817}"
        case .schedulerNotWorkingHoursLight: return "\u{f818}"
        case .schedulerNotWorkingHoursRegular: return "\u{f819}"
        case .schedulerUnavailableBold: return "\u{f81a}"
        case .schedulerUnavailableLight: return "\u{f81b}"
        case .schedulerUnavailableRegular: return "\u{f81c}"
        case .schedulerUnknownBold: return "\u{f81d}"
        case .schedulerUnknownLight: return "\u{f81e}"
        case .schedulerUnknownRegular: return "\u{f81f}"
        case .screenshotBold: return "\u{f820}"
        case .screenshotDocBold: return "\u{f821}"
        case .screenshotDocFilled: return "\u{f822}"
        case .screenshotDocLight: return "\u{f823}"
        case .screenshotDocRegular: return "\u{f824}"
        case .screenshotLight: return "\u{f825}"
        case .screenshotRegular: return "\u{f826}"
        case .searchBold: return "\u{f827}"
        case .searchFilled: return "\u{f828}"
        case .searchLight: return "\u{f829}"
        case .searchRegular: return "\u{f82a}"
        case .secondaryArrowBold: return "\u{f82b}"
        case .secondaryArrowLight: return "\u{f82c}"
        case .secondaryArrowRegular: return "\u{f82d}"
        case .secureCallLockBold: return "\u{f82e}"
        case .secureCallLockFilled: return "\u{f82f}"
        case .secureCallLockLight: return "\u{f830}"
        case .secureCallLockRegular: return "\u{f831}"
        case .secureCallShieldBold: return "\u{f832}"
        case .secureCallShieldFilled: return "\u{f833}"
        case .secureCallShieldLight: return "\u{f834}"
        case .secureCallShieldRegular: return "\u{f835}"
        case .secureCircleBold: return "\u{f836}"
        case .secureCircleFilled: return "\u{f837}"
        case .secureCircleLight: return "\u{f838}"
        case .secureCircleRegular: return "\u{f839}"
        case .secureLockBold: return "\u{f83a}"
        case .secureLockFilled: return "\u{f83b}"
        case .secureLockLight: return "\u{f83c}"
        case .secureLockRegular: return "\u{f83d}"
        case .selectAllBold: return "\u{f83e}"
        case .selectAllFilled: return "\u{f83f}"
        case .selectAllLight: return "\u{f840}"
        case .selectAllRegular: return "\u{f841}"
        case .selectionBold: return "\u{f842}"
        case .selectionLight: return "\u{f843}"
        case .selectionRegular: return "\u{f844}"
        case .sendBold: return "\u{f845}"
        case .sendFilled: return "\u{f846}"
        case .sendLight: return "\u{f847}"
        case .sendRegular: return "\u{f848}"
        case .serverBold: return "\u{f849}"
        case .serverErrorBold: return "\u{f84a}"
        case .serverErrorLight: return "\u{f84b}"
        case .serverErrorRegular: return "\u{f84c}"
        case .serverLight: return "\u{f84d}"
        case .serverRegular: return "\u{f84e}"
        case .servicesBold: return "\u{f84f}"
        case .servicesLight: return "\u{f850}"
        case .servicesRegular: return "\u{f851}"
        case .setVariableBold: return "\u{f852}"
        case .setVariableLight: return "\u{f853}"
        case .setVariableRegular: return "\u{f854}"
        case .settingsBold: return "\u{f855}"
        case .settingsFilled: return "\u{f856}"
        case .settingsLight: return "\u{f857}"
        case .settingsRegular: return "\u{f858}"
        case .setupAssistantBold: return "\u{f859}"
        case .setupAssistantLight: return "\u{f85a}"
        case .setupAssistantRegular: return "\u{f85b}"
        case .sftpBold: return "\u{f85c}"
        case .sftpLight: return "\u{f85d}"
        case .sftpRegular: return "\u{f85e}"
        case .shapeCircleBold: return "\u{f85f}"
        case .shapeCircleFilled: return "\u{f860}"
        case .shapeCircleLight: return "\u{f861}"
        case .shapeCircleRegular: return "\u{f862}"
        case .shapeDiagonalLineBold: return "\u{f863}"
        case .shapeDiagonalLineLight: return "\u{f864}"
        case .shapeDiagonalLineRegular: return "\u{f865}"
        case .shapeDiamondBold: return "\u{f866}"
        case .shapeDiamondFilled: return "\u{f867}"
        case .shapeDiamondLight: return "\u{f868}"
        case .shapeDiamondRegular: return "\u{f869}"
        case .shapeOvalBold: return "\u{f86a}"
        case .shapeOvalLight: return "\u{f86b}"
        case .shapeOvalRegular: return "\u{f86c}"
        case .shapeSquareBold: return "\u{f86d}"
        case .shapeSquareFilled: return "\u{f86e}"
        case .shapeSquareLight: return "\u{f86f}"
        case .shapeSquareRegular: return "\u{f870}"
        case .shapeTriangleBold: return "\u{f871}"
        case .shapeTriangleFilled: return "\u{f872}"
        case .shapeTriangleLight: return "\u{f873}"
        case .shapeTriangleRegular: return "\u{f874}"
        case .shapesBold: return "\u{f875}"
        case .shapesLight: return "\u{f876}"
        case .shapesRegular: return "\u{f877}"
        case .shareCNativeAdrBold: return "\u{f878}"
        case .shareCNativeAdrLight: return "\u{f879}"
        case .shareCNativeAdrRegular: return "\u{f87a}"
        case .shareCNativeIphBold: return "\u{f87b}"
        case .shareCNativeIphLight: return "\u{f87c}"
        case .shareCNativeIphRegular: return "\u{f87d}"
        case .shareScreenBold: return "\u{f87e}"
        case .shareScreenFilled: return "\u{f87f}"
        case .shareScreenLight: return "\u{f880}"
        case .shareScreenRegular: return "\u{f881}"
        case .shareScreenSmallFilled: return "\u{f882}"
        case .shareSpaceBold: return "\u{f883}"
        case .shareSpaceLight: return "\u{f884}"
        case .shareSpaceRegular: return "\u{f885}"
        case .shieldBold: return "\u{f886}"
        case .shieldLight: return "\u{f887}"
        case .shieldRegular: return "\u{f888}"
        case .shortTextBoxBold: return "\u{f889}"
        case .shortTextBoxLight: return "\u{f88a}"
        case .shortTextBoxRegular: return "\u{f88b}"
        case .showBold: return "\u{f88c}"
        case .showFilled: return "\u{f88d}"
        case .showLight: return "\u{f88e}"
        case .showRegular: return "\u{f88f}"
        case .signInBold: return "\u{f890}"
        case .signInFilled: return "\u{f891}"
        case .signInForcedBold: return "\u{f892}"
        case .signInForcedLight: return "\u{f893}"
        case .signInForcedRegular: return "\u{f894}"
        case .signInLight: return "\u{f895}"
        case .signInRegular: return "\u{f896}"
        case .signOutBold: return "\u{f897}"
        case .signOutLight: return "\u{f898}"
        case .signOutRegular: return "\u{f899}"
        case .signal0Bold: return "\u{f89a}"
        case .signal0Light: return "\u{f89b}"
        case .signal0Regular: return "\u{f89c}"
        case .signal100Bold: return "\u{f89d}"
        case .signal100Light: return "\u{f89e}"
        case .signal100Regular: return "\u{f89f}"
        case .signal25Bold: return "\u{f8a0}"
        case .signal25Light: return "\u{f8a1}"
        case .signal25Regular: return "\u{f8a2}"
        case .signal50Bold: return "\u{f8a3}"
        case .signal50Light: return "\u{f8a4}"
        case .signal50Regular: return "\u{f8a5}"
        case .signal75Bold: return "\u{f8a6}"
        case .signal75Light: return "\u{f8a7}"
        case .signal75Regular: return "\u{f8a8}"
        case .simplePromotionBold: return "\u{f8a9}"
        case .simplePromotionLight: return "\u{f8aa}"
        case .simplePromotionRegular: return "\u{f8ab}"
        case .singleNumberReachBold: return "\u{f8ac}"
        case .singleNumberReachLight: return "\u{f8ad}"
        case .singleNumberReachRegular: return "\u{f8ae}"
        case .sipRegistrationInProgressBold: return "\u{f8af}"
        case .sipRegistrationInProgressFilled: return "\u{f8b0}"
        case .sipRegistrationInProgressLight: return "\u{f8b1}"
        case .sipRegistrationInProgressRegular: return "\u{f8b2}"
        case .skipBold: return "\u{f8b3}"
        case .skipBwBold: return "\u{f8b4}"
        case .skipBwFilled: return "\u{f8b5}"
        case .skipBwLight: return "\u{f8b6}"
        case .skipBwRegular: return "\u{f8b7}"
        case .skipFwBold: return "\u{f8b8}"
        case .skipFwFilled: return "\u{f8b9}"
        case .skipFwLight: return "\u{f8ba}"
        case .skipFwRegular: return "\u{f8bb}"
        case .skipLight: return "\u{f8bc}"
        case .skipRegular: return "\u{f8bd}"
        case .smsInboundBold: return "\u{f8be}"
        case .smsInboundLight: return "\u{f8bf}"
        case .smsInboundRegular: return "\u{f8c0}"
        case .socialAlexaFilled: return "\u{f8c1}"
        case .socialFacebookColoredFilled: return "\u{f8c2}"
        case .socialFacebookFilled: return "\u{f8c3}"
        case .socialFbmessengerColoredFilled: return "\u{f8c4}"
        case .socialFbmessengerFilled: return "\u{f8c5}"
        case .socialInstagramBold: return "\u{f8c6}"
        case .socialMicrosoftColoredFilled: return "\u{f8c7}"
        case .socialMicrosoftFilled: return "\u{f8c8}"
        case .socialMmsFilled: return "\u{f8c9}"
        case .socialMmsGoldFilled: return "\u{f8ca}"
        case .socialSmsFilled: return "\u{f8cb}"
        case .socialSmsMintFilled: return "\u{f8cc}"
        case .socialTwitterColoredFilled: return "\u{f8cd}"
        case .socialTwitterFilled: return "\u{f8ce}"
        case .socialViberBold: return "\u{f8cf}"
        case .socialViberColoredBold: return "\u{f8d0}"
        case .socialWhatsappBold: return "\u{f8d1}"
        case .socialWhatsappColoredFilled: return "\u{f8d2}"
        case .sortAscendingBold: return "\u{f8d3}"
        case .sortAscendingLight: return "\u{f8d4}"
        case .sortAscendingRegular: return "\u{f8d5}"
        case .sortDescendingBold: return "\u{f8d6}"
        case .sortDescendingLight: return "\u{f8d7}"
        case .sortDescendingRegular: return "\u{f8d8}"
        case .soundDefaultBold: return "\u{f8d9}"
        case .soundDefaultLight: return "\u{f8da}"
        case .soundDefaultRegular: return "\u{f8db}"
        case .speakerBold: return "\u{f8dc}"
        case .speakerDisconnectedBold: return "\u{f8dd}"
        case .speakerDisconnectedFilled: return "\u{f8de}"
        case .speakerDisconnectedLight: return "\u{f8df}"
        case .speakerDisconnectedRegular: return "\u{f8e0}"
        case .speakerFilled: return "\u{f8e1}"
        case .speakerLight: return "\u{f8e2}"
        case .speakerMutedBold: return "\u{f8e3}"
        case .speakerMutedFilled: return "\u{f8e4}"
        case .speakerMutedLight: return "\u{f8e5}"
        case .speakerMutedRegular: return "\u{f8e6}"
        case .speakerOffBold: return "\u{f8e7}"
        case .speakerOffFilled: return "\u{f8e8}"
        case .speakerOffLight: return "\u{f8e9}"
        case .speakerOffRegular: return "\u{f8ea}"
        case .speakerOnColoredBold: return "\u{f8eb}"
        case .speakerOnColoredLight: return "\u{f8ec}"
        case .speakerOnColoredRegular: return "\u{f8ed}"
        case .speakerRegular: return "\u{f8ee}"
        case .speakerTurnDownBold: return "\u{f8ef}"
        case .speakerTurnDownFilled: return "\u{f8f0}"
        case .speakerTurnDownLight: return "\u{f8f1}"
        case .speakerTurnDownRegular: return "\u{f8f2}"
        case .speakerTurnUpBold: return "\u{f8f3}"
        case .speakerTurnUpFilled: return "\u{f8f4}"
        case .speakerTurnUpLight: return "\u{f8f5}"
        case .speakerTurnUpRegular: return "\u{f8f6}"
        case .spinnerBold: return "\u{f8f7}"
        case .spinnerFilledBold: return "\u{f8f8}"
        case .spinnerFilledLight: return "\u{f8f9}"
        case .spinnerFilledRegular: return "\u{f8fa}"
        case .spinnerLight: return "\u{f8fb}"
        case .spinnerPartialBold: return "\u{f8fc}"
        case .spinnerPartialLight: return "\u{f8fd}"
        case .spinnerPartialRegular: return "\u{f8fe}"
        case .spinnerRegular: return "\u{f8ff}"
        case .stackedArea100ChartBold: return "\u{f900}"
        case .stackedArea100ChartFilled: return "\u{f901}"
        case .stackedArea100ChartLight: return "\u{f902}"
        case .stackedArea100ChartRegular: return "\u{f903}"
        case .stackedAreaChartBold: return "\u{f904}"
        case .stackedAreaChartFilled: return "\u{f905}"
        case .stackedAreaChartLight: return "\u{f906}"
        case .stackedAreaChartRegular: return "\u{f907}"
        case .stackedBar100ChartBold: return "\u{f908}"
        case .stackedBar100ChartFilled: return "\u{f909}"
        case .stackedBar100ChartLight: return "\u{f90a}"
        case .stackedBar100ChartRegular: return "\u{f90b}"
        case .stackedBarChartBold: return "\u{f90c}"
        case .stackedBarChartFilled: return "\u{f90d}"
        case .stackedBarChartLight: return "\u{f90e}"
        case .stackedBarChartRegular: return "\u{f90f}"
        case .startChatBold: return "\u{f910}"
        case .startChatLight: return "\u{f911}"
        case .startChatRegular: return "\u{f912}"
        case .stethoscopeBold: return "\u{f913}"
        case .stethoscopeLight: return "\u{f914}"
        case .stethoscopeRegular: return "\u{f915}"
        case .stickersBold: return "\u{f916}"
        case .stickersLight: return "\u{f917}"
        case .stickersRegular: return "\u{f918}"
        case .stickiesBold: return "\u{f919}"
        case .stickiesLight: return "\u{f91a}"
        case .stickiesRegular: return "\u{f91b}"
        case .stopBold: return "\u{f91c}"
        case .stopCircleBold: return "\u{f91d}"
        case .stopCircleFilled: return "\u{f91e}"
        case .stopCircleLight: return "\u{f91f}"
        case .stopCircleRegular: return "\u{f920}"
        case .stopContentShareBold: return "\u{f921}"
        case .stopContentShareLight: return "\u{f922}"
        case .stopContentShareRegular: return "\u{f923}"
        case .stopFilled: return "\u{f924}"
        case .stopLight: return "\u{f925}"
        case .stopRegular: return "\u{f926}"
        case .storedInfoBold: return "\u{f927}"
        case .storedInfoFilled: return "\u{f928}"
        case .storedInfoLight: return "\u{f929}"
        case .storedInfoRegular: return "\u{f92a}"
        case .streamingBold: return "\u{f92b}"
        case .streamingLight: return "\u{f92c}"
        case .streamingRegular: return "\u{f92d}"
        case .strikethroughBold: return "\u{f92e}"
        case .strikethroughLight: return "\u{f92f}"
        case .strikethroughRegular: return "\u{f930}"
        case .subscriptBold: return "\u{f931}"
        case .subscriptLight: return "\u{f932}"
        case .subscriptRegular: return "\u{f933}"
        case .superscriptBold: return "\u{f934}"
        case .superscriptLight: return "\u{f935}"
        case .superscriptRegular: return "\u{f936}"
        case .sx10Bold: return "\u{f937}"
        case .sx10Light: return "\u{f938}"
        case .sx10Regular: return "\u{f939}"
        case .sx20Bold: return "\u{f93a}"
        case .sx20Light: return "\u{f93b}"
        case .sx20Regular: return "\u{f93c}"
        case .sx80CodecBold: return "\u{f93d}"
        case .sx80CodecLight: return "\u{f93e}"
        case .sx80CodecRegular: return "\u{f93f}"
        case .tableBold: return "\u{f940}"
        case .tableLight: return "\u{f941}"
        case .tableRegular: return "\u{f942}"
        case .tabletBold: return "\u{f943}"
        case .tabletLight: return "\u{f944}"
        case .tabletRegular: return "\u{f945}"
        case .tabsBold: return "\u{f946}"
        case .tabsLight: return "\u{f947}"
        case .tabsRegular: return "\u{f948}"
        case .tagBold: return "\u{f949}"
        case .tagLight: return "\u{f94a}"
        case .tagRegular: return "\u{f94b}"
        case .tapBold: return "\u{f94c}"
        case .tapFilled: return "\u{f94d}"
        case .tapLight: return "\u{f94e}"
        case .tapRegular: return "\u{f94f}"
        case .telepresenceAlertBold: return "\u{f950}"
        case .telepresenceAlertLight: return "\u{f951}"
        case .telepresenceAlertMutedBold: return "\u{f952}"
        case .telepresenceAlertMutedLight: return "\u{f953}"
        case .telepresenceAlertMutedRegular: return "\u{f954}"
        case .telepresenceAlertRegular: return "\u{f955}"
        case .telepresenceBold: return "\u{f956}"
        case .telepresenceIx5000Bold: return "\u{f957}"
        case .telepresenceIx5000Light: return "\u{f958}"
        case .telepresenceIx5000Regular: return "\u{f959}"
        case .telepresenceLight: return "\u{f95a}"
        case .telepresencePrivateBold: return "\u{f95b}"
        case .telepresencePrivateLight: return "\u{f95c}"
        case .telepresencePrivateRegular: return "\u{f95d}"
        case .telepresenceRegular: return "\u{f95e}"
        case .temperatureBold: return "\u{f95f}"
        case .temperatureLight: return "\u{f960}"
        case .temperatureRegular: return "\u{f961}"
        case .textAlignCenterBold: return "\u{f962}"
        case .textAlignCenterFilled: return "\u{f963}"
        case .textAlignCenterLight: return "\u{f964}"
        case .textAlignCenterRegular: return "\u{f965}"
        case .textAlignLeftBold: return "\u{f966}"
        case .textAlignLeftFilled: return "\u{f967}"
        case .textAlignLeftLight: return "\u{f968}"
        case .textAlignLeftRegular: return "\u{f969}"
        case .textAlignRightBold: return "\u{f96a}"
        case .textAlignRightFilled: return "\u{f96b}"
        case .textAlignRightLight: return "\u{f96c}"
        case .textAlignRightRegular: return "\u{f96d}"
        case .textBold: return "\u{f96e}"
        case .textCodeBlockBold: return "\u{f96f}"
        case .textCodeBlockLight: return "\u{f970}"
        case .textCodeBlockRegular: return "\u{f971}"
        case .textHighlightBold: return "\u{f972}"
        case .textHighlightLight: return "\u{f973}"
        case .textHighlightRegular: return "\u{f974}"
        case .textLight: return "\u{f975}"
        case .textRegular: return "\u{f976}"
        case .threeColumnBold: return "\u{f977}"
        case .threeColumnLight: return "\u{f978}"
        case .threeColumnRegular: return "\u{f979}"
        case .threeDObjectBold: return "\u{f97a}"
        case .threeDObjectLight: return "\u{f97b}"
        case .threeDObjectRegular: return "\u{f97c}"
        case .tooFastBold: return "\u{f97d}"
        case .tooFastLight: return "\u{f97e}"
        case .tooFastRegular: return "\u{f97f}"
        case .tooSlowBold: return "\u{f980}"
        case .tooSlowLight: return "\u{f981}"
        case .tooSlowRegular: return "\u{f982}"
        case .toolsBold: return "\u{f983}"
        case .toolsLight: return "\u{f984}"
        case .toolsRegular: return "\u{f985}"
        case .touch10Bold: return "\u{f986}"
        case .touch10Light: return "\u{f987}"
        case .touch10Regular: return "\u{f988}"
        case .transcriptBold: return "\u{f989}"
        case .transcriptFilled: return "\u{f98a}"
        case .transcriptLight: return "\u{f98b}"
        case .transcriptRegular: return "\u{f98c}"
        case .translateBold: return "\u{f98d}"
        case .translateLight: return "\u{f98e}"
        case .translateRegular: return "\u{f98f}"
        case .trimBold: return "\u{f990}"
        case .trimLight: return "\u{f991}"
        case .trimRegular: return "\u{f992}"
        case .twoColumnBold: return "\u{f993}"
        case .twoColumnLight: return "\u{f994}"
        case .twoColumnRegular: return "\u{f995}"
        case .ucmCloudBold: return "\u{f996}"
        case .ucmCloudLight: return "\u{f997}"
        case .ucmCloudRegular: return "\u{f998}"
        case .underlineBold: return "\u{f999}"
        case .underlineLight: return "\u{f99a}"
        case .underlineRegular: return "\u{f99b}"
        case .undoBold: return "\u{f99c}"
        case .undoLight: return "\u{f99d}"
        case .undoRegular: return "\u{f99e}"
        case .unlinkBold: return "\u{f99f}"
        case .unlinkLight: return "\u{f9a0}"
        case .unlinkRegular: return "\u{f9a1}"
        case .unreadBold: return "\u{f9a2}"
        case .unreadFilled: return "\u{f9a3}"
        case .unreadLight: return "\u{f9a4}"
        case .unreadRegular: return "\u{f9a5}"
        case .unsecureUnlockedBold: return "\u{f9a6}"
        case .unsecureUnlockedFilled: return "\u{f9a7}"
        case .unsecureUnlockedLight: return "\u{f9a8}"
        case .unsecureUnlockedRegular: return "\u{f9a9}"
        case .unsortedBold: return "\u{f9aa}"
        case .unsortedLight: return "\u{f9ab}"
        case .unsortedRegular: return "\u{f9ac}"
        case .updateFileShareBold: return "\u{f9ad}"
        case .updateFileShareLight: return "\u{f9ae}"
        case .updateFileShareRegular: return "\u{f9af}"
        case .upgradeBold: return "\u{f9b0}"
        case .upgradeFilled: return "\u{f9b1}"
        case .upgradeLight: return "\u{f9b2}"
        case .upgradeRegular: return "\u{f9b3}"
        case .uploadBold: return "\u{f9b4}"
        case .uploadLight: return "\u{f9b5}"
        case .uploadRegular: return "\u{f9b6}"
        case .urgentVoicemailBold: return "\u{f9b7}"
        case .urgentVoicemailFilled: return "\u{f9b8}"
        case .usbBold: return "\u{f9b9}"
        case .usbHeadsetBold: return "\u{f9ba}"
        case .usbHeadsetLight: return "\u{f9bb}"
        case .usbHeadsetMutedBold: return "\u{f9bc}"
        case .usbHeadsetMutedLight: return "\u{f9bd}"
        case .usbHeadsetMutedRegular: return "\u{f9be}"
        case .usbHeadsetRegular: return "\u{f9bf}"
        case .usbLight: return "\u{f9c0}"
        case .usbRegular: return "\u{f9c1}"
        case .userBold: return "\u{f9c2}"
        case .userDeactivateBold: return "\u{f9c3}"
        case .userDeactivateLight: return "\u{f9c4}"
        case .userDeactivateRegular: return "\u{f9c5}"
        case .userLight: return "\u{f9c6}"
        case .userRegular: return "\u{f9c7}"
        case .vcsBold: return "\u{f9c8}"
        case .vcsLight: return "\u{f9c9}"
        case .vcsRegular: return "\u{f9ca}"
        case .videoBlurBold: return "\u{f9cb}"
        case .videoBlurFilled: return "\u{f9cc}"
        case .videoBlurLight: return "\u{f9cd}"
        case .videoBlurRegular: return "\u{f9ce}"
        case .videoBold: return "\u{f9cf}"
        case .videoEffectBold: return "\u{f9d0}"
        case .videoEffectFilled: return "\u{f9d1}"
        case .videoEffectLight: return "\u{f9d2}"
        case .videoEffectRegular: return "\u{f9d3}"
        case .videoFilled: return "\u{f9d4}"
        case .videoLayoutBold: return "\u{f9d5}"
        case .videoLayoutEqualBold: return "\u{f9d6}"
        case .videoLayoutEqualDualBold: return "\u{f9d7}"
        case .videoLayoutEqualDualLight: return "\u{f9d8}"
        case .videoLayoutEqualDualRegular: return "\u{f9d9}"
        case .videoLayoutEqualFilled: return "\u{f9da}"
        case .videoLayoutEqualLight: return "\u{f9db}"
        case .videoLayoutEqualRegular: return "\u{f9dc}"
        case .videoLayoutFilled: return "\u{f9dd}"
        case .videoLayoutLight: return "\u{f9de}"
        case .videoLayoutOverlayBold: return "\u{f9df}"
        case .videoLayoutOverlayLight: return "\u{f9e0}"
        case .videoLayoutOverlayRegular: return "\u{f9e1}"
        case .videoLayoutPresenterDominantBold: return "\u{f9e2}"
        case .videoLayoutPresenterDominantLight: return "\u{f9e3}"
        case .videoLayoutPresenterDominantRegular: return "\u{f9e4}"
        case .videoLayoutProminentBold: return "\u{f9e5}"
        case .videoLayoutProminentFilled: return "\u{f9e6}"
        case .videoLayoutProminentLight: return "\u{f9e7}"
        case .videoLayoutProminentRegular: return "\u{f9e8}"
        case .videoLayoutRegular: return "\u{f9e9}"
        case .videoLayoutShareDominantBold: return "\u{f9ea}"
        case .videoLayoutShareDominantLight: return "\u{f9eb}"
        case .videoLayoutShareDominantRegular: return "\u{f9ec}"
        case .videoLayoutSingleBold: return "\u{f9ed}"
        case .videoLayoutSingleFilled: return "\u{f9ee}"
        case .videoLayoutSingleLight: return "\u{f9ef}"
        case .videoLayoutSingleRegular: return "\u{f9f0}"
        case .videoLayoutStackBold: return "\u{f9f1}"
        case .videoLayoutStackFilled: return "\u{f9f2}"
        case .videoLayoutStackLight: return "\u{f9f3}"
        case .videoLayoutStackRegular: return "\u{f9f4}"
        case .videoLayoutVideoDominantBold: return "\u{f9f5}"
        case .videoLayoutVideoDominantLight: return "\u{f9f6}"
        case .videoLayoutVideoDominantRegular: return "\u{f9f7}"
        case .videoLight: return "\u{f9f8}"
        case .videoPlusBold: return "\u{f9f9}"
        case .videoPlusFilled: return "\u{f9fa}"
        case .videoPlusLight: return "\u{f9fb}"
        case .videoPlusRegular: return "\u{f9fc}"
        case .videoRegular: return "\u{f9fd}"
        case .videoSpeakerTrackBold: return "\u{f9fe}"
        case .videoSpeakerTrackFilled: return "\u{f9ff}"
        case .videoSpeakerTrackLight: return "\u{fa00}"
        case .videoSpeakerTrackRegular: return "\u{fa01}"
        case .viewAllBold: return "\u{fa02}"
        case .viewAllLight: return "\u{fa03}"
        case .viewAllRegular: return "\u{fa04}"
        case .viewListBold: return "\u{fa05}"
        case .viewListLight: return "\u{fa06}"
        case .viewListRegular: return "\u{fa07}"
        case .viewStackedBold: return "\u{fa08}"
        case .viewStackedFilled: return "\u{fa09}"
        case .viewStackedLight: return "\u{fa0a}"
        case .viewStackedRegular: return "\u{fa0b}"
        case .viewThumbnailBold: return "\u{fa0c}"
        case .viewThumbnailFilled: return "\u{fa0d}"
        case .viewThumbnailLight: return "\u{fa0e}"
        case .viewThumbnailRegular: return "\u{fa0f}"
        case .voicemailBold: return "\u{fa10}"
        case .voicemailFilled: return "\u{fa11}"
        case .voicemailLight: return "\u{fa12}"
        case .voicemailRegular: return "\u{fa13}"
        case .waffleMenuBold: return "\u{fa14}"
        case .waffleMenuLight: return "\u{fa15}"
        case .waffleMenuRegular: return "\u{fa16}"
        case .waitingroomActiveBold: return "\u{fa17}"
        case .waitingroomActiveLight: return "\u{fa18}"
        case .waitingroomActiveRegular: return "\u{fa19}"
        case .wallpaperBold: return "\u{fa1a}"
        case .wallpaperLight: return "\u{fa1b}"
        case .wallpaperRegular: return "\u{fa1c}"
        case .warningBadgeFilled: return "\u{fa1d}"
        case .warningBold: return "\u{fa1e}"
        case .warningFilled: return "\u{fa1f}"
        case .warningLight: return "\u{fa20}"
        case .warningRegular: return "\u{fa21}"
        case .webexAssistantActiveColored: return "\u{fa22}"
        case .webexAssistantInactiveColored: return "\u{fa23}"
        case .webexBoardBold: return "\u{fa24}"
        case .webexBoardLight: return "\u{fa25}"
        case .webexBoardRegular: return "\u{fa26}"
        case .webexCodecPlusBold: return "\u{fa27}"
        case .webexCodecPlusLight: return "\u{fa28}"
        case .webexCodecPlusRegular: return "\u{fa29}"
        case .webexDeskCameraBold: return "\u{fa2a}"
        case .webexDeskCameraLight: return "\u{fa2b}"
        case .webexDeskCameraRegular: return "\u{fa2c}"
        case .webexHelixFilled: return "\u{fa2d}"
        case .webexMeetingsBold: return "\u{fa2e}"
        case .webexMeetingsFilled: return "\u{fa2f}"
        case .webexMeetingsLight: return "\u{fa30}"
        case .webexMeetingsRegular: return "\u{fa31}"
        case .webexQuadCameraBold: return "\u{fa32}"
        case .webexQuadCameraLight: return "\u{fa33}"
        case .webexQuadCameraRegular: return "\u{fa34}"
        case .webexRoomKitBold: return "\u{fa35}"
        case .webexRoomKitLight: return "\u{fa36}"
        case .webexRoomKitPlusBold: return "\u{fa37}"
        case .webexRoomKitPlusLight: return "\u{fa38}"
        case .webexRoomKitPlusRegular: return "\u{fa39}"
        case .webexRoomKitRegular: return "\u{fa3a}"
        case .webexShareBold: return "\u{fa3b}"
        case .webexShareLight: return "\u{fa3c}"
        case .webexShareRegular: return "\u{fa3d}"
        case .webexTeamsBold: return "\u{fa3e}"
        case .webexTeamsFilled: return "\u{fa3f}"
        case .webexTeamsLight: return "\u{fa40}"
        case .webexTeamsNewBold: return "\u{fa41}"
        case .webexTeamsNewFilled: return "\u{fa42}"
        case .webexTeamsNewLight: return "\u{fa43}"
        case .webexTeamsNewRegular: return "\u{fa44}"
        case .webexTeamsRegular: return "\u{fa45}"
        case .webinarBold: return "\u{fa46}"
        case .webinarFilled: return "\u{fa47}"
        case .webinarLight: return "\u{fa48}"
        case .webinarRegular: return "\u{fa49}"
        case .weeklyRecurringScheduleNodeBold: return "\u{fa4a}"
        case .weeklyRecurringScheduleNodeLight: return "\u{fa4b}"
        case .weeklyRecurringScheduleNodeRegular: return "\u{fa4c}"
        case .whiteboardBold: return "\u{fa4d}"
        case .whiteboardContentBold: return "\u{fa4e}"
        case .whiteboardContentLight: return "\u{fa4f}"
        case .whiteboardContentRegular: return "\u{fa50}"
        case .whiteboardFilled: return "\u{fa51}"
        case .whiteboardLight: return "\u{fa52}"
        case .whiteboardRegular: return "\u{fa53}"
        case .widgetBold: return "\u{fa54}"
        case .widgetFilled: return "\u{fa55}"
        case .widgetLight: return "\u{fa56}"
        case .widgetRegular: return "\u{fa57}"
        case .wifiBold: return "\u{fa58}"
        case .wifiErrorBold: return "\u{fa59}"
        case .wifiErrorLight: return "\u{fa5a}"
        case .wifiErrorRegular: return "\u{fa5b}"
        case .wifiLight: return "\u{fa5c}"
        case .wifiRegular: return "\u{fa5d}"
        case .wifiSignalGoodColoredBold: return "\u{fa5e}"
        case .wifiSignalGoodColoredLight: return "\u{fa5f}"
        case .wifiSignalGoodColoredRegular: return "\u{fa60}"
        case .wifiSignalPoorColoredBold: return "\u{fa61}"
        case .wifiSignalPoorColoredLight: return "\u{fa62}"
        case .wifiSignalPoorColoredRegular: return "\u{fa63}"
        case .wifiSignalUnstableColoredBold: return "\u{fa64}"
        case .wifiSignalUnstableColoredLight: return "\u{fa65}"
        case .wifiSignalUnstableColoredRegular: return "\u{fa66}"
        case .windowCornerScrubBold: return "\u{fa67}"
        case .windowCornerScrubLight: return "\u{fa68}"
        case .windowCornerScrubRegular: return "\u{fa69}"
        case .windowRightCornerScrubBold: return "\u{fa6a}"
        case .windowRightCornerScrubLight: return "\u{fa6b}"
        case .windowRightCornerScrubRegular: return "\u{fa6c}"
        case .windowVerticalScrubBold: return "\u{fa6d}"
        case .windowVerticalScrubLight: return "\u{fa6e}"
        case .windowVerticalScrubRegular: return "\u{fa6f}"
        case .workflowDeploymentsBold: return "\u{fa70}"
        case .workflowDeploymentsLight: return "\u{fa71}"
        case .workflowDeploymentsRegular: return "\u{fa72}"
        case .workphoneBold: return "\u{fa73}"
        case .workphoneLight: return "\u{fa74}"
        case .workphoneRegular: return "\u{fa75}"
        case .zoomInBold: return "\u{fa76}"
        case .zoomInLight: return "\u{fa77}"
        case .zoomInRegular: return "\u{fa78}"
        case .zoomOutBold: return "\u{fa79}"
        case .zoomOutLight: return "\u{fa7a}"
        case .zoomOutRegular: return "\u{fa7b}"
