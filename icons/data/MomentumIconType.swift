...
@objc public enum MomentumIconType: Int {
    ...
    public var ligature: String {
        ...
        case .textBold12: return "\u{f9cf}"
        case .textBold16: return "\u{f9d0}"
        case .textCodeBlock12: return "\u{f9d1}"
        case .textCodeBlock16: return "\u{f9d2}"
        case .textColor16: return "\u{f9d3}"
        case .textFormat10: return "\u{f9d4}"
        case .textFormat12: return "\u{f9d5}"
        case .textFormat16: return "\u{f9d6}"
        case .textFormat20: return "\u{f9d7}"
        case .textFormat24: return "\u{f9d8}"
        case .textFormat8: return "\u{f9d9}"
        case .textHeading112: return "\u{f9da}"
        case .textHeading116: return "\u{f9db}"
        case .textHeading212: return "\u{f9dc}"
        case .textHeading216: return "\u{f9dd}"
        case .textHeading312: return "\u{f9de}"
        case .textHeading316: return "\u{f9df}"
        case .textItalic12: return "\u{f9e0}"
        case .textItalic16: return "\u{f9e1}"
        case .textListBulleted10: return "\u{f9e2}"
        case .textListBulleted12: return "\u{f9e3}"
        case .textListBulleted16: return "\u{f9e4}"
        case .textListBulleted8: return "\u{f9e5}"
        case .textListNumbered12: return "\u{f9e6}"
        case .textListNumbered16: return "\u{f9e7}"
        case .textListNumbered36: return "\u{f9e8}"
        case .textListNumbered40: return "\u{f9e9}"
        case .textStrikethrough16: return "\u{f9ea}"
        case .textTable16: return "\u{f9eb}"
        case .textUnderline12: return "\u{f9ec}"
        case .textUnderline16: return "\u{f9ed}"
        case .tooFast12: return "\u{f9ee}"
        case .tooFast16: return "\u{f9ef}"
        case .tooSlow12: return "\u{f9f0}"
        case .tooSlow16: return "\u{f9f1}"
        case .tools16: return "\u{f9f2}"
        case .tools20: return "\u{f9f3}"
        case .tools24: return "\u{f9f4}"
        case .tools32: return "\u{f9f5}"
        case .touch16: return "\u{f9f6}"
        case .touch1024: return "\u{f9f7}"
        case .transcript16: return "\u{f9f8}"
        case .twitter16: return "\u{f9f9}"
        case .twitterCircle24: return "\u{f9fa}"
        case .twitterCircle32: return "\u{f9fb}"
        case .twitterCircle40: return "\u{f9fc}"
        case .ucmCloud16: return "\u{f9fd}"
        case .ucmCloud24: return "\u{f9fe}"
        case .ucmCloud32: return "\u{f9ff}"
        case .undo12: return "\u{fa00}"
        case .undo14: return "\u{fa01}"
        case .undo16: return "\u{fa02}"
        case .undo24: return "\u{fa03}"
        case .unlink20: return "\u{fa04}"
        case .unreadBadge10: return "\u{fa05}"
        case .unreadBadge12: return "\u{fa06}"
        case .unreadBadge16: return "\u{fa07}"
        case .unreadBadge8: return "\u{fa08}"
        case .unsecure12: return "\u{fa09}"
        case .unsecure14: return "\u{fa0a}"
        case .unsecure16: return "\u{fa0b}"
        case .unsecure24: return "\u{fa0c}"
        case .unsecure28: return "\u{fa0d}"
        case .upload12: return "\u{fa0e}"
        case .upload130: return "\u{fa0f}"
        case .upload14: return "\u{fa10}"
        case .upload16: return "\u{fa11}"
        case .upload18: return "\u{fa12}"
        case .upload20: return "\u{fa13}"
        case .upload24: return "\u{fa14}"
        case .upload28: return "\u{fa15}"
        case .upload32: return "\u{fa16}"
        case .upload36: return "\u{fa17}"
        case .usb16: return "\u{fa18}"
        case .user16: return "\u{fa19}"
        case .user20: return "\u{fa1a}"
        case .user24: return "\u{fa1b}"
        case .user56: return "\u{fa1c}"
        case .videoEffect12: return "\u{fa1d}"
        case .videoLayout12: return "\u{fa1e}"
        case .videoLayout16: return "\u{fa1f}"
        case .videoLayoutAuto12: return "\u{fa20}"
        case .videoLayoutAuto16: return "\u{fa21}"
        case .videoLayoutAuto20: return "\u{fa22}"
        case .videoLayoutAuto24: return "\u{fa23}"
        case .videoLayoutEqual12: return "\u{fa24}"
        case .videoLayoutEqual14: return "\u{fa25}"
        case .videoLayoutEqual16: return "\u{fa26}"
        case .videoLayoutEqual20: return "\u{fa27}"
        case .videoLayoutEqual24: return "\u{fa28}"
        case .videoLayoutOverlay12: return "\u{fa29}"
        case .videoLayoutOverlay16: return "\u{fa2a}"
        case .videoLayoutOverlay20: return "\u{fa2b}"
        case .videoLayoutOverlay24: return "\u{fa2c}"
        case .videoLayoutProminent12: return "\u{fa2d}"
        case .videoLayoutProminent16: return "\u{fa2e}"
        case .videoLayoutProminent20: return "\u{fa2f}"
        case .videoLayoutProminent24: return "\u{fa30}"
        case .videoLayoutShareDominant12: return "\u{fa31}"
        case .videoLayoutShareDominant16: return "\u{fa32}"
        case .videoLayoutShareDominant20: return "\u{fa33}"
        case .videoLayoutShareDominant24: return "\u{fa34}"
        case .videoLayoutSingle16: return "\u{fa35}"
        case .videoLayoutSingle20: return "\u{fa36}"
        case .videoLayoutVideoDominant12: return "\u{fa37}"
        case .videoLayoutVideoDominant16: return "\u{fa38}"
        case .videoLayoutVideoDominant20: return "\u{fa39}"
        case .videoLayoutVideoDominant24: return "\u{fa3a}"
        case .viewAll12: return "\u{fa3b}"
        case .viewAll14: return "\u{fa3c}"
        case .viewFeedMultiple16: return "\u{fa3d}"
        case .viewFeedPanel16: return "\u{fa3e}"
        case .viewFeedSingle16: return "\u{fa3f}"
        case .viewList10: return "\u{fa40}"
        case .viewList12: return "\u{fa41}"
        case .viewList14: return "\u{fa42}"
        case .viewList16: return "\u{fa43}"
        case .viewList20: return "\u{fa44}"
        case .viewList24: return "\u{fa45}"
        case .viewList28: return "\u{fa46}"
        case .viewListCircle100: return "\u{fa47}"
        case .viewMixed12: return "\u{fa48}"
        case .viewStack12: return "\u{fa49}"
        case .viewStack14: return "\u{fa4a}"
        case .viewStack20: return "\u{fa4b}"
        case .viewStack24: return "\u{fa4c}"
        case .viewThumbnail12: return "\u{fa4d}"
        case .viewThumbnail14: return "\u{fa4e}"
        case .viewThumbnail16: return "\u{fa4f}"
        case .viewThumbnail20: return "\u{fa50}"
        case .viewThumbnail24: return "\u{fa51}"
        case .voicemail10: return "\u{fa52}"
        case .voicemail14: return "\u{fa53}"
        case .voicemail16: return "\u{fa54}"
        case .voicemail18: return "\u{fa55}"
        case .voicemail20: return "\u{fa56}"
        case .voicemail24: return "\u{fa57}"
        case .voicemail28: return "\u{fa58}"
        case .voicemail8: return "\u{fa59}"
        case .voicemailActive12: return "\u{fa5a}"
        case .voicemailActive14: return "\u{fa5b}"
        case .voicemailActive16: return "\u{fa5c}"
        case .voicemailActive18: return "\u{fa5d}"
        case .voicemailActive20: return "\u{fa5e}"
        case .voicemailActive24: return "\u{fa5f}"
        case .voicemailActive28: return "\u{fa60}"
        case .wallpaper16: return "\u{fa61}"
        case .wallpaper20: return "\u{fa62}"
        case .wallpaper24: return "\u{fa63}"
        case .wallpaper28: return "\u{fa64}"
        case .wallpaper32: return "\u{fa65}"
        case .warning100: return "\u{fa66}"
        case .warning12: return "\u{fa67}"
        case .warning14: return "\u{fa68}"
        case .warning16: return "\u{fa69}"
        case .warning20: return "\u{fa6a}"
        case .warning24: return "\u{fa6b}"
        case .warning28: return "\u{fa6c}"
        case .warning32: return "\u{fa6d}"
        case .warning40: return "\u{fa6e}"
        case .warning44: return "\u{fa6f}"
        case .warning56: return "\u{fa70}"
        case .warning64: return "\u{fa71}"
        case .warning72: return "\u{fa72}"
        case .webSharing16: return "\u{fa73}"
        case .webSharing24: return "\u{fa74}"
        case .webex10: return "\u{fa75}"
        case .webex16: return "\u{fa76}"
        case .webex24: return "\u{fa77}"
        case .webex48: return "\u{fa78}"
        case .webexBoard12: return "\u{fa79}"
        case .webexBoard14: return "\u{fa7a}"
        case .webexBoard16: return "\u{fa7b}"
        case .webexBoard20: return "\u{fa7c}"
        case .webexBoard24: return "\u{fa7d}"
        case .webexBoard28: return "\u{fa7e}"
        case .webexBoard32: return "\u{fa7f}"
        case .webexBoard48: return "\u{fa80}"
        case .webexCalling10: return "\u{fa81}"
        case .webexCalling12: return "\u{fa82}"
        case .webexCalling16: return "\u{fa83}"
        case .webexCalling18: return "\u{fa84}"
        case .webexCalling20: return "\u{fa85}"
        case .webexCalling24: return "\u{fa86}"
        case .webexCodecPlus16: return "\u{fa87}"
        case .webexCodecPlus20: return "\u{fa88}"
        case .webexInstantMeeting12: return "\u{fa89}"
        case .webexInstantMeeting14: return "\u{fa8a}"
        case .webexInstantMeeting16: return "\u{fa8b}"
        case .webexInstantMeeting20: return "\u{fa8c}"
        case .webexInstantMeeting24: return "\u{fa8d}"
        case .webexMeetings10: return "\u{fa8e}"
        case .webexMeetings12: return "\u{fa8f}"
        case .webexMeetings14: return "\u{fa90}"
        case .webexMeetings16: return "\u{fa91}"
        case .webexMeetings20: return "\u{fa92}"
        case .webexMeetings24: return "\u{fa93}"
        case .webexMeetings48: return "\u{fa94}"
        case .webexQuadCamera16: return "\u{fa95}"
        case .webexQuadCamera20: return "\u{fa96}"
        case .webexRoomKit16: return "\u{fa97}"
        case .webexRoomKit20: return "\u{fa98}"
        case .webexRoomKitPlus16: return "\u{fa99}"
        case .webexRoomKitPlus20: return "\u{fa9a}"
        case .webexShare12: return "\u{fa9b}"
        case .webexShare14: return "\u{fa9c}"
        case .webexShare16: return "\u{fa9d}"
        case .webexShare20: return "\u{fa9e}"
        case .webexTeams10: return "\u{fa9f}"
        case .webexTeams12: return "\u{faa0}"
        case .webexTeams14: return "\u{faa1}"
        case .webexTeams16: return "\u{faa2}"
        case .webexTeams18: return "\u{faa3}"
        case .webexTeams20: return "\u{faa4}"
        case .webexVoice16: return "\u{faa5}"
        case .webexVoice20: return "\u{faa6}"
        case .webpop12: return "\u{faa7}"
        case .webpop16: return "\u{faa8}"
        case .webpop20: return "\u{faa9}"
        case .webpop24: return "\u{faaa}"
        case .whiteboard10: return "\u{faab}"
        case .whiteboard12: return "\u{faac}"
        case .whiteboard14: return "\u{faad}"
        case .whiteboard16: return "\u{faae}"
        case .whiteboard20: return "\u{faaf}"
        case .whiteboard24: return "\u{fab0}"
        case .whiteboard26: return "\u{fab1}"
        case .whiteboard28: return "\u{fab2}"
        case .whiteboard32: return "\u{fab3}"
        case .whiteboard36: return "\u{fab4}"
        case .whiteboard8: return "\u{fab5}"
        case .whiteboardContent16: return "\u{fab6}"
        case .whiteboardContent24: return "\u{fab7}"
        case .widgetsAdr20: return "\u{fab8}"
        case .wifi12: return "\u{fab9}"
        case .wifi16: return "\u{faba}"
        case .wifi20: return "\u{fabb}"
        case .wifi24: return "\u{fabc}"
        case .wifiError12: return "\u{fabd}"
        case .wifiError16: return "\u{fabe}"
        case .wikipedia16: return "\u{fabf}"
        case .windowCornerScrub16: return "\u{fac0}"
        case .windowVerticalScrub16: return "\u{fac1}"
        case .youtubeCircle24: return "\u{fac2}"
        case .youtubeCircle32: return "\u{fac3}"
        case .youtubeCircle40: return "\u{fac4}"
        case .zoomIn12: return "\u{fac5}"
        case .zoomIn14: return "\u{fac6}"
        case .zoomIn16: return "\u{fac7}"
        case .zoomIn20: return "\u{fac8}"
        case .zoomOut12: return "\u{fac9}"
        case .zoomOut14: return "\u{faca}"
        case .zoomOut16: return "\u{facb}"
        case .zoomOut20: return "\u{facc}"
