class InputKitchenSinkController {
  public messages = {
...
export class InputKitchenSink implements angular.IComponentOptions {
  public static selector = 'exampleInputKitchenSink';
  public static bindings = {};
  public static controller = InputKitchenSinkController;
