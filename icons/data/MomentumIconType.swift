...
@objc public enum MomentumIconType: Int {
    ...
    public var ligature: String {
        ...
        case .moreCircle20: return "\u{f7ba}"
        case .mouseCursor16: return "\u{f7bb}"
        case .moveCallInAdr12: return "\u{f7bc}"
        case .moveCallInAdr16: return "\u{f7bd}"
        case .moveCallInAdr18: return "\u{f7be}"
        case .moveCallInAdr20: return "\u{f7bf}"
        case .moveCallInAdr24: return "\u{f7c0}"
        case .moveCallInAdr28: return "\u{f7c1}"
        case .moveCallInIph12: return "\u{f7c2}"
        case .moveCallInIph16: return "\u{f7c3}"
        case .moveCallInIph18: return "\u{f7c4}"
        case .moveCallInIph20: return "\u{f7c5}"
        case .moveCallInIph24: return "\u{f7c6}"
        case .moveCallInIph28: return "\u{f7c7}"
        case .moveCallInLaptop12: return "\u{f7c8}"
        case .moveCallInLaptop16: return "\u{f7c9}"
        case .moveCallInLaptop18: return "\u{f7ca}"
        case .moveCallInLaptop20: return "\u{f7cb}"
        case .moveCallInLaptop24: return "\u{f7cc}"
        case .moveCallInLaptop28: return "\u{f7cd}"
        case .moveCallInOutAdr28: return "\u{f7ce}"
        case .moveCallInOutIph28: return "\u{f7cf}"
        case .moveCallInTablet12: return "\u{f7d0}"
        case .moveCallInTablet18: return "\u{f7d1}"
        case .moveCallInTablet20: return "\u{f7d2}"
        case .moveCallInTablet24: return "\u{f7d3}"
        case .moveCallInTablet28: return "\u{f7d4}"
        case .moveCallOutAdr12: return "\u{f7d5}"
        case .moveCallOutAdr16: return "\u{f7d6}"
        case .moveCallOutAdr18: return "\u{f7d7}"
        case .moveCallOutAdr20: return "\u{f7d8}"
        case .moveCallOutAdr24: return "\u{f7d9}"
        case .moveCallOutAdr28: return "\u{f7da}"
        case .moveCallOutIph12: return "\u{f7db}"
        case .moveCallOutIph16: return "\u{f7dc}"
        case .moveCallOutIph18: return "\u{f7dd}"
        case .moveCallOutIph20: return "\u{f7de}"
        case .moveCallOutIph24: return "\u{f7df}"
        case .moveCallOutIph28: return "\u{f7e0}"
        case .moveCallOutLaptop12: return "\u{f7e1}"
        case .moveCallOutLaptop16: return "\u{f7e2}"
        case .moveCallOutLaptop18: return "\u{f7e3}"
        case .moveCallOutLaptop20: return "\u{f7e4}"
        case .moveCallOutLaptop24: return "\u{f7e5}"
        case .moveCallOutLaptop28: return "\u{f7e6}"
        case .moveCallOutTablet12: return "\u{f7e7}"
        case .moveCallOutTablet18: return "\u{f7e8}"
        case .moveCallOutTablet20: return "\u{f7e9}"
        case .moveCallOutTablet24: return "\u{f7ea}"
        case .moveCallOutTablet28: return "\u{f7eb}"
        case .multilineChart16: return "\u{f7ec}"
        case .multimedia16: return "\u{f7ed}"
        case .multimedia20: return "\u{f7ee}"
        case .multipleDevices16: return "\u{f7ef}"
        case .multipleDevices20: return "\u{f7f0}"
        case .multipleDevices24: return "\u{f7f1}"
        case .multipleDevices28: return "\u{f7f2}"
        case .multipleDevices64: return "\u{f7f3}"
        case .musicMode12: return "\u{f7f4}"
        case .musicMode16: return "\u{f7f5}"
        case .musicMode24: return "\u{f7f6}"
        case .musicMode8: return "\u{f7f7}"
        case .muteOnEntry16: return "\u{f7f8}"
        case .newVoicemail16: return "\u{f7f9}"
        case .newVoicemail20: return "\u{f7fa}"
        case .newVoicemail24: return "\u{f7fb}"
        case .newWhiteboard12: return "\u{f7fc}"
        case .newWhiteboard16: return "\u{f7fd}"
        case .next10: return "\u{f7fe}"
        case .next12: return "\u{f7ff}"
        case .next16: return "\u{f800}"
        case .next18: return "\u{f801}"
        case .next20: return "\u{f802}"
        case .next24: return "\u{f803}"
        case .next28: return "\u{f804}"
        case .next36: return "\u{f805}"
        case .noDevices28: return "\u{f806}"
        case .noPhoneWarning20: return "\u{f807}"
        case .noPhoneWarning24: return "\u{f808}"
        case .note16: return "\u{f809}"
        case .note20: return "\u{f80a}"
        case .note24: return "\u{f80b}"
        case .notePpt16: return "\u{f80c}"
        case .notePpt20: return "\u{f80d}"
        case .notepad16: return "\u{f80e}"
        case .notes10: return "\u{f80f}"
        case .notes12: return "\u{f810}"
        case .notes14: return "\u{f811}"
        case .notes16: return "\u{f812}"
        case .notes20: return "\u{f813}"
        case .notes24: return "\u{f814}"
        case .notes26: return "\u{f815}"
        case .notes28: return "\u{f816}"
        case .notes36: return "\u{f817}"
        case .notes8: return "\u{f818}"
        case .oneToOneZoom16: return "\u{f819}"
        ...
        case .presentation20: return "\u{f95b}"
        case .presentation24: return "\u{f95c}"
        case .print10: return "\u{f95d}"
        case .print12: return "\u{f95e}"
        case .print16: return "\u{f95f}"
        case .priority12: return "\u{f960}"
        case .priority14: return "\u{f961}"
        case .priority16: return "\u{f962}"
        case .priority18: return "\u{f963}"
        case .priority20: return "\u{f964}"
        case .priority24: return "\u{f965}"
        case .priority28: return "\u{f966}"
        case .priority32: return "\u{f967}"
        case .priority40: return "\u{f968}"
        case .priority44: return "\u{f969}"
        case .priority72: return "\u{f96a}"
        case .priorityActive16: return "\u{f96b}"
        case .privacy16: return "\u{f96c}"
        case .privacy20: return "\u{f96d}"
        case .private10: return "\u{f96e}"
        case .private12: return "\u{f96f}"
        case .private14: return "\u{f970}"
        case .private16: return "\u{f971}"
        case .private20: return "\u{f972}"
        case .private24: return "\u{f973}"
        case .private28: return "\u{f974}"
        case .private8: return "\u{f975}"
        case .privateCircle100: return "\u{f976}"
        case .privateCircle14: return "\u{f977}"
        case .privateCircle16: return "\u{f978}"
        case .privateCircle20: return "\u{f979}"
        case .privateCircle24: return "\u{f97a}"
        case .privateCircle48: return "\u{f97b}"
        case .privateCircle56: return "\u{f97c}"
        case .privateCircle80: return "\u{f97d}"
        case .privateCircleActive16: return "\u{f97e}"
        case .privateCircleActive20: return "\u{f97f}"
        case .privateCircleActive24: return "\u{f980}"
        case .privateMeeting12: return "\u{f981}"
        case .privateMeeting14: return "\u{f982}"
        case .privateMeeting16: return "\u{f983}"
        case .privateMeeting20: return "\u{f984}"
        case .proBadge28: return "\u{f985}"
        case .productDemo16: return "\u{f986}"
        case .proximity12: return "\u{f987}"
        case .proximity16: return "\u{f988}"
        case .proximity20: return "\u{f989}"
        case .proximity24: return "\u{f98a}"
        case .proximity28: return "\u{f98b}"
        case .proximityMuted12: return "\u{f98c}"
        case .proximityMuted16: return "\u{f98d}"
        case .proximityMuted24: return "\u{f98e}"
        case .proximityMuted28: return "\u{f98f}"
        case .proximityVideo12: return "\u{f990}"
        case .proximityVideo14: return "\u{f991}"
        case .proximityVideo16: return "\u{f992}"
        case .proximityVideo20: return "\u{f993}"
        case .proximityVideo24: return "\u{f994}"
        case .proximityVideo26: return "\u{f995}"
        case .pto12: return "\u{f996}"
        case .pto120: return "\u{f997}"
        case .pto124: return "\u{f998}"
        case .pto14: return "\u{f999}"
        case .pto16: return "\u{f99a}"
        case .pto18: return "\u{f99b}"
        case .pto20: return "\u{f99c}"
        case .pto24: return "\u{f99d}"
        case .pto26: return "\u{f99e}"
        case .pto28: return "\u{f99f}"
        case .pto32: return "\u{f9a0}"
        case .pto40: return "\u{f9a1}"
        case .pto48: return "\u{f9a2}"
        case .pto56: return "\u{f9a3}"
        case .pto8: return "\u{f9a4}"
        case .pullCall12: return "\u{f9a5}"
        case .pullCall14: return "\u{f9a6}"
        case .pullCall16: return "\u{f9a7}"
        case .pullCall24: return "\u{f9a8}"
        case .qA16: return "\u{f9a9}"
        case .qA20: return "\u{f9aa}"
        case .qA24: return "\u{f9ab}"
        case .qA36: return "\u{f9ac}"
        case .quality16: return "\u{f9ad}"
        case .quality24: return "\u{f9ae}"
        case .queue14: return "\u{f9af}"
        case .queueContact: return "\u{f9b0}"
        case .queueContact14: return "\u{f9b1}"
        ...
        case .rotateContent12: return "\u{fa1b}"
        case .rotateContent24: return "\u{fa1c}"
        case .rssCircle24: return "\u{fa1d}"
        case .rssCircle32: return "\u{fa1e}"
        case .rssCircle40: return "\u{fa1f}"
        case .runningApplication16: return "\u{fa20}"
        case .runningApplication24: return "\u{fa21}"
        case .save12: return "\u{fa22}"
        case .save14: return "\u{fa23}"
        case .save16: return "\u{fa24}"
        case .save24: return "\u{fa25}"
        case .scan20: return "\u{fa26}"
        case .scan24: return "\u{fa27}"
        case .schedulerAvailable14: return "\u{fa28}"
        case .schedulerNotWorkingHours14: return "\u{fa29}"
        case .schedulerUnavailable14: return "\u{fa2a}"
        case .schedulerUnknown14: return "\u{fa2b}"
        ...
        case .videoLayout12: return "\u{fbf4}"
        case .videoLayout16: return "\u{fbf5}"
        case .videoLayoutAuto12: return "\u{fbf6}"
        case .videoLayoutAuto16: return "\u{fbf7}"
        case .videoLayoutAuto20: return "\u{fbf8}"
        case .videoLayoutAuto24: return "\u{fbf9}"
        case .videoLayoutEqual12: return "\u{fbfa}"
        case .videoLayoutEqual14: return "\u{fbfb}"
        case .videoLayoutEqual16: return "\u{fbfc}"
        case .videoLayoutEqual20: return "\u{fbfd}"
        case .videoLayoutEqual24: return "\u{fbfe}"
        case .videoLayoutEqual28: return "\u{fbff}"
        case .videoLayoutEqualFilled24: return "\u{fc00}"
        case .videoLayoutOverlay12: return "\u{fc01}"
        case .videoLayoutOverlay16: return "\u{fc02}"
        case .videoLayoutOverlay20: return "\u{fc03}"
        case .videoLayoutOverlay24: return "\u{fc04}"
        case .videoLayoutProminent12: return "\u{fc05}"
        case .videoLayoutProminent16: return "\u{fc06}"
        case .videoLayoutProminent20: return "\u{fc07}"
        case .videoLayoutProminent24: return "\u{fc08}"
        case .videoLayoutShareDominant12: return "\u{fc09}"
        case .videoLayoutShareDominant16: return "\u{fc0a}"
        case .videoLayoutShareDominant20: return "\u{fc0b}"
        case .videoLayoutShareDominant24: return "\u{fc0c}"
        case .videoLayoutSingle12: return "\u{fc0d}"
        case .videoLayoutSingle16: return "\u{fc0e}"
        case .videoLayoutSingle20: return "\u{fc0f}"
        case .videoLayoutSingle28: return "\u{fc10}"
        case .videoLayoutStack12: return "\u{fc11}"
        case .videoLayoutStack16: return "\u{fc12}"
        case .videoLayoutStack20: return "\u{fc13}"
        case .videoLayoutStack24: return "\u{fc14}"
        case .videoLayoutStackFilled24: return "\u{fc15}"
        case .videoLayoutVideoDominant12: return "\u{fc16}"
        case .videoLayoutVideoDominant16: return "\u{fc17}"
        case .videoLayoutVideoDominant20: return "\u{fc18}"
        case .videoLayoutVideoDominant24: return "\u{fc19}"
        case .viewAll12: return "\u{fc1a}"
        case .viewAll14: return "\u{fc1b}"
        case .viewFeedMultiple16: return "\u{fc1c}"
        case .viewFeedPanel16: return "\u{fc1d}"
        case .viewFeedSingle16: return "\u{fc1e}"
        case .viewList10: return "\u{fc1f}"
        case .viewList12: return "\u{fc20}"
        case .viewList14: return "\u{fc21}"
        case .viewList16: return "\u{fc22}"
        case .viewList20: return "\u{fc23}"
        case .viewList24: return "\u{fc24}"
        case .viewList28: return "\u{fc25}"
        case .viewListCircle100: return "\u{fc26}"
        case .viewMixed12: return "\u{fc27}"
        case .viewStack12: return "\u{fc28}"
        case .viewStack14: return "\u{fc29}"
        case .viewStack20: return "\u{fc2a}"
        case .viewStack24: return "\u{fc2b}"
        case .viewThumbnail12: return "\u{fc2c}"
        case .viewThumbnail14: return "\u{fc2d}"
        case .viewThumbnail16: return "\u{fc2e}"
        case .viewThumbnail20: return "\u{fc2f}"
        case .viewThumbnail24: return "\u{fc30}"
        case .voice20: return "\u{fc31}"
        case .voicemail10: return "\u{fc32}"
        case .voicemail14: return "\u{fc33}"
        case .voicemail16: return "\u{fc34}"
        case .voicemail18: return "\u{fc35}"
        case .voicemail20: return "\u{fc36}"
        case .voicemail22: return "\u{fc37}"
        case .voicemail24: return "\u{fc38}"
        case .voicemail28: return "\u{fc39}"
        case .voicemail8: return "\u{fc3a}"
        case .voicemailActive12: return "\u{fc3b}"
        case .voicemailActive14: return "\u{fc3c}"
        case .voicemailActive16: return "\u{fc3d}"
        case .voicemailActive18: return "\u{fc3e}"
        case .voicemailActive20: return "\u{fc3f}"
        case .voicemailActive22: return "\u{fc40}"
        case .voicemailActive24: return "\u{fc41}"
        case .voicemailActive28: return "\u{fc42}"
        case .wallpaper16: return "\u{fc43}"
        case .wallpaper20: return "\u{fc44}"
        case .wallpaper24: return "\u{fc45}"
        case .wallpaper28: return "\u{fc46}"
        case .wallpaper32: return "\u{fc47}"
        case .warning100: return "\u{fc48}"
        case .warning12: return "\u{fc49}"
        case .warning14: return "\u{fc4a}"
        case .warning16: return "\u{fc4b}"
        case .warning20: return "\u{fc4c}"
        case .warning24: return "\u{fc4d}"
        case .warning28: return "\u{fc4e}"
        case .warning32: return "\u{fc4f}"
        case .warning40: return "\u{fc50}"
        case .warning44: return "\u{fc51}"
        case .warning56: return "\u{fc52}"
        case .warning64: return "\u{fc53}"
        case .warning72: return "\u{fc54}"
        case .warningActive12: return "\u{fc55}"
        case .warningActive16: return "\u{fc56}"
        case .waveform20: return "\u{fc57}"
        case .webSharing16: return "\u{fc58}"
        case .webSharing24: return "\u{fc59}"
        case .webex10: return "\u{fc5a}"
        case .webex16: return "\u{fc5b}"
        case .webex24: return "\u{fc5c}"
        case .webex48: return "\u{fc5d}"
        case .webexBoard12: return "\u{fc5e}"
        case .webexBoard14: return "\u{fc5f}"
        case .webexBoard16: return "\u{fc60}"
        case .webexBoard20: return "\u{fc61}"
        case .webexBoard24: return "\u{fc62}"
        case .webexBoard28: return "\u{fc63}"
        case .webexBoard32: return "\u{fc64}"
        case .webexBoard48: return "\u{fc65}"
        case .webexCalling10: return "\u{fc66}"
        case .webexCalling12: return "\u{fc67}"
        case .webexCalling16: return "\u{fc68}"
        case .webexCalling18: return "\u{fc69}"
        case .webexCalling20: return "\u{fc6a}"
        case .webexCalling24: return "\u{fc6b}"
        case .webexCodecPlus16: return "\u{fc6c}"
        case .webexCodecPlus20: return "\u{fc6d}"
        case .webexCommunity20: return "\u{fc6e}"
        case .webexDeskCamera20: return "\u{fc6f}"
        case .webexInstantMeeting12: return "\u{fc70}"
        case .webexInstantMeeting14: return "\u{fc71}"
        case .webexInstantMeeting16: return "\u{fc72}"
        case .webexInstantMeeting20: return "\u{fc73}"
        case .webexInstantMeeting24: return "\u{fc74}"
        case .webexMeetings10: return "\u{fc75}"
        case .webexMeetings12: return "\u{fc76}"
        case .webexMeetings14: return "\u{fc77}"
        case .webexMeetings16: return "\u{fc78}"
        case .webexMeetings20: return "\u{fc79}"
        case .webexMeetings24: return "\u{fc7a}"
        case .webexMeetings48: return "\u{fc7b}"
        case .webexQuadCamera16: return "\u{fc7c}"
        case .webexQuadCamera20: return "\u{fc7d}"
        case .webexRoomKit16: return "\u{fc7e}"
        case .webexRoomKit20: return "\u{fc7f}"
        case .webexRoomKitPlus16: return "\u{fc80}"
        case .webexRoomKitPlus20: return "\u{fc81}"
        case .webexShare12: return "\u{fc82}"
        case .webexShare14: return "\u{fc83}"
        case .webexShare16: return "\u{fc84}"
        case .webexShare20: return "\u{fc85}"
        case .webexTeams10: return "\u{fc86}"
        case .webexTeams12: return "\u{fc87}"
        case .webexTeams14: return "\u{fc88}"
        case .webexTeams16: return "\u{fc89}"
        case .webexTeams18: return "\u{fc8a}"
        case .webexTeams20: return "\u{fc8b}"
        case .webexVoice16: return "\u{fc8c}"
        case .webexVoice20: return "\u{fc8d}"
        case .webpop12: return "\u{fc8e}"
        case .webpop16: return "\u{fc8f}"
        case .webpop20: return "\u{fc90}"
        case .webpop24: return "\u{fc91}"
        case .whatsApp12: return "\u{fc92}"
        case .whatsApp16: return "\u{fc93}"
        case .whiteboard10: return "\u{fc94}"
        case .whiteboard12: return "\u{fc95}"
        case .whiteboard14: return "\u{fc96}"
        case .whiteboard16: return "\u{fc97}"
        case .whiteboard20: return "\u{fc98}"
        case .whiteboard24: return "\u{fc99}"
        case .whiteboard26: return "\u{fc9a}"
        case .whiteboard28: return "\u{fc9b}"
        case .whiteboard32: return "\u{fc9c}"
        case .whiteboard36: return "\u{fc9d}"
        case .whiteboard8: return "\u{fc9e}"
        case .whiteboardContent16: return "\u{fc9f}"
        case .whiteboardContent24: return "\u{fca0}"
        case .widgetsAdr20: return "\u{fca1}"
        case .wifi12: return "\u{fca2}"
        case .wifi16: return "\u{fca3}"
        case .wifi20: return "\u{fca4}"
        case .wifi24: return "\u{fca5}"
        case .wifiError12: return "\u{fca6}"
        case .wifiError16: return "\u{fca7}"
        case .wifiSelected24: return "\u{fca8}"
        case .wikipedia16: return "\u{fca9}"
        case .windowCornerScrub16: return "\u{fcaa}"
        case .windowVerticalScrub16: return "\u{fcab}"
        case .youtubeCircle24: return "\u{fcac}"
        case .youtubeCircle32: return "\u{fcad}"
        case .youtubeCircle40: return "\u{fcae}"
        case .zoomIn12: return "\u{fcaf}"
        case .zoomIn14: return "\u{fcb0}"
        case .zoomIn16: return "\u{fcb1}"
        case .zoomIn20: return "\u{fcb2}"
        case .zoomOut12: return "\u{fcb3}"
        case .zoomOut14: return "\u{fcb4}"
        case .zoomOut16: return "\u{fcb5}"
        case .zoomOut20: return "\u{fcb6}"
