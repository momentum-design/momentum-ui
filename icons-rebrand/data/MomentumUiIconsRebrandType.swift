...
@objc public enum MomentumIconsRebrandType: Int {
    ...
    public var ligature: String {
        ...
        case .emailBold: return "\u{f3ce}"
        case .emailDeliveredBold: return "\u{f3cf}"
        case .emailDeliveredLight: return "\u{f3d0}"
        case .emailDeliveredRegular: return "\u{f3d1}"
        case .emailFailureBold: return "\u{f3d2}"
        case .emailFailureLight: return "\u{f3d3}"
        case .emailFailureRegular: return "\u{f3d4}"
        case .emailFilled: return "\u{f3d5}"
        case .emailInviteBold: return "\u{f3d6}"
        case .emailInviteLight: return "\u{f3d7}"
        case .emailInviteRegular: return "\u{f3d8}"
        case .emailLight: return "\u{f3d9}"
        case .emailReadBold: return "\u{f3da}"
        case .emailReadFilled: return "\u{f3db}"
        case .emailReadLight: return "\u{f3dc}"
        case .emailReadRegular: return "\u{f3dd}"
        case .emailRegular: return "\u{f3de}"
        case .emojiExcitedBold: return "\u{f3df}"
        case .emojiExcitedFilled: return "\u{f3e0}"
        case .emojiHappyBold: return "\u{f3e1}"
        case .emojiHappyFilled: return "\u{f3e2}"
        case .emojiHappyLight: return "\u{f3e3}"
        case .emojiHappyRegular: return "\u{f3e4}"
        case .emojiPassiveBold: return "\u{f3e5}"
        case .emojiPassiveFilled: return "\u{f3e6}"
        case .emojiPassiveLight: return "\u{f3e7}"
        case .emojiPassiveRegular: return "\u{f3e8}"
        case .emojiSadBold: return "\u{f3e9}"
        case .emojiSadFilled: return "\u{f3ea}"
        case .emojiSadLight: return "\u{f3eb}"
        case .emojiSadRegular: return "\u{f3ec}"
        case .emojiUnhappyBold: return "\u{f3ed}"
        case .emojiUnhappyFilled: return "\u{f3ee}"
        case .encryptionCircleFilled: return "\u{f3ef}"
        case .encryptionFilled: return "\u{f3f0}"
        case .endRemoteDesktopControlBold: return "\u{f3f1}"
        case .endRemoteDesktopControlLight: return "\u{f3f2}"
        case .endRemoteDesktopControlRegular: return "\u{f3f3}"
        case .endToEndEncryptionCircleFilled: return "\u{f3f4}"
        case .endToEndEncryptionFilled: return "\u{f3f5}"
        case .endpointBlockedBold: return "\u{f3f6}"
        case .endpointBlockedLight: return "\u{f3f7}"
        case .endpointBlockedRegular: return "\u{f3f8}"
        case .endpointBold: return "\u{f3f9}"
        case .endpointG270Bold: return "\u{f3fa}"
        case .endpointG270DualBold: return "\u{f3fb}"
        case .endpointG270DualLight: return "\u{f3fc}"
        case .endpointG270DualRegular: return "\u{f3fd}"
        case .endpointG270Light: return "\u{f3fe}"
        case .endpointG270Regular: return "\u{f3ff}"
        case .endpointG2Bold: return "\u{f400}"
        case .endpointG2Light: return "\u{f401}"
        case .endpointG2Regular: return "\u{f402}"
        case .endpointG2StandBold: return "\u{f403}"
        case .endpointG2StandLight: return "\u{f404}"
        case .endpointG2StandRegular: return "\u{f405}"
        case .endpointLight: return "\u{f406}"
        case .endpointMx800Bold: return "\u{f407}"
        case .endpointMx800DualBold: return "\u{f408}"
        case .endpointMx800DualLight: return "\u{f409}"
        case .endpointMx800DualRegular: return "\u{f40a}"
        case .endpointMx800Light: return "\u{f40b}"
        case .endpointMx800Regular: return "\u{f40c}"
        case .endpointRegular: return "\u{f40d}"
        case .endpointStandBold: return "\u{f40e}"
        case .endpointStandFilled: return "\u{f40f}"
        case .endpointStandLight: return "\u{f410}"
        case .endpointStandRegular: return "\u{f411}"
        case .endpointWarningBold: return "\u{f412}"
        case .endpointWarningLight: return "\u{f413}"
        case .endpointWarningRegular: return "\u{f414}"
        case .enterBold: return "\u{f415}"
        case .enterLight: return "\u{f416}"
        case .enterRegular: return "\u{f417}"
        case .enterRoomBold: return "\u{f418}"
        case .enterRoomFilled: return "\u{f419}"
        case .enterRoomLight: return "\u{f41a}"
        case .enterRoomRegular: return "\u{f41b}"
        case .eraserBold: return "\u{f41c}"
        case .eraserFilled: return "\u{f41d}"
        case .eraserLight: return "\u{f41e}"
        case .eraserRegular: return "\u{f41f}"
        case .errorLegacyBadgeFilled: return "\u{f420}"
        case .errorLegacyBold: return "\u{f421}"
        case .errorLegacyFilled: return "\u{f422}"
        case .errorLegacyLight: return "\u{f423}"
        case .errorLegacyRegular: return "\u{f424}"
        case .ethernetBold: return "\u{f425}"
        case .ethernetLight: return "\u{f426}"
        case .ethernetRegular: return "\u{f427}"
        case .eventBold: return "\u{f428}"
        case .eventLight: return "\u{f429}"
        case .eventRegular: return "\u{f42a}"
        case .exitRoomBold: return "\u{f42b}"
        case .exitRoomLight: return "\u{f42c}"
        case .exitRoomRegular: return "\u{f42d}"
        case .exludeBold: return "\u{f42e}"
        case .exludeLight: return "\u{f42f}"
        case .exludeRegular: return "\u{f430}"
        case .exploreBold: return "\u{f431}"
        case .exploreLight: return "\u{f432}"
        case .exploreRegular: return "\u{f433}"
        case .exportBold: return "\u{f434}"
        case .exportLight: return "\u{f435}"
        case .exportRegular: return "\u{f436}"
        case .extensionMobilityBold: return "\u{f437}"
        case .extensionMobilityLight: return "\u{f438}"
        case .extensionMobilityRegular: return "\u{f439}"
        case .externalMessageBold: return "\u{f43a}"
        case .externalMessageLight: return "\u{f43b}"
        case .externalMessageRegular: return "\u{f43c}"
        case .externalUserBold: return "\u{f43d}"
        case .externalUserLight: return "\u{f43e}"
        case .externalUserRegular: return "\u{f43f}"
        case .familyFontBold: return "\u{f440}"
        case .familyFontLight: return "\u{f441}"
        case .familyFontRegular: return "\u{f442}"
        case .fastForwardBold: return "\u{f443}"
        case .fastForwardLight: return "\u{f444}"
        case .fastForwardRegular: return "\u{f445}"
        case .favoriteBold: return "\u{f446}"
        case .favoriteFilled: return "\u{f447}"
        case .favoriteLight: return "\u{f448}"
        case .favoriteRegular: return "\u{f449}"
        case .favoritesBold: return "\u{f44a}"
        case .favoritesFilled: return "\u{f44b}"
        case .favoritesLight: return "\u{f44c}"
        case .favoritesRegular: return "\u{f44d}"
        case .fbwBold: return "\u{f44e}"
        case .fbwFilled: return "\u{f44f}"
        case .fbwLight: return "\u{f450}"
        case .fbwRegular: return "\u{f451}"
        case .ffwBold: return "\u{f452}"
        case .ffwFilled: return "\u{f453}"
        case .ffwLight: return "\u{f454}"
        case .ffwRegular: return "\u{f455}"
        case .file3DBold: return "\u{f456}"
        case .file3DFilled: return "\u{f457}"
        case .file3DLight: return "\u{f458}"
        case .file3DRegular: return "\u{f459}"
        case .fileAnalysisBold: return "\u{f45a}"
        case .fileAnalysisFilled: return "\u{f45b}"
        case .fileAnalysisLight: return "\u{f45c}"
        case .fileAnalysisRegular: return "\u{f45d}"
        case .fileAnnotationBold: return "\u{f45e}"
        case .fileAnnotationFilled: return "\u{f45f}"
        case .fileAnnotationLight: return "\u{f460}"
        case .fileAnnotationRegular: return "\u{f461}"
        case .fileAudioBold: return "\u{f462}"
        case .fileAudioFilled: return "\u{f463}"
        case .fileAudioLight: return "\u{f464}"
        case .fileAudioRegular: return "\u{f465}"
        case .fileBugBold: return "\u{f466}"
        case .fileBugFilled: return "\u{f467}"
        case .fileBugLight: return "\u{f468}"
        case .fileBugRegular: return "\u{f469}"
        case .fileCodeBold: return "\u{f46a}"
        case .fileCodeFilled: return "\u{f46b}"
        case .fileCodeLight: return "\u{f46c}"
        case .fileCodeRegular: return "\u{f46d}"
        case .fileDashboardBold: return "\u{f46e}"
        case .fileDashboardFilled: return "\u{f46f}"
        case .fileDashboardLight: return "\u{f470}"
        case .fileDashboardRegular: return "\u{f471}"
        case .fileExcelBold: return "\u{f472}"
        case .fileExcelFilled: return "\u{f473}"
        case .fileExcelLight: return "\u{f474}"
        case .fileExcelRegular: return "\u{f475}"
        case .fileGraphBold: return "\u{f476}"
        case .fileGraphFilled: return "\u{f477}"
        case .fileGraphLight: return "\u{f478}"
        case .fileGraphRegular: return "\u{f479}"
        case .fileImageBold: return "\u{f47a}"
        case .fileImageFilled: return "\u{f47b}"
        case .fileImageLight: return "\u{f47c}"
        case .fileImageRegular: return "\u{f47d}"
        case .fileKeynoteBold: return "\u{f47e}"
        case .fileKeynoteFilled: return "\u{f47f}"
        case .fileKeynoteLight: return "\u{f480}"
        case .fileKeynoteRegular: return "\u{f481}"
        case .fileLockedBold: return "\u{f482}"
        case .fileLockedFilled: return "\u{f483}"
        case .fileLockedLight: return "\u{f484}"
        case .fileLockedRegular: return "\u{f485}"
        case .fileMissingBold: return "\u{f486}"
        case .fileMissingFilled: return "\u{f487}"
        case .fileMissingLight: return "\u{f488}"
        case .fileMissingRegular: return "\u{f489}"
        case .fileMusicBold: return "\u{f48a}"
        case .fileMusicFilled: return "\u{f48b}"
        case .fileMusicLight: return "\u{f48c}"
        case .fileMusicRegular: return "\u{f48d}"
        case .fileOnenoteBold: return "\u{f48e}"
        case .fileOnenoteFilled: return "\u{f48f}"
        case .fileOnenoteLight: return "\u{f490}"
        case .fileOnenoteRegular: return "\u{f491}"
        case .filePdfBold: return "\u{f492}"
        case .filePdfFilled: return "\u{f493}"
        case .filePdfLight: return "\u{f494}"
        case .filePdfRegular: return "\u{f495}"
        case .filePowerpointBold: return "\u{f496}"
        case .filePowerpointFilled: return "\u{f497}"
        case .filePowerpointLight: return "\u{f498}"
        case .filePowerpointRegular: return "\u{f499}"
        case .fileSpreadsheetBold: return "\u{f49a}"
        case .fileSpreadsheetFilled: return "\u{f49b}"
        case .fileSpreadsheetLight: return "\u{f49c}"
        case .fileSpreadsheetRegular: return "\u{f49d}"
        case .fileTextBold: return "\u{f49e}"
        case .fileTextFilled: return "\u{f49f}"
        case .fileTextLight: return "\u{f4a0}"
        case .fileTextRegular: return "\u{f4a1}"
        case .fileVectorBold: return "\u{f4a2}"
        case .fileVectorFilled: return "\u{f4a3}"
        case .fileVectorLight: return "\u{f4a4}"
        case .fileVectorRegular: return "\u{f4a5}"
        case .fileVideoBold: return "\u{f4a6}"
        case .fileVideoFilled: return "\u{f4a7}"
        case .fileVideoLight: return "\u{f4a8}"
        case .fileVideoRegular: return "\u{f4a9}"
        case .fileWordBold: return "\u{f4aa}"
        case .fileWordFilled: return "\u{f4ab}"
        case .fileWordLight: return "\u{f4ac}"
        case .fileWordRegular: return "\u{f4ad}"
        case .fileZipBold: return "\u{f4ae}"
        case .fileZipFilled: return "\u{f4af}"
        case .fileZipLight: return "\u{f4b0}"
        case .fileZipRegular: return "\u{f4b1}"
        case .filesBold: return "\u{f4b2}"
        case .filesFilled: return "\u{f4b3}"
        case .filesLight: return "\u{f4b4}"
        case .filesRegular: return "\u{f4b5}"
        case .fillColourBold: return "\u{f4b6}"
        case .fillColourFilled: return "\u{f4b7}"
        case .fillColourLight: return "\u{f4b8}"
        case .fillColourRegular: return "\u{f4b9}"
        case .filterBold: return "\u{f4ba}"
        case .filterCircleBold: return "\u{f4bb}"
        case .filterCircleFilled: return "\u{f4bc}"
        case .filterCircleLight: return "\u{f4bd}"
        case .filterCircleRegular: return "\u{f4be}"
        case .filterLight: return "\u{f4bf}"
        case .filterRegular: return "\u{f4c0}"
        case .fitToWidthBold: return "\u{f4c1}"
        case .fitToWidthLight: return "\u{f4c2}"
        case .fitToWidthRegular: return "\u{f4c3}"
        case .fitToWindowBold: return "\u{f4c4}"
        case .fitToWindowExitBold: return "\u{f4c5}"
        case .fitToWindowExitLight: return "\u{f4c6}"
        case .fitToWindowExitRegular: return "\u{f4c7}"
        case .fitToWindowLight: return "\u{f4c8}"
        case .fitToWindowRegular: return "\u{f4c9}"
        case .flagBold: return "\u{f4ca}"
        case .flagCircleBold: return "\u{f4cb}"
        case .flagCircleFilled: return "\u{f4cc}"
        case .flagCircleLight: return "\u{f4cd}"
        case .flagCircleRegular: return "\u{f4ce}"
        case .flagFilled: return "\u{f4cf}"
        case .flagLight: return "\u{f4d0}"
        case .flagRegular: return "\u{f4d1}"
        case .folderBold: return "\u{f4d2}"
        case .folderEditBold: return "\u{f4d3}"
        case .folderEditLight: return "\u{f4d4}"
        case .folderEditRegular: return "\u{f4d5}"
        case .folderLight: return "\u{f4d6}"
        case .folderLockBold: return "\u{f4d7}"
        case .folderLockLight: return "\u{f4d8}"
        case .folderLockRegular: return "\u{f4d9}"
        case .folderRegular: return "\u{f4da}"
        case .folderViewBold: return "\u{f4db}"
        case .folderViewLight: return "\u{f4dc}"
        case .folderViewRegular: return "\u{f4dd}"
        case .followUpBold: return "\u{f4de}"
        case .followUpLight: return "\u{f4df}"
        case .followUpRegular: return "\u{f4e0}"
        case .foodBold: return "\u{f4e1}"
        case .foodLight: return "\u{f4e2}"
        case .foodRegular: return "\u{f4e3}"
        case .formatBold: return "\u{f4e4}"
        case .formatControlPanelDraggerBold: return "\u{f4e5}"
        case .formatControlPanelDraggerHorizontalBold: return "\u{f4e6}"
        case .formatControlPanelDraggerHorizontalLight: return "\u{f4e7}"
        case .formatControlPanelDraggerHorizontalRegular: return "\u{f4e8}"
        case .formatControlPanelDraggerLight: return "\u{f4e9}"
        case .formatControlPanelDraggerRegular: return "\u{f4ea}"
        case .formatDefaultAppBold: return "\u{f4eb}"
        case .formatDefaultAppLight: return "\u{f4ec}"
        case .formatDefaultAppRegular: return "\u{f4ed}"
        case .formatLight: return "\u{f4ee}"
        case .formatPanelControlBarBold: return "\u{f4ef}"
        case .formatPanelControlBarLight: return "\u{f4f0}"
        case .formatPanelControlBarRegular: return "\u{f4f1}"
        case .formatPanelControlDownBold: return "\u{f4f2}"
        case .formatPanelControlDownLight: return "\u{f4f3}"
        case .formatPanelControlDownRegular: return "\u{f4f4}"
        case .formatPanelControlLeftBold: return "\u{f4f5}"
        case .formatPanelControlLeftLight: return "\u{f4f6}"
        case .formatPanelControlLeftRegular: return "\u{f4f7}"
        case .formatPanelControlRightBold: return "\u{f4f8}"
        case .formatPanelControlRightLight: return "\u{f4f9}"
        case .formatPanelControlRightRegular: return "\u{f4fa}"
        case .formatPanelControlUpBold: return "\u{f4fb}"
        case .formatPanelControlUpDownBold: return "\u{f4fc}"
        case .formatPanelControlUpDownLight: return "\u{f4fd}"
        case .formatPanelControlUpDownRegular: return "\u{f4fe}"
        case .formatPanelControlUpLight: return "\u{f4ff}"
        case .formatPanelControlUpRegular: return "\u{f500}"
        case .formatRegular: return "\u{f501}"
        case .formatViewMixedBold: return "\u{f502}"
        case .formatViewMixedLight: return "\u{f503}"
        case .formatViewMixedRegular: return "\u{f504}"
        case .forwardMessageBold: return "\u{f505}"
        case .forwardMessageFilled: return "\u{f506}"
        case .forwardMessageLight: return "\u{f507}"
        case .forwardMessageRegular: return "\u{f508}"
        case .fourColumnBold: return "\u{f509}"
        case .fourColumnLight: return "\u{f50a}"
        case .fourColumnRegular: return "\u{f50b}"
        case .fourWayNavigationBold: return "\u{f50c}"
        case .fourWayNavigationLight: return "\u{f50d}"
        case .fourWayNavigationRegular: return "\u{f50e}"
        case .frequencyCappingBold: return "\u{f50f}"
        case .frequencyCappingLight: return "\u{f510}"
        case .frequencyCappingRegular: return "\u{f511}"
        case .fufillmentBold: return "\u{f512}"
        case .fufillmentLight: return "\u{f513}"
        case .fufillmentRegular: return "\u{f514}"
        case .fullscreenBold: return "\u{f515}"
        case .fullscreenExitBold: return "\u{f516}"
        case .fullscreenExitLight: return "\u{f517}"
        case .fullscreenExitRegular: return "\u{f518}"
        case .fullscreenLight: return "\u{f519}"
        case .fullscreenRegular: return "\u{f51a}"
        case .genericDeviceVideoBold: return "\u{f51b}"
        case .genericDeviceVideoFilled: return "\u{f51c}"
        case .genericDeviceVideoLight: return "\u{f51d}"
        case .genericDeviceVideoRegular: return "\u{f51e}"
        case .genericDeviceVideoSmallFilled: return "\u{f51f}"
        case .gifBold: return "\u{f520}"
        case .gifFilled: return "\u{f521}"
        case .gifLight: return "\u{f522}"
        case .gifRegular: return "\u{f523}"
        case .greenRoomBold: return "\u{f524}"
        case .greenRoomFilled: return "\u{f525}"
        case .greenRoomLight: return "\u{f526}"
        case .greenRoomRegular: return "\u{f527}"
        case .groupBold: return "\u{f528}"
        case .groupLight: return "\u{f529}"
        case .groupPickupLight: return "\u{f52a}"
        case .groupPickupBold: return "\u{f52b}"
        case .groupPickupFilled: return "\u{f52c}"
        case .groupPickupRegular: return "\u{f52d}"
        case .groupRegular: return "\u{f52e}"
        case .guestIssuerBold: return "\u{f52f}"
        case .guestIssuerLight: return "\u{f530}"
        case .guestIssuerRegular: return "\u{f531}"
        case .guideBold: return "\u{f532}"
        case .guideLight: return "\u{f533}"
        case .guideRegular: return "\u{f534}"
        case .handlerBold: return "\u{f535}"
        case .handlerLight: return "\u{f536}"
        case .handlerRegular: return "\u{f537}"
        case .handsetAlertBold: return "\u{f538}"
        case .handsetAlertFilled: return "\u{f539}"
        case .handsetAlertLight: return "\u{f53a}"
        case .handsetAlertRegular: return "\u{f53b}"
        case .handsetBold: return "\u{f53c}"
        case .handsetFilled: return "\u{f53d}"
        case .handsetLight: return "\u{f53e}"
        case .handsetMutedBold: return "\u{f53f}"
        case .handsetMutedFilled: return "\u{f540}"
        case .handsetMutedLight: return "\u{f541}"
        case .handsetMutedRegular: return "\u{f542}"
        case .handsetRegular: return "\u{f543}"
        case .handshakeBold: return "\u{f544}"
        case .handshakeLight: return "\u{f545}"
        case .handshakeRegular: return "\u{f546}"
        case .headingOneBold: return "\u{f547}"
        case .headingOneLight: return "\u{f548}"
        case .headingOneRegular: return "\u{f549}"
        case .headingThreeBold: return "\u{f54a}"
        case .headingThreeLight: return "\u{f54b}"
        case .headingThreeRegular: return "\u{f54c}"
        case .headingTwoBold: return "\u{f54d}"
        case .headingTwoLight: return "\u{f54e}"
        case .headingTwoRegular: return "\u{f54f}"
        case .headsetAlertBold: return "\u{f550}"
        case .headsetAlertLight: return "\u{f551}"
        case .headsetAlertRegular: return "\u{f552}"
        case .headsetBold: return "\u{f553}"
        case .headsetFilled: return "\u{f554}"
        case .headsetLight: return "\u{f555}"
        case .headsetMutedBold: return "\u{f556}"
        case .headsetMutedLight: return "\u{f557}"
        case .headsetMutedRegular: return "\u{f558}"
        case .headsetPrivateBold: return "\u{f559}"
        case .headsetPrivateLight: return "\u{f55a}"
        case .headsetPrivateRegular: return "\u{f55b}"
        case .headsetRegular: return "\u{f55c}"
        case .helpBold: return "\u{f55d}"
        case .helpCircleActiveFilled: return "\u{f55e}"
        case .helpCircleBold: return "\u{f55f}"
        case .helpCircleLight: return "\u{f560}"
        case .helpCircleRegular: return "\u{f561}"
        case .helpLight: return "\u{f562}"
        case .helpRegular: return "\u{f563}"
        case .helpdeskBold: return "\u{f564}"
        case .helpdeskLight: return "\u{f565}"
        case .helpdeskRegular: return "\u{f566}"
        case .hideBold: return "\u{f567}"
        case .hideFilled: return "\u{f568}"
        case .hideLight: return "\u{f569}"
        case .hideRegular: return "\u{f56a}"
        case .homeBold: return "\u{f56b}"
        case .homeFilled: return "\u{f56c}"
        case .homeLight: return "\u{f56d}"
        case .homeRegular: return "\u{f56e}"
        case .horizontalLineBold: return "\u{f56f}"
        case .horizontalLineLight: return "\u{f570}"
        case .horizontalLineRegular: return "\u{f571}"
        case .humidityBold: return "\u{f572}"
        case .humidityLight: return "\u{f573}"
        case .humidityRegular: return "\u{f574}"
        case .huntGroupBold: return "\u{f575}"
        case .huntGroupFilled: return "\u{f576}"
        case .huntGroupLight: return "\u{f577}"
        case .huntGroupRegular: return "\u{f578}"
        case .importBold: return "\u{f579}"
        case .importLight: return "\u{f57a}"
        case .importRegular: return "\u{f57b}"
        case .includeBold: return "\u{f57c}"
        case .includeLight: return "\u{f57d}"
        case .includeRegular: return "\u{f57e}"
        case .incomingCallLegacyBold: return "\u{f57f}"
        case .incomingCallLegacyFilled: return "\u{f580}"
        case .incomingCallLegacyLight: return "\u{f581}"
        case .incomingCallLegacyRegular: return "\u{f582}"
        case .infoBadgeFilled: return "\u{f583}"
        case .infoCircleBold: return "\u{f584}"
        case .infoCircleFilled: return "\u{f585}"
        case .infoCircleLight: return "\u{f586}"
        case .infoCircleRegular: return "\u{f587}"
        case .infoCircleTwoBold: return "\u{f588}"
        case .infoCircleTwoFilled: return "\u{f589}"
        case .infoCircleTwoLight: return "\u{f58a}"
        case .infoCircleTwoRegular: return "\u{f58b}"
        case .inputBold: return "\u{f58c}"
        case .inputDisconnectedBold: return "\u{f58d}"
        case .inputDisconnectedLight: return "\u{f58e}"
        case .inputDisconnectedRegular: return "\u{f58f}"
        case .inputLight: return "\u{f590}"
        case .inputRegular: return "\u{f591}"
        case .insightsBold: return "\u{f592}"
        case .insightsLight: return "\u{f593}"
        case .insightsRegular: return "\u{f594}"
        case .integrationsBold: return "\u{f595}"
        case .integrationsLight: return "\u{f596}"
        case .integrationsRegular: return "\u{f597}"
        case .intelligentRoutingBold: return "\u{f598}"
        case .intelligentRoutingLight: return "\u{f599}"
        case .intelligentRoutingRegular: return "\u{f59a}"
        case .invitedUserBold: return "\u{f59b}"
        case .invitedUserLight: return "\u{f59c}"
        case .invitedUserRegular: return "\u{f59d}"
        case .italicBold: return "\u{f59e}"
        case .italicLight: return "\u{f59f}"
        case .italicRegular: return "\u{f5a0}"
        case .joinAudioBold: return "\u{f5a1}"
        case .joinAudioFilled: return "\u{f5a2}"
        case .joinAudioLight: return "\u{f5a3}"
        case .joinAudioRegular: return "\u{f5a4}"
        case .keyboardBold: return "\u{f5a5}"
        case .keyboardCloseBold: return "\u{f5a6}"
        case .keyboardCloseLight: return "\u{f5a7}"
        case .keyboardCloseRegular: return "\u{f5a8}"
        case .keyboardLight: return "\u{f5a9}"
        case .keyboardRegular: return "\u{f5aa}"
        case .languageBold: return "\u{f5ab}"
        case .languageLight: return "\u{f5ac}"
        case .languageRegular: return "\u{f5ad}"
        case .laptopBold: return "\u{f5ae}"
        case .laptopDisconnectedBold: return "\u{f5af}"
        case .laptopDisconnectedLight: return "\u{f5b0}"
        case .laptopDisconnectedRegular: return "\u{f5b1}"
        case .laptopFilled: return "\u{f5b2}"
        case .laptopLight: return "\u{f5b3}"
        case .laptopRegular: return "\u{f5b4}"
        case .laserPointerBold: return "\u{f5b5}"
        case .laserPointerLight: return "\u{f5b6}"
        case .laserPointerRegular: return "\u{f5b7}"
        case .launchBold: return "\u{f5b8}"
        case .launchLight: return "\u{f5b9}"
        case .launchRegular: return "\u{f5ba}"
        case .layoutSideBySideVerticalBold: return "\u{f5bb}"
        case .layoutSideBySideVerticalFilled: return "\u{f5bc}"
        case .layoutSideBySideVerticalLight: return "\u{f5bd}"
        case .layoutSideBySideVerticalRegular: return "\u{f5be}"
        case .leaveBreakoutSessionBold: return "\u{f5bf}"
        case .leaveBreakoutSessionLight: return "\u{f5c0}"
        case .leaveBreakoutSessionRegular: return "\u{f5c1}"
        case .leaveDeviceBold: return "\u{f5c2}"
        case .leaveDeviceLight: return "\u{f5c3}"
        case .leaveDeviceRegular: return "\u{f5c4}"
        case .likeBold: return "\u{f5c5}"
        case .likeFilled: return "\u{f5c6}"
        case .likeLight: return "\u{f5c7}"
        case .likeRegular: return "\u{f5c8}"
        case .linkBold: return "\u{f5c9}"
        case .linkLight: return "\u{f5ca}"
        case .linkRegular: return "\u{f5cb}"
        case .listBulletedBold: return "\u{f5cc}"
        case .listBulletedLight: return "\u{f5cd}"
        case .listBulletedRegular: return "\u{f5ce}"
        case .listMenuBold: return "\u{f5cf}"
        case .listMenuLight: return "\u{f5d0}"
        case .listMenuRegular: return "\u{f5d1}"
        case .listNumberedBold: return "\u{f5d2}"
        case .listNumberedLight: return "\u{f5d3}"
        case .listNumberedRegular: return "\u{f5d4}"
        case .locationBold: return "\u{f5d5}"
        case .locationFilled: return "\u{f5d6}"
        case .locationLight: return "\u{f5d7}"
        case .locationRegular: return "\u{f5d8}"
        case .longTextBoxBold: return "\u{f5d9}"
        case .longTextBoxLight: return "\u{f5da}"
        case .longTextBoxRegular: return "\u{f5db}"
        case .lowerHandBold: return "\u{f5dc}"
        case .lowerHandLight: return "\u{f5dd}"
        case .lowerHandRegular: return "\u{f5de}"
        case .magicPenBold: return "\u{f5df}"
        case .magicPenFilled: return "\u{f5e0}"
        case .magicPenLight: return "\u{f5e1}"
        case .magicPenRegular: return "\u{f5e2}"
        case .markAsUnreadBold: return "\u{f5e3}"
        case .markAsUnreadLight: return "\u{f5e4}"
        case .markAsUnreadRegular: return "\u{f5e5}"
        case .markdownBold: return "\u{f5e6}"
        case .markdownLight: return "\u{f5e7}"
        case .markdownRegular: return "\u{f5e8}"
        case .markerBold: return "\u{f5e9}"
        case .markerFilled: return "\u{f5ea}"
        case .markerLight: return "\u{f5eb}"
        case .markerRegular: return "\u{f5ec}"
        case .maximizeBold: return "\u{f5ed}"
        case .maximizeLight: return "\u{f5ee}"
        case .maximizeRegular: return "\u{f5ef}"
        case .mediaPlayerBold: return "\u{f5f0}"
        case .mediaPlayerLight: return "\u{f5f1}"
        case .mediaPlayerRegular: return "\u{f5f2}"
        case .mediaQualityGoodBold: return "\u{f5f3}"
        case .mediaQualityGoodFilled: return "\u{f5f4}"
        case .mediaQualityGoodLight: return "\u{f5f5}"
        case .mediaQualityGoodRegular: return "\u{f5f6}"
        case .mediaQualityPoorBold: return "\u{f5f7}"
        case .mediaQualityPoorFilled: return "\u{f5f8}"
        case .mediaQualityPoorLight: return "\u{f5f9}"
        case .mediaQualityPoorRegular: return "\u{f5fa}"
        case .mediaQualityUnstableBold: return "\u{f5fb}"
        case .mediaQualityUnstableFilled: return "\u{f5fc}"
        case .mediaQualityUnstableLight: return "\u{f5fd}"
        case .mediaQualityUnstableRegular: return "\u{f5fe}"
        case .meetBold: return "\u{f5ff}"
        case .meetEndBold: return "\u{f600}"
        case .meetEndLight: return "\u{f601}"
        case .meetEndRegular: return "\u{f602}"
        case .meetFilled: return "\u{f603}"
        case .meetLight: return "\u{f604}"
        case .meetRegular: return "\u{f605}"
        case .meetingsBold: return "\u{f606}"
        case .meetingsFilled: return "\u{f607}"
        case .meetingsFocusMonthBold: return "\u{f608}"
        case .meetingsFocusMonthLight: return "\u{f609}"
        case .meetingsFocusMonthRegular: return "\u{f60a}"
        case .meetingsFocusOneDayBold: return "\u{f60b}"
        case .meetingsFocusOneDayLight: return "\u{f60c}"
        case .meetingsFocusOneDayRegular: return "\u{f60d}"
        case .meetingsFocusThreeDayBold: return "\u{f60e}"
        case .meetingsFocusThreeDayLight: return "\u{f60f}"
        case .meetingsFocusThreeDayRegular: return "\u{f610}"
        case .meetingsFocusUpcomingBold: return "\u{f611}"
        case .meetingsFocusUpcomingLight: return "\u{f612}"
        case .meetingsFocusUpcomingRegular: return "\u{f613}"
        case .meetingsFocusWeekBold: return "\u{f614}"
        case .meetingsFocusWeekLight: return "\u{f615}"
        case .meetingsFocusWeekRegular: return "\u{f616}"
        case .meetingsLight: return "\u{f617}"
        case .meetingsPresenceBold: return "\u{f618}"
        case .meetingsPresenceFilled: return "\u{f619}"
        case .meetingsPresenceLight: return "\u{f61a}"
        case .meetingsPresenceRegular: return "\u{f61b}"
        case .meetingsPresenceSmallFilled: return "\u{f61c}"
        case .meetingsRegular: return "\u{f61d}"
        case .meetingsTeamActiveBold: return "\u{f61e}"
        case .meetingsTeamActiveLight: return "\u{f61f}"
        case .meetingsTeamActiveRegular: return "\u{f620}"
        case .meetingsTeamBold: return "\u{f621}"
        case .meetingsTeamLight: return "\u{f622}"
        case .meetingsTeamNewBold: return "\u{f623}"
        case .meetingsTeamNewLight: return "\u{f624}"
        case .meetingsTeamNewRegular: return "\u{f625}"
        case .meetingsTeamRegular: return "\u{f626}"
        case .mentionBold: return "\u{f627}"
        case .mentionLight: return "\u{f628}"
        case .mentionRegular: return "\u{f629}"
        case .messageQueingBold: return "\u{f62a}"
        case .messageQueingLight: return "\u{f62b}"
        case .messageQueingRegular: return "\u{f62c}"
        case .microphoneBold: return "\u{f62d}"
        case .microphoneFilled: return "\u{f62e}"
        case .microphoneHardMutedBold: return "\u{f62f}"
        case .microphoneHardMutedColoredBold: return "\u{f630}"
        case .microphoneHardMutedColoredLight: return "\u{f631}"
        case .microphoneHardMutedColoredRegular: return "\u{f632}"
        case .microphoneHardMutedLight: return "\u{f633}"
        case .microphoneHardMutedRegular: return "\u{f634}"
        case .microphoneLight: return "\u{f635}"
        case .microphoneMusicModeColoredBold: return "\u{f636}"
        case .microphoneMusicModeColoredLight: return "\u{f637}"
        case .microphoneMusicModeColoredRegular: return "\u{f638}"
        case .microphoneMutedBold: return "\u{f639}"
        case .microphoneMutedFilled: return "\u{f63a}"
        case .microphoneMutedIndicatorFilled: return "\u{f63b}"
        case .microphoneMutedLight: return "\u{f63c}"
        case .microphoneMutedRedBold: return "\u{f63d}"
        case .microphoneMutedRedFilled: return "\u{f63e}"
        case .microphoneMutedRedLight: return "\u{f63f}"
        case .microphoneMutedRedRegular: return "\u{f640}"
        case .microphoneMutedRegular: return "\u{f641}"
        case .microphoneRegular: return "\u{f642}"
        case .minimizeBold: return "\u{f643}"
        case .minimizeLight: return "\u{f644}"
        case .minimizeRegular: return "\u{f645}"
        case .minusBold: return "\u{f646}"
        case .minusLight: return "\u{f647}"
        case .minusRegular: return "\u{f648}"
        case .mirrorBold: return "\u{f649}"
        case .mirrorFilled: return "\u{f64a}"
        case .mirrorLight: return "\u{f64b}"
        case .mirrorRegular: return "\u{f64c}"
        case .monitoringBold: return "\u{f64d}"
        case .monitoringLight: return "\u{f64e}"
        case .monitoringRegular: return "\u{f64f}"
        case .monthlyRecurringScheduleNodeBold: return "\u{f650}"
        case .monthlyRecurringScheduleNodeLight: return "\u{f651}"
        case .monthlyRecurringScheduleNodeRegular: return "\u{f652}"
        case .moreAdrBold: return "\u{f653}"
        case .moreAdrLight: return "\u{f654}"
        case .moreAdrRegular: return "\u{f655}"
        case .moreBold: return "\u{f656}"
        case .moreCircleBold: return "\u{f657}"
        case .moreCircleFilled: return "\u{f658}"
        case .moreCircleLight: return "\u{f659}"
        case .moreCircleRegular: return "\u{f65a}"
        case .moreLight: return "\u{f65b}"
        case .moreRegular: return "\u{f65c}"
        case .mouseCursorBold: return "\u{f65d}"
        case .mouseCursorLight: return "\u{f65e}"
        case .mouseCursorRegular: return "\u{f65f}"
        case .moveCallInAdrBold: return "\u{f660}"
        case .moveCallInAdrLight: return "\u{f661}"
        case .moveCallInAdrRegular: return "\u{f662}"
        case .moveCallInIphBold: return "\u{f663}"
        case .moveCallInIphLight: return "\u{f664}"
        case .moveCallInIphRegular: return "\u{f665}"
        case .moveCallInLaptopBold: return "\u{f666}"
        case .moveCallInLaptopLight: return "\u{f667}"
        case .moveCallInLaptopRegular: return "\u{f668}"
        case .moveCallInOutAdrBold: return "\u{f669}"
        case .moveCallInOutAdrLight: return "\u{f66a}"
        case .moveCallInOutAdrRegular: return "\u{f66b}"
        case .moveCallInOutIphBold: return "\u{f66c}"
        case .moveCallInOutIphLight: return "\u{f66d}"
        case .moveCallInOutIphRegular: return "\u{f66e}"
        case .moveCallInTabletBold: return "\u{f66f}"
        case .moveCallInTabletLight: return "\u{f670}"
        case .moveCallInTabletRegular: return "\u{f671}"
        case .moveCallOutAdrBold: return "\u{f672}"
        case .moveCallOutAdrLight: return "\u{f673}"
        case .moveCallOutAdrRegular: return "\u{f674}"
        case .moveCallOutIphBold: return "\u{f675}"
        case .moveCallOutIphLight: return "\u{f676}"
        case .moveCallOutIphRegular: return "\u{f677}"
        case .moveCallOutLaptopBold: return "\u{f678}"
        case .moveCallOutLaptopLight: return "\u{f679}"
        case .moveCallOutLaptopRegular: return "\u{f67a}"
        case .moveCallOutTabletBold: return "\u{f67b}"
        case .moveCallOutTabletLight: return "\u{f67c}"
        case .moveCallOutTabletRegular: return "\u{f67d}"
        case .multilineChartBold: return "\u{f67e}"
        case .multilineChartFilled: return "\u{f67f}"
        case .multilineChartLight: return "\u{f680}"
        case .multilineChartRegular: return "\u{f681}"
        case .multimediaBold: return "\u{f682}"
        case .multimediaFilled: return "\u{f683}"
        case .multimediaLight: return "\u{f684}"
        case .multimediaRegular: return "\u{f685}"
        case .multipledDevicesBold: return "\u{f686}"
        case .multipledDevicesLight: return "\u{f687}"
        case .multipledDevicesRegular: return "\u{f688}"
        case .musicModeBold: return "\u{f689}"
        case .musicModeCircleBold: return "\u{f68a}"
        case .musicModeCircleFilled: return "\u{f68b}"
        case .musicModeCircleLight: return "\u{f68c}"
        case .musicModeCircleRegular: return "\u{f68d}"
        case .musicModeFilled: return "\u{f68e}"
        case .musicModeLight: return "\u{f68f}"
        case .musicModeRegular: return "\u{f690}"
        case .muteOnEntryBold: return "\u{f691}"
        case .muteOnEntryFilled: return "\u{f692}"
        case .muteOnEntryLight: return "\u{f693}"
        case .muteOnEntryRegular: return "\u{f694}"
        case .newVoicemailBold: return "\u{f695}"
        case .newVoicemailLight: return "\u{f696}"
        case .newVoicemailRegular: return "\u{f697}"
        case .newWhiteboardBold: return "\u{f698}"
        case .newWhiteboardLight: return "\u{f699}"
        case .newWhiteboardRegular: return "\u{f69a}"
        case .nextBold: return "\u{f69b}"
        case .nextLight: return "\u{f69c}"
        case .nextRegular: return "\u{f69d}"
        case .noDevicesBold: return "\u{f69e}"
        case .noDevicesLight: return "\u{f69f}"
        case .noDevicesRegular: return "\u{f6a0}"
        case .noiseDetectedCanceledFilled: return "\u{f6a1}"
        case .noiseDetectedFilled: return "\u{f6a2}"
        case .noiseNoneCanceledFilled: return "\u{f6a3}"
        case .noiseNoneFilled: return "\u{f6a4}"
        case .noiseRemovalBold: return "\u{f6a5}"
        case .noiseRemovalLight: return "\u{f6a6}"
        case .noiseRemovalRegular: return "\u{f6a7}"
        case .noteBold: return "\u{f6a8}"
        case .noteLight: return "\u{f6a9}"
        case .notePptBold: return "\u{f6aa}"
        case .notePptLight: return "\u{f6ab}"
        case .notePptRegular: return "\u{f6ac}"
        case .noteRegular: return "\u{f6ad}"
        case .notesBold: return "\u{f6ae}"
        case .notesLight: return "\u{f6af}"
        case .notesRegular: return "\u{f6b0}"
        case .numberBold: return "\u{f6b1}"
        case .numberLight: return "\u{f6b2}"
        case .numberRegular: return "\u{f6b3}"
        case .oldRemoteBold: return "\u{f6b4}"
        case .oldRemoteLight: return "\u{f6b5}"
        case .oldRemoteRegular: return "\u{f6b6}"
        case .oldTouchBold: return "\u{f6b7}"
        case .oldTouchLight: return "\u{f6b8}"
        case .oldTouchRegular: return "\u{f6b9}"
        case .oneColumnBold: return "\u{f6ba}"
        case .oneColumnLight: return "\u{f6bb}"
        case .oneColumnRegular: return "\u{f6bc}"
        case .openInFolderBold: return "\u{f6bd}"
        case .openInFolderLight: return "\u{f6be}"
        case .openInFolderRegular: return "\u{f6bf}"
        case .openPagesBold: return "\u{f6c0}"
        case .openPagesLight: return "\u{f6c1}"
        case .openPagesRegular: return "\u{f6c2}"
        case .otherNumberBold: return "\u{f6c3}"
        case .otherNumberLight: return "\u{f6c4}"
        case .otherNumberRegular: return "\u{f6c5}"
        case .otherNumberWarningBold: return "\u{f6c6}"
        case .otherNumberWarningLight: return "\u{f6c7}"
        case .otherNumberWarningRegular: return "\u{f6c8}"
        case .outgoingCallLegacyBold: return "\u{f6c9}"
        case .outgoingCallLegacyLight: return "\u{f6ca}"
        case .outgoingCallLegacyRegular: return "\u{f6cb}"
        case .overflowLeftBold: return "\u{f6cc}"
        case .overflowLeftLight: return "\u{f6cd}"
        case .overflowLeftRegular: return "\u{f6ce}"
        case .overflowRightBold: return "\u{f6cf}"
        case .overflowRightLight: return "\u{f6d0}"
        case .overflowRightRegular: return "\u{f6d1}"
        case .pairedCameraBold: return "\u{f6d2}"
        case .pairedCameraLight: return "\u{f6d3}"
        case .pairedCameraRegular: return "\u{f6d4}"
        case .pairedDeviceBold: return "\u{f6d5}"
        case .pairedDeviceLight: return "\u{f6d6}"
        case .pairedDeviceRegular: return "\u{f6d7}"
        case .pairedHandsetBold: return "\u{f6d8}"
        case .pairedHandsetLight: return "\u{f6d9}"
        case .pairedHandsetRegular: return "\u{f6da}"
        case .pairingBold: return "\u{f6db}"
        case .pairingLight: return "\u{f6dc}"
        case .pairingRegular: return "\u{f6dd}"
        case .parkedBold: return "\u{f6de}"
        case .parkedFilled: return "\u{f6df}"
        case .parkedLight: return "\u{f6e0}"
        case .parkedRegular: return "\u{f6e1}"
        case .parseBold: return "\u{f6e2}"
        case .parseLight: return "\u{f6e3}"
        case .parseRegular: return "\u{f6e4}"
        case .partialBold: return "\u{f6e5}"
        case .partialLight: return "\u{f6e6}"
        case .partialRegular: return "\u{f6e7}"
        case .participantAddBold: return "\u{f6e8}"
        case .participantAddLight: return "\u{f6e9}"
        case .participantAddRegular: return "\u{f6ea}"
        case .participantBlockedBold: return "\u{f6eb}"
        case .participantBlockedLight: return "\u{f6ec}"
        case .participantBlockedRegular: return "\u{f6ed}"
        case .participantBold: return "\u{f6ee}"
        case .participantFilled: return "\u{f6ef}"
        case .participantLight: return "\u{f6f0}"
        case .participantListBold: return "\u{f6f1}"
        case .participantListFilled: return "\u{f6f2}"
        case .participantListLight: return "\u{f6f3}"
        case .participantListRegular: return "\u{f6f4}"
        case .participantRegular: return "\u{f6f5}"
        case .participantRemoveBold: return "\u{f6f6}"
        case .participantRemoveLight: return "\u{f6f7}"
        case .participantRemoveRegular: return "\u{f6f8}"
        case .participantUnknownBold: return "\u{f6f9}"
        case .participantUnknownLight: return "\u{f6fa}"
        case .participantUnknownRegular: return "\u{f6fb}"
        case .passMouseBold: return "\u{f6fc}"
        case .passMouseLight: return "\u{f6fd}"
        case .passMouseRegular: return "\u{f6fe}"
        case .pauseBold: return "\u{f6ff}"
        case .pauseFilled: return "\u{f700}"
        case .pauseLight: return "\u{f701}"
        case .pauseRegular: return "\u{f702}"
        case .penBold: return "\u{f703}"
        case .penFilled: return "\u{f704}"
        case .penLight: return "\u{f705}"
        case .penRegular: return "\u{f706}"
        case .peopleBold: return "\u{f707}"
        case .peopleCircleBold: return "\u{f708}"
        case .peopleCircleFilled: return "\u{f709}"
        case .peopleCircleLight: return "\u{f70a}"
        case .peopleCircleRegular: return "\u{f70b}"
        case .peopleFilled: return "\u{f70c}"
        case .peopleInsightsFilled: return "\u{f70d}"
        case .peopleLight: return "\u{f70e}"
        case .peopleRegular: return "\u{f70f}"
        case .phoneAlertBold: return "\u{f710}"
        case .phoneAlertLight: return "\u{f711}"
        case .phoneAlertRegular: return "\u{f712}"
        case .phoneBold: return "\u{f713}"
        case .phoneFilled: return "\u{f714}"
        case .phoneLight: return "\u{f715}"
        case .phoneMutedBold: return "\u{f716}"
        case .phoneMutedLight: return "\u{f717}"
        case .phoneMutedRegular: return "\u{f718}"
        case .phonePrivateBold: return "\u{f719}"
        case .phonePrivateLight: return "\u{f71a}"
        case .phonePrivateRegular: return "\u{f71b}"
        case .phoneRegular: return "\u{f71c}"
        case .phoneReplyAllBold: return "\u{f71d}"
        case .phoneReplyAllLight: return "\u{f71e}"
        case .phoneReplyAllRegular: return "\u{f71f}"
        case .phoneReplyBold: return "\u{f720}"
        case .phoneReplyLight: return "\u{f721}"
        case .phoneReplyRegular: return "\u{f722}"
        case .phoneSmallFilled: return "\u{f723}"
        case .pickerBold: return "\u{f724}"
        case .pickerLight: return "\u{f725}"
        case .pickerRegular: return "\u{f726}"
        case .pictureInPictureBold: return "\u{f727}"
        case .pictureInPictureFilled: return "\u{f728}"
        case .pictureInPictureLight: return "\u{f729}"
        case .pictureInPictureRegular: return "\u{f72a}"
        case .pieChartBold: return "\u{f72b}"
        case .pieChartFilled: return "\u{f72c}"
        case .pieChartLight: return "\u{f72d}"
        case .pieChartRegular: return "\u{f72e}"
        case .pinBold: return "\u{f72f}"
        case .pinFilled: return "\u{f730}"
        case .pinLight: return "\u{f731}"
        case .pinListActivityBold: return "\u{f732}"
        case .pinListActivityColoredBold: return "\u{f733}"
        case .pinListActivityColoredLight: return "\u{f734}"
        case .pinListActivityColoredRegular: return "\u{f735}"
        case .pinListActivityLight: return "\u{f736}"
        case .pinListActivityRegular: return "\u{f737}"
        case .pinListBold: return "\u{f738}"
        case .pinListLight: return "\u{f739}"
        case .pinListRegular: return "\u{f73a}"
        case .pinMutedBold: return "\u{f73b}"
        case .pinMutedFilled: return "\u{f73c}"
        case .pinMutedLight: return "\u{f73d}"
        case .pinMutedRegular: return "\u{f73e}"
        case .pinRegular: return "\u{f73f}"
        case .placeholderBold: return "\u{f740}"
        case .placeholderLight: return "\u{f741}"
        case .placeholderRegular: return "\u{f742}"
        case .playBold: return "\u{f743}"
        case .playFilled: return "\u{f744}"
        case .playLight: return "\u{f745}"
        case .playRegular: return "\u{f746}"
        case .plugAcBold: return "\u{f747}"
        case .plugAcLight: return "\u{f748}"
        case .plugAcRegular: return "\u{f749}"
        case .plusBold: return "\u{f74a}"
        case .plusCircleBold: return "\u{f74b}"
        case .plusCircleFilled: return "\u{f74c}"
        case .plusCircleLight: return "\u{f74d}"
        case .plusCircleRegular: return "\u{f74e}"
        case .plusLight: return "\u{f74f}"
        case .plusRegular: return "\u{f750}"
        case .pmrBold: return "\u{f751}"
        case .pmrFilled: return "\u{f752}"
        case .pmrLight: return "\u{f753}"
        case .pmrRegular: return "\u{f754}"
        case .pollBold: return "\u{f755}"
        case .pollLight: return "\u{f756}"
        case .pollRegular: return "\u{f757}"
        case .popInBold: return "\u{f758}"
        case .popInLight: return "\u{f759}"
        case .popInRegular: return "\u{f75a}"
        case .popOutBold: return "\u{f75b}"
        case .popOutLight: return "\u{f75c}"
        case .popOutRegular: return "\u{f75d}"
        case .popUpBold: return "\u{f75e}"
        case .popUpLight: return "\u{f75f}"
        case .popUpRegular: return "\u{f760}"
        case .portraitLandscapeBold: return "\u{f761}"
        case .portraitLandscapeLight: return "\u{f762}"
        case .portraitLandscapeRegular: return "\u{f763}"
        case .powerAcBold: return "\u{f764}"
        case .powerAcLight: return "\u{f765}"
        case .powerAcRegular: return "\u{f766}"
        case .powerBold: return "\u{f767}"
        case .powerLight: return "\u{f768}"
        case .powerRegular: return "\u{f769}"
        case .preHeaderBold: return "\u{f76a}"
        case .preHeaderLight: return "\u{f76b}"
        case .preHeaderRegular: return "\u{f76c}"
        case .presentationBold: return "\u{f76d}"
        case .presentationLight: return "\u{f76e}"
        case .presentationRegular: return "\u{f76f}"
        case .primaryParticipantBold: return "\u{f770}"
        case .primaryParticipantLight: return "\u{f771}"
        case .primaryParticipantRegular: return "\u{f772}"
        case .printBold: return "\u{f773}"
        case .printLight: return "\u{f774}"
        case .printRegular: return "\u{f775}"
        case .priorityBadgeFilled: return "\u{f776}"
        case .priorityCircleBold: return "\u{f777}"
        case .priorityCircleFilled: return "\u{f778}"
        case .priorityCircleLight: return "\u{f779}"
        case .priorityCircleRegular: return "\u{f77a}"
        case .priorityCircleTwoBold: return "\u{f77b}"
        case .priorityCircleTwoFilled: return "\u{f77c}"
        case .priorityCircleTwoLight: return "\u{f77d}"
        case .priorityCircleTwoRegular: return "\u{f77e}"
        case .privacyCircleBold: return "\u{f77f}"
        case .privacyCircleFilled: return "\u{f780}"
        case .privacyCircleLight: return "\u{f781}"
        case .privacyCircleRegular: return "\u{f782}"
        case .privateBold: return "\u{f783}"
        case .privateCircleBold: return "\u{f784}"
        case .privateCircleFilled: return "\u{f785}"
        case .privateCircleLight: return "\u{f786}"
        case .privateCircleRegular: return "\u{f787}"
        case .privateLight: return "\u{f788}"
        case .privateMeetingBold: return "\u{f789}"
        case .privateMeetingLight: return "\u{f78a}"
        case .privateMeetingRegular: return "\u{f78b}"
        case .privateRegular: return "\u{f78c}"
        case .productDemoBold: return "\u{f78d}"
        case .productDemoLight: return "\u{f78e}"
        case .productDemoRegular: return "\u{f78f}"
        case .proximityBold: return "\u{f790}"
        case .proximityLight: return "\u{f791}"
        case .proximityMutedBold: return "\u{f792}"
        case .proximityMutedLight: return "\u{f793}"
        case .proximityMutedRegular: return "\u{f794}"
        case .proximityRegular: return "\u{f795}"
        case .proximityVideoBold: return "\u{f796}"
        case .proximityVideoLight: return "\u{f797}"
        case .proximityVideoRegular: return "\u{f798}"
        case .ptoPresenceBold: return "\u{f799}"
        case .ptoPresenceFilled: return "\u{f79a}"
        case .ptoPresenceLight: return "\u{f79b}"
        case .ptoPresenceRegular: return "\u{f79c}"
        case .pullCallBold: return "\u{f79d}"
        case .pullCallLight: return "\u{f79e}"
        case .pullCallRegular: return "\u{f79f}"
        case .qABold: return "\u{f7a0}"
        case .qALight: return "\u{f7a1}"
        case .qARegular: return "\u{f7a2}"
        case .qualityBold: return "\u{f7a3}"
        case .qualityLight: return "\u{f7a4}"
        case .qualityRegular: return "\u{f7a5}"
        case .queueContactBold: return "\u{f7a6}"
        case .queueContactLight: return "\u{f7a7}"
        case .queueContactRegular: return "\u{f7a8}"
        case .quietBold: return "\u{f7a9}"
        case .quietHoursPresenceBold: return "\u{f7aa}"
        case .quietHoursPresenceFilled: return "\u{f7ab}"
        case .quietHoursPresenceLight: return "\u{f7ac}"
        case .quietHoursPresenceRegular: return "\u{f7ad}"
        case .quietLight: return "\u{f7ae}"
        case .quietRegular: return "\u{f7af}"
        case .radioButtonGroupBold: return "\u{f7b0}"
        case .radioButtonGroupLight: return "\u{f7b1}"
        case .radioButtonGroupRegular: return "\u{f7b2}"
        case .raiseHandBold: return "\u{f7b3}"
        case .raiseHandLight: return "\u{f7b4}"
        case .raiseHandRegular: return "\u{f7b5}"
        case .ramBold: return "\u{f7b6}"
        case .ramLight: return "\u{f7b7}"
        case .ramRegular: return "\u{f7b8}"
        case .reactionsBold: return "\u{f7b9}"
        case .reactionsFilled: return "\u{f7ba}"
        case .reactionsLight: return "\u{f7bb}"
        case .reactionsRegular: return "\u{f7bc}"
        case .reactivateBold: return "\u{f7bd}"
        case .reactivateLight: return "\u{f7be}"
        case .reactivateRegular: return "\u{f7bf}"
        case .recentsBold: return "\u{f7c0}"
        case .recentsFilled: return "\u{f7c1}"
        case .recentsLight: return "\u{f7c2}"
        case .recentsPresenceBold: return "\u{f7c3}"
        case .recentsPresenceFilled: return "\u{f7c4}"
        case .recentsPresenceLight: return "\u{f7c5}"
        case .recentsPresenceRegular: return "\u{f7c6}"
        case .recentsPresenceSmallFilled: return "\u{f7c7}"
        case .recentsRegular: return "\u{f7c8}"
        case .recordBold: return "\u{f7c9}"
        case .recordFilled: return "\u{f7ca}"
        case .recordLight: return "\u{f7cb}"
        case .recordPausedBold: return "\u{f7cc}"
        case .recordPausedFilled: return "\u{f7cd}"
        case .recordPausedLight: return "\u{f7ce}"
        case .recordPausedRegular: return "\u{f7cf}"
        case .recordRegular: return "\u{f7d0}"
        case .recurringBold: return "\u{f7d1}"
        case .recurringLight: return "\u{f7d2}"
        case .recurringOffBold: return "\u{f7d3}"
        case .recurringOffLight: return "\u{f7d4}"
        case .recurringOffRegular: return "\u{f7d5}"
        case .recurringRegular: return "\u{f7d6}"
        case .redialBold: return "\u{f7d7}"
        case .redialLight: return "\u{f7d8}"
        case .redialRegular: return "\u{f7d9}"
        case .redoBold: return "\u{f7da}"
        case .redoLight: return "\u{f7db}"
        case .redoRegular: return "\u{f7dc}"
        case .refreshBold: return "\u{f7dd}"
        case .refreshLight: return "\u{f7de}"
        case .refreshRegular: return "\u{f7df}"
        case .remoteCallBold: return "\u{f7e0}"
        case .remoteCallFilled: return "\u{f7e1}"
        case .remoteCallLight: return "\u{f7e2}"
        case .remoteCallRegular: return "\u{f7e3}"
        case .remoteDesktopControlBold: return "\u{f7e4}"
        case .remoteDesktopControlFilled: return "\u{f7e5}"
        case .remoteDesktopControlLight: return "\u{f7e6}"
        case .remoteDesktopControlRegular: return "\u{f7e7}"
        case .removeBold: return "\u{f7e8}"
        case .removeFilled: return "\u{f7e9}"
        case .removeLight: return "\u{f7ea}"
        case .removeRegular: return "\u{f7eb}"
        case .replyBold: return "\u{f7ec}"
        case .replyFilled: return "\u{f7ed}"
        case .replyLight: return "\u{f7ee}"
        case .replyListBold: return "\u{f7ef}"
        case .replyListLight: return "\u{f7f0}"
        case .replyListRegular: return "\u{f7f1}"
        case .replyRegular: return "\u{f7f2}"
        case .resetBold: return "\u{f7f3}"
        case .resetLight: return "\u{f7f4}"
        case .resetRegular: return "\u{f7f5}"
        case .responsiveMobileBold: return "\u{f7f6}"
        case .responsiveMobileLight: return "\u{f7f7}"
        case .responsiveMobileRegular: return "\u{f7f8}"
        case .restartBold: return "\u{f7f9}"
        case .restartLight: return "\u{f7fa}"
        case .restartRegular: return "\u{f7fb}"
        case .retrieveCallBold: return "\u{f7fc}"
        case .retrieveCallLight: return "\u{f7fd}"
        case .retrieveCallRegular: return "\u{f7fe}"
        case .returnBold: return "\u{f7ff}"
        case .returnLight: return "\u{f800}"
        case .returnRegular: return "\u{f801}"
        case .ringtoneBold: return "\u{f802}"
        case .ringtoneLight: return "\u{f803}"
        case .ringtoneRegular: return "\u{f804}"
        case .roomCalendarBold: return "\u{f805}"
        case .roomCalendarLight: return "\u{f806}"
        case .roomCalendarRegular: return "\u{f807}"
        case .roomLightsBold: return "\u{f808}"
        case .roomLightsFilled: return "\u{f809}"
        case .roomLightsLight: return "\u{f80a}"
        case .roomLightsRegular: return "\u{f80b}"
        case .rotateContentBold: return "\u{f80c}"
        case .rotateContentFilled: return "\u{f80d}"
        case .rotateContentLight: return "\u{f80e}"
        case .rotateContentRegular: return "\u{f80f}"
        case .ruleBasedBold: return "\u{f810}"
        case .ruleBasedLight: return "\u{f811}"
        case .ruleBasedRegular: return "\u{f812}"
        case .runningApplicationBold: return "\u{f813}"
        case .runningApplicationFilled: return "\u{f814}"
        case .runningApplicationLight: return "\u{f815}"
        case .runningApplicationRegular: return "\u{f816}"
        case .saveBold: return "\u{f817}"
        case .saveLight: return "\u{f818}"
        case .saveRegular: return "\u{f819}"
        case .scanBold: return "\u{f81a}"
        case .scanLight: return "\u{f81b}"
        case .scanRegular: return "\u{f81c}"
        case .schedulerAvailableBold: return "\u{f81d}"
        case .schedulerAvailableLight: return "\u{f81e}"
        case .schedulerAvailableRegular: return "\u{f81f}"
        case .schedulerNotWorkingHoursBold: return "\u{f820}"
        case .schedulerNotWorkingHoursLight: return "\u{f821}"
        case .schedulerNotWorkingHoursRegular: return "\u{f822}"
        case .schedulerUnavailableBold: return "\u{f823}"
        case .schedulerUnavailableLight: return "\u{f824}"
        case .schedulerUnavailableRegular: return "\u{f825}"
        case .schedulerUnknownBold: return "\u{f826}"
        case .schedulerUnknownLight: return "\u{f827}"
        case .schedulerUnknownRegular: return "\u{f828}"
        case .screenshotBold: return "\u{f829}"
        case .screenshotDocBold: return "\u{f82a}"
        case .screenshotDocFilled: return "\u{f82b}"
        case .screenshotDocLight: return "\u{f82c}"
        case .screenshotDocRegular: return "\u{f82d}"
        case .screenshotLight: return "\u{f82e}"
        case .screenshotRegular: return "\u{f82f}"
        case .searchBold: return "\u{f830}"
        case .searchFilled: return "\u{f831}"
        case .searchLight: return "\u{f832}"
        case .searchRegular: return "\u{f833}"
        case .secondaryArrowBold: return "\u{f834}"
        case .secondaryArrowLight: return "\u{f835}"
        case .secondaryArrowRegular: return "\u{f836}"
        case .secureCallLockBold: return "\u{f837}"
        case .secureCallLockFilled: return "\u{f838}"
        case .secureCallLockLight: return "\u{f839}"
        case .secureCallLockRegular: return "\u{f83a}"
        case .secureCallShieldBold: return "\u{f83b}"
        case .secureCallShieldFilled: return "\u{f83c}"
        case .secureCallShieldLight: return "\u{f83d}"
        case .secureCallShieldRegular: return "\u{f83e}"
        case .secureCircleBold: return "\u{f83f}"
        case .secureCircleFilled: return "\u{f840}"
        case .secureCircleLight: return "\u{f841}"
        case .secureCircleRegular: return "\u{f842}"
        case .secureLockBold: return "\u{f843}"
        case .secureLockFilled: return "\u{f844}"
        case .secureLockLight: return "\u{f845}"
        case .secureLockRegular: return "\u{f846}"
        case .selectAllBold: return "\u{f847}"
        case .selectAllFilled: return "\u{f848}"
        case .selectAllLight: return "\u{f849}"
        case .selectAllRegular: return "\u{f84a}"
        case .selectionBold: return "\u{f84b}"
        case .selectionLight: return "\u{f84c}"
        case .selectionRegular: return "\u{f84d}"
        case .sendBold: return "\u{f84e}"
        case .sendFilled: return "\u{f84f}"
        case .sendLight: return "\u{f850}"
        case .sendRegular: return "\u{f851}"
        case .serverBold: return "\u{f852}"
        case .serverErrorBold: return "\u{f853}"
        case .serverErrorLight: return "\u{f854}"
        case .serverErrorRegular: return "\u{f855}"
        case .serverLight: return "\u{f856}"
        case .serverRegular: return "\u{f857}"
        case .servicesBold: return "\u{f858}"
        case .servicesLight: return "\u{f859}"
        case .servicesRegular: return "\u{f85a}"
        case .setVariableBold: return "\u{f85b}"
        case .setVariableLight: return "\u{f85c}"
        case .setVariableRegular: return "\u{f85d}"
        case .settingsBold: return "\u{f85e}"
        case .settingsFilled: return "\u{f85f}"
        case .settingsLight: return "\u{f860}"
        case .settingsRegular: return "\u{f861}"
        case .setupAssistantBold: return "\u{f862}"
        case .setupAssistantLight: return "\u{f863}"
        case .setupAssistantRegular: return "\u{f864}"
        case .sftpBold: return "\u{f865}"
        case .sftpLight: return "\u{f866}"
        case .sftpRegular: return "\u{f867}"
        case .shapeCircleBold: return "\u{f868}"
        case .shapeCircleFilled: return "\u{f869}"
        case .shapeCircleLight: return "\u{f86a}"
        case .shapeCircleRegular: return "\u{f86b}"
        case .shapeDiagonalLineBold: return "\u{f86c}"
        case .shapeDiagonalLineLight: return "\u{f86d}"
        case .shapeDiagonalLineRegular: return "\u{f86e}"
        case .shapeDiamondBold: return "\u{f86f}"
        case .shapeDiamondFilled: return "\u{f870}"
        case .shapeDiamondLight: return "\u{f871}"
        case .shapeDiamondRegular: return "\u{f872}"
        case .shapeOvalBold: return "\u{f873}"
        case .shapeOvalLight: return "\u{f874}"
        case .shapeOvalRegular: return "\u{f875}"
        case .shapeSquareBold: return "\u{f876}"
        case .shapeSquareFilled: return "\u{f877}"
        case .shapeSquareLight: return "\u{f878}"
        case .shapeSquareRegular: return "\u{f879}"
        case .shapeTriangleBold: return "\u{f87a}"
        case .shapeTriangleFilled: return "\u{f87b}"
        case .shapeTriangleLight: return "\u{f87c}"
        case .shapeTriangleRegular: return "\u{f87d}"
        case .shapesBold: return "\u{f87e}"
        case .shapesLight: return "\u{f87f}"
        case .shapesRegular: return "\u{f880}"
        case .shareCNativeAdrBold: return "\u{f881}"
        case .shareCNativeAdrLight: return "\u{f882}"
        case .shareCNativeAdrRegular: return "\u{f883}"
        case .shareCNativeIphBold: return "\u{f884}"
        case .shareCNativeIphLight: return "\u{f885}"
        case .shareCNativeIphRegular: return "\u{f886}"
        case .shareScreenBold: return "\u{f887}"
        case .shareScreenFilled: return "\u{f888}"
        case .shareScreenLight: return "\u{f889}"
        case .shareScreenRegular: return "\u{f88a}"
        case .shareScreenSmallFilled: return "\u{f88b}"
        case .shareSpaceBold: return "\u{f88c}"
        case .shareSpaceLight: return "\u{f88d}"
        case .shareSpaceRegular: return "\u{f88e}"
        case .shieldBold: return "\u{f88f}"
        case .shieldLight: return "\u{f890}"
        case .shieldRegular: return "\u{f891}"
        case .shortTextBoxBold: return "\u{f892}"
        case .shortTextBoxLight: return "\u{f893}"
        case .shortTextBoxRegular: return "\u{f894}"
        case .showBold: return "\u{f895}"
        case .showFilled: return "\u{f896}"
        case .showLight: return "\u{f897}"
        case .showRegular: return "\u{f898}"
        case .signInBold: return "\u{f899}"
        case .signInFilled: return "\u{f89a}"
        case .signInForcedBold: return "\u{f89b}"
        case .signInForcedLight: return "\u{f89c}"
        case .signInForcedRegular: return "\u{f89d}"
        case .signInLight: return "\u{f89e}"
        case .signInRegular: return "\u{f89f}"
        case .signOutBold: return "\u{f8a0}"
        case .signOutLight: return "\u{f8a1}"
        case .signOutRegular: return "\u{f8a2}"
        case .signal0Bold: return "\u{f8a3}"
        case .signal0Light: return "\u{f8a4}"
        case .signal0Regular: return "\u{f8a5}"
        case .signal100Bold: return "\u{f8a6}"
        case .signal100Light: return "\u{f8a7}"
        case .signal100Regular: return "\u{f8a8}"
        case .signal25Bold: return "\u{f8a9}"
        case .signal25Light: return "\u{f8aa}"
        case .signal25Regular: return "\u{f8ab}"
        case .signal50Bold: return "\u{f8ac}"
        case .signal50Light: return "\u{f8ad}"
        case .signal50Regular: return "\u{f8ae}"
        case .signal75Bold: return "\u{f8af}"
        case .signal75Light: return "\u{f8b0}"
        case .signal75Regular: return "\u{f8b1}"
        case .simplePromotionBold: return "\u{f8b2}"
        case .simplePromotionLight: return "\u{f8b3}"
        case .simplePromotionRegular: return "\u{f8b4}"
        case .singleNumberReachBold: return "\u{f8b5}"
        case .singleNumberReachLight: return "\u{f8b6}"
        case .singleNumberReachRegular: return "\u{f8b7}"
        case .sipRegistrationInProgressBold: return "\u{f8b8}"
        case .sipRegistrationInProgressFilled: return "\u{f8b9}"
        case .sipRegistrationInProgressLight: return "\u{f8ba}"
        case .sipRegistrationInProgressRegular: return "\u{f8bb}"
        case .skipBold: return "\u{f8bc}"
        case .skipBwBold: return "\u{f8bd}"
        case .skipBwFilled: return "\u{f8be}"
        case .skipBwLight: return "\u{f8bf}"
        case .skipBwRegular: return "\u{f8c0}"
        case .skipFwBold: return "\u{f8c1}"
        case .skipFwFilled: return "\u{f8c2}"
        case .skipFwLight: return "\u{f8c3}"
        case .skipFwRegular: return "\u{f8c4}"
        case .skipLight: return "\u{f8c5}"
        case .skipRegular: return "\u{f8c6}"
        case .smsInboundBold: return "\u{f8c7}"
        case .smsInboundLight: return "\u{f8c8}"
        case .smsInboundRegular: return "\u{f8c9}"
        case .socialAlexaFilled: return "\u{f8ca}"
        case .socialFacebookColoredFilled: return "\u{f8cb}"
        case .socialFacebookFilled: return "\u{f8cc}"
        case .socialFbmessengerColoredFilled: return "\u{f8cd}"
        case .socialFbmessengerFilled: return "\u{f8ce}"
        case .socialInstagramBold: return "\u{f8cf}"
        case .socialMicrosoftColoredFilled: return "\u{f8d0}"
        case .socialMicrosoftFilled: return "\u{f8d1}"
        case .socialMmsFilled: return "\u{f8d2}"
        case .socialMmsGoldFilled: return "\u{f8d3}"
        case .socialSmsFilled: return "\u{f8d4}"
        case .socialSmsMintFilled: return "\u{f8d5}"
        case .socialTwitterColoredFilled: return "\u{f8d6}"
        case .socialTwitterFilled: return "\u{f8d7}"
        case .socialViberBold: return "\u{f8d8}"
        case .socialViberColoredBold: return "\u{f8d9}"
        case .socialWhatsappBold: return "\u{f8da}"
        case .socialWhatsappColoredFilled: return "\u{f8db}"
        case .sortAscendingBold: return "\u{f8dc}"
        case .sortAscendingLight: return "\u{f8dd}"
        case .sortAscendingRegular: return "\u{f8de}"
        case .sortDescendingBold: return "\u{f8df}"
        case .sortDescendingLight: return "\u{f8e0}"
        case .sortDescendingRegular: return "\u{f8e1}"
        case .soundDefaultBold: return "\u{f8e2}"
        case .soundDefaultLight: return "\u{f8e3}"
        case .soundDefaultRegular: return "\u{f8e4}"
        case .speakerBold: return "\u{f8e5}"
        case .speakerDisconnectedBold: return "\u{f8e6}"
        case .speakerDisconnectedFilled: return "\u{f8e7}"
        case .speakerDisconnectedLight: return "\u{f8e8}"
        case .speakerDisconnectedRegular: return "\u{f8e9}"
        case .speakerFilled: return "\u{f8ea}"
        case .speakerLight: return "\u{f8eb}"
        case .speakerMutedBold: return "\u{f8ec}"
        case .speakerMutedFilled: return "\u{f8ed}"
        case .speakerMutedLight: return "\u{f8ee}"
        case .speakerMutedRegular: return "\u{f8ef}"
        case .speakerOffBold: return "\u{f8f0}"
        case .speakerOffFilled: return "\u{f8f1}"
        case .speakerOffLight: return "\u{f8f2}"
        case .speakerOffRegular: return "\u{f8f3}"
        case .speakerOnColoredBold: return "\u{f8f4}"
        case .speakerOnColoredLight: return "\u{f8f5}"
        case .speakerOnColoredRegular: return "\u{f8f6}"
        case .speakerRegular: return "\u{f8f7}"
        case .speakerTurnDownBold: return "\u{f8f8}"
        case .speakerTurnDownFilled: return "\u{f8f9}"
        case .speakerTurnDownLight: return "\u{f8fa}"
        case .speakerTurnDownRegular: return "\u{f8fb}"
        case .speakerTurnUpBold: return "\u{f8fc}"
        case .speakerTurnUpFilled: return "\u{f8fd}"
        case .speakerTurnUpLight: return "\u{f8fe}"
        case .speakerTurnUpRegular: return "\u{f8ff}"
        case .spinnerBold: return "\u{f900}"
        case .spinnerFilledBold: return "\u{f901}"
        case .spinnerFilledLight: return "\u{f902}"
        case .spinnerFilledRegular: return "\u{f903}"
        case .spinnerLight: return "\u{f904}"
        case .spinnerPartialBold: return "\u{f905}"
        case .spinnerPartialLight: return "\u{f906}"
        case .spinnerPartialRegular: return "\u{f907}"
        case .spinnerRegular: return "\u{f908}"
        case .stackedArea100ChartBold: return "\u{f909}"
        case .stackedArea100ChartFilled: return "\u{f90a}"
        case .stackedArea100ChartLight: return "\u{f90b}"
        case .stackedArea100ChartRegular: return "\u{f90c}"
        case .stackedAreaChartBold: return "\u{f90d}"
        case .stackedAreaChartFilled: return "\u{f90e}"
        case .stackedAreaChartLight: return "\u{f90f}"
        case .stackedAreaChartRegular: return "\u{f910}"
        case .stackedBar100ChartBold: return "\u{f911}"
        case .stackedBar100ChartFilled: return "\u{f912}"
        case .stackedBar100ChartLight: return "\u{f913}"
        case .stackedBar100ChartRegular: return "\u{f914}"
        case .stackedBarChartBold: return "\u{f915}"
        case .stackedBarChartFilled: return "\u{f916}"
        case .stackedBarChartLight: return "\u{f917}"
        case .stackedBarChartRegular: return "\u{f918}"
        case .startChatBold: return "\u{f919}"
        case .startChatLight: return "\u{f91a}"
        case .startChatRegular: return "\u{f91b}"
        case .stethoscopeBold: return "\u{f91c}"
        case .stethoscopeLight: return "\u{f91d}"
        case .stethoscopeRegular: return "\u{f91e}"
        case .stickersBold: return "\u{f91f}"
        case .stickersLight: return "\u{f920}"
        case .stickersRegular: return "\u{f921}"
        case .stickiesBold: return "\u{f922}"
        case .stickiesLight: return "\u{f923}"
        case .stickiesRegular: return "\u{f924}"
        case .stopBold: return "\u{f925}"
        case .stopCircleBold: return "\u{f926}"
        case .stopCircleFilled: return "\u{f927}"
        case .stopCircleLight: return "\u{f928}"
        case .stopCircleRegular: return "\u{f929}"
        case .stopContentShareBold: return "\u{f92a}"
        case .stopContentShareLight: return "\u{f92b}"
        case .stopContentShareRegular: return "\u{f92c}"
        case .stopFilled: return "\u{f92d}"
        case .stopLight: return "\u{f92e}"
        case .stopRegular: return "\u{f92f}"
        case .storedInfoBold: return "\u{f930}"
        case .storedInfoFilled: return "\u{f931}"
        case .storedInfoLight: return "\u{f932}"
        case .storedInfoRegular: return "\u{f933}"
        case .streamingBold: return "\u{f934}"
        case .streamingLight: return "\u{f935}"
        case .streamingRegular: return "\u{f936}"
        case .strikethroughBold: return "\u{f937}"
        case .strikethroughLight: return "\u{f938}"
        case .strikethroughRegular: return "\u{f939}"
        case .subscriptBold: return "\u{f93a}"
        case .subscriptLight: return "\u{f93b}"
        case .subscriptRegular: return "\u{f93c}"
        case .superscriptBold: return "\u{f93d}"
        case .superscriptLight: return "\u{f93e}"
        case .superscriptRegular: return "\u{f93f}"
        case .sx10Bold: return "\u{f940}"
        case .sx10Light: return "\u{f941}"
        case .sx10Regular: return "\u{f942}"
        case .sx20Bold: return "\u{f943}"
        case .sx20Light: return "\u{f944}"
        case .sx20Regular: return "\u{f945}"
        case .sx80CodecBold: return "\u{f946}"
        case .sx80CodecLight: return "\u{f947}"
        case .sx80CodecRegular: return "\u{f948}"
        case .tableBold: return "\u{f949}"
        case .tableLight: return "\u{f94a}"
        case .tableRegular: return "\u{f94b}"
        case .tabletBold: return "\u{f94c}"
        case .tabletLight: return "\u{f94d}"
        case .tabletRegular: return "\u{f94e}"
        case .tabsBold: return "\u{f94f}"
        case .tabsLight: return "\u{f950}"
        case .tabsRegular: return "\u{f951}"
        case .tagBold: return "\u{f952}"
        case .tagLight: return "\u{f953}"
        case .tagRegular: return "\u{f954}"
        case .tapBold: return "\u{f955}"
        case .tapFilled: return "\u{f956}"
        case .tapLight: return "\u{f957}"
        case .tapRegular: return "\u{f958}"
        case .telepresenceAlertBold: return "\u{f959}"
        case .telepresenceAlertLight: return "\u{f95a}"
        case .telepresenceAlertMutedBold: return "\u{f95b}"
        case .telepresenceAlertMutedLight: return "\u{f95c}"
        case .telepresenceAlertMutedRegular: return "\u{f95d}"
        case .telepresenceAlertRegular: return "\u{f95e}"
        case .telepresenceBold: return "\u{f95f}"
        case .telepresenceIx5000Bold: return "\u{f960}"
        case .telepresenceIx5000Light: return "\u{f961}"
        case .telepresenceIx5000Regular: return "\u{f962}"
        case .telepresenceLight: return "\u{f963}"
        case .telepresencePrivateBold: return "\u{f964}"
        case .telepresencePrivateLight: return "\u{f965}"
        case .telepresencePrivateRegular: return "\u{f966}"
        case .telepresenceRegular: return "\u{f967}"
        case .temperatureBold: return "\u{f968}"
        case .temperatureLight: return "\u{f969}"
        case .temperatureRegular: return "\u{f96a}"
        case .textAlignCenterBold: return "\u{f96b}"
        case .textAlignCenterFilled: return "\u{f96c}"
        case .textAlignCenterLight: return "\u{f96d}"
        case .textAlignCenterRegular: return "\u{f96e}"
        case .textAlignLeftBold: return "\u{f96f}"
        case .textAlignLeftFilled: return "\u{f970}"
        case .textAlignLeftLight: return "\u{f971}"
        case .textAlignLeftRegular: return "\u{f972}"
        case .textAlignRightBold: return "\u{f973}"
        case .textAlignRightFilled: return "\u{f974}"
        case .textAlignRightLight: return "\u{f975}"
        case .textAlignRightRegular: return "\u{f976}"
        case .textBold: return "\u{f977}"
        case .textCodeBlockBold: return "\u{f978}"
        case .textCodeBlockLight: return "\u{f979}"
        case .textCodeBlockRegular: return "\u{f97a}"
        case .textHighlightBold: return "\u{f97b}"
        case .textHighlightLight: return "\u{f97c}"
        case .textHighlightRegular: return "\u{f97d}"
        case .textLight: return "\u{f97e}"
        case .textRegular: return "\u{f97f}"
        case .threeColumnBold: return "\u{f980}"
        case .threeColumnLight: return "\u{f981}"
        case .threeColumnRegular: return "\u{f982}"
        case .threeDObjectBold: return "\u{f983}"
        case .threeDObjectLight: return "\u{f984}"
        case .threeDObjectRegular: return "\u{f985}"
        case .tooFastBold: return "\u{f986}"
        case .tooFastLight: return "\u{f987}"
        case .tooFastRegular: return "\u{f988}"
        case .tooSlowBold: return "\u{f989}"
        case .tooSlowLight: return "\u{f98a}"
        case .tooSlowRegular: return "\u{f98b}"
        case .toolsBold: return "\u{f98c}"
        case .toolsLight: return "\u{f98d}"
        case .toolsRegular: return "\u{f98e}"
        case .touch10Bold: return "\u{f98f}"
        case .touch10Light: return "\u{f990}"
        case .touch10Regular: return "\u{f991}"
        case .transcriptBold: return "\u{f992}"
        case .transcriptFilled: return "\u{f993}"
        case .transcriptLight: return "\u{f994}"
        case .transcriptRegular: return "\u{f995}"
        case .translateBold: return "\u{f996}"
        case .translateLight: return "\u{f997}"
        case .translateRegular: return "\u{f998}"
        case .trimBold: return "\u{f999}"
        case .trimLight: return "\u{f99a}"
        case .trimRegular: return "\u{f99b}"
        case .twoColumnBold: return "\u{f99c}"
        case .twoColumnLight: return "\u{f99d}"
        case .twoColumnRegular: return "\u{f99e}"
        case .ucmCloudBold: return "\u{f99f}"
        case .ucmCloudLight: return "\u{f9a0}"
        case .ucmCloudRegular: return "\u{f9a1}"
        case .underlineBold: return "\u{f9a2}"
        case .underlineLight: return "\u{f9a3}"
        case .underlineRegular: return "\u{f9a4}"
        case .undoBold: return "\u{f9a5}"
        case .undoLight: return "\u{f9a6}"
        case .undoRegular: return "\u{f9a7}"
        case .unlinkBold: return "\u{f9a8}"
        case .unlinkLight: return "\u{f9a9}"
        case .unlinkRegular: return "\u{f9aa}"
        case .unreadBold: return "\u{f9ab}"
        case .unreadFilled: return "\u{f9ac}"
        case .unreadLight: return "\u{f9ad}"
        case .unreadRegular: return "\u{f9ae}"
        case .unsecureUnlockedBold: return "\u{f9af}"
        case .unsecureUnlockedFilled: return "\u{f9b0}"
        case .unsecureUnlockedLight: return "\u{f9b1}"
        case .unsecureUnlockedRegular: return "\u{f9b2}"
        case .unsortedBold: return "\u{f9b3}"
        case .unsortedLight: return "\u{f9b4}"
        case .unsortedRegular: return "\u{f9b5}"
        case .updateFileShareBold: return "\u{f9b6}"
        case .updateFileShareLight: return "\u{f9b7}"
        case .updateFileShareRegular: return "\u{f9b8}"
        case .upgradeBold: return "\u{f9b9}"
        case .upgradeFilled: return "\u{f9ba}"
        case .upgradeLight: return "\u{f9bb}"
        case .upgradeRegular: return "\u{f9bc}"
        case .uploadBold: return "\u{f9bd}"
        case .uploadLight: return "\u{f9be}"
        case .uploadRegular: return "\u{f9bf}"
        case .urgentVoicemailBold: return "\u{f9c0}"
        case .urgentVoicemailFilled: return "\u{f9c1}"
        case .usbBold: return "\u{f9c2}"
        case .usbHeadsetBold: return "\u{f9c3}"
        case .usbHeadsetLight: return "\u{f9c4}"
        case .usbHeadsetMutedBold: return "\u{f9c5}"
        case .usbHeadsetMutedLight: return "\u{f9c6}"
        case .usbHeadsetMutedRegular: return "\u{f9c7}"
        case .usbHeadsetRegular: return "\u{f9c8}"
        case .usbLight: return "\u{f9c9}"
        case .usbRegular: return "\u{f9ca}"
        case .userBold: return "\u{f9cb}"
        case .userDeactivateBold: return "\u{f9cc}"
        case .userDeactivateLight: return "\u{f9cd}"
        case .userDeactivateRegular: return "\u{f9ce}"
        case .userLight: return "\u{f9cf}"
        case .userRegular: return "\u{f9d0}"
        case .vcsBold: return "\u{f9d1}"
        case .vcsLight: return "\u{f9d2}"
        case .vcsRegular: return "\u{f9d3}"
        case .videoBlurBold: return "\u{f9d4}"
        case .videoBlurFilled: return "\u{f9d5}"
        case .videoBlurLight: return "\u{f9d6}"
        case .videoBlurRegular: return "\u{f9d7}"
        case .videoBold: return "\u{f9d8}"
        case .videoEffectBold: return "\u{f9d9}"
        case .videoEffectFilled: return "\u{f9da}"
        case .videoEffectLight: return "\u{f9db}"
        case .videoEffectRegular: return "\u{f9dc}"
        case .videoFilled: return "\u{f9dd}"
        case .videoLayoutBold: return "\u{f9de}"
        case .videoLayoutEqualBold: return "\u{f9df}"
        case .videoLayoutEqualDualBold: return "\u{f9e0}"
        case .videoLayoutEqualDualLight: return "\u{f9e1}"
        case .videoLayoutEqualDualRegular: return "\u{f9e2}"
        case .videoLayoutEqualFilled: return "\u{f9e3}"
        case .videoLayoutEqualLight: return "\u{f9e4}"
        case .videoLayoutEqualRegular: return "\u{f9e5}"
        case .videoLayoutFilled: return "\u{f9e6}"
        case .videoLayoutLight: return "\u{f9e7}"
        case .videoLayoutOverlayBold: return "\u{f9e8}"
        case .videoLayoutOverlayLight: return "\u{f9e9}"
        case .videoLayoutOverlayRegular: return "\u{f9ea}"
        case .videoLayoutPresenterDominantBold: return "\u{f9eb}"
        case .videoLayoutPresenterDominantLight: return "\u{f9ec}"
        case .videoLayoutPresenterDominantRegular: return "\u{f9ed}"
        case .videoLayoutProminentBold: return "\u{f9ee}"
        case .videoLayoutProminentFilled: return "\u{f9ef}"
        case .videoLayoutProminentLight: return "\u{f9f0}"
        case .videoLayoutProminentRegular: return "\u{f9f1}"
        case .videoLayoutRegular: return "\u{f9f2}"
        case .videoLayoutShareDominantBold: return "\u{f9f3}"
        case .videoLayoutShareDominantLight: return "\u{f9f4}"
        case .videoLayoutShareDominantRegular: return "\u{f9f5}"
        case .videoLayoutSingleBold: return "\u{f9f6}"
        case .videoLayoutSingleFilled: return "\u{f9f7}"
        case .videoLayoutSingleLight: return "\u{f9f8}"
        case .videoLayoutSingleRegular: return "\u{f9f9}"
        case .videoLayoutStackBold: return "\u{f9fa}"
        case .videoLayoutStackFilled: return "\u{f9fb}"
        case .videoLayoutStackLight: return "\u{f9fc}"
        case .videoLayoutStackRegular: return "\u{f9fd}"
        case .videoLayoutVideoDominantBold: return "\u{f9fe}"
        case .videoLayoutVideoDominantLight: return "\u{f9ff}"
        case .videoLayoutVideoDominantRegular: return "\u{fa00}"
        case .videoLight: return "\u{fa01}"
        case .videoPlusBold: return "\u{fa02}"
        case .videoPlusFilled: return "\u{fa03}"
        case .videoPlusLight: return "\u{fa04}"
        case .videoPlusRegular: return "\u{fa05}"
        case .videoRegular: return "\u{fa06}"
        case .videoSpeakerTrackBold: return "\u{fa07}"
        case .videoSpeakerTrackFilled: return "\u{fa08}"
        case .videoSpeakerTrackLight: return "\u{fa09}"
        case .videoSpeakerTrackRegular: return "\u{fa0a}"
        case .viewAllBold: return "\u{fa0b}"
        case .viewAllLight: return "\u{fa0c}"
        case .viewAllRegular: return "\u{fa0d}"
        case .viewListBold: return "\u{fa0e}"
        case .viewListLight: return "\u{fa0f}"
        case .viewListRegular: return "\u{fa10}"
        case .viewStackedBold: return "\u{fa11}"
        case .viewStackedFilled: return "\u{fa12}"
        case .viewStackedLight: return "\u{fa13}"
        case .viewStackedRegular: return "\u{fa14}"
        case .viewThumbnailBold: return "\u{fa15}"
        case .viewThumbnailFilled: return "\u{fa16}"
        case .viewThumbnailLight: return "\u{fa17}"
        case .viewThumbnailRegular: return "\u{fa18}"
        case .voicemailBold: return "\u{fa19}"
        case .voicemailFilled: return "\u{fa1a}"
        case .voicemailLight: return "\u{fa1b}"
        case .voicemailRegular: return "\u{fa1c}"
        case .waffleMenuBold: return "\u{fa1d}"
        case .waffleMenuLight: return "\u{fa1e}"
        case .waffleMenuRegular: return "\u{fa1f}"
        case .waitingroomActiveBold: return "\u{fa20}"
        case .waitingroomActiveLight: return "\u{fa21}"
        case .waitingroomActiveRegular: return "\u{fa22}"
        case .wallpaperBold: return "\u{fa23}"
        case .wallpaperLight: return "\u{fa24}"
        case .wallpaperRegular: return "\u{fa25}"
        case .warningBadgeFilled: return "\u{fa26}"
        case .warningBold: return "\u{fa27}"
        case .warningFilled: return "\u{fa28}"
        case .warningLight: return "\u{fa29}"
        case .warningRegular: return "\u{fa2a}"
        case .webexAssistantActiveColored: return "\u{fa2b}"
        case .webexAssistantInactiveColored: return "\u{fa2c}"
        case .webexBoardBold: return "\u{fa2d}"
        case .webexBoardLight: return "\u{fa2e}"
        case .webexBoardRegular: return "\u{fa2f}"
        case .webexCodecPlusBold: return "\u{fa30}"
        case .webexCodecPlusLight: return "\u{fa31}"
        case .webexCodecPlusRegular: return "\u{fa32}"
        case .webexDeskCameraBold: return "\u{fa33}"
        case .webexDeskCameraLight: return "\u{fa34}"
        case .webexDeskCameraRegular: return "\u{fa35}"
        case .webexHelixFilled: return "\u{fa36}"
        case .webexMeetingsBold: return "\u{fa37}"
        case .webexMeetingsFilled: return "\u{fa38}"
        case .webexMeetingsLight: return "\u{fa39}"
        case .webexMeetingsRegular: return "\u{fa3a}"
        case .webexQuadCameraBold: return "\u{fa3b}"
        case .webexQuadCameraLight: return "\u{fa3c}"
        case .webexQuadCameraRegular: return "\u{fa3d}"
        case .webexRoomKitBold: return "\u{fa3e}"
        case .webexRoomKitLight: return "\u{fa3f}"
        case .webexRoomKitPlusBold: return "\u{fa40}"
        case .webexRoomKitPlusLight: return "\u{fa41}"
        case .webexRoomKitPlusRegular: return "\u{fa42}"
        case .webexRoomKitRegular: return "\u{fa43}"
        case .webexShareBold: return "\u{fa44}"
        case .webexShareLight: return "\u{fa45}"
        case .webexShareRegular: return "\u{fa46}"
        case .webexTeamsBold: return "\u{fa47}"
        case .webexTeamsFilled: return "\u{fa48}"
        case .webexTeamsLight: return "\u{fa49}"
        case .webexTeamsNewBold: return "\u{fa4a}"
        case .webexTeamsNewFilled: return "\u{fa4b}"
        case .webexTeamsNewLight: return "\u{fa4c}"
        case .webexTeamsNewRegular: return "\u{fa4d}"
        case .webexTeamsRegular: return "\u{fa4e}"
        case .webinarBold: return "\u{fa4f}"
        case .webinarFilled: return "\u{fa50}"
        case .webinarLight: return "\u{fa51}"
        case .webinarRegular: return "\u{fa52}"
        case .weeklyRecurringScheduleNodeBold: return "\u{fa53}"
        case .weeklyRecurringScheduleNodeLight: return "\u{fa54}"
        case .weeklyRecurringScheduleNodeRegular: return "\u{fa55}"
        case .whiteboardBold: return "\u{fa56}"
        case .whiteboardContentBold: return "\u{fa57}"
        case .whiteboardContentLight: return "\u{fa58}"
        case .whiteboardContentRegular: return "\u{fa59}"
        case .whiteboardFilled: return "\u{fa5a}"
        case .whiteboardLight: return "\u{fa5b}"
        case .whiteboardRegular: return "\u{fa5c}"
        case .widgetBold: return "\u{fa5d}"
        case .widgetFilled: return "\u{fa5e}"
        case .widgetLight: return "\u{fa5f}"
        case .widgetRegular: return "\u{fa60}"
        case .wifiBold: return "\u{fa61}"
        case .wifiErrorBold: return "\u{fa62}"
        case .wifiErrorLight: return "\u{fa63}"
        case .wifiErrorRegular: return "\u{fa64}"
        case .wifiLight: return "\u{fa65}"
        case .wifiRegular: return "\u{fa66}"
        case .wifiSignalGoodColoredBold: return "\u{fa67}"
        case .wifiSignalGoodColoredLight: return "\u{fa68}"
        case .wifiSignalGoodColoredRegular: return "\u{fa69}"
        case .wifiSignalPoorColoredBold: return "\u{fa6a}"
        case .wifiSignalPoorColoredLight: return "\u{fa6b}"
        case .wifiSignalPoorColoredRegular: return "\u{fa6c}"
        case .wifiSignalUnstableColoredBold: return "\u{fa6d}"
        case .wifiSignalUnstableColoredLight: return "\u{fa6e}"
        case .wifiSignalUnstableColoredRegular: return "\u{fa6f}"
        case .windowCornerScrubBold: return "\u{fa70}"
        case .windowCornerScrubLight: return "\u{fa71}"
        case .windowCornerScrubRegular: return "\u{fa72}"
        case .windowRightCornerScrubBold: return "\u{fa73}"
        case .windowRightCornerScrubLight: return "\u{fa74}"
        case .windowRightCornerScrubRegular: return "\u{fa75}"
        case .windowVerticalScrubBold: return "\u{fa76}"
        case .windowVerticalScrubLight: return "\u{fa77}"
        case .windowVerticalScrubRegular: return "\u{fa78}"
        case .workflowDeploymentsBold: return "\u{fa79}"
        case .workflowDeploymentsLight: return "\u{fa7a}"
        case .workflowDeploymentsRegular: return "\u{fa7b}"
        case .workphoneBold: return "\u{fa7c}"
        case .workphoneLight: return "\u{fa7d}"
        case .workphoneRegular: return "\u{fa7e}"
        case .zoomInBold: return "\u{fa7f}"
        case .zoomInLight: return "\u{fa80}"
        case .zoomInRegular: return "\u{fa81}"
        case .zoomOutBold: return "\u{fa82}"
        case .zoomOutLight: return "\u{fa83}"
        case .zoomOutRegular: return "\u{fa84}"
